...
@state() private _spmNetworkSegment9 = { id: "NET-009", name: "Segment 9", subnet: "10.9.0.0/16", criticality: "high", deviceCount: 37, vulnerabilityCount: 3, lastScan: "2026-01-19" } as any;
  ...
  @state() private _complianceCalendarEvents: Array<{id: string; title: string; deadline: string; category: string; status: string; assignee: string; notes: string}> = [
    {id: 'cc-incident-timeline-viz-001', title: 'SOX Section 404 Compliance Review', deadline: '2026-06-30', category: 'Regulatory', status: 'In Progress', assignee: 'Compliance Team', notes: 'Annual internal control assessment for financial reporting'},
    {id: 'cc-incident-timeline-viz-002', title: 'GDPR Data Protection Impact Assessment', deadline: '2026-05-15', category: 'Privacy', status: 'Pending', assignee: 'DPO Office', notes: 'Quarterly DPIA for high-risk processing activities'},
    {id: 'cc-incident-timeline-viz-003', title: 'ISO 27001 Surveillance Audit', deadline: '2026-07-20', category: 'Certification', status: 'Scheduled', assignee: 'QA Lead', notes: 'Stage 2 surveillance audit for ISMS certification renewal'},
    {id: 'cc-incident-timeline-viz-004', title: 'PCI DSS v4.0 Gap Analysis', deadline: '2026-05-30', category: 'Payment', status: 'Not Started', assignee: 'Security Architect', notes: 'Assess current state against PCI DSS v4.0 requirements'},
    {id: 'cc-incident-timeline-viz-005', title: 'NIST CSF Self-Assessment', deadline: '2026-08-15', category: 'Framework', status: 'Pending', assignee: 'CISO', notes: 'Biannual self-assessment against NIST Cybersecurity Framework'},
    {id: 'cc-incident-timeline-viz-006', title: 'HIPAA Security Rule Audit', deadline: '2026-06-15', category: 'Healthcare', status: 'In Progress', assignee: 'Compliance Analyst', notes: 'Annual audit of administrative, physical, and technical safeguards'},
    {id: 'cc-incident-timeline-viz-007', title: 'SOC 2 Type II Report Renewal', deadline: '2026-09-30', category: 'Audit', status: 'Scheduled', assignee: 'External Auditor', notes: 'Engage auditor for SOC 2 Type II examination period'},
    {id: 'cc-incident-timeline-viz-008', title: 'FedRAMP Authorization Review', deadline: '2026-07-01', category: 'Government', status: 'Pending', assignee: 'FedRAMP PMO', notes: 'Review and update security authorization package'},
    {id: 'cc-incident-timeline-viz-009', title: 'Annual Penetration Test', deadline: '2026-10-15', category: 'Testing', status: 'Not Started', assignee: 'Red Team Lead', notes: 'Comprehensive external and internal penetration testing engagement'},
    {id: 'cc-incident-timeline-viz-010', title: 'Security Awareness Training Rollout', deadline: '2026-05-01', category: 'Training', status: 'Completed', assignee: 'Security Awareness Manager', notes: 'Q2 organization-wide security awareness training program'},
    {id: 'cc-incident-timeline-viz-011', title: 'Vendor Security Review Cycle', deadline: '2026-06-01', category: 'Third Party', status: 'In Progress', assignee: 'Vendor Manager', notes: 'Quarterly review of critical vendor security posture and SLA compliance'},
    {id: 'cc-incident-timeline-viz-012', title: 'Incident Response Plan Update', deadline: '2026-05-20', category: 'Operations', status: 'Pending', assignee: 'IR Team Lead', notes: 'Update IR procedures based on lessons learned from recent incidents'},
  ];
  ...
  @state() private _dataQualityMetrics: Array<{id: string; dataSource: string; completenessScore: number; accuracyScore: number; timelinessScore: number; consistencyScore: number; reliabilityRank: number; lastUpdated: string; issues: string[]; trend: string}> = [
    {id: 'dq-incident-timeline-viz-001', dataSource: 'Vulnerability Scanner Feed', completenessScore: 94, accuracyScore: 91, timelinessScore: 88, consistencyScore: 95, reliabilityRank: 1, lastUpdated: '2026-04-23T08:00:00Z', issues: ['Minor delay in Nessus plugin updates'], trend: 'improving'},
    {id: 'dq-incident-timeline-viz-002', dataSource: 'SIEM Event Logs', completenessScore: 87, accuracyScore: 93, timelinessScore: 96, consistencyScore: 89, reliabilityRank: 2, lastUpdated: '2026-04-23T07:30:00Z', issues: ['Some log sources showing gaps in off-hours'], trend: 'stable'},
    {id: 'dq-incident-timeline-viz-003', dataSource: 'Asset Inventory Database', completenessScore: 82, accuracyScore: 78, timelinessScore: 75, consistencyScore: 84, reliabilityRank: 4, lastUpdated: '2026-04-22T18:00:00Z', issues: ['Shadow IT devices not fully cataloged', 'Decommissioned assets still listed'], trend: 'declining'},
    {id: 'dq-incident-timeline-viz-004', dataSource: 'Threat Intelligence Platform', completenessScore: 91, accuracyScore: 89, timelinessScore: 92, consistencyScore: 87, reliabilityRank: 3, lastUpdated: '2026-04-23T06:00:00Z', issues: ['Some IOC sources lack confidence scoring'], trend: 'improving'},
    {id: 'dq-incident-timeline-viz-005', dataSource: 'Identity Provider Logs', completenessScore: 96, accuracyScore: 97, timelinessScore: 98, consistencyScore: 96, reliabilityRank: 1, lastUpdated: '2026-04-23T09:00:00Z', issues: [], trend: 'stable'},
    {id: 'dq-incident-timeline-viz-006', dataSource: 'Cloud Security Posture Data', completenessScore: 79, accuracyScore: 85, timelinessScore: 82, consistencyScore: 81, reliabilityRank: 5, lastUpdated: '2026-04-23T05:00:00Z', issues: ['Multi-cloud coverage gaps', 'API rate limiting affects scan frequency'], trend: 'declining'},
    {id: 'dq-incident-timeline-viz-007', dataSource: 'Compliance Evidence Store', completenessScore: 88, accuracyScore: 86, timelinessScore: 80, consistencyScore: 83, reliabilityRank: 4, lastUpdated: '2026-04-21T14:00:00Z', issues: ['Manual evidence collection delays', 'Inconsistent formatting across frameworks'], trend: 'stable'},
    {id: 'dq-incident-timeline-viz-008', dataSource: 'Network Flow Data', completenessScore: 92, accuracyScore: 90, timelinessScore: 94, consistencyScore: 91, reliabilityRank: 2, lastUpdated: '2026-04-23T08:30:00Z', issues: ['Encrypted traffic classification accuracy needs improvement'], trend: 'improving'},
  ];
  ...
  @state() private _workflowTemplates: Array<{id: string; name: string; description: string; category: string; steps: number; avgDuration: string; successRate: number; lastRun: string; manualInterventions: number; optimizationScore: number}> = [
    {id: 'wf-incident-timeline-viz-001', name: 'Vulnerability Triage Pipeline', description: 'Automated vulnerability assessment, prioritization, and assignment workflow', category: 'Vulnerability Management', steps: 8, avgDuration: '12 min', successRate: 94.5, lastRun: '2026-04-23T06:00:00Z', manualInterventions: 2, optimizationScore: 87},
    {id: 'wf-incident-timeline-viz-002', name: 'Incident Response Orchestration', description: 'End-to-end IR workflow from detection to containment and recovery', category: 'Incident Response', steps: 15, avgDuration: '45 min', successRate: 89.2, lastRun: '2026-04-22T14:30:00Z', manualInterventions: 5, optimizationScore: 72},
    {id: 'wf-incident-timeline-viz-003', name: 'Access Request Approval Chain', description: 'Multi-level approval workflow for privileged access requests', category: 'Identity & Access', steps: 6, avgDuration: '4 hours', successRate: 97.1, lastRun: '2026-04-23T09:15:00Z', manualInterventions: 1, optimizationScore: 92},
    {id: 'wf-incident-timeline-viz-004', name: 'Compliance Evidence Collection', description: 'Automated gathering and packaging of audit evidence artifacts', category: 'Compliance', steps: 10, avgDuration: '30 min', successRate: 91.8, lastRun: '2026-04-21T10:00:00Z', manualInterventions: 3, optimizationScore: 78},
    {id: 'wf-incident-timeline-viz-005', name: 'Security Patch Deployment', description: 'Staged patch rollout with validation and rollback capability', category: 'Patch Management', steps: 12, avgDuration: '2 hours', successRate: 96.3, lastRun: '2026-04-20T22:00:00Z', manualInterventions: 1, optimizationScore: 85},
    {id: 'wf-incident-timeline-viz-006', name: 'Threat Intelligence Enrichment', description: 'IOC enrichment and correlation with internal threat data', category: 'Threat Intelligence', steps: 7, avgDuration: '8 min', successRate: 93.7, lastRun: '2026-04-23T07:00:00Z', manualInterventions: 0, optimizationScore: 95},
    {id: 'wf-incident-timeline-viz-007', name: 'Security Reporting Pipeline', description: 'Automated generation and distribution of security metrics reports', category: 'Reporting', steps: 5, avgDuration: '15 min', successRate: 98.9, lastRun: '2026-04-23T08:00:00Z', manualInterventions: 0, optimizationScore: 97},
    {id: 'wf-incident-timeline-viz-008', name: 'Vendor Risk Assessment', description: 'Automated vendor security questionnaire distribution and scoring', category: 'Third Party', steps: 9, avgDuration: '3 days', successRate: 85.4, lastRun: '2026-04-19T11:00:00Z', manualInterventions: 4, optimizationScore: 65},
  ];
  ...
  @state() private _workflowExecutionHistory: Array<{workflowId: string; runDate: string; duration: string; status: string; trigger: string}> = [
    {workflowId: 'wf-incident-timeline-viz-001', runDate: '2026-04-23T06:00:00Z', duration: '11 min 23 sec', status: 'Success', trigger: 'Scheduled'},
    {workflowId: 'wf-incident-timeline-viz-002', runDate: '2026-04-22T14:30:00Z', duration: '42 min 15 sec', status: 'Success', trigger: 'Alert'},
    {workflowId: 'wf-incident-timeline-viz-003', runDate: '2026-04-23T09:15:00Z', duration: '3h 45 min', status: 'Success', trigger: 'User Request'},
    {workflowId: 'wf-incident-timeline-viz-001', runDate: '2026-04-22T06:00:00Z', duration: '13 min 08 sec', status: 'Partial', trigger: 'Scheduled'},
    {workflowId: 'wf-incident-timeline-viz-004', runDate: '2026-04-21T10:00:00Z', duration: '28 min 42 sec', status: 'Success', trigger: 'Scheduled'},
  ];
  ...
  @state() private _knowledgeArticles: Array<{id: string; title: string; category: string; author: string; publishDate: string; views: number; rating: number; tags: string[]; summary: string; readTime: string}> = [
    {id: 'kb-incident-timeline-viz-001', title: 'Zero Trust Architecture Implementation Guide', category: 'Architecture', author: 'Security Architecture Team', publishDate: '2026-03-15', views: 1842, rating: 4.8, tags: ['zero-trust', 'network', 'identity'], summary: 'Comprehensive guide for implementing zero trust principles across enterprise infrastructure', readTime: '15 min'},
    {id: 'kb-incident-timeline-viz-002', title: 'Ransomware Defense Playbook 2026', category: 'Threats', author: 'Threat Intelligence Team', publishDate: '2026-04-01', views: 2341, rating: 4.9, tags: ['ransomware', 'incident-response', 'defense'], summary: 'Updated playbook with latest ransomware tactics, techniques, and defensive measures', readTime: '12 min'},
    {id: 'kb-incident-timeline-viz-003', title: 'Cloud Security Best Practices for Multi-Cloud', category: 'Cloud', author: 'Cloud Security Team', publishDate: '2026-02-28', views: 1567, rating: 4.5, tags: ['cloud', 'aws', 'azure', 'gcp'], summary: 'Best practices for securing workloads across multiple cloud service providers', readTime: '18 min'},
    {id: 'kb-incident-timeline-viz-004', title: 'API Security Testing Methodology', category: 'Testing', author: 'Red Team', publishDate: '2026-03-22', views: 987, rating: 4.6, tags: ['api', 'testing', 'owasp'], summary: 'Structured methodology for identifying and testing API security vulnerabilities', readTime: '10 min'},
    {id: 'kb-incident-timeline-viz-005', title: 'Supply Chain Security Risk Management', category: 'Third Party', author: 'GRC Team', publishDate: '2026-01-20', views: 1234, rating: 4.3, tags: ['supply-chain', 'vendor', 'risk'], summary: 'Framework for managing security risks in the software supply chain', readTime: '14 min'},
    {id: 'kb-incident-timeline-viz-006', title: 'Kubernetes Security Hardening Checklist', category: 'Container', author: 'Platform Security', publishDate: '2026-04-10', views: 2103, rating: 4.7, tags: ['kubernetes', 'container', 'hardening'], summary: 'Step-by-step hardening checklist for production Kubernetes clusters', readTime: '11 min'},
    {id: 'kb-incident-timeline-viz-007', title: 'Security Metrics That Matter for Executives', category: 'Metrics', author: 'CISO Office', publishDate: '2026-03-05', views: 876, rating: 4.4, tags: ['metrics', 'kpi', 'reporting'], summary: 'Key security metrics and KPIs that resonate with board-level stakeholders', readTime: '8 min'},
    {id: 'kb-incident-timeline-viz-008', title: 'Phishing Simulation Campaign Design', category: 'Awareness', author: 'Security Awareness Team', publishDate: '2026-02-15', views: 1456, rating: 4.5, tags: ['phishing', 'simulation', 'training'], summary: 'Designing effective phishing simulations that drive real behavioral change', readTime: '9 min'},
    {id: 'kb-incident-timeline-viz-009', title: 'Data Loss Prevention Strategy and Implementation', category: 'Data Protection', author: 'Data Security Team', publishDate: '2026-03-28', views: 1678, rating: 4.6, tags: ['dlp', 'data-protection', 'compliance'], summary: 'Strategic approach to DLP covering people, process, and technology layers', readTime: '16 min'},
    {id: 'kb-incident-timeline-viz-010', title: 'Security Automation with SOAR Platforms', category: 'Automation', author: 'SOC Engineering', publishDate: '2026-04-05', views: 1098, rating: 4.7, tags: ['soar', 'automation', 'soc'], summary: 'Building effective security automation playbooks using SOAR technology', readTime: '13 min'},
    {id: 'kb-incident-timeline-viz-011', title: 'Third-Party Risk Assessment Framework', category: 'GRC', author: 'Vendor Management', publishDate: '2026-01-30', views: 1345, rating: 4.4, tags: ['vendor', 'risk', 'assessment'], summary: 'Structured framework for evaluating and monitoring third-party security risks', readTime: '12 min'},
    {id: 'kb-incident-timeline-viz-012', title: 'Network Detection and Response Best Practices', category: 'Network', author: 'Network Security Team', publishDate: '2026-03-18', views: 1567, rating: 4.5, tags: ['ndr', 'network', 'detection'], summary: 'Implementing effective network detection and response capabilities', readTime: '14 min'},
    {id: 'kb-incident-timeline-viz-013', title: 'Security Chaos Engineering Guide', category: 'Resilience', author: 'SRE Security', publishDate: '2026-04-12', views: 789, rating: 4.3, tags: ['chaos-engineering', 'resilience', 'testing'], summary: 'Applying chaos engineering principles to validate security controls', readTime: '10 min'},
    {id: 'kb-incident-timeline-viz-014', title: 'Incident Communication Templates', category: 'Incident Response', author: 'IR Team', publishDate: '2026-02-22', views: 2234, rating: 4.8, tags: ['incident', 'communication', 'templates'], summary: 'Ready-to-use communication templates for security incident scenarios', readTime: '7 min'},
    {id: 'kb-incident-timeline-viz-015', title: 'Endpoint Detection and Response Configuration', category: 'Endpoint', author: 'Endpoint Security', publishDate: '2026-03-08', views: 1345, rating: 4.5, tags: ['edr', 'endpoint', 'configuration'], summary: 'Optimal EDR configuration for maximum detection with minimal false positives', readTime: '11 min'},
    {id: 'kb-incident-timeline-viz-016', title: 'Security Code Review Standards', category: 'Development', author: 'AppSec Team', publishDate: '2026-02-10', views: 1890, rating: 4.6, tags: ['code-review', 'secure-sdlc', 'standards'], summary: 'Standards and checklists for security-focused code reviews', readTime: '13 min'},
    {id: 'kb-incident-timeline-viz-017', title: 'IoT Security Assessment Methodology', category: 'IoT', author: 'IoT Security Lab', publishDate: '2026-04-08', views: 654, rating: 4.2, tags: ['iot', 'embedded', 'assessment'], summary: 'Methodology for assessing security posture of IoT devices and ecosystems', readTime: '15 min'},
    {id: 'kb-incident-timeline-viz-018', title: 'Passwordless Authentication Migration Guide', category: 'Identity', author: 'IAM Team', publishDate: '2026-03-25', views: 1678, rating: 4.7, tags: ['passwordless', 'authentication', 'mfa'], summary: 'Step-by-step migration plan from password-based to passwordless authentication', readTime: '12 min'},
    {id: 'kb-incident-timeline-viz-019', title: 'Security Awareness Program Metrics', category: 'Awareness', author: 'Security Culture Team', publishDate: '2026-01-25', views: 1123, rating: 4.4, tags: ['awareness', 'metrics', 'culture'], summary: 'Measuring the effectiveness of your security awareness and training programs', readTime: '9 min'},
    {id: 'kb-incident-timeline-viz-020', title: 'Deception Technology Deployment Guide', category: 'Detection', author: 'Blue Team', publishDate: '2026-04-15', views: 876, rating: 4.5, tags: ['deception', 'honeypot', 'detection'], summary: 'Planning and deploying deception technology for advanced threat detection', readTime: '11 min'},
  ];
  ...
  // --- Security Scenario Planning Methods (INTIVI) ---
  private _initIntiviScenarios(): void {
    const worstCaseScenarios = [
      { id: "intivi-sc-01", name: "Ransomware Attack on Critical Infrastructure", category: "Malware", impact: 9500000, probability: 0.12, recoveryDays: 21, affectedSystems: 47, dataLossGb: 320, businessImpact: "critical" },
      { id: "intivi-sc-02", name: "Insider Data Exfiltration via Authorized Channels", category: "Insider Threat", impact: 7200000, probability: 0.18, recoveryDays: 14, affectedSystems: 12, dataLossGb: 85, businessImpact: "high" },
      { id: "intivi-sc-03", name: "Supply Chain Compromise via Third-Party Library", category: "Supply Chain", impact: 6800000, probability: 0.09, recoveryDays: 30, affectedSystems: 63, dataLossGb: 0, businessImpact: "critical" },
      { id: "intivi-sc-04", name: "Cloud Misconfiguration Leading to Public Exposure", category: "Cloud", impact: 4100000, probability: 0.22, recoveryDays: 7, affectedSystems: 8, dataLossGb: 450, businessImpact: "high" },
      { id: "intivi-sc-05", name: "Zero-Day Exploit in Core Application Framework", category: "Vulnerability", impact: 8900000, probability: 0.05, recoveryDays: 45, affectedSystems: 120, dataLossGb: 0, businessImpact: "critical" },
      { id: "intivi-sc-06", name: "Distributed Denial of Service on Customer-Facing Services", category: "Availability", impact: 3400000, probability: 0.25, recoveryDays: 3, affectedSystems: 15, dataLossGb: 0, businessImpact: "medium" },
      { id: "intivi-sc-07", name: "Credential Stuffing and Account Takeover Wave", category: "Identity", impact: 2800000, probability: 0.30, recoveryDays: 5, affectedSystems: 6, dataLossGb: 12, businessImpact: "medium" },
      { id: "intivi-sc-08", name: "Physical Security Breach at Data Center Facility", category: "Physical", impact: 12000000, probability: 0.02, recoveryDays: 60, affectedSystems: 200, dataLossGb: 5000, businessImpact: "critical" },
    ];
    this._intiviScenarios = worstCaseScenarios.map(s => ({ ...s, mitigationCost: Math.round(s.impact * 0.08), drillScheduled: false, lastDrillDate: null, drillScore: null, controlGaps: Math.floor(Math.random() * 5) + 1 }));
  }

  private _calculateIntiviScenarioRisk(): void {
    this._intiviScenarios.forEach(s => {
  ...
  private _scheduleIntiviDrills(): void {
  ...
  private _intiviScenarioComparison(): Record<string, unknown>[] {
    return this._intiviScenarios.map(s => ({
  ...
  // --- Security Control Effectiveness Analytics (INTIVI) ---
  private _initIntiviControls(): void {
    const controls = [
      { id: "intivi-ct-01", name: "Network Segmentation", type: "preventive", maturity: "defined", score: 82, target: 90, failures: 3, lastTest: "2026-03-15" },
      { id: "intivi-ct-02", name: "Endpoint Detection and Response", type: "detective", maturity: "managed", score: 88, target: 92, failures: 1, lastTest: "2026-04-01" },
      { id: "intivi-ct-03", name: "Data Loss Prevention", type: "preventive", maturity: "repeatable", score: 71, target: 85, failures: 7, lastTest: "2026-03-22" },
      { id: "intivi-ct-04", name: "Security Information and Event Management", type: "detective", maturity: "managed", score: 85, target: 90, failures: 2, lastTest: "2026-04-05" },
      { id: "intivi-ct-05", name: "Identity and Access Management", type: "preventive", maturity: "defined", score: 76, target: 88, failures: 5, lastTest: "2026-03-28" },
      { id: "intivi-ct-06", name: "Vulnerability Management", type: "corrective", maturity: "managed", score: 80, target: 90, failures: 4, lastTest: "2026-04-02" },
      { id: "intivi-ct-07", name: "Email Security Gateway", type: "preventive", maturity: "managed", score: 90, target: 95, failures: 1, lastTest: "2026-04-08" },
      { id: "intivi-ct-08", name: "Web Application Firewall", type: "preventive", maturity: "managed", score: 87, target: 92, failures: 2, lastTest: "2026-03-30" },
      { id: "intivi-ct-09", name: "Patch Management", type: "corrective", maturity: "defined", score: 68, target: 85, failures: 9, lastTest: "2026-03-18" },
      { id: "intivi-ct-10", name: "Encryption at Rest", type: "preventive", maturity: "managed", score: 93, target: 95, failures: 0, lastTest: "2026-04-10" },
      { id: "intivi-ct-11", name: "Encryption in Transit", type: "preventive", maturity: "optimized", score: 96, target: 98, failures: 0, lastTest: "2026-04-12" },
      { id: "intivi-ct-12", name: "Privileged Access Management", type: "preventive", maturity: "defined", score: 74, target: 88, failures: 6, lastTest: "2026-03-25" },
      { id: "intivi-ct-13", name: "Security Awareness Training", type: "preventive", maturity: "repeatable", score: 65, target: 80, failures: 11, lastTest: "2026-03-20" },
      { id: "intivi-ct-14", name: "Incident Response Plan", type: "corrective", maturity: "managed", score: 78, target: 88, failures: 4, lastTest: "2026-04-03" },
      { id: "intivi-ct-15", name: "Backup and Recovery", type: "corrective", maturity: "managed", score: 84, target: 92, failures: 3, lastTest: "2026-04-06" },
      { id: "intivi-ct-16", name: "Multi-Factor Authentication", type: "preventive", maturity: "managed", score: 91, target: 95, failures: 1, lastTest: "2026-04-09" },
      { id: "intivi-ct-17", name: "Network Traffic Analysis", type: "detective", maturity: "defined", score: 72, target: 85, failures: 5, lastTest: "2026-03-27" },
      { id: "intivi-ct-18", name: "Cloud Security Posture Management", type: "detective", maturity: "repeatable", score: 69, target: 82, failures: 8, lastTest: "2026-03-24" },
      { id: "intivi-ct-19", name: "Container Security Scanning", type: "preventive", maturity: "defined", score: 75, target: 85, failures: 5, lastTest: "2026-04-04" },
      { id: "intivi-ct-20", name: "API Security Gateway", type: "preventive", maturity: "repeatable", score: 70, target: 82, failures: 7, lastTest: "2026-03-29" },
      { id: "intivi-ct-21", name: "Threat Intelligence Platform", type: "detective", maturity: "managed", score: 83, target: 90, failures: 2, lastTest: "2026-04-07" },
      { id: "intivi-ct-22", name: "Database Activity Monitoring", type: "detective", maturity: "defined", score: 67, target: 80, failures: 8, lastTest: "2026-03-21" },
      { id: "intivi-ct-23", name: "Deception Technology", type: "detective", maturity: "initial", score: 55, target: 75, failures: 12, lastTest: "2026-03-16" },
      { id: "intivi-ct-24", name: "Security Orchestration Automation", type: "corrective", maturity: "repeatable", score: 73, target: 85, failures: 6, lastTest: "2026-04-01" },
      { id: "intivi-ct-25", name: "Third-Party Risk Assessment", type: "preventive", maturity: "defined", score: 64, target: 78, failures: 9, lastTest: "2026-03-19" },
    ];
    this._intiviControls = controls;
  }

  private _analyzeIntiviControlEffectiveness(): void {
    const typeBreakdown: Record<string, { total: number; avgScore: number; avgFailures: number }> = {};
    this._intiviControls.forEach(c => {
    ...
    this._intiviControlTypeBreakdown = typeBreakdown;
  }

  private _intiviControlOptimization(): Record<string, unknown>[] {
    return this._intiviControls.filter(c => c.score < c.target).map(c => ({
  ...
  // --- Security Data Pipeline Health (INTIVI) ---
  private _initIntiviPipelines(): void {
    const pipelines = [
      { id: "intivi-pl-01", name: "SIEM Log Ingestion", status: "healthy", healthScore: 94, latencyMs: 120, freshnessMin: 2, errorRate: 0.02, throughputMbps: 450, recordsPerSec: 12000, backPressure: 0.05, uptime: 99.97 },
      { id: "intivi-pl-02", name: "Threat Feed Aggregation", status: "healthy", healthScore: 91, latencyMs: 300, freshnessMin: 15, errorRate: 0.05, throughputMbps: 85, recordsPerSec: 3200, backPressure: 0.08, uptime: 99.92 },
      { id: "intivi-pl-03", name: "Vulnerability Scan Results", status: "degraded", healthScore: 72, latencyMs: 2500, freshnessMin: 60, errorRate: 0.15, throughputMbps: 25, recordsPerSec: 800, backPressure: 0.35, uptime: 98.50 },
      { id: "intivi-pl-04", name: "Endpoint Telemetry Stream", status: "healthy", healthScore: 88, latencyMs: 450, freshnessMin: 5, errorRate: 0.08, throughputMbps: 280, recordsPerSec: 8500, backPressure: 0.12, uptime: 99.85 },
      { id: "intivi-pl-05", name: "Cloud Audit Log Pipeline", status: "healthy", healthScore: 86, latencyMs: 600, freshnessMin: 10, errorRate: 0.06, throughputMbps: 150, recordsPerSec: 4500, backPressure: 0.10, uptime: 99.80 },
      { id: "intivi-pl-06", name: "Identity Event Stream", status: "warning", healthScore: 78, latencyMs: 1200, freshnessMin: 20, errorRate: 0.12, throughputMbps: 45, recordsPerSec: 1500, backPressure: 0.22, uptime: 99.40 },
      { id: "intivi-pl-07", name: "Network Flow Collection", status: "healthy", healthScore: 82, latencyMs: 800, freshnessMin: 8, errorRate: 0.09, throughputMbps: 650, recordsPerSec: 18000, backPressure: 0.15, uptime: 99.70 },
      { id: "intivi-pl-08", name: "DLP Incident Pipeline", status: "degraded", healthScore: 68, latencyMs: 3500, freshnessMin: 45, errorRate: 0.20, throughputMbps: 18, recordsPerSec: 500, backPressure: 0.42, uptime: 97.80 },
    ];
    this._intiviPipelines = pipelines.map(p => ({ ...p, dependencies: [], slaBreached: p.healthScore < 75, alertThreshold: p.errorRate > 0.15 }));
    this._intiviPipelines[0].dependencies = ["intivi-pl-04", "intivi-pl-07"];
    this._intiviPipelines[4].dependencies = ["intivi-pl-01"];
    this._intiviPipelines[5].dependencies = ["intivi-pl-02"];
    this._intiviPipelines[7].dependencies = ["intivi-pl-04", "intivi-pl-05"];
  }

  private _intiviPipelineTrend(): Record<string, unknown>[] {
    const hours = Array.from({ length: 24 }, (_, i) => `H${String(i).padStart(2, "0")}`);
    return this._intiviPipelines.map(p => ({
  ...
  // --- Security Stakeholder Report Generator (INTIVI) ---
  private _initIntiviReportTemplates(): void {
    this._intiviReportTemplates = [
      { id: "intivi-rp-01", name: "Board Security Report", audience: "board", frequency: "quarterly", sections: 6, autoGenerate: true, lastGenerated: "2026-03-31", pages: 12 },
      { id: "intivi-rp-02", name: "Executive Risk Summary", audience: "executive", frequency: "monthly", sections: 8, autoGenerate: true, lastGenerated: "2026-04-01", pages: 8 },
      { id: "intivi-rp-03", name: "Technical Security Review", audience: "technical", frequency: "weekly", sections: 12, autoGenerate: true, lastGenerated: "2026-04-21", pages: 25 },
      { id: "intivi-rp-04", name: "Audit Compliance Report", audience: "audit", frequency: "quarterly", sections: 10, autoGenerate: false, lastGenerated: "2026-03-15", pages: 35 },
      { id: "intivi-rp-05", name: "Regulatory Filing Package", audience: "regulatory", frequency: "annual", sections: 15, autoGenerate: false, lastGenerated: "2025-12-31", pages: 48 },
    ];
  }

  private _generateIntiviExecSummary(): string {
    const totalRisk = this._intiviScenarios.reduce((sum: number, s: any) => sum + s.riskScore, 0);
    const avgControl = Math.round(this._intiviControls.reduce((sum: number, c: any) => sum + c.score, 0) / this._intiviControls.length);
    const degradedPipes = this._intiviPipelines.filter((p: any) => p.status !== "healthy").length;
    return `Overall risk exposure: ${(totalRisk / 1000000).toFixed(1)}M. Average control effectiveness: {avgControl}%. {degradedPipes} pipeline(s) need attention. {this._intiviScenarios.filter((s: any) => s.mitigationPriority === "immediate").length} scenarios require immediate action.`;
  }

  // --- Security Technology Radar (INTIVI) ---
  private _initIntiviTechRadar(): void {
    this._intiviTechRadar = [
      { id: "intivi-tr-01", name: "AI-Powered Threat Detection", ring: "adopt", category: "Detection", maturity: 4, trend: "up", investment: "high", roi: 3.2, vendorCount: 8 },
      { id: "intivi-tr-02", name: "Zero Trust Architecture", ring: "adopt", category: "Architecture", maturity: 4, trend: "up", investment: "high", roi: 2.8, vendorCount: 12 },
      { id: "intivi-tr-03", name: "SASE/SSE Platform", ring: "trial", category: "Network", maturity: 3, trend: "up", investment: "medium", roi: 2.4, vendorCount: 10 },
      { id: "intivi-tr-04", name: "CNAPP Cloud Security", ring: "trial", category: "Cloud", maturity: 3, trend: "up", investment: "medium", roi: 2.1, vendorCount: 7 },
      { id: "intivi-tr-05", name: "Extended Detection and Response", ring: "adopt", category: "Detection", maturity: 4, trend: "stable", investment: "high", roi: 2.9, vendorCount: 9 },
      { id: "intivi-tr-06", name: "Quantum-Safe Cryptography", ring: "assess", category: "Crypto", maturity: 2, trend: "up", investment: "low", roi: 0.8, vendorCount: 4 },
      { id: "intivi-tr-07", name: "Security Service Edge", ring: "trial", category: "Network", maturity: 3, trend: "up", investment: "medium", roi: 2.0, vendorCount: 6 },
      { id: "intivi-tr-08", name: "SOAR 2.0 Autonomous SOC", ring: "assess", category: "Operations", maturity: 2, trend: "up", investment: "low", roi: 1.2, vendorCount: 5 },
      { id: "intivi-tr-09", name: "Software Supply Chain Security", ring: "trial", category: "DevSecOps", maturity: 3, trend: "up", investment: "medium", roi: 2.3, vendorCount: 8 },
      { id: "intivi-tr-10", name: "Identity Threat Detection", ring: "adopt", category: "Identity", maturity: 3, trend: "up", investment: "high", roi: 2.7, vendorCount: 7 },
      { id: "intivi-tr-11", name: "Data Security Posture Management", ring: "trial", category: "Data", maturity: 3, trend: "up", investment: "medium", roi: 2.2, vendorCount: 9 },
      { id: "intivi-tr-12", name: "Decentralized Identity Standards", ring: "hold", category: "Identity", maturity: 1, trend: "stable", investment: "low", roi: 0.5, vendorCount: 3 },
    ];
  }

  private _intiviRadarSummary(): Record<string, unknown> {
    const rings: Record<string, number> = { adopt: 0, trial: 0, assess: 0, hold: 0 };
    this._intiviTechRadar.forEach(t => { if (rings[t.ring as keyof typeof rings] !== undefined) rings[t.ring as keyof typeof rings]++; });
    return { adopt: rings.adopt, trial: rings.trial, assess: rings.assess, hold: rings.hold, total: this._intiviTechRadar.length, avgMaturity: 2.8, topInvestment: this._intiviTechRadar.filter(t => t.investment === "high").map(t => t.name) };
  }

  // --- INTIVI Security Compliance Mapping Matrix ---
  private _initIntiviComplianceMatrix(): void {
    ...
    this._intiviComplianceMatrix = frameworks.map(fw => ({
  ...
  private _intiviComplianceTrend(): Record<string, unknown>[] {
    const quarters = ["Q1-2025", "Q2-2025", "Q3-2025", "Q4-2025", "Q1-2026", "Q2-2026"];
    return this._intiviComplianceMatrix.map(fw => ({
  ...
  // --- INTIVI Threat Intelligence Correlation Engine ---
  private _initIntiviThreatIntel(): void {
    ...
    this._intiviThreatIntel = threatActors.map((actor, i) => ({
  ...
  private _intiviThreatCorrelation(): Record<string, unknown>[] {
    return this._intiviThreatIntel.filter(t => t.riskScore > 70).map(t => ({
  ...
  // --- INTIVI Security Metrics Deep Dive ---
  private _initIntiviMetricsDeep(): void {
    ...
    this._intiviMetricsDeep = metricCategories.map(cat => ({
  ...
  private _intiviMetricsHeatmap(): number[][] {
    return this._intiviMetricsDeep.map(cat =>
      cat.metrics.map(m => Math.round((m.value / m.target) * 100))
    );
  }

  // --- INTIVI Incident Cost Modeling ---
  private _initIntiviCostModel(): void {
    const incidentTypes = ["Data Breach", "Ransomware", "DDoS", "Insider Threat", "Phishing", "Supply Chain", "Cloud Misconfig", "Zero-Day"];
    this._intiviCostModel = incidentTypes.map(inc => ({
    ...
    this._intiviCostModel.forEach(m => { m.totalAnnualExposure = m.avgCost * m.frequency; });
  }

  private _intiviCostProjection(): Record<string, unknown>[] {
    return this._intiviCostModel.map(m => ({
  ...
  // --- INTIVI Security Architecture Pattern Library ---
  private _initIntiviArchPatterns(): void {
    ...
    this._intiviArchPatterns = patterns.map((p, i) => ({
  ...
  private _intiviArchPatternAnalysis(): Record<string, unknown> {
    const implemented = this._intiviArchPatterns.filter(p => p.implementation > 75).length;
    const avgCoverage = Math.round(this._intiviArchPatterns.reduce((s: number, p: any) => s + p.coverage, 0) / this._intiviArchPatterns.length);
    return {
      totalPatterns: this._intiviArchPatterns.length, fullyImplemented: implemented, avgCoverage,
      avgRiskReduction: Math.round(this._intiviArchPatterns.reduce((s: number, p: any) => s + p.riskReduction, 0) / this._intiviArchPatterns.length),
      gaps: this._intiviArchPatterns.filter(p => p.implementation < 60).map(p => p.pattern),
      recommendations: this._intiviArchPatterns.filter(p => p.implementation < 70).map(p => ({ pattern: p.pattern, current: p.implementation, target: 85, effort: p.costComplexity }))
    };
  }
  ...
  private _0b2RiskAssessmentWorkflow = [
  ...
  private _0b2TreatmentOptions = [
    {id: '0b2-T-001', riskId: 'RSK-042', risk: 'Ransomware Attack on Critical Infrastructure', before: 20, after: 6, strategy: 'Mitigate', controls: ['Next-gen EDR with behavioral detection and automated response', 'Zero-trust network micro-segmentation isolating critical assets', 'Immutable offline backup rotation with quarterly recovery testing', 'Incident response retainer with 1-hour response SLA'], cost: '$450K/yr', roi: '78% reduction vs $2.8M potential loss', timeline: 'Q3 2026', status: 'approved' as const},
  ...
  private _0b2TalentPositions = [
    ...
    {id: '0b2-H-002', title: 'Cloud Security Engineer', dept: 'Cloud Security', level: 'Mid-Senior', loc: 'SF/Remote', salary: '$155K-$180K', posted: '2026-03-20', applicants: 45, pipeline: 12, interviews: 6, offers: 2, urgency: 'high' as const, manager: 'Mike Johnson', skills: ['AWS/Azure/GCP', 'Terraform', 'Kubernetes', 'IAM', 'CSPM'], nice: ['CCSP', 'CKS', 'Serverless']},
    {id: '0b2-H-003', title: 'SOC Analyst L2', dept: 'Security Operations', level: 'Mid', loc: 'Austin TX', salary: '$105K-$130K', posted: '2026-04-01', applicants: 67, pipeline: 18, interviews: 8, offers: 0, urgency: 'medium' as const, manager: 'Lisa Park', skills: ['SIEM', 'Incident triage', 'Malware analysis', 'TCP/IP'], nice: ['GCIA', 'SOAR', 'Kill chain']},
    {id: '0b2-H-004', title: 'Staff Security Architect', dept: 'Architecture', level: 'Staff', loc: 'Remote US', salary: '$200K-$240K', posted: '2026-02-28', applicants: 12, pipeline: 3, interviews: 2, offers: 0, urgency: 'critical' as const, manager: 'David Lee', skills: ['Enterprise arch', 'Zero trust', 'Risk frameworks', 'Board comms'], nice: ['CISSP+SABSA', 'Team building', 'Speaker']},
    {id: '0b2-H-005', title: 'GRC Analyst', dept: 'GRC', level: 'Mid', loc: 'NY/Remote', salary: '$110K-$135K', posted: '2026-04-05', applicants: 34, pipeline: 9, interviews: 3, offers: 1, urgency: 'medium' as const, manager: 'Rachel Green', skills: ['ISO 27001', 'SOC 2', 'Risk assessment', 'Audit'], nice: ['CRISC', 'CISA', 'GDPR']},
    {id: '0b2-H-006', title: 'Threat Intel Analyst', dept: 'Threat Intel', level: 'Mid-Senior', loc: 'Remote US', salary: '$140K-$170K', posted: '2026-03-25', applicants: 19, pipeline: 5, interviews: 2, offers: 0, urgency: 'low' as const, manager: 'James Wilson', skills: ['MITRE ATT&CK', 'OSINT', 'Threat modeling', 'Reverse eng'], nice: ['CTIA', 'Nation-state', 'Dark web']},
    {id: '0b2-H-007', title: 'AppSec Engineer', dept: 'AppSec', level: 'Senior', loc: 'Seattle/Remote', salary: '$160K-$190K', posted: '2026-04-10', applicants: 28, pipeline: 7, interviews: 3, offers: 0, urgency: 'medium' as const, manager: 'Emily Zhang', skills: ['SAST/DAST/SCA', 'Secure SDLC', 'Code review', 'CI/CD'], nice: ['CSSLP', 'Mobile security']},
    {id: '0b2-H-008', title: 'IAM Engineer', dept: 'IAM', level: 'Mid', loc: 'Remote US', salary: '$135K-$160K', posted: '2026-04-08', applicants: 31, pipeline: 10, interviews: 5, offers: 1, urgency: 'medium' as const, manager: 'Chris Martinez', skills: ['Okta/Azure AD', 'SAML/OIDC', 'PAM', 'RBAC'], nice: ['CISSP', 'Zero trust IAM']}
  ];

  private _0b2InterviewScorecard = [
  ...
  private _0b2OnboardingSteps = [
    {id: '0b2-OB-01', item: 'Provision security-hardened laptop, monitors, peripherals, and configured workstation image with all required security tools', cat: 'IT Setup', day: 'Day 1', owner: 'IT Operations'},
    {id: '0b2-OB-02', item: 'Create AD account, email, Slack, VPN, SSO enrollment, and all required application access accounts', cat: 'Access', day: 'Day 1', owner: 'IAM Team'},
    {id: '0b2-OB-03', item: 'Grant security tooling access: SIEM console, EDR dashboard, vuln scanner, pentest platforms, SOAR', cat: 'Tools', day: 'Day 1-2', owner: 'SOC Manager'},
    {id: '0b2-OB-04', item: 'Complete MFA enrollment, security awareness onboarding course, and acceptable use policy acknowledgment', cat: 'Security', day: 'Day 1', owner: 'Awareness Team'},
    {id: '0b2-OB-05', item: 'Sign NDA, employment agreement, IP assignment, and code of conduct documents with HR', cat: 'HR', day: 'Day 1', owner: 'Human Resources'},
    {id: '0b2-OB-06', item: 'Introduction meetings with direct team members and key cross-functional stakeholders', cat: 'Integration', day: 'Week 1', owner: 'Hiring Manager'},
    {id: '0b2-OB-07', item: 'Security architecture overview, tooling walkthrough, and operational runbook review sessions', cat: 'Training', day: 'Week 1-2', owner: 'Security Architect'},
    {id: '0b2-OB-08', item: 'Shadow experienced team member on active incident response and threat hunting investigations', cat: 'Mentoring', day: 'Week 2-3', owner: 'SOC Lead'},
    {id: '0b2-OB-09', item: 'Set up individual certification study plan aligned with role requirements and career goals', cat: 'Development', day: 'Week 2', owner: 'Hiring Manager'},
    {id: '0b2-OB-10', item: 'Establish 30-60-90 day goals, define success metrics, and schedule first performance checkpoint', cat: 'Goals', day: 'Week 1', owner: 'Hiring Manager'}
  ];

  private _0b2MetricsDashboard = [
    {id: '0b2-MTD-001', name: 'Mean Time to Detect (MTTD)', value: '4.2 hours', trend: 'improving' as const, target: '< 4 hours', source: 'SIEM - Splunk', method: 'Median time from first alert to analyst acknowledgment', owner: 'SOC Manager', sla: '4 hours', prev: '5.1 hours', spark: [5.8, 5.4, 5.1, 4.9, 4.7, 4.5, 4.3, 4.2], breakdown: [{src: 'Network IDS', pct: '35%', avg: '3.8h'}, {src: 'Endpoint EDR', pct: '28%', avg: '4.1h'}, {src: 'Email Gateway', pct: '22%', avg: '3.5h'}, {src: 'Cloud Security', pct: '10%', avg: '5.2h'}, {src: 'User Reports', pct: '5%', avg: '6.8h'}]},
    {id: '0b2-MTD-002', name: 'Mean Time to Respond (MTTR)', value: '2.8 hours', trend: 'stable' as const, target: '< 3 hours', source: 'SOAR - XSOAR', method: 'Median time from acknowledgment to first containment action', owner: 'IR Lead', sla: '3 hours', prev: '2.7 hours', spark: [3.2, 3.0, 2.9, 2.8, 2.8, 2.9, 2.8, 2.8], breakdown: [{src: 'Auto Playbooks', pct: '42%', avg: '1.2h'}, {src: 'Semi-Auto', pct: '33%', avg: '2.5h'}, {src: 'Manual', pct: '20%', avg: '5.1h'}, {src: 'L3 Escalation', pct: '5%', avg: '8.3h'}]},
    {id: '0b2-MTD-003', name: 'Patch Compliance Rate', value: '97.6%', trend: 'improving' as const, target: '> 95%', source: 'Tenable.io', method: 'Pct of critical/high vulns patched within SLA windows', owner: 'Vuln Manager', sla: '95%', prev: '96.1%', spark: [93.2, 94.1, 94.8, 95.3, 95.9, 96.4, 97.0, 97.6], breakdown: [{src: 'Critical (7d)', pct: '40%', rate: '99.2%'}, {src: 'High (30d)', pct: '35%', rate: '97.8%'}, {src: 'Medium (90d)', pct: '20%', rate: '95.1%'}, {src: 'Low (180d)', pct: '5%', rate: '89.4%'}]},
    {id: '0b2-MTD-004', name: 'Phishing Click Rate', value: '3.2%', trend: 'improving' as const, target: '< 5%', source: 'KnowBe4 + Proofpoint', method: 'Pct of users clicking simulated phishing links monthly', owner: 'Awareness Lead', sla: '5%', prev: '4.1%', spark: [6.8, 6.2, 5.5, 5.1, 4.6, 4.1, 3.6, 3.2], breakdown: [{src: 'Spear Phishing', pct: '35%', rate: '5.1%'}, {src: 'Generic Phishing', pct: '30%', rate: '2.8%'}, {src: 'BEC Sim', pct: '20%', rate: '3.5%'}, {src: 'SMS Phishing', pct: '15%', rate: '1.9%'}]},
    {id: '0b2-MTD-005', name: 'Security Posture Score', value: '784', trend: 'improving' as const, target: '> 750', source: 'SecurityScorecard', method: 'Composite: external 30%, compliance 25%, vuln 25%, config 20%', owner: 'CISO', sla: '> 750', prev: '771', spark: [748, 752, 758, 762, 768, 773, 778, 784], breakdown: [{src: 'External Rating', pct: '30%', score: '791'}, {src: 'Compliance', pct: '25%', score: '812'}, {src: 'Vuln Mgmt', pct: '25%', score: '745'}, {src: 'Config', pct: '20%', score: '769'}]},
    {id: '0b2-MTD-006', name: 'Vulnerability Backlog', value: '142', trend: 'improving' as const, target: '< 150', source: 'Tenable + Qualys', method: 'Total open vulns across all scanned assets tracked weekly', owner: 'Vuln Manager', sla: '< 150', prev: '168', spark: [210, 198, 185, 175, 165, 158, 150, 142], breakdown: [{src: 'Critical', pct: '8%', count: '11'}, {src: 'High', pct: '22%', count: '31'}, {src: 'Medium', pct: '45%', count: '64'}, {src: 'Low', pct: '25%', count: '36'}]}
  ];

  private _0b2ArchReview = [
    {id: '0b2-AR-001', cat: 'Network', item: 'Network segmentation between trust zones with dedicated firewalls and granular ACLs', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Micro-segmentation via NSX across all production zones'},
    {id: '0b2-AR-002', cat: 'Network', item: 'DMZ architecture isolating public services from internal network', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Dual-firewall DMZ with WAF and DDoS mitigation'},
    {id: '0b2-AR-003', cat: 'Network', item: 'Least-privilege traffic flows with deny-by-default and quarterly review', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Explicit allow rules with automated drift detection'},
    {id: '0b2-AR-004', cat: 'Network', item: 'Encrypted external communications with IPSec/TLS 1.3 and PFS', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'IKEv2 with PFS, TLS 1.3 for all external APIs'},
    {id: '0b2-AR-005', cat: 'Identity', item: 'Centralized IdP with SSO and automated SCIM provisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Okta SSO SAML 2.0 for 247 apps with SCIM'},
    {id: '0b2-AR-006', cat: 'Identity', item: 'RBAC with quarterly reviews and automated deprovisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Quarterly recertification with JIT admin access'},
    {id: '0b2-AR-007', cat: 'Identity', item: 'PAM controlling all admin and service accounts with session recording', sev: 'high' as const, status: 'fail' as const, reviewer: 'IAM Lead', notes: '3 legacy accounts pending CyberArk enrollment'},
    {id: '0b2-AR-008', cat: 'Identity', item: 'MFA enforced for all users, hardware tokens for privileged access', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'FIDO2 for admins, push MFA for users, 99.8% enrollment'},
    {id: '0b2-AR-009', cat: 'Data', item: 'Data classification enforced with automated labeling on all repos', sev: 'high' as const, status: 'partial' as const, reviewer: 'Data Protection Lead', notes: 'Framework deployed, gaps on 4 legacy file shares'},
    {id: '0b2-AR-010', cat: 'Data', item: 'AES-256 encryption at rest for all sensitive data stores', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'Full-disk, TDE on DBs, SSE-KMS on cloud storage'},
    {id: '0b2-AR-011', cat: 'Data', item: 'DLP monitoring and preventing unauthorized data exfiltration', sev: 'high' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'DLP active on email, endpoint, cloud, and network'},
    {id: '0b2-AR-012', cat: 'Data', item: 'Encrypted off-site backups with quarterly restore testing', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Infrastructure Lead', notes: '3-2-1 strategy with immutable backups'},
    {id: '0b2-AR-013', cat: 'AppSec', item: 'Secure SDLC with SAST, DAST, SCA in all CI/CD pipelines', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: '34 pipelines with security gates and PR blocking'},
    {id: '0b2-AR-014', cat: 'AppSec', item: 'API gateway with auth, rate limiting, schema validation', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: 'Kong with OAuth2, rate limits, OpenAPI validation'},
    {id: '0b2-AR-015', cat: 'AppSec', item: 'Container security with image scanning and runtime protection', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Trivy scanning, Falco runtime in 80% of clusters'},
    {id: '0b2-AR-016', cat: 'Monitoring', item: 'SIEM collecting from all critical systems with correlation rules', sev: 'critical' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'Splunk 98% coverage with 1200+ correlation rules'},
    {id: '0b2-AR-017', cat: 'Monitoring', item: 'EDR with behavioral detection on all managed endpoints', sev: 'high' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'CrowdStrike on 99.2% endpoints with 24/7 MDR'},
    {id: '0b2-AR-018', cat: 'Monitoring', item: 'Executive dashboards with real-time posture visibility', sev: 'medium' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'PowerBI dashboards with weekly exec summaries'},
    {id: '0b2-AR-019', cat: 'Cloud', item: 'CSPM monitoring and remediating cloud misconfigurations', sev: 'high' as const, status: 'pass' as const, reviewer: 'Cloud Security Lead', notes: 'Prisma Cloud 450+ checks with auto-remediation'},
    {id: '0b2-AR-020', cat: 'Cloud', item: 'IaC templates scanned before deployment to production', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Checkov for Terraform, cfn-nag for CloudFormation pending'}
  ];

  private _get0b2RiskProgress(): number {
    return Math.round(this._0b2RiskAssessmentWorkflow.filter(s => s.status === 'completed').length / this._0b2RiskAssessmentWorkflow.length * 100);
  }

  private _get0b2TreatmentSummary(): {total: number; approved: number; avgReduction: number; investment: string} {
    const a = this._0b2TreatmentOptions.filter(r => r.status === 'approved').length;
    const avg = this._0b2TreatmentOptions.reduce((s, r) => s + ((r.before - r.after) / r.before * 100), 0) / this._0b2TreatmentOptions.length;
    return {total: this._0b2TreatmentOptions.length, approved: a, avgReduction: Math.round(avg), investment: '$1.125M annually'};
  }

  private _get0b2RuleSummary(): {total: number; passing: number; failing: number; avgRate: number; violations: number} {
    const p = this._0b2ComplianceRules.filter(r => r.result === 'pass').length;
    const f = this._0b2ComplianceRules.filter(r => r.result === 'fail').length;
    const avg = this._0b2ComplianceRules.reduce((s, r) => s + r.passRate, 0) / this._0b2ComplianceRules.length;
    const v = this._0b2ComplianceRules.reduce((s, r) => s + r.violations, 0);
    return {total: this._0b2ComplianceRules.length, passing: p, failing: f, avgRate: Math.round(avg * 10) / 10, violations: v};
  }

  private _get0b2PipelineStats(): {positions: number; applicants: number; interviewing: number; offers: number; critical: number} {
    const t = this._0b2TalentPositions.length;
    const a = this._0b2TalentPositions.reduce((s, p) => s + p.applicants, 0);
    const i = this._0b2TalentPositions.reduce((s, p) => s + p.interviews, 0);
    const o = this._0b2TalentPositions.reduce((s, p) => s + p.offers, 0);
    const c = this._0b2TalentPositions.filter(x => x.urgency === 'critical').length;
    return {positions: t, applicants: a, interviewing: i, offers: o, critical: c};
  }

  private _get0b2MetricTrends(): {improving: number; stable: number; total: number} {
    const imp = this._0b2MetricsDashboard.filter(m => m.trend === 'improving').length;
    const stb = this._0b2MetricsDashboard.filter(m => m.trend === 'stable').length;
    return {improving: imp, stable: stb, total: this._0b2MetricsDashboard.length};
  }

  private _get0b2ArchScore(): {total: number; passed: number; failed: number; partial: number; score: number} {
    const p = this._0b2ArchReview.filter(c => c.status === 'pass').length;
    const f = this._0b2ArchReview.filter(c => c.status === 'fail').length;
    const pa = this._0b2ArchReview.filter(c => c.status === 'partial').length;
    return {total: this._0b2ArchReview.length, passed: p, failed: f, partial: pa, score: Math.round((p / this._0b2ArchReview.length) * 100)};
  }


  private _z0b2IncidentScenarios = [
  ...
  private _z0b2SecurityFrameworks = [
  ...
  private _z0b2SecurityToolInventory = [
    ...
    {id: 'z0b2-TL-005', name: 'KnowBe4 Platform', category: 'Security Awareness', version: 'Current', license: 'Enterprise', annualCost: '$85K', users: 3200, coverage: 'All employees', integrations: ['Okta SCIM', 'Slack', 'HRIS system'], health: 'healthy' as const, lastMaintenance: '2026-04-05', nextMaintenance: '2026-07-05', owner: 'Awareness Lead'},
  ...
  private _getz0b2ScenarioSummary(): {total: number; critical: number; high: number; drilled: number; avgRiskScore: number} {
    const crit = this._z0b2IncidentScenarios.filter(s => s.impact === 'Critical').length;
    const high = this._z0b2IncidentScenarios.filter(s => s.impact === 'High').length;
    const avg = this._z0b2IncidentScenarios.reduce((s, x) => s + x.riskScore, 0) / this._z0b2IncidentScenarios.length;
    return {total: this._z0b2IncidentScenarios.length, critical: crit, high: high, drilled: this._z0b2IncidentScenarios.length, avgRiskScore: Math.round(avg)};
  }

  private _getz0b2VendorRiskSummary(): {total: number; approved: number; conditional: number; remediation: number; avgScore: number} {
    const approved = this._z0b2ThirdPartyRiskData.filter(v => v.status === 'approved').length;
    const cond = this._z0b2ThirdPartyRiskData.filter(v => v.status === 'conditional').length;
    const rem = this._z0b2ThirdPartyRiskData.filter(v => v.status === 'remediation_required').length;
    const avg = this._z0b2ThirdPartyRiskData.reduce((s, v) => s + v.riskScore, 0) / this._z0b2ThirdPartyRiskData.length;
    return {total: this._z0b2ThirdPartyRiskData.length, approved, conditional: cond, remediation: rem, avgScore: Math.round(avg)};
  }

  private _getz0b2TrainingSummary(): {total: number; avgCompletion: number; avgScore: number; overdueUpdates: number} {
    const avgComp = this._z0b2SecurityTrainingCatalog.reduce((s, t) => s + t.completionRate, 0) / this._z0b2SecurityTrainingCatalog.length;
    const avgScore = this._z0b2SecurityTrainingCatalog.filter(t => t.avgScore > 0).reduce((s, t) => s + t.avgScore, 0) / this._z0b2SecurityTrainingCatalog.filter(t => t.avgScore > 0).length;
    return {total: this._z0b2SecurityTrainingCatalog.length, avgCompletion: Math.round(avgComp * 10) / 10, avgScore: Math.round(avgScore), overdueUpdates: 0};
  }

  private _getz0b2ToolHealthSummary(): {total: number; healthy: number; degraded: number; annualCost: string} {
    const healthy = this._z0b2SecurityToolInventory.filter(t => t.health === 'healthy').length;
    const degraded = this._z0b2SecurityToolInventory.filter(t => t.health === 'degraded').length;
    const cost = this._z0b2SecurityToolInventory.reduce((s, t) => s + parseInt(t.annualCost.replace(/[^0-9]/g, '')), 0);
    return {total: this._z0b2SecurityToolInventory.length, healthy, degraded, annualCost: '$' + (cost / 1000).toFixed(0) + 'K'};
  }


  private _x0b2SecurityZones = [
    {zoneId: 'x0b2-Z-001', name: 'Internet DMZ', trustLevel: 'Untrusted', subnet: '10.0.0.0/24', segmentation: 'Dual-firewall', firewallRules: 45, monitoring: 'Full packet capture', assets: ['Web servers', 'Load balancers', 'WAF appliances', 'Reverse proxy'], riskLevel: 'high' as const, lastAssessment: '2026-04-15', nextAssessment: '2026-07-15'},
    {zoneId: 'x0b2-Z-002', name: 'Corporate Network', trustLevel: 'Trusted', subnet: '10.1.0.0/16', segmentation: 'VLAN + micro-seg', firewallRules: 128, monitoring: 'NetFlow + IDS', assets: ['Workstations', 'Printers', 'Meeting room systems', 'VoIP phones'], riskLevel: 'medium' as const, lastAssessment: '2026-04-10', nextAssessment: '2026-07-10'},
    {zoneId: 'x0b2-Z-003', name: 'Production Data Center', trustLevel: 'Restricted', subnet: '10.2.0.0/16', segmentation: 'Full micro-segmentation', firewallRules: 256, monitoring: 'Full packet capture + EDR', assets: ['Application servers', 'Database clusters', 'Message queues', 'API gateways'], riskLevel: 'low' as const, lastAssessment: '2026-04-12', nextAssessment: '2026-07-12'},
    {zoneId: 'x0b2-Z-004', name: 'Management Network', trustLevel: 'Restricted', subnet: '10.3.0.0/24', segmentation: 'Isolated VLAN', firewallRules: 32, monitoring: 'Syslog + SNMP', assets: ['Hypervisors', 'Switch management', 'Storage controllers', 'Backup appliances'], riskLevel: 'low' as const, lastAssessment: '2026-04-08', nextAssessment: '2026-07-08'},
    {zoneId: 'x0b2-Z-005', name: 'Cloud Production', trustLevel: 'Restricted', subnet: 'VPC: 172.16.0.0/12', segmentation: 'Security groups + NACLs', firewallRules: 189, monitoring: 'VPC Flow Logs + GuardDuty', assets: ['Kubernetes clusters', 'Managed databases', 'Object storage', 'Serverless functions'], riskLevel: 'medium' as const, lastAssessment: '2026-04-18', nextAssessment: '2026-07-18'}
  ];

  private _x0b2SecurityAlerts = [
    {id: 'x0b2-AL-001', severity: 'critical', title: 'Active ransomware encryption detected on PROD-DB-01', source: 'CrowdStrike', timestamp: '2026-04-22T13:45:00Z', status: 'investigating', assignee: 'SOC Analyst J. Smith', asset: 'PROD-DB-01 (10.2.1.15)', mitreTechnique: 'T1486 - Data Encrypted for Impact', playbook: 'IR-Ransomware-Isolate', sla: '15 minutes', elapsed: '12 minutes', notes: 'EDR detected mass file encryption event pattern. Automated isolation triggered. IR team paged.'},
    {id: 'x0b2-AL-002', severity: 'high', title: 'Impossible travel detected for user admin@company.com', source: 'Okta', timestamp: '2026-04-22T12:30:00Z', status: 'triaged', assignee: 'SOC Analyst M. Johnson', asset: 'Okta - admin@company.com', mitreTechnique: 'T1078 - Valid Accounts', playbook: 'IR-ImpossibleTravel', sla: '30 minutes', elapsed: '87 minutes', notes: 'Login from Tokyo followed by login from New York within 30 minutes. Account temporarily locked. User confirmed via out-of-band channel they are in New York.'},
    {id: 'x0b2-AL-003', severity: 'high', title: 'Public S3 bucket discovered with customer PII exposure', source: 'Prisma Cloud', timestamp: '2026-04-22T11:15:00Z', status: 'remediating', assignee: 'Cloud Security Lead A. Chen', asset: 'AWS S3: customer-data-archive-2024', mitreTechnique: 'N/A - Misconfiguration', playbook: 'IR-Cloud-Misconfig-Remediate', sla: '1 hour', elapsed: '2.5 hours', notes: 'Bucket containing archived customer records was publicly accessible. Bucket blocked and encrypted. Data exposure assessment in progress.'},
    {id: 'x0b2-AL-004', severity: 'medium', title: 'Anomalous data download by user jane.developer@company.com', source: 'Microsoft DLP', timestamp: '2026-04-22T10:00:00Z', status: 'investigating', assignee: 'SOC Analyst R. Davis', asset: 'Endpoint: WS-DEV-042', mitreTechnique: 'T1567 - Exfil Over Web Service', playbook: 'IR-DLP-Investigation', sla: '4 hours', elapsed: '3.5 hours', notes: 'User downloaded 4.2GB of source code files to personal Google Drive. Interview scheduled with user and manager.'},
    {id: 'x0b2-AL-005', severity: 'medium', title: 'Credential stuffing attack detected on customer portal', source: 'Cloudflare WAF', timestamp: '2026-04-22T09:30:00Z', status: 'contained', assignee: 'SOC Analyst K. Wilson', asset: 'Customer Portal (portal.company.com)', mitreTechnique: 'T1110 - Brute Force', playbook: 'IR-CredentialStuffing-Block', sla: '2 hours', elapsed: '4 hours', notes: 'Rate limiting and CAPTCHA automatically deployed. 12,000 failed login attempts from 800 unique IPs blocked. No successful account takeovers confirmed.'},
    {id: 'x0b2-AL-006', severity: 'low', title: 'SSL certificate expiring in 14 days for api.company.com', source: 'Certificate monitoring', timestamp: '2026-04-22T08:00:00Z', status: 'remediated', assignee: 'Infrastructure Lead T. Brown', asset: 'api.company.com', mitreTechnique: 'N/A', playbook: 'Certificate Renewal', sla: '30 days', elapsed: '16 days', notes: 'Automated renewal triggered via ACME. New certificate deployed successfully. No service interruption.'}
  ];

  private _x0b2ComplianceFrameworks = [
  ...
  private _x0b2DataClassificationPolicy = [
  ...
  private _getx0b2ZoneSummary(): {total: number; highRisk: number; mediumRisk: number; lowRisk: number; totalRules: number} {
    const high = this._x0b2SecurityZones.filter(z => z.riskLevel === 'high').length;
    const med = this._x0b2SecurityZones.filter(z => z.riskLevel === 'medium').length;
    const low = this._x0b2SecurityZones.filter(z => z.riskLevel === 'low').length;
    const rules = this._x0b2SecurityZones.reduce((s, z) => s + z.firewallRules, 0);
    return {total: this._x0b2SecurityZones.length, highRisk: high, mediumRisk: med, lowRisk: low, totalRules: rules};
  }

  private _getx0b2AlertSummary(): {total: number; critical: number; high: number; medium: number; low: number; open: number; contained: number} {
    const crit = this._x0b2SecurityAlerts.filter(a => a.severity === 'critical').length;
    const high = this._x0b2SecurityAlerts.filter(a => a.severity === 'high').length;
    const med = this._x0b2SecurityAlerts.filter(a => a.severity === 'medium').length;
    const low = this._x0b2SecurityAlerts.filter(a => a.severity === 'low').length;
    const open = this._x0b2SecurityAlerts.filter(a => a.status === 'investigating' || a.status === 'triaged').length;
    const contained = this._x0b2SecurityAlerts.filter(a => a.status === 'contained' || a.status === 'remediated').length;
    return {total: this._x0b2SecurityAlerts.length, critical: crit, high, medium: med, low, open, contained};
  }

  private _getx0b2ComplianceSummary(): {total: number; fullyCompliant: number; mostlyCompliant: number; avgComplianceRate: number} {
    const full = this._x0b2ComplianceFrameworks.filter(f => f.status === 'compliant').length;
    const mostly = this._x0b2ComplianceFrameworks.filter(f => f.status === 'mostly_compliant').length;
    const avgRate = this._x0b2ComplianceFrameworks.reduce((s, f) => s + (f.compliant / f.requirements * 100), 0) / this._x0b2ComplianceFrameworks.length;
    return {total: this._x0b2ComplianceFrameworks.length, fullyCompliant: full, mostlyCompliant: mostly, avgComplianceRate: Math.round(avgRate * 10) / 10};
  }


  private _w0b2VulnerabilityTrends = [
  ...
  private _w0b2AccessReviewHistory = [
    {reviewId: 'w0b2-AR-001', period: 'Q1 2026', reviewer: 'IAM Team', scope: 'All privileged accounts (350)', completedDate: '2026-03-31', findings: 22, revoked: 18, modified: 4, newExceptions: 0, overdue: false, nextReview: 'Q2 2026', notes: '18 accounts revoked due to role changes, 4 access levels reduced. No new exceptions approved.'},
    {reviewId: 'w0b2-AR-002', period: 'Q4 2025', reviewer: 'IAM Team', scope: 'All privileged accounts (342)', completedDate: '2025-12-31', findings: 28, revoked: 22, modified: 6, newExceptions: 2, overdue: false, nextReview: 'Q1 2026', notes: '22 accounts revoked, 6 modified. 2 new exceptions approved for contractor admin access with 90-day expiry.'},
    {reviewId: 'w0b2-AR-003', period: 'Q3 2025', reviewer: 'IAM Team', scope: 'All privileged accounts (335)', completedDate: '2025-09-30', findings: 25, revoked: 20, modified: 5, newExceptions: 1, overdue: false, nextReview: 'Q4 2025', notes: 'Trend of decreasing findings continues. New exception for emergency break-glass account.'},
    {reviewId: 'w0b2-AR-004', period: 'Q2 2025', reviewer: 'IAM Team', scope: 'All privileged accounts (328)', completedDate: '2025-06-30', findings: 30, revoked: 25, modified: 5, newExceptions: 0, overdue: false, nextReview: 'Q3 2025', notes: '30 findings identified. Process improvement implemented to reduce orphaned account creation.'}
  ];

  private _w0b2SecurityBudgetAllocation = [
  ...
  private _getw0b2PatchSummary(): {total: number; critical: number; completed: number; inProgress: number; waiting: number; avgSLACompliance: number} {
    const crit = this._w0b2PatchDeploymentSchedule.filter(p => p.severity === 'Critical').length;
    const comp = this._w0b2PatchDeploymentSchedule.filter(p => p.status === 'completed').length;
    const inProg = this._w0b2PatchDeploymentSchedule.filter(p => p.status === 'in_progress').length;
    const wait = this._w0b2PatchDeploymentSchedule.filter(p => p.status === 'waiting').length;
    return {total: this._w0b2PatchDeploymentSchedule.length, critical: crit, completed: comp, inProgress: inProg, waiting: wait, avgSLACompliance: 85};
  }

  private _getw0b2BudgetSummary(): {totalBudget: string; totalActual: string; overallUtilization: number; categories: number} {
    return {totalBudget: '$7.3M', totalActual: '$6.31M', overallUtilization: 86.4, categories: this._w0b2SecurityBudgetAllocation.length};
  }
  ...
  private _incident_timRiskRegister = [
    { id: "RSK-INC-0001", title: "Data breach from unpatched systems", owner: "CTO", category: "Financial", status: "mitigating", trend: "stable", severity: "medium", likelihood: 5, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-09", nextReview: "2026-07-24" },
    { id: "RSK-INC-0002", title: "Ransomware attack on critical infrastructure", owner: "CRO", category: "Strategic", status: "closed", trend: "decreasing", severity: "critical", likelihood: 4, impact: 2, treatment: "Monitor and review quarterly", lastReview: "2026-04-20", nextReview: "2026-07-27" },
    { id: "RSK-INC-0003", title: "Insider threat data exfiltration", owner: "VP Eng", category: "Compliance", status: "accepted", trend: "increasing", severity: "low", likelihood: 4, impact: 7, treatment: "Monitor and review quarterly", lastReview: "2026-04-18", nextReview: "2026-07-08" },
    { id: "RSK-INC-0004", title: "Supply chain compromise", owner: "Security Lead", category: "Technical", status: "open", trend: "stable", severity: "critical", likelihood: 8, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-05", nextReview: "2026-07-02" },
    { id: "RSK-INC-0005", title: "Cloud misconfiguration exposure", owner: "Risk Mgr", category: "Reputational", status: "mitigating", trend: "decreasing", severity: "low", likelihood: 6, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-23", nextReview: "2026-07-26" },
    { id: "RSK-INC-0006", title: "Phishing campaign success rate", owner: "Compliance Dir", category: "Legal", status: "closed", trend: "increasing", severity: "low", likelihood: 10, impact: 1, treatment: "Monitor and review quarterly", lastReview: "2026-04-21", nextReview: "2026-07-25" },
    { id: "RSK-INC-0007", title: "Third-party vendor data breach", owner: "IT Dir", category: "Regulatory", status: "accepted", trend: "stable", severity: "critical", likelihood: 6, impact: 1, treatment: "Monitor and review quarterly", lastReview: "2026-04-23", nextReview: "2026-07-21" },
    { id: "RSK-INC-0008", title: "Regulatory non-compliance penalty", owner: "DevOps Lead", category: "Third-Party", status: "open", trend: "decreasing", severity: "low", likelihood: 1, impact: 7, treatment: "Monitor and review quarterly", lastReview: "2026-04-18", nextReview: "2026-07-22" },
    { id: "RSK-INC-0009", title: "Zero-day exploit in production", owner: "Architect", category: "Human Capital", status: "mitigating", trend: "increasing", severity: "low", likelihood: 5, impact: 6, treatment: "Monitor and review quarterly", lastReview: "2026-04-14", nextReview: "2026-07-13" },
    { id: "RSK-INC-0010", title: "Insufficient access controls", owner: "CISO", category: "Operational", status: "closed", trend: "stable", severity: "high", likelihood: 1, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-18", nextReview: "2026-07-13" },
    { id: "RSK-INC-0011", title: "DDoS attack on services", owner: "CTO", category: "Financial", status: "accepted", trend: "decreasing", severity: "low", likelihood: 1, impact: 5, treatment: "Monitor and review quarterly", lastReview: "2026-04-01", nextReview: "2026-07-10" },
    { id: "RSK-INC-0012", title: "Social engineering attack", owner: "CRO", category: "Strategic", status: "open", trend: "increasing", severity: "high", likelihood: 7, impact: 2, treatment: "Monitor and review quarterly", lastReview: "2026-04-11", nextReview: "2026-07-12" },
    { id: "RSK-INC-0013", title: "API security vulnerability", owner: "VP Eng", category: "Compliance", status: "mitigating", trend: "stable", severity: "medium", likelihood: 9, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-06", nextReview: "2026-07-21" },
    { id: "RSK-INC-0014", title: "Mobile device compromise", owner: "Security Lead", category: "Technical", status: "closed", trend: "decreasing", severity: "critical", likelihood: 3, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-11", nextReview: "2026-07-21" },
    { id: "RSK-INC-0015", title: "Physical security breach", owner: "Risk Mgr", category: "Reputational", status: "accepted", trend: "increasing", severity: "critical", likelihood: 4, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-22", nextReview: "2026-07-11" },
    { id: "RSK-INC-0016", title: "Password policy weakness", owner: "Compliance Dir", category: "Legal", status: "open", trend: "stable", severity: "low", likelihood: 3, impact: 5, treatment: "Monitor and review quarterly", lastReview: "2026-04-12", nextReview: "2026-07-08" },
    { id: "RSK-INC-0017", title: "Network segmentation gap", owner: "IT Dir", category: "Regulatory", status: "mitigating", trend: "decreasing", severity: "high", likelihood: 7, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-13", nextReview: "2026-07-11" },
    { id: "RSK-INC-0018", title: "Encryption key management failure", owner: "DevOps Lead", category: "Third-Party", status: "closed", trend: "increasing", severity: "medium", likelihood: 4, impact: 1, treatment: "Monitor and review quarterly", lastReview: "2026-04-02", nextReview: "2026-07-13" },
    { id: "RSK-INC-0019", title: "Audit trail tampering", owner: "Architect", category: "Human Capital", status: "accepted", trend: "stable", severity: "low", likelihood: 8, impact: 7, treatment: "Monitor and review quarterly", lastReview: "2026-04-07", nextReview: "2026-07-17" },
    { id: "RSK-INC-0020", title: "Business email compromise", owner: "CISO", category: "Operational", status: "open", trend: "decreasing", severity: "medium", likelihood: 8, impact: 7, treatment: "Monitor and review quarterly", lastReview: "2026-04-15", nextReview: "2026-07-17" },
  ];
  ...
  private _incident_timApiEndpoints = [
    { method: "GET", path: "/api/v1/threats", name: "Threat Intelligence Feed", status: "active", avgLatency: 269.1, reqPerMin: 1303.0, errorRate: 0.59, uptime: round(98.7944769558837,2), version: "v3.2.18" },
    { method: "POST", path: "/api/v1/scans/start", name: "Vulnerability Scanner", status: "active", avgLatency: 221.0, reqPerMin: 47.0, errorRate: 0.23, uptime: round(97.40770364602838,2), version: "v2.2.5" },
    { method: "GET", path: "/api/v1/assets", name: "Asset Inventory", status: "active", avgLatency: 172.4, reqPerMin: 1825.0, errorRate: 1.37, uptime: round(98.17341449095652,2), version: "v1.6.7" },
    { method: "POST", path: "/api/v1/alerts", name: "Alert Management", status: "active", avgLatency: 334.1, reqPerMin: 2184.0, errorRate: 1.64, uptime: round(99.50985432116944,2), version: "v2.1.16" },
    { method: "GET", path: "/api/v1/compliance", name: "Compliance Status", status: "active", avgLatency: 253.1, reqPerMin: 991.0, errorRate: 0.35, uptime: round(96.2437089086382,2), version: "v1.9.9" },
    { method: "PUT", path: "/api/v1/policies", name: "Policy Engine", status: "active", avgLatency: 338.6, reqPerMin: 239.0, errorRate: 1.88, uptime: round(98.13860390157998,2), version: "v1.3.3" },
    { method: "GET", path: "/api/v1/incidents", name: "Incident Tracker", status: "active", avgLatency: 92.4, reqPerMin: 489.0, errorRate: 0.78, uptime: round(99.08317991907673,2), version: "v2.4.12" },
    { method: "POST", path: "/api/v1/forensics", name: "Forensics Collector", status: "degraded", avgLatency: 139.5, reqPerMin: 1557.0, errorRate: 0.39, uptime: round(97.88472253510157,2), version: "v1.0.15" },
    { method: "GET", path: "/api/v1/risk/assess", name: "Risk Assessment", status: "active", avgLatency: 423.1, reqPerMin: 1473.0, errorRate: 1.81, uptime: round(99.91687985949399,2), version: "v2.3.15" },
    { method: "POST", path: "/api/v1/auth/verify", name: "Authentication", status: "active", avgLatency: 413.5, reqPerMin: 1899.0, errorRate: 1.52, uptime: round(99.32150275365055,2), version: "v3.7.10" },
    { method: "GET", path: "/api/v1/logs/audit", name: "Audit Log Query", status: "active", avgLatency: 213.0, reqPerMin: 632.0, errorRate: 1.72, uptime: round(99.84085295317824,2), version: "v2.0.10" },
    { method: "PUT", path: "/api/v1/users/roles", name: "Role Management", status: "active", avgLatency: 338.6, reqPerMin: 472.0, errorRate: 1.08, uptime: round(98.77847593342027,2), version: "v2.7.7" },
    { method: "POST", path: "/api/v1/encrypt", name: "Encryption Service", status: "active", avgLatency: 172.2, reqPerMin: 1425.0, errorRate: 1.34, uptime: round(96.08805234520726,2), version: "v3.1.11" },
    { method: "GET", path: "/api/v1/network/topo", name: "Network Topology", status: "maintenance", avgLatency: 152.9, reqPerMin: 1732.0, errorRate: 0.37, uptime: round(96.40242717150355,2), version: "v1.1.12" },
    { method: "DELETE", path: "/api/v1/sessions", name: "Session Manager", status: "active", avgLatency: 210.3, reqPerMin: 815.0, errorRate: 1.3, uptime: round(95.56713392987359,2), version: "v3.3.20" },
  ];
  private _incident_timApiKeys = [
    { id: "ak-000001", name: "key-inci-001", created: "2026-01-24", lastUsed: "2026-04-13", status: "active", calls: 26847, rateLimit: 500 },
    { id: "ak-000002", name: "key-inci-002", created: "2026-07-10", lastUsed: "2026-04-06", status: "revoked", calls: 28365, rateLimit: 5000 },
    { id: "ak-000003", name: "key-inci-003", created: "2026-04-03", lastUsed: "2026-04-23", status: "active", calls: 29662, rateLimit: 100 },
    { id: "ak-000004", name: "key-inci-004", created: "2026-03-16", lastUsed: "2026-04-11", status: "active", calls: 25283, rateLimit: 5000 },
    { id: "ak-000005", name: "key-inci-005", created: "2026-09-23", lastUsed: "2026-04-01", status: "active", calls: 32166, rateLimit: 1000 },
    { id: "ak-000006", name: "key-inci-006", created: "2026-06-06", lastUsed: "2026-04-03", status: "active", calls: 15362, rateLimit: 500 },
    { id: "ak-000007", name: "key-inci-007", created: "2026-02-15", lastUsed: "2026-04-07", status: "active", calls: 36036, rateLimit: 1000 },
    { id: "ak-000008", name: "key-inci-008", created: "2026-09-04", lastUsed: "2026-04-14", status: "revoked", calls: 15653, rateLimit: 500 },
  ];
  ...
  private _incident_timTrainingModules = [
    { id: "TRN-001", name: "Security Fundamentals", completionRate: 72.5, avgScore: 62.8, behaviorChange: 85.1, enrolled: 235, completed: 231, duration: "65min", category: "mandatory" },
    { id: "TRN-002", name: "Phishing Awareness", completionRate: 48.8, avgScore: 72.8, behaviorChange: 63.9, enrolled: 58, completed: 236, duration: "102min", category: "mandatory" },
    { id: "TRN-003", name: "Social Engineering Defense", completionRate: 94.1, avgScore: 59.2, behaviorChange: 52.1, enrolled: 220, completed: 32, duration: "90min", category: "optional" },
    { id: "TRN-004", name: "Password Hygiene", completionRate: 83.5, avgScore: 64.6, behaviorChange: 89.6, enrolled: 339, completed: 293, duration: "112min", category: "mandatory" },
    { id: "TRN-005", name: "Data Classification", completionRate: 78.3, avgScore: 67.4, behaviorChange: 59.5, enrolled: 429, completed: 240, duration: "82min", category: "mandatory" },
    { id: "TRN-006", name: "Incident Response Basics", completionRate: 69.5, avgScore: 85.0, behaviorChange: 31.1, enrolled: 490, completed: 133, duration: "62min", category: "mandatory" },
    { id: "TRN-007", name: "Secure Coding", completionRate: 60.2, avgScore: 57.0, behaviorChange: 69.2, enrolled: 75, completed: 257, duration: "95min", category: "optional" },
    { id: "TRN-008", name: "Cloud Security", completionRate: 84.3, avgScore: 72.3, behaviorChange: 79.7, enrolled: 221, completed: 406, duration: "51min", category: "mandatory" },
    { id: "TRN-009", name: "Mobile Device Security", completionRate: 74.5, avgScore: 91.5, behaviorChange: 64.9, enrolled: 318, completed: 57, duration: "66min", category: "mandatory" },
    { id: "TRN-010", name: "Network Security", completionRate: 62.5, avgScore: 88.2, behaviorChange: 84.9, enrolled: 313, completed: 95, duration: "25min", category: "mandatory" },
    { id: "TRN-011", name: "Physical Security", completionRate: 49.1, avgScore: 67.7, behaviorChange: 38.8, enrolled: 314, completed: 406, duration: "78min", category: "optional" },
    { id: "TRN-012", name: "Regulatory Compliance", completionRate: 97.1, avgScore: 87.1, behaviorChange: 84.3, enrolled: 190, completed: 122, duration: "73min", category: "mandatory" },
    { id: "TRN-013", name: "Risk Management", completionRate: 66.7, avgScore: 92.5, behaviorChange: 83.2, enrolled: 267, completed: 442, duration: "114min", category: "mandatory" },
    { id: "TRN-014", name: "Cryptography Basics", completionRate: 88.8, avgScore: 77.9, behaviorChange: 48.2, enrolled: 282, completed: 26, duration: "40min", category: "mandatory" },
    { id: "TRN-015", name: "Access Control", completionRate: 92.5, avgScore: 67.5, behaviorChange: 39.1, enrolled: 333, completed: 227, duration: "64min", category: "optional" },
    { id: "TRN-016", name: "Vendor Management", completionRate: 75.2, avgScore: 80.2, behaviorChange: 32.6, enrolled: 440, completed: 130, duration: "75min", category: "mandatory" },
  ];
  private _incident_timPhishingResults = [
    { month: "2026-01", sent: 310, clicked: 74, reported: 79, clickRate: round(23.870967741935484,1), reportRate: round(25.483870967741932,1) },
    { month: "2026-02", sent: 268, clicked: 46, reported: 121, clickRate: round(17.16417910447761,1), reportRate: round(45.149253731343286,1) },
    { month: "2026-03", sent: 731, clicked: 99, reported: 192, clickRate: round(13.543091655266759,1), reportRate: round(26.265389876880985,1) },
    { month: "2026-04", sent: 620, clicked: 134, reported: 164, clickRate: round(21.612903225806452,1), reportRate: round(26.451612903225808,1) },
    { month: "2026-05", sent: 699, clicked: 151, reported: 161, clickRate: round(21.602288984263232,1), reportRate: round(23.032904148783977,1) },
    { month: "2026-06", sent: 430, clicked: 126, reported: 56, clickRate: round(29.30232558139535,1), reportRate: round(13.023255813953488,1) },
  ];
  private _incident_timTrainingROI = { totalInvestment: 152453, avgCostPerEmployee: 773, riskReductionPct: round(random.uniform(15,45),1), incidentReductionPct: round(random.uniform(10,35),1), complianceScoreGain: round(random.uniform(5,25),1) };
  private _incident_timLearningPaths = [
    { name: "Beginner Security Analyst", totalModules: 18, completedModules: 6, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 41, enrolled: 46 },
    { name: "Advanced Threat Hunter", totalModules: 12, completedModules: 4, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 25, enrolled: 40 },
    { name: "Security Architect", totalModules: 15, completedModules: 9, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 22, enrolled: 89 },
    { name: "Incident Responder", totalModules: 10, completedModules: 4, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 40, enrolled: 83 },
    { name: "Compliance Specialist", totalModules: 8, completedModules: 2, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 60, enrolled: 130 },
    { name: "DevSecOps Engineer", totalModules: 10, completedModules: 8, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 19, enrolled: 148 },
  ];
  ...
  private _incident_timGovBodies = [
    { name: "Security Steering Committee", members: 8, chair: "CISO", meetingFreq: "Weekly", lastMeeting: "2026-04-13", nextMeeting: "2026-05-13", quorum: 6 },
    { name: "Risk Management Board", members: 9, chair: "CTO", meetingFreq: "Bi-weekly", lastMeeting: "2026-04-03", nextMeeting: "2026-05-23", quorum: 3 },
    { name: "Data Governance Council", members: 13, chair: "CRO", meetingFreq: "Monthly", lastMeeting: "2026-04-02", nextMeeting: "2026-05-24", quorum: 3 },
    { name: "Compliance Oversight Board", members: 5, chair: "CDO", meetingFreq: "Monthly", lastMeeting: "2026-04-06", nextMeeting: "2026-05-27", quorum: 7 },
    { name: "Architecture Review Board", members: 13, chair: "VP Eng", meetingFreq: "Bi-weekly", lastMeeting: "2026-04-20", nextMeeting: "2026-05-18", quorum: 5 },
    { name: "Change Advisory Board", members: 15, chair: "CISO", meetingFreq: "Weekly", lastMeeting: "2026-04-21", nextMeeting: "2026-05-03", quorum: 8 },
    { name: "Incident Review Board", members: 13, chair: "CIO", meetingFreq: "As needed", lastMeeting: "2026-04-21", nextMeeting: "2026-05-08", quorum: 3 },
    { name: "Vendor Risk Committee", members: 10, chair: "CFO", meetingFreq: "Quarterly", lastMeeting: "2026-04-12", nextMeeting: "2026-05-10", quorum: 5 },
  ];
  private _incident_timDecisions = [
    { id: "DEC-0001", title: "Adopt zero-trust architecture framework", date: "2026-03-05", status: "approved", owner: "CISO" },
    ...
    { id: "DEC-0004", title: "Mandate MFA for all external access", date: "2026-02-04", status: "pending", owner: "CRO" },
    { id: "DEC-0005", title: "Establish bug bounty program", date: "2026-04-07", status: "approved", owner: "VP Eng" },
    { id: "DEC-0006", title: "Deploy EDR solution enterprise-wide", date: "2026-01-24", status: "approved", owner: "CISO" },
    { id: "DEC-0007", title: "Conduct annual penetration testing", date: "2026-03-26", status: "implemented", owner: "CTO" },
    { id: "DEC-0008", title: "Implement network micro-segmentation", date: "2026-04-26", status: "in-progress", owner: "Security Lead" },
    { id: "DEC-0009", title: "Establish security champion program", date: "2026-03-28", status: "pending", owner: "CRO" },
    { id: "DEC-0010", title: "Migrate to passwordless authentication", date: "2026-04-19", status: "approved", owner: "VP Eng" },
  ];
  private _incident_timPolicyLifecycle = [
    { name: "Information Security Policy", version: "v2.3", status: "active", lastUpdated: "2026-03-07", nextReview: "2026-11-26", owner: "CISO" },
    { name: "Acceptable Use Policy", version: "v4.0", status: "active", lastUpdated: "2026-04-15", nextReview: "2026-12-17", owner: "Legal" },
    { name: "Data Retention Policy", version: "v4.0", status: "under-review", lastUpdated: "2026-03-11", nextReview: "2026-8-28", owner: "DPO" },
    { name: "Access Control Policy", version: "v3.5", status: "active", lastUpdated: "2026-01-22", nextReview: "2026-10-11", owner: "IAM Lead" },
    { name: "Incident Response Policy", version: "v3.2", status: "draft", lastUpdated: "2026-03-23", nextReview: "2026-9-14", owner: "IR Lead" },
    { name: "Business Continuity Plan", version: "v1.2", status: "active", lastUpdated: "2026-01-27", nextReview: "2026-12-05", owner: "BCP Mgr" },
    { name: "Vendor Management Policy", version: "v1.3", status: "active", lastUpdated: "2026-04-11", nextReview: "2026-12-09", owner: "Procurement" },
    { name: "Encryption Standard", version: "v4.1", status: "under-review", lastUpdated: "2026-01-21", nextReview: "2026-8-16", owner: "Security Arch" },
  ];
  private _incident_timGovMaturityScore = { overall: 4.6, riskManagement: 3.0, compliance: 5.7, incidentResponse: 4.2, awareness: 5.6, technology: 4.8 };
  ...
  private _incident_timInnoProjects = [
    { id: "INN-001", name: "AI-Powered Threat Detection", description: "Machine learning models for real-time threat identification", status: "active", progress: 72, startDate: "2026-03-23", teamSize: 2, budget: 97119, milestones: 4, completedMilestones: 1 },
    { id: "INN-002", name: "Quantum-Resistant Cryptography", description: "Post-quantum encryption algorithm prototyping", status: "research", progress: 35, startDate: "2026-01-17", teamSize: 7, budget: 76130, milestones: 9, completedMilestones: 8 },
    { id: "INN-003", name: "Automated Red Teaming", description: "Autonomous penetration testing framework", status: "active", progress: 58, startDate: "2026-01-16", teamSize: 2, budget: 162110, milestones: 4, completedMilestones: 5 },
    { id: "INN-004", name: "Zero-Knowledge Authentication", description: "Privacy-preserving identity verification", status: "poc", progress: 88, startDate: "2026-02-26", teamSize: 2, budget: 149618, milestones: 8, completedMilestones: 3 },
    { id: "INN-005", name: "Blockchain Audit Trail", description: "Immutable security event logging", status: "active", progress: 45, startDate: "2026-02-15", teamSize: 6, budget: 125490, milestones: 9, completedMilestones: 8 },
    { id: "INN-006", name: "Behavioral Biometrics", description: "Continuous authentication via user behavior patterns", status: "research", progress: 22, startDate: "2026-02-19", teamSize: 4, budget: 64647, milestones: 5, completedMilestones: 7 },
    { id: "INN-007", name: "Deception Grid 2.0", description: "Advanced honeypot network with adaptive responses", status: "active", progress: 65, startDate: "2026-02-07", teamSize: 4, budget: 133112, milestones: 6, completedMilestones: 5 },
    { id: "INN-008", name: "Secure Enclave Integration", description: "Hardware-backed security for critical workloads", status: "poc", progress: 40, startDate: "2026-01-13", teamSize: 7, budget: 58066, milestones: 4, completedMilestones: 4 },
  ];
  private _incident_timTechEvaluations = [
    ...
    { name: "SOAR Platform 3.0", status: "planned", score: 5.8, recommendation: "Monitor", vendor: "Splunk" },
  ];
  ...
  private _incident_timInnoMetrics = { totalProjects: 8, activeProjects: 4, avgTimeToValue: "83 days", pocSuccessRate: round(random.uniform(55,85),1), researchToProduction: round(random.uniform(20,50),1), innovationIndex: round(random.uniform(6.0,9.5),1) };
  ...
  private _incident_timComplianceFrameworks = [
    { name: "SOC 2 Type II", description: "Trust Services Criteria", totalControls: 5, implementedControls: 2, status: "in-review", lastAudit: "2026-04-27", nextAudit: "2026-11-06", evidenceCount: 460 },
    { name: "ISO 27001", description: "Information Security Management", totalControls: 114, implementedControls: 101, status: "partially-compliant", lastAudit: "2026-03-11", nextAudit: "2026-12-02", evidenceCount: 126 },
    { name: "PCI DSS 4.0", description: "Payment Card Industry", totalControls: 12, implementedControls: 8, status: "compliant", lastAudit: "2026-01-02", nextAudit: "2026-7-01", evidenceCount: 489 },
    { name: "HIPAA", description: "Health Insurance Portability", totalControls: 18, implementedControls: 15, status: "partially-compliant", lastAudit: "2026-02-17", nextAudit: "2026-11-24", evidenceCount: 230 },
    { name: "GDPR", description: "Data Protection Regulation", totalControls: 99, implementedControls: 99, status: "partially-compliant", lastAudit: "2026-01-22", nextAudit: "2026-10-07", evidenceCount: 266 },
    { name: "NIST CSF 2.0", description: "Cybersecurity Framework", totalControls: 6, implementedControls: 5, status: "in-review", lastAudit: "2026-01-24", nextAudit: "2026-11-10", evidenceCount: 266 },
    { name: "FedRAMP", description: "Federal Risk Authorization", totalControls: 15, implementedControls: 9, status: "in-review", lastAudit: "2026-02-06", nextAudit: "2026-8-07", evidenceCount: 155 },
    { name: "SOX", description: "Sarbanes-Oxley Compliance", totalControls: 8, implementedControls: 8, status: "in-review", lastAudit: "2026-02-27", nextAudit: "2026-11-02", evidenceCount: 149 },
    { name: "CIS Controls v8", description: "Center for Internet Security", totalControls: 18, implementedControls: 14, status: "compliant", lastAudit: "2026-01-21", nextAudit: "2026-10-15", evidenceCount: 262 },
    { name: "COBIT 2019", description: "IT Governance Framework", totalControls: 40, implementedControls: 40, status: "compliant", lastAudit: "2026-04-25", nextAudit: "2026-7-04", evidenceCount: 418 },
  ];
  ...
  private _incident_timAuditTrail = [
    ...
    { id: "AUD-0002", action: "Evidence collected", auditor: "External Auditor", date: "2026-04-22", result: "pass", findings: 2 },
    ...
    { id: "AUD-0005", action: "Policy updated", auditor: "IT Audit", date: "2026-04-12", result: "pass", findings: 0 },
    ...
    { id: "AUD-0008", action: "Exception approved", auditor: "CISO Office", date: "2026-04-18", result: "conditional", findings: 2 },
  ...
  private _incident_timThreatActors = [
    { name: "APT-29", alias: "Cozy Bear", origin: "Russia", type: "Nation-State", severity: "high", lastActivity: "2026-04-13", targets: "Technology", indicators: 265, ttps: 19 },
    { name: "APT-41", alias: "Double Dragon", origin: "China", type: "Nation-State", severity: "critical", lastActivity: "2026-04-09", targets: "Technology", indicators: 107, ttps: 12 },
    { name: "Lazarus Group", alias: "Hidden Cobra", origin: "North Korea", type: "Nation-State", severity: "critical", lastActivity: "2026-04-10", targets: "Technology", indicators: 382, ttps: 9 },
    { name: "FIN7", alias: "Carbanak", origin: "Eastern Europe", type: "Financial", severity: "high", lastActivity: "2026-04-18", targets: "Healthcare", indicators: 97, ttps: 38 },
    { name: "Conti", alias: "Wizard Spider", origin: "Russia", type: "Ransomware", severity: "critical", lastActivity: "2026-04-17", targets: "Finance", indicators: 105, ttps: 48 },
    { name: "LockBit", alias: "LockBit Gang", origin: "Unknown", type: "Ransomware", severity: "high", lastActivity: "2026-04-21", targets: "Healthcare", indicators: 86, ttps: 11 },
    { name: "Cl0p", alias: "Cl0p Team", origin: "Unknown", type: "Ransomware", severity: "high", lastActivity: "2026-04-19", targets: "Government", indicators: 354, ttps: 43 },
    { name: "Sandworm", alias: "Unit 74455", origin: "Russia", type: "Nation-State", severity: "critical", lastActivity: "2026-04-17", targets: "Technology", indicators: 477, ttps: 10 },
  ];
  private _incident_timIoCFeed = [
    { id: "ioc-000001", type: "ip", value: "73.34.161.127", confidence: 57, source: "VirusTotal", firstSeen: "2026-04-16", lastSeen: "2026-04-09" },
    { id: "ioc-000002", type: "ip", value: "186.70.103.213", confidence: 64, source: "AlienVault", firstSeen: "2026-04-02", lastSeen: "2026-04-23" },
    { id: "ioc-000003", type: "ip", value: "74.122.228.235", confidence: 43, source: "CrowdStrike", firstSeen: "2026-04-12", lastSeen: "2026-04-23" },
    { id: "ioc-000004", type: "ip", value: "111.143.214.231", confidence: 58, source: "STIX", firstSeen: "2026-04-20", lastSeen: "2026-04-15" },
    { id: "ioc-000005", type: "ip", value: "111.14.46.213", confidence: 55, source: "CrowdStrike", firstSeen: "2026-04-17", lastSeen: "2026-04-04" },
    { id: "ioc-000006", type: "ip", value: "20.151.53.86", confidence: 60, source: "MISP", firstSeen: "2026-04-13", lastSeen: "2026-04-03" },
    { id: "ioc-000007", type: "ip", value: "146.188.9.89", confidence: 42, source: "CrowdStrike", firstSeen: "2026-04-12", lastSeen: "2026-04-12" },
    { id: "ioc-000008", type: "ip", value: "222.220.159.215", confidence: 96, source: "Mandiant", firstSeen: "2026-04-15", lastSeen: "2026-04-18" },
    { id: "ioc-000009", type: "ip", value: "67.28.225.241", confidence: 90, source: "AlienVault", firstSeen: "2026-04-02", lastSeen: "2026-04-21" },
    { id: "ioc-000010", type: "ip", value: "35.149.207.157", confidence: 54, source: "MISP", firstSeen: "2026-04-09", lastSeen: "2026-04-05" },
    { id: "ioc-000011", type: "ip", value: "8.211.211.83", confidence: 55, source: "CrowdStrike", firstSeen: "2026-04-18", lastSeen: "2026-04-03" },
    { id: "ioc-000012", type: "ip", value: "182.0.126.192", confidence: 79, source: "CrowdStrike", firstSeen: "2026-04-09", lastSeen: "2026-04-13" },
    { id: "ioc-000013", type: "ip", value: "75.133.96.38", confidence: 92, source: "AlienVault", firstSeen: "2026-04-02", lastSeen: "2026-04-11" },
    { id: "ioc-000014", type: "ip", value: "94.243.118.93", confidence: 55, source: "MISP", firstSeen: "2026-04-22", lastSeen: "2026-04-04" },
    { id: "ioc-000015", type: "ip", value: "234.240.184.19", confidence: 42, source: "Mandiant", firstSeen: "2026-04-08", lastSeen: "2026-04-13" },
  ];
  ...
  private _incident_timIncidents = [
    { id: "INC-20260001", title: "Unauthorized access detected", severity: "critical", status: "open", assignedTo: "SOC L1", detectedAt: "2026-04-14T14:36", affectedAssets: 13, rootCause: "Misconfiguration" },
    { id: "INC-20260002", title: "Malware outbreak on workstation", severity: "high", status: "investigating", assignedTo: "SOC L2", detectedAt: "2026-04-23T10:53", affectedAssets: 10, rootCause: "Credential compromise" },
    { id: "INC-20260003", title: "Data leak from S3 bucket", severity: "medium", status: "contained", assignedTo: "IR Lead", detectedAt: "2026-04-02T14:53", affectedAssets: 12, rootCause: "Zero-day" },
    { id: "INC-20260004", title: "Phishing campaign targeting finance", severity: "low", status: "eradicated", assignedTo: "CISO", detectedAt: "2026-04-19T07:19", affectedAssets: 44, rootCause: "Human error" },
    { id: "INC-20260005", title: "DDoS attack on web services", severity: "critical", status: "recovered", assignedTo: "Security Eng", detectedAt: "2026-04-10T08:50", affectedAssets: 7, rootCause: "Policy violation" },
    { id: "INC-20260006", title: "Ransomware encryption attempt", severity: "high", status: "closed", assignedTo: "Forensics", detectedAt: "2026-04-10T14:40", affectedAssets: 21, rootCause: "Unknown" },
    { id: "INC-20260007", title: "Insider data exfiltration", severity: "medium", status: "open", assignedTo: "SOC L1", detectedAt: "2026-04-10T19:40", affectedAssets: 37, rootCause: "Misconfiguration" },
    { id: "INC-20260008", title: "API key exposure in repo", severity: "low", status: "investigating", assignedTo: "SOC L2", detectedAt: "2026-04-14T23:03", affectedAssets: 1, rootCause: "Credential compromise" },
    { id: "INC-20260009", title: "SQL injection on portal", severity: "critical", status: "contained", assignedTo: "IR Lead", detectedAt: "2026-04-20T16:06", affectedAssets: 12, rootCause: "Zero-day" },
    { id: "INC-20260010", title: "Brute force on VPN", severity: "high", status: "eradicated", assignedTo: "CISO", detectedAt: "2026-04-01T13:30", affectedAssets: 45, rootCause: "Human error" },
    { id: "INC-20260011", title: "Supply chain alert from vendor", severity: "medium", status: "recovered", assignedTo: "Security Eng", detectedAt: "2026-04-19T08:45", affectedAssets: 26, rootCause: "Policy violation" },
    { id: "INC-20260012", title: "Suspicious lateral movement", severity: "low", status: "closed", assignedTo: "Forensics", detectedAt: "2026-04-02T08:39", affectedAssets: 15, rootCause: "Unknown" },
  ];
  private _incident_timGetIncidentStats() {
    const inc = this._incident_timIncidents;
    return { total: inc.length, open: inc.filter(i=>i.status==="open").length, investigating: inc.filter(i=>i.status==="investigating").length, mttd: 30, mttr: 39 };
  }
...
// ===== DATA SOVEREIGNTY COMPLIANCE (R22) =====
  ...
  private _renderBudgetPlanning() {
    const budgetData = [
      { category: "Personnel & Training", planned: 3228000, actual: 2620000, utilization: 81.2, q1: "17%", q2: "22%", q3: "20%", q4: "12%" },
      { category: "Tooling & Licensing", planned: 3235000, actual: 2633000, utilization: 81.4, q1: "20%", q2: "27%", q3: "31%", q4: "13%" },
      { category: "Infrastructure Security", planned: 3242000, actual: 2646000, utilization: 81.6, q1: "23%", q2: "32%", q3: "26%", q4: "14%" },
      { category: "Compliance & Audit", planned: 3249000, actual: 2659000, utilization: 81.8, q1: "26%", q2: "21%", q3: "21%", q4: "15%" },
      { category: "Incident Response", planned: 3256000, actual: 2672000, utilization: 82.1, q1: "29%", q2: "26%", q3: "32%", q4: "16%" },
      { category: "Third-Party Assessments", planned: 3263000, actual: 2685000, utilization: 82.3, q1: "16%", q2: "31%", q3: "27%", q4: "17%" },
      { category: "Security Awareness", planned: 3270000, actual: 2698000, utilization: 82.5, q1: "19%", q2: "20%", q3: "22%", q4: "18%" },
      { category: "Research & Innovation", planned: 3277000, actual: 2711000, utilization: 82.7, q1: "22%", q2: "25%", q3: "33%", q4: "19%" },
    ];
    ...
    const headcount = [
      { team: "SOC Tier 1", current: 15, target: 5, gap: 0, avgSalary: "115k" },
      { team: "SOC Tier 2", current: 7, target: 4, gap: 5, avgSalary: "144k" },
      { team: "Threat Intel", current: 16, target: 3, gap: 4, avgSalary: "173k" },
      { team: "Red Team", current: 8, target: 22, gap: 3, avgSalary: "91k" },
      { team: "GRC", current: 17, target: 21, gap: 2, avgSalary: "120k" },
      { team: "AppSec", current: 9, target: 20, gap: 1, avgSalary: "149k" },
      { team: "Cloud Sec", current: 18, target: 19, gap: 0, avgSalary: "178k" },
      { team: "Identity & Access", current: 10, target: 18, gap: 5, avgSalary: "96k" },
    ];
    const vendorSpend = [
      { vendor: "CrowdStrike", annual: "681k", contractEnd: "2026-07", renewalRisk: "Low", satisfaction: 3 },
      { vendor: "Palo Alto", annual: "712k", contractEnd: "2026-08", renewalRisk: "Medium", satisfaction: 5 },
      { vendor: "Splunk", annual: "743k", contractEnd: "2026-09", renewalRisk: "High", satisfaction: 4 },
      { vendor: "Qualys", annual: "774k", contractEnd: "2026-10", renewalRisk: "Low", satisfaction: 3 },
      { vendor: "Rapid7", annual: "54k", contractEnd: "2026-11", renewalRisk: "Medium", satisfaction: 5 },
      { vendor: "Mandiant", annual: "85k", contractEnd: "2026-12", renewalRisk: "High", satisfaction: 4 },
      { vendor: "Zscaler", annual: "116k", contractEnd: "2026-01", renewalRisk: "Low", satisfaction: 3 },
      { vendor: "Duo Security", annual: "147k", contractEnd: "2026-02", renewalRisk: "Medium", satisfaction: 5 },
    ];
    const roiProjections = [
      { area: "Threat Detection", investment: "514k", projectedReturn: "2289k", roiMultiple: "1.5x", confidence: 78 },
      { area: "Incident Reduction", investment: "557k", projectedReturn: "2336k", roiMultiple: "4.0x", confidence: 95 },
      { area: "Compliance Savings", investment: "600k", projectedReturn: "2383k", roiMultiple: "3.9x", confidence: 76 },
      { area: "Automation Gains", investment: "643k", projectedReturn: "2430k", roiMultiple: "3.8x", confidence: 93 },
      { area: "Risk Avoidance", investment: "686k", projectedReturn: "2477k", roiMultiple: "3.7x", confidence: 74 },
    ];
    return html`
  ...
  private _renderMetricsNormalization() {
    const kpiCatalog = [
      { id: "kpi-1", name: "MTTD", owner: "SOC", unit: "minutes", target: 91, current: 80, benchmark: 74, collection: "auto", frequency: "realtime" },
      { id: "kpi-2", name: "MTTR", owner: "GRC", unit: "%", target: 94, current: 87, benchmark: 85, collection: "semi-auto", frequency: "daily" },
      { id: "kpi-3", name: "MTTC", owner: "AppSec", unit: "score", target: 97, current: 94, benchmark: 96, collection: "manual", frequency: "weekly" },
      { id: "kpi-4", name: "Vuln SLA Compliance", owner: "Cloud Sec", unit: "count", target: 70, current: 55, benchmark: 73, collection: "auto", frequency: "monthly" },
      { id: "kpi-5", name: "Patch Coverage", owner: "Identity", unit: "days", target: 73, current: 62, benchmark: 84, collection: "semi-auto", frequency: "realtime" },
      { id: "kpi-6", name: "Phishing Click Rate", owner: "Threat Intel", unit: "minutes", target: 76, current: 69, benchmark: 95, collection: "manual", frequency: "daily" },
      { id: "kpi-7", name: "Training Completion", owner: "Security Ops", unit: "%", target: 79, current: 76, benchmark: 72, collection: "auto", frequency: "weekly" },
      { id: "kpi-8", name: "Escalation Rate", owner: "Risk Mgmt", unit: "score", target: 82, current: 83, benchmark: 83, collection: "semi-auto", frequency: "monthly" },
      { id: "kpi-9", name: "False Positive Rate", owner: "SOC", unit: "count", target: 85, current: 90, benchmark: 94, collection: "manual", frequency: "realtime" },
      { id: "kpi-10", name: "Threat Intel Actionability", owner: "GRC", unit: "days", target: 88, current: 97, benchmark: 71, collection: "auto", frequency: "daily" },
      { id: "kpi-11", name: "Endpoint Compliance", owner: "AppSec", unit: "minutes", target: 91, current: 58, benchmark: 82, collection: "semi-auto", frequency: "weekly" },
      { id: "kpi-12", name: "Cloud Misconfig Score", owner: "Cloud Sec", unit: "%", target: 94, current: 65, benchmark: 93, collection: "manual", frequency: "monthly" },
      { id: "kpi-13", name: "Identity Anomaly Rate", owner: "Identity", unit: "score", target: 97, current: 72, benchmark: 70, collection: "auto", frequency: "realtime" },
      { id: "kpi-14", name: "DLP Events", owner: "Threat Intel", unit: "count", target: 70, current: 79, benchmark: 81, collection: "semi-auto", frequency: "daily" },
      { id: "kpi-15", name: "Vendor Risk Avg", owner: "Security Ops", unit: "days", target: 73, current: 86, benchmark: 92, collection: "manual", frequency: "weekly" },
      { id: "kpi-16", name: "Compliance Audit Pass Rate", owner: "Risk Mgmt", unit: "minutes", target: 76, current: 93, benchmark: 69, collection: "auto", frequency: "monthly" },
      { id: "kpi-17", name: "Awareness Score", owner: "SOC", unit: "%", target: 79, current: 100, benchmark: 80, collection: "semi-auto", frequency: "realtime" },
      { id: "kpi-18", name: "SOC Utilization", owner: "GRC", unit: "score", target: 82, current: 61, benchmark: 91, collection: "manual", frequency: "daily" },
      { id: "kpi-19", name: "Automation Coverage", owner: "AppSec", unit: "count", target: 85, current: 68, benchmark: 68, collection: "auto", frequency: "weekly" },
      { id: "kpi-20", name: "Risk Register Currency", owner: "Cloud Sec", unit: "days", target: 88, current: 75, benchmark: 79, collection: "semi-auto", frequency: "monthly" },
    ];
    const benchmarkSources = [
      { source: "NIST CSF", mappedKPIs: 6, alignment: 84, lastReview: "2026-04-02", status: "aligned" },
      { source: "CIS Controls v8", mappedKPIs: 7, alignment: 62, lastReview: "2026-05-25", status: "partial" },
      { source: "ISO 27001:2022", mappedKPIs: 8, alignment: 79, lastReview: "2026-06-20", status: "reviewing" },
      { source: "PCI DSS 4.0", mappedKPIs: 3, alignment: 96, lastReview: "2026-01-15", status: "aligned" },
      { source: "SOC 2 Type II", mappedKPIs: 4, alignment: 74, lastReview: "2026-02-10", status: "partial" },
      { source: "MITRE ATT&CK", mappedKPIs: 5, alignment: 91, lastReview: "2026-03-05", status: "reviewing" },
      { source: "SANS Top 20", mappedKPIs: 6, alignment: 69, lastReview: "2026-04-28", status: "aligned" },
      { source: "OWASP Top 10", mappedKPIs: 7, alignment: 86, lastReview: "2026-05-23", status: "partial" },
    ];
  ...
  private _renderThreatHuntingCampaigns() {
    const campaigns = [
      { id: "HC-1001", name: "Lateral Movement Sweep", status: "active", hypothesis: "H1: Actors using pass-the-hash for lateral movement", leadHunter: "Alice Chen", findings: 1, startDate: "2026-02-22", endDate: null, effectiveness: 65 },
      { id: "HC-1002", name: "Credential Harvesting Hunt", status: "completed", hypothesis: "H2: Actors using web shells for persistence", leadHunter: "Bob Martinez", findings: 4, startDate: "2026-01-05", endDate: "2026-06-11", effectiveness: 84 },
      { id: "HC-1003", name: "Persistence Mechanism Audit", status: "planned", hypothesis: "H3: Actors using scheduled tasks for data theft", leadHunter: "Carol Wu", findings: 7, startDate: "2026-04-16", endDate: null, effectiveness: 44 },
      { id: "HC-1004", name: "C2 Beacon Detection", status: "in-review", hypothesis: "H4: Actors using DNS tunneling for C2 communication", leadHunter: "Dave Kim", findings: 10, startDate: "2026-03-27", endDate: null, effectiveness: 63 },
      { id: "HC-1005", name: "Data Exfiltration Patterns", status: "active", hypothesis: "H5: Actors using encrypted channels for privilege escalation", leadHunter: "Eve Johnson", findings: 13, startDate: "2026-02-10", endDate: null, effectiveness: 82 },
      { id: "HC-1006", name: "Privilege Escalation Scan", status: "completed", hypothesis: "H6: Actors using token impersonation for defense evasion", leadHunter: "Frank Liu", findings: 16, startDate: "2026-01-21", endDate: "2026-04-23", effectiveness: 42 },
      { id: "HC-1007", name: "Supply Chain Implant Hunt", status: "planned", hypothesis: "H7: Actors using poisoned images for initial access", leadHunter: "Grace Park", findings: 19, startDate: "2026-04-04", endDate: null, effectiveness: 61 },
      { id: "HC-1008", name: "Insider Threat Indicators", status: "in-review", hypothesis: "H8: Actors using legitimate tools for credential access", leadHunter: "Hector Silva", findings: 22, startDate: "2026-03-15", endDate: null, effectiveness: 80 },
      { id: "HC-1009", name: "Cloud Metadata Analysis", status: "active", hypothesis: "H9: Actors using API keys for command execution", leadHunter: "Alice Chen", findings: 25, startDate: "2026-02-26", endDate: null, effectiveness: 40 },
      { id: "HC-1010", name: "DNS Tunnel Detection", status: "completed", hypothesis: "H10: Actors using encoded subdomains for exfiltration", leadHunter: "Bob Martinez", findings: 28, startDate: "2026-01-09", endDate: "2026-05-07", effectiveness: 59 },
      { id: "HC-1011", name: "Fileless Malware Search", status: "planned", hypothesis: "H11: Actors using WMI providers for discovery", leadHunter: "Carol Wu", findings: 31, startDate: "2026-04-20", endDate: null, effectiveness: 78 },
      { id: "HC-1012", name: "Zero-Day Exploit Traces", status: "in-review", hypothesis: "H12: Actors using exploit kits for collection", leadHunter: "Dave Kim", findings: 34, startDate: "2026-03-03", endDate: null, effectiveness: 97 },
    ];
    const hunterLeaderboard = [
      { hunter: "Alice Chen", campaigns: 13, findings: 114, highSeverity: 23, avgScore: 72, streak: 2 },
      { hunter: "Bob Martinez", campaigns: 10, findings: 27, highSeverity: 2, avgScore: 65, streak: 3 },
      { hunter: "Carol Wu", campaigns: 7, findings: 56, highSeverity: 7, avgScore: 58, streak: 4 },
      { hunter: "Dave Kim", campaigns: 4, findings: 85, highSeverity: 12, avgScore: 95, streak: 5 },
      { hunter: "Eve Johnson", campaigns: 14, findings: 114, highSeverity: 17, avgScore: 88, streak: 6 },
      { hunter: "Frank Liu", campaigns: 11, findings: 27, highSeverity: 22, avgScore: 81, streak: 7 },
      { hunter: "Grace Park", campaigns: 8, findings: 56, highSeverity: 1, avgScore: 74, streak: 8 },
      { hunter: "Hector Silva", campaigns: 5, findings: 85, highSeverity: 6, avgScore: 67, streak: 1 },
    ];
    const mitreMapping = [
      { tactic: "Initial Access", techniques: 8, campaigns: 2, coverage: 99 },
      { tactic: "Execution", techniques: 7, campaigns: 1, coverage: 79 },
      { tactic: "Persistence", techniques: 6, campaigns: 6, coverage: 59 },
      { tactic: "Privilege Escalation", techniques: 5, campaigns: 5, coverage: 39 },
      { tactic: "Defense Evasion", techniques: 4, campaigns: 4, coverage: 90 },
      { tactic: "Credential Access", techniques: 3, campaigns: 3, coverage: 70 },
      { tactic: "Discovery", techniques: 2, campaigns: 2, coverage: 50 },
      { tactic: "Lateral Movement", techniques: 12, campaigns: 1, coverage: 30 },
      { tactic: "Collection", techniques: 11, campaigns: 6, coverage: 81 },
      { tactic: "Exfiltration", techniques: 10, campaigns: 5, coverage: 61 },
      { tactic: "Command & Control", techniques: 9, campaigns: 4, coverage: 41 },
      { tactic: "Impact", techniques: 8, campaigns: 3, coverage: 92 },
    ];
    return html`
  ...
  private _renderControlInventory() {
    const controls = [
      { id: "CTL-2001", name: "MFA Enforcement", domain: "Access Control", status: "implemented", effectiveness: 62, lastTest: "2026-02-14", nextReview: "2026-06-14", owner: "SOC", risk: "Low" },
      { id: "CTL-2002", name: "Network Segmentation", domain: "Network Security", status: "partial", effectiveness: 27, lastTest: "2026-01-27", nextReview: "2026-07-05", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2003", name: "EDR Deployment", domain: "Endpoint Protection", status: "planned", effectiveness: 34, lastTest: "2026-04-12", nextReview: "2026-08-24", owner: "IT Ops", risk: "High" },
      { id: "CTL-2004", name: "DLP Policy", domain: "Data Protection", status: "gap", effectiveness: 41, lastTest: "2026-03-25", nextReview: "2026-09-15", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2005", name: "SSO Integration", domain: "Identity Management", status: "implemented", effectiveness: 74, lastTest: "2026-02-10", nextReview: "2026-10-06", owner: "IAM", risk: "Low" },
      { id: "CTL-2006", name: "SAST Pipeline", domain: "Application Security", status: "partial", effectiveness: 4, lastTest: "2026-01-23", nextReview: "2026-11-25", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2007", name: "CSPM Scanning", domain: "Cloud Security", status: "planned", effectiveness: 11, lastTest: "2026-04-08", nextReview: "2026-12-16", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2008", name: "Badge Access", domain: "Physical Security", status: "gap", effectiveness: 18, lastTest: "2026-03-21", nextReview: "2026-05-07", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2009", name: "Least Privilege", domain: "Access Control", status: "implemented", effectiveness: 86, lastTest: "2026-02-06", nextReview: "2026-06-26", owner: "SOC", risk: "Low" },
      { id: "CTL-2010", name: "Firewall Rules", domain: "Network Security", status: "partial", effectiveness: 32, lastTest: "2026-01-19", nextReview: "2026-07-17", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2011", name: "Disk Encryption", domain: "Endpoint Protection", status: "planned", effectiveness: 39, lastTest: "2026-04-04", nextReview: "2026-08-08", owner: "IT Ops", risk: "High" },
      { id: "CTL-2012", name: "Data Classification", domain: "Data Protection", status: "gap", effectiveness: 46, lastTest: "2026-03-17", nextReview: "2026-09-27", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2013", name: "PAM Implementation", domain: "Identity Management", status: "implemented", effectiveness: 98, lastTest: "2026-02-02", nextReview: "2026-10-18", owner: "IAM", risk: "Low" },
      { id: "CTL-2014", name: "DAST Pipeline", domain: "Application Security", status: "partial", effectiveness: 9, lastTest: "2026-01-15", nextReview: "2026-11-09", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2015", name: "IAM Policy Review", domain: "Cloud Security", status: "planned", effectiveness: 16, lastTest: "2026-04-28", nextReview: "2026-12-28", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2016", name: "Visitor Management", domain: "Physical Security", status: "gap", effectiveness: 23, lastTest: "2026-03-13", nextReview: "2026-05-19", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2017", name: "Access Reviews", domain: "Access Control", status: "implemented", effectiveness: 51, lastTest: "2026-02-26", nextReview: "2026-06-10", owner: "SOC", risk: "Low" },
      { id: "CTL-2018", name: "IDS/IPS Tuning", domain: "Network Security", status: "partial", effectiveness: 37, lastTest: "2026-01-11", nextReview: "2026-07-01", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2019", name: "Patch Management", domain: "Endpoint Protection", status: "planned", effectiveness: 44, lastTest: "2026-04-24", nextReview: "2026-08-20", owner: "IT Ops", risk: "High" },
      { id: "CTL-2020", name: "Backup Encryption", domain: "Data Protection", status: "gap", effectiveness: 0, lastTest: "2026-03-09", nextReview: "2026-09-11", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2021", name: "Password Policy", domain: "Identity Management", status: "implemented", effectiveness: 63, lastTest: "2026-02-22", nextReview: "2026-10-02", owner: "IAM", risk: "Low" },
      { id: "CTL-2022", name: "Container Scanning", domain: "Application Security", status: "partial", effectiveness: 14, lastTest: "2026-01-07", nextReview: "2026-11-21", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2023", name: "WAF Configuration", domain: "Cloud Security", status: "planned", effectiveness: 21, lastTest: "2026-04-20", nextReview: "2026-12-12", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2024", name: "CCTV Coverage", domain: "Physical Security", status: "gap", effectiveness: 28, lastTest: "2026-03-05", nextReview: "2026-05-03", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2025", name: "RBAC Enforcement", domain: "Access Control", status: "implemented", effectiveness: 75, lastTest: "2026-02-18", nextReview: "2026-06-22", owner: "SOC", risk: "Low" },
      { id: "CTL-2026", name: "VPN Management", domain: "Network Security", status: "partial", effectiveness: 42, lastTest: "2026-01-03", nextReview: "2026-07-13", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2027", name: "App Whitelisting", domain: "Endpoint Protection", status: "planned", effectiveness: 49, lastTest: "2026-04-16", nextReview: "2026-08-04", owner: "IT Ops", risk: "High" },
      { id: "CTL-2028", name: "Key Management", domain: "Data Protection", status: "gap", effectiveness: 5, lastTest: "2026-03-01", nextReview: "2026-09-23", owner: "Data Gov", risk: "Critical" },
    ];
    const gapAnalysis = [
      { gap: "Insufficient MFA coverage for legacy apps", severity: "High", remediationPlan: "Plan R3001", eta: "2026-Q4", estimatedCost: "25k" },
      { gap: "Missing network micro-segmentation", severity: "Medium", remediationPlan: "Plan R3002", eta: "2026-Q3", estimatedCost: "54k" },
      { gap: "Inconsistent EDR deployment", severity: "Medium", remediationPlan: "Plan R3003", eta: "2026-Q2", estimatedCost: "83k" },
      { gap: "DLP not covering cloud storage", severity: "Low", remediationPlan: "Plan R3004", eta: "2026-Q4", estimatedCost: "112k" },
      { gap: "SSO not integrated with all SaaS", severity: "High", remediationPlan: "Plan R3005", eta: "2026-Q3", estimatedCost: "141k" },
    ];
    return html`
  ...
  private _renderIncidentCostTracker() {
    const incidents = [
      { id: "INC-7001", name: "Security Incident 1", severity: "Critical", totalCost: 1599000, responseCost: 431730, recoveryCost: 511680, legalCost: 95940, regulatoryCost: 143910, insuranceClaim: 479700, avoidedCost: 294000, date: "2026-02-06" },
      { id: "INC-7002", name: "Security Incident 2", severity: "High", totalCost: 1602000, responseCost: 544680, recoveryCost: 352440, legalCost: 304380, regulatoryCost: 240300, insuranceClaim: 0, avoidedCost: 323000, date: "2026-01-15" },
      { id: "INC-7003", name: "Security Incident 3", severity: "Medium", totalCost: 1605000, responseCost: 321000, recoveryCost: 529650, legalCost: 256800, regulatoryCost: 160500, insuranceClaim: 1219800, avoidedCost: 352000, date: "2026-04-24" },
      { id: "INC-7004", name: "Security Incident 4", severity: "Low", totalCost: 1608000, responseCost: 434160, recoveryCost: 369840, legalCost: 209040, regulatoryCost: 80400, insuranceClaim: 0, avoidedCost: 381000, date: "2026-03-05" },
      { id: "INC-7005", name: "Security Incident 5", severity: "Critical", totalCost: 1611000, responseCost: 547740, recoveryCost: 547740, legalCost: 161100, regulatoryCost: 177210, insuranceClaim: 1143810, avoidedCost: 410000, date: "2026-02-14" },
      { id: "INC-7006", name: "Security Incident 6", severity: "High", totalCost: 1614000, responseCost: 322800, recoveryCost: 387360, legalCost: 112980, regulatoryCost: 96840, insuranceClaim: 0, avoidedCost: 439000, date: "2026-01-23" },
      { id: "INC-7007", name: "Security Incident 7", severity: "Medium", totalCost: 1617000, responseCost: 436590, recoveryCost: 565950, legalCost: 323400, regulatoryCost: 194040, insuranceClaim: 1067220, avoidedCost: 468000, date: "2026-04-04" },
      { id: "INC-7008", name: "Security Incident 8", severity: "Low", totalCost: 1620000, responseCost: 550800, recoveryCost: 405000, legalCost: 275400, regulatoryCost: 113400, insuranceClaim: 0, avoidedCost: 497000, date: "2026-03-13" },
      { id: "INC-7009", name: "Security Incident 9", severity: "Critical", totalCost: 1623000, responseCost: 324600, recoveryCost: 584280, legalCost: 227220, regulatoryCost: 210990, insuranceClaim: 990030, avoidedCost: 30000, date: "2026-02-22" },
      { id: "INC-7010", name: "Security Incident 10", severity: "High", totalCost: 1626000, responseCost: 439020, recoveryCost: 422760, legalCost: 178860, regulatoryCost: 130080, insuranceClaim: 0, avoidedCost: 59000, date: "2026-01-03" },
      { id: "INC-7011", name: "Security Incident 11", severity: "Medium", totalCost: 1629000, responseCost: 553860, recoveryCost: 602730, legalCost: 130320, regulatoryCost: 228060, insuranceClaim: 912240, avoidedCost: 88000, date: "2026-04-12" },
      { id: "INC-7012", name: "Security Incident 12", severity: "Low", totalCost: 1632000, responseCost: 326400, recoveryCost: 440640, legalCost: 81600, regulatoryCost: 146880, insuranceClaim: 0, avoidedCost: 117000, date: "2026-03-21" },
    ];
    const yearlyTrend = [
      { month: "Jan", incidents: 6, totalCost: "174k", avgCost: "120k", insured: 20 },
      { month: "Feb", incidents: 3, totalCost: "217k", avgCost: "167k", insured: 20 },
      { month: "Mar", incidents: 11, totalCost: "260k", avgCost: "33k", insured: 20 },
      { month: "Apr", incidents: 8, totalCost: "303k", avgCost: "80k", insured: 20 },
      { month: "May", incidents: 5, totalCost: "346k", avgCost: "127k", insured: 20 },
      { month: "Jun", incidents: 2, totalCost: "389k", avgCost: "174k", insured: 20 },
    ];
