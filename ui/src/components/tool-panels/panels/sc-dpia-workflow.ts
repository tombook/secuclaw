/**
 * sc-dpia-workflow - Dpia Workflow
...
@customElement('sc-dpia-workflow')
export class ScDpiaWorkflow extends LitElement {
  static styles = css`
...
@state() private _tablePage = 1;
  ...
  @state() private _comments: CommentEntry[] = [
    { id: 'c1', author: 'soc-tier1', timestamp: '2026-04-23 04:00', text: 'Initial assessment started for Dpia Workflow finding #1' },
  ...
  private _items: PanelItem[] = [
      {
            "id": "dpia-workflow-1",
            "title": "Step 1: Processing Description",
            "severity": "medium",
            "status": "open",
            "category": "Security",
            "source": "SIEM",
            "description": "Purpose: Customer analytics | Categories: Browsing + Purchase | Scale: 500K users | Retention: 24 months",
      ...
      {
            "id": "dpia-workflow-2",
            "title": "Step 2: Necessity Assessment",
            "severity": "low",
            "status": "in-progress",
            "category": "Network",
            "source": "EDR",
            "description": "Legal basis: Legitimate interest | Proportionality: Verified | Less intrusive alternatives: Evaluated",
      ...
      {
            "id": "dpia-workflow-3",
            "title": "Step 3: Risk Identification",
            "severity": "high",
            "status": "resolved",
            "category": "Access",
            "source": "Scanner",
            "description": "Risks: Re-identification (High), Profiling (Medium), Unauthorized access (High) | Mitigations: 3/5 defined",
      ...
      {
            "id": "dpia-workflow-4",
            "title": "Step 4: Mitigation Measures",
            "severity": "high",
            "status": "open",
            "category": "Compliance",
            "source": "Audit",
            "description": "Encryption at rest: Yes | Access control: RBAC | Retention policy: Automated | Consent mechanism: In progress",
      ...
      {
            "id": "dpia-workflow-5",
            "title": "Step 5: DPA Documentation",
            "severity": "medium",
            "status": "in-progress",
            "category": "Operations",
            "source": "Manual",
            "description": "DPO review: Scheduled | Legal sign-off: Pending | Record of processing: Updated | Audit trail: Enabled",
      ...
      {
            "id": "dpia-workflow-6",
            "title": "Dpia Workflow Finding #6",
            "severity": "high",
            "status": "open",
            "category": "Security",
            "source": "SIEM",
            "description": "Automated dpia workflow assessment finding detected during routine scan of infrastructure component. Review and remediation recommended.",
      ...
      {
            "id": "dpia-workflow-10",
            "title": "Dpia Workflow Finding #10",
            "severity": "low",
            "status": "open",
            "category": "Operations",
            "source": "Manual",
  ...
  private _history: HistoryEntry[] = [
    { timestamp: '2026-04-23 04:15', action: 'Auto-correlated', user: 'system', details: 'Grouped related findings from Dpia Workflow analysis' },
    { timestamp: '2026-04-23 03:00', action: 'Created', user: 'scanner', details: 'New Dpia Workflow finding detected by automated assessment' },
    ...
    { timestamp: '2026-04-22 22:00', action: 'Resolved', user: 'security-eng', details: 'Remediation applied and verified for Dpia Workflow finding' },
    { timestamp: '2026-04-22 18:00', action: 'Created', user: 'audit', details: 'Compliance audit identified Dpia Workflow gap requiring remediation' },
    ...
    { timestamp: '2026-04-21 16:00', action: 'Resolved', user: 'soc-tier1', details: 'False positive confirmed - benign activity flagged by Dpia Workflow scan' },
    { timestamp: '2026-04-21 12:00', action: 'Exported', user: 'compliance', details: 'Exported Dpia Workflow findings for Q1 compliance report' },
  ];
...
private _workflowTasks: WorkflowTask[] = [
    { id: 'wt-1', title: 'Review Dpia Workflow finding #1', status: 'active', assignee: 'soc-tier1', blockedBy: [], slaDeadline: '2026-04-23T12:00:00Z', priority: 'p1', createdAt: '2026-04-23T00:00:00Z', completedAt: null },
    ...
    { id: 'wt-3', title: 'Update Dpia Workflow detection rules', status: 'blocked', assignee: 'soc-tier2', blockedBy: ['wt-2'], slaDeadline: '2026-04-24T00:00:00Z', priority: 'p2', createdAt: '2026-04-23T03:00:00Z', completedAt: null },
    ...
    { id: 'wt-8', title: 'Archive resolved Dpia Workflow findings', status: 'failed', assignee: 'soc-tier1', blockedBy: [], slaDeadline: '2026-04-23T08:00:00Z', priority: 'p4', createdAt: '2026-04-22T22:00:00Z', completedAt: null },
  ];

private _executionHistory: ExecutionRecord[] = [
    {
      id: 'exec-1', name: 'Dpia Workflow Full Assessment Run', startedAt: '2026-04-22T10:00:00Z', completedAt: '2026-04-22T10:12:00Z', status: 'success',
      steps: [
    ...
    {
      id: 'exec-2', name: 'Dpia Workflow Delta Scan', startedAt: '2026-04-23T02:00:00Z', completedAt: '2026-04-23T02:05:00Z', status: 'failed',
      steps: [
  ...
  private _runExecution() {
    ...
    const exec: ExecutionRecord = {
      id: 'exec-' + Date.now(), name: 'Dpia Workflow Assessment ' + new Date().toISOString().slice(0, 10), startedAt: new Date().toISOString(), completedAt: null, status: 'running', steps,
    };
  ...
  private _renderExecutionPanel(): unknown {
    ...
    return html`
      <div class="form-section">
        ...
        ` : html`<div class="empty-state">Click "Run Assessment" to start the Dpia Workflow analysis pipeline</div>`}
      </div>
      <div class="form-section">
        ...
        <div class="settings-card">
          ...
          <div style="display:flex;gap:8px;margin-top:4px;">
            <button class="btn primary" @click=${() => {
              ...
              const a = document.createElement('a'); a.href = url; a.download = 'dpia-workflow-config.json'; a.click();
    ...
    return html`
      <div style="margin-top:12px;">
        ...
        <div style="display:flex;gap:6px;margin-top:8px;">
          <input class="search-box" type="text" placeholder="Add a comment..." style="min-width:auto;flex:1;" id="dpia-workflow-comment-input" />
          <button class="btn primary" @click=${() => {
            const input = this.shadowRoot?.querySelector('#dpia-workflow-comment-input') as HTMLInputElement;
  ...
  private _exportJSON() {
    ...
    const url = URL.createObjectURL(blob);
    const a = document.createElement('a'); a.href = url; a.download = 'sc-dpia-workflow-data.json'; a.click();
    URL.revokeObjectURL(url);
  }
  ...
  private _exportCSV() {
    ...
    const url = URL.createObjectURL(blob);
    const a = document.createElement('a'); a.href = url; a.download = 'sc-dpia-workflow-data.csv'; a.click();
    URL.revokeObjectURL(url);
  }


  // --- Domain Rules Engine ---
  @state() private _dpiaRules: { id: string; name: string; category: string; severity: Severity; enabled: boolean; lastEval: string; passRate: number }[] = [];
  private _initDpiaRules() {
    const rules = [
    ...
    this._dpiaRules = rules;
  }
  private _evaluateDpiaRules(): { passed: number; failed: number; skipped: number; total: number } {
    let passed = 0, failed = 0, skipped = 0;
    this._dpiaRules.forEach(r => { if (!r.enabled) { skipped++; } else if (r.passRate >= 80) { passed++; } else { failed++; } });
    return { passed, failed, skipped, total: this._dpiaRules.length };
  }

  // --- CVSS Scoring ---
  @state() private _dpiacvssData: { itemId: string; vector: string; base: number; temporal: number; environmental: number; overall: number }[] = [];
  private _initDpiaCvss() {
    ...
    this._dpiacvssData = vectors.map((v, i) => {
  ...
  // --- Anomaly Detection ---
  @state() private _dpiaanomalies: { id: string; type: string; severity: Severity; description: string; detected: string; confidence: number; affected: string[] }[] = [];
  private _runDpiaAnomalyDetection() {
    const types = [
    ...
    this._dpiaanomalies = types.map((a, i) => ({
  ...
  // --- Trend Prediction ---
  @state() private _dpiapredictions: { horizon: string; metric: string; current: number; predicted: number; direction: 'up' | 'down' | 'stable'; confidence: number }[] = [];
  private _generateDpiaPredictions() {
    this._dpiapredictions = [
  ...
  // --- Approval Workflow ---
  @state() private _dpiaApprovals: { id: string; title: string; requester: string; status: 'pending' | 'approved' | 'rejected' | 'expired'; createdAt: string; priority: Priority; type: string }[] = [];
  private _initDpiaApprovals() {
    this._dpiaApprovals = [
  ...
  private _approveDpiaItem(id: string) { const item = this._dpiaApprovals.find(a => a.id === id); if (item) item.status = 'approved'; this.requestUpdate(); }
  private _rejectDpiaItem(id: string) { const item = this._dpiaApprovals.find(a => a.id === id); if (item) item.status = 'rejected'; this.requestUpdate(); }

  // --- Activity Feed ---
  @state() private _dpiaActivity: { id: string; action: string; user: string; target: string; timestamp: string }[] = [];
  private _initDpiaActivity() {
    const actions = [
    ...
    this._dpiaActivity = actions.map((a, i) => ({ id: 'ACT-' + String(i + 1).padStart(3, '0'), ...a, timestamp: new Date(Date.now() - i * 3600000).toISOString() }));
  }

  // --- Notification System ---
  @state() private _dpiaNotifications: { id: string; message: string; type: 'info' | 'warning' | 'error' | 'success'; read: boolean; timestamp: string }[] = [];
  private _initDpiaNotifications() {
    this._dpiaNotifications = [
  ...
  private _markDpiaNotifRead(id: string) { const n = this._dpiaNotifications.find(x => x.id === id); if (n) n.read = true; this.requestUpdate(); }

  // --- Panel Configuration ---
  @state() private _dpiaConfig: { layout: 'compact' | 'default' | 'expanded'; theme: 'dark' | 'midnight' | 'slate'; showAnomalies: boolean; showPredictions: boolean; autoRefresh: boolean; refreshInterval: number } = {
    layout: 'default', theme: 'dark', showAnomalies: true, showPredictions: true, autoRefresh: true, refreshInterval: 60,
  };
  private _dpiaPresets: { name: string; config: typeof this._dpiaConfig }[] = [
  ...
  private _applyDpiaPreset(preset: typeof this._dpiaPresets[0]) { this._dpiaConfig = { ...preset.config }; this.requestUpdate(); }

  private _renderDpiaTreemapSVG(): string {
    const categories = [
  ...
  private _renderDpiaSankeySVG(): string {
  ...
  // --- Render: Rules Engine ---
  private _renderDpiaRules(): any {
    const ev = this._evaluateDpiaRules();
    return html`
  ...
  private _renderDpiaAnomalies(): any {
    ...
    return html`
      <div style="background:#1a1d27;border-radius:8px;padding:12px;margin-top:12px">
        ...
        <div style="display:flex;flex-direction:column;gap:6px;max-height:160px;overflow-y:auto">
          $${this._dpiaanomalies.map(a => html`
  ...
  // --- Render: Approvals ---
  private _renderDpiaApprovals(): any {
    ...
    return html`
      <div style="background:#1a1d27;border-radius:8px;padding:12px;margin-top:12px">
        ...
        <div style="display:flex;flex-direction:column;gap:6px;max-height:160px;overflow-y:auto">
          $${this._dpiaApprovals.map(a => html`
            <div style="padding:6px 8px;background:#1f2937;border-radius:4px">
              ...
              $${a.status === 'pending' ? html`
                <div style="display:flex;gap:4px;margin-top:4px">
                  <button class="btn success" style="padding:2px 8px;font-size:9px" @click=$${() => this._approveDpiaItem(a.id)}>Approve</button>
                  <button class="btn error" style="padding:2px 8px;font-size:9px" @click=$${() => this._rejectDpiaItem(a.id)}>Reject</button>
                </div>` : nothing}
            </div>`)}
        </div>
      </div>`;
  ...
  private _renderDpiaNotifications(): any {
    const tc = (t: string) => t === 'error' ? '#ef4444' : t === 'warning' ? '#eab308' : t === 'success' ? '#22c55e' : '#3b82f6';
    const unread = this._dpiaNotifications.filter(n => !n.read).length;
    return html`
      <div style="background:#1a1d27;border-radius:8px;padding:12px;margin-top:12px">
        ...
        <div style="display:flex;flex-direction:column;gap:4px;max-height:120px;overflow-y:auto">
          $${this._dpiaNotifications.map(n => html`
            <div style="display:flex;align-items:center;gap:8px;padding:4px 8px;background:$${n.read ? '#1f2937' : '#252a36'};border-radius:4px;font-size:10px;opacity:$${n.read ? '0.6' : '1'};cursor:pointer" @click=$${() => this._markDpiaNotifRead(n.id)}>
      ...
      <div style="background:#1a1d27;border-radius:8px;padding:12px;margin-top:12px">
        ...
        <div style="display:flex;flex-direction:column;gap:6px;font-size:10px">
          <div style="display:flex;align-items:center;gap:8px">
            ...
            <select class="form-input" style="flex:1" @change=$${(e: Event) => { this._dpiaConfig.layout = (e.target as HTMLSelectElement).value as any; this.requestUpdate(); }}>
              <option value="compact" ?selected=$${this._dpiaConfig.layout === 'compact'}>Compact</option>
              <option value="default" ?selected=$${this._dpiaConfig.layout === 'default'}>Default</option>
              <option value="expanded" ?selected=$${this._dpiaConfig.layout === 'expanded'}>Expanded</option>
            </select>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Theme</span>
            <select class="form-input" style="flex:1" @change=$${(e: Event) => { this._dpiaConfig.theme = (e.target as HTMLSelectElement).value as any; this.requestUpdate(); }}>
              <option value="dark" ?selected=$${this._dpiaConfig.theme === 'dark'}>Dark</option>
              <option value="midnight" ?selected=$${this._dpiaConfig.theme === 'midnight'}>Midnight</option>
              <option value="slate" ?selected=$${this._dpiaConfig.theme === 'slate'}>Slate</option>
            </select>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Auto Refresh</span>
            <input type="checkbox" ?checked=$${this._dpiaConfig.autoRefresh} @change=$${() => { this._dpiaConfig.autoRefresh = !this._dpiaConfig.autoRefresh; this.requestUpdate(); }}/>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Show Anomalies</span>
            <input type="checkbox" ?checked=$${this._dpiaConfig.showAnomalies} @change=$${() => { this._dpiaConfig.showAnomalies = !this._dpiaConfig.showAnomalies; this.requestUpdate(); }}/>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Show Predictions</span>
            <input type="checkbox" ?checked=$${this._dpiaConfig.showPredictions} @change=$${() => { this._dpiaConfig.showPredictions = !this._dpiaConfig.showPredictions; this.requestUpdate(); }}/>
          </div>
          <div style="margin-top:6px;font-weight:600">Presets</div>
          <div style="display:flex;gap:4px">
            $${this._dpiaPresets.map(ps => html`<button class="btn" style="padding:2px 8px;font-size:9px" @click=$${() => this._applyDpiaPreset(ps)}>$${ps.name}</button>`)}
          </div>
        </div>
      </div>`;
  }
...
@state() private _spmComplianceCheck6 = { id: "CHK-006", control: "Control 6", framework: "NIST 800-53", status: "pass", evidenceCount: 4, lastAudit: "2026-01-11", nextAudit: "2026-04-11", findings: 2 } as any;
  ...
  @state() private _dpiaWorkflowRiskTopTen: Array<{id:string;name:string;score:number;trend:string;owner:string;category:string;lastAssessed:string}> = [
  ...
  @state() private _dpiaWorkflowRiskCategories: Array<{category:string;count:number;avgScore:number;color:string}> = [
  ...
  @state() private _dpiaWorkflowRiskVelocity: Array<{week:string;newRisks:number;closedRisks:number;netChange:number}> = [
  ...
  @state() private _dpiaWorkflowRiskAppetite: {current:number;threshold:number;maxTolerated:number;status:string} = {
    current: 68, threshold: 55, maxTolerated: 80, status: 'Warning'
  };
  @state() private _dpiaWorkflowRiskOwnerMatrix: Array<{owner:string;criticalCount:number;highCount:number;mediumCount:number;complianceRate:number}> = [
  ...
  private _renderDpiaworkflowRiskDash(): TemplateResult {
    const riskItems = this._dpiaWorkflowRiskTopTen;
    const velocity = this._dpiaWorkflowRiskVelocity;
    const appetite = this._dpiaWorkflowRiskAppetite;
    return html`
  ...
  @state() private _dpiaWorkflowContainerScans: Array<{image:string;registry:string;critical:number;high:number;medium:number;scanDate:string;status:string}> = [
  ...
  @state() private _dpiaWorkflowK8sPods: Array<{namespace:string;pod:string;securityContext:string;hostIPC:boolean;hostPID:boolean;privileged:boolean;riskLevel:string}> = [
  ...
  @state() private _dpiaWorkflowServerlessRisk: Array<{function:string;runtime:string;timeout:number;iamPerms:string;externalCalls:number;riskScore:number}> = [
  ...
  @state() private _dpiaWorkflowRuntimeAlerts: Array<{id:string;workload:string;alertType:string;severity:string;description:string;timestamp:string}> = [
  ...
  private _renderDpiaworkflowCloudWl(): TemplateResult {
    const containers = this._dpiaWorkflowContainerScans;
    const pods = this._dpiaWorkflowK8sPods;
    const alerts = this._dpiaWorkflowRuntimeAlerts;
    return html`
  ...
  @state() private _dpiaWorkflowCourses: Array<{id:string;title:string;category:string;duration:number;enrolled:number;completed:number;difficulty:string;rating:number}> = [
  ...
  @state() private _dpiaWorkflowLearningPaths: Array<{id:string;name:string;courseIds:string[];progress:number;enrolled:number}> = [
  ...
  @state() private _dpiaWorkflowDeptCompliance: Array<{dept:string;trainedPct:number;targetPct:number;avgScore:number;certCount:number}> = [
  ...
  @state() private _dpiaWorkflowSkillsGaps: Array<{skill:string;current:number;required:number;gap:number;priority:string}> = [
  ...
  private _renderDpiaworkflowTraining(): TemplateResult {
    const courses = this._dpiaWorkflowCourses;
    const deptComp = this._dpiaWorkflowDeptCompliance;
    return html`
  ...
  @state() private _dpiaWorkflowCorrRules: Array<{id:string;name:string;sources:string[];logic:string;severity:string;active:boolean;lastTriggered:string}> = [
  ...
  @state() private _dpiaWorkflowEventTimeline: Array<{timestamp:string;source:string;eventType:string;details:string;correlated:boolean}> = [
  ...
  @state() private _dpiaWorkflowFalsePosMetrics: {totalEvents:number;correlatedEvents:number;falsePositives:number;fpRate:number;topFpRules:string[]} = {
  ...
  @state() private _dpiaWorkflowEventPatterns: Array<{id:string;pattern:string;frequency:number;firstSeen:string;lastSeen:string;status:string}> = [
  ...
  private _renderDpiaworkflowEventCorr(): TemplateResult {
    const rules = this._dpiaWorkflowCorrRules;
    const timeline = this._dpiaWorkflowEventTimeline;
    const fpMetrics = this._dpiaWorkflowFalsePosMetrics;
    return html`
  ...
  @state() private _complianceCalendarEvents: Array<{id: string; title: string; deadline: string; category: string; status: string; assignee: string; notes: string}> = [
    {id: 'cc-dpia-workflow-001', title: 'SOX Section 404 Compliance Review', deadline: '2026-06-30', category: 'Regulatory', status: 'In Progress', assignee: 'Compliance Team', notes: 'Annual internal control assessment for financial reporting'},
    {id: 'cc-dpia-workflow-002', title: 'GDPR Data Protection Impact Assessment', deadline: '2026-05-15', category: 'Privacy', status: 'Pending', assignee: 'DPO Office', notes: 'Quarterly DPIA for high-risk processing activities'},
    {id: 'cc-dpia-workflow-003', title: 'ISO 27001 Surveillance Audit', deadline: '2026-07-20', category: 'Certification', status: 'Scheduled', assignee: 'QA Lead', notes: 'Stage 2 surveillance audit for ISMS certification renewal'},
    {id: 'cc-dpia-workflow-004', title: 'PCI DSS v4.0 Gap Analysis', deadline: '2026-05-30', category: 'Payment', status: 'Not Started', assignee: 'Security Architect', notes: 'Assess current state against PCI DSS v4.0 requirements'},
    {id: 'cc-dpia-workflow-005', title: 'NIST CSF Self-Assessment', deadline: '2026-08-15', category: 'Framework', status: 'Pending', assignee: 'CISO', notes: 'Biannual self-assessment against NIST Cybersecurity Framework'},
    {id: 'cc-dpia-workflow-006', title: 'HIPAA Security Rule Audit', deadline: '2026-06-15', category: 'Healthcare', status: 'In Progress', assignee: 'Compliance Analyst', notes: 'Annual audit of administrative, physical, and technical safeguards'},
    {id: 'cc-dpia-workflow-007', title: 'SOC 2 Type II Report Renewal', deadline: '2026-09-30', category: 'Audit', status: 'Scheduled', assignee: 'External Auditor', notes: 'Engage auditor for SOC 2 Type II examination period'},
    {id: 'cc-dpia-workflow-008', title: 'FedRAMP Authorization Review', deadline: '2026-07-01', category: 'Government', status: 'Pending', assignee: 'FedRAMP PMO', notes: 'Review and update security authorization package'},
    {id: 'cc-dpia-workflow-009', title: 'Annual Penetration Test', deadline: '2026-10-15', category: 'Testing', status: 'Not Started', assignee: 'Red Team Lead', notes: 'Comprehensive external and internal penetration testing engagement'},
    {id: 'cc-dpia-workflow-010', title: 'Security Awareness Training Rollout', deadline: '2026-05-01', category: 'Training', status: 'Completed', assignee: 'Security Awareness Manager', notes: 'Q2 organization-wide security awareness training program'},
    {id: 'cc-dpia-workflow-011', title: 'Vendor Security Review Cycle', deadline: '2026-06-01', category: 'Third Party', status: 'In Progress', assignee: 'Vendor Manager', notes: 'Quarterly review of critical vendor security posture and SLA compliance'},
    {id: 'cc-dpia-workflow-012', title: 'Incident Response Plan Update', deadline: '2026-05-20', category: 'Operations', status: 'Pending', assignee: 'IR Team Lead', notes: 'Update IR procedures based on lessons learned from recent incidents'},
  ];
  ...
  @state() private _dataQualityMetrics: Array<{id: string; dataSource: string; completenessScore: number; accuracyScore: number; timelinessScore: number; consistencyScore: number; reliabilityRank: number; lastUpdated: string; issues: string[]; trend: string}> = [
    {id: 'dq-dpia-workflow-001', dataSource: 'Vulnerability Scanner Feed', completenessScore: 94, accuracyScore: 91, timelinessScore: 88, consistencyScore: 95, reliabilityRank: 1, lastUpdated: '2026-04-23T08:00:00Z', issues: ['Minor delay in Nessus plugin updates'], trend: 'improving'},
    {id: 'dq-dpia-workflow-002', dataSource: 'SIEM Event Logs', completenessScore: 87, accuracyScore: 93, timelinessScore: 96, consistencyScore: 89, reliabilityRank: 2, lastUpdated: '2026-04-23T07:30:00Z', issues: ['Some log sources showing gaps in off-hours'], trend: 'stable'},
    {id: 'dq-dpia-workflow-003', dataSource: 'Asset Inventory Database', completenessScore: 82, accuracyScore: 78, timelinessScore: 75, consistencyScore: 84, reliabilityRank: 4, lastUpdated: '2026-04-22T18:00:00Z', issues: ['Shadow IT devices not fully cataloged', 'Decommissioned assets still listed'], trend: 'declining'},
    {id: 'dq-dpia-workflow-004', dataSource: 'Threat Intelligence Platform', completenessScore: 91, accuracyScore: 89, timelinessScore: 92, consistencyScore: 87, reliabilityRank: 3, lastUpdated: '2026-04-23T06:00:00Z', issues: ['Some IOC sources lack confidence scoring'], trend: 'improving'},
    {id: 'dq-dpia-workflow-005', dataSource: 'Identity Provider Logs', completenessScore: 96, accuracyScore: 97, timelinessScore: 98, consistencyScore: 96, reliabilityRank: 1, lastUpdated: '2026-04-23T09:00:00Z', issues: [], trend: 'stable'},
    {id: 'dq-dpia-workflow-006', dataSource: 'Cloud Security Posture Data', completenessScore: 79, accuracyScore: 85, timelinessScore: 82, consistencyScore: 81, reliabilityRank: 5, lastUpdated: '2026-04-23T05:00:00Z', issues: ['Multi-cloud coverage gaps', 'API rate limiting affects scan frequency'], trend: 'declining'},
    {id: 'dq-dpia-workflow-007', dataSource: 'Compliance Evidence Store', completenessScore: 88, accuracyScore: 86, timelinessScore: 80, consistencyScore: 83, reliabilityRank: 4, lastUpdated: '2026-04-21T14:00:00Z', issues: ['Manual evidence collection delays', 'Inconsistent formatting across frameworks'], trend: 'stable'},
    {id: 'dq-dpia-workflow-008', dataSource: 'Network Flow Data', completenessScore: 92, accuracyScore: 90, timelinessScore: 94, consistencyScore: 91, reliabilityRank: 2, lastUpdated: '2026-04-23T08:30:00Z', issues: ['Encrypted traffic classification accuracy needs improvement'], trend: 'improving'},
  ];
  ...
  @state() private _workflowTemplates: Array<{id: string; name: string; description: string; category: string; steps: number; avgDuration: string; successRate: number; lastRun: string; manualInterventions: number; optimizationScore: number}> = [
    {id: 'wf-dpia-workflow-001', name: 'Vulnerability Triage Pipeline', description: 'Automated vulnerability assessment, prioritization, and assignment workflow', category: 'Vulnerability Management', steps: 8, avgDuration: '12 min', successRate: 94.5, lastRun: '2026-04-23T06:00:00Z', manualInterventions: 2, optimizationScore: 87},
    {id: 'wf-dpia-workflow-002', name: 'Incident Response Orchestration', description: 'End-to-end IR workflow from detection to containment and recovery', category: 'Incident Response', steps: 15, avgDuration: '45 min', successRate: 89.2, lastRun: '2026-04-22T14:30:00Z', manualInterventions: 5, optimizationScore: 72},
    {id: 'wf-dpia-workflow-003', name: 'Access Request Approval Chain', description: 'Multi-level approval workflow for privileged access requests', category: 'Identity & Access', steps: 6, avgDuration: '4 hours', successRate: 97.1, lastRun: '2026-04-23T09:15:00Z', manualInterventions: 1, optimizationScore: 92},
    {id: 'wf-dpia-workflow-004', name: 'Compliance Evidence Collection', description: 'Automated gathering and packaging of audit evidence artifacts', category: 'Compliance', steps: 10, avgDuration: '30 min', successRate: 91.8, lastRun: '2026-04-21T10:00:00Z', manualInterventions: 3, optimizationScore: 78},
    {id: 'wf-dpia-workflow-005', name: 'Security Patch Deployment', description: 'Staged patch rollout with validation and rollback capability', category: 'Patch Management', steps: 12, avgDuration: '2 hours', successRate: 96.3, lastRun: '2026-04-20T22:00:00Z', manualInterventions: 1, optimizationScore: 85},
    {id: 'wf-dpia-workflow-006', name: 'Threat Intelligence Enrichment', description: 'IOC enrichment and correlation with internal threat data', category: 'Threat Intelligence', steps: 7, avgDuration: '8 min', successRate: 93.7, lastRun: '2026-04-23T07:00:00Z', manualInterventions: 0, optimizationScore: 95},
    {id: 'wf-dpia-workflow-007', name: 'Security Reporting Pipeline', description: 'Automated generation and distribution of security metrics reports', category: 'Reporting', steps: 5, avgDuration: '15 min', successRate: 98.9, lastRun: '2026-04-23T08:00:00Z', manualInterventions: 0, optimizationScore: 97},
    {id: 'wf-dpia-workflow-008', name: 'Vendor Risk Assessment', description: 'Automated vendor security questionnaire distribution and scoring', category: 'Third Party', steps: 9, avgDuration: '3 days', successRate: 85.4, lastRun: '2026-04-19T11:00:00Z', manualInterventions: 4, optimizationScore: 65},
  ];
  ...
  @state() private _workflowExecutionHistory: Array<{workflowId: string; runDate: string; duration: string; status: string; trigger: string}> = [
    {workflowId: 'wf-dpia-workflow-001', runDate: '2026-04-23T06:00:00Z', duration: '11 min 23 sec', status: 'Success', trigger: 'Scheduled'},
    {workflowId: 'wf-dpia-workflow-002', runDate: '2026-04-22T14:30:00Z', duration: '42 min 15 sec', status: 'Success', trigger: 'Alert'},
    {workflowId: 'wf-dpia-workflow-003', runDate: '2026-04-23T09:15:00Z', duration: '3h 45 min', status: 'Success', trigger: 'User Request'},
    {workflowId: 'wf-dpia-workflow-001', runDate: '2026-04-22T06:00:00Z', duration: '13 min 08 sec', status: 'Partial', trigger: 'Scheduled'},
    {workflowId: 'wf-dpia-workflow-004', runDate: '2026-04-21T10:00:00Z', duration: '28 min 42 sec', status: 'Success', trigger: 'Scheduled'},
  ];
  ...
  @state() private _knowledgeArticles: Array<{id: string; title: string; category: string; author: string; publishDate: string; views: number; rating: number; tags: string[]; summary: string; readTime: string}> = [
    {id: 'kb-dpia-workflow-001', title: 'Zero Trust Architecture Implementation Guide', category: 'Architecture', author: 'Security Architecture Team', publishDate: '2026-03-15', views: 1842, rating: 4.8, tags: ['zero-trust', 'network', 'identity'], summary: 'Comprehensive guide for implementing zero trust principles across enterprise infrastructure', readTime: '15 min'},
    {id: 'kb-dpia-workflow-002', title: 'Ransomware Defense Playbook 2026', category: 'Threats', author: 'Threat Intelligence Team', publishDate: '2026-04-01', views: 2341, rating: 4.9, tags: ['ransomware', 'incident-response', 'defense'], summary: 'Updated playbook with latest ransomware tactics, techniques, and defensive measures', readTime: '12 min'},
    {id: 'kb-dpia-workflow-003', title: 'Cloud Security Best Practices for Multi-Cloud', category: 'Cloud', author: 'Cloud Security Team', publishDate: '2026-02-28', views: 1567, rating: 4.5, tags: ['cloud', 'aws', 'azure', 'gcp'], summary: 'Best practices for securing workloads across multiple cloud service providers', readTime: '18 min'},
    {id: 'kb-dpia-workflow-004', title: 'API Security Testing Methodology', category: 'Testing', author: 'Red Team', publishDate: '2026-03-22', views: 987, rating: 4.6, tags: ['api', 'testing', 'owasp'], summary: 'Structured methodology for identifying and testing API security vulnerabilities', readTime: '10 min'},
    {id: 'kb-dpia-workflow-005', title: 'Supply Chain Security Risk Management', category: 'Third Party', author: 'GRC Team', publishDate: '2026-01-20', views: 1234, rating: 4.3, tags: ['supply-chain', 'vendor', 'risk'], summary: 'Framework for managing security risks in the software supply chain', readTime: '14 min'},
    {id: 'kb-dpia-workflow-006', title: 'Kubernetes Security Hardening Checklist', category: 'Container', author: 'Platform Security', publishDate: '2026-04-10', views: 2103, rating: 4.7, tags: ['kubernetes', 'container', 'hardening'], summary: 'Step-by-step hardening checklist for production Kubernetes clusters', readTime: '11 min'},
    {id: 'kb-dpia-workflow-007', title: 'Security Metrics That Matter for Executives', category: 'Metrics', author: 'CISO Office', publishDate: '2026-03-05', views: 876, rating: 4.4, tags: ['metrics', 'kpi', 'reporting'], summary: 'Key security metrics and KPIs that resonate with board-level stakeholders', readTime: '8 min'},
    {id: 'kb-dpia-workflow-008', title: 'Phishing Simulation Campaign Design', category: 'Awareness', author: 'Security Awareness Team', publishDate: '2026-02-15', views: 1456, rating: 4.5, tags: ['phishing', 'simulation', 'training'], summary: 'Designing effective phishing simulations that drive real behavioral change', readTime: '9 min'},
    {id: 'kb-dpia-workflow-009', title: 'Data Loss Prevention Strategy and Implementation', category: 'Data Protection', author: 'Data Security Team', publishDate: '2026-03-28', views: 1678, rating: 4.6, tags: ['dlp', 'data-protection', 'compliance'], summary: 'Strategic approach to DLP covering people, process, and technology layers', readTime: '16 min'},
    {id: 'kb-dpia-workflow-010', title: 'Security Automation with SOAR Platforms', category: 'Automation', author: 'SOC Engineering', publishDate: '2026-04-05', views: 1098, rating: 4.7, tags: ['soar', 'automation', 'soc'], summary: 'Building effective security automation playbooks using SOAR technology', readTime: '13 min'},
    {id: 'kb-dpia-workflow-011', title: 'Third-Party Risk Assessment Framework', category: 'GRC', author: 'Vendor Management', publishDate: '2026-01-30', views: 1345, rating: 4.4, tags: ['vendor', 'risk', 'assessment'], summary: 'Structured framework for evaluating and monitoring third-party security risks', readTime: '12 min'},
    {id: 'kb-dpia-workflow-012', title: 'Network Detection and Response Best Practices', category: 'Network', author: 'Network Security Team', publishDate: '2026-03-18', views: 1567, rating: 4.5, tags: ['ndr', 'network', 'detection'], summary: 'Implementing effective network detection and response capabilities', readTime: '14 min'},
    {id: 'kb-dpia-workflow-013', title: 'Security Chaos Engineering Guide', category: 'Resilience', author: 'SRE Security', publishDate: '2026-04-12', views: 789, rating: 4.3, tags: ['chaos-engineering', 'resilience', 'testing'], summary: 'Applying chaos engineering principles to validate security controls', readTime: '10 min'},
    {id: 'kb-dpia-workflow-014', title: 'Incident Communication Templates', category: 'Incident Response', author: 'IR Team', publishDate: '2026-02-22', views: 2234, rating: 4.8, tags: ['incident', 'communication', 'templates'], summary: 'Ready-to-use communication templates for security incident scenarios', readTime: '7 min'},
    {id: 'kb-dpia-workflow-015', title: 'Endpoint Detection and Response Configuration', category: 'Endpoint', author: 'Endpoint Security', publishDate: '2026-03-08', views: 1345, rating: 4.5, tags: ['edr', 'endpoint', 'configuration'], summary: 'Optimal EDR configuration for maximum detection with minimal false positives', readTime: '11 min'},
    {id: 'kb-dpia-workflow-016', title: 'Security Code Review Standards', category: 'Development', author: 'AppSec Team', publishDate: '2026-02-10', views: 1890, rating: 4.6, tags: ['code-review', 'secure-sdlc', 'standards'], summary: 'Standards and checklists for security-focused code reviews', readTime: '13 min'},
    {id: 'kb-dpia-workflow-017', title: 'IoT Security Assessment Methodology', category: 'IoT', author: 'IoT Security Lab', publishDate: '2026-04-08', views: 654, rating: 4.2, tags: ['iot', 'embedded', 'assessment'], summary: 'Methodology for assessing security posture of IoT devices and ecosystems', readTime: '15 min'},
    {id: 'kb-dpia-workflow-018', title: 'Passwordless Authentication Migration Guide', category: 'Identity', author: 'IAM Team', publishDate: '2026-03-25', views: 1678, rating: 4.7, tags: ['passwordless', 'authentication', 'mfa'], summary: 'Step-by-step migration plan from password-based to passwordless authentication', readTime: '12 min'},
    {id: 'kb-dpia-workflow-019', title: 'Security Awareness Program Metrics', category: 'Awareness', author: 'Security Culture Team', publishDate: '2026-01-25', views: 1123, rating: 4.4, tags: ['awareness', 'metrics', 'culture'], summary: 'Measuring the effectiveness of your security awareness and training programs', readTime: '9 min'},
    {id: 'kb-dpia-workflow-020', title: 'Deception Technology Deployment Guide', category: 'Detection', author: 'Blue Team', publishDate: '2026-04-15', views: 876, rating: 4.5, tags: ['deception', 'honeypot', 'detection'], summary: 'Planning and deploying deception technology for advanced threat detection', readTime: '11 min'},
  ];
  ...
  // --- Security Scenario Planning Methods (DPWO) ---
  private _initDpwoScenarios(): void {
    const worstCaseScenarios = [
      { id: "dpwo-sc-01", name: "Ransomware Attack on Critical Infrastructure", category: "Malware", impact: 9500000, probability: 0.12, recoveryDays: 21, affectedSystems: 47, dataLossGb: 320, businessImpact: "critical" },
      { id: "dpwo-sc-02", name: "Insider Data Exfiltration via Authorized Channels", category: "Insider Threat", impact: 7200000, probability: 0.18, recoveryDays: 14, affectedSystems: 12, dataLossGb: 85, businessImpact: "high" },
      { id: "dpwo-sc-03", name: "Supply Chain Compromise via Third-Party Library", category: "Supply Chain", impact: 6800000, probability: 0.09, recoveryDays: 30, affectedSystems: 63, dataLossGb: 0, businessImpact: "critical" },
      { id: "dpwo-sc-04", name: "Cloud Misconfiguration Leading to Public Exposure", category: "Cloud", impact: 4100000, probability: 0.22, recoveryDays: 7, affectedSystems: 8, dataLossGb: 450, businessImpact: "high" },
      { id: "dpwo-sc-05", name: "Zero-Day Exploit in Core Application Framework", category: "Vulnerability", impact: 8900000, probability: 0.05, recoveryDays: 45, affectedSystems: 120, dataLossGb: 0, businessImpact: "critical" },
      { id: "dpwo-sc-06", name: "Distributed Denial of Service on Customer-Facing Services", category: "Availability", impact: 3400000, probability: 0.25, recoveryDays: 3, affectedSystems: 15, dataLossGb: 0, businessImpact: "medium" },
      { id: "dpwo-sc-07", name: "Credential Stuffing and Account Takeover Wave", category: "Identity", impact: 2800000, probability: 0.30, recoveryDays: 5, affectedSystems: 6, dataLossGb: 12, businessImpact: "medium" },
      { id: "dpwo-sc-08", name: "Physical Security Breach at Data Center Facility", category: "Physical", impact: 12000000, probability: 0.02, recoveryDays: 60, affectedSystems: 200, dataLossGb: 5000, businessImpact: "critical" },
    ];
    this._dpwoScenarios = worstCaseScenarios.map(s => ({ ...s, mitigationCost: Math.round(s.impact * 0.08), drillScheduled: false, lastDrillDate: null, drillScore: null, controlGaps: Math.floor(Math.random() * 5) + 1 }));
  }

  private _calculateDpwoScenarioRisk(): void {
    this._dpwoScenarios.forEach(s => {
  ...
  private _scheduleDpwoDrills(): void {
  ...
  private _dpwoScenarioComparison(): Record<string, unknown>[] {
    return this._dpwoScenarios.map(s => ({
  ...
  // --- Security Control Effectiveness Analytics (DPWO) ---
  private _initDpwoControls(): void {
    const controls = [
      { id: "dpwo-ct-01", name: "Network Segmentation", type: "preventive", maturity: "defined", score: 82, target: 90, failures: 3, lastTest: "2026-03-15" },
      { id: "dpwo-ct-02", name: "Endpoint Detection and Response", type: "detective", maturity: "managed", score: 88, target: 92, failures: 1, lastTest: "2026-04-01" },
      { id: "dpwo-ct-03", name: "Data Loss Prevention", type: "preventive", maturity: "repeatable", score: 71, target: 85, failures: 7, lastTest: "2026-03-22" },
      { id: "dpwo-ct-04", name: "Security Information and Event Management", type: "detective", maturity: "managed", score: 85, target: 90, failures: 2, lastTest: "2026-04-05" },
      { id: "dpwo-ct-05", name: "Identity and Access Management", type: "preventive", maturity: "defined", score: 76, target: 88, failures: 5, lastTest: "2026-03-28" },
      { id: "dpwo-ct-06", name: "Vulnerability Management", type: "corrective", maturity: "managed", score: 80, target: 90, failures: 4, lastTest: "2026-04-02" },
      { id: "dpwo-ct-07", name: "Email Security Gateway", type: "preventive", maturity: "managed", score: 90, target: 95, failures: 1, lastTest: "2026-04-08" },
      { id: "dpwo-ct-08", name: "Web Application Firewall", type: "preventive", maturity: "managed", score: 87, target: 92, failures: 2, lastTest: "2026-03-30" },
      { id: "dpwo-ct-09", name: "Patch Management", type: "corrective", maturity: "defined", score: 68, target: 85, failures: 9, lastTest: "2026-03-18" },
      { id: "dpwo-ct-10", name: "Encryption at Rest", type: "preventive", maturity: "managed", score: 93, target: 95, failures: 0, lastTest: "2026-04-10" },
      { id: "dpwo-ct-11", name: "Encryption in Transit", type: "preventive", maturity: "optimized", score: 96, target: 98, failures: 0, lastTest: "2026-04-12" },
      { id: "dpwo-ct-12", name: "Privileged Access Management", type: "preventive", maturity: "defined", score: 74, target: 88, failures: 6, lastTest: "2026-03-25" },
      { id: "dpwo-ct-13", name: "Security Awareness Training", type: "preventive", maturity: "repeatable", score: 65, target: 80, failures: 11, lastTest: "2026-03-20" },
      { id: "dpwo-ct-14", name: "Incident Response Plan", type: "corrective", maturity: "managed", score: 78, target: 88, failures: 4, lastTest: "2026-04-03" },
      { id: "dpwo-ct-15", name: "Backup and Recovery", type: "corrective", maturity: "managed", score: 84, target: 92, failures: 3, lastTest: "2026-04-06" },
      { id: "dpwo-ct-16", name: "Multi-Factor Authentication", type: "preventive", maturity: "managed", score: 91, target: 95, failures: 1, lastTest: "2026-04-09" },
      { id: "dpwo-ct-17", name: "Network Traffic Analysis", type: "detective", maturity: "defined", score: 72, target: 85, failures: 5, lastTest: "2026-03-27" },
      { id: "dpwo-ct-18", name: "Cloud Security Posture Management", type: "detective", maturity: "repeatable", score: 69, target: 82, failures: 8, lastTest: "2026-03-24" },
      { id: "dpwo-ct-19", name: "Container Security Scanning", type: "preventive", maturity: "defined", score: 75, target: 85, failures: 5, lastTest: "2026-04-04" },
      { id: "dpwo-ct-20", name: "API Security Gateway", type: "preventive", maturity: "repeatable", score: 70, target: 82, failures: 7, lastTest: "2026-03-29" },
      { id: "dpwo-ct-21", name: "Threat Intelligence Platform", type: "detective", maturity: "managed", score: 83, target: 90, failures: 2, lastTest: "2026-04-07" },
      { id: "dpwo-ct-22", name: "Database Activity Monitoring", type: "detective", maturity: "defined", score: 67, target: 80, failures: 8, lastTest: "2026-03-21" },
      { id: "dpwo-ct-23", name: "Deception Technology", type: "detective", maturity: "initial", score: 55, target: 75, failures: 12, lastTest: "2026-03-16" },
      { id: "dpwo-ct-24", name: "Security Orchestration Automation", type: "corrective", maturity: "repeatable", score: 73, target: 85, failures: 6, lastTest: "2026-04-01" },
      { id: "dpwo-ct-25", name: "Third-Party Risk Assessment", type: "preventive", maturity: "defined", score: 64, target: 78, failures: 9, lastTest: "2026-03-19" },
    ];
    this._dpwoControls = controls;
  }

  private _analyzeDpwoControlEffectiveness(): void {
    const typeBreakdown: Record<string, { total: number; avgScore: number; avgFailures: number }> = {};
    this._dpwoControls.forEach(c => {
    ...
    this._dpwoControlTypeBreakdown = typeBreakdown;
  }

  private _dpwoControlOptimization(): Record<string, unknown>[] {
    return this._dpwoControls.filter(c => c.score < c.target).map(c => ({
  ...
  // --- Security Data Pipeline Health (DPWO) ---
  private _initDpwoPipelines(): void {
    const pipelines = [
      { id: "dpwo-pl-01", name: "SIEM Log Ingestion", status: "healthy", healthScore: 94, latencyMs: 120, freshnessMin: 2, errorRate: 0.02, throughputMbps: 450, recordsPerSec: 12000, backPressure: 0.05, uptime: 99.97 },
      { id: "dpwo-pl-02", name: "Threat Feed Aggregation", status: "healthy", healthScore: 91, latencyMs: 300, freshnessMin: 15, errorRate: 0.05, throughputMbps: 85, recordsPerSec: 3200, backPressure: 0.08, uptime: 99.92 },
      { id: "dpwo-pl-03", name: "Vulnerability Scan Results", status: "degraded", healthScore: 72, latencyMs: 2500, freshnessMin: 60, errorRate: 0.15, throughputMbps: 25, recordsPerSec: 800, backPressure: 0.35, uptime: 98.50 },
      { id: "dpwo-pl-04", name: "Endpoint Telemetry Stream", status: "healthy", healthScore: 88, latencyMs: 450, freshnessMin: 5, errorRate: 0.08, throughputMbps: 280, recordsPerSec: 8500, backPressure: 0.12, uptime: 99.85 },
      { id: "dpwo-pl-05", name: "Cloud Audit Log Pipeline", status: "healthy", healthScore: 86, latencyMs: 600, freshnessMin: 10, errorRate: 0.06, throughputMbps: 150, recordsPerSec: 4500, backPressure: 0.10, uptime: 99.80 },
      { id: "dpwo-pl-06", name: "Identity Event Stream", status: "warning", healthScore: 78, latencyMs: 1200, freshnessMin: 20, errorRate: 0.12, throughputMbps: 45, recordsPerSec: 1500, backPressure: 0.22, uptime: 99.40 },
      { id: "dpwo-pl-07", name: "Network Flow Collection", status: "healthy", healthScore: 82, latencyMs: 800, freshnessMin: 8, errorRate: 0.09, throughputMbps: 650, recordsPerSec: 18000, backPressure: 0.15, uptime: 99.70 },
      { id: "dpwo-pl-08", name: "DLP Incident Pipeline", status: "degraded", healthScore: 68, latencyMs: 3500, freshnessMin: 45, errorRate: 0.20, throughputMbps: 18, recordsPerSec: 500, backPressure: 0.42, uptime: 97.80 },
    ];
    this._dpwoPipelines = pipelines.map(p => ({ ...p, dependencies: [], slaBreached: p.healthScore < 75, alertThreshold: p.errorRate > 0.15 }));
    this._dpwoPipelines[0].dependencies = ["dpwo-pl-04", "dpwo-pl-07"];
    this._dpwoPipelines[4].dependencies = ["dpwo-pl-01"];
    this._dpwoPipelines[5].dependencies = ["dpwo-pl-02"];
    this._dpwoPipelines[7].dependencies = ["dpwo-pl-04", "dpwo-pl-05"];
  }

  private _dpwoPipelineTrend(): Record<string, unknown>[] {
    const hours = Array.from({ length: 24 }, (_, i) => `H${String(i).padStart(2, "0")}`);
    return this._dpwoPipelines.map(p => ({
  ...
  // --- Security Stakeholder Report Generator (DPWO) ---
  private _initDpwoReportTemplates(): void {
    this._dpwoReportTemplates = [
      { id: "dpwo-rp-01", name: "Board Security Report", audience: "board", frequency: "quarterly", sections: 6, autoGenerate: true, lastGenerated: "2026-03-31", pages: 12 },
      { id: "dpwo-rp-02", name: "Executive Risk Summary", audience: "executive", frequency: "monthly", sections: 8, autoGenerate: true, lastGenerated: "2026-04-01", pages: 8 },
      { id: "dpwo-rp-03", name: "Technical Security Review", audience: "technical", frequency: "weekly", sections: 12, autoGenerate: true, lastGenerated: "2026-04-21", pages: 25 },
      { id: "dpwo-rp-04", name: "Audit Compliance Report", audience: "audit", frequency: "quarterly", sections: 10, autoGenerate: false, lastGenerated: "2026-03-15", pages: 35 },
      { id: "dpwo-rp-05", name: "Regulatory Filing Package", audience: "regulatory", frequency: "annual", sections: 15, autoGenerate: false, lastGenerated: "2025-12-31", pages: 48 },
    ];
  }

  private _generateDpwoExecSummary(): string {
    const totalRisk = this._dpwoScenarios.reduce((sum: number, s: any) => sum + s.riskScore, 0);
    const avgControl = Math.round(this._dpwoControls.reduce((sum: number, c: any) => sum + c.score, 0) / this._dpwoControls.length);
    const degradedPipes = this._dpwoPipelines.filter((p: any) => p.status !== "healthy").length;
    return `Overall risk exposure: ${(totalRisk / 1000000).toFixed(1)}M. Average control effectiveness: {avgControl}%. {degradedPipes} pipeline(s) need attention. {this._dpwoScenarios.filter((s: any) => s.mitigationPriority === "immediate").length} scenarios require immediate action.`;
  }

  // --- Security Technology Radar (DPWO) ---
  private _initDpwoTechRadar(): void {
    this._dpwoTechRadar = [
      { id: "dpwo-tr-01", name: "AI-Powered Threat Detection", ring: "adopt", category: "Detection", maturity: 4, trend: "up", investment: "high", roi: 3.2, vendorCount: 8 },
      { id: "dpwo-tr-02", name: "Zero Trust Architecture", ring: "adopt", category: "Architecture", maturity: 4, trend: "up", investment: "high", roi: 2.8, vendorCount: 12 },
      { id: "dpwo-tr-03", name: "SASE/SSE Platform", ring: "trial", category: "Network", maturity: 3, trend: "up", investment: "medium", roi: 2.4, vendorCount: 10 },
      { id: "dpwo-tr-04", name: "CNAPP Cloud Security", ring: "trial", category: "Cloud", maturity: 3, trend: "up", investment: "medium", roi: 2.1, vendorCount: 7 },
      { id: "dpwo-tr-05", name: "Extended Detection and Response", ring: "adopt", category: "Detection", maturity: 4, trend: "stable", investment: "high", roi: 2.9, vendorCount: 9 },
      { id: "dpwo-tr-06", name: "Quantum-Safe Cryptography", ring: "assess", category: "Crypto", maturity: 2, trend: "up", investment: "low", roi: 0.8, vendorCount: 4 },
      { id: "dpwo-tr-07", name: "Security Service Edge", ring: "trial", category: "Network", maturity: 3, trend: "up", investment: "medium", roi: 2.0, vendorCount: 6 },
      { id: "dpwo-tr-08", name: "SOAR 2.0 Autonomous SOC", ring: "assess", category: "Operations", maturity: 2, trend: "up", investment: "low", roi: 1.2, vendorCount: 5 },
      { id: "dpwo-tr-09", name: "Software Supply Chain Security", ring: "trial", category: "DevSecOps", maturity: 3, trend: "up", investment: "medium", roi: 2.3, vendorCount: 8 },
      { id: "dpwo-tr-10", name: "Identity Threat Detection", ring: "adopt", category: "Identity", maturity: 3, trend: "up", investment: "high", roi: 2.7, vendorCount: 7 },
      { id: "dpwo-tr-11", name: "Data Security Posture Management", ring: "trial", category: "Data", maturity: 3, trend: "up", investment: "medium", roi: 2.2, vendorCount: 9 },
      { id: "dpwo-tr-12", name: "Decentralized Identity Standards", ring: "hold", category: "Identity", maturity: 1, trend: "stable", investment: "low", roi: 0.5, vendorCount: 3 },
    ];
  }

  private _dpwoRadarSummary(): Record<string, unknown> {
    const rings: Record<string, number> = { adopt: 0, trial: 0, assess: 0, hold: 0 };
    this._dpwoTechRadar.forEach(t => { if (rings[t.ring as keyof typeof rings] !== undefined) rings[t.ring as keyof typeof rings]++; });
    return { adopt: rings.adopt, trial: rings.trial, assess: rings.assess, hold: rings.hold, total: this._dpwoTechRadar.length, avgMaturity: 2.8, topInvestment: this._dpwoTechRadar.filter(t => t.investment === "high").map(t => t.name) };
  }

  // --- DPWO Security Compliance Mapping Matrix ---
  private _initDpwoComplianceMatrix(): void {
    ...
    this._dpwoComplianceMatrix = frameworks.map(fw => ({
  ...
  private _dpwoComplianceTrend(): Record<string, unknown>[] {
    const quarters = ["Q1-2025", "Q2-2025", "Q3-2025", "Q4-2025", "Q1-2026", "Q2-2026"];
    return this._dpwoComplianceMatrix.map(fw => ({
  ...
  // --- DPWO Threat Intelligence Correlation Engine ---
  private _initDpwoThreatIntel(): void {
    ...
    this._dpwoThreatIntel = threatActors.map((actor, i) => ({
  ...
  private _dpwoThreatCorrelation(): Record<string, unknown>[] {
    return this._dpwoThreatIntel.filter(t => t.riskScore > 70).map(t => ({
  ...
  // --- DPWO Security Metrics Deep Dive ---
  private _initDpwoMetricsDeep(): void {
    ...
    this._dpwoMetricsDeep = metricCategories.map(cat => ({
  ...
  private _dpwoMetricsHeatmap(): number[][] {
    return this._dpwoMetricsDeep.map(cat =>
      cat.metrics.map(m => Math.round((m.value / m.target) * 100))
    );
  }

  // --- DPWO Incident Cost Modeling ---
  private _initDpwoCostModel(): void {
    const incidentTypes = ["Data Breach", "Ransomware", "DDoS", "Insider Threat", "Phishing", "Supply Chain", "Cloud Misconfig", "Zero-Day"];
    this._dpwoCostModel = incidentTypes.map(inc => ({
    ...
    this._dpwoCostModel.forEach(m => { m.totalAnnualExposure = m.avgCost * m.frequency; });
  }

  private _dpwoCostProjection(): Record<string, unknown>[] {
    return this._dpwoCostModel.map(m => ({
  ...
  // --- DPWO Security Architecture Pattern Library ---
  private _initDpwoArchPatterns(): void {
    ...
    this._dpwoArchPatterns = patterns.map((p, i) => ({
  ...
  private _dpwoArchPatternAnalysis(): Record<string, unknown> {
    const implemented = this._dpwoArchPatterns.filter(p => p.implementation > 75).length;
    const avgCoverage = Math.round(this._dpwoArchPatterns.reduce((s: number, p: any) => s + p.coverage, 0) / this._dpwoArchPatterns.length);
    return {
      totalPatterns: this._dpwoArchPatterns.length, fullyImplemented: implemented, avgCoverage,
      avgRiskReduction: Math.round(this._dpwoArchPatterns.reduce((s: number, p: any) => s + p.riskReduction, 0) / this._dpwoArchPatterns.length),
      gaps: this._dpwoArchPatterns.filter(p => p.implementation < 60).map(p => p.pattern),
      recommendations: this._dpwoArchPatterns.filter(p => p.implementation < 70).map(p => ({ pattern: p.pattern, current: p.implementation, target: 85, effort: p.costComplexity }))
    };
  }
  ...
  private _a5eRiskAssessmentWorkflow = [
  ...
  private _a5eTreatmentOptions = [
    {id: 'a5e-T-001', riskId: 'RSK-042', risk: 'Ransomware Attack on Critical Infrastructure', before: 20, after: 6, strategy: 'Mitigate', controls: ['Next-gen EDR with behavioral detection and automated response', 'Zero-trust network micro-segmentation isolating critical assets', 'Immutable offline backup rotation with quarterly recovery testing', 'Incident response retainer with 1-hour response SLA'], cost: '$450K/yr', roi: '78% reduction vs $2.8M potential loss', timeline: 'Q3 2026', status: 'approved' as const},
  ...
  private _a5eTalentPositions = [
    ...
    {id: 'a5e-H-002', title: 'Cloud Security Engineer', dept: 'Cloud Security', level: 'Mid-Senior', loc: 'SF/Remote', salary: '$155K-$180K', posted: '2026-03-20', applicants: 45, pipeline: 12, interviews: 6, offers: 2, urgency: 'high' as const, manager: 'Mike Johnson', skills: ['AWS/Azure/GCP', 'Terraform', 'Kubernetes', 'IAM', 'CSPM'], nice: ['CCSP', 'CKS', 'Serverless']},
    {id: 'a5e-H-003', title: 'SOC Analyst L2', dept: 'Security Operations', level: 'Mid', loc: 'Austin TX', salary: '$105K-$130K', posted: '2026-04-01', applicants: 67, pipeline: 18, interviews: 8, offers: 0, urgency: 'medium' as const, manager: 'Lisa Park', skills: ['SIEM', 'Incident triage', 'Malware analysis', 'TCP/IP'], nice: ['GCIA', 'SOAR', 'Kill chain']},
    {id: 'a5e-H-004', title: 'Staff Security Architect', dept: 'Architecture', level: 'Staff', loc: 'Remote US', salary: '$200K-$240K', posted: '2026-02-28', applicants: 12, pipeline: 3, interviews: 2, offers: 0, urgency: 'critical' as const, manager: 'David Lee', skills: ['Enterprise arch', 'Zero trust', 'Risk frameworks', 'Board comms'], nice: ['CISSP+SABSA', 'Team building', 'Speaker']},
    {id: 'a5e-H-005', title: 'GRC Analyst', dept: 'GRC', level: 'Mid', loc: 'NY/Remote', salary: '$110K-$135K', posted: '2026-04-05', applicants: 34, pipeline: 9, interviews: 3, offers: 1, urgency: 'medium' as const, manager: 'Rachel Green', skills: ['ISO 27001', 'SOC 2', 'Risk assessment', 'Audit'], nice: ['CRISC', 'CISA', 'GDPR']},
    {id: 'a5e-H-006', title: 'Threat Intel Analyst', dept: 'Threat Intel', level: 'Mid-Senior', loc: 'Remote US', salary: '$140K-$170K', posted: '2026-03-25', applicants: 19, pipeline: 5, interviews: 2, offers: 0, urgency: 'low' as const, manager: 'James Wilson', skills: ['MITRE ATT&CK', 'OSINT', 'Threat modeling', 'Reverse eng'], nice: ['CTIA', 'Nation-state', 'Dark web']},
    {id: 'a5e-H-007', title: 'AppSec Engineer', dept: 'AppSec', level: 'Senior', loc: 'Seattle/Remote', salary: '$160K-$190K', posted: '2026-04-10', applicants: 28, pipeline: 7, interviews: 3, offers: 0, urgency: 'medium' as const, manager: 'Emily Zhang', skills: ['SAST/DAST/SCA', 'Secure SDLC', 'Code review', 'CI/CD'], nice: ['CSSLP', 'Mobile security']},
    {id: 'a5e-H-008', title: 'IAM Engineer', dept: 'IAM', level: 'Mid', loc: 'Remote US', salary: '$135K-$160K', posted: '2026-04-08', applicants: 31, pipeline: 10, interviews: 5, offers: 1, urgency: 'medium' as const, manager: 'Chris Martinez', skills: ['Okta/Azure AD', 'SAML/OIDC', 'PAM', 'RBAC'], nice: ['CISSP', 'Zero trust IAM']}
  ];

  private _a5eInterviewScorecard = [
  ...
  private _a5eOnboardingSteps = [
    {id: 'a5e-OB-01', item: 'Provision security-hardened laptop, monitors, peripherals, and configured workstation image with all required security tools', cat: 'IT Setup', day: 'Day 1', owner: 'IT Operations'},
    {id: 'a5e-OB-02', item: 'Create AD account, email, Slack, VPN, SSO enrollment, and all required application access accounts', cat: 'Access', day: 'Day 1', owner: 'IAM Team'},
    {id: 'a5e-OB-03', item: 'Grant security tooling access: SIEM console, EDR dashboard, vuln scanner, pentest platforms, SOAR', cat: 'Tools', day: 'Day 1-2', owner: 'SOC Manager'},
    {id: 'a5e-OB-04', item: 'Complete MFA enrollment, security awareness onboarding course, and acceptable use policy acknowledgment', cat: 'Security', day: 'Day 1', owner: 'Awareness Team'},
    {id: 'a5e-OB-05', item: 'Sign NDA, employment agreement, IP assignment, and code of conduct documents with HR', cat: 'HR', day: 'Day 1', owner: 'Human Resources'},
    {id: 'a5e-OB-06', item: 'Introduction meetings with direct team members and key cross-functional stakeholders', cat: 'Integration', day: 'Week 1', owner: 'Hiring Manager'},
    {id: 'a5e-OB-07', item: 'Security architecture overview, tooling walkthrough, and operational runbook review sessions', cat: 'Training', day: 'Week 1-2', owner: 'Security Architect'},
    {id: 'a5e-OB-08', item: 'Shadow experienced team member on active incident response and threat hunting investigations', cat: 'Mentoring', day: 'Week 2-3', owner: 'SOC Lead'},
    {id: 'a5e-OB-09', item: 'Set up individual certification study plan aligned with role requirements and career goals', cat: 'Development', day: 'Week 2', owner: 'Hiring Manager'},
    {id: 'a5e-OB-10', item: 'Establish 30-60-90 day goals, define success metrics, and schedule first performance checkpoint', cat: 'Goals', day: 'Week 1', owner: 'Hiring Manager'}
  ];

  private _a5eMetricsDashboard = [
    {id: 'a5e-MTD-001', name: 'Mean Time to Detect (MTTD)', value: '4.2 hours', trend: 'improving' as const, target: '< 4 hours', source: 'SIEM - Splunk', method: 'Median time from first alert to analyst acknowledgment', owner: 'SOC Manager', sla: '4 hours', prev: '5.1 hours', spark: [5.8, 5.4, 5.1, 4.9, 4.7, 4.5, 4.3, 4.2], breakdown: [{src: 'Network IDS', pct: '35%', avg: '3.8h'}, {src: 'Endpoint EDR', pct: '28%', avg: '4.1h'}, {src: 'Email Gateway', pct: '22%', avg: '3.5h'}, {src: 'Cloud Security', pct: '10%', avg: '5.2h'}, {src: 'User Reports', pct: '5%', avg: '6.8h'}]},
    {id: 'a5e-MTD-002', name: 'Mean Time to Respond (MTTR)', value: '2.8 hours', trend: 'stable' as const, target: '< 3 hours', source: 'SOAR - XSOAR', method: 'Median time from acknowledgment to first containment action', owner: 'IR Lead', sla: '3 hours', prev: '2.7 hours', spark: [3.2, 3.0, 2.9, 2.8, 2.8, 2.9, 2.8, 2.8], breakdown: [{src: 'Auto Playbooks', pct: '42%', avg: '1.2h'}, {src: 'Semi-Auto', pct: '33%', avg: '2.5h'}, {src: 'Manual', pct: '20%', avg: '5.1h'}, {src: 'L3 Escalation', pct: '5%', avg: '8.3h'}]},
    {id: 'a5e-MTD-003', name: 'Patch Compliance Rate', value: '97.6%', trend: 'improving' as const, target: '> 95%', source: 'Tenable.io', method: 'Pct of critical/high vulns patched within SLA windows', owner: 'Vuln Manager', sla: '95%', prev: '96.1%', spark: [93.2, 94.1, 94.8, 95.3, 95.9, 96.4, 97.0, 97.6], breakdown: [{src: 'Critical (7d)', pct: '40%', rate: '99.2%'}, {src: 'High (30d)', pct: '35%', rate: '97.8%'}, {src: 'Medium (90d)', pct: '20%', rate: '95.1%'}, {src: 'Low (180d)', pct: '5%', rate: '89.4%'}]},
    {id: 'a5e-MTD-004', name: 'Phishing Click Rate', value: '3.2%', trend: 'improving' as const, target: '< 5%', source: 'KnowBe4 + Proofpoint', method: 'Pct of users clicking simulated phishing links monthly', owner: 'Awareness Lead', sla: '5%', prev: '4.1%', spark: [6.8, 6.2, 5.5, 5.1, 4.6, 4.1, 3.6, 3.2], breakdown: [{src: 'Spear Phishing', pct: '35%', rate: '5.1%'}, {src: 'Generic Phishing', pct: '30%', rate: '2.8%'}, {src: 'BEC Sim', pct: '20%', rate: '3.5%'}, {src: 'SMS Phishing', pct: '15%', rate: '1.9%'}]},
    {id: 'a5e-MTD-005', name: 'Security Posture Score', value: '784', trend: 'improving' as const, target: '> 750', source: 'SecurityScorecard', method: 'Composite: external 30%, compliance 25%, vuln 25%, config 20%', owner: 'CISO', sla: '> 750', prev: '771', spark: [748, 752, 758, 762, 768, 773, 778, 784], breakdown: [{src: 'External Rating', pct: '30%', score: '791'}, {src: 'Compliance', pct: '25%', score: '812'}, {src: 'Vuln Mgmt', pct: '25%', score: '745'}, {src: 'Config', pct: '20%', score: '769'}]},
    {id: 'a5e-MTD-006', name: 'Vulnerability Backlog', value: '142', trend: 'improving' as const, target: '< 150', source: 'Tenable + Qualys', method: 'Total open vulns across all scanned assets tracked weekly', owner: 'Vuln Manager', sla: '< 150', prev: '168', spark: [210, 198, 185, 175, 165, 158, 150, 142], breakdown: [{src: 'Critical', pct: '8%', count: '11'}, {src: 'High', pct: '22%', count: '31'}, {src: 'Medium', pct: '45%', count: '64'}, {src: 'Low', pct: '25%', count: '36'}]}
  ];

  private _a5eArchReview = [
    {id: 'a5e-AR-001', cat: 'Network', item: 'Network segmentation between trust zones with dedicated firewalls and granular ACLs', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Micro-segmentation via NSX across all production zones'},
    {id: 'a5e-AR-002', cat: 'Network', item: 'DMZ architecture isolating public services from internal network', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Dual-firewall DMZ with WAF and DDoS mitigation'},
    {id: 'a5e-AR-003', cat: 'Network', item: 'Least-privilege traffic flows with deny-by-default and quarterly review', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Explicit allow rules with automated drift detection'},
    {id: 'a5e-AR-004', cat: 'Network', item: 'Encrypted external communications with IPSec/TLS 1.3 and PFS', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'IKEv2 with PFS, TLS 1.3 for all external APIs'},
    {id: 'a5e-AR-005', cat: 'Identity', item: 'Centralized IdP with SSO and automated SCIM provisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Okta SSO SAML 2.0 for 247 apps with SCIM'},
    {id: 'a5e-AR-006', cat: 'Identity', item: 'RBAC with quarterly reviews and automated deprovisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Quarterly recertification with JIT admin access'},
    {id: 'a5e-AR-007', cat: 'Identity', item: 'PAM controlling all admin and service accounts with session recording', sev: 'high' as const, status: 'fail' as const, reviewer: 'IAM Lead', notes: '3 legacy accounts pending CyberArk enrollment'},
    {id: 'a5e-AR-008', cat: 'Identity', item: 'MFA enforced for all users, hardware tokens for privileged access', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'FIDO2 for admins, push MFA for users, 99.8% enrollment'},
    {id: 'a5e-AR-009', cat: 'Data', item: 'Data classification enforced with automated labeling on all repos', sev: 'high' as const, status: 'partial' as const, reviewer: 'Data Protection Lead', notes: 'Framework deployed, gaps on 4 legacy file shares'},
    {id: 'a5e-AR-010', cat: 'Data', item: 'AES-256 encryption at rest for all sensitive data stores', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'Full-disk, TDE on DBs, SSE-KMS on cloud storage'},
    {id: 'a5e-AR-011', cat: 'Data', item: 'DLP monitoring and preventing unauthorized data exfiltration', sev: 'high' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'DLP active on email, endpoint, cloud, and network'},
    {id: 'a5e-AR-012', cat: 'Data', item: 'Encrypted off-site backups with quarterly restore testing', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Infrastructure Lead', notes: '3-2-1 strategy with immutable backups'},
    {id: 'a5e-AR-013', cat: 'AppSec', item: 'Secure SDLC with SAST, DAST, SCA in all CI/CD pipelines', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: '34 pipelines with security gates and PR blocking'},
    {id: 'a5e-AR-014', cat: 'AppSec', item: 'API gateway with auth, rate limiting, schema validation', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: 'Kong with OAuth2, rate limits, OpenAPI validation'},
    {id: 'a5e-AR-015', cat: 'AppSec', item: 'Container security with image scanning and runtime protection', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Trivy scanning, Falco runtime in 80% of clusters'},
    {id: 'a5e-AR-016', cat: 'Monitoring', item: 'SIEM collecting from all critical systems with correlation rules', sev: 'critical' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'Splunk 98% coverage with 1200+ correlation rules'},
    {id: 'a5e-AR-017', cat: 'Monitoring', item: 'EDR with behavioral detection on all managed endpoints', sev: 'high' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'CrowdStrike on 99.2% endpoints with 24/7 MDR'},
    {id: 'a5e-AR-018', cat: 'Monitoring', item: 'Executive dashboards with real-time posture visibility', sev: 'medium' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'PowerBI dashboards with weekly exec summaries'},
    {id: 'a5e-AR-019', cat: 'Cloud', item: 'CSPM monitoring and remediating cloud misconfigurations', sev: 'high' as const, status: 'pass' as const, reviewer: 'Cloud Security Lead', notes: 'Prisma Cloud 450+ checks with auto-remediation'},
    {id: 'a5e-AR-020', cat: 'Cloud', item: 'IaC templates scanned before deployment to production', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Checkov for Terraform, cfn-nag for CloudFormation pending'}
  ];

  private _geta5eRiskProgress(): number {
    return Math.round(this._a5eRiskAssessmentWorkflow.filter(s => s.status === 'completed').length / this._a5eRiskAssessmentWorkflow.length * 100);
  }

  private _geta5eTreatmentSummary(): {total: number; approved: number; avgReduction: number; investment: string} {
    const a = this._a5eTreatmentOptions.filter(r => r.status === 'approved').length;
    const avg = this._a5eTreatmentOptions.reduce((s, r) => s + ((r.before - r.after) / r.before * 100), 0) / this._a5eTreatmentOptions.length;
    return {total: this._a5eTreatmentOptions.length, approved: a, avgReduction: Math.round(avg), investment: '$1.125M annually'};
  }

  private _geta5eRuleSummary(): {total: number; passing: number; failing: number; avgRate: number; violations: number} {
    const p = this._a5eComplianceRules.filter(r => r.result === 'pass').length;
    const f = this._a5eComplianceRules.filter(r => r.result === 'fail').length;
    const avg = this._a5eComplianceRules.reduce((s, r) => s + r.passRate, 0) / this._a5eComplianceRules.length;
    const v = this._a5eComplianceRules.reduce((s, r) => s + r.violations, 0);
    return {total: this._a5eComplianceRules.length, passing: p, failing: f, avgRate: Math.round(avg * 10) / 10, violations: v};
  }

  private _geta5ePipelineStats(): {positions: number; applicants: number; interviewing: number; offers: number; critical: number} {
    const t = this._a5eTalentPositions.length;
    const a = this._a5eTalentPositions.reduce((s, p) => s + p.applicants, 0);
    const i = this._a5eTalentPositions.reduce((s, p) => s + p.interviews, 0);
    const o = this._a5eTalentPositions.reduce((s, p) => s + p.offers, 0);
    const c = this._a5eTalentPositions.filter(x => x.urgency === 'critical').length;
    return {positions: t, applicants: a, interviewing: i, offers: o, critical: c};
  }

  private _geta5eMetricTrends(): {improving: number; stable: number; total: number} {
    const imp = this._a5eMetricsDashboard.filter(m => m.trend === 'improving').length;
    const stb = this._a5eMetricsDashboard.filter(m => m.trend === 'stable').length;
    return {improving: imp, stable: stb, total: this._a5eMetricsDashboard.length};
  }

  private _geta5eArchScore(): {total: number; passed: number; failed: number; partial: number; score: number} {
    const p = this._a5eArchReview.filter(c => c.status === 'pass').length;
    const f = this._a5eArchReview.filter(c => c.status === 'fail').length;
    const pa = this._a5eArchReview.filter(c => c.status === 'partial').length;
    return {total: this._a5eArchReview.length, passed: p, failed: f, partial: pa, score: Math.round((p / this._a5eArchReview.length) * 100)};
  }


  private _za5eIncidentScenarios = [
    {id: 'za5e-IS-001', name: 'Ransomware Outbreak in Production Environment', category: 'Malware', likelihood: 'Medium', impact: 'Critical', riskScore: 15, playbooks: ['IR-Ransomware-Isolate', 'IR-Ransomware-Eradicate', 'IR-Ransomway-Recover'], estimatedMTTD: '15min', estimatedMTTR: '4h', involvedTeams: ['SOC', 'IR', 'Infrastructure', 'Legal', 'Comms'], keyIndicators: ['Mass file encryption events', 'Ransom note deployment', 'Lateral movement via SMB/RDP', 'Backup deletion attempts'], mitigationControls: ['EDR behavioral detection', 'Network segmentation', 'Immutable backups', 'Email filtering'], lessonsLearned: 'Ensure offline backups are tested quarterly and Ransomware-specific playbooks are updated with latest threat intelligence', lastDrillDate: '2026-03-15', nextDrillDate: '2026-06-15'},
    {id: 'za5e-IS-002', name: 'Cloud Misconfiguration Leading to Data Exposure', category: 'Cloud', likelihood: 'High', impact: 'High', riskScore: 16, playbooks: ['IR-Cloud-Misconfig-Assess', 'IR-Cloud-Misconfig-Remediate', 'IR-Cloud-Misconfig-Notify'], estimatedMTTD: '2h', estimatedMTTR: '6h', involvedTeams: ['Cloud Security', 'SOC', 'Data Protection', 'Legal'], keyIndicators: ['Public S3 bucket exposure', 'Overly permissive IAM policies', 'Unencrypted database snapshots', 'Public API endpoint discovery'], mitigationControls: ['CSPM monitoring', 'IAM policy analyzer', 'Automated remediation', 'Cloud audit logging'], lessonsLearned: 'Implement CSPM with auto-remediation for common misconfigurations and conduct monthly cloud configuration reviews', lastDrillDate: '2026-02-20', nextDrillDate: '2026-05-20'},
    {id: 'za5e-IS-003', name: 'Insider Threat Data Exfiltration', category: 'Insider', likelihood: 'Low', impact: 'Critical', riskScore: 12, playbooks: ['IR-Insider-Investigate', 'IR-Insider-Contain', 'IR-Insider-Escalate'], estimatedMTTD: '8h', estimatedMTTR: '24h', involvedTeams: ['SOC', 'IR', 'HR', 'Legal', 'IAM'], keyIndicators: ['Anomalous data access patterns', 'Large file downloads to USB or cloud', 'Off-hours access to sensitive systems', 'Accessing data outside normal job scope'], mitigationControls: ['UEBA analytics', 'DLP policies', 'PAM controls', 'Access reviews'], lessonsLearned: 'Strengthen UEBA baselines and implement automated alerts for data access pattern anomalies', lastDrillDate: '2026-01-10', nextDrillDate: '2026-04-10'},
    {id: 'za5e-IS-004', name: 'Supply Chain Attack via Compromised Vendor Software', category: 'Supply Chain', likelihood: 'Low', impact: 'Critical', riskScore: 12, playbooks: ['IR-SupplyChain-Detect', 'IR-SupplyChain-Isolate', 'IR-SupplyChain-Remediate'], estimatedMTTD: '24h', estimatedMTTR: '72h', involvedTeams: ['SOC', 'IR', 'Procurement', 'Vendor Mgmt', 'Legal'], keyIndicators: ['Unexpected network connections from vendor software', 'Modified binaries or dependencies', 'Anomalous behavior from trusted applications', 'SBOM discrepancy alerts'], mitigationControls: ['SCA scanning', 'SBOM monitoring', 'Vendor security assessments', 'Network segmentation'], lessonsLearned: 'Require SBOM from all vendors and implement continuous monitoring of third-party component behavior', lastDrillDate: '2026-03-01', nextDrillDate: '2026-06-01'},
    {id: 'za5e-IS-005', name: 'Credential Stuffing Attack on Customer Portal', category: 'External Attack', likelihood: 'High', impact: 'Medium', riskScore: 12, playbooks: ['IR-CredentialStuffing-Detect', 'IR-CredentialStuffing-Block', 'IR-CredentialStuffing-Notify'], estimatedMTTD: '30min', estimatedMTTR: '2h', involvedTeams: ['SOC', 'AppSec', 'Customer Support', 'Comms'], keyIndicators: ['High volume of failed login attempts', 'Login attempts from known compromised credential lists', 'Unusual geographic distribution of login attempts', 'Account takeover indicators'], mitigationControls: ['WAF rate limiting', 'CAPTCHA on login', 'MFA enforcement', 'Credential monitoring service'], lessonsLearned: 'Deploy advanced bot detection on login endpoints and implement proactive credential monitoring for customer accounts', lastDrillDate: '2026-04-01', nextDrillDate: '2026-07-01'},
    {id: 'za5e-IS-006', name: 'Phishing Campaign Targeting Executive Team', category: 'Social Engineering', likelihood: 'High', impact: 'High', riskScore: 16, playbooks: ['IR-Phishing-Contain', 'IR-Phishing-Investigate', 'IR-Phishing-Notify'], estimatedMTTD: '1h', estimatedMTTR: '4h', involvedTeams: ['SOC', 'Awareness', 'Executive Office', 'IT'], keyIndicators: ['Sophisticated spear-phishing emails to C-suite', 'Business email compromise indicators', 'Redirected MFA approval requests', 'Unauthorized wire transfer attempts'], mitigationControls: ['AI email filtering', 'Executive awareness training', 'Out-of-band verification policy', 'DMARC/DKIM/SPF'], lessonsLearned: 'Implement additional email security controls for executive mailboxes and conduct monthly spear-phishing simulations', lastDrillDate: '2026-02-15', nextDrillDate: '2026-05-15'}
  ];

  private _za5eSecurityFrameworks = [
  ...
  private _getza5eScenarioSummary(): {total: number; critical: number; high: number; drilled: number; avgRiskScore: number} {
    const crit = this._za5eIncidentScenarios.filter(s => s.impact === 'Critical').length;
    const high = this._za5eIncidentScenarios.filter(s => s.impact === 'High').length;
    const avg = this._za5eIncidentScenarios.reduce((s, x) => s + x.riskScore, 0) / this._za5eIncidentScenarios.length;
    return {total: this._za5eIncidentScenarios.length, critical: crit, high: high, drilled: this._za5eIncidentScenarios.length, avgRiskScore: Math.round(avg)};
  }

  private _getza5eVendorRiskSummary(): {total: number; approved: number; conditional: number; remediation: number; avgScore: number} {
    const approved = this._za5eThirdPartyRiskData.filter(v => v.status === 'approved').length;
    const cond = this._za5eThirdPartyRiskData.filter(v => v.status === 'conditional').length;
    const rem = this._za5eThirdPartyRiskData.filter(v => v.status === 'remediation_required').length;
    const avg = this._za5eThirdPartyRiskData.reduce((s, v) => s + v.riskScore, 0) / this._za5eThirdPartyRiskData.length;
    return {total: this._za5eThirdPartyRiskData.length, approved, conditional: cond, remediation: rem, avgScore: Math.round(avg)};
  }

  private _getza5eTrainingSummary(): {total: number; avgCompletion: number; avgScore: number; overdueUpdates: number} {
    const avgComp = this._za5eSecurityTrainingCatalog.reduce((s, t) => s + t.completionRate, 0) / this._za5eSecurityTrainingCatalog.length;
    const avgScore = this._za5eSecurityTrainingCatalog.filter(t => t.avgScore > 0).reduce((s, t) => s + t.avgScore, 0) / this._za5eSecurityTrainingCatalog.filter(t => t.avgScore > 0).length;
    return {total: this._za5eSecurityTrainingCatalog.length, avgCompletion: Math.round(avgComp * 10) / 10, avgScore: Math.round(avgScore), overdueUpdates: 0};
  }

  private _getza5eToolHealthSummary(): {total: number; healthy: number; degraded: number; annualCost: string} {
    const healthy = this._za5eSecurityToolInventory.filter(t => t.health === 'healthy').length;
    const degraded = this._za5eSecurityToolInventory.filter(t => t.health === 'degraded').length;
    const cost = this._za5eSecurityToolInventory.reduce((s, t) => s + parseInt(t.annualCost.replace(/[^0-9]/g, '')), 0);
    return {total: this._za5eSecurityToolInventory.length, healthy, degraded, annualCost: '$' + (cost / 1000).toFixed(0) + 'K'};
  }


  private _xa5eSecurityZones = [
    {zoneId: 'xa5e-Z-001', name: 'Internet DMZ', trustLevel: 'Untrusted', subnet: '10.0.0.0/24', segmentation: 'Dual-firewall', firewallRules: 45, monitoring: 'Full packet capture', assets: ['Web servers', 'Load balancers', 'WAF appliances', 'Reverse proxy'], riskLevel: 'high' as const, lastAssessment: '2026-04-15', nextAssessment: '2026-07-15'},
    {zoneId: 'xa5e-Z-002', name: 'Corporate Network', trustLevel: 'Trusted', subnet: '10.1.0.0/16', segmentation: 'VLAN + micro-seg', firewallRules: 128, monitoring: 'NetFlow + IDS', assets: ['Workstations', 'Printers', 'Meeting room systems', 'VoIP phones'], riskLevel: 'medium' as const, lastAssessment: '2026-04-10', nextAssessment: '2026-07-10'},
    {zoneId: 'xa5e-Z-003', name: 'Production Data Center', trustLevel: 'Restricted', subnet: '10.2.0.0/16', segmentation: 'Full micro-segmentation', firewallRules: 256, monitoring: 'Full packet capture + EDR', assets: ['Application servers', 'Database clusters', 'Message queues', 'API gateways'], riskLevel: 'low' as const, lastAssessment: '2026-04-12', nextAssessment: '2026-07-12'},
    {zoneId: 'xa5e-Z-004', name: 'Management Network', trustLevel: 'Restricted', subnet: '10.3.0.0/24', segmentation: 'Isolated VLAN', firewallRules: 32, monitoring: 'Syslog + SNMP', assets: ['Hypervisors', 'Switch management', 'Storage controllers', 'Backup appliances'], riskLevel: 'low' as const, lastAssessment: '2026-04-08', nextAssessment: '2026-07-08'},
    {zoneId: 'xa5e-Z-005', name: 'Cloud Production', trustLevel: 'Restricted', subnet: 'VPC: 172.16.0.0/12', segmentation: 'Security groups + NACLs', firewallRules: 189, monitoring: 'VPC Flow Logs + GuardDuty', assets: ['Kubernetes clusters', 'Managed databases', 'Object storage', 'Serverless functions'], riskLevel: 'medium' as const, lastAssessment: '2026-04-18', nextAssessment: '2026-07-18'}
  ];

  private _xa5eSecurityAlerts = [
    {id: 'xa5e-AL-001', severity: 'critical', title: 'Active ransomware encryption detected on PROD-DB-01', source: 'CrowdStrike', timestamp: '2026-04-22T13:45:00Z', status: 'investigating', assignee: 'SOC Analyst J. Smith', asset: 'PROD-DB-01 (10.2.1.15)', mitreTechnique: 'T1486 - Data Encrypted for Impact', playbook: 'IR-Ransomware-Isolate', sla: '15 minutes', elapsed: '12 minutes', notes: 'EDR detected mass file encryption event pattern. Automated isolation triggered. IR team paged.'},
    {id: 'xa5e-AL-002', severity: 'high', title: 'Impossible travel detected for user admin@company.com', source: 'Okta', timestamp: '2026-04-22T12:30:00Z', status: 'triaged', assignee: 'SOC Analyst M. Johnson', asset: 'Okta - admin@company.com', mitreTechnique: 'T1078 - Valid Accounts', playbook: 'IR-ImpossibleTravel', sla: '30 minutes', elapsed: '87 minutes', notes: 'Login from Tokyo followed by login from New York within 30 minutes. Account temporarily locked. User confirmed via out-of-band channel they are in New York.'},
    {id: 'xa5e-AL-003', severity: 'high', title: 'Public S3 bucket discovered with customer PII exposure', source: 'Prisma Cloud', timestamp: '2026-04-22T11:15:00Z', status: 'remediating', assignee: 'Cloud Security Lead A. Chen', asset: 'AWS S3: customer-data-archive-2024', mitreTechnique: 'N/A - Misconfiguration', playbook: 'IR-Cloud-Misconfig-Remediate', sla: '1 hour', elapsed: '2.5 hours', notes: 'Bucket containing archived customer records was publicly accessible. Bucket blocked and encrypted. Data exposure assessment in progress.'},
    {id: 'xa5e-AL-004', severity: 'medium', title: 'Anomalous data download by user jane.developer@company.com', source: 'Microsoft DLP', timestamp: '2026-04-22T10:00:00Z', status: 'investigating', assignee: 'SOC Analyst R. Davis', asset: 'Endpoint: WS-DEV-042', mitreTechnique: 'T1567 - Exfil Over Web Service', playbook: 'IR-DLP-Investigation', sla: '4 hours', elapsed: '3.5 hours', notes: 'User downloaded 4.2GB of source code files to personal Google Drive. Interview scheduled with user and manager.'},
    {id: 'xa5e-AL-005', severity: 'medium', title: 'Credential stuffing attack detected on customer portal', source: 'Cloudflare WAF', timestamp: '2026-04-22T09:30:00Z', status: 'contained', assignee: 'SOC Analyst K. Wilson', asset: 'Customer Portal (portal.company.com)', mitreTechnique: 'T1110 - Brute Force', playbook: 'IR-CredentialStuffing-Block', sla: '2 hours', elapsed: '4 hours', notes: 'Rate limiting and CAPTCHA automatically deployed. 12,000 failed login attempts from 800 unique IPs blocked. No successful account takeovers confirmed.'},
    {id: 'xa5e-AL-006', severity: 'low', title: 'SSL certificate expiring in 14 days for api.company.com', source: 'Certificate monitoring', timestamp: '2026-04-22T08:00:00Z', status: 'remediated', assignee: 'Infrastructure Lead T. Brown', asset: 'api.company.com', mitreTechnique: 'N/A', playbook: 'Certificate Renewal', sla: '30 days', elapsed: '16 days', notes: 'Automated renewal triggered via ACME. New certificate deployed successfully. No service interruption.'}
  ];

  private _xa5eComplianceFrameworks = [
  ...
  private _xa5eDataClassificationPolicy = [
  ...
  private _getxa5eZoneSummary(): {total: number; highRisk: number; mediumRisk: number; lowRisk: number; totalRules: number} {
    const high = this._xa5eSecurityZones.filter(z => z.riskLevel === 'high').length;
    const med = this._xa5eSecurityZones.filter(z => z.riskLevel === 'medium').length;
    const low = this._xa5eSecurityZones.filter(z => z.riskLevel === 'low').length;
    const rules = this._xa5eSecurityZones.reduce((s, z) => s + z.firewallRules, 0);
    return {total: this._xa5eSecurityZones.length, highRisk: high, mediumRisk: med, lowRisk: low, totalRules: rules};
  }

  private _getxa5eAlertSummary(): {total: number; critical: number; high: number; medium: number; low: number; open: number; contained: number} {
    const crit = this._xa5eSecurityAlerts.filter(a => a.severity === 'critical').length;
    const high = this._xa5eSecurityAlerts.filter(a => a.severity === 'high').length;
    const med = this._xa5eSecurityAlerts.filter(a => a.severity === 'medium').length;
    const low = this._xa5eSecurityAlerts.filter(a => a.severity === 'low').length;
    const open = this._xa5eSecurityAlerts.filter(a => a.status === 'investigating' || a.status === 'triaged').length;
    const contained = this._xa5eSecurityAlerts.filter(a => a.status === 'contained' || a.status === 'remediated').length;
    return {total: this._xa5eSecurityAlerts.length, critical: crit, high, medium: med, low, open, contained};
  }

  private _getxa5eComplianceSummary(): {total: number; fullyCompliant: number; mostlyCompliant: number; avgComplianceRate: number} {
    const full = this._xa5eComplianceFrameworks.filter(f => f.status === 'compliant').length;
    const mostly = this._xa5eComplianceFrameworks.filter(f => f.status === 'mostly_compliant').length;
    const avgRate = this._xa5eComplianceFrameworks.reduce((s, f) => s + (f.compliant / f.requirements * 100), 0) / this._xa5eComplianceFrameworks.length;
    return {total: this._xa5eComplianceFrameworks.length, fullyCompliant: full, mostlyCompliant: mostly, avgComplianceRate: Math.round(avgRate * 10) / 10};
  }
  ...
  // === Security Risk Register (dpia_workflo) ===
  private _dpia_workfloRiskRegister = [
    { id: "RSK-DPI-0001", title: "Data breach from unpatched systems", owner: "CTO", category: "Financial", status: "mitigating", trend: "stable", severity: "low", likelihood: 6, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-17", nextReview: "2026-07-18" },
    { id: "RSK-DPI-0002", title: "Ransomware attack on critical infrastructure", owner: "CRO", category: "Strategic", status: "closed", trend: "decreasing", severity: "low", likelihood: 9, impact: 6, treatment: "Monitor and review quarterly", lastReview: "2026-04-15", nextReview: "2026-07-05" },
    { id: "RSK-DPI-0003", title: "Insider threat data exfiltration", owner: "VP Eng", category: "Compliance", status: "accepted", trend: "increasing", severity: "medium", likelihood: 8, impact: 4, treatment: "Monitor and review quarterly", lastReview: "2026-04-22", nextReview: "2026-07-17" },
    { id: "RSK-DPI-0004", title: "Supply chain compromise", owner: "Security Lead", category: "Technical", status: "open", trend: "stable", severity: "medium", likelihood: 9, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-09", nextReview: "2026-07-25" },
    { id: "RSK-DPI-0005", title: "Cloud misconfiguration exposure", owner: "Risk Mgr", category: "Reputational", status: "mitigating", trend: "decreasing", severity: "high", likelihood: 3, impact: 2, treatment: "Monitor and review quarterly", lastReview: "2026-04-16", nextReview: "2026-07-16" },
    { id: "RSK-DPI-0006", title: "Phishing campaign success rate", owner: "Compliance Dir", category: "Legal", status: "closed", trend: "increasing", severity: "critical", likelihood: 1, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-01", nextReview: "2026-07-26" },
    { id: "RSK-DPI-0007", title: "Third-party vendor data breach", owner: "IT Dir", category: "Regulatory", status: "accepted", trend: "stable", severity: "high", likelihood: 2, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-23", nextReview: "2026-07-01" },
    { id: "RSK-DPI-0008", title: "Regulatory non-compliance penalty", owner: "DevOps Lead", category: "Third-Party", status: "open", trend: "decreasing", severity: "medium", likelihood: 6, impact: 5, treatment: "Monitor and review quarterly", lastReview: "2026-04-11", nextReview: "2026-07-22" },
    { id: "RSK-DPI-0009", title: "Zero-day exploit in production", owner: "Architect", category: "Human Capital", status: "mitigating", trend: "increasing", severity: "medium", likelihood: 6, impact: 6, treatment: "Monitor and review quarterly", lastReview: "2026-04-12", nextReview: "2026-07-03" },
    { id: "RSK-DPI-0010", title: "Insufficient access controls", owner: "CISO", category: "Operational", status: "closed", trend: "stable", severity: "high", likelihood: 3, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-15", nextReview: "2026-07-19" },
    { id: "RSK-DPI-0011", title: "DDoS attack on services", owner: "CTO", category: "Financial", status: "accepted", trend: "decreasing", severity: "critical", likelihood: 1, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-16", nextReview: "2026-07-06" },
    { id: "RSK-DPI-0012", title: "Social engineering attack", owner: "CRO", category: "Strategic", status: "open", trend: "increasing", severity: "high", likelihood: 7, impact: 5, treatment: "Monitor and review quarterly", lastReview: "2026-04-04", nextReview: "2026-07-21" },
    { id: "RSK-DPI-0013", title: "API security vulnerability", owner: "VP Eng", category: "Compliance", status: "mitigating", trend: "stable", severity: "medium", likelihood: 5, impact: 1, treatment: "Monitor and review quarterly", lastReview: "2026-04-21", nextReview: "2026-07-03" },
    { id: "RSK-DPI-0014", title: "Mobile device compromise", owner: "Security Lead", category: "Technical", status: "closed", trend: "decreasing", severity: "medium", likelihood: 3, impact: 4, treatment: "Monitor and review quarterly", lastReview: "2026-04-10", nextReview: "2026-07-22" },
    { id: "RSK-DPI-0015", title: "Physical security breach", owner: "Risk Mgr", category: "Reputational", status: "accepted", trend: "increasing", severity: "high", likelihood: 1, impact: 6, treatment: "Monitor and review quarterly", lastReview: "2026-04-21", nextReview: "2026-07-08" },
    { id: "RSK-DPI-0016", title: "Password policy weakness", owner: "Compliance Dir", category: "Legal", status: "open", trend: "stable", severity: "critical", likelihood: 5, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-16", nextReview: "2026-07-13" },
    { id: "RSK-DPI-0017", title: "Network segmentation gap", owner: "IT Dir", category: "Regulatory", status: "mitigating", trend: "decreasing", severity: "low", likelihood: 1, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-04", nextReview: "2026-07-05" },
    { id: "RSK-DPI-0018", title: "Encryption key management failure", owner: "DevOps Lead", category: "Third-Party", status: "closed", trend: "increasing", severity: "critical", likelihood: 7, impact: 1, treatment: "Monitor and review quarterly", lastReview: "2026-04-17", nextReview: "2026-07-27" },
    { id: "RSK-DPI-0019", title: "Audit trail tampering", owner: "Architect", category: "Human Capital", status: "accepted", trend: "stable", severity: "high", likelihood: 5, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-08", nextReview: "2026-07-18" },
    { id: "RSK-DPI-0020", title: "Business email compromise", owner: "CISO", category: "Operational", status: "open", trend: "decreasing", severity: "low", likelihood: 4, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-17", nextReview: "2026-07-17" },
  ];
  private _dpia_workfloRiskFilter: string = 'all';
  private _dpia_workfloRiskSeverity: string = 'all';
  private _dpia_workfloRiskStatus: string = 'all';
  private _dpia_workfloExpandedRisk: string = '';
  private _dpia_workfloFilterRisks() {
    const reg = this._dpia_workfloRiskRegister;
    return reg.filter(r => {
      if (this._dpia_workfloRiskFilter !== "all" && r.category !== this._dpia_workfloRiskFilter) return false;
      if (this._dpia_workfloRiskSeverity !== "all" && r.severity !== this._dpia_workfloRiskSeverity) return false;
      if (this._dpia_workfloRiskStatus !== "all" && r.status !== this._dpia_workfloRiskStatus) return false;
      return true;
    });
  }
  private _dpia_workfloGetRiskScore(r: any) { return Math.round(r.likelihood * r.impact * 1.5); }
  private _dpia_workfloGetRiskTrendIcon(trend: string) {
    if (trend === "increasing") return "\u2191";
    if (trend === "decreasing") return "\u2193";
    return "\u2192";
  }
  private _dpia_workfloGetRiskColor(sev: string) {
    if (sev === "critical") return "#dc2626";
    if (sev === "high") return "#ea580c";
    if (sev === "medium") return "#d97706";
    return "#16a34a";
  }
  private _dpia_workfloGetRiskCounts() {
    const reg = this._dpia_workfloRiskRegister;
  ...
  private _dpia_workfloGetTreatmentProgress() {
    const reg = this._dpia_workfloRiskRegister;
    const treated = reg.filter(r => r.status === "mitigating" || r.status === "closed").length;
    return Math.round((treated / Math.max(reg.length, 1)) * 100);
  }

  // === Security Metrics API Gateway (dpia_workflo) ===
  private _dpia_workfloApiEndpoints = [
    { method: "GET", path: "/api/v1/threats", name: "Threat Intelligence Feed", status: "active", avgLatency: 115.9, reqPerMin: 1383.0, errorRate: 1.6, uptime: round(98.01649070781019,2), version: "v1.5.6" },
    { method: "POST", path: "/api/v1/scans/start", name: "Vulnerability Scanner", status: "active", avgLatency: 296.2, reqPerMin: 813.0, errorRate: 0.06, uptime: round(99.36273189702857,2), version: "v3.3.14" },
    { method: "GET", path: "/api/v1/assets", name: "Asset Inventory", status: "active", avgLatency: 168.2, reqPerMin: 392.0, errorRate: 0.4, uptime: round(97.94240912650905,2), version: "v2.4.1" },
    { method: "POST", path: "/api/v1/alerts", name: "Alert Management", status: "active", avgLatency: 349.9, reqPerMin: 564.0, errorRate: 2.01, uptime: round(98.42605735902885,2), version: "v3.0.9" },
    { method: "GET", path: "/api/v1/compliance", name: "Compliance Status", status: "active", avgLatency: 274.6, reqPerMin: 1505.0, errorRate: 0.95, uptime: round(96.71309614704113,2), version: "v3.5.12" },
    { method: "PUT", path: "/api/v1/policies", name: "Policy Engine", status: "active", avgLatency: 96.2, reqPerMin: 533.0, errorRate: 0.1, uptime: round(97.34320721079622,2), version: "v3.2.12" },
    { method: "GET", path: "/api/v1/incidents", name: "Incident Tracker", status: "active", avgLatency: 78.5, reqPerMin: 1101.0, errorRate: 1.48, uptime: round(95.71956698675143,2), version: "v3.5.7" },
    { method: "POST", path: "/api/v1/forensics", name: "Forensics Collector", status: "degraded", avgLatency: 49.7, reqPerMin: 2466.0, errorRate: 1.43, uptime: round(97.3090184698023,2), version: "v2.1.0" },
    { method: "GET", path: "/api/v1/risk/assess", name: "Risk Assessment", status: "active", avgLatency: 315.0, reqPerMin: 760.0, errorRate: 0.43, uptime: round(97.35133416087608,2), version: "v1.9.8" },
    { method: "POST", path: "/api/v1/auth/verify", name: "Authentication", status: "active", avgLatency: 58.2, reqPerMin: 1836.0, errorRate: 0.06, uptime: round(98.91399024463794,2), version: "v3.6.2" },
    { method: "GET", path: "/api/v1/logs/audit", name: "Audit Log Query", status: "active", avgLatency: 215.6, reqPerMin: 1424.0, errorRate: 2.4, uptime: round(99.15997697258109,2), version: "v3.6.12" },
    { method: "PUT", path: "/api/v1/users/roles", name: "Role Management", status: "active", avgLatency: 191.1, reqPerMin: 1465.0, errorRate: 1.62, uptime: round(96.03831899851653,2), version: "v3.0.1" },
    { method: "POST", path: "/api/v1/encrypt", name: "Encryption Service", status: "active", avgLatency: 268.9, reqPerMin: 212.0, errorRate: 1.23, uptime: round(96.92909148521608,2), version: "v3.2.19" },
    { method: "GET", path: "/api/v1/network/topo", name: "Network Topology", status: "maintenance", avgLatency: 59.2, reqPerMin: 2217.0, errorRate: 0.78, uptime: round(99.81676780068085,2), version: "v3.2.17" },
    { method: "DELETE", path: "/api/v1/sessions", name: "Session Manager", status: "active", avgLatency: 310.0, reqPerMin: 494.0, errorRate: 1.79, uptime: round(99.59778115394474,2), version: "v1.8.6" },
  ];
  private _dpia_workfloApiKeys = [
    { id: "ak-000001", name: "key-dpia-001", created: "2026-07-03", lastUsed: "2026-04-22", status: "active", calls: 11186, rateLimit: 500 },
    { id: "ak-000002", name: "key-dpia-002", created: "2026-08-04", lastUsed: "2026-04-23", status: "active", calls: 27450, rateLimit: 100 },
    { id: "ak-000003", name: "key-dpia-003", created: "2026-05-01", lastUsed: "2026-04-09", status: "active", calls: 24875, rateLimit: 100 },
    { id: "ak-000004", name: "key-dpia-004", created: "2026-09-02", lastUsed: "2026-04-06", status: "revoked", calls: 1109, rateLimit: 1000 },
    { id: "ak-000005", name: "key-dpia-005", created: "2026-09-18", lastUsed: "2026-04-23", status: "active", calls: 10915, rateLimit: 100 },
    { id: "ak-000006", name: "key-dpia-006", created: "2026-07-19", lastUsed: "2026-04-22", status: "active", calls: 45361, rateLimit: 100 },
    { id: "ak-000007", name: "key-dpia-007", created: "2026-02-12", lastUsed: "2026-04-08", status: "active", calls: 15722, rateLimit: 5000 },
    { id: "ak-000008", name: "key-dpia-008", created: "2026-09-14", lastUsed: "2026-04-08", status: "active", calls: 44084, rateLimit: 1000 },
  ];
  private _dpia_workfloApiHealthSummary() {
    const eps = this._dpia_workfloApiEndpoints;
  ...
  private _dpia_workfloGetApiByMethod(method: string) { return this._dpia_workfloApiEndpoints.filter(e=>e.method===method); }
  private _dpia_workfloGetSlowEndpoints() { return this._dpia_workfloApiEndpoints.filter(e=>e.avgLatency>200).sort((a,b)=>b.avgLatency-a.avgLatency); }
  private _dpia_workfloGetHighErrorEndpoints() { return this._dpia_workfloApiEndpoints.filter(e=>e.errorRate>1.0).sort((a,b)=>b.errorRate-a.errorRate); }

  // === Security Training Effectiveness (dpia_workflo) ===
  private _dpia_workfloTrainingModules = [
    { id: "TRN-001", name: "Security Fundamentals", completionRate: 58.6, avgScore: 70.2, behaviorChange: 34.2, enrolled: 326, completed: 56, duration: "63min", category: "mandatory" },
    { id: "TRN-002", name: "Phishing Awareness", completionRate: 66.9, avgScore: 84.1, behaviorChange: 39.5, enrolled: 403, completed: 401, duration: "114min", category: "mandatory" },
    { id: "TRN-003", name: "Social Engineering Defense", completionRate: 88.9, avgScore: 56.2, behaviorChange: 50.7, enrolled: 296, completed: 289, duration: "99min", category: "optional" },
    { id: "TRN-004", name: "Password Hygiene", completionRate: 45.3, avgScore: 68.3, behaviorChange: 73.5, enrolled: 263, completed: 220, duration: "89min", category: "mandatory" },
    { id: "TRN-005", name: "Data Classification", completionRate: 45.5, avgScore: 74.4, behaviorChange: 55.9, enrolled: 179, completed: 180, duration: "99min", category: "mandatory" },
    { id: "TRN-006", name: "Incident Response Basics", completionRate: 86.3, avgScore: 79.9, behaviorChange: 45.9, enrolled: 53, completed: 293, duration: "57min", category: "mandatory" },
    { id: "TRN-007", name: "Secure Coding", completionRate: 80.9, avgScore: 73.6, behaviorChange: 69.8, enrolled: 389, completed: 232, duration: "25min", category: "optional" },
    { id: "TRN-008", name: "Cloud Security", completionRate: 58.6, avgScore: 58.3, behaviorChange: 40.3, enrolled: 364, completed: 139, duration: "91min", category: "mandatory" },
    { id: "TRN-009", name: "Mobile Device Security", completionRate: 49.2, avgScore: 90.7, behaviorChange: 66.1, enrolled: 172, completed: 401, duration: "19min", category: "mandatory" },
    { id: "TRN-010", name: "Network Security", completionRate: 89.0, avgScore: 63.3, behaviorChange: 61.2, enrolled: 325, completed: 312, duration: "116min", category: "mandatory" },
    { id: "TRN-011", name: "Physical Security", completionRate: 87.3, avgScore: 62.8, behaviorChange: 66.1, enrolled: 186, completed: 350, duration: "102min", category: "optional" },
    { id: "TRN-012", name: "Regulatory Compliance", completionRate: 84.7, avgScore: 84.7, behaviorChange: 75.9, enrolled: 260, completed: 307, duration: "98min", category: "mandatory" },
    { id: "TRN-013", name: "Risk Management", completionRate: 49.6, avgScore: 83.1, behaviorChange: 48.3, enrolled: 223, completed: 160, duration: "35min", category: "mandatory" },
    { id: "TRN-014", name: "Cryptography Basics", completionRate: 66.5, avgScore: 86.9, behaviorChange: 47.7, enrolled: 459, completed: 426, duration: "110min", category: "mandatory" },
    { id: "TRN-015", name: "Access Control", completionRate: 95.0, avgScore: 90.7, behaviorChange: 36.2, enrolled: 150, completed: 257, duration: "98min", category: "optional" },
    { id: "TRN-016", name: "Vendor Management", completionRate: 74.9, avgScore: 66.4, behaviorChange: 78.1, enrolled: 101, completed: 48, duration: "68min", category: "mandatory" },
  ];
  private _dpia_workfloPhishingResults = [
    { month: "2026-01", sent: 744, clicked: 78, reported: 106, clickRate: round(10.483870967741936,1), reportRate: round(14.24731182795699,1) },
    { month: "2026-02", sent: 624, clicked: 74, reported: 240, clickRate: round(11.858974358974358,1), reportRate: round(38.46153846153847,1) },
    { month: "2026-03", sent: 721, clicked: 114, reported: 343, clickRate: round(15.811373092926493,1), reportRate: round(47.57281553398058,1) },
    { month: "2026-04", sent: 448, clicked: 97, reported: 98, clickRate: round(21.651785714285715,1), reportRate: round(21.875,1) },
    { month: "2026-05", sent: 903, clicked: 116, reported: 168, clickRate: round(12.846068660022148,1), reportRate: round(18.6046511627907,1) },
    { month: "2026-06", sent: 353, clicked: 77, reported: 102, clickRate: round(21.813031161473088,1), reportRate: round(28.89518413597734,1) },
  ];
  private _dpia_workfloTrainingROI = { totalInvestment: 116965, avgCostPerEmployee: 312, riskReductionPct: round(random.uniform(15,45),1), incidentReductionPct: round(random.uniform(10,35),1), complianceScoreGain: round(random.uniform(5,25),1) };
  private _dpia_workfloLearningPaths = [
    { name: "Beginner Security Analyst", totalModules: 19, completedModules: 15, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 58, enrolled: 100 },
    { name: "Advanced Threat Hunter", totalModules: 12, completedModules: 13, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 29, enrolled: 163 },
    { name: "Security Architect", totalModules: 16, completedModules: 16, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 25, enrolled: 183 },
    { name: "Incident Responder", totalModules: 17, completedModules: 2, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 15, enrolled: 196 },
    { name: "Compliance Specialist", totalModules: 9, completedModules: 14, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 32, enrolled: 144 },
    { name: "DevSecOps Engineer", totalModules: 20, completedModules: 2, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 46, enrolled: 106 },
  ];
  private _dpia_workfloGetOverallCompletion() {
    const mods = this._dpia_workfloTrainingModules;
    return round(mods.reduce((s,m)=>s+m.completionRate,0)/mods.length,1);
  }
  private _dpia_workfloGetTopPerformers() { return [...this._dpia_workfloTrainingModules].sort((a,b)=>b.avgScore-a.avgScore).slice(0,5); }
  private _dpia_workfloGetModulesNeedingAttention() { return this._dpia_workfloTrainingModules.filter(m=>m.completionRate<70||m.avgScore<65); }

  // === Security Governance Framework (dpia_workflo) ===
  private _dpia_workfloGovBodies = [
    { name: "Security Steering Committee", members: 12, chair: "CISO", meetingFreq: "Weekly", lastMeeting: "2026-04-11", nextMeeting: "2026-05-01", quorum: 5 },
    { name: "Risk Management Board", members: 8, chair: "CTO", meetingFreq: "Bi-weekly", lastMeeting: "2026-04-11", nextMeeting: "2026-05-20", quorum: 4 },
    { name: "Data Governance Council", members: 5, chair: "CRO", meetingFreq: "Monthly", lastMeeting: "2026-04-20", nextMeeting: "2026-05-07", quorum: 8 },
    { name: "Compliance Oversight Board", members: 11, chair: "CDO", meetingFreq: "Monthly", lastMeeting: "2026-04-18", nextMeeting: "2026-05-11", quorum: 8 },
    { name: "Architecture Review Board", members: 13, chair: "VP Eng", meetingFreq: "Bi-weekly", lastMeeting: "2026-04-22", nextMeeting: "2026-05-18", quorum: 8 },
    { name: "Change Advisory Board", members: 5, chair: "CISO", meetingFreq: "Weekly", lastMeeting: "2026-04-20", nextMeeting: "2026-05-04", quorum: 3 },
    { name: "Incident Review Board", members: 7, chair: "CIO", meetingFreq: "As needed", lastMeeting: "2026-04-06", nextMeeting: "2026-05-06", quorum: 8 },
    { name: "Vendor Risk Committee", members: 14, chair: "CFO", meetingFreq: "Quarterly", lastMeeting: "2026-04-03", nextMeeting: "2026-05-11", quorum: 4 },
  ];
  private _dpia_workfloDecisions = [
    { id: "DEC-0001", title: "Adopt zero-trust architecture framework", date: "2026-01-23", status: "approved", owner: "CISO" },
    { id: "DEC-0002", title: "Migrate to SIEM 2.0 platform", date: "2026-02-17", status: "implemented", owner: "CTO" },
    { id: "DEC-0003", title: "Implement DLP across all endpoints", date: "2026-04-06", status: "in-progress", owner: "Security Lead" },
    { id: "DEC-0004", title: "Mandate MFA for all external access", date: "2026-01-24", status: "pending", owner: "CRO" },
    { id: "DEC-0005", title: "Establish bug bounty program", date: "2026-01-07", status: "approved", owner: "VP Eng" },
    { id: "DEC-0006", title: "Deploy EDR solution enterprise-wide", date: "2026-04-21", status: "approved", owner: "CISO" },
    { id: "DEC-0007", title: "Conduct annual penetration testing", date: "2026-04-03", status: "implemented", owner: "CTO" },
  ...
  private _dpia_workfloPolicyLifecycle = [
    { name: "Information Security Policy", version: "v1.1", status: "active", lastUpdated: "2026-04-07", nextReview: "2026-10-08", owner: "CISO" },
    { name: "Acceptable Use Policy", version: "v4.2", status: "active", lastUpdated: "2026-03-06", nextReview: "2026-12-01", owner: "Legal" },
    { name: "Data Retention Policy", version: "v1.5", status: "under-review", lastUpdated: "2026-01-23", nextReview: "2026-11-25", owner: "DPO" },
    { name: "Access Control Policy", version: "v1.5", status: "active", lastUpdated: "2026-03-23", nextReview: "2026-10-18", owner: "IAM Lead" },
    { name: "Incident Response Policy", version: "v3.4", status: "draft", lastUpdated: "2026-03-10", nextReview: "2026-8-12", owner: "IR Lead" },
    { name: "Business Continuity Plan", version: "v3.2", status: "active", lastUpdated: "2026-01-15", nextReview: "2026-9-10", owner: "BCP Mgr" },
    { name: "Vendor Management Policy", version: "v1.1", status: "active", lastUpdated: "2026-04-23", nextReview: "2026-7-13", owner: "Procurement" },
    { name: "Encryption Standard", version: "v1.2", status: "under-review", lastUpdated: "2026-04-09", nextReview: "2026-11-27", owner: "Security Arch" },
  ];
  private _dpia_workfloGovMaturityScore = { overall: 5.6, riskManagement: 5.5, compliance: 5.1, incidentResponse: 5.0, awareness: 4.3, technology: 5.1 };
  private _dpia_workfloGetPendingDecisions() { return this._dpia_workfloDecisions.filter(d=>d.status==='pending'||d.status==='in-progress'); }
  private _dpia_workfloGetActivePolicies() { return this._dpia_workfloPolicyLifecycle.filter(p=>p.status==='active'); }
  private _dpia_workfloGetEscalationPath() { return ["L1 Analyst","L2 Senior","Security Lead","CISO","Board"]; }

  // === Security Innovation Lab (dpia_workflo) ===
  private _dpia_workfloInnoProjects = [
    { id: "INN-001", name: "AI-Powered Threat Detection", description: "Machine learning models for real-time threat identification", status: "active", progress: 72, startDate: "2026-01-10", teamSize: 6, budget: 26836, milestones: 4, completedMilestones: 2 },
    { id: "INN-002", name: "Quantum-Resistant Cryptography", description: "Post-quantum encryption algorithm prototyping", status: "research", progress: 35, startDate: "2026-02-03", teamSize: 6, budget: 14090, milestones: 8, completedMilestones: 7 },
    { id: "INN-003", name: "Automated Red Teaming", description: "Autonomous penetration testing framework", status: "active", progress: 58, startDate: "2026-01-05", teamSize: 2, budget: 50321, milestones: 7, completedMilestones: 2 },
    { id: "INN-004", name: "Zero-Knowledge Authentication", description: "Privacy-preserving identity verification", status: "poc", progress: 88, startDate: "2026-01-11", teamSize: 5, budget: 90435, milestones: 4, completedMilestones: 3 },
    { id: "INN-005", name: "Blockchain Audit Trail", description: "Immutable security event logging", status: "active", progress: 45, startDate: "2026-01-17", teamSize: 4, budget: 96838, milestones: 3, completedMilestones: 3 },
    { id: "INN-006", name: "Behavioral Biometrics", description: "Continuous authentication via user behavior patterns", status: "research", progress: 22, startDate: "2026-02-10", teamSize: 7, budget: 178630, milestones: 8, completedMilestones: 3 },
    { id: "INN-007", name: "Deception Grid 2.0", description: "Advanced honeypot network with adaptive responses", status: "active", progress: 65, startDate: "2026-01-04", teamSize: 4, budget: 119793, milestones: 3, completedMilestones: 6 },
    { id: "INN-008", name: "Secure Enclave Integration", description: "Hardware-backed security for critical workloads", status: "poc", progress: 40, startDate: "2026-02-21", teamSize: 6, budget: 180661, milestones: 6, completedMilestones: 6 },
  ];
  private _dpia_workfloTechEvaluations = [
    { name: "Rust for Security Tools", status: "evaluating", score: 5.4, recommendation: "Adopt", vendor: "Open Source" },
    ...
    { name: "Homomorphic Encryption", status: "evaluating", score: 10.8, recommendation: "Pilot", vendor: "GCP" },
    { name: "SASE Architecture", status: "completed", score: 5.6, recommendation: "Adopt", vendor: "Multiple" },
    { name: "SOAR Platform 3.0", status: "planned", score: 4.9, recommendation: "Monitor", vendor: "Splunk" },
  ];
  private _dpia_workfloCollaborationPartners = [
  ...
  private _dpia_workfloInnoMetrics = { totalProjects: 8, activeProjects: 4, avgTimeToValue: "180 days", pocSuccessRate: round(random.uniform(55,85),1), researchToProduction: round(random.uniform(20,50),1), innovationIndex: round(random.uniform(6.0,9.5),1) };
  private _dpia_workfloGetProjectByStatus(status: string) { return this._dpia_workfloInnoProjects.filter(p=>p.status===status); }
  private _dpia_workfloGetTopEvaluations() { return [...this._dpia_workfloTechEvaluations].sort((a,b)=>b.score-a.score).slice(0,3); }



  // === Compliance Dashboard Extension (dpia_workflo) ===
  private _dpia_workfloComplianceFrameworks = [
    { name: "SOC 2 Type II", description: "Trust Services Criteria", totalControls: 5, implementedControls: 5, status: "compliant", lastAudit: "2026-01-10", nextAudit: "2026-9-23", evidenceCount: 475 },
    { name: "ISO 27001", description: "Information Security Management", totalControls: 114, implementedControls: 111, status: "partially-compliant", lastAudit: "2026-03-03", nextAudit: "2026-7-05", evidenceCount: 225 },
    { name: "PCI DSS 4.0", description: "Payment Card Industry", totalControls: 12, implementedControls: 11, status: "partially-compliant", lastAudit: "2026-01-03", nextAudit: "2026-7-03", evidenceCount: 242 },
    { name: "HIPAA", description: "Health Insurance Portability", totalControls: 18, implementedControls: 14, status: "compliant", lastAudit: "2026-01-01", nextAudit: "2026-8-03", evidenceCount: 189 },
    { name: "GDPR", description: "Data Protection Regulation", totalControls: 99, implementedControls: 71, status: "compliant", lastAudit: "2026-04-16", nextAudit: "2026-12-12", evidenceCount: 201 },
    { name: "NIST CSF 2.0", description: "Cybersecurity Framework", totalControls: 6, implementedControls: 4, status: "non-compliant", lastAudit: "2026-01-18", nextAudit: "2026-10-24", evidenceCount: 457 },
    { name: "FedRAMP", description: "Federal Risk Authorization", totalControls: 15, implementedControls: 10, status: "compliant", lastAudit: "2026-01-28", nextAudit: "2026-10-04", evidenceCount: 391 },
    { name: "SOX", description: "Sarbanes-Oxley Compliance", totalControls: 8, implementedControls: 7, status: "in-review", lastAudit: "2026-04-23", nextAudit: "2026-9-07", evidenceCount: 268 },
    { name: "CIS Controls v8", description: "Center for Internet Security", totalControls: 18, implementedControls: 13, status: "partially-compliant", lastAudit: "2026-02-15", nextAudit: "2026-8-06", evidenceCount: 479 },
    { name: "COBIT 2019", description: "IT Governance Framework", totalControls: 40, implementedControls: 40, status: "compliant", lastAudit: "2026-01-09", nextAudit: "2026-12-03", evidenceCount: 265 },
  ];
  private _dpia_workfloGetComplianceScore() {
    const fw = this._dpia_workfloComplianceFrameworks;
    return round(fw.reduce((s,f)=>s + (f.implementedControls/Math.max(f.totalControls,1))*100, 0) / fw.length, 1);
  }
  private _dpia_workfloGetGaps() {
    return this._dpia_workfloComplianceFrameworks.filter(f => f.status !== "compliant");
  }
  private _dpia_workfloAuditTrail = [
    { id: "AUD-0001", action: "Control tested", auditor: "Internal Audit", date: "2026-04-11", result: "pass", findings: 3 },
    ...
    { id: "AUD-0007", action: "Access reviewed", auditor: "QA Team", date: "2026-04-21", result: "pass", findings: 0 },
    { id: "AUD-0008", action: "Exception approved", auditor: "CISO Office", date: "2026-04-21", result: "conditional", findings: 4 },
    { id: "AUD-0009", action: "Risk accepted", auditor: "Board Audit", date: "2026-04-18", result: "pass", findings: 1 },
    { id: "AUD-0010", action: "Control enhanced", auditor: "Third Party", date: "2026-04-12", result: "pass", findings: 3 },
  ];

  // === Threat Intelligence Feed Extension (dpia_workflo) ===
  private _dpia_workfloThreatActors = [
    { name: "APT-29", alias: "Cozy Bear", origin: "Russia", type: "Nation-State", severity: "high", lastActivity: "2026-04-22", targets: "Government", indicators: 304, ttps: 49 },
    { name: "APT-41", alias: "Double Dragon", origin: "China", type: "Nation-State", severity: "critical", lastActivity: "2026-04-23", targets: "Energy", indicators: 24, ttps: 36 },
    { name: "Lazarus Group", alias: "Hidden Cobra", origin: "North Korea", type: "Nation-State", severity: "critical", lastActivity: "2026-04-11", targets: "Healthcare", indicators: 439, ttps: 49 },
    { name: "FIN7", alias: "Carbanak", origin: "Eastern Europe", type: "Financial", severity: "high", lastActivity: "2026-04-15", targets: "Government", indicators: 402, ttps: 44 },
    { name: "Conti", alias: "Wizard Spider", origin: "Russia", type: "Ransomware", severity: "critical", lastActivity: "2026-04-07", targets: "Manufacturing", indicators: 346, ttps: 10 },
    { name: "LockBit", alias: "LockBit Gang", origin: "Unknown", type: "Ransomware", severity: "high", lastActivity: "2026-04-15", targets: "Finance", indicators: 376, ttps: 8 },
    { name: "Cl0p", alias: "Cl0p Team", origin: "Unknown", type: "Ransomware", severity: "high", lastActivity: "2026-04-14", targets: "Energy", indicators: 228, ttps: 29 },
    { name: "Sandworm", alias: "Unit 74455", origin: "Russia", type: "Nation-State", severity: "critical", lastActivity: "2026-04-02", targets: "Healthcare", indicators: 492, ttps: 7 },
  ];
  private _dpia_workfloIoCFeed = [
    { id: "ioc-000001", type: "ip", value: "73.46.120.204", confidence: 58, source: "MISP", firstSeen: "2026-04-05", lastSeen: "2026-04-14" },
    { id: "ioc-000002", type: "ip", value: "207.169.60.46", confidence: 40, source: "Mandiant", firstSeen: "2026-04-05", lastSeen: "2026-04-02" },
    { id: "ioc-000003", type: "ip", value: "203.145.192.208", confidence: 69, source: "Mandiant", firstSeen: "2026-04-21", lastSeen: "2026-04-07" },
    { id: "ioc-000004", type: "ip", value: "51.150.61.59", confidence: 54, source: "MISP", firstSeen: "2026-04-01", lastSeen: "2026-04-13" },
    { id: "ioc-000005", type: "ip", value: "235.105.23.184", confidence: 61, source: "AlienVault", firstSeen: "2026-04-08", lastSeen: "2026-04-21" },
    { id: "ioc-000006", type: "ip", value: "210.167.105.134", confidence: 90, source: "STIX", firstSeen: "2026-04-16", lastSeen: "2026-04-06" },
    { id: "ioc-000007", type: "ip", value: "197.161.204.192", confidence: 54, source: "MISP", firstSeen: "2026-04-21", lastSeen: "2026-04-08" },
    { id: "ioc-000008", type: "ip", value: "100.197.115.128", confidence: 52, source: "STIX", firstSeen: "2026-04-22", lastSeen: "2026-04-05" },
    { id: "ioc-000009", type: "ip", value: "89.124.176.133", confidence: 76, source: "MISP", firstSeen: "2026-04-12", lastSeen: "2026-04-05" },
    { id: "ioc-000010", type: "ip", value: "44.147.29.50", confidence: 43, source: "CrowdStrike", firstSeen: "2026-04-12", lastSeen: "2026-04-16" },
    { id: "ioc-000011", type: "ip", value: "188.138.20.5", confidence: 93, source: "Mandiant", firstSeen: "2026-04-04", lastSeen: "2026-04-01" },
    { id: "ioc-000012", type: "ip", value: "23.197.94.13", confidence: 82, source: "CrowdStrike", firstSeen: "2026-04-08", lastSeen: "2026-04-09" },
    { id: "ioc-000013", type: "ip", value: "26.136.106.19", confidence: 57, source: "MISP", firstSeen: "2026-04-03", lastSeen: "2026-04-18" },
    { id: "ioc-000014", type: "ip", value: "57.217.128.34", confidence: 57, source: "STIX", firstSeen: "2026-04-18", lastSeen: "2026-04-19" },
    { id: "ioc-000015", type: "ip", value: "44.127.188.32", confidence: 55, source: "AlienVault", firstSeen: "2026-04-06", lastSeen: "2026-04-21" },
  ];
  private _dpia_workfloGetActiveThreats() { return this._dpia_workfloThreatActors.filter(a => a.severity === 'critical'); }
  private _dpia_workfloGetThreatSummary() {
    const actors = this._dpia_workfloThreatActors;
  ...
  // === Incident Management Extension (dpia_workflo) ===
  private _dpia_workfloIncidents = [
    { id: "INC-20260001", title: "Unauthorized access detected", severity: "critical", status: "open", assignedTo: "SOC L1", detectedAt: "2026-04-02T13:31", affectedAssets: 26, rootCause: "Misconfiguration" },
    { id: "INC-20260002", title: "Malware outbreak on workstation", severity: "high", status: "investigating", assignedTo: "SOC L2", detectedAt: "2026-04-02T08:25", affectedAssets: 47, rootCause: "Credential compromise" },
    { id: "INC-20260003", title: "Data leak from S3 bucket", severity: "medium", status: "contained", assignedTo: "IR Lead", detectedAt: "2026-04-02T20:21", affectedAssets: 46, rootCause: "Zero-day" },
    { id: "INC-20260004", title: "Phishing campaign targeting finance", severity: "low", status: "eradicated", assignedTo: "CISO", detectedAt: "2026-04-16T23:48", affectedAssets: 30, rootCause: "Human error" },
    { id: "INC-20260005", title: "DDoS attack on web services", severity: "critical", status: "recovered", assignedTo: "Security Eng", detectedAt: "2026-04-12T12:20", affectedAssets: 11, rootCause: "Policy violation" },
    { id: "INC-20260006", title: "Ransomware encryption attempt", severity: "high", status: "closed", assignedTo: "Forensics", detectedAt: "2026-04-09T19:47", affectedAssets: 3, rootCause: "Unknown" },
    { id: "INC-20260007", title: "Insider data exfiltration", severity: "medium", status: "open", assignedTo: "SOC L1", detectedAt: "2026-04-03T19:27", affectedAssets: 17, rootCause: "Misconfiguration" },
    { id: "INC-20260008", title: "API key exposure in repo", severity: "low", status: "investigating", assignedTo: "SOC L2", detectedAt: "2026-04-02T14:06", affectedAssets: 39, rootCause: "Credential compromise" },
    { id: "INC-20260009", title: "SQL injection on portal", severity: "critical", status: "contained", assignedTo: "IR Lead", detectedAt: "2026-04-13T03:12", affectedAssets: 40, rootCause: "Zero-day" },
    { id: "INC-20260010", title: "Brute force on VPN", severity: "high", status: "eradicated", assignedTo: "CISO", detectedAt: "2026-04-16T03:22", affectedAssets: 31, rootCause: "Human error" },
    { id: "INC-20260011", title: "Supply chain alert from vendor", severity: "medium", status: "recovered", assignedTo: "Security Eng", detectedAt: "2026-04-10T19:55", affectedAssets: 1, rootCause: "Policy violation" },
    { id: "INC-20260012", title: "Suspicious lateral movement", severity: "low", status: "closed", assignedTo: "Forensics", detectedAt: "2026-04-21T07:54", affectedAssets: 12, rootCause: "Unknown" },
  ];
  private _dpia_workfloGetIncidentStats() {
    const inc = this._dpia_workfloIncidents;
    return { total: inc.length, open: inc.filter(i=>i.status==="open").length, investigating: inc.filter(i=>i.status==="investigating").length, mttd: 42, mttr: 89 };
  }
  private _dpia_workfloGetSeverityDistribution() {
    const inc = this._dpia_workfloIncidents;
  ...
  render() {    if (this._dpiaRules.length === 0) { this._initDpiaRules(); this._initDpiaCvss(); this._runDpiaAnomalyDetection(); this._generateDpiaPredictions(); this._initDpiaApprovals(); this._initDpiaActivity(); this._initDpiaNotifications(); }
...
<div class="tabs">
        ...
        ${this._activeTab === 'rules' ? html`
          ${this._renderDpiaRules()}
          <div style="margin-top:12px;font-size:11px;font-weight:600;margin-bottom:6px">Category Treemap</div>
          <div style="background:#1a1d27;border-radius:8px;padding:12px">${this._renderDpiaTreemapSVG()}</div>
          <div style="margin-top:12px;font-size:11px;font-weight:600;margin-bottom:6px">Data Flow (Sankey)</div>
          <div style="background:#1a1d27;border-radius:8px;padding:12px">${this._renderDpiaSankeySVG()}</div>
          ${this._renderDpiaActivity()}
        ` : nothing}
        ${this._activeTab === 'anomalies' ? html`
          ${this._renderDpiaAnomalies()}
          ${this._renderDpiaNotifications()}
        ` : nothing}
        ${this._activeTab === 'predictions' ? html`
          ${this._renderDpiaPredictions()}
          ...
          <div style="background:#1a1d27;border-radius:8px;padding:12px">
            <table class="history-table"><thead><tr><th>ID</th><th>Base</th><th>Temporal</th><th>Environmental</th><th>Overall</th></tr></thead><tbody>
              ${this._dpiacvssData.map(c => html`<tr><td>${c.itemId}</td><td style="color:${c.base >= 7 ? '#ef4444' : c.base >= 4 ? '#eab308' : '#22c55e'}">${c.base}</td><td>${c.temporal}</td><td>${c.environmental}</td><td style="font-weight:700;color:${c.overall >= 7 ? '#ef4444' : c.overall >= 4 ? '#eab308' : '#22c55e'}">${c.overall}</td></tr>`)}
            </tbody></table>
          </div>
        ` : nothing}
        ${this._activeTab === 'approvals' ? html`
          ${this._renderDpiaApprovals()}
        ` : nothing}
        ${this._activeTab === 'config' ? html`
          ${this._renderDpiaConfig()}
        ` : nothing}
        ${this._activeTab === 'new' ? html`
          <div class="form-section">
            <div class="form-title">Create New Dpia Workflow Entry</div>
            <div class="form-grid">
  ...
  @state() private _dwScenarios: {id:string;name:string;attackType:string;target:string;method:string;impactLow:number;impactHigh:number;confidence:number;mitigation:string;status:string}[] = [];
  @state() private _dwScenarioForm: {attackType:string;target:string;method:string} = {attackType:'',target:'',method:''};
  @state() private _dwScenarioCompare: boolean = false;
  @state() private _dwScenarioSelected: string[] = [];

  private _dwInitScenarios(): void {
    const saved = localStorage.getItem('dw_scenarios');
    if (saved) { try { this._dwScenarios = JSON.parse(saved); } catch { /* ignore */ } }
    if (this._dwScenarios.length === 0) {
      this._dwScenarios = [
        {id:'dw-s1',name:'Baseline Threat',attackType:'Phishing',target:'Employees',method:'Spear Email',impactLow:45,impactHigh:78,confidence:72,mitigation:'Security awareness training + email filtering',status:'active'},
        {id:'dw-s2',name:'Escalated Attack',attackType:'Ransomware',target:'Endpoints',method:'Drive-by Download',impactLow:65,impactHigh:95,confidence:58,mitigation:'EDR deployment + network segmentation',status:'saved'},
        {id:'dw-s3',name:'Insider Threat',attackType:'Data Exfiltration',target:'Databases',method:'SQL Injection',impactLow:55,impactHigh:88,confidence:65,mitigation:'DLP policies + query monitoring',status:'draft'},
      ];
    }
  }

  private _dwSaveScenarios(): void {
    localStorage.setItem('dw_scenarios', JSON.stringify(this._dwScenarios));
  }

  private _dwAddScenario(): void {
    const f = this._dwScenarioForm;
    if (!f.attackType || !f.target) return;
    this._dwScenarios = [...this._dwScenarios, {
      id: 'dw-s' + (this._dwScenarios.length + 1),
    ...
    this._dwScenarioForm = {attackType:'',target:'',method:''};
    this._dwSaveScenarios();
  }

  private _dwRenderScenarioEngine(): any {
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <button class="tab" @click=${() => { this._dwScenarioCompare = !this._dwScenarioCompare; }}>${this._dwScenarioCompare ? 'List View' : 'Compare'}</button>
        </div>
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:6px;margin-bottom:10px">
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._dwScenarioForm = {...this._dwScenarioForm, attackType: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Attack Type</option>
            ${attackTypes.map(a => html`<option value=${a} ${this._dwScenarioForm.attackType === a ? 'selected' : ''}>${a}</option>`)}
          </select>
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._dwScenarioForm = {...this._dwScenarioForm, target: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Target</option>
            ${targets.map(t => html`<option value=${t} ${this._dwScenarioForm.target === t ? 'selected' : ''}>${t}</option>`)}
          </select>
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._dwScenarioForm = {...this._dwScenarioForm, method: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Method</option>
            ${methods.map(m => html`<option value=${m} ${this._dwScenarioForm.method === m ? 'selected' : ''}>${m}</option>`)}
          </select>
        </div>
        <button style="background:#3b82f6;border:none;border-radius:4px;padding:4px 12px;color:#fff;font-size:11px;cursor:pointer" @click=${this._dwAddScenario}>Run Simulation</button>
      </div>
      ${this._dwScenarioCompare && this._dwScenarios.length >= 2 ? html`
        <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
          <div style="font-weight:600;font-size:12px;color:#e2e8f0;margin-bottom:8px">Side-by-Side Comparison</div>
          <div style="display:grid;grid-template-columns:repeat(${Math.min(3, this._dwScenarios.length)},1fr);gap:8px">
            ${this._dwScenarios.slice(0,3).map(s => html`
      ...
      <div style="background:#0f1117;border-radius:8px;padding:12px">
        <div style="font-weight:600;font-size:12px;color:#e2e8f0;margin-bottom:8px">Saved Scenarios (${this._dwScenarios.length})</div>
        ${this._dwScenarios.map(s => html`
  ...
  @state() private _dwTrendData: {day:number;value:number;anomaly:boolean}[] = [];
  @state() private _dwTrendZoom: {start:number;end:number} | null = null;
  @state() private _dwTrendMA: number = 7;

  private _dwInitTrendData(): void {
    ...
    this._dwTrendData = data;
  }

  private _dwCalcMA(window: number): number[] {
    const result: number[] = [];
    for (let i = 0; i < this._dwTrendData.length; i++) {
      const start = Math.max(0, i - window + 1);
      const slice = this._dwTrendData.slice(start, i + 1);
      result.push(slice.reduce((s, d) => s + d.value, 0) / slice.length);
    }
    return result;
  }

  private _dwGetStats(): {mean:number;median:number;stddev:number;trend:string} {
    const vals = this._dwTrendData.map(d => d.value);
    const n = vals.length;
  ...
  private _dwRenderTimeSeries(): any {
    const stats = this._dwGetStats();
    const filtered = this._dwTrendZoom ? this._dwTrendData.filter(d => d.day >= this._dwTrendZoom.start && d.day <= this._dwTrendZoom.end) : this._dwTrendData;
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px">
            <button class="tab ${this._dwTrendMA === 7 ? 'active' : ''}" @click=${() => { this._dwTrendMA = 7; }}>7D MA</button>
            <button class="tab ${this._dwTrendMA === 30 ? 'active' : ''}" @click=${() => { this._dwTrendMA = 30; }}>30D MA</button>
            <button class="tab" @click=${() => { this._dwTrendZoom = null; }}>Reset Zoom</button>
          </div>
        </div>
        <div style="position:relative;height:120px;background:#1a1d2e;border-radius:6px;overflow:hidden;margin-bottom:8px;cursor:crosshair" @click=${(e: any) => {
          ...
          this._dwTrendZoom = { start: Math.max(0, center - 10), end: Math.min(89, center + 10) };
        }}>
  ...
  @state() private _dwRoles: string[] = ['Admin','Analyst','Operator','Viewer','Auditor'];
  @state() private _dwActions: string[] = ['Create','Read','Update','Delete','Export','Approve'];
  @state() private _dwPermissions: { [role: string]: { [action: string]: boolean } } = {};
  @state() private _dwPermAudit: {role:string;action:string;changedBy:string;timestamp:string;oldVal:boolean;newVal:boolean}[] = [];
  @state() private _dwPermCompare: string[] = [];

  private _dwInitPermissions(): void {
    ...
    for (const role of this._dwRoles) {
      perms[role] = {};
      this._dwActions.forEach((a, i) => { perms[role][a] = defaults[role]?.[i] ?? false; });
    }
    this._dwPermissions = perms;
  }

  private _dwTogglePermission(role: string, action: string): void {
    const old = this._dwPermissions[role][action];
    this._dwPermissions = {...this._dwPermissions, [role]: {...this._dwPermissions[role], [action]: !old}};
    this._dwPermAudit.unshift({role,action,changedBy:'current_user',timestamp:new Date().toISOString(),oldVal:old,newVal:!old});
  }

  private _dwRenderRBAC(): any {
    const compareRoles = this._dwPermCompare.map(r => this._dwPermissions[r]).filter(Boolean);
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          <span style="font-weight:700;font-size:13px;color:#e2e8f0">RBAC Permission Matrix</span>
          <div style="display:flex;gap:4px">
            ${this._dwRoles.map(r => html`
              <button class="tab ${this._dwPermCompare.includes(r) ? 'active' : ''}" @click=${() => {
                this._dwPermCompare = this._dwPermCompare.includes(r) ? this._dwPermCompare.filter(x => x !== r) : [...this._dwPermCompare, r];
              }}>${r}</button>
            `)}
          </div>
        </div>
          ...
          <table style="width:100%;border-collapse:collapse;font-size:10px">
            <thead>
              <tr>
                ...
                ${this._dwActions.map(a => html`<th style="padding:6px;color:#6b7280;border-bottom:1px solid #2a2d3a;text-align:center">${a}</th>`)}
              </tr>
            </thead>
            <tbody>
              ${this._dwRoles.map(role => html`
                <tr style="border-bottom:1px solid #1a1d2e">
                  <td style="padding:6px;color:#e2e8f0;font-weight:600">${role}</td>
                  ${this._dwActions.map(action => html`
                    <td style="text-align:center;padding:6px">
                      <button style="width:28px;height:20px;border-radius:3px;border:1px solid #2a2d3a;background:${this._dwPermissions[role][action] ? '#22c55e' : '#1a1d2e'};cursor:pointer;color:#fff;font-size:10px" @click=${() => this._dwTogglePermission(role, action)}>${this._dwPermissions[role][action] ? 'Y' : 'N'}</button>
                    </td>
                  `)}
                </tr>
              `)}
        ...
        ${compareRoles.length >= 2 ? html`
          <div style="margin-top:10px;padding:8px;background:#1a1d2e;border-radius:6px">
            <div style="font-size:11px;font-weight:600;color:#e2e8f0;margin-bottom:6px">Role Diff: ${this._dwPermCompare.join(' vs ')}</div>
            ${this._dwActions.map(action => {
              ...
              return allSame ? nothing : html`
                <div style="display:flex;gap:8px;padding:3px 0;font-size:10px">
                  ...
                  ${compareRoles.map((r, i) => html`<span style="color:${r[action] ? '#22c55e' : '#ef4444'}">${this._dwPermCompare[i]}=${r[action] ? 'Y' : 'N'}</span>`)}
                </div>
              `;
            })}
          </div>
        ` : nothing}
        ${this._dwPermAudit.length > 0 ? html`
          <div style="margin-top:8px;font-size:9px;color:#6b7280">Recent: ${this._dwPermAudit.slice(0,3).map(a => html`<span style="margin-right:8px">${a.role}.${a.action}: ${a.oldVal ? 'Y' : 'N'}->${a.newVal ? 'Y' : 'N'}</span>`)}
        ` : nothing}
      </div>
    `;
  }
  ...
  // === REPORTING SUITE ===
  @state() private _dwReportTemplate: string = 'executive';
  @state() private _dwReportSchedule: string = 'weekly';
  @state() private _dwReportDistList: string[] = ['security-team@company.com','ciso@company.com'];
  @state() private _dwReportHistory: {id:string;template:string;generatedAt:string;status:string}[] = [];

  private _dwGenerateReport(): void {
    const id = 'rpt-' + Date.now();
    this._dwReportHistory.unshift({id,template:this._dwReportTemplate,generatedAt:new Date().toISOString(),status:'sent'});
  }

  private _dwRenderReporting(): any {
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:8px">
          <div>
            ...
            ${templates.map(t => html`
              <div style="padding:6px;background:${this._dwReportTemplate === t.key ? '#1e3a5f' : '#1a1d2e'};border:1px solid ${this._dwReportTemplate === t.key ? '#3b82f6' : '#2a2d3a'};border-radius:4px;margin-bottom:4px;cursor:pointer" @click=${() => { this._dwReportTemplate = t.key; }}>
          ...
          <div>
            ...
            <div style="display:flex;gap:4px;margin-bottom:8px">
              ${schedules.map(s => html`<button class="tab ${this._dwReportSchedule === s.key ? 'active' : ''}" @click=${() => { this._dwReportSchedule = s.key; }}>${s.label}</button>`)}
            </div>
            <div style="font-size:10px;color:#6b7280;margin-bottom:4px">Distribution</div>
            <div style="font-size:10px;color:#9ca3af">${this._dwReportDistList.map(d => html`<div>${d}</div>`)}</div>
            <div style="margin-top:6px;display:flex;gap:4px">
              <button style="background:#3b82f6;border:none;border-radius:4px;padding:4px 10px;color:#fff;font-size:10px;cursor:pointer" @click=${this._dwGenerateReport}>Generate</button>
        ...
        ${this._dwReportHistory.length > 0 ? html`
          <div style="border-top:1px solid #2a2d3a;padding-top:8px">
            ...
            ${this._dwReportHistory.slice(0,3).map(r => html`
  ...
  @state() private _dwHighContrast: boolean = false;
  @state() private _dwA11yAnnounce: string = '';
  @state() private _dwShortcutsVisible: boolean = false;
  @state() private _dwFocusTrap: boolean = false;

  private _dwShortcuts: Record<string, string> = {
  ...
  private _dwHandleKeydown(e: KeyboardEvent): void {
    if (e.key === 'Escape' && this._dwFocusTrap) { this._dwFocusTrap = false; this._dwAnnounce('Dialog closed'); }
    if (e.ctrlKey && e.shiftKey && e.key === 'H') { e.preventDefault(); this._dwHighContrast = !this._dwHighContrast; this._dwAnnounce('High contrast ' + (this._dwHighContrast ? 'enabled' : 'disabled')); }
    if (e.ctrlKey && e.shiftKey && e.key === 'A') { e.preventDefault(); this._dwShortcutsVisible = !this._dwShortcutsVisible; }
  }

  private _dwAnnounce(msg: string): void {
    this._dwA11yAnnounce = msg;
    setTimeout(() => { this._dwA11yAnnounce = ''; }, 2000);
  }

  private _dwRenderAccessibility(): any {
    return html`
      <div role="region" aria-label="Accessibility Controls" style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <button class="tab ${this._dwShortcutsVisible ? 'active' : ''}" @click=${() => { this._dwShortcutsVisible = !this._dwShortcutsVisible; }} aria-expanded=${this._dwShortcutsVisible}>Shortcuts</button>
        </div>
        <div style="display:flex;gap:8px;margin-bottom:8px">
          <label style="display:flex;align-items:center;gap:6px;font-size:11px;color:#e2e8f0;cursor:pointer">
            <input type="checkbox" .checked=${this._dwHighContrast} @change=${() => { this._dwHighContrast = !this._dwHighContrast; }} aria-label="Toggle high contrast mode">
            High Contrast
          </label>
        </div>
        ${this._dwShortcutsVisible ? html`
          <div role="list" aria-label="Keyboard shortcuts" style="background:#1a1d2e;border-radius:6px;padding:8px">
            ${Object.entries(this._dwShortcuts).map(([key, desc]) => html`
        ...
        ` : nothing}
        <div role="status" aria-live="polite" aria-atomic="true" style="position:absolute;left:-9999px">${this._dwA11yAnnounce}</div>
      </div>
    `;
  }
  ...
  connectedCallback(): void {
    ...
    this._dwInitScenarios();
    this._dwInitTrendData();
    this._dwInitPermissions();
    document.addEventListener('keydown', this._dwHandleKeydown.bind(this));
  }

  disconnectedCallback(): void {
    super.disconnectedCallback();
    document.removeEventListener('keydown', this._dwHandleKeydown.bind(this));
  }

  // === TAB INTEGRATION FOR EXTENDED FEATURES ===
  @state() private _dwActiveSubTab: string = 'scenario';
  ...
  private _dwGetAllSubTabs(): {key:string;label:string}[] {
    return [
  ...
  private _dwRenderSubPanel(): any {
    switch (this._dwActiveSubTab) {
      case 'scenario': return this._dwRenderScenarioEngine();
      case 'timeseries': return this._dwRenderTimeSeries();
      case 'rbac': return this._dwRenderRBAC();
      case 'reporting': return this._dwRenderReporting();
      case 'a11y': return this._dwRenderAccessibility();
      default: return nothing;
    }
  }

  private _dwRenderTabBar(): any {
    return html`
      <div style="display:flex;gap:4px;margin-bottom:12px;border-bottom:1px solid #2a2d3a;padding-bottom:8px;flex-wrap:wrap" role="tablist" aria-label="Extended panel features">
        ${this._dwGetAllSubTabs().map(t => html`
          <button class="tab ${this._dwActiveSubTab === t.key ? 'active' : ''}" @click=${() => { this._dwActiveSubTab = t.key; }} role="tab" aria-selected=${this._dwActiveSubTab === t.key}>${t.label}</button>
        `)}
      </div>
      <div role="tabpanel" aria-labelledby="dw-tab-${this._dwActiveSubTab}">
        ${this._dwRenderSubPanel()}
      </div>
    `;
  }
  ...
  @state() private _soarPlaybooks: Array<{
    ...
    {
      id: 'pb-soar-001', name: 'Dpia Workflow Auto Response', status: 'active',
      steps: [
    ...
    {
      id: 'pb-soar-002', name: 'Dpia Workflow Investigation Workflow', status: 'active',
      steps: [
    ...
    {
      id: 'pb-soar-003', name: 'Dpia Workflow Compliance Scan', status: 'draft',
      steps: [
  ...
  @state() private _dwAle: number = 0;
  @state() private _dwSroi: number = 0;
  @state() private _dwCpi: number = 0;
  @state() private _dwBudgetAlloc: number = 0;
  @state() private _dwCostBenefit: number = 0;

  // Security Economics Calculator
  private dwInitEconomics() {
    this._dwAle = Math.round(2850000 + Math.random() * 4500000);
    this._dwSroi = Math.round(180 + Math.random() * 320);
    this._dwCpi = Math.round(45000 + Math.random() * 120000);
    this._dwBudgetAlloc = Math.round(2500000 + Math.random() * 3000000);
    this._dwCostBenefit = Math.round(220 + Math.random() * 180);
  }

  private _dwCalcAle(): { annual: number; perIncident: number; byCategory: Array<{name: string; value: number}> } {
    const base = this._dwAle;
    const categories = [
  ...
  private _dwCalcSroi(): Array<{year: number; investment: number; savings: number; roi: number}> {
    const baseInv = this._dwSroi * 10000;
  ...
  private _dwGetBudgetAlloc(): Array<{category: string; amount: number; pct: number; trend: string}> {
    const total = this._dwBudgetAlloc;
    const items = [
  ...
  private _dwGetCostBenefit(): Array<{control: string; cost: number; benefit: number; ratio: number; priority: string}> {
    const base = this._dwCostBenefit;
    const controls = [
  ...
  private _dwRenderEconomics() {
    const ale = this._dwCalcAle();
    const roi = this._dwCalcSroi();
    const budget = this._dwGetBudgetAlloc();
    const cb = this._dwGetCostBenefit();
    const cpi = this._dwCpi;
  ...
  @state() private _dwThreatLevel: any = null;
  @state() private _dwEmergingThreats: any = null;
  @state() private _dwThreatTrends: any = null;
  @state() private _dwSectorRadar: any = null;
  @state() private _dwActorActivity: any = null;

  // Threat Landscape Intelligence
  private dwInitThreatIntel() {
    this._dwThreatLevel = {
  ...
  private _dwRenderThreatIntel() {
    const tl = this._dwThreatLevel;
    const et = this._dwEmergingThreats;
    const sr = this._dwSectorRadar;
    const aa = this._dwActorActivity;
  ...
  @state() private _dwPolicies: any = null;
  @state() private _dwExceptions: any = null;
  @state() private _dwRiskRegister: any = null;
  @state() private _dwMeetings: any = null;
  @state() private _dwDeadlines: any = null;

  // Security Governance Dashboard
  private dwInitGovernance() {
    this._dwPolicies = [
  ...
  private _dwRenderGovernance() {
    const policies = this._dwPolicies;
    const risks = this._dwRiskRegister;
    const deadlines = this._dwDeadlines;
  ...
  @state() private _dwCriticalAssets: any = null;
  @state() private _dwAssetDeps: any = null;
  @state() private _dwEolAssets: any = null;
  @state() private _dwAssetRisk: any = null;

  // Asset Intelligence
  private dwInitAssetIntel() {
    this._dwCriticalAssets = [
    ...
    this._dwAssetRisk = { critical: 7, high: 23, medium: 45, low: 128, total: 203 };
  }

  private _dwRenderAssetIntel() {
    const assets = this._dwCriticalAssets;
    const eol = this._dwEolAssets;
    const ar = this._dwAssetRisk;
  ...
  @state() private _dwUserBaseline: any = null;
  @state() private _dwAnomalyRules: any = null;
  @state() private _dwDataAccess: any = null;
  @state() private _dwInsiderRisk: any = null;
  @state() private _dpiawor15Timeline: Array<{id:string;time:string;event:string;severity:string;actor:string}> = [
  ...
  @state() private _dpiawor15RootCauses: Array<{why:string;answer:string}> = [
  ...
  @state() private _dpiawor15ImpactMatrix: Array<{system:string;users:number;data:string;revenue:string;status:string}> = [
  ...
  @state() private _dpiawor15Actions: Array<{id:string;item:string;owner:string;deadline:string;priority:string;status:string}> = [
  ...
  @state() private _dpiawor15Lessons: Array<{id:string;lesson:string;category:string;severity:string;applies_to:string}> = [
  ...
  @state() private _dpiawor15ActiveTab: string = 'timeline';
  @state() private _dpiawor15Benchmarks: Array<{metric:string;current:number;industry:number;target:number;unit:string;source:string}> = [
  ...
  @state() private _dpiawor15MaturityLevels: Array<{domain:string;current:number;target:number;description:string}> = [
  ...
  @state() private _dpiawor15QuarterlyData: Array<{quarter:string;score:number;improvement:number}> = [
  ...
  @state() private _dpiawor15SelectedDomain: string = 'all';
  @state() private _dpiawor15Alerts: Array<{id:string;name:string;severity:number;confidence:number;assetCrit:number;score:number;enriched:boolean;group:string;status:string;enrichData:Array<{key:string;value:string}>}> = [
  ...
  @state() private _dpiawor15QualityMetrics: {fpRate:number;enrichSuccess:number;avgTriageTime:number;enrichedCount:number;totalCount:number} = {fpRate:0.12, enrichSuccess:0.78, avgTriageTime:4.5, enrichedCount:3, totalCount:5};
  @state() private _dpiawor15RoutingRules: Array<{name:string;condition:string;channel:string;active:boolean}> = [
  ...
  @state() private _dpiawor15Shapes: Array<{id:string;type:string;label:string;controls:string[]}> = [
  ...
  @state() private _dpiawor15TrustBoundaries: Array<{from:string;to:string;label:string;strength:string}> = [
  ...
  @state() private _dpiawor15ADRs: Array<{id:string;title:string;status:string;date:string;decision:string}> = [
  ...
  @state() private _dpiawor15SelectedShape: string = '';
  @state() private _dpiawor15Gauges: Array<{name:string;value:number;max:number;unit:string;status:string;color:string}> = [
  ...
  @state() private _dpiawor15Anomalies: Array<{id:string;time:string;description:string;severity:string;acknowledged:boolean}> = [
  ...
  @state() private _dpiawor15Integrations: Array<{name:string;status:string;uptime:number;lastCheck:string;latency:number}> = [
  ...
  @state() private _dpiawor15AlertFatigue: Array<{analyst:string;alertsPerDay:number;escalated:number;dismissed:number;avgResponseMin:number}> = [
  ...
  @state() private _dpiawor15SlaTarget: number = 99.9;

  // Insider Threat Detection
  private dwInitInsiderThreat() {
    this._dwUserBaseline = [
    ...
    this._dwInsiderRisk = { totalUsers: 2847, monitored: 342, flagged: 18, investigated: 5, confirmed: 1 };
  }

  private _dwRenderInsiderThreat() {
    const baseline = this._dwUserBaseline;
    const rules = this._dwAnomalyRules;
    const ir = this._dwInsiderRisk;
    ...
    return html`<div class="card" style="padding:14px;margin-bottom:8px">
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px;margin-bottom:10px;flex-wrap:wrap">
            ${['timeline','rootcause','impact','actions','lessons'].map(t => html`
              <button class="btn ${this._dpiawor15ActiveTab === t ? 'btn-primary' : ''}" style="font-size:10px;padding:3px 8px" @click=${() => { this._dpiawor15ActiveTab = t; }}>${t.charAt(0).toUpperCase() + t.slice(1)}</button>
            `)}
          </div>
          ${this._dpiawor15ActiveTab === 'timeline' ? html`
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._dpiawor15Timeline.map(e => html`
          ...
          ` : this._dpiawor15ActiveTab === 'rootcause' ? html`
            <div style="margin-bottom:8px">${{__html: this._dpiawor15RenderFishbone()}}</div>
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._dpiawor15RootCauses.map((rc, i) => html`
          ...
          ` : this._dpiawor15ActiveTab === 'impact' ? html`
            <div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:10px">
              ...
              <tbody>${this._dpiawor15ImpactMatrix.map(imp => html`
          ...
          ` : this._dpiawor15ActiveTab === 'actions' ? html`
            <div style="display:flex;gap:12px;margin-bottom:8px;font-size:10px;color:#888">
              ${Object.entries(this._dpiawor15GetActionStats()).map(([k,v]) => html`<span>${k}: <b style="color:#ddd">${v}</b></span>`)}
            </div>
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._dpiawor15Actions.map(a => html`
                <div style="display:flex;gap:8px;align-items:center;padding:6px;background:#1a1d27;border-radius:4px;cursor:pointer" @click=${() => this._dpiawor15ToggleAction(a.id)}>
          ...
          ` : html`
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._dpiawor15Lessons.map(l => html`
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px;margin-bottom:10px;flex-wrap:wrap">
            ${['all', ...this._dpiawor15MaturityLevels.map(m => m.domain)].map(d => html`
              <button class="btn ${this._dpiawor15SelectedDomain === d ? 'btn-primary' : ''}" style="font-size:9px;padding:2px 6px" @click=${() => { this._dpiawor15SelectedDomain = d; }}>${d}</button>
            `)}
          </div>
          <div style="display:flex;gap:16px;margin-bottom:10px">
            <div style="text-align:center"><div style="color:#e0e0e0;font-size:20px;font-weight:bold">${this._dpiawor15GetOverallMaturity()}/5</div><div style="color:#888;font-size:10px">Maturity Level</div></div>
            <div style="text-align:center"><div style="color:#4f4;font-size:20px;font-weight:bold">${this._dpiawor15GetGapAnalysis().filter(g => g.isAbove).length}/${this._dpiawor15Benchmarks.length}</div><div style="color:#888;font-size:10px">Above Industry</div></div>
          </div>
          <div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:10px">
            ...
            <tbody>${this._dpiawor15GetGapAnalysis().map(b => html`
          ...
          <div style="margin-top:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Maturity by Domain</div>
            ${this._dpiawor15MaturityLevels.filter(m => this._dpiawor15SelectedDomain === 'all' || m.domain === this._dpiawor15SelectedDomain).map(m => html`
          ...
          <div style="margin-top:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Quarterly Trend</div>
            <div style="display:flex;height:40px;align-items:flex-end;gap:4px">
              ${this._dpiawor15QuarterlyData.map(q => html`<div style="flex:1;text-align:center"><div style="background:#4a9eff;height:${q.score * 0.5}px;border-radius:2px 2px 0 0" title="${q.score}"></div><div style="color:#666;font-size:8px;margin-top:2px">${q.quarter}</div></div>`)}
            </div>
          </div>
        </div>
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:12px;margin-bottom:8px;font-size:10px">
            <div style="display:flex;gap:4px;flex-wrap:wrap">${this._dpiawor15GroupAlerts().map(g => html`<span style="color:#888;padding:2px 6px;background:#1a1d27;border-radius:3px">${g.group}: ${g.count}</span>`)}</div>
          </div>
          <div style="display:flex;gap:8px;margin-bottom:8px;font-size:10px;color:#888">
            <span>FP Rate: <b style="color:${this._dpiawor15QualityMetrics.fpRate > 0.15 ? '#f44' : '#4f4'}">${(this._dpiawor15QualityMetrics.fpRate * 100).toFixed(1)}%</b></span>
            <span>Enrich: <b style="color:#4a9eff">${(this._dpiawor15QualityMetrics.enrichSuccess * 100).toFixed(0)}%</b></span>
            <span>Avg Triage: <b style="color:#ddd">${this._dpiawor15QualityMetrics.avgTriageTime}m</b></span>
          </div>
          <div style="display:flex;flex-direction:column;gap:4px;max-height:200px;overflow-y:auto">
            ${this._dpiawor15Alerts.sort((a, b) => this._dpiawor15CalcScore(b) - this._dpiawor15CalcScore(a)).map(a => {
              const score = this._dpiawor15CalcScore(a);
              return html`
                <div style="padding:6px;background:#1a1d27;border-radius:4px;border-left:3px solid ${a.severity >= 4 ? '#f44' : a.severity >= 3 ? '#fa0' : '#4a9eff'}">
                  <div style="display:flex;justify-content:space-between;align-items:center">
                    ...
                    <button class="btn" style="font-size:9px;padding:1px 6px;margin-left:4px" @click=${() => this._dpiawor15EnrichAlert(a.id)}>${a.enriched ? 'Re-enrich' : 'Enrich'}</button>
                  </div>
          ...
          <div style="margin-top:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Routing Rules</div>
            ${this._dpiawor15RoutingRules.map(r => html`
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:8px;margin-bottom:8px;flex-wrap:wrap">
            ${this._dpiawor15Shapes.map(s => {
              const v = this._dpiawor15ValidateControl(s.id);
              return html`<div style="padding:4px 8px;background:#1a1d27;border-radius:3px;cursor:pointer;border:1px solid ${this._dpiawor15SelectedShape === s.id ? '#4a9eff' : '#2a2d37'}" @click=${() => { this._dpiawor15SelectedShape = this._dpiawor15SelectedShape === s.id ? '' : s.id; }}>
          ...
          ${this._dpiawor15SelectedShape ? html`
            ${(() => {
              const shape = this._dpiawor15Shapes.find(s => s.id === this._dpiawor15SelectedShape);
              const v = this._dpiawor15ValidateControl(this._dpiawor15SelectedShape);
              return shape ? html`
          ...
          <div style="margin-bottom:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Trust Boundaries</div>
            ${this._dpiawor15TrustBoundaries.map(tb => html`
              <div style="display:flex;gap:6px;align-items:center;padding:3px;background:#1a1d27;border-radius:3px;margin-bottom:2px;font-size:9px">
                <span style="color:#ddd">${this._dpiawor15Shapes.find(s => s.id === tb.from)?.label || tb.from}</span>
                <span style="color:#4a9eff">\u2194</span>
                <span style="color:#ddd">${this._dpiawor15Shapes.find(s => s.id === tb.to)?.label || tb.to}</span>
          ...
          <div><div style="color:#888;font-size:10px;margin-bottom:4px">Architecture Decision Records</div>
            ${this._dpiawor15ADRs.map(adr => html`
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:8px;margin-bottom:8px;flex-wrap:wrap">
            ${this._dpiawor15Gauges.map(g => html`
          ...
          <div style="display:flex;gap:8px;margin-bottom:8px;align-items:center">
            ...
            <span style="color:${this._dpiawor15GetOverallHealth().score >= 99 ? '#4f4' : '#fa0'};font-size:12px;font-weight:bold">${this._dpiawor15GetOverallHealth().score}%</span>
            <span style="color:#888;font-size:10px">(Target: ${this._dpiawor15SlaTarget}%)</span>
            <span style="color:#4f4;font-size:10px">${this._dpiawor15GetOverallHealth().healthy} healthy</span>
            <span style="color:#fa0;font-size:10px">${this._dpiawor15GetOverallHealth().degraded} degraded</span>
          </div>
          <div style="margin-bottom:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Anomaly Stream</div>
            ${this._dpiawor15Anomalies.slice(0, 3).map(a => html`
              <div style="display:flex;gap:6px;align-items:center;padding:4px;background:#1a1d27;border-radius:3px;margin-bottom:2px;opacity:${a.acknowledged ? 0.5 : 1}">
                ...
                ${!a.acknowledged ? html`<button class="btn" style="font-size:8px;padding:1px 4px" @click=${() => this._dpiawor15AckAnomaly(a.id)}>ACK</button>` : html`<span style="color:#4f4;font-size:9px">ACK'd</span>`}
              </div>
            `)}
          </div>
          <div style="margin-bottom:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Integration Health</div>
            ${this._dpiawor15Integrations.map(i => html`
              <div style="display:flex;gap:6px;align-items:center;padding:3px;background:#1a1d27;border-radius:3px;margin-bottom:2px;font-size:9px">
          ...
          <div><div style="color:#888;font-size:10px;margin-bottom:4px">Alert Fatigue Analysis</div>
            <div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:9px">
              ...
              <tbody>${this._dpiawor15AlertFatigue.map(af => html`
  ...
  private _dpiawor15RenderFishbone(): string {
  ...
  private _dpiawor15ToggleAction(id: string) {
    this._dpiawor15Actions = this._dpiawor15Actions.map(a => a.id === id ? {...a, status: a.status === 'pending' ? 'in_progress' : a.status === 'in_progress' ? 'completed' : 'pending'} : a);
  }

  private _dpiawor15GetActionStats() {
    const total = this._dpiawor15Actions.length;
    const done = this._dpiawor15Actions.filter(a => a.status === 'completed').length;
    const inProg = this._dpiawor15Actions.filter(a => a.status === 'in_progress').length;
    return { total, done, inProg, pending: total - done - inProg };
  }

  private _dpiawor15GetOverallMaturity(): number {
    if (this._dpiawor15SelectedDomain === 'all') {
      return Math.round(this._dpiawor15MaturityLevels.reduce((s, m) => s + m.current, 0) / this._dpiawor15MaturityLevels.length * 10) / 10;
    }
    const d = this._dpiawor15MaturityLevels.find(m => m.domain === this._dpiawor15SelectedDomain);
    return d ? d.current : 0;
  }

  private _dpiawor15GetGapAnalysis() {
    return this._dpiawor15Benchmarks.map(b => {
  ...
  private _dpiawor15CalcScore(alert: any): number {
    return Math.round(alert.severity * alert.confidence * alert.assetCrit * 100) / 100;
  }

  private _dpiawor15EnrichAlert(id: string) {
    this._dpiawor15Alerts = this._dpiawor15Alerts.map(a => {
      if (a.id !== id) return a;
      const score = this._dpiawor15CalcScore(a);
  ...
  private _dpiawor15GroupAlerts() {
    const groups: Record<string, number> = {};
    this._dpiawor15Alerts.forEach(a => { groups[a.group] = (groups[a.group] || 0) + 1; });
    return Object.entries(groups).map(([g, c]) => ({group: g, count: c}));
  }

  private _dpiawor15ValidateControl(shapeId: string): {valid:boolean;missing:string[]} {
    const shape = this._dpiawor15Shapes.find(s => s.id === shapeId);
  ...
  private _dpiawor15GetOverallHealth(): {healthy:number;degraded:number;down:number;score:number} {
    const online = this._dpiawor15Integrations.filter(i => i.status === 'online').length;
    const degraded = this._dpiawor15Integrations.filter(i => i.status === 'degraded').length;
    const total = this._dpiawor15Integrations.length;
    return { healthy: online, degraded, down: total - online - degraded, score: Math.round(online / total * 100) };
  }

  private _dpiawor15AckAnomaly(id: string) {
    this._dpiawor15Anomalies = this._dpiawor15Anomalies.map(a => a.id === id ? {...a, acknowledged: true} : a);
  }
...
// ===== DATA SOVEREIGNTY COMPLIANCE (R22) =====
  ...
  private _renderBudgetPlanning() {
    const budgetData = [
      { category: "Personnel & Training", planned: 2806000, actual: 2116000, utilization: 75.4, q1: "25%", q2: "30%", q3: "28%", q4: "20%" },
      { category: "Tooling & Licensing", planned: 2813000, actual: 2129000, utilization: 75.7, q1: "28%", q2: "35%", q3: "23%", q4: "21%" },
      { category: "Infrastructure Security", planned: 2820000, actual: 2142000, utilization: 76.0, q1: "15%", q2: "24%", q3: "18%", q4: "22%" },
      { category: "Compliance & Audit", planned: 2827000, actual: 2155000, utilization: 76.2, q1: "18%", q2: "29%", q3: "29%", q4: "23%" },
      { category: "Incident Response", planned: 2834000, actual: 2168000, utilization: 76.5, q1: "21%", q2: "34%", q3: "24%", q4: "24%" },
      { category: "Third-Party Assessments", planned: 2841000, actual: 2181000, utilization: 76.8, q1: "24%", q2: "23%", q3: "19%", q4: "25%" },
      { category: "Security Awareness", planned: 2848000, actual: 2194000, utilization: 77.0, q1: "27%", q2: "28%", q3: "30%", q4: "10%" },
      { category: "Research & Innovation", planned: 2855000, actual: 2207000, utilization: 77.3, q1: "30%", q2: "33%", q3: "25%", q4: "11%" },
    ];
    ...
    const headcount = [
      { team: "SOC Tier 1", current: 13, target: 17, gap: 0, avgSalary: "118k" },
      { team: "SOC Tier 2", current: 5, target: 16, gap: 5, avgSalary: "147k" },
      { team: "Threat Intel", current: 14, target: 15, gap: 4, avgSalary: "176k" },
      { team: "Red Team", current: 6, target: 14, gap: 3, avgSalary: "94k" },
      { team: "GRC", current: 15, target: 13, gap: 2, avgSalary: "123k" },
      { team: "AppSec", current: 7, target: 12, gap: 1, avgSalary: "152k" },
      { team: "Cloud Sec", current: 16, target: 11, gap: 0, avgSalary: "181k" },
      { team: "Identity & Access", current: 8, target: 10, gap: 5, avgSalary: "99k" },
    ];
    const vendorSpend = [
      { vendor: "CrowdStrike", annual: "444k", contractEnd: "2026-07", renewalRisk: "Low", satisfaction: 3 },
      { vendor: "Palo Alto", annual: "475k", contractEnd: "2026-08", renewalRisk: "Medium", satisfaction: 5 },
      { vendor: "Splunk", annual: "506k", contractEnd: "2026-09", renewalRisk: "High", satisfaction: 4 },
      { vendor: "Qualys", annual: "537k", contractEnd: "2026-10", renewalRisk: "Low", satisfaction: 3 },
      { vendor: "Rapid7", annual: "568k", contractEnd: "2026-11", renewalRisk: "Medium", satisfaction: 5 },
      { vendor: "Mandiant", annual: "599k", contractEnd: "2026-12", renewalRisk: "High", satisfaction: 4 },
      { vendor: "Zscaler", annual: "630k", contractEnd: "2026-01", renewalRisk: "Low", satisfaction: 3 },
      { vendor: "Duo Security", annual: "661k", contractEnd: "2026-02", renewalRisk: "Medium", satisfaction: 5 },
    ];
    const roiProjections = [
      { area: "Threat Detection", investment: "835k", projectedReturn: "2031k", roiMultiple: "2.9x", confidence: 66 },
      { area: "Incident Reduction", investment: "878k", projectedReturn: "2078k", roiMultiple: "2.8x", confidence: 83 },
      { area: "Compliance Savings", investment: "120k", projectedReturn: "2125k", roiMultiple: "2.7x", confidence: 64 },
      { area: "Automation Gains", investment: "163k", projectedReturn: "2172k", roiMultiple: "2.6x", confidence: 81 },
      { area: "Risk Avoidance", investment: "206k", projectedReturn: "2219k", roiMultiple: "2.5x", confidence: 62 },
    ];
    return html`
  ...
  private _renderMetricsNormalization() {
    const kpiCatalog = [
      { id: "kpi-1", name: "MTTD", owner: "SOC", unit: "minutes", target: 73, current: 74, benchmark: 72, collection: "auto", frequency: "realtime" },
      { id: "kpi-2", name: "MTTR", owner: "GRC", unit: "%", target: 76, current: 81, benchmark: 83, collection: "semi-auto", frequency: "daily" },
      { id: "kpi-3", name: "MTTC", owner: "AppSec", unit: "score", target: 79, current: 88, benchmark: 94, collection: "manual", frequency: "weekly" },
      { id: "kpi-4", name: "Vuln SLA Compliance", owner: "Cloud Sec", unit: "count", target: 82, current: 95, benchmark: 71, collection: "auto", frequency: "monthly" },
      { id: "kpi-5", name: "Patch Coverage", owner: "Identity", unit: "days", target: 85, current: 56, benchmark: 82, collection: "semi-auto", frequency: "realtime" },
      { id: "kpi-6", name: "Phishing Click Rate", owner: "Threat Intel", unit: "minutes", target: 88, current: 63, benchmark: 93, collection: "manual", frequency: "daily" },
      { id: "kpi-7", name: "Training Completion", owner: "Security Ops", unit: "%", target: 91, current: 70, benchmark: 70, collection: "auto", frequency: "weekly" },
      { id: "kpi-8", name: "Escalation Rate", owner: "Risk Mgmt", unit: "score", target: 94, current: 77, benchmark: 81, collection: "semi-auto", frequency: "monthly" },
      { id: "kpi-9", name: "False Positive Rate", owner: "SOC", unit: "count", target: 97, current: 84, benchmark: 92, collection: "manual", frequency: "realtime" },
      { id: "kpi-10", name: "Threat Intel Actionability", owner: "GRC", unit: "days", target: 70, current: 91, benchmark: 69, collection: "auto", frequency: "daily" },
      { id: "kpi-11", name: "Endpoint Compliance", owner: "AppSec", unit: "minutes", target: 73, current: 98, benchmark: 80, collection: "semi-auto", frequency: "weekly" },
      { id: "kpi-12", name: "Cloud Misconfig Score", owner: "Cloud Sec", unit: "%", target: 76, current: 59, benchmark: 91, collection: "manual", frequency: "monthly" },
      { id: "kpi-13", name: "Identity Anomaly Rate", owner: "Identity", unit: "score", target: 79, current: 66, benchmark: 68, collection: "auto", frequency: "realtime" },
      { id: "kpi-14", name: "DLP Events", owner: "Threat Intel", unit: "count", target: 82, current: 73, benchmark: 79, collection: "semi-auto", frequency: "daily" },
      { id: "kpi-15", name: "Vendor Risk Avg", owner: "Security Ops", unit: "days", target: 85, current: 80, benchmark: 90, collection: "manual", frequency: "weekly" },
      { id: "kpi-16", name: "Compliance Audit Pass Rate", owner: "Risk Mgmt", unit: "minutes", target: 88, current: 87, benchmark: 67, collection: "auto", frequency: "monthly" },
      { id: "kpi-17", name: "Awareness Score", owner: "SOC", unit: "%", target: 91, current: 94, benchmark: 78, collection: "semi-auto", frequency: "realtime" },
      { id: "kpi-18", name: "SOC Utilization", owner: "GRC", unit: "score", target: 94, current: 55, benchmark: 89, collection: "manual", frequency: "daily" },
      { id: "kpi-19", name: "Automation Coverage", owner: "AppSec", unit: "count", target: 97, current: 62, benchmark: 66, collection: "auto", frequency: "weekly" },
      { id: "kpi-20", name: "Risk Register Currency", owner: "Cloud Sec", unit: "days", target: 70, current: 69, benchmark: 77, collection: "semi-auto", frequency: "monthly" },
    ];
    const benchmarkSources = [
      { source: "NIST CSF", mappedKPIs: 6, alignment: 72, lastReview: "2026-04-02", status: "aligned" },
      { source: "CIS Controls v8", mappedKPIs: 7, alignment: 89, lastReview: "2026-05-25", status: "partial" },
      { source: "ISO 27001:2022", mappedKPIs: 8, alignment: 67, lastReview: "2026-06-20", status: "reviewing" },
      { source: "PCI DSS 4.0", mappedKPIs: 3, alignment: 84, lastReview: "2026-01-15", status: "aligned" },
      { source: "SOC 2 Type II", mappedKPIs: 4, alignment: 62, lastReview: "2026-02-10", status: "partial" },
      { source: "MITRE ATT&CK", mappedKPIs: 5, alignment: 79, lastReview: "2026-03-05", status: "reviewing" },
      { source: "SANS Top 20", mappedKPIs: 6, alignment: 96, lastReview: "2026-04-28", status: "aligned" },
      { source: "OWASP Top 10", mappedKPIs: 7, alignment: 74, lastReview: "2026-05-23", status: "partial" },
    ];
  ...
  private _renderThreatHuntingCampaigns() {
    const campaigns = [
      { id: "HC-1001", name: "Lateral Movement Sweep", status: "active", hypothesis: "H1: Actors using pass-the-hash for lateral movement", leadHunter: "Alice Chen", findings: 25, startDate: "2026-02-22", endDate: null, effectiveness: 82 },
      { id: "HC-1002", name: "Credential Harvesting Hunt", status: "completed", hypothesis: "H2: Actors using web shells for persistence", leadHunter: "Bob Martinez", findings: 28, startDate: "2026-01-05", endDate: "2026-06-11", effectiveness: 42 },
      { id: "HC-1003", name: "Persistence Mechanism Audit", status: "planned", hypothesis: "H3: Actors using scheduled tasks for data theft", leadHunter: "Carol Wu", findings: 31, startDate: "2026-04-16", endDate: null, effectiveness: 61 },
      { id: "HC-1004", name: "C2 Beacon Detection", status: "in-review", hypothesis: "H4: Actors using DNS tunneling for C2 communication", leadHunter: "Dave Kim", findings: 34, startDate: "2026-03-27", endDate: null, effectiveness: 80 },
      { id: "HC-1005", name: "Data Exfiltration Patterns", status: "active", hypothesis: "H5: Actors using encrypted channels for privilege escalation", leadHunter: "Eve Johnson", findings: 37, startDate: "2026-02-10", endDate: null, effectiveness: 40 },
      { id: "HC-1006", name: "Privilege Escalation Scan", status: "completed", hypothesis: "H6: Actors using token impersonation for defense evasion", leadHunter: "Frank Liu", findings: 40, startDate: "2026-01-21", endDate: "2026-04-23", effectiveness: 59 },
      { id: "HC-1007", name: "Supply Chain Implant Hunt", status: "planned", hypothesis: "H7: Actors using poisoned images for initial access", leadHunter: "Grace Park", findings: 43, startDate: "2026-04-04", endDate: null, effectiveness: 78 },
      { id: "HC-1008", name: "Insider Threat Indicators", status: "in-review", hypothesis: "H8: Actors using legitimate tools for credential access", leadHunter: "Hector Silva", findings: 46, startDate: "2026-03-15", endDate: null, effectiveness: 97 },
      { id: "HC-1009", name: "Cloud Metadata Analysis", status: "active", hypothesis: "H9: Actors using API keys for command execution", leadHunter: "Alice Chen", findings: 1, startDate: "2026-02-26", endDate: null, effectiveness: 57 },
      { id: "HC-1010", name: "DNS Tunnel Detection", status: "completed", hypothesis: "H10: Actors using encoded subdomains for exfiltration", leadHunter: "Bob Martinez", findings: 4, startDate: "2026-01-09", endDate: "2026-05-07", effectiveness: 76 },
      { id: "HC-1011", name: "Fileless Malware Search", status: "planned", hypothesis: "H11: Actors using WMI providers for discovery", leadHunter: "Carol Wu", findings: 7, startDate: "2026-04-20", endDate: null, effectiveness: 95 },
      { id: "HC-1012", name: "Zero-Day Exploit Traces", status: "in-review", hypothesis: "H12: Actors using exploit kits for collection", leadHunter: "Dave Kim", findings: 10, startDate: "2026-03-03", endDate: null, effectiveness: 55 },
    ];
    const hunterLeaderboard = [
      { hunter: "Alice Chen", campaigns: 14, findings: 74, highSeverity: 11, avgScore: 92, streak: 2 },
      { hunter: "Bob Martinez", campaigns: 11, findings: 103, highSeverity: 16, avgScore: 85, streak: 3 },
      { hunter: "Carol Wu", campaigns: 8, findings: 16, highSeverity: 21, avgScore: 78, streak: 4 },
      { hunter: "Dave Kim", campaigns: 5, findings: 45, highSeverity: 0, avgScore: 71, streak: 5 },
      { hunter: "Eve Johnson", campaigns: 15, findings: 74, highSeverity: 5, avgScore: 64, streak: 6 },
      { hunter: "Frank Liu", campaigns: 12, findings: 103, highSeverity: 10, avgScore: 57, streak: 7 },
      { hunter: "Grace Park", campaigns: 9, findings: 16, highSeverity: 15, avgScore: 94, streak: 8 },
      { hunter: "Hector Silva", campaigns: 6, findings: 45, highSeverity: 20, avgScore: 87, streak: 1 },
    ];
    const mitreMapping = [
      { tactic: "Initial Access", techniques: 6, campaigns: 2, coverage: 85 },
      { tactic: "Execution", techniques: 5, campaigns: 1, coverage: 65 },
      { tactic: "Persistence", techniques: 4, campaigns: 6, coverage: 45 },
      { tactic: "Privilege Escalation", techniques: 3, campaigns: 5, coverage: 96 },
      { tactic: "Defense Evasion", techniques: 2, campaigns: 4, coverage: 76 },
      { tactic: "Credential Access", techniques: 12, campaigns: 3, coverage: 56 },
      { tactic: "Discovery", techniques: 11, campaigns: 2, coverage: 36 },
      { tactic: "Lateral Movement", techniques: 10, campaigns: 1, coverage: 87 },
      { tactic: "Collection", techniques: 9, campaigns: 6, coverage: 67 },
      { tactic: "Exfiltration", techniques: 8, campaigns: 5, coverage: 47 },
      { tactic: "Command & Control", techniques: 7, campaigns: 4, coverage: 98 },
      { tactic: "Impact", techniques: 6, campaigns: 3, coverage: 78 },
    ];
    return html`
  ...
  private _renderControlInventory() {
    const controls = [
      { id: "CTL-2001", name: "MFA Enforcement", domain: "Access Control", status: "implemented", effectiveness: 79, lastTest: "2026-02-14", nextReview: "2026-06-14", owner: "SOC", risk: "Low" },
      { id: "CTL-2002", name: "Network Segmentation", domain: "Network Security", status: "partial", effectiveness: 42, lastTest: "2026-01-27", nextReview: "2026-07-05", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2003", name: "EDR Deployment", domain: "Endpoint Protection", status: "planned", effectiveness: 49, lastTest: "2026-04-12", nextReview: "2026-08-24", owner: "IT Ops", risk: "High" },
      { id: "CTL-2004", name: "DLP Policy", domain: "Data Protection", status: "gap", effectiveness: 5, lastTest: "2026-03-25", nextReview: "2026-09-15", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2005", name: "SSO Integration", domain: "Identity Management", status: "implemented", effectiveness: 91, lastTest: "2026-02-10", nextReview: "2026-10-06", owner: "IAM", risk: "Low" },
      { id: "CTL-2006", name: "SAST Pipeline", domain: "Application Security", status: "partial", effectiveness: 19, lastTest: "2026-01-23", nextReview: "2026-11-25", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2007", name: "CSPM Scanning", domain: "Cloud Security", status: "planned", effectiveness: 26, lastTest: "2026-04-08", nextReview: "2026-12-16", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2008", name: "Badge Access", domain: "Physical Security", status: "gap", effectiveness: 33, lastTest: "2026-03-21", nextReview: "2026-05-07", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2009", name: "Least Privilege", domain: "Access Control", status: "implemented", effectiveness: 44, lastTest: "2026-02-06", nextReview: "2026-06-26", owner: "SOC", risk: "Low" },
      { id: "CTL-2010", name: "Firewall Rules", domain: "Network Security", status: "partial", effectiveness: 47, lastTest: "2026-01-19", nextReview: "2026-07-17", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2011", name: "Disk Encryption", domain: "Endpoint Protection", status: "planned", effectiveness: 3, lastTest: "2026-04-04", nextReview: "2026-08-08", owner: "IT Ops", risk: "High" },
      { id: "CTL-2012", name: "Data Classification", domain: "Data Protection", status: "gap", effectiveness: 10, lastTest: "2026-03-17", nextReview: "2026-09-27", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2013", name: "PAM Implementation", domain: "Identity Management", status: "implemented", effectiveness: 56, lastTest: "2026-02-02", nextReview: "2026-10-18", owner: "IAM", risk: "Low" },
      { id: "CTL-2014", name: "DAST Pipeline", domain: "Application Security", status: "partial", effectiveness: 24, lastTest: "2026-01-15", nextReview: "2026-11-09", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2015", name: "IAM Policy Review", domain: "Cloud Security", status: "planned", effectiveness: 31, lastTest: "2026-04-28", nextReview: "2026-12-28", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2016", name: "Visitor Management", domain: "Physical Security", status: "gap", effectiveness: 38, lastTest: "2026-03-13", nextReview: "2026-05-19", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2017", name: "Access Reviews", domain: "Access Control", status: "implemented", effectiveness: 68, lastTest: "2026-02-26", nextReview: "2026-06-10", owner: "SOC", risk: "Low" },
      { id: "CTL-2018", name: "IDS/IPS Tuning", domain: "Network Security", status: "partial", effectiveness: 1, lastTest: "2026-01-11", nextReview: "2026-07-01", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2019", name: "Patch Management", domain: "Endpoint Protection", status: "planned", effectiveness: 8, lastTest: "2026-04-24", nextReview: "2026-08-20", owner: "IT Ops", risk: "High" },
      { id: "CTL-2020", name: "Backup Encryption", domain: "Data Protection", status: "gap", effectiveness: 15, lastTest: "2026-03-09", nextReview: "2026-09-11", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2021", name: "Password Policy", domain: "Identity Management", status: "implemented", effectiveness: 80, lastTest: "2026-02-22", nextReview: "2026-10-02", owner: "IAM", risk: "Low" },
      { id: "CTL-2022", name: "Container Scanning", domain: "Application Security", status: "partial", effectiveness: 29, lastTest: "2026-01-07", nextReview: "2026-11-21", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2023", name: "WAF Configuration", domain: "Cloud Security", status: "planned", effectiveness: 36, lastTest: "2026-04-20", nextReview: "2026-12-12", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2024", name: "CCTV Coverage", domain: "Physical Security", status: "gap", effectiveness: 43, lastTest: "2026-03-05", nextReview: "2026-05-03", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2025", name: "RBAC Enforcement", domain: "Access Control", status: "implemented", effectiveness: 92, lastTest: "2026-02-18", nextReview: "2026-06-22", owner: "SOC", risk: "Low" },
      { id: "CTL-2026", name: "VPN Management", domain: "Network Security", status: "partial", effectiveness: 6, lastTest: "2026-01-03", nextReview: "2026-07-13", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2027", name: "App Whitelisting", domain: "Endpoint Protection", status: "planned", effectiveness: 13, lastTest: "2026-04-16", nextReview: "2026-08-04", owner: "IT Ops", risk: "High" },
      { id: "CTL-2028", name: "Key Management", domain: "Data Protection", status: "gap", effectiveness: 20, lastTest: "2026-03-01", nextReview: "2026-09-23", owner: "Data Gov", risk: "Critical" },
    ];
    const gapAnalysis = [
      { gap: "Insufficient MFA coverage for legacy apps", severity: "High", remediationPlan: "Plan R3001", eta: "2026-Q4", estimatedCost: "88k" },
      { gap: "Missing network micro-segmentation", severity: "Medium", remediationPlan: "Plan R3002", eta: "2026-Q3", estimatedCost: "117k" },
      { gap: "Inconsistent EDR deployment", severity: "Medium", remediationPlan: "Plan R3003", eta: "2026-Q2", estimatedCost: "146k" },
      { gap: "DLP not covering cloud storage", severity: "Low", remediationPlan: "Plan R3004", eta: "2026-Q4", estimatedCost: "175k" },
      { gap: "SSO not integrated with all SaaS", severity: "High", remediationPlan: "Plan R3005", eta: "2026-Q3", estimatedCost: "23k" },
    ];
    return html`
  ...
  private _renderIncidentCostTracker() {
    const incidents = [
      { id: "INC-7001", name: "Security Incident 1", severity: "Critical", totalCost: 922000, responseCost: 248940, recoveryCost: 295040, legalCost: 129080, regulatoryCost: 64540, insuranceClaim: 414900, avoidedCost: 478000, date: "2026-02-06" },
      { id: "INC-7002", name: "Security Incident 2", severity: "High", totalCost: 925000, responseCost: 314500, recoveryCost: 203500, legalCost: 101750, regulatoryCost: 120250, insuranceClaim: 0, avoidedCost: 11000, date: "2026-01-15" },
      { id: "INC-7003", name: "Security Incident 3", severity: "Medium", totalCost: 928000, responseCost: 185600, recoveryCost: 306240, legalCost: 74240, regulatoryCost: 74240, insuranceClaim: 371200, avoidedCost: 40000, date: "2026-04-24" },
      { id: "INC-7004", name: "Security Incident 4", severity: "Low", totalCost: 931000, responseCost: 251370, recoveryCost: 214130, legalCost: 46550, regulatoryCost: 130340, insuranceClaim: 0, avoidedCost: 69000, date: "2026-03-05" },
      { id: "INC-7005", name: "Security Incident 5", severity: "Critical", totalCost: 934000, responseCost: 317560, recoveryCost: 317560, legalCost: 168120, regulatoryCost: 84060, insuranceClaim: 326900, avoidedCost: 98000, date: "2026-02-14" },
      { id: "INC-7006", name: "Security Incident 6", severity: "High", totalCost: 937000, responseCost: 187400, recoveryCost: 224880, legalCost: 140550, regulatoryCost: 140550, insuranceClaim: 0, avoidedCost: 127000, date: "2026-01-23" },
      { id: "INC-7007", name: "Security Incident 7", severity: "Medium", totalCost: 940000, responseCost: 253800, recoveryCost: 329000, legalCost: 112800, regulatoryCost: 94000, insuranceClaim: 282000, avoidedCost: 156000, date: "2026-04-04" },
      { id: "INC-7008", name: "Security Incident 8", severity: "Low", totalCost: 943000, responseCost: 320620, recoveryCost: 235750, legalCost: 84870, regulatoryCost: 47150, insuranceClaim: 0, avoidedCost: 185000, date: "2026-03-13" },
      { id: "INC-7009", name: "Security Incident 9", severity: "Critical", totalCost: 946000, responseCost: 189200, recoveryCost: 340560, legalCost: 56760, regulatoryCost: 104060, insuranceClaim: 718960, avoidedCost: 214000, date: "2026-02-22" },
      { id: "INC-7010", name: "Security Incident 10", severity: "High", totalCost: 949000, responseCost: 256230, recoveryCost: 246740, legalCost: 180310, regulatoryCost: 56940, insuranceClaim: 0, avoidedCost: 243000, date: "2026-01-03" },
      { id: "INC-7011", name: "Security Incident 11", severity: "Medium", totalCost: 952000, responseCost: 323680, recoveryCost: 352240, legalCost: 152320, regulatoryCost: 114240, insuranceClaim: 675920, avoidedCost: 272000, date: "2026-04-12" },
      { id: "INC-7012", name: "Security Incident 12", severity: "Low", totalCost: 955000, responseCost: 191000, recoveryCost: 257850, legalCost: 124150, regulatoryCost: 66850, insuranceClaim: 0, avoidedCost: 301000, date: "2026-03-21" },
    ];
    const yearlyTrend = [
      { month: "Jan", incidents: 4, totalCost: "688k", avgCost: "183k", insured: 35 },
      { month: "Feb", incidents: 12, totalCost: "731k", avgCost: "49k", insured: 35 },
      { month: "Mar", incidents: 9, totalCost: "774k", avgCost: "96k", insured: 35 },
      { month: "Apr", incidents: 6, totalCost: "66k", avgCost: "143k", insured: 35 },
      { month: "May", incidents: 3, totalCost: "109k", avgCost: "190k", insured: 35 },
      { month: "Jun", incidents: 11, totalCost: "152k", avgCost: "56k", insured: 35 },
    ];
