...
export class ScBcpDashboard extends LitElement {
  ...
  private _data: MockItem[] = [
    {name:"BCP Plan: Core Banking System",status:"active",risk:"critical",detail:"RTO: 4h | RPO: 1h | DR Site: Shanghai backup | Last test: 30d ago | Status: Compliant"},
    {name:"BCP Plan: Payment Gateway",status:"active",risk:"high",detail:"RTO: 2h | RPO: 15min | DR Site: Active-active | Last test: 14d ago | Status: Compliant"},
    {name:"BCP Plan: Customer Portal",status:"review",risk:"medium",detail:"RTO: 8h | RPO: 4h | DR Site: Cold standby | Last test: 90d ago | Status: Review needed"},
    {name:"BCP Plan: HR System",status:"active",risk:"low",detail:"RTO: 24h | RPO: 12h | DR Site: Cloud backup | Last test: 60d ago | Status: Compliant"},
    {name:"BCP Plan: Email & Comms",status:"attention",risk:"medium",detail:"RTO: 4h | RPO: 1h | DR Site: Microsoft 365 failover | Last test: Never | Status: NOT TESTED"}
  ];
  ...
  render() {
    ...
    return html`<div class="panel"><div class="pt">Bcp Dashboard</div>
