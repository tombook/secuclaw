/**
 * sc-exfil-detection - Exfil Detection
...
@customElement('sc-exfil-detection')
export class ScExfilDetection extends LitElement {
  static styles = css`
...
@state() private _tablePage = 1;
  ...
  @state() private _comments: CommentEntry[] = [
    { id: 'c1', author: 'soc-tier1', timestamp: '2026-04-23 04:00', text: 'Initial assessment started for Exfil Detection finding #1' },
  ...
  private _items: PanelItem[] = [
      {
            "id": "exfil-detection-1",
            "title": "Email Channel DLP",
            "severity": "high",
            "status": "open",
            "category": "Security",
            "source": "SIEM",
            "description": "24h violations: 34 | Top: SSN patterns (12), Credit cards (8), Source code (6) | Blocked: 28, Warned: 6",
      ...
      {
            "id": "exfil-detection-2",
            "title": "USB Device Monitor",
            "severity": "medium",
            "status": "in-progress",
            "category": "Network",
            "source": "EDR",
            "description": "Active USB devices: 23 | Blocked writes: 3 | Unauthorized devices: 1 (EP-103) | Policy: Encrypted only",
      ...
      {
            "id": "exfil-detection-3",
            "title": "Cloud Upload Detection",
            "severity": "high",
            "status": "resolved",
            "category": "Access",
            "source": "Scanner",
            "description": "Cloud apps monitored: 15 | Suspicious uploads: 5 | Large file (>100MB) to personal cloud: 2 incidents",
      ...
      {
            "id": "exfil-detection-4",
            "title": "Network Exfil (DNS/ICMP)",
            "severity": "critical",
            "status": "open",
            "category": "Compliance",
            "source": "Audit",
            "description": "DNS tunnel: 2.3GB via exfil.evil.com | ICMP tunnel: 450MB unusual payload | Blocked: DNS sinkhole active",
      ...
      {
            "id": "exfil-detection-5",
            "title": "Exfil Detection Finding #5",
            "severity": "medium",
            "status": "open",
            "category": "Operations",
            "source": "Manual",
            "description": "Automated exfil detection assessment finding detected during routine scan of infrastructure component. Review and remediation recommended.",
      ...
      {
            "id": "exfil-detection-6",
            "title": "Exfil Detection Finding #6",
            "severity": "high",
            "status": "open",
            "category": "Security",
            "source": "SIEM",
      ...
      {
            "id": "exfil-detection-7",
            "title": "Exfil Detection Finding #7",
            "severity": "low",
            "status": "open",
            "category": "Network",
            "source": "EDR",
      ...
      {
            "id": "exfil-detection-8",
            "title": "Exfil Detection Finding #8",
            "severity": "medium",
            "status": "open",
            "category": "Access",
            "source": "Scanner",
      ...
      {
            "id": "exfil-detection-9",
            "title": "Exfil Detection Finding #9",
            "severity": "high",
            "status": "open",
            "category": "Compliance",
            "source": "Audit",
      ...
      {
            "id": "exfil-detection-10",
            "title": "Exfil Detection Finding #10",
            "severity": "low",
            "status": "open",
            "category": "Operations",
            "source": "Manual",
  ...
  private _history: HistoryEntry[] = [
    { timestamp: '2026-04-23 04:15', action: 'Auto-correlated', user: 'system', details: 'Grouped related findings from Exfil Detection analysis' },
    { timestamp: '2026-04-23 03:00', action: 'Created', user: 'scanner', details: 'New Exfil Detection finding detected by automated assessment' },
    ...
    { timestamp: '2026-04-22 22:00', action: 'Resolved', user: 'security-eng', details: 'Remediation applied and verified for Exfil Detection finding' },
    { timestamp: '2026-04-22 18:00', action: 'Created', user: 'audit', details: 'Compliance audit identified Exfil Detection gap requiring remediation' },
    ...
    { timestamp: '2026-04-21 16:00', action: 'Resolved', user: 'soc-tier1', details: 'False positive confirmed - benign activity flagged by Exfil Detection scan' },
    { timestamp: '2026-04-21 12:00', action: 'Exported', user: 'compliance', details: 'Exported Exfil Detection findings for Q1 compliance report' },
  ];
...
private _workflowTasks: WorkflowTask[] = [
    { id: 'wt-1', title: 'Review Exfil Detection finding #1', status: 'active', assignee: 'soc-tier1', blockedBy: [], slaDeadline: '2026-04-23T12:00:00Z', priority: 'p1', createdAt: '2026-04-23T00:00:00Z', completedAt: null },
    ...
    { id: 'wt-3', title: 'Update Exfil Detection detection rules', status: 'blocked', assignee: 'soc-tier2', blockedBy: ['wt-2'], slaDeadline: '2026-04-24T00:00:00Z', priority: 'p2', createdAt: '2026-04-23T03:00:00Z', completedAt: null },
    ...
    { id: 'wt-8', title: 'Archive resolved Exfil Detection findings', status: 'failed', assignee: 'soc-tier1', blockedBy: [], slaDeadline: '2026-04-23T08:00:00Z', priority: 'p4', createdAt: '2026-04-22T22:00:00Z', completedAt: null },
  ];

private _executionHistory: ExecutionRecord[] = [
    {
      id: 'exec-1', name: 'Exfil Detection Full Assessment Run', startedAt: '2026-04-22T10:00:00Z', completedAt: '2026-04-22T10:12:00Z', status: 'success',
      steps: [
    ...
    {
      id: 'exec-2', name: 'Exfil Detection Delta Scan', startedAt: '2026-04-23T02:00:00Z', completedAt: '2026-04-23T02:05:00Z', status: 'failed',
      steps: [
  ...
  private _runExecution() {
    ...
    const exec: ExecutionRecord = {
      id: 'exec-' + Date.now(), name: 'Exfil Detection Assessment ' + new Date().toISOString().slice(0, 10), startedAt: new Date().toISOString(), completedAt: null, status: 'running', steps,
    };
  ...
  private _renderExecutionPanel(): unknown {
    ...
    return html`
      <div class="form-section">
        ...
        ` : html`<div class="empty-state">Click "Run Assessment" to start the Exfil Detection analysis pipeline</div>`}
      </div>
      <div class="form-section">
        ...
        <div class="settings-card">
          ...
          <div style="display:flex;gap:8px;margin-top:4px;">
            <button class="btn primary" @click=${() => {
              ...
              const a = document.createElement('a'); a.href = url; a.download = 'exfil-detection-config.json'; a.click();
    ...
    return html`
      <div style="margin-top:12px;">
        ...
        <div style="display:flex;gap:6px;margin-top:8px;">
          <input class="search-box" type="text" placeholder="Add a comment..." style="min-width:auto;flex:1;" id="exfil-detection-comment-input" />
          <button class="btn primary" @click=${() => {
            const input = this.shadowRoot?.querySelector('#exfil-detection-comment-input') as HTMLInputElement;
  ...
  private _exportJSON() {
    ...
    const url = URL.createObjectURL(blob);
    const a = document.createElement('a'); a.href = url; a.download = 'sc-exfil-detection-data.json'; a.click();
    URL.revokeObjectURL(url);
  }
  ...
  private _exportCSV() {
    ...
    const url = URL.createObjectURL(blob);
    const a = document.createElement('a'); a.href = url; a.download = 'sc-exfil-detection-data.csv'; a.click();
    URL.revokeObjectURL(url);
  }


  // --- Domain Rules Engine ---
  @state() private _exfRules: { id: string; name: string; category: string; severity: Severity; enabled: boolean; lastEval: string; passRate: number }[] = [];
  private _initExfRules() {
    const rules = [
    ...
    this._exfRules = rules;
  }
  private _evaluateExfRules(): { passed: number; failed: number; skipped: number; total: number } {
    let passed = 0, failed = 0, skipped = 0;
    this._exfRules.forEach(r => { if (!r.enabled) { skipped++; } else if (r.passRate >= 80) { passed++; } else { failed++; } });
    return { passed, failed, skipped, total: this._exfRules.length };
  }

  // --- CVSS Scoring ---
  @state() private _exfcvssData: { itemId: string; vector: string; base: number; temporal: number; environmental: number; overall: number }[] = [];
  private _initExfCvss() {
    ...
    this._exfcvssData = vectors.map((v, i) => {
  ...
  // --- Anomaly Detection ---
  @state() private _exfanomalies: { id: string; type: string; severity: Severity; description: string; detected: string; confidence: number; affected: string[] }[] = [];
  private _runExfAnomalyDetection() {
    const types = [
    ...
    this._exfanomalies = types.map((a, i) => ({
  ...
  // --- Trend Prediction ---
  @state() private _exfpredictions: { horizon: string; metric: string; current: number; predicted: number; direction: 'up' | 'down' | 'stable'; confidence: number }[] = [];
  private _generateExfPredictions() {
    this._exfpredictions = [
  ...
  // --- Approval Workflow ---
  @state() private _exfApprovals: { id: string; title: string; requester: string; status: 'pending' | 'approved' | 'rejected' | 'expired'; createdAt: string; priority: Priority; type: string }[] = [];
  private _initExfApprovals() {
    this._exfApprovals = [
  ...
  private _approveExfItem(id: string) { const item = this._exfApprovals.find(a => a.id === id); if (item) item.status = 'approved'; this.requestUpdate(); }
  private _rejectExfItem(id: string) { const item = this._exfApprovals.find(a => a.id === id); if (item) item.status = 'rejected'; this.requestUpdate(); }

  // --- Activity Feed ---
  @state() private _exfActivity: { id: string; action: string; user: string; target: string; timestamp: string }[] = [];
  private _initExfActivity() {
    const actions = [
    ...
    this._exfActivity = actions.map((a, i) => ({ id: 'ACT-' + String(i + 1).padStart(3, '0'), ...a, timestamp: new Date(Date.now() - i * 3600000).toISOString() }));
  }

  // --- Notification System ---
  @state() private _exfNotifications: { id: string; message: string; type: 'info' | 'warning' | 'error' | 'success'; read: boolean; timestamp: string }[] = [];
  private _initExfNotifications() {
    this._exfNotifications = [
  ...
  private _markExfNotifRead(id: string) { const n = this._exfNotifications.find(x => x.id === id); if (n) n.read = true; this.requestUpdate(); }

  // --- Panel Configuration ---
  @state() private _exfConfig: { layout: 'compact' | 'default' | 'expanded'; theme: 'dark' | 'midnight' | 'slate'; showAnomalies: boolean; showPredictions: boolean; autoRefresh: boolean; refreshInterval: number } = {
    layout: 'default', theme: 'dark', showAnomalies: true, showPredictions: true, autoRefresh: true, refreshInterval: 60,
  };
  private _exfPresets: { name: string; config: typeof this._exfConfig }[] = [
  ...
  private _applyExfPreset(preset: typeof this._exfPresets[0]) { this._exfConfig = { ...preset.config }; this.requestUpdate(); }

  private _renderExfTreemapSVG(): string {
    const categories = [
  ...
  private _renderExfSankeySVG(): string {
  ...
  // --- Render: Rules Engine ---
  private _renderExfRules(): any {
    const ev = this._evaluateExfRules();
    return html`
  ...
  private _renderExfAnomalies(): any {
  ...
  // --- Render: Approvals ---
  private _renderExfApprovals(): any {
          ...
          $${this._exfApprovals.map(a => html`
            <div style="padding:6px 8px;background:#1f2937;border-radius:4px">
              ...
              $${a.status === 'pending' ? html`
                <div style="display:flex;gap:4px;margin-top:4px">
                  <button class="btn success" style="padding:2px 8px;font-size:9px" @click=$${() => this._approveExfItem(a.id)}>Approve</button>
                  <button class="btn error" style="padding:2px 8px;font-size:9px" @click=$${() => this._rejectExfItem(a.id)}>Reject</button>
                </div>` : nothing}
            </div>`)}
        </div>
      </div>`;
  ...
  private _renderExfNotifications(): any {
    const tc = (t: string) => t === 'error' ? '#ef4444' : t === 'warning' ? '#eab308' : t === 'success' ? '#22c55e' : '#3b82f6';
    const unread = this._exfNotifications.filter(n => !n.read).length;
    return html`
      <div style="background:#1a1d27;border-radius:8px;padding:12px;margin-top:12px">
        ...
        <div style="display:flex;flex-direction:column;gap:4px;max-height:120px;overflow-y:auto">
          $${this._exfNotifications.map(n => html`
            <div style="display:flex;align-items:center;gap:8px;padding:4px 8px;background:$${n.read ? '#1f2937' : '#252a36'};border-radius:4px;font-size:10px;opacity:$${n.read ? '0.6' : '1'};cursor:pointer" @click=$${() => this._markExfNotifRead(n.id)}>
      ...
      <div style="background:#1a1d27;border-radius:8px;padding:12px;margin-top:12px">
        ...
        <div style="display:flex;flex-direction:column;gap:6px;font-size:10px">
          <div style="display:flex;align-items:center;gap:8px">
            ...
            <select class="form-input" style="flex:1" @change=$${(e: Event) => { this._exfConfig.layout = (e.target as HTMLSelectElement).value as any; this.requestUpdate(); }}>
              <option value="compact" ?selected=$${this._exfConfig.layout === 'compact'}>Compact</option>
              <option value="default" ?selected=$${this._exfConfig.layout === 'default'}>Default</option>
              <option value="expanded" ?selected=$${this._exfConfig.layout === 'expanded'}>Expanded</option>
            </select>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Theme</span>
            <select class="form-input" style="flex:1" @change=$${(e: Event) => { this._exfConfig.theme = (e.target as HTMLSelectElement).value as any; this.requestUpdate(); }}>
              <option value="dark" ?selected=$${this._exfConfig.theme === 'dark'}>Dark</option>
              <option value="midnight" ?selected=$${this._exfConfig.theme === 'midnight'}>Midnight</option>
              <option value="slate" ?selected=$${this._exfConfig.theme === 'slate'}>Slate</option>
            </select>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Auto Refresh</span>
            <input type="checkbox" ?checked=$${this._exfConfig.autoRefresh} @change=$${() => { this._exfConfig.autoRefresh = !this._exfConfig.autoRefresh; this.requestUpdate(); }}/>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Show Anomalies</span>
            <input type="checkbox" ?checked=$${this._exfConfig.showAnomalies} @change=$${() => { this._exfConfig.showAnomalies = !this._exfConfig.showAnomalies; this.requestUpdate(); }}/>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Show Predictions</span>
            <input type="checkbox" ?checked=$${this._exfConfig.showPredictions} @change=$${() => { this._exfConfig.showPredictions = !this._exfConfig.showPredictions; this.requestUpdate(); }}/>
          </div>
          <div style="margin-top:6px;font-weight:600">Presets</div>
          <div style="display:flex;gap:4px">
            $${this._exfPresets.map(ps => html`<button class="btn" style="padding:2px 8px;font-size:9px" @click=$${() => this._applyExfPreset(ps)}>$${ps.name}</button>`)}
          </div>
        </div>
      </div>`;
  }
...
@state() private _spmRiskRegister3 = { id: "RSK-003", title: "Risk Item 3", category: "operational", likelihood: 4, impact: "high", owner: "Security Team", status: "open", mitigation: "Implement compensating controls", targetDate: "2026-02-13" } as any;
  ...
  @state() private _exfilDetectiCourses: Array<{id:string;title:string;category:string;duration:number;enrolled:number;completed:number;difficulty:string;rating:number}> = [
  ...
  @state() private _exfilDetectiLearningPaths: Array<{id:string;name:string;courseIds:string[];progress:number;enrolled:number}> = [
  ...
  @state() private _exfilDetectiDeptCompliance: Array<{dept:string;trainedPct:number;targetPct:number;avgScore:number;certCount:number}> = [
  ...
  @state() private _exfilDetectiSkillsGaps: Array<{skill:string;current:number;required:number;gap:number;priority:string}> = [
  ...
  private _renderExfildetectiTraining(): TemplateResult {
    const courses = this._exfilDetectiCourses;
    const deptComp = this._exfilDetectiDeptCompliance;
    return html`
  ...
  @state() private _exfilDetectiCorrRules: Array<{id:string;name:string;sources:string[];logic:string;severity:string;active:boolean;lastTriggered:string}> = [
  ...
  @state() private _exfilDetectiEventTimeline: Array<{timestamp:string;source:string;eventType:string;details:string;correlated:boolean}> = [
  ...
  @state() private _exfilDetectiFalsePosMetrics: {totalEvents:number;correlatedEvents:number;falsePositives:number;fpRate:number;topFpRules:string[]} = {
  ...
  @state() private _exfilDetectiEventPatterns: Array<{id:string;pattern:string;frequency:number;firstSeen:string;lastSeen:string;status:string}> = [
  ...
  private _renderExfildetectiEventCorr(): TemplateResult {
    const rules = this._exfilDetectiCorrRules;
    const timeline = this._exfilDetectiEventTimeline;
    const fpMetrics = this._exfilDetectiFalsePosMetrics;
    return html`
  ...
  @state() private _exfilDetectiContainerScans: Array<{image:string;registry:string;critical:number;high:number;medium:number;scanDate:string;status:string}> = [
  ...
  @state() private _exfilDetectiK8sPods: Array<{namespace:string;pod:string;securityContext:string;hostIPC:boolean;hostPID:boolean;privileged:boolean;riskLevel:string}> = [
  ...
  @state() private _exfilDetectiServerlessRisk: Array<{function:string;runtime:string;timeout:number;iamPerms:string;externalCalls:number;riskScore:number}> = [
  ...
  @state() private _exfilDetectiRuntimeAlerts: Array<{id:string;workload:string;alertType:string;severity:string;description:string;timestamp:string}> = [
  ...
  private _renderExfildetectiCloudWl(): TemplateResult {
    const containers = this._exfilDetectiContainerScans;
    const pods = this._exfilDetectiK8sPods;
    const alerts = this._exfilDetectiRuntimeAlerts;
    return html`
  ...
  @state() private _exfilDetectiRiskTopTen: Array<{id:string;name:string;score:number;trend:string;owner:string;category:string;lastAssessed:string}> = [
  ...
  @state() private _exfilDetectiRiskCategories: Array<{category:string;count:number;avgScore:number;color:string}> = [
  ...
  @state() private _exfilDetectiRiskVelocity: Array<{week:string;newRisks:number;closedRisks:number;netChange:number}> = [
  ...
  @state() private _exfilDetectiRiskAppetite: {current:number;threshold:number;maxTolerated:number;status:string} = {
    current: 68, threshold: 55, maxTolerated: 80, status: 'Warning'
  };
  @state() private _exfilDetectiRiskOwnerMatrix: Array<{owner:string;criticalCount:number;highCount:number;mediumCount:number;complianceRate:number}> = [
  ...
  private _renderExfildetectiRiskDash(): TemplateResult {
    const riskItems = this._exfilDetectiRiskTopTen;
    const velocity = this._exfilDetectiRiskVelocity;
    const appetite = this._exfilDetectiRiskAppetite;
    return html`
  ...
  @state() private _complianceCalendarEvents: Array<{id: string; title: string; deadline: string; category: string; status: string; assignee: string; notes: string}> = [
    {id: 'cc-exfil-detection-001', title: 'SOX Section 404 Compliance Review', deadline: '2026-06-30', category: 'Regulatory', status: 'In Progress', assignee: 'Compliance Team', notes: 'Annual internal control assessment for financial reporting'},
    {id: 'cc-exfil-detection-002', title: 'GDPR Data Protection Impact Assessment', deadline: '2026-05-15', category: 'Privacy', status: 'Pending', assignee: 'DPO Office', notes: 'Quarterly DPIA for high-risk processing activities'},
    {id: 'cc-exfil-detection-003', title: 'ISO 27001 Surveillance Audit', deadline: '2026-07-20', category: 'Certification', status: 'Scheduled', assignee: 'QA Lead', notes: 'Stage 2 surveillance audit for ISMS certification renewal'},
    {id: 'cc-exfil-detection-004', title: 'PCI DSS v4.0 Gap Analysis', deadline: '2026-05-30', category: 'Payment', status: 'Not Started', assignee: 'Security Architect', notes: 'Assess current state against PCI DSS v4.0 requirements'},
    {id: 'cc-exfil-detection-005', title: 'NIST CSF Self-Assessment', deadline: '2026-08-15', category: 'Framework', status: 'Pending', assignee: 'CISO', notes: 'Biannual self-assessment against NIST Cybersecurity Framework'},
    {id: 'cc-exfil-detection-006', title: 'HIPAA Security Rule Audit', deadline: '2026-06-15', category: 'Healthcare', status: 'In Progress', assignee: 'Compliance Analyst', notes: 'Annual audit of administrative, physical, and technical safeguards'},
    {id: 'cc-exfil-detection-007', title: 'SOC 2 Type II Report Renewal', deadline: '2026-09-30', category: 'Audit', status: 'Scheduled', assignee: 'External Auditor', notes: 'Engage auditor for SOC 2 Type II examination period'},
    {id: 'cc-exfil-detection-008', title: 'FedRAMP Authorization Review', deadline: '2026-07-01', category: 'Government', status: 'Pending', assignee: 'FedRAMP PMO', notes: 'Review and update security authorization package'},
    {id: 'cc-exfil-detection-009', title: 'Annual Penetration Test', deadline: '2026-10-15', category: 'Testing', status: 'Not Started', assignee: 'Red Team Lead', notes: 'Comprehensive external and internal penetration testing engagement'},
    {id: 'cc-exfil-detection-010', title: 'Security Awareness Training Rollout', deadline: '2026-05-01', category: 'Training', status: 'Completed', assignee: 'Security Awareness Manager', notes: 'Q2 organization-wide security awareness training program'},
    {id: 'cc-exfil-detection-011', title: 'Vendor Security Review Cycle', deadline: '2026-06-01', category: 'Third Party', status: 'In Progress', assignee: 'Vendor Manager', notes: 'Quarterly review of critical vendor security posture and SLA compliance'},
    {id: 'cc-exfil-detection-012', title: 'Incident Response Plan Update', deadline: '2026-05-20', category: 'Operations', status: 'Pending', assignee: 'IR Team Lead', notes: 'Update IR procedures based on lessons learned from recent incidents'},
  ];
  ...
  @state() private _dataQualityMetrics: Array<{id: string; dataSource: string; completenessScore: number; accuracyScore: number; timelinessScore: number; consistencyScore: number; reliabilityRank: number; lastUpdated: string; issues: string[]; trend: string}> = [
    {id: 'dq-exfil-detection-001', dataSource: 'Vulnerability Scanner Feed', completenessScore: 94, accuracyScore: 91, timelinessScore: 88, consistencyScore: 95, reliabilityRank: 1, lastUpdated: '2026-04-23T08:00:00Z', issues: ['Minor delay in Nessus plugin updates'], trend: 'improving'},
    {id: 'dq-exfil-detection-002', dataSource: 'SIEM Event Logs', completenessScore: 87, accuracyScore: 93, timelinessScore: 96, consistencyScore: 89, reliabilityRank: 2, lastUpdated: '2026-04-23T07:30:00Z', issues: ['Some log sources showing gaps in off-hours'], trend: 'stable'},
    {id: 'dq-exfil-detection-003', dataSource: 'Asset Inventory Database', completenessScore: 82, accuracyScore: 78, timelinessScore: 75, consistencyScore: 84, reliabilityRank: 4, lastUpdated: '2026-04-22T18:00:00Z', issues: ['Shadow IT devices not fully cataloged', 'Decommissioned assets still listed'], trend: 'declining'},
    {id: 'dq-exfil-detection-004', dataSource: 'Threat Intelligence Platform', completenessScore: 91, accuracyScore: 89, timelinessScore: 92, consistencyScore: 87, reliabilityRank: 3, lastUpdated: '2026-04-23T06:00:00Z', issues: ['Some IOC sources lack confidence scoring'], trend: 'improving'},
    {id: 'dq-exfil-detection-005', dataSource: 'Identity Provider Logs', completenessScore: 96, accuracyScore: 97, timelinessScore: 98, consistencyScore: 96, reliabilityRank: 1, lastUpdated: '2026-04-23T09:00:00Z', issues: [], trend: 'stable'},
    {id: 'dq-exfil-detection-006', dataSource: 'Cloud Security Posture Data', completenessScore: 79, accuracyScore: 85, timelinessScore: 82, consistencyScore: 81, reliabilityRank: 5, lastUpdated: '2026-04-23T05:00:00Z', issues: ['Multi-cloud coverage gaps', 'API rate limiting affects scan frequency'], trend: 'declining'},
    {id: 'dq-exfil-detection-007', dataSource: 'Compliance Evidence Store', completenessScore: 88, accuracyScore: 86, timelinessScore: 80, consistencyScore: 83, reliabilityRank: 4, lastUpdated: '2026-04-21T14:00:00Z', issues: ['Manual evidence collection delays', 'Inconsistent formatting across frameworks'], trend: 'stable'},
    {id: 'dq-exfil-detection-008', dataSource: 'Network Flow Data', completenessScore: 92, accuracyScore: 90, timelinessScore: 94, consistencyScore: 91, reliabilityRank: 2, lastUpdated: '2026-04-23T08:30:00Z', issues: ['Encrypted traffic classification accuracy needs improvement'], trend: 'improving'},
  ];
  ...
  @state() private _workflowTemplates: Array<{id: string; name: string; description: string; category: string; steps: number; avgDuration: string; successRate: number; lastRun: string; manualInterventions: number; optimizationScore: number}> = [
    {id: 'wf-exfil-detection-001', name: 'Vulnerability Triage Pipeline', description: 'Automated vulnerability assessment, prioritization, and assignment workflow', category: 'Vulnerability Management', steps: 8, avgDuration: '12 min', successRate: 94.5, lastRun: '2026-04-23T06:00:00Z', manualInterventions: 2, optimizationScore: 87},
    {id: 'wf-exfil-detection-002', name: 'Incident Response Orchestration', description: 'End-to-end IR workflow from detection to containment and recovery', category: 'Incident Response', steps: 15, avgDuration: '45 min', successRate: 89.2, lastRun: '2026-04-22T14:30:00Z', manualInterventions: 5, optimizationScore: 72},
    {id: 'wf-exfil-detection-003', name: 'Access Request Approval Chain', description: 'Multi-level approval workflow for privileged access requests', category: 'Identity & Access', steps: 6, avgDuration: '4 hours', successRate: 97.1, lastRun: '2026-04-23T09:15:00Z', manualInterventions: 1, optimizationScore: 92},
    {id: 'wf-exfil-detection-004', name: 'Compliance Evidence Collection', description: 'Automated gathering and packaging of audit evidence artifacts', category: 'Compliance', steps: 10, avgDuration: '30 min', successRate: 91.8, lastRun: '2026-04-21T10:00:00Z', manualInterventions: 3, optimizationScore: 78},
    {id: 'wf-exfil-detection-005', name: 'Security Patch Deployment', description: 'Staged patch rollout with validation and rollback capability', category: 'Patch Management', steps: 12, avgDuration: '2 hours', successRate: 96.3, lastRun: '2026-04-20T22:00:00Z', manualInterventions: 1, optimizationScore: 85},
    {id: 'wf-exfil-detection-006', name: 'Threat Intelligence Enrichment', description: 'IOC enrichment and correlation with internal threat data', category: 'Threat Intelligence', steps: 7, avgDuration: '8 min', successRate: 93.7, lastRun: '2026-04-23T07:00:00Z', manualInterventions: 0, optimizationScore: 95},
    {id: 'wf-exfil-detection-007', name: 'Security Reporting Pipeline', description: 'Automated generation and distribution of security metrics reports', category: 'Reporting', steps: 5, avgDuration: '15 min', successRate: 98.9, lastRun: '2026-04-23T08:00:00Z', manualInterventions: 0, optimizationScore: 97},
    {id: 'wf-exfil-detection-008', name: 'Vendor Risk Assessment', description: 'Automated vendor security questionnaire distribution and scoring', category: 'Third Party', steps: 9, avgDuration: '3 days', successRate: 85.4, lastRun: '2026-04-19T11:00:00Z', manualInterventions: 4, optimizationScore: 65},
  ];
  ...
  @state() private _workflowExecutionHistory: Array<{workflowId: string; runDate: string; duration: string; status: string; trigger: string}> = [
    {workflowId: 'wf-exfil-detection-001', runDate: '2026-04-23T06:00:00Z', duration: '11 min 23 sec', status: 'Success', trigger: 'Scheduled'},
    {workflowId: 'wf-exfil-detection-002', runDate: '2026-04-22T14:30:00Z', duration: '42 min 15 sec', status: 'Success', trigger: 'Alert'},
    {workflowId: 'wf-exfil-detection-003', runDate: '2026-04-23T09:15:00Z', duration: '3h 45 min', status: 'Success', trigger: 'User Request'},
    {workflowId: 'wf-exfil-detection-001', runDate: '2026-04-22T06:00:00Z', duration: '13 min 08 sec', status: 'Partial', trigger: 'Scheduled'},
    {workflowId: 'wf-exfil-detection-004', runDate: '2026-04-21T10:00:00Z', duration: '28 min 42 sec', status: 'Success', trigger: 'Scheduled'},
  ];
  ...
  @state() private _knowledgeArticles: Array<{id: string; title: string; category: string; author: string; publishDate: string; views: number; rating: number; tags: string[]; summary: string; readTime: string}> = [
    {id: 'kb-exfil-detection-001', title: 'Zero Trust Architecture Implementation Guide', category: 'Architecture', author: 'Security Architecture Team', publishDate: '2026-03-15', views: 1842, rating: 4.8, tags: ['zero-trust', 'network', 'identity'], summary: 'Comprehensive guide for implementing zero trust principles across enterprise infrastructure', readTime: '15 min'},
    {id: 'kb-exfil-detection-002', title: 'Ransomware Defense Playbook 2026', category: 'Threats', author: 'Threat Intelligence Team', publishDate: '2026-04-01', views: 2341, rating: 4.9, tags: ['ransomware', 'incident-response', 'defense'], summary: 'Updated playbook with latest ransomware tactics, techniques, and defensive measures', readTime: '12 min'},
    {id: 'kb-exfil-detection-003', title: 'Cloud Security Best Practices for Multi-Cloud', category: 'Cloud', author: 'Cloud Security Team', publishDate: '2026-02-28', views: 1567, rating: 4.5, tags: ['cloud', 'aws', 'azure', 'gcp'], summary: 'Best practices for securing workloads across multiple cloud service providers', readTime: '18 min'},
    {id: 'kb-exfil-detection-004', title: 'API Security Testing Methodology', category: 'Testing', author: 'Red Team', publishDate: '2026-03-22', views: 987, rating: 4.6, tags: ['api', 'testing', 'owasp'], summary: 'Structured methodology for identifying and testing API security vulnerabilities', readTime: '10 min'},
    {id: 'kb-exfil-detection-005', title: 'Supply Chain Security Risk Management', category: 'Third Party', author: 'GRC Team', publishDate: '2026-01-20', views: 1234, rating: 4.3, tags: ['supply-chain', 'vendor', 'risk'], summary: 'Framework for managing security risks in the software supply chain', readTime: '14 min'},
    {id: 'kb-exfil-detection-006', title: 'Kubernetes Security Hardening Checklist', category: 'Container', author: 'Platform Security', publishDate: '2026-04-10', views: 2103, rating: 4.7, tags: ['kubernetes', 'container', 'hardening'], summary: 'Step-by-step hardening checklist for production Kubernetes clusters', readTime: '11 min'},
    {id: 'kb-exfil-detection-007', title: 'Security Metrics That Matter for Executives', category: 'Metrics', author: 'CISO Office', publishDate: '2026-03-05', views: 876, rating: 4.4, tags: ['metrics', 'kpi', 'reporting'], summary: 'Key security metrics and KPIs that resonate with board-level stakeholders', readTime: '8 min'},
    {id: 'kb-exfil-detection-008', title: 'Phishing Simulation Campaign Design', category: 'Awareness', author: 'Security Awareness Team', publishDate: '2026-02-15', views: 1456, rating: 4.5, tags: ['phishing', 'simulation', 'training'], summary: 'Designing effective phishing simulations that drive real behavioral change', readTime: '9 min'},
    {id: 'kb-exfil-detection-009', title: 'Data Loss Prevention Strategy and Implementation', category: 'Data Protection', author: 'Data Security Team', publishDate: '2026-03-28', views: 1678, rating: 4.6, tags: ['dlp', 'data-protection', 'compliance'], summary: 'Strategic approach to DLP covering people, process, and technology layers', readTime: '16 min'},
    {id: 'kb-exfil-detection-010', title: 'Security Automation with SOAR Platforms', category: 'Automation', author: 'SOC Engineering', publishDate: '2026-04-05', views: 1098, rating: 4.7, tags: ['soar', 'automation', 'soc'], summary: 'Building effective security automation playbooks using SOAR technology', readTime: '13 min'},
    {id: 'kb-exfil-detection-011', title: 'Third-Party Risk Assessment Framework', category: 'GRC', author: 'Vendor Management', publishDate: '2026-01-30', views: 1345, rating: 4.4, tags: ['vendor', 'risk', 'assessment'], summary: 'Structured framework for evaluating and monitoring third-party security risks', readTime: '12 min'},
    {id: 'kb-exfil-detection-012', title: 'Network Detection and Response Best Practices', category: 'Network', author: 'Network Security Team', publishDate: '2026-03-18', views: 1567, rating: 4.5, tags: ['ndr', 'network', 'detection'], summary: 'Implementing effective network detection and response capabilities', readTime: '14 min'},
    {id: 'kb-exfil-detection-013', title: 'Security Chaos Engineering Guide', category: 'Resilience', author: 'SRE Security', publishDate: '2026-04-12', views: 789, rating: 4.3, tags: ['chaos-engineering', 'resilience', 'testing'], summary: 'Applying chaos engineering principles to validate security controls', readTime: '10 min'},
    {id: 'kb-exfil-detection-014', title: 'Incident Communication Templates', category: 'Incident Response', author: 'IR Team', publishDate: '2026-02-22', views: 2234, rating: 4.8, tags: ['incident', 'communication', 'templates'], summary: 'Ready-to-use communication templates for security incident scenarios', readTime: '7 min'},
    {id: 'kb-exfil-detection-015', title: 'Endpoint Detection and Response Configuration', category: 'Endpoint', author: 'Endpoint Security', publishDate: '2026-03-08', views: 1345, rating: 4.5, tags: ['edr', 'endpoint', 'configuration'], summary: 'Optimal EDR configuration for maximum detection with minimal false positives', readTime: '11 min'},
    {id: 'kb-exfil-detection-016', title: 'Security Code Review Standards', category: 'Development', author: 'AppSec Team', publishDate: '2026-02-10', views: 1890, rating: 4.6, tags: ['code-review', 'secure-sdlc', 'standards'], summary: 'Standards and checklists for security-focused code reviews', readTime: '13 min'},
    {id: 'kb-exfil-detection-017', title: 'IoT Security Assessment Methodology', category: 'IoT', author: 'IoT Security Lab', publishDate: '2026-04-08', views: 654, rating: 4.2, tags: ['iot', 'embedded', 'assessment'], summary: 'Methodology for assessing security posture of IoT devices and ecosystems', readTime: '15 min'},
    {id: 'kb-exfil-detection-018', title: 'Passwordless Authentication Migration Guide', category: 'Identity', author: 'IAM Team', publishDate: '2026-03-25', views: 1678, rating: 4.7, tags: ['passwordless', 'authentication', 'mfa'], summary: 'Step-by-step migration plan from password-based to passwordless authentication', readTime: '12 min'},
    {id: 'kb-exfil-detection-019', title: 'Security Awareness Program Metrics', category: 'Awareness', author: 'Security Culture Team', publishDate: '2026-01-25', views: 1123, rating: 4.4, tags: ['awareness', 'metrics', 'culture'], summary: 'Measuring the effectiveness of your security awareness and training programs', readTime: '9 min'},
    {id: 'kb-exfil-detection-020', title: 'Deception Technology Deployment Guide', category: 'Detection', author: 'Blue Team', publishDate: '2026-04-15', views: 876, rating: 4.5, tags: ['deception', 'honeypot', 'detection'], summary: 'Planning and deploying deception technology for advanced threat detection', readTime: '11 min'},
  ];
  ...
  // --- Security Scenario Planning Methods (EXDE) ---
  private _initExdeScenarios(): void {
    const worstCaseScenarios = [
      { id: "exde-sc-01", name: "Ransomware Attack on Critical Infrastructure", category: "Malware", impact: 9500000, probability: 0.12, recoveryDays: 21, affectedSystems: 47, dataLossGb: 320, businessImpact: "critical" },
      { id: "exde-sc-02", name: "Insider Data Exfiltration via Authorized Channels", category: "Insider Threat", impact: 7200000, probability: 0.18, recoveryDays: 14, affectedSystems: 12, dataLossGb: 85, businessImpact: "high" },
      { id: "exde-sc-03", name: "Supply Chain Compromise via Third-Party Library", category: "Supply Chain", impact: 6800000, probability: 0.09, recoveryDays: 30, affectedSystems: 63, dataLossGb: 0, businessImpact: "critical" },
      { id: "exde-sc-04", name: "Cloud Misconfiguration Leading to Public Exposure", category: "Cloud", impact: 4100000, probability: 0.22, recoveryDays: 7, affectedSystems: 8, dataLossGb: 450, businessImpact: "high" },
      { id: "exde-sc-05", name: "Zero-Day Exploit in Core Application Framework", category: "Vulnerability", impact: 8900000, probability: 0.05, recoveryDays: 45, affectedSystems: 120, dataLossGb: 0, businessImpact: "critical" },
      { id: "exde-sc-06", name: "Distributed Denial of Service on Customer-Facing Services", category: "Availability", impact: 3400000, probability: 0.25, recoveryDays: 3, affectedSystems: 15, dataLossGb: 0, businessImpact: "medium" },
      { id: "exde-sc-07", name: "Credential Stuffing and Account Takeover Wave", category: "Identity", impact: 2800000, probability: 0.30, recoveryDays: 5, affectedSystems: 6, dataLossGb: 12, businessImpact: "medium" },
      { id: "exde-sc-08", name: "Physical Security Breach at Data Center Facility", category: "Physical", impact: 12000000, probability: 0.02, recoveryDays: 60, affectedSystems: 200, dataLossGb: 5000, businessImpact: "critical" },
    ];
    this._exdeScenarios = worstCaseScenarios.map(s => ({ ...s, mitigationCost: Math.round(s.impact * 0.08), drillScheduled: false, lastDrillDate: null, drillScore: null, controlGaps: Math.floor(Math.random() * 5) + 1 }));
  }

  private _calculateExdeScenarioRisk(): void {
    this._exdeScenarios.forEach(s => {
  ...
  private _scheduleExdeDrills(): void {
  ...
  private _exdeScenarioComparison(): Record<string, unknown>[] {
    return this._exdeScenarios.map(s => ({
  ...
  // --- Security Control Effectiveness Analytics (EXDE) ---
  private _initExdeControls(): void {
    const controls = [
      { id: "exde-ct-01", name: "Network Segmentation", type: "preventive", maturity: "defined", score: 82, target: 90, failures: 3, lastTest: "2026-03-15" },
      { id: "exde-ct-02", name: "Endpoint Detection and Response", type: "detective", maturity: "managed", score: 88, target: 92, failures: 1, lastTest: "2026-04-01" },
      { id: "exde-ct-03", name: "Data Loss Prevention", type: "preventive", maturity: "repeatable", score: 71, target: 85, failures: 7, lastTest: "2026-03-22" },
      { id: "exde-ct-04", name: "Security Information and Event Management", type: "detective", maturity: "managed", score: 85, target: 90, failures: 2, lastTest: "2026-04-05" },
      { id: "exde-ct-05", name: "Identity and Access Management", type: "preventive", maturity: "defined", score: 76, target: 88, failures: 5, lastTest: "2026-03-28" },
      { id: "exde-ct-06", name: "Vulnerability Management", type: "corrective", maturity: "managed", score: 80, target: 90, failures: 4, lastTest: "2026-04-02" },
      { id: "exde-ct-07", name: "Email Security Gateway", type: "preventive", maturity: "managed", score: 90, target: 95, failures: 1, lastTest: "2026-04-08" },
      { id: "exde-ct-08", name: "Web Application Firewall", type: "preventive", maturity: "managed", score: 87, target: 92, failures: 2, lastTest: "2026-03-30" },
      { id: "exde-ct-09", name: "Patch Management", type: "corrective", maturity: "defined", score: 68, target: 85, failures: 9, lastTest: "2026-03-18" },
      { id: "exde-ct-10", name: "Encryption at Rest", type: "preventive", maturity: "managed", score: 93, target: 95, failures: 0, lastTest: "2026-04-10" },
      { id: "exde-ct-11", name: "Encryption in Transit", type: "preventive", maturity: "optimized", score: 96, target: 98, failures: 0, lastTest: "2026-04-12" },
      { id: "exde-ct-12", name: "Privileged Access Management", type: "preventive", maturity: "defined", score: 74, target: 88, failures: 6, lastTest: "2026-03-25" },
      { id: "exde-ct-13", name: "Security Awareness Training", type: "preventive", maturity: "repeatable", score: 65, target: 80, failures: 11, lastTest: "2026-03-20" },
      { id: "exde-ct-14", name: "Incident Response Plan", type: "corrective", maturity: "managed", score: 78, target: 88, failures: 4, lastTest: "2026-04-03" },
      { id: "exde-ct-15", name: "Backup and Recovery", type: "corrective", maturity: "managed", score: 84, target: 92, failures: 3, lastTest: "2026-04-06" },
      { id: "exde-ct-16", name: "Multi-Factor Authentication", type: "preventive", maturity: "managed", score: 91, target: 95, failures: 1, lastTest: "2026-04-09" },
      { id: "exde-ct-17", name: "Network Traffic Analysis", type: "detective", maturity: "defined", score: 72, target: 85, failures: 5, lastTest: "2026-03-27" },
      { id: "exde-ct-18", name: "Cloud Security Posture Management", type: "detective", maturity: "repeatable", score: 69, target: 82, failures: 8, lastTest: "2026-03-24" },
      { id: "exde-ct-19", name: "Container Security Scanning", type: "preventive", maturity: "defined", score: 75, target: 85, failures: 5, lastTest: "2026-04-04" },
      { id: "exde-ct-20", name: "API Security Gateway", type: "preventive", maturity: "repeatable", score: 70, target: 82, failures: 7, lastTest: "2026-03-29" },
      { id: "exde-ct-21", name: "Threat Intelligence Platform", type: "detective", maturity: "managed", score: 83, target: 90, failures: 2, lastTest: "2026-04-07" },
      { id: "exde-ct-22", name: "Database Activity Monitoring", type: "detective", maturity: "defined", score: 67, target: 80, failures: 8, lastTest: "2026-03-21" },
      { id: "exde-ct-23", name: "Deception Technology", type: "detective", maturity: "initial", score: 55, target: 75, failures: 12, lastTest: "2026-03-16" },
      { id: "exde-ct-24", name: "Security Orchestration Automation", type: "corrective", maturity: "repeatable", score: 73, target: 85, failures: 6, lastTest: "2026-04-01" },
      { id: "exde-ct-25", name: "Third-Party Risk Assessment", type: "preventive", maturity: "defined", score: 64, target: 78, failures: 9, lastTest: "2026-03-19" },
    ];
    this._exdeControls = controls;
  }

  private _analyzeExdeControlEffectiveness(): void {
    const typeBreakdown: Record<string, { total: number; avgScore: number; avgFailures: number }> = {};
    this._exdeControls.forEach(c => {
    ...
    this._exdeControlTypeBreakdown = typeBreakdown;
  }

  private _exdeControlOptimization(): Record<string, unknown>[] {
    return this._exdeControls.filter(c => c.score < c.target).map(c => ({
  ...
  // --- Security Data Pipeline Health (EXDE) ---
  private _initExdePipelines(): void {
    const pipelines = [
      { id: "exde-pl-01", name: "SIEM Log Ingestion", status: "healthy", healthScore: 94, latencyMs: 120, freshnessMin: 2, errorRate: 0.02, throughputMbps: 450, recordsPerSec: 12000, backPressure: 0.05, uptime: 99.97 },
      { id: "exde-pl-02", name: "Threat Feed Aggregation", status: "healthy", healthScore: 91, latencyMs: 300, freshnessMin: 15, errorRate: 0.05, throughputMbps: 85, recordsPerSec: 3200, backPressure: 0.08, uptime: 99.92 },
      { id: "exde-pl-03", name: "Vulnerability Scan Results", status: "degraded", healthScore: 72, latencyMs: 2500, freshnessMin: 60, errorRate: 0.15, throughputMbps: 25, recordsPerSec: 800, backPressure: 0.35, uptime: 98.50 },
      { id: "exde-pl-04", name: "Endpoint Telemetry Stream", status: "healthy", healthScore: 88, latencyMs: 450, freshnessMin: 5, errorRate: 0.08, throughputMbps: 280, recordsPerSec: 8500, backPressure: 0.12, uptime: 99.85 },
      { id: "exde-pl-05", name: "Cloud Audit Log Pipeline", status: "healthy", healthScore: 86, latencyMs: 600, freshnessMin: 10, errorRate: 0.06, throughputMbps: 150, recordsPerSec: 4500, backPressure: 0.10, uptime: 99.80 },
      { id: "exde-pl-06", name: "Identity Event Stream", status: "warning", healthScore: 78, latencyMs: 1200, freshnessMin: 20, errorRate: 0.12, throughputMbps: 45, recordsPerSec: 1500, backPressure: 0.22, uptime: 99.40 },
      { id: "exde-pl-07", name: "Network Flow Collection", status: "healthy", healthScore: 82, latencyMs: 800, freshnessMin: 8, errorRate: 0.09, throughputMbps: 650, recordsPerSec: 18000, backPressure: 0.15, uptime: 99.70 },
      { id: "exde-pl-08", name: "DLP Incident Pipeline", status: "degraded", healthScore: 68, latencyMs: 3500, freshnessMin: 45, errorRate: 0.20, throughputMbps: 18, recordsPerSec: 500, backPressure: 0.42, uptime: 97.80 },
    ];
    this._exdePipelines = pipelines.map(p => ({ ...p, dependencies: [], slaBreached: p.healthScore < 75, alertThreshold: p.errorRate > 0.15 }));
    this._exdePipelines[0].dependencies = ["exde-pl-04", "exde-pl-07"];
    this._exdePipelines[4].dependencies = ["exde-pl-01"];
    this._exdePipelines[5].dependencies = ["exde-pl-02"];
    this._exdePipelines[7].dependencies = ["exde-pl-04", "exde-pl-05"];
  }

  private _exdePipelineTrend(): Record<string, unknown>[] {
    const hours = Array.from({ length: 24 }, (_, i) => `H${String(i).padStart(2, "0")}`);
    return this._exdePipelines.map(p => ({
  ...
  // --- Security Stakeholder Report Generator (EXDE) ---
  private _initExdeReportTemplates(): void {
    this._exdeReportTemplates = [
      { id: "exde-rp-01", name: "Board Security Report", audience: "board", frequency: "quarterly", sections: 6, autoGenerate: true, lastGenerated: "2026-03-31", pages: 12 },
      { id: "exde-rp-02", name: "Executive Risk Summary", audience: "executive", frequency: "monthly", sections: 8, autoGenerate: true, lastGenerated: "2026-04-01", pages: 8 },
      { id: "exde-rp-03", name: "Technical Security Review", audience: "technical", frequency: "weekly", sections: 12, autoGenerate: true, lastGenerated: "2026-04-21", pages: 25 },
      { id: "exde-rp-04", name: "Audit Compliance Report", audience: "audit", frequency: "quarterly", sections: 10, autoGenerate: false, lastGenerated: "2026-03-15", pages: 35 },
      { id: "exde-rp-05", name: "Regulatory Filing Package", audience: "regulatory", frequency: "annual", sections: 15, autoGenerate: false, lastGenerated: "2025-12-31", pages: 48 },
    ];
  }

  private _generateExdeExecSummary(): string {
    const totalRisk = this._exdeScenarios.reduce((sum: number, s: any) => sum + s.riskScore, 0);
    const avgControl = Math.round(this._exdeControls.reduce((sum: number, c: any) => sum + c.score, 0) / this._exdeControls.length);
    const degradedPipes = this._exdePipelines.filter((p: any) => p.status !== "healthy").length;
    return `Overall risk exposure: ${(totalRisk / 1000000).toFixed(1)}M. Average control effectiveness: {avgControl}%. {degradedPipes} pipeline(s) need attention. {this._exdeScenarios.filter((s: any) => s.mitigationPriority === "immediate").length} scenarios require immediate action.`;
  }

  // --- Security Technology Radar (EXDE) ---
  private _initExdeTechRadar(): void {
    this._exdeTechRadar = [
      { id: "exde-tr-01", name: "AI-Powered Threat Detection", ring: "adopt", category: "Detection", maturity: 4, trend: "up", investment: "high", roi: 3.2, vendorCount: 8 },
      { id: "exde-tr-02", name: "Zero Trust Architecture", ring: "adopt", category: "Architecture", maturity: 4, trend: "up", investment: "high", roi: 2.8, vendorCount: 12 },
      { id: "exde-tr-03", name: "SASE/SSE Platform", ring: "trial", category: "Network", maturity: 3, trend: "up", investment: "medium", roi: 2.4, vendorCount: 10 },
      { id: "exde-tr-04", name: "CNAPP Cloud Security", ring: "trial", category: "Cloud", maturity: 3, trend: "up", investment: "medium", roi: 2.1, vendorCount: 7 },
      { id: "exde-tr-05", name: "Extended Detection and Response", ring: "adopt", category: "Detection", maturity: 4, trend: "stable", investment: "high", roi: 2.9, vendorCount: 9 },
      { id: "exde-tr-06", name: "Quantum-Safe Cryptography", ring: "assess", category: "Crypto", maturity: 2, trend: "up", investment: "low", roi: 0.8, vendorCount: 4 },
      { id: "exde-tr-07", name: "Security Service Edge", ring: "trial", category: "Network", maturity: 3, trend: "up", investment: "medium", roi: 2.0, vendorCount: 6 },
      { id: "exde-tr-08", name: "SOAR 2.0 Autonomous SOC", ring: "assess", category: "Operations", maturity: 2, trend: "up", investment: "low", roi: 1.2, vendorCount: 5 },
      { id: "exde-tr-09", name: "Software Supply Chain Security", ring: "trial", category: "DevSecOps", maturity: 3, trend: "up", investment: "medium", roi: 2.3, vendorCount: 8 },
      { id: "exde-tr-10", name: "Identity Threat Detection", ring: "adopt", category: "Identity", maturity: 3, trend: "up", investment: "high", roi: 2.7, vendorCount: 7 },
      { id: "exde-tr-11", name: "Data Security Posture Management", ring: "trial", category: "Data", maturity: 3, trend: "up", investment: "medium", roi: 2.2, vendorCount: 9 },
      { id: "exde-tr-12", name: "Decentralized Identity Standards", ring: "hold", category: "Identity", maturity: 1, trend: "stable", investment: "low", roi: 0.5, vendorCount: 3 },
    ];
  }

  private _exdeRadarSummary(): Record<string, unknown> {
    const rings: Record<string, number> = { adopt: 0, trial: 0, assess: 0, hold: 0 };
    this._exdeTechRadar.forEach(t => { if (rings[t.ring as keyof typeof rings] !== undefined) rings[t.ring as keyof typeof rings]++; });
    return { adopt: rings.adopt, trial: rings.trial, assess: rings.assess, hold: rings.hold, total: this._exdeTechRadar.length, avgMaturity: 2.8, topInvestment: this._exdeTechRadar.filter(t => t.investment === "high").map(t => t.name) };
  }

  // --- EXDE Security Compliance Mapping Matrix ---
  private _initExdeComplianceMatrix(): void {
    ...
    this._exdeComplianceMatrix = frameworks.map(fw => ({
  ...
  private _exdeComplianceTrend(): Record<string, unknown>[] {
    const quarters = ["Q1-2025", "Q2-2025", "Q3-2025", "Q4-2025", "Q1-2026", "Q2-2026"];
    return this._exdeComplianceMatrix.map(fw => ({
  ...
  // --- EXDE Threat Intelligence Correlation Engine ---
  private _initExdeThreatIntel(): void {
    ...
    this._exdeThreatIntel = threatActors.map((actor, i) => ({
  ...
  private _exdeThreatCorrelation(): Record<string, unknown>[] {
    return this._exdeThreatIntel.filter(t => t.riskScore > 70).map(t => ({
  ...
  // --- EXDE Security Metrics Deep Dive ---
  private _initExdeMetricsDeep(): void {
    ...
    this._exdeMetricsDeep = metricCategories.map(cat => ({
  ...
  private _exdeMetricsHeatmap(): number[][] {
    return this._exdeMetricsDeep.map(cat =>
      cat.metrics.map(m => Math.round((m.value / m.target) * 100))
    );
  }

  // --- EXDE Incident Cost Modeling ---
  private _initExdeCostModel(): void {
    const incidentTypes = ["Data Breach", "Ransomware", "DDoS", "Insider Threat", "Phishing", "Supply Chain", "Cloud Misconfig", "Zero-Day"];
    this._exdeCostModel = incidentTypes.map(inc => ({
    ...
    this._exdeCostModel.forEach(m => { m.totalAnnualExposure = m.avgCost * m.frequency; });
  }

  private _exdeCostProjection(): Record<string, unknown>[] {
    return this._exdeCostModel.map(m => ({
  ...
  // --- EXDE Security Architecture Pattern Library ---
  private _initExdeArchPatterns(): void {
    ...
    this._exdeArchPatterns = patterns.map((p, i) => ({
  ...
  private _exdeArchPatternAnalysis(): Record<string, unknown> {
    const implemented = this._exdeArchPatterns.filter(p => p.implementation > 75).length;
    const avgCoverage = Math.round(this._exdeArchPatterns.reduce((s: number, p: any) => s + p.coverage, 0) / this._exdeArchPatterns.length);
    return {
      totalPatterns: this._exdeArchPatterns.length, fullyImplemented: implemented, avgCoverage,
      avgRiskReduction: Math.round(this._exdeArchPatterns.reduce((s: number, p: any) => s + p.riskReduction, 0) / this._exdeArchPatterns.length),
      gaps: this._exdeArchPatterns.filter(p => p.implementation < 60).map(p => p.pattern),
      recommendations: this._exdeArchPatterns.filter(p => p.implementation < 70).map(p => ({ pattern: p.pattern, current: p.implementation, target: 85, effort: p.costComplexity }))
    };
  }
  ...
  private _edAutoRules = [
    ...
    {id: 'ed-CR-010', name: 'TLS Certificate Expiry Monitoring', framework: 'NIST 800-53 SC-13', desc: 'Monitor all TLS and SSL certificates for upcoming expiry within configurable warning windows with automated renewal', enabled: true as const, frequency: 'Daily', lastRun: '2026-04-22T14:00:00Z', lastResult: 'pass' as const, passRate: 98.9, violations: 3, autoRemediate: true as const, remediation: 'Trigger automated certificate renewal via ACME protocol integration with internal certificate authority', history: [{d: '04-22', r: 'pass', v: 3}, {d: '04-21', r: 'pass', v: 3}, {d: '04-20', r: 'pass', v: 4}, {d: '04-19', r: 'pass', v: 4}, {d: '04-18', r: 'pass', v: 5}]}
  ];

  private _edDriftAlerts = [
    {ruleId: 'ed-CR-007', name: 'Data Classification Label Enforcement', dir: 'regression' as const, prev: 86.1, curr: 82.4, delta: -3.7, sev: 'warning' as const, detected: '2026-04-20T12:00:00Z', rootCause: 'New file shares created during Q1 cloud migration project lacked classification labels due to process gap', remediation: 'Bulk classification task scheduled for all data owners with 2-week deadline and compliance tracking'},
    {ruleId: 'ed-CR-002', name: 'MFA Enrollment Verification', dir: 'regression' as const, prev: 89.2, curr: 87.5, delta: -1.7, sev: 'info' as const, detected: '2026-04-21T08:00:00Z', rootCause: '12 new contractor accounts onboarded without MFA enforcement due to HR onboarding process gap', remediation: 'HR onboarding checklist updated to include MFA as mandatory step before system access is granted'},
    {ruleId: 'ed-CR-005', name: 'Firewall Rule Baseline Compliance', dir: 'improvement' as const, prev: 89.8, curr: 91.3, delta: 1.5, sev: 'info' as const, detected: '2026-04-22T06:00:00Z', rootCause: 'Automated remediation workflow successfully cleaned up 5 orphaned firewall rules from decommissioned systems', remediation: 'Continue automated cleanup on weekly schedule and expand to include staging environment firewalls'},
    {ruleId: 'ed-CR-011', name: 'Endpoint Detection Status', dir: 'improvement' as const, prev: 95.1, curr: 96.2, delta: 1.1, sev: 'info' as const, detected: '2026-04-22T10:00:00Z', rootCause: 'RMM integration enabled bulk EDR reinstallation on 15 previously offline or reimaged endpoints', remediation: 'No action needed, improvement trend expected to continue as offline device recovery completes'}
  ];

  private _getedRuleSummary(): {total: number; enabled: number; passing: number; failing: number; avgPassRate: number; autoRemRate: number; totalVulns: number} {
    const enabled = this._edAutoRules.filter(r => r.enabled).length;
    const passing = this._edAutoRules.filter(r => r.lastResult === 'pass').length;
    const failing = this._edAutoRules.filter(r => r.lastResult === 'fail').length;
    const avgRate = this._edAutoRules.reduce((s, r) => s + r.passRate, 0) / this._edAutoRules.length;
    const autoRate = this._edAutoRules.filter(r => r.autoRemediate).length / this._edAutoRules.length * 100;
    const totalVulns = this._edAutoRules.reduce((s, r) => s + r.violations, 0);
    return {total: this._edAutoRules.length, enabled, passing, failing, avgPassRate: Math.round(avgRate * 10) / 10, autoRemRate: Math.round(autoRate), totalVulns};
  }

  private _getedEffectiveness(): {autoRemSuccess: number; avgRemTime: string; fpRate: number; coverage: number; savings: string} {
  ...
  private _edOnboardingChecklist = [
    {id: 'ed-OB-001', item: 'Provision security-hardened laptop, dual monitors, peripherals, and configured workstation image with all required tools', cat: 'IT Setup', day: 'Day 1', owner: 'IT Operations'},
    {id: 'ed-OB-002', item: 'Create Active Directory account, corporate email, Slack workspace, VPN access, SSO enrollment, and all required application accounts', cat: 'Access Provisioning', day: 'Day 1', owner: 'IAM Team'},
    {id: 'ed-OB-003', item: 'Grant access to security tooling platform: SIEM console, EDR dashboard, vulnerability scanner, penetration testing tools, and SOAR platform', cat: 'Security Tool Access', day: 'Day 1-2', owner: 'SOC Manager'},
    {id: 'ed-OB-004', item: 'Complete MFA enrollment for all accounts, security awareness onboarding course, and sign acceptable use policy acknowledgment', cat: 'Security Onboarding', day: 'Day 1', owner: 'Security Awareness Team'},
    {id: 'ed-OB-005', item: 'Sign NDA, employment agreement, intellectual property assignment, and code of conduct documents with HR representative', cat: 'HR Documentation', day: 'Day 1', owner: 'Human Resources'},
    {id: 'ed-OB-006', item: 'Schedule and complete introduction meetings with all direct team members and key cross-functional stakeholders', cat: 'Team Integration', day: 'Week 1', owner: 'Hiring Manager'},
    {id: 'ed-OB-007', item: 'Attend security architecture overview sessions, tooling walkthrough demonstrations, and review operational runbooks and SOPs', cat: 'Technical Training', day: 'Week 1-2', owner: 'Security Architect'},
    {id: 'ed-OB-008', item: 'Shadow experienced team member on active incident response cases and threat hunting investigations for hands-on exposure', cat: 'Mentoring and Shadowing', day: 'Week 2-3', owner: 'SOC Team Lead'},
    {id: 'ed-OB-009', item: 'Set up individual certification study plan aligned with role requirements and long-term career development goals', cat: 'Professional Development', day: 'Week 2', owner: 'Hiring Manager'},
    {id: 'ed-OB-010', item: 'Establish 30-60-90 day performance goals, define success metrics, and schedule first formal performance review checkpoint', cat: 'Goal Setting', day: 'Week 1', owner: 'Hiring Manager'}
  ];

  private _edRetentionRisks = [
  ...
  private _getedArchSummary(): {total: number; passed: number; failed: number; partial: number; criticalFails: number; score: number} {
    const p = this._edArchChecklist.filter(c => c.status === 'pass').length;
    const f = this._edArchChecklist.filter(c => c.status === 'fail').length;
    const pa = this._edArchChecklist.filter(c => c.status === 'partial').length;
    const cf = this._edArchChecklist.filter(c => c.status === 'fail' && c.sev === 'critical').length;
    return {total: this._edArchChecklist.length, passed: p, failed: f, partial: pa, criticalFails: cf, score: Math.round((p / this._edArchChecklist.length) * 100)};
  }

  private _getedApprovalStatus(): {stage: string; approvers: Array<{name: string; role: string; status: string}>; nextAction: string} {
  ...
  private _313RiskAssessmentWorkflow = [
  ...
  private _313TreatmentOptions = [
    {id: '313-T-001', riskId: 'RSK-042', risk: 'Ransomware Attack on Critical Infrastructure', before: 20, after: 6, strategy: 'Mitigate', controls: ['Next-gen EDR with behavioral detection and automated response', 'Zero-trust network micro-segmentation isolating critical assets', 'Immutable offline backup rotation with quarterly recovery testing', 'Incident response retainer with 1-hour response SLA'], cost: '$450K/yr', roi: '78% reduction vs $2.8M potential loss', timeline: 'Q3 2026', status: 'approved' as const},
  ...
  private _313TalentPositions = [
    ...
    {id: '313-H-002', title: 'Cloud Security Engineer', dept: 'Cloud Security', level: 'Mid-Senior', loc: 'SF/Remote', salary: '$155K-$180K', posted: '2026-03-20', applicants: 45, pipeline: 12, interviews: 6, offers: 2, urgency: 'high' as const, manager: 'Mike Johnson', skills: ['AWS/Azure/GCP', 'Terraform', 'Kubernetes', 'IAM', 'CSPM'], nice: ['CCSP', 'CKS', 'Serverless']},
    {id: '313-H-003', title: 'SOC Analyst L2', dept: 'Security Operations', level: 'Mid', loc: 'Austin TX', salary: '$105K-$130K', posted: '2026-04-01', applicants: 67, pipeline: 18, interviews: 8, offers: 0, urgency: 'medium' as const, manager: 'Lisa Park', skills: ['SIEM', 'Incident triage', 'Malware analysis', 'TCP/IP'], nice: ['GCIA', 'SOAR', 'Kill chain']},
    {id: '313-H-004', title: 'Staff Security Architect', dept: 'Architecture', level: 'Staff', loc: 'Remote US', salary: '$200K-$240K', posted: '2026-02-28', applicants: 12, pipeline: 3, interviews: 2, offers: 0, urgency: 'critical' as const, manager: 'David Lee', skills: ['Enterprise arch', 'Zero trust', 'Risk frameworks', 'Board comms'], nice: ['CISSP+SABSA', 'Team building', 'Speaker']},
    {id: '313-H-005', title: 'GRC Analyst', dept: 'GRC', level: 'Mid', loc: 'NY/Remote', salary: '$110K-$135K', posted: '2026-04-05', applicants: 34, pipeline: 9, interviews: 3, offers: 1, urgency: 'medium' as const, manager: 'Rachel Green', skills: ['ISO 27001', 'SOC 2', 'Risk assessment', 'Audit'], nice: ['CRISC', 'CISA', 'GDPR']},
    {id: '313-H-006', title: 'Threat Intel Analyst', dept: 'Threat Intel', level: 'Mid-Senior', loc: 'Remote US', salary: '$140K-$170K', posted: '2026-03-25', applicants: 19, pipeline: 5, interviews: 2, offers: 0, urgency: 'low' as const, manager: 'James Wilson', skills: ['MITRE ATT&CK', 'OSINT', 'Threat modeling', 'Reverse eng'], nice: ['CTIA', 'Nation-state', 'Dark web']},
    {id: '313-H-007', title: 'AppSec Engineer', dept: 'AppSec', level: 'Senior', loc: 'Seattle/Remote', salary: '$160K-$190K', posted: '2026-04-10', applicants: 28, pipeline: 7, interviews: 3, offers: 0, urgency: 'medium' as const, manager: 'Emily Zhang', skills: ['SAST/DAST/SCA', 'Secure SDLC', 'Code review', 'CI/CD'], nice: ['CSSLP', 'Mobile security']},
    {id: '313-H-008', title: 'IAM Engineer', dept: 'IAM', level: 'Mid', loc: 'Remote US', salary: '$135K-$160K', posted: '2026-04-08', applicants: 31, pipeline: 10, interviews: 5, offers: 1, urgency: 'medium' as const, manager: 'Chris Martinez', skills: ['Okta/Azure AD', 'SAML/OIDC', 'PAM', 'RBAC'], nice: ['CISSP', 'Zero trust IAM']}
  ];

  private _313InterviewScorecard = [
  ...
  private _313OnboardingSteps = [
    {id: '313-OB-01', item: 'Provision security-hardened laptop, monitors, peripherals, and configured workstation image with all required security tools', cat: 'IT Setup', day: 'Day 1', owner: 'IT Operations'},
    {id: '313-OB-02', item: 'Create AD account, email, Slack, VPN, SSO enrollment, and all required application access accounts', cat: 'Access', day: 'Day 1', owner: 'IAM Team'},
    {id: '313-OB-03', item: 'Grant security tooling access: SIEM console, EDR dashboard, vuln scanner, pentest platforms, SOAR', cat: 'Tools', day: 'Day 1-2', owner: 'SOC Manager'},
    {id: '313-OB-04', item: 'Complete MFA enrollment, security awareness onboarding course, and acceptable use policy acknowledgment', cat: 'Security', day: 'Day 1', owner: 'Awareness Team'},
    {id: '313-OB-05', item: 'Sign NDA, employment agreement, IP assignment, and code of conduct documents with HR', cat: 'HR', day: 'Day 1', owner: 'Human Resources'},
    {id: '313-OB-06', item: 'Introduction meetings with direct team members and key cross-functional stakeholders', cat: 'Integration', day: 'Week 1', owner: 'Hiring Manager'},
    {id: '313-OB-07', item: 'Security architecture overview, tooling walkthrough, and operational runbook review sessions', cat: 'Training', day: 'Week 1-2', owner: 'Security Architect'},
    {id: '313-OB-08', item: 'Shadow experienced team member on active incident response and threat hunting investigations', cat: 'Mentoring', day: 'Week 2-3', owner: 'SOC Lead'},
    {id: '313-OB-09', item: 'Set up individual certification study plan aligned with role requirements and career goals', cat: 'Development', day: 'Week 2', owner: 'Hiring Manager'},
    {id: '313-OB-10', item: 'Establish 30-60-90 day goals, define success metrics, and schedule first performance checkpoint', cat: 'Goals', day: 'Week 1', owner: 'Hiring Manager'}
  ];

  private _313MetricsDashboard = [
    {id: '313-MTD-001', name: 'Mean Time to Detect (MTTD)', value: '4.2 hours', trend: 'improving' as const, target: '< 4 hours', source: 'SIEM - Splunk', method: 'Median time from first alert to analyst acknowledgment', owner: 'SOC Manager', sla: '4 hours', prev: '5.1 hours', spark: [5.8, 5.4, 5.1, 4.9, 4.7, 4.5, 4.3, 4.2], breakdown: [{src: 'Network IDS', pct: '35%', avg: '3.8h'}, {src: 'Endpoint EDR', pct: '28%', avg: '4.1h'}, {src: 'Email Gateway', pct: '22%', avg: '3.5h'}, {src: 'Cloud Security', pct: '10%', avg: '5.2h'}, {src: 'User Reports', pct: '5%', avg: '6.8h'}]},
    {id: '313-MTD-002', name: 'Mean Time to Respond (MTTR)', value: '2.8 hours', trend: 'stable' as const, target: '< 3 hours', source: 'SOAR - XSOAR', method: 'Median time from acknowledgment to first containment action', owner: 'IR Lead', sla: '3 hours', prev: '2.7 hours', spark: [3.2, 3.0, 2.9, 2.8, 2.8, 2.9, 2.8, 2.8], breakdown: [{src: 'Auto Playbooks', pct: '42%', avg: '1.2h'}, {src: 'Semi-Auto', pct: '33%', avg: '2.5h'}, {src: 'Manual', pct: '20%', avg: '5.1h'}, {src: 'L3 Escalation', pct: '5%', avg: '8.3h'}]},
    {id: '313-MTD-003', name: 'Patch Compliance Rate', value: '97.6%', trend: 'improving' as const, target: '> 95%', source: 'Tenable.io', method: 'Pct of critical/high vulns patched within SLA windows', owner: 'Vuln Manager', sla: '95%', prev: '96.1%', spark: [93.2, 94.1, 94.8, 95.3, 95.9, 96.4, 97.0, 97.6], breakdown: [{src: 'Critical (7d)', pct: '40%', rate: '99.2%'}, {src: 'High (30d)', pct: '35%', rate: '97.8%'}, {src: 'Medium (90d)', pct: '20%', rate: '95.1%'}, {src: 'Low (180d)', pct: '5%', rate: '89.4%'}]},
    {id: '313-MTD-004', name: 'Phishing Click Rate', value: '3.2%', trend: 'improving' as const, target: '< 5%', source: 'KnowBe4 + Proofpoint', method: 'Pct of users clicking simulated phishing links monthly', owner: 'Awareness Lead', sla: '5%', prev: '4.1%', spark: [6.8, 6.2, 5.5, 5.1, 4.6, 4.1, 3.6, 3.2], breakdown: [{src: 'Spear Phishing', pct: '35%', rate: '5.1%'}, {src: 'Generic Phishing', pct: '30%', rate: '2.8%'}, {src: 'BEC Sim', pct: '20%', rate: '3.5%'}, {src: 'SMS Phishing', pct: '15%', rate: '1.9%'}]},
    {id: '313-MTD-005', name: 'Security Posture Score', value: '784', trend: 'improving' as const, target: '> 750', source: 'SecurityScorecard', method: 'Composite: external 30%, compliance 25%, vuln 25%, config 20%', owner: 'CISO', sla: '> 750', prev: '771', spark: [748, 752, 758, 762, 768, 773, 778, 784], breakdown: [{src: 'External Rating', pct: '30%', score: '791'}, {src: 'Compliance', pct: '25%', score: '812'}, {src: 'Vuln Mgmt', pct: '25%', score: '745'}, {src: 'Config', pct: '20%', score: '769'}]},
    {id: '313-MTD-006', name: 'Vulnerability Backlog', value: '142', trend: 'improving' as const, target: '< 150', source: 'Tenable + Qualys', method: 'Total open vulns across all scanned assets tracked weekly', owner: 'Vuln Manager', sla: '< 150', prev: '168', spark: [210, 198, 185, 175, 165, 158, 150, 142], breakdown: [{src: 'Critical', pct: '8%', count: '11'}, {src: 'High', pct: '22%', count: '31'}, {src: 'Medium', pct: '45%', count: '64'}, {src: 'Low', pct: '25%', count: '36'}]}
  ];

  private _313ArchReview = [
    {id: '313-AR-001', cat: 'Network', item: 'Network segmentation between trust zones with dedicated firewalls and granular ACLs', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Micro-segmentation via NSX across all production zones'},
    {id: '313-AR-002', cat: 'Network', item: 'DMZ architecture isolating public services from internal network', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Dual-firewall DMZ with WAF and DDoS mitigation'},
    {id: '313-AR-003', cat: 'Network', item: 'Least-privilege traffic flows with deny-by-default and quarterly review', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Explicit allow rules with automated drift detection'},
    {id: '313-AR-004', cat: 'Network', item: 'Encrypted external communications with IPSec/TLS 1.3 and PFS', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'IKEv2 with PFS, TLS 1.3 for all external APIs'},
    {id: '313-AR-005', cat: 'Identity', item: 'Centralized IdP with SSO and automated SCIM provisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Okta SSO SAML 2.0 for 247 apps with SCIM'},
    {id: '313-AR-006', cat: 'Identity', item: 'RBAC with quarterly reviews and automated deprovisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Quarterly recertification with JIT admin access'},
    {id: '313-AR-007', cat: 'Identity', item: 'PAM controlling all admin and service accounts with session recording', sev: 'high' as const, status: 'fail' as const, reviewer: 'IAM Lead', notes: '3 legacy accounts pending CyberArk enrollment'},
    {id: '313-AR-008', cat: 'Identity', item: 'MFA enforced for all users, hardware tokens for privileged access', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'FIDO2 for admins, push MFA for users, 99.8% enrollment'},
    {id: '313-AR-009', cat: 'Data', item: 'Data classification enforced with automated labeling on all repos', sev: 'high' as const, status: 'partial' as const, reviewer: 'Data Protection Lead', notes: 'Framework deployed, gaps on 4 legacy file shares'},
    {id: '313-AR-010', cat: 'Data', item: 'AES-256 encryption at rest for all sensitive data stores', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'Full-disk, TDE on DBs, SSE-KMS on cloud storage'},
    {id: '313-AR-011', cat: 'Data', item: 'DLP monitoring and preventing unauthorized data exfiltration', sev: 'high' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'DLP active on email, endpoint, cloud, and network'},
    {id: '313-AR-012', cat: 'Data', item: 'Encrypted off-site backups with quarterly restore testing', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Infrastructure Lead', notes: '3-2-1 strategy with immutable backups'},
    {id: '313-AR-013', cat: 'AppSec', item: 'Secure SDLC with SAST, DAST, SCA in all CI/CD pipelines', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: '34 pipelines with security gates and PR blocking'},
    {id: '313-AR-014', cat: 'AppSec', item: 'API gateway with auth, rate limiting, schema validation', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: 'Kong with OAuth2, rate limits, OpenAPI validation'},
    {id: '313-AR-015', cat: 'AppSec', item: 'Container security with image scanning and runtime protection', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Trivy scanning, Falco runtime in 80% of clusters'},
    {id: '313-AR-016', cat: 'Monitoring', item: 'SIEM collecting from all critical systems with correlation rules', sev: 'critical' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'Splunk 98% coverage with 1200+ correlation rules'},
    {id: '313-AR-017', cat: 'Monitoring', item: 'EDR with behavioral detection on all managed endpoints', sev: 'high' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'CrowdStrike on 99.2% endpoints with 24/7 MDR'},
    {id: '313-AR-018', cat: 'Monitoring', item: 'Executive dashboards with real-time posture visibility', sev: 'medium' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'PowerBI dashboards with weekly exec summaries'},
    {id: '313-AR-019', cat: 'Cloud', item: 'CSPM monitoring and remediating cloud misconfigurations', sev: 'high' as const, status: 'pass' as const, reviewer: 'Cloud Security Lead', notes: 'Prisma Cloud 450+ checks with auto-remediation'},
    {id: '313-AR-020', cat: 'Cloud', item: 'IaC templates scanned before deployment to production', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Checkov for Terraform, cfn-nag for CloudFormation pending'}
  ];

  private _get313RiskProgress(): number {
    return Math.round(this._313RiskAssessmentWorkflow.filter(s => s.status === 'completed').length / this._313RiskAssessmentWorkflow.length * 100);
  }

  private _get313TreatmentSummary(): {total: number; approved: number; avgReduction: number; investment: string} {
    const a = this._313TreatmentOptions.filter(r => r.status === 'approved').length;
    const avg = this._313TreatmentOptions.reduce((s, r) => s + ((r.before - r.after) / r.before * 100), 0) / this._313TreatmentOptions.length;
    return {total: this._313TreatmentOptions.length, approved: a, avgReduction: Math.round(avg), investment: '$1.125M annually'};
  }

  private _get313RuleSummary(): {total: number; passing: number; failing: number; avgRate: number; violations: number} {
    const p = this._313ComplianceRules.filter(r => r.result === 'pass').length;
    const f = this._313ComplianceRules.filter(r => r.result === 'fail').length;
    const avg = this._313ComplianceRules.reduce((s, r) => s + r.passRate, 0) / this._313ComplianceRules.length;
    const v = this._313ComplianceRules.reduce((s, r) => s + r.violations, 0);
    return {total: this._313ComplianceRules.length, passing: p, failing: f, avgRate: Math.round(avg * 10) / 10, violations: v};
  }

  private _get313PipelineStats(): {positions: number; applicants: number; interviewing: number; offers: number; critical: number} {
    const t = this._313TalentPositions.length;
    const a = this._313TalentPositions.reduce((s, p) => s + p.applicants, 0);
    const i = this._313TalentPositions.reduce((s, p) => s + p.interviews, 0);
    const o = this._313TalentPositions.reduce((s, p) => s + p.offers, 0);
    const c = this._313TalentPositions.filter(x => x.urgency === 'critical').length;
    return {positions: t, applicants: a, interviewing: i, offers: o, critical: c};
  }

  private _get313MetricTrends(): {improving: number; stable: number; total: number} {
    const imp = this._313MetricsDashboard.filter(m => m.trend === 'improving').length;
    const stb = this._313MetricsDashboard.filter(m => m.trend === 'stable').length;
    return {improving: imp, stable: stb, total: this._313MetricsDashboard.length};
  }

  private _get313ArchScore(): {total: number; passed: number; failed: number; partial: number; score: number} {
    const p = this._313ArchReview.filter(c => c.status === 'pass').length;
    const f = this._313ArchReview.filter(c => c.status === 'fail').length;
    const pa = this._313ArchReview.filter(c => c.status === 'partial').length;
    return {total: this._313ArchReview.length, passed: p, failed: f, partial: pa, score: Math.round((p / this._313ArchReview.length) * 100)};
  }
  ...
  // === Security Risk Register (exfil_detect) ===
  private _exfil_detectRiskRegister = [
    { id: "RSK-EXF-0001", title: "Data breach from unpatched systems", owner: "CTO", category: "Financial", status: "mitigating", trend: "stable", severity: "medium", likelihood: 7, impact: 5, treatment: "Monitor and review quarterly", lastReview: "2026-04-23", nextReview: "2026-07-18" },
    { id: "RSK-EXF-0002", title: "Ransomware attack on critical infrastructure", owner: "CRO", category: "Strategic", status: "closed", trend: "decreasing", severity: "critical", likelihood: 3, impact: 6, treatment: "Monitor and review quarterly", lastReview: "2026-04-14", nextReview: "2026-07-15" },
    { id: "RSK-EXF-0003", title: "Insider threat data exfiltration", owner: "VP Eng", category: "Compliance", status: "accepted", trend: "increasing", severity: "critical", likelihood: 8, impact: 2, treatment: "Monitor and review quarterly", lastReview: "2026-04-19", nextReview: "2026-07-07" },
    { id: "RSK-EXF-0004", title: "Supply chain compromise", owner: "Security Lead", category: "Technical", status: "open", trend: "stable", severity: "low", likelihood: 6, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-02", nextReview: "2026-07-28" },
    { id: "RSK-EXF-0005", title: "Cloud misconfiguration exposure", owner: "Risk Mgr", category: "Reputational", status: "mitigating", trend: "decreasing", severity: "low", likelihood: 7, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-18", nextReview: "2026-07-26" },
    { id: "RSK-EXF-0006", title: "Phishing campaign success rate", owner: "Compliance Dir", category: "Legal", status: "closed", trend: "increasing", severity: "high", likelihood: 4, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-10", nextReview: "2026-07-17" },
    { id: "RSK-EXF-0007", title: "Third-party vendor data breach", owner: "IT Dir", category: "Regulatory", status: "accepted", trend: "stable", severity: "critical", likelihood: 3, impact: 5, treatment: "Monitor and review quarterly", lastReview: "2026-04-06", nextReview: "2026-07-24" },
    { id: "RSK-EXF-0008", title: "Regulatory non-compliance penalty", owner: "DevOps Lead", category: "Third-Party", status: "open", trend: "decreasing", severity: "medium", likelihood: 4, impact: 5, treatment: "Monitor and review quarterly", lastReview: "2026-04-01", nextReview: "2026-07-12" },
    { id: "RSK-EXF-0009", title: "Zero-day exploit in production", owner: "Architect", category: "Human Capital", status: "mitigating", trend: "increasing", severity: "low", likelihood: 2, impact: 2, treatment: "Monitor and review quarterly", lastReview: "2026-04-04", nextReview: "2026-07-28" },
    { id: "RSK-EXF-0010", title: "Insufficient access controls", owner: "CISO", category: "Operational", status: "closed", trend: "stable", severity: "low", likelihood: 1, impact: 4, treatment: "Monitor and review quarterly", lastReview: "2026-04-05", nextReview: "2026-07-15" },
    { id: "RSK-EXF-0011", title: "DDoS attack on services", owner: "CTO", category: "Financial", status: "accepted", trend: "decreasing", severity: "medium", likelihood: 9, impact: 7, treatment: "Monitor and review quarterly", lastReview: "2026-04-11", nextReview: "2026-07-28" },
    { id: "RSK-EXF-0012", title: "Social engineering attack", owner: "CRO", category: "Strategic", status: "open", trend: "increasing", severity: "high", likelihood: 3, impact: 7, treatment: "Monitor and review quarterly", lastReview: "2026-04-18", nextReview: "2026-07-12" },
    { id: "RSK-EXF-0013", title: "API security vulnerability", owner: "VP Eng", category: "Compliance", status: "mitigating", trend: "stable", severity: "medium", likelihood: 10, impact: 1, treatment: "Monitor and review quarterly", lastReview: "2026-04-13", nextReview: "2026-07-13" },
    { id: "RSK-EXF-0014", title: "Mobile device compromise", owner: "Security Lead", category: "Technical", status: "closed", trend: "decreasing", severity: "medium", likelihood: 6, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-12", nextReview: "2026-07-18" },
    { id: "RSK-EXF-0015", title: "Physical security breach", owner: "Risk Mgr", category: "Reputational", status: "accepted", trend: "increasing", severity: "low", likelihood: 3, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-17", nextReview: "2026-07-11" },
    { id: "RSK-EXF-0016", title: "Password policy weakness", owner: "Compliance Dir", category: "Legal", status: "open", trend: "stable", severity: "critical", likelihood: 9, impact: 5, treatment: "Monitor and review quarterly", lastReview: "2026-04-13", nextReview: "2026-07-08" },
    { id: "RSK-EXF-0017", title: "Network segmentation gap", owner: "IT Dir", category: "Regulatory", status: "mitigating", trend: "decreasing", severity: "low", likelihood: 3, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-14", nextReview: "2026-07-23" },
    { id: "RSK-EXF-0018", title: "Encryption key management failure", owner: "DevOps Lead", category: "Third-Party", status: "closed", trend: "increasing", severity: "critical", likelihood: 5, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-15", nextReview: "2026-07-10" },
    { id: "RSK-EXF-0019", title: "Audit trail tampering", owner: "Architect", category: "Human Capital", status: "accepted", trend: "stable", severity: "low", likelihood: 7, impact: 6, treatment: "Monitor and review quarterly", lastReview: "2026-04-01", nextReview: "2026-07-10" },
    { id: "RSK-EXF-0020", title: "Business email compromise", owner: "CISO", category: "Operational", status: "open", trend: "decreasing", severity: "low", likelihood: 6, impact: 1, treatment: "Monitor and review quarterly", lastReview: "2026-04-09", nextReview: "2026-07-20" },
  ];
  private _exfil_detectRiskFilter: string = 'all';
  private _exfil_detectRiskSeverity: string = 'all';
  private _exfil_detectRiskStatus: string = 'all';
  private _exfil_detectExpandedRisk: string = '';
  private _exfil_detectFilterRisks() {
    const reg = this._exfil_detectRiskRegister;
    return reg.filter(r => {
      if (this._exfil_detectRiskFilter !== "all" && r.category !== this._exfil_detectRiskFilter) return false;
      if (this._exfil_detectRiskSeverity !== "all" && r.severity !== this._exfil_detectRiskSeverity) return false;
      if (this._exfil_detectRiskStatus !== "all" && r.status !== this._exfil_detectRiskStatus) return false;
      return true;
    });
  }
  private _exfil_detectGetRiskScore(r: any) { return Math.round(r.likelihood * r.impact * 1.5); }
  private _exfil_detectGetRiskTrendIcon(trend: string) {
    if (trend === "increasing") return "\u2191";
    if (trend === "decreasing") return "\u2193";
    return "\u2192";
  }
  private _exfil_detectGetRiskColor(sev: string) {
    if (sev === "critical") return "#dc2626";
    if (sev === "high") return "#ea580c";
    if (sev === "medium") return "#d97706";
    return "#16a34a";
  }
  private _exfil_detectGetRiskCounts() {
    const reg = this._exfil_detectRiskRegister;
  ...
  private _exfil_detectGetTreatmentProgress() {
    const reg = this._exfil_detectRiskRegister;
    const treated = reg.filter(r => r.status === "mitigating" || r.status === "closed").length;
    return Math.round((treated / Math.max(reg.length, 1)) * 100);
  }

  // === Security Metrics API Gateway (exfil_detect) ===
  private _exfil_detectApiEndpoints = [
    { method: "GET", path: "/api/v1/threats", name: "Threat Intelligence Feed", status: "active", avgLatency: 85.8, reqPerMin: 1048.0, errorRate: 1.94, uptime: round(96.19443241810215,2), version: "v1.0.11" },
    { method: "POST", path: "/api/v1/scans/start", name: "Vulnerability Scanner", status: "active", avgLatency: 107.6, reqPerMin: 2397.0, errorRate: 0.81, uptime: round(95.94885528511591,2), version: "v2.9.13" },
    { method: "GET", path: "/api/v1/assets", name: "Asset Inventory", status: "active", avgLatency: 177.3, reqPerMin: 1957.0, errorRate: 1.12, uptime: round(99.13464713538173,2), version: "v1.0.6" },
    { method: "POST", path: "/api/v1/alerts", name: "Alert Management", status: "active", avgLatency: 55.5, reqPerMin: 2234.0, errorRate: 0.23, uptime: round(95.43494438616244,2), version: "v2.5.18" },
    { method: "GET", path: "/api/v1/compliance", name: "Compliance Status", status: "active", avgLatency: 363.6, reqPerMin: 1565.0, errorRate: 0.64, uptime: round(95.30725090972436,2), version: "v2.7.12" },
    { method: "PUT", path: "/api/v1/policies", name: "Policy Engine", status: "active", avgLatency: 189.4, reqPerMin: 2358.0, errorRate: 0.96, uptime: round(96.94780250516767,2), version: "v2.9.0" },
    { method: "GET", path: "/api/v1/incidents", name: "Incident Tracker", status: "active", avgLatency: 121.0, reqPerMin: 473.0, errorRate: 0.6, uptime: round(97.62838076288814,2), version: "v2.9.3" },
    { method: "POST", path: "/api/v1/forensics", name: "Forensics Collector", status: "degraded", avgLatency: 186.6, reqPerMin: 15.0, errorRate: 1.66, uptime: round(97.7457533743077,2), version: "v1.7.15" },
    { method: "GET", path: "/api/v1/risk/assess", name: "Risk Assessment", status: "active", avgLatency: 290.5, reqPerMin: 463.0, errorRate: 1.76, uptime: round(96.66897521671386,2), version: "v1.9.17" },
    { method: "POST", path: "/api/v1/auth/verify", name: "Authentication", status: "active", avgLatency: 447.6, reqPerMin: 355.0, errorRate: 1.5, uptime: round(96.95270907048852,2), version: "v3.9.13" },
    { method: "GET", path: "/api/v1/logs/audit", name: "Audit Log Query", status: "active", avgLatency: 327.6, reqPerMin: 1974.0, errorRate: 1.59, uptime: round(96.64196056512948,2), version: "v3.1.20" },
    { method: "PUT", path: "/api/v1/users/roles", name: "Role Management", status: "active", avgLatency: 394.2, reqPerMin: 1814.0, errorRate: 1.82, uptime: round(96.33120637557596,2), version: "v3.6.2" },
    { method: "POST", path: "/api/v1/encrypt", name: "Encryption Service", status: "active", avgLatency: 214.9, reqPerMin: 2373.0, errorRate: 0.24, uptime: round(96.86292061969604,2), version: "v1.7.18" },
    { method: "GET", path: "/api/v1/network/topo", name: "Network Topology", status: "maintenance", avgLatency: 92.7, reqPerMin: 1772.0, errorRate: 1.4, uptime: round(95.5698374888706,2), version: "v3.7.10" },
    { method: "DELETE", path: "/api/v1/sessions", name: "Session Manager", status: "active", avgLatency: 383.4, reqPerMin: 1732.0, errorRate: 1.88, uptime: round(98.2992105666569,2), version: "v3.8.20" },
  ];
  private _exfil_detectApiKeys = [
    { id: "ak-000001", name: "key-exfi-001", created: "2026-02-11", lastUsed: "2026-04-01", status: "active", calls: 34462, rateLimit: 1000 },
    { id: "ak-000002", name: "key-exfi-002", created: "2026-02-28", lastUsed: "2026-04-08", status: "active", calls: 43402, rateLimit: 1000 },
    { id: "ak-000003", name: "key-exfi-003", created: "2026-05-02", lastUsed: "2026-04-17", status: "active", calls: 1568, rateLimit: 1000 },
    { id: "ak-000004", name: "key-exfi-004", created: "2026-02-24", lastUsed: "2026-04-10", status: "active", calls: 36966, rateLimit: 5000 },
    { id: "ak-000005", name: "key-exfi-005", created: "2026-04-04", lastUsed: "2026-04-18", status: "revoked", calls: 20483, rateLimit: 5000 },
    { id: "ak-000006", name: "key-exfi-006", created: "2026-02-07", lastUsed: "2026-04-09", status: "active", calls: 6671, rateLimit: 100 },
    { id: "ak-000007", name: "key-exfi-007", created: "2026-04-27", lastUsed: "2026-04-17", status: "active", calls: 41047, rateLimit: 1000 },
    { id: "ak-000008", name: "key-exfi-008", created: "2026-06-04", lastUsed: "2026-04-15", status: "active", calls: 40174, rateLimit: 1000 },
  ];
  private _exfil_detectApiHealthSummary() {
    const eps = this._exfil_detectApiEndpoints;
  ...
  private _exfil_detectGetApiByMethod(method: string) { return this._exfil_detectApiEndpoints.filter(e=>e.method===method); }
  private _exfil_detectGetSlowEndpoints() { return this._exfil_detectApiEndpoints.filter(e=>e.avgLatency>200).sort((a,b)=>b.avgLatency-a.avgLatency); }
  private _exfil_detectGetHighErrorEndpoints() { return this._exfil_detectApiEndpoints.filter(e=>e.errorRate>1.0).sort((a,b)=>b.errorRate-a.errorRate); }

  // === Security Training Effectiveness (exfil_detect) ===
  private _exfil_detectTrainingModules = [
    { id: "TRN-001", name: "Security Fundamentals", completionRate: 94.0, avgScore: 74.8, behaviorChange: 40.0, enrolled: 306, completed: 158, duration: "61min", category: "mandatory" },
    { id: "TRN-002", name: "Phishing Awareness", completionRate: 55.6, avgScore: 62.3, behaviorChange: 61.9, enrolled: 354, completed: 150, duration: "98min", category: "mandatory" },
    { id: "TRN-003", name: "Social Engineering Defense", completionRate: 72.7, avgScore: 61.4, behaviorChange: 36.4, enrolled: 346, completed: 32, duration: "35min", category: "optional" },
    { id: "TRN-004", name: "Password Hygiene", completionRate: 81.6, avgScore: 62.7, behaviorChange: 77.5, enrolled: 441, completed: 28, duration: "110min", category: "mandatory" },
    { id: "TRN-005", name: "Data Classification", completionRate: 92.4, avgScore: 56.6, behaviorChange: 31.8, enrolled: 64, completed: 347, duration: "47min", category: "mandatory" },
    { id: "TRN-006", name: "Incident Response Basics", completionRate: 90.4, avgScore: 59.0, behaviorChange: 44.2, enrolled: 427, completed: 181, duration: "26min", category: "mandatory" },
    { id: "TRN-007", name: "Secure Coding", completionRate: 93.5, avgScore: 75.4, behaviorChange: 54.7, enrolled: 186, completed: 132, duration: "95min", category: "optional" },
    { id: "TRN-008", name: "Cloud Security", completionRate: 88.3, avgScore: 84.3, behaviorChange: 44.3, enrolled: 458, completed: 37, duration: "61min", category: "mandatory" },
    { id: "TRN-009", name: "Mobile Device Security", completionRate: 63.3, avgScore: 77.9, behaviorChange: 82.5, enrolled: 251, completed: 87, duration: "62min", category: "mandatory" },
    { id: "TRN-010", name: "Network Security", completionRate: 69.7, avgScore: 83.2, behaviorChange: 32.8, enrolled: 247, completed: 85, duration: "67min", category: "mandatory" },
    { id: "TRN-011", name: "Physical Security", completionRate: 75.4, avgScore: 94.0, behaviorChange: 54.0, enrolled: 227, completed: 417, duration: "90min", category: "optional" },
    { id: "TRN-012", name: "Regulatory Compliance", completionRate: 48.5, avgScore: 94.1, behaviorChange: 62.0, enrolled: 225, completed: 64, duration: "65min", category: "mandatory" },
    { id: "TRN-013", name: "Risk Management", completionRate: 89.1, avgScore: 73.8, behaviorChange: 79.9, enrolled: 65, completed: 360, duration: "118min", category: "mandatory" },
    { id: "TRN-014", name: "Cryptography Basics", completionRate: 75.8, avgScore: 63.2, behaviorChange: 30.8, enrolled: 310, completed: 425, duration: "38min", category: "mandatory" },
    { id: "TRN-015", name: "Access Control", completionRate: 67.3, avgScore: 74.4, behaviorChange: 52.5, enrolled: 63, completed: 295, duration: "97min", category: "optional" },
    { id: "TRN-016", name: "Vendor Management", completionRate: 96.6, avgScore: 64.3, behaviorChange: 30.6, enrolled: 367, completed: 134, duration: "113min", category: "mandatory" },
  ];
  private _exfil_detectPhishingResults = [
    { month: "2026-01", sent: 493, clicked: 52, reported: 184, clickRate: round(10.547667342799189,1), reportRate: round(37.32251521298174,1) },
    { month: "2026-02", sent: 872, clicked: 106, reported: 313, clickRate: round(12.155963302752294,1), reportRate: round(35.89449541284404,1) },
    { month: "2026-03", sent: 775, clicked: 128, reported: 267, clickRate: round(16.516129032258064,1), reportRate: round(34.45161290322581,1) },
    { month: "2026-04", sent: 308, clicked: 87, reported: 51, clickRate: round(28.246753246753247,1), reportRate: round(16.558441558441558,1) },
    { month: "2026-05", sent: 873, clicked: 82, reported: 494, clickRate: round(9.392898052691868,1), reportRate: round(56.5864833906071,1) },
    { month: "2026-06", sent: 568, clicked: 151, reported: 331, clickRate: round(26.58450704225352,1), reportRate: round(58.27464788732394,1) },
  ];
  private _exfil_detectTrainingROI = { totalInvestment: 65871, avgCostPerEmployee: 715, riskReductionPct: round(random.uniform(15,45),1), incidentReductionPct: round(random.uniform(10,35),1), complianceScoreGain: round(random.uniform(5,25),1) };
  private _exfil_detectLearningPaths = [
    { name: "Beginner Security Analyst", totalModules: 17, completedModules: 13, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 36, enrolled: 106 },
    { name: "Advanced Threat Hunter", totalModules: 20, completedModules: 17, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 64, enrolled: 48 },
    { name: "Security Architect", totalModules: 16, completedModules: 9, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 68, enrolled: 104 },
    { name: "Incident Responder", totalModules: 16, completedModules: 14, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 26, enrolled: 147 },
    { name: "Compliance Specialist", totalModules: 12, completedModules: 12, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 59, enrolled: 40 },
    { name: "DevSecOps Engineer", totalModules: 8, completedModules: 11, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 41, enrolled: 105 },
  ];
  private _exfil_detectGetOverallCompletion() {
    const mods = this._exfil_detectTrainingModules;
    return round(mods.reduce((s,m)=>s+m.completionRate,0)/mods.length,1);
  }
  private _exfil_detectGetTopPerformers() { return [...this._exfil_detectTrainingModules].sort((a,b)=>b.avgScore-a.avgScore).slice(0,5); }
  private _exfil_detectGetModulesNeedingAttention() { return this._exfil_detectTrainingModules.filter(m=>m.completionRate<70||m.avgScore<65); }

  // === Security Governance Framework (exfil_detect) ===
  private _exfil_detectGovBodies = [
    { name: "Security Steering Committee", members: 12, chair: "CISO", meetingFreq: "Weekly", lastMeeting: "2026-04-08", nextMeeting: "2026-05-13", quorum: 4 },
    { name: "Risk Management Board", members: 7, chair: "CTO", meetingFreq: "Bi-weekly", lastMeeting: "2026-04-14", nextMeeting: "2026-05-12", quorum: 8 },
    { name: "Data Governance Council", members: 8, chair: "CRO", meetingFreq: "Monthly", lastMeeting: "2026-04-22", nextMeeting: "2026-05-20", quorum: 3 },
    { name: "Compliance Oversight Board", members: 5, chair: "CDO", meetingFreq: "Monthly", lastMeeting: "2026-04-06", nextMeeting: "2026-05-23", quorum: 7 },
    { name: "Architecture Review Board", members: 11, chair: "VP Eng", meetingFreq: "Bi-weekly", lastMeeting: "2026-04-02", nextMeeting: "2026-05-11", quorum: 7 },
    { name: "Change Advisory Board", members: 11, chair: "CISO", meetingFreq: "Weekly", lastMeeting: "2026-04-10", nextMeeting: "2026-05-13", quorum: 5 },
    { name: "Incident Review Board", members: 5, chair: "CIO", meetingFreq: "As needed", lastMeeting: "2026-04-17", nextMeeting: "2026-05-10", quorum: 4 },
    { name: "Vendor Risk Committee", members: 14, chair: "CFO", meetingFreq: "Quarterly", lastMeeting: "2026-04-12", nextMeeting: "2026-05-20", quorum: 7 },
  ];
  private _exfil_detectDecisions = [
    { id: "DEC-0001", title: "Adopt zero-trust architecture framework", date: "2026-04-07", status: "approved", owner: "CISO" },
    { id: "DEC-0002", title: "Migrate to SIEM 2.0 platform", date: "2026-02-26", status: "implemented", owner: "CTO" },
    { id: "DEC-0003", title: "Implement DLP across all endpoints", date: "2026-04-12", status: "in-progress", owner: "Security Lead" },
    { id: "DEC-0004", title: "Mandate MFA for all external access", date: "2026-01-07", status: "pending", owner: "CRO" },
    { id: "DEC-0005", title: "Establish bug bounty program", date: "2026-02-06", status: "approved", owner: "VP Eng" },
    { id: "DEC-0006", title: "Deploy EDR solution enterprise-wide", date: "2026-01-28", status: "approved", owner: "CISO" },
    { id: "DEC-0007", title: "Conduct annual penetration testing", date: "2026-03-05", status: "implemented", owner: "CTO" },
    { id: "DEC-0008", title: "Implement network micro-segmentation", date: "2026-02-01", status: "in-progress", owner: "Security Lead" },
    { id: "DEC-0009", title: "Establish security champion program", date: "2026-04-10", status: "pending", owner: "CRO" },
    { id: "DEC-0010", title: "Migrate to passwordless authentication", date: "2026-02-05", status: "approved", owner: "VP Eng" },
  ];
  private _exfil_detectPolicyLifecycle = [
    { name: "Information Security Policy", version: "v4.3", status: "active", lastUpdated: "2026-02-03", nextReview: "2026-8-04", owner: "CISO" },
    { name: "Acceptable Use Policy", version: "v2.0", status: "active", lastUpdated: "2026-03-05", nextReview: "2026-10-15", owner: "Legal" },
    { name: "Data Retention Policy", version: "v3.2", status: "under-review", lastUpdated: "2026-04-19", nextReview: "2026-12-10", owner: "DPO" },
    { name: "Access Control Policy", version: "v4.0", status: "active", lastUpdated: "2026-04-16", nextReview: "2026-7-15", owner: "IAM Lead" },
    { name: "Incident Response Policy", version: "v1.5", status: "draft", lastUpdated: "2026-04-11", nextReview: "2026-10-15", owner: "IR Lead" },
    { name: "Business Continuity Plan", version: "v1.5", status: "active", lastUpdated: "2026-03-22", nextReview: "2026-10-08", owner: "BCP Mgr" },
    { name: "Vendor Management Policy", version: "v1.3", status: "active", lastUpdated: "2026-04-10", nextReview: "2026-11-23", owner: "Procurement" },
    { name: "Encryption Standard", version: "v4.2", status: "under-review", lastUpdated: "2026-04-12", nextReview: "2026-8-22", owner: "Security Arch" },
  ];
  private _exfil_detectGovMaturityScore = { overall: 3.3, riskManagement: 2.8, compliance: 4.4, incidentResponse: 2.3, awareness: 5.8, technology: 2.7 };
  private _exfil_detectGetPendingDecisions() { return this._exfil_detectDecisions.filter(d=>d.status==='pending'||d.status==='in-progress'); }
  private _exfil_detectGetActivePolicies() { return this._exfil_detectPolicyLifecycle.filter(p=>p.status==='active'); }
  private _exfil_detectGetEscalationPath() { return ["L1 Analyst","L2 Senior","Security Lead","CISO","Board"]; }

  // === Security Innovation Lab (exfil_detect) ===
  private _exfil_detectInnoProjects = [
    { id: "INN-001", name: "AI-Powered Threat Detection", description: "Machine learning models for real-time threat identification", status: "active", progress: 72, startDate: "2026-02-21", teamSize: 8, budget: 121857, milestones: 10, completedMilestones: 7 },
    { id: "INN-002", name: "Quantum-Resistant Cryptography", description: "Post-quantum encryption algorithm prototyping", status: "research", progress: 35, startDate: "2026-03-05", teamSize: 7, budget: 102960, milestones: 6, completedMilestones: 2 },
    { id: "INN-003", name: "Automated Red Teaming", description: "Autonomous penetration testing framework", status: "active", progress: 58, startDate: "2026-03-03", teamSize: 7, budget: 76305, milestones: 4, completedMilestones: 1 },
    { id: "INN-004", name: "Zero-Knowledge Authentication", description: "Privacy-preserving identity verification", status: "poc", progress: 88, startDate: "2026-03-19", teamSize: 4, budget: 51969, milestones: 5, completedMilestones: 9 },
    { id: "INN-005", name: "Blockchain Audit Trail", description: "Immutable security event logging", status: "active", progress: 45, startDate: "2026-01-08", teamSize: 7, budget: 171193, milestones: 7, completedMilestones: 4 },
    { id: "INN-006", name: "Behavioral Biometrics", description: "Continuous authentication via user behavior patterns", status: "research", progress: 22, startDate: "2026-01-27", teamSize: 7, budget: 47037, milestones: 4, completedMilestones: 1 },
    { id: "INN-007", name: "Deception Grid 2.0", description: "Advanced honeypot network with adaptive responses", status: "active", progress: 65, startDate: "2026-01-19", teamSize: 7, budget: 26496, milestones: 8, completedMilestones: 2 },
    { id: "INN-008", name: "Secure Enclave Integration", description: "Hardware-backed security for critical workloads", status: "poc", progress: 40, startDate: "2026-02-18", teamSize: 7, budget: 127135, milestones: 5, completedMilestones: 9 },
  ];
  private _exfil_detectTechEvaluations = [
    { name: "Rust for Security Tools", status: "evaluating", score: 6.9, recommendation: "Adopt", vendor: "Open Source" },
    { name: "eBPF for Runtime Detection", status: "completed", score: 7.5, recommendation: "Adopt", vendor: "AWS" },
    { name: "Confidential Computing", status: "planned", score: 7.3, recommendation: "Investigate", vendor: "Azure" },
    { name: "Homomorphic Encryption", status: "evaluating", score: 6.2, recommendation: "Pilot", vendor: "GCP" },
    { name: "SASE Architecture", status: "completed", score: 5.8, recommendation: "Adopt", vendor: "Multiple" },
    { name: "SOAR Platform 3.0", status: "planned", score: 10.0, recommendation: "Monitor", vendor: "Splunk" },
  ];
  private _exfil_detectCollaborationPartners = [
  ...
  private _exfil_detectInnoMetrics = { totalProjects: 8, activeProjects: 4, avgTimeToValue: "71 days", pocSuccessRate: round(random.uniform(55,85),1), researchToProduction: round(random.uniform(20,50),1), innovationIndex: round(random.uniform(6.0,9.5),1) };
  private _exfil_detectGetProjectByStatus(status: string) { return this._exfil_detectInnoProjects.filter(p=>p.status===status); }
  private _exfil_detectGetTopEvaluations() { return [...this._exfil_detectTechEvaluations].sort((a,b)=>b.score-a.score).slice(0,3); }



  // === Compliance Dashboard Extension (exfil_detect) ===
  private _exfil_detectComplianceFrameworks = [
    { name: "SOC 2 Type II", description: "Trust Services Criteria", totalControls: 5, implementedControls: 2, status: "partially-compliant", lastAudit: "2026-03-06", nextAudit: "2026-10-09", evidenceCount: 386 },
    { name: "ISO 27001", description: "Information Security Management", totalControls: 114, implementedControls: 113, status: "partially-compliant", lastAudit: "2026-04-25", nextAudit: "2026-8-04", evidenceCount: 340 },
    { name: "PCI DSS 4.0", description: "Payment Card Industry", totalControls: 12, implementedControls: 12, status: "non-compliant", lastAudit: "2026-02-27", nextAudit: "2026-12-17", evidenceCount: 129 },
    { name: "HIPAA", description: "Health Insurance Portability", totalControls: 18, implementedControls: 10, status: "partially-compliant", lastAudit: "2026-03-06", nextAudit: "2026-11-24", evidenceCount: 269 },
    { name: "GDPR", description: "Data Protection Regulation", totalControls: 99, implementedControls: 52, status: "partially-compliant", lastAudit: "2026-02-18", nextAudit: "2026-10-16", evidenceCount: 218 },
    { name: "NIST CSF 2.0", description: "Cybersecurity Framework", totalControls: 6, implementedControls: 5, status: "partially-compliant", lastAudit: "2026-03-20", nextAudit: "2026-11-02", evidenceCount: 426 },
    { name: "FedRAMP", description: "Federal Risk Authorization", totalControls: 15, implementedControls: 9, status: "partially-compliant", lastAudit: "2026-04-17", nextAudit: "2026-12-27", evidenceCount: 103 },
    { name: "SOX", description: "Sarbanes-Oxley Compliance", totalControls: 8, implementedControls: 6, status: "non-compliant", lastAudit: "2026-02-17", nextAudit: "2026-10-08", evidenceCount: 89 },
    { name: "CIS Controls v8", description: "Center for Internet Security", totalControls: 18, implementedControls: 18, status: "partially-compliant", lastAudit: "2026-01-21", nextAudit: "2026-12-13", evidenceCount: 337 },
    { name: "COBIT 2019", description: "IT Governance Framework", totalControls: 40, implementedControls: 32, status: "compliant", lastAudit: "2026-01-14", nextAudit: "2026-8-20", evidenceCount: 103 },
  ];
  private _exfil_detectGetComplianceScore() {
    const fw = this._exfil_detectComplianceFrameworks;
    return round(fw.reduce((s,f)=>s + (f.implementedControls/Math.max(f.totalControls,1))*100, 0) / fw.length, 1);
  }
  private _exfil_detectGetGaps() {
    return this._exfil_detectComplianceFrameworks.filter(f => f.status !== "compliant");
  }
  private _exfil_detectAuditTrail = [
    { id: "AUD-0001", action: "Control tested", auditor: "Internal Audit", date: "2026-04-04", result: "pass", findings: 5 },
    { id: "AUD-0002", action: "Evidence collected", auditor: "External Auditor", date: "2026-04-11", result: "pass", findings: 0 },
    { id: "AUD-0003", action: "Gap identified", auditor: "Security Team", date: "2026-04-02", result: "fail", findings: 2 },
    { id: "AUD-0004", action: "Remediation completed", auditor: "Compliance Officer", date: "2026-04-19", result: "pass", findings: 4 },
    { id: "AUD-0005", action: "Policy updated", auditor: "IT Audit", date: "2026-04-21", result: "pass", findings: 0 },
    { id: "AUD-0006", action: "Training verified", auditor: "Risk Team", date: "2026-04-17", result: "pass", findings: 1 },
    { id: "AUD-0007", action: "Access reviewed", auditor: "QA Team", date: "2026-04-17", result: "pass", findings: 3 },
    { id: "AUD-0008", action: "Exception approved", auditor: "CISO Office", date: "2026-04-19", result: "conditional", findings: 4 },
    { id: "AUD-0009", action: "Risk accepted", auditor: "Board Audit", date: "2026-04-13", result: "pass", findings: 1 },
    { id: "AUD-0010", action: "Control enhanced", auditor: "Third Party", date: "2026-04-01", result: "pass", findings: 2 },
  ];

  // === Threat Intelligence Feed Extension (exfil_detect) ===
  private _exfil_detectThreatActors = [
    { name: "APT-29", alias: "Cozy Bear", origin: "Russia", type: "Nation-State", severity: "high", lastActivity: "2026-04-10", targets: "Manufacturing", indicators: 275, ttps: 34 },
    { name: "APT-41", alias: "Double Dragon", origin: "China", type: "Nation-State", severity: "critical", lastActivity: "2026-04-17", targets: "Manufacturing", indicators: 151, ttps: 30 },
    { name: "Lazarus Group", alias: "Hidden Cobra", origin: "North Korea", type: "Nation-State", severity: "critical", lastActivity: "2026-04-09", targets: "Energy", indicators: 154, ttps: 41 },
    { name: "FIN7", alias: "Carbanak", origin: "Eastern Europe", type: "Financial", severity: "high", lastActivity: "2026-04-11", targets: "Finance", indicators: 396, ttps: 13 },
    { name: "Conti", alias: "Wizard Spider", origin: "Russia", type: "Ransomware", severity: "critical", lastActivity: "2026-04-14", targets: "Healthcare", indicators: 270, ttps: 33 },
    { name: "LockBit", alias: "LockBit Gang", origin: "Unknown", type: "Ransomware", severity: "high", lastActivity: "2026-04-15", targets: "Finance", indicators: 342, ttps: 31 },
    { name: "Cl0p", alias: "Cl0p Team", origin: "Unknown", type: "Ransomware", severity: "high", lastActivity: "2026-04-18", targets: "Manufacturing", indicators: 181, ttps: 10 },
    { name: "Sandworm", alias: "Unit 74455", origin: "Russia", type: "Nation-State", severity: "critical", lastActivity: "2026-04-14", targets: "Finance", indicators: 88, ttps: 14 },
  ];
  private _exfil_detectIoCFeed = [
    { id: "ioc-000001", type: "ip", value: "124.156.164.238", confidence: 53, source: "STIX", firstSeen: "2026-04-09", lastSeen: "2026-04-23" },
    { id: "ioc-000002", type: "ip", value: "83.37.5.132", confidence: 42, source: "AlienVault", firstSeen: "2026-04-22", lastSeen: "2026-04-20" },
    { id: "ioc-000003", type: "ip", value: "59.160.153.75", confidence: 59, source: "AlienVault", firstSeen: "2026-04-03", lastSeen: "2026-04-09" },
    { id: "ioc-000004", type: "ip", value: "198.62.77.77", confidence: 55, source: "CrowdStrike", firstSeen: "2026-04-07", lastSeen: "2026-04-06" },
    { id: "ioc-000005", type: "ip", value: "50.212.170.66", confidence: 81, source: "CrowdStrike", firstSeen: "2026-04-13", lastSeen: "2026-04-12" },
    { id: "ioc-000006", type: "ip", value: "243.63.218.157", confidence: 83, source: "AlienVault", firstSeen: "2026-04-23", lastSeen: "2026-04-05" },
    { id: "ioc-000007", type: "ip", value: "9.61.87.94", confidence: 97, source: "AlienVault", firstSeen: "2026-04-17", lastSeen: "2026-04-11" },
    { id: "ioc-000008", type: "ip", value: "88.253.131.144", confidence: 64, source: "VirusTotal", firstSeen: "2026-04-23", lastSeen: "2026-04-06" },
    { id: "ioc-000009", type: "ip", value: "120.152.56.3", confidence: 63, source: "MISP", firstSeen: "2026-04-10", lastSeen: "2026-04-16" },
    { id: "ioc-000010", type: "ip", value: "49.100.162.38", confidence: 52, source: "STIX", firstSeen: "2026-04-04", lastSeen: "2026-04-13" },
    { id: "ioc-000011", type: "ip", value: "30.163.78.112", confidence: 89, source: "Mandiant", firstSeen: "2026-04-21", lastSeen: "2026-04-03" },
    { id: "ioc-000012", type: "ip", value: "117.181.124.53", confidence: 53, source: "VirusTotal", firstSeen: "2026-04-08", lastSeen: "2026-04-02" },
    { id: "ioc-000013", type: "ip", value: "184.52.248.95", confidence: 93, source: "MISP", firstSeen: "2026-04-03", lastSeen: "2026-04-05" },
    { id: "ioc-000014", type: "ip", value: "200.11.200.209", confidence: 71, source: "Mandiant", firstSeen: "2026-04-18", lastSeen: "2026-04-16" },
    { id: "ioc-000015", type: "ip", value: "86.34.46.220", confidence: 94, source: "STIX", firstSeen: "2026-04-04", lastSeen: "2026-04-11" },
  ];
  private _exfil_detectGetActiveThreats() { return this._exfil_detectThreatActors.filter(a => a.severity === 'critical'); }
  private _exfil_detectGetThreatSummary() {
    const actors = this._exfil_detectThreatActors;
  ...
  // === Incident Management Extension (exfil_detect) ===
  private _exfil_detectIncidents = [
    { id: "INC-20260001", title: "Unauthorized access detected", severity: "critical", status: "open", assignedTo: "SOC L1", detectedAt: "2026-04-21T03:14", affectedAssets: 13, rootCause: "Misconfiguration" },
    { id: "INC-20260002", title: "Malware outbreak on workstation", severity: "high", status: "investigating", assignedTo: "SOC L2", detectedAt: "2026-04-12T17:43", affectedAssets: 13, rootCause: "Credential compromise" },
    { id: "INC-20260003", title: "Data leak from S3 bucket", severity: "medium", status: "contained", assignedTo: "IR Lead", detectedAt: "2026-04-16T10:54", affectedAssets: 13, rootCause: "Zero-day" },
    { id: "INC-20260004", title: "Phishing campaign targeting finance", severity: "low", status: "eradicated", assignedTo: "CISO", detectedAt: "2026-04-01T03:59", affectedAssets: 27, rootCause: "Human error" },
    { id: "INC-20260005", title: "DDoS attack on web services", severity: "critical", status: "recovered", assignedTo: "Security Eng", detectedAt: "2026-04-18T23:27", affectedAssets: 15, rootCause: "Policy violation" },
    { id: "INC-20260006", title: "Ransomware encryption attempt", severity: "high", status: "closed", assignedTo: "Forensics", detectedAt: "2026-04-04T12:00", affectedAssets: 4, rootCause: "Unknown" },
    { id: "INC-20260007", title: "Insider data exfiltration", severity: "medium", status: "open", assignedTo: "SOC L1", detectedAt: "2026-04-02T10:06", affectedAssets: 25, rootCause: "Misconfiguration" },
    { id: "INC-20260008", title: "API key exposure in repo", severity: "low", status: "investigating", assignedTo: "SOC L2", detectedAt: "2026-04-18T13:43", affectedAssets: 21, rootCause: "Credential compromise" },
    { id: "INC-20260009", title: "SQL injection on portal", severity: "critical", status: "contained", assignedTo: "IR Lead", detectedAt: "2026-04-23T08:42", affectedAssets: 43, rootCause: "Zero-day" },
    { id: "INC-20260010", title: "Brute force on VPN", severity: "high", status: "eradicated", assignedTo: "CISO", detectedAt: "2026-04-15T02:38", affectedAssets: 41, rootCause: "Human error" },
    { id: "INC-20260011", title: "Supply chain alert from vendor", severity: "medium", status: "recovered", assignedTo: "Security Eng", detectedAt: "2026-04-09T12:22", affectedAssets: 15, rootCause: "Policy violation" },
    { id: "INC-20260012", title: "Suspicious lateral movement", severity: "low", status: "closed", assignedTo: "Forensics", detectedAt: "2026-04-22T20:10", affectedAssets: 15, rootCause: "Unknown" },
  ];
  private _exfil_detectGetIncidentStats() {
    const inc = this._exfil_detectIncidents;
    return { total: inc.length, open: inc.filter(i=>i.status==="open").length, investigating: inc.filter(i=>i.status==="investigating").length, mttd: 33, mttr: 132 };
  }
  private _exfil_detectGetSeverityDistribution() {
    const inc = this._exfil_detectIncidents;
  ...
  render() {    if (this._exfRules.length === 0) { this._initExfRules(); this._initExfCvss(); this._runExfAnomalyDetection(); this._generateExfPredictions(); this._initExfApprovals(); this._initExfActivity(); this._initExfNotifications(); }
...
<div class="tabs">
        ...
        ${this._activeTab === 'rules' ? html`
          ${this._renderExfRules()}
          <div style="margin-top:12px;font-size:11px;font-weight:600;margin-bottom:6px">Category Treemap</div>
          <div style="background:#1a1d27;border-radius:8px;padding:12px">${this._renderExfTreemapSVG()}</div>
          <div style="margin-top:12px;font-size:11px;font-weight:600;margin-bottom:6px">Data Flow (Sankey)</div>
          <div style="background:#1a1d27;border-radius:8px;padding:12px">${this._renderExfSankeySVG()}</div>
          ${this._renderExfActivity()}
        ` : nothing}
        ${this._activeTab === 'anomalies' ? html`
          ${this._renderExfAnomalies()}
          ${this._renderExfNotifications()}
        ` : nothing}
        ${this._activeTab === 'predictions' ? html`
          ${this._renderExfPredictions()}
          ...
          <div style="background:#1a1d27;border-radius:8px;padding:12px">
            <table class="history-table"><thead><tr><th>ID</th><th>Base</th><th>Temporal</th><th>Environmental</th><th>Overall</th></tr></thead><tbody>
              ${this._exfcvssData.map(c => html`<tr><td>${c.itemId}</td><td style="color:${c.base >= 7 ? '#ef4444' : c.base >= 4 ? '#eab308' : '#22c55e'}">${c.base}</td><td>${c.temporal}</td><td>${c.environmental}</td><td style="font-weight:700;color:${c.overall >= 7 ? '#ef4444' : c.overall >= 4 ? '#eab308' : '#22c55e'}">${c.overall}</td></tr>`)}
            </tbody></table>
          </div>
        ` : nothing}
        ${this._activeTab === 'approvals' ? html`
          ${this._renderExfApprovals()}
        ` : nothing}
        ${this._activeTab === 'config' ? html`
          ${this._renderExfConfig()}
        ` : nothing}
        ${this._activeTab === 'new' ? html`
          <div class="form-section">
            <div class="form-title">Create New Exfil Detection Entry</div>
            <div class="form-grid">
  ...
  @state() private _edScenarios: {id:string;name:string;attackType:string;target:string;method:string;impactLow:number;impactHigh:number;confidence:number;mitigation:string;status:string}[] = [];
  @state() private _edScenarioForm: {attackType:string;target:string;method:string} = {attackType:'',target:'',method:''};
  @state() private _edScenarioCompare: boolean = false;
  @state() private _edScenarioSelected: string[] = [];

  private _edInitScenarios(): void {
    const saved = localStorage.getItem('ed_scenarios');
    if (saved) { try { this._edScenarios = JSON.parse(saved); } catch { /* ignore */ } }
    if (this._edScenarios.length === 0) {
      this._edScenarios = [
        {id:'ed-s1',name:'Baseline Threat',attackType:'Phishing',target:'Employees',method:'Spear Email',impactLow:45,impactHigh:78,confidence:72,mitigation:'Security awareness training + email filtering',status:'active'},
        {id:'ed-s2',name:'Escalated Attack',attackType:'Ransomware',target:'Endpoints',method:'Drive-by Download',impactLow:65,impactHigh:95,confidence:58,mitigation:'EDR deployment + network segmentation',status:'saved'},
        {id:'ed-s3',name:'Insider Threat',attackType:'Data Exfiltration',target:'Databases',method:'SQL Injection',impactLow:55,impactHigh:88,confidence:65,mitigation:'DLP policies + query monitoring',status:'draft'},
      ];
    }
  }

  private _edSaveScenarios(): void {
    localStorage.setItem('ed_scenarios', JSON.stringify(this._edScenarios));
  }

  private _edAddScenario(): void {
    const f = this._edScenarioForm;
    if (!f.attackType || !f.target) return;
    this._edScenarios = [...this._edScenarios, {
      id: 'ed-s' + (this._edScenarios.length + 1),
    ...
    this._edScenarioForm = {attackType:'',target:'',method:''};
    this._edSaveScenarios();
  }

  private _edRenderScenarioEngine(): any {
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <button class="tab" @click=${() => { this._edScenarioCompare = !this._edScenarioCompare; }}>${this._edScenarioCompare ? 'List View' : 'Compare'}</button>
        </div>
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:6px;margin-bottom:10px">
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._edScenarioForm = {...this._edScenarioForm, attackType: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Attack Type</option>
            ${attackTypes.map(a => html`<option value=${a} ${this._edScenarioForm.attackType === a ? 'selected' : ''}>${a}</option>`)}
          </select>
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._edScenarioForm = {...this._edScenarioForm, target: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Target</option>
            ${targets.map(t => html`<option value=${t} ${this._edScenarioForm.target === t ? 'selected' : ''}>${t}</option>`)}
          </select>
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._edScenarioForm = {...this._edScenarioForm, method: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Method</option>
            ${methods.map(m => html`<option value=${m} ${this._edScenarioForm.method === m ? 'selected' : ''}>${m}</option>`)}
          </select>
        </div>
        <button style="background:#3b82f6;border:none;border-radius:4px;padding:4px 12px;color:#fff;font-size:11px;cursor:pointer" @click=${this._edAddScenario}>Run Simulation</button>
      </div>
      ${this._edScenarioCompare && this._edScenarios.length >= 2 ? html`
        <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
          <div style="font-weight:600;font-size:12px;color:#e2e8f0;margin-bottom:8px">Side-by-Side Comparison</div>
          <div style="display:grid;grid-template-columns:repeat(${Math.min(3, this._edScenarios.length)},1fr);gap:8px">
            ${this._edScenarios.slice(0,3).map(s => html`
      ...
      <div style="background:#0f1117;border-radius:8px;padding:12px">
        <div style="font-weight:600;font-size:12px;color:#e2e8f0;margin-bottom:8px">Saved Scenarios (${this._edScenarios.length})</div>
        ${this._edScenarios.map(s => html`
  ...
  @state() private _edTrendData: {day:number;value:number;anomaly:boolean}[] = [];
  @state() private _edTrendZoom: {start:number;end:number} | null = null;
  @state() private _edTrendMA: number = 7;

  private _edInitTrendData(): void {
    ...
    this._edTrendData = data;
  }

  private _edCalcMA(window: number): number[] {
    const result: number[] = [];
    for (let i = 0; i < this._edTrendData.length; i++) {
      const start = Math.max(0, i - window + 1);
      const slice = this._edTrendData.slice(start, i + 1);
      result.push(slice.reduce((s, d) => s + d.value, 0) / slice.length);
    }
    return result;
  }

  private _edGetStats(): {mean:number;median:number;stddev:number;trend:string} {
    const vals = this._edTrendData.map(d => d.value);
    const n = vals.length;
  ...
  private _edRenderTimeSeries(): any {
    const stats = this._edGetStats();
    const filtered = this._edTrendZoom ? this._edTrendData.filter(d => d.day >= this._edTrendZoom.start && d.day <= this._edTrendZoom.end) : this._edTrendData;
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px">
            <button class="tab ${this._edTrendMA === 7 ? 'active' : ''}" @click=${() => { this._edTrendMA = 7; }}>7D MA</button>
            <button class="tab ${this._edTrendMA === 30 ? 'active' : ''}" @click=${() => { this._edTrendMA = 30; }}>30D MA</button>
            <button class="tab" @click=${() => { this._edTrendZoom = null; }}>Reset Zoom</button>
          </div>
        </div>
        <div style="position:relative;height:120px;background:#1a1d2e;border-radius:6px;overflow:hidden;margin-bottom:8px;cursor:crosshair" @click=${(e: any) => {
          ...
          this._edTrendZoom = { start: Math.max(0, center - 10), end: Math.min(89, center + 10) };
        }}>
  ...
  @state() private _edRoles: string[] = ['Admin','Analyst','Operator','Viewer','Auditor'];
  @state() private _edActions: string[] = ['Create','Read','Update','Delete','Export','Approve'];
  @state() private _edPermissions: { [role: string]: { [action: string]: boolean } } = {};
  @state() private _edPermAudit: {role:string;action:string;changedBy:string;timestamp:string;oldVal:boolean;newVal:boolean}[] = [];
  @state() private _edPermCompare: string[] = [];

  private _edInitPermissions(): void {
    ...
    for (const role of this._edRoles) {
      perms[role] = {};
      this._edActions.forEach((a, i) => { perms[role][a] = defaults[role]?.[i] ?? false; });
    }
    this._edPermissions = perms;
  }

  private _edTogglePermission(role: string, action: string): void {
    const old = this._edPermissions[role][action];
    this._edPermissions = {...this._edPermissions, [role]: {...this._edPermissions[role], [action]: !old}};
    this._edPermAudit.unshift({role,action,changedBy:'current_user',timestamp:new Date().toISOString(),oldVal:old,newVal:!old});
  }

  private _edRenderRBAC(): any {
    const compareRoles = this._edPermCompare.map(r => this._edPermissions[r]).filter(Boolean);
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          <span style="font-weight:700;font-size:13px;color:#e2e8f0">RBAC Permission Matrix</span>
          <div style="display:flex;gap:4px">
            ${this._edRoles.map(r => html`
              <button class="tab ${this._edPermCompare.includes(r) ? 'active' : ''}" @click=${() => {
                this._edPermCompare = this._edPermCompare.includes(r) ? this._edPermCompare.filter(x => x !== r) : [...this._edPermCompare, r];
              }}>${r}</button>
            `)}
          </div>
        </div>
          ...
          <table style="width:100%;border-collapse:collapse;font-size:10px">
            <thead>
              <tr>
                ...
                ${this._edActions.map(a => html`<th style="padding:6px;color:#6b7280;border-bottom:1px solid #2a2d3a;text-align:center">${a}</th>`)}
              </tr>
            </thead>
            <tbody>
              ${this._edRoles.map(role => html`
                <tr style="border-bottom:1px solid #1a1d2e">
                  <td style="padding:6px;color:#e2e8f0;font-weight:600">${role}</td>
                  ${this._edActions.map(action => html`
                    <td style="text-align:center;padding:6px">
                      <button style="width:28px;height:20px;border-radius:3px;border:1px solid #2a2d3a;background:${this._edPermissions[role][action] ? '#22c55e' : '#1a1d2e'};cursor:pointer;color:#fff;font-size:10px" @click=${() => this._edTogglePermission(role, action)}>${this._edPermissions[role][action] ? 'Y' : 'N'}</button>
                    </td>
                  `)}
                </tr>
              `)}
        ...
        ${compareRoles.length >= 2 ? html`
          <div style="margin-top:10px;padding:8px;background:#1a1d2e;border-radius:6px">
            <div style="font-size:11px;font-weight:600;color:#e2e8f0;margin-bottom:6px">Role Diff: ${this._edPermCompare.join(' vs ')}</div>
            ${this._edActions.map(action => {
              ...
              return allSame ? nothing : html`
                <div style="display:flex;gap:8px;padding:3px 0;font-size:10px">
                  ...
                  ${compareRoles.map((r, i) => html`<span style="color:${r[action] ? '#22c55e' : '#ef4444'}">${this._edPermCompare[i]}=${r[action] ? 'Y' : 'N'}</span>`)}
                </div>
              `;
            })}
          </div>
        ` : nothing}
        ${this._edPermAudit.length > 0 ? html`
          <div style="margin-top:8px;font-size:9px;color:#6b7280">Recent: ${this._edPermAudit.slice(0,3).map(a => html`<span style="margin-right:8px">${a.role}.${a.action}: ${a.oldVal ? 'Y' : 'N'}->${a.newVal ? 'Y' : 'N'}</span>`)}
        ` : nothing}
      </div>
    `;
  }
  ...
  // === REPORTING SUITE ===
  @state() private _edReportTemplate: string = 'executive';
  @state() private _edReportSchedule: string = 'weekly';
  @state() private _edReportDistList: string[] = ['security-team@company.com','ciso@company.com'];
  @state() private _edReportHistory: {id:string;template:string;generatedAt:string;status:string}[] = [];

  private _edGenerateReport(): void {
    const id = 'rpt-' + Date.now();
    this._edReportHistory.unshift({id,template:this._edReportTemplate,generatedAt:new Date().toISOString(),status:'sent'});
  }

  private _edRenderReporting(): any {
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:8px">
          <div>
            ...
            ${templates.map(t => html`
              <div style="padding:6px;background:${this._edReportTemplate === t.key ? '#1e3a5f' : '#1a1d2e'};border:1px solid ${this._edReportTemplate === t.key ? '#3b82f6' : '#2a2d3a'};border-radius:4px;margin-bottom:4px;cursor:pointer" @click=${() => { this._edReportTemplate = t.key; }}>
          ...
          <div>
            ...
            <div style="display:flex;gap:4px;margin-bottom:8px">
              ${schedules.map(s => html`<button class="tab ${this._edReportSchedule === s.key ? 'active' : ''}" @click=${() => { this._edReportSchedule = s.key; }}>${s.label}</button>`)}
            </div>
            <div style="font-size:10px;color:#6b7280;margin-bottom:4px">Distribution</div>
            <div style="font-size:10px;color:#9ca3af">${this._edReportDistList.map(d => html`<div>${d}</div>`)}</div>
            <div style="margin-top:6px;display:flex;gap:4px">
              <button style="background:#3b82f6;border:none;border-radius:4px;padding:4px 10px;color:#fff;font-size:10px;cursor:pointer" @click=${this._edGenerateReport}>Generate</button>
        ...
        ${this._edReportHistory.length > 0 ? html`
          <div style="border-top:1px solid #2a2d3a;padding-top:8px">
            ...
            ${this._edReportHistory.slice(0,3).map(r => html`
  ...
  @state() private _edHighContrast: boolean = false;
  @state() private _edA11yAnnounce: string = '';
  @state() private _edShortcutsVisible: boolean = false;
  @state() private _edFocusTrap: boolean = false;

  private _edShortcuts: Record<string, string> = {
  ...
  private _edHandleKeydown(e: KeyboardEvent): void {
    if (e.key === 'Escape' && this._edFocusTrap) { this._edFocusTrap = false; this._edAnnounce('Dialog closed'); }
    if (e.ctrlKey && e.shiftKey && e.key === 'H') { e.preventDefault(); this._edHighContrast = !this._edHighContrast; this._edAnnounce('High contrast ' + (this._edHighContrast ? 'enabled' : 'disabled')); }
    if (e.ctrlKey && e.shiftKey && e.key === 'A') { e.preventDefault(); this._edShortcutsVisible = !this._edShortcutsVisible; }
  }

  private _edAnnounce(msg: string): void {
    this._edA11yAnnounce = msg;
    setTimeout(() => { this._edA11yAnnounce = ''; }, 2000);
  }

  private _edRenderAccessibility(): any {
    return html`
      <div role="region" aria-label="Accessibility Controls" style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <button class="tab ${this._edShortcutsVisible ? 'active' : ''}" @click=${() => { this._edShortcutsVisible = !this._edShortcutsVisible; }} aria-expanded=${this._edShortcutsVisible}>Shortcuts</button>
        </div>
        <div style="display:flex;gap:8px;margin-bottom:8px">
          <label style="display:flex;align-items:center;gap:6px;font-size:11px;color:#e2e8f0;cursor:pointer">
            <input type="checkbox" .checked=${this._edHighContrast} @change=${() => { this._edHighContrast = !this._edHighContrast; }} aria-label="Toggle high contrast mode">
            High Contrast
          </label>
        </div>
        ${this._edShortcutsVisible ? html`
          <div role="list" aria-label="Keyboard shortcuts" style="background:#1a1d2e;border-radius:6px;padding:8px">
            ${Object.entries(this._edShortcuts).map(([key, desc]) => html`
        ...
        ` : nothing}
        <div role="status" aria-live="polite" aria-atomic="true" style="position:absolute;left:-9999px">${this._edA11yAnnounce}</div>
      </div>
    `;
  }
  ...
  connectedCallback(): void {
    ...
    this._edInitScenarios();
    this._edInitTrendData();
    this._edInitPermissions();
    document.addEventListener('keydown', this._edHandleKeydown.bind(this));
  }

  disconnectedCallback(): void {
    super.disconnectedCallback();
    document.removeEventListener('keydown', this._edHandleKeydown.bind(this));
  }

  // === TAB INTEGRATION FOR EXTENDED FEATURES ===
  @state() private _edActiveSubTab: string = 'scenario';
  ...
  private _edGetAllSubTabs(): {key:string;label:string}[] {
    return [
  ...
  private _edRenderSubPanel(): any {
    switch (this._edActiveSubTab) {
      case 'scenario': return this._edRenderScenarioEngine();
      case 'timeseries': return this._edRenderTimeSeries();
      case 'rbac': return this._edRenderRBAC();
      case 'reporting': return this._edRenderReporting();
      case 'a11y': return this._edRenderAccessibility();
      default: return nothing;
    }
  }

  private _edRenderTabBar(): any {
    return html`
      <div style="display:flex;gap:4px;margin-bottom:12px;border-bottom:1px solid #2a2d3a;padding-bottom:8px;flex-wrap:wrap" role="tablist" aria-label="Extended panel features">
        ${this._edGetAllSubTabs().map(t => html`
          <button class="tab ${this._edActiveSubTab === t.key ? 'active' : ''}" @click=${() => { this._edActiveSubTab = t.key; }} role="tab" aria-selected=${this._edActiveSubTab === t.key}>${t.label}</button>
        `)}
      </div>
      <div role="tabpanel" aria-labelledby="ed-tab-${this._edActiveSubTab}">
        ${this._edRenderSubPanel()}
      </div>
    `;
  }
  ...
  @state() private _soarPlaybooks: Array<{
    ...
    {
      id: 'pb-soar-001', name: 'Exfil Detection Auto Response', status: 'active',
      steps: [
    ...
    {
      id: 'pb-soar-002', name: 'Exfil Detection Investigation Workflow', status: 'active',
      steps: [
    ...
    {
      id: 'pb-soar-003', name: 'Exfil Detection Compliance Scan', status: 'draft',
      steps: [
  ...
  @state() private _edAle: number = 0;
  @state() private _edSroi: number = 0;
  @state() private _edCpi: number = 0;
  @state() private _edBudgetAlloc: number = 0;
  @state() private _edCostBenefit: number = 0;

  // Security Economics Calculator
  private edInitEconomics() {
    this._edAle = Math.round(2850000 + Math.random() * 4500000);
    this._edSroi = Math.round(180 + Math.random() * 320);
    this._edCpi = Math.round(45000 + Math.random() * 120000);
    this._edBudgetAlloc = Math.round(2500000 + Math.random() * 3000000);
    this._edCostBenefit = Math.round(220 + Math.random() * 180);
  }

  private _edCalcAle(): { annual: number; perIncident: number; byCategory: Array<{name: string; value: number}> } {
    const base = this._edAle;
    const categories = [
  ...
  private _edCalcSroi(): Array<{year: number; investment: number; savings: number; roi: number}> {
    const baseInv = this._edSroi * 10000;
  ...
  private _edGetBudgetAlloc(): Array<{category: string; amount: number; pct: number; trend: string}> {
    const total = this._edBudgetAlloc;
    const items = [
  ...
  private _edGetCostBenefit(): Array<{control: string; cost: number; benefit: number; ratio: number; priority: string}> {
    const base = this._edCostBenefit;
    const controls = [
  ...
  private _edRenderEconomics() {
    const ale = this._edCalcAle();
    const roi = this._edCalcSroi();
    const budget = this._edGetBudgetAlloc();
    const cb = this._edGetCostBenefit();
    const cpi = this._edCpi;
  ...
  @state() private _edThreatLevel: any = null;
  @state() private _edEmergingThreats: any = null;
  @state() private _edThreatTrends: any = null;
  @state() private _edSectorRadar: any = null;
  @state() private _edActorActivity: any = null;

  // Threat Landscape Intelligence
  private edInitThreatIntel() {
    this._edThreatLevel = {
  ...
  private _edRenderThreatIntel() {
    const tl = this._edThreatLevel;
    const et = this._edEmergingThreats;
    const sr = this._edSectorRadar;
    const aa = this._edActorActivity;
  ...
  @state() private _edPolicies: any = null;
  @state() private _edExceptions: any = null;
  @state() private _edRiskRegister: any = null;
  @state() private _edMeetings: any = null;
  @state() private _edDeadlines: any = null;

  // Security Governance Dashboard
  private edInitGovernance() {
    this._edPolicies = [
  ...
  private _edRenderGovernance() {
    const policies = this._edPolicies;
    const risks = this._edRiskRegister;
    const deadlines = this._edDeadlines;
  ...
  @state() private _edCriticalAssets: any = null;
  @state() private _edAssetDeps: any = null;
  @state() private _edEolAssets: any = null;
  @state() private _edAssetRisk: any = null;

  // Asset Intelligence
  private edInitAssetIntel() {
    this._edCriticalAssets = [
    ...
    this._edAssetRisk = { critical: 7, high: 23, medium: 45, low: 128, total: 203 };
  }

  private _edRenderAssetIntel() {
    const assets = this._edCriticalAssets;
    const eol = this._edEolAssets;
    const ar = this._edAssetRisk;
  ...
  @state() private _edUserBaseline: any = null;
  @state() private _edAnomalyRules: any = null;
  @state() private _edDataAccess: any = null;
  @state() private _edInsiderRisk: any = null;
  @state() private _exfildr15Timeline: Array<{id:string;time:string;event:string;severity:string;actor:string}> = [
  ...
  @state() private _exfildr15RootCauses: Array<{why:string;answer:string}> = [
  ...
  @state() private _exfildr15ImpactMatrix: Array<{system:string;users:number;data:string;revenue:string;status:string}> = [
  ...
  @state() private _exfildr15Actions: Array<{id:string;item:string;owner:string;deadline:string;priority:string;status:string}> = [
  ...
  @state() private _exfildr15Lessons: Array<{id:string;lesson:string;category:string;severity:string;applies_to:string}> = [
  ...
  @state() private _exfildr15ActiveTab: string = 'timeline';
  @state() private _exfildr15Benchmarks: Array<{metric:string;current:number;industry:number;target:number;unit:string;source:string}> = [
  ...
  @state() private _exfildr15MaturityLevels: Array<{domain:string;current:number;target:number;description:string}> = [
  ...
  @state() private _exfildr15QuarterlyData: Array<{quarter:string;score:number;improvement:number}> = [
  ...
  @state() private _exfildr15SelectedDomain: string = 'all';
  @state() private _exfildr15Alerts: Array<{id:string;name:string;severity:number;confidence:number;assetCrit:number;score:number;enriched:boolean;group:string;status:string;enrichData:Array<{key:string;value:string}>}> = [
  ...
  @state() private _exfildr15QualityMetrics: {fpRate:number;enrichSuccess:number;avgTriageTime:number;enrichedCount:number;totalCount:number} = {fpRate:0.12, enrichSuccess:0.78, avgTriageTime:4.5, enrichedCount:3, totalCount:5};
  @state() private _exfildr15RoutingRules: Array<{name:string;condition:string;channel:string;active:boolean}> = [
  ...
  @state() private _exfildr15Shapes: Array<{id:string;type:string;label:string;controls:string[]}> = [
  ...
  @state() private _exfildr15TrustBoundaries: Array<{from:string;to:string;label:string;strength:string}> = [
  ...
  @state() private _exfildr15ADRs: Array<{id:string;title:string;status:string;date:string;decision:string}> = [
  ...
  @state() private _exfildr15SelectedShape: string = '';
  @state() private _exfildr15Gauges: Array<{name:string;value:number;max:number;unit:string;status:string;color:string}> = [
  ...
  @state() private _exfildr15Anomalies: Array<{id:string;time:string;description:string;severity:string;acknowledged:boolean}> = [
  ...
  @state() private _exfildr15Integrations: Array<{name:string;status:string;uptime:number;lastCheck:string;latency:number}> = [
  ...
  @state() private _exfildr15AlertFatigue: Array<{analyst:string;alertsPerDay:number;escalated:number;dismissed:number;avgResponseMin:number}> = [
  ...
  @state() private _exfildr15SlaTarget: number = 99.9;

  // Insider Threat Detection
  private edInitInsiderThreat() {
    this._edUserBaseline = [
    ...
    this._edInsiderRisk = { totalUsers: 2847, monitored: 342, flagged: 18, investigated: 5, confirmed: 1 };
  }

  private _edRenderInsiderThreat() {
    const baseline = this._edUserBaseline;
    const rules = this._edAnomalyRules;
    const ir = this._edInsiderRisk;
    ...
    return html`<div class="card" style="padding:14px;margin-bottom:8px">
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px;margin-bottom:10px;flex-wrap:wrap">
            ${['timeline','rootcause','impact','actions','lessons'].map(t => html`
              <button class="btn ${this._exfildr15ActiveTab === t ? 'btn-primary' : ''}" style="font-size:10px;padding:3px 8px" @click=${() => { this._exfildr15ActiveTab = t; }}>${t.charAt(0).toUpperCase() + t.slice(1)}</button>
            `)}
          </div>
          ${this._exfildr15ActiveTab === 'timeline' ? html`
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._exfildr15Timeline.map(e => html`
          ...
          ` : this._exfildr15ActiveTab === 'rootcause' ? html`
            <div style="margin-bottom:8px">${{__html: this._exfildr15RenderFishbone()}}</div>
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._exfildr15RootCauses.map((rc, i) => html`
          ...
          ` : this._exfildr15ActiveTab === 'impact' ? html`
            <div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:10px">
              ...
              <tbody>${this._exfildr15ImpactMatrix.map(imp => html`
          ...
          ` : this._exfildr15ActiveTab === 'actions' ? html`
            <div style="display:flex;gap:12px;margin-bottom:8px;font-size:10px;color:#888">
              ${Object.entries(this._exfildr15GetActionStats()).map(([k,v]) => html`<span>${k}: <b style="color:#ddd">${v}</b></span>`)}
            </div>
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._exfildr15Actions.map(a => html`
                <div style="display:flex;gap:8px;align-items:center;padding:6px;background:#1a1d27;border-radius:4px;cursor:pointer" @click=${() => this._exfildr15ToggleAction(a.id)}>
          ...
          ` : html`
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._exfildr15Lessons.map(l => html`
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px;margin-bottom:10px;flex-wrap:wrap">
            ${['all', ...this._exfildr15MaturityLevels.map(m => m.domain)].map(d => html`
              <button class="btn ${this._exfildr15SelectedDomain === d ? 'btn-primary' : ''}" style="font-size:9px;padding:2px 6px" @click=${() => { this._exfildr15SelectedDomain = d; }}>${d}</button>
            `)}
          </div>
          <div style="display:flex;gap:16px;margin-bottom:10px">
            <div style="text-align:center"><div style="color:#e0e0e0;font-size:20px;font-weight:bold">${this._exfildr15GetOverallMaturity()}/5</div><div style="color:#888;font-size:10px">Maturity Level</div></div>
            <div style="text-align:center"><div style="color:#4f4;font-size:20px;font-weight:bold">${this._exfildr15GetGapAnalysis().filter(g => g.isAbove).length}/${this._exfildr15Benchmarks.length}</div><div style="color:#888;font-size:10px">Above Industry</div></div>
          </div>
          <div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:10px">
            ...
            <tbody>${this._exfildr15GetGapAnalysis().map(b => html`
          ...
          <div style="margin-top:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Maturity by Domain</div>
            ${this._exfildr15MaturityLevels.filter(m => this._exfildr15SelectedDomain === 'all' || m.domain === this._exfildr15SelectedDomain).map(m => html`
          ...
          <div style="margin-top:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Quarterly Trend</div>
            <div style="display:flex;height:40px;align-items:flex-end;gap:4px">
              ${this._exfildr15QuarterlyData.map(q => html`<div style="flex:1;text-align:center"><div style="background:#4a9eff;height:${q.score * 0.5}px;border-radius:2px 2px 0 0" title="${q.score}"></div><div style="color:#666;font-size:8px;margin-top:2px">${q.quarter}</div></div>`)}
            </div>
          </div>
        </div>
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:12px;margin-bottom:8px;font-size:10px">
            <div style="display:flex;gap:4px;flex-wrap:wrap">${this._exfildr15GroupAlerts().map(g => html`<span style="color:#888;padding:2px 6px;background:#1a1d27;border-radius:3px">${g.group}: ${g.count}</span>`)}</div>
          </div>
          <div style="display:flex;gap:8px;margin-bottom:8px;font-size:10px;color:#888">
            <span>FP Rate: <b style="color:${this._exfildr15QualityMetrics.fpRate > 0.15 ? '#f44' : '#4f4'}">${(this._exfildr15QualityMetrics.fpRate * 100).toFixed(1)}%</b></span>
            <span>Enrich: <b style="color:#4a9eff">${(this._exfildr15QualityMetrics.enrichSuccess * 100).toFixed(0)}%</b></span>
            <span>Avg Triage: <b style="color:#ddd">${this._exfildr15QualityMetrics.avgTriageTime}m</b></span>
          </div>
          <div style="display:flex;flex-direction:column;gap:4px;max-height:200px;overflow-y:auto">
            ${this._exfildr15Alerts.sort((a, b) => this._exfildr15CalcScore(b) - this._exfildr15CalcScore(a)).map(a => {
              const score = this._exfildr15CalcScore(a);
              return html`
                <div style="padding:6px;background:#1a1d27;border-radius:4px;border-left:3px solid ${a.severity >= 4 ? '#f44' : a.severity >= 3 ? '#fa0' : '#4a9eff'}">
                  <div style="display:flex;justify-content:space-between;align-items:center">
                    ...
                    <button class="btn" style="font-size:9px;padding:1px 6px;margin-left:4px" @click=${() => this._exfildr15EnrichAlert(a.id)}>${a.enriched ? 'Re-enrich' : 'Enrich'}</button>
                  </div>
          ...
          <div style="margin-top:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Routing Rules</div>
            ${this._exfildr15RoutingRules.map(r => html`
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:8px;margin-bottom:8px;flex-wrap:wrap">
            ${this._exfildr15Shapes.map(s => {
              const v = this._exfildr15ValidateControl(s.id);
              return html`<div style="padding:4px 8px;background:#1a1d27;border-radius:3px;cursor:pointer;border:1px solid ${this._exfildr15SelectedShape === s.id ? '#4a9eff' : '#2a2d37'}" @click=${() => { this._exfildr15SelectedShape = this._exfildr15SelectedShape === s.id ? '' : s.id; }}>
          ...
          ${this._exfildr15SelectedShape ? html`
            ${(() => {
              const shape = this._exfildr15Shapes.find(s => s.id === this._exfildr15SelectedShape);
              const v = this._exfildr15ValidateControl(this._exfildr15SelectedShape);
              return shape ? html`
          ...
          <div style="margin-bottom:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Trust Boundaries</div>
            ${this._exfildr15TrustBoundaries.map(tb => html`
              <div style="display:flex;gap:6px;align-items:center;padding:3px;background:#1a1d27;border-radius:3px;margin-bottom:2px;font-size:9px">
                <span style="color:#ddd">${this._exfildr15Shapes.find(s => s.id === tb.from)?.label || tb.from}</span>
                <span style="color:#4a9eff">\u2194</span>
                <span style="color:#ddd">${this._exfildr15Shapes.find(s => s.id === tb.to)?.label || tb.to}</span>
          ...
          <div><div style="color:#888;font-size:10px;margin-bottom:4px">Architecture Decision Records</div>
            ${this._exfildr15ADRs.map(adr => html`
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:8px;margin-bottom:8px;flex-wrap:wrap">
            ${this._exfildr15Gauges.map(g => html`
          ...
          <div style="display:flex;gap:8px;margin-bottom:8px;align-items:center">
            ...
            <span style="color:${this._exfildr15GetOverallHealth().score >= 99 ? '#4f4' : '#fa0'};font-size:12px;font-weight:bold">${this._exfildr15GetOverallHealth().score}%</span>
            <span style="color:#888;font-size:10px">(Target: ${this._exfildr15SlaTarget}%)</span>
            <span style="color:#4f4;font-size:10px">${this._exfildr15GetOverallHealth().healthy} healthy</span>
            <span style="color:#fa0;font-size:10px">${this._exfildr15GetOverallHealth().degraded} degraded</span>
          </div>
          <div style="margin-bottom:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Anomaly Stream</div>
            ${this._exfildr15Anomalies.slice(0, 3).map(a => html`
              <div style="display:flex;gap:6px;align-items:center;padding:4px;background:#1a1d27;border-radius:3px;margin-bottom:2px;opacity:${a.acknowledged ? 0.5 : 1}">
                ...
                ${!a.acknowledged ? html`<button class="btn" style="font-size:8px;padding:1px 4px" @click=${() => this._exfildr15AckAnomaly(a.id)}>ACK</button>` : html`<span style="color:#4f4;font-size:9px">ACK'd</span>`}
              </div>
            `)}
          </div>
          <div style="margin-bottom:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Integration Health</div>
            ${this._exfildr15Integrations.map(i => html`
              <div style="display:flex;gap:6px;align-items:center;padding:3px;background:#1a1d27;border-radius:3px;margin-bottom:2px;font-size:9px">
          ...
          <div><div style="color:#888;font-size:10px;margin-bottom:4px">Alert Fatigue Analysis</div>
            <div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:9px">
              ...
              <tbody>${this._exfildr15AlertFatigue.map(af => html`
  ...
  private _exfildr15RenderFishbone(): string {
  ...
  private _exfildr15ToggleAction(id: string) {
    this._exfildr15Actions = this._exfildr15Actions.map(a => a.id === id ? {...a, status: a.status === 'pending' ? 'in_progress' : a.status === 'in_progress' ? 'completed' : 'pending'} : a);
  }

  private _exfildr15GetActionStats() {
    const total = this._exfildr15Actions.length;
    const done = this._exfildr15Actions.filter(a => a.status === 'completed').length;
    const inProg = this._exfildr15Actions.filter(a => a.status === 'in_progress').length;
    return { total, done, inProg, pending: total - done - inProg };
  }

  private _exfildr15GetOverallMaturity(): number {
    if (this._exfildr15SelectedDomain === 'all') {
      return Math.round(this._exfildr15MaturityLevels.reduce((s, m) => s + m.current, 0) / this._exfildr15MaturityLevels.length * 10) / 10;
    }
    const d = this._exfildr15MaturityLevels.find(m => m.domain === this._exfildr15SelectedDomain);
    return d ? d.current : 0;
  }

  private _exfildr15GetGapAnalysis() {
    return this._exfildr15Benchmarks.map(b => {
  ...
  private _exfildr15CalcScore(alert: any): number {
    return Math.round(alert.severity * alert.confidence * alert.assetCrit * 100) / 100;
  }

  private _exfildr15EnrichAlert(id: string) {
    this._exfildr15Alerts = this._exfildr15Alerts.map(a => {
      if (a.id !== id) return a;
      const score = this._exfildr15CalcScore(a);
  ...
  private _exfildr15GroupAlerts() {
    const groups: Record<string, number> = {};
    this._exfildr15Alerts.forEach(a => { groups[a.group] = (groups[a.group] || 0) + 1; });
    return Object.entries(groups).map(([g, c]) => ({group: g, count: c}));
  }

  private _exfildr15ValidateControl(shapeId: string): {valid:boolean;missing:string[]} {
    const shape = this._exfildr15Shapes.find(s => s.id === shapeId);
  ...
  private _exfildr15GetOverallHealth(): {healthy:number;degraded:number;down:number;score:number} {
    const online = this._exfildr15Integrations.filter(i => i.status === 'online').length;
    const degraded = this._exfildr15Integrations.filter(i => i.status === 'degraded').length;
    const total = this._exfildr15Integrations.length;
    return { healthy: online, degraded, down: total - online - degraded, score: Math.round(online / total * 100) };
  }

  private _exfildr15AckAnomaly(id: string) {
    this._exfildr15Anomalies = this._exfildr15Anomalies.map(a => a.id === id ? {...a, acknowledged: true} : a);
  }
...
// ===== DATA SOVEREIGNTY COMPLIANCE (R22) =====
  ...
  private _renderBudgetPlanning() {
    const budgetData = [
      { category: "Personnel & Training", planned: 1144000, actual: 1808000, utilization: 158.0, q1: "18%", q2: "23%", q3: "21%", q4: "13%" },
      { category: "Tooling & Licensing", planned: 1151000, actual: 1821000, utilization: 158.2, q1: "21%", q2: "28%", q3: "32%", q4: "14%" },
      { category: "Infrastructure Security", planned: 1158000, actual: 1834000, utilization: 158.4, q1: "24%", q2: "33%", q3: "27%", q4: "15%" },
      { category: "Compliance & Audit", planned: 1165000, actual: 1847000, utilization: 158.5, q1: "27%", q2: "22%", q3: "22%", q4: "16%" },
      { category: "Incident Response", planned: 1172000, actual: 1860000, utilization: 158.7, q1: "30%", q2: "27%", q3: "33%", q4: "17%" },
      { category: "Third-Party Assessments", planned: 1179000, actual: 1873000, utilization: 158.9, q1: "17%", q2: "32%", q3: "28%", q4: "18%" },
      { category: "Security Awareness", planned: 1186000, actual: 1886000, utilization: 159.0, q1: "20%", q2: "21%", q3: "23%", q4: "19%" },
      { category: "Research & Innovation", planned: 1193000, actual: 1899000, utilization: 159.2, q1: "23%", q2: "26%", q3: "18%", q4: "20%" },
    ];
    ...
    const headcount = [
      { team: "SOC Tier 1", current: 13, target: 22, gap: 1, avgSalary: "125k" },
      { team: "SOC Tier 2", current: 5, target: 21, gap: 0, avgSalary: "154k" },
      { team: "Threat Intel", current: 14, target: 20, gap: 5, avgSalary: "183k" },
      { team: "Red Team", current: 6, target: 19, gap: 4, avgSalary: "101k" },
      { team: "GRC", current: 15, target: 18, gap: 3, avgSalary: "130k" },
      { team: "AppSec", current: 7, target: 17, gap: 2, avgSalary: "159k" },
      { team: "Cloud Sec", current: 16, target: 16, gap: 1, avgSalary: "188k" },
      { team: "Identity & Access", current: 8, target: 15, gap: 0, avgSalary: "106k" },
    ];
    const vendorSpend = [
      { vendor: "CrowdStrike", annual: "785k", contractEnd: "2026-08", renewalRisk: "Low", satisfaction: 4 },
      { vendor: "Palo Alto", annual: "65k", contractEnd: "2026-09", renewalRisk: "Medium", satisfaction: 3 },
      { vendor: "Splunk", annual: "96k", contractEnd: "2026-10", renewalRisk: "High", satisfaction: 5 },
      { vendor: "Qualys", annual: "127k", contractEnd: "2026-11", renewalRisk: "Low", satisfaction: 4 },
      { vendor: "Rapid7", annual: "158k", contractEnd: "2026-12", renewalRisk: "Medium", satisfaction: 3 },
      { vendor: "Mandiant", annual: "189k", contractEnd: "2026-01", renewalRisk: "High", satisfaction: 5 },
      { vendor: "Zscaler", annual: "220k", contractEnd: "2026-02", renewalRisk: "Low", satisfaction: 4 },
      { vendor: "Duo Security", annual: "251k", contractEnd: "2026-03", renewalRisk: "Medium", satisfaction: 3 },
    ];
    const roiProjections = [
      { area: "Threat Detection", investment: "245k", projectedReturn: "1589k", roiMultiple: "4.0x", confidence: 79 },
      { area: "Incident Reduction", investment: "288k", projectedReturn: "1636k", roiMultiple: "3.9x", confidence: 60 },
      { area: "Compliance Savings", investment: "331k", projectedReturn: "1683k", roiMultiple: "3.8x", confidence: 77 },
      { area: "Automation Gains", investment: "374k", projectedReturn: "1730k", roiMultiple: "3.7x", confidence: 94 },
      { area: "Risk Avoidance", investment: "417k", projectedReturn: "1777k", roiMultiple: "3.6x", confidence: 75 },
    ];
    return html`
  ...
  private _renderMetricsNormalization() {
    const kpiCatalog = [
      { id: "kpi-1", name: "MTTD", owner: "SOC", unit: "minutes", target: 98, current: 81, benchmark: 89, collection: "auto", frequency: "realtime" },
      { id: "kpi-2", name: "MTTR", owner: "GRC", unit: "%", target: 71, current: 88, benchmark: 66, collection: "semi-auto", frequency: "daily" },
      { id: "kpi-3", name: "MTTC", owner: "AppSec", unit: "score", target: 74, current: 95, benchmark: 77, collection: "manual", frequency: "weekly" },
      { id: "kpi-4", name: "Vuln SLA Compliance", owner: "Cloud Sec", unit: "count", target: 77, current: 56, benchmark: 88, collection: "auto", frequency: "monthly" },
      { id: "kpi-5", name: "Patch Coverage", owner: "Identity", unit: "days", target: 80, current: 63, benchmark: 65, collection: "semi-auto", frequency: "realtime" },
      { id: "kpi-6", name: "Phishing Click Rate", owner: "Threat Intel", unit: "minutes", target: 83, current: 70, benchmark: 76, collection: "manual", frequency: "daily" },
      { id: "kpi-7", name: "Training Completion", owner: "Security Ops", unit: "%", target: 86, current: 77, benchmark: 87, collection: "auto", frequency: "weekly" },
      { id: "kpi-8", name: "Escalation Rate", owner: "Risk Mgmt", unit: "score", target: 89, current: 84, benchmark: 98, collection: "semi-auto", frequency: "monthly" },
      { id: "kpi-9", name: "False Positive Rate", owner: "SOC", unit: "count", target: 92, current: 91, benchmark: 75, collection: "manual", frequency: "realtime" },
      { id: "kpi-10", name: "Threat Intel Actionability", owner: "GRC", unit: "days", target: 95, current: 98, benchmark: 86, collection: "auto", frequency: "daily" },
      { id: "kpi-11", name: "Endpoint Compliance", owner: "AppSec", unit: "minutes", target: 98, current: 59, benchmark: 97, collection: "semi-auto", frequency: "weekly" },
      { id: "kpi-12", name: "Cloud Misconfig Score", owner: "Cloud Sec", unit: "%", target: 71, current: 66, benchmark: 74, collection: "manual", frequency: "monthly" },
      { id: "kpi-13", name: "Identity Anomaly Rate", owner: "Identity", unit: "score", target: 74, current: 73, benchmark: 85, collection: "auto", frequency: "realtime" },
      { id: "kpi-14", name: "DLP Events", owner: "Threat Intel", unit: "count", target: 77, current: 80, benchmark: 96, collection: "semi-auto", frequency: "daily" },
      { id: "kpi-15", name: "Vendor Risk Avg", owner: "Security Ops", unit: "days", target: 80, current: 87, benchmark: 73, collection: "manual", frequency: "weekly" },
      { id: "kpi-16", name: "Compliance Audit Pass Rate", owner: "Risk Mgmt", unit: "minutes", target: 83, current: 94, benchmark: 84, collection: "auto", frequency: "monthly" },
      { id: "kpi-17", name: "Awareness Score", owner: "SOC", unit: "%", target: 86, current: 55, benchmark: 95, collection: "semi-auto", frequency: "realtime" },
      { id: "kpi-18", name: "SOC Utilization", owner: "GRC", unit: "score", target: 89, current: 62, benchmark: 72, collection: "manual", frequency: "daily" },
      { id: "kpi-19", name: "Automation Coverage", owner: "AppSec", unit: "count", target: 92, current: 69, benchmark: 83, collection: "auto", frequency: "weekly" },
      { id: "kpi-20", name: "Risk Register Currency", owner: "Cloud Sec", unit: "days", target: 95, current: 76, benchmark: 94, collection: "semi-auto", frequency: "monthly" },
    ];
    const benchmarkSources = [
      { source: "NIST CSF", mappedKPIs: 7, alignment: 70, lastReview: "2026-05-23", status: "aligned" },
      { source: "CIS Controls v8", mappedKPIs: 8, alignment: 87, lastReview: "2026-06-18", status: "partial" },
      { source: "ISO 27001:2022", mappedKPIs: 3, alignment: 65, lastReview: "2026-01-13", status: "reviewing" },
      { source: "PCI DSS 4.0", mappedKPIs: 4, alignment: 82, lastReview: "2026-02-08", status: "aligned" },
      { source: "SOC 2 Type II", mappedKPIs: 5, alignment: 60, lastReview: "2026-03-03", status: "partial" },
      { source: "MITRE ATT&CK", mappedKPIs: 6, alignment: 77, lastReview: "2026-04-26", status: "reviewing" },
      { source: "SANS Top 20", mappedKPIs: 7, alignment: 94, lastReview: "2026-05-21", status: "aligned" },
      { source: "OWASP Top 10", mappedKPIs: 8, alignment: 72, lastReview: "2026-06-16", status: "partial" },
    ];
    const normalizationRules = [
      { rule: "Time metrics normalized to minutes", appliesTo: 6, exceptions: 1, version: "v2.8" },
      { rule: "Percentage metrics capped at 100", appliesTo: 5, exceptions: 2, version: "v2.5" },
      { rule: "Count metrics use 7-day rolling avg", appliesTo: 4, exceptions: 0, version: "v2.2" },
      { rule: "Score metrics use 0-100 scale", appliesTo: 3, exceptions: 1, version: "v2.9" },
      { rule: "Rate metrics per 1000 events", appliesTo: 7, exceptions: 2, version: "v2.6" },
    ];
    return html`
  ...
  private _renderThreatHuntingCampaigns() {
    const campaigns = [
      { id: "HC-1001", name: "Lateral Movement Sweep", status: "active", hypothesis: "H1: Actors using pass-the-hash for lateral movement", leadHunter: "Alice Chen", findings: 2, startDate: "2026-03-15", endDate: null, effectiveness: 96 },
      { id: "HC-1002", name: "Credential Harvesting Hunt", status: "completed", hypothesis: "H2: Actors using web shells for persistence", leadHunter: "Bob Martinez", findings: 5, startDate: "2026-02-26", endDate: "2026-04-04", effectiveness: 56 },
      { id: "HC-1003", name: "Persistence Mechanism Audit", status: "planned", hypothesis: "H3: Actors using scheduled tasks for data theft", leadHunter: "Carol Wu", findings: 8, startDate: "2026-01-09", endDate: null, effectiveness: 75 },
      { id: "HC-1004", name: "C2 Beacon Detection", status: "in-review", hypothesis: "H4: Actors using DNS tunneling for C2 communication", leadHunter: "Dave Kim", findings: 11, startDate: "2026-04-20", endDate: null, effectiveness: 94 },
      { id: "HC-1005", name: "Data Exfiltration Patterns", status: "active", hypothesis: "H5: Actors using encrypted channels for privilege escalation", leadHunter: "Eve Johnson", findings: 14, startDate: "2026-03-03", endDate: null, effectiveness: 54 },
      { id: "HC-1006", name: "Privilege Escalation Scan", status: "completed", hypothesis: "H6: Actors using token impersonation for defense evasion", leadHunter: "Frank Liu", findings: 17, startDate: "2026-02-14", endDate: "2026-05-16", effectiveness: 73 },
      { id: "HC-1007", name: "Supply Chain Implant Hunt", status: "planned", hypothesis: "H7: Actors using poisoned images for initial access", leadHunter: "Grace Park", findings: 20, startDate: "2026-01-25", endDate: null, effectiveness: 92 },
      { id: "HC-1008", name: "Insider Threat Indicators", status: "in-review", hypothesis: "H8: Actors using legitimate tools for credential access", leadHunter: "Hector Silva", findings: 23, startDate: "2026-04-08", endDate: null, effectiveness: 52 },
      { id: "HC-1009", name: "Cloud Metadata Analysis", status: "active", hypothesis: "H9: Actors using API keys for command execution", leadHunter: "Alice Chen", findings: 26, startDate: "2026-03-19", endDate: null, effectiveness: 71 },
      { id: "HC-1010", name: "DNS Tunnel Detection", status: "completed", hypothesis: "H10: Actors using encoded subdomains for exfiltration", leadHunter: "Bob Martinez", findings: 29, startDate: "2026-02-02", endDate: "2026-06-28", effectiveness: 90 },
      { id: "HC-1011", name: "Fileless Malware Search", status: "planned", hypothesis: "H11: Actors using WMI providers for discovery", leadHunter: "Carol Wu", findings: 32, startDate: "2026-01-13", endDate: null, effectiveness: 50 },
      { id: "HC-1012", name: "Zero-Day Exploit Traces", status: "in-review", hypothesis: "H12: Actors using exploit kits for collection", leadHunter: "Dave Kim", findings: 35, startDate: "2026-04-24", endDate: null, effectiveness: 69 },
    ];
    const hunterLeaderboard = [
      { hunter: "Alice Chen", campaigns: 12, findings: 35, highSeverity: 22, avgScore: 77, streak: 3 },
      { hunter: "Bob Martinez", campaigns: 9, findings: 64, highSeverity: 1, avgScore: 70, streak: 4 },
      { hunter: "Carol Wu", campaigns: 6, findings: 93, highSeverity: 6, avgScore: 63, streak: 5 },
      { hunter: "Dave Kim", campaigns: 3, findings: 6, highSeverity: 11, avgScore: 56, streak: 6 },
      { hunter: "Eve Johnson", campaigns: 13, findings: 35, highSeverity: 16, avgScore: 93, streak: 7 },
      { hunter: "Frank Liu", campaigns: 10, findings: 64, highSeverity: 21, avgScore: 86, streak: 8 },
      { hunter: "Grace Park", campaigns: 7, findings: 93, highSeverity: 0, avgScore: 79, streak: 1 },
      { hunter: "Hector Silva", campaigns: 4, findings: 6, highSeverity: 5, avgScore: 72, streak: 2 },
    ];
    const mitreMapping = [
      { tactic: "Initial Access", techniques: 2, campaigns: 3, coverage: 69 },
      { tactic: "Execution", techniques: 12, campaigns: 2, coverage: 49 },
      { tactic: "Persistence", techniques: 11, campaigns: 1, coverage: 100 },
      { tactic: "Privilege Escalation", techniques: 10, campaigns: 6, coverage: 80 },
      { tactic: "Defense Evasion", techniques: 9, campaigns: 5, coverage: 60 },
      { tactic: "Credential Access", techniques: 8, campaigns: 4, coverage: 40 },
      { tactic: "Discovery", techniques: 7, campaigns: 3, coverage: 91 },
      { tactic: "Lateral Movement", techniques: 6, campaigns: 2, coverage: 71 },
      { tactic: "Collection", techniques: 5, campaigns: 1, coverage: 51 },
      { tactic: "Exfiltration", techniques: 4, campaigns: 6, coverage: 31 },
      { tactic: "Command & Control", techniques: 3, campaigns: 5, coverage: 82 },
      { tactic: "Impact", techniques: 2, campaigns: 4, coverage: 62 },
    ];
    return html`
  ...
  private _renderControlInventory() {
    const controls = [
      { id: "CTL-2001", name: "MFA Enforcement", domain: "Access Control", status: "implemented", effectiveness: 93, lastTest: "2026-03-07", nextReview: "2026-07-07", owner: "SOC", risk: "Low" },
      { id: "CTL-2002", name: "Network Segmentation", domain: "Network Security", status: "partial", effectiveness: 25, lastTest: "2026-02-20", nextReview: "2026-08-26", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2003", name: "EDR Deployment", domain: "Endpoint Protection", status: "planned", effectiveness: 32, lastTest: "2026-01-05", nextReview: "2026-09-17", owner: "IT Ops", risk: "High" },
      { id: "CTL-2004", name: "DLP Policy", domain: "Data Protection", status: "gap", effectiveness: 39, lastTest: "2026-04-18", nextReview: "2026-10-08", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2005", name: "SSO Integration", domain: "Identity Management", status: "implemented", effectiveness: 46, lastTest: "2026-03-03", nextReview: "2026-11-27", owner: "IAM", risk: "Low" },
      { id: "CTL-2006", name: "SAST Pipeline", domain: "Application Security", status: "partial", effectiveness: 2, lastTest: "2026-02-16", nextReview: "2026-12-18", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2007", name: "CSPM Scanning", domain: "Cloud Security", status: "planned", effectiveness: 9, lastTest: "2026-01-01", nextReview: "2026-05-09", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2008", name: "Badge Access", domain: "Physical Security", status: "gap", effectiveness: 16, lastTest: "2026-04-14", nextReview: "2026-06-28", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2009", name: "Least Privilege", domain: "Access Control", status: "implemented", effectiveness: 58, lastTest: "2026-03-27", nextReview: "2026-07-19", owner: "SOC", risk: "Low" },
      { id: "CTL-2010", name: "Firewall Rules", domain: "Network Security", status: "partial", effectiveness: 30, lastTest: "2026-02-12", nextReview: "2026-08-10", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2011", name: "Disk Encryption", domain: "Endpoint Protection", status: "planned", effectiveness: 37, lastTest: "2026-01-25", nextReview: "2026-09-01", owner: "IT Ops", risk: "High" },
      { id: "CTL-2012", name: "Data Classification", domain: "Data Protection", status: "gap", effectiveness: 44, lastTest: "2026-04-10", nextReview: "2026-10-20", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2013", name: "PAM Implementation", domain: "Identity Management", status: "implemented", effectiveness: 70, lastTest: "2026-03-23", nextReview: "2026-11-11", owner: "IAM", risk: "Low" },
      { id: "CTL-2014", name: "DAST Pipeline", domain: "Application Security", status: "partial", effectiveness: 7, lastTest: "2026-02-08", nextReview: "2026-12-02", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2015", name: "IAM Policy Review", domain: "Cloud Security", status: "planned", effectiveness: 14, lastTest: "2026-01-21", nextReview: "2026-05-21", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2016", name: "Visitor Management", domain: "Physical Security", status: "gap", effectiveness: 21, lastTest: "2026-04-06", nextReview: "2026-06-12", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2017", name: "Access Reviews", domain: "Access Control", status: "implemented", effectiveness: 82, lastTest: "2026-03-19", nextReview: "2026-07-03", owner: "SOC", risk: "Low" },
      { id: "CTL-2018", name: "IDS/IPS Tuning", domain: "Network Security", status: "partial", effectiveness: 35, lastTest: "2026-02-04", nextReview: "2026-08-22", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2019", name: "Patch Management", domain: "Endpoint Protection", status: "planned", effectiveness: 42, lastTest: "2026-01-17", nextReview: "2026-09-13", owner: "IT Ops", risk: "High" },
      { id: "CTL-2020", name: "Backup Encryption", domain: "Data Protection", status: "gap", effectiveness: 49, lastTest: "2026-04-02", nextReview: "2026-10-04", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2021", name: "Password Policy", domain: "Identity Management", status: "implemented", effectiveness: 94, lastTest: "2026-03-15", nextReview: "2026-11-23", owner: "IAM", risk: "Low" },
      { id: "CTL-2022", name: "Container Scanning", domain: "Application Security", status: "partial", effectiveness: 12, lastTest: "2026-02-28", nextReview: "2026-12-14", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2023", name: "WAF Configuration", domain: "Cloud Security", status: "planned", effectiveness: 19, lastTest: "2026-01-13", nextReview: "2026-05-05", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2024", name: "CCTV Coverage", domain: "Physical Security", status: "gap", effectiveness: 26, lastTest: "2026-04-26", nextReview: "2026-06-24", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2025", name: "RBAC Enforcement", domain: "Access Control", status: "implemented", effectiveness: 47, lastTest: "2026-03-11", nextReview: "2026-07-15", owner: "SOC", risk: "Low" },
      { id: "CTL-2026", name: "VPN Management", domain: "Network Security", status: "partial", effectiveness: 40, lastTest: "2026-02-24", nextReview: "2026-08-06", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2027", name: "App Whitelisting", domain: "Endpoint Protection", status: "planned", effectiveness: 47, lastTest: "2026-01-09", nextReview: "2026-09-25", owner: "IT Ops", risk: "High" },
      { id: "CTL-2028", name: "Key Management", domain: "Data Protection", status: "gap", effectiveness: 3, lastTest: "2026-04-22", nextReview: "2026-10-16", owner: "Data Gov", risk: "Critical" },
    ];
    const gapAnalysis = [
      { gap: "Insufficient MFA coverage for legacy apps", severity: "High", remediationPlan: "Plan R3001", eta: "2026-Q2", estimatedCost: "89k" },
      { gap: "Missing network micro-segmentation", severity: "Medium", remediationPlan: "Plan R3002", eta: "2026-Q4", estimatedCost: "118k" },
      { gap: "Inconsistent EDR deployment", severity: "Medium", remediationPlan: "Plan R3003", eta: "2026-Q3", estimatedCost: "147k" },
      { gap: "DLP not covering cloud storage", severity: "Low", remediationPlan: "Plan R3004", eta: "2026-Q2", estimatedCost: "176k" },
      { gap: "SSO not integrated with all SaaS", severity: "High", remediationPlan: "Plan R3005", eta: "2026-Q4", estimatedCost: "24k" },
    ];
    return html`
  ...
  private _renderIncidentCostTracker() {
    const incidents = [
      { id: "INC-7001", name: "Security Incident 1", severity: "Critical", totalCost: 1014000, responseCost: 344760, recoveryCost: 395460, legalCost: 70980, regulatoryCost: 141960, insuranceClaim: 0, avoidedCost: 215000, date: "2026-03-27" },
      { id: "INC-7002", name: "Security Incident 2", severity: "High", totalCost: 1017000, responseCost: 203400, recoveryCost: 294930, legalCost: 203400, regulatoryCost: 91530, insuranceClaim: 518670, avoidedCost: 244000, date: "2026-02-08" },
      { id: "INC-7003", name: "Security Incident 3", severity: "Medium", totalCost: 1020000, responseCost: 275400, recoveryCost: 408000, legalCost: 173400, regulatoryCost: 153000, insuranceClaim: 0, avoidedCost: 273000, date: "2026-01-17" },
      { id: "INC-7004", name: "Security Incident 4", severity: "Low", totalCost: 1023000, responseCost: 347820, recoveryCost: 306900, legalCost: 143220, regulatoryCost: 102300, insuranceClaim: 470580, avoidedCost: 302000, date: "2026-04-26" },
      { id: "INC-7005", name: "Security Incident 5", severity: "Critical", totalCost: 1026000, responseCost: 205200, recoveryCost: 205200, legalCost: 112860, regulatoryCost: 51300, insuranceClaim: 0, avoidedCost: 331000, date: "2026-03-07" },
      { id: "INC-7006", name: "Security Incident 6", severity: "High", totalCost: 1029000, responseCost: 277830, recoveryCost: 318990, legalCost: 82320, regulatoryCost: 113190, insuranceClaim: 421890, avoidedCost: 360000, date: "2026-02-16" },
      { id: "INC-7007", name: "Security Incident 7", severity: "Medium", totalCost: 1032000, responseCost: 350880, recoveryCost: 216720, legalCost: 51600, regulatoryCost: 61920, insuranceClaim: 0, avoidedCost: 389000, date: "2026-01-25" },
      { id: "INC-7008", name: "Security Incident 8", severity: "Low", totalCost: 1035000, responseCost: 207000, recoveryCost: 331200, legalCost: 186300, regulatoryCost: 124200, insuranceClaim: 372600, avoidedCost: 418000, date: "2026-04-06" },
      { id: "INC-7009", name: "Security Incident 9", severity: "Critical", totalCost: 1038000, responseCost: 280260, recoveryCost: 228360, legalCost: 155700, regulatoryCost: 72660, insuranceClaim: 0, avoidedCost: 447000, date: "2026-03-15" },
      { id: "INC-7010", name: "Security Incident 10", severity: "High", totalCost: 1041000, responseCost: 353940, recoveryCost: 343530, legalCost: 124920, regulatoryCost: 135330, insuranceClaim: 322710, avoidedCost: 476000, date: "2026-02-24" },
      { id: "INC-7011", name: "Security Incident 11", severity: "Medium", totalCost: 1044000, responseCost: 208800, recoveryCost: 240120, legalCost: 93960, regulatoryCost: 83520, insuranceClaim: 0, avoidedCost: 9000, date: "2026-01-05" },
      { id: "INC-7012", name: "Security Incident 12", severity: "Low", totalCost: 1047000, responseCost: 282690, recoveryCost: 355980, legalCost: 62820, regulatoryCost: 146580, insuranceClaim: 806190, avoidedCost: 38000, date: "2026-04-14" },
    ];
    const yearlyTrend = [
      { month: "Jan", incidents: 11, totalCost: "278k", avgCost: "184k", insured: 69 },
      { month: "Feb", incidents: 8, totalCost: "321k", avgCost: "50k", insured: 69 },
      { month: "Mar", incidents: 5, totalCost: "364k", avgCost: "97k", insured: 69 },
      { month: "Apr", incidents: 2, totalCost: "407k", avgCost: "144k", insured: 69 },
      { month: "May", incidents: 10, totalCost: "450k", avgCost: "191k", insured: 69 },
      { month: "Jun", incidents: 7, totalCost: "493k", avgCost: "57k", insured: 69 },
    ];
...
declare global { interface HTMLElementTagNameMap { 'sc-exfil-detection': ScExfilDetection; } }
