...
@customElement('sc-deception')
export class ScDeception extends LitElement {
  static styles = css`
...
@state() private _tablePage = 1;
  ...
  @state() private _comments: CommentEntry[] = [
    { id: 'c1', author: 'soc-tier1', timestamp: '2026-04-23 04:00', text: 'Initial assessment started for Deception finding #1' },
  ...
  private _items: PanelItem[] = [
      {
            "id": "deception-1",
            "title": "Honeypot: Web Server (canary)",
            "severity": "medium",
            "status": "open",
            "category": "Security",
            "source": "SIEM",
            "description": "Type: Cowrie SSH | Port: 2222 | Last hit: 2h ago | Attacker IP: 185.220.xx.xx | Attempts: 34",
      ...
      {
            "id": "deception-2",
            "title": "Honeypot: Database (mysql-fake)",
            "severity": "medium",
            "status": "in-progress",
            "category": "Network",
            "source": "EDR",
            "description": "Type: MySQL fake | Port: 3307 | Last hit: 1d ago | Queries: 12 SELECT attempts | No data exposed",
      ...
      {
            "id": "deception-3",
            "title": "Canary Token: AWS Keys",
            "severity": "medium",
            "status": "resolved",
            "category": "Access",
            "source": "Scanner",
            "description": "Type: AWS canary token | Triggered: 3h ago | Location: GitHub gist | Used from: 203.0.113.42 | AWS region: us-east-1",
      ...
      {
            "id": "deception-4",
            "title": "Honeypot: SMB Share",
            "severity": "medium",
            "status": "open",
            "category": "Compliance",
            "source": "Audit",
            "description": "Type: SMB | Share: backup$ | Last access: 4h ago | Files browsed: 5 | Downloaded: 0 | Honey files intact",
      ...
      {
            "id": "deception-5",
            "title": "Canary DNS: sensitive.corp.com",
            "severity": "medium",
            "status": "in-progress",
            "category": "Operations",
            "source": "Manual",
            "description": "Type: DNS canary | Last query: Never | Domain: sensitive-data.corp.com | Monitoring: Active",
      ...
      {
            "id": "deception-6",
            "title": "Deception Finding #6",
            "severity": "high",
            "status": "open",
            "category": "Security",
            "source": "SIEM",
            "description": "Automated deception assessment finding detected during routine scan of infrastructure component. Review and remediation recommended.",
  ...
  private _history: HistoryEntry[] = [
    { timestamp: '2026-04-23 04:15', action: 'Auto-correlated', user: 'system', details: 'Grouped related findings from Deception analysis' },
    { timestamp: '2026-04-23 03:00', action: 'Created', user: 'scanner', details: 'New Deception finding detected by automated assessment' },
    ...
    { timestamp: '2026-04-22 22:00', action: 'Resolved', user: 'security-eng', details: 'Remediation applied and verified for Deception finding' },
    { timestamp: '2026-04-22 18:00', action: 'Created', user: 'audit', details: 'Compliance audit identified Deception gap requiring remediation' },
    ...
    { timestamp: '2026-04-21 16:00', action: 'Resolved', user: 'soc-tier1', details: 'False positive confirmed - benign activity flagged by Deception scan' },
    { timestamp: '2026-04-21 12:00', action: 'Exported', user: 'compliance', details: 'Exported Deception findings for Q1 compliance report' },
  ];
...
private _workflowTasks: WorkflowTask[] = [
    { id: 'wt-1', title: 'Review Deception finding #1', status: 'active', assignee: 'soc-tier1', blockedBy: [], slaDeadline: '2026-04-23T12:00:00Z', priority: 'p1', createdAt: '2026-04-23T00:00:00Z', completedAt: null },
    ...
    { id: 'wt-3', title: 'Update Deception detection rules', status: 'blocked', assignee: 'soc-tier2', blockedBy: ['wt-2'], slaDeadline: '2026-04-24T00:00:00Z', priority: 'p2', createdAt: '2026-04-23T03:00:00Z', completedAt: null },
    ...
    { id: 'wt-8', title: 'Archive resolved Deception findings', status: 'failed', assignee: 'soc-tier1', blockedBy: [], slaDeadline: '2026-04-23T08:00:00Z', priority: 'p4', createdAt: '2026-04-22T22:00:00Z', completedAt: null },
  ];

private _executionHistory: ExecutionRecord[] = [
    {
      id: 'exec-1', name: 'Deception Full Assessment Run', startedAt: '2026-04-22T10:00:00Z', completedAt: '2026-04-22T10:12:00Z', status: 'success',
      steps: [
    ...
    {
      id: 'exec-2', name: 'Deception Delta Scan', startedAt: '2026-04-23T02:00:00Z', completedAt: '2026-04-23T02:05:00Z', status: 'failed',
      steps: [
  ...
  private _runExecution() {
    ...
    const exec: ExecutionRecord = {
      id: 'exec-' + Date.now(), name: 'Deception Assessment ' + new Date().toISOString().slice(0, 10), startedAt: new Date().toISOString(), completedAt: null, status: 'running', steps,
    };
  ...
  private _renderExecutionPanel(): unknown {
    ...
    return html`
      <div class="form-section">
        ...
        ` : html`<div class="empty-state">Click "Run Assessment" to start the Deception analysis pipeline</div>`}
      </div>
      <div class="form-section">
        ...
        <div class="settings-card">
          ...
          <div style="display:flex;gap:8px;margin-top:4px;">
            <button class="btn primary" @click=${() => {
              ...
              const a = document.createElement('a'); a.href = url; a.download = 'deception-config.json'; a.click();
    ...
    return html`
      <div style="margin-top:12px;">
        ...
        <div style="display:flex;gap:6px;margin-top:8px;">
          <input class="search-box" type="text" placeholder="Add a comment..." style="min-width:auto;flex:1;" id="deception-comment-input" />
          <button class="btn primary" @click=${() => {
            const input = this.shadowRoot?.querySelector('#deception-comment-input') as HTMLInputElement;
  ...
  private _exportJSON() {
    ...
    const url = URL.createObjectURL(blob);
    const a = document.createElement('a'); a.href = url; a.download = 'sc-deception-data.json'; a.click();
    URL.revokeObjectURL(url);
  }
  ...
  private _exportCSV() {
    ...
    const url = URL.createObjectURL(blob);
    const a = document.createElement('a'); a.href = url; a.download = 'sc-deception-data.csv'; a.click();
    URL.revokeObjectURL(url);
  }


  // --- Domain Rules Engine ---
  @state() private _decRules: { id: string; name: string; category: string; severity: Severity; enabled: boolean; lastEval: string; passRate: number }[] = [];
  private _initDecRules() {
    const rules = [
    ...
    this._decRules = rules;
  }
  private _evaluateDecRules(): { passed: number; failed: number; skipped: number; total: number } {
    let passed = 0, failed = 0, skipped = 0;
    this._decRules.forEach(r => { if (!r.enabled) { skipped++; } else if (r.passRate >= 80) { passed++; } else { failed++; } });
    return { passed, failed, skipped, total: this._decRules.length };
  }

  // --- CVSS Scoring ---
  @state() private _deccvssData: { itemId: string; vector: string; base: number; temporal: number; environmental: number; overall: number }[] = [];
  private _initDecCvss() {
    ...
    this._deccvssData = vectors.map((v, i) => {
  ...
  // --- Anomaly Detection ---
  @state() private _decanomalies: { id: string; type: string; severity: Severity; description: string; detected: string; confidence: number; affected: string[] }[] = [];
  private _runDecAnomalyDetection() {
    const types = [
    ...
    this._decanomalies = types.map((a, i) => ({
  ...
  // --- Trend Prediction ---
  @state() private _decpredictions: { horizon: string; metric: string; current: number; predicted: number; direction: 'up' | 'down' | 'stable'; confidence: number }[] = [];
  private _generateDecPredictions() {
    this._decpredictions = [
  ...
  // --- Approval Workflow ---
  @state() private _decApprovals: { id: string; title: string; requester: string; status: 'pending' | 'approved' | 'rejected' | 'expired'; createdAt: string; priority: Priority; type: string }[] = [];
  private _initDecApprovals() {
    this._decApprovals = [
  ...
  private _approveDecItem(id: string) { const item = this._decApprovals.find(a => a.id === id); if (item) item.status = 'approved'; this.requestUpdate(); }
  private _rejectDecItem(id: string) { const item = this._decApprovals.find(a => a.id === id); if (item) item.status = 'rejected'; this.requestUpdate(); }

  // --- Activity Feed ---
  @state() private _decActivity: { id: string; action: string; user: string; target: string; timestamp: string }[] = [];
  private _initDecActivity() {
    const actions = [
    ...
    this._decActivity = actions.map((a, i) => ({ id: 'ACT-' + String(i + 1).padStart(3, '0'), ...a, timestamp: new Date(Date.now() - i * 3600000).toISOString() }));
  }

  // --- Notification System ---
  @state() private _decNotifications: { id: string; message: string; type: 'info' | 'warning' | 'error' | 'success'; read: boolean; timestamp: string }[] = [];
  private _initDecNotifications() {
    this._decNotifications = [
  ...
  private _markDecNotifRead(id: string) { const n = this._decNotifications.find(x => x.id === id); if (n) n.read = true; this.requestUpdate(); }

  // --- Panel Configuration ---
  @state() private _decConfig: { layout: 'compact' | 'default' | 'expanded'; theme: 'dark' | 'midnight' | 'slate'; showAnomalies: boolean; showPredictions: boolean; autoRefresh: boolean; refreshInterval: number } = {
    layout: 'default', theme: 'dark', showAnomalies: true, showPredictions: true, autoRefresh: true, refreshInterval: 60,
  };
  private _decPresets: { name: string; config: typeof this._decConfig }[] = [
  ...
  private _applyDecPreset(preset: typeof this._decPresets[0]) { this._decConfig = { ...preset.config }; this.requestUpdate(); }

  private _renderDecTreemapSVG(): string {
    const categories = [
  ...
  private _renderDecSankeySVG(): string {
  ...
  // --- Render: Rules Engine ---
  private _renderDecRules(): any {
    const ev = this._evaluateDecRules();
    return html`
  ...
  private _renderDecAnomalies(): any {
  ...
  // --- Render: Approvals ---
  private _renderDecApprovals(): any {
          ...
          $${this._decApprovals.map(a => html`
            <div style="padding:6px 8px;background:#1f2937;border-radius:4px">
              ...
              $${a.status === 'pending' ? html`
                <div style="display:flex;gap:4px;margin-top:4px">
                  <button class="btn success" style="padding:2px 8px;font-size:9px" @click=$${() => this._approveDecItem(a.id)}>Approve</button>
                  <button class="btn error" style="padding:2px 8px;font-size:9px" @click=$${() => this._rejectDecItem(a.id)}>Reject</button>
                </div>` : nothing}
            </div>`)}
        </div>
      </div>`;
  ...
  private _renderDecNotifications(): any {
    const tc = (t: string) => t === 'error' ? '#ef4444' : t === 'warning' ? '#eab308' : t === 'success' ? '#22c55e' : '#3b82f6';
    const unread = this._decNotifications.filter(n => !n.read).length;
    return html`
      <div style="background:#1a1d27;border-radius:8px;padding:12px;margin-top:12px">
        ...
        <div style="display:flex;flex-direction:column;gap:4px;max-height:120px;overflow-y:auto">
          $${this._decNotifications.map(n => html`
            <div style="display:flex;align-items:center;gap:8px;padding:4px 8px;background:$${n.read ? '#1f2937' : '#252a36'};border-radius:4px;font-size:10px;opacity:$${n.read ? '0.6' : '1'};cursor:pointer" @click=$${() => this._markDecNotifRead(n.id)}>
      ...
      <div style="background:#1a1d27;border-radius:8px;padding:12px;margin-top:12px">
        ...
        <div style="display:flex;flex-direction:column;gap:6px;font-size:10px">
          <div style="display:flex;align-items:center;gap:8px">
            ...
            <select class="form-input" style="flex:1" @change=$${(e: Event) => { this._decConfig.layout = (e.target as HTMLSelectElement).value as any; this.requestUpdate(); }}>
              <option value="compact" ?selected=$${this._decConfig.layout === 'compact'}>Compact</option>
              <option value="default" ?selected=$${this._decConfig.layout === 'default'}>Default</option>
              <option value="expanded" ?selected=$${this._decConfig.layout === 'expanded'}>Expanded</option>
            </select>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Theme</span>
            <select class="form-input" style="flex:1" @change=$${(e: Event) => { this._decConfig.theme = (e.target as HTMLSelectElement).value as any; this.requestUpdate(); }}>
              <option value="dark" ?selected=$${this._decConfig.theme === 'dark'}>Dark</option>
              <option value="midnight" ?selected=$${this._decConfig.theme === 'midnight'}>Midnight</option>
              <option value="slate" ?selected=$${this._decConfig.theme === 'slate'}>Slate</option>
            </select>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Auto Refresh</span>
            <input type="checkbox" ?checked=$${this._decConfig.autoRefresh} @change=$${() => { this._decConfig.autoRefresh = !this._decConfig.autoRefresh; this.requestUpdate(); }}/>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Show Anomalies</span>
            <input type="checkbox" ?checked=$${this._decConfig.showAnomalies} @change=$${() => { this._decConfig.showAnomalies = !this._decConfig.showAnomalies; this.requestUpdate(); }}/>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Show Predictions</span>
            <input type="checkbox" ?checked=$${this._decConfig.showPredictions} @change=$${() => { this._decConfig.showPredictions = !this._decConfig.showPredictions; this.requestUpdate(); }}/>
          </div>
          <div style="margin-top:6px;font-weight:600">Presets</div>
          <div style="display:flex;gap:4px">
            $${this._decPresets.map(ps => html`<button class="btn" style="padding:2px 8px;font-size:9px" @click=$${() => this._applyDecPreset(ps)}>$${ps.name}</button>`)}
          </div>
        </div>
      </div>`;
  }
...
@state() private _spmComplianceCheck6 = { id: "CHK-006", control: "Control 6", framework: "NIST 800-53", status: "pass", evidenceCount: 4, lastAudit: "2026-01-11", nextAudit: "2026-04-11", findings: 2 } as any;
  ...
  @state() private _deceptionRiskTopTen: Array<{id:string;name:string;score:number;trend:string;owner:string;category:string;lastAssessed:string}> = [
  ...
  @state() private _deceptionRiskCategories: Array<{category:string;count:number;avgScore:number;color:string}> = [
  ...
  @state() private _deceptionRiskVelocity: Array<{week:string;newRisks:number;closedRisks:number;netChange:number}> = [
  ...
  @state() private _deceptionRiskAppetite: {current:number;threshold:number;maxTolerated:number;status:string} = {
    current: 68, threshold: 55, maxTolerated: 80, status: 'Warning'
  };
  @state() private _deceptionRiskOwnerMatrix: Array<{owner:string;criticalCount:number;highCount:number;mediumCount:number;complianceRate:number}> = [
  ...
  private _renderDeceptionRiskDash(): TemplateResult {
    const riskItems = this._deceptionRiskTopTen;
    const velocity = this._deceptionRiskVelocity;
    const appetite = this._deceptionRiskAppetite;
    return html`
  ...
  @state() private _deceptionContainerScans: Array<{image:string;registry:string;critical:number;high:number;medium:number;scanDate:string;status:string}> = [
  ...
  @state() private _deceptionK8sPods: Array<{namespace:string;pod:string;securityContext:string;hostIPC:boolean;hostPID:boolean;privileged:boolean;riskLevel:string}> = [
  ...
  @state() private _deceptionServerlessRisk: Array<{function:string;runtime:string;timeout:number;iamPerms:string;externalCalls:number;riskScore:number}> = [
  ...
  @state() private _deceptionRuntimeAlerts: Array<{id:string;workload:string;alertType:string;severity:string;description:string;timestamp:string}> = [
  ...
  private _renderDeceptionCloudWl(): TemplateResult {
    const containers = this._deceptionContainerScans;
    const pods = this._deceptionK8sPods;
    const alerts = this._deceptionRuntimeAlerts;
    return html`
  ...
  @state() private _deceptionCorrRules: Array<{id:string;name:string;sources:string[];logic:string;severity:string;active:boolean;lastTriggered:string}> = [
  ...
  @state() private _deceptionEventTimeline: Array<{timestamp:string;source:string;eventType:string;details:string;correlated:boolean}> = [
  ...
  @state() private _deceptionFalsePosMetrics: {totalEvents:number;correlatedEvents:number;falsePositives:number;fpRate:number;topFpRules:string[]} = {
  ...
  @state() private _deceptionEventPatterns: Array<{id:string;pattern:string;frequency:number;firstSeen:string;lastSeen:string;status:string}> = [
  ...
  private _renderDeceptionEventCorr(): TemplateResult {
    const rules = this._deceptionCorrRules;
    const timeline = this._deceptionEventTimeline;
    const fpMetrics = this._deceptionFalsePosMetrics;
    return html`
  ...
  @state() private _deceptionCourses: Array<{id:string;title:string;category:string;duration:number;enrolled:number;completed:number;difficulty:string;rating:number}> = [
  ...
  @state() private _deceptionLearningPaths: Array<{id:string;name:string;courseIds:string[];progress:number;enrolled:number}> = [
  ...
  @state() private _deceptionDeptCompliance: Array<{dept:string;trainedPct:number;targetPct:number;avgScore:number;certCount:number}> = [
  ...
  @state() private _deceptionSkillsGaps: Array<{skill:string;current:number;required:number;gap:number;priority:string}> = [
  ...
  private _renderDeceptionTraining(): TemplateResult {
    const courses = this._deceptionCourses;
    const deptComp = this._deceptionDeptCompliance;
    return html`
  ...
  @state() private _complianceCalendarEvents: Array<{id: string; title: string; deadline: string; category: string; status: string; assignee: string; notes: string}> = [
    {id: 'cc-deception-001', title: 'SOX Section 404 Compliance Review', deadline: '2026-06-30', category: 'Regulatory', status: 'In Progress', assignee: 'Compliance Team', notes: 'Annual internal control assessment for financial reporting'},
    {id: 'cc-deception-002', title: 'GDPR Data Protection Impact Assessment', deadline: '2026-05-15', category: 'Privacy', status: 'Pending', assignee: 'DPO Office', notes: 'Quarterly DPIA for high-risk processing activities'},
    {id: 'cc-deception-003', title: 'ISO 27001 Surveillance Audit', deadline: '2026-07-20', category: 'Certification', status: 'Scheduled', assignee: 'QA Lead', notes: 'Stage 2 surveillance audit for ISMS certification renewal'},
    {id: 'cc-deception-004', title: 'PCI DSS v4.0 Gap Analysis', deadline: '2026-05-30', category: 'Payment', status: 'Not Started', assignee: 'Security Architect', notes: 'Assess current state against PCI DSS v4.0 requirements'},
    {id: 'cc-deception-005', title: 'NIST CSF Self-Assessment', deadline: '2026-08-15', category: 'Framework', status: 'Pending', assignee: 'CISO', notes: 'Biannual self-assessment against NIST Cybersecurity Framework'},
    {id: 'cc-deception-006', title: 'HIPAA Security Rule Audit', deadline: '2026-06-15', category: 'Healthcare', status: 'In Progress', assignee: 'Compliance Analyst', notes: 'Annual audit of administrative, physical, and technical safeguards'},
    {id: 'cc-deception-007', title: 'SOC 2 Type II Report Renewal', deadline: '2026-09-30', category: 'Audit', status: 'Scheduled', assignee: 'External Auditor', notes: 'Engage auditor for SOC 2 Type II examination period'},
    {id: 'cc-deception-008', title: 'FedRAMP Authorization Review', deadline: '2026-07-01', category: 'Government', status: 'Pending', assignee: 'FedRAMP PMO', notes: 'Review and update security authorization package'},
    {id: 'cc-deception-009', title: 'Annual Penetration Test', deadline: '2026-10-15', category: 'Testing', status: 'Not Started', assignee: 'Red Team Lead', notes: 'Comprehensive external and internal penetration testing engagement'},
    {id: 'cc-deception-010', title: 'Security Awareness Training Rollout', deadline: '2026-05-01', category: 'Training', status: 'Completed', assignee: 'Security Awareness Manager', notes: 'Q2 organization-wide security awareness training program'},
    {id: 'cc-deception-011', title: 'Vendor Security Review Cycle', deadline: '2026-06-01', category: 'Third Party', status: 'In Progress', assignee: 'Vendor Manager', notes: 'Quarterly review of critical vendor security posture and SLA compliance'},
    {id: 'cc-deception-012', title: 'Incident Response Plan Update', deadline: '2026-05-20', category: 'Operations', status: 'Pending', assignee: 'IR Team Lead', notes: 'Update IR procedures based on lessons learned from recent incidents'},
  ];
  ...
  @state() private _dataQualityMetrics: Array<{id: string; dataSource: string; completenessScore: number; accuracyScore: number; timelinessScore: number; consistencyScore: number; reliabilityRank: number; lastUpdated: string; issues: string[]; trend: string}> = [
    {id: 'dq-deception-001', dataSource: 'Vulnerability Scanner Feed', completenessScore: 94, accuracyScore: 91, timelinessScore: 88, consistencyScore: 95, reliabilityRank: 1, lastUpdated: '2026-04-23T08:00:00Z', issues: ['Minor delay in Nessus plugin updates'], trend: 'improving'},
    {id: 'dq-deception-002', dataSource: 'SIEM Event Logs', completenessScore: 87, accuracyScore: 93, timelinessScore: 96, consistencyScore: 89, reliabilityRank: 2, lastUpdated: '2026-04-23T07:30:00Z', issues: ['Some log sources showing gaps in off-hours'], trend: 'stable'},
    {id: 'dq-deception-003', dataSource: 'Asset Inventory Database', completenessScore: 82, accuracyScore: 78, timelinessScore: 75, consistencyScore: 84, reliabilityRank: 4, lastUpdated: '2026-04-22T18:00:00Z', issues: ['Shadow IT devices not fully cataloged', 'Decommissioned assets still listed'], trend: 'declining'},
    {id: 'dq-deception-004', dataSource: 'Threat Intelligence Platform', completenessScore: 91, accuracyScore: 89, timelinessScore: 92, consistencyScore: 87, reliabilityRank: 3, lastUpdated: '2026-04-23T06:00:00Z', issues: ['Some IOC sources lack confidence scoring'], trend: 'improving'},
    {id: 'dq-deception-005', dataSource: 'Identity Provider Logs', completenessScore: 96, accuracyScore: 97, timelinessScore: 98, consistencyScore: 96, reliabilityRank: 1, lastUpdated: '2026-04-23T09:00:00Z', issues: [], trend: 'stable'},
    {id: 'dq-deception-006', dataSource: 'Cloud Security Posture Data', completenessScore: 79, accuracyScore: 85, timelinessScore: 82, consistencyScore: 81, reliabilityRank: 5, lastUpdated: '2026-04-23T05:00:00Z', issues: ['Multi-cloud coverage gaps', 'API rate limiting affects scan frequency'], trend: 'declining'},
    {id: 'dq-deception-007', dataSource: 'Compliance Evidence Store', completenessScore: 88, accuracyScore: 86, timelinessScore: 80, consistencyScore: 83, reliabilityRank: 4, lastUpdated: '2026-04-21T14:00:00Z', issues: ['Manual evidence collection delays', 'Inconsistent formatting across frameworks'], trend: 'stable'},
    {id: 'dq-deception-008', dataSource: 'Network Flow Data', completenessScore: 92, accuracyScore: 90, timelinessScore: 94, consistencyScore: 91, reliabilityRank: 2, lastUpdated: '2026-04-23T08:30:00Z', issues: ['Encrypted traffic classification accuracy needs improvement'], trend: 'improving'},
  ];
  ...
  @state() private _workflowTemplates: Array<{id: string; name: string; description: string; category: string; steps: number; avgDuration: string; successRate: number; lastRun: string; manualInterventions: number; optimizationScore: number}> = [
    {id: 'wf-deception-001', name: 'Vulnerability Triage Pipeline', description: 'Automated vulnerability assessment, prioritization, and assignment workflow', category: 'Vulnerability Management', steps: 8, avgDuration: '12 min', successRate: 94.5, lastRun: '2026-04-23T06:00:00Z', manualInterventions: 2, optimizationScore: 87},
    {id: 'wf-deception-002', name: 'Incident Response Orchestration', description: 'End-to-end IR workflow from detection to containment and recovery', category: 'Incident Response', steps: 15, avgDuration: '45 min', successRate: 89.2, lastRun: '2026-04-22T14:30:00Z', manualInterventions: 5, optimizationScore: 72},
    {id: 'wf-deception-003', name: 'Access Request Approval Chain', description: 'Multi-level approval workflow for privileged access requests', category: 'Identity & Access', steps: 6, avgDuration: '4 hours', successRate: 97.1, lastRun: '2026-04-23T09:15:00Z', manualInterventions: 1, optimizationScore: 92},
    {id: 'wf-deception-004', name: 'Compliance Evidence Collection', description: 'Automated gathering and packaging of audit evidence artifacts', category: 'Compliance', steps: 10, avgDuration: '30 min', successRate: 91.8, lastRun: '2026-04-21T10:00:00Z', manualInterventions: 3, optimizationScore: 78},
    {id: 'wf-deception-005', name: 'Security Patch Deployment', description: 'Staged patch rollout with validation and rollback capability', category: 'Patch Management', steps: 12, avgDuration: '2 hours', successRate: 96.3, lastRun: '2026-04-20T22:00:00Z', manualInterventions: 1, optimizationScore: 85},
    {id: 'wf-deception-006', name: 'Threat Intelligence Enrichment', description: 'IOC enrichment and correlation with internal threat data', category: 'Threat Intelligence', steps: 7, avgDuration: '8 min', successRate: 93.7, lastRun: '2026-04-23T07:00:00Z', manualInterventions: 0, optimizationScore: 95},
    {id: 'wf-deception-007', name: 'Security Reporting Pipeline', description: 'Automated generation and distribution of security metrics reports', category: 'Reporting', steps: 5, avgDuration: '15 min', successRate: 98.9, lastRun: '2026-04-23T08:00:00Z', manualInterventions: 0, optimizationScore: 97},
    {id: 'wf-deception-008', name: 'Vendor Risk Assessment', description: 'Automated vendor security questionnaire distribution and scoring', category: 'Third Party', steps: 9, avgDuration: '3 days', successRate: 85.4, lastRun: '2026-04-19T11:00:00Z', manualInterventions: 4, optimizationScore: 65},
  ];
  ...
  @state() private _workflowExecutionHistory: Array<{workflowId: string; runDate: string; duration: string; status: string; trigger: string}> = [
    {workflowId: 'wf-deception-001', runDate: '2026-04-23T06:00:00Z', duration: '11 min 23 sec', status: 'Success', trigger: 'Scheduled'},
    {workflowId: 'wf-deception-002', runDate: '2026-04-22T14:30:00Z', duration: '42 min 15 sec', status: 'Success', trigger: 'Alert'},
    {workflowId: 'wf-deception-003', runDate: '2026-04-23T09:15:00Z', duration: '3h 45 min', status: 'Success', trigger: 'User Request'},
    {workflowId: 'wf-deception-001', runDate: '2026-04-22T06:00:00Z', duration: '13 min 08 sec', status: 'Partial', trigger: 'Scheduled'},
    {workflowId: 'wf-deception-004', runDate: '2026-04-21T10:00:00Z', duration: '28 min 42 sec', status: 'Success', trigger: 'Scheduled'},
  ];
  ...
  @state() private _knowledgeArticles: Array<{id: string; title: string; category: string; author: string; publishDate: string; views: number; rating: number; tags: string[]; summary: string; readTime: string}> = [
    {id: 'kb-deception-001', title: 'Zero Trust Architecture Implementation Guide', category: 'Architecture', author: 'Security Architecture Team', publishDate: '2026-03-15', views: 1842, rating: 4.8, tags: ['zero-trust', 'network', 'identity'], summary: 'Comprehensive guide for implementing zero trust principles across enterprise infrastructure', readTime: '15 min'},
    {id: 'kb-deception-002', title: 'Ransomware Defense Playbook 2026', category: 'Threats', author: 'Threat Intelligence Team', publishDate: '2026-04-01', views: 2341, rating: 4.9, tags: ['ransomware', 'incident-response', 'defense'], summary: 'Updated playbook with latest ransomware tactics, techniques, and defensive measures', readTime: '12 min'},
    {id: 'kb-deception-003', title: 'Cloud Security Best Practices for Multi-Cloud', category: 'Cloud', author: 'Cloud Security Team', publishDate: '2026-02-28', views: 1567, rating: 4.5, tags: ['cloud', 'aws', 'azure', 'gcp'], summary: 'Best practices for securing workloads across multiple cloud service providers', readTime: '18 min'},
    {id: 'kb-deception-004', title: 'API Security Testing Methodology', category: 'Testing', author: 'Red Team', publishDate: '2026-03-22', views: 987, rating: 4.6, tags: ['api', 'testing', 'owasp'], summary: 'Structured methodology for identifying and testing API security vulnerabilities', readTime: '10 min'},
    {id: 'kb-deception-005', title: 'Supply Chain Security Risk Management', category: 'Third Party', author: 'GRC Team', publishDate: '2026-01-20', views: 1234, rating: 4.3, tags: ['supply-chain', 'vendor', 'risk'], summary: 'Framework for managing security risks in the software supply chain', readTime: '14 min'},
    {id: 'kb-deception-006', title: 'Kubernetes Security Hardening Checklist', category: 'Container', author: 'Platform Security', publishDate: '2026-04-10', views: 2103, rating: 4.7, tags: ['kubernetes', 'container', 'hardening'], summary: 'Step-by-step hardening checklist for production Kubernetes clusters', readTime: '11 min'},
    {id: 'kb-deception-007', title: 'Security Metrics That Matter for Executives', category: 'Metrics', author: 'CISO Office', publishDate: '2026-03-05', views: 876, rating: 4.4, tags: ['metrics', 'kpi', 'reporting'], summary: 'Key security metrics and KPIs that resonate with board-level stakeholders', readTime: '8 min'},
    {id: 'kb-deception-008', title: 'Phishing Simulation Campaign Design', category: 'Awareness', author: 'Security Awareness Team', publishDate: '2026-02-15', views: 1456, rating: 4.5, tags: ['phishing', 'simulation', 'training'], summary: 'Designing effective phishing simulations that drive real behavioral change', readTime: '9 min'},
    {id: 'kb-deception-009', title: 'Data Loss Prevention Strategy and Implementation', category: 'Data Protection', author: 'Data Security Team', publishDate: '2026-03-28', views: 1678, rating: 4.6, tags: ['dlp', 'data-protection', 'compliance'], summary: 'Strategic approach to DLP covering people, process, and technology layers', readTime: '16 min'},
    {id: 'kb-deception-010', title: 'Security Automation with SOAR Platforms', category: 'Automation', author: 'SOC Engineering', publishDate: '2026-04-05', views: 1098, rating: 4.7, tags: ['soar', 'automation', 'soc'], summary: 'Building effective security automation playbooks using SOAR technology', readTime: '13 min'},
    {id: 'kb-deception-011', title: 'Third-Party Risk Assessment Framework', category: 'GRC', author: 'Vendor Management', publishDate: '2026-01-30', views: 1345, rating: 4.4, tags: ['vendor', 'risk', 'assessment'], summary: 'Structured framework for evaluating and monitoring third-party security risks', readTime: '12 min'},
    {id: 'kb-deception-012', title: 'Network Detection and Response Best Practices', category: 'Network', author: 'Network Security Team', publishDate: '2026-03-18', views: 1567, rating: 4.5, tags: ['ndr', 'network', 'detection'], summary: 'Implementing effective network detection and response capabilities', readTime: '14 min'},
    {id: 'kb-deception-013', title: 'Security Chaos Engineering Guide', category: 'Resilience', author: 'SRE Security', publishDate: '2026-04-12', views: 789, rating: 4.3, tags: ['chaos-engineering', 'resilience', 'testing'], summary: 'Applying chaos engineering principles to validate security controls', readTime: '10 min'},
    {id: 'kb-deception-014', title: 'Incident Communication Templates', category: 'Incident Response', author: 'IR Team', publishDate: '2026-02-22', views: 2234, rating: 4.8, tags: ['incident', 'communication', 'templates'], summary: 'Ready-to-use communication templates for security incident scenarios', readTime: '7 min'},
    {id: 'kb-deception-015', title: 'Endpoint Detection and Response Configuration', category: 'Endpoint', author: 'Endpoint Security', publishDate: '2026-03-08', views: 1345, rating: 4.5, tags: ['edr', 'endpoint', 'configuration'], summary: 'Optimal EDR configuration for maximum detection with minimal false positives', readTime: '11 min'},
    {id: 'kb-deception-016', title: 'Security Code Review Standards', category: 'Development', author: 'AppSec Team', publishDate: '2026-02-10', views: 1890, rating: 4.6, tags: ['code-review', 'secure-sdlc', 'standards'], summary: 'Standards and checklists for security-focused code reviews', readTime: '13 min'},
    {id: 'kb-deception-017', title: 'IoT Security Assessment Methodology', category: 'IoT', author: 'IoT Security Lab', publishDate: '2026-04-08', views: 654, rating: 4.2, tags: ['iot', 'embedded', 'assessment'], summary: 'Methodology for assessing security posture of IoT devices and ecosystems', readTime: '15 min'},
    {id: 'kb-deception-018', title: 'Passwordless Authentication Migration Guide', category: 'Identity', author: 'IAM Team', publishDate: '2026-03-25', views: 1678, rating: 4.7, tags: ['passwordless', 'authentication', 'mfa'], summary: 'Step-by-step migration plan from password-based to passwordless authentication', readTime: '12 min'},
    {id: 'kb-deception-019', title: 'Security Awareness Program Metrics', category: 'Awareness', author: 'Security Culture Team', publishDate: '2026-01-25', views: 1123, rating: 4.4, tags: ['awareness', 'metrics', 'culture'], summary: 'Measuring the effectiveness of your security awareness and training programs', readTime: '9 min'},
    {id: 'kb-deception-020', title: 'Deception Technology Deployment Guide', category: 'Detection', author: 'Blue Team', publishDate: '2026-04-15', views: 876, rating: 4.5, tags: ['deception', 'honeypot', 'detection'], summary: 'Planning and deploying deception technology for advanced threat detection', readTime: '11 min'},
  ];
  ...
  // --- Security Scenario Planning Methods (DE) ---
  private _initDeScenarios(): void {
    const worstCaseScenarios = [
      { id: "de-sc-01", name: "Ransomware Attack on Critical Infrastructure", category: "Malware", impact: 9500000, probability: 0.12, recoveryDays: 21, affectedSystems: 47, dataLossGb: 320, businessImpact: "critical" },
      { id: "de-sc-02", name: "Insider Data Exfiltration via Authorized Channels", category: "Insider Threat", impact: 7200000, probability: 0.18, recoveryDays: 14, affectedSystems: 12, dataLossGb: 85, businessImpact: "high" },
      { id: "de-sc-03", name: "Supply Chain Compromise via Third-Party Library", category: "Supply Chain", impact: 6800000, probability: 0.09, recoveryDays: 30, affectedSystems: 63, dataLossGb: 0, businessImpact: "critical" },
      { id: "de-sc-04", name: "Cloud Misconfiguration Leading to Public Exposure", category: "Cloud", impact: 4100000, probability: 0.22, recoveryDays: 7, affectedSystems: 8, dataLossGb: 450, businessImpact: "high" },
      { id: "de-sc-05", name: "Zero-Day Exploit in Core Application Framework", category: "Vulnerability", impact: 8900000, probability: 0.05, recoveryDays: 45, affectedSystems: 120, dataLossGb: 0, businessImpact: "critical" },
      { id: "de-sc-06", name: "Distributed Denial of Service on Customer-Facing Services", category: "Availability", impact: 3400000, probability: 0.25, recoveryDays: 3, affectedSystems: 15, dataLossGb: 0, businessImpact: "medium" },
      { id: "de-sc-07", name: "Credential Stuffing and Account Takeover Wave", category: "Identity", impact: 2800000, probability: 0.30, recoveryDays: 5, affectedSystems: 6, dataLossGb: 12, businessImpact: "medium" },
      { id: "de-sc-08", name: "Physical Security Breach at Data Center Facility", category: "Physical", impact: 12000000, probability: 0.02, recoveryDays: 60, affectedSystems: 200, dataLossGb: 5000, businessImpact: "critical" },
    ];
    this._deScenarios = worstCaseScenarios.map(s => ({ ...s, mitigationCost: Math.round(s.impact * 0.08), drillScheduled: false, lastDrillDate: null, drillScore: null, controlGaps: Math.floor(Math.random() * 5) + 1 }));
  }

  private _calculateDeScenarioRisk(): void {
    this._deScenarios.forEach(s => {
  ...
  private _scheduleDeDrills(): void {
  ...
  private _deScenarioComparison(): Record<string, unknown>[] {
    return this._deScenarios.map(s => ({
  ...
  // --- Security Control Effectiveness Analytics (DE) ---
  private _initDeControls(): void {
    const controls = [
      { id: "de-ct-01", name: "Network Segmentation", type: "preventive", maturity: "defined", score: 82, target: 90, failures: 3, lastTest: "2026-03-15" },
      { id: "de-ct-02", name: "Endpoint Detection and Response", type: "detective", maturity: "managed", score: 88, target: 92, failures: 1, lastTest: "2026-04-01" },
      { id: "de-ct-03", name: "Data Loss Prevention", type: "preventive", maturity: "repeatable", score: 71, target: 85, failures: 7, lastTest: "2026-03-22" },
      { id: "de-ct-04", name: "Security Information and Event Management", type: "detective", maturity: "managed", score: 85, target: 90, failures: 2, lastTest: "2026-04-05" },
      { id: "de-ct-05", name: "Identity and Access Management", type: "preventive", maturity: "defined", score: 76, target: 88, failures: 5, lastTest: "2026-03-28" },
      { id: "de-ct-06", name: "Vulnerability Management", type: "corrective", maturity: "managed", score: 80, target: 90, failures: 4, lastTest: "2026-04-02" },
      { id: "de-ct-07", name: "Email Security Gateway", type: "preventive", maturity: "managed", score: 90, target: 95, failures: 1, lastTest: "2026-04-08" },
      { id: "de-ct-08", name: "Web Application Firewall", type: "preventive", maturity: "managed", score: 87, target: 92, failures: 2, lastTest: "2026-03-30" },
      { id: "de-ct-09", name: "Patch Management", type: "corrective", maturity: "defined", score: 68, target: 85, failures: 9, lastTest: "2026-03-18" },
      { id: "de-ct-10", name: "Encryption at Rest", type: "preventive", maturity: "managed", score: 93, target: 95, failures: 0, lastTest: "2026-04-10" },
      { id: "de-ct-11", name: "Encryption in Transit", type: "preventive", maturity: "optimized", score: 96, target: 98, failures: 0, lastTest: "2026-04-12" },
      { id: "de-ct-12", name: "Privileged Access Management", type: "preventive", maturity: "defined", score: 74, target: 88, failures: 6, lastTest: "2026-03-25" },
      { id: "de-ct-13", name: "Security Awareness Training", type: "preventive", maturity: "repeatable", score: 65, target: 80, failures: 11, lastTest: "2026-03-20" },
      { id: "de-ct-14", name: "Incident Response Plan", type: "corrective", maturity: "managed", score: 78, target: 88, failures: 4, lastTest: "2026-04-03" },
      { id: "de-ct-15", name: "Backup and Recovery", type: "corrective", maturity: "managed", score: 84, target: 92, failures: 3, lastTest: "2026-04-06" },
      { id: "de-ct-16", name: "Multi-Factor Authentication", type: "preventive", maturity: "managed", score: 91, target: 95, failures: 1, lastTest: "2026-04-09" },
      { id: "de-ct-17", name: "Network Traffic Analysis", type: "detective", maturity: "defined", score: 72, target: 85, failures: 5, lastTest: "2026-03-27" },
      { id: "de-ct-18", name: "Cloud Security Posture Management", type: "detective", maturity: "repeatable", score: 69, target: 82, failures: 8, lastTest: "2026-03-24" },
      { id: "de-ct-19", name: "Container Security Scanning", type: "preventive", maturity: "defined", score: 75, target: 85, failures: 5, lastTest: "2026-04-04" },
      { id: "de-ct-20", name: "API Security Gateway", type: "preventive", maturity: "repeatable", score: 70, target: 82, failures: 7, lastTest: "2026-03-29" },
      { id: "de-ct-21", name: "Threat Intelligence Platform", type: "detective", maturity: "managed", score: 83, target: 90, failures: 2, lastTest: "2026-04-07" },
      { id: "de-ct-22", name: "Database Activity Monitoring", type: "detective", maturity: "defined", score: 67, target: 80, failures: 8, lastTest: "2026-03-21" },
      { id: "de-ct-23", name: "Deception Technology", type: "detective", maturity: "initial", score: 55, target: 75, failures: 12, lastTest: "2026-03-16" },
      { id: "de-ct-24", name: "Security Orchestration Automation", type: "corrective", maturity: "repeatable", score: 73, target: 85, failures: 6, lastTest: "2026-04-01" },
      { id: "de-ct-25", name: "Third-Party Risk Assessment", type: "preventive", maturity: "defined", score: 64, target: 78, failures: 9, lastTest: "2026-03-19" },
    ];
    this._deControls = controls;
  }

  private _analyzeDeControlEffectiveness(): void {
    const typeBreakdown: Record<string, { total: number; avgScore: number; avgFailures: number }> = {};
    this._deControls.forEach(c => {
    ...
    this._deControlTypeBreakdown = typeBreakdown;
  }

  private _deControlOptimization(): Record<string, unknown>[] {
    return this._deControls.filter(c => c.score < c.target).map(c => ({
  ...
  // --- Security Data Pipeline Health (DE) ---
  private _initDePipelines(): void {
    const pipelines = [
      { id: "de-pl-01", name: "SIEM Log Ingestion", status: "healthy", healthScore: 94, latencyMs: 120, freshnessMin: 2, errorRate: 0.02, throughputMbps: 450, recordsPerSec: 12000, backPressure: 0.05, uptime: 99.97 },
      { id: "de-pl-02", name: "Threat Feed Aggregation", status: "healthy", healthScore: 91, latencyMs: 300, freshnessMin: 15, errorRate: 0.05, throughputMbps: 85, recordsPerSec: 3200, backPressure: 0.08, uptime: 99.92 },
      { id: "de-pl-03", name: "Vulnerability Scan Results", status: "degraded", healthScore: 72, latencyMs: 2500, freshnessMin: 60, errorRate: 0.15, throughputMbps: 25, recordsPerSec: 800, backPressure: 0.35, uptime: 98.50 },
      { id: "de-pl-04", name: "Endpoint Telemetry Stream", status: "healthy", healthScore: 88, latencyMs: 450, freshnessMin: 5, errorRate: 0.08, throughputMbps: 280, recordsPerSec: 8500, backPressure: 0.12, uptime: 99.85 },
      { id: "de-pl-05", name: "Cloud Audit Log Pipeline", status: "healthy", healthScore: 86, latencyMs: 600, freshnessMin: 10, errorRate: 0.06, throughputMbps: 150, recordsPerSec: 4500, backPressure: 0.10, uptime: 99.80 },
      { id: "de-pl-06", name: "Identity Event Stream", status: "warning", healthScore: 78, latencyMs: 1200, freshnessMin: 20, errorRate: 0.12, throughputMbps: 45, recordsPerSec: 1500, backPressure: 0.22, uptime: 99.40 },
      { id: "de-pl-07", name: "Network Flow Collection", status: "healthy", healthScore: 82, latencyMs: 800, freshnessMin: 8, errorRate: 0.09, throughputMbps: 650, recordsPerSec: 18000, backPressure: 0.15, uptime: 99.70 },
      { id: "de-pl-08", name: "DLP Incident Pipeline", status: "degraded", healthScore: 68, latencyMs: 3500, freshnessMin: 45, errorRate: 0.20, throughputMbps: 18, recordsPerSec: 500, backPressure: 0.42, uptime: 97.80 },
    ];
    this._dePipelines = pipelines.map(p => ({ ...p, dependencies: [], slaBreached: p.healthScore < 75, alertThreshold: p.errorRate > 0.15 }));
    this._dePipelines[0].dependencies = ["de-pl-04", "de-pl-07"];
    this._dePipelines[4].dependencies = ["de-pl-01"];
    this._dePipelines[5].dependencies = ["de-pl-02"];
    this._dePipelines[7].dependencies = ["de-pl-04", "de-pl-05"];
  }

  private _dePipelineTrend(): Record<string, unknown>[] {
    const hours = Array.from({ length: 24 }, (_, i) => `H${String(i).padStart(2, "0")}`);
    return this._dePipelines.map(p => ({
  ...
  // --- Security Stakeholder Report Generator (DE) ---
  private _initDeReportTemplates(): void {
    this._deReportTemplates = [
      { id: "de-rp-01", name: "Board Security Report", audience: "board", frequency: "quarterly", sections: 6, autoGenerate: true, lastGenerated: "2026-03-31", pages: 12 },
      { id: "de-rp-02", name: "Executive Risk Summary", audience: "executive", frequency: "monthly", sections: 8, autoGenerate: true, lastGenerated: "2026-04-01", pages: 8 },
      { id: "de-rp-03", name: "Technical Security Review", audience: "technical", frequency: "weekly", sections: 12, autoGenerate: true, lastGenerated: "2026-04-21", pages: 25 },
      { id: "de-rp-04", name: "Audit Compliance Report", audience: "audit", frequency: "quarterly", sections: 10, autoGenerate: false, lastGenerated: "2026-03-15", pages: 35 },
      { id: "de-rp-05", name: "Regulatory Filing Package", audience: "regulatory", frequency: "annual", sections: 15, autoGenerate: false, lastGenerated: "2025-12-31", pages: 48 },
    ];
  }

  private _generateDeExecSummary(): string {
    const totalRisk = this._deScenarios.reduce((sum: number, s: any) => sum + s.riskScore, 0);
    const avgControl = Math.round(this._deControls.reduce((sum: number, c: any) => sum + c.score, 0) / this._deControls.length);
    const degradedPipes = this._dePipelines.filter((p: any) => p.status !== "healthy").length;
    return `Overall risk exposure: ${(totalRisk / 1000000).toFixed(1)}M. Average control effectiveness: {avgControl}%. {degradedPipes} pipeline(s) need attention. {this._deScenarios.filter((s: any) => s.mitigationPriority === "immediate").length} scenarios require immediate action.`;
  }

  // --- Security Technology Radar (DE) ---
  private _initDeTechRadar(): void {
    this._deTechRadar = [
      { id: "de-tr-01", name: "AI-Powered Threat Detection", ring: "adopt", category: "Detection", maturity: 4, trend: "up", investment: "high", roi: 3.2, vendorCount: 8 },
      { id: "de-tr-02", name: "Zero Trust Architecture", ring: "adopt", category: "Architecture", maturity: 4, trend: "up", investment: "high", roi: 2.8, vendorCount: 12 },
      { id: "de-tr-03", name: "SASE/SSE Platform", ring: "trial", category: "Network", maturity: 3, trend: "up", investment: "medium", roi: 2.4, vendorCount: 10 },
      { id: "de-tr-04", name: "CNAPP Cloud Security", ring: "trial", category: "Cloud", maturity: 3, trend: "up", investment: "medium", roi: 2.1, vendorCount: 7 },
      { id: "de-tr-05", name: "Extended Detection and Response", ring: "adopt", category: "Detection", maturity: 4, trend: "stable", investment: "high", roi: 2.9, vendorCount: 9 },
      { id: "de-tr-06", name: "Quantum-Safe Cryptography", ring: "assess", category: "Crypto", maturity: 2, trend: "up", investment: "low", roi: 0.8, vendorCount: 4 },
      { id: "de-tr-07", name: "Security Service Edge", ring: "trial", category: "Network", maturity: 3, trend: "up", investment: "medium", roi: 2.0, vendorCount: 6 },
      { id: "de-tr-08", name: "SOAR 2.0 Autonomous SOC", ring: "assess", category: "Operations", maturity: 2, trend: "up", investment: "low", roi: 1.2, vendorCount: 5 },
      { id: "de-tr-09", name: "Software Supply Chain Security", ring: "trial", category: "DevSecOps", maturity: 3, trend: "up", investment: "medium", roi: 2.3, vendorCount: 8 },
      { id: "de-tr-10", name: "Identity Threat Detection", ring: "adopt", category: "Identity", maturity: 3, trend: "up", investment: "high", roi: 2.7, vendorCount: 7 },
      { id: "de-tr-11", name: "Data Security Posture Management", ring: "trial", category: "Data", maturity: 3, trend: "up", investment: "medium", roi: 2.2, vendorCount: 9 },
      { id: "de-tr-12", name: "Decentralized Identity Standards", ring: "hold", category: "Identity", maturity: 1, trend: "stable", investment: "low", roi: 0.5, vendorCount: 3 },
    ];
  }

  private _deRadarSummary(): Record<string, unknown> {
    const rings: Record<string, number> = { adopt: 0, trial: 0, assess: 0, hold: 0 };
    this._deTechRadar.forEach(t => { if (rings[t.ring as keyof typeof rings] !== undefined) rings[t.ring as keyof typeof rings]++; });
    return { adopt: rings.adopt, trial: rings.trial, assess: rings.assess, hold: rings.hold, total: this._deTechRadar.length, avgMaturity: 2.8, topInvestment: this._deTechRadar.filter(t => t.investment === "high").map(t => t.name) };
  }

  // --- DE Security Compliance Mapping Matrix ---
  private _initDeComplianceMatrix(): void {
    ...
    this._deComplianceMatrix = frameworks.map(fw => ({
  ...
  private _deComplianceTrend(): Record<string, unknown>[] {
    const quarters = ["Q1-2025", "Q2-2025", "Q3-2025", "Q4-2025", "Q1-2026", "Q2-2026"];
    return this._deComplianceMatrix.map(fw => ({
  ...
  // --- DE Threat Intelligence Correlation Engine ---
  private _initDeThreatIntel(): void {
    ...
    this._deThreatIntel = threatActors.map((actor, i) => ({
  ...
  private _deThreatCorrelation(): Record<string, unknown>[] {
    return this._deThreatIntel.filter(t => t.riskScore > 70).map(t => ({
  ...
  // --- DE Security Metrics Deep Dive ---
  private _initDeMetricsDeep(): void {
    ...
    this._deMetricsDeep = metricCategories.map(cat => ({
  ...
  private _deMetricsHeatmap(): number[][] {
    return this._deMetricsDeep.map(cat =>
      cat.metrics.map(m => Math.round((m.value / m.target) * 100))
    );
  }

  // --- DE Incident Cost Modeling ---
  private _initDeCostModel(): void {
    const incidentTypes = ["Data Breach", "Ransomware", "DDoS", "Insider Threat", "Phishing", "Supply Chain", "Cloud Misconfig", "Zero-Day"];
    this._deCostModel = incidentTypes.map(inc => ({
    ...
    this._deCostModel.forEach(m => { m.totalAnnualExposure = m.avgCost * m.frequency; });
  }

  private _deCostProjection(): Record<string, unknown>[] {
    return this._deCostModel.map(m => ({
  ...
  // --- DE Security Architecture Pattern Library ---
  private _initDeArchPatterns(): void {
    ...
    this._deArchPatterns = patterns.map((p, i) => ({
  ...
  private _deArchPatternAnalysis(): Record<string, unknown> {
    const implemented = this._deArchPatterns.filter(p => p.implementation > 75).length;
    const avgCoverage = Math.round(this._deArchPatterns.reduce((s: number, p: any) => s + p.coverage, 0) / this._deArchPatterns.length);
    return {
      totalPatterns: this._deArchPatterns.length, fullyImplemented: implemented, avgCoverage,
      avgRiskReduction: Math.round(this._deArchPatterns.reduce((s: number, p: any) => s + p.riskReduction, 0) / this._deArchPatterns.length),
      gaps: this._deArchPatterns.filter(p => p.implementation < 60).map(p => p.pattern),
      recommendations: this._deArchPatterns.filter(p => p.implementation < 70).map(p => ({ pattern: p.pattern, current: p.implementation, target: 85, effort: p.costComplexity }))
    };
  }
  ...
  private _343RiskAssessmentWorkflow = [
  ...
  private _343TreatmentOptions = [
    {id: '343-T-001', riskId: 'RSK-042', risk: 'Ransomware Attack on Critical Infrastructure', before: 20, after: 6, strategy: 'Mitigate', controls: ['Next-gen EDR with behavioral detection and automated response', 'Zero-trust network micro-segmentation isolating critical assets', 'Immutable offline backup rotation with quarterly recovery testing', 'Incident response retainer with 1-hour response SLA'], cost: '$450K/yr', roi: '78% reduction vs $2.8M potential loss', timeline: 'Q3 2026', status: 'approved' as const},
  ...
  private _343TalentPositions = [
    ...
    {id: '343-H-002', title: 'Cloud Security Engineer', dept: 'Cloud Security', level: 'Mid-Senior', loc: 'SF/Remote', salary: '$155K-$180K', posted: '2026-03-20', applicants: 45, pipeline: 12, interviews: 6, offers: 2, urgency: 'high' as const, manager: 'Mike Johnson', skills: ['AWS/Azure/GCP', 'Terraform', 'Kubernetes', 'IAM', 'CSPM'], nice: ['CCSP', 'CKS', 'Serverless']},
    {id: '343-H-003', title: 'SOC Analyst L2', dept: 'Security Operations', level: 'Mid', loc: 'Austin TX', salary: '$105K-$130K', posted: '2026-04-01', applicants: 67, pipeline: 18, interviews: 8, offers: 0, urgency: 'medium' as const, manager: 'Lisa Park', skills: ['SIEM', 'Incident triage', 'Malware analysis', 'TCP/IP'], nice: ['GCIA', 'SOAR', 'Kill chain']},
    {id: '343-H-004', title: 'Staff Security Architect', dept: 'Architecture', level: 'Staff', loc: 'Remote US', salary: '$200K-$240K', posted: '2026-02-28', applicants: 12, pipeline: 3, interviews: 2, offers: 0, urgency: 'critical' as const, manager: 'David Lee', skills: ['Enterprise arch', 'Zero trust', 'Risk frameworks', 'Board comms'], nice: ['CISSP+SABSA', 'Team building', 'Speaker']},
    {id: '343-H-005', title: 'GRC Analyst', dept: 'GRC', level: 'Mid', loc: 'NY/Remote', salary: '$110K-$135K', posted: '2026-04-05', applicants: 34, pipeline: 9, interviews: 3, offers: 1, urgency: 'medium' as const, manager: 'Rachel Green', skills: ['ISO 27001', 'SOC 2', 'Risk assessment', 'Audit'], nice: ['CRISC', 'CISA', 'GDPR']},
    {id: '343-H-006', title: 'Threat Intel Analyst', dept: 'Threat Intel', level: 'Mid-Senior', loc: 'Remote US', salary: '$140K-$170K', posted: '2026-03-25', applicants: 19, pipeline: 5, interviews: 2, offers: 0, urgency: 'low' as const, manager: 'James Wilson', skills: ['MITRE ATT&CK', 'OSINT', 'Threat modeling', 'Reverse eng'], nice: ['CTIA', 'Nation-state', 'Dark web']},
    {id: '343-H-007', title: 'AppSec Engineer', dept: 'AppSec', level: 'Senior', loc: 'Seattle/Remote', salary: '$160K-$190K', posted: '2026-04-10', applicants: 28, pipeline: 7, interviews: 3, offers: 0, urgency: 'medium' as const, manager: 'Emily Zhang', skills: ['SAST/DAST/SCA', 'Secure SDLC', 'Code review', 'CI/CD'], nice: ['CSSLP', 'Mobile security']},
    {id: '343-H-008', title: 'IAM Engineer', dept: 'IAM', level: 'Mid', loc: 'Remote US', salary: '$135K-$160K', posted: '2026-04-08', applicants: 31, pipeline: 10, interviews: 5, offers: 1, urgency: 'medium' as const, manager: 'Chris Martinez', skills: ['Okta/Azure AD', 'SAML/OIDC', 'PAM', 'RBAC'], nice: ['CISSP', 'Zero trust IAM']}
  ];

  private _343InterviewScorecard = [
  ...
  private _343OnboardingSteps = [
    {id: '343-OB-01', item: 'Provision security-hardened laptop, monitors, peripherals, and configured workstation image with all required security tools', cat: 'IT Setup', day: 'Day 1', owner: 'IT Operations'},
    {id: '343-OB-02', item: 'Create AD account, email, Slack, VPN, SSO enrollment, and all required application access accounts', cat: 'Access', day: 'Day 1', owner: 'IAM Team'},
    {id: '343-OB-03', item: 'Grant security tooling access: SIEM console, EDR dashboard, vuln scanner, pentest platforms, SOAR', cat: 'Tools', day: 'Day 1-2', owner: 'SOC Manager'},
    {id: '343-OB-04', item: 'Complete MFA enrollment, security awareness onboarding course, and acceptable use policy acknowledgment', cat: 'Security', day: 'Day 1', owner: 'Awareness Team'},
    {id: '343-OB-05', item: 'Sign NDA, employment agreement, IP assignment, and code of conduct documents with HR', cat: 'HR', day: 'Day 1', owner: 'Human Resources'},
    {id: '343-OB-06', item: 'Introduction meetings with direct team members and key cross-functional stakeholders', cat: 'Integration', day: 'Week 1', owner: 'Hiring Manager'},
    {id: '343-OB-07', item: 'Security architecture overview, tooling walkthrough, and operational runbook review sessions', cat: 'Training', day: 'Week 1-2', owner: 'Security Architect'},
    {id: '343-OB-08', item: 'Shadow experienced team member on active incident response and threat hunting investigations', cat: 'Mentoring', day: 'Week 2-3', owner: 'SOC Lead'},
    {id: '343-OB-09', item: 'Set up individual certification study plan aligned with role requirements and career goals', cat: 'Development', day: 'Week 2', owner: 'Hiring Manager'},
    {id: '343-OB-10', item: 'Establish 30-60-90 day goals, define success metrics, and schedule first performance checkpoint', cat: 'Goals', day: 'Week 1', owner: 'Hiring Manager'}
  ];

  private _343MetricsDashboard = [
    {id: '343-MTD-001', name: 'Mean Time to Detect (MTTD)', value: '4.2 hours', trend: 'improving' as const, target: '< 4 hours', source: 'SIEM - Splunk', method: 'Median time from first alert to analyst acknowledgment', owner: 'SOC Manager', sla: '4 hours', prev: '5.1 hours', spark: [5.8, 5.4, 5.1, 4.9, 4.7, 4.5, 4.3, 4.2], breakdown: [{src: 'Network IDS', pct: '35%', avg: '3.8h'}, {src: 'Endpoint EDR', pct: '28%', avg: '4.1h'}, {src: 'Email Gateway', pct: '22%', avg: '3.5h'}, {src: 'Cloud Security', pct: '10%', avg: '5.2h'}, {src: 'User Reports', pct: '5%', avg: '6.8h'}]},
    {id: '343-MTD-002', name: 'Mean Time to Respond (MTTR)', value: '2.8 hours', trend: 'stable' as const, target: '< 3 hours', source: 'SOAR - XSOAR', method: 'Median time from acknowledgment to first containment action', owner: 'IR Lead', sla: '3 hours', prev: '2.7 hours', spark: [3.2, 3.0, 2.9, 2.8, 2.8, 2.9, 2.8, 2.8], breakdown: [{src: 'Auto Playbooks', pct: '42%', avg: '1.2h'}, {src: 'Semi-Auto', pct: '33%', avg: '2.5h'}, {src: 'Manual', pct: '20%', avg: '5.1h'}, {src: 'L3 Escalation', pct: '5%', avg: '8.3h'}]},
    {id: '343-MTD-003', name: 'Patch Compliance Rate', value: '97.6%', trend: 'improving' as const, target: '> 95%', source: 'Tenable.io', method: 'Pct of critical/high vulns patched within SLA windows', owner: 'Vuln Manager', sla: '95%', prev: '96.1%', spark: [93.2, 94.1, 94.8, 95.3, 95.9, 96.4, 97.0, 97.6], breakdown: [{src: 'Critical (7d)', pct: '40%', rate: '99.2%'}, {src: 'High (30d)', pct: '35%', rate: '97.8%'}, {src: 'Medium (90d)', pct: '20%', rate: '95.1%'}, {src: 'Low (180d)', pct: '5%', rate: '89.4%'}]},
    {id: '343-MTD-004', name: 'Phishing Click Rate', value: '3.2%', trend: 'improving' as const, target: '< 5%', source: 'KnowBe4 + Proofpoint', method: 'Pct of users clicking simulated phishing links monthly', owner: 'Awareness Lead', sla: '5%', prev: '4.1%', spark: [6.8, 6.2, 5.5, 5.1, 4.6, 4.1, 3.6, 3.2], breakdown: [{src: 'Spear Phishing', pct: '35%', rate: '5.1%'}, {src: 'Generic Phishing', pct: '30%', rate: '2.8%'}, {src: 'BEC Sim', pct: '20%', rate: '3.5%'}, {src: 'SMS Phishing', pct: '15%', rate: '1.9%'}]},
    {id: '343-MTD-005', name: 'Security Posture Score', value: '784', trend: 'improving' as const, target: '> 750', source: 'SecurityScorecard', method: 'Composite: external 30%, compliance 25%, vuln 25%, config 20%', owner: 'CISO', sla: '> 750', prev: '771', spark: [748, 752, 758, 762, 768, 773, 778, 784], breakdown: [{src: 'External Rating', pct: '30%', score: '791'}, {src: 'Compliance', pct: '25%', score: '812'}, {src: 'Vuln Mgmt', pct: '25%', score: '745'}, {src: 'Config', pct: '20%', score: '769'}]},
    {id: '343-MTD-006', name: 'Vulnerability Backlog', value: '142', trend: 'improving' as const, target: '< 150', source: 'Tenable + Qualys', method: 'Total open vulns across all scanned assets tracked weekly', owner: 'Vuln Manager', sla: '< 150', prev: '168', spark: [210, 198, 185, 175, 165, 158, 150, 142], breakdown: [{src: 'Critical', pct: '8%', count: '11'}, {src: 'High', pct: '22%', count: '31'}, {src: 'Medium', pct: '45%', count: '64'}, {src: 'Low', pct: '25%', count: '36'}]}
  ];

  private _343ArchReview = [
    {id: '343-AR-001', cat: 'Network', item: 'Network segmentation between trust zones with dedicated firewalls and granular ACLs', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Micro-segmentation via NSX across all production zones'},
    {id: '343-AR-002', cat: 'Network', item: 'DMZ architecture isolating public services from internal network', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Dual-firewall DMZ with WAF and DDoS mitigation'},
    {id: '343-AR-003', cat: 'Network', item: 'Least-privilege traffic flows with deny-by-default and quarterly review', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Explicit allow rules with automated drift detection'},
    {id: '343-AR-004', cat: 'Network', item: 'Encrypted external communications with IPSec/TLS 1.3 and PFS', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'IKEv2 with PFS, TLS 1.3 for all external APIs'},
    {id: '343-AR-005', cat: 'Identity', item: 'Centralized IdP with SSO and automated SCIM provisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Okta SSO SAML 2.0 for 247 apps with SCIM'},
    {id: '343-AR-006', cat: 'Identity', item: 'RBAC with quarterly reviews and automated deprovisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Quarterly recertification with JIT admin access'},
    {id: '343-AR-007', cat: 'Identity', item: 'PAM controlling all admin and service accounts with session recording', sev: 'high' as const, status: 'fail' as const, reviewer: 'IAM Lead', notes: '3 legacy accounts pending CyberArk enrollment'},
    {id: '343-AR-008', cat: 'Identity', item: 'MFA enforced for all users, hardware tokens for privileged access', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'FIDO2 for admins, push MFA for users, 99.8% enrollment'},
    {id: '343-AR-009', cat: 'Data', item: 'Data classification enforced with automated labeling on all repos', sev: 'high' as const, status: 'partial' as const, reviewer: 'Data Protection Lead', notes: 'Framework deployed, gaps on 4 legacy file shares'},
    {id: '343-AR-010', cat: 'Data', item: 'AES-256 encryption at rest for all sensitive data stores', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'Full-disk, TDE on DBs, SSE-KMS on cloud storage'},
    {id: '343-AR-011', cat: 'Data', item: 'DLP monitoring and preventing unauthorized data exfiltration', sev: 'high' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'DLP active on email, endpoint, cloud, and network'},
    {id: '343-AR-012', cat: 'Data', item: 'Encrypted off-site backups with quarterly restore testing', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Infrastructure Lead', notes: '3-2-1 strategy with immutable backups'},
    {id: '343-AR-013', cat: 'AppSec', item: 'Secure SDLC with SAST, DAST, SCA in all CI/CD pipelines', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: '34 pipelines with security gates and PR blocking'},
    {id: '343-AR-014', cat: 'AppSec', item: 'API gateway with auth, rate limiting, schema validation', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: 'Kong with OAuth2, rate limits, OpenAPI validation'},
    {id: '343-AR-015', cat: 'AppSec', item: 'Container security with image scanning and runtime protection', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Trivy scanning, Falco runtime in 80% of clusters'},
    {id: '343-AR-016', cat: 'Monitoring', item: 'SIEM collecting from all critical systems with correlation rules', sev: 'critical' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'Splunk 98% coverage with 1200+ correlation rules'},
    {id: '343-AR-017', cat: 'Monitoring', item: 'EDR with behavioral detection on all managed endpoints', sev: 'high' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'CrowdStrike on 99.2% endpoints with 24/7 MDR'},
    {id: '343-AR-018', cat: 'Monitoring', item: 'Executive dashboards with real-time posture visibility', sev: 'medium' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'PowerBI dashboards with weekly exec summaries'},
    {id: '343-AR-019', cat: 'Cloud', item: 'CSPM monitoring and remediating cloud misconfigurations', sev: 'high' as const, status: 'pass' as const, reviewer: 'Cloud Security Lead', notes: 'Prisma Cloud 450+ checks with auto-remediation'},
    {id: '343-AR-020', cat: 'Cloud', item: 'IaC templates scanned before deployment to production', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Checkov for Terraform, cfn-nag for CloudFormation pending'}
  ];

  private _get343RiskProgress(): number {
    return Math.round(this._343RiskAssessmentWorkflow.filter(s => s.status === 'completed').length / this._343RiskAssessmentWorkflow.length * 100);
  }

  private _get343TreatmentSummary(): {total: number; approved: number; avgReduction: number; investment: string} {
    const a = this._343TreatmentOptions.filter(r => r.status === 'approved').length;
    const avg = this._343TreatmentOptions.reduce((s, r) => s + ((r.before - r.after) / r.before * 100), 0) / this._343TreatmentOptions.length;
    return {total: this._343TreatmentOptions.length, approved: a, avgReduction: Math.round(avg), investment: '$1.125M annually'};
  }

  private _get343RuleSummary(): {total: number; passing: number; failing: number; avgRate: number; violations: number} {
    const p = this._343ComplianceRules.filter(r => r.result === 'pass').length;
    const f = this._343ComplianceRules.filter(r => r.result === 'fail').length;
    const avg = this._343ComplianceRules.reduce((s, r) => s + r.passRate, 0) / this._343ComplianceRules.length;
    const v = this._343ComplianceRules.reduce((s, r) => s + r.violations, 0);
    return {total: this._343ComplianceRules.length, passing: p, failing: f, avgRate: Math.round(avg * 10) / 10, violations: v};
  }

  private _get343PipelineStats(): {positions: number; applicants: number; interviewing: number; offers: number; critical: number} {
    const t = this._343TalentPositions.length;
    const a = this._343TalentPositions.reduce((s, p) => s + p.applicants, 0);
    const i = this._343TalentPositions.reduce((s, p) => s + p.interviews, 0);
    const o = this._343TalentPositions.reduce((s, p) => s + p.offers, 0);
    const c = this._343TalentPositions.filter(x => x.urgency === 'critical').length;
    return {positions: t, applicants: a, interviewing: i, offers: o, critical: c};
  }

  private _get343MetricTrends(): {improving: number; stable: number; total: number} {
    const imp = this._343MetricsDashboard.filter(m => m.trend === 'improving').length;
    const stb = this._343MetricsDashboard.filter(m => m.trend === 'stable').length;
    return {improving: imp, stable: stb, total: this._343MetricsDashboard.length};
  }

  private _get343ArchScore(): {total: number; passed: number; failed: number; partial: number; score: number} {
    const p = this._343ArchReview.filter(c => c.status === 'pass').length;
    const f = this._343ArchReview.filter(c => c.status === 'fail').length;
    const pa = this._343ArchReview.filter(c => c.status === 'partial').length;
    return {total: this._343ArchReview.length, passed: p, failed: f, partial: pa, score: Math.round((p / this._343ArchReview.length) * 100)};
  }


  private _z343IncidentScenarios = [
    {id: 'z343-IS-001', name: 'Ransomware Outbreak in Production Environment', category: 'Malware', likelihood: 'Medium', impact: 'Critical', riskScore: 15, playbooks: ['IR-Ransomware-Isolate', 'IR-Ransomware-Eradicate', 'IR-Ransomway-Recover'], estimatedMTTD: '15min', estimatedMTTR: '4h', involvedTeams: ['SOC', 'IR', 'Infrastructure', 'Legal', 'Comms'], keyIndicators: ['Mass file encryption events', 'Ransom note deployment', 'Lateral movement via SMB/RDP', 'Backup deletion attempts'], mitigationControls: ['EDR behavioral detection', 'Network segmentation', 'Immutable backups', 'Email filtering'], lessonsLearned: 'Ensure offline backups are tested quarterly and Ransomware-specific playbooks are updated with latest threat intelligence', lastDrillDate: '2026-03-15', nextDrillDate: '2026-06-15'},
    {id: 'z343-IS-002', name: 'Cloud Misconfiguration Leading to Data Exposure', category: 'Cloud', likelihood: 'High', impact: 'High', riskScore: 16, playbooks: ['IR-Cloud-Misconfig-Assess', 'IR-Cloud-Misconfig-Remediate', 'IR-Cloud-Misconfig-Notify'], estimatedMTTD: '2h', estimatedMTTR: '6h', involvedTeams: ['Cloud Security', 'SOC', 'Data Protection', 'Legal'], keyIndicators: ['Public S3 bucket exposure', 'Overly permissive IAM policies', 'Unencrypted database snapshots', 'Public API endpoint discovery'], mitigationControls: ['CSPM monitoring', 'IAM policy analyzer', 'Automated remediation', 'Cloud audit logging'], lessonsLearned: 'Implement CSPM with auto-remediation for common misconfigurations and conduct monthly cloud configuration reviews', lastDrillDate: '2026-02-20', nextDrillDate: '2026-05-20'},
    {id: 'z343-IS-003', name: 'Insider Threat Data Exfiltration', category: 'Insider', likelihood: 'Low', impact: 'Critical', riskScore: 12, playbooks: ['IR-Insider-Investigate', 'IR-Insider-Contain', 'IR-Insider-Escalate'], estimatedMTTD: '8h', estimatedMTTR: '24h', involvedTeams: ['SOC', 'IR', 'HR', 'Legal', 'IAM'], keyIndicators: ['Anomalous data access patterns', 'Large file downloads to USB or cloud', 'Off-hours access to sensitive systems', 'Accessing data outside normal job scope'], mitigationControls: ['UEBA analytics', 'DLP policies', 'PAM controls', 'Access reviews'], lessonsLearned: 'Strengthen UEBA baselines and implement automated alerts for data access pattern anomalies', lastDrillDate: '2026-01-10', nextDrillDate: '2026-04-10'},
    {id: 'z343-IS-004', name: 'Supply Chain Attack via Compromised Vendor Software', category: 'Supply Chain', likelihood: 'Low', impact: 'Critical', riskScore: 12, playbooks: ['IR-SupplyChain-Detect', 'IR-SupplyChain-Isolate', 'IR-SupplyChain-Remediate'], estimatedMTTD: '24h', estimatedMTTR: '72h', involvedTeams: ['SOC', 'IR', 'Procurement', 'Vendor Mgmt', 'Legal'], keyIndicators: ['Unexpected network connections from vendor software', 'Modified binaries or dependencies', 'Anomalous behavior from trusted applications', 'SBOM discrepancy alerts'], mitigationControls: ['SCA scanning', 'SBOM monitoring', 'Vendor security assessments', 'Network segmentation'], lessonsLearned: 'Require SBOM from all vendors and implement continuous monitoring of third-party component behavior', lastDrillDate: '2026-03-01', nextDrillDate: '2026-06-01'},
    {id: 'z343-IS-005', name: 'Credential Stuffing Attack on Customer Portal', category: 'External Attack', likelihood: 'High', impact: 'Medium', riskScore: 12, playbooks: ['IR-CredentialStuffing-Detect', 'IR-CredentialStuffing-Block', 'IR-CredentialStuffing-Notify'], estimatedMTTD: '30min', estimatedMTTR: '2h', involvedTeams: ['SOC', 'AppSec', 'Customer Support', 'Comms'], keyIndicators: ['High volume of failed login attempts', 'Login attempts from known compromised credential lists', 'Unusual geographic distribution of login attempts', 'Account takeover indicators'], mitigationControls: ['WAF rate limiting', 'CAPTCHA on login', 'MFA enforcement', 'Credential monitoring service'], lessonsLearned: 'Deploy advanced bot detection on login endpoints and implement proactive credential monitoring for customer accounts', lastDrillDate: '2026-04-01', nextDrillDate: '2026-07-01'},
    {id: 'z343-IS-006', name: 'Phishing Campaign Targeting Executive Team', category: 'Social Engineering', likelihood: 'High', impact: 'High', riskScore: 16, playbooks: ['IR-Phishing-Contain', 'IR-Phishing-Investigate', 'IR-Phishing-Notify'], estimatedMTTD: '1h', estimatedMTTR: '4h', involvedTeams: ['SOC', 'Awareness', 'Executive Office', 'IT'], keyIndicators: ['Sophisticated spear-phishing emails to C-suite', 'Business email compromise indicators', 'Redirected MFA approval requests', 'Unauthorized wire transfer attempts'], mitigationControls: ['AI email filtering', 'Executive awareness training', 'Out-of-band verification policy', 'DMARC/DKIM/SPF'], lessonsLearned: 'Implement additional email security controls for executive mailboxes and conduct monthly spear-phishing simulations', lastDrillDate: '2026-02-15', nextDrillDate: '2026-05-15'}
  ];

  private _z343SecurityFrameworks = [
  ...
  private _getz343ScenarioSummary(): {total: number; critical: number; high: number; drilled: number; avgRiskScore: number} {
    const crit = this._z343IncidentScenarios.filter(s => s.impact === 'Critical').length;
    const high = this._z343IncidentScenarios.filter(s => s.impact === 'High').length;
    const avg = this._z343IncidentScenarios.reduce((s, x) => s + x.riskScore, 0) / this._z343IncidentScenarios.length;
    return {total: this._z343IncidentScenarios.length, critical: crit, high: high, drilled: this._z343IncidentScenarios.length, avgRiskScore: Math.round(avg)};
  }

  private _getz343VendorRiskSummary(): {total: number; approved: number; conditional: number; remediation: number; avgScore: number} {
    const approved = this._z343ThirdPartyRiskData.filter(v => v.status === 'approved').length;
    const cond = this._z343ThirdPartyRiskData.filter(v => v.status === 'conditional').length;
    const rem = this._z343ThirdPartyRiskData.filter(v => v.status === 'remediation_required').length;
    const avg = this._z343ThirdPartyRiskData.reduce((s, v) => s + v.riskScore, 0) / this._z343ThirdPartyRiskData.length;
    return {total: this._z343ThirdPartyRiskData.length, approved, conditional: cond, remediation: rem, avgScore: Math.round(avg)};
  }

  private _getz343TrainingSummary(): {total: number; avgCompletion: number; avgScore: number; overdueUpdates: number} {
    const avgComp = this._z343SecurityTrainingCatalog.reduce((s, t) => s + t.completionRate, 0) / this._z343SecurityTrainingCatalog.length;
    const avgScore = this._z343SecurityTrainingCatalog.filter(t => t.avgScore > 0).reduce((s, t) => s + t.avgScore, 0) / this._z343SecurityTrainingCatalog.filter(t => t.avgScore > 0).length;
    return {total: this._z343SecurityTrainingCatalog.length, avgCompletion: Math.round(avgComp * 10) / 10, avgScore: Math.round(avgScore), overdueUpdates: 0};
  }

  private _getz343ToolHealthSummary(): {total: number; healthy: number; degraded: number; annualCost: string} {
    const healthy = this._z343SecurityToolInventory.filter(t => t.health === 'healthy').length;
    const degraded = this._z343SecurityToolInventory.filter(t => t.health === 'degraded').length;
    const cost = this._z343SecurityToolInventory.reduce((s, t) => s + parseInt(t.annualCost.replace(/[^0-9]/g, '')), 0);
    return {total: this._z343SecurityToolInventory.length, healthy, degraded, annualCost: '$' + (cost / 1000).toFixed(0) + 'K'};
  }


  private _x343SecurityZones = [
    {zoneId: 'x343-Z-001', name: 'Internet DMZ', trustLevel: 'Untrusted', subnet: '10.0.0.0/24', segmentation: 'Dual-firewall', firewallRules: 45, monitoring: 'Full packet capture', assets: ['Web servers', 'Load balancers', 'WAF appliances', 'Reverse proxy'], riskLevel: 'high' as const, lastAssessment: '2026-04-15', nextAssessment: '2026-07-15'},
    {zoneId: 'x343-Z-002', name: 'Corporate Network', trustLevel: 'Trusted', subnet: '10.1.0.0/16', segmentation: 'VLAN + micro-seg', firewallRules: 128, monitoring: 'NetFlow + IDS', assets: ['Workstations', 'Printers', 'Meeting room systems', 'VoIP phones'], riskLevel: 'medium' as const, lastAssessment: '2026-04-10', nextAssessment: '2026-07-10'},
    {zoneId: 'x343-Z-003', name: 'Production Data Center', trustLevel: 'Restricted', subnet: '10.2.0.0/16', segmentation: 'Full micro-segmentation', firewallRules: 256, monitoring: 'Full packet capture + EDR', assets: ['Application servers', 'Database clusters', 'Message queues', 'API gateways'], riskLevel: 'low' as const, lastAssessment: '2026-04-12', nextAssessment: '2026-07-12'},
    {zoneId: 'x343-Z-004', name: 'Management Network', trustLevel: 'Restricted', subnet: '10.3.0.0/24', segmentation: 'Isolated VLAN', firewallRules: 32, monitoring: 'Syslog + SNMP', assets: ['Hypervisors', 'Switch management', 'Storage controllers', 'Backup appliances'], riskLevel: 'low' as const, lastAssessment: '2026-04-08', nextAssessment: '2026-07-08'},
    {zoneId: 'x343-Z-005', name: 'Cloud Production', trustLevel: 'Restricted', subnet: 'VPC: 172.16.0.0/12', segmentation: 'Security groups + NACLs', firewallRules: 189, monitoring: 'VPC Flow Logs + GuardDuty', assets: ['Kubernetes clusters', 'Managed databases', 'Object storage', 'Serverless functions'], riskLevel: 'medium' as const, lastAssessment: '2026-04-18', nextAssessment: '2026-07-18'}
  ];

  private _x343SecurityAlerts = [
    {id: 'x343-AL-001', severity: 'critical', title: 'Active ransomware encryption detected on PROD-DB-01', source: 'CrowdStrike', timestamp: '2026-04-22T13:45:00Z', status: 'investigating', assignee: 'SOC Analyst J. Smith', asset: 'PROD-DB-01 (10.2.1.15)', mitreTechnique: 'T1486 - Data Encrypted for Impact', playbook: 'IR-Ransomware-Isolate', sla: '15 minutes', elapsed: '12 minutes', notes: 'EDR detected mass file encryption event pattern. Automated isolation triggered. IR team paged.'},
    {id: 'x343-AL-002', severity: 'high', title: 'Impossible travel detected for user admin@company.com', source: 'Okta', timestamp: '2026-04-22T12:30:00Z', status: 'triaged', assignee: 'SOC Analyst M. Johnson', asset: 'Okta - admin@company.com', mitreTechnique: 'T1078 - Valid Accounts', playbook: 'IR-ImpossibleTravel', sla: '30 minutes', elapsed: '87 minutes', notes: 'Login from Tokyo followed by login from New York within 30 minutes. Account temporarily locked. User confirmed via out-of-band channel they are in New York.'},
    {id: 'x343-AL-003', severity: 'high', title: 'Public S3 bucket discovered with customer PII exposure', source: 'Prisma Cloud', timestamp: '2026-04-22T11:15:00Z', status: 'remediating', assignee: 'Cloud Security Lead A. Chen', asset: 'AWS S3: customer-data-archive-2024', mitreTechnique: 'N/A - Misconfiguration', playbook: 'IR-Cloud-Misconfig-Remediate', sla: '1 hour', elapsed: '2.5 hours', notes: 'Bucket containing archived customer records was publicly accessible. Bucket blocked and encrypted. Data exposure assessment in progress.'},
    {id: 'x343-AL-004', severity: 'medium', title: 'Anomalous data download by user jane.developer@company.com', source: 'Microsoft DLP', timestamp: '2026-04-22T10:00:00Z', status: 'investigating', assignee: 'SOC Analyst R. Davis', asset: 'Endpoint: WS-DEV-042', mitreTechnique: 'T1567 - Exfil Over Web Service', playbook: 'IR-DLP-Investigation', sla: '4 hours', elapsed: '3.5 hours', notes: 'User downloaded 4.2GB of source code files to personal Google Drive. Interview scheduled with user and manager.'},
    {id: 'x343-AL-005', severity: 'medium', title: 'Credential stuffing attack detected on customer portal', source: 'Cloudflare WAF', timestamp: '2026-04-22T09:30:00Z', status: 'contained', assignee: 'SOC Analyst K. Wilson', asset: 'Customer Portal (portal.company.com)', mitreTechnique: 'T1110 - Brute Force', playbook: 'IR-CredentialStuffing-Block', sla: '2 hours', elapsed: '4 hours', notes: 'Rate limiting and CAPTCHA automatically deployed. 12,000 failed login attempts from 800 unique IPs blocked. No successful account takeovers confirmed.'},
    {id: 'x343-AL-006', severity: 'low', title: 'SSL certificate expiring in 14 days for api.company.com', source: 'Certificate monitoring', timestamp: '2026-04-22T08:00:00Z', status: 'remediated', assignee: 'Infrastructure Lead T. Brown', asset: 'api.company.com', mitreTechnique: 'N/A', playbook: 'Certificate Renewal', sla: '30 days', elapsed: '16 days', notes: 'Automated renewal triggered via ACME. New certificate deployed successfully. No service interruption.'}
  ];

  private _x343ComplianceFrameworks = [
  ...
  private _x343DataClassificationPolicy = [
  ...
  private _getx343ZoneSummary(): {total: number; highRisk: number; mediumRisk: number; lowRisk: number; totalRules: number} {
    const high = this._x343SecurityZones.filter(z => z.riskLevel === 'high').length;
    const med = this._x343SecurityZones.filter(z => z.riskLevel === 'medium').length;
    const low = this._x343SecurityZones.filter(z => z.riskLevel === 'low').length;
    const rules = this._x343SecurityZones.reduce((s, z) => s + z.firewallRules, 0);
    return {total: this._x343SecurityZones.length, highRisk: high, mediumRisk: med, lowRisk: low, totalRules: rules};
  }

  private _getx343AlertSummary(): {total: number; critical: number; high: number; medium: number; low: number; open: number; contained: number} {
    const crit = this._x343SecurityAlerts.filter(a => a.severity === 'critical').length;
    const high = this._x343SecurityAlerts.filter(a => a.severity === 'high').length;
    const med = this._x343SecurityAlerts.filter(a => a.severity === 'medium').length;
    const low = this._x343SecurityAlerts.filter(a => a.severity === 'low').length;
    const open = this._x343SecurityAlerts.filter(a => a.status === 'investigating' || a.status === 'triaged').length;
    const contained = this._x343SecurityAlerts.filter(a => a.status === 'contained' || a.status === 'remediated').length;
    return {total: this._x343SecurityAlerts.length, critical: crit, high, medium: med, low, open, contained};
  }

  private _getx343ComplianceSummary(): {total: number; fullyCompliant: number; mostlyCompliant: number; avgComplianceRate: number} {
    const full = this._x343ComplianceFrameworks.filter(f => f.status === 'compliant').length;
    const mostly = this._x343ComplianceFrameworks.filter(f => f.status === 'mostly_compliant').length;
    const avgRate = this._x343ComplianceFrameworks.reduce((s, f) => s + (f.compliant / f.requirements * 100), 0) / this._x343ComplianceFrameworks.length;
    return {total: this._x343ComplianceFrameworks.length, fullyCompliant: full, mostlyCompliant: mostly, avgComplianceRate: Math.round(avgRate * 10) / 10};
  }
  ...
  // === Security Risk Register (deception) ===
  private _deceptionRiskRegister = [
    { id: "RSK-DEC-0001", title: "Data breach from unpatched systems", owner: "CTO", category: "Financial", status: "mitigating", trend: "stable", severity: "critical", likelihood: 8, impact: 1, treatment: "Monitor and review quarterly", lastReview: "2026-04-03", nextReview: "2026-07-23" },
    { id: "RSK-DEC-0002", title: "Ransomware attack on critical infrastructure", owner: "CRO", category: "Strategic", status: "closed", trend: "decreasing", severity: "high", likelihood: 8, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-08", nextReview: "2026-07-15" },
    { id: "RSK-DEC-0003", title: "Insider threat data exfiltration", owner: "VP Eng", category: "Compliance", status: "accepted", trend: "increasing", severity: "critical", likelihood: 7, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-01", nextReview: "2026-07-27" },
    { id: "RSK-DEC-0004", title: "Supply chain compromise", owner: "Security Lead", category: "Technical", status: "open", trend: "stable", severity: "medium", likelihood: 9, impact: 7, treatment: "Monitor and review quarterly", lastReview: "2026-04-15", nextReview: "2026-07-11" },
    { id: "RSK-DEC-0005", title: "Cloud misconfiguration exposure", owner: "Risk Mgr", category: "Reputational", status: "mitigating", trend: "decreasing", severity: "high", likelihood: 8, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-17", nextReview: "2026-07-14" },
    { id: "RSK-DEC-0006", title: "Phishing campaign success rate", owner: "Compliance Dir", category: "Legal", status: "closed", trend: "increasing", severity: "medium", likelihood: 7, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-05", nextReview: "2026-07-01" },
    { id: "RSK-DEC-0007", title: "Third-party vendor data breach", owner: "IT Dir", category: "Regulatory", status: "accepted", trend: "stable", severity: "critical", likelihood: 4, impact: 2, treatment: "Monitor and review quarterly", lastReview: "2026-04-05", nextReview: "2026-07-25" },
    { id: "RSK-DEC-0008", title: "Regulatory non-compliance penalty", owner: "DevOps Lead", category: "Third-Party", status: "open", trend: "decreasing", severity: "high", likelihood: 9, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-17", nextReview: "2026-07-18" },
    { id: "RSK-DEC-0009", title: "Zero-day exploit in production", owner: "Architect", category: "Human Capital", status: "mitigating", trend: "increasing", severity: "medium", likelihood: 8, impact: 4, treatment: "Monitor and review quarterly", lastReview: "2026-04-22", nextReview: "2026-07-20" },
    { id: "RSK-DEC-0010", title: "Insufficient access controls", owner: "CISO", category: "Operational", status: "closed", trend: "stable", severity: "medium", likelihood: 6, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-02", nextReview: "2026-07-07" },
    { id: "RSK-DEC-0011", title: "DDoS attack on services", owner: "CTO", category: "Financial", status: "accepted", trend: "decreasing", severity: "medium", likelihood: 6, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-11", nextReview: "2026-07-23" },
    { id: "RSK-DEC-0012", title: "Social engineering attack", owner: "CRO", category: "Strategic", status: "open", trend: "increasing", severity: "high", likelihood: 1, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-14", nextReview: "2026-07-20" },
    { id: "RSK-DEC-0013", title: "API security vulnerability", owner: "VP Eng", category: "Compliance", status: "mitigating", trend: "stable", severity: "critical", likelihood: 10, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-10", nextReview: "2026-07-20" },
    { id: "RSK-DEC-0014", title: "Mobile device compromise", owner: "Security Lead", category: "Technical", status: "closed", trend: "decreasing", severity: "low", likelihood: 2, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-09", nextReview: "2026-07-21" },
    { id: "RSK-DEC-0015", title: "Physical security breach", owner: "Risk Mgr", category: "Reputational", status: "accepted", trend: "increasing", severity: "low", likelihood: 2, impact: 4, treatment: "Monitor and review quarterly", lastReview: "2026-04-14", nextReview: "2026-07-20" },
    { id: "RSK-DEC-0016", title: "Password policy weakness", owner: "Compliance Dir", category: "Legal", status: "open", trend: "stable", severity: "critical", likelihood: 3, impact: 7, treatment: "Monitor and review quarterly", lastReview: "2026-04-16", nextReview: "2026-07-21" },
    { id: "RSK-DEC-0017", title: "Network segmentation gap", owner: "IT Dir", category: "Regulatory", status: "mitigating", trend: "decreasing", severity: "low", likelihood: 3, impact: 1, treatment: "Monitor and review quarterly", lastReview: "2026-04-22", nextReview: "2026-07-23" },
    { id: "RSK-DEC-0018", title: "Encryption key management failure", owner: "DevOps Lead", category: "Third-Party", status: "closed", trend: "increasing", severity: "low", likelihood: 10, impact: 5, treatment: "Monitor and review quarterly", lastReview: "2026-04-20", nextReview: "2026-07-15" },
    { id: "RSK-DEC-0019", title: "Audit trail tampering", owner: "Architect", category: "Human Capital", status: "accepted", trend: "stable", severity: "medium", likelihood: 9, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-12", nextReview: "2026-07-11" },
    { id: "RSK-DEC-0020", title: "Business email compromise", owner: "CISO", category: "Operational", status: "open", trend: "decreasing", severity: "low", likelihood: 3, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-12", nextReview: "2026-07-01" },
  ];
  private _deceptionRiskFilter: string = 'all';
  private _deceptionRiskSeverity: string = 'all';
  private _deceptionRiskStatus: string = 'all';
  private _deceptionExpandedRisk: string = '';
  private _deceptionFilterRisks() {
    const reg = this._deceptionRiskRegister;
    return reg.filter(r => {
      if (this._deceptionRiskFilter !== "all" && r.category !== this._deceptionRiskFilter) return false;
      if (this._deceptionRiskSeverity !== "all" && r.severity !== this._deceptionRiskSeverity) return false;
      if (this._deceptionRiskStatus !== "all" && r.status !== this._deceptionRiskStatus) return false;
      return true;
    });
  }
  private _deceptionGetRiskScore(r: any) { return Math.round(r.likelihood * r.impact * 1.5); }
  private _deceptionGetRiskTrendIcon(trend: string) {
    if (trend === "increasing") return "\u2191";
    if (trend === "decreasing") return "\u2193";
    return "\u2192";
  }
  private _deceptionGetRiskColor(sev: string) {
    if (sev === "critical") return "#dc2626";
    if (sev === "high") return "#ea580c";
    if (sev === "medium") return "#d97706";
    return "#16a34a";
  }
  private _deceptionGetRiskCounts() {
    const reg = this._deceptionRiskRegister;
  ...
  private _deceptionGetTreatmentProgress() {
    const reg = this._deceptionRiskRegister;
    const treated = reg.filter(r => r.status === "mitigating" || r.status === "closed").length;
    return Math.round((treated / Math.max(reg.length, 1)) * 100);
  }

  // === Security Metrics API Gateway (deception) ===
  private _deceptionApiEndpoints = [
    { method: "GET", path: "/api/v1/threats", name: "Threat Intelligence Feed", status: "active", avgLatency: 300.4, reqPerMin: 1665.0, errorRate: 1.55, uptime: round(97.89290716780546,2), version: "v1.5.2" },
    { method: "POST", path: "/api/v1/scans/start", name: "Vulnerability Scanner", status: "active", avgLatency: 346.6, reqPerMin: 669.0, errorRate: 0.02, uptime: round(99.66340427120508,2), version: "v3.6.17" },
    { method: "GET", path: "/api/v1/assets", name: "Asset Inventory", status: "active", avgLatency: 446.5, reqPerMin: 2058.0, errorRate: 1.59, uptime: round(96.85522952356035,2), version: "v2.8.19" },
    { method: "POST", path: "/api/v1/alerts", name: "Alert Management", status: "active", avgLatency: 241.8, reqPerMin: 167.0, errorRate: 1.49, uptime: round(95.67461870745245,2), version: "v1.6.9" },
    { method: "GET", path: "/api/v1/compliance", name: "Compliance Status", status: "active", avgLatency: 371.2, reqPerMin: 356.0, errorRate: 1.07, uptime: round(98.19692896655238,2), version: "v2.6.16" },
    { method: "PUT", path: "/api/v1/policies", name: "Policy Engine", status: "active", avgLatency: 224.5, reqPerMin: 369.0, errorRate: 1.24, uptime: round(97.9810999582823,2), version: "v1.0.20" },
    { method: "GET", path: "/api/v1/incidents", name: "Incident Tracker", status: "active", avgLatency: 192.0, reqPerMin: 738.0, errorRate: 2.44, uptime: round(95.78129743745524,2), version: "v2.4.17" },
    { method: "POST", path: "/api/v1/forensics", name: "Forensics Collector", status: "degraded", avgLatency: 125.0, reqPerMin: 578.0, errorRate: 0.11, uptime: round(95.75615567786971,2), version: "v2.5.14" },
    { method: "GET", path: "/api/v1/risk/assess", name: "Risk Assessment", status: "active", avgLatency: 121.3, reqPerMin: 936.0, errorRate: 0.05, uptime: round(98.97723294937597,2), version: "v2.8.20" },
    { method: "POST", path: "/api/v1/auth/verify", name: "Authentication", status: "active", avgLatency: 36.7, reqPerMin: 1402.0, errorRate: 1.2, uptime: round(98.18215165491583,2), version: "v1.9.10" },
    { method: "GET", path: "/api/v1/logs/audit", name: "Audit Log Query", status: "active", avgLatency: 447.1, reqPerMin: 539.0, errorRate: 1.18, uptime: round(95.87351286430732,2), version: "v3.1.14" },
    { method: "PUT", path: "/api/v1/users/roles", name: "Role Management", status: "active", avgLatency: 372.9, reqPerMin: 1595.0, errorRate: 1.72, uptime: round(95.30090942253769,2), version: "v2.1.7" },
    { method: "POST", path: "/api/v1/encrypt", name: "Encryption Service", status: "active", avgLatency: 278.7, reqPerMin: 1958.0, errorRate: 1.63, uptime: round(95.57496798077885,2), version: "v3.5.1" },
    { method: "GET", path: "/api/v1/network/topo", name: "Network Topology", status: "maintenance", avgLatency: 129.2, reqPerMin: 1247.0, errorRate: 2.26, uptime: round(96.09602599104596,2), version: "v3.5.20" },
    { method: "DELETE", path: "/api/v1/sessions", name: "Session Manager", status: "active", avgLatency: 208.2, reqPerMin: 494.0, errorRate: 0.08, uptime: round(96.00674218589396,2), version: "v3.0.15" },
  ];
  private _deceptionApiKeys = [
    { id: "ak-000001", name: "key-dece-001", created: "2026-08-11", lastUsed: "2026-04-01", status: "revoked", calls: 8780, rateLimit: 1000 },
    { id: "ak-000002", name: "key-dece-002", created: "2026-08-13", lastUsed: "2026-04-21", status: "active", calls: 23431, rateLimit: 1000 },
    { id: "ak-000003", name: "key-dece-003", created: "2026-06-10", lastUsed: "2026-04-18", status: "active", calls: 24352, rateLimit: 500 },
    { id: "ak-000004", name: "key-dece-004", created: "2026-03-28", lastUsed: "2026-04-14", status: "active", calls: 37716, rateLimit: 5000 },
    { id: "ak-000005", name: "key-dece-005", created: "2026-07-27", lastUsed: "2026-04-21", status: "active", calls: 41302, rateLimit: 100 },
    { id: "ak-000006", name: "key-dece-006", created: "2026-04-27", lastUsed: "2026-04-14", status: "active", calls: 2538, rateLimit: 1000 },
    { id: "ak-000007", name: "key-dece-007", created: "2026-06-09", lastUsed: "2026-04-13", status: "active", calls: 1182, rateLimit: 500 },
    { id: "ak-000008", name: "key-dece-008", created: "2026-04-03", lastUsed: "2026-04-07", status: "revoked", calls: 7877, rateLimit: 5000 },
  ];
  private _deceptionApiHealthSummary() {
    const eps = this._deceptionApiEndpoints;
  ...
  private _deceptionGetApiByMethod(method: string) { return this._deceptionApiEndpoints.filter(e=>e.method===method); }
  private _deceptionGetSlowEndpoints() { return this._deceptionApiEndpoints.filter(e=>e.avgLatency>200).sort((a,b)=>b.avgLatency-a.avgLatency); }
  private _deceptionGetHighErrorEndpoints() { return this._deceptionApiEndpoints.filter(e=>e.errorRate>1.0).sort((a,b)=>b.errorRate-a.errorRate); }

  // === Security Training Effectiveness (deception) ===
  private _deceptionTrainingModules = [
    { id: "TRN-001", name: "Security Fundamentals", completionRate: 90.0, avgScore: 76.1, behaviorChange: 80.2, enrolled: 162, completed: 50, duration: "101min", category: "mandatory" },
    { id: "TRN-002", name: "Phishing Awareness", completionRate: 77.7, avgScore: 64.8, behaviorChange: 48.8, enrolled: 142, completed: 178, duration: "101min", category: "mandatory" },
    { id: "TRN-003", name: "Social Engineering Defense", completionRate: 92.3, avgScore: 82.3, behaviorChange: 31.9, enrolled: 105, completed: 132, duration: "32min", category: "optional" },
    { id: "TRN-004", name: "Password Hygiene", completionRate: 91.2, avgScore: 79.0, behaviorChange: 89.0, enrolled: 78, completed: 110, duration: "91min", category: "mandatory" },
    { id: "TRN-005", name: "Data Classification", completionRate: 86.7, avgScore: 78.2, behaviorChange: 73.5, enrolled: 334, completed: 446, duration: "119min", category: "mandatory" },
    { id: "TRN-006", name: "Incident Response Basics", completionRate: 78.9, avgScore: 68.6, behaviorChange: 71.9, enrolled: 113, completed: 385, duration: "109min", category: "mandatory" },
    { id: "TRN-007", name: "Secure Coding", completionRate: 85.8, avgScore: 59.8, behaviorChange: 59.2, enrolled: 359, completed: 353, duration: "62min", category: "optional" },
    { id: "TRN-008", name: "Cloud Security", completionRate: 82.2, avgScore: 85.9, behaviorChange: 73.7, enrolled: 322, completed: 141, duration: "104min", category: "mandatory" },
    { id: "TRN-009", name: "Mobile Device Security", completionRate: 75.4, avgScore: 69.2, behaviorChange: 37.6, enrolled: 445, completed: 381, duration: "96min", category: "mandatory" },
    { id: "TRN-010", name: "Network Security", completionRate: 70.2, avgScore: 64.0, behaviorChange: 32.3, enrolled: 327, completed: 59, duration: "99min", category: "mandatory" },
    { id: "TRN-011", name: "Physical Security", completionRate: 79.7, avgScore: 59.1, behaviorChange: 83.5, enrolled: 430, completed: 61, duration: "25min", category: "optional" },
    { id: "TRN-012", name: "Regulatory Compliance", completionRate: 97.6, avgScore: 74.8, behaviorChange: 73.3, enrolled: 84, completed: 31, duration: "58min", category: "mandatory" },
    { id: "TRN-013", name: "Risk Management", completionRate: 71.9, avgScore: 70.2, behaviorChange: 89.3, enrolled: 475, completed: 161, duration: "41min", category: "mandatory" },
    { id: "TRN-014", name: "Cryptography Basics", completionRate: 76.3, avgScore: 85.7, behaviorChange: 71.2, enrolled: 435, completed: 339, duration: "98min", category: "mandatory" },
    { id: "TRN-015", name: "Access Control", completionRate: 75.1, avgScore: 62.9, behaviorChange: 78.5, enrolled: 225, completed: 199, duration: "46min", category: "optional" },
    { id: "TRN-016", name: "Vendor Management", completionRate: 59.8, avgScore: 92.8, behaviorChange: 46.1, enrolled: 349, completed: 236, duration: "105min", category: "mandatory" },
  ];
  private _deceptionPhishingResults = [
    { month: "2026-01", sent: 383, clicked: 78, reported: 91, clickRate: round(20.365535248041773,1), reportRate: round(23.759791122715406,1) },
    { month: "2026-02", sent: 933, clicked: 105, reported: 276, clickRate: round(11.254019292604502,1), reportRate: round(29.581993569131832,1) },
    { month: "2026-03", sent: 834, clicked: 195, reported: 347, clickRate: round(23.381294964028775,1), reportRate: round(41.60671462829736,1) },
    { month: "2026-04", sent: 354, clicked: 95, reported: 174, clickRate: round(26.836158192090398,1), reportRate: round(49.152542372881356,1) },
    { month: "2026-05", sent: 224, clicked: 59, reported: 49, clickRate: round(26.339285714285715,1), reportRate: round(21.875,1) },
    { month: "2026-06", sent: 736, clicked: 103, reported: 114, clickRate: round(13.994565217391305,1), reportRate: round(15.489130434782608,1) },
  ];
  private _deceptionTrainingROI = { totalInvestment: 194476, avgCostPerEmployee: 370, riskReductionPct: round(random.uniform(15,45),1), incidentReductionPct: round(random.uniform(10,35),1), complianceScoreGain: round(random.uniform(5,25),1) };
  private _deceptionLearningPaths = [
    { name: "Beginner Security Analyst", totalModules: 20, completedModules: 13, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 78, enrolled: 194 },
    { name: "Advanced Threat Hunter", totalModules: 16, completedModules: 9, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 28, enrolled: 157 },
    { name: "Security Architect", totalModules: 8, completedModules: 10, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 51, enrolled: 43 },
    { name: "Incident Responder", totalModules: 14, completedModules: 13, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 11, enrolled: 123 },
    { name: "Compliance Specialist", totalModules: 18, completedModules: 13, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 80, enrolled: 84 },
    { name: "DevSecOps Engineer", totalModules: 11, completedModules: 10, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 51, enrolled: 54 },
  ];
  private _deceptionGetOverallCompletion() {
    const mods = this._deceptionTrainingModules;
    return round(mods.reduce((s,m)=>s+m.completionRate,0)/mods.length,1);
  }
  private _deceptionGetTopPerformers() { return [...this._deceptionTrainingModules].sort((a,b)=>b.avgScore-a.avgScore).slice(0,5); }
  private _deceptionGetModulesNeedingAttention() { return this._deceptionTrainingModules.filter(m=>m.completionRate<70||m.avgScore<65); }

  // === Security Governance Framework (deception) ===
  private _deceptionGovBodies = [
    { name: "Security Steering Committee", members: 5, chair: "CISO", meetingFreq: "Weekly", lastMeeting: "2026-04-20", nextMeeting: "2026-05-08", quorum: 6 },
    { name: "Risk Management Board", members: 7, chair: "CTO", meetingFreq: "Bi-weekly", lastMeeting: "2026-04-06", nextMeeting: "2026-05-05", quorum: 8 },
    { name: "Data Governance Council", members: 15, chair: "CRO", meetingFreq: "Monthly", lastMeeting: "2026-04-22", nextMeeting: "2026-05-06", quorum: 7 },
    { name: "Compliance Oversight Board", members: 5, chair: "CDO", meetingFreq: "Monthly", lastMeeting: "2026-04-05", nextMeeting: "2026-05-09", quorum: 3 },
    { name: "Architecture Review Board", members: 10, chair: "VP Eng", meetingFreq: "Bi-weekly", lastMeeting: "2026-04-22", nextMeeting: "2026-05-14", quorum: 7 },
    { name: "Change Advisory Board", members: 8, chair: "CISO", meetingFreq: "Weekly", lastMeeting: "2026-04-21", nextMeeting: "2026-05-12", quorum: 8 },
    { name: "Incident Review Board", members: 5, chair: "CIO", meetingFreq: "As needed", lastMeeting: "2026-04-22", nextMeeting: "2026-05-25", quorum: 7 },
    { name: "Vendor Risk Committee", members: 11, chair: "CFO", meetingFreq: "Quarterly", lastMeeting: "2026-04-12", nextMeeting: "2026-05-06", quorum: 8 },
  ];
  private _deceptionDecisions = [
    { id: "DEC-0001", title: "Adopt zero-trust architecture framework", date: "2026-03-19", status: "approved", owner: "CISO" },
    { id: "DEC-0002", title: "Migrate to SIEM 2.0 platform", date: "2026-01-15", status: "implemented", owner: "CTO" },
    { id: "DEC-0003", title: "Implement DLP across all endpoints", date: "2026-04-27", status: "in-progress", owner: "Security Lead" },
    { id: "DEC-0004", title: "Mandate MFA for all external access", date: "2026-01-16", status: "pending", owner: "CRO" },
    { id: "DEC-0005", title: "Establish bug bounty program", date: "2026-01-28", status: "approved", owner: "VP Eng" },
    { id: "DEC-0006", title: "Deploy EDR solution enterprise-wide", date: "2026-04-13", status: "approved", owner: "CISO" },
  ...
  private _deceptionPolicyLifecycle = [
    { name: "Information Security Policy", version: "v4.3", status: "active", lastUpdated: "2026-04-03", nextReview: "2026-12-15", owner: "CISO" },
    { name: "Acceptable Use Policy", version: "v3.5", status: "active", lastUpdated: "2026-03-26", nextReview: "2026-10-05", owner: "Legal" },
    { name: "Data Retention Policy", version: "v4.4", status: "under-review", lastUpdated: "2026-03-05", nextReview: "2026-10-19", owner: "DPO" },
    { name: "Access Control Policy", version: "v1.5", status: "active", lastUpdated: "2026-01-19", nextReview: "2026-10-18", owner: "IAM Lead" },
    { name: "Incident Response Policy", version: "v2.0", status: "draft", lastUpdated: "2026-01-25", nextReview: "2026-8-15", owner: "IR Lead" },
    { name: "Business Continuity Plan", version: "v1.5", status: "active", lastUpdated: "2026-01-12", nextReview: "2026-8-01", owner: "BCP Mgr" },
    { name: "Vendor Management Policy", version: "v2.0", status: "active", lastUpdated: "2026-01-27", nextReview: "2026-7-04", owner: "Procurement" },
    { name: "Encryption Standard", version: "v4.2", status: "under-review", lastUpdated: "2026-01-21", nextReview: "2026-8-24", owner: "Security Arch" },
  ];
  private _deceptionGovMaturityScore = { overall: 3.0, riskManagement: 3.4, compliance: 3.0, incidentResponse: 2.6, awareness: 3.6, technology: 4.3 };
  private _deceptionGetPendingDecisions() { return this._deceptionDecisions.filter(d=>d.status==='pending'||d.status==='in-progress'); }
  private _deceptionGetActivePolicies() { return this._deceptionPolicyLifecycle.filter(p=>p.status==='active'); }
  private _deceptionGetEscalationPath() { return ["L1 Analyst","L2 Senior","Security Lead","CISO","Board"]; }

  // === Security Innovation Lab (deception) ===
  private _deceptionInnoProjects = [
    { id: "INN-001", name: "AI-Powered Threat Detection", description: "Machine learning models for real-time threat identification", status: "active", progress: 72, startDate: "2026-01-18", teamSize: 6, budget: 144476, milestones: 4, completedMilestones: 7 },
    { id: "INN-002", name: "Quantum-Resistant Cryptography", description: "Post-quantum encryption algorithm prototyping", status: "research", progress: 35, startDate: "2026-01-24", teamSize: 3, budget: 104256, milestones: 7, completedMilestones: 2 },
    { id: "INN-003", name: "Automated Red Teaming", description: "Autonomous penetration testing framework", status: "active", progress: 58, startDate: "2026-03-28", teamSize: 7, budget: 183553, milestones: 3, completedMilestones: 2 },
    { id: "INN-004", name: "Zero-Knowledge Authentication", description: "Privacy-preserving identity verification", status: "poc", progress: 88, startDate: "2026-02-28", teamSize: 5, budget: 146649, milestones: 9, completedMilestones: 4 },
    { id: "INN-005", name: "Blockchain Audit Trail", description: "Immutable security event logging", status: "active", progress: 45, startDate: "2026-02-09", teamSize: 4, budget: 45120, milestones: 8, completedMilestones: 6 },
    { id: "INN-006", name: "Behavioral Biometrics", description: "Continuous authentication via user behavior patterns", status: "research", progress: 22, startDate: "2026-03-01", teamSize: 8, budget: 10596, milestones: 8, completedMilestones: 9 },
    { id: "INN-007", name: "Deception Grid 2.0", description: "Advanced honeypot network with adaptive responses", status: "active", progress: 65, startDate: "2026-02-10", teamSize: 6, budget: 34855, milestones: 10, completedMilestones: 3 },
    { id: "INN-008", name: "Secure Enclave Integration", description: "Hardware-backed security for critical workloads", status: "poc", progress: 40, startDate: "2026-02-01", teamSize: 6, budget: 72644, milestones: 3, completedMilestones: 5 },
  ];
  private _deceptionTechEvaluations = [
    { name: "Rust for Security Tools", status: "evaluating", score: 7.0, recommendation: "Adopt", vendor: "Open Source" },
    { name: "eBPF for Runtime Detection", status: "completed", score: 3.6, recommendation: "Adopt", vendor: "AWS" },
    ...
    { name: "SOAR Platform 3.0", status: "planned", score: 10.7, recommendation: "Monitor", vendor: "Splunk" },
  ];
  private _deceptionCollaborationPartners = [
  ...
  private _deceptionInnoMetrics = { totalProjects: 8, activeProjects: 4, avgTimeToValue: "145 days", pocSuccessRate: round(random.uniform(55,85),1), researchToProduction: round(random.uniform(20,50),1), innovationIndex: round(random.uniform(6.0,9.5),1) };
  private _deceptionGetProjectByStatus(status: string) { return this._deceptionInnoProjects.filter(p=>p.status===status); }
  private _deceptionGetTopEvaluations() { return [...this._deceptionTechEvaluations].sort((a,b)=>b.score-a.score).slice(0,3); }



  // === Compliance Dashboard Extension (deception) ===
  private _deceptionComplianceFrameworks = [
    { name: "SOC 2 Type II", description: "Trust Services Criteria", totalControls: 5, implementedControls: 3, status: "in-review", lastAudit: "2026-01-05", nextAudit: "2026-11-28", evidenceCount: 68 },
    { name: "ISO 27001", description: "Information Security Management", totalControls: 114, implementedControls: 69, status: "in-review", lastAudit: "2026-02-14", nextAudit: "2026-8-15", evidenceCount: 474 },
    { name: "PCI DSS 4.0", description: "Payment Card Industry", totalControls: 12, implementedControls: 6, status: "non-compliant", lastAudit: "2026-02-26", nextAudit: "2026-11-21", evidenceCount: 411 },
    { name: "HIPAA", description: "Health Insurance Portability", totalControls: 18, implementedControls: 10, status: "partially-compliant", lastAudit: "2026-01-07", nextAudit: "2026-12-06", evidenceCount: 144 },
    { name: "GDPR", description: "Data Protection Regulation", totalControls: 99, implementedControls: 76, status: "partially-compliant", lastAudit: "2026-03-06", nextAudit: "2026-11-08", evidenceCount: 477 },
    { name: "NIST CSF 2.0", description: "Cybersecurity Framework", totalControls: 6, implementedControls: 4, status: "partially-compliant", lastAudit: "2026-04-28", nextAudit: "2026-8-09", evidenceCount: 442 },
    { name: "FedRAMP", description: "Federal Risk Authorization", totalControls: 15, implementedControls: 10, status: "compliant", lastAudit: "2026-04-22", nextAudit: "2026-8-13", evidenceCount: 217 },
    { name: "SOX", description: "Sarbanes-Oxley Compliance", totalControls: 8, implementedControls: 8, status: "non-compliant", lastAudit: "2026-03-19", nextAudit: "2026-10-13", evidenceCount: 495 },
    { name: "CIS Controls v8", description: "Center for Internet Security", totalControls: 18, implementedControls: 16, status: "compliant", lastAudit: "2026-01-27", nextAudit: "2026-11-18", evidenceCount: 307 },
    { name: "COBIT 2019", description: "IT Governance Framework", totalControls: 40, implementedControls: 32, status: "non-compliant", lastAudit: "2026-03-16", nextAudit: "2026-9-26", evidenceCount: 328 },
  ];
  private _deceptionGetComplianceScore() {
    const fw = this._deceptionComplianceFrameworks;
    return round(fw.reduce((s,f)=>s + (f.implementedControls/Math.max(f.totalControls,1))*100, 0) / fw.length, 1);
  }
  private _deceptionGetGaps() {
    return this._deceptionComplianceFrameworks.filter(f => f.status !== "compliant");
  }
  private _deceptionAuditTrail = [
    { id: "AUD-0001", action: "Control tested", auditor: "Internal Audit", date: "2026-04-16", result: "pass", findings: 1 },
    { id: "AUD-0002", action: "Evidence collected", auditor: "External Auditor", date: "2026-04-10", result: "pass", findings: 1 },
    { id: "AUD-0003", action: "Gap identified", auditor: "Security Team", date: "2026-04-04", result: "fail", findings: 1 },
    { id: "AUD-0004", action: "Remediation completed", auditor: "Compliance Officer", date: "2026-04-12", result: "pass", findings: 2 },
    { id: "AUD-0005", action: "Policy updated", auditor: "IT Audit", date: "2026-04-14", result: "pass", findings: 1 },
    { id: "AUD-0006", action: "Training verified", auditor: "Risk Team", date: "2026-04-15", result: "pass", findings: 1 },
    { id: "AUD-0007", action: "Access reviewed", auditor: "QA Team", date: "2026-04-18", result: "pass", findings: 2 },
    { id: "AUD-0008", action: "Exception approved", auditor: "CISO Office", date: "2026-04-10", result: "conditional", findings: 4 },
    { id: "AUD-0009", action: "Risk accepted", auditor: "Board Audit", date: "2026-04-03", result: "pass", findings: 1 },
    { id: "AUD-0010", action: "Control enhanced", auditor: "Third Party", date: "2026-04-09", result: "pass", findings: 0 },
  ];

  // === Threat Intelligence Feed Extension (deception) ===
  private _deceptionThreatActors = [
    { name: "APT-29", alias: "Cozy Bear", origin: "Russia", type: "Nation-State", severity: "high", lastActivity: "2026-04-08", targets: "Manufacturing", indicators: 73, ttps: 47 },
    { name: "APT-41", alias: "Double Dragon", origin: "China", type: "Nation-State", severity: "critical", lastActivity: "2026-04-23", targets: "Manufacturing", indicators: 270, ttps: 49 },
    { name: "Lazarus Group", alias: "Hidden Cobra", origin: "North Korea", type: "Nation-State", severity: "critical", lastActivity: "2026-04-08", targets: "Finance", indicators: 58, ttps: 39 },
    { name: "FIN7", alias: "Carbanak", origin: "Eastern Europe", type: "Financial", severity: "high", lastActivity: "2026-04-03", targets: "Energy", indicators: 171, ttps: 44 },
    { name: "Conti", alias: "Wizard Spider", origin: "Russia", type: "Ransomware", severity: "critical", lastActivity: "2026-04-16", targets: "Government", indicators: 483, ttps: 14 },
    { name: "LockBit", alias: "LockBit Gang", origin: "Unknown", type: "Ransomware", severity: "high", lastActivity: "2026-04-11", targets: "Energy", indicators: 373, ttps: 6 },
    { name: "Cl0p", alias: "Cl0p Team", origin: "Unknown", type: "Ransomware", severity: "high", lastActivity: "2026-04-18", targets: "Government", indicators: 73, ttps: 44 },
    { name: "Sandworm", alias: "Unit 74455", origin: "Russia", type: "Nation-State", severity: "critical", lastActivity: "2026-04-23", targets: "Government", indicators: 305, ttps: 49 },
  ];
  private _deceptionIoCFeed = [
    { id: "ioc-000001", type: "ip", value: "153.202.75.236", confidence: 93, source: "MISP", firstSeen: "2026-04-02", lastSeen: "2026-04-20" },
    { id: "ioc-000002", type: "ip", value: "55.57.101.82", confidence: 79, source: "MISP", firstSeen: "2026-04-15", lastSeen: "2026-04-06" },
    { id: "ioc-000003", type: "ip", value: "174.78.137.12", confidence: 54, source: "CrowdStrike", firstSeen: "2026-04-03", lastSeen: "2026-04-16" },
    { id: "ioc-000004", type: "ip", value: "19.209.154.189", confidence: 61, source: "CrowdStrike", firstSeen: "2026-04-08", lastSeen: "2026-04-02" },
    { id: "ioc-000005", type: "ip", value: "124.180.124.11", confidence: 40, source: "Mandiant", firstSeen: "2026-04-23", lastSeen: "2026-04-12" },
    { id: "ioc-000006", type: "ip", value: "30.9.224.201", confidence: 62, source: "VirusTotal", firstSeen: "2026-04-03", lastSeen: "2026-04-09" },
    { id: "ioc-000007", type: "ip", value: "102.3.189.245", confidence: 57, source: "VirusTotal", firstSeen: "2026-04-06", lastSeen: "2026-04-21" },
    { id: "ioc-000008", type: "ip", value: "35.130.143.147", confidence: 45, source: "VirusTotal", firstSeen: "2026-04-02", lastSeen: "2026-04-03" },
    { id: "ioc-000009", type: "ip", value: "235.241.106.209", confidence: 85, source: "VirusTotal", firstSeen: "2026-04-05", lastSeen: "2026-04-11" },
    { id: "ioc-000010", type: "ip", value: "100.110.226.220", confidence: 83, source: "Mandiant", firstSeen: "2026-04-20", lastSeen: "2026-04-07" },
    { id: "ioc-000011", type: "ip", value: "9.154.235.194", confidence: 66, source: "CrowdStrike", firstSeen: "2026-04-01", lastSeen: "2026-04-06" },
    { id: "ioc-000012", type: "ip", value: "77.226.188.192", confidence: 82, source: "MISP", firstSeen: "2026-04-03", lastSeen: "2026-04-08" },
    { id: "ioc-000013", type: "ip", value: "232.22.251.86", confidence: 87, source: "AlienVault", firstSeen: "2026-04-19", lastSeen: "2026-04-08" },
    { id: "ioc-000014", type: "ip", value: "114.205.105.188", confidence: 70, source: "Mandiant", firstSeen: "2026-04-13", lastSeen: "2026-04-07" },
    { id: "ioc-000015", type: "ip", value: "82.105.92.192", confidence: 89, source: "MISP", firstSeen: "2026-04-13", lastSeen: "2026-04-01" },
  ];
  private _deceptionGetActiveThreats() { return this._deceptionThreatActors.filter(a => a.severity === 'critical'); }
  private _deceptionGetThreatSummary() {
    const actors = this._deceptionThreatActors;
  ...
  // === Incident Management Extension (deception) ===
  private _deceptionIncidents = [
    { id: "INC-20260001", title: "Unauthorized access detected", severity: "critical", status: "open", assignedTo: "SOC L1", detectedAt: "2026-04-15T03:46", affectedAssets: 10, rootCause: "Misconfiguration" },
    { id: "INC-20260002", title: "Malware outbreak on workstation", severity: "high", status: "investigating", assignedTo: "SOC L2", detectedAt: "2026-04-11T04:39", affectedAssets: 8, rootCause: "Credential compromise" },
    { id: "INC-20260003", title: "Data leak from S3 bucket", severity: "medium", status: "contained", assignedTo: "IR Lead", detectedAt: "2026-04-18T20:22", affectedAssets: 43, rootCause: "Zero-day" },
    { id: "INC-20260004", title: "Phishing campaign targeting finance", severity: "low", status: "eradicated", assignedTo: "CISO", detectedAt: "2026-04-06T08:48", affectedAssets: 3, rootCause: "Human error" },
    { id: "INC-20260005", title: "DDoS attack on web services", severity: "critical", status: "recovered", assignedTo: "Security Eng", detectedAt: "2026-04-06T01:34", affectedAssets: 34, rootCause: "Policy violation" },
    { id: "INC-20260006", title: "Ransomware encryption attempt", severity: "high", status: "closed", assignedTo: "Forensics", detectedAt: "2026-04-23T12:51", affectedAssets: 44, rootCause: "Unknown" },
    { id: "INC-20260007", title: "Insider data exfiltration", severity: "medium", status: "open", assignedTo: "SOC L1", detectedAt: "2026-04-21T16:31", affectedAssets: 17, rootCause: "Misconfiguration" },
    { id: "INC-20260008", title: "API key exposure in repo", severity: "low", status: "investigating", assignedTo: "SOC L2", detectedAt: "2026-04-08T20:15", affectedAssets: 42, rootCause: "Credential compromise" },
    { id: "INC-20260009", title: "SQL injection on portal", severity: "critical", status: "contained", assignedTo: "IR Lead", detectedAt: "2026-04-15T06:29", affectedAssets: 5, rootCause: "Zero-day" },
    { id: "INC-20260010", title: "Brute force on VPN", severity: "high", status: "eradicated", assignedTo: "CISO", detectedAt: "2026-04-07T14:53", affectedAssets: 41, rootCause: "Human error" },
    { id: "INC-20260011", title: "Supply chain alert from vendor", severity: "medium", status: "recovered", assignedTo: "Security Eng", detectedAt: "2026-04-19T18:21", affectedAssets: 47, rootCause: "Policy violation" },
    { id: "INC-20260012", title: "Suspicious lateral movement", severity: "low", status: "closed", assignedTo: "Forensics", detectedAt: "2026-04-19T22:10", affectedAssets: 26, rootCause: "Unknown" },
  ];
  private _deceptionGetIncidentStats() {
    const inc = this._deceptionIncidents;
    return { total: inc.length, open: inc.filter(i=>i.status==="open").length, investigating: inc.filter(i=>i.status==="investigating").length, mttd: 19, mttr: 113 };
  }
  private _deceptionGetSeverityDistribution() {
    const inc = this._deceptionIncidents;
  ...
  render() {    if (this._decRules.length === 0) { this._initDecRules(); this._initDecCvss(); this._runDecAnomalyDetection(); this._generateDecPredictions(); this._initDecApprovals(); this._initDecActivity(); this._initDecNotifications(); }
...
<div class="tabs">
        ...
        ${this._activeTab === 'rules' ? html`
          ${this._renderDecRules()}
          <div style="margin-top:12px;font-size:11px;font-weight:600;margin-bottom:6px">Category Treemap</div>
          <div style="background:#1a1d27;border-radius:8px;padding:12px">${this._renderDecTreemapSVG()}</div>
          <div style="margin-top:12px;font-size:11px;font-weight:600;margin-bottom:6px">Data Flow (Sankey)</div>
          <div style="background:#1a1d27;border-radius:8px;padding:12px">${this._renderDecSankeySVG()}</div>
          ${this._renderDecActivity()}
        ` : nothing}
        ${this._activeTab === 'anomalies' ? html`
          ${this._renderDecAnomalies()}
          ${this._renderDecNotifications()}
        ` : nothing}
        ${this._activeTab === 'predictions' ? html`
          ${this._renderDecPredictions()}
          ...
          <div style="background:#1a1d27;border-radius:8px;padding:12px">
            <table class="history-table"><thead><tr><th>ID</th><th>Base</th><th>Temporal</th><th>Environmental</th><th>Overall</th></tr></thead><tbody>
              ${this._deccvssData.map(c => html`<tr><td>${c.itemId}</td><td style="color:${c.base >= 7 ? '#ef4444' : c.base >= 4 ? '#eab308' : '#22c55e'}">${c.base}</td><td>${c.temporal}</td><td>${c.environmental}</td><td style="font-weight:700;color:${c.overall >= 7 ? '#ef4444' : c.overall >= 4 ? '#eab308' : '#22c55e'}">${c.overall}</td></tr>`)}
            </tbody></table>
          </div>
        ` : nothing}
        ${this._activeTab === 'approvals' ? html`
          ${this._renderDecApprovals()}
        ` : nothing}
        ${this._activeTab === 'config' ? html`
          ${this._renderDecConfig()}
        ` : nothing}
        ${this._activeTab === 'new' ? html`
          <div class="form-section">
            <div class="form-title">Create New Deception Entry</div>
            <div class="form-grid">
  ...
  @state() private _dScenarios: {id:string;name:string;attackType:string;target:string;method:string;impactLow:number;impactHigh:number;confidence:number;mitigation:string;status:string}[] = [];
  @state() private _dScenarioForm: {attackType:string;target:string;method:string} = {attackType:'',target:'',method:''};
  @state() private _dScenarioCompare: boolean = false;
  @state() private _dScenarioSelected: string[] = [];

  private _dInitScenarios(): void {
    const saved = localStorage.getItem('d_scenarios');
    if (saved) { try { this._dScenarios = JSON.parse(saved); } catch { /* ignore */ } }
    if (this._dScenarios.length === 0) {
      this._dScenarios = [
        {id:'d-s1',name:'Baseline Threat',attackType:'Phishing',target:'Employees',method:'Spear Email',impactLow:45,impactHigh:78,confidence:72,mitigation:'Security awareness training + email filtering',status:'active'},
        {id:'d-s2',name:'Escalated Attack',attackType:'Ransomware',target:'Endpoints',method:'Drive-by Download',impactLow:65,impactHigh:95,confidence:58,mitigation:'EDR deployment + network segmentation',status:'saved'},
        {id:'d-s3',name:'Insider Threat',attackType:'Data Exfiltration',target:'Databases',method:'SQL Injection',impactLow:55,impactHigh:88,confidence:65,mitigation:'DLP policies + query monitoring',status:'draft'},
      ];
    }
  }

  private _dSaveScenarios(): void {
    localStorage.setItem('d_scenarios', JSON.stringify(this._dScenarios));
  }

  private _dAddScenario(): void {
    const f = this._dScenarioForm;
    if (!f.attackType || !f.target) return;
    this._dScenarios = [...this._dScenarios, {
      id: 'd-s' + (this._dScenarios.length + 1),
    ...
    this._dScenarioForm = {attackType:'',target:'',method:''};
    this._dSaveScenarios();
  }

  private _dRenderScenarioEngine(): any {
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <button class="tab" @click=${() => { this._dScenarioCompare = !this._dScenarioCompare; }}>${this._dScenarioCompare ? 'List View' : 'Compare'}</button>
        </div>
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:6px;margin-bottom:10px">
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._dScenarioForm = {...this._dScenarioForm, attackType: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Attack Type</option>
            ${attackTypes.map(a => html`<option value=${a} ${this._dScenarioForm.attackType === a ? 'selected' : ''}>${a}</option>`)}
          </select>
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._dScenarioForm = {...this._dScenarioForm, target: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Target</option>
            ${targets.map(t => html`<option value=${t} ${this._dScenarioForm.target === t ? 'selected' : ''}>${t}</option>`)}
          </select>
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._dScenarioForm = {...this._dScenarioForm, method: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Method</option>
            ${methods.map(m => html`<option value=${m} ${this._dScenarioForm.method === m ? 'selected' : ''}>${m}</option>`)}
          </select>
        </div>
        <button style="background:#3b82f6;border:none;border-radius:4px;padding:4px 12px;color:#fff;font-size:11px;cursor:pointer" @click=${this._dAddScenario}>Run Simulation</button>
      </div>
      ${this._dScenarioCompare && this._dScenarios.length >= 2 ? html`
        <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
          <div style="font-weight:600;font-size:12px;color:#e2e8f0;margin-bottom:8px">Side-by-Side Comparison</div>
          <div style="display:grid;grid-template-columns:repeat(${Math.min(3, this._dScenarios.length)},1fr);gap:8px">
            ${this._dScenarios.slice(0,3).map(s => html`
      ...
      <div style="background:#0f1117;border-radius:8px;padding:12px">
        <div style="font-weight:600;font-size:12px;color:#e2e8f0;margin-bottom:8px">Saved Scenarios (${this._dScenarios.length})</div>
        ${this._dScenarios.map(s => html`
  ...
  @state() private _dTrendData: {day:number;value:number;anomaly:boolean}[] = [];
  @state() private _dTrendZoom: {start:number;end:number} | null = null;
  @state() private _dTrendMA: number = 7;

  private _dInitTrendData(): void {
    ...
    this._dTrendData = data;
  }

  private _dCalcMA(window: number): number[] {
    const result: number[] = [];
    for (let i = 0; i < this._dTrendData.length; i++) {
      const start = Math.max(0, i - window + 1);
      const slice = this._dTrendData.slice(start, i + 1);
      result.push(slice.reduce((s, d) => s + d.value, 0) / slice.length);
    }
    return result;
  }

  private _dGetStats(): {mean:number;median:number;stddev:number;trend:string} {
    const vals = this._dTrendData.map(d => d.value);
    const n = vals.length;
  ...
  private _dRenderTimeSeries(): any {
    const stats = this._dGetStats();
    const filtered = this._dTrendZoom ? this._dTrendData.filter(d => d.day >= this._dTrendZoom.start && d.day <= this._dTrendZoom.end) : this._dTrendData;
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px">
            <button class="tab ${this._dTrendMA === 7 ? 'active' : ''}" @click=${() => { this._dTrendMA = 7; }}>7D MA</button>
            <button class="tab ${this._dTrendMA === 30 ? 'active' : ''}" @click=${() => { this._dTrendMA = 30; }}>30D MA</button>
            <button class="tab" @click=${() => { this._dTrendZoom = null; }}>Reset Zoom</button>
          </div>
        </div>
        <div style="position:relative;height:120px;background:#1a1d2e;border-radius:6px;overflow:hidden;margin-bottom:8px;cursor:crosshair" @click=${(e: any) => {
          ...
          this._dTrendZoom = { start: Math.max(0, center - 10), end: Math.min(89, center + 10) };
        }}>
  ...
  @state() private _dRoles: string[] = ['Admin','Analyst','Operator','Viewer','Auditor'];
  @state() private _dActions: string[] = ['Create','Read','Update','Delete','Export','Approve'];
  @state() private _dPermissions: { [role: string]: { [action: string]: boolean } } = {};
  @state() private _dPermAudit: {role:string;action:string;changedBy:string;timestamp:string;oldVal:boolean;newVal:boolean}[] = [];
  @state() private _dPermCompare: string[] = [];

  private _dInitPermissions(): void {
    ...
    for (const role of this._dRoles) {
      perms[role] = {};
      this._dActions.forEach((a, i) => { perms[role][a] = defaults[role]?.[i] ?? false; });
    }
    this._dPermissions = perms;
  }

  private _dTogglePermission(role: string, action: string): void {
    const old = this._dPermissions[role][action];
    this._dPermissions = {...this._dPermissions, [role]: {...this._dPermissions[role], [action]: !old}};
    this._dPermAudit.unshift({role,action,changedBy:'current_user',timestamp:new Date().toISOString(),oldVal:old,newVal:!old});
  }

  private _dRenderRBAC(): any {
    const compareRoles = this._dPermCompare.map(r => this._dPermissions[r]).filter(Boolean);
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          <span style="font-weight:700;font-size:13px;color:#e2e8f0">RBAC Permission Matrix</span>
          <div style="display:flex;gap:4px">
            ${this._dRoles.map(r => html`
              <button class="tab ${this._dPermCompare.includes(r) ? 'active' : ''}" @click=${() => {
                this._dPermCompare = this._dPermCompare.includes(r) ? this._dPermCompare.filter(x => x !== r) : [...this._dPermCompare, r];
              }}>${r}</button>
            `)}
          </div>
        </div>
          ...
          <table style="width:100%;border-collapse:collapse;font-size:10px">
            <thead>
              <tr>
                ...
                ${this._dActions.map(a => html`<th style="padding:6px;color:#6b7280;border-bottom:1px solid #2a2d3a;text-align:center">${a}</th>`)}
              </tr>
            </thead>
            <tbody>
              ${this._dRoles.map(role => html`
                <tr style="border-bottom:1px solid #1a1d2e">
                  <td style="padding:6px;color:#e2e8f0;font-weight:600">${role}</td>
                  ${this._dActions.map(action => html`
                    <td style="text-align:center;padding:6px">
                      <button style="width:28px;height:20px;border-radius:3px;border:1px solid #2a2d3a;background:${this._dPermissions[role][action] ? '#22c55e' : '#1a1d2e'};cursor:pointer;color:#fff;font-size:10px" @click=${() => this._dTogglePermission(role, action)}>${this._dPermissions[role][action] ? 'Y' : 'N'}</button>
                    </td>
                  `)}
                </tr>
              `)}
        ...
        ${compareRoles.length >= 2 ? html`
          <div style="margin-top:10px;padding:8px;background:#1a1d2e;border-radius:6px">
            <div style="font-size:11px;font-weight:600;color:#e2e8f0;margin-bottom:6px">Role Diff: ${this._dPermCompare.join(' vs ')}</div>
            ${this._dActions.map(action => {
              ...
              return allSame ? nothing : html`
                <div style="display:flex;gap:8px;padding:3px 0;font-size:10px">
                  ...
                  ${compareRoles.map((r, i) => html`<span style="color:${r[action] ? '#22c55e' : '#ef4444'}">${this._dPermCompare[i]}=${r[action] ? 'Y' : 'N'}</span>`)}
                </div>
              `;
            })}
          </div>
        ` : nothing}
        ${this._dPermAudit.length > 0 ? html`
          <div style="margin-top:8px;font-size:9px;color:#6b7280">Recent: ${this._dPermAudit.slice(0,3).map(a => html`<span style="margin-right:8px">${a.role}.${a.action}: ${a.oldVal ? 'Y' : 'N'}->${a.newVal ? 'Y' : 'N'}</span>`)}
        ` : nothing}
      </div>
    `;
  }
  ...
  // === REPORTING SUITE ===
  @state() private _dReportTemplate: string = 'executive';
  @state() private _dReportSchedule: string = 'weekly';
  @state() private _dReportDistList: string[] = ['security-team@company.com','ciso@company.com'];
  @state() private _dReportHistory: {id:string;template:string;generatedAt:string;status:string}[] = [];

  private _dGenerateReport(): void {
    const id = 'rpt-' + Date.now();
    this._dReportHistory.unshift({id,template:this._dReportTemplate,generatedAt:new Date().toISOString(),status:'sent'});
  }

  private _dRenderReporting(): any {
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:8px">
          <div>
            ...
            ${templates.map(t => html`
              <div style="padding:6px;background:${this._dReportTemplate === t.key ? '#1e3a5f' : '#1a1d2e'};border:1px solid ${this._dReportTemplate === t.key ? '#3b82f6' : '#2a2d3a'};border-radius:4px;margin-bottom:4px;cursor:pointer" @click=${() => { this._dReportTemplate = t.key; }}>
          ...
          <div>
            ...
            <div style="display:flex;gap:4px;margin-bottom:8px">
              ${schedules.map(s => html`<button class="tab ${this._dReportSchedule === s.key ? 'active' : ''}" @click=${() => { this._dReportSchedule = s.key; }}>${s.label}</button>`)}
            </div>
            <div style="font-size:10px;color:#6b7280;margin-bottom:4px">Distribution</div>
            <div style="font-size:10px;color:#9ca3af">${this._dReportDistList.map(d => html`<div>${d}</div>`)}</div>
            <div style="margin-top:6px;display:flex;gap:4px">
              <button style="background:#3b82f6;border:none;border-radius:4px;padding:4px 10px;color:#fff;font-size:10px;cursor:pointer" @click=${this._dGenerateReport}>Generate</button>
        ...
        ${this._dReportHistory.length > 0 ? html`
          <div style="border-top:1px solid #2a2d3a;padding-top:8px">
            ...
            ${this._dReportHistory.slice(0,3).map(r => html`
  ...
  @state() private _dHighContrast: boolean = false;
  @state() private _dA11yAnnounce: string = '';
  @state() private _dShortcutsVisible: boolean = false;
  @state() private _dFocusTrap: boolean = false;

  private _dShortcuts: Record<string, string> = {
  ...
  private _dHandleKeydown(e: KeyboardEvent): void {
    if (e.key === 'Escape' && this._dFocusTrap) { this._dFocusTrap = false; this._dAnnounce('Dialog closed'); }
    if (e.ctrlKey && e.shiftKey && e.key === 'H') { e.preventDefault(); this._dHighContrast = !this._dHighContrast; this._dAnnounce('High contrast ' + (this._dHighContrast ? 'enabled' : 'disabled')); }
    if (e.ctrlKey && e.shiftKey && e.key === 'A') { e.preventDefault(); this._dShortcutsVisible = !this._dShortcutsVisible; }
  }

  private _dAnnounce(msg: string): void {
    this._dA11yAnnounce = msg;
    setTimeout(() => { this._dA11yAnnounce = ''; }, 2000);
  }

  private _dRenderAccessibility(): any {
    return html`
      <div role="region" aria-label="Accessibility Controls" style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <button class="tab ${this._dShortcutsVisible ? 'active' : ''}" @click=${() => { this._dShortcutsVisible = !this._dShortcutsVisible; }} aria-expanded=${this._dShortcutsVisible}>Shortcuts</button>
        </div>
        <div style="display:flex;gap:8px;margin-bottom:8px">
          <label style="display:flex;align-items:center;gap:6px;font-size:11px;color:#e2e8f0;cursor:pointer">
            <input type="checkbox" .checked=${this._dHighContrast} @change=${() => { this._dHighContrast = !this._dHighContrast; }} aria-label="Toggle high contrast mode">
            High Contrast
          </label>
        </div>
        ${this._dShortcutsVisible ? html`
          <div role="list" aria-label="Keyboard shortcuts" style="background:#1a1d2e;border-radius:6px;padding:8px">
            ${Object.entries(this._dShortcuts).map(([key, desc]) => html`
        ...
        ` : nothing}
        <div role="status" aria-live="polite" aria-atomic="true" style="position:absolute;left:-9999px">${this._dA11yAnnounce}</div>
      </div>
    `;
  }
  ...
  connectedCallback(): void {
    ...
    this._dInitScenarios();
    this._dInitTrendData();
    this._dInitPermissions();
    document.addEventListener('keydown', this._dHandleKeydown.bind(this));
  }

  disconnectedCallback(): void {
    super.disconnectedCallback();
    document.removeEventListener('keydown', this._dHandleKeydown.bind(this));
  }

  // === TAB INTEGRATION FOR EXTENDED FEATURES ===
  @state() private _dActiveSubTab: string = 'scenario';
  ...
  private _initThreatModel() {
    const categories = [
      ...
      { id: 'tc2', category: 'Tampering', threats: [
        { id: 't4', name: 'Data injection in deception technology', stride: 'T', likelihood: 7, impact: 8, dreadScore: 7.0, status: 'open', mitigations: ['Input validation', 'WAF rules'], assignedTo: 'Dev Team', discoveredDate: '2024-01-08', lastReviewed: '2024-02-10' },
  ...
  private _dGetAllSubTabs(): {key:string;label:string}[] {
    return [
  ...
  private _dRenderSubPanel(): any {
    switch (this._dActiveSubTab) {
      case 'scenario': return this._dRenderScenarioEngine();
      case 'timeseries': return this._dRenderTimeSeries();
      case 'rbac': return this._dRenderRBAC();
      case 'reporting': return this._dRenderReporting();
      case 'a11y': return this._dRenderAccessibility();
      default: return nothing;
    }
  }

  private _dRenderTabBar(): any {
    return html`
      <div style="display:flex;gap:4px;margin-bottom:12px;border-bottom:1px solid #2a2d3a;padding-bottom:8px;flex-wrap:wrap" role="tablist" aria-label="Extended panel features">
        ${this._dGetAllSubTabs().map(t => html`
          <button class="tab ${this._dActiveSubTab === t.key ? 'active' : ''}" @click=${() => { this._dActiveSubTab = t.key; }} role="tab" aria-selected=${this._dActiveSubTab === t.key}>${t.label}</button>
        `)}
      </div>
      <div role="tabpanel" aria-labelledby="d-tab-${this._dActiveSubTab}">
        ${this._dRenderSubPanel()}
      </div>
    `;
  }
  ...
  @state() private _soarPlaybooks: Array<{
    ...
    {
      id: 'pb-soar-001', name: 'Deception Auto Response', status: 'active',
      steps: [
    ...
    {
      id: 'pb-soar-002', name: 'Deception Investigation Workflow', status: 'active',
      steps: [
    ...
    {
      id: 'pb-soar-003', name: 'Deception Compliance Scan', status: 'draft',
      steps: [
  ...
  @state() private _decAle: number = 0;
  @state() private _decSroi: number = 0;
  @state() private _decCpi: number = 0;
  @state() private _decBudgetAlloc: number = 0;
  @state() private _decCostBenefit: number = 0;

  // Security Economics Calculator
  private decInitEconomics() {
    this._decAle = Math.round(2850000 + Math.random() * 4500000);
    this._decSroi = Math.round(180 + Math.random() * 320);
    this._decCpi = Math.round(45000 + Math.random() * 120000);
    this._decBudgetAlloc = Math.round(2500000 + Math.random() * 3000000);
    this._decCostBenefit = Math.round(220 + Math.random() * 180);
  }

  private _decCalcAle(): { annual: number; perIncident: number; byCategory: Array<{name: string; value: number}> } {
    const base = this._decAle;
    const categories = [
  ...
  private _decCalcSroi(): Array<{year: number; investment: number; savings: number; roi: number}> {
    const baseInv = this._decSroi * 10000;
  ...
  private _decGetBudgetAlloc(): Array<{category: string; amount: number; pct: number; trend: string}> {
    const total = this._decBudgetAlloc;
    const items = [
  ...
  private _decGetCostBenefit(): Array<{control: string; cost: number; benefit: number; ratio: number; priority: string}> {
    const base = this._decCostBenefit;
    const controls = [
  ...
  private _decRenderEconomics() {
    const ale = this._decCalcAle();
    const roi = this._decCalcSroi();
    const budget = this._decGetBudgetAlloc();
    const cb = this._decGetCostBenefit();
    const cpi = this._decCpi;
  ...
  @state() private _decThreatLevel: any = null;
  @state() private _decEmergingThreats: any = null;
  @state() private _decThreatTrends: any = null;
  @state() private _decSectorRadar: any = null;
  @state() private _decActorActivity: any = null;

  // Threat Landscape Intelligence
  private decInitThreatIntel() {
    this._decThreatLevel = {
  ...
  private _decRenderThreatIntel() {
    const tl = this._decThreatLevel;
    const et = this._decEmergingThreats;
    const sr = this._decSectorRadar;
    const aa = this._decActorActivity;
  ...
  @state() private _decPolicies: any = null;
  @state() private _decExceptions: any = null;
  @state() private _decRiskRegister: any = null;
  @state() private _decMeetings: any = null;
  @state() private _decDeadlines: any = null;

  // Security Governance Dashboard
  private decInitGovernance() {
    this._decPolicies = [
  ...
  private _decRenderGovernance() {
    const policies = this._decPolicies;
    const risks = this._decRiskRegister;
    const deadlines = this._decDeadlines;
  ...
  @state() private _decCriticalAssets: any = null;
  @state() private _decAssetDeps: any = null;
  @state() private _decEolAssets: any = null;
  @state() private _decAssetRisk: any = null;

  // Asset Intelligence
  private decInitAssetIntel() {
    this._decCriticalAssets = [
    ...
    this._decAssetRisk = { critical: 7, high: 23, medium: 45, low: 128, total: 203 };
  }

  private _decRenderAssetIntel() {
    const assets = this._decCriticalAssets;
    const eol = this._decEolAssets;
    const ar = this._decAssetRisk;
  ...
  @state() private _decUserBaseline: any = null;
  @state() private _decAnomalyRules: any = null;
  @state() private _decDataAccess: any = null;
  @state() private _decInsiderRisk: any = null;
  @state() private _deceptr15Timeline: Array<{id:string;time:string;event:string;severity:string;actor:string}> = [
  ...
  @state() private _deceptr15RootCauses: Array<{why:string;answer:string}> = [
  ...
  @state() private _deceptr15ImpactMatrix: Array<{system:string;users:number;data:string;revenue:string;status:string}> = [
  ...
  @state() private _deceptr15Actions: Array<{id:string;item:string;owner:string;deadline:string;priority:string;status:string}> = [
  ...
  @state() private _deceptr15Lessons: Array<{id:string;lesson:string;category:string;severity:string;applies_to:string}> = [
  ...
  @state() private _deceptr15ActiveTab: string = 'timeline';
  @state() private _deceptr15Benchmarks: Array<{metric:string;current:number;industry:number;target:number;unit:string;source:string}> = [
  ...
  @state() private _deceptr15MaturityLevels: Array<{domain:string;current:number;target:number;description:string}> = [
  ...
  @state() private _deceptr15QuarterlyData: Array<{quarter:string;score:number;improvement:number}> = [
  ...
  @state() private _deceptr15SelectedDomain: string = 'all';
  @state() private _deceptr15Alerts: Array<{id:string;name:string;severity:number;confidence:number;assetCrit:number;score:number;enriched:boolean;group:string;status:string;enrichData:Array<{key:string;value:string}>}> = [
  ...
  @state() private _deceptr15QualityMetrics: {fpRate:number;enrichSuccess:number;avgTriageTime:number;enrichedCount:number;totalCount:number} = {fpRate:0.12, enrichSuccess:0.78, avgTriageTime:4.5, enrichedCount:3, totalCount:5};
  @state() private _deceptr15RoutingRules: Array<{name:string;condition:string;channel:string;active:boolean}> = [
  ...
  @state() private _deceptr15Shapes: Array<{id:string;type:string;label:string;controls:string[]}> = [
  ...
  @state() private _deceptr15TrustBoundaries: Array<{from:string;to:string;label:string;strength:string}> = [
  ...
  @state() private _deceptr15ADRs: Array<{id:string;title:string;status:string;date:string;decision:string}> = [
  ...
  @state() private _deceptr15SelectedShape: string = '';
  @state() private _deceptr15Gauges: Array<{name:string;value:number;max:number;unit:string;status:string;color:string}> = [
  ...
  @state() private _deceptr15Anomalies: Array<{id:string;time:string;description:string;severity:string;acknowledged:boolean}> = [
  ...
  @state() private _deceptr15Integrations: Array<{name:string;status:string;uptime:number;lastCheck:string;latency:number}> = [
  ...
  @state() private _deceptr15AlertFatigue: Array<{analyst:string;alertsPerDay:number;escalated:number;dismissed:number;avgResponseMin:number}> = [
  ...
  @state() private _deceptr15SlaTarget: number = 99.9;

  // Insider Threat Detection
  private decInitInsiderThreat() {
    this._decUserBaseline = [
    ...
    this._decInsiderRisk = { totalUsers: 2847, monitored: 342, flagged: 18, investigated: 5, confirmed: 1 };
  }

  private _decRenderInsiderThreat() {
    const baseline = this._decUserBaseline;
    const rules = this._decAnomalyRules;
    const ir = this._decInsiderRisk;
    ...
    return html`<div class="card" style="padding:14px;margin-bottom:8px">
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px;margin-bottom:10px;flex-wrap:wrap">
            ${['timeline','rootcause','impact','actions','lessons'].map(t => html`
              <button class="btn ${this._deceptr15ActiveTab === t ? 'btn-primary' : ''}" style="font-size:10px;padding:3px 8px" @click=${() => { this._deceptr15ActiveTab = t; }}>${t.charAt(0).toUpperCase() + t.slice(1)}</button>
            `)}
          </div>
          ${this._deceptr15ActiveTab === 'timeline' ? html`
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._deceptr15Timeline.map(e => html`
          ...
          ` : this._deceptr15ActiveTab === 'rootcause' ? html`
            <div style="margin-bottom:8px">${{__html: this._deceptr15RenderFishbone()}}</div>
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._deceptr15RootCauses.map((rc, i) => html`
          ...
          ` : this._deceptr15ActiveTab === 'impact' ? html`
            <div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:10px">
              ...
              <tbody>${this._deceptr15ImpactMatrix.map(imp => html`
          ...
          ` : this._deceptr15ActiveTab === 'actions' ? html`
            <div style="display:flex;gap:12px;margin-bottom:8px;font-size:10px;color:#888">
              ${Object.entries(this._deceptr15GetActionStats()).map(([k,v]) => html`<span>${k}: <b style="color:#ddd">${v}</b></span>`)}
            </div>
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._deceptr15Actions.map(a => html`
                <div style="display:flex;gap:8px;align-items:center;padding:6px;background:#1a1d27;border-radius:4px;cursor:pointer" @click=${() => this._deceptr15ToggleAction(a.id)}>
          ...
          ` : html`
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._deceptr15Lessons.map(l => html`
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px;margin-bottom:10px;flex-wrap:wrap">
            ${['all', ...this._deceptr15MaturityLevels.map(m => m.domain)].map(d => html`
              <button class="btn ${this._deceptr15SelectedDomain === d ? 'btn-primary' : ''}" style="font-size:9px;padding:2px 6px" @click=${() => { this._deceptr15SelectedDomain = d; }}>${d}</button>
            `)}
          </div>
          <div style="display:flex;gap:16px;margin-bottom:10px">
            <div style="text-align:center"><div style="color:#e0e0e0;font-size:20px;font-weight:bold">${this._deceptr15GetOverallMaturity()}/5</div><div style="color:#888;font-size:10px">Maturity Level</div></div>
            <div style="text-align:center"><div style="color:#4f4;font-size:20px;font-weight:bold">${this._deceptr15GetGapAnalysis().filter(g => g.isAbove).length}/${this._deceptr15Benchmarks.length}</div><div style="color:#888;font-size:10px">Above Industry</div></div>
          </div>
          <div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:10px">
            ...
            <tbody>${this._deceptr15GetGapAnalysis().map(b => html`
          ...
          <div style="margin-top:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Maturity by Domain</div>
            ${this._deceptr15MaturityLevels.filter(m => this._deceptr15SelectedDomain === 'all' || m.domain === this._deceptr15SelectedDomain).map(m => html`
          ...
          <div style="margin-top:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Quarterly Trend</div>
            <div style="display:flex;height:40px;align-items:flex-end;gap:4px">
              ${this._deceptr15QuarterlyData.map(q => html`<div style="flex:1;text-align:center"><div style="background:#4a9eff;height:${q.score * 0.5}px;border-radius:2px 2px 0 0" title="${q.score}"></div><div style="color:#666;font-size:8px;margin-top:2px">${q.quarter}</div></div>`)}
            </div>
          </div>
        </div>
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:12px;margin-bottom:8px;font-size:10px">
            <div style="display:flex;gap:4px;flex-wrap:wrap">${this._deceptr15GroupAlerts().map(g => html`<span style="color:#888;padding:2px 6px;background:#1a1d27;border-radius:3px">${g.group}: ${g.count}</span>`)}</div>
          </div>
          <div style="display:flex;gap:8px;margin-bottom:8px;font-size:10px;color:#888">
            <span>FP Rate: <b style="color:${this._deceptr15QualityMetrics.fpRate > 0.15 ? '#f44' : '#4f4'}">${(this._deceptr15QualityMetrics.fpRate * 100).toFixed(1)}%</b></span>
            <span>Enrich: <b style="color:#4a9eff">${(this._deceptr15QualityMetrics.enrichSuccess * 100).toFixed(0)}%</b></span>
            <span>Avg Triage: <b style="color:#ddd">${this._deceptr15QualityMetrics.avgTriageTime}m</b></span>
          </div>
          <div style="display:flex;flex-direction:column;gap:4px;max-height:200px;overflow-y:auto">
            ${this._deceptr15Alerts.sort((a, b) => this._deceptr15CalcScore(b) - this._deceptr15CalcScore(a)).map(a => {
              const score = this._deceptr15CalcScore(a);
              return html`
                <div style="padding:6px;background:#1a1d27;border-radius:4px;border-left:3px solid ${a.severity >= 4 ? '#f44' : a.severity >= 3 ? '#fa0' : '#4a9eff'}">
                  <div style="display:flex;justify-content:space-between;align-items:center">
                    ...
                    <button class="btn" style="font-size:9px;padding:1px 6px;margin-left:4px" @click=${() => this._deceptr15EnrichAlert(a.id)}>${a.enriched ? 'Re-enrich' : 'Enrich'}</button>
                  </div>
          ...
          <div style="margin-top:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Routing Rules</div>
            ${this._deceptr15RoutingRules.map(r => html`
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:8px;margin-bottom:8px;flex-wrap:wrap">
            ${this._deceptr15Shapes.map(s => {
              const v = this._deceptr15ValidateControl(s.id);
              return html`<div style="padding:4px 8px;background:#1a1d27;border-radius:3px;cursor:pointer;border:1px solid ${this._deceptr15SelectedShape === s.id ? '#4a9eff' : '#2a2d37'}" @click=${() => { this._deceptr15SelectedShape = this._deceptr15SelectedShape === s.id ? '' : s.id; }}>
          ...
          ${this._deceptr15SelectedShape ? html`
            ${(() => {
              const shape = this._deceptr15Shapes.find(s => s.id === this._deceptr15SelectedShape);
              const v = this._deceptr15ValidateControl(this._deceptr15SelectedShape);
              return shape ? html`
          ...
          <div style="margin-bottom:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Trust Boundaries</div>
            ${this._deceptr15TrustBoundaries.map(tb => html`
              <div style="display:flex;gap:6px;align-items:center;padding:3px;background:#1a1d27;border-radius:3px;margin-bottom:2px;font-size:9px">
                <span style="color:#ddd">${this._deceptr15Shapes.find(s => s.id === tb.from)?.label || tb.from}</span>
                <span style="color:#4a9eff">\u2194</span>
                <span style="color:#ddd">${this._deceptr15Shapes.find(s => s.id === tb.to)?.label || tb.to}</span>
          ...
          <div><div style="color:#888;font-size:10px;margin-bottom:4px">Architecture Decision Records</div>
            ${this._deceptr15ADRs.map(adr => html`
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:8px;margin-bottom:8px;flex-wrap:wrap">
            ${this._deceptr15Gauges.map(g => html`
          ...
          <div style="display:flex;gap:8px;margin-bottom:8px;align-items:center">
            ...
            <span style="color:${this._deceptr15GetOverallHealth().score >= 99 ? '#4f4' : '#fa0'};font-size:12px;font-weight:bold">${this._deceptr15GetOverallHealth().score}%</span>
            <span style="color:#888;font-size:10px">(Target: ${this._deceptr15SlaTarget}%)</span>
            <span style="color:#4f4;font-size:10px">${this._deceptr15GetOverallHealth().healthy} healthy</span>
            <span style="color:#fa0;font-size:10px">${this._deceptr15GetOverallHealth().degraded} degraded</span>
          </div>
          <div style="margin-bottom:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Anomaly Stream</div>
            ${this._deceptr15Anomalies.slice(0, 3).map(a => html`
              <div style="display:flex;gap:6px;align-items:center;padding:4px;background:#1a1d27;border-radius:3px;margin-bottom:2px;opacity:${a.acknowledged ? 0.5 : 1}">
                ...
                ${!a.acknowledged ? html`<button class="btn" style="font-size:8px;padding:1px 4px" @click=${() => this._deceptr15AckAnomaly(a.id)}>ACK</button>` : html`<span style="color:#4f4;font-size:9px">ACK'd</span>`}
              </div>
            `)}
          </div>
          <div style="margin-bottom:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Integration Health</div>
            ${this._deceptr15Integrations.map(i => html`
              <div style="display:flex;gap:6px;align-items:center;padding:3px;background:#1a1d27;border-radius:3px;margin-bottom:2px;font-size:9px">
          ...
          <div><div style="color:#888;font-size:10px;margin-bottom:4px">Alert Fatigue Analysis</div>
            <div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:9px">
              ...
              <tbody>${this._deceptr15AlertFatigue.map(af => html`
  ...
  private _deceptr15RenderFishbone(): string {
  ...
  private _deceptr15ToggleAction(id: string) {
    this._deceptr15Actions = this._deceptr15Actions.map(a => a.id === id ? {...a, status: a.status === 'pending' ? 'in_progress' : a.status === 'in_progress' ? 'completed' : 'pending'} : a);
  }

  private _deceptr15GetActionStats() {
    const total = this._deceptr15Actions.length;
    const done = this._deceptr15Actions.filter(a => a.status === 'completed').length;
    const inProg = this._deceptr15Actions.filter(a => a.status === 'in_progress').length;
    return { total, done, inProg, pending: total - done - inProg };
  }

  private _deceptr15GetOverallMaturity(): number {
    if (this._deceptr15SelectedDomain === 'all') {
      return Math.round(this._deceptr15MaturityLevels.reduce((s, m) => s + m.current, 0) / this._deceptr15MaturityLevels.length * 10) / 10;
    }
    const d = this._deceptr15MaturityLevels.find(m => m.domain === this._deceptr15SelectedDomain);
    return d ? d.current : 0;
  }

  private _deceptr15GetGapAnalysis() {
    return this._deceptr15Benchmarks.map(b => {
  ...
  private _deceptr15CalcScore(alert: any): number {
    return Math.round(alert.severity * alert.confidence * alert.assetCrit * 100) / 100;
  }

  private _deceptr15EnrichAlert(id: string) {
    this._deceptr15Alerts = this._deceptr15Alerts.map(a => {
      if (a.id !== id) return a;
      const score = this._deceptr15CalcScore(a);
  ...
  private _deceptr15GroupAlerts() {
    const groups: Record<string, number> = {};
    this._deceptr15Alerts.forEach(a => { groups[a.group] = (groups[a.group] || 0) + 1; });
    return Object.entries(groups).map(([g, c]) => ({group: g, count: c}));
  }

  private _deceptr15ValidateControl(shapeId: string): {valid:boolean;missing:string[]} {
    const shape = this._deceptr15Shapes.find(s => s.id === shapeId);
  ...
  private _deceptr15GetOverallHealth(): {healthy:number;degraded:number;down:number;score:number} {
    const online = this._deceptr15Integrations.filter(i => i.status === 'online').length;
    const degraded = this._deceptr15Integrations.filter(i => i.status === 'degraded').length;
    const total = this._deceptr15Integrations.length;
    return { healthy: online, degraded, down: total - online - degraded, score: Math.round(online / total * 100) };
  }

  private _deceptr15AckAnomaly(id: string) {
    this._deceptr15Anomalies = this._deceptr15Anomalies.map(a => a.id === id ? {...a, acknowledged: true} : a);
  }
...
// ===== SECURITY CONTROL TESTING (R22) =====
  ...
  private _renderBudgetPlanning() {
    const budgetData = [
      { category: "Personnel & Training", planned: 2781000, actual: 1203000, utilization: 43.3, q1: "26%", q2: "31%", q3: "29%", q4: "21%" },
      { category: "Tooling & Licensing", planned: 2788000, actual: 1216000, utilization: 43.6, q1: "29%", q2: "20%", q3: "24%", q4: "22%" },
      { category: "Infrastructure Security", planned: 2795000, actual: 1229000, utilization: 44.0, q1: "16%", q2: "25%", q3: "19%", q4: "23%" },
      { category: "Compliance & Audit", planned: 2802000, actual: 1242000, utilization: 44.3, q1: "19%", q2: "30%", q3: "30%", q4: "24%" },
      { category: "Incident Response", planned: 2809000, actual: 1255000, utilization: 44.7, q1: "22%", q2: "35%", q3: "25%", q4: "25%" },
      { category: "Third-Party Assessments", planned: 2816000, actual: 1268000, utilization: 45.0, q1: "25%", q2: "24%", q3: "20%", q4: "10%" },
      { category: "Security Awareness", planned: 2823000, actual: 1281000, utilization: 45.4, q1: "28%", q2: "29%", q3: "31%", q4: "11%" },
      { category: "Research & Innovation", planned: 2830000, actual: 1294000, utilization: 45.7, q1: "15%", q2: "34%", q3: "26%", q4: "12%" },
    ];
    ...
    const headcount = [
      { team: "SOC Tier 1", current: 7, target: 6, gap: 5, avgSalary: "183k" },
      { team: "SOC Tier 2", current: 16, target: 5, gap: 4, avgSalary: "101k" },
      { team: "Threat Intel", current: 8, target: 4, gap: 3, avgSalary: "130k" },
      { team: "Red Team", current: 17, target: 3, gap: 2, avgSalary: "159k" },
      { team: "GRC", current: 9, target: 22, gap: 1, avgSalary: "188k" },
      { team: "AppSec", current: 18, target: 21, gap: 0, avgSalary: "106k" },
      { team: "Cloud Sec", current: 10, target: 20, gap: 5, avgSalary: "135k" },
      { team: "Identity & Access", current: 2, target: 19, gap: 4, avgSalary: "164k" },
    ];
    const vendorSpend = [
      { vendor: "CrowdStrike", annual: "497k", contractEnd: "2026-12", renewalRisk: "Low", satisfaction: 5 },
      { vendor: "Palo Alto", annual: "528k", contractEnd: "2026-01", renewalRisk: "Medium", satisfaction: 4 },
      { vendor: "Splunk", annual: "559k", contractEnd: "2026-02", renewalRisk: "High", satisfaction: 3 },
      { vendor: "Qualys", annual: "590k", contractEnd: "2026-03", renewalRisk: "Low", satisfaction: 5 },
      { vendor: "Rapid7", annual: "621k", contractEnd: "2026-04", renewalRisk: "Medium", satisfaction: 4 },
      { vendor: "Mandiant", annual: "652k", contractEnd: "2026-05", renewalRisk: "High", satisfaction: 3 },
      { vendor: "Zscaler", annual: "683k", contractEnd: "2026-06", renewalRisk: "Low", satisfaction: 5 },
      { vendor: "Duo Security", annual: "714k", contractEnd: "2026-07", renewalRisk: "Medium", satisfaction: 4 },
    ];
    const roiProjections = [
      { area: "Threat Detection", investment: "597k", projectedReturn: "2013k", roiMultiple: "2.2x", confidence: 71 },
      { area: "Incident Reduction", investment: "640k", projectedReturn: "2060k", roiMultiple: "2.1x", confidence: 88 },
      { area: "Compliance Savings", investment: "683k", projectedReturn: "2107k", roiMultiple: "2.0x", confidence: 69 },
      { area: "Automation Gains", investment: "726k", projectedReturn: "2154k", roiMultiple: "1.9x", confidence: 86 },
      { area: "Risk Avoidance", investment: "769k", projectedReturn: "2201k", roiMultiple: "1.8x", confidence: 67 },
    ];
    return html`
  ...
  private _renderMetricsNormalization() {
    const kpiCatalog = [
      { id: "kpi-1", name: "MTTD", owner: "SOC", unit: "minutes", target: 72, current: 73, benchmark: 83, collection: "auto", frequency: "realtime" },
      { id: "kpi-2", name: "MTTR", owner: "GRC", unit: "%", target: 75, current: 80, benchmark: 94, collection: "semi-auto", frequency: "daily" },
      { id: "kpi-3", name: "MTTC", owner: "AppSec", unit: "score", target: 78, current: 87, benchmark: 71, collection: "manual", frequency: "weekly" },
      { id: "kpi-4", name: "Vuln SLA Compliance", owner: "Cloud Sec", unit: "count", target: 81, current: 94, benchmark: 82, collection: "auto", frequency: "monthly" },
      { id: "kpi-5", name: "Patch Coverage", owner: "Identity", unit: "days", target: 84, current: 55, benchmark: 93, collection: "semi-auto", frequency: "realtime" },
      { id: "kpi-6", name: "Phishing Click Rate", owner: "Threat Intel", unit: "minutes", target: 87, current: 62, benchmark: 70, collection: "manual", frequency: "daily" },
      { id: "kpi-7", name: "Training Completion", owner: "Security Ops", unit: "%", target: 90, current: 69, benchmark: 81, collection: "auto", frequency: "weekly" },
      { id: "kpi-8", name: "Escalation Rate", owner: "Risk Mgmt", unit: "score", target: 93, current: 76, benchmark: 92, collection: "semi-auto", frequency: "monthly" },
      { id: "kpi-9", name: "False Positive Rate", owner: "SOC", unit: "count", target: 96, current: 83, benchmark: 69, collection: "manual", frequency: "realtime" },
      { id: "kpi-10", name: "Threat Intel Actionability", owner: "GRC", unit: "days", target: 99, current: 90, benchmark: 80, collection: "auto", frequency: "daily" },
      { id: "kpi-11", name: "Endpoint Compliance", owner: "AppSec", unit: "minutes", target: 72, current: 97, benchmark: 91, collection: "semi-auto", frequency: "weekly" },
      { id: "kpi-12", name: "Cloud Misconfig Score", owner: "Cloud Sec", unit: "%", target: 75, current: 58, benchmark: 68, collection: "manual", frequency: "monthly" },
      { id: "kpi-13", name: "Identity Anomaly Rate", owner: "Identity", unit: "score", target: 78, current: 65, benchmark: 79, collection: "auto", frequency: "realtime" },
      { id: "kpi-14", name: "DLP Events", owner: "Threat Intel", unit: "count", target: 81, current: 72, benchmark: 90, collection: "semi-auto", frequency: "daily" },
      { id: "kpi-15", name: "Vendor Risk Avg", owner: "Security Ops", unit: "days", target: 84, current: 79, benchmark: 67, collection: "manual", frequency: "weekly" },
      { id: "kpi-16", name: "Compliance Audit Pass Rate", owner: "Risk Mgmt", unit: "minutes", target: 87, current: 86, benchmark: 78, collection: "auto", frequency: "monthly" },
      { id: "kpi-17", name: "Awareness Score", owner: "SOC", unit: "%", target: 90, current: 93, benchmark: 89, collection: "semi-auto", frequency: "realtime" },
      { id: "kpi-18", name: "SOC Utilization", owner: "GRC", unit: "score", target: 93, current: 100, benchmark: 66, collection: "manual", frequency: "daily" },
      { id: "kpi-19", name: "Automation Coverage", owner: "AppSec", unit: "count", target: 96, current: 61, benchmark: 77, collection: "auto", frequency: "weekly" },
      { id: "kpi-20", name: "Risk Register Currency", owner: "Cloud Sec", unit: "days", target: 99, current: 68, benchmark: 88, collection: "semi-auto", frequency: "monthly" },
    ];
    const benchmarkSources = [
      { source: "NIST CSF", mappedKPIs: 5, alignment: 65, lastReview: "2026-03-19", status: "aligned" },
      { source: "CIS Controls v8", mappedKPIs: 6, alignment: 82, lastReview: "2026-04-14", status: "partial" },
      { source: "ISO 27001:2022", mappedKPIs: 7, alignment: 60, lastReview: "2026-05-09", status: "reviewing" },
      { source: "PCI DSS 4.0", mappedKPIs: 8, alignment: 77, lastReview: "2026-06-04", status: "aligned" },
      { source: "SOC 2 Type II", mappedKPIs: 3, alignment: 94, lastReview: "2026-01-27", status: "partial" },
      { source: "MITRE ATT&CK", mappedKPIs: 4, alignment: 72, lastReview: "2026-02-22", status: "reviewing" },
      { source: "SANS Top 20", mappedKPIs: 5, alignment: 89, lastReview: "2026-03-17", status: "aligned" },
      { source: "OWASP Top 10", mappedKPIs: 6, alignment: 67, lastReview: "2026-04-12", status: "partial" },
    ];
  ...
  private _renderThreatHuntingCampaigns() {
    const campaigns = [
      { id: "HC-1001", name: "Lateral Movement Sweep", status: "active", hypothesis: "H1: Actors using pass-the-hash for lateral movement", leadHunter: "Alice Chen", findings: 42, startDate: "2026-03-11", endDate: null, effectiveness: 76 },
      { id: "HC-1002", name: "Credential Harvesting Hunt", status: "completed", hypothesis: "H2: Actors using web shells for persistence", leadHunter: "Bob Martinez", findings: 45, startDate: "2026-02-22", endDate: "2026-05-28", effectiveness: 95 },
      { id: "HC-1003", name: "Persistence Mechanism Audit", status: "planned", hypothesis: "H3: Actors using scheduled tasks for data theft", leadHunter: "Carol Wu", findings: 0, startDate: "2026-01-05", endDate: null, effectiveness: 55 },
      { id: "HC-1004", name: "C2 Beacon Detection", status: "in-review", hypothesis: "H4: Actors using DNS tunneling for C2 communication", leadHunter: "Dave Kim", findings: 3, startDate: "2026-04-16", endDate: null, effectiveness: 74 },
      { id: "HC-1005", name: "Data Exfiltration Patterns", status: "active", hypothesis: "H5: Actors using encrypted channels for privilege escalation", leadHunter: "Eve Johnson", findings: 6, startDate: "2026-03-27", endDate: null, effectiveness: 93 },
      { id: "HC-1006", name: "Privilege Escalation Scan", status: "completed", hypothesis: "H6: Actors using token impersonation for defense evasion", leadHunter: "Frank Liu", findings: 9, startDate: "2026-02-10", endDate: "2026-06-12", effectiveness: 53 },
      { id: "HC-1007", name: "Supply Chain Implant Hunt", status: "planned", hypothesis: "H7: Actors using poisoned images for initial access", leadHunter: "Grace Park", findings: 12, startDate: "2026-01-21", endDate: null, effectiveness: 72 },
      { id: "HC-1008", name: "Insider Threat Indicators", status: "in-review", hypothesis: "H8: Actors using legitimate tools for credential access", leadHunter: "Hector Silva", findings: 15, startDate: "2026-04-04", endDate: null, effectiveness: 91 },
      { id: "HC-1009", name: "Cloud Metadata Analysis", status: "active", hypothesis: "H9: Actors using API keys for command execution", leadHunter: "Alice Chen", findings: 18, startDate: "2026-03-15", endDate: null, effectiveness: 51 },
      { id: "HC-1010", name: "DNS Tunnel Detection", status: "completed", hypothesis: "H10: Actors using encoded subdomains for exfiltration", leadHunter: "Bob Martinez", findings: 21, startDate: "2026-02-26", endDate: "2026-04-24", effectiveness: 70 },
      { id: "HC-1011", name: "Fileless Malware Search", status: "planned", hypothesis: "H11: Actors using WMI providers for discovery", leadHunter: "Carol Wu", findings: 24, startDate: "2026-01-09", endDate: null, effectiveness: 89 },
      { id: "HC-1012", name: "Zero-Day Exploit Traces", status: "in-review", hypothesis: "H12: Actors using exploit kits for collection", leadHunter: "Dave Kim", findings: 27, startDate: "2026-04-20", endDate: null, effectiveness: 49 },
    ];
    const hunterLeaderboard = [
      { hunter: "Alice Chen", campaigns: 7, findings: 35, highSeverity: 4, avgScore: 61, streak: 3 },
      { hunter: "Bob Martinez", campaigns: 4, findings: 64, highSeverity: 9, avgScore: 98, streak: 4 },
      { hunter: "Carol Wu", campaigns: 14, findings: 93, highSeverity: 14, avgScore: 91, streak: 5 },
      { hunter: "Dave Kim", campaigns: 11, findings: 6, highSeverity: 19, avgScore: 84, streak: 6 },
      { hunter: "Eve Johnson", campaigns: 8, findings: 35, highSeverity: 24, avgScore: 77, streak: 7 },
      { hunter: "Frank Liu", campaigns: 5, findings: 64, highSeverity: 3, avgScore: 70, streak: 8 },
      { hunter: "Grace Park", campaigns: 15, findings: 93, highSeverity: 8, avgScore: 63, streak: 1 },
      { hunter: "Hector Silva", campaigns: 12, findings: 6, highSeverity: 13, avgScore: 56, streak: 2 },
    ];
    const mitreMapping = [
      { tactic: "Initial Access", techniques: 8, campaigns: 1, coverage: 85 },
      { tactic: "Execution", techniques: 7, campaigns: 6, coverage: 65 },
      { tactic: "Persistence", techniques: 6, campaigns: 5, coverage: 45 },
      { tactic: "Privilege Escalation", techniques: 5, campaigns: 4, coverage: 96 },
      { tactic: "Defense Evasion", techniques: 4, campaigns: 3, coverage: 76 },
      { tactic: "Credential Access", techniques: 3, campaigns: 2, coverage: 56 },
      { tactic: "Discovery", techniques: 2, campaigns: 1, coverage: 36 },
      { tactic: "Lateral Movement", techniques: 12, campaigns: 6, coverage: 87 },
      { tactic: "Collection", techniques: 11, campaigns: 5, coverage: 67 },
      { tactic: "Exfiltration", techniques: 10, campaigns: 4, coverage: 47 },
      { tactic: "Command & Control", techniques: 9, campaigns: 3, coverage: 98 },
      { tactic: "Impact", techniques: 8, campaigns: 2, coverage: 78 },
    ];
    return html`
  ...
  private _renderControlInventory() {
    const controls = [
      { id: "CTL-2001", name: "MFA Enforcement", domain: "Access Control", status: "implemented", effectiveness: 73, lastTest: "2026-03-03", nextReview: "2026-07-03", owner: "SOC", risk: "Low" },
      { id: "CTL-2002", name: "Network Segmentation", domain: "Network Security", status: "partial", effectiveness: 2, lastTest: "2026-02-16", nextReview: "2026-08-22", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2003", name: "EDR Deployment", domain: "Endpoint Protection", status: "planned", effectiveness: 9, lastTest: "2026-01-01", nextReview: "2026-09-13", owner: "IT Ops", risk: "High" },
      { id: "CTL-2004", name: "DLP Policy", domain: "Data Protection", status: "gap", effectiveness: 16, lastTest: "2026-04-14", nextReview: "2026-10-04", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2005", name: "SSO Integration", domain: "Identity Management", status: "implemented", effectiveness: 85, lastTest: "2026-03-27", nextReview: "2026-11-23", owner: "IAM", risk: "Low" },
      { id: "CTL-2006", name: "SAST Pipeline", domain: "Application Security", status: "partial", effectiveness: 30, lastTest: "2026-02-12", nextReview: "2026-12-14", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2007", name: "CSPM Scanning", domain: "Cloud Security", status: "planned", effectiveness: 37, lastTest: "2026-01-25", nextReview: "2026-05-05", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2008", name: "Badge Access", domain: "Physical Security", status: "gap", effectiveness: 44, lastTest: "2026-04-10", nextReview: "2026-06-24", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2009", name: "Least Privilege", domain: "Access Control", status: "implemented", effectiveness: 97, lastTest: "2026-03-23", nextReview: "2026-07-15", owner: "SOC", risk: "Low" },
      { id: "CTL-2010", name: "Firewall Rules", domain: "Network Security", status: "partial", effectiveness: 7, lastTest: "2026-02-08", nextReview: "2026-08-06", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2011", name: "Disk Encryption", domain: "Endpoint Protection", status: "planned", effectiveness: 14, lastTest: "2026-01-21", nextReview: "2026-09-25", owner: "IT Ops", risk: "High" },
      { id: "CTL-2012", name: "Data Classification", domain: "Data Protection", status: "gap", effectiveness: 21, lastTest: "2026-04-06", nextReview: "2026-10-16", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2013", name: "PAM Implementation", domain: "Identity Management", status: "implemented", effectiveness: 50, lastTest: "2026-03-19", nextReview: "2026-11-07", owner: "IAM", risk: "Low" },
      { id: "CTL-2014", name: "DAST Pipeline", domain: "Application Security", status: "partial", effectiveness: 35, lastTest: "2026-02-04", nextReview: "2026-12-26", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2015", name: "IAM Policy Review", domain: "Cloud Security", status: "planned", effectiveness: 42, lastTest: "2026-01-17", nextReview: "2026-05-17", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2016", name: "Visitor Management", domain: "Physical Security", status: "gap", effectiveness: 49, lastTest: "2026-04-02", nextReview: "2026-06-08", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2017", name: "Access Reviews", domain: "Access Control", status: "implemented", effectiveness: 62, lastTest: "2026-03-15", nextReview: "2026-07-27", owner: "SOC", risk: "Low" },
      { id: "CTL-2018", name: "IDS/IPS Tuning", domain: "Network Security", status: "partial", effectiveness: 12, lastTest: "2026-02-28", nextReview: "2026-08-18", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2019", name: "Patch Management", domain: "Endpoint Protection", status: "planned", effectiveness: 19, lastTest: "2026-01-13", nextReview: "2026-09-09", owner: "IT Ops", risk: "High" },
      { id: "CTL-2020", name: "Backup Encryption", domain: "Data Protection", status: "gap", effectiveness: 26, lastTest: "2026-04-26", nextReview: "2026-10-28", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2021", name: "Password Policy", domain: "Identity Management", status: "implemented", effectiveness: 74, lastTest: "2026-03-11", nextReview: "2026-11-19", owner: "IAM", risk: "Low" },
      { id: "CTL-2022", name: "Container Scanning", domain: "Application Security", status: "partial", effectiveness: 40, lastTest: "2026-02-24", nextReview: "2026-12-10", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2023", name: "WAF Configuration", domain: "Cloud Security", status: "planned", effectiveness: 47, lastTest: "2026-01-09", nextReview: "2026-05-01", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2024", name: "CCTV Coverage", domain: "Physical Security", status: "gap", effectiveness: 3, lastTest: "2026-04-22", nextReview: "2026-06-20", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2025", name: "RBAC Enforcement", domain: "Access Control", status: "implemented", effectiveness: 86, lastTest: "2026-03-07", nextReview: "2026-07-11", owner: "SOC", risk: "Low" },
      { id: "CTL-2026", name: "VPN Management", domain: "Network Security", status: "partial", effectiveness: 17, lastTest: "2026-02-20", nextReview: "2026-08-02", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2027", name: "App Whitelisting", domain: "Endpoint Protection", status: "planned", effectiveness: 24, lastTest: "2026-01-05", nextReview: "2026-09-21", owner: "IT Ops", risk: "High" },
      { id: "CTL-2028", name: "Key Management", domain: "Data Protection", status: "gap", effectiveness: 31, lastTest: "2026-04-18", nextReview: "2026-10-12", owner: "Data Gov", risk: "Critical" },
    ];
    const gapAnalysis = [
  ...
  private _renderIncidentCostTracker() {
    const incidents = [
      { id: "INC-7001", name: "Security Incident 1", severity: "Critical", totalCost: 981000, responseCost: 225630, recoveryCost: 274680, legalCost: 147150, regulatoryCost: 88290, insuranceClaim: 0, avoidedCost: 239000, date: "2026-03-23" },
      { id: "INC-7002", name: "Security Incident 2", severity: "High", totalCost: 984000, responseCost: 295200, recoveryCost: 383760, legalCost: 118080, regulatoryCost: 147600, insuranceClaim: 777360, avoidedCost: 268000, date: "2026-02-04" },
      { id: "INC-7003", name: "Security Incident 3", severity: "Medium", totalCost: 987000, responseCost: 157920, recoveryCost: 286230, legalCost: 88830, regulatoryCost: 98700, insuranceClaim: 0, avoidedCost: 297000, date: "2026-01-13" },
      { id: "INC-7004", name: "Security Incident 4", severity: "Low", totalCost: 990000, responseCost: 227700, recoveryCost: 396000, legalCost: 59400, regulatoryCost: 49500, insuranceClaim: 732600, avoidedCost: 326000, date: "2026-04-22" },
      { id: "INC-7005", name: "Security Incident 5", severity: "Critical", totalCost: 993000, responseCost: 297900, recoveryCost: 297900, legalCost: 188670, regulatoryCost: 109230, insuranceClaim: 0, avoidedCost: 355000, date: "2026-03-03" },
      { id: "INC-7006", name: "Security Incident 6", severity: "High", totalCost: 996000, responseCost: 159360, recoveryCost: 199200, legalCost: 159360, regulatoryCost: 59760, insuranceClaim: 687240, avoidedCost: 384000, date: "2026-02-12" },
      { id: "INC-7007", name: "Security Incident 7", severity: "Medium", totalCost: 999000, responseCost: 229770, recoveryCost: 309690, legalCost: 129870, regulatoryCost: 119880, insuranceClaim: 0, avoidedCost: 413000, date: "2026-01-21" },
      { id: "INC-7008", name: "Security Incident 8", severity: "Low", totalCost: 1002000, responseCost: 300600, recoveryCost: 210420, legalCost: 100200, regulatoryCost: 70140, insuranceClaim: 641280, avoidedCost: 442000, date: "2026-04-02" },
      { id: "INC-7009", name: "Security Incident 9", severity: "Critical", totalCost: 1005000, responseCost: 160800, recoveryCost: 321600, legalCost: 70350, regulatoryCost: 130650, insuranceClaim: 0, avoidedCost: 471000, date: "2026-03-11" },
      { id: "INC-7010", name: "Security Incident 10", severity: "High", totalCost: 1008000, responseCost: 231840, recoveryCost: 221760, legalCost: 201600, regulatoryCost: 80640, insuranceClaim: 594720, avoidedCost: 500000, date: "2026-02-20" },
      { id: "INC-7011", name: "Security Incident 11", severity: "Medium", totalCost: 1011000, responseCost: 303300, recoveryCost: 333630, legalCost: 171870, regulatoryCost: 141540, insuranceClaim: 0, avoidedCost: 33000, date: "2026-01-01" },
      { id: "INC-7012", name: "Security Incident 12", severity: "Low", totalCost: 1014000, responseCost: 162240, recoveryCost: 233220, legalCost: 141960, regulatoryCost: 91260, insuranceClaim: 547560, avoidedCost: 62000, date: "2026-04-10" },
    ];
    const yearlyTrend = [
      { month: "Jan", incidents: 6, totalCost: "741k", avgCost: "181k", insured: 46 },
      { month: "Feb", incidents: 3, totalCost: "784k", avgCost: "47k", insured: 46 },
      { month: "Mar", incidents: 11, totalCost: "76k", avgCost: "94k", insured: 46 },
      { month: "Apr", incidents: 8, totalCost: "119k", avgCost: "141k", insured: 46 },
      { month: "May", incidents: 5, totalCost: "162k", avgCost: "188k", insured: 46 },
      { month: "Jun", incidents: 2, totalCost: "205k", avgCost: "54k", insured: 46 },
    ];
...
declare global { interface HTMLElementTagNameMap { 'sc-deception': ScDeception; } }
