...
export class ScZeroTrustDesigner extends LitElement {
  ...
  private _data: MockItem[] = [
    {name:"Identity Verification Layer",status:"implemented",risk:"high",detail:"mTLS everywhere | Certificate pinning | Continuous auth | Risk-based MFA | Device trust required"},
    {name:"Network Micro-Segmentation",status:"in-progress",risk:"critical",detail:"5 security zones defined | East-west firewall rules | Service mesh (Istio) | Zero LAN trust"},
    {name:"Least Privilege Access",status:"implemented",risk:"high",detail:"JIT provisioning | RBAC with attribute checks | Break-glass procedures | Quarterly access review"},
    {name:"Data Classification Enforcement",status:"partial",risk:"medium",detail:"DLP rules: 3/5 levels | Encryption: at-rest + in-transit | Tokenization for PII | Masking for analytics"},
    {name:"Continuous Monitoring",status:"implemented",risk:"low",detail:"UEBA baseline | Anomaly detection | Device posture check | Network flow analysis"}
  ];
  ...
  render() {
    ...
    return html`<div class="panel"><div class="pt">Zero Trust Designer</div>
