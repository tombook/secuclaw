...
@customElement('sc-stride-model')
export class ScStrideModel extends LitElement {
  static styles = css`
...
@state() private _tablePage = 1;
  ...
  @state() private _comments: CommentEntry[] = [
    { id: 'c1', author: 'soc-tier1', timestamp: '2026-04-23 04:00', text: 'Initial assessment started for Stride Model finding #1' },
  ...
  private _items: PanelItem[] = [
      {
            "id": "stride-model-1",
            "title": "S - Spoofing: API Authentication",
            "severity": "medium",
            "status": "open",
            "category": "Security",
            "source": "SIEM",
            "description": "Threat: Token theft via XSS | Component: Auth service | Impact: Account takeover | Mitigation: CSP + HttpOnly + Short TTL",
      ...
      {
            "id": "stride-model-2",
            "title": "T - Tampering: Database Records",
            "severity": "medium",
            "status": "in-progress",
            "category": "Network",
            "source": "EDR",
            "description": "Threat: SQL injection data modification | Component: MySQL | Impact: Data integrity loss | Mitigation: Parameterized queries + checksums",
      ...
      {
            "id": "stride-model-3",
            "title": "R - Repudiation: Admin Actions",
            "severity": "medium",
            "status": "resolved",
            "category": "Access",
            "source": "Scanner",
            "description": "Threat: Shared admin accounts deny attribution | Component: Admin panel | Impact: No accountability | Mitigation: Named accounts + audit log",
      ...
      {
            "id": "stride-model-4",
            "title": "I - Info Disclosure: API Response",
            "severity": "medium",
            "status": "open",
            "category": "Compliance",
            "source": "Audit",
            "description": "Threat: Excessive data in API responses | Component: REST API | Impact: PII leak | Mitigation: Field filtering + DLP",
      ...
      {
            "id": "stride-model-5",
            "title": "D - Denial of Service: Web App",
            "severity": "medium",
            "status": "in-progress",
            "category": "Operations",
            "source": "Manual",
            "description": "Threat: Volumetric DDoS + application layer | Component: Web frontend | Impact: Service outage | Mitigation: CDN + rate limit + WAF",
      ...
      {
            "id": "stride-model-6",
            "title": "E - Elevation of Privilege: JWT",
            "severity": "medium",
            "status": "resolved",
            "category": "Security",
            "source": "SIEM",
            "description": "Threat: JWT role tampering | Component: Auth middleware | Impact: Admin access | Mitigation: Signed tokens + server-side validation",
      ...
      {
            "id": "stride-model-7",
            "title": "Stride Model Finding #7",
            "severity": "low",
            "status": "open",
            "category": "Network",
            "source": "EDR",
            "description": "Automated stride model assessment finding detected during routine scan of infrastructure component. Review and remediation recommended.",
  ...
  private _history: HistoryEntry[] = [
    { timestamp: '2026-04-23 04:15', action: 'Auto-correlated', user: 'system', details: 'Grouped related findings from Stride Model analysis' },
    { timestamp: '2026-04-23 03:00', action: 'Created', user: 'scanner', details: 'New Stride Model finding detected by automated assessment' },
    ...
    { timestamp: '2026-04-22 22:00', action: 'Resolved', user: 'security-eng', details: 'Remediation applied and verified for Stride Model finding' },
    { timestamp: '2026-04-22 18:00', action: 'Created', user: 'audit', details: 'Compliance audit identified Stride Model gap requiring remediation' },
    ...
    { timestamp: '2026-04-21 16:00', action: 'Resolved', user: 'soc-tier1', details: 'False positive confirmed - benign activity flagged by Stride Model scan' },
    { timestamp: '2026-04-21 12:00', action: 'Exported', user: 'compliance', details: 'Exported Stride Model findings for Q1 compliance report' },
  ];
...
private _workflowTasks: WorkflowTask[] = [
    { id: 'wt-1', title: 'Review Stride Model finding #1', status: 'active', assignee: 'soc-tier1', blockedBy: [], slaDeadline: '2026-04-23T12:00:00Z', priority: 'p1', createdAt: '2026-04-23T00:00:00Z', completedAt: null },
    ...
    { id: 'wt-3', title: 'Update Stride Model detection rules', status: 'blocked', assignee: 'soc-tier2', blockedBy: ['wt-2'], slaDeadline: '2026-04-24T00:00:00Z', priority: 'p2', createdAt: '2026-04-23T03:00:00Z', completedAt: null },
    ...
    { id: 'wt-8', title: 'Archive resolved Stride Model findings', status: 'failed', assignee: 'soc-tier1', blockedBy: [], slaDeadline: '2026-04-23T08:00:00Z', priority: 'p4', createdAt: '2026-04-22T22:00:00Z', completedAt: null },
  ];

private _executionHistory: ExecutionRecord[] = [
    {
      id: 'exec-1', name: 'Stride Model Full Assessment Run', startedAt: '2026-04-22T10:00:00Z', completedAt: '2026-04-22T10:12:00Z', status: 'success',
      steps: [
    ...
    {
      id: 'exec-2', name: 'Stride Model Delta Scan', startedAt: '2026-04-23T02:00:00Z', completedAt: '2026-04-23T02:05:00Z', status: 'failed',
      steps: [
  ...
  private _runExecution() {
    ...
    const exec: ExecutionRecord = {
      id: 'exec-' + Date.now(), name: 'Stride Model Assessment ' + new Date().toISOString().slice(0, 10), startedAt: new Date().toISOString(), completedAt: null, status: 'running', steps,
    };
  ...
  private _renderExecutionPanel(): unknown {
    ...
    return html`
      <div class="form-section">
        ...
        ` : html`<div class="empty-state">Click "Run Assessment" to start the Stride Model analysis pipeline</div>`}
      </div>
      <div class="form-section">
        ...
        <div class="settings-card">
          ...
          <div style="display:flex;gap:8px;margin-top:4px;">
            <button class="btn primary" @click=${() => {
              ...
              const a = document.createElement('a'); a.href = url; a.download = 'stride-model-config.json'; a.click();
    ...
    return html`
      <div style="margin-top:12px;">
        ...
        <div style="display:flex;gap:6px;margin-top:8px;">
          <input class="search-box" type="text" placeholder="Add a comment..." style="min-width:auto;flex:1;" id="stride-model-comment-input" />
          <button class="btn primary" @click=${() => {
            const input = this.shadowRoot?.querySelector('#stride-model-comment-input') as HTMLInputElement;
  ...
  private _exportJSON() {
    ...
    const url = URL.createObjectURL(blob);
    const a = document.createElement('a'); a.href = url; a.download = 'sc-stride-model-data.json'; a.click();
    URL.revokeObjectURL(url);
  }
  ...
  private _exportCSV() {
    ...
    const url = URL.createObjectURL(blob);
    const a = document.createElement('a'); a.href = url; a.download = 'sc-stride-model-data.csv'; a.click();
    URL.revokeObjectURL(url);
  }


  // --- Domain Rules Engine ---
  @state() private _smRules: { id: string; name: string; category: string; severity: Severity; enabled: boolean; lastEval: string; passRate: number }[] = [];
  private _initSmRules() {
    const rules = [
  ...
  private _evaluateSmRules(): { passed: number; failed: number; skipped: number; total: number } {
    let passed = 0, failed = 0, skipped = 0;
    this._smRules.forEach(r => { if (!r.enabled) { skipped++; } else if (r.passRate >= 80) { passed++; } else { failed++; } });
    return { passed, failed, skipped, total: this._smRules.length };
  }

  // --- CVSS Scoring ---
  @state() private _smcvssData: { itemId: string; vector: string; base: number; temporal: number; environmental: number; overall: number }[] = [];
  private _initSmCvss() {
    ...
    this._smcvssData = vectors.map((v, i) => {
  ...
  // --- Anomaly Detection ---
  @state() private _smanomalies: { id: string; type: string; severity: Severity; description: string; detected: string; confidence: number; affected: string[] }[] = [];
  private _runSmAnomalyDetection() {
    const types = [
    ...
    this._smanomalies = types.map((a, i) => ({
  ...
  // --- Trend Prediction ---
  @state() private _smpredictions: { horizon: string; metric: string; current: number; predicted: number; direction: 'up' | 'down' | 'stable'; confidence: number }[] = [];
  private _generateSmPredictions() {
    this._smpredictions = [
  ...
  // --- Approval Workflow ---
  @state() private _smApprovals: { id: string; title: string; requester: string; status: 'pending' | 'approved' | 'rejected' | 'expired'; createdAt: string; priority: Priority; type: string }[] = [];
  private _initSmApprovals() {
    this._smApprovals = [
  ...
  private _approveSmItem(id: string) { const item = this._smApprovals.find(a => a.id === id); if (item) item.status = 'approved'; this.requestUpdate(); }
  private _rejectSmItem(id: string) { const item = this._smApprovals.find(a => a.id === id); if (item) item.status = 'rejected'; this.requestUpdate(); }

  // --- Activity Feed ---
  @state() private _smActivity: { id: string; action: string; user: string; target: string; timestamp: string }[] = [];
  private _initSmActivity() {
    const actions = [
    ...
    this._smActivity = actions.map((a, i) => ({ id: 'ACT-' + String(i + 1).padStart(3, '0'), ...a, timestamp: new Date(Date.now() - i * 3600000).toISOString() }));
  }

  // --- Notification System ---
  @state() private _smNotifications: { id: string; message: string; type: 'info' | 'warning' | 'error' | 'success'; read: boolean; timestamp: string }[] = [];
  private _initSmNotifications() {
    this._smNotifications = [
  ...
  private _markSmNotifRead(id: string) { const n = this._smNotifications.find(x => x.id === id); if (n) n.read = true; this.requestUpdate(); }

  // --- Panel Configuration ---
  @state() private _smConfig: { layout: 'compact' | 'default' | 'expanded'; theme: 'dark' | 'midnight' | 'slate'; showAnomalies: boolean; showPredictions: boolean; autoRefresh: boolean; refreshInterval: number } = {
    layout: 'default', theme: 'dark', showAnomalies: true, showPredictions: true, autoRefresh: true, refreshInterval: 60,
  };
  private _smPresets: { name: string; config: typeof this._smConfig }[] = [
  ...
  private _applySmPreset(preset: typeof this._smPresets[0]) { this._smConfig = { ...preset.config }; this.requestUpdate(); }

  private _renderSmTreemapSVG(): string {
    const categories = [
  ...
  private _renderSmSankeySVG(): string {
  ...
  // --- Render: Rules Engine ---
  private _renderSmRules(): any {
    const ev = this._evaluateSmRules();
    return html`
  ...
  private _renderSmAnomalies(): any {
  ...
  // --- Render: Approvals ---
  private _renderSmApprovals(): any {
          ...
          $${this._smApprovals.map(a => html`
            <div style="padding:6px 8px;background:#1f2937;border-radius:4px">
              ...
              $${a.status === 'pending' ? html`
                <div style="display:flex;gap:4px;margin-top:4px">
                  <button class="btn success" style="padding:2px 8px;font-size:9px" @click=$${() => this._approveSmItem(a.id)}>Approve</button>
                  <button class="btn error" style="padding:2px 8px;font-size:9px" @click=$${() => this._rejectSmItem(a.id)}>Reject</button>
                </div>` : nothing}
            </div>`)}
        </div>
      </div>`;
  ...
  private _renderSmNotifications(): any {
    const tc = (t: string) => t === 'error' ? '#ef4444' : t === 'warning' ? '#eab308' : t === 'success' ? '#22c55e' : '#3b82f6';
    const unread = this._smNotifications.filter(n => !n.read).length;
    return html`
      <div style="background:#1a1d27;border-radius:8px;padding:12px;margin-top:12px">
        ...
        <div style="display:flex;flex-direction:column;gap:4px;max-height:120px;overflow-y:auto">
          $${this._smNotifications.map(n => html`
            <div style="display:flex;align-items:center;gap:8px;padding:4px 8px;background:$${n.read ? '#1f2937' : '#252a36'};border-radius:4px;font-size:10px;opacity:$${n.read ? '0.6' : '1'};cursor:pointer" @click=$${() => this._markSmNotifRead(n.id)}>
      ...
      <div style="background:#1a1d27;border-radius:8px;padding:12px;margin-top:12px">
        ...
        <div style="display:flex;flex-direction:column;gap:6px;font-size:10px">
          <div style="display:flex;align-items:center;gap:8px">
            ...
            <select class="form-input" style="flex:1" @change=$${(e: Event) => { this._smConfig.layout = (e.target as HTMLSelectElement).value as any; this.requestUpdate(); }}>
              <option value="compact" ?selected=$${this._smConfig.layout === 'compact'}>Compact</option>
              <option value="default" ?selected=$${this._smConfig.layout === 'default'}>Default</option>
              <option value="expanded" ?selected=$${this._smConfig.layout === 'expanded'}>Expanded</option>
            </select>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Theme</span>
            <select class="form-input" style="flex:1" @change=$${(e: Event) => { this._smConfig.theme = (e.target as HTMLSelectElement).value as any; this.requestUpdate(); }}>
              <option value="dark" ?selected=$${this._smConfig.theme === 'dark'}>Dark</option>
              <option value="midnight" ?selected=$${this._smConfig.theme === 'midnight'}>Midnight</option>
              <option value="slate" ?selected=$${this._smConfig.theme === 'slate'}>Slate</option>
            </select>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Auto Refresh</span>
            <input type="checkbox" ?checked=$${this._smConfig.autoRefresh} @change=$${() => { this._smConfig.autoRefresh = !this._smConfig.autoRefresh; this.requestUpdate(); }}/>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Show Anomalies</span>
            <input type="checkbox" ?checked=$${this._smConfig.showAnomalies} @change=$${() => { this._smConfig.showAnomalies = !this._smConfig.showAnomalies; this.requestUpdate(); }}/>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Show Predictions</span>
            <input type="checkbox" ?checked=$${this._smConfig.showPredictions} @change=$${() => { this._smConfig.showPredictions = !this._smConfig.showPredictions; this.requestUpdate(); }}/>
          </div>
          <div style="margin-top:6px;font-weight:600">Presets</div>
          <div style="display:flex;gap:4px">
            $${this._smPresets.map(ps => html`<button class="btn" style="padding:2px 8px;font-size:9px" @click=$${() => this._applySmPreset(ps)}>$${ps.name}</button>`)}
          </div>
        </div>
      </div>`;
  }
  ...
  @state() private _strideModelContainerScans: Array<{image:string;registry:string;critical:number;high:number;medium:number;scanDate:string;status:string}> = [
  ...
  @state() private _strideModelK8sPods: Array<{namespace:string;pod:string;securityContext:string;hostIPC:boolean;hostPID:boolean;privileged:boolean;riskLevel:string}> = [
  ...
  @state() private _strideModelServerlessRisk: Array<{function:string;runtime:string;timeout:number;iamPerms:string;externalCalls:number;riskScore:number}> = [
  ...
  @state() private _strideModelRuntimeAlerts: Array<{id:string;workload:string;alertType:string;severity:string;description:string;timestamp:string}> = [
  ...
  private _renderStridemodelCloudWl(): TemplateResult {
    const containers = this._strideModelContainerScans;
    const pods = this._strideModelK8sPods;
    const alerts = this._strideModelRuntimeAlerts;
    return html`
  ...
  @state() private _strideModelRiskTopTen: Array<{id:string;name:string;score:number;trend:string;owner:string;category:string;lastAssessed:string}> = [
  ...
  @state() private _strideModelRiskCategories: Array<{category:string;count:number;avgScore:number;color:string}> = [
  ...
  @state() private _strideModelRiskVelocity: Array<{week:string;newRisks:number;closedRisks:number;netChange:number}> = [
  ...
  @state() private _strideModelRiskAppetite: {current:number;threshold:number;maxTolerated:number;status:string} = {
    current: 68, threshold: 55, maxTolerated: 80, status: 'Warning'
  };
  @state() private _strideModelRiskOwnerMatrix: Array<{owner:string;criticalCount:number;highCount:number;mediumCount:number;complianceRate:number}> = [
  ...
  private _renderStridemodelRiskDash(): TemplateResult {
    const riskItems = this._strideModelRiskTopTen;
    const velocity = this._strideModelRiskVelocity;
    const appetite = this._strideModelRiskAppetite;
    return html`
  ...
  @state() private _strideModelCourses: Array<{id:string;title:string;category:string;duration:number;enrolled:number;completed:number;difficulty:string;rating:number}> = [
  ...
  @state() private _strideModelLearningPaths: Array<{id:string;name:string;courseIds:string[];progress:number;enrolled:number}> = [
  ...
  @state() private _strideModelDeptCompliance: Array<{dept:string;trainedPct:number;targetPct:number;avgScore:number;certCount:number}> = [
  ...
  @state() private _strideModelSkillsGaps: Array<{skill:string;current:number;required:number;gap:number;priority:string}> = [
  ...
  private _renderStridemodelTraining(): TemplateResult {
    const courses = this._strideModelCourses;
    const deptComp = this._strideModelDeptCompliance;
    return html`
  ...
  @state() private _strideModelZones: Array<{id:string;name:string;trustLevel:number;subnet:string;devices:number;policy:string;lastAudit:string}> = [
  ...
  @state() private _strideModelSegRules: Array<{id:string;source:string;dest:string;action:string;protocol:string;port:string;status:string;hits:number}> = [
  ...
  @state() private _strideModelCrossZoneTraffic: Array<{source:string;dest:string;bytes:number;sessions:number;violations:number}> = [
  ...
  @state() private _strideModelMicroSegGaps: Array<{id:string;zone:string;gapType:string;severity:string;recommendation:string}> = [
  ...
  private _renderStridemodelNetworkSeg(): TemplateResult {
    const zones = this._strideModelZones;
    const gaps = this._strideModelMicroSegGaps;
    return html`
  ...
  @state() private _complianceCalendarEvents: Array<{id: string; title: string; deadline: string; category: string; status: string; assignee: string; notes: string}> = [
    {id: 'cc-stride-model-001', title: 'SOX Section 404 Compliance Review', deadline: '2026-06-30', category: 'Regulatory', status: 'In Progress', assignee: 'Compliance Team', notes: 'Annual internal control assessment for financial reporting'},
    {id: 'cc-stride-model-002', title: 'GDPR Data Protection Impact Assessment', deadline: '2026-05-15', category: 'Privacy', status: 'Pending', assignee: 'DPO Office', notes: 'Quarterly DPIA for high-risk processing activities'},
    {id: 'cc-stride-model-003', title: 'ISO 27001 Surveillance Audit', deadline: '2026-07-20', category: 'Certification', status: 'Scheduled', assignee: 'QA Lead', notes: 'Stage 2 surveillance audit for ISMS certification renewal'},
    {id: 'cc-stride-model-004', title: 'PCI DSS v4.0 Gap Analysis', deadline: '2026-05-30', category: 'Payment', status: 'Not Started', assignee: 'Security Architect', notes: 'Assess current state against PCI DSS v4.0 requirements'},
    {id: 'cc-stride-model-005', title: 'NIST CSF Self-Assessment', deadline: '2026-08-15', category: 'Framework', status: 'Pending', assignee: 'CISO', notes: 'Biannual self-assessment against NIST Cybersecurity Framework'},
    {id: 'cc-stride-model-006', title: 'HIPAA Security Rule Audit', deadline: '2026-06-15', category: 'Healthcare', status: 'In Progress', assignee: 'Compliance Analyst', notes: 'Annual audit of administrative, physical, and technical safeguards'},
    {id: 'cc-stride-model-007', title: 'SOC 2 Type II Report Renewal', deadline: '2026-09-30', category: 'Audit', status: 'Scheduled', assignee: 'External Auditor', notes: 'Engage auditor for SOC 2 Type II examination period'},
    {id: 'cc-stride-model-008', title: 'FedRAMP Authorization Review', deadline: '2026-07-01', category: 'Government', status: 'Pending', assignee: 'FedRAMP PMO', notes: 'Review and update security authorization package'},
    {id: 'cc-stride-model-009', title: 'Annual Penetration Test', deadline: '2026-10-15', category: 'Testing', status: 'Not Started', assignee: 'Red Team Lead', notes: 'Comprehensive external and internal penetration testing engagement'},
    {id: 'cc-stride-model-010', title: 'Security Awareness Training Rollout', deadline: '2026-05-01', category: 'Training', status: 'Completed', assignee: 'Security Awareness Manager', notes: 'Q2 organization-wide security awareness training program'},
    {id: 'cc-stride-model-011', title: 'Vendor Security Review Cycle', deadline: '2026-06-01', category: 'Third Party', status: 'In Progress', assignee: 'Vendor Manager', notes: 'Quarterly review of critical vendor security posture and SLA compliance'},
    {id: 'cc-stride-model-012', title: 'Incident Response Plan Update', deadline: '2026-05-20', category: 'Operations', status: 'Pending', assignee: 'IR Team Lead', notes: 'Update IR procedures based on lessons learned from recent incidents'},
  ];
  ...
  @state() private _dataQualityMetrics: Array<{id: string; dataSource: string; completenessScore: number; accuracyScore: number; timelinessScore: number; consistencyScore: number; reliabilityRank: number; lastUpdated: string; issues: string[]; trend: string}> = [
    {id: 'dq-stride-model-001', dataSource: 'Vulnerability Scanner Feed', completenessScore: 94, accuracyScore: 91, timelinessScore: 88, consistencyScore: 95, reliabilityRank: 1, lastUpdated: '2026-04-23T08:00:00Z', issues: ['Minor delay in Nessus plugin updates'], trend: 'improving'},
    {id: 'dq-stride-model-002', dataSource: 'SIEM Event Logs', completenessScore: 87, accuracyScore: 93, timelinessScore: 96, consistencyScore: 89, reliabilityRank: 2, lastUpdated: '2026-04-23T07:30:00Z', issues: ['Some log sources showing gaps in off-hours'], trend: 'stable'},
    {id: 'dq-stride-model-003', dataSource: 'Asset Inventory Database', completenessScore: 82, accuracyScore: 78, timelinessScore: 75, consistencyScore: 84, reliabilityRank: 4, lastUpdated: '2026-04-22T18:00:00Z', issues: ['Shadow IT devices not fully cataloged', 'Decommissioned assets still listed'], trend: 'declining'},
    {id: 'dq-stride-model-004', dataSource: 'Threat Intelligence Platform', completenessScore: 91, accuracyScore: 89, timelinessScore: 92, consistencyScore: 87, reliabilityRank: 3, lastUpdated: '2026-04-23T06:00:00Z', issues: ['Some IOC sources lack confidence scoring'], trend: 'improving'},
    {id: 'dq-stride-model-005', dataSource: 'Identity Provider Logs', completenessScore: 96, accuracyScore: 97, timelinessScore: 98, consistencyScore: 96, reliabilityRank: 1, lastUpdated: '2026-04-23T09:00:00Z', issues: [], trend: 'stable'},
    {id: 'dq-stride-model-006', dataSource: 'Cloud Security Posture Data', completenessScore: 79, accuracyScore: 85, timelinessScore: 82, consistencyScore: 81, reliabilityRank: 5, lastUpdated: '2026-04-23T05:00:00Z', issues: ['Multi-cloud coverage gaps', 'API rate limiting affects scan frequency'], trend: 'declining'},
    {id: 'dq-stride-model-007', dataSource: 'Compliance Evidence Store', completenessScore: 88, accuracyScore: 86, timelinessScore: 80, consistencyScore: 83, reliabilityRank: 4, lastUpdated: '2026-04-21T14:00:00Z', issues: ['Manual evidence collection delays', 'Inconsistent formatting across frameworks'], trend: 'stable'},
    {id: 'dq-stride-model-008', dataSource: 'Network Flow Data', completenessScore: 92, accuracyScore: 90, timelinessScore: 94, consistencyScore: 91, reliabilityRank: 2, lastUpdated: '2026-04-23T08:30:00Z', issues: ['Encrypted traffic classification accuracy needs improvement'], trend: 'improving'},
  ];
  ...
  @state() private _workflowTemplates: Array<{id: string; name: string; description: string; category: string; steps: number; avgDuration: string; successRate: number; lastRun: string; manualInterventions: number; optimizationScore: number}> = [
    {id: 'wf-stride-model-001', name: 'Vulnerability Triage Pipeline', description: 'Automated vulnerability assessment, prioritization, and assignment workflow', category: 'Vulnerability Management', steps: 8, avgDuration: '12 min', successRate: 94.5, lastRun: '2026-04-23T06:00:00Z', manualInterventions: 2, optimizationScore: 87},
    {id: 'wf-stride-model-002', name: 'Incident Response Orchestration', description: 'End-to-end IR workflow from detection to containment and recovery', category: 'Incident Response', steps: 15, avgDuration: '45 min', successRate: 89.2, lastRun: '2026-04-22T14:30:00Z', manualInterventions: 5, optimizationScore: 72},
    {id: 'wf-stride-model-003', name: 'Access Request Approval Chain', description: 'Multi-level approval workflow for privileged access requests', category: 'Identity & Access', steps: 6, avgDuration: '4 hours', successRate: 97.1, lastRun: '2026-04-23T09:15:00Z', manualInterventions: 1, optimizationScore: 92},
    {id: 'wf-stride-model-004', name: 'Compliance Evidence Collection', description: 'Automated gathering and packaging of audit evidence artifacts', category: 'Compliance', steps: 10, avgDuration: '30 min', successRate: 91.8, lastRun: '2026-04-21T10:00:00Z', manualInterventions: 3, optimizationScore: 78},
    {id: 'wf-stride-model-005', name: 'Security Patch Deployment', description: 'Staged patch rollout with validation and rollback capability', category: 'Patch Management', steps: 12, avgDuration: '2 hours', successRate: 96.3, lastRun: '2026-04-20T22:00:00Z', manualInterventions: 1, optimizationScore: 85},
    {id: 'wf-stride-model-006', name: 'Threat Intelligence Enrichment', description: 'IOC enrichment and correlation with internal threat data', category: 'Threat Intelligence', steps: 7, avgDuration: '8 min', successRate: 93.7, lastRun: '2026-04-23T07:00:00Z', manualInterventions: 0, optimizationScore: 95},
    {id: 'wf-stride-model-007', name: 'Security Reporting Pipeline', description: 'Automated generation and distribution of security metrics reports', category: 'Reporting', steps: 5, avgDuration: '15 min', successRate: 98.9, lastRun: '2026-04-23T08:00:00Z', manualInterventions: 0, optimizationScore: 97},
    {id: 'wf-stride-model-008', name: 'Vendor Risk Assessment', description: 'Automated vendor security questionnaire distribution and scoring', category: 'Third Party', steps: 9, avgDuration: '3 days', successRate: 85.4, lastRun: '2026-04-19T11:00:00Z', manualInterventions: 4, optimizationScore: 65},
  ];
  ...
  @state() private _workflowExecutionHistory: Array<{workflowId: string; runDate: string; duration: string; status: string; trigger: string}> = [
    {workflowId: 'wf-stride-model-001', runDate: '2026-04-23T06:00:00Z', duration: '11 min 23 sec', status: 'Success', trigger: 'Scheduled'},
    {workflowId: 'wf-stride-model-002', runDate: '2026-04-22T14:30:00Z', duration: '42 min 15 sec', status: 'Success', trigger: 'Alert'},
    {workflowId: 'wf-stride-model-003', runDate: '2026-04-23T09:15:00Z', duration: '3h 45 min', status: 'Success', trigger: 'User Request'},
    {workflowId: 'wf-stride-model-001', runDate: '2026-04-22T06:00:00Z', duration: '13 min 08 sec', status: 'Partial', trigger: 'Scheduled'},
    {workflowId: 'wf-stride-model-004', runDate: '2026-04-21T10:00:00Z', duration: '28 min 42 sec', status: 'Success', trigger: 'Scheduled'},
  ];
  ...
  @state() private _knowledgeArticles: Array<{id: string; title: string; category: string; author: string; publishDate: string; views: number; rating: number; tags: string[]; summary: string; readTime: string}> = [
    {id: 'kb-stride-model-001', title: 'Zero Trust Architecture Implementation Guide', category: 'Architecture', author: 'Security Architecture Team', publishDate: '2026-03-15', views: 1842, rating: 4.8, tags: ['zero-trust', 'network', 'identity'], summary: 'Comprehensive guide for implementing zero trust principles across enterprise infrastructure', readTime: '15 min'},
    {id: 'kb-stride-model-002', title: 'Ransomware Defense Playbook 2026', category: 'Threats', author: 'Threat Intelligence Team', publishDate: '2026-04-01', views: 2341, rating: 4.9, tags: ['ransomware', 'incident-response', 'defense'], summary: 'Updated playbook with latest ransomware tactics, techniques, and defensive measures', readTime: '12 min'},
    {id: 'kb-stride-model-003', title: 'Cloud Security Best Practices for Multi-Cloud', category: 'Cloud', author: 'Cloud Security Team', publishDate: '2026-02-28', views: 1567, rating: 4.5, tags: ['cloud', 'aws', 'azure', 'gcp'], summary: 'Best practices for securing workloads across multiple cloud service providers', readTime: '18 min'},
    {id: 'kb-stride-model-004', title: 'API Security Testing Methodology', category: 'Testing', author: 'Red Team', publishDate: '2026-03-22', views: 987, rating: 4.6, tags: ['api', 'testing', 'owasp'], summary: 'Structured methodology for identifying and testing API security vulnerabilities', readTime: '10 min'},
    {id: 'kb-stride-model-005', title: 'Supply Chain Security Risk Management', category: 'Third Party', author: 'GRC Team', publishDate: '2026-01-20', views: 1234, rating: 4.3, tags: ['supply-chain', 'vendor', 'risk'], summary: 'Framework for managing security risks in the software supply chain', readTime: '14 min'},
    {id: 'kb-stride-model-006', title: 'Kubernetes Security Hardening Checklist', category: 'Container', author: 'Platform Security', publishDate: '2026-04-10', views: 2103, rating: 4.7, tags: ['kubernetes', 'container', 'hardening'], summary: 'Step-by-step hardening checklist for production Kubernetes clusters', readTime: '11 min'},
    {id: 'kb-stride-model-007', title: 'Security Metrics That Matter for Executives', category: 'Metrics', author: 'CISO Office', publishDate: '2026-03-05', views: 876, rating: 4.4, tags: ['metrics', 'kpi', 'reporting'], summary: 'Key security metrics and KPIs that resonate with board-level stakeholders', readTime: '8 min'},
    {id: 'kb-stride-model-008', title: 'Phishing Simulation Campaign Design', category: 'Awareness', author: 'Security Awareness Team', publishDate: '2026-02-15', views: 1456, rating: 4.5, tags: ['phishing', 'simulation', 'training'], summary: 'Designing effective phishing simulations that drive real behavioral change', readTime: '9 min'},
    {id: 'kb-stride-model-009', title: 'Data Loss Prevention Strategy and Implementation', category: 'Data Protection', author: 'Data Security Team', publishDate: '2026-03-28', views: 1678, rating: 4.6, tags: ['dlp', 'data-protection', 'compliance'], summary: 'Strategic approach to DLP covering people, process, and technology layers', readTime: '16 min'},
    {id: 'kb-stride-model-010', title: 'Security Automation with SOAR Platforms', category: 'Automation', author: 'SOC Engineering', publishDate: '2026-04-05', views: 1098, rating: 4.7, tags: ['soar', 'automation', 'soc'], summary: 'Building effective security automation playbooks using SOAR technology', readTime: '13 min'},
    {id: 'kb-stride-model-011', title: 'Third-Party Risk Assessment Framework', category: 'GRC', author: 'Vendor Management', publishDate: '2026-01-30', views: 1345, rating: 4.4, tags: ['vendor', 'risk', 'assessment'], summary: 'Structured framework for evaluating and monitoring third-party security risks', readTime: '12 min'},
    {id: 'kb-stride-model-012', title: 'Network Detection and Response Best Practices', category: 'Network', author: 'Network Security Team', publishDate: '2026-03-18', views: 1567, rating: 4.5, tags: ['ndr', 'network', 'detection'], summary: 'Implementing effective network detection and response capabilities', readTime: '14 min'},
    {id: 'kb-stride-model-013', title: 'Security Chaos Engineering Guide', category: 'Resilience', author: 'SRE Security', publishDate: '2026-04-12', views: 789, rating: 4.3, tags: ['chaos-engineering', 'resilience', 'testing'], summary: 'Applying chaos engineering principles to validate security controls', readTime: '10 min'},
    {id: 'kb-stride-model-014', title: 'Incident Communication Templates', category: 'Incident Response', author: 'IR Team', publishDate: '2026-02-22', views: 2234, rating: 4.8, tags: ['incident', 'communication', 'templates'], summary: 'Ready-to-use communication templates for security incident scenarios', readTime: '7 min'},
    {id: 'kb-stride-model-015', title: 'Endpoint Detection and Response Configuration', category: 'Endpoint', author: 'Endpoint Security', publishDate: '2026-03-08', views: 1345, rating: 4.5, tags: ['edr', 'endpoint', 'configuration'], summary: 'Optimal EDR configuration for maximum detection with minimal false positives', readTime: '11 min'},
    {id: 'kb-stride-model-016', title: 'Security Code Review Standards', category: 'Development', author: 'AppSec Team', publishDate: '2026-02-10', views: 1890, rating: 4.6, tags: ['code-review', 'secure-sdlc', 'standards'], summary: 'Standards and checklists for security-focused code reviews', readTime: '13 min'},
    {id: 'kb-stride-model-017', title: 'IoT Security Assessment Methodology', category: 'IoT', author: 'IoT Security Lab', publishDate: '2026-04-08', views: 654, rating: 4.2, tags: ['iot', 'embedded', 'assessment'], summary: 'Methodology for assessing security posture of IoT devices and ecosystems', readTime: '15 min'},
    {id: 'kb-stride-model-018', title: 'Passwordless Authentication Migration Guide', category: 'Identity', author: 'IAM Team', publishDate: '2026-03-25', views: 1678, rating: 4.7, tags: ['passwordless', 'authentication', 'mfa'], summary: 'Step-by-step migration plan from password-based to passwordless authentication', readTime: '12 min'},
    {id: 'kb-stride-model-019', title: 'Security Awareness Program Metrics', category: 'Awareness', author: 'Security Culture Team', publishDate: '2026-01-25', views: 1123, rating: 4.4, tags: ['awareness', 'metrics', 'culture'], summary: 'Measuring the effectiveness of your security awareness and training programs', readTime: '9 min'},
    {id: 'kb-stride-model-020', title: 'Deception Technology Deployment Guide', category: 'Detection', author: 'Blue Team', publishDate: '2026-04-15', views: 876, rating: 4.5, tags: ['deception', 'honeypot', 'detection'], summary: 'Planning and deploying deception technology for advanced threat detection', readTime: '11 min'},
  ];
  ...
  // --- Security Scenario Planning Methods (STMO) ---
  private _initStmoScenarios(): void {
    const worstCaseScenarios = [
      { id: "stmo-sc-01", name: "Ransomware Attack on Critical Infrastructure", category: "Malware", impact: 9500000, probability: 0.12, recoveryDays: 21, affectedSystems: 47, dataLossGb: 320, businessImpact: "critical" },
      { id: "stmo-sc-02", name: "Insider Data Exfiltration via Authorized Channels", category: "Insider Threat", impact: 7200000, probability: 0.18, recoveryDays: 14, affectedSystems: 12, dataLossGb: 85, businessImpact: "high" },
      { id: "stmo-sc-03", name: "Supply Chain Compromise via Third-Party Library", category: "Supply Chain", impact: 6800000, probability: 0.09, recoveryDays: 30, affectedSystems: 63, dataLossGb: 0, businessImpact: "critical" },
      { id: "stmo-sc-04", name: "Cloud Misconfiguration Leading to Public Exposure", category: "Cloud", impact: 4100000, probability: 0.22, recoveryDays: 7, affectedSystems: 8, dataLossGb: 450, businessImpact: "high" },
      { id: "stmo-sc-05", name: "Zero-Day Exploit in Core Application Framework", category: "Vulnerability", impact: 8900000, probability: 0.05, recoveryDays: 45, affectedSystems: 120, dataLossGb: 0, businessImpact: "critical" },
      { id: "stmo-sc-06", name: "Distributed Denial of Service on Customer-Facing Services", category: "Availability", impact: 3400000, probability: 0.25, recoveryDays: 3, affectedSystems: 15, dataLossGb: 0, businessImpact: "medium" },
      { id: "stmo-sc-07", name: "Credential Stuffing and Account Takeover Wave", category: "Identity", impact: 2800000, probability: 0.30, recoveryDays: 5, affectedSystems: 6, dataLossGb: 12, businessImpact: "medium" },
      { id: "stmo-sc-08", name: "Physical Security Breach at Data Center Facility", category: "Physical", impact: 12000000, probability: 0.02, recoveryDays: 60, affectedSystems: 200, dataLossGb: 5000, businessImpact: "critical" },
    ];
    this._stmoScenarios = worstCaseScenarios.map(s => ({ ...s, mitigationCost: Math.round(s.impact * 0.08), drillScheduled: false, lastDrillDate: null, drillScore: null, controlGaps: Math.floor(Math.random() * 5) + 1 }));
  }

  private _calculateStmoScenarioRisk(): void {
    this._stmoScenarios.forEach(s => {
  ...
  private _scheduleStmoDrills(): void {
  ...
  private _stmoScenarioComparison(): Record<string, unknown>[] {
    return this._stmoScenarios.map(s => ({
  ...
  // --- Security Control Effectiveness Analytics (STMO) ---
  private _initStmoControls(): void {
    const controls = [
      { id: "stmo-ct-01", name: "Network Segmentation", type: "preventive", maturity: "defined", score: 82, target: 90, failures: 3, lastTest: "2026-03-15" },
      { id: "stmo-ct-02", name: "Endpoint Detection and Response", type: "detective", maturity: "managed", score: 88, target: 92, failures: 1, lastTest: "2026-04-01" },
      { id: "stmo-ct-03", name: "Data Loss Prevention", type: "preventive", maturity: "repeatable", score: 71, target: 85, failures: 7, lastTest: "2026-03-22" },
      { id: "stmo-ct-04", name: "Security Information and Event Management", type: "detective", maturity: "managed", score: 85, target: 90, failures: 2, lastTest: "2026-04-05" },
      { id: "stmo-ct-05", name: "Identity and Access Management", type: "preventive", maturity: "defined", score: 76, target: 88, failures: 5, lastTest: "2026-03-28" },
      { id: "stmo-ct-06", name: "Vulnerability Management", type: "corrective", maturity: "managed", score: 80, target: 90, failures: 4, lastTest: "2026-04-02" },
      { id: "stmo-ct-07", name: "Email Security Gateway", type: "preventive", maturity: "managed", score: 90, target: 95, failures: 1, lastTest: "2026-04-08" },
      { id: "stmo-ct-08", name: "Web Application Firewall", type: "preventive", maturity: "managed", score: 87, target: 92, failures: 2, lastTest: "2026-03-30" },
      { id: "stmo-ct-09", name: "Patch Management", type: "corrective", maturity: "defined", score: 68, target: 85, failures: 9, lastTest: "2026-03-18" },
      { id: "stmo-ct-10", name: "Encryption at Rest", type: "preventive", maturity: "managed", score: 93, target: 95, failures: 0, lastTest: "2026-04-10" },
      { id: "stmo-ct-11", name: "Encryption in Transit", type: "preventive", maturity: "optimized", score: 96, target: 98, failures: 0, lastTest: "2026-04-12" },
      { id: "stmo-ct-12", name: "Privileged Access Management", type: "preventive", maturity: "defined", score: 74, target: 88, failures: 6, lastTest: "2026-03-25" },
      { id: "stmo-ct-13", name: "Security Awareness Training", type: "preventive", maturity: "repeatable", score: 65, target: 80, failures: 11, lastTest: "2026-03-20" },
      { id: "stmo-ct-14", name: "Incident Response Plan", type: "corrective", maturity: "managed", score: 78, target: 88, failures: 4, lastTest: "2026-04-03" },
      { id: "stmo-ct-15", name: "Backup and Recovery", type: "corrective", maturity: "managed", score: 84, target: 92, failures: 3, lastTest: "2026-04-06" },
      { id: "stmo-ct-16", name: "Multi-Factor Authentication", type: "preventive", maturity: "managed", score: 91, target: 95, failures: 1, lastTest: "2026-04-09" },
      { id: "stmo-ct-17", name: "Network Traffic Analysis", type: "detective", maturity: "defined", score: 72, target: 85, failures: 5, lastTest: "2026-03-27" },
      { id: "stmo-ct-18", name: "Cloud Security Posture Management", type: "detective", maturity: "repeatable", score: 69, target: 82, failures: 8, lastTest: "2026-03-24" },
      { id: "stmo-ct-19", name: "Container Security Scanning", type: "preventive", maturity: "defined", score: 75, target: 85, failures: 5, lastTest: "2026-04-04" },
      { id: "stmo-ct-20", name: "API Security Gateway", type: "preventive", maturity: "repeatable", score: 70, target: 82, failures: 7, lastTest: "2026-03-29" },
      { id: "stmo-ct-21", name: "Threat Intelligence Platform", type: "detective", maturity: "managed", score: 83, target: 90, failures: 2, lastTest: "2026-04-07" },
      { id: "stmo-ct-22", name: "Database Activity Monitoring", type: "detective", maturity: "defined", score: 67, target: 80, failures: 8, lastTest: "2026-03-21" },
      { id: "stmo-ct-23", name: "Deception Technology", type: "detective", maturity: "initial", score: 55, target: 75, failures: 12, lastTest: "2026-03-16" },
      { id: "stmo-ct-24", name: "Security Orchestration Automation", type: "corrective", maturity: "repeatable", score: 73, target: 85, failures: 6, lastTest: "2026-04-01" },
      { id: "stmo-ct-25", name: "Third-Party Risk Assessment", type: "preventive", maturity: "defined", score: 64, target: 78, failures: 9, lastTest: "2026-03-19" },
    ];
    this._stmoControls = controls;
  }

  private _analyzeStmoControlEffectiveness(): void {
    const typeBreakdown: Record<string, { total: number; avgScore: number; avgFailures: number }> = {};
    this._stmoControls.forEach(c => {
    ...
    this._stmoControlTypeBreakdown = typeBreakdown;
  }

  private _stmoControlOptimization(): Record<string, unknown>[] {
    return this._stmoControls.filter(c => c.score < c.target).map(c => ({
  ...
  // --- Security Data Pipeline Health (STMO) ---
  private _initStmoPipelines(): void {
    const pipelines = [
      { id: "stmo-pl-01", name: "SIEM Log Ingestion", status: "healthy", healthScore: 94, latencyMs: 120, freshnessMin: 2, errorRate: 0.02, throughputMbps: 450, recordsPerSec: 12000, backPressure: 0.05, uptime: 99.97 },
      { id: "stmo-pl-02", name: "Threat Feed Aggregation", status: "healthy", healthScore: 91, latencyMs: 300, freshnessMin: 15, errorRate: 0.05, throughputMbps: 85, recordsPerSec: 3200, backPressure: 0.08, uptime: 99.92 },
      { id: "stmo-pl-03", name: "Vulnerability Scan Results", status: "degraded", healthScore: 72, latencyMs: 2500, freshnessMin: 60, errorRate: 0.15, throughputMbps: 25, recordsPerSec: 800, backPressure: 0.35, uptime: 98.50 },
      { id: "stmo-pl-04", name: "Endpoint Telemetry Stream", status: "healthy", healthScore: 88, latencyMs: 450, freshnessMin: 5, errorRate: 0.08, throughputMbps: 280, recordsPerSec: 8500, backPressure: 0.12, uptime: 99.85 },
      { id: "stmo-pl-05", name: "Cloud Audit Log Pipeline", status: "healthy", healthScore: 86, latencyMs: 600, freshnessMin: 10, errorRate: 0.06, throughputMbps: 150, recordsPerSec: 4500, backPressure: 0.10, uptime: 99.80 },
      { id: "stmo-pl-06", name: "Identity Event Stream", status: "warning", healthScore: 78, latencyMs: 1200, freshnessMin: 20, errorRate: 0.12, throughputMbps: 45, recordsPerSec: 1500, backPressure: 0.22, uptime: 99.40 },
      { id: "stmo-pl-07", name: "Network Flow Collection", status: "healthy", healthScore: 82, latencyMs: 800, freshnessMin: 8, errorRate: 0.09, throughputMbps: 650, recordsPerSec: 18000, backPressure: 0.15, uptime: 99.70 },
      { id: "stmo-pl-08", name: "DLP Incident Pipeline", status: "degraded", healthScore: 68, latencyMs: 3500, freshnessMin: 45, errorRate: 0.20, throughputMbps: 18, recordsPerSec: 500, backPressure: 0.42, uptime: 97.80 },
    ];
    this._stmoPipelines = pipelines.map(p => ({ ...p, dependencies: [], slaBreached: p.healthScore < 75, alertThreshold: p.errorRate > 0.15 }));
    this._stmoPipelines[0].dependencies = ["stmo-pl-04", "stmo-pl-07"];
    this._stmoPipelines[4].dependencies = ["stmo-pl-01"];
    this._stmoPipelines[5].dependencies = ["stmo-pl-02"];
    this._stmoPipelines[7].dependencies = ["stmo-pl-04", "stmo-pl-05"];
  }

  private _stmoPipelineTrend(): Record<string, unknown>[] {
    const hours = Array.from({ length: 24 }, (_, i) => `H${String(i).padStart(2, "0")}`);
    return this._stmoPipelines.map(p => ({
  ...
  // --- Security Stakeholder Report Generator (STMO) ---
  private _initStmoReportTemplates(): void {
    this._stmoReportTemplates = [
      { id: "stmo-rp-01", name: "Board Security Report", audience: "board", frequency: "quarterly", sections: 6, autoGenerate: true, lastGenerated: "2026-03-31", pages: 12 },
      { id: "stmo-rp-02", name: "Executive Risk Summary", audience: "executive", frequency: "monthly", sections: 8, autoGenerate: true, lastGenerated: "2026-04-01", pages: 8 },
      { id: "stmo-rp-03", name: "Technical Security Review", audience: "technical", frequency: "weekly", sections: 12, autoGenerate: true, lastGenerated: "2026-04-21", pages: 25 },
      { id: "stmo-rp-04", name: "Audit Compliance Report", audience: "audit", frequency: "quarterly", sections: 10, autoGenerate: false, lastGenerated: "2026-03-15", pages: 35 },
      { id: "stmo-rp-05", name: "Regulatory Filing Package", audience: "regulatory", frequency: "annual", sections: 15, autoGenerate: false, lastGenerated: "2025-12-31", pages: 48 },
    ];
  }

  private _generateStmoExecSummary(): string {
    const totalRisk = this._stmoScenarios.reduce((sum: number, s: any) => sum + s.riskScore, 0);
    const avgControl = Math.round(this._stmoControls.reduce((sum: number, c: any) => sum + c.score, 0) / this._stmoControls.length);
    const degradedPipes = this._stmoPipelines.filter((p: any) => p.status !== "healthy").length;
    return `Overall risk exposure: ${(totalRisk / 1000000).toFixed(1)}M. Average control effectiveness: {avgControl}%. {degradedPipes} pipeline(s) need attention. {this._stmoScenarios.filter((s: any) => s.mitigationPriority === "immediate").length} scenarios require immediate action.`;
  }

  // --- Security Technology Radar (STMO) ---
  private _initStmoTechRadar(): void {
    this._stmoTechRadar = [
      { id: "stmo-tr-01", name: "AI-Powered Threat Detection", ring: "adopt", category: "Detection", maturity: 4, trend: "up", investment: "high", roi: 3.2, vendorCount: 8 },
      { id: "stmo-tr-02", name: "Zero Trust Architecture", ring: "adopt", category: "Architecture", maturity: 4, trend: "up", investment: "high", roi: 2.8, vendorCount: 12 },
      { id: "stmo-tr-03", name: "SASE/SSE Platform", ring: "trial", category: "Network", maturity: 3, trend: "up", investment: "medium", roi: 2.4, vendorCount: 10 },
      { id: "stmo-tr-04", name: "CNAPP Cloud Security", ring: "trial", category: "Cloud", maturity: 3, trend: "up", investment: "medium", roi: 2.1, vendorCount: 7 },
      { id: "stmo-tr-05", name: "Extended Detection and Response", ring: "adopt", category: "Detection", maturity: 4, trend: "stable", investment: "high", roi: 2.9, vendorCount: 9 },
      { id: "stmo-tr-06", name: "Quantum-Safe Cryptography", ring: "assess", category: "Crypto", maturity: 2, trend: "up", investment: "low", roi: 0.8, vendorCount: 4 },
      { id: "stmo-tr-07", name: "Security Service Edge", ring: "trial", category: "Network", maturity: 3, trend: "up", investment: "medium", roi: 2.0, vendorCount: 6 },
      { id: "stmo-tr-08", name: "SOAR 2.0 Autonomous SOC", ring: "assess", category: "Operations", maturity: 2, trend: "up", investment: "low", roi: 1.2, vendorCount: 5 },
      { id: "stmo-tr-09", name: "Software Supply Chain Security", ring: "trial", category: "DevSecOps", maturity: 3, trend: "up", investment: "medium", roi: 2.3, vendorCount: 8 },
      { id: "stmo-tr-10", name: "Identity Threat Detection", ring: "adopt", category: "Identity", maturity: 3, trend: "up", investment: "high", roi: 2.7, vendorCount: 7 },
      { id: "stmo-tr-11", name: "Data Security Posture Management", ring: "trial", category: "Data", maturity: 3, trend: "up", investment: "medium", roi: 2.2, vendorCount: 9 },
      { id: "stmo-tr-12", name: "Decentralized Identity Standards", ring: "hold", category: "Identity", maturity: 1, trend: "stable", investment: "low", roi: 0.5, vendorCount: 3 },
    ];
  }

  private _stmoRadarSummary(): Record<string, unknown> {
    const rings: Record<string, number> = { adopt: 0, trial: 0, assess: 0, hold: 0 };
    this._stmoTechRadar.forEach(t => { if (rings[t.ring as keyof typeof rings] !== undefined) rings[t.ring as keyof typeof rings]++; });
    return { adopt: rings.adopt, trial: rings.trial, assess: rings.assess, hold: rings.hold, total: this._stmoTechRadar.length, avgMaturity: 2.8, topInvestment: this._stmoTechRadar.filter(t => t.investment === "high").map(t => t.name) };
  }

  // --- STMO Security Compliance Mapping Matrix ---
  private _initStmoComplianceMatrix(): void {
    ...
    this._stmoComplianceMatrix = frameworks.map(fw => ({
  ...
  private _stmoComplianceTrend(): Record<string, unknown>[] {
    const quarters = ["Q1-2025", "Q2-2025", "Q3-2025", "Q4-2025", "Q1-2026", "Q2-2026"];
    return this._stmoComplianceMatrix.map(fw => ({
  ...
  // --- STMO Threat Intelligence Correlation Engine ---
  private _initStmoThreatIntel(): void {
    ...
    this._stmoThreatIntel = threatActors.map((actor, i) => ({
  ...
  private _stmoThreatCorrelation(): Record<string, unknown>[] {
    return this._stmoThreatIntel.filter(t => t.riskScore > 70).map(t => ({
  ...
  // --- STMO Security Metrics Deep Dive ---
  private _initStmoMetricsDeep(): void {
    ...
    this._stmoMetricsDeep = metricCategories.map(cat => ({
  ...
  private _stmoMetricsHeatmap(): number[][] {
    return this._stmoMetricsDeep.map(cat =>
      cat.metrics.map(m => Math.round((m.value / m.target) * 100))
    );
  }

  // --- STMO Incident Cost Modeling ---
  private _initStmoCostModel(): void {
    const incidentTypes = ["Data Breach", "Ransomware", "DDoS", "Insider Threat", "Phishing", "Supply Chain", "Cloud Misconfig", "Zero-Day"];
    this._stmoCostModel = incidentTypes.map(inc => ({
    ...
    this._stmoCostModel.forEach(m => { m.totalAnnualExposure = m.avgCost * m.frequency; });
  }

  private _stmoCostProjection(): Record<string, unknown>[] {
    return this._stmoCostModel.map(m => ({
  ...
  // --- STMO Security Architecture Pattern Library ---
  private _initStmoArchPatterns(): void {
    ...
    this._stmoArchPatterns = patterns.map((p, i) => ({
  ...
  private _stmoArchPatternAnalysis(): Record<string, unknown> {
    const implemented = this._stmoArchPatterns.filter(p => p.implementation > 75).length;
    const avgCoverage = Math.round(this._stmoArchPatterns.reduce((s: number, p: any) => s + p.coverage, 0) / this._stmoArchPatterns.length);
    return {
      totalPatterns: this._stmoArchPatterns.length, fullyImplemented: implemented, avgCoverage,
      avgRiskReduction: Math.round(this._stmoArchPatterns.reduce((s: number, p: any) => s + p.riskReduction, 0) / this._stmoArchPatterns.length),
      gaps: this._stmoArchPatterns.filter(p => p.implementation < 60).map(p => p.pattern),
      recommendations: this._stmoArchPatterns.filter(p => p.implementation < 70).map(p => ({ pattern: p.pattern, current: p.implementation, target: 85, effort: p.costComplexity }))
    };
  }
  ...
  private _0dfRiskAssessmentWorkflow = [
  ...
  private _0dfTreatmentOptions = [
    {id: '0df-T-001', riskId: 'RSK-042', risk: 'Ransomware Attack on Critical Infrastructure', before: 20, after: 6, strategy: 'Mitigate', controls: ['Next-gen EDR with behavioral detection and automated response', 'Zero-trust network micro-segmentation isolating critical assets', 'Immutable offline backup rotation with quarterly recovery testing', 'Incident response retainer with 1-hour response SLA'], cost: '$450K/yr', roi: '78% reduction vs $2.8M potential loss', timeline: 'Q3 2026', status: 'approved' as const},
  ...
  private _0dfTalentPositions = [
    ...
    {id: '0df-H-002', title: 'Cloud Security Engineer', dept: 'Cloud Security', level: 'Mid-Senior', loc: 'SF/Remote', salary: '$155K-$180K', posted: '2026-03-20', applicants: 45, pipeline: 12, interviews: 6, offers: 2, urgency: 'high' as const, manager: 'Mike Johnson', skills: ['AWS/Azure/GCP', 'Terraform', 'Kubernetes', 'IAM', 'CSPM'], nice: ['CCSP', 'CKS', 'Serverless']},
    {id: '0df-H-003', title: 'SOC Analyst L2', dept: 'Security Operations', level: 'Mid', loc: 'Austin TX', salary: '$105K-$130K', posted: '2026-04-01', applicants: 67, pipeline: 18, interviews: 8, offers: 0, urgency: 'medium' as const, manager: 'Lisa Park', skills: ['SIEM', 'Incident triage', 'Malware analysis', 'TCP/IP'], nice: ['GCIA', 'SOAR', 'Kill chain']},
    {id: '0df-H-004', title: 'Staff Security Architect', dept: 'Architecture', level: 'Staff', loc: 'Remote US', salary: '$200K-$240K', posted: '2026-02-28', applicants: 12, pipeline: 3, interviews: 2, offers: 0, urgency: 'critical' as const, manager: 'David Lee', skills: ['Enterprise arch', 'Zero trust', 'Risk frameworks', 'Board comms'], nice: ['CISSP+SABSA', 'Team building', 'Speaker']},
    {id: '0df-H-005', title: 'GRC Analyst', dept: 'GRC', level: 'Mid', loc: 'NY/Remote', salary: '$110K-$135K', posted: '2026-04-05', applicants: 34, pipeline: 9, interviews: 3, offers: 1, urgency: 'medium' as const, manager: 'Rachel Green', skills: ['ISO 27001', 'SOC 2', 'Risk assessment', 'Audit'], nice: ['CRISC', 'CISA', 'GDPR']},
    {id: '0df-H-006', title: 'Threat Intel Analyst', dept: 'Threat Intel', level: 'Mid-Senior', loc: 'Remote US', salary: '$140K-$170K', posted: '2026-03-25', applicants: 19, pipeline: 5, interviews: 2, offers: 0, urgency: 'low' as const, manager: 'James Wilson', skills: ['MITRE ATT&CK', 'OSINT', 'Threat modeling', 'Reverse eng'], nice: ['CTIA', 'Nation-state', 'Dark web']},
    {id: '0df-H-007', title: 'AppSec Engineer', dept: 'AppSec', level: 'Senior', loc: 'Seattle/Remote', salary: '$160K-$190K', posted: '2026-04-10', applicants: 28, pipeline: 7, interviews: 3, offers: 0, urgency: 'medium' as const, manager: 'Emily Zhang', skills: ['SAST/DAST/SCA', 'Secure SDLC', 'Code review', 'CI/CD'], nice: ['CSSLP', 'Mobile security']},
    {id: '0df-H-008', title: 'IAM Engineer', dept: 'IAM', level: 'Mid', loc: 'Remote US', salary: '$135K-$160K', posted: '2026-04-08', applicants: 31, pipeline: 10, interviews: 5, offers: 1, urgency: 'medium' as const, manager: 'Chris Martinez', skills: ['Okta/Azure AD', 'SAML/OIDC', 'PAM', 'RBAC'], nice: ['CISSP', 'Zero trust IAM']}
  ];

  private _0dfInterviewScorecard = [
  ...
  private _0dfOnboardingSteps = [
    {id: '0df-OB-01', item: 'Provision security-hardened laptop, monitors, peripherals, and configured workstation image with all required security tools', cat: 'IT Setup', day: 'Day 1', owner: 'IT Operations'},
    {id: '0df-OB-02', item: 'Create AD account, email, Slack, VPN, SSO enrollment, and all required application access accounts', cat: 'Access', day: 'Day 1', owner: 'IAM Team'},
    {id: '0df-OB-03', item: 'Grant security tooling access: SIEM console, EDR dashboard, vuln scanner, pentest platforms, SOAR', cat: 'Tools', day: 'Day 1-2', owner: 'SOC Manager'},
    {id: '0df-OB-04', item: 'Complete MFA enrollment, security awareness onboarding course, and acceptable use policy acknowledgment', cat: 'Security', day: 'Day 1', owner: 'Awareness Team'},
    {id: '0df-OB-05', item: 'Sign NDA, employment agreement, IP assignment, and code of conduct documents with HR', cat: 'HR', day: 'Day 1', owner: 'Human Resources'},
    {id: '0df-OB-06', item: 'Introduction meetings with direct team members and key cross-functional stakeholders', cat: 'Integration', day: 'Week 1', owner: 'Hiring Manager'},
    {id: '0df-OB-07', item: 'Security architecture overview, tooling walkthrough, and operational runbook review sessions', cat: 'Training', day: 'Week 1-2', owner: 'Security Architect'},
    {id: '0df-OB-08', item: 'Shadow experienced team member on active incident response and threat hunting investigations', cat: 'Mentoring', day: 'Week 2-3', owner: 'SOC Lead'},
    {id: '0df-OB-09', item: 'Set up individual certification study plan aligned with role requirements and career goals', cat: 'Development', day: 'Week 2', owner: 'Hiring Manager'},
    {id: '0df-OB-10', item: 'Establish 30-60-90 day goals, define success metrics, and schedule first performance checkpoint', cat: 'Goals', day: 'Week 1', owner: 'Hiring Manager'}
  ];

  private _0dfMetricsDashboard = [
    {id: '0df-MTD-001', name: 'Mean Time to Detect (MTTD)', value: '4.2 hours', trend: 'improving' as const, target: '< 4 hours', source: 'SIEM - Splunk', method: 'Median time from first alert to analyst acknowledgment', owner: 'SOC Manager', sla: '4 hours', prev: '5.1 hours', spark: [5.8, 5.4, 5.1, 4.9, 4.7, 4.5, 4.3, 4.2], breakdown: [{src: 'Network IDS', pct: '35%', avg: '3.8h'}, {src: 'Endpoint EDR', pct: '28%', avg: '4.1h'}, {src: 'Email Gateway', pct: '22%', avg: '3.5h'}, {src: 'Cloud Security', pct: '10%', avg: '5.2h'}, {src: 'User Reports', pct: '5%', avg: '6.8h'}]},
    {id: '0df-MTD-002', name: 'Mean Time to Respond (MTTR)', value: '2.8 hours', trend: 'stable' as const, target: '< 3 hours', source: 'SOAR - XSOAR', method: 'Median time from acknowledgment to first containment action', owner: 'IR Lead', sla: '3 hours', prev: '2.7 hours', spark: [3.2, 3.0, 2.9, 2.8, 2.8, 2.9, 2.8, 2.8], breakdown: [{src: 'Auto Playbooks', pct: '42%', avg: '1.2h'}, {src: 'Semi-Auto', pct: '33%', avg: '2.5h'}, {src: 'Manual', pct: '20%', avg: '5.1h'}, {src: 'L3 Escalation', pct: '5%', avg: '8.3h'}]},
    {id: '0df-MTD-003', name: 'Patch Compliance Rate', value: '97.6%', trend: 'improving' as const, target: '> 95%', source: 'Tenable.io', method: 'Pct of critical/high vulns patched within SLA windows', owner: 'Vuln Manager', sla: '95%', prev: '96.1%', spark: [93.2, 94.1, 94.8, 95.3, 95.9, 96.4, 97.0, 97.6], breakdown: [{src: 'Critical (7d)', pct: '40%', rate: '99.2%'}, {src: 'High (30d)', pct: '35%', rate: '97.8%'}, {src: 'Medium (90d)', pct: '20%', rate: '95.1%'}, {src: 'Low (180d)', pct: '5%', rate: '89.4%'}]},
    {id: '0df-MTD-004', name: 'Phishing Click Rate', value: '3.2%', trend: 'improving' as const, target: '< 5%', source: 'KnowBe4 + Proofpoint', method: 'Pct of users clicking simulated phishing links monthly', owner: 'Awareness Lead', sla: '5%', prev: '4.1%', spark: [6.8, 6.2, 5.5, 5.1, 4.6, 4.1, 3.6, 3.2], breakdown: [{src: 'Spear Phishing', pct: '35%', rate: '5.1%'}, {src: 'Generic Phishing', pct: '30%', rate: '2.8%'}, {src: 'BEC Sim', pct: '20%', rate: '3.5%'}, {src: 'SMS Phishing', pct: '15%', rate: '1.9%'}]},
    {id: '0df-MTD-005', name: 'Security Posture Score', value: '784', trend: 'improving' as const, target: '> 750', source: 'SecurityScorecard', method: 'Composite: external 30%, compliance 25%, vuln 25%, config 20%', owner: 'CISO', sla: '> 750', prev: '771', spark: [748, 752, 758, 762, 768, 773, 778, 784], breakdown: [{src: 'External Rating', pct: '30%', score: '791'}, {src: 'Compliance', pct: '25%', score: '812'}, {src: 'Vuln Mgmt', pct: '25%', score: '745'}, {src: 'Config', pct: '20%', score: '769'}]},
    {id: '0df-MTD-006', name: 'Vulnerability Backlog', value: '142', trend: 'improving' as const, target: '< 150', source: 'Tenable + Qualys', method: 'Total open vulns across all scanned assets tracked weekly', owner: 'Vuln Manager', sla: '< 150', prev: '168', spark: [210, 198, 185, 175, 165, 158, 150, 142], breakdown: [{src: 'Critical', pct: '8%', count: '11'}, {src: 'High', pct: '22%', count: '31'}, {src: 'Medium', pct: '45%', count: '64'}, {src: 'Low', pct: '25%', count: '36'}]}
  ];

  private _0dfArchReview = [
    {id: '0df-AR-001', cat: 'Network', item: 'Network segmentation between trust zones with dedicated firewalls and granular ACLs', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Micro-segmentation via NSX across all production zones'},
    {id: '0df-AR-002', cat: 'Network', item: 'DMZ architecture isolating public services from internal network', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Dual-firewall DMZ with WAF and DDoS mitigation'},
    {id: '0df-AR-003', cat: 'Network', item: 'Least-privilege traffic flows with deny-by-default and quarterly review', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Explicit allow rules with automated drift detection'},
    {id: '0df-AR-004', cat: 'Network', item: 'Encrypted external communications with IPSec/TLS 1.3 and PFS', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'IKEv2 with PFS, TLS 1.3 for all external APIs'},
    {id: '0df-AR-005', cat: 'Identity', item: 'Centralized IdP with SSO and automated SCIM provisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Okta SSO SAML 2.0 for 247 apps with SCIM'},
    {id: '0df-AR-006', cat: 'Identity', item: 'RBAC with quarterly reviews and automated deprovisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Quarterly recertification with JIT admin access'},
    {id: '0df-AR-007', cat: 'Identity', item: 'PAM controlling all admin and service accounts with session recording', sev: 'high' as const, status: 'fail' as const, reviewer: 'IAM Lead', notes: '3 legacy accounts pending CyberArk enrollment'},
    {id: '0df-AR-008', cat: 'Identity', item: 'MFA enforced for all users, hardware tokens for privileged access', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'FIDO2 for admins, push MFA for users, 99.8% enrollment'},
    {id: '0df-AR-009', cat: 'Data', item: 'Data classification enforced with automated labeling on all repos', sev: 'high' as const, status: 'partial' as const, reviewer: 'Data Protection Lead', notes: 'Framework deployed, gaps on 4 legacy file shares'},
    {id: '0df-AR-010', cat: 'Data', item: 'AES-256 encryption at rest for all sensitive data stores', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'Full-disk, TDE on DBs, SSE-KMS on cloud storage'},
    {id: '0df-AR-011', cat: 'Data', item: 'DLP monitoring and preventing unauthorized data exfiltration', sev: 'high' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'DLP active on email, endpoint, cloud, and network'},
    {id: '0df-AR-012', cat: 'Data', item: 'Encrypted off-site backups with quarterly restore testing', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Infrastructure Lead', notes: '3-2-1 strategy with immutable backups'},
    {id: '0df-AR-013', cat: 'AppSec', item: 'Secure SDLC with SAST, DAST, SCA in all CI/CD pipelines', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: '34 pipelines with security gates and PR blocking'},
    {id: '0df-AR-014', cat: 'AppSec', item: 'API gateway with auth, rate limiting, schema validation', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: 'Kong with OAuth2, rate limits, OpenAPI validation'},
    {id: '0df-AR-015', cat: 'AppSec', item: 'Container security with image scanning and runtime protection', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Trivy scanning, Falco runtime in 80% of clusters'},
    {id: '0df-AR-016', cat: 'Monitoring', item: 'SIEM collecting from all critical systems with correlation rules', sev: 'critical' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'Splunk 98% coverage with 1200+ correlation rules'},
    {id: '0df-AR-017', cat: 'Monitoring', item: 'EDR with behavioral detection on all managed endpoints', sev: 'high' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'CrowdStrike on 99.2% endpoints with 24/7 MDR'},
    {id: '0df-AR-018', cat: 'Monitoring', item: 'Executive dashboards with real-time posture visibility', sev: 'medium' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'PowerBI dashboards with weekly exec summaries'},
    {id: '0df-AR-019', cat: 'Cloud', item: 'CSPM monitoring and remediating cloud misconfigurations', sev: 'high' as const, status: 'pass' as const, reviewer: 'Cloud Security Lead', notes: 'Prisma Cloud 450+ checks with auto-remediation'},
    {id: '0df-AR-020', cat: 'Cloud', item: 'IaC templates scanned before deployment to production', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Checkov for Terraform, cfn-nag for CloudFormation pending'}
  ];

  private _get0dfRiskProgress(): number {
    return Math.round(this._0dfRiskAssessmentWorkflow.filter(s => s.status === 'completed').length / this._0dfRiskAssessmentWorkflow.length * 100);
  }

  private _get0dfTreatmentSummary(): {total: number; approved: number; avgReduction: number; investment: string} {
    const a = this._0dfTreatmentOptions.filter(r => r.status === 'approved').length;
    const avg = this._0dfTreatmentOptions.reduce((s, r) => s + ((r.before - r.after) / r.before * 100), 0) / this._0dfTreatmentOptions.length;
    return {total: this._0dfTreatmentOptions.length, approved: a, avgReduction: Math.round(avg), investment: '$1.125M annually'};
  }

  private _get0dfRuleSummary(): {total: number; passing: number; failing: number; avgRate: number; violations: number} {
    const p = this._0dfComplianceRules.filter(r => r.result === 'pass').length;
    const f = this._0dfComplianceRules.filter(r => r.result === 'fail').length;
    const avg = this._0dfComplianceRules.reduce((s, r) => s + r.passRate, 0) / this._0dfComplianceRules.length;
    const v = this._0dfComplianceRules.reduce((s, r) => s + r.violations, 0);
    return {total: this._0dfComplianceRules.length, passing: p, failing: f, avgRate: Math.round(avg * 10) / 10, violations: v};
  }

  private _get0dfPipelineStats(): {positions: number; applicants: number; interviewing: number; offers: number; critical: number} {
    const t = this._0dfTalentPositions.length;
    const a = this._0dfTalentPositions.reduce((s, p) => s + p.applicants, 0);
    const i = this._0dfTalentPositions.reduce((s, p) => s + p.interviews, 0);
    const o = this._0dfTalentPositions.reduce((s, p) => s + p.offers, 0);
    const c = this._0dfTalentPositions.filter(x => x.urgency === 'critical').length;
    return {positions: t, applicants: a, interviewing: i, offers: o, critical: c};
  }

  private _get0dfMetricTrends(): {improving: number; stable: number; total: number} {
    const imp = this._0dfMetricsDashboard.filter(m => m.trend === 'improving').length;
    const stb = this._0dfMetricsDashboard.filter(m => m.trend === 'stable').length;
    return {improving: imp, stable: stb, total: this._0dfMetricsDashboard.length};
  }

  private _get0dfArchScore(): {total: number; passed: number; failed: number; partial: number; score: number} {
    const p = this._0dfArchReview.filter(c => c.status === 'pass').length;
    const f = this._0dfArchReview.filter(c => c.status === 'fail').length;
    const pa = this._0dfArchReview.filter(c => c.status === 'partial').length;
    return {total: this._0dfArchReview.length, passed: p, failed: f, partial: pa, score: Math.round((p / this._0dfArchReview.length) * 100)};
  }


  private _z0dfIncidentScenarios = [
    {id: 'z0df-IS-001', name: 'Ransomware Outbreak in Production Environment', category: 'Malware', likelihood: 'Medium', impact: 'Critical', riskScore: 15, playbooks: ['IR-Ransomware-Isolate', 'IR-Ransomware-Eradicate', 'IR-Ransomway-Recover'], estimatedMTTD: '15min', estimatedMTTR: '4h', involvedTeams: ['SOC', 'IR', 'Infrastructure', 'Legal', 'Comms'], keyIndicators: ['Mass file encryption events', 'Ransom note deployment', 'Lateral movement via SMB/RDP', 'Backup deletion attempts'], mitigationControls: ['EDR behavioral detection', 'Network segmentation', 'Immutable backups', 'Email filtering'], lessonsLearned: 'Ensure offline backups are tested quarterly and Ransomware-specific playbooks are updated with latest threat intelligence', lastDrillDate: '2026-03-15', nextDrillDate: '2026-06-15'},
    {id: 'z0df-IS-002', name: 'Cloud Misconfiguration Leading to Data Exposure', category: 'Cloud', likelihood: 'High', impact: 'High', riskScore: 16, playbooks: ['IR-Cloud-Misconfig-Assess', 'IR-Cloud-Misconfig-Remediate', 'IR-Cloud-Misconfig-Notify'], estimatedMTTD: '2h', estimatedMTTR: '6h', involvedTeams: ['Cloud Security', 'SOC', 'Data Protection', 'Legal'], keyIndicators: ['Public S3 bucket exposure', 'Overly permissive IAM policies', 'Unencrypted database snapshots', 'Public API endpoint discovery'], mitigationControls: ['CSPM monitoring', 'IAM policy analyzer', 'Automated remediation', 'Cloud audit logging'], lessonsLearned: 'Implement CSPM with auto-remediation for common misconfigurations and conduct monthly cloud configuration reviews', lastDrillDate: '2026-02-20', nextDrillDate: '2026-05-20'},
    {id: 'z0df-IS-003', name: 'Insider Threat Data Exfiltration', category: 'Insider', likelihood: 'Low', impact: 'Critical', riskScore: 12, playbooks: ['IR-Insider-Investigate', 'IR-Insider-Contain', 'IR-Insider-Escalate'], estimatedMTTD: '8h', estimatedMTTR: '24h', involvedTeams: ['SOC', 'IR', 'HR', 'Legal', 'IAM'], keyIndicators: ['Anomalous data access patterns', 'Large file downloads to USB or cloud', 'Off-hours access to sensitive systems', 'Accessing data outside normal job scope'], mitigationControls: ['UEBA analytics', 'DLP policies', 'PAM controls', 'Access reviews'], lessonsLearned: 'Strengthen UEBA baselines and implement automated alerts for data access pattern anomalies', lastDrillDate: '2026-01-10', nextDrillDate: '2026-04-10'},
    {id: 'z0df-IS-004', name: 'Supply Chain Attack via Compromised Vendor Software', category: 'Supply Chain', likelihood: 'Low', impact: 'Critical', riskScore: 12, playbooks: ['IR-SupplyChain-Detect', 'IR-SupplyChain-Isolate', 'IR-SupplyChain-Remediate'], estimatedMTTD: '24h', estimatedMTTR: '72h', involvedTeams: ['SOC', 'IR', 'Procurement', 'Vendor Mgmt', 'Legal'], keyIndicators: ['Unexpected network connections from vendor software', 'Modified binaries or dependencies', 'Anomalous behavior from trusted applications', 'SBOM discrepancy alerts'], mitigationControls: ['SCA scanning', 'SBOM monitoring', 'Vendor security assessments', 'Network segmentation'], lessonsLearned: 'Require SBOM from all vendors and implement continuous monitoring of third-party component behavior', lastDrillDate: '2026-03-01', nextDrillDate: '2026-06-01'},
    {id: 'z0df-IS-005', name: 'Credential Stuffing Attack on Customer Portal', category: 'External Attack', likelihood: 'High', impact: 'Medium', riskScore: 12, playbooks: ['IR-CredentialStuffing-Detect', 'IR-CredentialStuffing-Block', 'IR-CredentialStuffing-Notify'], estimatedMTTD: '30min', estimatedMTTR: '2h', involvedTeams: ['SOC', 'AppSec', 'Customer Support', 'Comms'], keyIndicators: ['High volume of failed login attempts', 'Login attempts from known compromised credential lists', 'Unusual geographic distribution of login attempts', 'Account takeover indicators'], mitigationControls: ['WAF rate limiting', 'CAPTCHA on login', 'MFA enforcement', 'Credential monitoring service'], lessonsLearned: 'Deploy advanced bot detection on login endpoints and implement proactive credential monitoring for customer accounts', lastDrillDate: '2026-04-01', nextDrillDate: '2026-07-01'},
    {id: 'z0df-IS-006', name: 'Phishing Campaign Targeting Executive Team', category: 'Social Engineering', likelihood: 'High', impact: 'High', riskScore: 16, playbooks: ['IR-Phishing-Contain', 'IR-Phishing-Investigate', 'IR-Phishing-Notify'], estimatedMTTD: '1h', estimatedMTTR: '4h', involvedTeams: ['SOC', 'Awareness', 'Executive Office', 'IT'], keyIndicators: ['Sophisticated spear-phishing emails to C-suite', 'Business email compromise indicators', 'Redirected MFA approval requests', 'Unauthorized wire transfer attempts'], mitigationControls: ['AI email filtering', 'Executive awareness training', 'Out-of-band verification policy', 'DMARC/DKIM/SPF'], lessonsLearned: 'Implement additional email security controls for executive mailboxes and conduct monthly spear-phishing simulations', lastDrillDate: '2026-02-15', nextDrillDate: '2026-05-15'}
  ];

  private _z0dfSecurityFrameworks = [
  ...
  private _getz0dfScenarioSummary(): {total: number; critical: number; high: number; drilled: number; avgRiskScore: number} {
    const crit = this._z0dfIncidentScenarios.filter(s => s.impact === 'Critical').length;
    const high = this._z0dfIncidentScenarios.filter(s => s.impact === 'High').length;
    const avg = this._z0dfIncidentScenarios.reduce((s, x) => s + x.riskScore, 0) / this._z0dfIncidentScenarios.length;
    return {total: this._z0dfIncidentScenarios.length, critical: crit, high: high, drilled: this._z0dfIncidentScenarios.length, avgRiskScore: Math.round(avg)};
  }

  private _getz0dfVendorRiskSummary(): {total: number; approved: number; conditional: number; remediation: number; avgScore: number} {
    const approved = this._z0dfThirdPartyRiskData.filter(v => v.status === 'approved').length;
    const cond = this._z0dfThirdPartyRiskData.filter(v => v.status === 'conditional').length;
    const rem = this._z0dfThirdPartyRiskData.filter(v => v.status === 'remediation_required').length;
    const avg = this._z0dfThirdPartyRiskData.reduce((s, v) => s + v.riskScore, 0) / this._z0dfThirdPartyRiskData.length;
    return {total: this._z0dfThirdPartyRiskData.length, approved, conditional: cond, remediation: rem, avgScore: Math.round(avg)};
  }

  private _getz0dfTrainingSummary(): {total: number; avgCompletion: number; avgScore: number; overdueUpdates: number} {
    const avgComp = this._z0dfSecurityTrainingCatalog.reduce((s, t) => s + t.completionRate, 0) / this._z0dfSecurityTrainingCatalog.length;
    const avgScore = this._z0dfSecurityTrainingCatalog.filter(t => t.avgScore > 0).reduce((s, t) => s + t.avgScore, 0) / this._z0dfSecurityTrainingCatalog.filter(t => t.avgScore > 0).length;
    return {total: this._z0dfSecurityTrainingCatalog.length, avgCompletion: Math.round(avgComp * 10) / 10, avgScore: Math.round(avgScore), overdueUpdates: 0};
  }

  private _getz0dfToolHealthSummary(): {total: number; healthy: number; degraded: number; annualCost: string} {
    const healthy = this._z0dfSecurityToolInventory.filter(t => t.health === 'healthy').length;
    const degraded = this._z0dfSecurityToolInventory.filter(t => t.health === 'degraded').length;
    const cost = this._z0dfSecurityToolInventory.reduce((s, t) => s + parseInt(t.annualCost.replace(/[^0-9]/g, '')), 0);
    return {total: this._z0dfSecurityToolInventory.length, healthy, degraded, annualCost: '$' + (cost / 1000).toFixed(0) + 'K'};
  }


  private _x0dfSecurityZones = [
    {zoneId: 'x0df-Z-001', name: 'Internet DMZ', trustLevel: 'Untrusted', subnet: '10.0.0.0/24', segmentation: 'Dual-firewall', firewallRules: 45, monitoring: 'Full packet capture', assets: ['Web servers', 'Load balancers', 'WAF appliances', 'Reverse proxy'], riskLevel: 'high' as const, lastAssessment: '2026-04-15', nextAssessment: '2026-07-15'},
    {zoneId: 'x0df-Z-002', name: 'Corporate Network', trustLevel: 'Trusted', subnet: '10.1.0.0/16', segmentation: 'VLAN + micro-seg', firewallRules: 128, monitoring: 'NetFlow + IDS', assets: ['Workstations', 'Printers', 'Meeting room systems', 'VoIP phones'], riskLevel: 'medium' as const, lastAssessment: '2026-04-10', nextAssessment: '2026-07-10'},
    {zoneId: 'x0df-Z-003', name: 'Production Data Center', trustLevel: 'Restricted', subnet: '10.2.0.0/16', segmentation: 'Full micro-segmentation', firewallRules: 256, monitoring: 'Full packet capture + EDR', assets: ['Application servers', 'Database clusters', 'Message queues', 'API gateways'], riskLevel: 'low' as const, lastAssessment: '2026-04-12', nextAssessment: '2026-07-12'},
    {zoneId: 'x0df-Z-004', name: 'Management Network', trustLevel: 'Restricted', subnet: '10.3.0.0/24', segmentation: 'Isolated VLAN', firewallRules: 32, monitoring: 'Syslog + SNMP', assets: ['Hypervisors', 'Switch management', 'Storage controllers', 'Backup appliances'], riskLevel: 'low' as const, lastAssessment: '2026-04-08', nextAssessment: '2026-07-08'},
    {zoneId: 'x0df-Z-005', name: 'Cloud Production', trustLevel: 'Restricted', subnet: 'VPC: 172.16.0.0/12', segmentation: 'Security groups + NACLs', firewallRules: 189, monitoring: 'VPC Flow Logs + GuardDuty', assets: ['Kubernetes clusters', 'Managed databases', 'Object storage', 'Serverless functions'], riskLevel: 'medium' as const, lastAssessment: '2026-04-18', nextAssessment: '2026-07-18'}
  ];

  private _x0dfSecurityAlerts = [
    {id: 'x0df-AL-001', severity: 'critical', title: 'Active ransomware encryption detected on PROD-DB-01', source: 'CrowdStrike', timestamp: '2026-04-22T13:45:00Z', status: 'investigating', assignee: 'SOC Analyst J. Smith', asset: 'PROD-DB-01 (10.2.1.15)', mitreTechnique: 'T1486 - Data Encrypted for Impact', playbook: 'IR-Ransomware-Isolate', sla: '15 minutes', elapsed: '12 minutes', notes: 'EDR detected mass file encryption event pattern. Automated isolation triggered. IR team paged.'},
    {id: 'x0df-AL-002', severity: 'high', title: 'Impossible travel detected for user admin@company.com', source: 'Okta', timestamp: '2026-04-22T12:30:00Z', status: 'triaged', assignee: 'SOC Analyst M. Johnson', asset: 'Okta - admin@company.com', mitreTechnique: 'T1078 - Valid Accounts', playbook: 'IR-ImpossibleTravel', sla: '30 minutes', elapsed: '87 minutes', notes: 'Login from Tokyo followed by login from New York within 30 minutes. Account temporarily locked. User confirmed via out-of-band channel they are in New York.'},
    {id: 'x0df-AL-003', severity: 'high', title: 'Public S3 bucket discovered with customer PII exposure', source: 'Prisma Cloud', timestamp: '2026-04-22T11:15:00Z', status: 'remediating', assignee: 'Cloud Security Lead A. Chen', asset: 'AWS S3: customer-data-archive-2024', mitreTechnique: 'N/A - Misconfiguration', playbook: 'IR-Cloud-Misconfig-Remediate', sla: '1 hour', elapsed: '2.5 hours', notes: 'Bucket containing archived customer records was publicly accessible. Bucket blocked and encrypted. Data exposure assessment in progress.'},
    {id: 'x0df-AL-004', severity: 'medium', title: 'Anomalous data download by user jane.developer@company.com', source: 'Microsoft DLP', timestamp: '2026-04-22T10:00:00Z', status: 'investigating', assignee: 'SOC Analyst R. Davis', asset: 'Endpoint: WS-DEV-042', mitreTechnique: 'T1567 - Exfil Over Web Service', playbook: 'IR-DLP-Investigation', sla: '4 hours', elapsed: '3.5 hours', notes: 'User downloaded 4.2GB of source code files to personal Google Drive. Interview scheduled with user and manager.'},
    {id: 'x0df-AL-005', severity: 'medium', title: 'Credential stuffing attack detected on customer portal', source: 'Cloudflare WAF', timestamp: '2026-04-22T09:30:00Z', status: 'contained', assignee: 'SOC Analyst K. Wilson', asset: 'Customer Portal (portal.company.com)', mitreTechnique: 'T1110 - Brute Force', playbook: 'IR-CredentialStuffing-Block', sla: '2 hours', elapsed: '4 hours', notes: 'Rate limiting and CAPTCHA automatically deployed. 12,000 failed login attempts from 800 unique IPs blocked. No successful account takeovers confirmed.'},
    {id: 'x0df-AL-006', severity: 'low', title: 'SSL certificate expiring in 14 days for api.company.com', source: 'Certificate monitoring', timestamp: '2026-04-22T08:00:00Z', status: 'remediated', assignee: 'Infrastructure Lead T. Brown', asset: 'api.company.com', mitreTechnique: 'N/A', playbook: 'Certificate Renewal', sla: '30 days', elapsed: '16 days', notes: 'Automated renewal triggered via ACME. New certificate deployed successfully. No service interruption.'}
  ];

  private _x0dfComplianceFrameworks = [
  ...
  private _x0dfDataClassificationPolicy = [
  ...
  private _getx0dfZoneSummary(): {total: number; highRisk: number; mediumRisk: number; lowRisk: number; totalRules: number} {
    const high = this._x0dfSecurityZones.filter(z => z.riskLevel === 'high').length;
    const med = this._x0dfSecurityZones.filter(z => z.riskLevel === 'medium').length;
    const low = this._x0dfSecurityZones.filter(z => z.riskLevel === 'low').length;
    const rules = this._x0dfSecurityZones.reduce((s, z) => s + z.firewallRules, 0);
    return {total: this._x0dfSecurityZones.length, highRisk: high, mediumRisk: med, lowRisk: low, totalRules: rules};
  }

  private _getx0dfAlertSummary(): {total: number; critical: number; high: number; medium: number; low: number; open: number; contained: number} {
    const crit = this._x0dfSecurityAlerts.filter(a => a.severity === 'critical').length;
    const high = this._x0dfSecurityAlerts.filter(a => a.severity === 'high').length;
    const med = this._x0dfSecurityAlerts.filter(a => a.severity === 'medium').length;
    const low = this._x0dfSecurityAlerts.filter(a => a.severity === 'low').length;
    const open = this._x0dfSecurityAlerts.filter(a => a.status === 'investigating' || a.status === 'triaged').length;
    const contained = this._x0dfSecurityAlerts.filter(a => a.status === 'contained' || a.status === 'remediated').length;
    return {total: this._x0dfSecurityAlerts.length, critical: crit, high, medium: med, low, open, contained};
  }

  private _getx0dfComplianceSummary(): {total: number; fullyCompliant: number; mostlyCompliant: number; avgComplianceRate: number} {
    const full = this._x0dfComplianceFrameworks.filter(f => f.status === 'compliant').length;
    const mostly = this._x0dfComplianceFrameworks.filter(f => f.status === 'mostly_compliant').length;
    const avgRate = this._x0dfComplianceFrameworks.reduce((s, f) => s + (f.compliant / f.requirements * 100), 0) / this._x0dfComplianceFrameworks.length;
    return {total: this._x0dfComplianceFrameworks.length, fullyCompliant: full, mostlyCompliant: mostly, avgComplianceRate: Math.round(avgRate * 10) / 10};
  }
  ...
  // === Security Risk Register (stride_model) ===
  private _stride_modelRiskRegister = [
    { id: "RSK-STR-0001", title: "Data breach from unpatched systems", owner: "CTO", category: "Financial", status: "mitigating", trend: "stable", severity: "critical", likelihood: 4, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-21", nextReview: "2026-07-19" },
    { id: "RSK-STR-0002", title: "Ransomware attack on critical infrastructure", owner: "CRO", category: "Strategic", status: "closed", trend: "decreasing", severity: "low", likelihood: 5, impact: 5, treatment: "Monitor and review quarterly", lastReview: "2026-04-10", nextReview: "2026-07-02" },
    { id: "RSK-STR-0003", title: "Insider threat data exfiltration", owner: "VP Eng", category: "Compliance", status: "accepted", trend: "increasing", severity: "medium", likelihood: 3, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-13", nextReview: "2026-07-16" },
    { id: "RSK-STR-0004", title: "Supply chain compromise", owner: "Security Lead", category: "Technical", status: "open", trend: "stable", severity: "medium", likelihood: 3, impact: 6, treatment: "Monitor and review quarterly", lastReview: "2026-04-02", nextReview: "2026-07-20" },
    { id: "RSK-STR-0005", title: "Cloud misconfiguration exposure", owner: "Risk Mgr", category: "Reputational", status: "mitigating", trend: "decreasing", severity: "low", likelihood: 1, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-23", nextReview: "2026-07-13" },
    { id: "RSK-STR-0006", title: "Phishing campaign success rate", owner: "Compliance Dir", category: "Legal", status: "closed", trend: "increasing", severity: "medium", likelihood: 4, impact: 7, treatment: "Monitor and review quarterly", lastReview: "2026-04-04", nextReview: "2026-07-25" },
    { id: "RSK-STR-0007", title: "Third-party vendor data breach", owner: "IT Dir", category: "Regulatory", status: "accepted", trend: "stable", severity: "critical", likelihood: 2, impact: 2, treatment: "Monitor and review quarterly", lastReview: "2026-04-05", nextReview: "2026-07-13" },
    { id: "RSK-STR-0008", title: "Regulatory non-compliance penalty", owner: "DevOps Lead", category: "Third-Party", status: "open", trend: "decreasing", severity: "medium", likelihood: 4, impact: 7, treatment: "Monitor and review quarterly", lastReview: "2026-04-22", nextReview: "2026-07-08" },
    { id: "RSK-STR-0009", title: "Zero-day exploit in production", owner: "Architect", category: "Human Capital", status: "mitigating", trend: "increasing", severity: "critical", likelihood: 7, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-04", nextReview: "2026-07-03" },
    { id: "RSK-STR-0010", title: "Insufficient access controls", owner: "CISO", category: "Operational", status: "closed", trend: "stable", severity: "low", likelihood: 7, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-16", nextReview: "2026-07-08" },
    { id: "RSK-STR-0011", title: "DDoS attack on services", owner: "CTO", category: "Financial", status: "accepted", trend: "decreasing", severity: "high", likelihood: 5, impact: 6, treatment: "Monitor and review quarterly", lastReview: "2026-04-09", nextReview: "2026-07-25" },
    { id: "RSK-STR-0012", title: "Social engineering attack", owner: "CRO", category: "Strategic", status: "open", trend: "increasing", severity: "critical", likelihood: 5, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-09", nextReview: "2026-07-08" },
    { id: "RSK-STR-0013", title: "API security vulnerability", owner: "VP Eng", category: "Compliance", status: "mitigating", trend: "stable", severity: "high", likelihood: 5, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-08", nextReview: "2026-07-08" },
    { id: "RSK-STR-0014", title: "Mobile device compromise", owner: "Security Lead", category: "Technical", status: "closed", trend: "decreasing", severity: "medium", likelihood: 3, impact: 2, treatment: "Monitor and review quarterly", lastReview: "2026-04-19", nextReview: "2026-07-21" },
    { id: "RSK-STR-0015", title: "Physical security breach", owner: "Risk Mgr", category: "Reputational", status: "accepted", trend: "increasing", severity: "high", likelihood: 7, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-20", nextReview: "2026-07-08" },
    { id: "RSK-STR-0016", title: "Password policy weakness", owner: "Compliance Dir", category: "Legal", status: "open", trend: "stable", severity: "critical", likelihood: 1, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-20", nextReview: "2026-07-02" },
    { id: "RSK-STR-0017", title: "Network segmentation gap", owner: "IT Dir", category: "Regulatory", status: "mitigating", trend: "decreasing", severity: "low", likelihood: 7, impact: 7, treatment: "Monitor and review quarterly", lastReview: "2026-04-19", nextReview: "2026-07-03" },
    { id: "RSK-STR-0018", title: "Encryption key management failure", owner: "DevOps Lead", category: "Third-Party", status: "closed", trend: "increasing", severity: "high", likelihood: 3, impact: 5, treatment: "Monitor and review quarterly", lastReview: "2026-04-11", nextReview: "2026-07-28" },
    { id: "RSK-STR-0019", title: "Audit trail tampering", owner: "Architect", category: "Human Capital", status: "accepted", trend: "stable", severity: "critical", likelihood: 4, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-05", nextReview: "2026-07-03" },
    { id: "RSK-STR-0020", title: "Business email compromise", owner: "CISO", category: "Operational", status: "open", trend: "decreasing", severity: "critical", likelihood: 5, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-21", nextReview: "2026-07-04" },
  ];
  private _stride_modelRiskFilter: string = 'all';
  private _stride_modelRiskSeverity: string = 'all';
  private _stride_modelRiskStatus: string = 'all';
  private _stride_modelExpandedRisk: string = '';
  private _stride_modelFilterRisks() {
    const reg = this._stride_modelRiskRegister;
    return reg.filter(r => {
      if (this._stride_modelRiskFilter !== "all" && r.category !== this._stride_modelRiskFilter) return false;
      if (this._stride_modelRiskSeverity !== "all" && r.severity !== this._stride_modelRiskSeverity) return false;
      if (this._stride_modelRiskStatus !== "all" && r.status !== this._stride_modelRiskStatus) return false;
      return true;
    });
  }
  private _stride_modelGetRiskScore(r: any) { return Math.round(r.likelihood * r.impact * 1.5); }
  private _stride_modelGetRiskTrendIcon(trend: string) {
    if (trend === "increasing") return "\u2191";
    if (trend === "decreasing") return "\u2193";
    return "\u2192";
  }
  private _stride_modelGetRiskColor(sev: string) {
    if (sev === "critical") return "#dc2626";
    if (sev === "high") return "#ea580c";
    if (sev === "medium") return "#d97706";
    return "#16a34a";
  }
  private _stride_modelGetRiskCounts() {
    const reg = this._stride_modelRiskRegister;
  ...
  private _stride_modelGetTreatmentProgress() {
    const reg = this._stride_modelRiskRegister;
    const treated = reg.filter(r => r.status === "mitigating" || r.status === "closed").length;
    return Math.round((treated / Math.max(reg.length, 1)) * 100);
  }

  // === Security Metrics API Gateway (stride_model) ===
  private _stride_modelApiEndpoints = [
    { method: "GET", path: "/api/v1/threats", name: "Threat Intelligence Feed", status: "active", avgLatency: 222.5, reqPerMin: 1918.0, errorRate: 2.46, uptime: round(97.3186962502211,2), version: "v3.7.14" },
    { method: "POST", path: "/api/v1/scans/start", name: "Vulnerability Scanner", status: "active", avgLatency: 191.5, reqPerMin: 772.0, errorRate: 1.84, uptime: round(96.71207433267631,2), version: "v2.5.1" },
    { method: "GET", path: "/api/v1/assets", name: "Asset Inventory", status: "active", avgLatency: 122.0, reqPerMin: 1588.0, errorRate: 0.74, uptime: round(98.50871870972607,2), version: "v3.9.15" },
    { method: "POST", path: "/api/v1/alerts", name: "Alert Management", status: "active", avgLatency: 330.7, reqPerMin: 1132.0, errorRate: 2.07, uptime: round(98.9661970476589,2), version: "v1.9.13" },
    { method: "GET", path: "/api/v1/compliance", name: "Compliance Status", status: "active", avgLatency: 251.0, reqPerMin: 608.0, errorRate: 1.57, uptime: round(96.60465286208427,2), version: "v2.5.9" },
    { method: "PUT", path: "/api/v1/policies", name: "Policy Engine", status: "active", avgLatency: 185.4, reqPerMin: 1364.0, errorRate: 1.36, uptime: round(99.75106391134909,2), version: "v3.6.11" },
    { method: "GET", path: "/api/v1/incidents", name: "Incident Tracker", status: "active", avgLatency: 252.6, reqPerMin: 81.0, errorRate: 1.56, uptime: round(99.89321906327781,2), version: "v2.4.3" },
    { method: "POST", path: "/api/v1/forensics", name: "Forensics Collector", status: "degraded", avgLatency: 354.6, reqPerMin: 195.0, errorRate: 0.06, uptime: round(97.78430697728213,2), version: "v2.8.15" },
    { method: "GET", path: "/api/v1/risk/assess", name: "Risk Assessment", status: "active", avgLatency: 206.0, reqPerMin: 2027.0, errorRate: 2.18, uptime: round(97.82399482949778,2), version: "v2.9.9" },
    { method: "POST", path: "/api/v1/auth/verify", name: "Authentication", status: "active", avgLatency: 249.0, reqPerMin: 2388.0, errorRate: 2.11, uptime: round(99.74950517883029,2), version: "v3.6.7" },
    { method: "GET", path: "/api/v1/logs/audit", name: "Audit Log Query", status: "active", avgLatency: 191.7, reqPerMin: 813.0, errorRate: 1.49, uptime: round(96.45585988382643,2), version: "v3.0.9" },
    { method: "PUT", path: "/api/v1/users/roles", name: "Role Management", status: "active", avgLatency: 311.1, reqPerMin: 1941.0, errorRate: 2.48, uptime: round(98.66042246250818,2), version: "v2.2.6" },
    { method: "POST", path: "/api/v1/encrypt", name: "Encryption Service", status: "active", avgLatency: 140.8, reqPerMin: 443.0, errorRate: 1.3, uptime: round(95.68878211705135,2), version: "v1.1.0" },
    { method: "GET", path: "/api/v1/network/topo", name: "Network Topology", status: "maintenance", avgLatency: 104.3, reqPerMin: 816.0, errorRate: 0.76, uptime: round(97.80345930446344,2), version: "v2.6.11" },
    { method: "DELETE", path: "/api/v1/sessions", name: "Session Manager", status: "active", avgLatency: 381.6, reqPerMin: 2265.0, errorRate: 1.49, uptime: round(95.2874545448561,2), version: "v2.5.16" },
  ];
  private _stride_modelApiKeys = [
    { id: "ak-000001", name: "key-stri-001", created: "2026-06-02", lastUsed: "2026-04-18", status: "active", calls: 3150, rateLimit: 5000 },
    { id: "ak-000002", name: "key-stri-002", created: "2026-07-20", lastUsed: "2026-04-09", status: "active", calls: 33930, rateLimit: 5000 },
    { id: "ak-000003", name: "key-stri-003", created: "2026-01-04", lastUsed: "2026-04-12", status: "active", calls: 43936, rateLimit: 100 },
    { id: "ak-000004", name: "key-stri-004", created: "2026-06-04", lastUsed: "2026-04-06", status: "active", calls: 42541, rateLimit: 1000 },
    { id: "ak-000005", name: "key-stri-005", created: "2026-02-08", lastUsed: "2026-04-05", status: "revoked", calls: 44381, rateLimit: 1000 },
    { id: "ak-000006", name: "key-stri-006", created: "2026-02-27", lastUsed: "2026-04-14", status: "revoked", calls: 38024, rateLimit: 500 },
    { id: "ak-000007", name: "key-stri-007", created: "2026-02-07", lastUsed: "2026-04-20", status: "revoked", calls: 24654, rateLimit: 100 },
    { id: "ak-000008", name: "key-stri-008", created: "2026-07-16", lastUsed: "2026-04-16", status: "active", calls: 47733, rateLimit: 1000 },
  ];
  private _stride_modelApiHealthSummary() {
    const eps = this._stride_modelApiEndpoints;
  ...
  private _stride_modelGetApiByMethod(method: string) { return this._stride_modelApiEndpoints.filter(e=>e.method===method); }
  private _stride_modelGetSlowEndpoints() { return this._stride_modelApiEndpoints.filter(e=>e.avgLatency>200).sort((a,b)=>b.avgLatency-a.avgLatency); }
  private _stride_modelGetHighErrorEndpoints() { return this._stride_modelApiEndpoints.filter(e=>e.errorRate>1.0).sort((a,b)=>b.errorRate-a.errorRate); }

  // === Security Training Effectiveness (stride_model) ===
  private _stride_modelTrainingModules = [
    { id: "TRN-001", name: "Security Fundamentals", completionRate: 45.6, avgScore: 57.7, behaviorChange: 69.3, enrolled: 275, completed: 238, duration: "108min", category: "mandatory" },
    { id: "TRN-002", name: "Phishing Awareness", completionRate: 48.5, avgScore: 55.8, behaviorChange: 87.6, enrolled: 116, completed: 368, duration: "69min", category: "mandatory" },
    { id: "TRN-003", name: "Social Engineering Defense", completionRate: 46.9, avgScore: 80.7, behaviorChange: 33.8, enrolled: 171, completed: 264, duration: "84min", category: "optional" },
    { id: "TRN-004", name: "Password Hygiene", completionRate: 46.8, avgScore: 56.4, behaviorChange: 76.9, enrolled: 68, completed: 62, duration: "78min", category: "mandatory" },
    { id: "TRN-005", name: "Data Classification", completionRate: 67.2, avgScore: 62.4, behaviorChange: 52.6, enrolled: 82, completed: 403, duration: "110min", category: "mandatory" },
    { id: "TRN-006", name: "Incident Response Basics", completionRate: 55.8, avgScore: 60.6, behaviorChange: 36.1, enrolled: 101, completed: 274, duration: "24min", category: "mandatory" },
    { id: "TRN-007", name: "Secure Coding", completionRate: 62.7, avgScore: 77.3, behaviorChange: 57.2, enrolled: 240, completed: 416, duration: "65min", category: "optional" },
    { id: "TRN-008", name: "Cloud Security", completionRate: 59.6, avgScore: 89.5, behaviorChange: 71.8, enrolled: 245, completed: 27, duration: "83min", category: "mandatory" },
    { id: "TRN-009", name: "Mobile Device Security", completionRate: 78.8, avgScore: 77.0, behaviorChange: 86.0, enrolled: 324, completed: 348, duration: "88min", category: "mandatory" },
    { id: "TRN-010", name: "Network Security", completionRate: 89.0, avgScore: 88.4, behaviorChange: 47.7, enrolled: 348, completed: 161, duration: "17min", category: "mandatory" },
    { id: "TRN-011", name: "Physical Security", completionRate: 45.9, avgScore: 58.3, behaviorChange: 78.6, enrolled: 419, completed: 156, duration: "61min", category: "optional" },
    { id: "TRN-012", name: "Regulatory Compliance", completionRate: 95.2, avgScore: 90.2, behaviorChange: 68.6, enrolled: 280, completed: 242, duration: "90min", category: "mandatory" },
    { id: "TRN-013", name: "Risk Management", completionRate: 51.1, avgScore: 76.9, behaviorChange: 55.8, enrolled: 312, completed: 352, duration: "34min", category: "mandatory" },
    { id: "TRN-014", name: "Cryptography Basics", completionRate: 92.1, avgScore: 83.8, behaviorChange: 37.1, enrolled: 150, completed: 153, duration: "102min", category: "mandatory" },
    { id: "TRN-015", name: "Access Control", completionRate: 84.0, avgScore: 93.0, behaviorChange: 40.7, enrolled: 414, completed: 48, duration: "40min", category: "optional" },
    { id: "TRN-016", name: "Vendor Management", completionRate: 57.7, avgScore: 92.2, behaviorChange: 42.3, enrolled: 316, completed: 169, duration: "95min", category: "mandatory" },
  ];
  private _stride_modelPhishingResults = [
    { month: "2026-01", sent: 360, clicked: 25, reported: 46, clickRate: round(6.944444444444445,1), reportRate: round(12.777777777777777,1) },
    { month: "2026-02", sent: 838, clicked: 30, reported: 279, clickRate: round(3.579952267303103,1), reportRate: round(33.29355608591885,1) },
    { month: "2026-03", sent: 508, clicked: 9, reported: 173, clickRate: round(1.7716535433070866,1), reportRate: round(34.05511811023622,1) },
    { month: "2026-04", sent: 786, clicked: 145, reported: 338, clickRate: round(18.447837150127228,1), reportRate: round(43.00254452926209,1) },
    { month: "2026-05", sent: 342, clicked: 39, reported: 116, clickRate: round(11.403508771929824,1), reportRate: round(33.91812865497076,1) },
    { month: "2026-06", sent: 342, clicked: 46, reported: 197, clickRate: round(13.450292397660817,1), reportRate: round(57.60233918128655,1) },
  ];
  private _stride_modelTrainingROI = { totalInvestment: 168507, avgCostPerEmployee: 484, riskReductionPct: round(random.uniform(15,45),1), incidentReductionPct: round(random.uniform(10,35),1), complianceScoreGain: round(random.uniform(5,25),1) };
  private _stride_modelLearningPaths = [
    { name: "Beginner Security Analyst", totalModules: 13, completedModules: 4, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 75, enrolled: 62 },
    { name: "Advanced Threat Hunter", totalModules: 20, completedModules: 3, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 23, enrolled: 66 },
    { name: "Security Architect", totalModules: 14, completedModules: 18, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 71, enrolled: 177 },
    { name: "Incident Responder", totalModules: 12, completedModules: 14, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 24, enrolled: 124 },
    { name: "Compliance Specialist", totalModules: 15, completedModules: 17, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 10, enrolled: 20 },
    { name: "DevSecOps Engineer", totalModules: 12, completedModules: 13, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 73, enrolled: 53 },
  ];
  private _stride_modelGetOverallCompletion() {
    const mods = this._stride_modelTrainingModules;
    return round(mods.reduce((s,m)=>s+m.completionRate,0)/mods.length,1);
  }
  private _stride_modelGetTopPerformers() { return [...this._stride_modelTrainingModules].sort((a,b)=>b.avgScore-a.avgScore).slice(0,5); }
  private _stride_modelGetModulesNeedingAttention() { return this._stride_modelTrainingModules.filter(m=>m.completionRate<70||m.avgScore<65); }

  // === Security Governance Framework (stride_model) ===
  private _stride_modelGovBodies = [
    { name: "Security Steering Committee", members: 14, chair: "CISO", meetingFreq: "Weekly", lastMeeting: "2026-04-12", nextMeeting: "2026-05-09", quorum: 6 },
    { name: "Risk Management Board", members: 8, chair: "CTO", meetingFreq: "Bi-weekly", lastMeeting: "2026-04-03", nextMeeting: "2026-05-14", quorum: 8 },
    { name: "Data Governance Council", members: 11, chair: "CRO", meetingFreq: "Monthly", lastMeeting: "2026-04-03", nextMeeting: "2026-05-09", quorum: 8 },
    { name: "Compliance Oversight Board", members: 14, chair: "CDO", meetingFreq: "Monthly", lastMeeting: "2026-04-07", nextMeeting: "2026-05-11", quorum: 3 },
    { name: "Architecture Review Board", members: 11, chair: "VP Eng", meetingFreq: "Bi-weekly", lastMeeting: "2026-04-08", nextMeeting: "2026-05-01", quorum: 3 },
    { name: "Change Advisory Board", members: 7, chair: "CISO", meetingFreq: "Weekly", lastMeeting: "2026-04-05", nextMeeting: "2026-05-24", quorum: 5 },
    { name: "Incident Review Board", members: 9, chair: "CIO", meetingFreq: "As needed", lastMeeting: "2026-04-19", nextMeeting: "2026-05-08", quorum: 4 },
    { name: "Vendor Risk Committee", members: 9, chair: "CFO", meetingFreq: "Quarterly", lastMeeting: "2026-04-06", nextMeeting: "2026-05-21", quorum: 7 },
  ];
  private _stride_modelDecisions = [
    { id: "DEC-0001", title: "Adopt zero-trust architecture framework", date: "2026-01-27", status: "approved", owner: "CISO" },
    { id: "DEC-0002", title: "Migrate to SIEM 2.0 platform", date: "2026-01-15", status: "implemented", owner: "CTO" },
    { id: "DEC-0003", title: "Implement DLP across all endpoints", date: "2026-04-05", status: "in-progress", owner: "Security Lead" },
    { id: "DEC-0004", title: "Mandate MFA for all external access", date: "2026-01-02", status: "pending", owner: "CRO" },
    { id: "DEC-0005", title: "Establish bug bounty program", date: "2026-01-01", status: "approved", owner: "VP Eng" },
    { id: "DEC-0006", title: "Deploy EDR solution enterprise-wide", date: "2026-04-10", status: "approved", owner: "CISO" },
    { id: "DEC-0007", title: "Conduct annual penetration testing", date: "2026-02-09", status: "implemented", owner: "CTO" },
    { id: "DEC-0008", title: "Implement network micro-segmentation", date: "2026-03-21", status: "in-progress", owner: "Security Lead" },
    { id: "DEC-0009", title: "Establish security champion program", date: "2026-02-13", status: "pending", owner: "CRO" },
    { id: "DEC-0010", title: "Migrate to passwordless authentication", date: "2026-02-18", status: "approved", owner: "VP Eng" },
  ];
  private _stride_modelPolicyLifecycle = [
    { name: "Information Security Policy", version: "v2.3", status: "active", lastUpdated: "2026-04-01", nextReview: "2026-10-20", owner: "CISO" },
    { name: "Acceptable Use Policy", version: "v3.0", status: "active", lastUpdated: "2026-01-28", nextReview: "2026-10-22", owner: "Legal" },
    { name: "Data Retention Policy", version: "v3.2", status: "under-review", lastUpdated: "2026-01-14", nextReview: "2026-10-19", owner: "DPO" },
    { name: "Access Control Policy", version: "v1.3", status: "active", lastUpdated: "2026-01-07", nextReview: "2026-8-14", owner: "IAM Lead" },
    { name: "Incident Response Policy", version: "v4.3", status: "draft", lastUpdated: "2026-03-23", nextReview: "2026-11-16", owner: "IR Lead" },
    { name: "Business Continuity Plan", version: "v4.0", status: "active", lastUpdated: "2026-04-17", nextReview: "2026-11-24", owner: "BCP Mgr" },
    { name: "Vendor Management Policy", version: "v3.1", status: "active", lastUpdated: "2026-02-13", nextReview: "2026-7-16", owner: "Procurement" },
    { name: "Encryption Standard", version: "v3.4", status: "under-review", lastUpdated: "2026-01-26", nextReview: "2026-11-26", owner: "Security Arch" },
  ];
  private _stride_modelGovMaturityScore = { overall: 3.4, riskManagement: 5.6, compliance: 5.1, incidentResponse: 4.0, awareness: 2.8, technology: 3.7 };
  private _stride_modelGetPendingDecisions() { return this._stride_modelDecisions.filter(d=>d.status==='pending'||d.status==='in-progress'); }
  private _stride_modelGetActivePolicies() { return this._stride_modelPolicyLifecycle.filter(p=>p.status==='active'); }
  private _stride_modelGetEscalationPath() { return ["L1 Analyst","L2 Senior","Security Lead","CISO","Board"]; }

  // === Security Innovation Lab (stride_model) ===
  private _stride_modelInnoProjects = [
    { id: "INN-001", name: "AI-Powered Threat Detection", description: "Machine learning models for real-time threat identification", status: "active", progress: 72, startDate: "2026-03-23", teamSize: 8, budget: 23429, milestones: 10, completedMilestones: 5 },
    { id: "INN-002", name: "Quantum-Resistant Cryptography", description: "Post-quantum encryption algorithm prototyping", status: "research", progress: 35, startDate: "2026-02-13", teamSize: 8, budget: 156623, milestones: 6, completedMilestones: 9 },
    { id: "INN-003", name: "Automated Red Teaming", description: "Autonomous penetration testing framework", status: "active", progress: 58, startDate: "2026-02-20", teamSize: 7, budget: 154351, milestones: 3, completedMilestones: 5 },
    { id: "INN-004", name: "Zero-Knowledge Authentication", description: "Privacy-preserving identity verification", status: "poc", progress: 88, startDate: "2026-01-09", teamSize: 3, budget: 22381, milestones: 4, completedMilestones: 8 },
    { id: "INN-005", name: "Blockchain Audit Trail", description: "Immutable security event logging", status: "active", progress: 45, startDate: "2026-03-27", teamSize: 4, budget: 97962, milestones: 5, completedMilestones: 8 },
    { id: "INN-006", name: "Behavioral Biometrics", description: "Continuous authentication via user behavior patterns", status: "research", progress: 22, startDate: "2026-01-18", teamSize: 7, budget: 109395, milestones: 8, completedMilestones: 5 },
    { id: "INN-007", name: "Deception Grid 2.0", description: "Advanced honeypot network with adaptive responses", status: "active", progress: 65, startDate: "2026-03-02", teamSize: 4, budget: 20775, milestones: 8, completedMilestones: 6 },
    { id: "INN-008", name: "Secure Enclave Integration", description: "Hardware-backed security for critical workloads", status: "poc", progress: 40, startDate: "2026-01-08", teamSize: 8, budget: 85976, milestones: 5, completedMilestones: 9 },
  ];
  private _stride_modelTechEvaluations = [
    ...
    { name: "Confidential Computing", status: "planned", score: 5.1, recommendation: "Investigate", vendor: "Azure" },
    { name: "Homomorphic Encryption", status: "evaluating", score: 4.7, recommendation: "Pilot", vendor: "GCP" },
  ...
  private _stride_modelCollaborationPartners = [
  ...
  private _stride_modelInnoMetrics = { totalProjects: 8, activeProjects: 4, avgTimeToValue: "176 days", pocSuccessRate: round(random.uniform(55,85),1), researchToProduction: round(random.uniform(20,50),1), innovationIndex: round(random.uniform(6.0,9.5),1) };
  private _stride_modelGetProjectByStatus(status: string) { return this._stride_modelInnoProjects.filter(p=>p.status===status); }
  private _stride_modelGetTopEvaluations() { return [...this._stride_modelTechEvaluations].sort((a,b)=>b.score-a.score).slice(0,3); }



  // === Compliance Dashboard Extension (stride_model) ===
  private _stride_modelComplianceFrameworks = [
    { name: "SOC 2 Type II", description: "Trust Services Criteria", totalControls: 5, implementedControls: 2, status: "partially-compliant", lastAudit: "2026-03-18", nextAudit: "2026-9-14", evidenceCount: 225 },
    { name: "ISO 27001", description: "Information Security Management", totalControls: 114, implementedControls: 104, status: "in-review", lastAudit: "2026-04-27", nextAudit: "2026-7-24", evidenceCount: 336 },
    { name: "PCI DSS 4.0", description: "Payment Card Industry", totalControls: 12, implementedControls: 6, status: "partially-compliant", lastAudit: "2026-03-24", nextAudit: "2026-8-07", evidenceCount: 330 },
    { name: "HIPAA", description: "Health Insurance Portability", totalControls: 18, implementedControls: 12, status: "non-compliant", lastAudit: "2026-03-06", nextAudit: "2026-7-22", evidenceCount: 179 },
    { name: "GDPR", description: "Data Protection Regulation", totalControls: 99, implementedControls: 58, status: "non-compliant", lastAudit: "2026-02-06", nextAudit: "2026-10-08", evidenceCount: 443 },
    { name: "NIST CSF 2.0", description: "Cybersecurity Framework", totalControls: 6, implementedControls: 3, status: "partially-compliant", lastAudit: "2026-04-09", nextAudit: "2026-10-23", evidenceCount: 257 },
    { name: "FedRAMP", description: "Federal Risk Authorization", totalControls: 15, implementedControls: 15, status: "partially-compliant", lastAudit: "2026-01-04", nextAudit: "2026-9-06", evidenceCount: 164 },
    { name: "SOX", description: "Sarbanes-Oxley Compliance", totalControls: 8, implementedControls: 5, status: "partially-compliant", lastAudit: "2026-02-18", nextAudit: "2026-11-02", evidenceCount: 319 },
    { name: "CIS Controls v8", description: "Center for Internet Security", totalControls: 18, implementedControls: 10, status: "partially-compliant", lastAudit: "2026-02-10", nextAudit: "2026-7-07", evidenceCount: 91 },
    { name: "COBIT 2019", description: "IT Governance Framework", totalControls: 40, implementedControls: 20, status: "non-compliant", lastAudit: "2026-01-19", nextAudit: "2026-11-22", evidenceCount: 308 },
  ];
  private _stride_modelGetComplianceScore() {
    const fw = this._stride_modelComplianceFrameworks;
    return round(fw.reduce((s,f)=>s + (f.implementedControls/Math.max(f.totalControls,1))*100, 0) / fw.length, 1);
  }
  private _stride_modelGetGaps() {
    return this._stride_modelComplianceFrameworks.filter(f => f.status !== "compliant");
  }
  private _stride_modelAuditTrail = [
    { id: "AUD-0001", action: "Control tested", auditor: "Internal Audit", date: "2026-04-12", result: "pass", findings: 2 },
    { id: "AUD-0002", action: "Evidence collected", auditor: "External Auditor", date: "2026-04-13", result: "pass", findings: 1 },
    { id: "AUD-0003", action: "Gap identified", auditor: "Security Team", date: "2026-04-12", result: "fail", findings: 3 },
    { id: "AUD-0004", action: "Remediation completed", auditor: "Compliance Officer", date: "2026-04-23", result: "pass", findings: 0 },
    { id: "AUD-0005", action: "Policy updated", auditor: "IT Audit", date: "2026-04-19", result: "pass", findings: 5 },
    { id: "AUD-0006", action: "Training verified", auditor: "Risk Team", date: "2026-04-15", result: "pass", findings: 0 },
    { id: "AUD-0007", action: "Access reviewed", auditor: "QA Team", date: "2026-04-07", result: "pass", findings: 3 },
    { id: "AUD-0008", action: "Exception approved", auditor: "CISO Office", date: "2026-04-11", result: "conditional", findings: 2 },
    { id: "AUD-0009", action: "Risk accepted", auditor: "Board Audit", date: "2026-04-18", result: "pass", findings: 0 },
    { id: "AUD-0010", action: "Control enhanced", auditor: "Third Party", date: "2026-04-02", result: "pass", findings: 1 },
  ];

  // === Threat Intelligence Feed Extension (stride_model) ===
  private _stride_modelThreatActors = [
    { name: "APT-29", alias: "Cozy Bear", origin: "Russia", type: "Nation-State", severity: "high", lastActivity: "2026-04-19", targets: "Technology", indicators: 282, ttps: 44 },
    { name: "APT-41", alias: "Double Dragon", origin: "China", type: "Nation-State", severity: "critical", lastActivity: "2026-04-14", targets: "Finance", indicators: 363, ttps: 5 },
    { name: "Lazarus Group", alias: "Hidden Cobra", origin: "North Korea", type: "Nation-State", severity: "critical", lastActivity: "2026-04-17", targets: "Government", indicators: 318, ttps: 36 },
    { name: "FIN7", alias: "Carbanak", origin: "Eastern Europe", type: "Financial", severity: "high", lastActivity: "2026-04-01", targets: "Technology", indicators: 217, ttps: 50 },
    { name: "Conti", alias: "Wizard Spider", origin: "Russia", type: "Ransomware", severity: "critical", lastActivity: "2026-04-07", targets: "Government", indicators: 348, ttps: 39 },
    { name: "LockBit", alias: "LockBit Gang", origin: "Unknown", type: "Ransomware", severity: "high", lastActivity: "2026-04-01", targets: "Energy", indicators: 467, ttps: 36 },
    { name: "Cl0p", alias: "Cl0p Team", origin: "Unknown", type: "Ransomware", severity: "high", lastActivity: "2026-04-15", targets: "Energy", indicators: 328, ttps: 34 },
    { name: "Sandworm", alias: "Unit 74455", origin: "Russia", type: "Nation-State", severity: "critical", lastActivity: "2026-04-09", targets: "Manufacturing", indicators: 407, ttps: 31 },
  ];
  private _stride_modelIoCFeed = [
    { id: "ioc-000001", type: "ip", value: "17.29.9.221", confidence: 51, source: "MISP", firstSeen: "2026-04-18", lastSeen: "2026-04-08" },
    { id: "ioc-000002", type: "ip", value: "70.99.179.15", confidence: 49, source: "VirusTotal", firstSeen: "2026-04-08", lastSeen: "2026-04-21" },
    { id: "ioc-000003", type: "ip", value: "199.88.98.75", confidence: 45, source: "VirusTotal", firstSeen: "2026-04-02", lastSeen: "2026-04-12" },
    { id: "ioc-000004", type: "ip", value: "133.78.94.160", confidence: 60, source: "CrowdStrike", firstSeen: "2026-04-21", lastSeen: "2026-04-06" },
    { id: "ioc-000005", type: "ip", value: "139.215.92.70", confidence: 79, source: "AlienVault", firstSeen: "2026-04-20", lastSeen: "2026-04-21" },
    { id: "ioc-000006", type: "ip", value: "138.120.214.104", confidence: 46, source: "STIX", firstSeen: "2026-04-09", lastSeen: "2026-04-09" },
    { id: "ioc-000007", type: "ip", value: "127.232.246.156", confidence: 72, source: "VirusTotal", firstSeen: "2026-04-05", lastSeen: "2026-04-02" },
    { id: "ioc-000008", type: "ip", value: "36.4.55.81", confidence: 89, source: "CrowdStrike", firstSeen: "2026-04-20", lastSeen: "2026-04-18" },
    { id: "ioc-000009", type: "ip", value: "208.8.233.114", confidence: 44, source: "STIX", firstSeen: "2026-04-18", lastSeen: "2026-04-12" },
    { id: "ioc-000010", type: "ip", value: "135.30.89.75", confidence: 73, source: "AlienVault", firstSeen: "2026-04-21", lastSeen: "2026-04-15" },
    { id: "ioc-000011", type: "ip", value: "129.169.215.6", confidence: 60, source: "VirusTotal", firstSeen: "2026-04-07", lastSeen: "2026-04-18" },
    { id: "ioc-000012", type: "ip", value: "190.222.216.227", confidence: 54, source: "AlienVault", firstSeen: "2026-04-06", lastSeen: "2026-04-07" },
    { id: "ioc-000013", type: "ip", value: "135.20.107.101", confidence: 46, source: "VirusTotal", firstSeen: "2026-04-16", lastSeen: "2026-04-06" },
    { id: "ioc-000014", type: "ip", value: "247.124.20.112", confidence: 97, source: "MISP", firstSeen: "2026-04-04", lastSeen: "2026-04-05" },
    { id: "ioc-000015", type: "ip", value: "67.125.217.80", confidence: 74, source: "CrowdStrike", firstSeen: "2026-04-06", lastSeen: "2026-04-20" },
  ];
  private _stride_modelGetActiveThreats() { return this._stride_modelThreatActors.filter(a => a.severity === 'critical'); }
  private _stride_modelGetThreatSummary() {
    const actors = this._stride_modelThreatActors;
  ...
  // === Incident Management Extension (stride_model) ===
  private _stride_modelIncidents = [
    { id: "INC-20260001", title: "Unauthorized access detected", severity: "critical", status: "open", assignedTo: "SOC L1", detectedAt: "2026-04-11T11:43", affectedAssets: 25, rootCause: "Misconfiguration" },
    { id: "INC-20260002", title: "Malware outbreak on workstation", severity: "high", status: "investigating", assignedTo: "SOC L2", detectedAt: "2026-04-19T09:56", affectedAssets: 3, rootCause: "Credential compromise" },
    { id: "INC-20260003", title: "Data leak from S3 bucket", severity: "medium", status: "contained", assignedTo: "IR Lead", detectedAt: "2026-04-12T03:27", affectedAssets: 18, rootCause: "Zero-day" },
    { id: "INC-20260004", title: "Phishing campaign targeting finance", severity: "low", status: "eradicated", assignedTo: "CISO", detectedAt: "2026-04-02T15:02", affectedAssets: 32, rootCause: "Human error" },
    { id: "INC-20260005", title: "DDoS attack on web services", severity: "critical", status: "recovered", assignedTo: "Security Eng", detectedAt: "2026-04-15T18:42", affectedAssets: 12, rootCause: "Policy violation" },
    { id: "INC-20260006", title: "Ransomware encryption attempt", severity: "high", status: "closed", assignedTo: "Forensics", detectedAt: "2026-04-18T20:18", affectedAssets: 18, rootCause: "Unknown" },
    { id: "INC-20260007", title: "Insider data exfiltration", severity: "medium", status: "open", assignedTo: "SOC L1", detectedAt: "2026-04-18T05:45", affectedAssets: 1, rootCause: "Misconfiguration" },
    { id: "INC-20260008", title: "API key exposure in repo", severity: "low", status: "investigating", assignedTo: "SOC L2", detectedAt: "2026-04-18T12:40", affectedAssets: 42, rootCause: "Credential compromise" },
    { id: "INC-20260009", title: "SQL injection on portal", severity: "critical", status: "contained", assignedTo: "IR Lead", detectedAt: "2026-04-10T14:32", affectedAssets: 38, rootCause: "Zero-day" },
    { id: "INC-20260010", title: "Brute force on VPN", severity: "high", status: "eradicated", assignedTo: "CISO", detectedAt: "2026-04-05T10:55", affectedAssets: 18, rootCause: "Human error" },
    { id: "INC-20260011", title: "Supply chain alert from vendor", severity: "medium", status: "recovered", assignedTo: "Security Eng", detectedAt: "2026-04-16T08:23", affectedAssets: 43, rootCause: "Policy violation" },
    { id: "INC-20260012", title: "Suspicious lateral movement", severity: "low", status: "closed", assignedTo: "Forensics", detectedAt: "2026-04-23T14:40", affectedAssets: 22, rootCause: "Unknown" },
  ];
  private _stride_modelGetIncidentStats() {
    const inc = this._stride_modelIncidents;
    return { total: inc.length, open: inc.filter(i=>i.status==="open").length, investigating: inc.filter(i=>i.status==="investigating").length, mttd: 37, mttr: 122 };
  }
  private _stride_modelGetSeverityDistribution() {
    const inc = this._stride_modelIncidents;
...
<div class="tabs">
        ...
        ${this._activeTab === 'rules' ? html`
          ...
          <div style="background:#1a1d27;border-radius:8px;padding:12px">${this._renderSmTreemapSVG()}</div>
          <div style="margin-top:12px;font-size:11px;font-weight:600;margin-bottom:6px">Data Flow (Sankey)</div>
          <div style="background:#1a1d27;border-radius:8px;padding:12px">${this._renderSmSankeySVG()}</div>
          ${this._renderSmActivity()}
        ` : nothing}
        ${this._activeTab === 'anomalies' ? html`
          ${this._renderSmAnomalies()}
          ${this._renderSmNotifications()}
        ` : nothing}
        ${this._activeTab === 'predictions' ? html`
          ${this._renderSmPredictions()}
          ...
          <div style="background:#1a1d27;border-radius:8px;padding:12px">
            <table class="history-table"><thead><tr><th>ID</th><th>Base</th><th>Temporal</th><th>Environmental</th><th>Overall</th></tr></thead><tbody>
              ${this._smcvssData.map(c => html`<tr><td>${c.itemId}</td><td style="color:${c.base >= 7 ? '#ef4444' : c.base >= 4 ? '#eab308' : '#22c55e'}">${c.base}</td><td>${c.temporal}</td><td>${c.environmental}</td><td style="font-weight:700;color:${c.overall >= 7 ? '#ef4444' : c.overall >= 4 ? '#eab308' : '#22c55e'}">${c.overall}</td></tr>`)}
            </tbody></table>
          </div>
        ` : nothing}
        ${this._activeTab === 'approvals' ? html`
          ${this._renderSmApprovals()}
        ` : nothing}
        ${this._activeTab === 'config' ? html`
          ${this._renderSmConfig()}
        ` : nothing}
        ${this._activeTab === 'new' ? html`
          <div class="form-section">
            <div class="form-title">Create New Stride Model Entry</div>
            <div class="form-grid">
  ...
  @state() private _smScenarios: {id:string;name:string;attackType:string;target:string;method:string;impactLow:number;impactHigh:number;confidence:number;mitigation:string;status:string}[] = [];
  @state() private _smScenarioForm: {attackType:string;target:string;method:string} = {attackType:'',target:'',method:''};
  @state() private _smScenarioCompare: boolean = false;
  @state() private _smScenarioSelected: string[] = [];

  private _smInitScenarios(): void {
    const saved = localStorage.getItem('sm_scenarios');
    if (saved) { try { this._smScenarios = JSON.parse(saved); } catch { /* ignore */ } }
    if (this._smScenarios.length === 0) {
      this._smScenarios = [
        {id:'sm-s1',name:'Baseline Threat',attackType:'Phishing',target:'Employees',method:'Spear Email',impactLow:45,impactHigh:78,confidence:72,mitigation:'Security awareness training + email filtering',status:'active'},
        {id:'sm-s2',name:'Escalated Attack',attackType:'Ransomware',target:'Endpoints',method:'Drive-by Download',impactLow:65,impactHigh:95,confidence:58,mitigation:'EDR deployment + network segmentation',status:'saved'},
        {id:'sm-s3',name:'Insider Threat',attackType:'Data Exfiltration',target:'Databases',method:'SQL Injection',impactLow:55,impactHigh:88,confidence:65,mitigation:'DLP policies + query monitoring',status:'draft'},
      ];
    }
  }

  private _smSaveScenarios(): void {
    localStorage.setItem('sm_scenarios', JSON.stringify(this._smScenarios));
  }

  private _smAddScenario(): void {
    const f = this._smScenarioForm;
    if (!f.attackType || !f.target) return;
    this._smScenarios = [...this._smScenarios, {
      id: 'sm-s' + (this._smScenarios.length + 1),
    ...
    this._smScenarioForm = {attackType:'',target:'',method:''};
    this._smSaveScenarios();
  }

  private _smRenderScenarioEngine(): any {
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <button class="tab" @click=${() => { this._smScenarioCompare = !this._smScenarioCompare; }}>${this._smScenarioCompare ? 'List View' : 'Compare'}</button>
        </div>
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:6px;margin-bottom:10px">
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._smScenarioForm = {...this._smScenarioForm, attackType: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Attack Type</option>
            ${attackTypes.map(a => html`<option value=${a} ${this._smScenarioForm.attackType === a ? 'selected' : ''}>${a}</option>`)}
          </select>
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._smScenarioForm = {...this._smScenarioForm, target: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Target</option>
            ${targets.map(t => html`<option value=${t} ${this._smScenarioForm.target === t ? 'selected' : ''}>${t}</option>`)}
          </select>
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._smScenarioForm = {...this._smScenarioForm, method: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Method</option>
            ${methods.map(m => html`<option value=${m} ${this._smScenarioForm.method === m ? 'selected' : ''}>${m}</option>`)}
          </select>
        </div>
        <button style="background:#3b82f6;border:none;border-radius:4px;padding:4px 12px;color:#fff;font-size:11px;cursor:pointer" @click=${this._smAddScenario}>Run Simulation</button>
      </div>
      ${this._smScenarioCompare && this._smScenarios.length >= 2 ? html`
        <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
          <div style="font-weight:600;font-size:12px;color:#e2e8f0;margin-bottom:8px">Side-by-Side Comparison</div>
          <div style="display:grid;grid-template-columns:repeat(${Math.min(3, this._smScenarios.length)},1fr);gap:8px">
            ${this._smScenarios.slice(0,3).map(s => html`
      ...
      <div style="background:#0f1117;border-radius:8px;padding:12px">
        <div style="font-weight:600;font-size:12px;color:#e2e8f0;margin-bottom:8px">Saved Scenarios (${this._smScenarios.length})</div>
        ${this._smScenarios.map(s => html`
  ...
  @state() private _smTrendData: {day:number;value:number;anomaly:boolean}[] = [];
  @state() private _smTrendZoom: {start:number;end:number} | null = null;
  @state() private _smTrendMA: number = 7;

  private _smInitTrendData(): void {
    ...
    this._smTrendData = data;
  }

  private _smCalcMA(window: number): number[] {
    const result: number[] = [];
    for (let i = 0; i < this._smTrendData.length; i++) {
      const start = Math.max(0, i - window + 1);
      const slice = this._smTrendData.slice(start, i + 1);
      result.push(slice.reduce((s, d) => s + d.value, 0) / slice.length);
    }
    return result;
  }

  private _smGetStats(): {mean:number;median:number;stddev:number;trend:string} {
    const vals = this._smTrendData.map(d => d.value);
    const n = vals.length;
  ...
  private _smRenderTimeSeries(): any {
    const stats = this._smGetStats();
    const filtered = this._smTrendZoom ? this._smTrendData.filter(d => d.day >= this._smTrendZoom.start && d.day <= this._smTrendZoom.end) : this._smTrendData;
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px">
            <button class="tab ${this._smTrendMA === 7 ? 'active' : ''}" @click=${() => { this._smTrendMA = 7; }}>7D MA</button>
            <button class="tab ${this._smTrendMA === 30 ? 'active' : ''}" @click=${() => { this._smTrendMA = 30; }}>30D MA</button>
            <button class="tab" @click=${() => { this._smTrendZoom = null; }}>Reset Zoom</button>
          </div>
        </div>
        <div style="position:relative;height:120px;background:#1a1d2e;border-radius:6px;overflow:hidden;margin-bottom:8px;cursor:crosshair" @click=${(e: any) => {
          ...
          this._smTrendZoom = { start: Math.max(0, center - 10), end: Math.min(89, center + 10) };
        }}>
  ...
  @state() private _smRoles: string[] = ['Admin','Analyst','Operator','Viewer','Auditor'];
  @state() private _smActions: string[] = ['Create','Read','Update','Delete','Export','Approve'];
  @state() private _smPermissions: { [role: string]: { [action: string]: boolean } } = {};
  @state() private _smPermAudit: {role:string;action:string;changedBy:string;timestamp:string;oldVal:boolean;newVal:boolean}[] = [];
  @state() private _smPermCompare: string[] = [];

  private _smInitPermissions(): void {
    ...
    for (const role of this._smRoles) {
      perms[role] = {};
      this._smActions.forEach((a, i) => { perms[role][a] = defaults[role]?.[i] ?? false; });
    }
    this._smPermissions = perms;
  }

  private _smTogglePermission(role: string, action: string): void {
    const old = this._smPermissions[role][action];
    this._smPermissions = {...this._smPermissions, [role]: {...this._smPermissions[role], [action]: !old}};
    this._smPermAudit.unshift({role,action,changedBy:'current_user',timestamp:new Date().toISOString(),oldVal:old,newVal:!old});
  }

  private _smRenderRBAC(): any {
    const compareRoles = this._smPermCompare.map(r => this._smPermissions[r]).filter(Boolean);
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          <span style="font-weight:700;font-size:13px;color:#e2e8f0">RBAC Permission Matrix</span>
          <div style="display:flex;gap:4px">
            ${this._smRoles.map(r => html`
              <button class="tab ${this._smPermCompare.includes(r) ? 'active' : ''}" @click=${() => {
                this._smPermCompare = this._smPermCompare.includes(r) ? this._smPermCompare.filter(x => x !== r) : [...this._smPermCompare, r];
              }}>${r}</button>
            `)}
          </div>
        </div>
          ...
          <table style="width:100%;border-collapse:collapse;font-size:10px">
            <thead>
              <tr>
                ...
                ${this._smActions.map(a => html`<th style="padding:6px;color:#6b7280;border-bottom:1px solid #2a2d3a;text-align:center">${a}</th>`)}
              </tr>
            </thead>
            <tbody>
              ${this._smRoles.map(role => html`
                <tr style="border-bottom:1px solid #1a1d2e">
                  <td style="padding:6px;color:#e2e8f0;font-weight:600">${role}</td>
                  ${this._smActions.map(action => html`
                    <td style="text-align:center;padding:6px">
                      <button style="width:28px;height:20px;border-radius:3px;border:1px solid #2a2d3a;background:${this._smPermissions[role][action] ? '#22c55e' : '#1a1d2e'};cursor:pointer;color:#fff;font-size:10px" @click=${() => this._smTogglePermission(role, action)}>${this._smPermissions[role][action] ? 'Y' : 'N'}</button>
                    </td>
                  `)}
                </tr>
              `)}
        ...
        ${compareRoles.length >= 2 ? html`
          <div style="margin-top:10px;padding:8px;background:#1a1d2e;border-radius:6px">
            <div style="font-size:11px;font-weight:600;color:#e2e8f0;margin-bottom:6px">Role Diff: ${this._smPermCompare.join(' vs ')}</div>
            ${this._smActions.map(action => {
              ...
              return allSame ? nothing : html`
                <div style="display:flex;gap:8px;padding:3px 0;font-size:10px">
                  ...
                  ${compareRoles.map((r, i) => html`<span style="color:${r[action] ? '#22c55e' : '#ef4444'}">${this._smPermCompare[i]}=${r[action] ? 'Y' : 'N'}</span>`)}
                </div>
              `;
            })}
          </div>
        ` : nothing}
        ${this._smPermAudit.length > 0 ? html`
          <div style="margin-top:8px;font-size:9px;color:#6b7280">Recent: ${this._smPermAudit.slice(0,3).map(a => html`<span style="margin-right:8px">${a.role}.${a.action}: ${a.oldVal ? 'Y' : 'N'}->${a.newVal ? 'Y' : 'N'}</span>`)}
        ` : nothing}
      </div>
    `;
  }
  ...
  // === REPORTING SUITE ===
  @state() private _smReportTemplate: string = 'executive';
  @state() private _smReportSchedule: string = 'weekly';
  @state() private _smReportDistList: string[] = ['security-team@company.com','ciso@company.com'];
  @state() private _smReportHistory: {id:string;template:string;generatedAt:string;status:string}[] = [];

  private _smGenerateReport(): void {
    const id = 'rpt-' + Date.now();
    this._smReportHistory.unshift({id,template:this._smReportTemplate,generatedAt:new Date().toISOString(),status:'sent'});
  }

  private _smRenderReporting(): any {
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:8px">
          <div>
            ...
            ${templates.map(t => html`
              <div style="padding:6px;background:${this._smReportTemplate === t.key ? '#1e3a5f' : '#1a1d2e'};border:1px solid ${this._smReportTemplate === t.key ? '#3b82f6' : '#2a2d3a'};border-radius:4px;margin-bottom:4px;cursor:pointer" @click=${() => { this._smReportTemplate = t.key; }}>
          ...
          <div>
            ...
            <div style="display:flex;gap:4px;margin-bottom:8px">
              ${schedules.map(s => html`<button class="tab ${this._smReportSchedule === s.key ? 'active' : ''}" @click=${() => { this._smReportSchedule = s.key; }}>${s.label}</button>`)}
            </div>
            <div style="font-size:10px;color:#6b7280;margin-bottom:4px">Distribution</div>
            <div style="font-size:10px;color:#9ca3af">${this._smReportDistList.map(d => html`<div>${d}</div>`)}</div>
            <div style="margin-top:6px;display:flex;gap:4px">
              <button style="background:#3b82f6;border:none;border-radius:4px;padding:4px 10px;color:#fff;font-size:10px;cursor:pointer" @click=${this._smGenerateReport}>Generate</button>
        ...
        ${this._smReportHistory.length > 0 ? html`
          <div style="border-top:1px solid #2a2d3a;padding-top:8px">
            ...
            ${this._smReportHistory.slice(0,3).map(r => html`
  ...
  @state() private _smHighContrast: boolean = false;
  @state() private _smA11yAnnounce: string = '';
  @state() private _smShortcutsVisible: boolean = false;
  @state() private _smFocusTrap: boolean = false;

  private _smShortcuts: Record<string, string> = {
  ...
  private _smHandleKeydown(e: KeyboardEvent): void {
    if (e.key === 'Escape' && this._smFocusTrap) { this._smFocusTrap = false; this._smAnnounce('Dialog closed'); }
    if (e.ctrlKey && e.shiftKey && e.key === 'H') { e.preventDefault(); this._smHighContrast = !this._smHighContrast; this._smAnnounce('High contrast ' + (this._smHighContrast ? 'enabled' : 'disabled')); }
    if (e.ctrlKey && e.shiftKey && e.key === 'A') { e.preventDefault(); this._smShortcutsVisible = !this._smShortcutsVisible; }
  }

  private _smAnnounce(msg: string): void {
    this._smA11yAnnounce = msg;
    setTimeout(() => { this._smA11yAnnounce = ''; }, 2000);
  }

  private _smRenderAccessibility(): any {
    return html`
      <div role="region" aria-label="Accessibility Controls" style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <button class="tab ${this._smShortcutsVisible ? 'active' : ''}" @click=${() => { this._smShortcutsVisible = !this._smShortcutsVisible; }} aria-expanded=${this._smShortcutsVisible}>Shortcuts</button>
        </div>
        <div style="display:flex;gap:8px;margin-bottom:8px">
          <label style="display:flex;align-items:center;gap:6px;font-size:11px;color:#e2e8f0;cursor:pointer">
            <input type="checkbox" .checked=${this._smHighContrast} @change=${() => { this._smHighContrast = !this._smHighContrast; }} aria-label="Toggle high contrast mode">
            High Contrast
          </label>
        </div>
        ${this._smShortcutsVisible ? html`
          <div role="list" aria-label="Keyboard shortcuts" style="background:#1a1d2e;border-radius:6px;padding:8px">
            ${Object.entries(this._smShortcuts).map(([key, desc]) => html`
        ...
        ` : nothing}
        <div role="status" aria-live="polite" aria-atomic="true" style="position:absolute;left:-9999px">${this._smA11yAnnounce}</div>
      </div>
    `;
  }
  ...
  connectedCallback(): void {
    ...
    this._smInitScenarios();
    this._smInitTrendData();
    this._smInitPermissions();
    document.addEventListener('keydown', this._smHandleKeydown.bind(this));
  }

  disconnectedCallback(): void {
    super.disconnectedCallback();
    document.removeEventListener('keydown', this._smHandleKeydown.bind(this));
  }

  // === TAB INTEGRATION FOR EXTENDED FEATURES ===
  @state() private _smActiveSubTab: string = 'scenario';
  ...
  private _smGetAllSubTabs(): {key:string;label:string}[] {
    return [
  ...
  private _smRenderSubPanel(): any {
    switch (this._smActiveSubTab) {
      case 'scenario': return this._smRenderScenarioEngine();
      case 'timeseries': return this._smRenderTimeSeries();
      case 'rbac': return this._smRenderRBAC();
      case 'reporting': return this._smRenderReporting();
      case 'a11y': return this._smRenderAccessibility();
      default: return nothing;
    }
  }

  private _smRenderTabBar(): any {
    return html`
      <div style="display:flex;gap:4px;margin-bottom:12px;border-bottom:1px solid #2a2d3a;padding-bottom:8px;flex-wrap:wrap" role="tablist" aria-label="Extended panel features">
        ${this._smGetAllSubTabs().map(t => html`
          <button class="tab ${this._smActiveSubTab === t.key ? 'active' : ''}" @click=${() => { this._smActiveSubTab = t.key; }} role="tab" aria-selected=${this._smActiveSubTab === t.key}>${t.label}</button>
        `)}
      </div>
      <div role="tabpanel" aria-labelledby="sm-tab-${this._smActiveSubTab}">
        ${this._smRenderSubPanel()}
      </div>
    `;
  }
  ...
  @state() private _soarPlaybooks: Array<{
    ...
    {
      id: 'pb-soar-001', name: 'Stride Model Auto Response', status: 'active',
      steps: [
    ...
    {
      id: 'pb-soar-002', name: 'Stride Model Investigation Workflow', status: 'active',
      steps: [
    ...
    {
      id: 'pb-soar-003', name: 'Stride Model Compliance Scan', status: 'draft',
      steps: [
  ...
  @state() private _smAle: number = 0;
  @state() private _smSroi: number = 0;
  @state() private _smCpi: number = 0;
  @state() private _smBudgetAlloc: number = 0;
  @state() private _smCostBenefit: number = 0;

  // Security Economics Calculator
  private smInitEconomics() {
    this._smAle = Math.round(2850000 + Math.random() * 4500000);
    this._smSroi = Math.round(180 + Math.random() * 320);
    this._smCpi = Math.round(45000 + Math.random() * 120000);
    this._smBudgetAlloc = Math.round(2500000 + Math.random() * 3000000);
    this._smCostBenefit = Math.round(220 + Math.random() * 180);
  }

  private _smCalcAle(): { annual: number; perIncident: number; byCategory: Array<{name: string; value: number}> } {
    const base = this._smAle;
    const categories = [
  ...
  private _smCalcSroi(): Array<{year: number; investment: number; savings: number; roi: number}> {
    const baseInv = this._smSroi * 10000;
  ...
  private _smGetBudgetAlloc(): Array<{category: string; amount: number; pct: number; trend: string}> {
    const total = this._smBudgetAlloc;
    const items = [
  ...
  private _smGetCostBenefit(): Array<{control: string; cost: number; benefit: number; ratio: number; priority: string}> {
    const base = this._smCostBenefit;
    const controls = [
  ...
  private _smRenderEconomics() {
    const ale = this._smCalcAle();
    const roi = this._smCalcSroi();
    const budget = this._smGetBudgetAlloc();
    const cb = this._smGetCostBenefit();
    const cpi = this._smCpi;
  ...
  @state() private _smThreatLevel: any = null;
  @state() private _smEmergingThreats: any = null;
  @state() private _smThreatTrends: any = null;
  @state() private _smSectorRadar: any = null;
  @state() private _smActorActivity: any = null;

  // Threat Landscape Intelligence
  private smInitThreatIntel() {
    this._smThreatLevel = {
  ...
  private _smRenderThreatIntel() {
    const tl = this._smThreatLevel;
    const et = this._smEmergingThreats;
    const sr = this._smSectorRadar;
    const aa = this._smActorActivity;
  ...
  @state() private _smPolicies: any = null;
  @state() private _smExceptions: any = null;
  @state() private _smRiskRegister: any = null;
  @state() private _smMeetings: any = null;
  @state() private _smDeadlines: any = null;

  // Security Governance Dashboard
  private smInitGovernance() {
    this._smPolicies = [
  ...
  private _smRenderGovernance() {
    const policies = this._smPolicies;
    const risks = this._smRiskRegister;
    const deadlines = this._smDeadlines;
  ...
  @state() private _smCriticalAssets: any = null;
  @state() private _smAssetDeps: any = null;
  @state() private _smEolAssets: any = null;
  @state() private _smAssetRisk: any = null;

  // Asset Intelligence
  private smInitAssetIntel() {
    this._smCriticalAssets = [
    ...
    this._smAssetRisk = { critical: 7, high: 23, medium: 45, low: 128, total: 203 };
  }

  private _smRenderAssetIntel() {
    const assets = this._smCriticalAssets;
    const eol = this._smEolAssets;
    const ar = this._smAssetRisk;
  ...
  @state() private _smUserBaseline: any = null;
  @state() private _smAnomalyRules: any = null;
  @state() private _smDataAccess: any = null;
  @state() private _smInsiderRisk: any = null;
  @state() private _strider15Timeline: Array<{id:string;time:string;event:string;severity:string;actor:string}> = [
  ...
  @state() private _strider15RootCauses: Array<{why:string;answer:string}> = [
  ...
  @state() private _strider15ImpactMatrix: Array<{system:string;users:number;data:string;revenue:string;status:string}> = [
  ...
  @state() private _strider15Actions: Array<{id:string;item:string;owner:string;deadline:string;priority:string;status:string}> = [
  ...
  @state() private _strider15Lessons: Array<{id:string;lesson:string;category:string;severity:string;applies_to:string}> = [
  ...
  @state() private _strider15ActiveTab: string = 'timeline';
  @state() private _strider15Benchmarks: Array<{metric:string;current:number;industry:number;target:number;unit:string;source:string}> = [
  ...
  @state() private _strider15MaturityLevels: Array<{domain:string;current:number;target:number;description:string}> = [
  ...
  @state() private _strider15QuarterlyData: Array<{quarter:string;score:number;improvement:number}> = [
  ...
  @state() private _strider15SelectedDomain: string = 'all';
  @state() private _strider15Alerts: Array<{id:string;name:string;severity:number;confidence:number;assetCrit:number;score:number;enriched:boolean;group:string;status:string;enrichData:Array<{key:string;value:string}>}> = [
  ...
  @state() private _strider15QualityMetrics: {fpRate:number;enrichSuccess:number;avgTriageTime:number;enrichedCount:number;totalCount:number} = {fpRate:0.12, enrichSuccess:0.78, avgTriageTime:4.5, enrichedCount:3, totalCount:5};
  @state() private _strider15RoutingRules: Array<{name:string;condition:string;channel:string;active:boolean}> = [
  ...
  @state() private _strider15Shapes: Array<{id:string;type:string;label:string;controls:string[]}> = [
  ...
  @state() private _strider15TrustBoundaries: Array<{from:string;to:string;label:string;strength:string}> = [
  ...
  @state() private _strider15ADRs: Array<{id:string;title:string;status:string;date:string;decision:string}> = [
  ...
  @state() private _strider15SelectedShape: string = '';
  @state() private _strider15Gauges: Array<{name:string;value:number;max:number;unit:string;status:string;color:string}> = [
  ...
  @state() private _strider15Anomalies: Array<{id:string;time:string;description:string;severity:string;acknowledged:boolean}> = [
  ...
  @state() private _strider15Integrations: Array<{name:string;status:string;uptime:number;lastCheck:string;latency:number}> = [
  ...
  @state() private _strider15AlertFatigue: Array<{analyst:string;alertsPerDay:number;escalated:number;dismissed:number;avgResponseMin:number}> = [
  ...
  @state() private _strider15SlaTarget: number = 99.9;

  // Insider Threat Detection
  private smInitInsiderThreat() {
    this._smUserBaseline = [
    ...
    this._smInsiderRisk = { totalUsers: 2847, monitored: 342, flagged: 18, investigated: 5, confirmed: 1 };
  }

  private _smRenderInsiderThreat() {
    const baseline = this._smUserBaseline;
    const rules = this._smAnomalyRules;
    const ir = this._smInsiderRisk;
    ...
    return html`<div class="card" style="padding:14px;margin-bottom:8px">
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px;margin-bottom:10px;flex-wrap:wrap">
            ${['timeline','rootcause','impact','actions','lessons'].map(t => html`
              <button class="btn ${this._strider15ActiveTab === t ? 'btn-primary' : ''}" style="font-size:10px;padding:3px 8px" @click=${() => { this._strider15ActiveTab = t; }}>${t.charAt(0).toUpperCase() + t.slice(1)}</button>
            `)}
          </div>
          ${this._strider15ActiveTab === 'timeline' ? html`
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._strider15Timeline.map(e => html`
          ...
          ` : this._strider15ActiveTab === 'rootcause' ? html`
            <div style="margin-bottom:8px">${{__html: this._strider15RenderFishbone()}}</div>
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._strider15RootCauses.map((rc, i) => html`
          ...
          ` : this._strider15ActiveTab === 'impact' ? html`
            <div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:10px">
              ...
              <tbody>${this._strider15ImpactMatrix.map(imp => html`
          ...
          ` : this._strider15ActiveTab === 'actions' ? html`
            <div style="display:flex;gap:12px;margin-bottom:8px;font-size:10px;color:#888">
              ${Object.entries(this._strider15GetActionStats()).map(([k,v]) => html`<span>${k}: <b style="color:#ddd">${v}</b></span>`)}
            </div>
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._strider15Actions.map(a => html`
                <div style="display:flex;gap:8px;align-items:center;padding:6px;background:#1a1d27;border-radius:4px;cursor:pointer" @click=${() => this._strider15ToggleAction(a.id)}>
          ...
          ` : html`
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._strider15Lessons.map(l => html`
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px;margin-bottom:10px;flex-wrap:wrap">
            ${['all', ...this._strider15MaturityLevels.map(m => m.domain)].map(d => html`
              <button class="btn ${this._strider15SelectedDomain === d ? 'btn-primary' : ''}" style="font-size:9px;padding:2px 6px" @click=${() => { this._strider15SelectedDomain = d; }}>${d}</button>
            `)}
          </div>
          <div style="display:flex;gap:16px;margin-bottom:10px">
            <div style="text-align:center"><div style="color:#e0e0e0;font-size:20px;font-weight:bold">${this._strider15GetOverallMaturity()}/5</div><div style="color:#888;font-size:10px">Maturity Level</div></div>
            <div style="text-align:center"><div style="color:#4f4;font-size:20px;font-weight:bold">${this._strider15GetGapAnalysis().filter(g => g.isAbove).length}/${this._strider15Benchmarks.length}</div><div style="color:#888;font-size:10px">Above Industry</div></div>
          </div>
          <div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:10px">
            ...
            <tbody>${this._strider15GetGapAnalysis().map(b => html`
          ...
          <div style="margin-top:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Maturity by Domain</div>
            ${this._strider15MaturityLevels.filter(m => this._strider15SelectedDomain === 'all' || m.domain === this._strider15SelectedDomain).map(m => html`
          ...
          <div style="margin-top:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Quarterly Trend</div>
            <div style="display:flex;height:40px;align-items:flex-end;gap:4px">
              ${this._strider15QuarterlyData.map(q => html`<div style="flex:1;text-align:center"><div style="background:#4a9eff;height:${q.score * 0.5}px;border-radius:2px 2px 0 0" title="${q.score}"></div><div style="color:#666;font-size:8px;margin-top:2px">${q.quarter}</div></div>`)}
            </div>
          </div>
        </div>
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:12px;margin-bottom:8px;font-size:10px">
            <div style="display:flex;gap:4px;flex-wrap:wrap">${this._strider15GroupAlerts().map(g => html`<span style="color:#888;padding:2px 6px;background:#1a1d27;border-radius:3px">${g.group}: ${g.count}</span>`)}</div>
          </div>
          <div style="display:flex;gap:8px;margin-bottom:8px;font-size:10px;color:#888">
            <span>FP Rate: <b style="color:${this._strider15QualityMetrics.fpRate > 0.15 ? '#f44' : '#4f4'}">${(this._strider15QualityMetrics.fpRate * 100).toFixed(1)}%</b></span>
            <span>Enrich: <b style="color:#4a9eff">${(this._strider15QualityMetrics.enrichSuccess * 100).toFixed(0)}%</b></span>
            <span>Avg Triage: <b style="color:#ddd">${this._strider15QualityMetrics.avgTriageTime}m</b></span>
          </div>
          <div style="display:flex;flex-direction:column;gap:4px;max-height:200px;overflow-y:auto">
            ${this._strider15Alerts.sort((a, b) => this._strider15CalcScore(b) - this._strider15CalcScore(a)).map(a => {
              const score = this._strider15CalcScore(a);
              return html`
                <div style="padding:6px;background:#1a1d27;border-radius:4px;border-left:3px solid ${a.severity >= 4 ? '#f44' : a.severity >= 3 ? '#fa0' : '#4a9eff'}">
                  <div style="display:flex;justify-content:space-between;align-items:center">
                    ...
                    <button class="btn" style="font-size:9px;padding:1px 6px;margin-left:4px" @click=${() => this._strider15EnrichAlert(a.id)}>${a.enriched ? 'Re-enrich' : 'Enrich'}</button>
                  </div>
          ...
          <div style="margin-top:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Routing Rules</div>
            ${this._strider15RoutingRules.map(r => html`
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:8px;margin-bottom:8px;flex-wrap:wrap">
            ${this._strider15Shapes.map(s => {
              const v = this._strider15ValidateControl(s.id);
              return html`<div style="padding:4px 8px;background:#1a1d27;border-radius:3px;cursor:pointer;border:1px solid ${this._strider15SelectedShape === s.id ? '#4a9eff' : '#2a2d37'}" @click=${() => { this._strider15SelectedShape = this._strider15SelectedShape === s.id ? '' : s.id; }}>
          ...
          ${this._strider15SelectedShape ? html`
            ${(() => {
              const shape = this._strider15Shapes.find(s => s.id === this._strider15SelectedShape);
              const v = this._strider15ValidateControl(this._strider15SelectedShape);
              return shape ? html`
          ...
          <div style="margin-bottom:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Trust Boundaries</div>
            ${this._strider15TrustBoundaries.map(tb => html`
              <div style="display:flex;gap:6px;align-items:center;padding:3px;background:#1a1d27;border-radius:3px;margin-bottom:2px;font-size:9px">
                <span style="color:#ddd">${this._strider15Shapes.find(s => s.id === tb.from)?.label || tb.from}</span>
                <span style="color:#4a9eff">\u2194</span>
                <span style="color:#ddd">${this._strider15Shapes.find(s => s.id === tb.to)?.label || tb.to}</span>
          ...
          <div><div style="color:#888;font-size:10px;margin-bottom:4px">Architecture Decision Records</div>
            ${this._strider15ADRs.map(adr => html`
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:8px;margin-bottom:8px;flex-wrap:wrap">
            ${this._strider15Gauges.map(g => html`
          ...
          <div style="display:flex;gap:8px;margin-bottom:8px;align-items:center">
            ...
            <span style="color:${this._strider15GetOverallHealth().score >= 99 ? '#4f4' : '#fa0'};font-size:12px;font-weight:bold">${this._strider15GetOverallHealth().score}%</span>
            <span style="color:#888;font-size:10px">(Target: ${this._strider15SlaTarget}%)</span>
            <span style="color:#4f4;font-size:10px">${this._strider15GetOverallHealth().healthy} healthy</span>
            <span style="color:#fa0;font-size:10px">${this._strider15GetOverallHealth().degraded} degraded</span>
          </div>
          <div style="margin-bottom:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Anomaly Stream</div>
            ${this._strider15Anomalies.slice(0, 3).map(a => html`
              <div style="display:flex;gap:6px;align-items:center;padding:4px;background:#1a1d27;border-radius:3px;margin-bottom:2px;opacity:${a.acknowledged ? 0.5 : 1}">
                ...
                ${!a.acknowledged ? html`<button class="btn" style="font-size:8px;padding:1px 4px" @click=${() => this._strider15AckAnomaly(a.id)}>ACK</button>` : html`<span style="color:#4f4;font-size:9px">ACK'd</span>`}
              </div>
            `)}
          </div>
          <div style="margin-bottom:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Integration Health</div>
            ${this._strider15Integrations.map(i => html`
              <div style="display:flex;gap:6px;align-items:center;padding:3px;background:#1a1d27;border-radius:3px;margin-bottom:2px;font-size:9px">
          ...
          <div><div style="color:#888;font-size:10px;margin-bottom:4px">Alert Fatigue Analysis</div>
            <div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:9px">
              ...
              <tbody>${this._strider15AlertFatigue.map(af => html`
  ...
  private _strider15RenderFishbone(): string {
  ...
  private _strider15ToggleAction(id: string) {
    this._strider15Actions = this._strider15Actions.map(a => a.id === id ? {...a, status: a.status === 'pending' ? 'in_progress' : a.status === 'in_progress' ? 'completed' : 'pending'} : a);
  }

  private _strider15GetActionStats() {
    const total = this._strider15Actions.length;
    const done = this._strider15Actions.filter(a => a.status === 'completed').length;
    const inProg = this._strider15Actions.filter(a => a.status === 'in_progress').length;
    return { total, done, inProg, pending: total - done - inProg };
  }

  private _strider15GetOverallMaturity(): number {
    if (this._strider15SelectedDomain === 'all') {
      return Math.round(this._strider15MaturityLevels.reduce((s, m) => s + m.current, 0) / this._strider15MaturityLevels.length * 10) / 10;
    }
    const d = this._strider15MaturityLevels.find(m => m.domain === this._strider15SelectedDomain);
    return d ? d.current : 0;
  }

  private _strider15GetGapAnalysis() {
    return this._strider15Benchmarks.map(b => {
  ...
  private _strider15CalcScore(alert: any): number {
    return Math.round(alert.severity * alert.confidence * alert.assetCrit * 100) / 100;
  }

  private _strider15EnrichAlert(id: string) {
    this._strider15Alerts = this._strider15Alerts.map(a => {
      if (a.id !== id) return a;
      const score = this._strider15CalcScore(a);
  ...
  private _strider15GroupAlerts() {
    const groups: Record<string, number> = {};
    this._strider15Alerts.forEach(a => { groups[a.group] = (groups[a.group] || 0) + 1; });
    return Object.entries(groups).map(([g, c]) => ({group: g, count: c}));
  }

  private _strider15ValidateControl(shapeId: string): {valid:boolean;missing:string[]} {
    const shape = this._strider15Shapes.find(s => s.id === shapeId);
  ...
  private _strider15GetOverallHealth(): {healthy:number;degraded:number;down:number;score:number} {
    const online = this._strider15Integrations.filter(i => i.status === 'online').length;
    const degraded = this._strider15Integrations.filter(i => i.status === 'degraded').length;
    const total = this._strider15Integrations.length;
    return { healthy: online, degraded, down: total - online - degraded, score: Math.round(online / total * 100) };
  }

  private _strider15AckAnomaly(id: string) {
    this._strider15Anomalies = this._strider15Anomalies.map(a => a.id === id ? {...a, acknowledged: true} : a);
  }
...
// ===== SECURITY CONTROL TESTING (R22) =====
  ...
  private _renderBudgetPlanning() {
    const budgetData = [
      { category: "Personnel & Training", planned: 3461000, actual: 3519000, utilization: 101.7, q1: "23%", q2: "28%", q3: "26%", q4: "18%" },
      { category: "Tooling & Licensing", planned: 3468000, actual: 3532000, utilization: 101.8, q1: "26%", q2: "33%", q3: "21%", q4: "19%" },
      { category: "Infrastructure Security", planned: 3475000, actual: 3545000, utilization: 102.0, q1: "29%", q2: "22%", q3: "32%", q4: "20%" },
      { category: "Compliance & Audit", planned: 3482000, actual: 3558000, utilization: 102.2, q1: "16%", q2: "27%", q3: "27%", q4: "21%" },
      { category: "Incident Response", planned: 3489000, actual: 3571000, utilization: 102.4, q1: "19%", q2: "32%", q3: "22%", q4: "22%" },
      { category: "Third-Party Assessments", planned: 3496000, actual: 3584000, utilization: 102.5, q1: "22%", q2: "21%", q3: "33%", q4: "23%" },
      { category: "Security Awareness", planned: 3503000, actual: 3597000, utilization: 102.7, q1: "25%", q2: "26%", q3: "28%", q4: "24%" },
      { category: "Research & Innovation", planned: 3510000, actual: 3610000, utilization: 102.8, q1: "28%", q2: "31%", q3: "23%", q4: "25%" },
    ];
    ...
    const headcount = [
      { team: "SOC Tier 1", current: 5, target: 19, gap: 2, avgSalary: "189k" },
      { team: "SOC Tier 2", current: 14, target: 18, gap: 1, avgSalary: "107k" },
      { team: "Threat Intel", current: 6, target: 17, gap: 0, avgSalary: "136k" },
      { team: "Red Team", current: 15, target: 16, gap: 5, avgSalary: "165k" },
      { team: "GRC", current: 7, target: 15, gap: 4, avgSalary: "194k" },
      { team: "AppSec", current: 16, target: 14, gap: 3, avgSalary: "112k" },
      { team: "Cloud Sec", current: 8, target: 13, gap: 2, avgSalary: "141k" },
      { team: "Identity & Access", current: 17, target: 12, gap: 1, avgSalary: "170k" },
    ];
    const vendorSpend = [
      { vendor: "CrowdStrike", annual: "131k", contractEnd: "2026-09", renewalRisk: "Low", satisfaction: 5 },
      { vendor: "Palo Alto", annual: "162k", contractEnd: "2026-10", renewalRisk: "Medium", satisfaction: 4 },
      { vendor: "Splunk", annual: "193k", contractEnd: "2026-11", renewalRisk: "High", satisfaction: 3 },
      { vendor: "Qualys", annual: "224k", contractEnd: "2026-12", renewalRisk: "Low", satisfaction: 5 },
      { vendor: "Rapid7", annual: "255k", contractEnd: "2026-01", renewalRisk: "Medium", satisfaction: 4 },
      { vendor: "Mandiant", annual: "286k", contractEnd: "2026-02", renewalRisk: "High", satisfaction: 3 },
      { vendor: "Zscaler", annual: "317k", contractEnd: "2026-03", renewalRisk: "Low", satisfaction: 5 },
      { vendor: "Duo Security", annual: "348k", contractEnd: "2026-04", renewalRisk: "Medium", satisfaction: 4 },
    ];
    const roiProjections = [
      { area: "Threat Detection", investment: "831k", projectedReturn: "1683k", roiMultiple: "3.3x", confidence: 80 },
      { area: "Incident Reduction", investment: "874k", projectedReturn: "1730k", roiMultiple: "3.2x", confidence: 61 },
      { area: "Compliance Savings", investment: "116k", projectedReturn: "1777k", roiMultiple: "3.1x", confidence: 78 },
      { area: "Automation Gains", investment: "159k", projectedReturn: "1824k", roiMultiple: "3.0x", confidence: 95 },
      { area: "Risk Avoidance", investment: "202k", projectedReturn: "1871k", roiMultiple: "2.9x", confidence: 76 },
    ];
    return html`
  ...
  private _renderMetricsNormalization() {
    const kpiCatalog = [
      { id: "kpi-1", name: "MTTD", owner: "SOC", unit: "minutes", target: 75, current: 92, benchmark: 98, collection: "auto", frequency: "realtime" },
      { id: "kpi-2", name: "MTTR", owner: "GRC", unit: "%", target: 78, current: 99, benchmark: 75, collection: "semi-auto", frequency: "daily" },
      { id: "kpi-3", name: "MTTC", owner: "AppSec", unit: "score", target: 81, current: 60, benchmark: 86, collection: "manual", frequency: "weekly" },
      { id: "kpi-4", name: "Vuln SLA Compliance", owner: "Cloud Sec", unit: "count", target: 84, current: 67, benchmark: 97, collection: "auto", frequency: "monthly" },
      { id: "kpi-5", name: "Patch Coverage", owner: "Identity", unit: "days", target: 87, current: 74, benchmark: 74, collection: "semi-auto", frequency: "realtime" },
      { id: "kpi-6", name: "Phishing Click Rate", owner: "Threat Intel", unit: "minutes", target: 90, current: 81, benchmark: 85, collection: "manual", frequency: "daily" },
      { id: "kpi-7", name: "Training Completion", owner: "Security Ops", unit: "%", target: 93, current: 88, benchmark: 96, collection: "auto", frequency: "weekly" },
      { id: "kpi-8", name: "Escalation Rate", owner: "Risk Mgmt", unit: "score", target: 96, current: 95, benchmark: 73, collection: "semi-auto", frequency: "monthly" },
      { id: "kpi-9", name: "False Positive Rate", owner: "SOC", unit: "count", target: 99, current: 56, benchmark: 84, collection: "manual", frequency: "realtime" },
      { id: "kpi-10", name: "Threat Intel Actionability", owner: "GRC", unit: "days", target: 72, current: 63, benchmark: 95, collection: "auto", frequency: "daily" },
      { id: "kpi-11", name: "Endpoint Compliance", owner: "AppSec", unit: "minutes", target: 75, current: 70, benchmark: 72, collection: "semi-auto", frequency: "weekly" },
      { id: "kpi-12", name: "Cloud Misconfig Score", owner: "Cloud Sec", unit: "%", target: 78, current: 77, benchmark: 83, collection: "manual", frequency: "monthly" },
      { id: "kpi-13", name: "Identity Anomaly Rate", owner: "Identity", unit: "score", target: 81, current: 84, benchmark: 94, collection: "auto", frequency: "realtime" },
      { id: "kpi-14", name: "DLP Events", owner: "Threat Intel", unit: "count", target: 84, current: 91, benchmark: 71, collection: "semi-auto", frequency: "daily" },
      { id: "kpi-15", name: "Vendor Risk Avg", owner: "Security Ops", unit: "days", target: 87, current: 98, benchmark: 82, collection: "manual", frequency: "weekly" },
      { id: "kpi-16", name: "Compliance Audit Pass Rate", owner: "Risk Mgmt", unit: "minutes", target: 90, current: 59, benchmark: 93, collection: "auto", frequency: "monthly" },
      { id: "kpi-17", name: "Awareness Score", owner: "SOC", unit: "%", target: 93, current: 66, benchmark: 70, collection: "semi-auto", frequency: "realtime" },
      { id: "kpi-18", name: "SOC Utilization", owner: "GRC", unit: "score", target: 96, current: 73, benchmark: 81, collection: "manual", frequency: "daily" },
      { id: "kpi-19", name: "Automation Coverage", owner: "AppSec", unit: "count", target: 99, current: 80, benchmark: 92, collection: "auto", frequency: "weekly" },
      { id: "kpi-20", name: "Risk Register Currency", owner: "Cloud Sec", unit: "days", target: 72, current: 87, benchmark: 69, collection: "semi-auto", frequency: "monthly" },
    ];
    const benchmarkSources = [
      { source: "NIST CSF", mappedKPIs: 8, alignment: 89, lastReview: "2026-06-16", status: "aligned" },
      { source: "CIS Controls v8", mappedKPIs: 3, alignment: 67, lastReview: "2026-01-11", status: "partial" },
      { source: "ISO 27001:2022", mappedKPIs: 4, alignment: 84, lastReview: "2026-02-06", status: "reviewing" },
      { source: "PCI DSS 4.0", mappedKPIs: 5, alignment: 62, lastReview: "2026-03-01", status: "aligned" },
      { source: "SOC 2 Type II", mappedKPIs: 6, alignment: 79, lastReview: "2026-04-24", status: "partial" },
      { source: "MITRE ATT&CK", mappedKPIs: 7, alignment: 96, lastReview: "2026-05-19", status: "reviewing" },
      { source: "SANS Top 20", mappedKPIs: 8, alignment: 74, lastReview: "2026-06-14", status: "aligned" },
      { source: "OWASP Top 10", mappedKPIs: 3, alignment: 91, lastReview: "2026-01-09", status: "partial" },
    ];
  ...
  private _renderThreatHuntingCampaigns() {
    const campaigns = [
      { id: "HC-1001", name: "Lateral Movement Sweep", status: "active", hypothesis: "H1: Actors using pass-the-hash for lateral movement", leadHunter: "Alice Chen", findings: 39, startDate: "2026-04-08", endDate: null, effectiveness: 77 },
      { id: "HC-1002", name: "Credential Harvesting Hunt", status: "completed", hypothesis: "H2: Actors using web shells for persistence", leadHunter: "Bob Martinez", findings: 42, startDate: "2026-03-19", endDate: "2026-05-25", effectiveness: 96 },
      { id: "HC-1003", name: "Persistence Mechanism Audit", status: "planned", hypothesis: "H3: Actors using scheduled tasks for data theft", leadHunter: "Carol Wu", findings: 45, startDate: "2026-02-02", endDate: null, effectiveness: 56 },
      { id: "HC-1004", name: "C2 Beacon Detection", status: "in-review", hypothesis: "H4: Actors using DNS tunneling for C2 communication", leadHunter: "Dave Kim", findings: 0, startDate: "2026-01-13", endDate: null, effectiveness: 75 },
      { id: "HC-1005", name: "Data Exfiltration Patterns", status: "active", hypothesis: "H5: Actors using encrypted channels for privilege escalation", leadHunter: "Eve Johnson", findings: 3, startDate: "2026-04-24", endDate: null, effectiveness: 94 },
      { id: "HC-1006", name: "Privilege Escalation Scan", status: "completed", hypothesis: "H6: Actors using token impersonation for defense evasion", leadHunter: "Frank Liu", findings: 6, startDate: "2026-03-07", endDate: "2026-06-09", effectiveness: 54 },
      { id: "HC-1007", name: "Supply Chain Implant Hunt", status: "planned", hypothesis: "H7: Actors using poisoned images for initial access", leadHunter: "Grace Park", findings: 9, startDate: "2026-02-18", endDate: null, effectiveness: 73 },
      { id: "HC-1008", name: "Insider Threat Indicators", status: "in-review", hypothesis: "H8: Actors using legitimate tools for credential access", leadHunter: "Hector Silva", findings: 12, startDate: "2026-01-01", endDate: null, effectiveness: 92 },
      { id: "HC-1009", name: "Cloud Metadata Analysis", status: "active", hypothesis: "H9: Actors using API keys for command execution", leadHunter: "Alice Chen", findings: 15, startDate: "2026-04-12", endDate: null, effectiveness: 52 },
      { id: "HC-1010", name: "DNS Tunnel Detection", status: "completed", hypothesis: "H10: Actors using encoded subdomains for exfiltration", leadHunter: "Bob Martinez", findings: 18, startDate: "2026-03-23", endDate: "2026-04-21", effectiveness: 71 },
      { id: "HC-1011", name: "Fileless Malware Search", status: "planned", hypothesis: "H11: Actors using WMI providers for discovery", leadHunter: "Carol Wu", findings: 21, startDate: "2026-02-06", endDate: null, effectiveness: 90 },
      { id: "HC-1012", name: "Zero-Day Exploit Traces", status: "in-review", hypothesis: "H12: Actors using exploit kits for collection", leadHunter: "Dave Kim", findings: 24, startDate: "2026-01-17", endDate: null, effectiveness: 50 },
    ];
    const hunterLeaderboard = [
      { hunter: "Alice Chen", campaigns: 5, findings: 28, highSeverity: 15, avgScore: 98, streak: 8 },
      { hunter: "Bob Martinez", campaigns: 15, findings: 57, highSeverity: 20, avgScore: 91, streak: 1 },
      { hunter: "Carol Wu", campaigns: 12, findings: 86, highSeverity: 25, avgScore: 84, streak: 2 },
      { hunter: "Dave Kim", campaigns: 9, findings: 115, highSeverity: 4, avgScore: 77, streak: 3 },
      { hunter: "Eve Johnson", campaigns: 6, findings: 28, highSeverity: 9, avgScore: 70, streak: 4 },
      { hunter: "Frank Liu", campaigns: 3, findings: 57, highSeverity: 14, avgScore: 63, streak: 5 },
      { hunter: "Grace Park", campaigns: 13, findings: 86, highSeverity: 19, avgScore: 56, streak: 6 },
      { hunter: "Hector Silva", campaigns: 10, findings: 115, highSeverity: 24, avgScore: 93, streak: 7 },
    ];
    const mitreMapping = [
      { tactic: "Initial Access", techniques: 12, campaigns: 4, coverage: 92 },
      { tactic: "Execution", techniques: 11, campaigns: 3, coverage: 72 },
      { tactic: "Persistence", techniques: 10, campaigns: 2, coverage: 52 },
      { tactic: "Privilege Escalation", techniques: 9, campaigns: 1, coverage: 32 },
      { tactic: "Defense Evasion", techniques: 8, campaigns: 6, coverage: 83 },
      { tactic: "Credential Access", techniques: 7, campaigns: 5, coverage: 63 },
      { tactic: "Discovery", techniques: 6, campaigns: 4, coverage: 43 },
      { tactic: "Lateral Movement", techniques: 5, campaigns: 3, coverage: 94 },
      { tactic: "Collection", techniques: 4, campaigns: 2, coverage: 74 },
      { tactic: "Exfiltration", techniques: 3, campaigns: 1, coverage: 54 },
      { tactic: "Command & Control", techniques: 2, campaigns: 6, coverage: 34 },
      { tactic: "Impact", techniques: 12, campaigns: 5, coverage: 85 },
    ];
    return html`
  ...
  private _renderControlInventory() {
    const controls = [
      { id: "CTL-2001", name: "MFA Enforcement", domain: "Access Control", status: "implemented", effectiveness: 74, lastTest: "2026-04-28", nextReview: "2026-12-28", owner: "SOC", risk: "Low" },
      { id: "CTL-2002", name: "Network Segmentation", domain: "Network Security", status: "partial", effectiveness: 17, lastTest: "2026-03-13", nextReview: "2026-05-19", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2003", name: "EDR Deployment", domain: "Endpoint Protection", status: "planned", effectiveness: 24, lastTest: "2026-02-26", nextReview: "2026-06-10", owner: "IT Ops", risk: "High" },
      { id: "CTL-2004", name: "DLP Policy", domain: "Data Protection", status: "gap", effectiveness: 31, lastTest: "2026-01-11", nextReview: "2026-07-01", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2005", name: "SSO Integration", domain: "Identity Management", status: "implemented", effectiveness: 86, lastTest: "2026-04-24", nextReview: "2026-08-20", owner: "IAM", risk: "Low" },
      { id: "CTL-2006", name: "SAST Pipeline", domain: "Application Security", status: "partial", effectiveness: 45, lastTest: "2026-03-09", nextReview: "2026-09-11", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2007", name: "CSPM Scanning", domain: "Cloud Security", status: "planned", effectiveness: 1, lastTest: "2026-02-22", nextReview: "2026-10-02", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2008", name: "Badge Access", domain: "Physical Security", status: "gap", effectiveness: 8, lastTest: "2026-01-07", nextReview: "2026-11-21", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2009", name: "Least Privilege", domain: "Access Control", status: "implemented", effectiveness: 98, lastTest: "2026-04-20", nextReview: "2026-12-12", owner: "SOC", risk: "Low" },
      { id: "CTL-2010", name: "Firewall Rules", domain: "Network Security", status: "partial", effectiveness: 22, lastTest: "2026-03-05", nextReview: "2026-05-03", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2011", name: "Disk Encryption", domain: "Endpoint Protection", status: "planned", effectiveness: 29, lastTest: "2026-02-18", nextReview: "2026-06-22", owner: "IT Ops", risk: "High" },
      { id: "CTL-2012", name: "Data Classification", domain: "Data Protection", status: "gap", effectiveness: 36, lastTest: "2026-01-03", nextReview: "2026-07-13", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2013", name: "PAM Implementation", domain: "Identity Management", status: "implemented", effectiveness: 51, lastTest: "2026-04-16", nextReview: "2026-08-04", owner: "IAM", risk: "Low" },
      { id: "CTL-2014", name: "DAST Pipeline", domain: "Application Security", status: "partial", effectiveness: 50, lastTest: "2026-03-01", nextReview: "2026-09-23", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2015", name: "IAM Policy Review", domain: "Cloud Security", status: "planned", effectiveness: 6, lastTest: "2026-02-14", nextReview: "2026-10-14", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2016", name: "Visitor Management", domain: "Physical Security", status: "gap", effectiveness: 13, lastTest: "2026-01-27", nextReview: "2026-11-05", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2017", name: "Access Reviews", domain: "Access Control", status: "implemented", effectiveness: 63, lastTest: "2026-04-12", nextReview: "2026-12-24", owner: "SOC", risk: "Low" },
      { id: "CTL-2018", name: "IDS/IPS Tuning", domain: "Network Security", status: "partial", effectiveness: 27, lastTest: "2026-03-25", nextReview: "2026-05-15", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2019", name: "Patch Management", domain: "Endpoint Protection", status: "planned", effectiveness: 34, lastTest: "2026-02-10", nextReview: "2026-06-06", owner: "IT Ops", risk: "High" },
      { id: "CTL-2020", name: "Backup Encryption", domain: "Data Protection", status: "gap", effectiveness: 41, lastTest: "2026-01-23", nextReview: "2026-07-25", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2021", name: "Password Policy", domain: "Identity Management", status: "implemented", effectiveness: 75, lastTest: "2026-04-08", nextReview: "2026-08-16", owner: "IAM", risk: "Low" },
      { id: "CTL-2022", name: "Container Scanning", domain: "Application Security", status: "partial", effectiveness: 4, lastTest: "2026-03-21", nextReview: "2026-09-07", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2023", name: "WAF Configuration", domain: "Cloud Security", status: "planned", effectiveness: 11, lastTest: "2026-02-06", nextReview: "2026-10-26", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2024", name: "CCTV Coverage", domain: "Physical Security", status: "gap", effectiveness: 18, lastTest: "2026-01-19", nextReview: "2026-11-17", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2025", name: "RBAC Enforcement", domain: "Access Control", status: "implemented", effectiveness: 87, lastTest: "2026-04-04", nextReview: "2026-12-08", owner: "SOC", risk: "Low" },
      { id: "CTL-2026", name: "VPN Management", domain: "Network Security", status: "partial", effectiveness: 32, lastTest: "2026-03-17", nextReview: "2026-05-27", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2027", name: "App Whitelisting", domain: "Endpoint Protection", status: "planned", effectiveness: 39, lastTest: "2026-02-02", nextReview: "2026-06-18", owner: "IT Ops", risk: "High" },
      { id: "CTL-2028", name: "Key Management", domain: "Data Protection", status: "gap", effectiveness: 46, lastTest: "2026-01-15", nextReview: "2026-07-09", owner: "Data Gov", risk: "Critical" },
    ];
    const gapAnalysis = [
      { gap: "Insufficient MFA coverage for legacy apps", severity: "High", remediationPlan: "Plan R3001", eta: "2026-Q3", estimatedCost: "35k" },
      { gap: "Missing network micro-segmentation", severity: "Medium", remediationPlan: "Plan R3002", eta: "2026-Q2", estimatedCost: "64k" },
      { gap: "Inconsistent EDR deployment", severity: "Medium", remediationPlan: "Plan R3003", eta: "2026-Q4", estimatedCost: "93k" },
      { gap: "DLP not covering cloud storage", severity: "Low", remediationPlan: "Plan R3004", eta: "2026-Q3", estimatedCost: "122k" },
      { gap: "SSO not integrated with all SaaS", severity: "High", remediationPlan: "Plan R3005", eta: "2026-Q2", estimatedCost: "151k" },
    ];
    return html`
  ...
  private _renderIncidentCostTracker() {
    const incidents = [
      { id: "INC-7001", name: "Security Incident 1", severity: "Critical", totalCost: 2163000, responseCost: 432600, recoveryCost: 540750, legalCost: 259560, regulatoryCost: 281190, insuranceClaim: 1535730, avoidedCost: 44000, date: "2026-04-20" },
      { id: "INC-7002", name: "Security Incident 2", severity: "High", totalCost: 2166000, responseCost: 584820, recoveryCost: 779760, legalCost: 194940, regulatoryCost: 173280, insuranceClaim: 0, avoidedCost: 73000, date: "2026-03-01" },
      { id: "INC-7003", name: "Security Incident 3", severity: "Medium", totalCost: 2169000, responseCost: 737460, recoveryCost: 563940, legalCost: 130140, regulatoryCost: 303660, insuranceClaim: 1431540, avoidedCost: 102000, date: "2026-02-10" },
      { id: "INC-7004", name: "Security Incident 4", severity: "Low", totalCost: 2172000, responseCost: 434400, recoveryCost: 803640, legalCost: 412680, regulatoryCost: 195480, insuranceClaim: 0, avoidedCost: 131000, date: "2026-01-19" },
      { id: "INC-7005", name: "Security Incident 5", severity: "Critical", totalCost: 2175000, responseCost: 587250, recoveryCost: 587250, legalCost: 348000, regulatoryCost: 326250, insuranceClaim: 1326750, avoidedCost: 160000, date: "2026-04-28" },
      { id: "INC-7006", name: "Security Incident 6", severity: "High", totalCost: 2178000, responseCost: 740520, recoveryCost: 827640, legalCost: 283140, regulatoryCost: 217800, insuranceClaim: 0, avoidedCost: 189000, date: "2026-03-09" },
      { id: "INC-7007", name: "Security Incident 7", severity: "Medium", totalCost: 2181000, responseCost: 436200, recoveryCost: 610680, legalCost: 218100, regulatoryCost: 109050, insuranceClaim: 1221360, avoidedCost: 218000, date: "2026-02-18" },
      { id: "INC-7008", name: "Security Incident 8", severity: "Low", totalCost: 2184000, responseCost: 589680, recoveryCost: 851760, legalCost: 152880, regulatoryCost: 240240, insuranceClaim: 0, avoidedCost: 247000, date: "2026-01-27" },
      { id: "INC-7009", name: "Security Incident 9", severity: "Critical", totalCost: 2187000, responseCost: 743580, recoveryCost: 634230, legalCost: 437400, regulatoryCost: 131220, insuranceClaim: 1115370, avoidedCost: 276000, date: "2026-04-08" },
      { id: "INC-7010", name: "Security Incident 10", severity: "High", totalCost: 2190000, responseCost: 438000, recoveryCost: 876000, legalCost: 372300, regulatoryCost: 262800, insuranceClaim: 0, avoidedCost: 305000, date: "2026-03-17" },
      { id: "INC-7011", name: "Security Incident 11", severity: "Medium", totalCost: 2193000, responseCost: 592110, recoveryCost: 657900, legalCost: 307020, regulatoryCost: 153510, insuranceClaim: 1008780, avoidedCost: 334000, date: "2026-02-26" },
      { id: "INC-7012", name: "Security Incident 12", severity: "Low", totalCost: 2196000, responseCost: 746640, recoveryCost: 439200, legalCost: 241560, regulatoryCost: 285480, insuranceClaim: 0, avoidedCost: 363000, date: "2026-01-07" },
    ];
    const yearlyTrend = [
      { month: "Jan", incidents: 10, totalCost: "375k", avgCost: "130k", insured: 61 },
      { month: "Feb", incidents: 7, totalCost: "418k", avgCost: "177k", insured: 61 },
      { month: "Mar", incidents: 4, totalCost: "461k", avgCost: "43k", insured: 61 },
      { month: "Apr", incidents: 12, totalCost: "504k", avgCost: "90k", insured: 61 },
      { month: "May", incidents: 9, totalCost: "547k", avgCost: "137k", insured: 61 },
      { month: "Jun", incidents: 6, totalCost: "590k", avgCost: "184k", insured: 61 },
    ];
...
declare global { interface HTMLElementTagNameMap { 'sc-stride-model': ScStrideModel; } }
