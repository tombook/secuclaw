/**
 * sc-attack-patterns - Attack Patterns
...
@customElement('sc-attack-patterns')
export class ScAttackPatterns extends LitElement {
  static styles = css`
...
@state() private _tablePage = 1;
  ...
  @state() private _comments: CommentEntry[] = [
    { id: 'c1', author: 'soc-tier1', timestamp: '2026-04-23 04:00', text: 'Initial assessment started for Attack Patterns finding #1' },
  ...
  private _items: PanelItem[] = [
      {
            "id": "attack-patterns-1",
            "title": "T1190 - Exploit Public-Facing App",
            "severity": "critical",
            "status": "open",
            "category": "Security",
            "source": "SIEM",
            "description": "MITRE ATT&CK Initial Access. Exploit web vulnerability for initial foothold. Detection: WAF + HIDS.",
      ...
      {
            "id": "attack-patterns-2",
            "title": "T1059.001 - PowerShell",
            "severity": "high",
            "status": "in-progress",
            "category": "Network",
            "source": "EDR",
            "description": "MITRE ATT&CK Execution. PowerShell scripts for post-exploitation. Detection: AMSI + Script Block Logging.",
      ...
      {
            "id": "attack-patterns-3",
            "title": "T1078 - Valid Accounts",
            "severity": "high",
            "status": "resolved",
            "category": "Access",
            "source": "Scanner",
            "description": "MITRE ATT&CK Defense Evasion. Use stolen credentials. Detection: UEBA + Impossible Travel.",
      ...
      {
            "id": "attack-patterns-4",
            "title": "T1021.001 - Remote Desktop",
            "severity": "medium",
            "status": "open",
            "category": "Compliance",
            "source": "Audit",
            "description": "MITRE ATT&CK Lateral Movement. RDP for internal movement. Detection: Network + EDR.",
      ...
      {
            "id": "attack-patterns-5",
            "title": "T1048 - Exfiltration Over Alt Protocol",
            "severity": "critical",
            "status": "in-progress",
            "category": "Operations",
            "source": "Manual",
            "description": "MITRE ATT&CK Exfiltration. DNS/ICMP tunneling. Detection: DNS analytics + DLP.",
      ...
      {
            "id": "attack-patterns-6",
            "title": "T1055 - Process Injection",
            "severity": "high",
            "status": "resolved",
            "category": "Security",
            "source": "SIEM",
            "description": "MITRE ATT&CK Defense Evasion. Inject into legitimate processes. Detection: EDR + memory scanning.",
      ...
      {
            "id": "attack-patterns-7",
            "title": "Attack Patterns Finding #7",
            "severity": "low",
            "status": "open",
            "category": "Network",
            "source": "EDR",
            "description": "Automated attack patterns assessment finding detected during routine scan of infrastructure component. Review and remediation recommended.",
      ...
      {
            "id": "attack-patterns-8",
            "title": "Attack Patterns Finding #8",
            "severity": "medium",
            "status": "open",
            "category": "Access",
            "source": "Scanner",
      ...
      {
            "id": "attack-patterns-9",
            "title": "Attack Patterns Finding #9",
            "severity": "high",
            "status": "open",
            "category": "Compliance",
            "source": "Audit",
      ...
      {
            "id": "attack-patterns-10",
            "title": "Attack Patterns Finding #10",
            "severity": "low",
            "status": "open",
            "category": "Operations",
            "source": "Manual",
  ...
  private _history: HistoryEntry[] = [
    { timestamp: '2026-04-23 04:15', action: 'Auto-correlated', user: 'system', details: 'Grouped related findings from Attack Patterns analysis' },
    { timestamp: '2026-04-23 03:00', action: 'Created', user: 'scanner', details: 'New Attack Patterns finding detected by automated assessment' },
    ...
    { timestamp: '2026-04-22 22:00', action: 'Resolved', user: 'security-eng', details: 'Remediation applied and verified for Attack Patterns finding' },
    { timestamp: '2026-04-22 18:00', action: 'Created', user: 'audit', details: 'Compliance audit identified Attack Patterns gap requiring remediation' },
    ...
    { timestamp: '2026-04-21 16:00', action: 'Resolved', user: 'soc-tier1', details: 'False positive confirmed - benign activity flagged by Attack Patterns scan' },
    { timestamp: '2026-04-21 12:00', action: 'Exported', user: 'compliance', details: 'Exported Attack Patterns findings for Q1 compliance report' },
  ];
...
private _workflowTasks: WorkflowTask[] = [
    { id: 'wt-1', title: 'Review Attack Patterns finding #1', status: 'active', assignee: 'soc-tier1', blockedBy: [], slaDeadline: '2026-04-23T12:00:00Z', priority: 'p1', createdAt: '2026-04-23T00:00:00Z', completedAt: null },
    ...
    { id: 'wt-3', title: 'Update Attack Patterns detection rules', status: 'blocked', assignee: 'soc-tier2', blockedBy: ['wt-2'], slaDeadline: '2026-04-24T00:00:00Z', priority: 'p2', createdAt: '2026-04-23T03:00:00Z', completedAt: null },
    ...
    { id: 'wt-8', title: 'Archive resolved Attack Patterns findings', status: 'failed', assignee: 'soc-tier1', blockedBy: [], slaDeadline: '2026-04-23T08:00:00Z', priority: 'p4', createdAt: '2026-04-22T22:00:00Z', completedAt: null },
  ];

private _executionHistory: ExecutionRecord[] = [
    {
      id: 'exec-1', name: 'Attack Patterns Full Assessment Run', startedAt: '2026-04-22T10:00:00Z', completedAt: '2026-04-22T10:12:00Z', status: 'success',
      steps: [
    ...
    {
      id: 'exec-2', name: 'Attack Patterns Delta Scan', startedAt: '2026-04-23T02:00:00Z', completedAt: '2026-04-23T02:05:00Z', status: 'failed',
      steps: [
  ...
  private _runExecution() {
    ...
    const exec: ExecutionRecord = {
      id: 'exec-' + Date.now(), name: 'Attack Patterns Assessment ' + new Date().toISOString().slice(0, 10), startedAt: new Date().toISOString(), completedAt: null, status: 'running', steps,
    };
  ...
  private _renderExecutionPanel(): unknown {
    ...
    return html`
      <div class="form-section">
        ...
        ` : html`<div class="empty-state">Click "Run Assessment" to start the Attack Patterns analysis pipeline</div>`}
      </div>
      <div class="form-section">
        ...
        <div class="settings-card">
          ...
          <div style="display:flex;gap:8px;margin-top:4px;">
            <button class="btn primary" @click=${() => {
              ...
              const a = document.createElement('a'); a.href = url; a.download = 'attack-patterns-config.json'; a.click();
    ...
    return html`
      <div style="margin-top:12px;">
        ...
        <div style="display:flex;gap:6px;margin-top:8px;">
          <input class="search-box" type="text" placeholder="Add a comment..." style="min-width:auto;flex:1;" id="attack-patterns-comment-input" />
          <button class="btn primary" @click=${() => {
            const input = this.shadowRoot?.querySelector('#attack-patterns-comment-input') as HTMLInputElement;
  ...
  private _exportJSON() {
    ...
    const url = URL.createObjectURL(blob);
    const a = document.createElement('a'); a.href = url; a.download = 'sc-attack-patterns-data.json'; a.click();
    URL.revokeObjectURL(url);
  }
  ...
  private _exportCSV() {
    ...
    const url = URL.createObjectURL(blob);
    const a = document.createElement('a'); a.href = url; a.download = 'sc-attack-patterns-data.csv'; a.click();
    URL.revokeObjectURL(url);
  }


  // --- Domain Rules Engine ---
  @state() private _apRules: { id: string; name: string; category: string; severity: Severity; enabled: boolean; lastEval: string; passRate: number }[] = [];
  private _initApRules() {
    const rules = [
  ...
  private _evaluateApRules(): { passed: number; failed: number; skipped: number; total: number } {
    let passed = 0, failed = 0, skipped = 0;
    this._apRules.forEach(r => { if (!r.enabled) { skipped++; } else if (r.passRate >= 80) { passed++; } else { failed++; } });
    return { passed, failed, skipped, total: this._apRules.length };
  }

  // --- CVSS Scoring ---
  @state() private _apcvssData: { itemId: string; vector: string; base: number; temporal: number; environmental: number; overall: number }[] = [];
  private _initApCvss() {
    ...
    this._apcvssData = vectors.map((v, i) => {
  ...
  // --- Anomaly Detection ---
  @state() private _apanomalies: { id: string; type: string; severity: Severity; description: string; detected: string; confidence: number; affected: string[] }[] = [];
  private _runApAnomalyDetection() {
    const types = [
    ...
    this._apanomalies = types.map((a, i) => ({
  ...
  // --- Trend Prediction ---
  @state() private _appredictions: { horizon: string; metric: string; current: number; predicted: number; direction: 'up' | 'down' | 'stable'; confidence: number }[] = [];
  private _generateApPredictions() {
    this._appredictions = [
  ...
  // --- Approval Workflow ---
  @state() private _apApprovals: { id: string; title: string; requester: string; status: 'pending' | 'approved' | 'rejected' | 'expired'; createdAt: string; priority: Priority; type: string }[] = [];
  private _initApApprovals() {
    this._apApprovals = [
  ...
  private _approveApItem(id: string) { const item = this._apApprovals.find(a => a.id === id); if (item) item.status = 'approved'; this.requestUpdate(); }
  private _rejectApItem(id: string) { const item = this._apApprovals.find(a => a.id === id); if (item) item.status = 'rejected'; this.requestUpdate(); }

  // --- Activity Feed ---
  @state() private _apActivity: { id: string; action: string; user: string; target: string; timestamp: string }[] = [];
  private _initApActivity() {
    const actions = [
    ...
    this._apActivity = actions.map((a, i) => ({ id: 'ACT-' + String(i + 1).padStart(3, '0'), ...a, timestamp: new Date(Date.now() - i * 3600000).toISOString() }));
  }

  // --- Notification System ---
  @state() private _apNotifications: { id: string; message: string; type: 'info' | 'warning' | 'error' | 'success'; read: boolean; timestamp: string }[] = [];
  private _initApNotifications() {
    this._apNotifications = [
  ...
  private _markApNotifRead(id: string) { const n = this._apNotifications.find(x => x.id === id); if (n) n.read = true; this.requestUpdate(); }

  // --- Panel Configuration ---
  @state() private _apConfig: { layout: 'compact' | 'default' | 'expanded'; theme: 'dark' | 'midnight' | 'slate'; showAnomalies: boolean; showPredictions: boolean; autoRefresh: boolean; refreshInterval: number } = {
    layout: 'default', theme: 'dark', showAnomalies: true, showPredictions: true, autoRefresh: true, refreshInterval: 60,
  };
  private _apPresets: { name: string; config: typeof this._apConfig }[] = [
  ...
  private _applyApPreset(preset: typeof this._apPresets[0]) { this._apConfig = { ...preset.config }; this.requestUpdate(); }

  private _renderApTreemapSVG(): string {
    const categories = [
  ...
  private _renderApSankeySVG(): string {
  ...
  // --- Render: Rules Engine ---
  private _renderApRules(): any {
    const ev = this._evaluateApRules();
    return html`
  ...
  private _renderApAnomalies(): any {
  ...
  // --- Render: Approvals ---
  private _renderApApprovals(): any {
          ...
          $${this._apApprovals.map(a => html`
            <div style="padding:6px 8px;background:#1f2937;border-radius:4px">
              ...
              $${a.status === 'pending' ? html`
                <div style="display:flex;gap:4px;margin-top:4px">
                  <button class="btn success" style="padding:2px 8px;font-size:9px" @click=$${() => this._approveApItem(a.id)}>Approve</button>
                  <button class="btn error" style="padding:2px 8px;font-size:9px" @click=$${() => this._rejectApItem(a.id)}>Reject</button>
                </div>` : nothing}
            </div>`)}
        </div>
      </div>`;
  ...
  private _renderApNotifications(): any {
    const tc = (t: string) => t === 'error' ? '#ef4444' : t === 'warning' ? '#eab308' : t === 'success' ? '#22c55e' : '#3b82f6';
    const unread = this._apNotifications.filter(n => !n.read).length;
    return html`
      <div style="background:#1a1d27;border-radius:8px;padding:12px;margin-top:12px">
        ...
        <div style="display:flex;flex-direction:column;gap:4px;max-height:120px;overflow-y:auto">
          $${this._apNotifications.map(n => html`
            <div style="display:flex;align-items:center;gap:8px;padding:4px 8px;background:$${n.read ? '#1f2937' : '#252a36'};border-radius:4px;font-size:10px;opacity:$${n.read ? '0.6' : '1'};cursor:pointer" @click=$${() => this._markApNotifRead(n.id)}>
      ...
      <div style="background:#1a1d27;border-radius:8px;padding:12px;margin-top:12px">
        ...
        <div style="display:flex;flex-direction:column;gap:6px;font-size:10px">
          <div style="display:flex;align-items:center;gap:8px">
            ...
            <select class="form-input" style="flex:1" @change=$${(e: Event) => { this._apConfig.layout = (e.target as HTMLSelectElement).value as any; this.requestUpdate(); }}>
              <option value="compact" ?selected=$${this._apConfig.layout === 'compact'}>Compact</option>
              <option value="default" ?selected=$${this._apConfig.layout === 'default'}>Default</option>
              <option value="expanded" ?selected=$${this._apConfig.layout === 'expanded'}>Expanded</option>
            </select>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Theme</span>
            <select class="form-input" style="flex:1" @change=$${(e: Event) => { this._apConfig.theme = (e.target as HTMLSelectElement).value as any; this.requestUpdate(); }}>
              <option value="dark" ?selected=$${this._apConfig.theme === 'dark'}>Dark</option>
              <option value="midnight" ?selected=$${this._apConfig.theme === 'midnight'}>Midnight</option>
              <option value="slate" ?selected=$${this._apConfig.theme === 'slate'}>Slate</option>
            </select>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Auto Refresh</span>
            <input type="checkbox" ?checked=$${this._apConfig.autoRefresh} @change=$${() => { this._apConfig.autoRefresh = !this._apConfig.autoRefresh; this.requestUpdate(); }}/>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Show Anomalies</span>
            <input type="checkbox" ?checked=$${this._apConfig.showAnomalies} @change=$${() => { this._apConfig.showAnomalies = !this._apConfig.showAnomalies; this.requestUpdate(); }}/>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Show Predictions</span>
            <input type="checkbox" ?checked=$${this._apConfig.showPredictions} @change=$${() => { this._apConfig.showPredictions = !this._apConfig.showPredictions; this.requestUpdate(); }}/>
          </div>
          <div style="margin-top:6px;font-weight:600">Presets</div>
          <div style="display:flex;gap:4px">
            $${this._apPresets.map(ps => html`<button class="btn" style="padding:2px 8px;font-size:9px" @click=$${() => this._applyApPreset(ps)}>$${ps.name}</button>`)}
          </div>
        </div>
      </div>`;
  }
  ...
  @state() private _attackPatterRiskTopTen: Array<{id:string;name:string;score:number;trend:string;owner:string;category:string;lastAssessed:string}> = [
  ...
  @state() private _attackPatterRiskCategories: Array<{category:string;count:number;avgScore:number;color:string}> = [
  ...
  @state() private _attackPatterRiskVelocity: Array<{week:string;newRisks:number;closedRisks:number;netChange:number}> = [
  ...
  @state() private _attackPatterRiskAppetite: {current:number;threshold:number;maxTolerated:number;status:string} = {
    current: 68, threshold: 55, maxTolerated: 80, status: 'Warning'
  };
  @state() private _attackPatterRiskOwnerMatrix: Array<{owner:string;criticalCount:number;highCount:number;mediumCount:number;complianceRate:number}> = [
  ...
  private _renderAttackpatterRiskDash(): TemplateResult {
    const riskItems = this._attackPatterRiskTopTen;
    const velocity = this._attackPatterRiskVelocity;
    const appetite = this._attackPatterRiskAppetite;
    return html`
  ...
  @state() private _attackPatterContainerScans: Array<{image:string;registry:string;critical:number;high:number;medium:number;scanDate:string;status:string}> = [
  ...
  @state() private _attackPatterK8sPods: Array<{namespace:string;pod:string;securityContext:string;hostIPC:boolean;hostPID:boolean;privileged:boolean;riskLevel:string}> = [
  ...
  @state() private _attackPatterServerlessRisk: Array<{function:string;runtime:string;timeout:number;iamPerms:string;externalCalls:number;riskScore:number}> = [
  ...
  @state() private _attackPatterRuntimeAlerts: Array<{id:string;workload:string;alertType:string;severity:string;description:string;timestamp:string}> = [
  ...
  private _renderAttackpatterCloudWl(): TemplateResult {
    const containers = this._attackPatterContainerScans;
    const pods = this._attackPatterK8sPods;
    const alerts = this._attackPatterRuntimeAlerts;
    return html`
  ...
  @state() private _attackPatterCourses: Array<{id:string;title:string;category:string;duration:number;enrolled:number;completed:number;difficulty:string;rating:number}> = [
  ...
  @state() private _attackPatterLearningPaths: Array<{id:string;name:string;courseIds:string[];progress:number;enrolled:number}> = [
  ...
  @state() private _attackPatterDeptCompliance: Array<{dept:string;trainedPct:number;targetPct:number;avgScore:number;certCount:number}> = [
  ...
  @state() private _attackPatterSkillsGaps: Array<{skill:string;current:number;required:number;gap:number;priority:string}> = [
  ...
  private _renderAttackpatterTraining(): TemplateResult {
    const courses = this._attackPatterCourses;
    const deptComp = this._attackPatterDeptCompliance;
    return html`
  ...
  @state() private _attackPatterCorrRules: Array<{id:string;name:string;sources:string[];logic:string;severity:string;active:boolean;lastTriggered:string}> = [
  ...
  @state() private _attackPatterEventTimeline: Array<{timestamp:string;source:string;eventType:string;details:string;correlated:boolean}> = [
  ...
  @state() private _attackPatterFalsePosMetrics: {totalEvents:number;correlatedEvents:number;falsePositives:number;fpRate:number;topFpRules:string[]} = {
  ...
  @state() private _attackPatterEventPatterns: Array<{id:string;pattern:string;frequency:number;firstSeen:string;lastSeen:string;status:string}> = [
  ...
  private _renderAttackpatterEventCorr(): TemplateResult {
    const rules = this._attackPatterCorrRules;
    const timeline = this._attackPatterEventTimeline;
    const fpMetrics = this._attackPatterFalsePosMetrics;
    return html`
  ...
  @state() private _attackPatterThreatIntel: Array<{source:string;indicator:string;type:string;confidence:number;severity:string;observed:string;description:string}> = [
  ...
  @state() private _attackPatterIntelMetrics: {totalIndicators:number;criticalCount:number;highCount:number;mediumCount:number;staleIndicators:number;feedUptime:number} = {
    totalIndicators: 45230, criticalCount: 234, highCount: 1892, mediumCount: 8765, staleIndicators: 567, feedUptime: 99.7
  };
  @state() private _attackPatterIntelTrending: Array<{category:string;thisWeek:number;lastWeek:number;change:number}> = [
  ...
  private _renderAttackpatterThreatIntel(): TemplateResult {
    const intel = this._attackPatterThreatIntel;
    const trending = this._attackPatterIntelTrending;
    const metrics = this._attackPatterIntelMetrics;
    return html`
  ...
  @state() private _complianceCalendarEvents: Array<{id: string; title: string; deadline: string; category: string; status: string; assignee: string; notes: string}> = [
    {id: 'cc-attack-patterns-001', title: 'SOX Section 404 Compliance Review', deadline: '2026-06-30', category: 'Regulatory', status: 'In Progress', assignee: 'Compliance Team', notes: 'Annual internal control assessment for financial reporting'},
    {id: 'cc-attack-patterns-002', title: 'GDPR Data Protection Impact Assessment', deadline: '2026-05-15', category: 'Privacy', status: 'Pending', assignee: 'DPO Office', notes: 'Quarterly DPIA for high-risk processing activities'},
    {id: 'cc-attack-patterns-003', title: 'ISO 27001 Surveillance Audit', deadline: '2026-07-20', category: 'Certification', status: 'Scheduled', assignee: 'QA Lead', notes: 'Stage 2 surveillance audit for ISMS certification renewal'},
    {id: 'cc-attack-patterns-004', title: 'PCI DSS v4.0 Gap Analysis', deadline: '2026-05-30', category: 'Payment', status: 'Not Started', assignee: 'Security Architect', notes: 'Assess current state against PCI DSS v4.0 requirements'},
    {id: 'cc-attack-patterns-005', title: 'NIST CSF Self-Assessment', deadline: '2026-08-15', category: 'Framework', status: 'Pending', assignee: 'CISO', notes: 'Biannual self-assessment against NIST Cybersecurity Framework'},
    {id: 'cc-attack-patterns-006', title: 'HIPAA Security Rule Audit', deadline: '2026-06-15', category: 'Healthcare', status: 'In Progress', assignee: 'Compliance Analyst', notes: 'Annual audit of administrative, physical, and technical safeguards'},
    {id: 'cc-attack-patterns-007', title: 'SOC 2 Type II Report Renewal', deadline: '2026-09-30', category: 'Audit', status: 'Scheduled', assignee: 'External Auditor', notes: 'Engage auditor for SOC 2 Type II examination period'},
    {id: 'cc-attack-patterns-008', title: 'FedRAMP Authorization Review', deadline: '2026-07-01', category: 'Government', status: 'Pending', assignee: 'FedRAMP PMO', notes: 'Review and update security authorization package'},
    {id: 'cc-attack-patterns-009', title: 'Annual Penetration Test', deadline: '2026-10-15', category: 'Testing', status: 'Not Started', assignee: 'Red Team Lead', notes: 'Comprehensive external and internal penetration testing engagement'},
    {id: 'cc-attack-patterns-010', title: 'Security Awareness Training Rollout', deadline: '2026-05-01', category: 'Training', status: 'Completed', assignee: 'Security Awareness Manager', notes: 'Q2 organization-wide security awareness training program'},
    {id: 'cc-attack-patterns-011', title: 'Vendor Security Review Cycle', deadline: '2026-06-01', category: 'Third Party', status: 'In Progress', assignee: 'Vendor Manager', notes: 'Quarterly review of critical vendor security posture and SLA compliance'},
    {id: 'cc-attack-patterns-012', title: 'Incident Response Plan Update', deadline: '2026-05-20', category: 'Operations', status: 'Pending', assignee: 'IR Team Lead', notes: 'Update IR procedures based on lessons learned from recent incidents'},
  ];
  ...
  @state() private _dataQualityMetrics: Array<{id: string; dataSource: string; completenessScore: number; accuracyScore: number; timelinessScore: number; consistencyScore: number; reliabilityRank: number; lastUpdated: string; issues: string[]; trend: string}> = [
    {id: 'dq-attack-patterns-001', dataSource: 'Vulnerability Scanner Feed', completenessScore: 94, accuracyScore: 91, timelinessScore: 88, consistencyScore: 95, reliabilityRank: 1, lastUpdated: '2026-04-23T08:00:00Z', issues: ['Minor delay in Nessus plugin updates'], trend: 'improving'},
    {id: 'dq-attack-patterns-002', dataSource: 'SIEM Event Logs', completenessScore: 87, accuracyScore: 93, timelinessScore: 96, consistencyScore: 89, reliabilityRank: 2, lastUpdated: '2026-04-23T07:30:00Z', issues: ['Some log sources showing gaps in off-hours'], trend: 'stable'},
    {id: 'dq-attack-patterns-003', dataSource: 'Asset Inventory Database', completenessScore: 82, accuracyScore: 78, timelinessScore: 75, consistencyScore: 84, reliabilityRank: 4, lastUpdated: '2026-04-22T18:00:00Z', issues: ['Shadow IT devices not fully cataloged', 'Decommissioned assets still listed'], trend: 'declining'},
    {id: 'dq-attack-patterns-004', dataSource: 'Threat Intelligence Platform', completenessScore: 91, accuracyScore: 89, timelinessScore: 92, consistencyScore: 87, reliabilityRank: 3, lastUpdated: '2026-04-23T06:00:00Z', issues: ['Some IOC sources lack confidence scoring'], trend: 'improving'},
    {id: 'dq-attack-patterns-005', dataSource: 'Identity Provider Logs', completenessScore: 96, accuracyScore: 97, timelinessScore: 98, consistencyScore: 96, reliabilityRank: 1, lastUpdated: '2026-04-23T09:00:00Z', issues: [], trend: 'stable'},
    {id: 'dq-attack-patterns-006', dataSource: 'Cloud Security Posture Data', completenessScore: 79, accuracyScore: 85, timelinessScore: 82, consistencyScore: 81, reliabilityRank: 5, lastUpdated: '2026-04-23T05:00:00Z', issues: ['Multi-cloud coverage gaps', 'API rate limiting affects scan frequency'], trend: 'declining'},
    {id: 'dq-attack-patterns-007', dataSource: 'Compliance Evidence Store', completenessScore: 88, accuracyScore: 86, timelinessScore: 80, consistencyScore: 83, reliabilityRank: 4, lastUpdated: '2026-04-21T14:00:00Z', issues: ['Manual evidence collection delays', 'Inconsistent formatting across frameworks'], trend: 'stable'},
    {id: 'dq-attack-patterns-008', dataSource: 'Network Flow Data', completenessScore: 92, accuracyScore: 90, timelinessScore: 94, consistencyScore: 91, reliabilityRank: 2, lastUpdated: '2026-04-23T08:30:00Z', issues: ['Encrypted traffic classification accuracy needs improvement'], trend: 'improving'},
  ];
  ...
  @state() private _workflowTemplates: Array<{id: string; name: string; description: string; category: string; steps: number; avgDuration: string; successRate: number; lastRun: string; manualInterventions: number; optimizationScore: number}> = [
    {id: 'wf-attack-patterns-001', name: 'Vulnerability Triage Pipeline', description: 'Automated vulnerability assessment, prioritization, and assignment workflow', category: 'Vulnerability Management', steps: 8, avgDuration: '12 min', successRate: 94.5, lastRun: '2026-04-23T06:00:00Z', manualInterventions: 2, optimizationScore: 87},
    {id: 'wf-attack-patterns-002', name: 'Incident Response Orchestration', description: 'End-to-end IR workflow from detection to containment and recovery', category: 'Incident Response', steps: 15, avgDuration: '45 min', successRate: 89.2, lastRun: '2026-04-22T14:30:00Z', manualInterventions: 5, optimizationScore: 72},
    {id: 'wf-attack-patterns-003', name: 'Access Request Approval Chain', description: 'Multi-level approval workflow for privileged access requests', category: 'Identity & Access', steps: 6, avgDuration: '4 hours', successRate: 97.1, lastRun: '2026-04-23T09:15:00Z', manualInterventions: 1, optimizationScore: 92},
    {id: 'wf-attack-patterns-004', name: 'Compliance Evidence Collection', description: 'Automated gathering and packaging of audit evidence artifacts', category: 'Compliance', steps: 10, avgDuration: '30 min', successRate: 91.8, lastRun: '2026-04-21T10:00:00Z', manualInterventions: 3, optimizationScore: 78},
    {id: 'wf-attack-patterns-005', name: 'Security Patch Deployment', description: 'Staged patch rollout with validation and rollback capability', category: 'Patch Management', steps: 12, avgDuration: '2 hours', successRate: 96.3, lastRun: '2026-04-20T22:00:00Z', manualInterventions: 1, optimizationScore: 85},
    {id: 'wf-attack-patterns-006', name: 'Threat Intelligence Enrichment', description: 'IOC enrichment and correlation with internal threat data', category: 'Threat Intelligence', steps: 7, avgDuration: '8 min', successRate: 93.7, lastRun: '2026-04-23T07:00:00Z', manualInterventions: 0, optimizationScore: 95},
    {id: 'wf-attack-patterns-007', name: 'Security Reporting Pipeline', description: 'Automated generation and distribution of security metrics reports', category: 'Reporting', steps: 5, avgDuration: '15 min', successRate: 98.9, lastRun: '2026-04-23T08:00:00Z', manualInterventions: 0, optimizationScore: 97},
    {id: 'wf-attack-patterns-008', name: 'Vendor Risk Assessment', description: 'Automated vendor security questionnaire distribution and scoring', category: 'Third Party', steps: 9, avgDuration: '3 days', successRate: 85.4, lastRun: '2026-04-19T11:00:00Z', manualInterventions: 4, optimizationScore: 65},
  ];
  ...
  @state() private _workflowExecutionHistory: Array<{workflowId: string; runDate: string; duration: string; status: string; trigger: string}> = [
    {workflowId: 'wf-attack-patterns-001', runDate: '2026-04-23T06:00:00Z', duration: '11 min 23 sec', status: 'Success', trigger: 'Scheduled'},
    {workflowId: 'wf-attack-patterns-002', runDate: '2026-04-22T14:30:00Z', duration: '42 min 15 sec', status: 'Success', trigger: 'Alert'},
    {workflowId: 'wf-attack-patterns-003', runDate: '2026-04-23T09:15:00Z', duration: '3h 45 min', status: 'Success', trigger: 'User Request'},
    {workflowId: 'wf-attack-patterns-001', runDate: '2026-04-22T06:00:00Z', duration: '13 min 08 sec', status: 'Partial', trigger: 'Scheduled'},
    {workflowId: 'wf-attack-patterns-004', runDate: '2026-04-21T10:00:00Z', duration: '28 min 42 sec', status: 'Success', trigger: 'Scheduled'},
  ];
  ...
  @state() private _knowledgeArticles: Array<{id: string; title: string; category: string; author: string; publishDate: string; views: number; rating: number; tags: string[]; summary: string; readTime: string}> = [
    {id: 'kb-attack-patterns-001', title: 'Zero Trust Architecture Implementation Guide', category: 'Architecture', author: 'Security Architecture Team', publishDate: '2026-03-15', views: 1842, rating: 4.8, tags: ['zero-trust', 'network', 'identity'], summary: 'Comprehensive guide for implementing zero trust principles across enterprise infrastructure', readTime: '15 min'},
    {id: 'kb-attack-patterns-002', title: 'Ransomware Defense Playbook 2026', category: 'Threats', author: 'Threat Intelligence Team', publishDate: '2026-04-01', views: 2341, rating: 4.9, tags: ['ransomware', 'incident-response', 'defense'], summary: 'Updated playbook with latest ransomware tactics, techniques, and defensive measures', readTime: '12 min'},
    {id: 'kb-attack-patterns-003', title: 'Cloud Security Best Practices for Multi-Cloud', category: 'Cloud', author: 'Cloud Security Team', publishDate: '2026-02-28', views: 1567, rating: 4.5, tags: ['cloud', 'aws', 'azure', 'gcp'], summary: 'Best practices for securing workloads across multiple cloud service providers', readTime: '18 min'},
    {id: 'kb-attack-patterns-004', title: 'API Security Testing Methodology', category: 'Testing', author: 'Red Team', publishDate: '2026-03-22', views: 987, rating: 4.6, tags: ['api', 'testing', 'owasp'], summary: 'Structured methodology for identifying and testing API security vulnerabilities', readTime: '10 min'},
    {id: 'kb-attack-patterns-005', title: 'Supply Chain Security Risk Management', category: 'Third Party', author: 'GRC Team', publishDate: '2026-01-20', views: 1234, rating: 4.3, tags: ['supply-chain', 'vendor', 'risk'], summary: 'Framework for managing security risks in the software supply chain', readTime: '14 min'},
    {id: 'kb-attack-patterns-006', title: 'Kubernetes Security Hardening Checklist', category: 'Container', author: 'Platform Security', publishDate: '2026-04-10', views: 2103, rating: 4.7, tags: ['kubernetes', 'container', 'hardening'], summary: 'Step-by-step hardening checklist for production Kubernetes clusters', readTime: '11 min'},
    {id: 'kb-attack-patterns-007', title: 'Security Metrics That Matter for Executives', category: 'Metrics', author: 'CISO Office', publishDate: '2026-03-05', views: 876, rating: 4.4, tags: ['metrics', 'kpi', 'reporting'], summary: 'Key security metrics and KPIs that resonate with board-level stakeholders', readTime: '8 min'},
    {id: 'kb-attack-patterns-008', title: 'Phishing Simulation Campaign Design', category: 'Awareness', author: 'Security Awareness Team', publishDate: '2026-02-15', views: 1456, rating: 4.5, tags: ['phishing', 'simulation', 'training'], summary: 'Designing effective phishing simulations that drive real behavioral change', readTime: '9 min'},
    {id: 'kb-attack-patterns-009', title: 'Data Loss Prevention Strategy and Implementation', category: 'Data Protection', author: 'Data Security Team', publishDate: '2026-03-28', views: 1678, rating: 4.6, tags: ['dlp', 'data-protection', 'compliance'], summary: 'Strategic approach to DLP covering people, process, and technology layers', readTime: '16 min'},
    {id: 'kb-attack-patterns-010', title: 'Security Automation with SOAR Platforms', category: 'Automation', author: 'SOC Engineering', publishDate: '2026-04-05', views: 1098, rating: 4.7, tags: ['soar', 'automation', 'soc'], summary: 'Building effective security automation playbooks using SOAR technology', readTime: '13 min'},
    {id: 'kb-attack-patterns-011', title: 'Third-Party Risk Assessment Framework', category: 'GRC', author: 'Vendor Management', publishDate: '2026-01-30', views: 1345, rating: 4.4, tags: ['vendor', 'risk', 'assessment'], summary: 'Structured framework for evaluating and monitoring third-party security risks', readTime: '12 min'},
    {id: 'kb-attack-patterns-012', title: 'Network Detection and Response Best Practices', category: 'Network', author: 'Network Security Team', publishDate: '2026-03-18', views: 1567, rating: 4.5, tags: ['ndr', 'network', 'detection'], summary: 'Implementing effective network detection and response capabilities', readTime: '14 min'},
    {id: 'kb-attack-patterns-013', title: 'Security Chaos Engineering Guide', category: 'Resilience', author: 'SRE Security', publishDate: '2026-04-12', views: 789, rating: 4.3, tags: ['chaos-engineering', 'resilience', 'testing'], summary: 'Applying chaos engineering principles to validate security controls', readTime: '10 min'},
    {id: 'kb-attack-patterns-014', title: 'Incident Communication Templates', category: 'Incident Response', author: 'IR Team', publishDate: '2026-02-22', views: 2234, rating: 4.8, tags: ['incident', 'communication', 'templates'], summary: 'Ready-to-use communication templates for security incident scenarios', readTime: '7 min'},
    {id: 'kb-attack-patterns-015', title: 'Endpoint Detection and Response Configuration', category: 'Endpoint', author: 'Endpoint Security', publishDate: '2026-03-08', views: 1345, rating: 4.5, tags: ['edr', 'endpoint', 'configuration'], summary: 'Optimal EDR configuration for maximum detection with minimal false positives', readTime: '11 min'},
    {id: 'kb-attack-patterns-016', title: 'Security Code Review Standards', category: 'Development', author: 'AppSec Team', publishDate: '2026-02-10', views: 1890, rating: 4.6, tags: ['code-review', 'secure-sdlc', 'standards'], summary: 'Standards and checklists for security-focused code reviews', readTime: '13 min'},
    {id: 'kb-attack-patterns-017', title: 'IoT Security Assessment Methodology', category: 'IoT', author: 'IoT Security Lab', publishDate: '2026-04-08', views: 654, rating: 4.2, tags: ['iot', 'embedded', 'assessment'], summary: 'Methodology for assessing security posture of IoT devices and ecosystems', readTime: '15 min'},
    {id: 'kb-attack-patterns-018', title: 'Passwordless Authentication Migration Guide', category: 'Identity', author: 'IAM Team', publishDate: '2026-03-25', views: 1678, rating: 4.7, tags: ['passwordless', 'authentication', 'mfa'], summary: 'Step-by-step migration plan from password-based to passwordless authentication', readTime: '12 min'},
    {id: 'kb-attack-patterns-019', title: 'Security Awareness Program Metrics', category: 'Awareness', author: 'Security Culture Team', publishDate: '2026-01-25', views: 1123, rating: 4.4, tags: ['awareness', 'metrics', 'culture'], summary: 'Measuring the effectiveness of your security awareness and training programs', readTime: '9 min'},
    {id: 'kb-attack-patterns-020', title: 'Deception Technology Deployment Guide', category: 'Detection', author: 'Blue Team', publishDate: '2026-04-15', views: 876, rating: 4.5, tags: ['deception', 'honeypot', 'detection'], summary: 'Planning and deploying deception technology for advanced threat detection', readTime: '11 min'},
  ];
  ...
  // --- Security Scenario Planning Methods (ATPA) ---
  private _initAtpaScenarios(): void {
    const worstCaseScenarios = [
      { id: "atpa-sc-01", name: "Ransomware Attack on Critical Infrastructure", category: "Malware", impact: 9500000, probability: 0.12, recoveryDays: 21, affectedSystems: 47, dataLossGb: 320, businessImpact: "critical" },
      { id: "atpa-sc-02", name: "Insider Data Exfiltration via Authorized Channels", category: "Insider Threat", impact: 7200000, probability: 0.18, recoveryDays: 14, affectedSystems: 12, dataLossGb: 85, businessImpact: "high" },
      { id: "atpa-sc-03", name: "Supply Chain Compromise via Third-Party Library", category: "Supply Chain", impact: 6800000, probability: 0.09, recoveryDays: 30, affectedSystems: 63, dataLossGb: 0, businessImpact: "critical" },
      { id: "atpa-sc-04", name: "Cloud Misconfiguration Leading to Public Exposure", category: "Cloud", impact: 4100000, probability: 0.22, recoveryDays: 7, affectedSystems: 8, dataLossGb: 450, businessImpact: "high" },
      { id: "atpa-sc-05", name: "Zero-Day Exploit in Core Application Framework", category: "Vulnerability", impact: 8900000, probability: 0.05, recoveryDays: 45, affectedSystems: 120, dataLossGb: 0, businessImpact: "critical" },
      { id: "atpa-sc-06", name: "Distributed Denial of Service on Customer-Facing Services", category: "Availability", impact: 3400000, probability: 0.25, recoveryDays: 3, affectedSystems: 15, dataLossGb: 0, businessImpact: "medium" },
      { id: "atpa-sc-07", name: "Credential Stuffing and Account Takeover Wave", category: "Identity", impact: 2800000, probability: 0.30, recoveryDays: 5, affectedSystems: 6, dataLossGb: 12, businessImpact: "medium" },
      { id: "atpa-sc-08", name: "Physical Security Breach at Data Center Facility", category: "Physical", impact: 12000000, probability: 0.02, recoveryDays: 60, affectedSystems: 200, dataLossGb: 5000, businessImpact: "critical" },
    ];
    this._atpaScenarios = worstCaseScenarios.map(s => ({ ...s, mitigationCost: Math.round(s.impact * 0.08), drillScheduled: false, lastDrillDate: null, drillScore: null, controlGaps: Math.floor(Math.random() * 5) + 1 }));
  }

  private _calculateAtpaScenarioRisk(): void {
    this._atpaScenarios.forEach(s => {
  ...
  private _scheduleAtpaDrills(): void {
  ...
  private _atpaScenarioComparison(): Record<string, unknown>[] {
    return this._atpaScenarios.map(s => ({
  ...
  // --- Security Control Effectiveness Analytics (ATPA) ---
  private _initAtpaControls(): void {
    const controls = [
      { id: "atpa-ct-01", name: "Network Segmentation", type: "preventive", maturity: "defined", score: 82, target: 90, failures: 3, lastTest: "2026-03-15" },
      { id: "atpa-ct-02", name: "Endpoint Detection and Response", type: "detective", maturity: "managed", score: 88, target: 92, failures: 1, lastTest: "2026-04-01" },
      { id: "atpa-ct-03", name: "Data Loss Prevention", type: "preventive", maturity: "repeatable", score: 71, target: 85, failures: 7, lastTest: "2026-03-22" },
      { id: "atpa-ct-04", name: "Security Information and Event Management", type: "detective", maturity: "managed", score: 85, target: 90, failures: 2, lastTest: "2026-04-05" },
      { id: "atpa-ct-05", name: "Identity and Access Management", type: "preventive", maturity: "defined", score: 76, target: 88, failures: 5, lastTest: "2026-03-28" },
      { id: "atpa-ct-06", name: "Vulnerability Management", type: "corrective", maturity: "managed", score: 80, target: 90, failures: 4, lastTest: "2026-04-02" },
      { id: "atpa-ct-07", name: "Email Security Gateway", type: "preventive", maturity: "managed", score: 90, target: 95, failures: 1, lastTest: "2026-04-08" },
      { id: "atpa-ct-08", name: "Web Application Firewall", type: "preventive", maturity: "managed", score: 87, target: 92, failures: 2, lastTest: "2026-03-30" },
      { id: "atpa-ct-09", name: "Patch Management", type: "corrective", maturity: "defined", score: 68, target: 85, failures: 9, lastTest: "2026-03-18" },
      { id: "atpa-ct-10", name: "Encryption at Rest", type: "preventive", maturity: "managed", score: 93, target: 95, failures: 0, lastTest: "2026-04-10" },
      { id: "atpa-ct-11", name: "Encryption in Transit", type: "preventive", maturity: "optimized", score: 96, target: 98, failures: 0, lastTest: "2026-04-12" },
      { id: "atpa-ct-12", name: "Privileged Access Management", type: "preventive", maturity: "defined", score: 74, target: 88, failures: 6, lastTest: "2026-03-25" },
      { id: "atpa-ct-13", name: "Security Awareness Training", type: "preventive", maturity: "repeatable", score: 65, target: 80, failures: 11, lastTest: "2026-03-20" },
      { id: "atpa-ct-14", name: "Incident Response Plan", type: "corrective", maturity: "managed", score: 78, target: 88, failures: 4, lastTest: "2026-04-03" },
      { id: "atpa-ct-15", name: "Backup and Recovery", type: "corrective", maturity: "managed", score: 84, target: 92, failures: 3, lastTest: "2026-04-06" },
      { id: "atpa-ct-16", name: "Multi-Factor Authentication", type: "preventive", maturity: "managed", score: 91, target: 95, failures: 1, lastTest: "2026-04-09" },
      { id: "atpa-ct-17", name: "Network Traffic Analysis", type: "detective", maturity: "defined", score: 72, target: 85, failures: 5, lastTest: "2026-03-27" },
      { id: "atpa-ct-18", name: "Cloud Security Posture Management", type: "detective", maturity: "repeatable", score: 69, target: 82, failures: 8, lastTest: "2026-03-24" },
      { id: "atpa-ct-19", name: "Container Security Scanning", type: "preventive", maturity: "defined", score: 75, target: 85, failures: 5, lastTest: "2026-04-04" },
      { id: "atpa-ct-20", name: "API Security Gateway", type: "preventive", maturity: "repeatable", score: 70, target: 82, failures: 7, lastTest: "2026-03-29" },
      { id: "atpa-ct-21", name: "Threat Intelligence Platform", type: "detective", maturity: "managed", score: 83, target: 90, failures: 2, lastTest: "2026-04-07" },
      { id: "atpa-ct-22", name: "Database Activity Monitoring", type: "detective", maturity: "defined", score: 67, target: 80, failures: 8, lastTest: "2026-03-21" },
      { id: "atpa-ct-23", name: "Deception Technology", type: "detective", maturity: "initial", score: 55, target: 75, failures: 12, lastTest: "2026-03-16" },
      { id: "atpa-ct-24", name: "Security Orchestration Automation", type: "corrective", maturity: "repeatable", score: 73, target: 85, failures: 6, lastTest: "2026-04-01" },
      { id: "atpa-ct-25", name: "Third-Party Risk Assessment", type: "preventive", maturity: "defined", score: 64, target: 78, failures: 9, lastTest: "2026-03-19" },
    ];
    this._atpaControls = controls;
  }

  private _analyzeAtpaControlEffectiveness(): void {
    const typeBreakdown: Record<string, { total: number; avgScore: number; avgFailures: number }> = {};
    this._atpaControls.forEach(c => {
    ...
    this._atpaControlTypeBreakdown = typeBreakdown;
  }

  private _atpaControlOptimization(): Record<string, unknown>[] {
    return this._atpaControls.filter(c => c.score < c.target).map(c => ({
  ...
  // --- Security Data Pipeline Health (ATPA) ---
  private _initAtpaPipelines(): void {
    const pipelines = [
      { id: "atpa-pl-01", name: "SIEM Log Ingestion", status: "healthy", healthScore: 94, latencyMs: 120, freshnessMin: 2, errorRate: 0.02, throughputMbps: 450, recordsPerSec: 12000, backPressure: 0.05, uptime: 99.97 },
      { id: "atpa-pl-02", name: "Threat Feed Aggregation", status: "healthy", healthScore: 91, latencyMs: 300, freshnessMin: 15, errorRate: 0.05, throughputMbps: 85, recordsPerSec: 3200, backPressure: 0.08, uptime: 99.92 },
      { id: "atpa-pl-03", name: "Vulnerability Scan Results", status: "degraded", healthScore: 72, latencyMs: 2500, freshnessMin: 60, errorRate: 0.15, throughputMbps: 25, recordsPerSec: 800, backPressure: 0.35, uptime: 98.50 },
      { id: "atpa-pl-04", name: "Endpoint Telemetry Stream", status: "healthy", healthScore: 88, latencyMs: 450, freshnessMin: 5, errorRate: 0.08, throughputMbps: 280, recordsPerSec: 8500, backPressure: 0.12, uptime: 99.85 },
      { id: "atpa-pl-05", name: "Cloud Audit Log Pipeline", status: "healthy", healthScore: 86, latencyMs: 600, freshnessMin: 10, errorRate: 0.06, throughputMbps: 150, recordsPerSec: 4500, backPressure: 0.10, uptime: 99.80 },
      { id: "atpa-pl-06", name: "Identity Event Stream", status: "warning", healthScore: 78, latencyMs: 1200, freshnessMin: 20, errorRate: 0.12, throughputMbps: 45, recordsPerSec: 1500, backPressure: 0.22, uptime: 99.40 },
      { id: "atpa-pl-07", name: "Network Flow Collection", status: "healthy", healthScore: 82, latencyMs: 800, freshnessMin: 8, errorRate: 0.09, throughputMbps: 650, recordsPerSec: 18000, backPressure: 0.15, uptime: 99.70 },
      { id: "atpa-pl-08", name: "DLP Incident Pipeline", status: "degraded", healthScore: 68, latencyMs: 3500, freshnessMin: 45, errorRate: 0.20, throughputMbps: 18, recordsPerSec: 500, backPressure: 0.42, uptime: 97.80 },
    ];
    this._atpaPipelines = pipelines.map(p => ({ ...p, dependencies: [], slaBreached: p.healthScore < 75, alertThreshold: p.errorRate > 0.15 }));
    this._atpaPipelines[0].dependencies = ["atpa-pl-04", "atpa-pl-07"];
    this._atpaPipelines[4].dependencies = ["atpa-pl-01"];
    this._atpaPipelines[5].dependencies = ["atpa-pl-02"];
    this._atpaPipelines[7].dependencies = ["atpa-pl-04", "atpa-pl-05"];
  }

  private _atpaPipelineTrend(): Record<string, unknown>[] {
    const hours = Array.from({ length: 24 }, (_, i) => `H${String(i).padStart(2, "0")}`);
    return this._atpaPipelines.map(p => ({
  ...
  // --- Security Stakeholder Report Generator (ATPA) ---
  private _initAtpaReportTemplates(): void {
    this._atpaReportTemplates = [
      { id: "atpa-rp-01", name: "Board Security Report", audience: "board", frequency: "quarterly", sections: 6, autoGenerate: true, lastGenerated: "2026-03-31", pages: 12 },
      { id: "atpa-rp-02", name: "Executive Risk Summary", audience: "executive", frequency: "monthly", sections: 8, autoGenerate: true, lastGenerated: "2026-04-01", pages: 8 },
      { id: "atpa-rp-03", name: "Technical Security Review", audience: "technical", frequency: "weekly", sections: 12, autoGenerate: true, lastGenerated: "2026-04-21", pages: 25 },
      { id: "atpa-rp-04", name: "Audit Compliance Report", audience: "audit", frequency: "quarterly", sections: 10, autoGenerate: false, lastGenerated: "2026-03-15", pages: 35 },
      { id: "atpa-rp-05", name: "Regulatory Filing Package", audience: "regulatory", frequency: "annual", sections: 15, autoGenerate: false, lastGenerated: "2025-12-31", pages: 48 },
    ];
  }

  private _generateAtpaExecSummary(): string {
    const totalRisk = this._atpaScenarios.reduce((sum: number, s: any) => sum + s.riskScore, 0);
    const avgControl = Math.round(this._atpaControls.reduce((sum: number, c: any) => sum + c.score, 0) / this._atpaControls.length);
    const degradedPipes = this._atpaPipelines.filter((p: any) => p.status !== "healthy").length;
    return `Overall risk exposure: ${(totalRisk / 1000000).toFixed(1)}M. Average control effectiveness: {avgControl}%. {degradedPipes} pipeline(s) need attention. {this._atpaScenarios.filter((s: any) => s.mitigationPriority === "immediate").length} scenarios require immediate action.`;
  }

  // --- Security Technology Radar (ATPA) ---
  private _initAtpaTechRadar(): void {
    this._atpaTechRadar = [
      { id: "atpa-tr-01", name: "AI-Powered Threat Detection", ring: "adopt", category: "Detection", maturity: 4, trend: "up", investment: "high", roi: 3.2, vendorCount: 8 },
      { id: "atpa-tr-02", name: "Zero Trust Architecture", ring: "adopt", category: "Architecture", maturity: 4, trend: "up", investment: "high", roi: 2.8, vendorCount: 12 },
      { id: "atpa-tr-03", name: "SASE/SSE Platform", ring: "trial", category: "Network", maturity: 3, trend: "up", investment: "medium", roi: 2.4, vendorCount: 10 },
      { id: "atpa-tr-04", name: "CNAPP Cloud Security", ring: "trial", category: "Cloud", maturity: 3, trend: "up", investment: "medium", roi: 2.1, vendorCount: 7 },
      { id: "atpa-tr-05", name: "Extended Detection and Response", ring: "adopt", category: "Detection", maturity: 4, trend: "stable", investment: "high", roi: 2.9, vendorCount: 9 },
      { id: "atpa-tr-06", name: "Quantum-Safe Cryptography", ring: "assess", category: "Crypto", maturity: 2, trend: "up", investment: "low", roi: 0.8, vendorCount: 4 },
      { id: "atpa-tr-07", name: "Security Service Edge", ring: "trial", category: "Network", maturity: 3, trend: "up", investment: "medium", roi: 2.0, vendorCount: 6 },
      { id: "atpa-tr-08", name: "SOAR 2.0 Autonomous SOC", ring: "assess", category: "Operations", maturity: 2, trend: "up", investment: "low", roi: 1.2, vendorCount: 5 },
      { id: "atpa-tr-09", name: "Software Supply Chain Security", ring: "trial", category: "DevSecOps", maturity: 3, trend: "up", investment: "medium", roi: 2.3, vendorCount: 8 },
      { id: "atpa-tr-10", name: "Identity Threat Detection", ring: "adopt", category: "Identity", maturity: 3, trend: "up", investment: "high", roi: 2.7, vendorCount: 7 },
      { id: "atpa-tr-11", name: "Data Security Posture Management", ring: "trial", category: "Data", maturity: 3, trend: "up", investment: "medium", roi: 2.2, vendorCount: 9 },
      { id: "atpa-tr-12", name: "Decentralized Identity Standards", ring: "hold", category: "Identity", maturity: 1, trend: "stable", investment: "low", roi: 0.5, vendorCount: 3 },
    ];
  }

  private _atpaRadarSummary(): Record<string, unknown> {
    const rings: Record<string, number> = { adopt: 0, trial: 0, assess: 0, hold: 0 };
    this._atpaTechRadar.forEach(t => { if (rings[t.ring as keyof typeof rings] !== undefined) rings[t.ring as keyof typeof rings]++; });
    return { adopt: rings.adopt, trial: rings.trial, assess: rings.assess, hold: rings.hold, total: this._atpaTechRadar.length, avgMaturity: 2.8, topInvestment: this._atpaTechRadar.filter(t => t.investment === "high").map(t => t.name) };
  }

  // --- ATPA Security Compliance Mapping Matrix ---
  private _initAtpaComplianceMatrix(): void {
    ...
    this._atpaComplianceMatrix = frameworks.map(fw => ({
  ...
  private _atpaComplianceTrend(): Record<string, unknown>[] {
    const quarters = ["Q1-2025", "Q2-2025", "Q3-2025", "Q4-2025", "Q1-2026", "Q2-2026"];
    return this._atpaComplianceMatrix.map(fw => ({
  ...
  // --- ATPA Threat Intelligence Correlation Engine ---
  private _initAtpaThreatIntel(): void {
    ...
    this._atpaThreatIntel = threatActors.map((actor, i) => ({
  ...
  private _atpaThreatCorrelation(): Record<string, unknown>[] {
    return this._atpaThreatIntel.filter(t => t.riskScore > 70).map(t => ({
  ...
  // --- ATPA Security Metrics Deep Dive ---
  private _initAtpaMetricsDeep(): void {
    ...
    this._atpaMetricsDeep = metricCategories.map(cat => ({
  ...
  private _atpaMetricsHeatmap(): number[][] {
    return this._atpaMetricsDeep.map(cat =>
      cat.metrics.map(m => Math.round((m.value / m.target) * 100))
    );
  }

  // --- ATPA Incident Cost Modeling ---
  private _initAtpaCostModel(): void {
    const incidentTypes = ["Data Breach", "Ransomware", "DDoS", "Insider Threat", "Phishing", "Supply Chain", "Cloud Misconfig", "Zero-Day"];
    this._atpaCostModel = incidentTypes.map(inc => ({
    ...
    this._atpaCostModel.forEach(m => { m.totalAnnualExposure = m.avgCost * m.frequency; });
  }

  private _atpaCostProjection(): Record<string, unknown>[] {
    return this._atpaCostModel.map(m => ({
  ...
  // --- ATPA Security Architecture Pattern Library ---
  private _initAtpaArchPatterns(): void {
    ...
    this._atpaArchPatterns = patterns.map((p, i) => ({
  ...
  private _atpaArchPatternAnalysis(): Record<string, unknown> {
    const implemented = this._atpaArchPatterns.filter(p => p.implementation > 75).length;
    const avgCoverage = Math.round(this._atpaArchPatterns.reduce((s: number, p: any) => s + p.coverage, 0) / this._atpaArchPatterns.length);
    return {
      totalPatterns: this._atpaArchPatterns.length, fullyImplemented: implemented, avgCoverage,
      avgRiskReduction: Math.round(this._atpaArchPatterns.reduce((s: number, p: any) => s + p.riskReduction, 0) / this._atpaArchPatterns.length),
      gaps: this._atpaArchPatterns.filter(p => p.implementation < 60).map(p => p.pattern),
      recommendations: this._atpaArchPatterns.filter(p => p.implementation < 70).map(p => ({ pattern: p.pattern, current: p.implementation, target: 85, effort: p.costComplexity }))
    };
  }
  ...
  private _d2fRiskAssessmentWorkflow = [
  ...
  private _d2fTreatmentOptions = [
    {id: 'd2f-T-001', riskId: 'RSK-042', risk: 'Ransomware Attack on Critical Infrastructure', before: 20, after: 6, strategy: 'Mitigate', controls: ['Next-gen EDR with behavioral detection and automated response', 'Zero-trust network micro-segmentation isolating critical assets', 'Immutable offline backup rotation with quarterly recovery testing', 'Incident response retainer with 1-hour response SLA'], cost: '$450K/yr', roi: '78% reduction vs $2.8M potential loss', timeline: 'Q3 2026', status: 'approved' as const},
  ...
  private _d2fTalentPositions = [
    ...
    {id: 'd2f-H-002', title: 'Cloud Security Engineer', dept: 'Cloud Security', level: 'Mid-Senior', loc: 'SF/Remote', salary: '$155K-$180K', posted: '2026-03-20', applicants: 45, pipeline: 12, interviews: 6, offers: 2, urgency: 'high' as const, manager: 'Mike Johnson', skills: ['AWS/Azure/GCP', 'Terraform', 'Kubernetes', 'IAM', 'CSPM'], nice: ['CCSP', 'CKS', 'Serverless']},
    {id: 'd2f-H-003', title: 'SOC Analyst L2', dept: 'Security Operations', level: 'Mid', loc: 'Austin TX', salary: '$105K-$130K', posted: '2026-04-01', applicants: 67, pipeline: 18, interviews: 8, offers: 0, urgency: 'medium' as const, manager: 'Lisa Park', skills: ['SIEM', 'Incident triage', 'Malware analysis', 'TCP/IP'], nice: ['GCIA', 'SOAR', 'Kill chain']},
    {id: 'd2f-H-004', title: 'Staff Security Architect', dept: 'Architecture', level: 'Staff', loc: 'Remote US', salary: '$200K-$240K', posted: '2026-02-28', applicants: 12, pipeline: 3, interviews: 2, offers: 0, urgency: 'critical' as const, manager: 'David Lee', skills: ['Enterprise arch', 'Zero trust', 'Risk frameworks', 'Board comms'], nice: ['CISSP+SABSA', 'Team building', 'Speaker']},
    {id: 'd2f-H-005', title: 'GRC Analyst', dept: 'GRC', level: 'Mid', loc: 'NY/Remote', salary: '$110K-$135K', posted: '2026-04-05', applicants: 34, pipeline: 9, interviews: 3, offers: 1, urgency: 'medium' as const, manager: 'Rachel Green', skills: ['ISO 27001', 'SOC 2', 'Risk assessment', 'Audit'], nice: ['CRISC', 'CISA', 'GDPR']},
    {id: 'd2f-H-006', title: 'Threat Intel Analyst', dept: 'Threat Intel', level: 'Mid-Senior', loc: 'Remote US', salary: '$140K-$170K', posted: '2026-03-25', applicants: 19, pipeline: 5, interviews: 2, offers: 0, urgency: 'low' as const, manager: 'James Wilson', skills: ['MITRE ATT&CK', 'OSINT', 'Threat modeling', 'Reverse eng'], nice: ['CTIA', 'Nation-state', 'Dark web']},
    {id: 'd2f-H-007', title: 'AppSec Engineer', dept: 'AppSec', level: 'Senior', loc: 'Seattle/Remote', salary: '$160K-$190K', posted: '2026-04-10', applicants: 28, pipeline: 7, interviews: 3, offers: 0, urgency: 'medium' as const, manager: 'Emily Zhang', skills: ['SAST/DAST/SCA', 'Secure SDLC', 'Code review', 'CI/CD'], nice: ['CSSLP', 'Mobile security']},
    {id: 'd2f-H-008', title: 'IAM Engineer', dept: 'IAM', level: 'Mid', loc: 'Remote US', salary: '$135K-$160K', posted: '2026-04-08', applicants: 31, pipeline: 10, interviews: 5, offers: 1, urgency: 'medium' as const, manager: 'Chris Martinez', skills: ['Okta/Azure AD', 'SAML/OIDC', 'PAM', 'RBAC'], nice: ['CISSP', 'Zero trust IAM']}
  ];

  private _d2fInterviewScorecard = [
  ...
  private _d2fOnboardingSteps = [
    {id: 'd2f-OB-01', item: 'Provision security-hardened laptop, monitors, peripherals, and configured workstation image with all required security tools', cat: 'IT Setup', day: 'Day 1', owner: 'IT Operations'},
    {id: 'd2f-OB-02', item: 'Create AD account, email, Slack, VPN, SSO enrollment, and all required application access accounts', cat: 'Access', day: 'Day 1', owner: 'IAM Team'},
    {id: 'd2f-OB-03', item: 'Grant security tooling access: SIEM console, EDR dashboard, vuln scanner, pentest platforms, SOAR', cat: 'Tools', day: 'Day 1-2', owner: 'SOC Manager'},
    {id: 'd2f-OB-04', item: 'Complete MFA enrollment, security awareness onboarding course, and acceptable use policy acknowledgment', cat: 'Security', day: 'Day 1', owner: 'Awareness Team'},
    {id: 'd2f-OB-05', item: 'Sign NDA, employment agreement, IP assignment, and code of conduct documents with HR', cat: 'HR', day: 'Day 1', owner: 'Human Resources'},
    {id: 'd2f-OB-06', item: 'Introduction meetings with direct team members and key cross-functional stakeholders', cat: 'Integration', day: 'Week 1', owner: 'Hiring Manager'},
    {id: 'd2f-OB-07', item: 'Security architecture overview, tooling walkthrough, and operational runbook review sessions', cat: 'Training', day: 'Week 1-2', owner: 'Security Architect'},
    {id: 'd2f-OB-08', item: 'Shadow experienced team member on active incident response and threat hunting investigations', cat: 'Mentoring', day: 'Week 2-3', owner: 'SOC Lead'},
    {id: 'd2f-OB-09', item: 'Set up individual certification study plan aligned with role requirements and career goals', cat: 'Development', day: 'Week 2', owner: 'Hiring Manager'},
    {id: 'd2f-OB-10', item: 'Establish 30-60-90 day goals, define success metrics, and schedule first performance checkpoint', cat: 'Goals', day: 'Week 1', owner: 'Hiring Manager'}
  ];

  private _d2fMetricsDashboard = [
    {id: 'd2f-MTD-001', name: 'Mean Time to Detect (MTTD)', value: '4.2 hours', trend: 'improving' as const, target: '< 4 hours', source: 'SIEM - Splunk', method: 'Median time from first alert to analyst acknowledgment', owner: 'SOC Manager', sla: '4 hours', prev: '5.1 hours', spark: [5.8, 5.4, 5.1, 4.9, 4.7, 4.5, 4.3, 4.2], breakdown: [{src: 'Network IDS', pct: '35%', avg: '3.8h'}, {src: 'Endpoint EDR', pct: '28%', avg: '4.1h'}, {src: 'Email Gateway', pct: '22%', avg: '3.5h'}, {src: 'Cloud Security', pct: '10%', avg: '5.2h'}, {src: 'User Reports', pct: '5%', avg: '6.8h'}]},
    {id: 'd2f-MTD-002', name: 'Mean Time to Respond (MTTR)', value: '2.8 hours', trend: 'stable' as const, target: '< 3 hours', source: 'SOAR - XSOAR', method: 'Median time from acknowledgment to first containment action', owner: 'IR Lead', sla: '3 hours', prev: '2.7 hours', spark: [3.2, 3.0, 2.9, 2.8, 2.8, 2.9, 2.8, 2.8], breakdown: [{src: 'Auto Playbooks', pct: '42%', avg: '1.2h'}, {src: 'Semi-Auto', pct: '33%', avg: '2.5h'}, {src: 'Manual', pct: '20%', avg: '5.1h'}, {src: 'L3 Escalation', pct: '5%', avg: '8.3h'}]},
    {id: 'd2f-MTD-003', name: 'Patch Compliance Rate', value: '97.6%', trend: 'improving' as const, target: '> 95%', source: 'Tenable.io', method: 'Pct of critical/high vulns patched within SLA windows', owner: 'Vuln Manager', sla: '95%', prev: '96.1%', spark: [93.2, 94.1, 94.8, 95.3, 95.9, 96.4, 97.0, 97.6], breakdown: [{src: 'Critical (7d)', pct: '40%', rate: '99.2%'}, {src: 'High (30d)', pct: '35%', rate: '97.8%'}, {src: 'Medium (90d)', pct: '20%', rate: '95.1%'}, {src: 'Low (180d)', pct: '5%', rate: '89.4%'}]},
    {id: 'd2f-MTD-004', name: 'Phishing Click Rate', value: '3.2%', trend: 'improving' as const, target: '< 5%', source: 'KnowBe4 + Proofpoint', method: 'Pct of users clicking simulated phishing links monthly', owner: 'Awareness Lead', sla: '5%', prev: '4.1%', spark: [6.8, 6.2, 5.5, 5.1, 4.6, 4.1, 3.6, 3.2], breakdown: [{src: 'Spear Phishing', pct: '35%', rate: '5.1%'}, {src: 'Generic Phishing', pct: '30%', rate: '2.8%'}, {src: 'BEC Sim', pct: '20%', rate: '3.5%'}, {src: 'SMS Phishing', pct: '15%', rate: '1.9%'}]},
    {id: 'd2f-MTD-005', name: 'Security Posture Score', value: '784', trend: 'improving' as const, target: '> 750', source: 'SecurityScorecard', method: 'Composite: external 30%, compliance 25%, vuln 25%, config 20%', owner: 'CISO', sla: '> 750', prev: '771', spark: [748, 752, 758, 762, 768, 773, 778, 784], breakdown: [{src: 'External Rating', pct: '30%', score: '791'}, {src: 'Compliance', pct: '25%', score: '812'}, {src: 'Vuln Mgmt', pct: '25%', score: '745'}, {src: 'Config', pct: '20%', score: '769'}]},
    {id: 'd2f-MTD-006', name: 'Vulnerability Backlog', value: '142', trend: 'improving' as const, target: '< 150', source: 'Tenable + Qualys', method: 'Total open vulns across all scanned assets tracked weekly', owner: 'Vuln Manager', sla: '< 150', prev: '168', spark: [210, 198, 185, 175, 165, 158, 150, 142], breakdown: [{src: 'Critical', pct: '8%', count: '11'}, {src: 'High', pct: '22%', count: '31'}, {src: 'Medium', pct: '45%', count: '64'}, {src: 'Low', pct: '25%', count: '36'}]}
  ];

  private _d2fArchReview = [
    {id: 'd2f-AR-001', cat: 'Network', item: 'Network segmentation between trust zones with dedicated firewalls and granular ACLs', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Micro-segmentation via NSX across all production zones'},
    {id: 'd2f-AR-002', cat: 'Network', item: 'DMZ architecture isolating public services from internal network', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Dual-firewall DMZ with WAF and DDoS mitigation'},
    {id: 'd2f-AR-003', cat: 'Network', item: 'Least-privilege traffic flows with deny-by-default and quarterly review', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Explicit allow rules with automated drift detection'},
    {id: 'd2f-AR-004', cat: 'Network', item: 'Encrypted external communications with IPSec/TLS 1.3 and PFS', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'IKEv2 with PFS, TLS 1.3 for all external APIs'},
    {id: 'd2f-AR-005', cat: 'Identity', item: 'Centralized IdP with SSO and automated SCIM provisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Okta SSO SAML 2.0 for 247 apps with SCIM'},
    {id: 'd2f-AR-006', cat: 'Identity', item: 'RBAC with quarterly reviews and automated deprovisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Quarterly recertification with JIT admin access'},
    {id: 'd2f-AR-007', cat: 'Identity', item: 'PAM controlling all admin and service accounts with session recording', sev: 'high' as const, status: 'fail' as const, reviewer: 'IAM Lead', notes: '3 legacy accounts pending CyberArk enrollment'},
    {id: 'd2f-AR-008', cat: 'Identity', item: 'MFA enforced for all users, hardware tokens for privileged access', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'FIDO2 for admins, push MFA for users, 99.8% enrollment'},
    {id: 'd2f-AR-009', cat: 'Data', item: 'Data classification enforced with automated labeling on all repos', sev: 'high' as const, status: 'partial' as const, reviewer: 'Data Protection Lead', notes: 'Framework deployed, gaps on 4 legacy file shares'},
    {id: 'd2f-AR-010', cat: 'Data', item: 'AES-256 encryption at rest for all sensitive data stores', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'Full-disk, TDE on DBs, SSE-KMS on cloud storage'},
    {id: 'd2f-AR-011', cat: 'Data', item: 'DLP monitoring and preventing unauthorized data exfiltration', sev: 'high' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'DLP active on email, endpoint, cloud, and network'},
    {id: 'd2f-AR-012', cat: 'Data', item: 'Encrypted off-site backups with quarterly restore testing', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Infrastructure Lead', notes: '3-2-1 strategy with immutable backups'},
    {id: 'd2f-AR-013', cat: 'AppSec', item: 'Secure SDLC with SAST, DAST, SCA in all CI/CD pipelines', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: '34 pipelines with security gates and PR blocking'},
    {id: 'd2f-AR-014', cat: 'AppSec', item: 'API gateway with auth, rate limiting, schema validation', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: 'Kong with OAuth2, rate limits, OpenAPI validation'},
    {id: 'd2f-AR-015', cat: 'AppSec', item: 'Container security with image scanning and runtime protection', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Trivy scanning, Falco runtime in 80% of clusters'},
    {id: 'd2f-AR-016', cat: 'Monitoring', item: 'SIEM collecting from all critical systems with correlation rules', sev: 'critical' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'Splunk 98% coverage with 1200+ correlation rules'},
    {id: 'd2f-AR-017', cat: 'Monitoring', item: 'EDR with behavioral detection on all managed endpoints', sev: 'high' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'CrowdStrike on 99.2% endpoints with 24/7 MDR'},
    {id: 'd2f-AR-018', cat: 'Monitoring', item: 'Executive dashboards with real-time posture visibility', sev: 'medium' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'PowerBI dashboards with weekly exec summaries'},
    {id: 'd2f-AR-019', cat: 'Cloud', item: 'CSPM monitoring and remediating cloud misconfigurations', sev: 'high' as const, status: 'pass' as const, reviewer: 'Cloud Security Lead', notes: 'Prisma Cloud 450+ checks with auto-remediation'},
    {id: 'd2f-AR-020', cat: 'Cloud', item: 'IaC templates scanned before deployment to production', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Checkov for Terraform, cfn-nag for CloudFormation pending'}
  ];

  private _getd2fRiskProgress(): number {
    return Math.round(this._d2fRiskAssessmentWorkflow.filter(s => s.status === 'completed').length / this._d2fRiskAssessmentWorkflow.length * 100);
  }

  private _getd2fTreatmentSummary(): {total: number; approved: number; avgReduction: number; investment: string} {
    const a = this._d2fTreatmentOptions.filter(r => r.status === 'approved').length;
    const avg = this._d2fTreatmentOptions.reduce((s, r) => s + ((r.before - r.after) / r.before * 100), 0) / this._d2fTreatmentOptions.length;
    return {total: this._d2fTreatmentOptions.length, approved: a, avgReduction: Math.round(avg), investment: '$1.125M annually'};
  }

  private _getd2fRuleSummary(): {total: number; passing: number; failing: number; avgRate: number; violations: number} {
    const p = this._d2fComplianceRules.filter(r => r.result === 'pass').length;
    const f = this._d2fComplianceRules.filter(r => r.result === 'fail').length;
    const avg = this._d2fComplianceRules.reduce((s, r) => s + r.passRate, 0) / this._d2fComplianceRules.length;
    const v = this._d2fComplianceRules.reduce((s, r) => s + r.violations, 0);
    return {total: this._d2fComplianceRules.length, passing: p, failing: f, avgRate: Math.round(avg * 10) / 10, violations: v};
  }

  private _getd2fPipelineStats(): {positions: number; applicants: number; interviewing: number; offers: number; critical: number} {
    const t = this._d2fTalentPositions.length;
    const a = this._d2fTalentPositions.reduce((s, p) => s + p.applicants, 0);
    const i = this._d2fTalentPositions.reduce((s, p) => s + p.interviews, 0);
    const o = this._d2fTalentPositions.reduce((s, p) => s + p.offers, 0);
    const c = this._d2fTalentPositions.filter(x => x.urgency === 'critical').length;
    return {positions: t, applicants: a, interviewing: i, offers: o, critical: c};
  }

  private _getd2fMetricTrends(): {improving: number; stable: number; total: number} {
    const imp = this._d2fMetricsDashboard.filter(m => m.trend === 'improving').length;
    const stb = this._d2fMetricsDashboard.filter(m => m.trend === 'stable').length;
    return {improving: imp, stable: stb, total: this._d2fMetricsDashboard.length};
  }

  private _getd2fArchScore(): {total: number; passed: number; failed: number; partial: number; score: number} {
    const p = this._d2fArchReview.filter(c => c.status === 'pass').length;
    const f = this._d2fArchReview.filter(c => c.status === 'fail').length;
    const pa = this._d2fArchReview.filter(c => c.status === 'partial').length;
    return {total: this._d2fArchReview.length, passed: p, failed: f, partial: pa, score: Math.round((p / this._d2fArchReview.length) * 100)};
  }


  private _zd2fIncidentScenarios = [
    {id: 'zd2f-IS-001', name: 'Ransomware Outbreak in Production Environment', category: 'Malware', likelihood: 'Medium', impact: 'Critical', riskScore: 15, playbooks: ['IR-Ransomware-Isolate', 'IR-Ransomware-Eradicate', 'IR-Ransomway-Recover'], estimatedMTTD: '15min', estimatedMTTR: '4h', involvedTeams: ['SOC', 'IR', 'Infrastructure', 'Legal', 'Comms'], keyIndicators: ['Mass file encryption events', 'Ransom note deployment', 'Lateral movement via SMB/RDP', 'Backup deletion attempts'], mitigationControls: ['EDR behavioral detection', 'Network segmentation', 'Immutable backups', 'Email filtering'], lessonsLearned: 'Ensure offline backups are tested quarterly and Ransomware-specific playbooks are updated with latest threat intelligence', lastDrillDate: '2026-03-15', nextDrillDate: '2026-06-15'},
    {id: 'zd2f-IS-002', name: 'Cloud Misconfiguration Leading to Data Exposure', category: 'Cloud', likelihood: 'High', impact: 'High', riskScore: 16, playbooks: ['IR-Cloud-Misconfig-Assess', 'IR-Cloud-Misconfig-Remediate', 'IR-Cloud-Misconfig-Notify'], estimatedMTTD: '2h', estimatedMTTR: '6h', involvedTeams: ['Cloud Security', 'SOC', 'Data Protection', 'Legal'], keyIndicators: ['Public S3 bucket exposure', 'Overly permissive IAM policies', 'Unencrypted database snapshots', 'Public API endpoint discovery'], mitigationControls: ['CSPM monitoring', 'IAM policy analyzer', 'Automated remediation', 'Cloud audit logging'], lessonsLearned: 'Implement CSPM with auto-remediation for common misconfigurations and conduct monthly cloud configuration reviews', lastDrillDate: '2026-02-20', nextDrillDate: '2026-05-20'},
    {id: 'zd2f-IS-003', name: 'Insider Threat Data Exfiltration', category: 'Insider', likelihood: 'Low', impact: 'Critical', riskScore: 12, playbooks: ['IR-Insider-Investigate', 'IR-Insider-Contain', 'IR-Insider-Escalate'], estimatedMTTD: '8h', estimatedMTTR: '24h', involvedTeams: ['SOC', 'IR', 'HR', 'Legal', 'IAM'], keyIndicators: ['Anomalous data access patterns', 'Large file downloads to USB or cloud', 'Off-hours access to sensitive systems', 'Accessing data outside normal job scope'], mitigationControls: ['UEBA analytics', 'DLP policies', 'PAM controls', 'Access reviews'], lessonsLearned: 'Strengthen UEBA baselines and implement automated alerts for data access pattern anomalies', lastDrillDate: '2026-01-10', nextDrillDate: '2026-04-10'},
    {id: 'zd2f-IS-004', name: 'Supply Chain Attack via Compromised Vendor Software', category: 'Supply Chain', likelihood: 'Low', impact: 'Critical', riskScore: 12, playbooks: ['IR-SupplyChain-Detect', 'IR-SupplyChain-Isolate', 'IR-SupplyChain-Remediate'], estimatedMTTD: '24h', estimatedMTTR: '72h', involvedTeams: ['SOC', 'IR', 'Procurement', 'Vendor Mgmt', 'Legal'], keyIndicators: ['Unexpected network connections from vendor software', 'Modified binaries or dependencies', 'Anomalous behavior from trusted applications', 'SBOM discrepancy alerts'], mitigationControls: ['SCA scanning', 'SBOM monitoring', 'Vendor security assessments', 'Network segmentation'], lessonsLearned: 'Require SBOM from all vendors and implement continuous monitoring of third-party component behavior', lastDrillDate: '2026-03-01', nextDrillDate: '2026-06-01'},
    {id: 'zd2f-IS-005', name: 'Credential Stuffing Attack on Customer Portal', category: 'External Attack', likelihood: 'High', impact: 'Medium', riskScore: 12, playbooks: ['IR-CredentialStuffing-Detect', 'IR-CredentialStuffing-Block', 'IR-CredentialStuffing-Notify'], estimatedMTTD: '30min', estimatedMTTR: '2h', involvedTeams: ['SOC', 'AppSec', 'Customer Support', 'Comms'], keyIndicators: ['High volume of failed login attempts', 'Login attempts from known compromised credential lists', 'Unusual geographic distribution of login attempts', 'Account takeover indicators'], mitigationControls: ['WAF rate limiting', 'CAPTCHA on login', 'MFA enforcement', 'Credential monitoring service'], lessonsLearned: 'Deploy advanced bot detection on login endpoints and implement proactive credential monitoring for customer accounts', lastDrillDate: '2026-04-01', nextDrillDate: '2026-07-01'},
    {id: 'zd2f-IS-006', name: 'Phishing Campaign Targeting Executive Team', category: 'Social Engineering', likelihood: 'High', impact: 'High', riskScore: 16, playbooks: ['IR-Phishing-Contain', 'IR-Phishing-Investigate', 'IR-Phishing-Notify'], estimatedMTTD: '1h', estimatedMTTR: '4h', involvedTeams: ['SOC', 'Awareness', 'Executive Office', 'IT'], keyIndicators: ['Sophisticated spear-phishing emails to C-suite', 'Business email compromise indicators', 'Redirected MFA approval requests', 'Unauthorized wire transfer attempts'], mitigationControls: ['AI email filtering', 'Executive awareness training', 'Out-of-band verification policy', 'DMARC/DKIM/SPF'], lessonsLearned: 'Implement additional email security controls for executive mailboxes and conduct monthly spear-phishing simulations', lastDrillDate: '2026-02-15', nextDrillDate: '2026-05-15'}
  ];

  private _zd2fSecurityFrameworks = [
  ...
  private _getzd2fScenarioSummary(): {total: number; critical: number; high: number; drilled: number; avgRiskScore: number} {
    const crit = this._zd2fIncidentScenarios.filter(s => s.impact === 'Critical').length;
    const high = this._zd2fIncidentScenarios.filter(s => s.impact === 'High').length;
    const avg = this._zd2fIncidentScenarios.reduce((s, x) => s + x.riskScore, 0) / this._zd2fIncidentScenarios.length;
    return {total: this._zd2fIncidentScenarios.length, critical: crit, high: high, drilled: this._zd2fIncidentScenarios.length, avgRiskScore: Math.round(avg)};
  }

  private _getzd2fVendorRiskSummary(): {total: number; approved: number; conditional: number; remediation: number; avgScore: number} {
    const approved = this._zd2fThirdPartyRiskData.filter(v => v.status === 'approved').length;
    const cond = this._zd2fThirdPartyRiskData.filter(v => v.status === 'conditional').length;
    const rem = this._zd2fThirdPartyRiskData.filter(v => v.status === 'remediation_required').length;
    const avg = this._zd2fThirdPartyRiskData.reduce((s, v) => s + v.riskScore, 0) / this._zd2fThirdPartyRiskData.length;
    return {total: this._zd2fThirdPartyRiskData.length, approved, conditional: cond, remediation: rem, avgScore: Math.round(avg)};
  }

  private _getzd2fTrainingSummary(): {total: number; avgCompletion: number; avgScore: number; overdueUpdates: number} {
    const avgComp = this._zd2fSecurityTrainingCatalog.reduce((s, t) => s + t.completionRate, 0) / this._zd2fSecurityTrainingCatalog.length;
    const avgScore = this._zd2fSecurityTrainingCatalog.filter(t => t.avgScore > 0).reduce((s, t) => s + t.avgScore, 0) / this._zd2fSecurityTrainingCatalog.filter(t => t.avgScore > 0).length;
    return {total: this._zd2fSecurityTrainingCatalog.length, avgCompletion: Math.round(avgComp * 10) / 10, avgScore: Math.round(avgScore), overdueUpdates: 0};
  }

  private _getzd2fToolHealthSummary(): {total: number; healthy: number; degraded: number; annualCost: string} {
    const healthy = this._zd2fSecurityToolInventory.filter(t => t.health === 'healthy').length;
    const degraded = this._zd2fSecurityToolInventory.filter(t => t.health === 'degraded').length;
    const cost = this._zd2fSecurityToolInventory.reduce((s, t) => s + parseInt(t.annualCost.replace(/[^0-9]/g, '')), 0);
    return {total: this._zd2fSecurityToolInventory.length, healthy, degraded, annualCost: '$' + (cost / 1000).toFixed(0) + 'K'};
  }


  private _xd2fSecurityZones = [
    {zoneId: 'xd2f-Z-001', name: 'Internet DMZ', trustLevel: 'Untrusted', subnet: '10.0.0.0/24', segmentation: 'Dual-firewall', firewallRules: 45, monitoring: 'Full packet capture', assets: ['Web servers', 'Load balancers', 'WAF appliances', 'Reverse proxy'], riskLevel: 'high' as const, lastAssessment: '2026-04-15', nextAssessment: '2026-07-15'},
    {zoneId: 'xd2f-Z-002', name: 'Corporate Network', trustLevel: 'Trusted', subnet: '10.1.0.0/16', segmentation: 'VLAN + micro-seg', firewallRules: 128, monitoring: 'NetFlow + IDS', assets: ['Workstations', 'Printers', 'Meeting room systems', 'VoIP phones'], riskLevel: 'medium' as const, lastAssessment: '2026-04-10', nextAssessment: '2026-07-10'},
    {zoneId: 'xd2f-Z-003', name: 'Production Data Center', trustLevel: 'Restricted', subnet: '10.2.0.0/16', segmentation: 'Full micro-segmentation', firewallRules: 256, monitoring: 'Full packet capture + EDR', assets: ['Application servers', 'Database clusters', 'Message queues', 'API gateways'], riskLevel: 'low' as const, lastAssessment: '2026-04-12', nextAssessment: '2026-07-12'},
    {zoneId: 'xd2f-Z-004', name: 'Management Network', trustLevel: 'Restricted', subnet: '10.3.0.0/24', segmentation: 'Isolated VLAN', firewallRules: 32, monitoring: 'Syslog + SNMP', assets: ['Hypervisors', 'Switch management', 'Storage controllers', 'Backup appliances'], riskLevel: 'low' as const, lastAssessment: '2026-04-08', nextAssessment: '2026-07-08'},
    {zoneId: 'xd2f-Z-005', name: 'Cloud Production', trustLevel: 'Restricted', subnet: 'VPC: 172.16.0.0/12', segmentation: 'Security groups + NACLs', firewallRules: 189, monitoring: 'VPC Flow Logs + GuardDuty', assets: ['Kubernetes clusters', 'Managed databases', 'Object storage', 'Serverless functions'], riskLevel: 'medium' as const, lastAssessment: '2026-04-18', nextAssessment: '2026-07-18'}
  ];

  private _xd2fSecurityAlerts = [
  ...
  private _xd2fComplianceFrameworks = [
  ...
  private _xd2fDataClassificationPolicy = [
  ...
  private _getxd2fZoneSummary(): {total: number; highRisk: number; mediumRisk: number; lowRisk: number; totalRules: number} {
    const high = this._xd2fSecurityZones.filter(z => z.riskLevel === 'high').length;
    const med = this._xd2fSecurityZones.filter(z => z.riskLevel === 'medium').length;
    const low = this._xd2fSecurityZones.filter(z => z.riskLevel === 'low').length;
    const rules = this._xd2fSecurityZones.reduce((s, z) => s + z.firewallRules, 0);
    return {total: this._xd2fSecurityZones.length, highRisk: high, mediumRisk: med, lowRisk: low, totalRules: rules};
  }

  private _getxd2fAlertSummary(): {total: number; critical: number; high: number; medium: number; low: number; open: number; contained: number} {
    const crit = this._xd2fSecurityAlerts.filter(a => a.severity === 'critical').length;
    const high = this._xd2fSecurityAlerts.filter(a => a.severity === 'high').length;
    const med = this._xd2fSecurityAlerts.filter(a => a.severity === 'medium').length;
    const low = this._xd2fSecurityAlerts.filter(a => a.severity === 'low').length;
    const open = this._xd2fSecurityAlerts.filter(a => a.status === 'investigating' || a.status === 'triaged').length;
    const contained = this._xd2fSecurityAlerts.filter(a => a.status === 'contained' || a.status === 'remediated').length;
    return {total: this._xd2fSecurityAlerts.length, critical: crit, high, medium: med, low, open, contained};
  }

  private _getxd2fComplianceSummary(): {total: number; fullyCompliant: number; mostlyCompliant: number; avgComplianceRate: number} {
    const full = this._xd2fComplianceFrameworks.filter(f => f.status === 'compliant').length;
    const mostly = this._xd2fComplianceFrameworks.filter(f => f.status === 'mostly_compliant').length;
    const avgRate = this._xd2fComplianceFrameworks.reduce((s, f) => s + (f.compliant / f.requirements * 100), 0) / this._xd2fComplianceFrameworks.length;
    return {total: this._xd2fComplianceFrameworks.length, fullyCompliant: full, mostlyCompliant: mostly, avgComplianceRate: Math.round(avgRate * 10) / 10};
  }
  ...
  // === Security Risk Register (attack_patte) ===
  private _attack_patteRiskRegister = [
    { id: "RSK-ATT-0001", title: "Data breach from unpatched systems", owner: "CTO", category: "Financial", status: "mitigating", trend: "stable", severity: "critical", likelihood: 10, impact: 6, treatment: "Monitor and review quarterly", lastReview: "2026-04-20", nextReview: "2026-07-07" },
    { id: "RSK-ATT-0002", title: "Ransomware attack on critical infrastructure", owner: "CRO", category: "Strategic", status: "closed", trend: "decreasing", severity: "critical", likelihood: 7, impact: 6, treatment: "Monitor and review quarterly", lastReview: "2026-04-18", nextReview: "2026-07-19" },
    { id: "RSK-ATT-0003", title: "Insider threat data exfiltration", owner: "VP Eng", category: "Compliance", status: "accepted", trend: "increasing", severity: "medium", likelihood: 8, impact: 2, treatment: "Monitor and review quarterly", lastReview: "2026-04-08", nextReview: "2026-07-18" },
    { id: "RSK-ATT-0004", title: "Supply chain compromise", owner: "Security Lead", category: "Technical", status: "open", trend: "stable", severity: "low", likelihood: 10, impact: 7, treatment: "Monitor and review quarterly", lastReview: "2026-04-11", nextReview: "2026-07-23" },
    { id: "RSK-ATT-0005", title: "Cloud misconfiguration exposure", owner: "Risk Mgr", category: "Reputational", status: "mitigating", trend: "decreasing", severity: "medium", likelihood: 9, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-09", nextReview: "2026-07-13" },
    { id: "RSK-ATT-0006", title: "Phishing campaign success rate", owner: "Compliance Dir", category: "Legal", status: "closed", trend: "increasing", severity: "medium", likelihood: 3, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-11", nextReview: "2026-07-26" },
    { id: "RSK-ATT-0007", title: "Third-party vendor data breach", owner: "IT Dir", category: "Regulatory", status: "accepted", trend: "stable", severity: "high", likelihood: 4, impact: 2, treatment: "Monitor and review quarterly", lastReview: "2026-04-21", nextReview: "2026-07-06" },
    { id: "RSK-ATT-0008", title: "Regulatory non-compliance penalty", owner: "DevOps Lead", category: "Third-Party", status: "open", trend: "decreasing", severity: "medium", likelihood: 1, impact: 4, treatment: "Monitor and review quarterly", lastReview: "2026-04-13", nextReview: "2026-07-27" },
    { id: "RSK-ATT-0009", title: "Zero-day exploit in production", owner: "Architect", category: "Human Capital", status: "mitigating", trend: "increasing", severity: "critical", likelihood: 3, impact: 5, treatment: "Monitor and review quarterly", lastReview: "2026-04-12", nextReview: "2026-07-05" },
    { id: "RSK-ATT-0010", title: "Insufficient access controls", owner: "CISO", category: "Operational", status: "closed", trend: "stable", severity: "high", likelihood: 9, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-17", nextReview: "2026-07-12" },
    { id: "RSK-ATT-0011", title: "DDoS attack on services", owner: "CTO", category: "Financial", status: "accepted", trend: "decreasing", severity: "high", likelihood: 9, impact: 4, treatment: "Monitor and review quarterly", lastReview: "2026-04-06", nextReview: "2026-07-07" },
    { id: "RSK-ATT-0012", title: "Social engineering attack", owner: "CRO", category: "Strategic", status: "open", trend: "increasing", severity: "low", likelihood: 4, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-11", nextReview: "2026-07-22" },
    { id: "RSK-ATT-0013", title: "API security vulnerability", owner: "VP Eng", category: "Compliance", status: "mitigating", trend: "stable", severity: "low", likelihood: 2, impact: 4, treatment: "Monitor and review quarterly", lastReview: "2026-04-06", nextReview: "2026-07-11" },
    { id: "RSK-ATT-0014", title: "Mobile device compromise", owner: "Security Lead", category: "Technical", status: "closed", trend: "decreasing", severity: "low", likelihood: 9, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-06", nextReview: "2026-07-10" },
    { id: "RSK-ATT-0015", title: "Physical security breach", owner: "Risk Mgr", category: "Reputational", status: "accepted", trend: "increasing", severity: "critical", likelihood: 9, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-12", nextReview: "2026-07-19" },
    { id: "RSK-ATT-0016", title: "Password policy weakness", owner: "Compliance Dir", category: "Legal", status: "open", trend: "stable", severity: "high", likelihood: 8, impact: 2, treatment: "Monitor and review quarterly", lastReview: "2026-04-19", nextReview: "2026-07-10" },
    { id: "RSK-ATT-0017", title: "Network segmentation gap", owner: "IT Dir", category: "Regulatory", status: "mitigating", trend: "decreasing", severity: "high", likelihood: 10, impact: 7, treatment: "Monitor and review quarterly", lastReview: "2026-04-10", nextReview: "2026-07-11" },
    { id: "RSK-ATT-0018", title: "Encryption key management failure", owner: "DevOps Lead", category: "Third-Party", status: "closed", trend: "increasing", severity: "critical", likelihood: 7, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-22", nextReview: "2026-07-15" },
    { id: "RSK-ATT-0019", title: "Audit trail tampering", owner: "Architect", category: "Human Capital", status: "accepted", trend: "stable", severity: "critical", likelihood: 4, impact: 4, treatment: "Monitor and review quarterly", lastReview: "2026-04-05", nextReview: "2026-07-17" },
    { id: "RSK-ATT-0020", title: "Business email compromise", owner: "CISO", category: "Operational", status: "open", trend: "decreasing", severity: "low", likelihood: 3, impact: 4, treatment: "Monitor and review quarterly", lastReview: "2026-04-20", nextReview: "2026-07-04" },
  ];
  private _attack_patteRiskFilter: string = 'all';
  private _attack_patteRiskSeverity: string = 'all';
  private _attack_patteRiskStatus: string = 'all';
  private _attack_patteExpandedRisk: string = '';
  private _attack_patteFilterRisks() {
    const reg = this._attack_patteRiskRegister;
    return reg.filter(r => {
      if (this._attack_patteRiskFilter !== "all" && r.category !== this._attack_patteRiskFilter) return false;
      if (this._attack_patteRiskSeverity !== "all" && r.severity !== this._attack_patteRiskSeverity) return false;
      if (this._attack_patteRiskStatus !== "all" && r.status !== this._attack_patteRiskStatus) return false;
      return true;
    });
  }
  private _attack_patteGetRiskScore(r: any) { return Math.round(r.likelihood * r.impact * 1.5); }
  private _attack_patteGetRiskTrendIcon(trend: string) {
    if (trend === "increasing") return "\u2191";
    if (trend === "decreasing") return "\u2193";
    return "\u2192";
  }
  private _attack_patteGetRiskColor(sev: string) {
    if (sev === "critical") return "#dc2626";
    if (sev === "high") return "#ea580c";
    if (sev === "medium") return "#d97706";
    return "#16a34a";
  }
  private _attack_patteGetRiskCounts() {
    const reg = this._attack_patteRiskRegister;
  ...
  private _attack_patteGetTreatmentProgress() {
    const reg = this._attack_patteRiskRegister;
    const treated = reg.filter(r => r.status === "mitigating" || r.status === "closed").length;
    return Math.round((treated / Math.max(reg.length, 1)) * 100);
  }

  // === Security Metrics API Gateway (attack_patte) ===
  private _attack_patteApiEndpoints = [
    { method: "GET", path: "/api/v1/threats", name: "Threat Intelligence Feed", status: "active", avgLatency: 219.3, reqPerMin: 591.0, errorRate: 0.28, uptime: round(95.12353460546929,2), version: "v3.4.6" },
    { method: "POST", path: "/api/v1/scans/start", name: "Vulnerability Scanner", status: "active", avgLatency: 66.4, reqPerMin: 535.0, errorRate: 1.68, uptime: round(99.54194152042923,2), version: "v3.6.4" },
    { method: "GET", path: "/api/v1/assets", name: "Asset Inventory", status: "active", avgLatency: 355.3, reqPerMin: 1964.0, errorRate: 0.32, uptime: round(96.02337908308547,2), version: "v2.8.2" },
    { method: "POST", path: "/api/v1/alerts", name: "Alert Management", status: "active", avgLatency: 182.3, reqPerMin: 919.0, errorRate: 0.44, uptime: round(99.90050240026386,2), version: "v3.5.8" },
    { method: "GET", path: "/api/v1/compliance", name: "Compliance Status", status: "active", avgLatency: 380.5, reqPerMin: 1443.0, errorRate: 0.28, uptime: round(95.00514235962939,2), version: "v1.3.14" },
    { method: "PUT", path: "/api/v1/policies", name: "Policy Engine", status: "active", avgLatency: 373.8, reqPerMin: 2079.0, errorRate: 0.01, uptime: round(99.34108011088665,2), version: "v2.9.12" },
    { method: "GET", path: "/api/v1/incidents", name: "Incident Tracker", status: "active", avgLatency: 378.7, reqPerMin: 2492.0, errorRate: 0.28, uptime: round(96.73445963415747,2), version: "v2.2.7" },
    { method: "POST", path: "/api/v1/forensics", name: "Forensics Collector", status: "degraded", avgLatency: 387.6, reqPerMin: 2383.0, errorRate: 2.2, uptime: round(95.73399825152018,2), version: "v1.7.8" },
    { method: "GET", path: "/api/v1/risk/assess", name: "Risk Assessment", status: "active", avgLatency: 246.7, reqPerMin: 2112.0, errorRate: 0.84, uptime: round(99.45330272754717,2), version: "v1.5.12" },
    { method: "POST", path: "/api/v1/auth/verify", name: "Authentication", status: "active", avgLatency: 398.5, reqPerMin: 526.0, errorRate: 0.03, uptime: round(98.86989587766901,2), version: "v1.4.4" },
    { method: "GET", path: "/api/v1/logs/audit", name: "Audit Log Query", status: "active", avgLatency: 264.2, reqPerMin: 1027.0, errorRate: 1.06, uptime: round(95.6912722952686,2), version: "v3.2.0" },
    { method: "PUT", path: "/api/v1/users/roles", name: "Role Management", status: "active", avgLatency: 241.9, reqPerMin: 1735.0, errorRate: 0.7, uptime: round(98.49864615079959,2), version: "v2.1.2" },
    { method: "POST", path: "/api/v1/encrypt", name: "Encryption Service", status: "active", avgLatency: 327.4, reqPerMin: 2239.0, errorRate: 2.44, uptime: round(96.46399290251037,2), version: "v3.2.9" },
    { method: "GET", path: "/api/v1/network/topo", name: "Network Topology", status: "maintenance", avgLatency: 331.4, reqPerMin: 1906.0, errorRate: 0.77, uptime: round(97.05483395838979,2), version: "v2.4.16" },
    { method: "DELETE", path: "/api/v1/sessions", name: "Session Manager", status: "active", avgLatency: 124.5, reqPerMin: 997.0, errorRate: 0.31, uptime: round(96.54559576652608,2), version: "v3.8.20" },
  ];
  private _attack_patteApiKeys = [
    { id: "ak-000001", name: "key-atta-001", created: "2026-06-20", lastUsed: "2026-04-22", status: "active", calls: 9723, rateLimit: 1000 },
    { id: "ak-000002", name: "key-atta-002", created: "2026-08-14", lastUsed: "2026-04-13", status: "active", calls: 41300, rateLimit: 500 },
    { id: "ak-000003", name: "key-atta-003", created: "2026-05-08", lastUsed: "2026-04-06", status: "revoked", calls: 5571, rateLimit: 1000 },
    { id: "ak-000004", name: "key-atta-004", created: "2026-04-28", lastUsed: "2026-04-07", status: "revoked", calls: 5166, rateLimit: 500 },
    { id: "ak-000005", name: "key-atta-005", created: "2026-04-05", lastUsed: "2026-04-16", status: "active", calls: 42300, rateLimit: 5000 },
    { id: "ak-000006", name: "key-atta-006", created: "2026-01-22", lastUsed: "2026-04-05", status: "active", calls: 45495, rateLimit: 100 },
    { id: "ak-000007", name: "key-atta-007", created: "2026-01-14", lastUsed: "2026-04-21", status: "active", calls: 3460, rateLimit: 1000 },
    { id: "ak-000008", name: "key-atta-008", created: "2026-09-09", lastUsed: "2026-04-15", status: "active", calls: 21751, rateLimit: 100 },
  ];
  private _attack_patteApiHealthSummary() {
    const eps = this._attack_patteApiEndpoints;
  ...
  private _attack_patteGetApiByMethod(method: string) { return this._attack_patteApiEndpoints.filter(e=>e.method===method); }
  private _attack_patteGetSlowEndpoints() { return this._attack_patteApiEndpoints.filter(e=>e.avgLatency>200).sort((a,b)=>b.avgLatency-a.avgLatency); }
  private _attack_patteGetHighErrorEndpoints() { return this._attack_patteApiEndpoints.filter(e=>e.errorRate>1.0).sort((a,b)=>b.errorRate-a.errorRate); }

  // === Security Training Effectiveness (attack_patte) ===
  private _attack_patteTrainingModules = [
    { id: "TRN-001", name: "Security Fundamentals", completionRate: 63.4, avgScore: 58.0, behaviorChange: 61.6, enrolled: 75, completed: 219, duration: "72min", category: "mandatory" },
    { id: "TRN-002", name: "Phishing Awareness", completionRate: 78.4, avgScore: 61.6, behaviorChange: 33.3, enrolled: 77, completed: 265, duration: "118min", category: "mandatory" },
    { id: "TRN-003", name: "Social Engineering Defense", completionRate: 64.4, avgScore: 91.9, behaviorChange: 48.9, enrolled: 51, completed: 144, duration: "100min", category: "optional" },
    { id: "TRN-004", name: "Password Hygiene", completionRate: 49.7, avgScore: 73.5, behaviorChange: 83.3, enrolled: 438, completed: 280, duration: "67min", category: "mandatory" },
    { id: "TRN-005", name: "Data Classification", completionRate: 84.7, avgScore: 92.4, behaviorChange: 54.2, enrolled: 206, completed: 270, duration: "110min", category: "mandatory" },
    { id: "TRN-006", name: "Incident Response Basics", completionRate: 59.1, avgScore: 86.2, behaviorChange: 36.3, enrolled: 335, completed: 37, duration: "17min", category: "mandatory" },
    { id: "TRN-007", name: "Secure Coding", completionRate: 96.4, avgScore: 91.8, behaviorChange: 31.6, enrolled: 433, completed: 203, duration: "62min", category: "optional" },
    { id: "TRN-008", name: "Cloud Security", completionRate: 73.6, avgScore: 94.5, behaviorChange: 89.5, enrolled: 360, completed: 28, duration: "111min", category: "mandatory" },
    { id: "TRN-009", name: "Mobile Device Security", completionRate: 89.3, avgScore: 83.6, behaviorChange: 56.5, enrolled: 177, completed: 377, duration: "120min", category: "mandatory" },
    { id: "TRN-010", name: "Network Security", completionRate: 55.9, avgScore: 58.1, behaviorChange: 58.8, enrolled: 329, completed: 315, duration: "50min", category: "mandatory" },
    { id: "TRN-011", name: "Physical Security", completionRate: 52.7, avgScore: 68.2, behaviorChange: 68.5, enrolled: 229, completed: 386, duration: "71min", category: "optional" },
    { id: "TRN-012", name: "Regulatory Compliance", completionRate: 91.0, avgScore: 92.6, behaviorChange: 80.2, enrolled: 415, completed: 115, duration: "19min", category: "mandatory" },
    { id: "TRN-013", name: "Risk Management", completionRate: 62.9, avgScore: 88.9, behaviorChange: 62.3, enrolled: 402, completed: 281, duration: "104min", category: "mandatory" },
    { id: "TRN-014", name: "Cryptography Basics", completionRate: 64.4, avgScore: 55.7, behaviorChange: 65.7, enrolled: 72, completed: 324, duration: "113min", category: "mandatory" },
    { id: "TRN-015", name: "Access Control", completionRate: 62.6, avgScore: 81.4, behaviorChange: 52.1, enrolled: 362, completed: 277, duration: "89min", category: "optional" },
    { id: "TRN-016", name: "Vendor Management", completionRate: 63.3, avgScore: 78.3, behaviorChange: 56.1, enrolled: 388, completed: 45, duration: "68min", category: "mandatory" },
  ];
  private _attack_pattePhishingResults = [
    { month: "2026-01", sent: 954, clicked: 161, reported: 208, clickRate: round(16.87631027253669,1), reportRate: round(21.80293501048218,1) },
    { month: "2026-02", sent: 951, clicked: 92, reported: 235, clickRate: round(9.674027339642482,1), reportRate: round(24.710830704521555,1) },
    { month: "2026-03", sent: 858, clicked: 5, reported: 327, clickRate: round(0.5827505827505828,1), reportRate: round(38.111888111888106,1) },
    { month: "2026-04", sent: 966, clicked: 52, reported: 449, clickRate: round(5.383022774327122,1), reportRate: round(46.48033126293996,1) },
    { month: "2026-05", sent: 314, clicked: 27, reported: 180, clickRate: round(8.598726114649681,1), reportRate: round(57.324840764331206,1) },
    { month: "2026-06", sent: 946, clicked: 123, reported: 567, clickRate: round(13.002114164904862,1), reportRate: round(59.936575052854124,1) },
  ];
  private _attack_patteTrainingROI = { totalInvestment: 92175, avgCostPerEmployee: 201, riskReductionPct: round(random.uniform(15,45),1), incidentReductionPct: round(random.uniform(10,35),1), complianceScoreGain: round(random.uniform(5,25),1) };
  private _attack_patteLearningPaths = [
    { name: "Beginner Security Analyst", totalModules: 20, completedModules: 18, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 32, enrolled: 64 },
    { name: "Advanced Threat Hunter", totalModules: 8, completedModules: 7, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 59, enrolled: 72 },
    { name: "Security Architect", totalModules: 18, completedModules: 16, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 39, enrolled: 66 },
    { name: "Incident Responder", totalModules: 14, completedModules: 6, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 14, enrolled: 124 },
    { name: "Compliance Specialist", totalModules: 12, completedModules: 18, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 71, enrolled: 45 },
    { name: "DevSecOps Engineer", totalModules: 9, completedModules: 16, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 79, enrolled: 157 },
  ];
  private _attack_patteGetOverallCompletion() {
    const mods = this._attack_patteTrainingModules;
    return round(mods.reduce((s,m)=>s+m.completionRate,0)/mods.length,1);
  }
  private _attack_patteGetTopPerformers() { return [...this._attack_patteTrainingModules].sort((a,b)=>b.avgScore-a.avgScore).slice(0,5); }
  private _attack_patteGetModulesNeedingAttention() { return this._attack_patteTrainingModules.filter(m=>m.completionRate<70||m.avgScore<65); }

  // === Security Governance Framework (attack_patte) ===
  private _attack_patteGovBodies = [
    { name: "Security Steering Committee", members: 13, chair: "CISO", meetingFreq: "Weekly", lastMeeting: "2026-04-11", nextMeeting: "2026-05-24", quorum: 8 },
    { name: "Risk Management Board", members: 8, chair: "CTO", meetingFreq: "Bi-weekly", lastMeeting: "2026-04-04", nextMeeting: "2026-05-15", quorum: 6 },
    { name: "Data Governance Council", members: 11, chair: "CRO", meetingFreq: "Monthly", lastMeeting: "2026-04-21", nextMeeting: "2026-05-10", quorum: 3 },
    { name: "Compliance Oversight Board", members: 12, chair: "CDO", meetingFreq: "Monthly", lastMeeting: "2026-04-18", nextMeeting: "2026-05-02", quorum: 7 },
    { name: "Architecture Review Board", members: 12, chair: "VP Eng", meetingFreq: "Bi-weekly", lastMeeting: "2026-04-19", nextMeeting: "2026-05-05", quorum: 3 },
    { name: "Change Advisory Board", members: 5, chair: "CISO", meetingFreq: "Weekly", lastMeeting: "2026-04-03", nextMeeting: "2026-05-01", quorum: 5 },
    { name: "Incident Review Board", members: 14, chair: "CIO", meetingFreq: "As needed", lastMeeting: "2026-04-08", nextMeeting: "2026-05-27", quorum: 3 },
    { name: "Vendor Risk Committee", members: 6, chair: "CFO", meetingFreq: "Quarterly", lastMeeting: "2026-04-09", nextMeeting: "2026-05-25", quorum: 3 },
  ];
  private _attack_patteDecisions = [
    { id: "DEC-0001", title: "Adopt zero-trust architecture framework", date: "2026-03-14", status: "approved", owner: "CISO" },
    { id: "DEC-0002", title: "Migrate to SIEM 2.0 platform", date: "2026-01-02", status: "implemented", owner: "CTO" },
    ...
    { id: "DEC-0005", title: "Establish bug bounty program", date: "2026-04-20", status: "approved", owner: "VP Eng" },
    { id: "DEC-0006", title: "Deploy EDR solution enterprise-wide", date: "2026-04-25", status: "approved", owner: "CISO" },
    ...
    { id: "DEC-0010", title: "Migrate to passwordless authentication", date: "2026-01-24", status: "approved", owner: "VP Eng" },
  ];
  private _attack_pattePolicyLifecycle = [
    { name: "Information Security Policy", version: "v3.0", status: "active", lastUpdated: "2026-04-07", nextReview: "2026-9-24", owner: "CISO" },
    { name: "Acceptable Use Policy", version: "v2.2", status: "active", lastUpdated: "2026-01-28", nextReview: "2026-9-21", owner: "Legal" },
    { name: "Data Retention Policy", version: "v1.2", status: "under-review", lastUpdated: "2026-02-19", nextReview: "2026-9-19", owner: "DPO" },
    { name: "Access Control Policy", version: "v2.0", status: "active", lastUpdated: "2026-03-03", nextReview: "2026-7-26", owner: "IAM Lead" },
    { name: "Incident Response Policy", version: "v2.1", status: "draft", lastUpdated: "2026-02-02", nextReview: "2026-9-27", owner: "IR Lead" },
    { name: "Business Continuity Plan", version: "v2.0", status: "active", lastUpdated: "2026-03-15", nextReview: "2026-10-14", owner: "BCP Mgr" },
    { name: "Vendor Management Policy", version: "v3.1", status: "active", lastUpdated: "2026-02-16", nextReview: "2026-7-08", owner: "Procurement" },
    { name: "Encryption Standard", version: "v4.5", status: "under-review", lastUpdated: "2026-03-07", nextReview: "2026-7-04", owner: "Security Arch" },
  ];
  private _attack_patteGovMaturityScore = { overall: 2.4, riskManagement: 5.7, compliance: 4.5, incidentResponse: 3.5, awareness: 3.4, technology: 4.6 };
  private _attack_patteGetPendingDecisions() { return this._attack_patteDecisions.filter(d=>d.status==='pending'||d.status==='in-progress'); }
  private _attack_patteGetActivePolicies() { return this._attack_pattePolicyLifecycle.filter(p=>p.status==='active'); }
  private _attack_patteGetEscalationPath() { return ["L1 Analyst","L2 Senior","Security Lead","CISO","Board"]; }

  // === Security Innovation Lab (attack_patte) ===
  private _attack_patteInnoProjects = [
    { id: "INN-001", name: "AI-Powered Threat Detection", description: "Machine learning models for real-time threat identification", status: "active", progress: 72, startDate: "2026-03-08", teamSize: 6, budget: 178151, milestones: 6, completedMilestones: 4 },
    { id: "INN-002", name: "Quantum-Resistant Cryptography", description: "Post-quantum encryption algorithm prototyping", status: "research", progress: 35, startDate: "2026-03-27", teamSize: 3, budget: 73556, milestones: 9, completedMilestones: 4 },
    { id: "INN-003", name: "Automated Red Teaming", description: "Autonomous penetration testing framework", status: "active", progress: 58, startDate: "2026-03-04", teamSize: 4, budget: 79458, milestones: 10, completedMilestones: 4 },
    { id: "INN-004", name: "Zero-Knowledge Authentication", description: "Privacy-preserving identity verification", status: "poc", progress: 88, startDate: "2026-01-10", teamSize: 8, budget: 123665, milestones: 3, completedMilestones: 4 },
    { id: "INN-005", name: "Blockchain Audit Trail", description: "Immutable security event logging", status: "active", progress: 45, startDate: "2026-02-25", teamSize: 5, budget: 105848, milestones: 8, completedMilestones: 4 },
    { id: "INN-006", name: "Behavioral Biometrics", description: "Continuous authentication via user behavior patterns", status: "research", progress: 22, startDate: "2026-01-09", teamSize: 4, budget: 147384, milestones: 10, completedMilestones: 6 },
    { id: "INN-007", name: "Deception Grid 2.0", description: "Advanced honeypot network with adaptive responses", status: "active", progress: 65, startDate: "2026-01-24", teamSize: 3, budget: 20655, milestones: 7, completedMilestones: 1 },
    { id: "INN-008", name: "Secure Enclave Integration", description: "Hardware-backed security for critical workloads", status: "poc", progress: 40, startDate: "2026-03-12", teamSize: 4, budget: 178118, milestones: 4, completedMilestones: 5 },
  ];
  private _attack_patteTechEvaluations = [
    { name: "Rust for Security Tools", status: "evaluating", score: 10.3, recommendation: "Adopt", vendor: "Open Source" },
    ...
    { name: "Homomorphic Encryption", status: "evaluating", score: 6.9, recommendation: "Pilot", vendor: "GCP" },
    { name: "SASE Architecture", status: "completed", score: 9.6, recommendation: "Adopt", vendor: "Multiple" },
    { name: "SOAR Platform 3.0", status: "planned", score: 4.1, recommendation: "Monitor", vendor: "Splunk" },
  ];
  private _attack_patteCollaborationPartners = [
  ...
  private _attack_patteInnoMetrics = { totalProjects: 8, activeProjects: 4, avgTimeToValue: "117 days", pocSuccessRate: round(random.uniform(55,85),1), researchToProduction: round(random.uniform(20,50),1), innovationIndex: round(random.uniform(6.0,9.5),1) };
  private _attack_patteGetProjectByStatus(status: string) { return this._attack_patteInnoProjects.filter(p=>p.status===status); }
  private _attack_patteGetTopEvaluations() { return [...this._attack_patteTechEvaluations].sort((a,b)=>b.score-a.score).slice(0,3); }



  // === Compliance Dashboard Extension (attack_patte) ===
  private _attack_patteComplianceFrameworks = [
    { name: "SOC 2 Type II", description: "Trust Services Criteria", totalControls: 5, implementedControls: 4, status: "non-compliant", lastAudit: "2026-01-18", nextAudit: "2026-12-23", evidenceCount: 250 },
    { name: "ISO 27001", description: "Information Security Management", totalControls: 114, implementedControls: 71, status: "in-review", lastAudit: "2026-04-20", nextAudit: "2026-12-03", evidenceCount: 259 },
    { name: "PCI DSS 4.0", description: "Payment Card Industry", totalControls: 12, implementedControls: 7, status: "compliant", lastAudit: "2026-04-12", nextAudit: "2026-10-12", evidenceCount: 211 },
    { name: "HIPAA", description: "Health Insurance Portability", totalControls: 18, implementedControls: 17, status: "non-compliant", lastAudit: "2026-04-27", nextAudit: "2026-9-24", evidenceCount: 63 },
    { name: "GDPR", description: "Data Protection Regulation", totalControls: 99, implementedControls: 99, status: "in-review", lastAudit: "2026-01-06", nextAudit: "2026-7-08", evidenceCount: 275 },
    { name: "NIST CSF 2.0", description: "Cybersecurity Framework", totalControls: 6, implementedControls: 4, status: "compliant", lastAudit: "2026-03-12", nextAudit: "2026-10-17", evidenceCount: 449 },
    { name: "FedRAMP", description: "Federal Risk Authorization", totalControls: 15, implementedControls: 10, status: "in-review", lastAudit: "2026-02-25", nextAudit: "2026-12-12", evidenceCount: 55 },
    { name: "SOX", description: "Sarbanes-Oxley Compliance", totalControls: 8, implementedControls: 6, status: "in-review", lastAudit: "2026-04-16", nextAudit: "2026-9-10", evidenceCount: 74 },
    { name: "CIS Controls v8", description: "Center for Internet Security", totalControls: 18, implementedControls: 18, status: "compliant", lastAudit: "2026-02-18", nextAudit: "2026-12-05", evidenceCount: 441 },
    { name: "COBIT 2019", description: "IT Governance Framework", totalControls: 40, implementedControls: 40, status: "in-review", lastAudit: "2026-02-18", nextAudit: "2026-12-24", evidenceCount: 166 },
  ];
  private _attack_patteGetComplianceScore() {
    const fw = this._attack_patteComplianceFrameworks;
    return round(fw.reduce((s,f)=>s + (f.implementedControls/Math.max(f.totalControls,1))*100, 0) / fw.length, 1);
  }
  private _attack_patteGetGaps() {
    return this._attack_patteComplianceFrameworks.filter(f => f.status !== "compliant");
  }
  private _attack_patteAuditTrail = [
    ...
    { id: "AUD-0004", action: "Remediation completed", auditor: "Compliance Officer", date: "2026-04-04", result: "pass", findings: 2 },
    { id: "AUD-0005", action: "Policy updated", auditor: "IT Audit", date: "2026-04-12", result: "pass", findings: 2 },
    { id: "AUD-0006", action: "Training verified", auditor: "Risk Team", date: "2026-04-22", result: "pass", findings: 4 },
    { id: "AUD-0007", action: "Access reviewed", auditor: "QA Team", date: "2026-04-14", result: "pass", findings: 2 },
    { id: "AUD-0008", action: "Exception approved", auditor: "CISO Office", date: "2026-04-22", result: "conditional", findings: 2 },
    { id: "AUD-0009", action: "Risk accepted", auditor: "Board Audit", date: "2026-04-02", result: "pass", findings: 1 },
    { id: "AUD-0010", action: "Control enhanced", auditor: "Third Party", date: "2026-04-10", result: "pass", findings: 2 },
  ];

  // === Threat Intelligence Feed Extension (attack_patte) ===
  private _attack_patteThreatActors = [
    { name: "APT-29", alias: "Cozy Bear", origin: "Russia", type: "Nation-State", severity: "high", lastActivity: "2026-04-02", targets: "Manufacturing", indicators: 321, ttps: 45 },
    { name: "APT-41", alias: "Double Dragon", origin: "China", type: "Nation-State", severity: "critical", lastActivity: "2026-04-06", targets: "Technology", indicators: 347, ttps: 43 },
    { name: "Lazarus Group", alias: "Hidden Cobra", origin: "North Korea", type: "Nation-State", severity: "critical", lastActivity: "2026-04-12", targets: "Manufacturing", indicators: 362, ttps: 48 },
    { name: "FIN7", alias: "Carbanak", origin: "Eastern Europe", type: "Financial", severity: "high", lastActivity: "2026-04-16", targets: "Healthcare", indicators: 481, ttps: 10 },
    { name: "Conti", alias: "Wizard Spider", origin: "Russia", type: "Ransomware", severity: "critical", lastActivity: "2026-04-12", targets: "Manufacturing", indicators: 291, ttps: 12 },
    { name: "LockBit", alias: "LockBit Gang", origin: "Unknown", type: "Ransomware", severity: "high", lastActivity: "2026-04-20", targets: "Finance", indicators: 32, ttps: 48 },
    { name: "Cl0p", alias: "Cl0p Team", origin: "Unknown", type: "Ransomware", severity: "high", lastActivity: "2026-04-04", targets: "Energy", indicators: 328, ttps: 8 },
    { name: "Sandworm", alias: "Unit 74455", origin: "Russia", type: "Nation-State", severity: "critical", lastActivity: "2026-04-17", targets: "Finance", indicators: 202, ttps: 24 },
  ];
  private _attack_patteIoCFeed = [
    { id: "ioc-000001", type: "ip", value: "196.11.238.152", confidence: 88, source: "CrowdStrike", firstSeen: "2026-04-13", lastSeen: "2026-04-14" },
    { id: "ioc-000002", type: "ip", value: "65.8.155.63", confidence: 48, source: "Mandiant", firstSeen: "2026-04-04", lastSeen: "2026-04-10" },
    { id: "ioc-000003", type: "ip", value: "179.61.154.84", confidence: 54, source: "Mandiant", firstSeen: "2026-04-03", lastSeen: "2026-04-08" },
    { id: "ioc-000004", type: "ip", value: "216.63.83.27", confidence: 66, source: "CrowdStrike", firstSeen: "2026-04-07", lastSeen: "2026-04-13" },
    { id: "ioc-000005", type: "ip", value: "161.204.154.212", confidence: 64, source: "VirusTotal", firstSeen: "2026-04-17", lastSeen: "2026-04-06" },
    { id: "ioc-000006", type: "ip", value: "35.227.222.199", confidence: 83, source: "MISP", firstSeen: "2026-04-23", lastSeen: "2026-04-05" },
    { id: "ioc-000007", type: "ip", value: "123.139.94.192", confidence: 78, source: "Mandiant", firstSeen: "2026-04-19", lastSeen: "2026-04-12" },
    { id: "ioc-000008", type: "ip", value: "164.177.142.215", confidence: 48, source: "CrowdStrike", firstSeen: "2026-04-17", lastSeen: "2026-04-12" },
    { id: "ioc-000009", type: "ip", value: "40.240.57.51", confidence: 77, source: "VirusTotal", firstSeen: "2026-04-15", lastSeen: "2026-04-16" },
    { id: "ioc-000010", type: "ip", value: "157.129.42.142", confidence: 63, source: "Mandiant", firstSeen: "2026-04-02", lastSeen: "2026-04-11" },
    { id: "ioc-000011", type: "ip", value: "253.248.158.205", confidence: 92, source: "VirusTotal", firstSeen: "2026-04-16", lastSeen: "2026-04-14" },
    { id: "ioc-000012", type: "ip", value: "29.15.139.158", confidence: 93, source: "STIX", firstSeen: "2026-04-11", lastSeen: "2026-04-19" },
    { id: "ioc-000013", type: "ip", value: "18.25.240.162", confidence: 48, source: "AlienVault", firstSeen: "2026-04-03", lastSeen: "2026-04-22" },
    { id: "ioc-000014", type: "ip", value: "141.254.225.51", confidence: 42, source: "VirusTotal", firstSeen: "2026-04-10", lastSeen: "2026-04-16" },
    { id: "ioc-000015", type: "ip", value: "185.145.89.237", confidence: 88, source: "VirusTotal", firstSeen: "2026-04-05", lastSeen: "2026-04-23" },
  ];
  private _attack_patteGetActiveThreats() { return this._attack_patteThreatActors.filter(a => a.severity === 'critical'); }
  private _attack_patteGetThreatSummary() {
    const actors = this._attack_patteThreatActors;
  ...
  // === Incident Management Extension (attack_patte) ===
  private _attack_patteIncidents = [
    { id: "INC-20260001", title: "Unauthorized access detected", severity: "critical", status: "open", assignedTo: "SOC L1", detectedAt: "2026-04-06T17:42", affectedAssets: 14, rootCause: "Misconfiguration" },
    { id: "INC-20260002", title: "Malware outbreak on workstation", severity: "high", status: "investigating", assignedTo: "SOC L2", detectedAt: "2026-04-03T07:00", affectedAssets: 38, rootCause: "Credential compromise" },
    { id: "INC-20260003", title: "Data leak from S3 bucket", severity: "medium", status: "contained", assignedTo: "IR Lead", detectedAt: "2026-04-05T04:21", affectedAssets: 34, rootCause: "Zero-day" },
    { id: "INC-20260004", title: "Phishing campaign targeting finance", severity: "low", status: "eradicated", assignedTo: "CISO", detectedAt: "2026-04-12T17:09", affectedAssets: 4, rootCause: "Human error" },
    { id: "INC-20260005", title: "DDoS attack on web services", severity: "critical", status: "recovered", assignedTo: "Security Eng", detectedAt: "2026-04-22T05:26", affectedAssets: 46, rootCause: "Policy violation" },
    { id: "INC-20260006", title: "Ransomware encryption attempt", severity: "high", status: "closed", assignedTo: "Forensics", detectedAt: "2026-04-22T16:56", affectedAssets: 20, rootCause: "Unknown" },
    { id: "INC-20260007", title: "Insider data exfiltration", severity: "medium", status: "open", assignedTo: "SOC L1", detectedAt: "2026-04-10T18:20", affectedAssets: 24, rootCause: "Misconfiguration" },
    { id: "INC-20260008", title: "API key exposure in repo", severity: "low", status: "investigating", assignedTo: "SOC L2", detectedAt: "2026-04-20T23:03", affectedAssets: 5, rootCause: "Credential compromise" },
    { id: "INC-20260009", title: "SQL injection on portal", severity: "critical", status: "contained", assignedTo: "IR Lead", detectedAt: "2026-04-17T23:23", affectedAssets: 2, rootCause: "Zero-day" },
    { id: "INC-20260010", title: "Brute force on VPN", severity: "high", status: "eradicated", assignedTo: "CISO", detectedAt: "2026-04-02T02:26", affectedAssets: 31, rootCause: "Human error" },
    { id: "INC-20260011", title: "Supply chain alert from vendor", severity: "medium", status: "recovered", assignedTo: "Security Eng", detectedAt: "2026-04-13T00:18", affectedAssets: 22, rootCause: "Policy violation" },
    { id: "INC-20260012", title: "Suspicious lateral movement", severity: "low", status: "closed", assignedTo: "Forensics", detectedAt: "2026-04-19T12:02", affectedAssets: 2, rootCause: "Unknown" },
  ];
  private _attack_patteGetIncidentStats() {
    const inc = this._attack_patteIncidents;
    return { total: inc.length, open: inc.filter(i=>i.status==="open").length, investigating: inc.filter(i=>i.status==="investigating").length, mttd: 31, mttr: 156 };
  }
  private _attack_patteGetSeverityDistribution() {
    const inc = this._attack_patteIncidents;
...
<div class="tabs">
        ...
        ${this._activeTab === 'rules' ? html`
          ...
          <div style="background:#1a1d27;border-radius:8px;padding:12px">${this._renderApTreemapSVG()}</div>
          <div style="margin-top:12px;font-size:11px;font-weight:600;margin-bottom:6px">Data Flow (Sankey)</div>
          <div style="background:#1a1d27;border-radius:8px;padding:12px">${this._renderApSankeySVG()}</div>
          ${this._renderApActivity()}
        ` : nothing}
        ${this._activeTab === 'anomalies' ? html`
          ${this._renderApAnomalies()}
          ${this._renderApNotifications()}
        ` : nothing}
        ${this._activeTab === 'predictions' ? html`
          ${this._renderApPredictions()}
          ...
          <div style="background:#1a1d27;border-radius:8px;padding:12px">
            <table class="history-table"><thead><tr><th>ID</th><th>Base</th><th>Temporal</th><th>Environmental</th><th>Overall</th></tr></thead><tbody>
              ${this._apcvssData.map(c => html`<tr><td>${c.itemId}</td><td style="color:${c.base >= 7 ? '#ef4444' : c.base >= 4 ? '#eab308' : '#22c55e'}">${c.base}</td><td>${c.temporal}</td><td>${c.environmental}</td><td style="font-weight:700;color:${c.overall >= 7 ? '#ef4444' : c.overall >= 4 ? '#eab308' : '#22c55e'}">${c.overall}</td></tr>`)}
            </tbody></table>
          </div>
        ` : nothing}
        ${this._activeTab === 'approvals' ? html`
          ${this._renderApApprovals()}
        ` : nothing}
        ...
        ${this._activeTab === 'new' ? html`
          <div class="form-section">
            <div class="form-title">Create New Attack Patterns Entry</div>
            <div class="form-grid">
  ...
  @state() private _apScenarios: {id:string;name:string;attackType:string;target:string;method:string;impactLow:number;impactHigh:number;confidence:number;mitigation:string;status:string}[] = [];
  @state() private _apScenarioForm: {attackType:string;target:string;method:string} = {attackType:'',target:'',method:''};
  @state() private _apScenarioCompare: boolean = false;
  @state() private _apScenarioSelected: string[] = [];

  private _apInitScenarios(): void {
    const saved = localStorage.getItem('ap_scenarios');
    if (saved) { try { this._apScenarios = JSON.parse(saved); } catch { /* ignore */ } }
    if (this._apScenarios.length === 0) {
      this._apScenarios = [
        {id:'ap-s1',name:'Baseline Threat',attackType:'Phishing',target:'Employees',method:'Spear Email',impactLow:45,impactHigh:78,confidence:72,mitigation:'Security awareness training + email filtering',status:'active'},
        {id:'ap-s2',name:'Escalated Attack',attackType:'Ransomware',target:'Endpoints',method:'Drive-by Download',impactLow:65,impactHigh:95,confidence:58,mitigation:'EDR deployment + network segmentation',status:'saved'},
        {id:'ap-s3',name:'Insider Threat',attackType:'Data Exfiltration',target:'Databases',method:'SQL Injection',impactLow:55,impactHigh:88,confidence:65,mitigation:'DLP policies + query monitoring',status:'draft'},
      ];
    }
  }

  private _apSaveScenarios(): void {
    localStorage.setItem('ap_scenarios', JSON.stringify(this._apScenarios));
  }

  private _apAddScenario(): void {
    const f = this._apScenarioForm;
    if (!f.attackType || !f.target) return;
    this._apScenarios = [...this._apScenarios, {
      id: 'ap-s' + (this._apScenarios.length + 1),
    ...
    this._apScenarioForm = {attackType:'',target:'',method:''};
    this._apSaveScenarios();
  }

  private _apRenderScenarioEngine(): any {
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <button class="tab" @click=${() => { this._apScenarioCompare = !this._apScenarioCompare; }}>${this._apScenarioCompare ? 'List View' : 'Compare'}</button>
        </div>
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:6px;margin-bottom:10px">
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._apScenarioForm = {...this._apScenarioForm, attackType: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Attack Type</option>
            ${attackTypes.map(a => html`<option value=${a} ${this._apScenarioForm.attackType === a ? 'selected' : ''}>${a}</option>`)}
          </select>
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._apScenarioForm = {...this._apScenarioForm, target: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Target</option>
            ${targets.map(t => html`<option value=${t} ${this._apScenarioForm.target === t ? 'selected' : ''}>${t}</option>`)}
          </select>
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._apScenarioForm = {...this._apScenarioForm, method: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Method</option>
            ${methods.map(m => html`<option value=${m} ${this._apScenarioForm.method === m ? 'selected' : ''}>${m}</option>`)}
          </select>
        </div>
        <button style="background:#3b82f6;border:none;border-radius:4px;padding:4px 12px;color:#fff;font-size:11px;cursor:pointer" @click=${this._apAddScenario}>Run Simulation</button>
      </div>
      ${this._apScenarioCompare && this._apScenarios.length >= 2 ? html`
        <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
          <div style="font-weight:600;font-size:12px;color:#e2e8f0;margin-bottom:8px">Side-by-Side Comparison</div>
          <div style="display:grid;grid-template-columns:repeat(${Math.min(3, this._apScenarios.length)},1fr);gap:8px">
            ${this._apScenarios.slice(0,3).map(s => html`
      ...
      <div style="background:#0f1117;border-radius:8px;padding:12px">
        <div style="font-weight:600;font-size:12px;color:#e2e8f0;margin-bottom:8px">Saved Scenarios (${this._apScenarios.length})</div>
        ${this._apScenarios.map(s => html`
  ...
  @state() private _apTrendData: {day:number;value:number;anomaly:boolean}[] = [];
  @state() private _apTrendZoom: {start:number;end:number} | null = null;
  @state() private _apTrendMA: number = 7;

  private _apInitTrendData(): void {
    ...
    this._apTrendData = data;
  }

  private _apCalcMA(window: number): number[] {
    const result: number[] = [];
    for (let i = 0; i < this._apTrendData.length; i++) {
      const start = Math.max(0, i - window + 1);
      const slice = this._apTrendData.slice(start, i + 1);
      result.push(slice.reduce((s, d) => s + d.value, 0) / slice.length);
    }
    return result;
  }

  private _apGetStats(): {mean:number;median:number;stddev:number;trend:string} {
    const vals = this._apTrendData.map(d => d.value);
    const n = vals.length;
  ...
  private _apRenderTimeSeries(): any {
    const stats = this._apGetStats();
    const filtered = this._apTrendZoom ? this._apTrendData.filter(d => d.day >= this._apTrendZoom.start && d.day <= this._apTrendZoom.end) : this._apTrendData;
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px">
            <button class="tab ${this._apTrendMA === 7 ? 'active' : ''}" @click=${() => { this._apTrendMA = 7; }}>7D MA</button>
            <button class="tab ${this._apTrendMA === 30 ? 'active' : ''}" @click=${() => { this._apTrendMA = 30; }}>30D MA</button>
            <button class="tab" @click=${() => { this._apTrendZoom = null; }}>Reset Zoom</button>
          </div>
        </div>
        <div style="position:relative;height:120px;background:#1a1d2e;border-radius:6px;overflow:hidden;margin-bottom:8px;cursor:crosshair" @click=${(e: any) => {
          ...
          this._apTrendZoom = { start: Math.max(0, center - 10), end: Math.min(89, center + 10) };
        }}>
  ...
  @state() private _apRoles: string[] = ['Admin','Analyst','Operator','Viewer','Auditor'];
  @state() private _apActions: string[] = ['Create','Read','Update','Delete','Export','Approve'];
  @state() private _apPermissions: { [role: string]: { [action: string]: boolean } } = {};
  @state() private _apPermAudit: {role:string;action:string;changedBy:string;timestamp:string;oldVal:boolean;newVal:boolean}[] = [];
  @state() private _apPermCompare: string[] = [];

  private _apInitPermissions(): void {
    ...
    for (const role of this._apRoles) {
      perms[role] = {};
      this._apActions.forEach((a, i) => { perms[role][a] = defaults[role]?.[i] ?? false; });
    }
    this._apPermissions = perms;
  }

  private _apTogglePermission(role: string, action: string): void {
    const old = this._apPermissions[role][action];
    this._apPermissions = {...this._apPermissions, [role]: {...this._apPermissions[role], [action]: !old}};
    this._apPermAudit.unshift({role,action,changedBy:'current_user',timestamp:new Date().toISOString(),oldVal:old,newVal:!old});
  }

  private _apRenderRBAC(): any {
    const compareRoles = this._apPermCompare.map(r => this._apPermissions[r]).filter(Boolean);
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          <span style="font-weight:700;font-size:13px;color:#e2e8f0">RBAC Permission Matrix</span>
          <div style="display:flex;gap:4px">
            ${this._apRoles.map(r => html`
              <button class="tab ${this._apPermCompare.includes(r) ? 'active' : ''}" @click=${() => {
                this._apPermCompare = this._apPermCompare.includes(r) ? this._apPermCompare.filter(x => x !== r) : [...this._apPermCompare, r];
              }}>${r}</button>
            `)}
          </div>
        </div>
          ...
          <table style="width:100%;border-collapse:collapse;font-size:10px">
            <thead>
              <tr>
                ...
                ${this._apActions.map(a => html`<th style="padding:6px;color:#6b7280;border-bottom:1px solid #2a2d3a;text-align:center">${a}</th>`)}
              </tr>
            </thead>
            <tbody>
              ${this._apRoles.map(role => html`
                <tr style="border-bottom:1px solid #1a1d2e">
                  <td style="padding:6px;color:#e2e8f0;font-weight:600">${role}</td>
                  ${this._apActions.map(action => html`
                    <td style="text-align:center;padding:6px">
                      <button style="width:28px;height:20px;border-radius:3px;border:1px solid #2a2d3a;background:${this._apPermissions[role][action] ? '#22c55e' : '#1a1d2e'};cursor:pointer;color:#fff;font-size:10px" @click=${() => this._apTogglePermission(role, action)}>${this._apPermissions[role][action] ? 'Y' : 'N'}</button>
                    </td>
                  `)}
                </tr>
              `)}
        ...
        ${compareRoles.length >= 2 ? html`
          <div style="margin-top:10px;padding:8px;background:#1a1d2e;border-radius:6px">
            <div style="font-size:11px;font-weight:600;color:#e2e8f0;margin-bottom:6px">Role Diff: ${this._apPermCompare.join(' vs ')}</div>
            ${this._apActions.map(action => {
              ...
              return allSame ? nothing : html`
                <div style="display:flex;gap:8px;padding:3px 0;font-size:10px">
                  ...
                  ${compareRoles.map((r, i) => html`<span style="color:${r[action] ? '#22c55e' : '#ef4444'}">${this._apPermCompare[i]}=${r[action] ? 'Y' : 'N'}</span>`)}
                </div>
              `;
            })}
          </div>
        ` : nothing}
        ${this._apPermAudit.length > 0 ? html`
          <div style="margin-top:8px;font-size:9px;color:#6b7280">Recent: ${this._apPermAudit.slice(0,3).map(a => html`<span style="margin-right:8px">${a.role}.${a.action}: ${a.oldVal ? 'Y' : 'N'}->${a.newVal ? 'Y' : 'N'}</span>`)}
        ` : nothing}
      </div>
    `;
  }
  ...
  // === REPORTING SUITE ===
  @state() private _apReportTemplate: string = 'executive';
  @state() private _apReportSchedule: string = 'weekly';
  @state() private _apReportDistList: string[] = ['security-team@company.com','ciso@company.com'];
  @state() private _apReportHistory: {id:string;template:string;generatedAt:string;status:string}[] = [];

  private _apGenerateReport(): void {
    const id = 'rpt-' + Date.now();
    this._apReportHistory.unshift({id,template:this._apReportTemplate,generatedAt:new Date().toISOString(),status:'sent'});
  }

  private _apRenderReporting(): any {
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:8px">
          <div>
            ...
            ${templates.map(t => html`
              <div style="padding:6px;background:${this._apReportTemplate === t.key ? '#1e3a5f' : '#1a1d2e'};border:1px solid ${this._apReportTemplate === t.key ? '#3b82f6' : '#2a2d3a'};border-radius:4px;margin-bottom:4px;cursor:pointer" @click=${() => { this._apReportTemplate = t.key; }}>
          ...
          <div>
            ...
            <div style="display:flex;gap:4px;margin-bottom:8px">
              ${schedules.map(s => html`<button class="tab ${this._apReportSchedule === s.key ? 'active' : ''}" @click=${() => { this._apReportSchedule = s.key; }}>${s.label}</button>`)}
            </div>
            <div style="font-size:10px;color:#6b7280;margin-bottom:4px">Distribution</div>
            <div style="font-size:10px;color:#9ca3af">${this._apReportDistList.map(d => html`<div>${d}</div>`)}</div>
            <div style="margin-top:6px;display:flex;gap:4px">
              <button style="background:#3b82f6;border:none;border-radius:4px;padding:4px 10px;color:#fff;font-size:10px;cursor:pointer" @click=${this._apGenerateReport}>Generate</button>
        ...
        ${this._apReportHistory.length > 0 ? html`
          <div style="border-top:1px solid #2a2d3a;padding-top:8px">
            ...
            ${this._apReportHistory.slice(0,3).map(r => html`
  ...
  @state() private _apHighContrast: boolean = false;
  @state() private _apA11yAnnounce: string = '';
  @state() private _apShortcutsVisible: boolean = false;
  @state() private _apFocusTrap: boolean = false;

  private _apShortcuts: Record<string, string> = {
  ...
  private _apHandleKeydown(e: KeyboardEvent): void {
    if (e.key === 'Escape' && this._apFocusTrap) { this._apFocusTrap = false; this._apAnnounce('Dialog closed'); }
    if (e.ctrlKey && e.shiftKey && e.key === 'H') { e.preventDefault(); this._apHighContrast = !this._apHighContrast; this._apAnnounce('High contrast ' + (this._apHighContrast ? 'enabled' : 'disabled')); }
    if (e.ctrlKey && e.shiftKey && e.key === 'A') { e.preventDefault(); this._apShortcutsVisible = !this._apShortcutsVisible; }
  }

  private _apAnnounce(msg: string): void {
    this._apA11yAnnounce = msg;
    setTimeout(() => { this._apA11yAnnounce = ''; }, 2000);
  }

  private _apRenderAccessibility(): any {
    return html`
      <div role="region" aria-label="Accessibility Controls" style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <button class="tab ${this._apShortcutsVisible ? 'active' : ''}" @click=${() => { this._apShortcutsVisible = !this._apShortcutsVisible; }} aria-expanded=${this._apShortcutsVisible}>Shortcuts</button>
        </div>
        <div style="display:flex;gap:8px;margin-bottom:8px">
          <label style="display:flex;align-items:center;gap:6px;font-size:11px;color:#e2e8f0;cursor:pointer">
            <input type="checkbox" .checked=${this._apHighContrast} @change=${() => { this._apHighContrast = !this._apHighContrast; }} aria-label="Toggle high contrast mode">
            High Contrast
          </label>
        </div>
        ${this._apShortcutsVisible ? html`
          <div role="list" aria-label="Keyboard shortcuts" style="background:#1a1d2e;border-radius:6px;padding:8px">
            ${Object.entries(this._apShortcuts).map(([key, desc]) => html`
        ...
        ` : nothing}
        <div role="status" aria-live="polite" aria-atomic="true" style="position:absolute;left:-9999px">${this._apA11yAnnounce}</div>
      </div>
    `;
  }
  ...
  connectedCallback(): void {
    ...
    this._apInitScenarios();
    this._apInitTrendData();
    this._apInitPermissions();
    document.addEventListener('keydown', this._apHandleKeydown.bind(this));
  }

  disconnectedCallback(): void {
    super.disconnectedCallback();
    document.removeEventListener('keydown', this._apHandleKeydown.bind(this));
  }

  // === TAB INTEGRATION FOR EXTENDED FEATURES ===
  @state() private _apActiveSubTab: string = 'scenario';
  ...
  private _apGetAllSubTabs(): {key:string;label:string}[] {
    return [
  ...
  private _apRenderSubPanel(): any {
    switch (this._apActiveSubTab) {
      case 'scenario': return this._apRenderScenarioEngine();
      case 'timeseries': return this._apRenderTimeSeries();
      case 'rbac': return this._apRenderRBAC();
      case 'reporting': return this._apRenderReporting();
      case 'a11y': return this._apRenderAccessibility();
      default: return nothing;
    }
  }

  private _apRenderTabBar(): any {
    return html`
      <div style="display:flex;gap:4px;margin-bottom:12px;border-bottom:1px solid #2a2d3a;padding-bottom:8px;flex-wrap:wrap" role="tablist" aria-label="Extended panel features">
        ${this._apGetAllSubTabs().map(t => html`
          <button class="tab ${this._apActiveSubTab === t.key ? 'active' : ''}" @click=${() => { this._apActiveSubTab = t.key; }} role="tab" aria-selected=${this._apActiveSubTab === t.key}>${t.label}</button>
        `)}
      </div>
      <div role="tabpanel" aria-labelledby="ap-tab-${this._apActiveSubTab}">
        ${this._apRenderSubPanel()}
      </div>
    `;
  }
  ...
  @state() private _soarPlaybooks: Array<{
    ...
    {
      id: 'pb-soar-001', name: 'Attack Patterns Auto Response', status: 'active',
      steps: [
    ...
    {
      id: 'pb-soar-002', name: 'Attack Patterns Investigation Workflow', status: 'active',
      steps: [
    ...
    {
      id: 'pb-soar-003', name: 'Attack Patterns Compliance Scan', status: 'draft',
      steps: [
  ...
  @state() private _apAle: number = 0;
  @state() private _apSroi: number = 0;
  @state() private _apCpi: number = 0;
  @state() private _apBudgetAlloc: number = 0;
  @state() private _apCostBenefit: number = 0;

  // Security Economics Calculator
  private apInitEconomics() {
    this._apAle = Math.round(2850000 + Math.random() * 4500000);
    this._apSroi = Math.round(180 + Math.random() * 320);
    this._apCpi = Math.round(45000 + Math.random() * 120000);
    this._apBudgetAlloc = Math.round(2500000 + Math.random() * 3000000);
    this._apCostBenefit = Math.round(220 + Math.random() * 180);
  }

  private _apCalcAle(): { annual: number; perIncident: number; byCategory: Array<{name: string; value: number}> } {
    const base = this._apAle;
    const categories = [
  ...
  private _apCalcSroi(): Array<{year: number; investment: number; savings: number; roi: number}> {
    const baseInv = this._apSroi * 10000;
  ...
  private _apGetBudgetAlloc(): Array<{category: string; amount: number; pct: number; trend: string}> {
    const total = this._apBudgetAlloc;
    const items = [
  ...
  private _apGetCostBenefit(): Array<{control: string; cost: number; benefit: number; ratio: number; priority: string}> {
    const base = this._apCostBenefit;
    const controls = [
  ...
  private _apRenderEconomics() {
    const ale = this._apCalcAle();
    const roi = this._apCalcSroi();
    const budget = this._apGetBudgetAlloc();
    const cb = this._apGetCostBenefit();
    const cpi = this._apCpi;
  ...
  @state() private _apThreatLevel: any = null;
  @state() private _apEmergingThreats: any = null;
  @state() private _apThreatTrends: any = null;
  @state() private _apSectorRadar: any = null;
  @state() private _apActorActivity: any = null;

  // Threat Landscape Intelligence
  private apInitThreatIntel() {
    this._apThreatLevel = {
  ...
  private _apRenderThreatIntel() {
    const tl = this._apThreatLevel;
    const et = this._apEmergingThreats;
    const sr = this._apSectorRadar;
    const aa = this._apActorActivity;
  ...
  @state() private _apPolicies: any = null;
  @state() private _apExceptions: any = null;
  @state() private _apRiskRegister: any = null;
  @state() private _apMeetings: any = null;
  @state() private _apDeadlines: any = null;

  // Security Governance Dashboard
  private apInitGovernance() {
    this._apPolicies = [
  ...
  private _apRenderGovernance() {
    const policies = this._apPolicies;
    const risks = this._apRiskRegister;
    const deadlines = this._apDeadlines;
  ...
  @state() private _apCriticalAssets: any = null;
  @state() private _apAssetDeps: any = null;
  @state() private _apEolAssets: any = null;
  @state() private _apAssetRisk: any = null;

  // Asset Intelligence
  private apInitAssetIntel() {
    this._apCriticalAssets = [
    ...
    this._apAssetRisk = { critical: 7, high: 23, medium: 45, low: 128, total: 203 };
  }

  private _apRenderAssetIntel() {
    const assets = this._apCriticalAssets;
    const eol = this._apEolAssets;
    const ar = this._apAssetRisk;
  ...
  @state() private _apUserBaseline: any = null;
  @state() private _apAnomalyRules: any = null;
  @state() private _apDataAccess: any = null;
  @state() private _apInsiderRisk: any = null;
  @state() private _attackr15Timeline: Array<{id:string;time:string;event:string;severity:string;actor:string}> = [
  ...
  @state() private _attackr15RootCauses: Array<{why:string;answer:string}> = [
  ...
  @state() private _attackr15ImpactMatrix: Array<{system:string;users:number;data:string;revenue:string;status:string}> = [
  ...
  @state() private _attackr15Actions: Array<{id:string;item:string;owner:string;deadline:string;priority:string;status:string}> = [
  ...
  @state() private _attackr15Lessons: Array<{id:string;lesson:string;category:string;severity:string;applies_to:string}> = [
  ...
  @state() private _attackr15ActiveTab: string = 'timeline';
  @state() private _attackr15Benchmarks: Array<{metric:string;current:number;industry:number;target:number;unit:string;source:string}> = [
  ...
  @state() private _attackr15MaturityLevels: Array<{domain:string;current:number;target:number;description:string}> = [
  ...
  @state() private _attackr15QuarterlyData: Array<{quarter:string;score:number;improvement:number}> = [
  ...
  @state() private _attackr15SelectedDomain: string = 'all';
  @state() private _attackr15Alerts: Array<{id:string;name:string;severity:number;confidence:number;assetCrit:number;score:number;enriched:boolean;group:string;status:string;enrichData:Array<{key:string;value:string}>}> = [
  ...
  @state() private _attackr15QualityMetrics: {fpRate:number;enrichSuccess:number;avgTriageTime:number;enrichedCount:number;totalCount:number} = {fpRate:0.12, enrichSuccess:0.78, avgTriageTime:4.5, enrichedCount:3, totalCount:5};
  @state() private _attackr15RoutingRules: Array<{name:string;condition:string;channel:string;active:boolean}> = [
  ...
  @state() private _attackr15Shapes: Array<{id:string;type:string;label:string;controls:string[]}> = [
  ...
  @state() private _attackr15TrustBoundaries: Array<{from:string;to:string;label:string;strength:string}> = [
  ...
  @state() private _attackr15ADRs: Array<{id:string;title:string;status:string;date:string;decision:string}> = [
  ...
  @state() private _attackr15SelectedShape: string = '';
  @state() private _attackr15Gauges: Array<{name:string;value:number;max:number;unit:string;status:string;color:string}> = [
  ...
  @state() private _attackr15Anomalies: Array<{id:string;time:string;description:string;severity:string;acknowledged:boolean}> = [
  ...
  @state() private _attackr15Integrations: Array<{name:string;status:string;uptime:number;lastCheck:string;latency:number}> = [
  ...
  @state() private _attackr15AlertFatigue: Array<{analyst:string;alertsPerDay:number;escalated:number;dismissed:number;avgResponseMin:number}> = [
  ...
  @state() private _attackr15SlaTarget: number = 99.9;

  // Insider Threat Detection
  private apInitInsiderThreat() {
    this._apUserBaseline = [
    ...
    this._apInsiderRisk = { totalUsers: 2847, monitored: 342, flagged: 18, investigated: 5, confirmed: 1 };
  }

  private _apRenderInsiderThreat() {
    const baseline = this._apUserBaseline;
    const rules = this._apAnomalyRules;
    const ir = this._apInsiderRisk;
    ...
    return html`<div class="card" style="padding:14px;margin-bottom:8px">
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px;margin-bottom:10px;flex-wrap:wrap">
            ${['timeline','rootcause','impact','actions','lessons'].map(t => html`
              <button class="btn ${this._attackr15ActiveTab === t ? 'btn-primary' : ''}" style="font-size:10px;padding:3px 8px" @click=${() => { this._attackr15ActiveTab = t; }}>${t.charAt(0).toUpperCase() + t.slice(1)}</button>
            `)}
          </div>
          ${this._attackr15ActiveTab === 'timeline' ? html`
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._attackr15Timeline.map(e => html`
          ...
          ` : this._attackr15ActiveTab === 'rootcause' ? html`
            <div style="margin-bottom:8px">${{__html: this._attackr15RenderFishbone()}}</div>
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._attackr15RootCauses.map((rc, i) => html`
          ...
          ` : this._attackr15ActiveTab === 'impact' ? html`
            <div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:10px">
              ...
              <tbody>${this._attackr15ImpactMatrix.map(imp => html`
          ...
          ` : this._attackr15ActiveTab === 'actions' ? html`
            <div style="display:flex;gap:12px;margin-bottom:8px;font-size:10px;color:#888">
              ${Object.entries(this._attackr15GetActionStats()).map(([k,v]) => html`<span>${k}: <b style="color:#ddd">${v}</b></span>`)}
            </div>
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._attackr15Actions.map(a => html`
                <div style="display:flex;gap:8px;align-items:center;padding:6px;background:#1a1d27;border-radius:4px;cursor:pointer" @click=${() => this._attackr15ToggleAction(a.id)}>
          ...
          ` : html`
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._attackr15Lessons.map(l => html`
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px;margin-bottom:10px;flex-wrap:wrap">
            ${['all', ...this._attackr15MaturityLevels.map(m => m.domain)].map(d => html`
              <button class="btn ${this._attackr15SelectedDomain === d ? 'btn-primary' : ''}" style="font-size:9px;padding:2px 6px" @click=${() => { this._attackr15SelectedDomain = d; }}>${d}</button>
            `)}
          </div>
          <div style="display:flex;gap:16px;margin-bottom:10px">
            <div style="text-align:center"><div style="color:#e0e0e0;font-size:20px;font-weight:bold">${this._attackr15GetOverallMaturity()}/5</div><div style="color:#888;font-size:10px">Maturity Level</div></div>
            <div style="text-align:center"><div style="color:#4f4;font-size:20px;font-weight:bold">${this._attackr15GetGapAnalysis().filter(g => g.isAbove).length}/${this._attackr15Benchmarks.length}</div><div style="color:#888;font-size:10px">Above Industry</div></div>
          </div>
          <div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:10px">
            ...
            <tbody>${this._attackr15GetGapAnalysis().map(b => html`
          ...
          <div style="margin-top:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Maturity by Domain</div>
            ${this._attackr15MaturityLevels.filter(m => this._attackr15SelectedDomain === 'all' || m.domain === this._attackr15SelectedDomain).map(m => html`
          ...
          <div style="margin-top:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Quarterly Trend</div>
            <div style="display:flex;height:40px;align-items:flex-end;gap:4px">
              ${this._attackr15QuarterlyData.map(q => html`<div style="flex:1;text-align:center"><div style="background:#4a9eff;height:${q.score * 0.5}px;border-radius:2px 2px 0 0" title="${q.score}"></div><div style="color:#666;font-size:8px;margin-top:2px">${q.quarter}</div></div>`)}
            </div>
          </div>
        </div>
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:12px;margin-bottom:8px;font-size:10px">
            <div style="display:flex;gap:4px;flex-wrap:wrap">${this._attackr15GroupAlerts().map(g => html`<span style="color:#888;padding:2px 6px;background:#1a1d27;border-radius:3px">${g.group}: ${g.count}</span>`)}</div>
          </div>
          <div style="display:flex;gap:8px;margin-bottom:8px;font-size:10px;color:#888">
            <span>FP Rate: <b style="color:${this._attackr15QualityMetrics.fpRate > 0.15 ? '#f44' : '#4f4'}">${(this._attackr15QualityMetrics.fpRate * 100).toFixed(1)}%</b></span>
            <span>Enrich: <b style="color:#4a9eff">${(this._attackr15QualityMetrics.enrichSuccess * 100).toFixed(0)}%</b></span>
            <span>Avg Triage: <b style="color:#ddd">${this._attackr15QualityMetrics.avgTriageTime}m</b></span>
          </div>
          <div style="display:flex;flex-direction:column;gap:4px;max-height:200px;overflow-y:auto">
            ${this._attackr15Alerts.sort((a, b) => this._attackr15CalcScore(b) - this._attackr15CalcScore(a)).map(a => {
              const score = this._attackr15CalcScore(a);
              return html`
                <div style="padding:6px;background:#1a1d27;border-radius:4px;border-left:3px solid ${a.severity >= 4 ? '#f44' : a.severity >= 3 ? '#fa0' : '#4a9eff'}">
                  <div style="display:flex;justify-content:space-between;align-items:center">
                    ...
                    <button class="btn" style="font-size:9px;padding:1px 6px;margin-left:4px" @click=${() => this._attackr15EnrichAlert(a.id)}>${a.enriched ? 'Re-enrich' : 'Enrich'}</button>
                  </div>
          ...
          <div style="margin-top:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Routing Rules</div>
            ${this._attackr15RoutingRules.map(r => html`
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:8px;margin-bottom:8px;flex-wrap:wrap">
            ${this._attackr15Shapes.map(s => {
              const v = this._attackr15ValidateControl(s.id);
              return html`<div style="padding:4px 8px;background:#1a1d27;border-radius:3px;cursor:pointer;border:1px solid ${this._attackr15SelectedShape === s.id ? '#4a9eff' : '#2a2d37'}" @click=${() => { this._attackr15SelectedShape = this._attackr15SelectedShape === s.id ? '' : s.id; }}>
          ...
          ${this._attackr15SelectedShape ? html`
            ${(() => {
              const shape = this._attackr15Shapes.find(s => s.id === this._attackr15SelectedShape);
              const v = this._attackr15ValidateControl(this._attackr15SelectedShape);
              return shape ? html`
          ...
          <div style="margin-bottom:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Trust Boundaries</div>
            ${this._attackr15TrustBoundaries.map(tb => html`
              <div style="display:flex;gap:6px;align-items:center;padding:3px;background:#1a1d27;border-radius:3px;margin-bottom:2px;font-size:9px">
                <span style="color:#ddd">${this._attackr15Shapes.find(s => s.id === tb.from)?.label || tb.from}</span>
                <span style="color:#4a9eff">\u2194</span>
                <span style="color:#ddd">${this._attackr15Shapes.find(s => s.id === tb.to)?.label || tb.to}</span>
          ...
          <div><div style="color:#888;font-size:10px;margin-bottom:4px">Architecture Decision Records</div>
            ${this._attackr15ADRs.map(adr => html`
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:8px;margin-bottom:8px;flex-wrap:wrap">
            ${this._attackr15Gauges.map(g => html`
          ...
          <div style="display:flex;gap:8px;margin-bottom:8px;align-items:center">
            ...
            <span style="color:${this._attackr15GetOverallHealth().score >= 99 ? '#4f4' : '#fa0'};font-size:12px;font-weight:bold">${this._attackr15GetOverallHealth().score}%</span>
            <span style="color:#888;font-size:10px">(Target: ${this._attackr15SlaTarget}%)</span>
            <span style="color:#4f4;font-size:10px">${this._attackr15GetOverallHealth().healthy} healthy</span>
            <span style="color:#fa0;font-size:10px">${this._attackr15GetOverallHealth().degraded} degraded</span>
          </div>
          <div style="margin-bottom:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Anomaly Stream</div>
            ${this._attackr15Anomalies.slice(0, 3).map(a => html`
              <div style="display:flex;gap:6px;align-items:center;padding:4px;background:#1a1d27;border-radius:3px;margin-bottom:2px;opacity:${a.acknowledged ? 0.5 : 1}">
                ...
                ${!a.acknowledged ? html`<button class="btn" style="font-size:8px;padding:1px 4px" @click=${() => this._attackr15AckAnomaly(a.id)}>ACK</button>` : html`<span style="color:#4f4;font-size:9px">ACK'd</span>`}
              </div>
            `)}
          </div>
          <div style="margin-bottom:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Integration Health</div>
            ${this._attackr15Integrations.map(i => html`
              <div style="display:flex;gap:6px;align-items:center;padding:3px;background:#1a1d27;border-radius:3px;margin-bottom:2px;font-size:9px">
          ...
          <div><div style="color:#888;font-size:10px;margin-bottom:4px">Alert Fatigue Analysis</div>
            <div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:9px">
              ...
              <tbody>${this._attackr15AlertFatigue.map(af => html`
  ...
  private _attackr15RenderFishbone(): string {
  ...
  private _attackr15ToggleAction(id: string) {
    this._attackr15Actions = this._attackr15Actions.map(a => a.id === id ? {...a, status: a.status === 'pending' ? 'in_progress' : a.status === 'in_progress' ? 'completed' : 'pending'} : a);
  }

  private _attackr15GetActionStats() {
    const total = this._attackr15Actions.length;
    const done = this._attackr15Actions.filter(a => a.status === 'completed').length;
    const inProg = this._attackr15Actions.filter(a => a.status === 'in_progress').length;
    return { total, done, inProg, pending: total - done - inProg };
  }

  private _attackr15GetOverallMaturity(): number {
    if (this._attackr15SelectedDomain === 'all') {
      return Math.round(this._attackr15MaturityLevels.reduce((s, m) => s + m.current, 0) / this._attackr15MaturityLevels.length * 10) / 10;
    }
    const d = this._attackr15MaturityLevels.find(m => m.domain === this._attackr15SelectedDomain);
    return d ? d.current : 0;
  }

  private _attackr15GetGapAnalysis() {
    return this._attackr15Benchmarks.map(b => {
  ...
  private _attackr15CalcScore(alert: any): number {
    return Math.round(alert.severity * alert.confidence * alert.assetCrit * 100) / 100;
  }

  private _attackr15EnrichAlert(id: string) {
    this._attackr15Alerts = this._attackr15Alerts.map(a => {
      if (a.id !== id) return a;
      const score = this._attackr15CalcScore(a);
  ...
  private _attackr15GroupAlerts() {
    const groups: Record<string, number> = {};
    this._attackr15Alerts.forEach(a => { groups[a.group] = (groups[a.group] || 0) + 1; });
    return Object.entries(groups).map(([g, c]) => ({group: g, count: c}));
  }

  private _attackr15ValidateControl(shapeId: string): {valid:boolean;missing:string[]} {
    const shape = this._attackr15Shapes.find(s => s.id === shapeId);
  ...
  private _attackr15GetOverallHealth(): {healthy:number;degraded:number;down:number;score:number} {
    const online = this._attackr15Integrations.filter(i => i.status === 'online').length;
    const degraded = this._attackr15Integrations.filter(i => i.status === 'degraded').length;
    const total = this._attackr15Integrations.length;
    return { healthy: online, degraded, down: total - online - degraded, score: Math.round(online / total * 100) };
  }

  private _attackr15AckAnomaly(id: string) {
    this._attackr15Anomalies = this._attackr15Anomalies.map(a => a.id === id ? {...a, acknowledged: true} : a);
  }
...
// ===== SECURITY ROI DASHBOARD (R22) =====
  ...
  private _renderBudgetPlanning() {
    const budgetData = [
      { category: "Personnel & Training", planned: 4164000, actual: 3535000, utilization: 84.9, q1: "20%", q2: "25%", q3: "23%", q4: "15%" },
      { category: "Tooling & Licensing", planned: 4171000, actual: 3548000, utilization: 85.1, q1: "23%", q2: "30%", q3: "18%", q4: "16%" },
      { category: "Infrastructure Security", planned: 4178000, actual: 3561000, utilization: 85.2, q1: "26%", q2: "35%", q3: "29%", q4: "17%" },
      { category: "Compliance & Audit", planned: 4185000, actual: 3574000, utilization: 85.4, q1: "29%", q2: "24%", q3: "24%", q4: "18%" },
      { category: "Incident Response", planned: 4192000, actual: 3587000, utilization: 85.6, q1: "16%", q2: "29%", q3: "19%", q4: "19%" },
      { category: "Third-Party Assessments", planned: 4199000, actual: 3600000, utilization: 85.7, q1: "19%", q2: "34%", q3: "30%", q4: "20%" },
      { category: "Security Awareness", planned: 4206000, actual: 3613000, utilization: 85.9, q1: "22%", q2: "23%", q3: "25%", q4: "21%" },
      { category: "Research & Innovation", planned: 4213000, actual: 3626000, utilization: 86.1, q1: "25%", q2: "28%", q3: "20%", q4: "22%" },
    ];
    ...
    const headcount = [
      { team: "SOC Tier 1", current: 14, target: 8, gap: 3, avgSalary: "130k" },
      { team: "SOC Tier 2", current: 6, target: 7, gap: 2, avgSalary: "159k" },
      { team: "Threat Intel", current: 15, target: 6, gap: 1, avgSalary: "188k" },
      { team: "Red Team", current: 7, target: 5, gap: 0, avgSalary: "106k" },
      { team: "GRC", current: 16, target: 4, gap: 5, avgSalary: "135k" },
      { team: "AppSec", current: 8, target: 3, gap: 4, avgSalary: "164k" },
      { team: "Cloud Sec", current: 17, target: 22, gap: 3, avgSalary: "193k" },
      { team: "Identity & Access", current: 9, target: 21, gap: 2, avgSalary: "111k" },
    ];
    const vendorSpend = [
      { vendor: "CrowdStrike", annual: "208k", contractEnd: "2026-10", renewalRisk: "Low", satisfaction: 3 },
      { vendor: "Palo Alto", annual: "239k", contractEnd: "2026-11", renewalRisk: "Medium", satisfaction: 5 },
      { vendor: "Splunk", annual: "270k", contractEnd: "2026-12", renewalRisk: "High", satisfaction: 4 },
      { vendor: "Qualys", annual: "301k", contractEnd: "2026-01", renewalRisk: "Low", satisfaction: 3 },
      { vendor: "Rapid7", annual: "332k", contractEnd: "2026-02", renewalRisk: "Medium", satisfaction: 5 },
      { vendor: "Mandiant", annual: "363k", contractEnd: "2026-03", renewalRisk: "High", satisfaction: 4 },
      { vendor: "Zscaler", annual: "394k", contractEnd: "2026-04", renewalRisk: "Low", satisfaction: 3 },
      { vendor: "Duo Security", annual: "425k", contractEnd: "2026-05", renewalRisk: "Medium", satisfaction: 5 },
    ];
    const roiProjections = [
      { area: "Threat Detection", investment: "613k", projectedReturn: "767k", roiMultiple: "1.6x", confidence: 69 },
      { area: "Incident Reduction", investment: "656k", projectedReturn: "814k", roiMultiple: "1.5x", confidence: 86 },
      { area: "Compliance Savings", investment: "699k", projectedReturn: "861k", roiMultiple: "4.0x", confidence: 67 },
      { area: "Automation Gains", investment: "742k", projectedReturn: "908k", roiMultiple: "3.9x", confidence: 84 },
      { area: "Risk Avoidance", investment: "785k", projectedReturn: "955k", roiMultiple: "3.8x", confidence: 65 },
    ];
    return html`
  ...
  private _renderMetricsNormalization() {
    const kpiCatalog = [
      { id: "kpi-1", name: "MTTD", owner: "SOC", unit: "minutes", target: 94, current: 71, benchmark: 73, collection: "auto", frequency: "realtime" },
      { id: "kpi-2", name: "MTTR", owner: "GRC", unit: "%", target: 97, current: 78, benchmark: 84, collection: "semi-auto", frequency: "daily" },
      { id: "kpi-3", name: "MTTC", owner: "AppSec", unit: "score", target: 70, current: 85, benchmark: 95, collection: "manual", frequency: "weekly" },
      { id: "kpi-4", name: "Vuln SLA Compliance", owner: "Cloud Sec", unit: "count", target: 73, current: 92, benchmark: 72, collection: "auto", frequency: "monthly" },
      { id: "kpi-5", name: "Patch Coverage", owner: "Identity", unit: "days", target: 76, current: 99, benchmark: 83, collection: "semi-auto", frequency: "realtime" },
      { id: "kpi-6", name: "Phishing Click Rate", owner: "Threat Intel", unit: "minutes", target: 79, current: 60, benchmark: 94, collection: "manual", frequency: "daily" },
      { id: "kpi-7", name: "Training Completion", owner: "Security Ops", unit: "%", target: 82, current: 67, benchmark: 71, collection: "auto", frequency: "weekly" },
      { id: "kpi-8", name: "Escalation Rate", owner: "Risk Mgmt", unit: "score", target: 85, current: 74, benchmark: 82, collection: "semi-auto", frequency: "monthly" },
      { id: "kpi-9", name: "False Positive Rate", owner: "SOC", unit: "count", target: 88, current: 81, benchmark: 93, collection: "manual", frequency: "realtime" },
      { id: "kpi-10", name: "Threat Intel Actionability", owner: "GRC", unit: "days", target: 91, current: 88, benchmark: 70, collection: "auto", frequency: "daily" },
      { id: "kpi-11", name: "Endpoint Compliance", owner: "AppSec", unit: "minutes", target: 94, current: 95, benchmark: 81, collection: "semi-auto", frequency: "weekly" },
      { id: "kpi-12", name: "Cloud Misconfig Score", owner: "Cloud Sec", unit: "%", target: 97, current: 56, benchmark: 92, collection: "manual", frequency: "monthly" },
      { id: "kpi-13", name: "Identity Anomaly Rate", owner: "Identity", unit: "score", target: 70, current: 63, benchmark: 69, collection: "auto", frequency: "realtime" },
      { id: "kpi-14", name: "DLP Events", owner: "Threat Intel", unit: "count", target: 73, current: 70, benchmark: 80, collection: "semi-auto", frequency: "daily" },
      { id: "kpi-15", name: "Vendor Risk Avg", owner: "Security Ops", unit: "days", target: 76, current: 77, benchmark: 91, collection: "manual", frequency: "weekly" },
      { id: "kpi-16", name: "Compliance Audit Pass Rate", owner: "Risk Mgmt", unit: "minutes", target: 79, current: 84, benchmark: 68, collection: "auto", frequency: "monthly" },
      { id: "kpi-17", name: "Awareness Score", owner: "SOC", unit: "%", target: 82, current: 91, benchmark: 79, collection: "semi-auto", frequency: "realtime" },
      { id: "kpi-18", name: "SOC Utilization", owner: "GRC", unit: "score", target: 85, current: 98, benchmark: 90, collection: "manual", frequency: "daily" },
      { id: "kpi-19", name: "Automation Coverage", owner: "AppSec", unit: "count", target: 88, current: 59, benchmark: 67, collection: "auto", frequency: "weekly" },
      { id: "kpi-20", name: "Risk Register Currency", owner: "Cloud Sec", unit: "days", target: 91, current: 66, benchmark: 78, collection: "semi-auto", frequency: "monthly" },
    ];
    const benchmarkSources = [
      { source: "NIST CSF", mappedKPIs: 3, alignment: 72, lastReview: "2026-01-25", status: "aligned" },
      { source: "CIS Controls v8", mappedKPIs: 4, alignment: 89, lastReview: "2026-02-20", status: "partial" },
      { source: "ISO 27001:2022", mappedKPIs: 5, alignment: 67, lastReview: "2026-03-15", status: "reviewing" },
      { source: "PCI DSS 4.0", mappedKPIs: 6, alignment: 84, lastReview: "2026-04-10", status: "aligned" },
      { source: "SOC 2 Type II", mappedKPIs: 7, alignment: 62, lastReview: "2026-05-05", status: "partial" },
      { source: "MITRE ATT&CK", mappedKPIs: 8, alignment: 79, lastReview: "2026-06-28", status: "reviewing" },
      { source: "SANS Top 20", mappedKPIs: 3, alignment: 96, lastReview: "2026-01-23", status: "aligned" },
      { source: "OWASP Top 10", mappedKPIs: 4, alignment: 74, lastReview: "2026-02-18", status: "partial" },
    ];
  ...
  private _renderThreatHuntingCampaigns() {
    const campaigns = [
      { id: "HC-1001", name: "Lateral Movement Sweep", status: "active", hypothesis: "H1: Actors using pass-the-hash for lateral movement", leadHunter: "Alice Chen", findings: 4, startDate: "2026-01-17", endDate: null, effectiveness: 50 },
      { id: "HC-1002", name: "Credential Harvesting Hunt", status: "completed", hypothesis: "H2: Actors using web shells for persistence", leadHunter: "Bob Martinez", findings: 7, startDate: "2026-04-28", endDate: "2026-06-06", effectiveness: 69 },
      { id: "HC-1003", name: "Persistence Mechanism Audit", status: "planned", hypothesis: "H3: Actors using scheduled tasks for data theft", leadHunter: "Carol Wu", findings: 10, startDate: "2026-03-11", endDate: null, effectiveness: 88 },
      { id: "HC-1004", name: "C2 Beacon Detection", status: "in-review", hypothesis: "H4: Actors using DNS tunneling for C2 communication", leadHunter: "Dave Kim", findings: 13, startDate: "2026-02-22", endDate: null, effectiveness: 48 },
      { id: "HC-1005", name: "Data Exfiltration Patterns", status: "active", hypothesis: "H5: Actors using encrypted channels for privilege escalation", leadHunter: "Eve Johnson", findings: 16, startDate: "2026-01-05", endDate: null, effectiveness: 67 },
      { id: "HC-1006", name: "Privilege Escalation Scan", status: "completed", hypothesis: "H6: Actors using token impersonation for defense evasion", leadHunter: "Frank Liu", findings: 19, startDate: "2026-04-16", endDate: "2026-04-18", effectiveness: 86 },
      { id: "HC-1007", name: "Supply Chain Implant Hunt", status: "planned", hypothesis: "H7: Actors using poisoned images for initial access", leadHunter: "Grace Park", findings: 22, startDate: "2026-03-27", endDate: null, effectiveness: 46 },
      { id: "HC-1008", name: "Insider Threat Indicators", status: "in-review", hypothesis: "H8: Actors using legitimate tools for credential access", leadHunter: "Hector Silva", findings: 25, startDate: "2026-02-10", endDate: null, effectiveness: 65 },
      { id: "HC-1009", name: "Cloud Metadata Analysis", status: "active", hypothesis: "H9: Actors using API keys for command execution", leadHunter: "Alice Chen", findings: 28, startDate: "2026-01-21", endDate: null, effectiveness: 84 },
      { id: "HC-1010", name: "DNS Tunnel Detection", status: "completed", hypothesis: "H10: Actors using encoded subdomains for exfiltration", leadHunter: "Bob Martinez", findings: 31, startDate: "2026-04-04", endDate: "2026-05-02", effectiveness: 44 },
      { id: "HC-1011", name: "Fileless Malware Search", status: "planned", hypothesis: "H11: Actors using WMI providers for discovery", leadHunter: "Carol Wu", findings: 34, startDate: "2026-03-15", endDate: null, effectiveness: 63 },
      { id: "HC-1012", name: "Zero-Day Exploit Traces", status: "in-review", hypothesis: "H12: Actors using exploit kits for collection", leadHunter: "Dave Kim", findings: 37, startDate: "2026-02-26", endDate: null, effectiveness: 82 },
    ];
    const hunterLeaderboard = [
      { hunter: "Alice Chen", campaigns: 14, findings: 21, highSeverity: 24, avgScore: 67, streak: 5 },
      { hunter: "Bob Martinez", campaigns: 11, findings: 50, highSeverity: 3, avgScore: 60, streak: 6 },
      { hunter: "Carol Wu", campaigns: 8, findings: 79, highSeverity: 8, avgScore: 97, streak: 7 },
      { hunter: "Dave Kim", campaigns: 5, findings: 108, highSeverity: 13, avgScore: 90, streak: 8 },
      { hunter: "Eve Johnson", campaigns: 15, findings: 21, highSeverity: 18, avgScore: 83, streak: 1 },
      { hunter: "Frank Liu", campaigns: 12, findings: 50, highSeverity: 23, avgScore: 76, streak: 2 },
      { hunter: "Grace Park", campaigns: 9, findings: 79, highSeverity: 2, avgScore: 69, streak: 3 },
      { hunter: "Hector Silva", campaigns: 6, findings: 108, highSeverity: 7, avgScore: 62, streak: 4 },
    ];
    const mitreMapping = [
      { tactic: "Initial Access", techniques: 3, campaigns: 5, coverage: 72 },
      { tactic: "Execution", techniques: 2, campaigns: 4, coverage: 52 },
      { tactic: "Persistence", techniques: 12, campaigns: 3, coverage: 32 },
      { tactic: "Privilege Escalation", techniques: 11, campaigns: 2, coverage: 83 },
      { tactic: "Defense Evasion", techniques: 10, campaigns: 1, coverage: 63 },
      { tactic: "Credential Access", techniques: 9, campaigns: 6, coverage: 43 },
      { tactic: "Discovery", techniques: 8, campaigns: 5, coverage: 94 },
      { tactic: "Lateral Movement", techniques: 7, campaigns: 4, coverage: 74 },
      { tactic: "Collection", techniques: 6, campaigns: 3, coverage: 54 },
      { tactic: "Exfiltration", techniques: 5, campaigns: 2, coverage: 34 },
      { tactic: "Command & Control", techniques: 4, campaigns: 1, coverage: 85 },
      { tactic: "Impact", techniques: 3, campaigns: 6, coverage: 65 },
    ];
    return html`
  ...
  private _renderControlInventory() {
    const controls = [
      { id: "CTL-2001", name: "MFA Enforcement", domain: "Access Control", status: "implemented", effectiveness: 47, lastTest: "2026-01-09", nextReview: "2026-09-09", owner: "SOC", risk: "Low" },
      { id: "CTL-2002", name: "Network Segmentation", domain: "Network Security", status: "partial", effectiveness: 9, lastTest: "2026-04-22", nextReview: "2026-10-28", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2003", name: "EDR Deployment", domain: "Endpoint Protection", status: "planned", effectiveness: 16, lastTest: "2026-03-07", nextReview: "2026-11-19", owner: "IT Ops", risk: "High" },
      { id: "CTL-2004", name: "DLP Policy", domain: "Data Protection", status: "gap", effectiveness: 23, lastTest: "2026-02-20", nextReview: "2026-12-10", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2005", name: "SSO Integration", domain: "Identity Management", status: "implemented", effectiveness: 59, lastTest: "2026-01-05", nextReview: "2026-05-01", owner: "IAM", risk: "Low" },
      { id: "CTL-2006", name: "SAST Pipeline", domain: "Application Security", status: "partial", effectiveness: 37, lastTest: "2026-04-18", nextReview: "2026-06-20", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2007", name: "CSPM Scanning", domain: "Cloud Security", status: "planned", effectiveness: 44, lastTest: "2026-03-03", nextReview: "2026-07-11", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2008", name: "Badge Access", domain: "Physical Security", status: "gap", effectiveness: 0, lastTest: "2026-02-16", nextReview: "2026-08-02", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2009", name: "Least Privilege", domain: "Access Control", status: "implemented", effectiveness: 71, lastTest: "2026-01-01", nextReview: "2026-09-21", owner: "SOC", risk: "Low" },
      { id: "CTL-2010", name: "Firewall Rules", domain: "Network Security", status: "partial", effectiveness: 14, lastTest: "2026-04-14", nextReview: "2026-10-12", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2011", name: "Disk Encryption", domain: "Endpoint Protection", status: "planned", effectiveness: 21, lastTest: "2026-03-27", nextReview: "2026-11-03", owner: "IT Ops", risk: "High" },
      { id: "CTL-2012", name: "Data Classification", domain: "Data Protection", status: "gap", effectiveness: 28, lastTest: "2026-02-12", nextReview: "2026-12-22", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2013", name: "PAM Implementation", domain: "Identity Management", status: "implemented", effectiveness: 83, lastTest: "2026-01-25", nextReview: "2026-05-13", owner: "IAM", risk: "Low" },
      { id: "CTL-2014", name: "DAST Pipeline", domain: "Application Security", status: "partial", effectiveness: 42, lastTest: "2026-04-10", nextReview: "2026-06-04", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2015", name: "IAM Policy Review", domain: "Cloud Security", status: "planned", effectiveness: 49, lastTest: "2026-03-23", nextReview: "2026-07-23", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2016", name: "Visitor Management", domain: "Physical Security", status: "gap", effectiveness: 5, lastTest: "2026-02-08", nextReview: "2026-08-14", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2017", name: "Access Reviews", domain: "Access Control", status: "implemented", effectiveness: 95, lastTest: "2026-01-21", nextReview: "2026-09-05", owner: "SOC", risk: "Low" },
      { id: "CTL-2018", name: "IDS/IPS Tuning", domain: "Network Security", status: "partial", effectiveness: 19, lastTest: "2026-04-06", nextReview: "2026-10-24", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2019", name: "Patch Management", domain: "Endpoint Protection", status: "planned", effectiveness: 26, lastTest: "2026-03-19", nextReview: "2026-11-15", owner: "IT Ops", risk: "High" },
      { id: "CTL-2020", name: "Backup Encryption", domain: "Data Protection", status: "gap", effectiveness: 33, lastTest: "2026-02-04", nextReview: "2026-12-06", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2021", name: "Password Policy", domain: "Identity Management", status: "implemented", effectiveness: 48, lastTest: "2026-01-17", nextReview: "2026-05-25", owner: "IAM", risk: "Low" },
      { id: "CTL-2022", name: "Container Scanning", domain: "Application Security", status: "partial", effectiveness: 47, lastTest: "2026-04-02", nextReview: "2026-06-16", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2023", name: "WAF Configuration", domain: "Cloud Security", status: "planned", effectiveness: 3, lastTest: "2026-03-15", nextReview: "2026-07-07", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2024", name: "CCTV Coverage", domain: "Physical Security", status: "gap", effectiveness: 10, lastTest: "2026-02-28", nextReview: "2026-08-26", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2025", name: "RBAC Enforcement", domain: "Access Control", status: "implemented", effectiveness: 60, lastTest: "2026-01-13", nextReview: "2026-09-17", owner: "SOC", risk: "Low" },
      { id: "CTL-2026", name: "VPN Management", domain: "Network Security", status: "partial", effectiveness: 24, lastTest: "2026-04-26", nextReview: "2026-10-08", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2027", name: "App Whitelisting", domain: "Endpoint Protection", status: "planned", effectiveness: 31, lastTest: "2026-03-11", nextReview: "2026-11-27", owner: "IT Ops", risk: "High" },
      { id: "CTL-2028", name: "Key Management", domain: "Data Protection", status: "gap", effectiveness: 38, lastTest: "2026-02-24", nextReview: "2026-12-18", owner: "Data Gov", risk: "Critical" },
    ];
    const gapAnalysis = [
      { gap: "Insufficient MFA coverage for legacy apps", severity: "High", remediationPlan: "Plan R3001", eta: "2026-Q4", estimatedCost: "142k" },
      { gap: "Missing network micro-segmentation", severity: "Medium", remediationPlan: "Plan R3002", eta: "2026-Q3", estimatedCost: "171k" },
      { gap: "Inconsistent EDR deployment", severity: "Medium", remediationPlan: "Plan R3003", eta: "2026-Q2", estimatedCost: "200k" },
      { gap: "DLP not covering cloud storage", severity: "Low", remediationPlan: "Plan R3004", eta: "2026-Q4", estimatedCost: "48k" },
      { gap: "SSO not integrated with all SaaS", severity: "High", remediationPlan: "Plan R3005", eta: "2026-Q3", estimatedCost: "77k" },
    ];
    return html`
  ...
  private _renderIncidentCostTracker() {
    const incidents = [
      { id: "INC-7001", name: "Security Incident 1", severity: "Critical", totalCost: 2451000, responseCost: 367650, recoveryCost: 490200, legalCost: 220590, regulatoryCost: 367650, insuranceClaim: 0, avoidedCost: 457000, date: "2026-01-01" },
      { id: "INC-7002", name: "Security Incident 2", severity: "High", totalCost: 2454000, responseCost: 539880, recoveryCost: 760740, legalCost: 147240, regulatoryCost: 245400, insuranceClaim: 858900, avoidedCost: 486000, date: "2026-04-10" },
      { id: "INC-7003", name: "Security Incident 3", severity: "Medium", totalCost: 2457000, responseCost: 712530, recoveryCost: 515970, legalCost: 466830, regulatoryCost: 122850, insuranceClaim: 0, avoidedCost: 19000, date: "2026-03-19" },
      { id: "INC-7004", name: "Security Incident 4", severity: "Low", totalCost: 2460000, responseCost: 369000, recoveryCost: 787200, legalCost: 393600, regulatoryCost: 270600, insuranceClaim: 738000, avoidedCost: 48000, date: "2026-02-28" },
      { id: "INC-7005", name: "Security Incident 5", severity: "Critical", totalCost: 2463000, responseCost: 541860, recoveryCost: 541860, legalCost: 320190, regulatoryCost: 147780, insuranceClaim: 0, avoidedCost: 77000, date: "2026-01-09" },
      { id: "INC-7006", name: "Security Incident 6", severity: "High", totalCost: 2466000, responseCost: 715140, recoveryCost: 813780, legalCost: 246600, regulatoryCost: 295920, insuranceClaim: 1874160, avoidedCost: 106000, date: "2026-04-18" },
      { id: "INC-7007", name: "Security Incident 7", severity: "Medium", totalCost: 2469000, responseCost: 370350, recoveryCost: 567870, legalCost: 172830, regulatoryCost: 172830, insuranceClaim: 0, avoidedCost: 135000, date: "2026-03-27" },
      { id: "INC-7008", name: "Security Incident 8", severity: "Low", totalCost: 2472000, responseCost: 543840, recoveryCost: 840480, legalCost: 494400, regulatoryCost: 321360, insuranceClaim: 1755120, avoidedCost: 164000, date: "2026-02-08" },
      { id: "INC-7009", name: "Security Incident 9", severity: "Critical", totalCost: 2475000, responseCost: 717750, recoveryCost: 594000, legalCost: 420750, regulatoryCost: 198000, insuranceClaim: 0, avoidedCost: 193000, date: "2026-01-17" },
      { id: "INC-7010", name: "Security Incident 10", severity: "High", totalCost: 2478000, responseCost: 371700, recoveryCost: 867300, legalCost: 346920, regulatoryCost: 346920, insuranceClaim: 1635480, avoidedCost: 222000, date: "2026-04-26" },
      { id: "INC-7011", name: "Security Incident 11", severity: "Medium", totalCost: 2481000, responseCost: 545820, recoveryCost: 620250, legalCost: 272910, regulatoryCost: 223290, insuranceClaim: 0, avoidedCost: 251000, date: "2026-03-07" },
      { id: "INC-7012", name: "Security Incident 12", severity: "Low", totalCost: 2484000, responseCost: 720360, recoveryCost: 894240, legalCost: 198720, regulatoryCost: 372600, insuranceClaim: 1515240, avoidedCost: 280000, date: "2026-02-16" },
    ];
    const yearlyTrend = [
      { month: "Jan", incidents: 12, totalCost: "452k", avgCost: "56k", insured: 53 },
      { month: "Feb", incidents: 9, totalCost: "495k", avgCost: "103k", insured: 53 },
      { month: "Mar", incidents: 6, totalCost: "538k", avgCost: "150k", insured: 53 },
      { month: "Apr", incidents: 3, totalCost: "581k", avgCost: "197k", insured: 53 },
      { month: "May", incidents: 11, totalCost: "624k", avgCost: "63k", insured: 53 },
      { month: "Jun", incidents: 8, totalCost: "667k", avgCost: "110k", insured: 53 },
    ];
...
declare global { interface HTMLElementTagNameMap { 'sc-attack-patterns': ScAttackPatterns; } }
