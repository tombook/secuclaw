...
`;
  ...
  @state() private _complianceCalendarEvents: Array<{id: string; title: string; deadline: string; category: string; status: string; assignee: string; notes: string}> = [
    {id: 'cc-purple-team-001', title: 'SOX Section 404 Compliance Review', deadline: '2026-06-30', category: 'Regulatory', status: 'In Progress', assignee: 'Compliance Team', notes: 'Annual internal control assessment for financial reporting'},
    {id: 'cc-purple-team-002', title: 'GDPR Data Protection Impact Assessment', deadline: '2026-05-15', category: 'Privacy', status: 'Pending', assignee: 'DPO Office', notes: 'Quarterly DPIA for high-risk processing activities'},
    {id: 'cc-purple-team-003', title: 'ISO 27001 Surveillance Audit', deadline: '2026-07-20', category: 'Certification', status: 'Scheduled', assignee: 'QA Lead', notes: 'Stage 2 surveillance audit for ISMS certification renewal'},
    {id: 'cc-purple-team-004', title: 'PCI DSS v4.0 Gap Analysis', deadline: '2026-05-30', category: 'Payment', status: 'Not Started', assignee: 'Security Architect', notes: 'Assess current state against PCI DSS v4.0 requirements'},
    {id: 'cc-purple-team-005', title: 'NIST CSF Self-Assessment', deadline: '2026-08-15', category: 'Framework', status: 'Pending', assignee: 'CISO', notes: 'Biannual self-assessment against NIST Cybersecurity Framework'},
    {id: 'cc-purple-team-006', title: 'HIPAA Security Rule Audit', deadline: '2026-06-15', category: 'Healthcare', status: 'In Progress', assignee: 'Compliance Analyst', notes: 'Annual audit of administrative, physical, and technical safeguards'},
    {id: 'cc-purple-team-007', title: 'SOC 2 Type II Report Renewal', deadline: '2026-09-30', category: 'Audit', status: 'Scheduled', assignee: 'External Auditor', notes: 'Engage auditor for SOC 2 Type II examination period'},
    {id: 'cc-purple-team-008', title: 'FedRAMP Authorization Review', deadline: '2026-07-01', category: 'Government', status: 'Pending', assignee: 'FedRAMP PMO', notes: 'Review and update security authorization package'},
    {id: 'cc-purple-team-009', title: 'Annual Penetration Test', deadline: '2026-10-15', category: 'Testing', status: 'Not Started', assignee: 'Red Team Lead', notes: 'Comprehensive external and internal penetration testing engagement'},
    {id: 'cc-purple-team-010', title: 'Security Awareness Training Rollout', deadline: '2026-05-01', category: 'Training', status: 'Completed', assignee: 'Security Awareness Manager', notes: 'Q2 organization-wide security awareness training program'},
    {id: 'cc-purple-team-011', title: 'Vendor Security Review Cycle', deadline: '2026-06-01', category: 'Third Party', status: 'In Progress', assignee: 'Vendor Manager', notes: 'Quarterly review of critical vendor security posture and SLA compliance'},
    {id: 'cc-purple-team-012', title: 'Incident Response Plan Update', deadline: '2026-05-20', category: 'Operations', status: 'Pending', assignee: 'IR Team Lead', notes: 'Update IR procedures based on lessons learned from recent incidents'},
  ];
  ...
  @state() private _dataQualityMetrics: Array<{id: string; dataSource: string; completenessScore: number; accuracyScore: number; timelinessScore: number; consistencyScore: number; reliabilityRank: number; lastUpdated: string; issues: string[]; trend: string}> = [
    {id: 'dq-purple-team-001', dataSource: 'Vulnerability Scanner Feed', completenessScore: 94, accuracyScore: 91, timelinessScore: 88, consistencyScore: 95, reliabilityRank: 1, lastUpdated: '2026-04-23T08:00:00Z', issues: ['Minor delay in Nessus plugin updates'], trend: 'improving'},
    {id: 'dq-purple-team-002', dataSource: 'SIEM Event Logs', completenessScore: 87, accuracyScore: 93, timelinessScore: 96, consistencyScore: 89, reliabilityRank: 2, lastUpdated: '2026-04-23T07:30:00Z', issues: ['Some log sources showing gaps in off-hours'], trend: 'stable'},
    {id: 'dq-purple-team-003', dataSource: 'Asset Inventory Database', completenessScore: 82, accuracyScore: 78, timelinessScore: 75, consistencyScore: 84, reliabilityRank: 4, lastUpdated: '2026-04-22T18:00:00Z', issues: ['Shadow IT devices not fully cataloged', 'Decommissioned assets still listed'], trend: 'declining'},
    {id: 'dq-purple-team-004', dataSource: 'Threat Intelligence Platform', completenessScore: 91, accuracyScore: 89, timelinessScore: 92, consistencyScore: 87, reliabilityRank: 3, lastUpdated: '2026-04-23T06:00:00Z', issues: ['Some IOC sources lack confidence scoring'], trend: 'improving'},
    {id: 'dq-purple-team-005', dataSource: 'Identity Provider Logs', completenessScore: 96, accuracyScore: 97, timelinessScore: 98, consistencyScore: 96, reliabilityRank: 1, lastUpdated: '2026-04-23T09:00:00Z', issues: [], trend: 'stable'},
    {id: 'dq-purple-team-006', dataSource: 'Cloud Security Posture Data', completenessScore: 79, accuracyScore: 85, timelinessScore: 82, consistencyScore: 81, reliabilityRank: 5, lastUpdated: '2026-04-23T05:00:00Z', issues: ['Multi-cloud coverage gaps', 'API rate limiting affects scan frequency'], trend: 'declining'},
    {id: 'dq-purple-team-007', dataSource: 'Compliance Evidence Store', completenessScore: 88, accuracyScore: 86, timelinessScore: 80, consistencyScore: 83, reliabilityRank: 4, lastUpdated: '2026-04-21T14:00:00Z', issues: ['Manual evidence collection delays', 'Inconsistent formatting across frameworks'], trend: 'stable'},
    {id: 'dq-purple-team-008', dataSource: 'Network Flow Data', completenessScore: 92, accuracyScore: 90, timelinessScore: 94, consistencyScore: 91, reliabilityRank: 2, lastUpdated: '2026-04-23T08:30:00Z', issues: ['Encrypted traffic classification accuracy needs improvement'], trend: 'improving'},
  ];
  ...
  @state() private _workflowTemplates: Array<{id: string; name: string; description: string; category: string; steps: number; avgDuration: string; successRate: number; lastRun: string; manualInterventions: number; optimizationScore: number}> = [
    {id: 'wf-purple-team-001', name: 'Vulnerability Triage Pipeline', description: 'Automated vulnerability assessment, prioritization, and assignment workflow', category: 'Vulnerability Management', steps: 8, avgDuration: '12 min', successRate: 94.5, lastRun: '2026-04-23T06:00:00Z', manualInterventions: 2, optimizationScore: 87},
    {id: 'wf-purple-team-002', name: 'Incident Response Orchestration', description: 'End-to-end IR workflow from detection to containment and recovery', category: 'Incident Response', steps: 15, avgDuration: '45 min', successRate: 89.2, lastRun: '2026-04-22T14:30:00Z', manualInterventions: 5, optimizationScore: 72},
    {id: 'wf-purple-team-003', name: 'Access Request Approval Chain', description: 'Multi-level approval workflow for privileged access requests', category: 'Identity & Access', steps: 6, avgDuration: '4 hours', successRate: 97.1, lastRun: '2026-04-23T09:15:00Z', manualInterventions: 1, optimizationScore: 92},
    {id: 'wf-purple-team-004', name: 'Compliance Evidence Collection', description: 'Automated gathering and packaging of audit evidence artifacts', category: 'Compliance', steps: 10, avgDuration: '30 min', successRate: 91.8, lastRun: '2026-04-21T10:00:00Z', manualInterventions: 3, optimizationScore: 78},
    {id: 'wf-purple-team-005', name: 'Security Patch Deployment', description: 'Staged patch rollout with validation and rollback capability', category: 'Patch Management', steps: 12, avgDuration: '2 hours', successRate: 96.3, lastRun: '2026-04-20T22:00:00Z', manualInterventions: 1, optimizationScore: 85},
    {id: 'wf-purple-team-006', name: 'Threat Intelligence Enrichment', description: 'IOC enrichment and correlation with internal threat data', category: 'Threat Intelligence', steps: 7, avgDuration: '8 min', successRate: 93.7, lastRun: '2026-04-23T07:00:00Z', manualInterventions: 0, optimizationScore: 95},
    {id: 'wf-purple-team-007', name: 'Security Reporting Pipeline', description: 'Automated generation and distribution of security metrics reports', category: 'Reporting', steps: 5, avgDuration: '15 min', successRate: 98.9, lastRun: '2026-04-23T08:00:00Z', manualInterventions: 0, optimizationScore: 97},
    {id: 'wf-purple-team-008', name: 'Vendor Risk Assessment', description: 'Automated vendor security questionnaire distribution and scoring', category: 'Third Party', steps: 9, avgDuration: '3 days', successRate: 85.4, lastRun: '2026-04-19T11:00:00Z', manualInterventions: 4, optimizationScore: 65},
  ];
  ...
  @state() private _workflowExecutionHistory: Array<{workflowId: string; runDate: string; duration: string; status: string; trigger: string}> = [
    {workflowId: 'wf-purple-team-001', runDate: '2026-04-23T06:00:00Z', duration: '11 min 23 sec', status: 'Success', trigger: 'Scheduled'},
    {workflowId: 'wf-purple-team-002', runDate: '2026-04-22T14:30:00Z', duration: '42 min 15 sec', status: 'Success', trigger: 'Alert'},
    {workflowId: 'wf-purple-team-003', runDate: '2026-04-23T09:15:00Z', duration: '3h 45 min', status: 'Success', trigger: 'User Request'},
    {workflowId: 'wf-purple-team-001', runDate: '2026-04-22T06:00:00Z', duration: '13 min 08 sec', status: 'Partial', trigger: 'Scheduled'},
    {workflowId: 'wf-purple-team-004', runDate: '2026-04-21T10:00:00Z', duration: '28 min 42 sec', status: 'Success', trigger: 'Scheduled'},
  ];
  ...
  @state() private _knowledgeArticles: Array<{id: string; title: string; category: string; author: string; publishDate: string; views: number; rating: number; tags: string[]; summary: string; readTime: string}> = [
    {id: 'kb-purple-team-001', title: 'Zero Trust Architecture Implementation Guide', category: 'Architecture', author: 'Security Architecture Team', publishDate: '2026-03-15', views: 1842, rating: 4.8, tags: ['zero-trust', 'network', 'identity'], summary: 'Comprehensive guide for implementing zero trust principles across enterprise infrastructure', readTime: '15 min'},
    {id: 'kb-purple-team-002', title: 'Ransomware Defense Playbook 2026', category: 'Threats', author: 'Threat Intelligence Team', publishDate: '2026-04-01', views: 2341, rating: 4.9, tags: ['ransomware', 'incident-response', 'defense'], summary: 'Updated playbook with latest ransomware tactics, techniques, and defensive measures', readTime: '12 min'},
    {id: 'kb-purple-team-003', title: 'Cloud Security Best Practices for Multi-Cloud', category: 'Cloud', author: 'Cloud Security Team', publishDate: '2026-02-28', views: 1567, rating: 4.5, tags: ['cloud', 'aws', 'azure', 'gcp'], summary: 'Best practices for securing workloads across multiple cloud service providers', readTime: '18 min'},
    {id: 'kb-purple-team-004', title: 'API Security Testing Methodology', category: 'Testing', author: 'Red Team', publishDate: '2026-03-22', views: 987, rating: 4.6, tags: ['api', 'testing', 'owasp'], summary: 'Structured methodology for identifying and testing API security vulnerabilities', readTime: '10 min'},
    {id: 'kb-purple-team-005', title: 'Supply Chain Security Risk Management', category: 'Third Party', author: 'GRC Team', publishDate: '2026-01-20', views: 1234, rating: 4.3, tags: ['supply-chain', 'vendor', 'risk'], summary: 'Framework for managing security risks in the software supply chain', readTime: '14 min'},
    {id: 'kb-purple-team-006', title: 'Kubernetes Security Hardening Checklist', category: 'Container', author: 'Platform Security', publishDate: '2026-04-10', views: 2103, rating: 4.7, tags: ['kubernetes', 'container', 'hardening'], summary: 'Step-by-step hardening checklist for production Kubernetes clusters', readTime: '11 min'},
    {id: 'kb-purple-team-007', title: 'Security Metrics That Matter for Executives', category: 'Metrics', author: 'CISO Office', publishDate: '2026-03-05', views: 876, rating: 4.4, tags: ['metrics', 'kpi', 'reporting'], summary: 'Key security metrics and KPIs that resonate with board-level stakeholders', readTime: '8 min'},
    {id: 'kb-purple-team-008', title: 'Phishing Simulation Campaign Design', category: 'Awareness', author: 'Security Awareness Team', publishDate: '2026-02-15', views: 1456, rating: 4.5, tags: ['phishing', 'simulation', 'training'], summary: 'Designing effective phishing simulations that drive real behavioral change', readTime: '9 min'},
    {id: 'kb-purple-team-009', title: 'Data Loss Prevention Strategy and Implementation', category: 'Data Protection', author: 'Data Security Team', publishDate: '2026-03-28', views: 1678, rating: 4.6, tags: ['dlp', 'data-protection', 'compliance'], summary: 'Strategic approach to DLP covering people, process, and technology layers', readTime: '16 min'},
    {id: 'kb-purple-team-010', title: 'Security Automation with SOAR Platforms', category: 'Automation', author: 'SOC Engineering', publishDate: '2026-04-05', views: 1098, rating: 4.7, tags: ['soar', 'automation', 'soc'], summary: 'Building effective security automation playbooks using SOAR technology', readTime: '13 min'},
    {id: 'kb-purple-team-011', title: 'Third-Party Risk Assessment Framework', category: 'GRC', author: 'Vendor Management', publishDate: '2026-01-30', views: 1345, rating: 4.4, tags: ['vendor', 'risk', 'assessment'], summary: 'Structured framework for evaluating and monitoring third-party security risks', readTime: '12 min'},
    {id: 'kb-purple-team-012', title: 'Network Detection and Response Best Practices', category: 'Network', author: 'Network Security Team', publishDate: '2026-03-18', views: 1567, rating: 4.5, tags: ['ndr', 'network', 'detection'], summary: 'Implementing effective network detection and response capabilities', readTime: '14 min'},
    {id: 'kb-purple-team-013', title: 'Security Chaos Engineering Guide', category: 'Resilience', author: 'SRE Security', publishDate: '2026-04-12', views: 789, rating: 4.3, tags: ['chaos-engineering', 'resilience', 'testing'], summary: 'Applying chaos engineering principles to validate security controls', readTime: '10 min'},
    {id: 'kb-purple-team-014', title: 'Incident Communication Templates', category: 'Incident Response', author: 'IR Team', publishDate: '2026-02-22', views: 2234, rating: 4.8, tags: ['incident', 'communication', 'templates'], summary: 'Ready-to-use communication templates for security incident scenarios', readTime: '7 min'},
    {id: 'kb-purple-team-015', title: 'Endpoint Detection and Response Configuration', category: 'Endpoint', author: 'Endpoint Security', publishDate: '2026-03-08', views: 1345, rating: 4.5, tags: ['edr', 'endpoint', 'configuration'], summary: 'Optimal EDR configuration for maximum detection with minimal false positives', readTime: '11 min'},
    {id: 'kb-purple-team-016', title: 'Security Code Review Standards', category: 'Development', author: 'AppSec Team', publishDate: '2026-02-10', views: 1890, rating: 4.6, tags: ['code-review', 'secure-sdlc', 'standards'], summary: 'Standards and checklists for security-focused code reviews', readTime: '13 min'},
    {id: 'kb-purple-team-017', title: 'IoT Security Assessment Methodology', category: 'IoT', author: 'IoT Security Lab', publishDate: '2026-04-08', views: 654, rating: 4.2, tags: ['iot', 'embedded', 'assessment'], summary: 'Methodology for assessing security posture of IoT devices and ecosystems', readTime: '15 min'},
    {id: 'kb-purple-team-018', title: 'Passwordless Authentication Migration Guide', category: 'Identity', author: 'IAM Team', publishDate: '2026-03-25', views: 1678, rating: 4.7, tags: ['passwordless', 'authentication', 'mfa'], summary: 'Step-by-step migration plan from password-based to passwordless authentication', readTime: '12 min'},
    {id: 'kb-purple-team-019', title: 'Security Awareness Program Metrics', category: 'Awareness', author: 'Security Culture Team', publishDate: '2026-01-25', views: 1123, rating: 4.4, tags: ['awareness', 'metrics', 'culture'], summary: 'Measuring the effectiveness of your security awareness and training programs', readTime: '9 min'},
    {id: 'kb-purple-team-020', title: 'Deception Technology Deployment Guide', category: 'Detection', author: 'Blue Team', publishDate: '2026-04-15', views: 876, rating: 4.5, tags: ['deception', 'honeypot', 'detection'], summary: 'Planning and deploying deception technology for advanced threat detection', readTime: '11 min'},
  ];
  ...
  // --- Security Scenario Planning Methods (PUTE) ---
  private _initPuteScenarios(): void {
    const worstCaseScenarios = [
      { id: "pute-sc-01", name: "Ransomware Attack on Critical Infrastructure", category: "Malware", impact: 9500000, probability: 0.12, recoveryDays: 21, affectedSystems: 47, dataLossGb: 320, businessImpact: "critical" },
      { id: "pute-sc-02", name: "Insider Data Exfiltration via Authorized Channels", category: "Insider Threat", impact: 7200000, probability: 0.18, recoveryDays: 14, affectedSystems: 12, dataLossGb: 85, businessImpact: "high" },
      { id: "pute-sc-03", name: "Supply Chain Compromise via Third-Party Library", category: "Supply Chain", impact: 6800000, probability: 0.09, recoveryDays: 30, affectedSystems: 63, dataLossGb: 0, businessImpact: "critical" },
      { id: "pute-sc-04", name: "Cloud Misconfiguration Leading to Public Exposure", category: "Cloud", impact: 4100000, probability: 0.22, recoveryDays: 7, affectedSystems: 8, dataLossGb: 450, businessImpact: "high" },
      { id: "pute-sc-05", name: "Zero-Day Exploit in Core Application Framework", category: "Vulnerability", impact: 8900000, probability: 0.05, recoveryDays: 45, affectedSystems: 120, dataLossGb: 0, businessImpact: "critical" },
      { id: "pute-sc-06", name: "Distributed Denial of Service on Customer-Facing Services", category: "Availability", impact: 3400000, probability: 0.25, recoveryDays: 3, affectedSystems: 15, dataLossGb: 0, businessImpact: "medium" },
      { id: "pute-sc-07", name: "Credential Stuffing and Account Takeover Wave", category: "Identity", impact: 2800000, probability: 0.30, recoveryDays: 5, affectedSystems: 6, dataLossGb: 12, businessImpact: "medium" },
      { id: "pute-sc-08", name: "Physical Security Breach at Data Center Facility", category: "Physical", impact: 12000000, probability: 0.02, recoveryDays: 60, affectedSystems: 200, dataLossGb: 5000, businessImpact: "critical" },
    ];
    this._puteScenarios = worstCaseScenarios.map(s => ({ ...s, mitigationCost: Math.round(s.impact * 0.08), drillScheduled: false, lastDrillDate: null, drillScore: null, controlGaps: Math.floor(Math.random() * 5) + 1 }));
  }

  private _calculatePuteScenarioRisk(): void {
    this._puteScenarios.forEach(s => {
  ...
  private _schedulePuteDrills(): void {
  ...
  private _puteScenarioComparison(): Record<string, unknown>[] {
    return this._puteScenarios.map(s => ({
  ...
  // --- Security Control Effectiveness Analytics (PUTE) ---
  private _initPuteControls(): void {
    const controls = [
      { id: "pute-ct-01", name: "Network Segmentation", type: "preventive", maturity: "defined", score: 82, target: 90, failures: 3, lastTest: "2026-03-15" },
      { id: "pute-ct-02", name: "Endpoint Detection and Response", type: "detective", maturity: "managed", score: 88, target: 92, failures: 1, lastTest: "2026-04-01" },
      { id: "pute-ct-03", name: "Data Loss Prevention", type: "preventive", maturity: "repeatable", score: 71, target: 85, failures: 7, lastTest: "2026-03-22" },
      { id: "pute-ct-04", name: "Security Information and Event Management", type: "detective", maturity: "managed", score: 85, target: 90, failures: 2, lastTest: "2026-04-05" },
      { id: "pute-ct-05", name: "Identity and Access Management", type: "preventive", maturity: "defined", score: 76, target: 88, failures: 5, lastTest: "2026-03-28" },
      { id: "pute-ct-06", name: "Vulnerability Management", type: "corrective", maturity: "managed", score: 80, target: 90, failures: 4, lastTest: "2026-04-02" },
      { id: "pute-ct-07", name: "Email Security Gateway", type: "preventive", maturity: "managed", score: 90, target: 95, failures: 1, lastTest: "2026-04-08" },
      { id: "pute-ct-08", name: "Web Application Firewall", type: "preventive", maturity: "managed", score: 87, target: 92, failures: 2, lastTest: "2026-03-30" },
      { id: "pute-ct-09", name: "Patch Management", type: "corrective", maturity: "defined", score: 68, target: 85, failures: 9, lastTest: "2026-03-18" },
      { id: "pute-ct-10", name: "Encryption at Rest", type: "preventive", maturity: "managed", score: 93, target: 95, failures: 0, lastTest: "2026-04-10" },
      { id: "pute-ct-11", name: "Encryption in Transit", type: "preventive", maturity: "optimized", score: 96, target: 98, failures: 0, lastTest: "2026-04-12" },
      { id: "pute-ct-12", name: "Privileged Access Management", type: "preventive", maturity: "defined", score: 74, target: 88, failures: 6, lastTest: "2026-03-25" },
      { id: "pute-ct-13", name: "Security Awareness Training", type: "preventive", maturity: "repeatable", score: 65, target: 80, failures: 11, lastTest: "2026-03-20" },
      { id: "pute-ct-14", name: "Incident Response Plan", type: "corrective", maturity: "managed", score: 78, target: 88, failures: 4, lastTest: "2026-04-03" },
      { id: "pute-ct-15", name: "Backup and Recovery", type: "corrective", maturity: "managed", score: 84, target: 92, failures: 3, lastTest: "2026-04-06" },
      { id: "pute-ct-16", name: "Multi-Factor Authentication", type: "preventive", maturity: "managed", score: 91, target: 95, failures: 1, lastTest: "2026-04-09" },
      { id: "pute-ct-17", name: "Network Traffic Analysis", type: "detective", maturity: "defined", score: 72, target: 85, failures: 5, lastTest: "2026-03-27" },
      { id: "pute-ct-18", name: "Cloud Security Posture Management", type: "detective", maturity: "repeatable", score: 69, target: 82, failures: 8, lastTest: "2026-03-24" },
      { id: "pute-ct-19", name: "Container Security Scanning", type: "preventive", maturity: "defined", score: 75, target: 85, failures: 5, lastTest: "2026-04-04" },
      { id: "pute-ct-20", name: "API Security Gateway", type: "preventive", maturity: "repeatable", score: 70, target: 82, failures: 7, lastTest: "2026-03-29" },
      { id: "pute-ct-21", name: "Threat Intelligence Platform", type: "detective", maturity: "managed", score: 83, target: 90, failures: 2, lastTest: "2026-04-07" },
      { id: "pute-ct-22", name: "Database Activity Monitoring", type: "detective", maturity: "defined", score: 67, target: 80, failures: 8, lastTest: "2026-03-21" },
      { id: "pute-ct-23", name: "Deception Technology", type: "detective", maturity: "initial", score: 55, target: 75, failures: 12, lastTest: "2026-03-16" },
      { id: "pute-ct-24", name: "Security Orchestration Automation", type: "corrective", maturity: "repeatable", score: 73, target: 85, failures: 6, lastTest: "2026-04-01" },
      { id: "pute-ct-25", name: "Third-Party Risk Assessment", type: "preventive", maturity: "defined", score: 64, target: 78, failures: 9, lastTest: "2026-03-19" },
    ];
    this._puteControls = controls;
  }

  private _analyzePuteControlEffectiveness(): void {
    const typeBreakdown: Record<string, { total: number; avgScore: number; avgFailures: number }> = {};
    this._puteControls.forEach(c => {
    ...
    this._puteControlTypeBreakdown = typeBreakdown;
  }

  private _puteControlOptimization(): Record<string, unknown>[] {
    return this._puteControls.filter(c => c.score < c.target).map(c => ({
  ...
  // --- Security Data Pipeline Health (PUTE) ---
  private _initPutePipelines(): void {
    const pipelines = [
      { id: "pute-pl-01", name: "SIEM Log Ingestion", status: "healthy", healthScore: 94, latencyMs: 120, freshnessMin: 2, errorRate: 0.02, throughputMbps: 450, recordsPerSec: 12000, backPressure: 0.05, uptime: 99.97 },
      { id: "pute-pl-02", name: "Threat Feed Aggregation", status: "healthy", healthScore: 91, latencyMs: 300, freshnessMin: 15, errorRate: 0.05, throughputMbps: 85, recordsPerSec: 3200, backPressure: 0.08, uptime: 99.92 },
      { id: "pute-pl-03", name: "Vulnerability Scan Results", status: "degraded", healthScore: 72, latencyMs: 2500, freshnessMin: 60, errorRate: 0.15, throughputMbps: 25, recordsPerSec: 800, backPressure: 0.35, uptime: 98.50 },
      { id: "pute-pl-04", name: "Endpoint Telemetry Stream", status: "healthy", healthScore: 88, latencyMs: 450, freshnessMin: 5, errorRate: 0.08, throughputMbps: 280, recordsPerSec: 8500, backPressure: 0.12, uptime: 99.85 },
      { id: "pute-pl-05", name: "Cloud Audit Log Pipeline", status: "healthy", healthScore: 86, latencyMs: 600, freshnessMin: 10, errorRate: 0.06, throughputMbps: 150, recordsPerSec: 4500, backPressure: 0.10, uptime: 99.80 },
      { id: "pute-pl-06", name: "Identity Event Stream", status: "warning", healthScore: 78, latencyMs: 1200, freshnessMin: 20, errorRate: 0.12, throughputMbps: 45, recordsPerSec: 1500, backPressure: 0.22, uptime: 99.40 },
      { id: "pute-pl-07", name: "Network Flow Collection", status: "healthy", healthScore: 82, latencyMs: 800, freshnessMin: 8, errorRate: 0.09, throughputMbps: 650, recordsPerSec: 18000, backPressure: 0.15, uptime: 99.70 },
      { id: "pute-pl-08", name: "DLP Incident Pipeline", status: "degraded", healthScore: 68, latencyMs: 3500, freshnessMin: 45, errorRate: 0.20, throughputMbps: 18, recordsPerSec: 500, backPressure: 0.42, uptime: 97.80 },
    ];
    this._putePipelines = pipelines.map(p => ({ ...p, dependencies: [], slaBreached: p.healthScore < 75, alertThreshold: p.errorRate > 0.15 }));
    this._putePipelines[0].dependencies = ["pute-pl-04", "pute-pl-07"];
    this._putePipelines[4].dependencies = ["pute-pl-01"];
    this._putePipelines[5].dependencies = ["pute-pl-02"];
    this._putePipelines[7].dependencies = ["pute-pl-04", "pute-pl-05"];
  }

  private _putePipelineTrend(): Record<string, unknown>[] {
    const hours = Array.from({ length: 24 }, (_, i) => `H${String(i).padStart(2, "0")}`);
    return this._putePipelines.map(p => ({
  ...
  // --- Security Stakeholder Report Generator (PUTE) ---
  private _initPuteReportTemplates(): void {
    this._puteReportTemplates = [
      { id: "pute-rp-01", name: "Board Security Report", audience: "board", frequency: "quarterly", sections: 6, autoGenerate: true, lastGenerated: "2026-03-31", pages: 12 },
      { id: "pute-rp-02", name: "Executive Risk Summary", audience: "executive", frequency: "monthly", sections: 8, autoGenerate: true, lastGenerated: "2026-04-01", pages: 8 },
      { id: "pute-rp-03", name: "Technical Security Review", audience: "technical", frequency: "weekly", sections: 12, autoGenerate: true, lastGenerated: "2026-04-21", pages: 25 },
      { id: "pute-rp-04", name: "Audit Compliance Report", audience: "audit", frequency: "quarterly", sections: 10, autoGenerate: false, lastGenerated: "2026-03-15", pages: 35 },
      { id: "pute-rp-05", name: "Regulatory Filing Package", audience: "regulatory", frequency: "annual", sections: 15, autoGenerate: false, lastGenerated: "2025-12-31", pages: 48 },
    ];
  }

  private _generatePuteExecSummary(): string {
    const totalRisk = this._puteScenarios.reduce((sum: number, s: any) => sum + s.riskScore, 0);
    const avgControl = Math.round(this._puteControls.reduce((sum: number, c: any) => sum + c.score, 0) / this._puteControls.length);
    const degradedPipes = this._putePipelines.filter((p: any) => p.status !== "healthy").length;
    return `Overall risk exposure: ${(totalRisk / 1000000).toFixed(1)}M. Average control effectiveness: {avgControl}%. {degradedPipes} pipeline(s) need attention. {this._puteScenarios.filter((s: any) => s.mitigationPriority === "immediate").length} scenarios require immediate action.`;
  }

  // --- Security Technology Radar (PUTE) ---
  private _initPuteTechRadar(): void {
    this._puteTechRadar = [
      { id: "pute-tr-01", name: "AI-Powered Threat Detection", ring: "adopt", category: "Detection", maturity: 4, trend: "up", investment: "high", roi: 3.2, vendorCount: 8 },
      { id: "pute-tr-02", name: "Zero Trust Architecture", ring: "adopt", category: "Architecture", maturity: 4, trend: "up", investment: "high", roi: 2.8, vendorCount: 12 },
      { id: "pute-tr-03", name: "SASE/SSE Platform", ring: "trial", category: "Network", maturity: 3, trend: "up", investment: "medium", roi: 2.4, vendorCount: 10 },
      { id: "pute-tr-04", name: "CNAPP Cloud Security", ring: "trial", category: "Cloud", maturity: 3, trend: "up", investment: "medium", roi: 2.1, vendorCount: 7 },
      { id: "pute-tr-05", name: "Extended Detection and Response", ring: "adopt", category: "Detection", maturity: 4, trend: "stable", investment: "high", roi: 2.9, vendorCount: 9 },
      { id: "pute-tr-06", name: "Quantum-Safe Cryptography", ring: "assess", category: "Crypto", maturity: 2, trend: "up", investment: "low", roi: 0.8, vendorCount: 4 },
      { id: "pute-tr-07", name: "Security Service Edge", ring: "trial", category: "Network", maturity: 3, trend: "up", investment: "medium", roi: 2.0, vendorCount: 6 },
      { id: "pute-tr-08", name: "SOAR 2.0 Autonomous SOC", ring: "assess", category: "Operations", maturity: 2, trend: "up", investment: "low", roi: 1.2, vendorCount: 5 },
      { id: "pute-tr-09", name: "Software Supply Chain Security", ring: "trial", category: "DevSecOps", maturity: 3, trend: "up", investment: "medium", roi: 2.3, vendorCount: 8 },
      { id: "pute-tr-10", name: "Identity Threat Detection", ring: "adopt", category: "Identity", maturity: 3, trend: "up", investment: "high", roi: 2.7, vendorCount: 7 },
      { id: "pute-tr-11", name: "Data Security Posture Management", ring: "trial", category: "Data", maturity: 3, trend: "up", investment: "medium", roi: 2.2, vendorCount: 9 },
      { id: "pute-tr-12", name: "Decentralized Identity Standards", ring: "hold", category: "Identity", maturity: 1, trend: "stable", investment: "low", roi: 0.5, vendorCount: 3 },
    ];
  }

  private _puteRadarSummary(): Record<string, unknown> {
    const rings: Record<string, number> = { adopt: 0, trial: 0, assess: 0, hold: 0 };
    this._puteTechRadar.forEach(t => { if (rings[t.ring as keyof typeof rings] !== undefined) rings[t.ring as keyof typeof rings]++; });
    return { adopt: rings.adopt, trial: rings.trial, assess: rings.assess, hold: rings.hold, total: this._puteTechRadar.length, avgMaturity: 2.8, topInvestment: this._puteTechRadar.filter(t => t.investment === "high").map(t => t.name) };
  }

  // --- PUTE Security Compliance Mapping Matrix ---
  private _initPuteComplianceMatrix(): void {
    ...
    this._puteComplianceMatrix = frameworks.map(fw => ({
  ...
  private _puteComplianceTrend(): Record<string, unknown>[] {
    const quarters = ["Q1-2025", "Q2-2025", "Q3-2025", "Q4-2025", "Q1-2026", "Q2-2026"];
    return this._puteComplianceMatrix.map(fw => ({
  ...
  // --- PUTE Threat Intelligence Correlation Engine ---
  private _initPuteThreatIntel(): void {
    ...
    this._puteThreatIntel = threatActors.map((actor, i) => ({
  ...
  private _puteThreatCorrelation(): Record<string, unknown>[] {
    return this._puteThreatIntel.filter(t => t.riskScore > 70).map(t => ({
  ...
  // --- PUTE Security Metrics Deep Dive ---
  private _initPuteMetricsDeep(): void {
    ...
    this._puteMetricsDeep = metricCategories.map(cat => ({
  ...
  private _puteMetricsHeatmap(): number[][] {
    return this._puteMetricsDeep.map(cat =>
      cat.metrics.map(m => Math.round((m.value / m.target) * 100))
    );
  }

  // --- PUTE Incident Cost Modeling ---
  private _initPuteCostModel(): void {
    const incidentTypes = ["Data Breach", "Ransomware", "DDoS", "Insider Threat", "Phishing", "Supply Chain", "Cloud Misconfig", "Zero-Day"];
    this._puteCostModel = incidentTypes.map(inc => ({
    ...
    this._puteCostModel.forEach(m => { m.totalAnnualExposure = m.avgCost * m.frequency; });
  }

  private _puteCostProjection(): Record<string, unknown>[] {
    return this._puteCostModel.map(m => ({
  ...
  // --- PUTE Security Architecture Pattern Library ---
  private _initPuteArchPatterns(): void {
    ...
    this._puteArchPatterns = patterns.map((p, i) => ({
  ...
  private _puteArchPatternAnalysis(): Record<string, unknown> {
    const implemented = this._puteArchPatterns.filter(p => p.implementation > 75).length;
    const avgCoverage = Math.round(this._puteArchPatterns.reduce((s: number, p: any) => s + p.coverage, 0) / this._puteArchPatterns.length);
    return {
      totalPatterns: this._puteArchPatterns.length, fullyImplemented: implemented, avgCoverage,
      avgRiskReduction: Math.round(this._puteArchPatterns.reduce((s: number, p: any) => s + p.riskReduction, 0) / this._puteArchPatterns.length),
      gaps: this._puteArchPatterns.filter(p => p.implementation < 60).map(p => p.pattern),
      recommendations: this._puteArchPatterns.filter(p => p.implementation < 70).map(p => ({ pattern: p.pattern, current: p.implementation, target: 85, effort: p.costComplexity }))
    };
  }
  ...
  private _9cdRiskAssessmentWorkflow = [
  ...
  private _9cdTreatmentOptions = [
    {id: '9cd-T-001', riskId: 'RSK-042', risk: 'Ransomware Attack on Critical Infrastructure', before: 20, after: 6, strategy: 'Mitigate', controls: ['Next-gen EDR with behavioral detection and automated response', 'Zero-trust network micro-segmentation isolating critical assets', 'Immutable offline backup rotation with quarterly recovery testing', 'Incident response retainer with 1-hour response SLA'], cost: '$450K/yr', roi: '78% reduction vs $2.8M potential loss', timeline: 'Q3 2026', status: 'approved' as const},
  ...
  private _9cdTalentPositions = [
    ...
    {id: '9cd-H-002', title: 'Cloud Security Engineer', dept: 'Cloud Security', level: 'Mid-Senior', loc: 'SF/Remote', salary: '$155K-$180K', posted: '2026-03-20', applicants: 45, pipeline: 12, interviews: 6, offers: 2, urgency: 'high' as const, manager: 'Mike Johnson', skills: ['AWS/Azure/GCP', 'Terraform', 'Kubernetes', 'IAM', 'CSPM'], nice: ['CCSP', 'CKS', 'Serverless']},
    {id: '9cd-H-003', title: 'SOC Analyst L2', dept: 'Security Operations', level: 'Mid', loc: 'Austin TX', salary: '$105K-$130K', posted: '2026-04-01', applicants: 67, pipeline: 18, interviews: 8, offers: 0, urgency: 'medium' as const, manager: 'Lisa Park', skills: ['SIEM', 'Incident triage', 'Malware analysis', 'TCP/IP'], nice: ['GCIA', 'SOAR', 'Kill chain']},
    {id: '9cd-H-004', title: 'Staff Security Architect', dept: 'Architecture', level: 'Staff', loc: 'Remote US', salary: '$200K-$240K', posted: '2026-02-28', applicants: 12, pipeline: 3, interviews: 2, offers: 0, urgency: 'critical' as const, manager: 'David Lee', skills: ['Enterprise arch', 'Zero trust', 'Risk frameworks', 'Board comms'], nice: ['CISSP+SABSA', 'Team building', 'Speaker']},
    {id: '9cd-H-005', title: 'GRC Analyst', dept: 'GRC', level: 'Mid', loc: 'NY/Remote', salary: '$110K-$135K', posted: '2026-04-05', applicants: 34, pipeline: 9, interviews: 3, offers: 1, urgency: 'medium' as const, manager: 'Rachel Green', skills: ['ISO 27001', 'SOC 2', 'Risk assessment', 'Audit'], nice: ['CRISC', 'CISA', 'GDPR']},
    {id: '9cd-H-006', title: 'Threat Intel Analyst', dept: 'Threat Intel', level: 'Mid-Senior', loc: 'Remote US', salary: '$140K-$170K', posted: '2026-03-25', applicants: 19, pipeline: 5, interviews: 2, offers: 0, urgency: 'low' as const, manager: 'James Wilson', skills: ['MITRE ATT&CK', 'OSINT', 'Threat modeling', 'Reverse eng'], nice: ['CTIA', 'Nation-state', 'Dark web']},
    {id: '9cd-H-007', title: 'AppSec Engineer', dept: 'AppSec', level: 'Senior', loc: 'Seattle/Remote', salary: '$160K-$190K', posted: '2026-04-10', applicants: 28, pipeline: 7, interviews: 3, offers: 0, urgency: 'medium' as const, manager: 'Emily Zhang', skills: ['SAST/DAST/SCA', 'Secure SDLC', 'Code review', 'CI/CD'], nice: ['CSSLP', 'Mobile security']},
    {id: '9cd-H-008', title: 'IAM Engineer', dept: 'IAM', level: 'Mid', loc: 'Remote US', salary: '$135K-$160K', posted: '2026-04-08', applicants: 31, pipeline: 10, interviews: 5, offers: 1, urgency: 'medium' as const, manager: 'Chris Martinez', skills: ['Okta/Azure AD', 'SAML/OIDC', 'PAM', 'RBAC'], nice: ['CISSP', 'Zero trust IAM']}
  ];

  private _9cdInterviewScorecard = [
  ...
  private _9cdOnboardingSteps = [
    {id: '9cd-OB-01', item: 'Provision security-hardened laptop, monitors, peripherals, and configured workstation image with all required security tools', cat: 'IT Setup', day: 'Day 1', owner: 'IT Operations'},
    {id: '9cd-OB-02', item: 'Create AD account, email, Slack, VPN, SSO enrollment, and all required application access accounts', cat: 'Access', day: 'Day 1', owner: 'IAM Team'},
    {id: '9cd-OB-03', item: 'Grant security tooling access: SIEM console, EDR dashboard, vuln scanner, pentest platforms, SOAR', cat: 'Tools', day: 'Day 1-2', owner: 'SOC Manager'},
    {id: '9cd-OB-04', item: 'Complete MFA enrollment, security awareness onboarding course, and acceptable use policy acknowledgment', cat: 'Security', day: 'Day 1', owner: 'Awareness Team'},
    {id: '9cd-OB-05', item: 'Sign NDA, employment agreement, IP assignment, and code of conduct documents with HR', cat: 'HR', day: 'Day 1', owner: 'Human Resources'},
    {id: '9cd-OB-06', item: 'Introduction meetings with direct team members and key cross-functional stakeholders', cat: 'Integration', day: 'Week 1', owner: 'Hiring Manager'},
    {id: '9cd-OB-07', item: 'Security architecture overview, tooling walkthrough, and operational runbook review sessions', cat: 'Training', day: 'Week 1-2', owner: 'Security Architect'},
    {id: '9cd-OB-08', item: 'Shadow experienced team member on active incident response and threat hunting investigations', cat: 'Mentoring', day: 'Week 2-3', owner: 'SOC Lead'},
    {id: '9cd-OB-09', item: 'Set up individual certification study plan aligned with role requirements and career goals', cat: 'Development', day: 'Week 2', owner: 'Hiring Manager'},
    {id: '9cd-OB-10', item: 'Establish 30-60-90 day goals, define success metrics, and schedule first performance checkpoint', cat: 'Goals', day: 'Week 1', owner: 'Hiring Manager'}
  ];

  private _9cdMetricsDashboard = [
    {id: '9cd-MTD-001', name: 'Mean Time to Detect (MTTD)', value: '4.2 hours', trend: 'improving' as const, target: '< 4 hours', source: 'SIEM - Splunk', method: 'Median time from first alert to analyst acknowledgment', owner: 'SOC Manager', sla: '4 hours', prev: '5.1 hours', spark: [5.8, 5.4, 5.1, 4.9, 4.7, 4.5, 4.3, 4.2], breakdown: [{src: 'Network IDS', pct: '35%', avg: '3.8h'}, {src: 'Endpoint EDR', pct: '28%', avg: '4.1h'}, {src: 'Email Gateway', pct: '22%', avg: '3.5h'}, {src: 'Cloud Security', pct: '10%', avg: '5.2h'}, {src: 'User Reports', pct: '5%', avg: '6.8h'}]},
    {id: '9cd-MTD-002', name: 'Mean Time to Respond (MTTR)', value: '2.8 hours', trend: 'stable' as const, target: '< 3 hours', source: 'SOAR - XSOAR', method: 'Median time from acknowledgment to first containment action', owner: 'IR Lead', sla: '3 hours', prev: '2.7 hours', spark: [3.2, 3.0, 2.9, 2.8, 2.8, 2.9, 2.8, 2.8], breakdown: [{src: 'Auto Playbooks', pct: '42%', avg: '1.2h'}, {src: 'Semi-Auto', pct: '33%', avg: '2.5h'}, {src: 'Manual', pct: '20%', avg: '5.1h'}, {src: 'L3 Escalation', pct: '5%', avg: '8.3h'}]},
    {id: '9cd-MTD-003', name: 'Patch Compliance Rate', value: '97.6%', trend: 'improving' as const, target: '> 95%', source: 'Tenable.io', method: 'Pct of critical/high vulns patched within SLA windows', owner: 'Vuln Manager', sla: '95%', prev: '96.1%', spark: [93.2, 94.1, 94.8, 95.3, 95.9, 96.4, 97.0, 97.6], breakdown: [{src: 'Critical (7d)', pct: '40%', rate: '99.2%'}, {src: 'High (30d)', pct: '35%', rate: '97.8%'}, {src: 'Medium (90d)', pct: '20%', rate: '95.1%'}, {src: 'Low (180d)', pct: '5%', rate: '89.4%'}]},
    {id: '9cd-MTD-004', name: 'Phishing Click Rate', value: '3.2%', trend: 'improving' as const, target: '< 5%', source: 'KnowBe4 + Proofpoint', method: 'Pct of users clicking simulated phishing links monthly', owner: 'Awareness Lead', sla: '5%', prev: '4.1%', spark: [6.8, 6.2, 5.5, 5.1, 4.6, 4.1, 3.6, 3.2], breakdown: [{src: 'Spear Phishing', pct: '35%', rate: '5.1%'}, {src: 'Generic Phishing', pct: '30%', rate: '2.8%'}, {src: 'BEC Sim', pct: '20%', rate: '3.5%'}, {src: 'SMS Phishing', pct: '15%', rate: '1.9%'}]},
    {id: '9cd-MTD-005', name: 'Security Posture Score', value: '784', trend: 'improving' as const, target: '> 750', source: 'SecurityScorecard', method: 'Composite: external 30%, compliance 25%, vuln 25%, config 20%', owner: 'CISO', sla: '> 750', prev: '771', spark: [748, 752, 758, 762, 768, 773, 778, 784], breakdown: [{src: 'External Rating', pct: '30%', score: '791'}, {src: 'Compliance', pct: '25%', score: '812'}, {src: 'Vuln Mgmt', pct: '25%', score: '745'}, {src: 'Config', pct: '20%', score: '769'}]},
    {id: '9cd-MTD-006', name: 'Vulnerability Backlog', value: '142', trend: 'improving' as const, target: '< 150', source: 'Tenable + Qualys', method: 'Total open vulns across all scanned assets tracked weekly', owner: 'Vuln Manager', sla: '< 150', prev: '168', spark: [210, 198, 185, 175, 165, 158, 150, 142], breakdown: [{src: 'Critical', pct: '8%', count: '11'}, {src: 'High', pct: '22%', count: '31'}, {src: 'Medium', pct: '45%', count: '64'}, {src: 'Low', pct: '25%', count: '36'}]}
  ];

  private _9cdArchReview = [
    {id: '9cd-AR-001', cat: 'Network', item: 'Network segmentation between trust zones with dedicated firewalls and granular ACLs', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Micro-segmentation via NSX across all production zones'},
    {id: '9cd-AR-002', cat: 'Network', item: 'DMZ architecture isolating public services from internal network', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Dual-firewall DMZ with WAF and DDoS mitigation'},
    {id: '9cd-AR-003', cat: 'Network', item: 'Least-privilege traffic flows with deny-by-default and quarterly review', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Explicit allow rules with automated drift detection'},
    {id: '9cd-AR-004', cat: 'Network', item: 'Encrypted external communications with IPSec/TLS 1.3 and PFS', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'IKEv2 with PFS, TLS 1.3 for all external APIs'},
    {id: '9cd-AR-005', cat: 'Identity', item: 'Centralized IdP with SSO and automated SCIM provisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Okta SSO SAML 2.0 for 247 apps with SCIM'},
    {id: '9cd-AR-006', cat: 'Identity', item: 'RBAC with quarterly reviews and automated deprovisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Quarterly recertification with JIT admin access'},
    {id: '9cd-AR-007', cat: 'Identity', item: 'PAM controlling all admin and service accounts with session recording', sev: 'high' as const, status: 'fail' as const, reviewer: 'IAM Lead', notes: '3 legacy accounts pending CyberArk enrollment'},
    {id: '9cd-AR-008', cat: 'Identity', item: 'MFA enforced for all users, hardware tokens for privileged access', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'FIDO2 for admins, push MFA for users, 99.8% enrollment'},
    {id: '9cd-AR-009', cat: 'Data', item: 'Data classification enforced with automated labeling on all repos', sev: 'high' as const, status: 'partial' as const, reviewer: 'Data Protection Lead', notes: 'Framework deployed, gaps on 4 legacy file shares'},
    {id: '9cd-AR-010', cat: 'Data', item: 'AES-256 encryption at rest for all sensitive data stores', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'Full-disk, TDE on DBs, SSE-KMS on cloud storage'},
    {id: '9cd-AR-011', cat: 'Data', item: 'DLP monitoring and preventing unauthorized data exfiltration', sev: 'high' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'DLP active on email, endpoint, cloud, and network'},
    {id: '9cd-AR-012', cat: 'Data', item: 'Encrypted off-site backups with quarterly restore testing', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Infrastructure Lead', notes: '3-2-1 strategy with immutable backups'},
    {id: '9cd-AR-013', cat: 'AppSec', item: 'Secure SDLC with SAST, DAST, SCA in all CI/CD pipelines', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: '34 pipelines with security gates and PR blocking'},
    {id: '9cd-AR-014', cat: 'AppSec', item: 'API gateway with auth, rate limiting, schema validation', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: 'Kong with OAuth2, rate limits, OpenAPI validation'},
    {id: '9cd-AR-015', cat: 'AppSec', item: 'Container security with image scanning and runtime protection', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Trivy scanning, Falco runtime in 80% of clusters'},
    {id: '9cd-AR-016', cat: 'Monitoring', item: 'SIEM collecting from all critical systems with correlation rules', sev: 'critical' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'Splunk 98% coverage with 1200+ correlation rules'},
    {id: '9cd-AR-017', cat: 'Monitoring', item: 'EDR with behavioral detection on all managed endpoints', sev: 'high' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'CrowdStrike on 99.2% endpoints with 24/7 MDR'},
    {id: '9cd-AR-018', cat: 'Monitoring', item: 'Executive dashboards with real-time posture visibility', sev: 'medium' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'PowerBI dashboards with weekly exec summaries'},
    {id: '9cd-AR-019', cat: 'Cloud', item: 'CSPM monitoring and remediating cloud misconfigurations', sev: 'high' as const, status: 'pass' as const, reviewer: 'Cloud Security Lead', notes: 'Prisma Cloud 450+ checks with auto-remediation'},
    {id: '9cd-AR-020', cat: 'Cloud', item: 'IaC templates scanned before deployment to production', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Checkov for Terraform, cfn-nag for CloudFormation pending'}
  ];

  private _get9cdRiskProgress(): number {
    return Math.round(this._9cdRiskAssessmentWorkflow.filter(s => s.status === 'completed').length / this._9cdRiskAssessmentWorkflow.length * 100);
  }

  private _get9cdTreatmentSummary(): {total: number; approved: number; avgReduction: number; investment: string} {
    const a = this._9cdTreatmentOptions.filter(r => r.status === 'approved').length;
    const avg = this._9cdTreatmentOptions.reduce((s, r) => s + ((r.before - r.after) / r.before * 100), 0) / this._9cdTreatmentOptions.length;
    return {total: this._9cdTreatmentOptions.length, approved: a, avgReduction: Math.round(avg), investment: '$1.125M annually'};
  }

  private _get9cdRuleSummary(): {total: number; passing: number; failing: number; avgRate: number; violations: number} {
    const p = this._9cdComplianceRules.filter(r => r.result === 'pass').length;
    const f = this._9cdComplianceRules.filter(r => r.result === 'fail').length;
    const avg = this._9cdComplianceRules.reduce((s, r) => s + r.passRate, 0) / this._9cdComplianceRules.length;
    const v = this._9cdComplianceRules.reduce((s, r) => s + r.violations, 0);
    return {total: this._9cdComplianceRules.length, passing: p, failing: f, avgRate: Math.round(avg * 10) / 10, violations: v};
  }

  private _get9cdPipelineStats(): {positions: number; applicants: number; interviewing: number; offers: number; critical: number} {
    const t = this._9cdTalentPositions.length;
    const a = this._9cdTalentPositions.reduce((s, p) => s + p.applicants, 0);
    const i = this._9cdTalentPositions.reduce((s, p) => s + p.interviews, 0);
    const o = this._9cdTalentPositions.reduce((s, p) => s + p.offers, 0);
    const c = this._9cdTalentPositions.filter(x => x.urgency === 'critical').length;
    return {positions: t, applicants: a, interviewing: i, offers: o, critical: c};
  }

  private _get9cdMetricTrends(): {improving: number; stable: number; total: number} {
    const imp = this._9cdMetricsDashboard.filter(m => m.trend === 'improving').length;
    const stb = this._9cdMetricsDashboard.filter(m => m.trend === 'stable').length;
    return {improving: imp, stable: stb, total: this._9cdMetricsDashboard.length};
  }

  private _get9cdArchScore(): {total: number; passed: number; failed: number; partial: number; score: number} {
    const p = this._9cdArchReview.filter(c => c.status === 'pass').length;
    const f = this._9cdArchReview.filter(c => c.status === 'fail').length;
    const pa = this._9cdArchReview.filter(c => c.status === 'partial').length;
    return {total: this._9cdArchReview.length, passed: p, failed: f, partial: pa, score: Math.round((p / this._9cdArchReview.length) * 100)};
  }


  private _z9cdIncidentScenarios = [
    {id: 'z9cd-IS-001', name: 'Ransomware Outbreak in Production Environment', category: 'Malware', likelihood: 'Medium', impact: 'Critical', riskScore: 15, playbooks: ['IR-Ransomware-Isolate', 'IR-Ransomware-Eradicate', 'IR-Ransomway-Recover'], estimatedMTTD: '15min', estimatedMTTR: '4h', involvedTeams: ['SOC', 'IR', 'Infrastructure', 'Legal', 'Comms'], keyIndicators: ['Mass file encryption events', 'Ransom note deployment', 'Lateral movement via SMB/RDP', 'Backup deletion attempts'], mitigationControls: ['EDR behavioral detection', 'Network segmentation', 'Immutable backups', 'Email filtering'], lessonsLearned: 'Ensure offline backups are tested quarterly and Ransomware-specific playbooks are updated with latest threat intelligence', lastDrillDate: '2026-03-15', nextDrillDate: '2026-06-15'},
    {id: 'z9cd-IS-002', name: 'Cloud Misconfiguration Leading to Data Exposure', category: 'Cloud', likelihood: 'High', impact: 'High', riskScore: 16, playbooks: ['IR-Cloud-Misconfig-Assess', 'IR-Cloud-Misconfig-Remediate', 'IR-Cloud-Misconfig-Notify'], estimatedMTTD: '2h', estimatedMTTR: '6h', involvedTeams: ['Cloud Security', 'SOC', 'Data Protection', 'Legal'], keyIndicators: ['Public S3 bucket exposure', 'Overly permissive IAM policies', 'Unencrypted database snapshots', 'Public API endpoint discovery'], mitigationControls: ['CSPM monitoring', 'IAM policy analyzer', 'Automated remediation', 'Cloud audit logging'], lessonsLearned: 'Implement CSPM with auto-remediation for common misconfigurations and conduct monthly cloud configuration reviews', lastDrillDate: '2026-02-20', nextDrillDate: '2026-05-20'},
    {id: 'z9cd-IS-003', name: 'Insider Threat Data Exfiltration', category: 'Insider', likelihood: 'Low', impact: 'Critical', riskScore: 12, playbooks: ['IR-Insider-Investigate', 'IR-Insider-Contain', 'IR-Insider-Escalate'], estimatedMTTD: '8h', estimatedMTTR: '24h', involvedTeams: ['SOC', 'IR', 'HR', 'Legal', 'IAM'], keyIndicators: ['Anomalous data access patterns', 'Large file downloads to USB or cloud', 'Off-hours access to sensitive systems', 'Accessing data outside normal job scope'], mitigationControls: ['UEBA analytics', 'DLP policies', 'PAM controls', 'Access reviews'], lessonsLearned: 'Strengthen UEBA baselines and implement automated alerts for data access pattern anomalies', lastDrillDate: '2026-01-10', nextDrillDate: '2026-04-10'},
    {id: 'z9cd-IS-004', name: 'Supply Chain Attack via Compromised Vendor Software', category: 'Supply Chain', likelihood: 'Low', impact: 'Critical', riskScore: 12, playbooks: ['IR-SupplyChain-Detect', 'IR-SupplyChain-Isolate', 'IR-SupplyChain-Remediate'], estimatedMTTD: '24h', estimatedMTTR: '72h', involvedTeams: ['SOC', 'IR', 'Procurement', 'Vendor Mgmt', 'Legal'], keyIndicators: ['Unexpected network connections from vendor software', 'Modified binaries or dependencies', 'Anomalous behavior from trusted applications', 'SBOM discrepancy alerts'], mitigationControls: ['SCA scanning', 'SBOM monitoring', 'Vendor security assessments', 'Network segmentation'], lessonsLearned: 'Require SBOM from all vendors and implement continuous monitoring of third-party component behavior', lastDrillDate: '2026-03-01', nextDrillDate: '2026-06-01'},
    {id: 'z9cd-IS-005', name: 'Credential Stuffing Attack on Customer Portal', category: 'External Attack', likelihood: 'High', impact: 'Medium', riskScore: 12, playbooks: ['IR-CredentialStuffing-Detect', 'IR-CredentialStuffing-Block', 'IR-CredentialStuffing-Notify'], estimatedMTTD: '30min', estimatedMTTR: '2h', involvedTeams: ['SOC', 'AppSec', 'Customer Support', 'Comms'], keyIndicators: ['High volume of failed login attempts', 'Login attempts from known compromised credential lists', 'Unusual geographic distribution of login attempts', 'Account takeover indicators'], mitigationControls: ['WAF rate limiting', 'CAPTCHA on login', 'MFA enforcement', 'Credential monitoring service'], lessonsLearned: 'Deploy advanced bot detection on login endpoints and implement proactive credential monitoring for customer accounts', lastDrillDate: '2026-04-01', nextDrillDate: '2026-07-01'},
    {id: 'z9cd-IS-006', name: 'Phishing Campaign Targeting Executive Team', category: 'Social Engineering', likelihood: 'High', impact: 'High', riskScore: 16, playbooks: ['IR-Phishing-Contain', 'IR-Phishing-Investigate', 'IR-Phishing-Notify'], estimatedMTTD: '1h', estimatedMTTR: '4h', involvedTeams: ['SOC', 'Awareness', 'Executive Office', 'IT'], keyIndicators: ['Sophisticated spear-phishing emails to C-suite', 'Business email compromise indicators', 'Redirected MFA approval requests', 'Unauthorized wire transfer attempts'], mitigationControls: ['AI email filtering', 'Executive awareness training', 'Out-of-band verification policy', 'DMARC/DKIM/SPF'], lessonsLearned: 'Implement additional email security controls for executive mailboxes and conduct monthly spear-phishing simulations', lastDrillDate: '2026-02-15', nextDrillDate: '2026-05-15'}
  ];

  private _z9cdSecurityFrameworks = [
  ...
  private _getz9cdScenarioSummary(): {total: number; critical: number; high: number; drilled: number; avgRiskScore: number} {
    const crit = this._z9cdIncidentScenarios.filter(s => s.impact === 'Critical').length;
    const high = this._z9cdIncidentScenarios.filter(s => s.impact === 'High').length;
    const avg = this._z9cdIncidentScenarios.reduce((s, x) => s + x.riskScore, 0) / this._z9cdIncidentScenarios.length;
    return {total: this._z9cdIncidentScenarios.length, critical: crit, high: high, drilled: this._z9cdIncidentScenarios.length, avgRiskScore: Math.round(avg)};
  }

  private _getz9cdVendorRiskSummary(): {total: number; approved: number; conditional: number; remediation: number; avgScore: number} {
    const approved = this._z9cdThirdPartyRiskData.filter(v => v.status === 'approved').length;
    const cond = this._z9cdThirdPartyRiskData.filter(v => v.status === 'conditional').length;
    const rem = this._z9cdThirdPartyRiskData.filter(v => v.status === 'remediation_required').length;
    const avg = this._z9cdThirdPartyRiskData.reduce((s, v) => s + v.riskScore, 0) / this._z9cdThirdPartyRiskData.length;
    return {total: this._z9cdThirdPartyRiskData.length, approved, conditional: cond, remediation: rem, avgScore: Math.round(avg)};
  }

  private _getz9cdTrainingSummary(): {total: number; avgCompletion: number; avgScore: number; overdueUpdates: number} {
    const avgComp = this._z9cdSecurityTrainingCatalog.reduce((s, t) => s + t.completionRate, 0) / this._z9cdSecurityTrainingCatalog.length;
    const avgScore = this._z9cdSecurityTrainingCatalog.filter(t => t.avgScore > 0).reduce((s, t) => s + t.avgScore, 0) / this._z9cdSecurityTrainingCatalog.filter(t => t.avgScore > 0).length;
    return {total: this._z9cdSecurityTrainingCatalog.length, avgCompletion: Math.round(avgComp * 10) / 10, avgScore: Math.round(avgScore), overdueUpdates: 0};
  }

  private _getz9cdToolHealthSummary(): {total: number; healthy: number; degraded: number; annualCost: string} {
    const healthy = this._z9cdSecurityToolInventory.filter(t => t.health === 'healthy').length;
    const degraded = this._z9cdSecurityToolInventory.filter(t => t.health === 'degraded').length;
    const cost = this._z9cdSecurityToolInventory.reduce((s, t) => s + parseInt(t.annualCost.replace(/[^0-9]/g, '')), 0);
    return {total: this._z9cdSecurityToolInventory.length, healthy, degraded, annualCost: '$' + (cost / 1000).toFixed(0) + 'K'};
  }


  private _x9cdSecurityZones = [
    {zoneId: 'x9cd-Z-001', name: 'Internet DMZ', trustLevel: 'Untrusted', subnet: '10.0.0.0/24', segmentation: 'Dual-firewall', firewallRules: 45, monitoring: 'Full packet capture', assets: ['Web servers', 'Load balancers', 'WAF appliances', 'Reverse proxy'], riskLevel: 'high' as const, lastAssessment: '2026-04-15', nextAssessment: '2026-07-15'},
    {zoneId: 'x9cd-Z-002', name: 'Corporate Network', trustLevel: 'Trusted', subnet: '10.1.0.0/16', segmentation: 'VLAN + micro-seg', firewallRules: 128, monitoring: 'NetFlow + IDS', assets: ['Workstations', 'Printers', 'Meeting room systems', 'VoIP phones'], riskLevel: 'medium' as const, lastAssessment: '2026-04-10', nextAssessment: '2026-07-10'},
    ...
    {zoneId: 'x9cd-Z-004', name: 'Management Network', trustLevel: 'Restricted', subnet: '10.3.0.0/24', segmentation: 'Isolated VLAN', firewallRules: 32, monitoring: 'Syslog + SNMP', assets: ['Hypervisors', 'Switch management', 'Storage controllers', 'Backup appliances'], riskLevel: 'low' as const, lastAssessment: '2026-04-08', nextAssessment: '2026-07-08'},
  ...
  private _x9cdDataClassificationPolicy = [
  ...
  private _getx9cdZoneSummary(): {total: number; highRisk: number; mediumRisk: number; lowRisk: number; totalRules: number} {
    const high = this._x9cdSecurityZones.filter(z => z.riskLevel === 'high').length;
    const med = this._x9cdSecurityZones.filter(z => z.riskLevel === 'medium').length;
    const low = this._x9cdSecurityZones.filter(z => z.riskLevel === 'low').length;
    const rules = this._x9cdSecurityZones.reduce((s, z) => s + z.firewallRules, 0);
    return {total: this._x9cdSecurityZones.length, highRisk: high, mediumRisk: med, lowRisk: low, totalRules: rules};
  }

  private _getx9cdAlertSummary(): {total: number; critical: number; high: number; medium: number; low: number; open: number; contained: number} {
    const crit = this._x9cdSecurityAlerts.filter(a => a.severity === 'critical').length;
    const high = this._x9cdSecurityAlerts.filter(a => a.severity === 'high').length;
    const med = this._x9cdSecurityAlerts.filter(a => a.severity === 'medium').length;
    const low = this._x9cdSecurityAlerts.filter(a => a.severity === 'low').length;
    const open = this._x9cdSecurityAlerts.filter(a => a.status === 'investigating' || a.status === 'triaged').length;
    const contained = this._x9cdSecurityAlerts.filter(a => a.status === 'contained' || a.status === 'remediated').length;
    return {total: this._x9cdSecurityAlerts.length, critical: crit, high, medium: med, low, open, contained};
  }

  private _getx9cdComplianceSummary(): {total: number; fullyCompliant: number; mostlyCompliant: number; avgComplianceRate: number} {
    const full = this._x9cdComplianceFrameworks.filter(f => f.status === 'compliant').length;
    const mostly = this._x9cdComplianceFrameworks.filter(f => f.status === 'mostly_compliant').length;
    const avgRate = this._x9cdComplianceFrameworks.reduce((s, f) => s + (f.compliant / f.requirements * 100), 0) / this._x9cdComplianceFrameworks.length;
    return {total: this._x9cdComplianceFrameworks.length, fullyCompliant: full, mostlyCompliant: mostly, avgComplianceRate: Math.round(avgRate * 10) / 10};
  }
  ...
  // === Security Risk Register (purple_team) ===
  private _purple_teamRiskRegister = [
    { id: "RSK-PUR-0001", title: "Data breach from unpatched systems", owner: "CTO", category: "Financial", status: "mitigating", trend: "stable", severity: "high", likelihood: 2, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-19", nextReview: "2026-07-12" },
    { id: "RSK-PUR-0002", title: "Ransomware attack on critical infrastructure", owner: "CRO", category: "Strategic", status: "closed", trend: "decreasing", severity: "medium", likelihood: 3, impact: 1, treatment: "Monitor and review quarterly", lastReview: "2026-04-02", nextReview: "2026-07-13" },
    { id: "RSK-PUR-0003", title: "Insider threat data exfiltration", owner: "VP Eng", category: "Compliance", status: "accepted", trend: "increasing", severity: "high", likelihood: 8, impact: 2, treatment: "Monitor and review quarterly", lastReview: "2026-04-04", nextReview: "2026-07-14" },
    { id: "RSK-PUR-0004", title: "Supply chain compromise", owner: "Security Lead", category: "Technical", status: "open", trend: "stable", severity: "high", likelihood: 9, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-12", nextReview: "2026-07-25" },
    { id: "RSK-PUR-0005", title: "Cloud misconfiguration exposure", owner: "Risk Mgr", category: "Reputational", status: "mitigating", trend: "decreasing", severity: "critical", likelihood: 9, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-09", nextReview: "2026-07-08" },
    { id: "RSK-PUR-0006", title: "Phishing campaign success rate", owner: "Compliance Dir", category: "Legal", status: "closed", trend: "increasing", severity: "critical", likelihood: 1, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-09", nextReview: "2026-07-26" },
    { id: "RSK-PUR-0007", title: "Third-party vendor data breach", owner: "IT Dir", category: "Regulatory", status: "accepted", trend: "stable", severity: "medium", likelihood: 5, impact: 1, treatment: "Monitor and review quarterly", lastReview: "2026-04-05", nextReview: "2026-07-27" },
    { id: "RSK-PUR-0008", title: "Regulatory non-compliance penalty", owner: "DevOps Lead", category: "Third-Party", status: "open", trend: "decreasing", severity: "high", likelihood: 6, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-08", nextReview: "2026-07-23" },
    { id: "RSK-PUR-0009", title: "Zero-day exploit in production", owner: "Architect", category: "Human Capital", status: "mitigating", trend: "increasing", severity: "medium", likelihood: 3, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-08", nextReview: "2026-07-20" },
    { id: "RSK-PUR-0010", title: "Insufficient access controls", owner: "CISO", category: "Operational", status: "closed", trend: "stable", severity: "critical", likelihood: 9, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-07", nextReview: "2026-07-16" },
    { id: "RSK-PUR-0011", title: "DDoS attack on services", owner: "CTO", category: "Financial", status: "accepted", trend: "decreasing", severity: "critical", likelihood: 4, impact: 2, treatment: "Monitor and review quarterly", lastReview: "2026-04-10", nextReview: "2026-07-22" },
    { id: "RSK-PUR-0012", title: "Social engineering attack", owner: "CRO", category: "Strategic", status: "open", trend: "increasing", severity: "high", likelihood: 9, impact: 7, treatment: "Monitor and review quarterly", lastReview: "2026-04-23", nextReview: "2026-07-20" },
    { id: "RSK-PUR-0013", title: "API security vulnerability", owner: "VP Eng", category: "Compliance", status: "mitigating", trend: "stable", severity: "critical", likelihood: 1, impact: 1, treatment: "Monitor and review quarterly", lastReview: "2026-04-18", nextReview: "2026-07-03" },
    { id: "RSK-PUR-0014", title: "Mobile device compromise", owner: "Security Lead", category: "Technical", status: "closed", trend: "decreasing", severity: "critical", likelihood: 2, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-04", nextReview: "2026-07-03" },
    { id: "RSK-PUR-0015", title: "Physical security breach", owner: "Risk Mgr", category: "Reputational", status: "accepted", trend: "increasing", severity: "low", likelihood: 9, impact: 4, treatment: "Monitor and review quarterly", lastReview: "2026-04-20", nextReview: "2026-07-11" },
    { id: "RSK-PUR-0016", title: "Password policy weakness", owner: "Compliance Dir", category: "Legal", status: "open", trend: "stable", severity: "high", likelihood: 4, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-01", nextReview: "2026-07-20" },
    { id: "RSK-PUR-0017", title: "Network segmentation gap", owner: "IT Dir", category: "Regulatory", status: "mitigating", trend: "decreasing", severity: "low", likelihood: 7, impact: 4, treatment: "Monitor and review quarterly", lastReview: "2026-04-13", nextReview: "2026-07-21" },
    { id: "RSK-PUR-0018", title: "Encryption key management failure", owner: "DevOps Lead", category: "Third-Party", status: "closed", trend: "increasing", severity: "critical", likelihood: 4, impact: 7, treatment: "Monitor and review quarterly", lastReview: "2026-04-18", nextReview: "2026-07-17" },
    { id: "RSK-PUR-0019", title: "Audit trail tampering", owner: "Architect", category: "Human Capital", status: "accepted", trend: "stable", severity: "high", likelihood: 3, impact: 6, treatment: "Monitor and review quarterly", lastReview: "2026-04-18", nextReview: "2026-07-27" },
    { id: "RSK-PUR-0020", title: "Business email compromise", owner: "CISO", category: "Operational", status: "open", trend: "decreasing", severity: "high", likelihood: 1, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-21", nextReview: "2026-07-25" },
  ];
  private _purple_teamRiskFilter: string = 'all';
  private _purple_teamRiskSeverity: string = 'all';
  private _purple_teamRiskStatus: string = 'all';
  private _purple_teamExpandedRisk: string = '';
  private _purple_teamFilterRisks() {
    const reg = this._purple_teamRiskRegister;
    return reg.filter(r => {
      if (this._purple_teamRiskFilter !== "all" && r.category !== this._purple_teamRiskFilter) return false;
      if (this._purple_teamRiskSeverity !== "all" && r.severity !== this._purple_teamRiskSeverity) return false;
      if (this._purple_teamRiskStatus !== "all" && r.status !== this._purple_teamRiskStatus) return false;
      return true;
    });
  }
  private _purple_teamGetRiskScore(r: any) { return Math.round(r.likelihood * r.impact * 1.5); }
  private _purple_teamGetRiskTrendIcon(trend: string) {
    if (trend === "increasing") return "\u2191";
    if (trend === "decreasing") return "\u2193";
    return "\u2192";
  }
  private _purple_teamGetRiskColor(sev: string) {
    if (sev === "critical") return "#dc2626";
    if (sev === "high") return "#ea580c";
    if (sev === "medium") return "#d97706";
    return "#16a34a";
  }
  private _purple_teamGetRiskCounts() {
    const reg = this._purple_teamRiskRegister;
  ...
  private _purple_teamGetTreatmentProgress() {
    const reg = this._purple_teamRiskRegister;
    const treated = reg.filter(r => r.status === "mitigating" || r.status === "closed").length;
    return Math.round((treated / Math.max(reg.length, 1)) * 100);
  }

  // === Security Metrics API Gateway (purple_team) ===
  private _purple_teamApiEndpoints = [
    { method: "GET", path: "/api/v1/threats", name: "Threat Intelligence Feed", status: "active", avgLatency: 42.8, reqPerMin: 1037.0, errorRate: 1.2, uptime: round(96.29855289522663,2), version: "v2.2.15" },
    { method: "POST", path: "/api/v1/scans/start", name: "Vulnerability Scanner", status: "active", avgLatency: 282.1, reqPerMin: 1253.0, errorRate: 0.48, uptime: round(97.02676536004681,2), version: "v1.5.17" },
    { method: "GET", path: "/api/v1/assets", name: "Asset Inventory", status: "active", avgLatency: 51.2, reqPerMin: 42.0, errorRate: 2.27, uptime: round(96.49227939126885,2), version: "v1.3.18" },
    { method: "POST", path: "/api/v1/alerts", name: "Alert Management", status: "active", avgLatency: 37.1, reqPerMin: 1137.0, errorRate: 0.63, uptime: round(99.7558990094574,2), version: "v2.7.16" },
    { method: "GET", path: "/api/v1/compliance", name: "Compliance Status", status: "active", avgLatency: 238.1, reqPerMin: 840.0, errorRate: 2.47, uptime: round(98.21313085306807,2), version: "v1.9.0" },
    { method: "PUT", path: "/api/v1/policies", name: "Policy Engine", status: "active", avgLatency: 130.1, reqPerMin: 809.0, errorRate: 2.01, uptime: round(98.74346145117376,2), version: "v3.5.14" },
    { method: "GET", path: "/api/v1/incidents", name: "Incident Tracker", status: "active", avgLatency: 104.5, reqPerMin: 1374.0, errorRate: 1.99, uptime: round(96.13690337921409,2), version: "v2.8.0" },
    { method: "POST", path: "/api/v1/forensics", name: "Forensics Collector", status: "degraded", avgLatency: 99.2, reqPerMin: 916.0, errorRate: 2.06, uptime: round(96.1741170994477,2), version: "v1.9.20" },
    { method: "GET", path: "/api/v1/risk/assess", name: "Risk Assessment", status: "active", avgLatency: 154.9, reqPerMin: 548.0, errorRate: 1.65, uptime: round(96.80354270832274,2), version: "v2.4.18" },
    { method: "POST", path: "/api/v1/auth/verify", name: "Authentication", status: "active", avgLatency: 127.2, reqPerMin: 1105.0, errorRate: 1.31, uptime: round(96.95341836382131,2), version: "v1.2.1" },
    { method: "GET", path: "/api/v1/logs/audit", name: "Audit Log Query", status: "active", avgLatency: 235.0, reqPerMin: 203.0, errorRate: 2.28, uptime: round(98.59456232866206,2), version: "v1.9.9" },
    { method: "PUT", path: "/api/v1/users/roles", name: "Role Management", status: "active", avgLatency: 431.5, reqPerMin: 2072.0, errorRate: 0.4, uptime: round(96.73659497947018,2), version: "v3.9.10" },
    { method: "POST", path: "/api/v1/encrypt", name: "Encryption Service", status: "active", avgLatency: 280.6, reqPerMin: 132.0, errorRate: 2.07, uptime: round(98.03206020102523,2), version: "v3.6.17" },
    { method: "GET", path: "/api/v1/network/topo", name: "Network Topology", status: "maintenance", avgLatency: 176.6, reqPerMin: 2356.0, errorRate: 2.05, uptime: round(96.84590457611023,2), version: "v1.6.13" },
    { method: "DELETE", path: "/api/v1/sessions", name: "Session Manager", status: "active", avgLatency: 368.1, reqPerMin: 2305.0, errorRate: 1.77, uptime: round(95.88220731658573,2), version: "v1.8.4" },
  ];
  private _purple_teamApiKeys = [
    { id: "ak-000001", name: "key-purp-001", created: "2026-04-20", lastUsed: "2026-04-11", status: "active", calls: 48436, rateLimit: 500 },
    { id: "ak-000002", name: "key-purp-002", created: "2026-06-24", lastUsed: "2026-04-10", status: "active", calls: 25717, rateLimit: 1000 },
    { id: "ak-000003", name: "key-purp-003", created: "2026-06-10", lastUsed: "2026-04-08", status: "revoked", calls: 41669, rateLimit: 100 },
    { id: "ak-000004", name: "key-purp-004", created: "2026-06-09", lastUsed: "2026-04-06", status: "active", calls: 9844, rateLimit: 1000 },
    { id: "ak-000005", name: "key-purp-005", created: "2026-05-25", lastUsed: "2026-04-02", status: "revoked", calls: 38596, rateLimit: 1000 },
    { id: "ak-000006", name: "key-purp-006", created: "2026-09-03", lastUsed: "2026-04-21", status: "active", calls: 38063, rateLimit: 5000 },
    { id: "ak-000007", name: "key-purp-007", created: "2026-07-04", lastUsed: "2026-04-17", status: "revoked", calls: 37772, rateLimit: 1000 },
    { id: "ak-000008", name: "key-purp-008", created: "2026-08-01", lastUsed: "2026-04-07", status: "active", calls: 36197, rateLimit: 500 },
  ];
  private _purple_teamApiHealthSummary() {
    const eps = this._purple_teamApiEndpoints;
  ...
  private _purple_teamGetApiByMethod(method: string) { return this._purple_teamApiEndpoints.filter(e=>e.method===method); }
  private _purple_teamGetSlowEndpoints() { return this._purple_teamApiEndpoints.filter(e=>e.avgLatency>200).sort((a,b)=>b.avgLatency-a.avgLatency); }
  private _purple_teamGetHighErrorEndpoints() { return this._purple_teamApiEndpoints.filter(e=>e.errorRate>1.0).sort((a,b)=>b.errorRate-a.errorRate); }

  // === Security Training Effectiveness (purple_team) ===
  private _purple_teamTrainingModules = [
    { id: "TRN-001", name: "Security Fundamentals", completionRate: 83.6, avgScore: 70.1, behaviorChange: 31.4, enrolled: 152, completed: 389, duration: "93min", category: "mandatory" },
    { id: "TRN-002", name: "Phishing Awareness", completionRate: 77.2, avgScore: 58.5, behaviorChange: 30.9, enrolled: 158, completed: 401, duration: "112min", category: "mandatory" },
    { id: "TRN-003", name: "Social Engineering Defense", completionRate: 89.3, avgScore: 58.3, behaviorChange: 31.7, enrolled: 67, completed: 253, duration: "64min", category: "optional" },
    { id: "TRN-004", name: "Password Hygiene", completionRate: 65.8, avgScore: 64.5, behaviorChange: 63.2, enrolled: 393, completed: 148, duration: "86min", category: "mandatory" },
    { id: "TRN-005", name: "Data Classification", completionRate: 75.3, avgScore: 66.8, behaviorChange: 70.6, enrolled: 488, completed: 175, duration: "99min", category: "mandatory" },
    { id: "TRN-006", name: "Incident Response Basics", completionRate: 68.7, avgScore: 92.4, behaviorChange: 58.5, enrolled: 225, completed: 389, duration: "72min", category: "mandatory" },
    { id: "TRN-007", name: "Secure Coding", completionRate: 94.7, avgScore: 89.0, behaviorChange: 48.2, enrolled: 464, completed: 380, duration: "74min", category: "optional" },
    { id: "TRN-008", name: "Cloud Security", completionRate: 74.5, avgScore: 76.2, behaviorChange: 42.3, enrolled: 470, completed: 35, duration: "23min", category: "mandatory" },
    { id: "TRN-009", name: "Mobile Device Security", completionRate: 95.6, avgScore: 80.3, behaviorChange: 66.5, enrolled: 486, completed: 413, duration: "92min", category: "mandatory" },
    { id: "TRN-010", name: "Network Security", completionRate: 93.6, avgScore: 70.5, behaviorChange: 54.8, enrolled: 330, completed: 32, duration: "54min", category: "mandatory" },
    { id: "TRN-011", name: "Physical Security", completionRate: 75.0, avgScore: 79.3, behaviorChange: 88.3, enrolled: 500, completed: 95, duration: "69min", category: "optional" },
    { id: "TRN-012", name: "Regulatory Compliance", completionRate: 48.0, avgScore: 66.1, behaviorChange: 38.4, enrolled: 177, completed: 86, duration: "60min", category: "mandatory" },
    { id: "TRN-013", name: "Risk Management", completionRate: 55.4, avgScore: 81.5, behaviorChange: 79.5, enrolled: 363, completed: 186, duration: "28min", category: "mandatory" },
    { id: "TRN-014", name: "Cryptography Basics", completionRate: 68.0, avgScore: 69.6, behaviorChange: 35.2, enrolled: 58, completed: 130, duration: "28min", category: "mandatory" },
    { id: "TRN-015", name: "Access Control", completionRate: 56.3, avgScore: 90.0, behaviorChange: 82.7, enrolled: 165, completed: 302, duration: "16min", category: "optional" },
    { id: "TRN-016", name: "Vendor Management", completionRate: 82.3, avgScore: 58.3, behaviorChange: 71.1, enrolled: 132, completed: 200, duration: "89min", category: "mandatory" },
  ];
  private _purple_teamPhishingResults = [
    { month: "2026-01", sent: 474, clicked: 113, reported: 167, clickRate: round(23.839662447257385,1), reportRate: round(35.232067510548525,1) },
    { month: "2026-02", sent: 495, clicked: 110, reported: 218, clickRate: round(22.22222222222222,1), reportRate: round(44.04040404040404,1) },
    { month: "2026-03", sent: 690, clicked: 144, reported: 61, clickRate: round(20.869565217391305,1), reportRate: round(8.840579710144928,1) },
    { month: "2026-04", sent: 621, clicked: 135, reported: 214, clickRate: round(21.73913043478261,1), reportRate: round(34.46054750402576,1) },
    { month: "2026-05", sent: 975, clicked: 183, reported: 127, clickRate: round(18.76923076923077,1), reportRate: round(13.025641025641024,1) },
    { month: "2026-06", sent: 411, clicked: 9, reported: 93, clickRate: round(2.18978102189781,1), reportRate: round(22.62773722627737,1) },
  ];
  private _purple_teamTrainingROI = { totalInvestment: 183921, avgCostPerEmployee: 528, riskReductionPct: round(random.uniform(15,45),1), incidentReductionPct: round(random.uniform(10,35),1), complianceScoreGain: round(random.uniform(5,25),1) };
  private _purple_teamLearningPaths = [
    { name: "Beginner Security Analyst", totalModules: 20, completedModules: 15, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 56, enrolled: 58 },
    { name: "Advanced Threat Hunter", totalModules: 14, completedModules: 3, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 25, enrolled: 116 },
    { name: "Security Architect", totalModules: 13, completedModules: 11, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 68, enrolled: 126 },
    { name: "Incident Responder", totalModules: 13, completedModules: 10, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 20, enrolled: 109 },
    { name: "Compliance Specialist", totalModules: 9, completedModules: 9, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 68, enrolled: 37 },
    { name: "DevSecOps Engineer", totalModules: 8, completedModules: 10, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 23, enrolled: 140 },
  ];
  private _purple_teamGetOverallCompletion() {
    const mods = this._purple_teamTrainingModules;
    return round(mods.reduce((s,m)=>s+m.completionRate,0)/mods.length,1);
  }
  private _purple_teamGetTopPerformers() { return [...this._purple_teamTrainingModules].sort((a,b)=>b.avgScore-a.avgScore).slice(0,5); }
  private _purple_teamGetModulesNeedingAttention() { return this._purple_teamTrainingModules.filter(m=>m.completionRate<70||m.avgScore<65); }

  // === Security Governance Framework (purple_team) ===
  private _purple_teamGovBodies = [
    { name: "Security Steering Committee", members: 14, chair: "CISO", meetingFreq: "Weekly", lastMeeting: "2026-04-13", nextMeeting: "2026-05-06", quorum: 7 },
    { name: "Risk Management Board", members: 11, chair: "CTO", meetingFreq: "Bi-weekly", lastMeeting: "2026-04-08", nextMeeting: "2026-05-14", quorum: 4 },
    { name: "Data Governance Council", members: 5, chair: "CRO", meetingFreq: "Monthly", lastMeeting: "2026-04-18", nextMeeting: "2026-05-13", quorum: 4 },
    { name: "Compliance Oversight Board", members: 14, chair: "CDO", meetingFreq: "Monthly", lastMeeting: "2026-04-08", nextMeeting: "2026-05-20", quorum: 8 },
    { name: "Architecture Review Board", members: 6, chair: "VP Eng", meetingFreq: "Bi-weekly", lastMeeting: "2026-04-20", nextMeeting: "2026-05-17", quorum: 7 },
    { name: "Change Advisory Board", members: 6, chair: "CISO", meetingFreq: "Weekly", lastMeeting: "2026-04-17", nextMeeting: "2026-05-17", quorum: 7 },
    { name: "Incident Review Board", members: 13, chair: "CIO", meetingFreq: "As needed", lastMeeting: "2026-04-15", nextMeeting: "2026-05-07", quorum: 8 },
    { name: "Vendor Risk Committee", members: 9, chair: "CFO", meetingFreq: "Quarterly", lastMeeting: "2026-04-20", nextMeeting: "2026-05-08", quorum: 4 },
  ];
  private _purple_teamDecisions = [
    { id: "DEC-0001", title: "Adopt zero-trust architecture framework", date: "2026-01-11", status: "approved", owner: "CISO" },
    { id: "DEC-0002", title: "Migrate to SIEM 2.0 platform", date: "2026-02-16", status: "implemented", owner: "CTO" },
    ...
    { id: "DEC-0006", title: "Deploy EDR solution enterprise-wide", date: "2026-01-04", status: "approved", owner: "CISO" },
    { id: "DEC-0007", title: "Conduct annual penetration testing", date: "2026-04-03", status: "implemented", owner: "CTO" },
    { id: "DEC-0008", title: "Implement network micro-segmentation", date: "2026-02-12", status: "in-progress", owner: "Security Lead" },
  ...
  private _purple_teamPolicyLifecycle = [
    { name: "Information Security Policy", version: "v3.4", status: "active", lastUpdated: "2026-02-09", nextReview: "2026-11-05", owner: "CISO" },
    { name: "Acceptable Use Policy", version: "v2.2", status: "active", lastUpdated: "2026-03-08", nextReview: "2026-7-25", owner: "Legal" },
    { name: "Data Retention Policy", version: "v1.4", status: "under-review", lastUpdated: "2026-04-12", nextReview: "2026-12-15", owner: "DPO" },
    { name: "Access Control Policy", version: "v2.2", status: "active", lastUpdated: "2026-02-10", nextReview: "2026-10-08", owner: "IAM Lead" },
    { name: "Incident Response Policy", version: "v4.2", status: "draft", lastUpdated: "2026-02-06", nextReview: "2026-9-14", owner: "IR Lead" },
    { name: "Business Continuity Plan", version: "v1.2", status: "active", lastUpdated: "2026-01-11", nextReview: "2026-9-25", owner: "BCP Mgr" },
    { name: "Vendor Management Policy", version: "v4.0", status: "active", lastUpdated: "2026-03-06", nextReview: "2026-10-16", owner: "Procurement" },
    { name: "Encryption Standard", version: "v2.1", status: "under-review", lastUpdated: "2026-01-24", nextReview: "2026-11-11", owner: "Security Arch" },
  ];
  private _purple_teamGovMaturityScore = { overall: 5.5, riskManagement: 4.5, compliance: 3.8, incidentResponse: 5.1, awareness: 5.2, technology: 3.8 };
  private _purple_teamGetPendingDecisions() { return this._purple_teamDecisions.filter(d=>d.status==='pending'||d.status==='in-progress'); }
  private _purple_teamGetActivePolicies() { return this._purple_teamPolicyLifecycle.filter(p=>p.status==='active'); }
  private _purple_teamGetEscalationPath() { return ["L1 Analyst","L2 Senior","Security Lead","CISO","Board"]; }

  // === Security Innovation Lab (purple_team) ===
  private _purple_teamInnoProjects = [
    { id: "INN-001", name: "AI-Powered Threat Detection", description: "Machine learning models for real-time threat identification", status: "active", progress: 72, startDate: "2026-02-28", teamSize: 6, budget: 190329, milestones: 8, completedMilestones: 1 },
    { id: "INN-002", name: "Quantum-Resistant Cryptography", description: "Post-quantum encryption algorithm prototyping", status: "research", progress: 35, startDate: "2026-01-06", teamSize: 3, budget: 134315, milestones: 3, completedMilestones: 4 },
    { id: "INN-003", name: "Automated Red Teaming", description: "Autonomous penetration testing framework", status: "active", progress: 58, startDate: "2026-03-06", teamSize: 8, budget: 117720, milestones: 4, completedMilestones: 1 },
    { id: "INN-004", name: "Zero-Knowledge Authentication", description: "Privacy-preserving identity verification", status: "poc", progress: 88, startDate: "2026-03-11", teamSize: 5, budget: 142802, milestones: 4, completedMilestones: 8 },
    { id: "INN-005", name: "Blockchain Audit Trail", description: "Immutable security event logging", status: "active", progress: 45, startDate: "2026-01-13", teamSize: 7, budget: 129348, milestones: 9, completedMilestones: 9 },
    { id: "INN-006", name: "Behavioral Biometrics", description: "Continuous authentication via user behavior patterns", status: "research", progress: 22, startDate: "2026-02-06", teamSize: 3, budget: 157730, milestones: 4, completedMilestones: 7 },
    { id: "INN-007", name: "Deception Grid 2.0", description: "Advanced honeypot network with adaptive responses", status: "active", progress: 65, startDate: "2026-03-20", teamSize: 5, budget: 32091, milestones: 7, completedMilestones: 2 },
    { id: "INN-008", name: "Secure Enclave Integration", description: "Hardware-backed security for critical workloads", status: "poc", progress: 40, startDate: "2026-01-23", teamSize: 6, budget: 162533, milestones: 3, completedMilestones: 5 },
  ];
  private _purple_teamTechEvaluations = [
    ...
    { name: "Confidential Computing", status: "planned", score: 7.1, recommendation: "Investigate", vendor: "Azure" },
  ...
  private _purple_teamCollaborationPartners = [
  ...
  private _purple_teamInnoMetrics = { totalProjects: 8, activeProjects: 4, avgTimeToValue: "163 days", pocSuccessRate: round(random.uniform(55,85),1), researchToProduction: round(random.uniform(20,50),1), innovationIndex: round(random.uniform(6.0,9.5),1) };
  private _purple_teamGetProjectByStatus(status: string) { return this._purple_teamInnoProjects.filter(p=>p.status===status); }
  private _purple_teamGetTopEvaluations() { return [...this._purple_teamTechEvaluations].sort((a,b)=>b.score-a.score).slice(0,3); }



  // === Compliance Dashboard Extension (purple_team) ===
  private _purple_teamComplianceFrameworks = [
    { name: "SOC 2 Type II", description: "Trust Services Criteria", totalControls: 5, implementedControls: 3, status: "non-compliant", lastAudit: "2026-01-02", nextAudit: "2026-10-03", evidenceCount: 415 },
    { name: "ISO 27001", description: "Information Security Management", totalControls: 114, implementedControls: 86, status: "compliant", lastAudit: "2026-03-13", nextAudit: "2026-12-04", evidenceCount: 280 },
    { name: "PCI DSS 4.0", description: "Payment Card Industry", totalControls: 12, implementedControls: 10, status: "compliant", lastAudit: "2026-03-04", nextAudit: "2026-12-18", evidenceCount: 222 },
    { name: "HIPAA", description: "Health Insurance Portability", totalControls: 18, implementedControls: 10, status: "in-review", lastAudit: "2026-02-20", nextAudit: "2026-12-25", evidenceCount: 193 },
    { name: "GDPR", description: "Data Protection Regulation", totalControls: 99, implementedControls: 93, status: "in-review", lastAudit: "2026-03-13", nextAudit: "2026-7-12", evidenceCount: 78 },
    { name: "NIST CSF 2.0", description: "Cybersecurity Framework", totalControls: 6, implementedControls: 6, status: "compliant", lastAudit: "2026-01-13", nextAudit: "2026-11-12", evidenceCount: 99 },
    { name: "FedRAMP", description: "Federal Risk Authorization", totalControls: 15, implementedControls: 14, status: "compliant", lastAudit: "2026-02-23", nextAudit: "2026-8-21", evidenceCount: 307 },
    { name: "SOX", description: "Sarbanes-Oxley Compliance", totalControls: 8, implementedControls: 6, status: "in-review", lastAudit: "2026-01-01", nextAudit: "2026-11-24", evidenceCount: 483 },
    { name: "CIS Controls v8", description: "Center for Internet Security", totalControls: 18, implementedControls: 13, status: "in-review", lastAudit: "2026-01-15", nextAudit: "2026-12-21", evidenceCount: 148 },
    { name: "COBIT 2019", description: "IT Governance Framework", totalControls: 40, implementedControls: 21, status: "in-review", lastAudit: "2026-04-10", nextAudit: "2026-10-26", evidenceCount: 207 },
  ];
  private _purple_teamGetComplianceScore() {
    const fw = this._purple_teamComplianceFrameworks;
    return round(fw.reduce((s,f)=>s + (f.implementedControls/Math.max(f.totalControls,1))*100, 0) / fw.length, 1);
  }
  private _purple_teamGetGaps() {
    return this._purple_teamComplianceFrameworks.filter(f => f.status !== "compliant");
  }
  private _purple_teamAuditTrail = [
    { id: "AUD-0001", action: "Control tested", auditor: "Internal Audit", date: "2026-04-03", result: "pass", findings: 2 },
    { id: "AUD-0002", action: "Evidence collected", auditor: "External Auditor", date: "2026-04-22", result: "pass", findings: 5 },
    ...
    { id: "AUD-0006", action: "Training verified", auditor: "Risk Team", date: "2026-04-18", result: "pass", findings: 5 },
  ...
  // === Threat Intelligence Feed Extension (purple_team) ===
  private _purple_teamThreatActors = [
    { name: "APT-29", alias: "Cozy Bear", origin: "Russia", type: "Nation-State", severity: "high", lastActivity: "2026-04-10", targets: "Healthcare", indicators: 308, ttps: 37 },
    { name: "APT-41", alias: "Double Dragon", origin: "China", type: "Nation-State", severity: "critical", lastActivity: "2026-04-16", targets: "Finance", indicators: 71, ttps: 38 },
    { name: "Lazarus Group", alias: "Hidden Cobra", origin: "North Korea", type: "Nation-State", severity: "critical", lastActivity: "2026-04-13", targets: "Technology", indicators: 302, ttps: 21 },
    { name: "FIN7", alias: "Carbanak", origin: "Eastern Europe", type: "Financial", severity: "high", lastActivity: "2026-04-08", targets: "Energy", indicators: 446, ttps: 13 },
    { name: "Conti", alias: "Wizard Spider", origin: "Russia", type: "Ransomware", severity: "critical", lastActivity: "2026-04-03", targets: "Energy", indicators: 31, ttps: 15 },
    { name: "LockBit", alias: "LockBit Gang", origin: "Unknown", type: "Ransomware", severity: "high", lastActivity: "2026-04-09", targets: "Government", indicators: 297, ttps: 14 },
    { name: "Cl0p", alias: "Cl0p Team", origin: "Unknown", type: "Ransomware", severity: "high", lastActivity: "2026-04-08", targets: "Energy", indicators: 280, ttps: 11 },
    { name: "Sandworm", alias: "Unit 74455", origin: "Russia", type: "Nation-State", severity: "critical", lastActivity: "2026-04-19", targets: "Manufacturing", indicators: 223, ttps: 10 },
  ];
  private _purple_teamIoCFeed = [
    { id: "ioc-000001", type: "ip", value: "112.112.73.125", confidence: 92, source: "MISP", firstSeen: "2026-04-08", lastSeen: "2026-04-13" },
    { id: "ioc-000002", type: "ip", value: "101.235.106.35", confidence: 40, source: "Mandiant", firstSeen: "2026-04-07", lastSeen: "2026-04-06" },
    { id: "ioc-000003", type: "ip", value: "183.108.18.68", confidence: 62, source: "CrowdStrike", firstSeen: "2026-04-13", lastSeen: "2026-04-01" },
    { id: "ioc-000004", type: "ip", value: "220.11.87.68", confidence: 45, source: "STIX", firstSeen: "2026-04-07", lastSeen: "2026-04-03" },
    { id: "ioc-000005", type: "ip", value: "75.227.160.98", confidence: 85, source: "VirusTotal", firstSeen: "2026-04-21", lastSeen: "2026-04-14" },
    { id: "ioc-000006", type: "ip", value: "157.94.172.122", confidence: 67, source: "AlienVault", firstSeen: "2026-04-20", lastSeen: "2026-04-15" },
    { id: "ioc-000007", type: "ip", value: "104.219.22.216", confidence: 63, source: "STIX", firstSeen: "2026-04-15", lastSeen: "2026-04-06" },
    { id: "ioc-000008", type: "ip", value: "123.119.41.156", confidence: 69, source: "CrowdStrike", firstSeen: "2026-04-04", lastSeen: "2026-04-05" },
    { id: "ioc-000009", type: "ip", value: "34.242.38.115", confidence: 81, source: "VirusTotal", firstSeen: "2026-04-06", lastSeen: "2026-04-15" },
    { id: "ioc-000010", type: "ip", value: "94.170.98.119", confidence: 63, source: "MISP", firstSeen: "2026-04-12", lastSeen: "2026-04-20" },
    { id: "ioc-000011", type: "ip", value: "81.222.218.66", confidence: 91, source: "Mandiant", firstSeen: "2026-04-05", lastSeen: "2026-04-17" },
    { id: "ioc-000012", type: "ip", value: "27.229.74.86", confidence: 74, source: "MISP", firstSeen: "2026-04-10", lastSeen: "2026-04-17" },
    { id: "ioc-000013", type: "ip", value: "133.251.105.238", confidence: 94, source: "Mandiant", firstSeen: "2026-04-11", lastSeen: "2026-04-22" },
    { id: "ioc-000014", type: "ip", value: "98.3.191.53", confidence: 81, source: "MISP", firstSeen: "2026-04-08", lastSeen: "2026-04-06" },
    { id: "ioc-000015", type: "ip", value: "175.222.97.131", confidence: 45, source: "VirusTotal", firstSeen: "2026-04-09", lastSeen: "2026-04-10" },
  ];
  private _purple_teamGetActiveThreats() { return this._purple_teamThreatActors.filter(a => a.severity === 'critical'); }
  private _purple_teamGetThreatSummary() {
    const actors = this._purple_teamThreatActors;
  ...
  // === Incident Management Extension (purple_team) ===
  private _purple_teamIncidents = [
    { id: "INC-20260001", title: "Unauthorized access detected", severity: "critical", status: "open", assignedTo: "SOC L1", detectedAt: "2026-04-09T09:18", affectedAssets: 15, rootCause: "Misconfiguration" },
    { id: "INC-20260002", title: "Malware outbreak on workstation", severity: "high", status: "investigating", assignedTo: "SOC L2", detectedAt: "2026-04-20T01:18", affectedAssets: 9, rootCause: "Credential compromise" },
    { id: "INC-20260003", title: "Data leak from S3 bucket", severity: "medium", status: "contained", assignedTo: "IR Lead", detectedAt: "2026-04-12T05:16", affectedAssets: 26, rootCause: "Zero-day" },
    { id: "INC-20260004", title: "Phishing campaign targeting finance", severity: "low", status: "eradicated", assignedTo: "CISO", detectedAt: "2026-04-08T16:49", affectedAssets: 32, rootCause: "Human error" },
    { id: "INC-20260005", title: "DDoS attack on web services", severity: "critical", status: "recovered", assignedTo: "Security Eng", detectedAt: "2026-04-20T20:24", affectedAssets: 19, rootCause: "Policy violation" },
    { id: "INC-20260006", title: "Ransomware encryption attempt", severity: "high", status: "closed", assignedTo: "Forensics", detectedAt: "2026-04-22T01:04", affectedAssets: 12, rootCause: "Unknown" },
    { id: "INC-20260007", title: "Insider data exfiltration", severity: "medium", status: "open", assignedTo: "SOC L1", detectedAt: "2026-04-06T16:08", affectedAssets: 17, rootCause: "Misconfiguration" },
    { id: "INC-20260008", title: "API key exposure in repo", severity: "low", status: "investigating", assignedTo: "SOC L2", detectedAt: "2026-04-04T03:40", affectedAssets: 8, rootCause: "Credential compromise" },
    { id: "INC-20260009", title: "SQL injection on portal", severity: "critical", status: "contained", assignedTo: "IR Lead", detectedAt: "2026-04-21T06:58", affectedAssets: 27, rootCause: "Zero-day" },
    { id: "INC-20260010", title: "Brute force on VPN", severity: "high", status: "eradicated", assignedTo: "CISO", detectedAt: "2026-04-23T14:26", affectedAssets: 40, rootCause: "Human error" },
    { id: "INC-20260011", title: "Supply chain alert from vendor", severity: "medium", status: "recovered", assignedTo: "Security Eng", detectedAt: "2026-04-01T01:11", affectedAssets: 29, rootCause: "Policy violation" },
    { id: "INC-20260012", title: "Suspicious lateral movement", severity: "low", status: "closed", assignedTo: "Forensics", detectedAt: "2026-04-07T23:13", affectedAssets: 11, rootCause: "Unknown" },
  ];
  private _purple_teamGetIncidentStats() {
    const inc = this._purple_teamIncidents;
    return { total: inc.length, open: inc.filter(i=>i.status==="open").length, investigating: inc.filter(i=>i.status==="investigating").length, mttd: 39, mttr: 122 };
  }
  private _purple_teamGetSeverityDistribution() {
    const inc = this._purple_teamIncidents;
  ...
  private _initPurpleTeamComplianceHub() {
    const purple_teamComplianceControls = [
    ...
    this._purple_teamComplianceScore = this._calcPurpleTeamComplianceScore(purple_teamComplianceControls);
    this._purple_teamDriftAlerts = purple_teamComplianceControls.filter(c => c.status === 'drift-detected' || c.status === 'non-compliant');
    this._purple_teamRemediationQueue = this._generatePurpleTeamRemediationPlan(purple_teamComplianceControls);
    this._purple_teamRegulatoryChanges = this._detectPurpleTeamRegulatoryImpact(purple_teamComplianceControls);
  }

  private _calcPurpleTeamComplianceScore(controls: Array<Record<string, unknown>>): number {
  ...
  private _generatePurpleTeamRemediationPlan(controls: Array<Record<string, unknown>>): Array<Record<string, unknown>> {
  ...
  private _detectPurpleTeamRegulatoryImpact(controls: Array<Record<string, unknown>>): Array<Record<string, unknown>> {
    return [
  ...
  private _runPurpleTeamContinuousMonitoring(): void {
    ...
    this._purple_teamMonitoringChecks = monitoringChecks;
  }


  // === SOC Intelligence Hub - Threat Analysis Engine ===
  private _initPurpleTeamSocIntelHub() {
    this._purple_teamThreatActors = [
    ...
    this._purple_teamTtpMapping = this._buildPurpleTeamTtpMatrix();
    this._purple_teamThreatCampaigns = this._trackPurpleTeamActiveCampaigns();
    this._purple_teamIntelFeeds = this._configurePurpleTeamIntelFeeds();
    this._purple_teamThreatScores = this._calcPurpleTeamThreatScores();
    this._purple_teamPredictiveAnalysis = this._runPurpleTeamPredictiveThreatModel();
  }

  private _buildPurpleTeamTtpMatrix(): Array<Record<string, unknown>> {
    const techniques = [
  ...
  private _trackPurpleTeamActiveCampaigns(): Array<Record<string, unknown>> {
    return [
  ...
  private _configurePurpleTeamIntelFeeds(): Array<Record<string, unknown>> {
    return [
  ...
  private _calcPurpleTeamThreatScores(): Array<Record<string, unknown>> {
    return this._purple_teamThreatActors.map((actor: Record<string, unknown>) => ({
  ...
  private _runPurpleTeamPredictiveThreatModel(): Array<Record<string, unknown>> {
    return [
  ...
  private _initPurpleTeamWorkflowEngine() {
    this._purple_teamWorkflows = [
    ...
    this._purple_teamWorkflowMetrics = this._aggregatePurpleTeamWorkflowMetrics();
    this._purple_teamWorkflowBottlenecks = this._identifyPurpleTeamBottlenecks();
    this._purple_teamAutomationROI = this._calcPurpleTeamAutomationROI();
  }

  private _aggregatePurpleTeamWorkflowMetrics(): Record<string, unknown> {
    const totalRuns = this._purple_teamWorkflows.reduce((s: number, w: Record<string, unknown>) => s + Number(w.totalRuns), 0);
    const avgSuccess = this._purple_teamWorkflows.reduce((s: number, w: Record<string, unknown>) => s + Number(w.successRate), 0) / this._purple_teamWorkflows.length;
    const totalAutoSteps = this._purple_teamWorkflows.reduce((s: number, w: Record<string, unknown>) => s + Number(w.autoSteps), 0);
    const totalManualSteps = this._purple_teamWorkflows.reduce((s: number, w: Record<string, unknown>) => s + Number(w.manualSteps), 0);
    return {
      ...
      activeWorkflows: this._purple_teamWorkflows.filter((w: Record<string, unknown>) => w.active).length,
      avgStepsPerWorkflow: Math.round((totalAutoSteps + totalManualSteps) / this._purple_teamWorkflows.length)
    };
  }

  private _identifyPurpleTeamBottlenecks(): Array<Record<string, unknown>> {
    return [
  ...
  private _calcPurpleTeamAutomationROI(): Array<Record<string, unknown>> {
    return this._purple_teamWorkflows.map((w: Record<string, unknown>) => ({
  ...
  private _runPurpleTeamPostureAssessment() {
    this._purple_teamPostureDimensions = [
    ...
    this._purple_teamOverallPostureScore = this._purple_teamPostureDimensions.reduce(
      (s: number, d: Record<string, unknown>) => s + Number(d.score) * Number(d.weight), 0
    );
    this._purple_teamPostureHistory = Array.from({ length: 30 }, (_, i) => ({
    ...
    this._purple_teamPostureRecommendations = this._generatePurpleTeamPostureRecommendations();
  }

  private _generatePurpleTeamPostureRecommendations(): Array<Record<string, unknown>> {
    return [
  ...
  private _initPurpleTeamIntegrationMatrix() {
    this._purple_teamIntegrations = [
    ...
    this._purple_teamIntegrationHealth = this._assessPurpleTeamIntegrationHealth();
    this._purple_teamIntegrationAlerts = this._monitorPurpleTeamIntegrationAlerts();
    this._purple_teamDataFlowMatrix = this._buildPurpleTeamDataFlowMatrix();
    this._purple_teamIntegrationSLA = this._trackPurpleTeamIntegrationSLA();
  }

  private _assessPurpleTeamIntegrationHealth(): Record<string, unknown> {
    const active = this._purple_teamIntegrations.filter((i: Record<string, unknown>) => i.status === 'active').length;
    const degraded = this._purple_teamIntegrations.filter((i: Record<string, unknown>) => i.status === 'degraded').length;
    const warning = this._purple_teamIntegrations.filter((i: Record<string, unknown>) => i.status === 'warning').length;
    const avgLatency = this._purple_teamIntegrations.reduce((s: number, i: Record<string, unknown>) => s + Number(i.latency), 0) / this._purple_teamIntegrations.length;
    const avgErrorRate = this._purple_teamIntegrations.reduce((s: number, i: Record<string, unknown>) => s + Number(i.errorRate), 0) / this._purple_teamIntegrations.length;
    return {
      totalIntegrations: this._purple_teamIntegrations.length, active, degraded, warning,
      healthScore: Math.round((active / this._purple_teamIntegrations.length) * 100),
      avgLatencyMs: Math.round(avgLatency), avgErrorRate: Math.round(avgErrorRate * 1000) / 10,
      dataFreshness: '95%', coverage: '92%'
    };
  }

  private _monitorPurpleTeamIntegrationAlerts(): Array<Record<string, unknown>> {
    return this._purple_teamIntegrations
  ...
  private _buildPurpleTeamDataFlowMatrix(): Array<Record<string, unknown>> {
  ...
  private _trackPurpleTeamIntegrationSLA(): Array<Record<string, unknown>> {
    return this._purple_teamIntegrations.map((i: Record<string, unknown>) => ({
      integrationId: i.integrationId, integrationName: i.name,
  ...
  private _initPurpleTeamServiceMesh() {
    this._purple_teamMeshServices = [
    ...
    this._purple_teamMeshHealth = this._calcPurpleTeamMeshHealth();
    this._purple_teamMeshTraffic = this._analyzePurpleTeamMeshTraffic();
  }

  private _calcPurpleTeamMeshHealth(): Record<string, unknown> {
    const healthy = this._purple_teamMeshServices.filter((s: Record<string, unknown>) => Number(s.errorRate) < 0.03).length;
    return {
      totalServices: this._purple_teamMeshServices.length, healthyServices: healthy,
      healthPercent: Math.round(healthy / this._purple_teamMeshServices.length * 100),
      totalReplicas: this._purple_teamMeshServices.reduce((s: number, svc: Record<string, unknown>) => s + Number(svc.replicas), 0),
      avgCpuUsage: Math.round(this._purple_teamMeshServices.reduce((s: number, svc: Record<string, unknown>) => s + Number(svc.cpuUsage), 0) / this._purple_teamMeshServices.length),
      avgMemoryUsage: Math.round(this._purple_teamMeshServices.reduce((s: number, svc: Record<string, unknown>) => s + Number(svc.memoryUsage), 0) / this._purple_teamMeshServices.length),
      avgLatencyP99: Math.round(this._purple_teamMeshServices.reduce((s: number, svc: Record<string, unknown>) => s + Number(svc.latencyP99), 0) / this._purple_teamMeshServices.length)
    };
  }

  private _analyzePurpleTeamMeshTraffic(): Array<Record<string, unknown>> {
    return this._purple_teamMeshServices.map((s: Record<string, unknown>) => ({
...
// ===== DATA SOVEREIGNTY COMPLIANCE (R22) =====
  ...
  private _renderBudgetPlanning() {
    const budgetData = [
      { category: "Personnel & Training", planned: 4274000, actual: 2049000, utilization: 47.9, q1: "26%", q2: "31%", q3: "29%", q4: "21%" },
      { category: "Tooling & Licensing", planned: 4281000, actual: 2062000, utilization: 48.2, q1: "29%", q2: "20%", q3: "24%", q4: "22%" },
      { category: "Infrastructure Security", planned: 4288000, actual: 2075000, utilization: 48.4, q1: "16%", q2: "25%", q3: "19%", q4: "23%" },
      { category: "Compliance & Audit", planned: 4295000, actual: 2088000, utilization: 48.6, q1: "19%", q2: "30%", q3: "30%", q4: "24%" },
      { category: "Incident Response", planned: 4302000, actual: 2101000, utilization: 48.8, q1: "22%", q2: "35%", q3: "25%", q4: "25%" },
      { category: "Third-Party Assessments", planned: 4309000, actual: 2114000, utilization: 49.1, q1: "25%", q2: "24%", q3: "20%", q4: "10%" },
      { category: "Security Awareness", planned: 4316000, actual: 2127000, utilization: 49.3, q1: "28%", q2: "29%", q3: "31%", q4: "11%" },
      { category: "Research & Innovation", planned: 4323000, actual: 2140000, utilization: 49.5, q1: "15%", q2: "34%", q3: "26%", q4: "12%" },
    ];
    ...
    const headcount = [
      { team: "SOC Tier 1", current: 2, target: 22, gap: 5, avgSalary: "144k" },
      { team: "SOC Tier 2", current: 11, target: 21, gap: 4, avgSalary: "173k" },
      { team: "Threat Intel", current: 3, target: 20, gap: 3, avgSalary: "91k" },
      { team: "Red Team", current: 12, target: 19, gap: 2, avgSalary: "120k" },
      { team: "GRC", current: 4, target: 18, gap: 1, avgSalary: "149k" },
      { team: "AppSec", current: 13, target: 17, gap: 0, avgSalary: "178k" },
      { team: "Cloud Sec", current: 5, target: 16, gap: 5, avgSalary: "96k" },
      { team: "Identity & Access", current: 14, target: 15, gap: 4, avgSalary: "125k" },
    ];
    const vendorSpend = [
      { vendor: "CrowdStrike", annual: "571k", contractEnd: "2026-12", renewalRisk: "Low", satisfaction: 5 },
      { vendor: "Palo Alto", annual: "602k", contractEnd: "2026-01", renewalRisk: "Medium", satisfaction: 4 },
      { vendor: "Splunk", annual: "633k", contractEnd: "2026-02", renewalRisk: "High", satisfaction: 3 },
      { vendor: "Qualys", annual: "664k", contractEnd: "2026-03", renewalRisk: "Low", satisfaction: 5 },
      { vendor: "Rapid7", annual: "695k", contractEnd: "2026-04", renewalRisk: "Medium", satisfaction: 4 },
      { vendor: "Mandiant", annual: "726k", contractEnd: "2026-05", renewalRisk: "High", satisfaction: 3 },
      { vendor: "Zscaler", annual: "757k", contractEnd: "2026-06", renewalRisk: "Low", satisfaction: 5 },
      { vendor: "Duo Security", annual: "788k", contractEnd: "2026-07", renewalRisk: "Medium", satisfaction: 4 },
    ];
    const roiProjections = [
      { area: "Threat Detection", investment: "402k", projectedReturn: "1515k", roiMultiple: "2.6x", confidence: 83 },
      { area: "Incident Reduction", investment: "445k", projectedReturn: "1562k", roiMultiple: "2.5x", confidence: 64 },
      { area: "Compliance Savings", investment: "488k", projectedReturn: "1609k", roiMultiple: "2.4x", confidence: 81 },
      { area: "Automation Gains", investment: "531k", projectedReturn: "1656k", roiMultiple: "2.3x", confidence: 62 },
      { area: "Risk Avoidance", investment: "574k", projectedReturn: "1703k", roiMultiple: "2.2x", confidence: 79 },
    ];
    return html`
  ...
  private _renderMetricsNormalization() {
    const kpiCatalog = [
      { id: "kpi-1", name: "MTTD", owner: "SOC", unit: "minutes", target: 78, current: 89, benchmark: 95, collection: "auto", frequency: "realtime" },
      { id: "kpi-2", name: "MTTR", owner: "GRC", unit: "%", target: 81, current: 96, benchmark: 72, collection: "semi-auto", frequency: "daily" },
      { id: "kpi-3", name: "MTTC", owner: "AppSec", unit: "score", target: 84, current: 57, benchmark: 83, collection: "manual", frequency: "weekly" },
      { id: "kpi-4", name: "Vuln SLA Compliance", owner: "Cloud Sec", unit: "count", target: 87, current: 64, benchmark: 94, collection: "auto", frequency: "monthly" },
      { id: "kpi-5", name: "Patch Coverage", owner: "Identity", unit: "days", target: 90, current: 71, benchmark: 71, collection: "semi-auto", frequency: "realtime" },
      { id: "kpi-6", name: "Phishing Click Rate", owner: "Threat Intel", unit: "minutes", target: 93, current: 78, benchmark: 82, collection: "manual", frequency: "daily" },
      { id: "kpi-7", name: "Training Completion", owner: "Security Ops", unit: "%", target: 96, current: 85, benchmark: 93, collection: "auto", frequency: "weekly" },
      { id: "kpi-8", name: "Escalation Rate", owner: "Risk Mgmt", unit: "score", target: 99, current: 92, benchmark: 70, collection: "semi-auto", frequency: "monthly" },
      { id: "kpi-9", name: "False Positive Rate", owner: "SOC", unit: "count", target: 72, current: 99, benchmark: 81, collection: "manual", frequency: "realtime" },
      { id: "kpi-10", name: "Threat Intel Actionability", owner: "GRC", unit: "days", target: 75, current: 60, benchmark: 92, collection: "auto", frequency: "daily" },
      { id: "kpi-11", name: "Endpoint Compliance", owner: "AppSec", unit: "minutes", target: 78, current: 67, benchmark: 69, collection: "semi-auto", frequency: "weekly" },
      { id: "kpi-12", name: "Cloud Misconfig Score", owner: "Cloud Sec", unit: "%", target: 81, current: 74, benchmark: 80, collection: "manual", frequency: "monthly" },
      { id: "kpi-13", name: "Identity Anomaly Rate", owner: "Identity", unit: "score", target: 84, current: 81, benchmark: 91, collection: "auto", frequency: "realtime" },
      { id: "kpi-14", name: "DLP Events", owner: "Threat Intel", unit: "count", target: 87, current: 88, benchmark: 68, collection: "semi-auto", frequency: "daily" },
      { id: "kpi-15", name: "Vendor Risk Avg", owner: "Security Ops", unit: "days", target: 90, current: 95, benchmark: 79, collection: "manual", frequency: "weekly" },
      { id: "kpi-16", name: "Compliance Audit Pass Rate", owner: "Risk Mgmt", unit: "minutes", target: 93, current: 56, benchmark: 90, collection: "auto", frequency: "monthly" },
      { id: "kpi-17", name: "Awareness Score", owner: "SOC", unit: "%", target: 96, current: 63, benchmark: 67, collection: "semi-auto", frequency: "realtime" },
      { id: "kpi-18", name: "SOC Utilization", owner: "GRC", unit: "score", target: 99, current: 70, benchmark: 78, collection: "manual", frequency: "daily" },
      { id: "kpi-19", name: "Automation Coverage", owner: "AppSec", unit: "count", target: 72, current: 77, benchmark: 89, collection: "auto", frequency: "weekly" },
      { id: "kpi-20", name: "Risk Register Currency", owner: "Cloud Sec", unit: "days", target: 75, current: 84, benchmark: 66, collection: "semi-auto", frequency: "monthly" },
    ];
    const benchmarkSources = [
      { source: "NIST CSF", mappedKPIs: 5, alignment: 95, lastReview: "2026-03-07", status: "aligned" },
      { source: "CIS Controls v8", mappedKPIs: 6, alignment: 73, lastReview: "2026-04-02", status: "partial" },
      { source: "ISO 27001:2022", mappedKPIs: 7, alignment: 90, lastReview: "2026-05-25", status: "reviewing" },
      { source: "PCI DSS 4.0", mappedKPIs: 8, alignment: 68, lastReview: "2026-06-20", status: "aligned" },
      { source: "SOC 2 Type II", mappedKPIs: 3, alignment: 85, lastReview: "2026-01-15", status: "partial" },
      { source: "MITRE ATT&CK", mappedKPIs: 4, alignment: 63, lastReview: "2026-02-10", status: "reviewing" },
      { source: "SANS Top 20", mappedKPIs: 5, alignment: 80, lastReview: "2026-03-05", status: "aligned" },
      { source: "OWASP Top 10", mappedKPIs: 6, alignment: 97, lastReview: "2026-04-28", status: "partial" },
    ];
  ...
  private _renderThreatHuntingCampaigns() {
    const campaigns = [
      { id: "HC-1001", name: "Lateral Movement Sweep", status: "active", hypothesis: "H1: Actors using pass-the-hash for lateral movement", leadHunter: "Alice Chen", findings: 42, startDate: "2026-03-27", endDate: null, effectiveness: 47 },
      { id: "HC-1002", name: "Credential Harvesting Hunt", status: "completed", hypothesis: "H2: Actors using web shells for persistence", leadHunter: "Bob Martinez", findings: 45, startDate: "2026-02-10", endDate: "2026-05-16", effectiveness: 66 },
      { id: "HC-1003", name: "Persistence Mechanism Audit", status: "planned", hypothesis: "H3: Actors using scheduled tasks for data theft", leadHunter: "Carol Wu", findings: 0, startDate: "2026-01-21", endDate: null, effectiveness: 85 },
      { id: "HC-1004", name: "C2 Beacon Detection", status: "in-review", hypothesis: "H4: Actors using DNS tunneling for C2 communication", leadHunter: "Dave Kim", findings: 3, startDate: "2026-04-04", endDate: null, effectiveness: 45 },
      { id: "HC-1005", name: "Data Exfiltration Patterns", status: "active", hypothesis: "H5: Actors using encrypted channels for privilege escalation", leadHunter: "Eve Johnson", findings: 6, startDate: "2026-03-15", endDate: null, effectiveness: 64 },
      { id: "HC-1006", name: "Privilege Escalation Scan", status: "completed", hypothesis: "H6: Actors using token impersonation for defense evasion", leadHunter: "Frank Liu", findings: 9, startDate: "2026-02-26", endDate: "2026-06-28", effectiveness: 83 },
      { id: "HC-1007", name: "Supply Chain Implant Hunt", status: "planned", hypothesis: "H7: Actors using poisoned images for initial access", leadHunter: "Grace Park", findings: 12, startDate: "2026-01-09", endDate: null, effectiveness: 43 },
      { id: "HC-1008", name: "Insider Threat Indicators", status: "in-review", hypothesis: "H8: Actors using legitimate tools for credential access", leadHunter: "Hector Silva", findings: 15, startDate: "2026-04-20", endDate: null, effectiveness: 62 },
      { id: "HC-1009", name: "Cloud Metadata Analysis", status: "active", hypothesis: "H9: Actors using API keys for command execution", leadHunter: "Alice Chen", findings: 18, startDate: "2026-03-03", endDate: null, effectiveness: 81 },
      { id: "HC-1010", name: "DNS Tunnel Detection", status: "completed", hypothesis: "H10: Actors using encoded subdomains for exfiltration", leadHunter: "Bob Martinez", findings: 21, startDate: "2026-02-14", endDate: "2026-04-12", effectiveness: 41 },
      { id: "HC-1011", name: "Fileless Malware Search", status: "planned", hypothesis: "H11: Actors using WMI providers for discovery", leadHunter: "Carol Wu", findings: 24, startDate: "2026-01-25", endDate: null, effectiveness: 60 },
      { id: "HC-1012", name: "Zero-Day Exploit Traces", status: "in-review", hypothesis: "H12: Actors using exploit kits for collection", leadHunter: "Dave Kim", findings: 27, startDate: "2026-04-08", endDate: null, effectiveness: 79 },
    ];
    const hunterLeaderboard = [
      { hunter: "Alice Chen", campaigns: 11, findings: 83, highSeverity: 8, avgScore: 85, streak: 3 },
      { hunter: "Bob Martinez", campaigns: 8, findings: 112, highSeverity: 13, avgScore: 78, streak: 4 },
      { hunter: "Carol Wu", campaigns: 5, findings: 25, highSeverity: 18, avgScore: 71, streak: 5 },
      { hunter: "Dave Kim", campaigns: 15, findings: 54, highSeverity: 23, avgScore: 64, streak: 6 },
      { hunter: "Eve Johnson", campaigns: 12, findings: 83, highSeverity: 2, avgScore: 57, streak: 7 },
      { hunter: "Frank Liu", campaigns: 9, findings: 112, highSeverity: 7, avgScore: 94, streak: 8 },
      { hunter: "Grace Park", campaigns: 6, findings: 25, highSeverity: 12, avgScore: 87, streak: 1 },
      { hunter: "Hector Silva", campaigns: 3, findings: 54, highSeverity: 17, avgScore: 80, streak: 2 },
    ];
    const mitreMapping = [
      { tactic: "Initial Access", techniques: 10, campaigns: 1, coverage: 73 },
      { tactic: "Execution", techniques: 9, campaigns: 6, coverage: 53 },
      { tactic: "Persistence", techniques: 8, campaigns: 5, coverage: 33 },
      { tactic: "Privilege Escalation", techniques: 7, campaigns: 4, coverage: 84 },
      { tactic: "Defense Evasion", techniques: 6, campaigns: 3, coverage: 64 },
      { tactic: "Credential Access", techniques: 5, campaigns: 2, coverage: 44 },
      { tactic: "Discovery", techniques: 4, campaigns: 1, coverage: 95 },
      { tactic: "Lateral Movement", techniques: 3, campaigns: 6, coverage: 75 },
      { tactic: "Collection", techniques: 2, campaigns: 5, coverage: 55 },
      { tactic: "Exfiltration", techniques: 12, campaigns: 4, coverage: 35 },
      { tactic: "Command & Control", techniques: 11, campaigns: 3, coverage: 86 },
      { tactic: "Impact", techniques: 10, campaigns: 2, coverage: 66 },
    ];
    return html`
  ...
  private _renderControlInventory() {
    const controls = [
      { id: "CTL-2001", name: "MFA Enforcement", domain: "Access Control", status: "implemented", effectiveness: 44, lastTest: "2026-03-19", nextReview: "2026-07-19", owner: "SOC", risk: "Low" },
      { id: "CTL-2002", name: "Network Segmentation", domain: "Network Security", status: "partial", effectiveness: 14, lastTest: "2026-02-04", nextReview: "2026-08-10", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2003", name: "EDR Deployment", domain: "Endpoint Protection", status: "planned", effectiveness: 21, lastTest: "2026-01-17", nextReview: "2026-09-01", owner: "IT Ops", risk: "High" },
      { id: "CTL-2004", name: "DLP Policy", domain: "Data Protection", status: "gap", effectiveness: 28, lastTest: "2026-04-02", nextReview: "2026-10-20", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2005", name: "SSO Integration", domain: "Identity Management", status: "implemented", effectiveness: 56, lastTest: "2026-03-15", nextReview: "2026-11-11", owner: "IAM", risk: "Low" },
      { id: "CTL-2006", name: "SAST Pipeline", domain: "Application Security", status: "partial", effectiveness: 42, lastTest: "2026-02-28", nextReview: "2026-12-02", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2007", name: "CSPM Scanning", domain: "Cloud Security", status: "planned", effectiveness: 49, lastTest: "2026-01-13", nextReview: "2026-05-21", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2008", name: "Badge Access", domain: "Physical Security", status: "gap", effectiveness: 5, lastTest: "2026-04-26", nextReview: "2026-06-12", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2009", name: "Least Privilege", domain: "Access Control", status: "implemented", effectiveness: 68, lastTest: "2026-03-11", nextReview: "2026-07-03", owner: "SOC", risk: "Low" },
      { id: "CTL-2010", name: "Firewall Rules", domain: "Network Security", status: "partial", effectiveness: 19, lastTest: "2026-02-24", nextReview: "2026-08-22", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2011", name: "Disk Encryption", domain: "Endpoint Protection", status: "planned", effectiveness: 26, lastTest: "2026-01-09", nextReview: "2026-09-13", owner: "IT Ops", risk: "High" },
      { id: "CTL-2012", name: "Data Classification", domain: "Data Protection", status: "gap", effectiveness: 33, lastTest: "2026-04-22", nextReview: "2026-10-04", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2013", name: "PAM Implementation", domain: "Identity Management", status: "implemented", effectiveness: 80, lastTest: "2026-03-07", nextReview: "2026-11-23", owner: "IAM", risk: "Low" },
      { id: "CTL-2014", name: "DAST Pipeline", domain: "Application Security", status: "partial", effectiveness: 47, lastTest: "2026-02-20", nextReview: "2026-12-14", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2015", name: "IAM Policy Review", domain: "Cloud Security", status: "planned", effectiveness: 3, lastTest: "2026-01-05", nextReview: "2026-05-05", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2016", name: "Visitor Management", domain: "Physical Security", status: "gap", effectiveness: 10, lastTest: "2026-04-18", nextReview: "2026-06-24", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2017", name: "Access Reviews", domain: "Access Control", status: "implemented", effectiveness: 92, lastTest: "2026-03-03", nextReview: "2026-07-15", owner: "SOC", risk: "Low" },
      { id: "CTL-2018", name: "IDS/IPS Tuning", domain: "Network Security", status: "partial", effectiveness: 24, lastTest: "2026-02-16", nextReview: "2026-08-06", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2019", name: "Patch Management", domain: "Endpoint Protection", status: "planned", effectiveness: 31, lastTest: "2026-01-01", nextReview: "2026-09-25", owner: "IT Ops", risk: "High" },
      { id: "CTL-2020", name: "Backup Encryption", domain: "Data Protection", status: "gap", effectiveness: 38, lastTest: "2026-04-14", nextReview: "2026-10-16", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2021", name: "Password Policy", domain: "Identity Management", status: "implemented", effectiveness: 45, lastTest: "2026-03-27", nextReview: "2026-11-07", owner: "IAM", risk: "Low" },
      { id: "CTL-2022", name: "Container Scanning", domain: "Application Security", status: "partial", effectiveness: 1, lastTest: "2026-02-12", nextReview: "2026-12-26", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2023", name: "WAF Configuration", domain: "Cloud Security", status: "planned", effectiveness: 8, lastTest: "2026-01-25", nextReview: "2026-05-17", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2024", name: "CCTV Coverage", domain: "Physical Security", status: "gap", effectiveness: 15, lastTest: "2026-04-10", nextReview: "2026-06-08", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2025", name: "RBAC Enforcement", domain: "Access Control", status: "implemented", effectiveness: 57, lastTest: "2026-03-23", nextReview: "2026-07-27", owner: "SOC", risk: "Low" },
      { id: "CTL-2026", name: "VPN Management", domain: "Network Security", status: "partial", effectiveness: 29, lastTest: "2026-02-08", nextReview: "2026-08-18", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2027", name: "App Whitelisting", domain: "Endpoint Protection", status: "planned", effectiveness: 36, lastTest: "2026-01-21", nextReview: "2026-09-09", owner: "IT Ops", risk: "High" },
      { id: "CTL-2028", name: "Key Management", domain: "Data Protection", status: "gap", effectiveness: 43, lastTest: "2026-04-06", nextReview: "2026-10-28", owner: "Data Gov", risk: "Critical" },
    ];
    const gapAnalysis = [
      { gap: "Insufficient MFA coverage for legacy apps", severity: "High", remediationPlan: "Plan R3001", eta: "2026-Q3", estimatedCost: "110k" },
      { gap: "Missing network micro-segmentation", severity: "Medium", remediationPlan: "Plan R3002", eta: "2026-Q2", estimatedCost: "139k" },
      { gap: "Inconsistent EDR deployment", severity: "Medium", remediationPlan: "Plan R3003", eta: "2026-Q4", estimatedCost: "168k" },
      { gap: "DLP not covering cloud storage", severity: "Low", remediationPlan: "Plan R3004", eta: "2026-Q3", estimatedCost: "197k" },
      { gap: "SSO not integrated with all SaaS", severity: "High", remediationPlan: "Plan R3005", eta: "2026-Q2", estimatedCost: "45k" },
    ];
    return html`
  ...
  private _renderIncidentCostTracker() {
    const incidents = [
      { id: "INC-7001", name: "Security Incident 1", severity: "Critical", totalCost: 656000, responseCost: 209920, recoveryCost: 242720, legalCost: 98400, regulatoryCost: 72160, insuranceClaim: 0, avoidedCost: 463000, date: "2026-03-11" },
      { id: "INC-7002", name: "Security Incident 2", severity: "High", totalCost: 659000, responseCost: 118620, recoveryCost: 177930, legalCost: 79080, regulatoryCost: 39540, insuranceClaim: 263600, avoidedCost: 492000, date: "2026-02-20" },
      { id: "INC-7003", name: "Security Incident 3", severity: "Medium", totalCost: 662000, responseCost: 165500, recoveryCost: 251560, legalCost: 59580, regulatoryCost: 79440, insuranceClaim: 0, avoidedCost: 25000, date: "2026-01-01" },
      { id: "INC-7004", name: "Security Incident 4", severity: "Low", totalCost: 665000, responseCost: 212800, recoveryCost: 186200, legalCost: 39900, regulatoryCost: 46550, insuranceClaim: 232750, avoidedCost: 54000, date: "2026-04-10" },
      { id: "INC-7005", name: "Security Incident 5", severity: "Critical", totalCost: 668000, responseCost: 120240, recoveryCost: 260520, legalCost: 126920, regulatoryCost: 86840, insuranceClaim: 0, avoidedCost: 83000, date: "2026-03-19" },
      { id: "INC-7006", name: "Security Incident 6", severity: "High", totalCost: 671000, responseCost: 167750, recoveryCost: 194590, legalCost: 107360, regulatoryCost: 53680, insuranceClaim: 201300, avoidedCost: 112000, date: "2026-02-28" },
      { id: "INC-7007", name: "Security Incident 7", severity: "Medium", totalCost: 674000, responseCost: 215680, recoveryCost: 269600, legalCost: 87620, regulatoryCost: 94360, insuranceClaim: 0, avoidedCost: 141000, date: "2026-01-09" },
      { id: "INC-7008", name: "Security Incident 8", severity: "Low", totalCost: 677000, responseCost: 121860, recoveryCost: 203100, legalCost: 67700, regulatoryCost: 60930, insuranceClaim: 514520, avoidedCost: 170000, date: "2026-04-18" },
      { id: "INC-7009", name: "Security Incident 9", severity: "Critical", totalCost: 680000, responseCost: 170000, recoveryCost: 136000, legalCost: 47600, regulatoryCost: 102000, insuranceClaim: 0, avoidedCost: 199000, date: "2026-03-27" },
      { id: "INC-7010", name: "Security Incident 10", severity: "High", totalCost: 683000, responseCost: 218560, recoveryCost: 211730, legalCost: 136600, regulatoryCost: 68300, insuranceClaim: 484930, avoidedCost: 228000, date: "2026-02-08" },
      { id: "INC-7011", name: "Security Incident 11", severity: "Medium", totalCost: 686000, responseCost: 123480, recoveryCost: 144060, legalCost: 116620, regulatoryCost: 34300, insuranceClaim: 0, avoidedCost: 257000, date: "2026-01-17" },
      { id: "INC-7012", name: "Security Incident 12", severity: "Low", totalCost: 689000, responseCost: 172250, recoveryCost: 220480, legalCost: 96460, regulatoryCost: 75790, insuranceClaim: 454740, avoidedCost: 286000, date: "2026-04-26" },
    ];
    const yearlyTrend = [
      { month: "Jan", incidents: 8, totalCost: "64k", avgCost: "24k", insured: 58 },
      { month: "Feb", incidents: 5, totalCost: "107k", avgCost: "71k", insured: 58 },
      { month: "Mar", incidents: 2, totalCost: "150k", avgCost: "118k", insured: 58 },
      { month: "Apr", incidents: 10, totalCost: "193k", avgCost: "165k", insured: 58 },
      { month: "May", incidents: 7, totalCost: "236k", avgCost: "31k", insured: 58 },
      { month: "Jun", incidents: 4, totalCost: "279k", avgCost: "78k", insured: 58 },
    ];
