...
export class ScPrivacyComputing extends LitElement {
  ...
  private _data: MockItem[] = [
    {name:"Data Masking (Production-like)",status:"active",risk:"low",detail:"Static masking: Name, SSN, DOB | Dynamic masking: Credit card | Tokenization: Email | Freshness: 24h"},
    {name:"Differential Privacy Engine",status:"configured",risk:"medium",detail:"Epsilon: 1.0 | Sensitivity: Calibrated | Query budget: 1000/day | Noise: Laplace mechanism"},
    {name:"Federated Learning Pipeline",status:"ready",risk:"low",detail:"Participants: 3 regions | Model: Secure aggregation | Rounds: 100 | DP guarantee: (3, 0.001)"},
    {name:"Homomorphic Encryption (POC)",status:"research",risk:"medium",detail:"Scheme: CKKS | Operations: Addition + Multiplication | Performance: 15x overhead | Use case: Analytics"},
    {name:"k-Anonymity Verification",status:"enforcing",risk:"high",detail:"k=5 achieved | Quasi-identifiers: 4 | L-diversity: 3 | T-closeness: Verified | Dataset: Customer records"}
  ];
  ...
  render() {
    ...
    return html`<div class="panel"><div class="pt">Privacy Computing</div>
