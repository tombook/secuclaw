/**
 * sc-dependency-tree - Dependency Tree
...
@customElement('sc-dependency-tree')
export class ScDependencyTree extends LitElement {
  static styles = css`
...
@state() private _tablePage = 1;
  ...
  @state() private _comments: CommentEntry[] = [
    { id: 'c1', author: 'soc-tier1', timestamp: '2026-04-23 04:00', text: 'Initial assessment started for Dependency Tree finding #1' },
  ...
  private _items: PanelItem[] = [
      {
            "id": "dependency-tree-1",
            "title": "express@4.18.2 (Direct)",
            "severity": "high",
            "status": "open",
            "category": "Security",
            "source": "SIEM",
            "description": "License: MIT | Transitive: 34 deps | Vulns: C:1 H:2 | Dependants: 12 services",
      ...
      {
            "id": "dependency-tree-2",
            "title": "lodash@4.17.20 (Direct)",
            "severity": "critical",
            "status": "in-progress",
            "category": "Network",
            "source": "EDR",
            "description": "License: MIT | CVE-2026-xxxx Prototype Pollution | Upgrade to: 4.17.21+ | Dependants: 8",
      ...
      {
            "id": "dependency-tree-3",
            "title": "jsonwebtoken@9.0.0 (Direct)",
            "severity": "medium",
            "status": "resolved",
            "category": "Access",
            "source": "Scanner",
            "description": "License: MIT | Vulns: M:1 | Key confusion vulnerability | Upgrade to: 9.0.2+",
      ...
      {
            "id": "dependency-tree-4",
            "title": "aws-sdk@2.1350.0 (Direct)",
            "severity": "low",
            "status": "open",
            "category": "Compliance",
            "source": "Audit",
            "description": "License: Apache-2.0 | No vulns | Version outdated (v3 available) | Dependants: 5 services",
      ...
      {
            "id": "dependency-tree-5",
            "title": "Dependency Tree Finding #5",
            "severity": "medium",
            "status": "open",
            "category": "Operations",
            "source": "Manual",
            "description": "Automated dependency tree assessment finding detected during routine scan of infrastructure component. Review and remediation recommended.",
      ...
      {
            "id": "dependency-tree-6",
            "title": "Dependency Tree Finding #6",
            "severity": "high",
            "status": "open",
            "category": "Security",
            "source": "SIEM",
      ...
      {
            "id": "dependency-tree-7",
            "title": "Dependency Tree Finding #7",
            "severity": "low",
            "status": "open",
            "category": "Network",
            "source": "EDR",
      ...
      {
            "id": "dependency-tree-8",
            "title": "Dependency Tree Finding #8",
            "severity": "medium",
            "status": "open",
            "category": "Access",
            "source": "Scanner",
      ...
      {
            "id": "dependency-tree-9",
            "title": "Dependency Tree Finding #9",
            "severity": "high",
            "status": "open",
            "category": "Compliance",
            "source": "Audit",
      ...
      {
            "id": "dependency-tree-10",
            "title": "Dependency Tree Finding #10",
            "severity": "low",
            "status": "open",
            "category": "Operations",
            "source": "Manual",
  ...
  private _history: HistoryEntry[] = [
    { timestamp: '2026-04-23 04:15', action: 'Auto-correlated', user: 'system', details: 'Grouped related findings from Dependency Tree analysis' },
    { timestamp: '2026-04-23 03:00', action: 'Created', user: 'scanner', details: 'New Dependency Tree finding detected by automated assessment' },
    ...
    { timestamp: '2026-04-22 22:00', action: 'Resolved', user: 'security-eng', details: 'Remediation applied and verified for Dependency Tree finding' },
    { timestamp: '2026-04-22 18:00', action: 'Created', user: 'audit', details: 'Compliance audit identified Dependency Tree gap requiring remediation' },
    ...
    { timestamp: '2026-04-21 16:00', action: 'Resolved', user: 'soc-tier1', details: 'False positive confirmed - benign activity flagged by Dependency Tree scan' },
    { timestamp: '2026-04-21 12:00', action: 'Exported', user: 'compliance', details: 'Exported Dependency Tree findings for Q1 compliance report' },
  ];
...
private _workflowTasks: WorkflowTask[] = [
    { id: 'wt-1', title: 'Review Dependency Tree finding #1', status: 'active', assignee: 'soc-tier1', blockedBy: [], slaDeadline: '2026-04-23T12:00:00Z', priority: 'p1', createdAt: '2026-04-23T00:00:00Z', completedAt: null },
    ...
    { id: 'wt-3', title: 'Update Dependency Tree detection rules', status: 'blocked', assignee: 'soc-tier2', blockedBy: ['wt-2'], slaDeadline: '2026-04-24T00:00:00Z', priority: 'p2', createdAt: '2026-04-23T03:00:00Z', completedAt: null },
    ...
    { id: 'wt-8', title: 'Archive resolved Dependency Tree findings', status: 'failed', assignee: 'soc-tier1', blockedBy: [], slaDeadline: '2026-04-23T08:00:00Z', priority: 'p4', createdAt: '2026-04-22T22:00:00Z', completedAt: null },
  ];

private _executionHistory: ExecutionRecord[] = [
    {
      id: 'exec-1', name: 'Dependency Tree Full Assessment Run', startedAt: '2026-04-22T10:00:00Z', completedAt: '2026-04-22T10:12:00Z', status: 'success',
      steps: [
    ...
    {
      id: 'exec-2', name: 'Dependency Tree Delta Scan', startedAt: '2026-04-23T02:00:00Z', completedAt: '2026-04-23T02:05:00Z', status: 'failed',
      steps: [
  ...
  private _runExecution() {
    ...
    const exec: ExecutionRecord = {
      id: 'exec-' + Date.now(), name: 'Dependency Tree Assessment ' + new Date().toISOString().slice(0, 10), startedAt: new Date().toISOString(), completedAt: null, status: 'running', steps,
    };
  ...
  private _renderExecutionPanel(): unknown {
    ...
    return html`
      <div class="form-section">
        ...
        ` : html`<div class="empty-state">Click "Run Assessment" to start the Dependency Tree analysis pipeline</div>`}
      </div>
      <div class="form-section">
        ...
        <div class="settings-card">
          ...
          <div style="display:flex;gap:8px;margin-top:4px;">
            <button class="btn primary" @click=${() => {
              ...
              const a = document.createElement('a'); a.href = url; a.download = 'dependency-tree-config.json'; a.click();
    ...
    return html`
      <div style="margin-top:12px;">
        ...
        <div style="display:flex;gap:6px;margin-top:8px;">
          <input class="search-box" type="text" placeholder="Add a comment..." style="min-width:auto;flex:1;" id="dependency-tree-comment-input" />
          <button class="btn primary" @click=${() => {
            const input = this.shadowRoot?.querySelector('#dependency-tree-comment-input') as HTMLInputElement;
  ...
  private _exportJSON() {
    ...
    const url = URL.createObjectURL(blob);
    const a = document.createElement('a'); a.href = url; a.download = 'sc-dependency-tree-data.json'; a.click();
    URL.revokeObjectURL(url);
  }
  ...
  private _exportCSV() {
    ...
    const url = URL.createObjectURL(blob);
    const a = document.createElement('a'); a.href = url; a.download = 'sc-dependency-tree-data.csv'; a.click();
    URL.revokeObjectURL(url);
  }


  // --- Domain Rules Engine ---
  @state() private _deptRules: { id: string; name: string; category: string; severity: Severity; enabled: boolean; lastEval: string; passRate: number }[] = [];
  private _initDeptRules() {
    const rules = [
    ...
    this._deptRules = rules;
  }
  private _evaluateDeptRules(): { passed: number; failed: number; skipped: number; total: number } {
    let passed = 0, failed = 0, skipped = 0;
    this._deptRules.forEach(r => { if (!r.enabled) { skipped++; } else if (r.passRate >= 80) { passed++; } else { failed++; } });
    return { passed, failed, skipped, total: this._deptRules.length };
  }

  // --- CVSS Scoring ---
  @state() private _deptcvssData: { itemId: string; vector: string; base: number; temporal: number; environmental: number; overall: number }[] = [];
  private _initDeptCvss() {
    ...
    this._deptcvssData = vectors.map((v, i) => {
  ...
  // --- Anomaly Detection ---
  @state() private _deptanomalies: { id: string; type: string; severity: Severity; description: string; detected: string; confidence: number; affected: string[] }[] = [];
  private _runDeptAnomalyDetection() {
    const types = [
    ...
    this._deptanomalies = types.map((a, i) => ({
  ...
  // --- Trend Prediction ---
  @state() private _deptpredictions: { horizon: string; metric: string; current: number; predicted: number; direction: 'up' | 'down' | 'stable'; confidence: number }[] = [];
  private _generateDeptPredictions() {
    this._deptpredictions = [
  ...
  // --- Approval Workflow ---
  @state() private _deptApprovals: { id: string; title: string; requester: string; status: 'pending' | 'approved' | 'rejected' | 'expired'; createdAt: string; priority: Priority; type: string }[] = [];
  private _initDeptApprovals() {
    this._deptApprovals = [
  ...
  private _approveDeptItem(id: string) { const item = this._deptApprovals.find(a => a.id === id); if (item) item.status = 'approved'; this.requestUpdate(); }
  private _rejectDeptItem(id: string) { const item = this._deptApprovals.find(a => a.id === id); if (item) item.status = 'rejected'; this.requestUpdate(); }

  // --- Activity Feed ---
  @state() private _deptActivity: { id: string; action: string; user: string; target: string; timestamp: string }[] = [];
  private _initDeptActivity() {
    const actions = [
    ...
    this._deptActivity = actions.map((a, i) => ({ id: 'ACT-' + String(i + 1).padStart(3, '0'), ...a, timestamp: new Date(Date.now() - i * 3600000).toISOString() }));
  }

  // --- Notification System ---
  @state() private _deptNotifications: { id: string; message: string; type: 'info' | 'warning' | 'error' | 'success'; read: boolean; timestamp: string }[] = [];
  private _initDeptNotifications() {
    this._deptNotifications = [
  ...
  private _markDeptNotifRead(id: string) { const n = this._deptNotifications.find(x => x.id === id); if (n) n.read = true; this.requestUpdate(); }

  // --- Panel Configuration ---
  @state() private _deptConfig: { layout: 'compact' | 'default' | 'expanded'; theme: 'dark' | 'midnight' | 'slate'; showAnomalies: boolean; showPredictions: boolean; autoRefresh: boolean; refreshInterval: number } = {
    layout: 'default', theme: 'dark', showAnomalies: true, showPredictions: true, autoRefresh: true, refreshInterval: 60,
  };
  private _deptPresets: { name: string; config: typeof this._deptConfig }[] = [
  ...
  private _applyDeptPreset(preset: typeof this._deptPresets[0]) { this._deptConfig = { ...preset.config }; this.requestUpdate(); }

  private _renderDeptTreemapSVG(): string {
    const categories = [
  ...
  private _renderDeptSankeySVG(): string {
  ...
  // --- Render: Rules Engine ---
  private _renderDeptRules(): any {
    const ev = this._evaluateDeptRules();
    return html`
  ...
  private _renderDeptAnomalies(): any {
    ...
    return html`
      <div style="background:#1a1d27;border-radius:8px;padding:12px;margin-top:12px">
        ...
        <div style="display:flex;flex-direction:column;gap:6px;max-height:160px;overflow-y:auto">
          $${this._deptanomalies.map(a => html`
  ...
  // --- Render: Approvals ---
  private _renderDeptApprovals(): any {
    ...
    return html`
      <div style="background:#1a1d27;border-radius:8px;padding:12px;margin-top:12px">
        ...
        <div style="display:flex;flex-direction:column;gap:6px;max-height:160px;overflow-y:auto">
          $${this._deptApprovals.map(a => html`
            <div style="padding:6px 8px;background:#1f2937;border-radius:4px">
              ...
              $${a.status === 'pending' ? html`
                <div style="display:flex;gap:4px;margin-top:4px">
                  <button class="btn success" style="padding:2px 8px;font-size:9px" @click=$${() => this._approveDeptItem(a.id)}>Approve</button>
                  <button class="btn error" style="padding:2px 8px;font-size:9px" @click=$${() => this._rejectDeptItem(a.id)}>Reject</button>
                </div>` : nothing}
            </div>`)}
        </div>
      </div>`;
  ...
  private _renderDeptNotifications(): any {
    const tc = (t: string) => t === 'error' ? '#ef4444' : t === 'warning' ? '#eab308' : t === 'success' ? '#22c55e' : '#3b82f6';
    const unread = this._deptNotifications.filter(n => !n.read).length;
    return html`
      <div style="background:#1a1d27;border-radius:8px;padding:12px;margin-top:12px">
        ...
        <div style="display:flex;flex-direction:column;gap:4px;max-height:120px;overflow-y:auto">
          $${this._deptNotifications.map(n => html`
            <div style="display:flex;align-items:center;gap:8px;padding:4px 8px;background:$${n.read ? '#1f2937' : '#252a36'};border-radius:4px;font-size:10px;opacity:$${n.read ? '0.6' : '1'};cursor:pointer" @click=$${() => this._markDeptNotifRead(n.id)}>
      ...
      <div style="background:#1a1d27;border-radius:8px;padding:12px;margin-top:12px">
        ...
        <div style="display:flex;flex-direction:column;gap:6px;font-size:10px">
          <div style="display:flex;align-items:center;gap:8px">
            ...
            <select class="form-input" style="flex:1" @change=$${(e: Event) => { this._deptConfig.layout = (e.target as HTMLSelectElement).value as any; this.requestUpdate(); }}>
              <option value="compact" ?selected=$${this._deptConfig.layout === 'compact'}>Compact</option>
              <option value="default" ?selected=$${this._deptConfig.layout === 'default'}>Default</option>
              <option value="expanded" ?selected=$${this._deptConfig.layout === 'expanded'}>Expanded</option>
            </select>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Theme</span>
            <select class="form-input" style="flex:1" @change=$${(e: Event) => { this._deptConfig.theme = (e.target as HTMLSelectElement).value as any; this.requestUpdate(); }}>
              <option value="dark" ?selected=$${this._deptConfig.theme === 'dark'}>Dark</option>
              <option value="midnight" ?selected=$${this._deptConfig.theme === 'midnight'}>Midnight</option>
              <option value="slate" ?selected=$${this._deptConfig.theme === 'slate'}>Slate</option>
            </select>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Auto Refresh</span>
            <input type="checkbox" ?checked=$${this._deptConfig.autoRefresh} @change=$${() => { this._deptConfig.autoRefresh = !this._deptConfig.autoRefresh; this.requestUpdate(); }}/>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Show Anomalies</span>
            <input type="checkbox" ?checked=$${this._deptConfig.showAnomalies} @change=$${() => { this._deptConfig.showAnomalies = !this._deptConfig.showAnomalies; this.requestUpdate(); }}/>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Show Predictions</span>
            <input type="checkbox" ?checked=$${this._deptConfig.showPredictions} @change=$${() => { this._deptConfig.showPredictions = !this._deptConfig.showPredictions; this.requestUpdate(); }}/>
          </div>
          <div style="margin-top:6px;font-weight:600">Presets</div>
          <div style="display:flex;gap:4px">
            $${this._deptPresets.map(ps => html`<button class="btn" style="padding:2px 8px;font-size:9px" @click=$${() => this._applyDeptPreset(ps)}>$${ps.name}</button>`)}
          </div>
        </div>
      </div>`;
  }
  ...
  @state() private _dependencyTrContainerScans: Array<{image:string;registry:string;critical:number;high:number;medium:number;scanDate:string;status:string}> = [
  ...
  @state() private _dependencyTrK8sPods: Array<{namespace:string;pod:string;securityContext:string;hostIPC:boolean;hostPID:boolean;privileged:boolean;riskLevel:string}> = [
  ...
  @state() private _dependencyTrServerlessRisk: Array<{function:string;runtime:string;timeout:number;iamPerms:string;externalCalls:number;riskScore:number}> = [
  ...
  @state() private _dependencyTrRuntimeAlerts: Array<{id:string;workload:string;alertType:string;severity:string;description:string;timestamp:string}> = [
  ...
  private _renderDependencytrCloudWl(): TemplateResult {
    const containers = this._dependencyTrContainerScans;
    const pods = this._dependencyTrK8sPods;
    const alerts = this._dependencyTrRuntimeAlerts;
    return html`
  ...
  @state() private _dependencyTrCorrRules: Array<{id:string;name:string;sources:string[];logic:string;severity:string;active:boolean;lastTriggered:string}> = [
  ...
  @state() private _dependencyTrEventTimeline: Array<{timestamp:string;source:string;eventType:string;details:string;correlated:boolean}> = [
  ...
  @state() private _dependencyTrFalsePosMetrics: {totalEvents:number;correlatedEvents:number;falsePositives:number;fpRate:number;topFpRules:string[]} = {
  ...
  @state() private _dependencyTrEventPatterns: Array<{id:string;pattern:string;frequency:number;firstSeen:string;lastSeen:string;status:string}> = [
  ...
  private _renderDependencytrEventCorr(): TemplateResult {
    const rules = this._dependencyTrCorrRules;
    const timeline = this._dependencyTrEventTimeline;
    const fpMetrics = this._dependencyTrFalsePosMetrics;
    return html`
  ...
  @state() private _dependencyTrCourses: Array<{id:string;title:string;category:string;duration:number;enrolled:number;completed:number;difficulty:string;rating:number}> = [
  ...
  @state() private _dependencyTrLearningPaths: Array<{id:string;name:string;courseIds:string[];progress:number;enrolled:number}> = [
  ...
  @state() private _dependencyTrDeptCompliance: Array<{dept:string;trainedPct:number;targetPct:number;avgScore:number;certCount:number}> = [
  ...
  @state() private _dependencyTrSkillsGaps: Array<{skill:string;current:number;required:number;gap:number;priority:string}> = [
  ...
  private _renderDependencytrTraining(): TemplateResult {
    const courses = this._dependencyTrCourses;
    const deptComp = this._dependencyTrDeptCompliance;
    return html`
  ...
  @state() private _dependencyTrRiskTopTen: Array<{id:string;name:string;score:number;trend:string;owner:string;category:string;lastAssessed:string}> = [
  ...
  @state() private _dependencyTrRiskCategories: Array<{category:string;count:number;avgScore:number;color:string}> = [
  ...
  @state() private _dependencyTrRiskVelocity: Array<{week:string;newRisks:number;closedRisks:number;netChange:number}> = [
  ...
  @state() private _dependencyTrRiskAppetite: {current:number;threshold:number;maxTolerated:number;status:string} = {
    current: 68, threshold: 55, maxTolerated: 80, status: 'Warning'
  };
  @state() private _dependencyTrRiskOwnerMatrix: Array<{owner:string;criticalCount:number;highCount:number;mediumCount:number;complianceRate:number}> = [
  ...
  private _renderDependencytrRiskDash(): TemplateResult {
    const riskItems = this._dependencyTrRiskTopTen;
    const velocity = this._dependencyTrRiskVelocity;
    const appetite = this._dependencyTrRiskAppetite;
    return html`
  ...
  @state() private _complianceCalendarEvents: Array<{id: string; title: string; deadline: string; category: string; status: string; assignee: string; notes: string}> = [
    {id: 'cc-dependency-tree-001', title: 'SOX Section 404 Compliance Review', deadline: '2026-06-30', category: 'Regulatory', status: 'In Progress', assignee: 'Compliance Team', notes: 'Annual internal control assessment for financial reporting'},
    {id: 'cc-dependency-tree-002', title: 'GDPR Data Protection Impact Assessment', deadline: '2026-05-15', category: 'Privacy', status: 'Pending', assignee: 'DPO Office', notes: 'Quarterly DPIA for high-risk processing activities'},
    {id: 'cc-dependency-tree-003', title: 'ISO 27001 Surveillance Audit', deadline: '2026-07-20', category: 'Certification', status: 'Scheduled', assignee: 'QA Lead', notes: 'Stage 2 surveillance audit for ISMS certification renewal'},
    {id: 'cc-dependency-tree-004', title: 'PCI DSS v4.0 Gap Analysis', deadline: '2026-05-30', category: 'Payment', status: 'Not Started', assignee: 'Security Architect', notes: 'Assess current state against PCI DSS v4.0 requirements'},
    {id: 'cc-dependency-tree-005', title: 'NIST CSF Self-Assessment', deadline: '2026-08-15', category: 'Framework', status: 'Pending', assignee: 'CISO', notes: 'Biannual self-assessment against NIST Cybersecurity Framework'},
    {id: 'cc-dependency-tree-006', title: 'HIPAA Security Rule Audit', deadline: '2026-06-15', category: 'Healthcare', status: 'In Progress', assignee: 'Compliance Analyst', notes: 'Annual audit of administrative, physical, and technical safeguards'},
    {id: 'cc-dependency-tree-007', title: 'SOC 2 Type II Report Renewal', deadline: '2026-09-30', category: 'Audit', status: 'Scheduled', assignee: 'External Auditor', notes: 'Engage auditor for SOC 2 Type II examination period'},
    {id: 'cc-dependency-tree-008', title: 'FedRAMP Authorization Review', deadline: '2026-07-01', category: 'Government', status: 'Pending', assignee: 'FedRAMP PMO', notes: 'Review and update security authorization package'},
    {id: 'cc-dependency-tree-009', title: 'Annual Penetration Test', deadline: '2026-10-15', category: 'Testing', status: 'Not Started', assignee: 'Red Team Lead', notes: 'Comprehensive external and internal penetration testing engagement'},
    {id: 'cc-dependency-tree-010', title: 'Security Awareness Training Rollout', deadline: '2026-05-01', category: 'Training', status: 'Completed', assignee: 'Security Awareness Manager', notes: 'Q2 organization-wide security awareness training program'},
    {id: 'cc-dependency-tree-011', title: 'Vendor Security Review Cycle', deadline: '2026-06-01', category: 'Third Party', status: 'In Progress', assignee: 'Vendor Manager', notes: 'Quarterly review of critical vendor security posture and SLA compliance'},
    {id: 'cc-dependency-tree-012', title: 'Incident Response Plan Update', deadline: '2026-05-20', category: 'Operations', status: 'Pending', assignee: 'IR Team Lead', notes: 'Update IR procedures based on lessons learned from recent incidents'},
  ];
  ...
  @state() private _dataQualityMetrics: Array<{id: string; dataSource: string; completenessScore: number; accuracyScore: number; timelinessScore: number; consistencyScore: number; reliabilityRank: number; lastUpdated: string; issues: string[]; trend: string}> = [
    {id: 'dq-dependency-tree-001', dataSource: 'Vulnerability Scanner Feed', completenessScore: 94, accuracyScore: 91, timelinessScore: 88, consistencyScore: 95, reliabilityRank: 1, lastUpdated: '2026-04-23T08:00:00Z', issues: ['Minor delay in Nessus plugin updates'], trend: 'improving'},
    {id: 'dq-dependency-tree-002', dataSource: 'SIEM Event Logs', completenessScore: 87, accuracyScore: 93, timelinessScore: 96, consistencyScore: 89, reliabilityRank: 2, lastUpdated: '2026-04-23T07:30:00Z', issues: ['Some log sources showing gaps in off-hours'], trend: 'stable'},
    {id: 'dq-dependency-tree-003', dataSource: 'Asset Inventory Database', completenessScore: 82, accuracyScore: 78, timelinessScore: 75, consistencyScore: 84, reliabilityRank: 4, lastUpdated: '2026-04-22T18:00:00Z', issues: ['Shadow IT devices not fully cataloged', 'Decommissioned assets still listed'], trend: 'declining'},
    {id: 'dq-dependency-tree-004', dataSource: 'Threat Intelligence Platform', completenessScore: 91, accuracyScore: 89, timelinessScore: 92, consistencyScore: 87, reliabilityRank: 3, lastUpdated: '2026-04-23T06:00:00Z', issues: ['Some IOC sources lack confidence scoring'], trend: 'improving'},
    {id: 'dq-dependency-tree-005', dataSource: 'Identity Provider Logs', completenessScore: 96, accuracyScore: 97, timelinessScore: 98, consistencyScore: 96, reliabilityRank: 1, lastUpdated: '2026-04-23T09:00:00Z', issues: [], trend: 'stable'},
    {id: 'dq-dependency-tree-006', dataSource: 'Cloud Security Posture Data', completenessScore: 79, accuracyScore: 85, timelinessScore: 82, consistencyScore: 81, reliabilityRank: 5, lastUpdated: '2026-04-23T05:00:00Z', issues: ['Multi-cloud coverage gaps', 'API rate limiting affects scan frequency'], trend: 'declining'},
    {id: 'dq-dependency-tree-007', dataSource: 'Compliance Evidence Store', completenessScore: 88, accuracyScore: 86, timelinessScore: 80, consistencyScore: 83, reliabilityRank: 4, lastUpdated: '2026-04-21T14:00:00Z', issues: ['Manual evidence collection delays', 'Inconsistent formatting across frameworks'], trend: 'stable'},
    {id: 'dq-dependency-tree-008', dataSource: 'Network Flow Data', completenessScore: 92, accuracyScore: 90, timelinessScore: 94, consistencyScore: 91, reliabilityRank: 2, lastUpdated: '2026-04-23T08:30:00Z', issues: ['Encrypted traffic classification accuracy needs improvement'], trend: 'improving'},
  ];
  ...
  @state() private _workflowTemplates: Array<{id: string; name: string; description: string; category: string; steps: number; avgDuration: string; successRate: number; lastRun: string; manualInterventions: number; optimizationScore: number}> = [
    {id: 'wf-dependency-tree-001', name: 'Vulnerability Triage Pipeline', description: 'Automated vulnerability assessment, prioritization, and assignment workflow', category: 'Vulnerability Management', steps: 8, avgDuration: '12 min', successRate: 94.5, lastRun: '2026-04-23T06:00:00Z', manualInterventions: 2, optimizationScore: 87},
    {id: 'wf-dependency-tree-002', name: 'Incident Response Orchestration', description: 'End-to-end IR workflow from detection to containment and recovery', category: 'Incident Response', steps: 15, avgDuration: '45 min', successRate: 89.2, lastRun: '2026-04-22T14:30:00Z', manualInterventions: 5, optimizationScore: 72},
    {id: 'wf-dependency-tree-003', name: 'Access Request Approval Chain', description: 'Multi-level approval workflow for privileged access requests', category: 'Identity & Access', steps: 6, avgDuration: '4 hours', successRate: 97.1, lastRun: '2026-04-23T09:15:00Z', manualInterventions: 1, optimizationScore: 92},
    {id: 'wf-dependency-tree-004', name: 'Compliance Evidence Collection', description: 'Automated gathering and packaging of audit evidence artifacts', category: 'Compliance', steps: 10, avgDuration: '30 min', successRate: 91.8, lastRun: '2026-04-21T10:00:00Z', manualInterventions: 3, optimizationScore: 78},
    {id: 'wf-dependency-tree-005', name: 'Security Patch Deployment', description: 'Staged patch rollout with validation and rollback capability', category: 'Patch Management', steps: 12, avgDuration: '2 hours', successRate: 96.3, lastRun: '2026-04-20T22:00:00Z', manualInterventions: 1, optimizationScore: 85},
    {id: 'wf-dependency-tree-006', name: 'Threat Intelligence Enrichment', description: 'IOC enrichment and correlation with internal threat data', category: 'Threat Intelligence', steps: 7, avgDuration: '8 min', successRate: 93.7, lastRun: '2026-04-23T07:00:00Z', manualInterventions: 0, optimizationScore: 95},
    {id: 'wf-dependency-tree-007', name: 'Security Reporting Pipeline', description: 'Automated generation and distribution of security metrics reports', category: 'Reporting', steps: 5, avgDuration: '15 min', successRate: 98.9, lastRun: '2026-04-23T08:00:00Z', manualInterventions: 0, optimizationScore: 97},
    {id: 'wf-dependency-tree-008', name: 'Vendor Risk Assessment', description: 'Automated vendor security questionnaire distribution and scoring', category: 'Third Party', steps: 9, avgDuration: '3 days', successRate: 85.4, lastRun: '2026-04-19T11:00:00Z', manualInterventions: 4, optimizationScore: 65},
  ];
  ...
  @state() private _workflowExecutionHistory: Array<{workflowId: string; runDate: string; duration: string; status: string; trigger: string}> = [
    {workflowId: 'wf-dependency-tree-001', runDate: '2026-04-23T06:00:00Z', duration: '11 min 23 sec', status: 'Success', trigger: 'Scheduled'},
    {workflowId: 'wf-dependency-tree-002', runDate: '2026-04-22T14:30:00Z', duration: '42 min 15 sec', status: 'Success', trigger: 'Alert'},
    {workflowId: 'wf-dependency-tree-003', runDate: '2026-04-23T09:15:00Z', duration: '3h 45 min', status: 'Success', trigger: 'User Request'},
    {workflowId: 'wf-dependency-tree-001', runDate: '2026-04-22T06:00:00Z', duration: '13 min 08 sec', status: 'Partial', trigger: 'Scheduled'},
    {workflowId: 'wf-dependency-tree-004', runDate: '2026-04-21T10:00:00Z', duration: '28 min 42 sec', status: 'Success', trigger: 'Scheduled'},
  ];
  ...
  @state() private _knowledgeArticles: Array<{id: string; title: string; category: string; author: string; publishDate: string; views: number; rating: number; tags: string[]; summary: string; readTime: string}> = [
    {id: 'kb-dependency-tree-001', title: 'Zero Trust Architecture Implementation Guide', category: 'Architecture', author: 'Security Architecture Team', publishDate: '2026-03-15', views: 1842, rating: 4.8, tags: ['zero-trust', 'network', 'identity'], summary: 'Comprehensive guide for implementing zero trust principles across enterprise infrastructure', readTime: '15 min'},
    {id: 'kb-dependency-tree-002', title: 'Ransomware Defense Playbook 2026', category: 'Threats', author: 'Threat Intelligence Team', publishDate: '2026-04-01', views: 2341, rating: 4.9, tags: ['ransomware', 'incident-response', 'defense'], summary: 'Updated playbook with latest ransomware tactics, techniques, and defensive measures', readTime: '12 min'},
    {id: 'kb-dependency-tree-003', title: 'Cloud Security Best Practices for Multi-Cloud', category: 'Cloud', author: 'Cloud Security Team', publishDate: '2026-02-28', views: 1567, rating: 4.5, tags: ['cloud', 'aws', 'azure', 'gcp'], summary: 'Best practices for securing workloads across multiple cloud service providers', readTime: '18 min'},
    {id: 'kb-dependency-tree-004', title: 'API Security Testing Methodology', category: 'Testing', author: 'Red Team', publishDate: '2026-03-22', views: 987, rating: 4.6, tags: ['api', 'testing', 'owasp'], summary: 'Structured methodology for identifying and testing API security vulnerabilities', readTime: '10 min'},
    {id: 'kb-dependency-tree-005', title: 'Supply Chain Security Risk Management', category: 'Third Party', author: 'GRC Team', publishDate: '2026-01-20', views: 1234, rating: 4.3, tags: ['supply-chain', 'vendor', 'risk'], summary: 'Framework for managing security risks in the software supply chain', readTime: '14 min'},
    {id: 'kb-dependency-tree-006', title: 'Kubernetes Security Hardening Checklist', category: 'Container', author: 'Platform Security', publishDate: '2026-04-10', views: 2103, rating: 4.7, tags: ['kubernetes', 'container', 'hardening'], summary: 'Step-by-step hardening checklist for production Kubernetes clusters', readTime: '11 min'},
    {id: 'kb-dependency-tree-007', title: 'Security Metrics That Matter for Executives', category: 'Metrics', author: 'CISO Office', publishDate: '2026-03-05', views: 876, rating: 4.4, tags: ['metrics', 'kpi', 'reporting'], summary: 'Key security metrics and KPIs that resonate with board-level stakeholders', readTime: '8 min'},
    {id: 'kb-dependency-tree-008', title: 'Phishing Simulation Campaign Design', category: 'Awareness', author: 'Security Awareness Team', publishDate: '2026-02-15', views: 1456, rating: 4.5, tags: ['phishing', 'simulation', 'training'], summary: 'Designing effective phishing simulations that drive real behavioral change', readTime: '9 min'},
    {id: 'kb-dependency-tree-009', title: 'Data Loss Prevention Strategy and Implementation', category: 'Data Protection', author: 'Data Security Team', publishDate: '2026-03-28', views: 1678, rating: 4.6, tags: ['dlp', 'data-protection', 'compliance'], summary: 'Strategic approach to DLP covering people, process, and technology layers', readTime: '16 min'},
    {id: 'kb-dependency-tree-010', title: 'Security Automation with SOAR Platforms', category: 'Automation', author: 'SOC Engineering', publishDate: '2026-04-05', views: 1098, rating: 4.7, tags: ['soar', 'automation', 'soc'], summary: 'Building effective security automation playbooks using SOAR technology', readTime: '13 min'},
    {id: 'kb-dependency-tree-011', title: 'Third-Party Risk Assessment Framework', category: 'GRC', author: 'Vendor Management', publishDate: '2026-01-30', views: 1345, rating: 4.4, tags: ['vendor', 'risk', 'assessment'], summary: 'Structured framework for evaluating and monitoring third-party security risks', readTime: '12 min'},
    {id: 'kb-dependency-tree-012', title: 'Network Detection and Response Best Practices', category: 'Network', author: 'Network Security Team', publishDate: '2026-03-18', views: 1567, rating: 4.5, tags: ['ndr', 'network', 'detection'], summary: 'Implementing effective network detection and response capabilities', readTime: '14 min'},
    {id: 'kb-dependency-tree-013', title: 'Security Chaos Engineering Guide', category: 'Resilience', author: 'SRE Security', publishDate: '2026-04-12', views: 789, rating: 4.3, tags: ['chaos-engineering', 'resilience', 'testing'], summary: 'Applying chaos engineering principles to validate security controls', readTime: '10 min'},
    {id: 'kb-dependency-tree-014', title: 'Incident Communication Templates', category: 'Incident Response', author: 'IR Team', publishDate: '2026-02-22', views: 2234, rating: 4.8, tags: ['incident', 'communication', 'templates'], summary: 'Ready-to-use communication templates for security incident scenarios', readTime: '7 min'},
    {id: 'kb-dependency-tree-015', title: 'Endpoint Detection and Response Configuration', category: 'Endpoint', author: 'Endpoint Security', publishDate: '2026-03-08', views: 1345, rating: 4.5, tags: ['edr', 'endpoint', 'configuration'], summary: 'Optimal EDR configuration for maximum detection with minimal false positives', readTime: '11 min'},
    {id: 'kb-dependency-tree-016', title: 'Security Code Review Standards', category: 'Development', author: 'AppSec Team', publishDate: '2026-02-10', views: 1890, rating: 4.6, tags: ['code-review', 'secure-sdlc', 'standards'], summary: 'Standards and checklists for security-focused code reviews', readTime: '13 min'},
    {id: 'kb-dependency-tree-017', title: 'IoT Security Assessment Methodology', category: 'IoT', author: 'IoT Security Lab', publishDate: '2026-04-08', views: 654, rating: 4.2, tags: ['iot', 'embedded', 'assessment'], summary: 'Methodology for assessing security posture of IoT devices and ecosystems', readTime: '15 min'},
    {id: 'kb-dependency-tree-018', title: 'Passwordless Authentication Migration Guide', category: 'Identity', author: 'IAM Team', publishDate: '2026-03-25', views: 1678, rating: 4.7, tags: ['passwordless', 'authentication', 'mfa'], summary: 'Step-by-step migration plan from password-based to passwordless authentication', readTime: '12 min'},
    {id: 'kb-dependency-tree-019', title: 'Security Awareness Program Metrics', category: 'Awareness', author: 'Security Culture Team', publishDate: '2026-01-25', views: 1123, rating: 4.4, tags: ['awareness', 'metrics', 'culture'], summary: 'Measuring the effectiveness of your security awareness and training programs', readTime: '9 min'},
    {id: 'kb-dependency-tree-020', title: 'Deception Technology Deployment Guide', category: 'Detection', author: 'Blue Team', publishDate: '2026-04-15', views: 876, rating: 4.5, tags: ['deception', 'honeypot', 'detection'], summary: 'Planning and deploying deception technology for advanced threat detection', readTime: '11 min'},
  ];
  ...
  // --- Security Scenario Planning Methods (DETR) ---
  private _initDetrScenarios(): void {
    const worstCaseScenarios = [
      { id: "detr-sc-01", name: "Ransomware Attack on Critical Infrastructure", category: "Malware", impact: 9500000, probability: 0.12, recoveryDays: 21, affectedSystems: 47, dataLossGb: 320, businessImpact: "critical" },
      { id: "detr-sc-02", name: "Insider Data Exfiltration via Authorized Channels", category: "Insider Threat", impact: 7200000, probability: 0.18, recoveryDays: 14, affectedSystems: 12, dataLossGb: 85, businessImpact: "high" },
      { id: "detr-sc-03", name: "Supply Chain Compromise via Third-Party Library", category: "Supply Chain", impact: 6800000, probability: 0.09, recoveryDays: 30, affectedSystems: 63, dataLossGb: 0, businessImpact: "critical" },
      { id: "detr-sc-04", name: "Cloud Misconfiguration Leading to Public Exposure", category: "Cloud", impact: 4100000, probability: 0.22, recoveryDays: 7, affectedSystems: 8, dataLossGb: 450, businessImpact: "high" },
      { id: "detr-sc-05", name: "Zero-Day Exploit in Core Application Framework", category: "Vulnerability", impact: 8900000, probability: 0.05, recoveryDays: 45, affectedSystems: 120, dataLossGb: 0, businessImpact: "critical" },
      { id: "detr-sc-06", name: "Distributed Denial of Service on Customer-Facing Services", category: "Availability", impact: 3400000, probability: 0.25, recoveryDays: 3, affectedSystems: 15, dataLossGb: 0, businessImpact: "medium" },
      { id: "detr-sc-07", name: "Credential Stuffing and Account Takeover Wave", category: "Identity", impact: 2800000, probability: 0.30, recoveryDays: 5, affectedSystems: 6, dataLossGb: 12, businessImpact: "medium" },
      { id: "detr-sc-08", name: "Physical Security Breach at Data Center Facility", category: "Physical", impact: 12000000, probability: 0.02, recoveryDays: 60, affectedSystems: 200, dataLossGb: 5000, businessImpact: "critical" },
    ];
    this._detrScenarios = worstCaseScenarios.map(s => ({ ...s, mitigationCost: Math.round(s.impact * 0.08), drillScheduled: false, lastDrillDate: null, drillScore: null, controlGaps: Math.floor(Math.random() * 5) + 1 }));
  }

  private _calculateDetrScenarioRisk(): void {
    this._detrScenarios.forEach(s => {
  ...
  private _scheduleDetrDrills(): void {
  ...
  private _detrScenarioComparison(): Record<string, unknown>[] {
    return this._detrScenarios.map(s => ({
  ...
  // --- Security Control Effectiveness Analytics (DETR) ---
  private _initDetrControls(): void {
    const controls = [
      { id: "detr-ct-01", name: "Network Segmentation", type: "preventive", maturity: "defined", score: 82, target: 90, failures: 3, lastTest: "2026-03-15" },
      { id: "detr-ct-02", name: "Endpoint Detection and Response", type: "detective", maturity: "managed", score: 88, target: 92, failures: 1, lastTest: "2026-04-01" },
      { id: "detr-ct-03", name: "Data Loss Prevention", type: "preventive", maturity: "repeatable", score: 71, target: 85, failures: 7, lastTest: "2026-03-22" },
      { id: "detr-ct-04", name: "Security Information and Event Management", type: "detective", maturity: "managed", score: 85, target: 90, failures: 2, lastTest: "2026-04-05" },
      { id: "detr-ct-05", name: "Identity and Access Management", type: "preventive", maturity: "defined", score: 76, target: 88, failures: 5, lastTest: "2026-03-28" },
      { id: "detr-ct-06", name: "Vulnerability Management", type: "corrective", maturity: "managed", score: 80, target: 90, failures: 4, lastTest: "2026-04-02" },
      { id: "detr-ct-07", name: "Email Security Gateway", type: "preventive", maturity: "managed", score: 90, target: 95, failures: 1, lastTest: "2026-04-08" },
      { id: "detr-ct-08", name: "Web Application Firewall", type: "preventive", maturity: "managed", score: 87, target: 92, failures: 2, lastTest: "2026-03-30" },
      { id: "detr-ct-09", name: "Patch Management", type: "corrective", maturity: "defined", score: 68, target: 85, failures: 9, lastTest: "2026-03-18" },
      { id: "detr-ct-10", name: "Encryption at Rest", type: "preventive", maturity: "managed", score: 93, target: 95, failures: 0, lastTest: "2026-04-10" },
      { id: "detr-ct-11", name: "Encryption in Transit", type: "preventive", maturity: "optimized", score: 96, target: 98, failures: 0, lastTest: "2026-04-12" },
      { id: "detr-ct-12", name: "Privileged Access Management", type: "preventive", maturity: "defined", score: 74, target: 88, failures: 6, lastTest: "2026-03-25" },
      { id: "detr-ct-13", name: "Security Awareness Training", type: "preventive", maturity: "repeatable", score: 65, target: 80, failures: 11, lastTest: "2026-03-20" },
      { id: "detr-ct-14", name: "Incident Response Plan", type: "corrective", maturity: "managed", score: 78, target: 88, failures: 4, lastTest: "2026-04-03" },
      { id: "detr-ct-15", name: "Backup and Recovery", type: "corrective", maturity: "managed", score: 84, target: 92, failures: 3, lastTest: "2026-04-06" },
      { id: "detr-ct-16", name: "Multi-Factor Authentication", type: "preventive", maturity: "managed", score: 91, target: 95, failures: 1, lastTest: "2026-04-09" },
      { id: "detr-ct-17", name: "Network Traffic Analysis", type: "detective", maturity: "defined", score: 72, target: 85, failures: 5, lastTest: "2026-03-27" },
      { id: "detr-ct-18", name: "Cloud Security Posture Management", type: "detective", maturity: "repeatable", score: 69, target: 82, failures: 8, lastTest: "2026-03-24" },
      { id: "detr-ct-19", name: "Container Security Scanning", type: "preventive", maturity: "defined", score: 75, target: 85, failures: 5, lastTest: "2026-04-04" },
      { id: "detr-ct-20", name: "API Security Gateway", type: "preventive", maturity: "repeatable", score: 70, target: 82, failures: 7, lastTest: "2026-03-29" },
      { id: "detr-ct-21", name: "Threat Intelligence Platform", type: "detective", maturity: "managed", score: 83, target: 90, failures: 2, lastTest: "2026-04-07" },
      { id: "detr-ct-22", name: "Database Activity Monitoring", type: "detective", maturity: "defined", score: 67, target: 80, failures: 8, lastTest: "2026-03-21" },
      { id: "detr-ct-23", name: "Deception Technology", type: "detective", maturity: "initial", score: 55, target: 75, failures: 12, lastTest: "2026-03-16" },
      { id: "detr-ct-24", name: "Security Orchestration Automation", type: "corrective", maturity: "repeatable", score: 73, target: 85, failures: 6, lastTest: "2026-04-01" },
      { id: "detr-ct-25", name: "Third-Party Risk Assessment", type: "preventive", maturity: "defined", score: 64, target: 78, failures: 9, lastTest: "2026-03-19" },
    ];
    this._detrControls = controls;
  }

  private _analyzeDetrControlEffectiveness(): void {
    const typeBreakdown: Record<string, { total: number; avgScore: number; avgFailures: number }> = {};
    this._detrControls.forEach(c => {
    ...
    this._detrControlTypeBreakdown = typeBreakdown;
  }

  private _detrControlOptimization(): Record<string, unknown>[] {
    return this._detrControls.filter(c => c.score < c.target).map(c => ({
  ...
  // --- Security Data Pipeline Health (DETR) ---
  private _initDetrPipelines(): void {
    const pipelines = [
      { id: "detr-pl-01", name: "SIEM Log Ingestion", status: "healthy", healthScore: 94, latencyMs: 120, freshnessMin: 2, errorRate: 0.02, throughputMbps: 450, recordsPerSec: 12000, backPressure: 0.05, uptime: 99.97 },
      { id: "detr-pl-02", name: "Threat Feed Aggregation", status: "healthy", healthScore: 91, latencyMs: 300, freshnessMin: 15, errorRate: 0.05, throughputMbps: 85, recordsPerSec: 3200, backPressure: 0.08, uptime: 99.92 },
      { id: "detr-pl-03", name: "Vulnerability Scan Results", status: "degraded", healthScore: 72, latencyMs: 2500, freshnessMin: 60, errorRate: 0.15, throughputMbps: 25, recordsPerSec: 800, backPressure: 0.35, uptime: 98.50 },
      { id: "detr-pl-04", name: "Endpoint Telemetry Stream", status: "healthy", healthScore: 88, latencyMs: 450, freshnessMin: 5, errorRate: 0.08, throughputMbps: 280, recordsPerSec: 8500, backPressure: 0.12, uptime: 99.85 },
      { id: "detr-pl-05", name: "Cloud Audit Log Pipeline", status: "healthy", healthScore: 86, latencyMs: 600, freshnessMin: 10, errorRate: 0.06, throughputMbps: 150, recordsPerSec: 4500, backPressure: 0.10, uptime: 99.80 },
      { id: "detr-pl-06", name: "Identity Event Stream", status: "warning", healthScore: 78, latencyMs: 1200, freshnessMin: 20, errorRate: 0.12, throughputMbps: 45, recordsPerSec: 1500, backPressure: 0.22, uptime: 99.40 },
      { id: "detr-pl-07", name: "Network Flow Collection", status: "healthy", healthScore: 82, latencyMs: 800, freshnessMin: 8, errorRate: 0.09, throughputMbps: 650, recordsPerSec: 18000, backPressure: 0.15, uptime: 99.70 },
      { id: "detr-pl-08", name: "DLP Incident Pipeline", status: "degraded", healthScore: 68, latencyMs: 3500, freshnessMin: 45, errorRate: 0.20, throughputMbps: 18, recordsPerSec: 500, backPressure: 0.42, uptime: 97.80 },
    ];
    this._detrPipelines = pipelines.map(p => ({ ...p, dependencies: [], slaBreached: p.healthScore < 75, alertThreshold: p.errorRate > 0.15 }));
    this._detrPipelines[0].dependencies = ["detr-pl-04", "detr-pl-07"];
    this._detrPipelines[4].dependencies = ["detr-pl-01"];
    this._detrPipelines[5].dependencies = ["detr-pl-02"];
    this._detrPipelines[7].dependencies = ["detr-pl-04", "detr-pl-05"];
  }

  private _detrPipelineTrend(): Record<string, unknown>[] {
    const hours = Array.from({ length: 24 }, (_, i) => `H${String(i).padStart(2, "0")}`);
    return this._detrPipelines.map(p => ({
  ...
  // --- Security Stakeholder Report Generator (DETR) ---
  private _initDetrReportTemplates(): void {
    this._detrReportTemplates = [
      { id: "detr-rp-01", name: "Board Security Report", audience: "board", frequency: "quarterly", sections: 6, autoGenerate: true, lastGenerated: "2026-03-31", pages: 12 },
      { id: "detr-rp-02", name: "Executive Risk Summary", audience: "executive", frequency: "monthly", sections: 8, autoGenerate: true, lastGenerated: "2026-04-01", pages: 8 },
      { id: "detr-rp-03", name: "Technical Security Review", audience: "technical", frequency: "weekly", sections: 12, autoGenerate: true, lastGenerated: "2026-04-21", pages: 25 },
      { id: "detr-rp-04", name: "Audit Compliance Report", audience: "audit", frequency: "quarterly", sections: 10, autoGenerate: false, lastGenerated: "2026-03-15", pages: 35 },
      { id: "detr-rp-05", name: "Regulatory Filing Package", audience: "regulatory", frequency: "annual", sections: 15, autoGenerate: false, lastGenerated: "2025-12-31", pages: 48 },
    ];
  }

  private _generateDetrExecSummary(): string {
    const totalRisk = this._detrScenarios.reduce((sum: number, s: any) => sum + s.riskScore, 0);
    const avgControl = Math.round(this._detrControls.reduce((sum: number, c: any) => sum + c.score, 0) / this._detrControls.length);
    const degradedPipes = this._detrPipelines.filter((p: any) => p.status !== "healthy").length;
    return `Overall risk exposure: ${(totalRisk / 1000000).toFixed(1)}M. Average control effectiveness: {avgControl}%. {degradedPipes} pipeline(s) need attention. {this._detrScenarios.filter((s: any) => s.mitigationPriority === "immediate").length} scenarios require immediate action.`;
  }

  // --- Security Technology Radar (DETR) ---
  private _initDetrTechRadar(): void {
    this._detrTechRadar = [
      { id: "detr-tr-01", name: "AI-Powered Threat Detection", ring: "adopt", category: "Detection", maturity: 4, trend: "up", investment: "high", roi: 3.2, vendorCount: 8 },
      { id: "detr-tr-02", name: "Zero Trust Architecture", ring: "adopt", category: "Architecture", maturity: 4, trend: "up", investment: "high", roi: 2.8, vendorCount: 12 },
      { id: "detr-tr-03", name: "SASE/SSE Platform", ring: "trial", category: "Network", maturity: 3, trend: "up", investment: "medium", roi: 2.4, vendorCount: 10 },
      { id: "detr-tr-04", name: "CNAPP Cloud Security", ring: "trial", category: "Cloud", maturity: 3, trend: "up", investment: "medium", roi: 2.1, vendorCount: 7 },
      { id: "detr-tr-05", name: "Extended Detection and Response", ring: "adopt", category: "Detection", maturity: 4, trend: "stable", investment: "high", roi: 2.9, vendorCount: 9 },
      { id: "detr-tr-06", name: "Quantum-Safe Cryptography", ring: "assess", category: "Crypto", maturity: 2, trend: "up", investment: "low", roi: 0.8, vendorCount: 4 },
      { id: "detr-tr-07", name: "Security Service Edge", ring: "trial", category: "Network", maturity: 3, trend: "up", investment: "medium", roi: 2.0, vendorCount: 6 },
      { id: "detr-tr-08", name: "SOAR 2.0 Autonomous SOC", ring: "assess", category: "Operations", maturity: 2, trend: "up", investment: "low", roi: 1.2, vendorCount: 5 },
      { id: "detr-tr-09", name: "Software Supply Chain Security", ring: "trial", category: "DevSecOps", maturity: 3, trend: "up", investment: "medium", roi: 2.3, vendorCount: 8 },
      { id: "detr-tr-10", name: "Identity Threat Detection", ring: "adopt", category: "Identity", maturity: 3, trend: "up", investment: "high", roi: 2.7, vendorCount: 7 },
      { id: "detr-tr-11", name: "Data Security Posture Management", ring: "trial", category: "Data", maturity: 3, trend: "up", investment: "medium", roi: 2.2, vendorCount: 9 },
      { id: "detr-tr-12", name: "Decentralized Identity Standards", ring: "hold", category: "Identity", maturity: 1, trend: "stable", investment: "low", roi: 0.5, vendorCount: 3 },
    ];
  }

  private _detrRadarSummary(): Record<string, unknown> {
    const rings: Record<string, number> = { adopt: 0, trial: 0, assess: 0, hold: 0 };
    this._detrTechRadar.forEach(t => { if (rings[t.ring as keyof typeof rings] !== undefined) rings[t.ring as keyof typeof rings]++; });
    return { adopt: rings.adopt, trial: rings.trial, assess: rings.assess, hold: rings.hold, total: this._detrTechRadar.length, avgMaturity: 2.8, topInvestment: this._detrTechRadar.filter(t => t.investment === "high").map(t => t.name) };
  }

  // --- DETR Security Compliance Mapping Matrix ---
  private _initDetrComplianceMatrix(): void {
    ...
    this._detrComplianceMatrix = frameworks.map(fw => ({
  ...
  private _detrComplianceTrend(): Record<string, unknown>[] {
    const quarters = ["Q1-2025", "Q2-2025", "Q3-2025", "Q4-2025", "Q1-2026", "Q2-2026"];
    return this._detrComplianceMatrix.map(fw => ({
  ...
  // --- DETR Threat Intelligence Correlation Engine ---
  private _initDetrThreatIntel(): void {
    ...
    this._detrThreatIntel = threatActors.map((actor, i) => ({
  ...
  private _detrThreatCorrelation(): Record<string, unknown>[] {
    return this._detrThreatIntel.filter(t => t.riskScore > 70).map(t => ({
  ...
  // --- DETR Security Metrics Deep Dive ---
  private _initDetrMetricsDeep(): void {
    ...
    this._detrMetricsDeep = metricCategories.map(cat => ({
  ...
  private _detrMetricsHeatmap(): number[][] {
    return this._detrMetricsDeep.map(cat =>
      cat.metrics.map(m => Math.round((m.value / m.target) * 100))
    );
  }

  // --- DETR Incident Cost Modeling ---
  private _initDetrCostModel(): void {
    const incidentTypes = ["Data Breach", "Ransomware", "DDoS", "Insider Threat", "Phishing", "Supply Chain", "Cloud Misconfig", "Zero-Day"];
    this._detrCostModel = incidentTypes.map(inc => ({
    ...
    this._detrCostModel.forEach(m => { m.totalAnnualExposure = m.avgCost * m.frequency; });
  }

  private _detrCostProjection(): Record<string, unknown>[] {
    return this._detrCostModel.map(m => ({
  ...
  // --- DETR Security Architecture Pattern Library ---
  private _initDetrArchPatterns(): void {
    ...
    this._detrArchPatterns = patterns.map((p, i) => ({
  ...
  private _detrArchPatternAnalysis(): Record<string, unknown> {
    const implemented = this._detrArchPatterns.filter(p => p.implementation > 75).length;
    const avgCoverage = Math.round(this._detrArchPatterns.reduce((s: number, p: any) => s + p.coverage, 0) / this._detrArchPatterns.length);
    return {
      totalPatterns: this._detrArchPatterns.length, fullyImplemented: implemented, avgCoverage,
      avgRiskReduction: Math.round(this._detrArchPatterns.reduce((s: number, p: any) => s + p.riskReduction, 0) / this._detrArchPatterns.length),
      gaps: this._detrArchPatterns.filter(p => p.implementation < 60).map(p => p.pattern),
      recommendations: this._detrArchPatterns.filter(p => p.implementation < 70).map(p => ({ pattern: p.pattern, current: p.implementation, target: 85, effort: p.costComplexity }))
    };
  }
  ...
  private _4edRiskAssessmentWorkflow = [
  ...
  private _4edTreatmentOptions = [
    {id: '4ed-T-001', riskId: 'RSK-042', risk: 'Ransomware Attack on Critical Infrastructure', before: 20, after: 6, strategy: 'Mitigate', controls: ['Next-gen EDR with behavioral detection and automated response', 'Zero-trust network micro-segmentation isolating critical assets', 'Immutable offline backup rotation with quarterly recovery testing', 'Incident response retainer with 1-hour response SLA'], cost: '$450K/yr', roi: '78% reduction vs $2.8M potential loss', timeline: 'Q3 2026', status: 'approved' as const},
  ...
  private _4edTalentPositions = [
    ...
    {id: '4ed-H-002', title: 'Cloud Security Engineer', dept: 'Cloud Security', level: 'Mid-Senior', loc: 'SF/Remote', salary: '$155K-$180K', posted: '2026-03-20', applicants: 45, pipeline: 12, interviews: 6, offers: 2, urgency: 'high' as const, manager: 'Mike Johnson', skills: ['AWS/Azure/GCP', 'Terraform', 'Kubernetes', 'IAM', 'CSPM'], nice: ['CCSP', 'CKS', 'Serverless']},
    {id: '4ed-H-003', title: 'SOC Analyst L2', dept: 'Security Operations', level: 'Mid', loc: 'Austin TX', salary: '$105K-$130K', posted: '2026-04-01', applicants: 67, pipeline: 18, interviews: 8, offers: 0, urgency: 'medium' as const, manager: 'Lisa Park', skills: ['SIEM', 'Incident triage', 'Malware analysis', 'TCP/IP'], nice: ['GCIA', 'SOAR', 'Kill chain']},
    {id: '4ed-H-004', title: 'Staff Security Architect', dept: 'Architecture', level: 'Staff', loc: 'Remote US', salary: '$200K-$240K', posted: '2026-02-28', applicants: 12, pipeline: 3, interviews: 2, offers: 0, urgency: 'critical' as const, manager: 'David Lee', skills: ['Enterprise arch', 'Zero trust', 'Risk frameworks', 'Board comms'], nice: ['CISSP+SABSA', 'Team building', 'Speaker']},
    {id: '4ed-H-005', title: 'GRC Analyst', dept: 'GRC', level: 'Mid', loc: 'NY/Remote', salary: '$110K-$135K', posted: '2026-04-05', applicants: 34, pipeline: 9, interviews: 3, offers: 1, urgency: 'medium' as const, manager: 'Rachel Green', skills: ['ISO 27001', 'SOC 2', 'Risk assessment', 'Audit'], nice: ['CRISC', 'CISA', 'GDPR']},
    {id: '4ed-H-006', title: 'Threat Intel Analyst', dept: 'Threat Intel', level: 'Mid-Senior', loc: 'Remote US', salary: '$140K-$170K', posted: '2026-03-25', applicants: 19, pipeline: 5, interviews: 2, offers: 0, urgency: 'low' as const, manager: 'James Wilson', skills: ['MITRE ATT&CK', 'OSINT', 'Threat modeling', 'Reverse eng'], nice: ['CTIA', 'Nation-state', 'Dark web']},
    {id: '4ed-H-007', title: 'AppSec Engineer', dept: 'AppSec', level: 'Senior', loc: 'Seattle/Remote', salary: '$160K-$190K', posted: '2026-04-10', applicants: 28, pipeline: 7, interviews: 3, offers: 0, urgency: 'medium' as const, manager: 'Emily Zhang', skills: ['SAST/DAST/SCA', 'Secure SDLC', 'Code review', 'CI/CD'], nice: ['CSSLP', 'Mobile security']},
    {id: '4ed-H-008', title: 'IAM Engineer', dept: 'IAM', level: 'Mid', loc: 'Remote US', salary: '$135K-$160K', posted: '2026-04-08', applicants: 31, pipeline: 10, interviews: 5, offers: 1, urgency: 'medium' as const, manager: 'Chris Martinez', skills: ['Okta/Azure AD', 'SAML/OIDC', 'PAM', 'RBAC'], nice: ['CISSP', 'Zero trust IAM']}
  ];

  private _4edInterviewScorecard = [
  ...
  private _4edOnboardingSteps = [
    {id: '4ed-OB-01', item: 'Provision security-hardened laptop, monitors, peripherals, and configured workstation image with all required security tools', cat: 'IT Setup', day: 'Day 1', owner: 'IT Operations'},
    {id: '4ed-OB-02', item: 'Create AD account, email, Slack, VPN, SSO enrollment, and all required application access accounts', cat: 'Access', day: 'Day 1', owner: 'IAM Team'},
    {id: '4ed-OB-03', item: 'Grant security tooling access: SIEM console, EDR dashboard, vuln scanner, pentest platforms, SOAR', cat: 'Tools', day: 'Day 1-2', owner: 'SOC Manager'},
    {id: '4ed-OB-04', item: 'Complete MFA enrollment, security awareness onboarding course, and acceptable use policy acknowledgment', cat: 'Security', day: 'Day 1', owner: 'Awareness Team'},
    {id: '4ed-OB-05', item: 'Sign NDA, employment agreement, IP assignment, and code of conduct documents with HR', cat: 'HR', day: 'Day 1', owner: 'Human Resources'},
    {id: '4ed-OB-06', item: 'Introduction meetings with direct team members and key cross-functional stakeholders', cat: 'Integration', day: 'Week 1', owner: 'Hiring Manager'},
    {id: '4ed-OB-07', item: 'Security architecture overview, tooling walkthrough, and operational runbook review sessions', cat: 'Training', day: 'Week 1-2', owner: 'Security Architect'},
    {id: '4ed-OB-08', item: 'Shadow experienced team member on active incident response and threat hunting investigations', cat: 'Mentoring', day: 'Week 2-3', owner: 'SOC Lead'},
    {id: '4ed-OB-09', item: 'Set up individual certification study plan aligned with role requirements and career goals', cat: 'Development', day: 'Week 2', owner: 'Hiring Manager'},
    {id: '4ed-OB-10', item: 'Establish 30-60-90 day goals, define success metrics, and schedule first performance checkpoint', cat: 'Goals', day: 'Week 1', owner: 'Hiring Manager'}
  ];

  private _4edMetricsDashboard = [
    {id: '4ed-MTD-001', name: 'Mean Time to Detect (MTTD)', value: '4.2 hours', trend: 'improving' as const, target: '< 4 hours', source: 'SIEM - Splunk', method: 'Median time from first alert to analyst acknowledgment', owner: 'SOC Manager', sla: '4 hours', prev: '5.1 hours', spark: [5.8, 5.4, 5.1, 4.9, 4.7, 4.5, 4.3, 4.2], breakdown: [{src: 'Network IDS', pct: '35%', avg: '3.8h'}, {src: 'Endpoint EDR', pct: '28%', avg: '4.1h'}, {src: 'Email Gateway', pct: '22%', avg: '3.5h'}, {src: 'Cloud Security', pct: '10%', avg: '5.2h'}, {src: 'User Reports', pct: '5%', avg: '6.8h'}]},
    {id: '4ed-MTD-002', name: 'Mean Time to Respond (MTTR)', value: '2.8 hours', trend: 'stable' as const, target: '< 3 hours', source: 'SOAR - XSOAR', method: 'Median time from acknowledgment to first containment action', owner: 'IR Lead', sla: '3 hours', prev: '2.7 hours', spark: [3.2, 3.0, 2.9, 2.8, 2.8, 2.9, 2.8, 2.8], breakdown: [{src: 'Auto Playbooks', pct: '42%', avg: '1.2h'}, {src: 'Semi-Auto', pct: '33%', avg: '2.5h'}, {src: 'Manual', pct: '20%', avg: '5.1h'}, {src: 'L3 Escalation', pct: '5%', avg: '8.3h'}]},
    {id: '4ed-MTD-003', name: 'Patch Compliance Rate', value: '97.6%', trend: 'improving' as const, target: '> 95%', source: 'Tenable.io', method: 'Pct of critical/high vulns patched within SLA windows', owner: 'Vuln Manager', sla: '95%', prev: '96.1%', spark: [93.2, 94.1, 94.8, 95.3, 95.9, 96.4, 97.0, 97.6], breakdown: [{src: 'Critical (7d)', pct: '40%', rate: '99.2%'}, {src: 'High (30d)', pct: '35%', rate: '97.8%'}, {src: 'Medium (90d)', pct: '20%', rate: '95.1%'}, {src: 'Low (180d)', pct: '5%', rate: '89.4%'}]},
    {id: '4ed-MTD-004', name: 'Phishing Click Rate', value: '3.2%', trend: 'improving' as const, target: '< 5%', source: 'KnowBe4 + Proofpoint', method: 'Pct of users clicking simulated phishing links monthly', owner: 'Awareness Lead', sla: '5%', prev: '4.1%', spark: [6.8, 6.2, 5.5, 5.1, 4.6, 4.1, 3.6, 3.2], breakdown: [{src: 'Spear Phishing', pct: '35%', rate: '5.1%'}, {src: 'Generic Phishing', pct: '30%', rate: '2.8%'}, {src: 'BEC Sim', pct: '20%', rate: '3.5%'}, {src: 'SMS Phishing', pct: '15%', rate: '1.9%'}]},
    {id: '4ed-MTD-005', name: 'Security Posture Score', value: '784', trend: 'improving' as const, target: '> 750', source: 'SecurityScorecard', method: 'Composite: external 30%, compliance 25%, vuln 25%, config 20%', owner: 'CISO', sla: '> 750', prev: '771', spark: [748, 752, 758, 762, 768, 773, 778, 784], breakdown: [{src: 'External Rating', pct: '30%', score: '791'}, {src: 'Compliance', pct: '25%', score: '812'}, {src: 'Vuln Mgmt', pct: '25%', score: '745'}, {src: 'Config', pct: '20%', score: '769'}]},
    {id: '4ed-MTD-006', name: 'Vulnerability Backlog', value: '142', trend: 'improving' as const, target: '< 150', source: 'Tenable + Qualys', method: 'Total open vulns across all scanned assets tracked weekly', owner: 'Vuln Manager', sla: '< 150', prev: '168', spark: [210, 198, 185, 175, 165, 158, 150, 142], breakdown: [{src: 'Critical', pct: '8%', count: '11'}, {src: 'High', pct: '22%', count: '31'}, {src: 'Medium', pct: '45%', count: '64'}, {src: 'Low', pct: '25%', count: '36'}]}
  ];

  private _4edArchReview = [
    {id: '4ed-AR-001', cat: 'Network', item: 'Network segmentation between trust zones with dedicated firewalls and granular ACLs', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Micro-segmentation via NSX across all production zones'},
    {id: '4ed-AR-002', cat: 'Network', item: 'DMZ architecture isolating public services from internal network', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Dual-firewall DMZ with WAF and DDoS mitigation'},
    {id: '4ed-AR-003', cat: 'Network', item: 'Least-privilege traffic flows with deny-by-default and quarterly review', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Explicit allow rules with automated drift detection'},
    {id: '4ed-AR-004', cat: 'Network', item: 'Encrypted external communications with IPSec/TLS 1.3 and PFS', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'IKEv2 with PFS, TLS 1.3 for all external APIs'},
    {id: '4ed-AR-005', cat: 'Identity', item: 'Centralized IdP with SSO and automated SCIM provisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Okta SSO SAML 2.0 for 247 apps with SCIM'},
    {id: '4ed-AR-006', cat: 'Identity', item: 'RBAC with quarterly reviews and automated deprovisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Quarterly recertification with JIT admin access'},
    {id: '4ed-AR-007', cat: 'Identity', item: 'PAM controlling all admin and service accounts with session recording', sev: 'high' as const, status: 'fail' as const, reviewer: 'IAM Lead', notes: '3 legacy accounts pending CyberArk enrollment'},
    {id: '4ed-AR-008', cat: 'Identity', item: 'MFA enforced for all users, hardware tokens for privileged access', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'FIDO2 for admins, push MFA for users, 99.8% enrollment'},
    {id: '4ed-AR-009', cat: 'Data', item: 'Data classification enforced with automated labeling on all repos', sev: 'high' as const, status: 'partial' as const, reviewer: 'Data Protection Lead', notes: 'Framework deployed, gaps on 4 legacy file shares'},
    {id: '4ed-AR-010', cat: 'Data', item: 'AES-256 encryption at rest for all sensitive data stores', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'Full-disk, TDE on DBs, SSE-KMS on cloud storage'},
    {id: '4ed-AR-011', cat: 'Data', item: 'DLP monitoring and preventing unauthorized data exfiltration', sev: 'high' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'DLP active on email, endpoint, cloud, and network'},
    {id: '4ed-AR-012', cat: 'Data', item: 'Encrypted off-site backups with quarterly restore testing', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Infrastructure Lead', notes: '3-2-1 strategy with immutable backups'},
    {id: '4ed-AR-013', cat: 'AppSec', item: 'Secure SDLC with SAST, DAST, SCA in all CI/CD pipelines', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: '34 pipelines with security gates and PR blocking'},
    {id: '4ed-AR-014', cat: 'AppSec', item: 'API gateway with auth, rate limiting, schema validation', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: 'Kong with OAuth2, rate limits, OpenAPI validation'},
    {id: '4ed-AR-015', cat: 'AppSec', item: 'Container security with image scanning and runtime protection', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Trivy scanning, Falco runtime in 80% of clusters'},
    {id: '4ed-AR-016', cat: 'Monitoring', item: 'SIEM collecting from all critical systems with correlation rules', sev: 'critical' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'Splunk 98% coverage with 1200+ correlation rules'},
    {id: '4ed-AR-017', cat: 'Monitoring', item: 'EDR with behavioral detection on all managed endpoints', sev: 'high' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'CrowdStrike on 99.2% endpoints with 24/7 MDR'},
    {id: '4ed-AR-018', cat: 'Monitoring', item: 'Executive dashboards with real-time posture visibility', sev: 'medium' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'PowerBI dashboards with weekly exec summaries'},
    {id: '4ed-AR-019', cat: 'Cloud', item: 'CSPM monitoring and remediating cloud misconfigurations', sev: 'high' as const, status: 'pass' as const, reviewer: 'Cloud Security Lead', notes: 'Prisma Cloud 450+ checks with auto-remediation'},
    {id: '4ed-AR-020', cat: 'Cloud', item: 'IaC templates scanned before deployment to production', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Checkov for Terraform, cfn-nag for CloudFormation pending'}
  ];

  private _get4edRiskProgress(): number {
    return Math.round(this._4edRiskAssessmentWorkflow.filter(s => s.status === 'completed').length / this._4edRiskAssessmentWorkflow.length * 100);
  }

  private _get4edTreatmentSummary(): {total: number; approved: number; avgReduction: number; investment: string} {
    const a = this._4edTreatmentOptions.filter(r => r.status === 'approved').length;
    const avg = this._4edTreatmentOptions.reduce((s, r) => s + ((r.before - r.after) / r.before * 100), 0) / this._4edTreatmentOptions.length;
    return {total: this._4edTreatmentOptions.length, approved: a, avgReduction: Math.round(avg), investment: '$1.125M annually'};
  }

  private _get4edRuleSummary(): {total: number; passing: number; failing: number; avgRate: number; violations: number} {
    const p = this._4edComplianceRules.filter(r => r.result === 'pass').length;
    const f = this._4edComplianceRules.filter(r => r.result === 'fail').length;
    const avg = this._4edComplianceRules.reduce((s, r) => s + r.passRate, 0) / this._4edComplianceRules.length;
    const v = this._4edComplianceRules.reduce((s, r) => s + r.violations, 0);
    return {total: this._4edComplianceRules.length, passing: p, failing: f, avgRate: Math.round(avg * 10) / 10, violations: v};
  }

  private _get4edPipelineStats(): {positions: number; applicants: number; interviewing: number; offers: number; critical: number} {
    const t = this._4edTalentPositions.length;
    const a = this._4edTalentPositions.reduce((s, p) => s + p.applicants, 0);
    const i = this._4edTalentPositions.reduce((s, p) => s + p.interviews, 0);
    const o = this._4edTalentPositions.reduce((s, p) => s + p.offers, 0);
    const c = this._4edTalentPositions.filter(x => x.urgency === 'critical').length;
    return {positions: t, applicants: a, interviewing: i, offers: o, critical: c};
  }

  private _get4edMetricTrends(): {improving: number; stable: number; total: number} {
    const imp = this._4edMetricsDashboard.filter(m => m.trend === 'improving').length;
    const stb = this._4edMetricsDashboard.filter(m => m.trend === 'stable').length;
    return {improving: imp, stable: stb, total: this._4edMetricsDashboard.length};
  }

  private _get4edArchScore(): {total: number; passed: number; failed: number; partial: number; score: number} {
    const p = this._4edArchReview.filter(c => c.status === 'pass').length;
    const f = this._4edArchReview.filter(c => c.status === 'fail').length;
    const pa = this._4edArchReview.filter(c => c.status === 'partial').length;
    return {total: this._4edArchReview.length, passed: p, failed: f, partial: pa, score: Math.round((p / this._4edArchReview.length) * 100)};
  }


  private _z4edIncidentScenarios = [
    {id: 'z4ed-IS-001', name: 'Ransomware Outbreak in Production Environment', category: 'Malware', likelihood: 'Medium', impact: 'Critical', riskScore: 15, playbooks: ['IR-Ransomware-Isolate', 'IR-Ransomware-Eradicate', 'IR-Ransomway-Recover'], estimatedMTTD: '15min', estimatedMTTR: '4h', involvedTeams: ['SOC', 'IR', 'Infrastructure', 'Legal', 'Comms'], keyIndicators: ['Mass file encryption events', 'Ransom note deployment', 'Lateral movement via SMB/RDP', 'Backup deletion attempts'], mitigationControls: ['EDR behavioral detection', 'Network segmentation', 'Immutable backups', 'Email filtering'], lessonsLearned: 'Ensure offline backups are tested quarterly and Ransomware-specific playbooks are updated with latest threat intelligence', lastDrillDate: '2026-03-15', nextDrillDate: '2026-06-15'},
    {id: 'z4ed-IS-002', name: 'Cloud Misconfiguration Leading to Data Exposure', category: 'Cloud', likelihood: 'High', impact: 'High', riskScore: 16, playbooks: ['IR-Cloud-Misconfig-Assess', 'IR-Cloud-Misconfig-Remediate', 'IR-Cloud-Misconfig-Notify'], estimatedMTTD: '2h', estimatedMTTR: '6h', involvedTeams: ['Cloud Security', 'SOC', 'Data Protection', 'Legal'], keyIndicators: ['Public S3 bucket exposure', 'Overly permissive IAM policies', 'Unencrypted database snapshots', 'Public API endpoint discovery'], mitigationControls: ['CSPM monitoring', 'IAM policy analyzer', 'Automated remediation', 'Cloud audit logging'], lessonsLearned: 'Implement CSPM with auto-remediation for common misconfigurations and conduct monthly cloud configuration reviews', lastDrillDate: '2026-02-20', nextDrillDate: '2026-05-20'},
    {id: 'z4ed-IS-003', name: 'Insider Threat Data Exfiltration', category: 'Insider', likelihood: 'Low', impact: 'Critical', riskScore: 12, playbooks: ['IR-Insider-Investigate', 'IR-Insider-Contain', 'IR-Insider-Escalate'], estimatedMTTD: '8h', estimatedMTTR: '24h', involvedTeams: ['SOC', 'IR', 'HR', 'Legal', 'IAM'], keyIndicators: ['Anomalous data access patterns', 'Large file downloads to USB or cloud', 'Off-hours access to sensitive systems', 'Accessing data outside normal job scope'], mitigationControls: ['UEBA analytics', 'DLP policies', 'PAM controls', 'Access reviews'], lessonsLearned: 'Strengthen UEBA baselines and implement automated alerts for data access pattern anomalies', lastDrillDate: '2026-01-10', nextDrillDate: '2026-04-10'},
    {id: 'z4ed-IS-004', name: 'Supply Chain Attack via Compromised Vendor Software', category: 'Supply Chain', likelihood: 'Low', impact: 'Critical', riskScore: 12, playbooks: ['IR-SupplyChain-Detect', 'IR-SupplyChain-Isolate', 'IR-SupplyChain-Remediate'], estimatedMTTD: '24h', estimatedMTTR: '72h', involvedTeams: ['SOC', 'IR', 'Procurement', 'Vendor Mgmt', 'Legal'], keyIndicators: ['Unexpected network connections from vendor software', 'Modified binaries or dependencies', 'Anomalous behavior from trusted applications', 'SBOM discrepancy alerts'], mitigationControls: ['SCA scanning', 'SBOM monitoring', 'Vendor security assessments', 'Network segmentation'], lessonsLearned: 'Require SBOM from all vendors and implement continuous monitoring of third-party component behavior', lastDrillDate: '2026-03-01', nextDrillDate: '2026-06-01'},
    {id: 'z4ed-IS-005', name: 'Credential Stuffing Attack on Customer Portal', category: 'External Attack', likelihood: 'High', impact: 'Medium', riskScore: 12, playbooks: ['IR-CredentialStuffing-Detect', 'IR-CredentialStuffing-Block', 'IR-CredentialStuffing-Notify'], estimatedMTTD: '30min', estimatedMTTR: '2h', involvedTeams: ['SOC', 'AppSec', 'Customer Support', 'Comms'], keyIndicators: ['High volume of failed login attempts', 'Login attempts from known compromised credential lists', 'Unusual geographic distribution of login attempts', 'Account takeover indicators'], mitigationControls: ['WAF rate limiting', 'CAPTCHA on login', 'MFA enforcement', 'Credential monitoring service'], lessonsLearned: 'Deploy advanced bot detection on login endpoints and implement proactive credential monitoring for customer accounts', lastDrillDate: '2026-04-01', nextDrillDate: '2026-07-01'},
    {id: 'z4ed-IS-006', name: 'Phishing Campaign Targeting Executive Team', category: 'Social Engineering', likelihood: 'High', impact: 'High', riskScore: 16, playbooks: ['IR-Phishing-Contain', 'IR-Phishing-Investigate', 'IR-Phishing-Notify'], estimatedMTTD: '1h', estimatedMTTR: '4h', involvedTeams: ['SOC', 'Awareness', 'Executive Office', 'IT'], keyIndicators: ['Sophisticated spear-phishing emails to C-suite', 'Business email compromise indicators', 'Redirected MFA approval requests', 'Unauthorized wire transfer attempts'], mitigationControls: ['AI email filtering', 'Executive awareness training', 'Out-of-band verification policy', 'DMARC/DKIM/SPF'], lessonsLearned: 'Implement additional email security controls for executive mailboxes and conduct monthly spear-phishing simulations', lastDrillDate: '2026-02-15', nextDrillDate: '2026-05-15'}
  ];

  private _z4edSecurityFrameworks = [
  ...
  private _getz4edScenarioSummary(): {total: number; critical: number; high: number; drilled: number; avgRiskScore: number} {
    const crit = this._z4edIncidentScenarios.filter(s => s.impact === 'Critical').length;
    const high = this._z4edIncidentScenarios.filter(s => s.impact === 'High').length;
    const avg = this._z4edIncidentScenarios.reduce((s, x) => s + x.riskScore, 0) / this._z4edIncidentScenarios.length;
    return {total: this._z4edIncidentScenarios.length, critical: crit, high: high, drilled: this._z4edIncidentScenarios.length, avgRiskScore: Math.round(avg)};
  }

  private _getz4edVendorRiskSummary(): {total: number; approved: number; conditional: number; remediation: number; avgScore: number} {
    const approved = this._z4edThirdPartyRiskData.filter(v => v.status === 'approved').length;
    const cond = this._z4edThirdPartyRiskData.filter(v => v.status === 'conditional').length;
    const rem = this._z4edThirdPartyRiskData.filter(v => v.status === 'remediation_required').length;
    const avg = this._z4edThirdPartyRiskData.reduce((s, v) => s + v.riskScore, 0) / this._z4edThirdPartyRiskData.length;
    return {total: this._z4edThirdPartyRiskData.length, approved, conditional: cond, remediation: rem, avgScore: Math.round(avg)};
  }

  private _getz4edTrainingSummary(): {total: number; avgCompletion: number; avgScore: number; overdueUpdates: number} {
    const avgComp = this._z4edSecurityTrainingCatalog.reduce((s, t) => s + t.completionRate, 0) / this._z4edSecurityTrainingCatalog.length;
    const avgScore = this._z4edSecurityTrainingCatalog.filter(t => t.avgScore > 0).reduce((s, t) => s + t.avgScore, 0) / this._z4edSecurityTrainingCatalog.filter(t => t.avgScore > 0).length;
    return {total: this._z4edSecurityTrainingCatalog.length, avgCompletion: Math.round(avgComp * 10) / 10, avgScore: Math.round(avgScore), overdueUpdates: 0};
  }

  private _getz4edToolHealthSummary(): {total: number; healthy: number; degraded: number; annualCost: string} {
    const healthy = this._z4edSecurityToolInventory.filter(t => t.health === 'healthy').length;
    const degraded = this._z4edSecurityToolInventory.filter(t => t.health === 'degraded').length;
    const cost = this._z4edSecurityToolInventory.reduce((s, t) => s + parseInt(t.annualCost.replace(/[^0-9]/g, '')), 0);
    return {total: this._z4edSecurityToolInventory.length, healthy, degraded, annualCost: '$' + (cost / 1000).toFixed(0) + 'K'};
  }


  private _x4edSecurityZones = [
    {zoneId: 'x4ed-Z-001', name: 'Internet DMZ', trustLevel: 'Untrusted', subnet: '10.0.0.0/24', segmentation: 'Dual-firewall', firewallRules: 45, monitoring: 'Full packet capture', assets: ['Web servers', 'Load balancers', 'WAF appliances', 'Reverse proxy'], riskLevel: 'high' as const, lastAssessment: '2026-04-15', nextAssessment: '2026-07-15'},
    {zoneId: 'x4ed-Z-002', name: 'Corporate Network', trustLevel: 'Trusted', subnet: '10.1.0.0/16', segmentation: 'VLAN + micro-seg', firewallRules: 128, monitoring: 'NetFlow + IDS', assets: ['Workstations', 'Printers', 'Meeting room systems', 'VoIP phones'], riskLevel: 'medium' as const, lastAssessment: '2026-04-10', nextAssessment: '2026-07-10'},
    {zoneId: 'x4ed-Z-003', name: 'Production Data Center', trustLevel: 'Restricted', subnet: '10.2.0.0/16', segmentation: 'Full micro-segmentation', firewallRules: 256, monitoring: 'Full packet capture + EDR', assets: ['Application servers', 'Database clusters', 'Message queues', 'API gateways'], riskLevel: 'low' as const, lastAssessment: '2026-04-12', nextAssessment: '2026-07-12'},
    {zoneId: 'x4ed-Z-004', name: 'Management Network', trustLevel: 'Restricted', subnet: '10.3.0.0/24', segmentation: 'Isolated VLAN', firewallRules: 32, monitoring: 'Syslog + SNMP', assets: ['Hypervisors', 'Switch management', 'Storage controllers', 'Backup appliances'], riskLevel: 'low' as const, lastAssessment: '2026-04-08', nextAssessment: '2026-07-08'},
    {zoneId: 'x4ed-Z-005', name: 'Cloud Production', trustLevel: 'Restricted', subnet: 'VPC: 172.16.0.0/12', segmentation: 'Security groups + NACLs', firewallRules: 189, monitoring: 'VPC Flow Logs + GuardDuty', assets: ['Kubernetes clusters', 'Managed databases', 'Object storage', 'Serverless functions'], riskLevel: 'medium' as const, lastAssessment: '2026-04-18', nextAssessment: '2026-07-18'}
  ];

  private _x4edSecurityAlerts = [
    {id: 'x4ed-AL-001', severity: 'critical', title: 'Active ransomware encryption detected on PROD-DB-01', source: 'CrowdStrike', timestamp: '2026-04-22T13:45:00Z', status: 'investigating', assignee: 'SOC Analyst J. Smith', asset: 'PROD-DB-01 (10.2.1.15)', mitreTechnique: 'T1486 - Data Encrypted for Impact', playbook: 'IR-Ransomware-Isolate', sla: '15 minutes', elapsed: '12 minutes', notes: 'EDR detected mass file encryption event pattern. Automated isolation triggered. IR team paged.'},
    {id: 'x4ed-AL-002', severity: 'high', title: 'Impossible travel detected for user admin@company.com', source: 'Okta', timestamp: '2026-04-22T12:30:00Z', status: 'triaged', assignee: 'SOC Analyst M. Johnson', asset: 'Okta - admin@company.com', mitreTechnique: 'T1078 - Valid Accounts', playbook: 'IR-ImpossibleTravel', sla: '30 minutes', elapsed: '87 minutes', notes: 'Login from Tokyo followed by login from New York within 30 minutes. Account temporarily locked. User confirmed via out-of-band channel they are in New York.'},
    {id: 'x4ed-AL-003', severity: 'high', title: 'Public S3 bucket discovered with customer PII exposure', source: 'Prisma Cloud', timestamp: '2026-04-22T11:15:00Z', status: 'remediating', assignee: 'Cloud Security Lead A. Chen', asset: 'AWS S3: customer-data-archive-2024', mitreTechnique: 'N/A - Misconfiguration', playbook: 'IR-Cloud-Misconfig-Remediate', sla: '1 hour', elapsed: '2.5 hours', notes: 'Bucket containing archived customer records was publicly accessible. Bucket blocked and encrypted. Data exposure assessment in progress.'},
    {id: 'x4ed-AL-004', severity: 'medium', title: 'Anomalous data download by user jane.developer@company.com', source: 'Microsoft DLP', timestamp: '2026-04-22T10:00:00Z', status: 'investigating', assignee: 'SOC Analyst R. Davis', asset: 'Endpoint: WS-DEV-042', mitreTechnique: 'T1567 - Exfil Over Web Service', playbook: 'IR-DLP-Investigation', sla: '4 hours', elapsed: '3.5 hours', notes: 'User downloaded 4.2GB of source code files to personal Google Drive. Interview scheduled with user and manager.'},
    {id: 'x4ed-AL-005', severity: 'medium', title: 'Credential stuffing attack detected on customer portal', source: 'Cloudflare WAF', timestamp: '2026-04-22T09:30:00Z', status: 'contained', assignee: 'SOC Analyst K. Wilson', asset: 'Customer Portal (portal.company.com)', mitreTechnique: 'T1110 - Brute Force', playbook: 'IR-CredentialStuffing-Block', sla: '2 hours', elapsed: '4 hours', notes: 'Rate limiting and CAPTCHA automatically deployed. 12,000 failed login attempts from 800 unique IPs blocked. No successful account takeovers confirmed.'},
    {id: 'x4ed-AL-006', severity: 'low', title: 'SSL certificate expiring in 14 days for api.company.com', source: 'Certificate monitoring', timestamp: '2026-04-22T08:00:00Z', status: 'remediated', assignee: 'Infrastructure Lead T. Brown', asset: 'api.company.com', mitreTechnique: 'N/A', playbook: 'Certificate Renewal', sla: '30 days', elapsed: '16 days', notes: 'Automated renewal triggered via ACME. New certificate deployed successfully. No service interruption.'}
  ];

  private _x4edComplianceFrameworks = [
  ...
  private _x4edDataClassificationPolicy = [
  ...
  private _getx4edZoneSummary(): {total: number; highRisk: number; mediumRisk: number; lowRisk: number; totalRules: number} {
    const high = this._x4edSecurityZones.filter(z => z.riskLevel === 'high').length;
    const med = this._x4edSecurityZones.filter(z => z.riskLevel === 'medium').length;
    const low = this._x4edSecurityZones.filter(z => z.riskLevel === 'low').length;
    const rules = this._x4edSecurityZones.reduce((s, z) => s + z.firewallRules, 0);
    return {total: this._x4edSecurityZones.length, highRisk: high, mediumRisk: med, lowRisk: low, totalRules: rules};
  }

  private _getx4edAlertSummary(): {total: number; critical: number; high: number; medium: number; low: number; open: number; contained: number} {
    const crit = this._x4edSecurityAlerts.filter(a => a.severity === 'critical').length;
    const high = this._x4edSecurityAlerts.filter(a => a.severity === 'high').length;
    const med = this._x4edSecurityAlerts.filter(a => a.severity === 'medium').length;
    const low = this._x4edSecurityAlerts.filter(a => a.severity === 'low').length;
    const open = this._x4edSecurityAlerts.filter(a => a.status === 'investigating' || a.status === 'triaged').length;
    const contained = this._x4edSecurityAlerts.filter(a => a.status === 'contained' || a.status === 'remediated').length;
    return {total: this._x4edSecurityAlerts.length, critical: crit, high, medium: med, low, open, contained};
  }

  private _getx4edComplianceSummary(): {total: number; fullyCompliant: number; mostlyCompliant: number; avgComplianceRate: number} {
    const full = this._x4edComplianceFrameworks.filter(f => f.status === 'compliant').length;
    const mostly = this._x4edComplianceFrameworks.filter(f => f.status === 'mostly_compliant').length;
    const avgRate = this._x4edComplianceFrameworks.reduce((s, f) => s + (f.compliant / f.requirements * 100), 0) / this._x4edComplianceFrameworks.length;
    return {total: this._x4edComplianceFrameworks.length, fullyCompliant: full, mostlyCompliant: mostly, avgComplianceRate: Math.round(avgRate * 10) / 10};
  }
  ...
  // === Security Risk Register (dependency_t) ===
  private _dependency_tRiskRegister = [
    { id: "RSK-DEP-0001", title: "Data breach from unpatched systems", owner: "CTO", category: "Financial", status: "mitigating", trend: "stable", severity: "low", likelihood: 4, impact: 6, treatment: "Monitor and review quarterly", lastReview: "2026-04-06", nextReview: "2026-07-14" },
    { id: "RSK-DEP-0002", title: "Ransomware attack on critical infrastructure", owner: "CRO", category: "Strategic", status: "closed", trend: "decreasing", severity: "low", likelihood: 4, impact: 2, treatment: "Monitor and review quarterly", lastReview: "2026-04-13", nextReview: "2026-07-01" },
    { id: "RSK-DEP-0003", title: "Insider threat data exfiltration", owner: "VP Eng", category: "Compliance", status: "accepted", trend: "increasing", severity: "critical", likelihood: 8, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-22", nextReview: "2026-07-11" },
    { id: "RSK-DEP-0004", title: "Supply chain compromise", owner: "Security Lead", category: "Technical", status: "open", trend: "stable", severity: "medium", likelihood: 2, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-23", nextReview: "2026-07-04" },
    { id: "RSK-DEP-0005", title: "Cloud misconfiguration exposure", owner: "Risk Mgr", category: "Reputational", status: "mitigating", trend: "decreasing", severity: "critical", likelihood: 9, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-04", nextReview: "2026-07-14" },
    { id: "RSK-DEP-0006", title: "Phishing campaign success rate", owner: "Compliance Dir", category: "Legal", status: "closed", trend: "increasing", severity: "medium", likelihood: 9, impact: 7, treatment: "Monitor and review quarterly", lastReview: "2026-04-20", nextReview: "2026-07-20" },
    { id: "RSK-DEP-0007", title: "Third-party vendor data breach", owner: "IT Dir", category: "Regulatory", status: "accepted", trend: "stable", severity: "high", likelihood: 4, impact: 5, treatment: "Monitor and review quarterly", lastReview: "2026-04-17", nextReview: "2026-07-10" },
    { id: "RSK-DEP-0008", title: "Regulatory non-compliance penalty", owner: "DevOps Lead", category: "Third-Party", status: "open", trend: "decreasing", severity: "low", likelihood: 7, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-13", nextReview: "2026-07-16" },
    { id: "RSK-DEP-0009", title: "Zero-day exploit in production", owner: "Architect", category: "Human Capital", status: "mitigating", trend: "increasing", severity: "low", likelihood: 10, impact: 7, treatment: "Monitor and review quarterly", lastReview: "2026-04-06", nextReview: "2026-07-13" },
    { id: "RSK-DEP-0010", title: "Insufficient access controls", owner: "CISO", category: "Operational", status: "closed", trend: "stable", severity: "high", likelihood: 10, impact: 7, treatment: "Monitor and review quarterly", lastReview: "2026-04-12", nextReview: "2026-07-21" },
    { id: "RSK-DEP-0011", title: "DDoS attack on services", owner: "CTO", category: "Financial", status: "accepted", trend: "decreasing", severity: "low", likelihood: 9, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-07", nextReview: "2026-07-03" },
    { id: "RSK-DEP-0012", title: "Social engineering attack", owner: "CRO", category: "Strategic", status: "open", trend: "increasing", severity: "high", likelihood: 7, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-23", nextReview: "2026-07-04" },
    { id: "RSK-DEP-0013", title: "API security vulnerability", owner: "VP Eng", category: "Compliance", status: "mitigating", trend: "stable", severity: "medium", likelihood: 9, impact: 4, treatment: "Monitor and review quarterly", lastReview: "2026-04-04", nextReview: "2026-07-12" },
    { id: "RSK-DEP-0014", title: "Mobile device compromise", owner: "Security Lead", category: "Technical", status: "closed", trend: "decreasing", severity: "low", likelihood: 1, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-17", nextReview: "2026-07-14" },
    { id: "RSK-DEP-0015", title: "Physical security breach", owner: "Risk Mgr", category: "Reputational", status: "accepted", trend: "increasing", severity: "critical", likelihood: 9, impact: 2, treatment: "Monitor and review quarterly", lastReview: "2026-04-02", nextReview: "2026-07-19" },
    { id: "RSK-DEP-0016", title: "Password policy weakness", owner: "Compliance Dir", category: "Legal", status: "open", trend: "stable", severity: "high", likelihood: 9, impact: 7, treatment: "Monitor and review quarterly", lastReview: "2026-04-04", nextReview: "2026-07-25" },
    { id: "RSK-DEP-0017", title: "Network segmentation gap", owner: "IT Dir", category: "Regulatory", status: "mitigating", trend: "decreasing", severity: "high", likelihood: 5, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-13", nextReview: "2026-07-13" },
    { id: "RSK-DEP-0018", title: "Encryption key management failure", owner: "DevOps Lead", category: "Third-Party", status: "closed", trend: "increasing", severity: "high", likelihood: 3, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-23", nextReview: "2026-07-05" },
    { id: "RSK-DEP-0019", title: "Audit trail tampering", owner: "Architect", category: "Human Capital", status: "accepted", trend: "stable", severity: "low", likelihood: 9, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-06", nextReview: "2026-07-08" },
    { id: "RSK-DEP-0020", title: "Business email compromise", owner: "CISO", category: "Operational", status: "open", trend: "decreasing", severity: "high", likelihood: 6, impact: 1, treatment: "Monitor and review quarterly", lastReview: "2026-04-12", nextReview: "2026-07-15" },
  ];
  private _dependency_tRiskFilter: string = 'all';
  private _dependency_tRiskSeverity: string = 'all';
  private _dependency_tRiskStatus: string = 'all';
  private _dependency_tExpandedRisk: string = '';
  private _dependency_tFilterRisks() {
    const reg = this._dependency_tRiskRegister;
    return reg.filter(r => {
      if (this._dependency_tRiskFilter !== "all" && r.category !== this._dependency_tRiskFilter) return false;
      if (this._dependency_tRiskSeverity !== "all" && r.severity !== this._dependency_tRiskSeverity) return false;
      if (this._dependency_tRiskStatus !== "all" && r.status !== this._dependency_tRiskStatus) return false;
      return true;
    });
  }
  private _dependency_tGetRiskScore(r: any) { return Math.round(r.likelihood * r.impact * 1.5); }
  private _dependency_tGetRiskTrendIcon(trend: string) {
    if (trend === "increasing") return "\u2191";
    if (trend === "decreasing") return "\u2193";
    return "\u2192";
  }
  private _dependency_tGetRiskColor(sev: string) {
    if (sev === "critical") return "#dc2626";
    if (sev === "high") return "#ea580c";
    if (sev === "medium") return "#d97706";
    return "#16a34a";
  }
  private _dependency_tGetRiskCounts() {
    const reg = this._dependency_tRiskRegister;
  ...
  private _dependency_tGetTreatmentProgress() {
    const reg = this._dependency_tRiskRegister;
    const treated = reg.filter(r => r.status === "mitigating" || r.status === "closed").length;
    return Math.round((treated / Math.max(reg.length, 1)) * 100);
  }

  // === Security Metrics API Gateway (dependency_t) ===
  private _dependency_tApiEndpoints = [
    { method: "GET", path: "/api/v1/threats", name: "Threat Intelligence Feed", status: "active", avgLatency: 19.9, reqPerMin: 2437.0, errorRate: 1.87, uptime: round(99.35530811405386,2), version: "v2.7.17" },
    { method: "POST", path: "/api/v1/scans/start", name: "Vulnerability Scanner", status: "active", avgLatency: 250.7, reqPerMin: 1171.0, errorRate: 0.45, uptime: round(99.62833867814338,2), version: "v2.2.7" },
    { method: "GET", path: "/api/v1/assets", name: "Asset Inventory", status: "active", avgLatency: 26.6, reqPerMin: 39.0, errorRate: 2.32, uptime: round(95.29668209387688,2), version: "v1.0.6" },
    { method: "POST", path: "/api/v1/alerts", name: "Alert Management", status: "active", avgLatency: 106.4, reqPerMin: 695.0, errorRate: 2.11, uptime: round(95.00288154037233,2), version: "v2.0.8" },
    { method: "GET", path: "/api/v1/compliance", name: "Compliance Status", status: "active", avgLatency: 123.8, reqPerMin: 605.0, errorRate: 2.33, uptime: round(96.13741151597763,2), version: "v1.4.17" },
    { method: "PUT", path: "/api/v1/policies", name: "Policy Engine", status: "active", avgLatency: 238.0, reqPerMin: 409.0, errorRate: 1.83, uptime: round(95.59989037734903,2), version: "v3.9.7" },
    { method: "GET", path: "/api/v1/incidents", name: "Incident Tracker", status: "active", avgLatency: 39.4, reqPerMin: 948.0, errorRate: 0.97, uptime: round(96.28763755736169,2), version: "v1.4.19" },
    { method: "POST", path: "/api/v1/forensics", name: "Forensics Collector", status: "degraded", avgLatency: 120.1, reqPerMin: 167.0, errorRate: 2.34, uptime: round(97.25950036932794,2), version: "v3.6.0" },
    { method: "GET", path: "/api/v1/risk/assess", name: "Risk Assessment", status: "active", avgLatency: 371.5, reqPerMin: 1891.0, errorRate: 2.45, uptime: round(96.14694623741974,2), version: "v1.5.11" },
    { method: "POST", path: "/api/v1/auth/verify", name: "Authentication", status: "active", avgLatency: 115.3, reqPerMin: 1876.0, errorRate: 0.92, uptime: round(99.26835564457883,2), version: "v1.2.8" },
    { method: "GET", path: "/api/v1/logs/audit", name: "Audit Log Query", status: "active", avgLatency: 268.7, reqPerMin: 2273.0, errorRate: 1.82, uptime: round(98.5021516904623,2), version: "v3.9.3" },
    { method: "PUT", path: "/api/v1/users/roles", name: "Role Management", status: "active", avgLatency: 184.1, reqPerMin: 251.0, errorRate: 2.16, uptime: round(98.93020995390353,2), version: "v3.6.18" },
    { method: "POST", path: "/api/v1/encrypt", name: "Encryption Service", status: "active", avgLatency: 421.1, reqPerMin: 1398.0, errorRate: 2.43, uptime: round(95.82539358172014,2), version: "v2.0.12" },
    { method: "GET", path: "/api/v1/network/topo", name: "Network Topology", status: "maintenance", avgLatency: 182.9, reqPerMin: 269.0, errorRate: 0.19, uptime: round(97.53433247262173,2), version: "v1.4.4" },
    { method: "DELETE", path: "/api/v1/sessions", name: "Session Manager", status: "active", avgLatency: 398.7, reqPerMin: 546.0, errorRate: 0.47, uptime: round(95.35114155032184,2), version: "v3.8.13" },
  ];
  private _dependency_tApiKeys = [
    { id: "ak-000001", name: "key-depe-001", created: "2026-04-14", lastUsed: "2026-04-20", status: "active", calls: 12463, rateLimit: 500 },
    { id: "ak-000002", name: "key-depe-002", created: "2026-05-11", lastUsed: "2026-04-06", status: "active", calls: 42120, rateLimit: 500 },
    { id: "ak-000003", name: "key-depe-003", created: "2026-07-26", lastUsed: "2026-04-18", status: "active", calls: 30852, rateLimit: 500 },
    { id: "ak-000004", name: "key-depe-004", created: "2026-05-11", lastUsed: "2026-04-06", status: "revoked", calls: 24558, rateLimit: 1000 },
    { id: "ak-000005", name: "key-depe-005", created: "2026-03-28", lastUsed: "2026-04-11", status: "active", calls: 47035, rateLimit: 100 },
    { id: "ak-000006", name: "key-depe-006", created: "2026-04-07", lastUsed: "2026-04-20", status: "active", calls: 30973, rateLimit: 500 },
    { id: "ak-000007", name: "key-depe-007", created: "2026-04-07", lastUsed: "2026-04-14", status: "active", calls: 4694, rateLimit: 100 },
    { id: "ak-000008", name: "key-depe-008", created: "2026-04-25", lastUsed: "2026-04-08", status: "active", calls: 24501, rateLimit: 5000 },
  ];
  private _dependency_tApiHealthSummary() {
    const eps = this._dependency_tApiEndpoints;
  ...
  private _dependency_tGetApiByMethod(method: string) { return this._dependency_tApiEndpoints.filter(e=>e.method===method); }
  private _dependency_tGetSlowEndpoints() { return this._dependency_tApiEndpoints.filter(e=>e.avgLatency>200).sort((a,b)=>b.avgLatency-a.avgLatency); }
  private _dependency_tGetHighErrorEndpoints() { return this._dependency_tApiEndpoints.filter(e=>e.errorRate>1.0).sort((a,b)=>b.errorRate-a.errorRate); }

  // === Security Training Effectiveness (dependency_t) ===
  private _dependency_tTrainingModules = [
    { id: "TRN-001", name: "Security Fundamentals", completionRate: 68.5, avgScore: 66.6, behaviorChange: 82.8, enrolled: 55, completed: 299, duration: "57min", category: "mandatory" },
    { id: "TRN-002", name: "Phishing Awareness", completionRate: 50.3, avgScore: 66.9, behaviorChange: 89.1, enrolled: 395, completed: 445, duration: "109min", category: "mandatory" },
    { id: "TRN-003", name: "Social Engineering Defense", completionRate: 61.0, avgScore: 78.7, behaviorChange: 80.0, enrolled: 54, completed: 446, duration: "72min", category: "optional" },
    { id: "TRN-004", name: "Password Hygiene", completionRate: 60.5, avgScore: 67.9, behaviorChange: 34.2, enrolled: 225, completed: 228, duration: "107min", category: "mandatory" },
    { id: "TRN-005", name: "Data Classification", completionRate: 54.2, avgScore: 89.4, behaviorChange: 49.1, enrolled: 57, completed: 173, duration: "49min", category: "mandatory" },
    { id: "TRN-006", name: "Incident Response Basics", completionRate: 46.3, avgScore: 86.6, behaviorChange: 80.4, enrolled: 442, completed: 110, duration: "100min", category: "mandatory" },
    { id: "TRN-007", name: "Secure Coding", completionRate: 93.8, avgScore: 72.5, behaviorChange: 72.3, enrolled: 486, completed: 236, duration: "62min", category: "optional" },
    { id: "TRN-008", name: "Cloud Security", completionRate: 60.2, avgScore: 58.5, behaviorChange: 45.7, enrolled: 440, completed: 375, duration: "17min", category: "mandatory" },
    { id: "TRN-009", name: "Mobile Device Security", completionRate: 68.1, avgScore: 75.1, behaviorChange: 58.1, enrolled: 310, completed: 450, duration: "119min", category: "mandatory" },
    { id: "TRN-010", name: "Network Security", completionRate: 62.0, avgScore: 91.8, behaviorChange: 34.3, enrolled: 222, completed: 42, duration: "19min", category: "mandatory" },
    { id: "TRN-011", name: "Physical Security", completionRate: 49.4, avgScore: 86.0, behaviorChange: 85.0, enrolled: 472, completed: 48, duration: "74min", category: "optional" },
    { id: "TRN-012", name: "Regulatory Compliance", completionRate: 94.2, avgScore: 60.3, behaviorChange: 78.1, enrolled: 77, completed: 236, duration: "68min", category: "mandatory" },
    { id: "TRN-013", name: "Risk Management", completionRate: 58.0, avgScore: 83.8, behaviorChange: 66.7, enrolled: 255, completed: 104, duration: "29min", category: "mandatory" },
    { id: "TRN-014", name: "Cryptography Basics", completionRate: 80.7, avgScore: 75.2, behaviorChange: 32.9, enrolled: 475, completed: 168, duration: "42min", category: "mandatory" },
    { id: "TRN-015", name: "Access Control", completionRate: 86.2, avgScore: 62.6, behaviorChange: 83.1, enrolled: 309, completed: 335, duration: "52min", category: "optional" },
    { id: "TRN-016", name: "Vendor Management", completionRate: 72.9, avgScore: 65.7, behaviorChange: 53.7, enrolled: 99, completed: 139, duration: "72min", category: "mandatory" },
  ];
  private _dependency_tPhishingResults = [
    { month: "2026-01", sent: 494, clicked: 59, reported: 157, clickRate: round(11.94331983805668,1), reportRate: round(31.781376518218625,1) },
    { month: "2026-02", sent: 634, clicked: 102, reported: 173, clickRate: round(16.08832807570978,1), reportRate: round(27.287066246056785,1) },
    { month: "2026-03", sent: 524, clicked: 148, reported: 294, clickRate: round(28.24427480916031,1), reportRate: round(56.10687022900763,1) },
    { month: "2026-04", sent: 292, clicked: 9, reported: 105, clickRate: round(3.0821917808219177,1), reportRate: round(35.95890410958904,1) },
    { month: "2026-05", sent: 628, clicked: 12, reported: 88, clickRate: round(1.910828025477707,1), reportRate: round(14.012738853503185,1) },
    { month: "2026-06", sent: 275, clicked: 54, reported: 64, clickRate: round(19.636363636363637,1), reportRate: round(23.272727272727273,1) },
  ];
  private _dependency_tTrainingROI = { totalInvestment: 67429, avgCostPerEmployee: 400, riskReductionPct: round(random.uniform(15,45),1), incidentReductionPct: round(random.uniform(10,35),1), complianceScoreGain: round(random.uniform(5,25),1) };
  private _dependency_tLearningPaths = [
    { name: "Beginner Security Analyst", totalModules: 19, completedModules: 10, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 37, enrolled: 59 },
    { name: "Advanced Threat Hunter", totalModules: 16, completedModules: 16, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 75, enrolled: 41 },
    { name: "Security Architect", totalModules: 9, completedModules: 17, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 48, enrolled: 198 },
    { name: "Incident Responder", totalModules: 9, completedModules: 2, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 14, enrolled: 143 },
    { name: "Compliance Specialist", totalModules: 11, completedModules: 17, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 55, enrolled: 50 },
    { name: "DevSecOps Engineer", totalModules: 13, completedModules: 5, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 45, enrolled: 99 },
  ];
  private _dependency_tGetOverallCompletion() {
    const mods = this._dependency_tTrainingModules;
    return round(mods.reduce((s,m)=>s+m.completionRate,0)/mods.length,1);
  }
  private _dependency_tGetTopPerformers() { return [...this._dependency_tTrainingModules].sort((a,b)=>b.avgScore-a.avgScore).slice(0,5); }
  private _dependency_tGetModulesNeedingAttention() { return this._dependency_tTrainingModules.filter(m=>m.completionRate<70||m.avgScore<65); }

  // === Security Governance Framework (dependency_t) ===
  private _dependency_tGovBodies = [
    { name: "Security Steering Committee", members: 6, chair: "CISO", meetingFreq: "Weekly", lastMeeting: "2026-04-06", nextMeeting: "2026-05-28", quorum: 5 },
    { name: "Risk Management Board", members: 10, chair: "CTO", meetingFreq: "Bi-weekly", lastMeeting: "2026-04-01", nextMeeting: "2026-05-03", quorum: 8 },
    { name: "Data Governance Council", members: 7, chair: "CRO", meetingFreq: "Monthly", lastMeeting: "2026-04-17", nextMeeting: "2026-05-13", quorum: 3 },
    { name: "Compliance Oversight Board", members: 13, chair: "CDO", meetingFreq: "Monthly", lastMeeting: "2026-04-20", nextMeeting: "2026-05-21", quorum: 3 },
    { name: "Architecture Review Board", members: 12, chair: "VP Eng", meetingFreq: "Bi-weekly", lastMeeting: "2026-04-03", nextMeeting: "2026-05-21", quorum: 3 },
    { name: "Change Advisory Board", members: 15, chair: "CISO", meetingFreq: "Weekly", lastMeeting: "2026-04-07", nextMeeting: "2026-05-03", quorum: 3 },
    { name: "Incident Review Board", members: 14, chair: "CIO", meetingFreq: "As needed", lastMeeting: "2026-04-11", nextMeeting: "2026-05-03", quorum: 4 },
    { name: "Vendor Risk Committee", members: 11, chair: "CFO", meetingFreq: "Quarterly", lastMeeting: "2026-04-16", nextMeeting: "2026-05-21", quorum: 3 },
  ];
  private _dependency_tDecisions = [
    { id: "DEC-0001", title: "Adopt zero-trust architecture framework", date: "2026-02-25", status: "approved", owner: "CISO" },
    { id: "DEC-0002", title: "Migrate to SIEM 2.0 platform", date: "2026-02-08", status: "implemented", owner: "CTO" },
    { id: "DEC-0003", title: "Implement DLP across all endpoints", date: "2026-04-13", status: "in-progress", owner: "Security Lead" },
    { id: "DEC-0004", title: "Mandate MFA for all external access", date: "2026-03-21", status: "pending", owner: "CRO" },
    { id: "DEC-0005", title: "Establish bug bounty program", date: "2026-03-06", status: "approved", owner: "VP Eng" },
    { id: "DEC-0006", title: "Deploy EDR solution enterprise-wide", date: "2026-02-10", status: "approved", owner: "CISO" },
    { id: "DEC-0007", title: "Conduct annual penetration testing", date: "2026-01-19", status: "implemented", owner: "CTO" },
    { id: "DEC-0008", title: "Implement network micro-segmentation", date: "2026-02-18", status: "in-progress", owner: "Security Lead" },
    { id: "DEC-0009", title: "Establish security champion program", date: "2026-03-21", status: "pending", owner: "CRO" },
    { id: "DEC-0010", title: "Migrate to passwordless authentication", date: "2026-03-24", status: "approved", owner: "VP Eng" },
  ];
  private _dependency_tPolicyLifecycle = [
    { name: "Information Security Policy", version: "v4.0", status: "active", lastUpdated: "2026-03-07", nextReview: "2026-8-20", owner: "CISO" },
    { name: "Acceptable Use Policy", version: "v1.5", status: "active", lastUpdated: "2026-02-10", nextReview: "2026-12-21", owner: "Legal" },
    { name: "Data Retention Policy", version: "v4.0", status: "under-review", lastUpdated: "2026-02-25", nextReview: "2026-10-10", owner: "DPO" },
    { name: "Access Control Policy", version: "v3.3", status: "active", lastUpdated: "2026-01-04", nextReview: "2026-8-27", owner: "IAM Lead" },
    { name: "Incident Response Policy", version: "v1.1", status: "draft", lastUpdated: "2026-04-17", nextReview: "2026-10-18", owner: "IR Lead" },
    { name: "Business Continuity Plan", version: "v2.5", status: "active", lastUpdated: "2026-01-17", nextReview: "2026-9-06", owner: "BCP Mgr" },
    { name: "Vendor Management Policy", version: "v1.1", status: "active", lastUpdated: "2026-03-08", nextReview: "2026-9-12", owner: "Procurement" },
    { name: "Encryption Standard", version: "v3.0", status: "under-review", lastUpdated: "2026-02-05", nextReview: "2026-7-06", owner: "Security Arch" },
  ];
  private _dependency_tGovMaturityScore = { overall: 3.9, riskManagement: 4.3, compliance: 4.1, incidentResponse: 4.6, awareness: 4.7, technology: 3.5 };
  private _dependency_tGetPendingDecisions() { return this._dependency_tDecisions.filter(d=>d.status==='pending'||d.status==='in-progress'); }
  private _dependency_tGetActivePolicies() { return this._dependency_tPolicyLifecycle.filter(p=>p.status==='active'); }
  private _dependency_tGetEscalationPath() { return ["L1 Analyst","L2 Senior","Security Lead","CISO","Board"]; }

  // === Security Innovation Lab (dependency_t) ===
  private _dependency_tInnoProjects = [
    { id: "INN-001", name: "AI-Powered Threat Detection", description: "Machine learning models for real-time threat identification", status: "active", progress: 72, startDate: "2026-01-28", teamSize: 4, budget: 138843, milestones: 3, completedMilestones: 3 },
    { id: "INN-002", name: "Quantum-Resistant Cryptography", description: "Post-quantum encryption algorithm prototyping", status: "research", progress: 35, startDate: "2026-01-09", teamSize: 8, budget: 26426, milestones: 8, completedMilestones: 6 },
    { id: "INN-003", name: "Automated Red Teaming", description: "Autonomous penetration testing framework", status: "active", progress: 58, startDate: "2026-02-21", teamSize: 2, budget: 59958, milestones: 9, completedMilestones: 9 },
    { id: "INN-004", name: "Zero-Knowledge Authentication", description: "Privacy-preserving identity verification", status: "poc", progress: 88, startDate: "2026-02-01", teamSize: 8, budget: 93690, milestones: 3, completedMilestones: 6 },
    { id: "INN-005", name: "Blockchain Audit Trail", description: "Immutable security event logging", status: "active", progress: 45, startDate: "2026-02-12", teamSize: 8, budget: 51832, milestones: 5, completedMilestones: 6 },
    { id: "INN-006", name: "Behavioral Biometrics", description: "Continuous authentication via user behavior patterns", status: "research", progress: 22, startDate: "2026-02-06", teamSize: 8, budget: 198984, milestones: 9, completedMilestones: 7 },
    { id: "INN-007", name: "Deception Grid 2.0", description: "Advanced honeypot network with adaptive responses", status: "active", progress: 65, startDate: "2026-02-10", teamSize: 8, budget: 152785, milestones: 3, completedMilestones: 7 },
    { id: "INN-008", name: "Secure Enclave Integration", description: "Hardware-backed security for critical workloads", status: "poc", progress: 40, startDate: "2026-03-04", teamSize: 5, budget: 33129, milestones: 7, completedMilestones: 3 },
  ];
  private _dependency_tTechEvaluations = [
    { name: "Rust for Security Tools", status: "evaluating", score: 4.3, recommendation: "Adopt", vendor: "Open Source" },
    { name: "eBPF for Runtime Detection", status: "completed", score: 5.8, recommendation: "Adopt", vendor: "AWS" },
    { name: "Confidential Computing", status: "planned", score: 6.3, recommendation: "Investigate", vendor: "Azure" },
    { name: "Homomorphic Encryption", status: "evaluating", score: 9.0, recommendation: "Pilot", vendor: "GCP" },
    { name: "SASE Architecture", status: "completed", score: 4.4, recommendation: "Adopt", vendor: "Multiple" },
    { name: "SOAR Platform 3.0", status: "planned", score: 5.0, recommendation: "Monitor", vendor: "Splunk" },
  ];
  private _dependency_tCollaborationPartners = [
  ...
  private _dependency_tInnoMetrics = { totalProjects: 8, activeProjects: 4, avgTimeToValue: "65 days", pocSuccessRate: round(random.uniform(55,85),1), researchToProduction: round(random.uniform(20,50),1), innovationIndex: round(random.uniform(6.0,9.5),1) };
  private _dependency_tGetProjectByStatus(status: string) { return this._dependency_tInnoProjects.filter(p=>p.status===status); }
  private _dependency_tGetTopEvaluations() { return [...this._dependency_tTechEvaluations].sort((a,b)=>b.score-a.score).slice(0,3); }



  // === Compliance Dashboard Extension (dependency_t) ===
  private _dependency_tComplianceFrameworks = [
    { name: "SOC 2 Type II", description: "Trust Services Criteria", totalControls: 5, implementedControls: 5, status: "in-review", lastAudit: "2026-01-12", nextAudit: "2026-11-12", evidenceCount: 140 },
    { name: "ISO 27001", description: "Information Security Management", totalControls: 114, implementedControls: 57, status: "in-review", lastAudit: "2026-04-03", nextAudit: "2026-11-10", evidenceCount: 423 },
    { name: "PCI DSS 4.0", description: "Payment Card Industry", totalControls: 12, implementedControls: 12, status: "non-compliant", lastAudit: "2026-01-19", nextAudit: "2026-11-13", evidenceCount: 230 },
    { name: "HIPAA", description: "Health Insurance Portability", totalControls: 18, implementedControls: 17, status: "in-review", lastAudit: "2026-01-09", nextAudit: "2026-9-08", evidenceCount: 201 },
    { name: "GDPR", description: "Data Protection Regulation", totalControls: 99, implementedControls: 54, status: "compliant", lastAudit: "2026-01-28", nextAudit: "2026-9-19", evidenceCount: 208 },
    { name: "NIST CSF 2.0", description: "Cybersecurity Framework", totalControls: 6, implementedControls: 3, status: "in-review", lastAudit: "2026-03-19", nextAudit: "2026-12-22", evidenceCount: 197 },
    { name: "FedRAMP", description: "Federal Risk Authorization", totalControls: 15, implementedControls: 9, status: "partially-compliant", lastAudit: "2026-04-03", nextAudit: "2026-7-15", evidenceCount: 439 },
    { name: "SOX", description: "Sarbanes-Oxley Compliance", totalControls: 8, implementedControls: 5, status: "in-review", lastAudit: "2026-04-06", nextAudit: "2026-10-11", evidenceCount: 137 },
    { name: "CIS Controls v8", description: "Center for Internet Security", totalControls: 18, implementedControls: 12, status: "compliant", lastAudit: "2026-01-14", nextAudit: "2026-10-28", evidenceCount: 362 },
    { name: "COBIT 2019", description: "IT Governance Framework", totalControls: 40, implementedControls: 29, status: "in-review", lastAudit: "2026-02-17", nextAudit: "2026-9-23", evidenceCount: 380 },
  ];
  private _dependency_tGetComplianceScore() {
    const fw = this._dependency_tComplianceFrameworks;
    return round(fw.reduce((s,f)=>s + (f.implementedControls/Math.max(f.totalControls,1))*100, 0) / fw.length, 1);
  }
  private _dependency_tGetGaps() {
    return this._dependency_tComplianceFrameworks.filter(f => f.status !== "compliant");
  }
  private _dependency_tAuditTrail = [
    { id: "AUD-0001", action: "Control tested", auditor: "Internal Audit", date: "2026-04-18", result: "pass", findings: 1 },
    { id: "AUD-0002", action: "Evidence collected", auditor: "External Auditor", date: "2026-04-05", result: "pass", findings: 4 },
    { id: "AUD-0003", action: "Gap identified", auditor: "Security Team", date: "2026-04-02", result: "fail", findings: 2 },
    { id: "AUD-0004", action: "Remediation completed", auditor: "Compliance Officer", date: "2026-04-08", result: "pass", findings: 2 },
    { id: "AUD-0005", action: "Policy updated", auditor: "IT Audit", date: "2026-04-01", result: "pass", findings: 4 },
    { id: "AUD-0006", action: "Training verified", auditor: "Risk Team", date: "2026-04-14", result: "pass", findings: 5 },
    { id: "AUD-0007", action: "Access reviewed", auditor: "QA Team", date: "2026-04-04", result: "pass", findings: 3 },
    { id: "AUD-0008", action: "Exception approved", auditor: "CISO Office", date: "2026-04-11", result: "conditional", findings: 2 },
    { id: "AUD-0009", action: "Risk accepted", auditor: "Board Audit", date: "2026-04-13", result: "pass", findings: 4 },
    { id: "AUD-0010", action: "Control enhanced", auditor: "Third Party", date: "2026-04-23", result: "pass", findings: 2 },
  ];

  // === Threat Intelligence Feed Extension (dependency_t) ===
  private _dependency_tThreatActors = [
    { name: "APT-29", alias: "Cozy Bear", origin: "Russia", type: "Nation-State", severity: "high", lastActivity: "2026-04-09", targets: "Healthcare", indicators: 182, ttps: 13 },
    { name: "APT-41", alias: "Double Dragon", origin: "China", type: "Nation-State", severity: "critical", lastActivity: "2026-04-15", targets: "Healthcare", indicators: 91, ttps: 19 },
    { name: "Lazarus Group", alias: "Hidden Cobra", origin: "North Korea", type: "Nation-State", severity: "critical", lastActivity: "2026-04-03", targets: "Finance", indicators: 214, ttps: 48 },
    { name: "FIN7", alias: "Carbanak", origin: "Eastern Europe", type: "Financial", severity: "high", lastActivity: "2026-04-11", targets: "Healthcare", indicators: 112, ttps: 33 },
    { name: "Conti", alias: "Wizard Spider", origin: "Russia", type: "Ransomware", severity: "critical", lastActivity: "2026-04-16", targets: "Technology", indicators: 348, ttps: 24 },
    { name: "LockBit", alias: "LockBit Gang", origin: "Unknown", type: "Ransomware", severity: "high", lastActivity: "2026-04-01", targets: "Finance", indicators: 485, ttps: 13 },
    { name: "Cl0p", alias: "Cl0p Team", origin: "Unknown", type: "Ransomware", severity: "high", lastActivity: "2026-04-16", targets: "Government", indicators: 32, ttps: 38 },
    { name: "Sandworm", alias: "Unit 74455", origin: "Russia", type: "Nation-State", severity: "critical", lastActivity: "2026-04-11", targets: "Healthcare", indicators: 35, ttps: 33 },
  ];
  private _dependency_tIoCFeed = [
    { id: "ioc-000001", type: "ip", value: "26.55.54.161", confidence: 96, source: "Mandiant", firstSeen: "2026-04-08", lastSeen: "2026-04-23" },
    { id: "ioc-000002", type: "ip", value: "81.29.60.73", confidence: 51, source: "MISP", firstSeen: "2026-04-07", lastSeen: "2026-04-10" },
    { id: "ioc-000003", type: "ip", value: "101.131.97.21", confidence: 78, source: "AlienVault", firstSeen: "2026-04-01", lastSeen: "2026-04-16" },
    { id: "ioc-000004", type: "ip", value: "90.65.148.206", confidence: 48, source: "VirusTotal", firstSeen: "2026-04-23", lastSeen: "2026-04-14" },
    { id: "ioc-000005", type: "ip", value: "10.46.158.32", confidence: 46, source: "CrowdStrike", firstSeen: "2026-04-07", lastSeen: "2026-04-19" },
    { id: "ioc-000006", type: "ip", value: "67.4.170.9", confidence: 53, source: "AlienVault", firstSeen: "2026-04-17", lastSeen: "2026-04-04" },
    { id: "ioc-000007", type: "ip", value: "188.203.54.105", confidence: 45, source: "MISP", firstSeen: "2026-04-07", lastSeen: "2026-04-01" },
    { id: "ioc-000008", type: "ip", value: "223.190.16.210", confidence: 65, source: "STIX", firstSeen: "2026-04-15", lastSeen: "2026-04-06" },
    { id: "ioc-000009", type: "ip", value: "218.66.172.202", confidence: 82, source: "CrowdStrike", firstSeen: "2026-04-05", lastSeen: "2026-04-06" },
    { id: "ioc-000010", type: "ip", value: "140.202.57.247", confidence: 65, source: "MISP", firstSeen: "2026-04-18", lastSeen: "2026-04-07" },
    { id: "ioc-000011", type: "ip", value: "241.202.143.173", confidence: 60, source: "Mandiant", firstSeen: "2026-04-09", lastSeen: "2026-04-16" },
    { id: "ioc-000012", type: "ip", value: "171.232.190.139", confidence: 98, source: "Mandiant", firstSeen: "2026-04-20", lastSeen: "2026-04-22" },
    { id: "ioc-000013", type: "ip", value: "6.27.99.145", confidence: 72, source: "Mandiant", firstSeen: "2026-04-01", lastSeen: "2026-04-10" },
    { id: "ioc-000014", type: "ip", value: "16.25.134.150", confidence: 74, source: "MISP", firstSeen: "2026-04-13", lastSeen: "2026-04-16" },
    { id: "ioc-000015", type: "ip", value: "104.252.88.55", confidence: 78, source: "VirusTotal", firstSeen: "2026-04-01", lastSeen: "2026-04-20" },
  ];
  private _dependency_tGetActiveThreats() { return this._dependency_tThreatActors.filter(a => a.severity === 'critical'); }
  private _dependency_tGetThreatSummary() {
    const actors = this._dependency_tThreatActors;
  ...
  // === Incident Management Extension (dependency_t) ===
  private _dependency_tIncidents = [
    { id: "INC-20260001", title: "Unauthorized access detected", severity: "critical", status: "open", assignedTo: "SOC L1", detectedAt: "2026-04-23T04:02", affectedAssets: 23, rootCause: "Misconfiguration" },
    { id: "INC-20260002", title: "Malware outbreak on workstation", severity: "high", status: "investigating", assignedTo: "SOC L2", detectedAt: "2026-04-18T13:13", affectedAssets: 39, rootCause: "Credential compromise" },
    { id: "INC-20260003", title: "Data leak from S3 bucket", severity: "medium", status: "contained", assignedTo: "IR Lead", detectedAt: "2026-04-18T22:31", affectedAssets: 1, rootCause: "Zero-day" },
    { id: "INC-20260004", title: "Phishing campaign targeting finance", severity: "low", status: "eradicated", assignedTo: "CISO", detectedAt: "2026-04-07T06:59", affectedAssets: 28, rootCause: "Human error" },
    { id: "INC-20260005", title: "DDoS attack on web services", severity: "critical", status: "recovered", assignedTo: "Security Eng", detectedAt: "2026-04-16T01:04", affectedAssets: 26, rootCause: "Policy violation" },
    { id: "INC-20260006", title: "Ransomware encryption attempt", severity: "high", status: "closed", assignedTo: "Forensics", detectedAt: "2026-04-23T05:38", affectedAssets: 2, rootCause: "Unknown" },
    { id: "INC-20260007", title: "Insider data exfiltration", severity: "medium", status: "open", assignedTo: "SOC L1", detectedAt: "2026-04-15T16:30", affectedAssets: 23, rootCause: "Misconfiguration" },
    { id: "INC-20260008", title: "API key exposure in repo", severity: "low", status: "investigating", assignedTo: "SOC L2", detectedAt: "2026-04-19T22:29", affectedAssets: 35, rootCause: "Credential compromise" },
    { id: "INC-20260009", title: "SQL injection on portal", severity: "critical", status: "contained", assignedTo: "IR Lead", detectedAt: "2026-04-23T13:29", affectedAssets: 9, rootCause: "Zero-day" },
    { id: "INC-20260010", title: "Brute force on VPN", severity: "high", status: "eradicated", assignedTo: "CISO", detectedAt: "2026-04-16T15:39", affectedAssets: 32, rootCause: "Human error" },
    { id: "INC-20260011", title: "Supply chain alert from vendor", severity: "medium", status: "recovered", assignedTo: "Security Eng", detectedAt: "2026-04-04T07:48", affectedAssets: 6, rootCause: "Policy violation" },
    { id: "INC-20260012", title: "Suspicious lateral movement", severity: "low", status: "closed", assignedTo: "Forensics", detectedAt: "2026-04-22T04:15", affectedAssets: 10, rootCause: "Unknown" },
  ];
  private _dependency_tGetIncidentStats() {
    const inc = this._dependency_tIncidents;
    return { total: inc.length, open: inc.filter(i=>i.status==="open").length, investigating: inc.filter(i=>i.status==="investigating").length, mttd: 9, mttr: 73 };
  }
  private _dependency_tGetSeverityDistribution() {
    const inc = this._dependency_tIncidents;
  ...
  private _initDependencyTreeComplianceHub() {
    const dependency_treeComplianceControls = [
    ...
    this._dependency_treeComplianceScore = this._calcDependencyTreeComplianceScore(dependency_treeComplianceControls);
    this._dependency_treeDriftAlerts = dependency_treeComplianceControls.filter(c => c.status === 'drift-detected' || c.status === 'non-compliant');
    this._dependency_treeRemediationQueue = this._generateDependencyTreeRemediationPlan(dependency_treeComplianceControls);
    this._dependency_treeRegulatoryChanges = this._detectDependencyTreeRegulatoryImpact(dependency_treeComplianceControls);
  }

  private _calcDependencyTreeComplianceScore(controls: Array<Record<string, unknown>>): number {
  ...
  private _generateDependencyTreeRemediationPlan(controls: Array<Record<string, unknown>>): Array<Record<string, unknown>> {
  ...
  private _detectDependencyTreeRegulatoryImpact(controls: Array<Record<string, unknown>>): Array<Record<string, unknown>> {
    return [
  ...
  private _runDependencyTreeContinuousMonitoring(): void {
    ...
    this._dependency_treeMonitoringChecks = monitoringChecks;
  }


  // === Security Architecture Evolution Tracker ===
  private _initDependencyTreeArchEvolution() {
    this._dependency_treeArchComponents = [
    ...
    this._dependency_treeArchRoadmap = this._planDependencyTreeArchRoadmap();
    this._dependency_treeArchRiskSurface = this._mapDependencyTreeArchRiskSurface();
    this._dependency_treeArchTechDebt = this._assessDependencyTreeTechDebt();
    this._dependency_treeArchEvolutionTimeline = this._buildDependencyTreeEvolutionTimeline();
  }

  private _planDependencyTreeArchRoadmap(): Array<Record<string, unknown>> {
    return [
  ...
  private _mapDependencyTreeArchRiskSurface(): Array<Record<string, unknown>> {
    return [
  ...
  private _assessDependencyTreeTechDebt(): Array<Record<string, unknown>> {
    return this._dependency_treeArchComponents
  ...
  private _buildDependencyTreeEvolutionTimeline(): Array<Record<string, unknown>> {
    return [
  ...
  private _initDependencyTreeDesignPatterns() {
    this._dependency_treeDesignPatterns = [
    ...
    this._dependency_treePatternCompliance = this._assessDependencyTreePatternCompliance();
    this._dependency_treePatternGaps = this._identifyDependencyTreePatternGaps();
  }

  private _assessDependencyTreePatternCompliance(): Array<Record<string, unknown>> {
    return this._dependency_treeDesignPatterns.map((pat: Record<string, unknown>) => ({
  ...
  private _identifyDependencyTreePatternGaps(): Array<Record<string, unknown>> {
    return this._dependency_treeDesignPatterns
  ...
  private _initDependencyTreeCapacityPlanning() {
    this._dependency_treeCapacityModels = [
    ...
    this._dependency_treeCapacityForecast = this._forecastDependencyTreeCapacity();
    this._dependency_treeCapacityAlerts = this._checkDependencyTreeCapacityAlerts();
  }

  private _forecastDependencyTreeCapacity(): Array<Record<string, unknown>> {
  ...
  private _checkDependencyTreeCapacityAlerts(): Array<Record<string, unknown>> {
    return this._dependency_treeCapacityModels
  ...
  private _initDependencyTreeIntegrationMatrix() {
    this._dependency_treeIntegrations = [
    ...
    this._dependency_treeIntegrationHealth = this._assessDependencyTreeIntegrationHealth();
    this._dependency_treeIntegrationAlerts = this._monitorDependencyTreeIntegrationAlerts();
    this._dependency_treeDataFlowMatrix = this._buildDependencyTreeDataFlowMatrix();
    this._dependency_treeIntegrationSLA = this._trackDependencyTreeIntegrationSLA();
  }

  private _assessDependencyTreeIntegrationHealth(): Record<string, unknown> {
    const active = this._dependency_treeIntegrations.filter((i: Record<string, unknown>) => i.status === 'active').length;
    const degraded = this._dependency_treeIntegrations.filter((i: Record<string, unknown>) => i.status === 'degraded').length;
    const warning = this._dependency_treeIntegrations.filter((i: Record<string, unknown>) => i.status === 'warning').length;
    const avgLatency = this._dependency_treeIntegrations.reduce((s: number, i: Record<string, unknown>) => s + Number(i.latency), 0) / this._dependency_treeIntegrations.length;
    const avgErrorRate = this._dependency_treeIntegrations.reduce((s: number, i: Record<string, unknown>) => s + Number(i.errorRate), 0) / this._dependency_treeIntegrations.length;
    return {
      totalIntegrations: this._dependency_treeIntegrations.length, active, degraded, warning,
      healthScore: Math.round((active / this._dependency_treeIntegrations.length) * 100),
      avgLatencyMs: Math.round(avgLatency), avgErrorRate: Math.round(avgErrorRate * 1000) / 10,
      dataFreshness: '95%', coverage: '92%'
    };
  }

  private _monitorDependencyTreeIntegrationAlerts(): Array<Record<string, unknown>> {
    return this._dependency_treeIntegrations
  ...
  private _buildDependencyTreeDataFlowMatrix(): Array<Record<string, unknown>> {
  ...
  private _trackDependencyTreeIntegrationSLA(): Array<Record<string, unknown>> {
    return this._dependency_treeIntegrations.map((i: Record<string, unknown>) => ({
      integrationId: i.integrationId, integrationName: i.name,
  ...
  private _initDependencyTreeServiceMesh() {
    this._dependency_treeMeshServices = [
    ...
    this._dependency_treeMeshHealth = this._calcDependencyTreeMeshHealth();
    this._dependency_treeMeshTraffic = this._analyzeDependencyTreeMeshTraffic();
  }

  private _calcDependencyTreeMeshHealth(): Record<string, unknown> {
    const healthy = this._dependency_treeMeshServices.filter((s: Record<string, unknown>) => Number(s.errorRate) < 0.03).length;
    return {
      totalServices: this._dependency_treeMeshServices.length, healthyServices: healthy,
      healthPercent: Math.round(healthy / this._dependency_treeMeshServices.length * 100),
      totalReplicas: this._dependency_treeMeshServices.reduce((s: number, svc: Record<string, unknown>) => s + Number(svc.replicas), 0),
      avgCpuUsage: Math.round(this._dependency_treeMeshServices.reduce((s: number, svc: Record<string, unknown>) => s + Number(svc.cpuUsage), 0) / this._dependency_treeMeshServices.length),
      avgMemoryUsage: Math.round(this._dependency_treeMeshServices.reduce((s: number, svc: Record<string, unknown>) => s + Number(svc.memoryUsage), 0) / this._dependency_treeMeshServices.length),
      avgLatencyP99: Math.round(this._dependency_treeMeshServices.reduce((s: number, svc: Record<string, unknown>) => s + Number(svc.latencyP99), 0) / this._dependency_treeMeshServices.length)
    };
  }

  private _analyzeDependencyTreeMeshTraffic(): Array<Record<string, unknown>> {
    return this._dependency_treeMeshServices.map((s: Record<string, unknown>) => ({
...
<div class="tabs">
        ...
        ${this._activeTab === 'rules' ? html`
          ${this._renderDeptRules()}
          <div style="margin-top:12px;font-size:11px;font-weight:600;margin-bottom:6px">Category Treemap</div>
          <div style="background:#1a1d27;border-radius:8px;padding:12px">${this._renderDeptTreemapSVG()}</div>
          <div style="margin-top:12px;font-size:11px;font-weight:600;margin-bottom:6px">Data Flow (Sankey)</div>
          <div style="background:#1a1d27;border-radius:8px;padding:12px">${this._renderDeptSankeySVG()}</div>
          ${this._renderDeptActivity()}
        ` : nothing}
        ${this._activeTab === 'anomalies' ? html`
          ${this._renderDeptAnomalies()}
          ${this._renderDeptNotifications()}
        ` : nothing}
        ${this._activeTab === 'predictions' ? html`
          ${this._renderDeptPredictions()}
          ...
          <div style="background:#1a1d27;border-radius:8px;padding:12px">
            <table class="history-table"><thead><tr><th>ID</th><th>Base</th><th>Temporal</th><th>Environmental</th><th>Overall</th></tr></thead><tbody>
              ${this._deptcvssData.map(c => html`<tr><td>${c.itemId}</td><td style="color:${c.base >= 7 ? '#ef4444' : c.base >= 4 ? '#eab308' : '#22c55e'}">${c.base}</td><td>${c.temporal}</td><td>${c.environmental}</td><td style="font-weight:700;color:${c.overall >= 7 ? '#ef4444' : c.overall >= 4 ? '#eab308' : '#22c55e'}">${c.overall}</td></tr>`)}
            </tbody></table>
          </div>
        ` : nothing}
        ${this._activeTab === 'approvals' ? html`
          ${this._renderDeptApprovals()}
        ` : nothing}
        ${this._activeTab === 'config' ? html`
          ${this._renderDeptConfig()}
        ` : nothing}
        ${this._activeTab === 'new' ? html`
          <div class="form-section">
            <div class="form-title">Create New Dependency Tree Entry</div>
            <div class="form-grid">
  ...
  @state() private _soarPlaybooks: Array<{
    ...
    {
      id: 'pb-soar-001', name: 'Dependency Tree Auto Response', status: 'active',
      steps: [
    ...
    {
      id: 'pb-soar-002', name: 'Dependency Tree Investigation Workflow', status: 'active',
      steps: [
    ...
    {
      id: 'pb-soar-003', name: 'Dependency Tree Compliance Scan', status: 'draft',
      steps: [
  ...
  @state() private _dependr15Timeline: Array<{id:string;time:string;event:string;severity:string;actor:string}> = [
  ...
  @state() private _dependr15RootCauses: Array<{why:string;answer:string}> = [
  ...
  @state() private _dependr15ImpactMatrix: Array<{system:string;users:number;data:string;revenue:string;status:string}> = [
  ...
  @state() private _dependr15Actions: Array<{id:string;item:string;owner:string;deadline:string;priority:string;status:string}> = [
  ...
  @state() private _dependr15Lessons: Array<{id:string;lesson:string;category:string;severity:string;applies_to:string}> = [
  ...
  @state() private _dependr15ActiveTab: string = 'timeline';
  @state() private _dependr15Benchmarks: Array<{metric:string;current:number;industry:number;target:number;unit:string;source:string}> = [
  ...
  @state() private _dependr15MaturityLevels: Array<{domain:string;current:number;target:number;description:string}> = [
  ...
  @state() private _dependr15QuarterlyData: Array<{quarter:string;score:number;improvement:number}> = [
  ...
  @state() private _dependr15SelectedDomain: string = 'all';
  @state() private _dependr15Alerts: Array<{id:string;name:string;severity:number;confidence:number;assetCrit:number;score:number;enriched:boolean;group:string;status:string;enrichData:Array<{key:string;value:string}>}> = [
  ...
  @state() private _dependr15QualityMetrics: {fpRate:number;enrichSuccess:number;avgTriageTime:number;enrichedCount:number;totalCount:number} = {fpRate:0.12, enrichSuccess:0.78, avgTriageTime:4.5, enrichedCount:3, totalCount:5};
  @state() private _dependr15RoutingRules: Array<{name:string;condition:string;channel:string;active:boolean}> = [
  ...
  @state() private _dependr15Shapes: Array<{id:string;type:string;label:string;controls:string[]}> = [
  ...
  @state() private _dependr15TrustBoundaries: Array<{from:string;to:string;label:string;strength:string}> = [
  ...
  @state() private _dependr15ADRs: Array<{id:string;title:string;status:string;date:string;decision:string}> = [
  ...
  @state() private _dependr15SelectedShape: string = '';
  @state() private _dependr15Gauges: Array<{name:string;value:number;max:number;unit:string;status:string;color:string}> = [
  ...
  @state() private _dependr15Anomalies: Array<{id:string;time:string;description:string;severity:string;acknowledged:boolean}> = [
  ...
  @state() private _dependr15Integrations: Array<{name:string;status:string;uptime:number;lastCheck:string;latency:number}> = [
  ...
  @state() private _dependr15AlertFatigue: Array<{analyst:string;alertsPerDay:number;escalated:number;dismissed:number;avgResponseMin:number}> = [
  ...
  @state() private _dependr15SlaTarget: number = 99.9;
  ...
  private _dtRenderInsiderThreat() {
    ...
    return html`<div class="card" style="padding:14px;margin-bottom:8px">
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px;margin-bottom:10px;flex-wrap:wrap">
            ${['timeline','rootcause','impact','actions','lessons'].map(t => html`
              <button class="btn ${this._dependr15ActiveTab === t ? 'btn-primary' : ''}" style="font-size:10px;padding:3px 8px" @click=${() => { this._dependr15ActiveTab = t; }}>${t.charAt(0).toUpperCase() + t.slice(1)}</button>
            `)}
          </div>
          ${this._dependr15ActiveTab === 'timeline' ? html`
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._dependr15Timeline.map(e => html`
          ...
          ` : this._dependr15ActiveTab === 'rootcause' ? html`
            <div style="margin-bottom:8px">${{__html: this._dependr15RenderFishbone()}}</div>
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._dependr15RootCauses.map((rc, i) => html`
          ...
          ` : this._dependr15ActiveTab === 'impact' ? html`
            <div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:10px">
              ...
              <tbody>${this._dependr15ImpactMatrix.map(imp => html`
          ...
          ` : this._dependr15ActiveTab === 'actions' ? html`
            <div style="display:flex;gap:12px;margin-bottom:8px;font-size:10px;color:#888">
              ${Object.entries(this._dependr15GetActionStats()).map(([k,v]) => html`<span>${k}: <b style="color:#ddd">${v}</b></span>`)}
            </div>
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._dependr15Actions.map(a => html`
                <div style="display:flex;gap:8px;align-items:center;padding:6px;background:#1a1d27;border-radius:4px;cursor:pointer" @click=${() => this._dependr15ToggleAction(a.id)}>
          ...
          ` : html`
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._dependr15Lessons.map(l => html`
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px;margin-bottom:10px;flex-wrap:wrap">
            ${['all', ...this._dependr15MaturityLevels.map(m => m.domain)].map(d => html`
              <button class="btn ${this._dependr15SelectedDomain === d ? 'btn-primary' : ''}" style="font-size:9px;padding:2px 6px" @click=${() => { this._dependr15SelectedDomain = d; }}>${d}</button>
            `)}
          </div>
          <div style="display:flex;gap:16px;margin-bottom:10px">
            <div style="text-align:center"><div style="color:#e0e0e0;font-size:20px;font-weight:bold">${this._dependr15GetOverallMaturity()}/5</div><div style="color:#888;font-size:10px">Maturity Level</div></div>
            <div style="text-align:center"><div style="color:#4f4;font-size:20px;font-weight:bold">${this._dependr15GetGapAnalysis().filter(g => g.isAbove).length}/${this._dependr15Benchmarks.length}</div><div style="color:#888;font-size:10px">Above Industry</div></div>
          </div>
          <div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:10px">
            ...
            <tbody>${this._dependr15GetGapAnalysis().map(b => html`
          ...
          <div style="margin-top:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Maturity by Domain</div>
            ${this._dependr15MaturityLevels.filter(m => this._dependr15SelectedDomain === 'all' || m.domain === this._dependr15SelectedDomain).map(m => html`
          ...
          <div style="margin-top:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Quarterly Trend</div>
            <div style="display:flex;height:40px;align-items:flex-end;gap:4px">
              ${this._dependr15QuarterlyData.map(q => html`<div style="flex:1;text-align:center"><div style="background:#4a9eff;height:${q.score * 0.5}px;border-radius:2px 2px 0 0" title="${q.score}"></div><div style="color:#666;font-size:8px;margin-top:2px">${q.quarter}</div></div>`)}
            </div>
          </div>
        </div>
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:12px;margin-bottom:8px;font-size:10px">
            <div style="display:flex;gap:4px;flex-wrap:wrap">${this._dependr15GroupAlerts().map(g => html`<span style="color:#888;padding:2px 6px;background:#1a1d27;border-radius:3px">${g.group}: ${g.count}</span>`)}</div>
          </div>
          <div style="display:flex;gap:8px;margin-bottom:8px;font-size:10px;color:#888">
            <span>FP Rate: <b style="color:${this._dependr15QualityMetrics.fpRate > 0.15 ? '#f44' : '#4f4'}">${(this._dependr15QualityMetrics.fpRate * 100).toFixed(1)}%</b></span>
            <span>Enrich: <b style="color:#4a9eff">${(this._dependr15QualityMetrics.enrichSuccess * 100).toFixed(0)}%</b></span>
            <span>Avg Triage: <b style="color:#ddd">${this._dependr15QualityMetrics.avgTriageTime}m</b></span>
          </div>
          <div style="display:flex;flex-direction:column;gap:4px;max-height:200px;overflow-y:auto">
            ${this._dependr15Alerts.sort((a, b) => this._dependr15CalcScore(b) - this._dependr15CalcScore(a)).map(a => {
              const score = this._dependr15CalcScore(a);
              return html`
                <div style="padding:6px;background:#1a1d27;border-radius:4px;border-left:3px solid ${a.severity >= 4 ? '#f44' : a.severity >= 3 ? '#fa0' : '#4a9eff'}">
                  <div style="display:flex;justify-content:space-between;align-items:center">
                    ...
                    <button class="btn" style="font-size:9px;padding:1px 6px;margin-left:4px" @click=${() => this._dependr15EnrichAlert(a.id)}>${a.enriched ? 'Re-enrich' : 'Enrich'}</button>
                  </div>
          ...
          <div style="margin-top:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Routing Rules</div>
            ${this._dependr15RoutingRules.map(r => html`
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:8px;margin-bottom:8px;flex-wrap:wrap">
            ${this._dependr15Shapes.map(s => {
              const v = this._dependr15ValidateControl(s.id);
              return html`<div style="padding:4px 8px;background:#1a1d27;border-radius:3px;cursor:pointer;border:1px solid ${this._dependr15SelectedShape === s.id ? '#4a9eff' : '#2a2d37'}" @click=${() => { this._dependr15SelectedShape = this._dependr15SelectedShape === s.id ? '' : s.id; }}>
          ...
          ${this._dependr15SelectedShape ? html`
            ${(() => {
              const shape = this._dependr15Shapes.find(s => s.id === this._dependr15SelectedShape);
              const v = this._dependr15ValidateControl(this._dependr15SelectedShape);
              return shape ? html`
          ...
          <div style="margin-bottom:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Trust Boundaries</div>
            ${this._dependr15TrustBoundaries.map(tb => html`
              <div style="display:flex;gap:6px;align-items:center;padding:3px;background:#1a1d27;border-radius:3px;margin-bottom:2px;font-size:9px">
                <span style="color:#ddd">${this._dependr15Shapes.find(s => s.id === tb.from)?.label || tb.from}</span>
                <span style="color:#4a9eff">\u2194</span>
                <span style="color:#ddd">${this._dependr15Shapes.find(s => s.id === tb.to)?.label || tb.to}</span>
          ...
          <div><div style="color:#888;font-size:10px;margin-bottom:4px">Architecture Decision Records</div>
            ${this._dependr15ADRs.map(adr => html`
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:8px;margin-bottom:8px;flex-wrap:wrap">
            ${this._dependr15Gauges.map(g => html`
          ...
          <div style="display:flex;gap:8px;margin-bottom:8px;align-items:center">
            ...
            <span style="color:${this._dependr15GetOverallHealth().score >= 99 ? '#4f4' : '#fa0'};font-size:12px;font-weight:bold">${this._dependr15GetOverallHealth().score}%</span>
            <span style="color:#888;font-size:10px">(Target: ${this._dependr15SlaTarget}%)</span>
            <span style="color:#4f4;font-size:10px">${this._dependr15GetOverallHealth().healthy} healthy</span>
            <span style="color:#fa0;font-size:10px">${this._dependr15GetOverallHealth().degraded} degraded</span>
          </div>
          <div style="margin-bottom:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Anomaly Stream</div>
            ${this._dependr15Anomalies.slice(0, 3).map(a => html`
              <div style="display:flex;gap:6px;align-items:center;padding:4px;background:#1a1d27;border-radius:3px;margin-bottom:2px;opacity:${a.acknowledged ? 0.5 : 1}">
                ...
                ${!a.acknowledged ? html`<button class="btn" style="font-size:8px;padding:1px 4px" @click=${() => this._dependr15AckAnomaly(a.id)}>ACK</button>` : html`<span style="color:#4f4;font-size:9px">ACK'd</span>`}
              </div>
            `)}
          </div>
          <div style="margin-bottom:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Integration Health</div>
            ${this._dependr15Integrations.map(i => html`
              <div style="display:flex;gap:6px;align-items:center;padding:3px;background:#1a1d27;border-radius:3px;margin-bottom:2px;font-size:9px">
          ...
          <div><div style="color:#888;font-size:10px;margin-bottom:4px">Alert Fatigue Analysis</div>
            <div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:9px">
              ...
              <tbody>${this._dependr15AlertFatigue.map(af => html`
  ...
  private _dependr15RenderFishbone(): string {
  ...
  private _dependr15ToggleAction(id: string) {
    this._dependr15Actions = this._dependr15Actions.map(a => a.id === id ? {...a, status: a.status === 'pending' ? 'in_progress' : a.status === 'in_progress' ? 'completed' : 'pending'} : a);
  }

  private _dependr15GetActionStats() {
    const total = this._dependr15Actions.length;
    const done = this._dependr15Actions.filter(a => a.status === 'completed').length;
    const inProg = this._dependr15Actions.filter(a => a.status === 'in_progress').length;
    return { total, done, inProg, pending: total - done - inProg };
  }

  private _dependr15GetOverallMaturity(): number {
    if (this._dependr15SelectedDomain === 'all') {
      return Math.round(this._dependr15MaturityLevels.reduce((s, m) => s + m.current, 0) / this._dependr15MaturityLevels.length * 10) / 10;
    }
    const d = this._dependr15MaturityLevels.find(m => m.domain === this._dependr15SelectedDomain);
    return d ? d.current : 0;
  }

  private _dependr15GetGapAnalysis() {
    return this._dependr15Benchmarks.map(b => {
  ...
  private _dependr15CalcScore(alert: any): number {
    return Math.round(alert.severity * alert.confidence * alert.assetCrit * 100) / 100;
  }

  private _dependr15EnrichAlert(id: string) {
    this._dependr15Alerts = this._dependr15Alerts.map(a => {
      if (a.id !== id) return a;
      const score = this._dependr15CalcScore(a);
  ...
  private _dependr15GroupAlerts() {
    const groups: Record<string, number> = {};
    this._dependr15Alerts.forEach(a => { groups[a.group] = (groups[a.group] || 0) + 1; });
    return Object.entries(groups).map(([g, c]) => ({group: g, count: c}));
  }

  private _dependr15ValidateControl(shapeId: string): {valid:boolean;missing:string[]} {
    const shape = this._dependr15Shapes.find(s => s.id === shapeId);
  ...
  private _dependr15GetOverallHealth(): {healthy:number;degraded:number;down:number;score:number} {
    const online = this._dependr15Integrations.filter(i => i.status === 'online').length;
    const degraded = this._dependr15Integrations.filter(i => i.status === 'degraded').length;
    const total = this._dependr15Integrations.length;
    return { healthy: online, degraded, down: total - online - degraded, score: Math.round(online / total * 100) };
  }

  private _dependr15AckAnomaly(id: string) {
    this._dependr15Anomalies = this._dependr15Anomalies.map(a => a.id === id ? {...a, acknowledged: true} : a);
  }
...
// ===== THREAT ACTOR PROFILE DATABASE (R22) =====
  ...
  private _renderBudgetPlanning() {
    const budgetData = [
      { category: "Personnel & Training", planned: 4262000, actual: 4745000, utilization: 111.3, q1: "30%", q2: "35%", q3: "33%", q4: "25%" },
      { category: "Tooling & Licensing", planned: 4269000, actual: 4758000, utilization: 111.5, q1: "17%", q2: "24%", q3: "28%", q4: "10%" },
      { category: "Infrastructure Security", planned: 4276000, actual: 4771000, utilization: 111.6, q1: "20%", q2: "29%", q3: "23%", q4: "11%" },
      { category: "Compliance & Audit", planned: 4283000, actual: 4784000, utilization: 111.7, q1: "23%", q2: "34%", q3: "18%", q4: "12%" },
      { category: "Incident Response", planned: 4290000, actual: 4797000, utilization: 111.8, q1: "26%", q2: "23%", q3: "29%", q4: "13%" },
      { category: "Third-Party Assessments", planned: 4297000, actual: 709000, utilization: 16.5, q1: "29%", q2: "28%", q3: "24%", q4: "14%" },
      { category: "Security Awareness", planned: 4304000, actual: 722000, utilization: 16.8, q1: "16%", q2: "33%", q3: "19%", q4: "15%" },
      { category: "Research & Innovation", planned: 4311000, actual: 735000, utilization: 17.0, q1: "19%", q2: "22%", q3: "30%", q4: "16%" },
    ];
    ...
    const headcount = [
      { team: "SOC Tier 1", current: 2, target: 22, gap: 1, avgSalary: "140k" },
      { team: "SOC Tier 2", current: 11, target: 21, gap: 0, avgSalary: "169k" },
      { team: "Threat Intel", current: 3, target: 20, gap: 5, avgSalary: "87k" },
      { team: "Red Team", current: 12, target: 19, gap: 4, avgSalary: "116k" },
      { team: "GRC", current: 4, target: 18, gap: 3, avgSalary: "145k" },
      { team: "AppSec", current: 13, target: 17, gap: 2, avgSalary: "174k" },
      { team: "Cloud Sec", current: 5, target: 16, gap: 1, avgSalary: "92k" },
      { team: "Identity & Access", current: 14, target: 15, gap: 0, avgSalary: "121k" },
    ];
    const vendorSpend = [
      { vendor: "CrowdStrike", annual: "134k", contractEnd: "2026-08", renewalRisk: "Low", satisfaction: 4 },
      { vendor: "Palo Alto", annual: "165k", contractEnd: "2026-09", renewalRisk: "Medium", satisfaction: 3 },
      { vendor: "Splunk", annual: "196k", contractEnd: "2026-10", renewalRisk: "High", satisfaction: 5 },
      { vendor: "Qualys", annual: "227k", contractEnd: "2026-11", renewalRisk: "Low", satisfaction: 4 },
      { vendor: "Rapid7", annual: "258k", contractEnd: "2026-12", renewalRisk: "Medium", satisfaction: 3 },
      { vendor: "Mandiant", annual: "289k", contractEnd: "2026-01", renewalRisk: "High", satisfaction: 5 },
      { vendor: "Zscaler", annual: "320k", contractEnd: "2026-02", renewalRisk: "Low", satisfaction: 4 },
      { vendor: "Duo Security", annual: "351k", contractEnd: "2026-03", renewalRisk: "Medium", satisfaction: 3 },
    ];
    const roiProjections = [
      { area: "Threat Detection", investment: "491k", projectedReturn: "1778k", roiMultiple: "3.0x", confidence: 91 },
      { area: "Incident Reduction", investment: "534k", projectedReturn: "1825k", roiMultiple: "2.9x", confidence: 72 },
      { area: "Compliance Savings", investment: "577k", projectedReturn: "1872k", roiMultiple: "2.8x", confidence: 89 },
      { area: "Automation Gains", investment: "620k", projectedReturn: "1919k", roiMultiple: "2.7x", confidence: 70 },
      { area: "Risk Avoidance", investment: "663k", projectedReturn: "1966k", roiMultiple: "2.6x", confidence: 87 },
    ];
    return html`
  ...
  private _renderMetricsNormalization() {
    const kpiCatalog = [
      { id: "kpi-1", name: "MTTD", owner: "SOC", unit: "minutes", target: 98, current: 83, benchmark: 95, collection: "auto", frequency: "realtime" },
      { id: "kpi-2", name: "MTTR", owner: "GRC", unit: "%", target: 71, current: 90, benchmark: 72, collection: "semi-auto", frequency: "daily" },
      { id: "kpi-3", name: "MTTC", owner: "AppSec", unit: "score", target: 74, current: 97, benchmark: 83, collection: "manual", frequency: "weekly" },
      { id: "kpi-4", name: "Vuln SLA Compliance", owner: "Cloud Sec", unit: "count", target: 77, current: 58, benchmark: 94, collection: "auto", frequency: "monthly" },
      { id: "kpi-5", name: "Patch Coverage", owner: "Identity", unit: "days", target: 80, current: 65, benchmark: 71, collection: "semi-auto", frequency: "realtime" },
      { id: "kpi-6", name: "Phishing Click Rate", owner: "Threat Intel", unit: "minutes", target: 83, current: 72, benchmark: 82, collection: "manual", frequency: "daily" },
      { id: "kpi-7", name: "Training Completion", owner: "Security Ops", unit: "%", target: 86, current: 79, benchmark: 93, collection: "auto", frequency: "weekly" },
      { id: "kpi-8", name: "Escalation Rate", owner: "Risk Mgmt", unit: "score", target: 89, current: 86, benchmark: 70, collection: "semi-auto", frequency: "monthly" },
      { id: "kpi-9", name: "False Positive Rate", owner: "SOC", unit: "count", target: 92, current: 93, benchmark: 81, collection: "manual", frequency: "realtime" },
      { id: "kpi-10", name: "Threat Intel Actionability", owner: "GRC", unit: "days", target: 95, current: 100, benchmark: 92, collection: "auto", frequency: "daily" },
      { id: "kpi-11", name: "Endpoint Compliance", owner: "AppSec", unit: "minutes", target: 98, current: 61, benchmark: 69, collection: "semi-auto", frequency: "weekly" },
      { id: "kpi-12", name: "Cloud Misconfig Score", owner: "Cloud Sec", unit: "%", target: 71, current: 68, benchmark: 80, collection: "manual", frequency: "monthly" },
      { id: "kpi-13", name: "Identity Anomaly Rate", owner: "Identity", unit: "score", target: 74, current: 75, benchmark: 91, collection: "auto", frequency: "realtime" },
      { id: "kpi-14", name: "DLP Events", owner: "Threat Intel", unit: "count", target: 77, current: 82, benchmark: 68, collection: "semi-auto", frequency: "daily" },
      { id: "kpi-15", name: "Vendor Risk Avg", owner: "Security Ops", unit: "days", target: 80, current: 89, benchmark: 79, collection: "manual", frequency: "weekly" },
      { id: "kpi-16", name: "Compliance Audit Pass Rate", owner: "Risk Mgmt", unit: "minutes", target: 83, current: 96, benchmark: 90, collection: "auto", frequency: "monthly" },
      { id: "kpi-17", name: "Awareness Score", owner: "SOC", unit: "%", target: 86, current: 57, benchmark: 67, collection: "semi-auto", frequency: "realtime" },
      { id: "kpi-18", name: "SOC Utilization", owner: "GRC", unit: "score", target: 89, current: 64, benchmark: 78, collection: "manual", frequency: "daily" },
      { id: "kpi-19", name: "Automation Coverage", owner: "AppSec", unit: "count", target: 92, current: 71, benchmark: 89, collection: "auto", frequency: "weekly" },
      { id: "kpi-20", name: "Risk Register Currency", owner: "Cloud Sec", unit: "days", target: 95, current: 78, benchmark: 66, collection: "semi-auto", frequency: "monthly" },
    ];
    const benchmarkSources = [
      { source: "NIST CSF", mappedKPIs: 7, alignment: 73, lastReview: "2026-05-19", status: "aligned" },
      { source: "CIS Controls v8", mappedKPIs: 8, alignment: 90, lastReview: "2026-06-14", status: "partial" },
      { source: "ISO 27001:2022", mappedKPIs: 3, alignment: 68, lastReview: "2026-01-09", status: "reviewing" },
      { source: "PCI DSS 4.0", mappedKPIs: 4, alignment: 85, lastReview: "2026-02-04", status: "aligned" },
      { source: "SOC 2 Type II", mappedKPIs: 5, alignment: 63, lastReview: "2026-03-27", status: "partial" },
      { source: "MITRE ATT&CK", mappedKPIs: 6, alignment: 80, lastReview: "2026-04-22", status: "reviewing" },
      { source: "SANS Top 20", mappedKPIs: 7, alignment: 97, lastReview: "2026-05-17", status: "aligned" },
      { source: "OWASP Top 10", mappedKPIs: 8, alignment: 75, lastReview: "2026-06-12", status: "partial" },
    ];
  ...
  private _renderThreatHuntingCampaigns() {
    const campaigns = [
      { id: "HC-1001", name: "Lateral Movement Sweep", status: "active", hypothesis: "H1: Actors using pass-the-hash for lateral movement", leadHunter: "Alice Chen", findings: 14, startDate: "2026-03-11", endDate: null, effectiveness: 89 },
      { id: "HC-1002", name: "Credential Harvesting Hunt", status: "completed", hypothesis: "H2: Actors using web shells for persistence", leadHunter: "Bob Martinez", findings: 17, startDate: "2026-02-22", endDate: "2026-04-28", effectiveness: 49 },
      { id: "HC-1003", name: "Persistence Mechanism Audit", status: "planned", hypothesis: "H3: Actors using scheduled tasks for data theft", leadHunter: "Carol Wu", findings: 20, startDate: "2026-01-05", endDate: null, effectiveness: 68 },
      { id: "HC-1004", name: "C2 Beacon Detection", status: "in-review", hypothesis: "H4: Actors using DNS tunneling for C2 communication", leadHunter: "Dave Kim", findings: 23, startDate: "2026-04-16", endDate: null, effectiveness: 87 },
      { id: "HC-1005", name: "Data Exfiltration Patterns", status: "active", hypothesis: "H5: Actors using encrypted channels for privilege escalation", leadHunter: "Eve Johnson", findings: 26, startDate: "2026-03-27", endDate: null, effectiveness: 47 },
      { id: "HC-1006", name: "Privilege Escalation Scan", status: "completed", hypothesis: "H6: Actors using token impersonation for defense evasion", leadHunter: "Frank Liu", findings: 29, startDate: "2026-02-10", endDate: "2026-05-12", effectiveness: 66 },
      { id: "HC-1007", name: "Supply Chain Implant Hunt", status: "planned", hypothesis: "H7: Actors using poisoned images for initial access", leadHunter: "Grace Park", findings: 32, startDate: "2026-01-21", endDate: null, effectiveness: 85 },
      { id: "HC-1008", name: "Insider Threat Indicators", status: "in-review", hypothesis: "H8: Actors using legitimate tools for credential access", leadHunter: "Hector Silva", findings: 35, startDate: "2026-04-04", endDate: null, effectiveness: 45 },
      { id: "HC-1009", name: "Cloud Metadata Analysis", status: "active", hypothesis: "H9: Actors using API keys for command execution", leadHunter: "Alice Chen", findings: 38, startDate: "2026-03-15", endDate: null, effectiveness: 64 },
      { id: "HC-1010", name: "DNS Tunnel Detection", status: "completed", hypothesis: "H10: Actors using encoded subdomains for exfiltration", leadHunter: "Bob Martinez", findings: 41, startDate: "2026-02-26", endDate: "2026-06-24", effectiveness: 83 },
      { id: "HC-1011", name: "Fileless Malware Search", status: "planned", hypothesis: "H11: Actors using WMI providers for discovery", leadHunter: "Carol Wu", findings: 44, startDate: "2026-01-09", endDate: null, effectiveness: 43 },
      { id: "HC-1012", name: "Zero-Day Exploit Traces", status: "in-review", hypothesis: "H12: Actors using exploit kits for collection", leadHunter: "Dave Kim", findings: 47, startDate: "2026-04-20", endDate: null, effectiveness: 62 },
    ];
    const hunterLeaderboard = [
      { hunter: "Alice Chen", campaigns: 15, findings: 83, highSeverity: 12, avgScore: 65, streak: 7 },
      { hunter: "Bob Martinez", campaigns: 12, findings: 112, highSeverity: 17, avgScore: 58, streak: 8 },
      { hunter: "Carol Wu", campaigns: 9, findings: 25, highSeverity: 22, avgScore: 95, streak: 1 },
      { hunter: "Dave Kim", campaigns: 6, findings: 54, highSeverity: 1, avgScore: 88, streak: 2 },
      { hunter: "Eve Johnson", campaigns: 3, findings: 83, highSeverity: 6, avgScore: 81, streak: 3 },
      { hunter: "Frank Liu", campaigns: 13, findings: 112, highSeverity: 11, avgScore: 74, streak: 4 },
      { hunter: "Grace Park", campaigns: 10, findings: 25, highSeverity: 16, avgScore: 67, streak: 5 },
      { hunter: "Hector Silva", campaigns: 7, findings: 54, highSeverity: 21, avgScore: 60, streak: 6 },
    ];
    const mitreMapping = [
      { tactic: "Initial Access", techniques: 12, campaigns: 3, coverage: 44 },
      { tactic: "Execution", techniques: 11, campaigns: 2, coverage: 95 },
      { tactic: "Persistence", techniques: 10, campaigns: 1, coverage: 75 },
      { tactic: "Privilege Escalation", techniques: 9, campaigns: 6, coverage: 55 },
      { tactic: "Defense Evasion", techniques: 8, campaigns: 5, coverage: 35 },
      { tactic: "Credential Access", techniques: 7, campaigns: 4, coverage: 86 },
      { tactic: "Discovery", techniques: 6, campaigns: 3, coverage: 66 },
      { tactic: "Lateral Movement", techniques: 5, campaigns: 2, coverage: 46 },
      { tactic: "Collection", techniques: 4, campaigns: 1, coverage: 97 },
      { tactic: "Exfiltration", techniques: 3, campaigns: 6, coverage: 77 },
      { tactic: "Command & Control", techniques: 2, campaigns: 5, coverage: 57 },
      { tactic: "Impact", techniques: 12, campaigns: 4, coverage: 37 },
    ];
    return html`
  ...
  private _renderControlInventory() {
    const controls = [
      { id: "CTL-2001", name: "MFA Enforcement", domain: "Access Control", status: "implemented", effectiveness: 86, lastTest: "2026-03-03", nextReview: "2026-11-03", owner: "SOC", risk: "Low" },
      { id: "CTL-2002", name: "Network Segmentation", domain: "Network Security", status: "partial", effectiveness: 31, lastTest: "2026-02-16", nextReview: "2026-12-22", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2003", name: "EDR Deployment", domain: "Endpoint Protection", status: "planned", effectiveness: 38, lastTest: "2026-01-01", nextReview: "2026-05-13", owner: "IT Ops", risk: "High" },
      { id: "CTL-2004", name: "DLP Policy", domain: "Data Protection", status: "gap", effectiveness: 45, lastTest: "2026-04-14", nextReview: "2026-06-04", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2005", name: "SSO Integration", domain: "Identity Management", status: "implemented", effectiveness: 98, lastTest: "2026-03-27", nextReview: "2026-07-23", owner: "IAM", risk: "Low" },
      { id: "CTL-2006", name: "SAST Pipeline", domain: "Application Security", status: "partial", effectiveness: 8, lastTest: "2026-02-12", nextReview: "2026-08-14", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2007", name: "CSPM Scanning", domain: "Cloud Security", status: "planned", effectiveness: 15, lastTest: "2026-01-25", nextReview: "2026-09-05", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2008", name: "Badge Access", domain: "Physical Security", status: "gap", effectiveness: 22, lastTest: "2026-04-10", nextReview: "2026-10-24", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2009", name: "Least Privilege", domain: "Access Control", status: "implemented", effectiveness: 51, lastTest: "2026-03-23", nextReview: "2026-11-15", owner: "SOC", risk: "Low" },
      { id: "CTL-2010", name: "Firewall Rules", domain: "Network Security", status: "partial", effectiveness: 36, lastTest: "2026-02-08", nextReview: "2026-12-06", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2011", name: "Disk Encryption", domain: "Endpoint Protection", status: "planned", effectiveness: 43, lastTest: "2026-01-21", nextReview: "2026-05-25", owner: "IT Ops", risk: "High" },
      { id: "CTL-2012", name: "Data Classification", domain: "Data Protection", status: "gap", effectiveness: 50, lastTest: "2026-04-06", nextReview: "2026-06-16", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2013", name: "PAM Implementation", domain: "Identity Management", status: "implemented", effectiveness: 63, lastTest: "2026-03-19", nextReview: "2026-07-07", owner: "IAM", risk: "Low" },
      { id: "CTL-2014", name: "DAST Pipeline", domain: "Application Security", status: "partial", effectiveness: 13, lastTest: "2026-02-04", nextReview: "2026-08-26", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2015", name: "IAM Policy Review", domain: "Cloud Security", status: "planned", effectiveness: 20, lastTest: "2026-01-17", nextReview: "2026-09-17", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2016", name: "Visitor Management", domain: "Physical Security", status: "gap", effectiveness: 27, lastTest: "2026-04-02", nextReview: "2026-10-08", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2017", name: "Access Reviews", domain: "Access Control", status: "implemented", effectiveness: 75, lastTest: "2026-03-15", nextReview: "2026-11-27", owner: "SOC", risk: "Low" },
      { id: "CTL-2018", name: "IDS/IPS Tuning", domain: "Network Security", status: "partial", effectiveness: 41, lastTest: "2026-02-28", nextReview: "2026-12-18", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2019", name: "Patch Management", domain: "Endpoint Protection", status: "planned", effectiveness: 48, lastTest: "2026-01-13", nextReview: "2026-05-09", owner: "IT Ops", risk: "High" },
      { id: "CTL-2020", name: "Backup Encryption", domain: "Data Protection", status: "gap", effectiveness: 4, lastTest: "2026-04-26", nextReview: "2026-06-28", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2021", name: "Password Policy", domain: "Identity Management", status: "implemented", effectiveness: 87, lastTest: "2026-03-11", nextReview: "2026-07-19", owner: "IAM", risk: "Low" },
      { id: "CTL-2022", name: "Container Scanning", domain: "Application Security", status: "partial", effectiveness: 18, lastTest: "2026-02-24", nextReview: "2026-08-10", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2023", name: "WAF Configuration", domain: "Cloud Security", status: "planned", effectiveness: 25, lastTest: "2026-01-09", nextReview: "2026-09-01", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2024", name: "CCTV Coverage", domain: "Physical Security", status: "gap", effectiveness: 32, lastTest: "2026-04-22", nextReview: "2026-10-20", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2025", name: "RBAC Enforcement", domain: "Access Control", status: "implemented", effectiveness: 40, lastTest: "2026-03-07", nextReview: "2026-11-11", owner: "SOC", risk: "Low" },
      { id: "CTL-2026", name: "VPN Management", domain: "Network Security", status: "partial", effectiveness: 46, lastTest: "2026-02-20", nextReview: "2026-12-02", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2027", name: "App Whitelisting", domain: "Endpoint Protection", status: "planned", effectiveness: 2, lastTest: "2026-01-05", nextReview: "2026-05-21", owner: "IT Ops", risk: "High" },
      { id: "CTL-2028", name: "Key Management", domain: "Data Protection", status: "gap", effectiveness: 9, lastTest: "2026-04-18", nextReview: "2026-06-12", owner: "Data Gov", risk: "Critical" },
    ];
    const gapAnalysis = [
      { gap: "Insufficient MFA coverage for legacy apps", severity: "High", remediationPlan: "Plan R3001", eta: "2026-Q2", estimatedCost: "90k" },
      { gap: "Missing network micro-segmentation", severity: "Medium", remediationPlan: "Plan R3002", eta: "2026-Q4", estimatedCost: "119k" },
      { gap: "Inconsistent EDR deployment", severity: "Medium", remediationPlan: "Plan R3003", eta: "2026-Q3", estimatedCost: "148k" },
      { gap: "DLP not covering cloud storage", severity: "Low", remediationPlan: "Plan R3004", eta: "2026-Q2", estimatedCost: "177k" },
      { gap: "SSO not integrated with all SaaS", severity: "High", remediationPlan: "Plan R3005", eta: "2026-Q4", estimatedCost: "25k" },
    ];
    return html`
  ...
  private _renderIncidentCostTracker() {
    const incidents = [
      { id: "INC-7001", name: "Security Incident 1", severity: "Critical", totalCost: 917000, responseCost: 146720, recoveryCost: 192570, legalCost: 174230, regulatoryCost: 119210, insuranceClaim: 0, avoidedCost: 291000, date: "2026-03-23" },
      { id: "INC-7002", name: "Security Incident 2", severity: "High", totalCost: 920000, responseCost: 211600, recoveryCost: 294400, legalCost: 147200, regulatoryCost: 73600, insuranceClaim: 524400, avoidedCost: 320000, date: "2026-02-04" },
      { id: "INC-7003", name: "Security Incident 3", severity: "Medium", totalCost: 923000, responseCost: 276900, recoveryCost: 203060, legalCost: 119990, regulatoryCost: 129220, insuranceClaim: 0, avoidedCost: 349000, date: "2026-01-13" },
      { id: "INC-7004", name: "Security Incident 4", severity: "Low", totalCost: 926000, responseCost: 148160, recoveryCost: 305580, legalCost: 92600, regulatoryCost: 83340, insuranceClaim: 481520, avoidedCost: 378000, date: "2026-04-22" },
      { id: "INC-7005", name: "Security Incident 5", severity: "Critical", totalCost: 929000, responseCost: 213670, recoveryCost: 213670, legalCost: 65030, regulatoryCost: 139350, insuranceClaim: 0, avoidedCost: 407000, date: "2026-03-03" },
      { id: "INC-7006", name: "Security Incident 6", severity: "High", totalCost: 932000, responseCost: 279600, recoveryCost: 316880, legalCost: 186400, regulatoryCost: 93200, insuranceClaim: 438040, avoidedCost: 436000, date: "2026-02-12" },
      { id: "INC-7007", name: "Security Incident 7", severity: "Medium", totalCost: 935000, responseCost: 149600, recoveryCost: 224400, legalCost: 158950, regulatoryCost: 46750, insuranceClaim: 0, avoidedCost: 465000, date: "2026-01-21" },
      { id: "INC-7008", name: "Security Incident 8", severity: "Low", totalCost: 938000, responseCost: 215740, recoveryCost: 328300, legalCost: 131320, regulatoryCost: 103180, insuranceClaim: 393960, avoidedCost: 494000, date: "2026-04-02" },
      { id: "INC-7009", name: "Security Incident 9", severity: "Critical", totalCost: 941000, responseCost: 282300, recoveryCost: 235250, legalCost: 103510, regulatoryCost: 56460, insuranceClaim: 0, avoidedCost: 27000, date: "2026-03-11" },
      { id: "INC-7010", name: "Security Incident 10", severity: "High", totalCost: 944000, responseCost: 151040, recoveryCost: 339840, legalCost: 75520, regulatoryCost: 113280, insuranceClaim: 349280, avoidedCost: 56000, date: "2026-02-20" },
      { id: "INC-7011", name: "Security Incident 11", severity: "Medium", totalCost: 947000, responseCost: 217810, recoveryCost: 246220, legalCost: 47350, regulatoryCost: 66290, insuranceClaim: 0, avoidedCost: 85000, date: "2026-01-01" },
      { id: "INC-7012", name: "Security Incident 12", severity: "Low", totalCost: 950000, responseCost: 285000, recoveryCost: 351500, legalCost: 171000, regulatoryCost: 123500, insuranceClaim: 304000, avoidedCost: 114000, date: "2026-04-10" },
    ];
    const yearlyTrend = [
      { month: "Jan", incidents: 10, totalCost: "378k", avgCost: "185k", insured: 24 },
      { month: "Feb", incidents: 7, totalCost: "421k", avgCost: "51k", insured: 24 },
      { month: "Mar", incidents: 4, totalCost: "464k", avgCost: "98k", insured: 24 },
      { month: "Apr", incidents: 12, totalCost: "507k", avgCost: "145k", insured: 24 },
      { month: "May", incidents: 9, totalCost: "550k", avgCost: "192k", insured: 24 },
      { month: "Jun", incidents: 6, totalCost: "593k", avgCost: "58k", insured: 24 },
    ];
...
declare global { interface HTMLElementTagNameMap { 'sc-dependency-tree': ScDependencyTree; } }
