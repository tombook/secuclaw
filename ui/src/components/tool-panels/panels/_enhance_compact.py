#!/usr/bin/env python3
"""Add compact ~40 line enhancement to panels at 1464 lines (need ~36 more to hit 1500)."""
...
# Find all files at exactly 1464 lines that need a boost to 1500+
count = 0
for fname in sorted(os.listdir(PANELS_DIR)):
    ...
    if 1460 <= lines < 1500:
        if count == 0:
            print("Enhancing 1464-line panels with compact addition:")
        enhance_file(filepath, COMPACT_ADDITION)
        count += 1
