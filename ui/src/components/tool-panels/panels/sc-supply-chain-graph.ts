...
export class ScSupplyChainGraph extends LitElement {
  ...
  private _data: MockItem[] = [
    {name:"Tier 1: CloudCorp (Cloud Infra)",status:"monitored",risk:"low",detail:"Risk: Low | SOC 2: Current | SBOM: Shared | Contract: 2028 | Last audit: 90d ago | Health: 98%"},
    {name:"Tier 1: FinPay (Payment)",status:"monitored",risk:"low",detail:"Risk: Low | PCI DSS: Level 1 | SBOM: N/A | Contract: 2027 | Last audit: 60d ago | Health: 99%"},
    {name:"Tier 2: DataSoft (Database)",status:"attention",risk:"medium",detail:"Risk: Medium | SOC 2: Expired | SBOM: Partial | Contract: Q3 renewal | Audit overdue: 30d"},
    {name:"Tier 3: OpenLib Contributors",status:"monitoring",risk:"high",detail:"Risk: High | No formal audit | SBOM: Auto-generated | 342 dependencies | 12 with known vulns"},
    {name:"Risk Path: DataSoft -> Core DB",status:"mapped",risk:"critical",detail:"Single point of failure. If DataSoft compromised: Direct access to production data."}
  ];
  ...
  render() {
    ...
    return html`<div class="panel"><div class="pt">Supply Chain Graph</div>
