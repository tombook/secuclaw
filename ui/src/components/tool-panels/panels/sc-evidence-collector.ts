/**
 * sc-evidence-collector - Evidence Collector
...
@customElement('sc-evidence-collector')
export class ScEvidenceCollector extends LitElement {
  static styles = css`
...
@state() private _tablePage = 1;
  ...
  @state() private _comments: CommentEntry[] = [
    { id: 'c1', author: 'soc-tier1', timestamp: '2026-04-23 04:00', text: 'Initial assessment started for Evidence Collector finding #1' },
  ...
  private _items: PanelItem[] = [
      {
            "id": "evidence-collector-1",
            "title": "SOC 2 CC6.1 - Logical Access",
            "severity": "high",
            "status": "open",
            "category": "Security",
            "source": "SIEM",
            "description": "Evidence: 12 artifacts | Status: Complete | Reviewer: Audit team | Last updated: 5d ago",
      ...
      {
            "id": "evidence-collector-2",
            "title": "ISO A.9 - Access Control",
            "severity": "medium",
            "status": "in-progress",
            "category": "Network",
            "source": "EDR",
            "description": "Evidence: 8/10 artifacts | Missing: Remote access logs | Reviewer: ISMS manager | Deadline: Apr 30",
      ...
      {
            "id": "evidence-collector-3",
            "title": "GDPR Art.30 - Records of Processing",
            "severity": "low",
            "status": "resolved",
            "category": "Access",
            "source": "Scanner",
            "description": "Evidence: Processing register | Status: Complete | DPO review: Done | Annual update: Scheduled",
      ...
      {
            "id": "evidence-collector-4",
            "title": "PCI Req 1 - Network Segmentation",
            "severity": "high",
            "status": "open",
            "category": "Compliance",
            "source": "Audit",
            "description": "Evidence: 0/5 artifacts | Status: Not started | Reviewer: QSA | Deadline: May 15 | Priority: HIGH",
      ...
      {
            "id": "evidence-collector-5",
            "title": "Evidence Collector Finding #5",
            "severity": "medium",
            "status": "open",
            "category": "Operations",
            "source": "Manual",
            "description": "Automated evidence collector assessment finding detected during routine scan of infrastructure component. Review and remediation recommended.",
      ...
      {
            "id": "evidence-collector-6",
            "title": "Evidence Collector Finding #6",
            "severity": "high",
            "status": "open",
            "category": "Security",
            "source": "SIEM",
      ...
      {
            "id": "evidence-collector-7",
            "title": "Evidence Collector Finding #7",
            "severity": "low",
            "status": "open",
            "category": "Network",
            "source": "EDR",
      ...
      {
            "id": "evidence-collector-8",
            "title": "Evidence Collector Finding #8",
            "severity": "medium",
            "status": "open",
            "category": "Access",
            "source": "Scanner",
      ...
      {
            "id": "evidence-collector-9",
            "title": "Evidence Collector Finding #9",
            "severity": "high",
            "status": "open",
            "category": "Compliance",
            "source": "Audit",
      ...
      {
            "id": "evidence-collector-10",
            "title": "Evidence Collector Finding #10",
            "severity": "low",
            "status": "open",
            "category": "Operations",
            "source": "Manual",
  ...
  private _history: HistoryEntry[] = [
    { timestamp: '2026-04-23 04:15', action: 'Auto-correlated', user: 'system', details: 'Grouped related findings from Evidence Collector analysis' },
    { timestamp: '2026-04-23 03:00', action: 'Created', user: 'scanner', details: 'New Evidence Collector finding detected by automated assessment' },
    ...
    { timestamp: '2026-04-22 22:00', action: 'Resolved', user: 'security-eng', details: 'Remediation applied and verified for Evidence Collector finding' },
    { timestamp: '2026-04-22 18:00', action: 'Created', user: 'audit', details: 'Compliance audit identified Evidence Collector gap requiring remediation' },
    ...
    { timestamp: '2026-04-21 16:00', action: 'Resolved', user: 'soc-tier1', details: 'False positive confirmed - benign activity flagged by Evidence Collector scan' },
    { timestamp: '2026-04-21 12:00', action: 'Exported', user: 'compliance', details: 'Exported Evidence Collector findings for Q1 compliance report' },
  ];
...
private _workflowTasks: WorkflowTask[] = [
    { id: 'wt-1', title: 'Review Evidence Collector finding #1', status: 'active', assignee: 'soc-tier1', blockedBy: [], slaDeadline: '2026-04-23T12:00:00Z', priority: 'p1', createdAt: '2026-04-23T00:00:00Z', completedAt: null },
    ...
    { id: 'wt-3', title: 'Update Evidence Collector detection rules', status: 'blocked', assignee: 'soc-tier2', blockedBy: ['wt-2'], slaDeadline: '2026-04-24T00:00:00Z', priority: 'p2', createdAt: '2026-04-23T03:00:00Z', completedAt: null },
    ...
    { id: 'wt-8', title: 'Archive resolved Evidence Collector findings', status: 'failed', assignee: 'soc-tier1', blockedBy: [], slaDeadline: '2026-04-23T08:00:00Z', priority: 'p4', createdAt: '2026-04-22T22:00:00Z', completedAt: null },
  ];

private _executionHistory: ExecutionRecord[] = [
    {
      id: 'exec-1', name: 'Evidence Collector Full Assessment Run', startedAt: '2026-04-22T10:00:00Z', completedAt: '2026-04-22T10:12:00Z', status: 'success',
      steps: [
    ...
    {
      id: 'exec-2', name: 'Evidence Collector Delta Scan', startedAt: '2026-04-23T02:00:00Z', completedAt: '2026-04-23T02:05:00Z', status: 'failed',
      steps: [
  ...
  private _runExecution() {
    ...
    const exec: ExecutionRecord = {
      id: 'exec-' + Date.now(), name: 'Evidence Collector Assessment ' + new Date().toISOString().slice(0, 10), startedAt: new Date().toISOString(), completedAt: null, status: 'running', steps,
    };
  ...
  private _renderExecutionPanel(): unknown {
    ...
    return html`
      <div class="form-section">
        ...
        ` : html`<div class="empty-state">Click "Run Assessment" to start the Evidence Collector analysis pipeline</div>`}
      </div>
      <div class="form-section">
        ...
        <div class="settings-card">
          ...
          <div style="display:flex;gap:8px;margin-top:4px;">
            <button class="btn primary" @click=${() => {
              ...
              const a = document.createElement('a'); a.href = url; a.download = 'evidence-collector-config.json'; a.click();
    ...
    return html`
      <div style="margin-top:12px;">
        ...
        <div style="display:flex;gap:6px;margin-top:8px;">
          <input class="search-box" type="text" placeholder="Add a comment..." style="min-width:auto;flex:1;" id="evidence-collector-comment-input" />
          <button class="btn primary" @click=${() => {
            const input = this.shadowRoot?.querySelector('#evidence-collector-comment-input') as HTMLInputElement;
  ...
  private _exportJSON() {
    ...
    const url = URL.createObjectURL(blob);
    const a = document.createElement('a'); a.href = url; a.download = 'sc-evidence-collector-data.json'; a.click();
    URL.revokeObjectURL(url);
  }
  ...
  private _exportCSV() {
    ...
    const url = URL.createObjectURL(blob);
    const a = document.createElement('a'); a.href = url; a.download = 'sc-evidence-collector-data.csv'; a.click();
    URL.revokeObjectURL(url);
  }


  // --- Domain Rules Engine ---
  @state() private _evcRules: { id: string; name: string; category: string; severity: Severity; enabled: boolean; lastEval: string; passRate: number }[] = [];
  private _initEvcRules() {
    const rules = [
    ...
    this._evcRules = rules;
  }
  private _evaluateEvcRules(): { passed: number; failed: number; skipped: number; total: number } {
    let passed = 0, failed = 0, skipped = 0;
    this._evcRules.forEach(r => { if (!r.enabled) { skipped++; } else if (r.passRate >= 80) { passed++; } else { failed++; } });
    return { passed, failed, skipped, total: this._evcRules.length };
  }

  // --- CVSS Scoring ---
  @state() private _evccvssData: { itemId: string; vector: string; base: number; temporal: number; environmental: number; overall: number }[] = [];
  private _initEvcCvss() {
    ...
    this._evccvssData = vectors.map((v, i) => {
  ...
  // --- Anomaly Detection ---
  @state() private _evcanomalies: { id: string; type: string; severity: Severity; description: string; detected: string; confidence: number; affected: string[] }[] = [];
  private _runEvcAnomalyDetection() {
    const types = [
    ...
    this._evcanomalies = types.map((a, i) => ({
  ...
  // --- Trend Prediction ---
  @state() private _evcpredictions: { horizon: string; metric: string; current: number; predicted: number; direction: 'up' | 'down' | 'stable'; confidence: number }[] = [];
  private _generateEvcPredictions() {
    this._evcpredictions = [
  ...
  // --- Approval Workflow ---
  @state() private _evcApprovals: { id: string; title: string; requester: string; status: 'pending' | 'approved' | 'rejected' | 'expired'; createdAt: string; priority: Priority; type: string }[] = [];
  private _initEvcApprovals() {
    this._evcApprovals = [
  ...
  private _approveEvcItem(id: string) { const item = this._evcApprovals.find(a => a.id === id); if (item) item.status = 'approved'; this.requestUpdate(); }
  private _rejectEvcItem(id: string) { const item = this._evcApprovals.find(a => a.id === id); if (item) item.status = 'rejected'; this.requestUpdate(); }

  // --- Activity Feed ---
  @state() private _evcActivity: { id: string; action: string; user: string; target: string; timestamp: string }[] = [];
  private _initEvcActivity() {
    const actions = [
    ...
    this._evcActivity = actions.map((a, i) => ({ id: 'ACT-' + String(i + 1).padStart(3, '0'), ...a, timestamp: new Date(Date.now() - i * 3600000).toISOString() }));
  }

  // --- Notification System ---
  @state() private _evcNotifications: { id: string; message: string; type: 'info' | 'warning' | 'error' | 'success'; read: boolean; timestamp: string }[] = [];
  private _initEvcNotifications() {
    this._evcNotifications = [
  ...
  private _markEvcNotifRead(id: string) { const n = this._evcNotifications.find(x => x.id === id); if (n) n.read = true; this.requestUpdate(); }

  // --- Panel Configuration ---
  @state() private _evcConfig: { layout: 'compact' | 'default' | 'expanded'; theme: 'dark' | 'midnight' | 'slate'; showAnomalies: boolean; showPredictions: boolean; autoRefresh: boolean; refreshInterval: number } = {
    layout: 'default', theme: 'dark', showAnomalies: true, showPredictions: true, autoRefresh: true, refreshInterval: 60,
  };
  private _evcPresets: { name: string; config: typeof this._evcConfig }[] = [
  ...
  private _applyEvcPreset(preset: typeof this._evcPresets[0]) { this._evcConfig = { ...preset.config }; this.requestUpdate(); }

  private _renderEvcTreemapSVG(): string {
    const categories = [
  ...
  private _renderEvcSankeySVG(): string {
  ...
  // --- Render: Rules Engine ---
  private _renderEvcRules(): any {
    const ev = this._evaluateEvcRules();
    return html`
  ...
  private _renderEvcAnomalies(): any {
  ...
  // --- Render: Approvals ---
  private _renderEvcApprovals(): any {
          ...
          $${this._evcApprovals.map(a => html`
            <div style="padding:6px 8px;background:#1f2937;border-radius:4px">
              ...
              $${a.status === 'pending' ? html`
                <div style="display:flex;gap:4px;margin-top:4px">
                  <button class="btn success" style="padding:2px 8px;font-size:9px" @click=$${() => this._approveEvcItem(a.id)}>Approve</button>
                  <button class="btn error" style="padding:2px 8px;font-size:9px" @click=$${() => this._rejectEvcItem(a.id)}>Reject</button>
                </div>` : nothing}
            </div>`)}
        </div>
      </div>`;
  ...
  private _renderEvcNotifications(): any {
    const tc = (t: string) => t === 'error' ? '#ef4444' : t === 'warning' ? '#eab308' : t === 'success' ? '#22c55e' : '#3b82f6';
    const unread = this._evcNotifications.filter(n => !n.read).length;
    return html`
      <div style="background:#1a1d27;border-radius:8px;padding:12px;margin-top:12px">
        ...
        <div style="display:flex;flex-direction:column;gap:4px;max-height:120px;overflow-y:auto">
          $${this._evcNotifications.map(n => html`
            <div style="display:flex;align-items:center;gap:8px;padding:4px 8px;background:$${n.read ? '#1f2937' : '#252a36'};border-radius:4px;font-size:10px;opacity:$${n.read ? '0.6' : '1'};cursor:pointer" @click=$${() => this._markEvcNotifRead(n.id)}>
      ...
      <div style="background:#1a1d27;border-radius:8px;padding:12px;margin-top:12px">
        ...
        <div style="display:flex;flex-direction:column;gap:6px;font-size:10px">
          <div style="display:flex;align-items:center;gap:8px">
            ...
            <select class="form-input" style="flex:1" @change=$${(e: Event) => { this._evcConfig.layout = (e.target as HTMLSelectElement).value as any; this.requestUpdate(); }}>
              <option value="compact" ?selected=$${this._evcConfig.layout === 'compact'}>Compact</option>
              <option value="default" ?selected=$${this._evcConfig.layout === 'default'}>Default</option>
              <option value="expanded" ?selected=$${this._evcConfig.layout === 'expanded'}>Expanded</option>
            </select>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Theme</span>
            <select class="form-input" style="flex:1" @change=$${(e: Event) => { this._evcConfig.theme = (e.target as HTMLSelectElement).value as any; this.requestUpdate(); }}>
              <option value="dark" ?selected=$${this._evcConfig.theme === 'dark'}>Dark</option>
              <option value="midnight" ?selected=$${this._evcConfig.theme === 'midnight'}>Midnight</option>
              <option value="slate" ?selected=$${this._evcConfig.theme === 'slate'}>Slate</option>
            </select>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Auto Refresh</span>
            <input type="checkbox" ?checked=$${this._evcConfig.autoRefresh} @change=$${() => { this._evcConfig.autoRefresh = !this._evcConfig.autoRefresh; this.requestUpdate(); }}/>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Show Anomalies</span>
            <input type="checkbox" ?checked=$${this._evcConfig.showAnomalies} @change=$${() => { this._evcConfig.showAnomalies = !this._evcConfig.showAnomalies; this.requestUpdate(); }}/>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Show Predictions</span>
            <input type="checkbox" ?checked=$${this._evcConfig.showPredictions} @change=$${() => { this._evcConfig.showPredictions = !this._evcConfig.showPredictions; this.requestUpdate(); }}/>
          </div>
          <div style="margin-top:6px;font-weight:600">Presets</div>
          <div style="display:flex;gap:4px">
            $${this._evcPresets.map(ps => html`<button class="btn" style="padding:2px 8px;font-size:9px" @click=$${() => this._applyEvcPreset(ps)}>$${ps.name}</button>`)}
          </div>
        </div>
      </div>`;
  }
...
@state() private _spmComplianceCheck6 = { id: "CHK-006", control: "Control 6", framework: "NIST 800-53", status: "pass", evidenceCount: 4, lastAudit: "2026-01-11", nextAudit: "2026-04-11", findings: 2 } as any;
  ...
  @state() private _evidenceCollRiskTopTen: Array<{id:string;name:string;score:number;trend:string;owner:string;category:string;lastAssessed:string}> = [
  ...
  @state() private _evidenceCollRiskCategories: Array<{category:string;count:number;avgScore:number;color:string}> = [
  ...
  @state() private _evidenceCollRiskVelocity: Array<{week:string;newRisks:number;closedRisks:number;netChange:number}> = [
  ...
  @state() private _evidenceCollRiskAppetite: {current:number;threshold:number;maxTolerated:number;status:string} = {
    current: 68, threshold: 55, maxTolerated: 80, status: 'Warning'
  };
  @state() private _evidenceCollRiskOwnerMatrix: Array<{owner:string;criticalCount:number;highCount:number;mediumCount:number;complianceRate:number}> = [
  ...
  private _renderEvidencecollRiskDash(): TemplateResult {
    const riskItems = this._evidenceCollRiskTopTen;
    const velocity = this._evidenceCollRiskVelocity;
    const appetite = this._evidenceCollRiskAppetite;
    return html`
  ...
  @state() private _evidenceCollCorrRules: Array<{id:string;name:string;sources:string[];logic:string;severity:string;active:boolean;lastTriggered:string}> = [
  ...
  @state() private _evidenceCollEventTimeline: Array<{timestamp:string;source:string;eventType:string;details:string;correlated:boolean}> = [
  ...
  @state() private _evidenceCollFalsePosMetrics: {totalEvents:number;correlatedEvents:number;falsePositives:number;fpRate:number;topFpRules:string[]} = {
  ...
  @state() private _evidenceCollEventPatterns: Array<{id:string;pattern:string;frequency:number;firstSeen:string;lastSeen:string;status:string}> = [
  ...
  private _renderEvidencecollEventCorr(): TemplateResult {
    const rules = this._evidenceCollCorrRules;
    const timeline = this._evidenceCollEventTimeline;
    const fpMetrics = this._evidenceCollFalsePosMetrics;
    return html`
  ...
  @state() private _evidenceCollCourses: Array<{id:string;title:string;category:string;duration:number;enrolled:number;completed:number;difficulty:string;rating:number}> = [
  ...
  @state() private _evidenceCollLearningPaths: Array<{id:string;name:string;courseIds:string[];progress:number;enrolled:number}> = [
  ...
  @state() private _evidenceCollDeptCompliance: Array<{dept:string;trainedPct:number;targetPct:number;avgScore:number;certCount:number}> = [
  ...
  @state() private _evidenceCollSkillsGaps: Array<{skill:string;current:number;required:number;gap:number;priority:string}> = [
  ...
  private _renderEvidencecollTraining(): TemplateResult {
    const courses = this._evidenceCollCourses;
    const deptComp = this._evidenceCollDeptCompliance;
    return html`
  ...
  @state() private _evidenceCollZones: Array<{id:string;name:string;trustLevel:number;subnet:string;devices:number;policy:string;lastAudit:string}> = [
  ...
  @state() private _evidenceCollSegRules: Array<{id:string;source:string;dest:string;action:string;protocol:string;port:string;status:string;hits:number}> = [
  ...
  @state() private _evidenceCollCrossZoneTraffic: Array<{source:string;dest:string;bytes:number;sessions:number;violations:number}> = [
  ...
  @state() private _evidenceCollMicroSegGaps: Array<{id:string;zone:string;gapType:string;severity:string;recommendation:string}> = [
  ...
  private _renderEvidencecollNetworkSeg(): TemplateResult {
    const zones = this._evidenceCollZones;
    const gaps = this._evidenceCollMicroSegGaps;
    return html`
  ...
  @state() private _complianceCalendarEvents: Array<{id: string; title: string; deadline: string; category: string; status: string; assignee: string; notes: string}> = [
    {id: 'cc-evidence-collector-001', title: 'SOX Section 404 Compliance Review', deadline: '2026-06-30', category: 'Regulatory', status: 'In Progress', assignee: 'Compliance Team', notes: 'Annual internal control assessment for financial reporting'},
    {id: 'cc-evidence-collector-002', title: 'GDPR Data Protection Impact Assessment', deadline: '2026-05-15', category: 'Privacy', status: 'Pending', assignee: 'DPO Office', notes: 'Quarterly DPIA for high-risk processing activities'},
    {id: 'cc-evidence-collector-003', title: 'ISO 27001 Surveillance Audit', deadline: '2026-07-20', category: 'Certification', status: 'Scheduled', assignee: 'QA Lead', notes: 'Stage 2 surveillance audit for ISMS certification renewal'},
    {id: 'cc-evidence-collector-004', title: 'PCI DSS v4.0 Gap Analysis', deadline: '2026-05-30', category: 'Payment', status: 'Not Started', assignee: 'Security Architect', notes: 'Assess current state against PCI DSS v4.0 requirements'},
    {id: 'cc-evidence-collector-005', title: 'NIST CSF Self-Assessment', deadline: '2026-08-15', category: 'Framework', status: 'Pending', assignee: 'CISO', notes: 'Biannual self-assessment against NIST Cybersecurity Framework'},
    {id: 'cc-evidence-collector-006', title: 'HIPAA Security Rule Audit', deadline: '2026-06-15', category: 'Healthcare', status: 'In Progress', assignee: 'Compliance Analyst', notes: 'Annual audit of administrative, physical, and technical safeguards'},
    {id: 'cc-evidence-collector-007', title: 'SOC 2 Type II Report Renewal', deadline: '2026-09-30', category: 'Audit', status: 'Scheduled', assignee: 'External Auditor', notes: 'Engage auditor for SOC 2 Type II examination period'},
    {id: 'cc-evidence-collector-008', title: 'FedRAMP Authorization Review', deadline: '2026-07-01', category: 'Government', status: 'Pending', assignee: 'FedRAMP PMO', notes: 'Review and update security authorization package'},
    {id: 'cc-evidence-collector-009', title: 'Annual Penetration Test', deadline: '2026-10-15', category: 'Testing', status: 'Not Started', assignee: 'Red Team Lead', notes: 'Comprehensive external and internal penetration testing engagement'},
    {id: 'cc-evidence-collector-010', title: 'Security Awareness Training Rollout', deadline: '2026-05-01', category: 'Training', status: 'Completed', assignee: 'Security Awareness Manager', notes: 'Q2 organization-wide security awareness training program'},
    {id: 'cc-evidence-collector-011', title: 'Vendor Security Review Cycle', deadline: '2026-06-01', category: 'Third Party', status: 'In Progress', assignee: 'Vendor Manager', notes: 'Quarterly review of critical vendor security posture and SLA compliance'},
    {id: 'cc-evidence-collector-012', title: 'Incident Response Plan Update', deadline: '2026-05-20', category: 'Operations', status: 'Pending', assignee: 'IR Team Lead', notes: 'Update IR procedures based on lessons learned from recent incidents'},
  ];
  ...
  @state() private _dataQualityMetrics: Array<{id: string; dataSource: string; completenessScore: number; accuracyScore: number; timelinessScore: number; consistencyScore: number; reliabilityRank: number; lastUpdated: string; issues: string[]; trend: string}> = [
    {id: 'dq-evidence-collector-001', dataSource: 'Vulnerability Scanner Feed', completenessScore: 94, accuracyScore: 91, timelinessScore: 88, consistencyScore: 95, reliabilityRank: 1, lastUpdated: '2026-04-23T08:00:00Z', issues: ['Minor delay in Nessus plugin updates'], trend: 'improving'},
    {id: 'dq-evidence-collector-002', dataSource: 'SIEM Event Logs', completenessScore: 87, accuracyScore: 93, timelinessScore: 96, consistencyScore: 89, reliabilityRank: 2, lastUpdated: '2026-04-23T07:30:00Z', issues: ['Some log sources showing gaps in off-hours'], trend: 'stable'},
    {id: 'dq-evidence-collector-003', dataSource: 'Asset Inventory Database', completenessScore: 82, accuracyScore: 78, timelinessScore: 75, consistencyScore: 84, reliabilityRank: 4, lastUpdated: '2026-04-22T18:00:00Z', issues: ['Shadow IT devices not fully cataloged', 'Decommissioned assets still listed'], trend: 'declining'},
    {id: 'dq-evidence-collector-004', dataSource: 'Threat Intelligence Platform', completenessScore: 91, accuracyScore: 89, timelinessScore: 92, consistencyScore: 87, reliabilityRank: 3, lastUpdated: '2026-04-23T06:00:00Z', issues: ['Some IOC sources lack confidence scoring'], trend: 'improving'},
    {id: 'dq-evidence-collector-005', dataSource: 'Identity Provider Logs', completenessScore: 96, accuracyScore: 97, timelinessScore: 98, consistencyScore: 96, reliabilityRank: 1, lastUpdated: '2026-04-23T09:00:00Z', issues: [], trend: 'stable'},
    {id: 'dq-evidence-collector-006', dataSource: 'Cloud Security Posture Data', completenessScore: 79, accuracyScore: 85, timelinessScore: 82, consistencyScore: 81, reliabilityRank: 5, lastUpdated: '2026-04-23T05:00:00Z', issues: ['Multi-cloud coverage gaps', 'API rate limiting affects scan frequency'], trend: 'declining'},
    {id: 'dq-evidence-collector-007', dataSource: 'Compliance Evidence Store', completenessScore: 88, accuracyScore: 86, timelinessScore: 80, consistencyScore: 83, reliabilityRank: 4, lastUpdated: '2026-04-21T14:00:00Z', issues: ['Manual evidence collection delays', 'Inconsistent formatting across frameworks'], trend: 'stable'},
    {id: 'dq-evidence-collector-008', dataSource: 'Network Flow Data', completenessScore: 92, accuracyScore: 90, timelinessScore: 94, consistencyScore: 91, reliabilityRank: 2, lastUpdated: '2026-04-23T08:30:00Z', issues: ['Encrypted traffic classification accuracy needs improvement'], trend: 'improving'},
  ];
  ...
  @state() private _workflowTemplates: Array<{id: string; name: string; description: string; category: string; steps: number; avgDuration: string; successRate: number; lastRun: string; manualInterventions: number; optimizationScore: number}> = [
    {id: 'wf-evidence-collector-001', name: 'Vulnerability Triage Pipeline', description: 'Automated vulnerability assessment, prioritization, and assignment workflow', category: 'Vulnerability Management', steps: 8, avgDuration: '12 min', successRate: 94.5, lastRun: '2026-04-23T06:00:00Z', manualInterventions: 2, optimizationScore: 87},
    {id: 'wf-evidence-collector-002', name: 'Incident Response Orchestration', description: 'End-to-end IR workflow from detection to containment and recovery', category: 'Incident Response', steps: 15, avgDuration: '45 min', successRate: 89.2, lastRun: '2026-04-22T14:30:00Z', manualInterventions: 5, optimizationScore: 72},
    {id: 'wf-evidence-collector-003', name: 'Access Request Approval Chain', description: 'Multi-level approval workflow for privileged access requests', category: 'Identity & Access', steps: 6, avgDuration: '4 hours', successRate: 97.1, lastRun: '2026-04-23T09:15:00Z', manualInterventions: 1, optimizationScore: 92},
    {id: 'wf-evidence-collector-004', name: 'Compliance Evidence Collection', description: 'Automated gathering and packaging of audit evidence artifacts', category: 'Compliance', steps: 10, avgDuration: '30 min', successRate: 91.8, lastRun: '2026-04-21T10:00:00Z', manualInterventions: 3, optimizationScore: 78},
    {id: 'wf-evidence-collector-005', name: 'Security Patch Deployment', description: 'Staged patch rollout with validation and rollback capability', category: 'Patch Management', steps: 12, avgDuration: '2 hours', successRate: 96.3, lastRun: '2026-04-20T22:00:00Z', manualInterventions: 1, optimizationScore: 85},
    {id: 'wf-evidence-collector-006', name: 'Threat Intelligence Enrichment', description: 'IOC enrichment and correlation with internal threat data', category: 'Threat Intelligence', steps: 7, avgDuration: '8 min', successRate: 93.7, lastRun: '2026-04-23T07:00:00Z', manualInterventions: 0, optimizationScore: 95},
    {id: 'wf-evidence-collector-007', name: 'Security Reporting Pipeline', description: 'Automated generation and distribution of security metrics reports', category: 'Reporting', steps: 5, avgDuration: '15 min', successRate: 98.9, lastRun: '2026-04-23T08:00:00Z', manualInterventions: 0, optimizationScore: 97},
    {id: 'wf-evidence-collector-008', name: 'Vendor Risk Assessment', description: 'Automated vendor security questionnaire distribution and scoring', category: 'Third Party', steps: 9, avgDuration: '3 days', successRate: 85.4, lastRun: '2026-04-19T11:00:00Z', manualInterventions: 4, optimizationScore: 65},
  ];
  ...
  @state() private _workflowExecutionHistory: Array<{workflowId: string; runDate: string; duration: string; status: string; trigger: string}> = [
    {workflowId: 'wf-evidence-collector-001', runDate: '2026-04-23T06:00:00Z', duration: '11 min 23 sec', status: 'Success', trigger: 'Scheduled'},
    {workflowId: 'wf-evidence-collector-002', runDate: '2026-04-22T14:30:00Z', duration: '42 min 15 sec', status: 'Success', trigger: 'Alert'},
    {workflowId: 'wf-evidence-collector-003', runDate: '2026-04-23T09:15:00Z', duration: '3h 45 min', status: 'Success', trigger: 'User Request'},
    {workflowId: 'wf-evidence-collector-001', runDate: '2026-04-22T06:00:00Z', duration: '13 min 08 sec', status: 'Partial', trigger: 'Scheduled'},
    {workflowId: 'wf-evidence-collector-004', runDate: '2026-04-21T10:00:00Z', duration: '28 min 42 sec', status: 'Success', trigger: 'Scheduled'},
  ];
  ...
  @state() private _knowledgeArticles: Array<{id: string; title: string; category: string; author: string; publishDate: string; views: number; rating: number; tags: string[]; summary: string; readTime: string}> = [
    {id: 'kb-evidence-collector-001', title: 'Zero Trust Architecture Implementation Guide', category: 'Architecture', author: 'Security Architecture Team', publishDate: '2026-03-15', views: 1842, rating: 4.8, tags: ['zero-trust', 'network', 'identity'], summary: 'Comprehensive guide for implementing zero trust principles across enterprise infrastructure', readTime: '15 min'},
    {id: 'kb-evidence-collector-002', title: 'Ransomware Defense Playbook 2026', category: 'Threats', author: 'Threat Intelligence Team', publishDate: '2026-04-01', views: 2341, rating: 4.9, tags: ['ransomware', 'incident-response', 'defense'], summary: 'Updated playbook with latest ransomware tactics, techniques, and defensive measures', readTime: '12 min'},
    {id: 'kb-evidence-collector-003', title: 'Cloud Security Best Practices for Multi-Cloud', category: 'Cloud', author: 'Cloud Security Team', publishDate: '2026-02-28', views: 1567, rating: 4.5, tags: ['cloud', 'aws', 'azure', 'gcp'], summary: 'Best practices for securing workloads across multiple cloud service providers', readTime: '18 min'},
    {id: 'kb-evidence-collector-004', title: 'API Security Testing Methodology', category: 'Testing', author: 'Red Team', publishDate: '2026-03-22', views: 987, rating: 4.6, tags: ['api', 'testing', 'owasp'], summary: 'Structured methodology for identifying and testing API security vulnerabilities', readTime: '10 min'},
    {id: 'kb-evidence-collector-005', title: 'Supply Chain Security Risk Management', category: 'Third Party', author: 'GRC Team', publishDate: '2026-01-20', views: 1234, rating: 4.3, tags: ['supply-chain', 'vendor', 'risk'], summary: 'Framework for managing security risks in the software supply chain', readTime: '14 min'},
    {id: 'kb-evidence-collector-006', title: 'Kubernetes Security Hardening Checklist', category: 'Container', author: 'Platform Security', publishDate: '2026-04-10', views: 2103, rating: 4.7, tags: ['kubernetes', 'container', 'hardening'], summary: 'Step-by-step hardening checklist for production Kubernetes clusters', readTime: '11 min'},
    {id: 'kb-evidence-collector-007', title: 'Security Metrics That Matter for Executives', category: 'Metrics', author: 'CISO Office', publishDate: '2026-03-05', views: 876, rating: 4.4, tags: ['metrics', 'kpi', 'reporting'], summary: 'Key security metrics and KPIs that resonate with board-level stakeholders', readTime: '8 min'},
    {id: 'kb-evidence-collector-008', title: 'Phishing Simulation Campaign Design', category: 'Awareness', author: 'Security Awareness Team', publishDate: '2026-02-15', views: 1456, rating: 4.5, tags: ['phishing', 'simulation', 'training'], summary: 'Designing effective phishing simulations that drive real behavioral change', readTime: '9 min'},
    {id: 'kb-evidence-collector-009', title: 'Data Loss Prevention Strategy and Implementation', category: 'Data Protection', author: 'Data Security Team', publishDate: '2026-03-28', views: 1678, rating: 4.6, tags: ['dlp', 'data-protection', 'compliance'], summary: 'Strategic approach to DLP covering people, process, and technology layers', readTime: '16 min'},
    {id: 'kb-evidence-collector-010', title: 'Security Automation with SOAR Platforms', category: 'Automation', author: 'SOC Engineering', publishDate: '2026-04-05', views: 1098, rating: 4.7, tags: ['soar', 'automation', 'soc'], summary: 'Building effective security automation playbooks using SOAR technology', readTime: '13 min'},
    {id: 'kb-evidence-collector-011', title: 'Third-Party Risk Assessment Framework', category: 'GRC', author: 'Vendor Management', publishDate: '2026-01-30', views: 1345, rating: 4.4, tags: ['vendor', 'risk', 'assessment'], summary: 'Structured framework for evaluating and monitoring third-party security risks', readTime: '12 min'},
    {id: 'kb-evidence-collector-012', title: 'Network Detection and Response Best Practices', category: 'Network', author: 'Network Security Team', publishDate: '2026-03-18', views: 1567, rating: 4.5, tags: ['ndr', 'network', 'detection'], summary: 'Implementing effective network detection and response capabilities', readTime: '14 min'},
    {id: 'kb-evidence-collector-013', title: 'Security Chaos Engineering Guide', category: 'Resilience', author: 'SRE Security', publishDate: '2026-04-12', views: 789, rating: 4.3, tags: ['chaos-engineering', 'resilience', 'testing'], summary: 'Applying chaos engineering principles to validate security controls', readTime: '10 min'},
    {id: 'kb-evidence-collector-014', title: 'Incident Communication Templates', category: 'Incident Response', author: 'IR Team', publishDate: '2026-02-22', views: 2234, rating: 4.8, tags: ['incident', 'communication', 'templates'], summary: 'Ready-to-use communication templates for security incident scenarios', readTime: '7 min'},
    {id: 'kb-evidence-collector-015', title: 'Endpoint Detection and Response Configuration', category: 'Endpoint', author: 'Endpoint Security', publishDate: '2026-03-08', views: 1345, rating: 4.5, tags: ['edr', 'endpoint', 'configuration'], summary: 'Optimal EDR configuration for maximum detection with minimal false positives', readTime: '11 min'},
    {id: 'kb-evidence-collector-016', title: 'Security Code Review Standards', category: 'Development', author: 'AppSec Team', publishDate: '2026-02-10', views: 1890, rating: 4.6, tags: ['code-review', 'secure-sdlc', 'standards'], summary: 'Standards and checklists for security-focused code reviews', readTime: '13 min'},
    {id: 'kb-evidence-collector-017', title: 'IoT Security Assessment Methodology', category: 'IoT', author: 'IoT Security Lab', publishDate: '2026-04-08', views: 654, rating: 4.2, tags: ['iot', 'embedded', 'assessment'], summary: 'Methodology for assessing security posture of IoT devices and ecosystems', readTime: '15 min'},
    {id: 'kb-evidence-collector-018', title: 'Passwordless Authentication Migration Guide', category: 'Identity', author: 'IAM Team', publishDate: '2026-03-25', views: 1678, rating: 4.7, tags: ['passwordless', 'authentication', 'mfa'], summary: 'Step-by-step migration plan from password-based to passwordless authentication', readTime: '12 min'},
    {id: 'kb-evidence-collector-019', title: 'Security Awareness Program Metrics', category: 'Awareness', author: 'Security Culture Team', publishDate: '2026-01-25', views: 1123, rating: 4.4, tags: ['awareness', 'metrics', 'culture'], summary: 'Measuring the effectiveness of your security awareness and training programs', readTime: '9 min'},
    {id: 'kb-evidence-collector-020', title: 'Deception Technology Deployment Guide', category: 'Detection', author: 'Blue Team', publishDate: '2026-04-15', views: 876, rating: 4.5, tags: ['deception', 'honeypot', 'detection'], summary: 'Planning and deploying deception technology for advanced threat detection', readTime: '11 min'},
  ];
  ...
  // --- Security Scenario Planning Methods (EVCO) ---
  private _initEvcoScenarios(): void {
    const worstCaseScenarios = [
      { id: "evco-sc-01", name: "Ransomware Attack on Critical Infrastructure", category: "Malware", impact: 9500000, probability: 0.12, recoveryDays: 21, affectedSystems: 47, dataLossGb: 320, businessImpact: "critical" },
      { id: "evco-sc-02", name: "Insider Data Exfiltration via Authorized Channels", category: "Insider Threat", impact: 7200000, probability: 0.18, recoveryDays: 14, affectedSystems: 12, dataLossGb: 85, businessImpact: "high" },
      { id: "evco-sc-03", name: "Supply Chain Compromise via Third-Party Library", category: "Supply Chain", impact: 6800000, probability: 0.09, recoveryDays: 30, affectedSystems: 63, dataLossGb: 0, businessImpact: "critical" },
      { id: "evco-sc-04", name: "Cloud Misconfiguration Leading to Public Exposure", category: "Cloud", impact: 4100000, probability: 0.22, recoveryDays: 7, affectedSystems: 8, dataLossGb: 450, businessImpact: "high" },
      { id: "evco-sc-05", name: "Zero-Day Exploit in Core Application Framework", category: "Vulnerability", impact: 8900000, probability: 0.05, recoveryDays: 45, affectedSystems: 120, dataLossGb: 0, businessImpact: "critical" },
      { id: "evco-sc-06", name: "Distributed Denial of Service on Customer-Facing Services", category: "Availability", impact: 3400000, probability: 0.25, recoveryDays: 3, affectedSystems: 15, dataLossGb: 0, businessImpact: "medium" },
      { id: "evco-sc-07", name: "Credential Stuffing and Account Takeover Wave", category: "Identity", impact: 2800000, probability: 0.30, recoveryDays: 5, affectedSystems: 6, dataLossGb: 12, businessImpact: "medium" },
      { id: "evco-sc-08", name: "Physical Security Breach at Data Center Facility", category: "Physical", impact: 12000000, probability: 0.02, recoveryDays: 60, affectedSystems: 200, dataLossGb: 5000, businessImpact: "critical" },
    ];
    this._evcoScenarios = worstCaseScenarios.map(s => ({ ...s, mitigationCost: Math.round(s.impact * 0.08), drillScheduled: false, lastDrillDate: null, drillScore: null, controlGaps: Math.floor(Math.random() * 5) + 1 }));
  }

  private _calculateEvcoScenarioRisk(): void {
    this._evcoScenarios.forEach(s => {
  ...
  private _scheduleEvcoDrills(): void {
  ...
  private _evcoScenarioComparison(): Record<string, unknown>[] {
    return this._evcoScenarios.map(s => ({
  ...
  // --- Security Control Effectiveness Analytics (EVCO) ---
  private _initEvcoControls(): void {
    const controls = [
      { id: "evco-ct-01", name: "Network Segmentation", type: "preventive", maturity: "defined", score: 82, target: 90, failures: 3, lastTest: "2026-03-15" },
      { id: "evco-ct-02", name: "Endpoint Detection and Response", type: "detective", maturity: "managed", score: 88, target: 92, failures: 1, lastTest: "2026-04-01" },
      { id: "evco-ct-03", name: "Data Loss Prevention", type: "preventive", maturity: "repeatable", score: 71, target: 85, failures: 7, lastTest: "2026-03-22" },
      { id: "evco-ct-04", name: "Security Information and Event Management", type: "detective", maturity: "managed", score: 85, target: 90, failures: 2, lastTest: "2026-04-05" },
      { id: "evco-ct-05", name: "Identity and Access Management", type: "preventive", maturity: "defined", score: 76, target: 88, failures: 5, lastTest: "2026-03-28" },
      { id: "evco-ct-06", name: "Vulnerability Management", type: "corrective", maturity: "managed", score: 80, target: 90, failures: 4, lastTest: "2026-04-02" },
      { id: "evco-ct-07", name: "Email Security Gateway", type: "preventive", maturity: "managed", score: 90, target: 95, failures: 1, lastTest: "2026-04-08" },
      { id: "evco-ct-08", name: "Web Application Firewall", type: "preventive", maturity: "managed", score: 87, target: 92, failures: 2, lastTest: "2026-03-30" },
      { id: "evco-ct-09", name: "Patch Management", type: "corrective", maturity: "defined", score: 68, target: 85, failures: 9, lastTest: "2026-03-18" },
      { id: "evco-ct-10", name: "Encryption at Rest", type: "preventive", maturity: "managed", score: 93, target: 95, failures: 0, lastTest: "2026-04-10" },
      { id: "evco-ct-11", name: "Encryption in Transit", type: "preventive", maturity: "optimized", score: 96, target: 98, failures: 0, lastTest: "2026-04-12" },
      { id: "evco-ct-12", name: "Privileged Access Management", type: "preventive", maturity: "defined", score: 74, target: 88, failures: 6, lastTest: "2026-03-25" },
      { id: "evco-ct-13", name: "Security Awareness Training", type: "preventive", maturity: "repeatable", score: 65, target: 80, failures: 11, lastTest: "2026-03-20" },
      { id: "evco-ct-14", name: "Incident Response Plan", type: "corrective", maturity: "managed", score: 78, target: 88, failures: 4, lastTest: "2026-04-03" },
      { id: "evco-ct-15", name: "Backup and Recovery", type: "corrective", maturity: "managed", score: 84, target: 92, failures: 3, lastTest: "2026-04-06" },
      { id: "evco-ct-16", name: "Multi-Factor Authentication", type: "preventive", maturity: "managed", score: 91, target: 95, failures: 1, lastTest: "2026-04-09" },
      { id: "evco-ct-17", name: "Network Traffic Analysis", type: "detective", maturity: "defined", score: 72, target: 85, failures: 5, lastTest: "2026-03-27" },
      { id: "evco-ct-18", name: "Cloud Security Posture Management", type: "detective", maturity: "repeatable", score: 69, target: 82, failures: 8, lastTest: "2026-03-24" },
      { id: "evco-ct-19", name: "Container Security Scanning", type: "preventive", maturity: "defined", score: 75, target: 85, failures: 5, lastTest: "2026-04-04" },
      { id: "evco-ct-20", name: "API Security Gateway", type: "preventive", maturity: "repeatable", score: 70, target: 82, failures: 7, lastTest: "2026-03-29" },
      { id: "evco-ct-21", name: "Threat Intelligence Platform", type: "detective", maturity: "managed", score: 83, target: 90, failures: 2, lastTest: "2026-04-07" },
      { id: "evco-ct-22", name: "Database Activity Monitoring", type: "detective", maturity: "defined", score: 67, target: 80, failures: 8, lastTest: "2026-03-21" },
      { id: "evco-ct-23", name: "Deception Technology", type: "detective", maturity: "initial", score: 55, target: 75, failures: 12, lastTest: "2026-03-16" },
      { id: "evco-ct-24", name: "Security Orchestration Automation", type: "corrective", maturity: "repeatable", score: 73, target: 85, failures: 6, lastTest: "2026-04-01" },
      { id: "evco-ct-25", name: "Third-Party Risk Assessment", type: "preventive", maturity: "defined", score: 64, target: 78, failures: 9, lastTest: "2026-03-19" },
    ];
    this._evcoControls = controls;
  }

  private _analyzeEvcoControlEffectiveness(): void {
    const typeBreakdown: Record<string, { total: number; avgScore: number; avgFailures: number }> = {};
    this._evcoControls.forEach(c => {
    ...
    this._evcoControlTypeBreakdown = typeBreakdown;
  }

  private _evcoControlOptimization(): Record<string, unknown>[] {
    return this._evcoControls.filter(c => c.score < c.target).map(c => ({
  ...
  // --- Security Data Pipeline Health (EVCO) ---
  private _initEvcoPipelines(): void {
    const pipelines = [
      { id: "evco-pl-01", name: "SIEM Log Ingestion", status: "healthy", healthScore: 94, latencyMs: 120, freshnessMin: 2, errorRate: 0.02, throughputMbps: 450, recordsPerSec: 12000, backPressure: 0.05, uptime: 99.97 },
      { id: "evco-pl-02", name: "Threat Feed Aggregation", status: "healthy", healthScore: 91, latencyMs: 300, freshnessMin: 15, errorRate: 0.05, throughputMbps: 85, recordsPerSec: 3200, backPressure: 0.08, uptime: 99.92 },
      { id: "evco-pl-03", name: "Vulnerability Scan Results", status: "degraded", healthScore: 72, latencyMs: 2500, freshnessMin: 60, errorRate: 0.15, throughputMbps: 25, recordsPerSec: 800, backPressure: 0.35, uptime: 98.50 },
      { id: "evco-pl-04", name: "Endpoint Telemetry Stream", status: "healthy", healthScore: 88, latencyMs: 450, freshnessMin: 5, errorRate: 0.08, throughputMbps: 280, recordsPerSec: 8500, backPressure: 0.12, uptime: 99.85 },
      { id: "evco-pl-05", name: "Cloud Audit Log Pipeline", status: "healthy", healthScore: 86, latencyMs: 600, freshnessMin: 10, errorRate: 0.06, throughputMbps: 150, recordsPerSec: 4500, backPressure: 0.10, uptime: 99.80 },
      { id: "evco-pl-06", name: "Identity Event Stream", status: "warning", healthScore: 78, latencyMs: 1200, freshnessMin: 20, errorRate: 0.12, throughputMbps: 45, recordsPerSec: 1500, backPressure: 0.22, uptime: 99.40 },
      { id: "evco-pl-07", name: "Network Flow Collection", status: "healthy", healthScore: 82, latencyMs: 800, freshnessMin: 8, errorRate: 0.09, throughputMbps: 650, recordsPerSec: 18000, backPressure: 0.15, uptime: 99.70 },
      { id: "evco-pl-08", name: "DLP Incident Pipeline", status: "degraded", healthScore: 68, latencyMs: 3500, freshnessMin: 45, errorRate: 0.20, throughputMbps: 18, recordsPerSec: 500, backPressure: 0.42, uptime: 97.80 },
    ];
    this._evcoPipelines = pipelines.map(p => ({ ...p, dependencies: [], slaBreached: p.healthScore < 75, alertThreshold: p.errorRate > 0.15 }));
    this._evcoPipelines[0].dependencies = ["evco-pl-04", "evco-pl-07"];
    this._evcoPipelines[4].dependencies = ["evco-pl-01"];
    this._evcoPipelines[5].dependencies = ["evco-pl-02"];
    this._evcoPipelines[7].dependencies = ["evco-pl-04", "evco-pl-05"];
  }

  private _evcoPipelineTrend(): Record<string, unknown>[] {
    const hours = Array.from({ length: 24 }, (_, i) => `H${String(i).padStart(2, "0")}`);
    return this._evcoPipelines.map(p => ({
  ...
  // --- Security Stakeholder Report Generator (EVCO) ---
  private _initEvcoReportTemplates(): void {
    this._evcoReportTemplates = [
      { id: "evco-rp-01", name: "Board Security Report", audience: "board", frequency: "quarterly", sections: 6, autoGenerate: true, lastGenerated: "2026-03-31", pages: 12 },
      { id: "evco-rp-02", name: "Executive Risk Summary", audience: "executive", frequency: "monthly", sections: 8, autoGenerate: true, lastGenerated: "2026-04-01", pages: 8 },
      { id: "evco-rp-03", name: "Technical Security Review", audience: "technical", frequency: "weekly", sections: 12, autoGenerate: true, lastGenerated: "2026-04-21", pages: 25 },
      { id: "evco-rp-04", name: "Audit Compliance Report", audience: "audit", frequency: "quarterly", sections: 10, autoGenerate: false, lastGenerated: "2026-03-15", pages: 35 },
      { id: "evco-rp-05", name: "Regulatory Filing Package", audience: "regulatory", frequency: "annual", sections: 15, autoGenerate: false, lastGenerated: "2025-12-31", pages: 48 },
    ];
  }

  private _generateEvcoExecSummary(): string {
    const totalRisk = this._evcoScenarios.reduce((sum: number, s: any) => sum + s.riskScore, 0);
    const avgControl = Math.round(this._evcoControls.reduce((sum: number, c: any) => sum + c.score, 0) / this._evcoControls.length);
    const degradedPipes = this._evcoPipelines.filter((p: any) => p.status !== "healthy").length;
    return `Overall risk exposure: ${(totalRisk / 1000000).toFixed(1)}M. Average control effectiveness: {avgControl}%. {degradedPipes} pipeline(s) need attention. {this._evcoScenarios.filter((s: any) => s.mitigationPriority === "immediate").length} scenarios require immediate action.`;
  }

  // --- Security Technology Radar (EVCO) ---
  private _initEvcoTechRadar(): void {
    this._evcoTechRadar = [
      { id: "evco-tr-01", name: "AI-Powered Threat Detection", ring: "adopt", category: "Detection", maturity: 4, trend: "up", investment: "high", roi: 3.2, vendorCount: 8 },
      { id: "evco-tr-02", name: "Zero Trust Architecture", ring: "adopt", category: "Architecture", maturity: 4, trend: "up", investment: "high", roi: 2.8, vendorCount: 12 },
      { id: "evco-tr-03", name: "SASE/SSE Platform", ring: "trial", category: "Network", maturity: 3, trend: "up", investment: "medium", roi: 2.4, vendorCount: 10 },
      { id: "evco-tr-04", name: "CNAPP Cloud Security", ring: "trial", category: "Cloud", maturity: 3, trend: "up", investment: "medium", roi: 2.1, vendorCount: 7 },
      { id: "evco-tr-05", name: "Extended Detection and Response", ring: "adopt", category: "Detection", maturity: 4, trend: "stable", investment: "high", roi: 2.9, vendorCount: 9 },
      { id: "evco-tr-06", name: "Quantum-Safe Cryptography", ring: "assess", category: "Crypto", maturity: 2, trend: "up", investment: "low", roi: 0.8, vendorCount: 4 },
      { id: "evco-tr-07", name: "Security Service Edge", ring: "trial", category: "Network", maturity: 3, trend: "up", investment: "medium", roi: 2.0, vendorCount: 6 },
      { id: "evco-tr-08", name: "SOAR 2.0 Autonomous SOC", ring: "assess", category: "Operations", maturity: 2, trend: "up", investment: "low", roi: 1.2, vendorCount: 5 },
      { id: "evco-tr-09", name: "Software Supply Chain Security", ring: "trial", category: "DevSecOps", maturity: 3, trend: "up", investment: "medium", roi: 2.3, vendorCount: 8 },
      { id: "evco-tr-10", name: "Identity Threat Detection", ring: "adopt", category: "Identity", maturity: 3, trend: "up", investment: "high", roi: 2.7, vendorCount: 7 },
      { id: "evco-tr-11", name: "Data Security Posture Management", ring: "trial", category: "Data", maturity: 3, trend: "up", investment: "medium", roi: 2.2, vendorCount: 9 },
      { id: "evco-tr-12", name: "Decentralized Identity Standards", ring: "hold", category: "Identity", maturity: 1, trend: "stable", investment: "low", roi: 0.5, vendorCount: 3 },
    ];
  }

  private _evcoRadarSummary(): Record<string, unknown> {
    const rings: Record<string, number> = { adopt: 0, trial: 0, assess: 0, hold: 0 };
    this._evcoTechRadar.forEach(t => { if (rings[t.ring as keyof typeof rings] !== undefined) rings[t.ring as keyof typeof rings]++; });
    return { adopt: rings.adopt, trial: rings.trial, assess: rings.assess, hold: rings.hold, total: this._evcoTechRadar.length, avgMaturity: 2.8, topInvestment: this._evcoTechRadar.filter(t => t.investment === "high").map(t => t.name) };
  }

  // --- EVCO Security Compliance Mapping Matrix ---
  private _initEvcoComplianceMatrix(): void {
    ...
    this._evcoComplianceMatrix = frameworks.map(fw => ({
  ...
  private _evcoComplianceTrend(): Record<string, unknown>[] {
    const quarters = ["Q1-2025", "Q2-2025", "Q3-2025", "Q4-2025", "Q1-2026", "Q2-2026"];
    return this._evcoComplianceMatrix.map(fw => ({
  ...
  // --- EVCO Threat Intelligence Correlation Engine ---
  private _initEvcoThreatIntel(): void {
    ...
    this._evcoThreatIntel = threatActors.map((actor, i) => ({
  ...
  private _evcoThreatCorrelation(): Record<string, unknown>[] {
    return this._evcoThreatIntel.filter(t => t.riskScore > 70).map(t => ({
  ...
  // --- EVCO Security Metrics Deep Dive ---
  private _initEvcoMetricsDeep(): void {
    ...
    this._evcoMetricsDeep = metricCategories.map(cat => ({
  ...
  private _evcoMetricsHeatmap(): number[][] {
    return this._evcoMetricsDeep.map(cat =>
      cat.metrics.map(m => Math.round((m.value / m.target) * 100))
    );
  }

  // --- EVCO Incident Cost Modeling ---
  private _initEvcoCostModel(): void {
    const incidentTypes = ["Data Breach", "Ransomware", "DDoS", "Insider Threat", "Phishing", "Supply Chain", "Cloud Misconfig", "Zero-Day"];
    this._evcoCostModel = incidentTypes.map(inc => ({
    ...
    this._evcoCostModel.forEach(m => { m.totalAnnualExposure = m.avgCost * m.frequency; });
  }

  private _evcoCostProjection(): Record<string, unknown>[] {
    return this._evcoCostModel.map(m => ({
  ...
  // --- EVCO Security Architecture Pattern Library ---
  private _initEvcoArchPatterns(): void {
    ...
    this._evcoArchPatterns = patterns.map((p, i) => ({
  ...
  private _evcoArchPatternAnalysis(): Record<string, unknown> {
    const implemented = this._evcoArchPatterns.filter(p => p.implementation > 75).length;
    const avgCoverage = Math.round(this._evcoArchPatterns.reduce((s: number, p: any) => s + p.coverage, 0) / this._evcoArchPatterns.length);
    return {
      totalPatterns: this._evcoArchPatterns.length, fullyImplemented: implemented, avgCoverage,
      avgRiskReduction: Math.round(this._evcoArchPatterns.reduce((s: number, p: any) => s + p.riskReduction, 0) / this._evcoArchPatterns.length),
      gaps: this._evcoArchPatterns.filter(p => p.implementation < 60).map(p => p.pattern),
      recommendations: this._evcoArchPatterns.filter(p => p.implementation < 70).map(p => ({ pattern: p.pattern, current: p.implementation, target: 85, effort: p.costComplexity }))
    };
  }
  ...
  private _931RiskAssessmentWorkflow = [
  ...
  private _931TreatmentOptions = [
    {id: '931-T-001', riskId: 'RSK-042', risk: 'Ransomware Attack on Critical Infrastructure', before: 20, after: 6, strategy: 'Mitigate', controls: ['Next-gen EDR with behavioral detection and automated response', 'Zero-trust network micro-segmentation isolating critical assets', 'Immutable offline backup rotation with quarterly recovery testing', 'Incident response retainer with 1-hour response SLA'], cost: '$450K/yr', roi: '78% reduction vs $2.8M potential loss', timeline: 'Q3 2026', status: 'approved' as const},
  ...
  private _931TalentPositions = [
    ...
    {id: '931-H-002', title: 'Cloud Security Engineer', dept: 'Cloud Security', level: 'Mid-Senior', loc: 'SF/Remote', salary: '$155K-$180K', posted: '2026-03-20', applicants: 45, pipeline: 12, interviews: 6, offers: 2, urgency: 'high' as const, manager: 'Mike Johnson', skills: ['AWS/Azure/GCP', 'Terraform', 'Kubernetes', 'IAM', 'CSPM'], nice: ['CCSP', 'CKS', 'Serverless']},
    {id: '931-H-003', title: 'SOC Analyst L2', dept: 'Security Operations', level: 'Mid', loc: 'Austin TX', salary: '$105K-$130K', posted: '2026-04-01', applicants: 67, pipeline: 18, interviews: 8, offers: 0, urgency: 'medium' as const, manager: 'Lisa Park', skills: ['SIEM', 'Incident triage', 'Malware analysis', 'TCP/IP'], nice: ['GCIA', 'SOAR', 'Kill chain']},
    {id: '931-H-004', title: 'Staff Security Architect', dept: 'Architecture', level: 'Staff', loc: 'Remote US', salary: '$200K-$240K', posted: '2026-02-28', applicants: 12, pipeline: 3, interviews: 2, offers: 0, urgency: 'critical' as const, manager: 'David Lee', skills: ['Enterprise arch', 'Zero trust', 'Risk frameworks', 'Board comms'], nice: ['CISSP+SABSA', 'Team building', 'Speaker']},
    {id: '931-H-005', title: 'GRC Analyst', dept: 'GRC', level: 'Mid', loc: 'NY/Remote', salary: '$110K-$135K', posted: '2026-04-05', applicants: 34, pipeline: 9, interviews: 3, offers: 1, urgency: 'medium' as const, manager: 'Rachel Green', skills: ['ISO 27001', 'SOC 2', 'Risk assessment', 'Audit'], nice: ['CRISC', 'CISA', 'GDPR']},
    {id: '931-H-006', title: 'Threat Intel Analyst', dept: 'Threat Intel', level: 'Mid-Senior', loc: 'Remote US', salary: '$140K-$170K', posted: '2026-03-25', applicants: 19, pipeline: 5, interviews: 2, offers: 0, urgency: 'low' as const, manager: 'James Wilson', skills: ['MITRE ATT&CK', 'OSINT', 'Threat modeling', 'Reverse eng'], nice: ['CTIA', 'Nation-state', 'Dark web']},
    {id: '931-H-007', title: 'AppSec Engineer', dept: 'AppSec', level: 'Senior', loc: 'Seattle/Remote', salary: '$160K-$190K', posted: '2026-04-10', applicants: 28, pipeline: 7, interviews: 3, offers: 0, urgency: 'medium' as const, manager: 'Emily Zhang', skills: ['SAST/DAST/SCA', 'Secure SDLC', 'Code review', 'CI/CD'], nice: ['CSSLP', 'Mobile security']},
    {id: '931-H-008', title: 'IAM Engineer', dept: 'IAM', level: 'Mid', loc: 'Remote US', salary: '$135K-$160K', posted: '2026-04-08', applicants: 31, pipeline: 10, interviews: 5, offers: 1, urgency: 'medium' as const, manager: 'Chris Martinez', skills: ['Okta/Azure AD', 'SAML/OIDC', 'PAM', 'RBAC'], nice: ['CISSP', 'Zero trust IAM']}
  ];

  private _931InterviewScorecard = [
  ...
  private _931OnboardingSteps = [
    {id: '931-OB-01', item: 'Provision security-hardened laptop, monitors, peripherals, and configured workstation image with all required security tools', cat: 'IT Setup', day: 'Day 1', owner: 'IT Operations'},
    {id: '931-OB-02', item: 'Create AD account, email, Slack, VPN, SSO enrollment, and all required application access accounts', cat: 'Access', day: 'Day 1', owner: 'IAM Team'},
    {id: '931-OB-03', item: 'Grant security tooling access: SIEM console, EDR dashboard, vuln scanner, pentest platforms, SOAR', cat: 'Tools', day: 'Day 1-2', owner: 'SOC Manager'},
    {id: '931-OB-04', item: 'Complete MFA enrollment, security awareness onboarding course, and acceptable use policy acknowledgment', cat: 'Security', day: 'Day 1', owner: 'Awareness Team'},
    {id: '931-OB-05', item: 'Sign NDA, employment agreement, IP assignment, and code of conduct documents with HR', cat: 'HR', day: 'Day 1', owner: 'Human Resources'},
    {id: '931-OB-06', item: 'Introduction meetings with direct team members and key cross-functional stakeholders', cat: 'Integration', day: 'Week 1', owner: 'Hiring Manager'},
    {id: '931-OB-07', item: 'Security architecture overview, tooling walkthrough, and operational runbook review sessions', cat: 'Training', day: 'Week 1-2', owner: 'Security Architect'},
    {id: '931-OB-08', item: 'Shadow experienced team member on active incident response and threat hunting investigations', cat: 'Mentoring', day: 'Week 2-3', owner: 'SOC Lead'},
    {id: '931-OB-09', item: 'Set up individual certification study plan aligned with role requirements and career goals', cat: 'Development', day: 'Week 2', owner: 'Hiring Manager'},
    {id: '931-OB-10', item: 'Establish 30-60-90 day goals, define success metrics, and schedule first performance checkpoint', cat: 'Goals', day: 'Week 1', owner: 'Hiring Manager'}
  ];

  private _931MetricsDashboard = [
    {id: '931-MTD-001', name: 'Mean Time to Detect (MTTD)', value: '4.2 hours', trend: 'improving' as const, target: '< 4 hours', source: 'SIEM - Splunk', method: 'Median time from first alert to analyst acknowledgment', owner: 'SOC Manager', sla: '4 hours', prev: '5.1 hours', spark: [5.8, 5.4, 5.1, 4.9, 4.7, 4.5, 4.3, 4.2], breakdown: [{src: 'Network IDS', pct: '35%', avg: '3.8h'}, {src: 'Endpoint EDR', pct: '28%', avg: '4.1h'}, {src: 'Email Gateway', pct: '22%', avg: '3.5h'}, {src: 'Cloud Security', pct: '10%', avg: '5.2h'}, {src: 'User Reports', pct: '5%', avg: '6.8h'}]},
    {id: '931-MTD-002', name: 'Mean Time to Respond (MTTR)', value: '2.8 hours', trend: 'stable' as const, target: '< 3 hours', source: 'SOAR - XSOAR', method: 'Median time from acknowledgment to first containment action', owner: 'IR Lead', sla: '3 hours', prev: '2.7 hours', spark: [3.2, 3.0, 2.9, 2.8, 2.8, 2.9, 2.8, 2.8], breakdown: [{src: 'Auto Playbooks', pct: '42%', avg: '1.2h'}, {src: 'Semi-Auto', pct: '33%', avg: '2.5h'}, {src: 'Manual', pct: '20%', avg: '5.1h'}, {src: 'L3 Escalation', pct: '5%', avg: '8.3h'}]},
    {id: '931-MTD-003', name: 'Patch Compliance Rate', value: '97.6%', trend: 'improving' as const, target: '> 95%', source: 'Tenable.io', method: 'Pct of critical/high vulns patched within SLA windows', owner: 'Vuln Manager', sla: '95%', prev: '96.1%', spark: [93.2, 94.1, 94.8, 95.3, 95.9, 96.4, 97.0, 97.6], breakdown: [{src: 'Critical (7d)', pct: '40%', rate: '99.2%'}, {src: 'High (30d)', pct: '35%', rate: '97.8%'}, {src: 'Medium (90d)', pct: '20%', rate: '95.1%'}, {src: 'Low (180d)', pct: '5%', rate: '89.4%'}]},
    {id: '931-MTD-004', name: 'Phishing Click Rate', value: '3.2%', trend: 'improving' as const, target: '< 5%', source: 'KnowBe4 + Proofpoint', method: 'Pct of users clicking simulated phishing links monthly', owner: 'Awareness Lead', sla: '5%', prev: '4.1%', spark: [6.8, 6.2, 5.5, 5.1, 4.6, 4.1, 3.6, 3.2], breakdown: [{src: 'Spear Phishing', pct: '35%', rate: '5.1%'}, {src: 'Generic Phishing', pct: '30%', rate: '2.8%'}, {src: 'BEC Sim', pct: '20%', rate: '3.5%'}, {src: 'SMS Phishing', pct: '15%', rate: '1.9%'}]},
    {id: '931-MTD-005', name: 'Security Posture Score', value: '784', trend: 'improving' as const, target: '> 750', source: 'SecurityScorecard', method: 'Composite: external 30%, compliance 25%, vuln 25%, config 20%', owner: 'CISO', sla: '> 750', prev: '771', spark: [748, 752, 758, 762, 768, 773, 778, 784], breakdown: [{src: 'External Rating', pct: '30%', score: '791'}, {src: 'Compliance', pct: '25%', score: '812'}, {src: 'Vuln Mgmt', pct: '25%', score: '745'}, {src: 'Config', pct: '20%', score: '769'}]},
    {id: '931-MTD-006', name: 'Vulnerability Backlog', value: '142', trend: 'improving' as const, target: '< 150', source: 'Tenable + Qualys', method: 'Total open vulns across all scanned assets tracked weekly', owner: 'Vuln Manager', sla: '< 150', prev: '168', spark: [210, 198, 185, 175, 165, 158, 150, 142], breakdown: [{src: 'Critical', pct: '8%', count: '11'}, {src: 'High', pct: '22%', count: '31'}, {src: 'Medium', pct: '45%', count: '64'}, {src: 'Low', pct: '25%', count: '36'}]}
  ];

  private _931ArchReview = [
    {id: '931-AR-001', cat: 'Network', item: 'Network segmentation between trust zones with dedicated firewalls and granular ACLs', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Micro-segmentation via NSX across all production zones'},
    {id: '931-AR-002', cat: 'Network', item: 'DMZ architecture isolating public services from internal network', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Dual-firewall DMZ with WAF and DDoS mitigation'},
    {id: '931-AR-003', cat: 'Network', item: 'Least-privilege traffic flows with deny-by-default and quarterly review', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Explicit allow rules with automated drift detection'},
    {id: '931-AR-004', cat: 'Network', item: 'Encrypted external communications with IPSec/TLS 1.3 and PFS', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'IKEv2 with PFS, TLS 1.3 for all external APIs'},
    {id: '931-AR-005', cat: 'Identity', item: 'Centralized IdP with SSO and automated SCIM provisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Okta SSO SAML 2.0 for 247 apps with SCIM'},
    {id: '931-AR-006', cat: 'Identity', item: 'RBAC with quarterly reviews and automated deprovisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Quarterly recertification with JIT admin access'},
    {id: '931-AR-007', cat: 'Identity', item: 'PAM controlling all admin and service accounts with session recording', sev: 'high' as const, status: 'fail' as const, reviewer: 'IAM Lead', notes: '3 legacy accounts pending CyberArk enrollment'},
    {id: '931-AR-008', cat: 'Identity', item: 'MFA enforced for all users, hardware tokens for privileged access', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'FIDO2 for admins, push MFA for users, 99.8% enrollment'},
    {id: '931-AR-009', cat: 'Data', item: 'Data classification enforced with automated labeling on all repos', sev: 'high' as const, status: 'partial' as const, reviewer: 'Data Protection Lead', notes: 'Framework deployed, gaps on 4 legacy file shares'},
    {id: '931-AR-010', cat: 'Data', item: 'AES-256 encryption at rest for all sensitive data stores', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'Full-disk, TDE on DBs, SSE-KMS on cloud storage'},
    {id: '931-AR-011', cat: 'Data', item: 'DLP monitoring and preventing unauthorized data exfiltration', sev: 'high' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'DLP active on email, endpoint, cloud, and network'},
    {id: '931-AR-012', cat: 'Data', item: 'Encrypted off-site backups with quarterly restore testing', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Infrastructure Lead', notes: '3-2-1 strategy with immutable backups'},
    {id: '931-AR-013', cat: 'AppSec', item: 'Secure SDLC with SAST, DAST, SCA in all CI/CD pipelines', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: '34 pipelines with security gates and PR blocking'},
    {id: '931-AR-014', cat: 'AppSec', item: 'API gateway with auth, rate limiting, schema validation', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: 'Kong with OAuth2, rate limits, OpenAPI validation'},
    {id: '931-AR-015', cat: 'AppSec', item: 'Container security with image scanning and runtime protection', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Trivy scanning, Falco runtime in 80% of clusters'},
    {id: '931-AR-016', cat: 'Monitoring', item: 'SIEM collecting from all critical systems with correlation rules', sev: 'critical' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'Splunk 98% coverage with 1200+ correlation rules'},
    {id: '931-AR-017', cat: 'Monitoring', item: 'EDR with behavioral detection on all managed endpoints', sev: 'high' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'CrowdStrike on 99.2% endpoints with 24/7 MDR'},
    {id: '931-AR-018', cat: 'Monitoring', item: 'Executive dashboards with real-time posture visibility', sev: 'medium' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'PowerBI dashboards with weekly exec summaries'},
    {id: '931-AR-019', cat: 'Cloud', item: 'CSPM monitoring and remediating cloud misconfigurations', sev: 'high' as const, status: 'pass' as const, reviewer: 'Cloud Security Lead', notes: 'Prisma Cloud 450+ checks with auto-remediation'},
    {id: '931-AR-020', cat: 'Cloud', item: 'IaC templates scanned before deployment to production', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Checkov for Terraform, cfn-nag for CloudFormation pending'}
  ];

  private _get931RiskProgress(): number {
    return Math.round(this._931RiskAssessmentWorkflow.filter(s => s.status === 'completed').length / this._931RiskAssessmentWorkflow.length * 100);
  }

  private _get931TreatmentSummary(): {total: number; approved: number; avgReduction: number; investment: string} {
    const a = this._931TreatmentOptions.filter(r => r.status === 'approved').length;
    const avg = this._931TreatmentOptions.reduce((s, r) => s + ((r.before - r.after) / r.before * 100), 0) / this._931TreatmentOptions.length;
    return {total: this._931TreatmentOptions.length, approved: a, avgReduction: Math.round(avg), investment: '$1.125M annually'};
  }

  private _get931RuleSummary(): {total: number; passing: number; failing: number; avgRate: number; violations: number} {
    const p = this._931ComplianceRules.filter(r => r.result === 'pass').length;
    const f = this._931ComplianceRules.filter(r => r.result === 'fail').length;
    const avg = this._931ComplianceRules.reduce((s, r) => s + r.passRate, 0) / this._931ComplianceRules.length;
    const v = this._931ComplianceRules.reduce((s, r) => s + r.violations, 0);
    return {total: this._931ComplianceRules.length, passing: p, failing: f, avgRate: Math.round(avg * 10) / 10, violations: v};
  }

  private _get931PipelineStats(): {positions: number; applicants: number; interviewing: number; offers: number; critical: number} {
    const t = this._931TalentPositions.length;
    const a = this._931TalentPositions.reduce((s, p) => s + p.applicants, 0);
    const i = this._931TalentPositions.reduce((s, p) => s + p.interviews, 0);
    const o = this._931TalentPositions.reduce((s, p) => s + p.offers, 0);
    const c = this._931TalentPositions.filter(x => x.urgency === 'critical').length;
    return {positions: t, applicants: a, interviewing: i, offers: o, critical: c};
  }

  private _get931MetricTrends(): {improving: number; stable: number; total: number} {
    const imp = this._931MetricsDashboard.filter(m => m.trend === 'improving').length;
    const stb = this._931MetricsDashboard.filter(m => m.trend === 'stable').length;
    return {improving: imp, stable: stb, total: this._931MetricsDashboard.length};
  }

  private _get931ArchScore(): {total: number; passed: number; failed: number; partial: number; score: number} {
    const p = this._931ArchReview.filter(c => c.status === 'pass').length;
    const f = this._931ArchReview.filter(c => c.status === 'fail').length;
    const pa = this._931ArchReview.filter(c => c.status === 'partial').length;
    return {total: this._931ArchReview.length, passed: p, failed: f, partial: pa, score: Math.round((p / this._931ArchReview.length) * 100)};
  }


  private _z931IncidentScenarios = [
    {id: 'z931-IS-001', name: 'Ransomware Outbreak in Production Environment', category: 'Malware', likelihood: 'Medium', impact: 'Critical', riskScore: 15, playbooks: ['IR-Ransomware-Isolate', 'IR-Ransomware-Eradicate', 'IR-Ransomway-Recover'], estimatedMTTD: '15min', estimatedMTTR: '4h', involvedTeams: ['SOC', 'IR', 'Infrastructure', 'Legal', 'Comms'], keyIndicators: ['Mass file encryption events', 'Ransom note deployment', 'Lateral movement via SMB/RDP', 'Backup deletion attempts'], mitigationControls: ['EDR behavioral detection', 'Network segmentation', 'Immutable backups', 'Email filtering'], lessonsLearned: 'Ensure offline backups are tested quarterly and Ransomware-specific playbooks are updated with latest threat intelligence', lastDrillDate: '2026-03-15', nextDrillDate: '2026-06-15'},
    {id: 'z931-IS-002', name: 'Cloud Misconfiguration Leading to Data Exposure', category: 'Cloud', likelihood: 'High', impact: 'High', riskScore: 16, playbooks: ['IR-Cloud-Misconfig-Assess', 'IR-Cloud-Misconfig-Remediate', 'IR-Cloud-Misconfig-Notify'], estimatedMTTD: '2h', estimatedMTTR: '6h', involvedTeams: ['Cloud Security', 'SOC', 'Data Protection', 'Legal'], keyIndicators: ['Public S3 bucket exposure', 'Overly permissive IAM policies', 'Unencrypted database snapshots', 'Public API endpoint discovery'], mitigationControls: ['CSPM monitoring', 'IAM policy analyzer', 'Automated remediation', 'Cloud audit logging'], lessonsLearned: 'Implement CSPM with auto-remediation for common misconfigurations and conduct monthly cloud configuration reviews', lastDrillDate: '2026-02-20', nextDrillDate: '2026-05-20'},
    {id: 'z931-IS-003', name: 'Insider Threat Data Exfiltration', category: 'Insider', likelihood: 'Low', impact: 'Critical', riskScore: 12, playbooks: ['IR-Insider-Investigate', 'IR-Insider-Contain', 'IR-Insider-Escalate'], estimatedMTTD: '8h', estimatedMTTR: '24h', involvedTeams: ['SOC', 'IR', 'HR', 'Legal', 'IAM'], keyIndicators: ['Anomalous data access patterns', 'Large file downloads to USB or cloud', 'Off-hours access to sensitive systems', 'Accessing data outside normal job scope'], mitigationControls: ['UEBA analytics', 'DLP policies', 'PAM controls', 'Access reviews'], lessonsLearned: 'Strengthen UEBA baselines and implement automated alerts for data access pattern anomalies', lastDrillDate: '2026-01-10', nextDrillDate: '2026-04-10'},
    {id: 'z931-IS-004', name: 'Supply Chain Attack via Compromised Vendor Software', category: 'Supply Chain', likelihood: 'Low', impact: 'Critical', riskScore: 12, playbooks: ['IR-SupplyChain-Detect', 'IR-SupplyChain-Isolate', 'IR-SupplyChain-Remediate'], estimatedMTTD: '24h', estimatedMTTR: '72h', involvedTeams: ['SOC', 'IR', 'Procurement', 'Vendor Mgmt', 'Legal'], keyIndicators: ['Unexpected network connections from vendor software', 'Modified binaries or dependencies', 'Anomalous behavior from trusted applications', 'SBOM discrepancy alerts'], mitigationControls: ['SCA scanning', 'SBOM monitoring', 'Vendor security assessments', 'Network segmentation'], lessonsLearned: 'Require SBOM from all vendors and implement continuous monitoring of third-party component behavior', lastDrillDate: '2026-03-01', nextDrillDate: '2026-06-01'},
    {id: 'z931-IS-005', name: 'Credential Stuffing Attack on Customer Portal', category: 'External Attack', likelihood: 'High', impact: 'Medium', riskScore: 12, playbooks: ['IR-CredentialStuffing-Detect', 'IR-CredentialStuffing-Block', 'IR-CredentialStuffing-Notify'], estimatedMTTD: '30min', estimatedMTTR: '2h', involvedTeams: ['SOC', 'AppSec', 'Customer Support', 'Comms'], keyIndicators: ['High volume of failed login attempts', 'Login attempts from known compromised credential lists', 'Unusual geographic distribution of login attempts', 'Account takeover indicators'], mitigationControls: ['WAF rate limiting', 'CAPTCHA on login', 'MFA enforcement', 'Credential monitoring service'], lessonsLearned: 'Deploy advanced bot detection on login endpoints and implement proactive credential monitoring for customer accounts', lastDrillDate: '2026-04-01', nextDrillDate: '2026-07-01'},
    {id: 'z931-IS-006', name: 'Phishing Campaign Targeting Executive Team', category: 'Social Engineering', likelihood: 'High', impact: 'High', riskScore: 16, playbooks: ['IR-Phishing-Contain', 'IR-Phishing-Investigate', 'IR-Phishing-Notify'], estimatedMTTD: '1h', estimatedMTTR: '4h', involvedTeams: ['SOC', 'Awareness', 'Executive Office', 'IT'], keyIndicators: ['Sophisticated spear-phishing emails to C-suite', 'Business email compromise indicators', 'Redirected MFA approval requests', 'Unauthorized wire transfer attempts'], mitigationControls: ['AI email filtering', 'Executive awareness training', 'Out-of-band verification policy', 'DMARC/DKIM/SPF'], lessonsLearned: 'Implement additional email security controls for executive mailboxes and conduct monthly spear-phishing simulations', lastDrillDate: '2026-02-15', nextDrillDate: '2026-05-15'}
  ];

  private _z931SecurityFrameworks = [
  ...
  private _getz931ScenarioSummary(): {total: number; critical: number; high: number; drilled: number; avgRiskScore: number} {
    const crit = this._z931IncidentScenarios.filter(s => s.impact === 'Critical').length;
    const high = this._z931IncidentScenarios.filter(s => s.impact === 'High').length;
    const avg = this._z931IncidentScenarios.reduce((s, x) => s + x.riskScore, 0) / this._z931IncidentScenarios.length;
    return {total: this._z931IncidentScenarios.length, critical: crit, high: high, drilled: this._z931IncidentScenarios.length, avgRiskScore: Math.round(avg)};
  }

  private _getz931VendorRiskSummary(): {total: number; approved: number; conditional: number; remediation: number; avgScore: number} {
    const approved = this._z931ThirdPartyRiskData.filter(v => v.status === 'approved').length;
    const cond = this._z931ThirdPartyRiskData.filter(v => v.status === 'conditional').length;
    const rem = this._z931ThirdPartyRiskData.filter(v => v.status === 'remediation_required').length;
    const avg = this._z931ThirdPartyRiskData.reduce((s, v) => s + v.riskScore, 0) / this._z931ThirdPartyRiskData.length;
    return {total: this._z931ThirdPartyRiskData.length, approved, conditional: cond, remediation: rem, avgScore: Math.round(avg)};
  }

  private _getz931TrainingSummary(): {total: number; avgCompletion: number; avgScore: number; overdueUpdates: number} {
    const avgComp = this._z931SecurityTrainingCatalog.reduce((s, t) => s + t.completionRate, 0) / this._z931SecurityTrainingCatalog.length;
    const avgScore = this._z931SecurityTrainingCatalog.filter(t => t.avgScore > 0).reduce((s, t) => s + t.avgScore, 0) / this._z931SecurityTrainingCatalog.filter(t => t.avgScore > 0).length;
    return {total: this._z931SecurityTrainingCatalog.length, avgCompletion: Math.round(avgComp * 10) / 10, avgScore: Math.round(avgScore), overdueUpdates: 0};
  }

  private _getz931ToolHealthSummary(): {total: number; healthy: number; degraded: number; annualCost: string} {
    const healthy = this._z931SecurityToolInventory.filter(t => t.health === 'healthy').length;
    const degraded = this._z931SecurityToolInventory.filter(t => t.health === 'degraded').length;
    const cost = this._z931SecurityToolInventory.reduce((s, t) => s + parseInt(t.annualCost.replace(/[^0-9]/g, '')), 0);
    return {total: this._z931SecurityToolInventory.length, healthy, degraded, annualCost: '$' + (cost / 1000).toFixed(0) + 'K'};
  }


  private _x931SecurityZones = [
    {zoneId: 'x931-Z-001', name: 'Internet DMZ', trustLevel: 'Untrusted', subnet: '10.0.0.0/24', segmentation: 'Dual-firewall', firewallRules: 45, monitoring: 'Full packet capture', assets: ['Web servers', 'Load balancers', 'WAF appliances', 'Reverse proxy'], riskLevel: 'high' as const, lastAssessment: '2026-04-15', nextAssessment: '2026-07-15'},
    {zoneId: 'x931-Z-002', name: 'Corporate Network', trustLevel: 'Trusted', subnet: '10.1.0.0/16', segmentation: 'VLAN + micro-seg', firewallRules: 128, monitoring: 'NetFlow + IDS', assets: ['Workstations', 'Printers', 'Meeting room systems', 'VoIP phones'], riskLevel: 'medium' as const, lastAssessment: '2026-04-10', nextAssessment: '2026-07-10'},
    {zoneId: 'x931-Z-003', name: 'Production Data Center', trustLevel: 'Restricted', subnet: '10.2.0.0/16', segmentation: 'Full micro-segmentation', firewallRules: 256, monitoring: 'Full packet capture + EDR', assets: ['Application servers', 'Database clusters', 'Message queues', 'API gateways'], riskLevel: 'low' as const, lastAssessment: '2026-04-12', nextAssessment: '2026-07-12'},
    {zoneId: 'x931-Z-004', name: 'Management Network', trustLevel: 'Restricted', subnet: '10.3.0.0/24', segmentation: 'Isolated VLAN', firewallRules: 32, monitoring: 'Syslog + SNMP', assets: ['Hypervisors', 'Switch management', 'Storage controllers', 'Backup appliances'], riskLevel: 'low' as const, lastAssessment: '2026-04-08', nextAssessment: '2026-07-08'},
    {zoneId: 'x931-Z-005', name: 'Cloud Production', trustLevel: 'Restricted', subnet: 'VPC: 172.16.0.0/12', segmentation: 'Security groups + NACLs', firewallRules: 189, monitoring: 'VPC Flow Logs + GuardDuty', assets: ['Kubernetes clusters', 'Managed databases', 'Object storage', 'Serverless functions'], riskLevel: 'medium' as const, lastAssessment: '2026-04-18', nextAssessment: '2026-07-18'}
  ];

  private _x931SecurityAlerts = [
    {id: 'x931-AL-001', severity: 'critical', title: 'Active ransomware encryption detected on PROD-DB-01', source: 'CrowdStrike', timestamp: '2026-04-22T13:45:00Z', status: 'investigating', assignee: 'SOC Analyst J. Smith', asset: 'PROD-DB-01 (10.2.1.15)', mitreTechnique: 'T1486 - Data Encrypted for Impact', playbook: 'IR-Ransomware-Isolate', sla: '15 minutes', elapsed: '12 minutes', notes: 'EDR detected mass file encryption event pattern. Automated isolation triggered. IR team paged.'},
    {id: 'x931-AL-002', severity: 'high', title: 'Impossible travel detected for user admin@company.com', source: 'Okta', timestamp: '2026-04-22T12:30:00Z', status: 'triaged', assignee: 'SOC Analyst M. Johnson', asset: 'Okta - admin@company.com', mitreTechnique: 'T1078 - Valid Accounts', playbook: 'IR-ImpossibleTravel', sla: '30 minutes', elapsed: '87 minutes', notes: 'Login from Tokyo followed by login from New York within 30 minutes. Account temporarily locked. User confirmed via out-of-band channel they are in New York.'},
    {id: 'x931-AL-003', severity: 'high', title: 'Public S3 bucket discovered with customer PII exposure', source: 'Prisma Cloud', timestamp: '2026-04-22T11:15:00Z', status: 'remediating', assignee: 'Cloud Security Lead A. Chen', asset: 'AWS S3: customer-data-archive-2024', mitreTechnique: 'N/A - Misconfiguration', playbook: 'IR-Cloud-Misconfig-Remediate', sla: '1 hour', elapsed: '2.5 hours', notes: 'Bucket containing archived customer records was publicly accessible. Bucket blocked and encrypted. Data exposure assessment in progress.'},
    {id: 'x931-AL-004', severity: 'medium', title: 'Anomalous data download by user jane.developer@company.com', source: 'Microsoft DLP', timestamp: '2026-04-22T10:00:00Z', status: 'investigating', assignee: 'SOC Analyst R. Davis', asset: 'Endpoint: WS-DEV-042', mitreTechnique: 'T1567 - Exfil Over Web Service', playbook: 'IR-DLP-Investigation', sla: '4 hours', elapsed: '3.5 hours', notes: 'User downloaded 4.2GB of source code files to personal Google Drive. Interview scheduled with user and manager.'},
    {id: 'x931-AL-005', severity: 'medium', title: 'Credential stuffing attack detected on customer portal', source: 'Cloudflare WAF', timestamp: '2026-04-22T09:30:00Z', status: 'contained', assignee: 'SOC Analyst K. Wilson', asset: 'Customer Portal (portal.company.com)', mitreTechnique: 'T1110 - Brute Force', playbook: 'IR-CredentialStuffing-Block', sla: '2 hours', elapsed: '4 hours', notes: 'Rate limiting and CAPTCHA automatically deployed. 12,000 failed login attempts from 800 unique IPs blocked. No successful account takeovers confirmed.'},
    {id: 'x931-AL-006', severity: 'low', title: 'SSL certificate expiring in 14 days for api.company.com', source: 'Certificate monitoring', timestamp: '2026-04-22T08:00:00Z', status: 'remediated', assignee: 'Infrastructure Lead T. Brown', asset: 'api.company.com', mitreTechnique: 'N/A', playbook: 'Certificate Renewal', sla: '30 days', elapsed: '16 days', notes: 'Automated renewal triggered via ACME. New certificate deployed successfully. No service interruption.'}
  ];

  private _x931ComplianceFrameworks = [
  ...
  private _x931DataClassificationPolicy = [
  ...
  private _getx931ZoneSummary(): {total: number; highRisk: number; mediumRisk: number; lowRisk: number; totalRules: number} {
    const high = this._x931SecurityZones.filter(z => z.riskLevel === 'high').length;
    const med = this._x931SecurityZones.filter(z => z.riskLevel === 'medium').length;
    const low = this._x931SecurityZones.filter(z => z.riskLevel === 'low').length;
    const rules = this._x931SecurityZones.reduce((s, z) => s + z.firewallRules, 0);
    return {total: this._x931SecurityZones.length, highRisk: high, mediumRisk: med, lowRisk: low, totalRules: rules};
  }

  private _getx931AlertSummary(): {total: number; critical: number; high: number; medium: number; low: number; open: number; contained: number} {
    const crit = this._x931SecurityAlerts.filter(a => a.severity === 'critical').length;
    const high = this._x931SecurityAlerts.filter(a => a.severity === 'high').length;
    const med = this._x931SecurityAlerts.filter(a => a.severity === 'medium').length;
    const low = this._x931SecurityAlerts.filter(a => a.severity === 'low').length;
    const open = this._x931SecurityAlerts.filter(a => a.status === 'investigating' || a.status === 'triaged').length;
    const contained = this._x931SecurityAlerts.filter(a => a.status === 'contained' || a.status === 'remediated').length;
    return {total: this._x931SecurityAlerts.length, critical: crit, high, medium: med, low, open, contained};
  }

  private _getx931ComplianceSummary(): {total: number; fullyCompliant: number; mostlyCompliant: number; avgComplianceRate: number} {
    const full = this._x931ComplianceFrameworks.filter(f => f.status === 'compliant').length;
    const mostly = this._x931ComplianceFrameworks.filter(f => f.status === 'mostly_compliant').length;
    const avgRate = this._x931ComplianceFrameworks.reduce((s, f) => s + (f.compliant / f.requirements * 100), 0) / this._x931ComplianceFrameworks.length;
    return {total: this._x931ComplianceFrameworks.length, fullyCompliant: full, mostlyCompliant: mostly, avgComplianceRate: Math.round(avgRate * 10) / 10};
  }
  ...
  // === Security Risk Register (evidence_col) ===
  private _evidence_colRiskRegister = [
    { id: "RSK-EVI-0001", title: "Data breach from unpatched systems", owner: "CTO", category: "Financial", status: "mitigating", trend: "stable", severity: "low", likelihood: 6, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-23", nextReview: "2026-07-17" },
    { id: "RSK-EVI-0002", title: "Ransomware attack on critical infrastructure", owner: "CRO", category: "Strategic", status: "closed", trend: "decreasing", severity: "low", likelihood: 6, impact: 6, treatment: "Monitor and review quarterly", lastReview: "2026-04-06", nextReview: "2026-07-24" },
    { id: "RSK-EVI-0003", title: "Insider threat data exfiltration", owner: "VP Eng", category: "Compliance", status: "accepted", trend: "increasing", severity: "medium", likelihood: 3, impact: 1, treatment: "Monitor and review quarterly", lastReview: "2026-04-13", nextReview: "2026-07-14" },
    { id: "RSK-EVI-0004", title: "Supply chain compromise", owner: "Security Lead", category: "Technical", status: "open", trend: "stable", severity: "critical", likelihood: 7, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-11", nextReview: "2026-07-20" },
    { id: "RSK-EVI-0005", title: "Cloud misconfiguration exposure", owner: "Risk Mgr", category: "Reputational", status: "mitigating", trend: "decreasing", severity: "high", likelihood: 9, impact: 5, treatment: "Monitor and review quarterly", lastReview: "2026-04-18", nextReview: "2026-07-23" },
    { id: "RSK-EVI-0006", title: "Phishing campaign success rate", owner: "Compliance Dir", category: "Legal", status: "closed", trend: "increasing", severity: "high", likelihood: 8, impact: 6, treatment: "Monitor and review quarterly", lastReview: "2026-04-13", nextReview: "2026-07-06" },
    { id: "RSK-EVI-0007", title: "Third-party vendor data breach", owner: "IT Dir", category: "Regulatory", status: "accepted", trend: "stable", severity: "critical", likelihood: 5, impact: 4, treatment: "Monitor and review quarterly", lastReview: "2026-04-16", nextReview: "2026-07-20" },
    { id: "RSK-EVI-0008", title: "Regulatory non-compliance penalty", owner: "DevOps Lead", category: "Third-Party", status: "open", trend: "decreasing", severity: "medium", likelihood: 9, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-02", nextReview: "2026-07-26" },
    { id: "RSK-EVI-0009", title: "Zero-day exploit in production", owner: "Architect", category: "Human Capital", status: "mitigating", trend: "increasing", severity: "medium", likelihood: 3, impact: 2, treatment: "Monitor and review quarterly", lastReview: "2026-04-22", nextReview: "2026-07-15" },
    { id: "RSK-EVI-0010", title: "Insufficient access controls", owner: "CISO", category: "Operational", status: "closed", trend: "stable", severity: "high", likelihood: 6, impact: 1, treatment: "Monitor and review quarterly", lastReview: "2026-04-21", nextReview: "2026-07-14" },
    { id: "RSK-EVI-0011", title: "DDoS attack on services", owner: "CTO", category: "Financial", status: "accepted", trend: "decreasing", severity: "low", likelihood: 7, impact: 7, treatment: "Monitor and review quarterly", lastReview: "2026-04-13", nextReview: "2026-07-03" },
    { id: "RSK-EVI-0012", title: "Social engineering attack", owner: "CRO", category: "Strategic", status: "open", trend: "increasing", severity: "medium", likelihood: 5, impact: 5, treatment: "Monitor and review quarterly", lastReview: "2026-04-13", nextReview: "2026-07-24" },
    { id: "RSK-EVI-0013", title: "API security vulnerability", owner: "VP Eng", category: "Compliance", status: "mitigating", trend: "stable", severity: "high", likelihood: 6, impact: 7, treatment: "Monitor and review quarterly", lastReview: "2026-04-03", nextReview: "2026-07-14" },
    { id: "RSK-EVI-0014", title: "Mobile device compromise", owner: "Security Lead", category: "Technical", status: "closed", trend: "decreasing", severity: "critical", likelihood: 3, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-17", nextReview: "2026-07-27" },
    { id: "RSK-EVI-0015", title: "Physical security breach", owner: "Risk Mgr", category: "Reputational", status: "accepted", trend: "increasing", severity: "low", likelihood: 4, impact: 7, treatment: "Monitor and review quarterly", lastReview: "2026-04-03", nextReview: "2026-07-05" },
    { id: "RSK-EVI-0016", title: "Password policy weakness", owner: "Compliance Dir", category: "Legal", status: "open", trend: "stable", severity: "critical", likelihood: 5, impact: 2, treatment: "Monitor and review quarterly", lastReview: "2026-04-04", nextReview: "2026-07-13" },
    { id: "RSK-EVI-0017", title: "Network segmentation gap", owner: "IT Dir", category: "Regulatory", status: "mitigating", trend: "decreasing", severity: "critical", likelihood: 5, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-03", nextReview: "2026-07-05" },
    { id: "RSK-EVI-0018", title: "Encryption key management failure", owner: "DevOps Lead", category: "Third-Party", status: "closed", trend: "increasing", severity: "critical", likelihood: 9, impact: 2, treatment: "Monitor and review quarterly", lastReview: "2026-04-13", nextReview: "2026-07-09" },
    { id: "RSK-EVI-0019", title: "Audit trail tampering", owner: "Architect", category: "Human Capital", status: "accepted", trend: "stable", severity: "high", likelihood: 5, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-06", nextReview: "2026-07-25" },
    { id: "RSK-EVI-0020", title: "Business email compromise", owner: "CISO", category: "Operational", status: "open", trend: "decreasing", severity: "high", likelihood: 3, impact: 4, treatment: "Monitor and review quarterly", lastReview: "2026-04-08", nextReview: "2026-07-26" },
  ];
  private _evidence_colRiskFilter: string = 'all';
  private _evidence_colRiskSeverity: string = 'all';
  private _evidence_colRiskStatus: string = 'all';
  private _evidence_colExpandedRisk: string = '';
  private _evidence_colFilterRisks() {
    const reg = this._evidence_colRiskRegister;
    return reg.filter(r => {
      if (this._evidence_colRiskFilter !== "all" && r.category !== this._evidence_colRiskFilter) return false;
      if (this._evidence_colRiskSeverity !== "all" && r.severity !== this._evidence_colRiskSeverity) return false;
      if (this._evidence_colRiskStatus !== "all" && r.status !== this._evidence_colRiskStatus) return false;
      return true;
    });
  }
  private _evidence_colGetRiskScore(r: any) { return Math.round(r.likelihood * r.impact * 1.5); }
  private _evidence_colGetRiskTrendIcon(trend: string) {
    if (trend === "increasing") return "\u2191";
    if (trend === "decreasing") return "\u2193";
    return "\u2192";
  }
  private _evidence_colGetRiskColor(sev: string) {
    if (sev === "critical") return "#dc2626";
    if (sev === "high") return "#ea580c";
    if (sev === "medium") return "#d97706";
    return "#16a34a";
  }
  private _evidence_colGetRiskCounts() {
    const reg = this._evidence_colRiskRegister;
  ...
  private _evidence_colGetTreatmentProgress() {
    const reg = this._evidence_colRiskRegister;
    const treated = reg.filter(r => r.status === "mitigating" || r.status === "closed").length;
    return Math.round((treated / Math.max(reg.length, 1)) * 100);
  }

  // === Security Metrics API Gateway (evidence_col) ===
  private _evidence_colApiEndpoints = [
    { method: "GET", path: "/api/v1/threats", name: "Threat Intelligence Feed", status: "active", avgLatency: 279.5, reqPerMin: 647.0, errorRate: 0.46, uptime: round(99.14683887976227,2), version: "v3.3.14" },
    { method: "POST", path: "/api/v1/scans/start", name: "Vulnerability Scanner", status: "active", avgLatency: 360.4, reqPerMin: 623.0, errorRate: 1.9, uptime: round(97.10224592587284,2), version: "v2.5.18" },
    { method: "GET", path: "/api/v1/assets", name: "Asset Inventory", status: "active", avgLatency: 202.7, reqPerMin: 68.0, errorRate: 1.72, uptime: round(96.93057722352465,2), version: "v3.7.16" },
    { method: "POST", path: "/api/v1/alerts", name: "Alert Management", status: "active", avgLatency: 91.3, reqPerMin: 508.0, errorRate: 1.47, uptime: round(95.77592689202534,2), version: "v2.7.6" },
    { method: "GET", path: "/api/v1/compliance", name: "Compliance Status", status: "active", avgLatency: 58.3, reqPerMin: 1243.0, errorRate: 1.38, uptime: round(98.46475026696741,2), version: "v1.2.9" },
    { method: "PUT", path: "/api/v1/policies", name: "Policy Engine", status: "active", avgLatency: 228.2, reqPerMin: 2175.0, errorRate: 0.57, uptime: round(95.65366485956999,2), version: "v3.3.0" },
    { method: "GET", path: "/api/v1/incidents", name: "Incident Tracker", status: "active", avgLatency: 189.0, reqPerMin: 582.0, errorRate: 0.22, uptime: round(97.15697316252836,2), version: "v1.4.14" },
    { method: "POST", path: "/api/v1/forensics", name: "Forensics Collector", status: "degraded", avgLatency: 254.6, reqPerMin: 152.0, errorRate: 0.69, uptime: round(97.6586003915493,2), version: "v2.1.6" },
    { method: "GET", path: "/api/v1/risk/assess", name: "Risk Assessment", status: "active", avgLatency: 362.0, reqPerMin: 1773.0, errorRate: 1.98, uptime: round(96.15415035396924,2), version: "v2.8.20" },
    { method: "POST", path: "/api/v1/auth/verify", name: "Authentication", status: "active", avgLatency: 62.2, reqPerMin: 347.0, errorRate: 2.45, uptime: round(95.04406752550604,2), version: "v1.4.12" },
    { method: "GET", path: "/api/v1/logs/audit", name: "Audit Log Query", status: "active", avgLatency: 346.1, reqPerMin: 1761.0, errorRate: 2.22, uptime: round(95.39363515601548,2), version: "v2.0.3" },
    { method: "PUT", path: "/api/v1/users/roles", name: "Role Management", status: "active", avgLatency: 348.4, reqPerMin: 662.0, errorRate: 0.49, uptime: round(96.33555158444369,2), version: "v2.0.7" },
    { method: "POST", path: "/api/v1/encrypt", name: "Encryption Service", status: "active", avgLatency: 75.9, reqPerMin: 217.0, errorRate: 0.06, uptime: round(96.78717842855423,2), version: "v3.9.14" },
    { method: "GET", path: "/api/v1/network/topo", name: "Network Topology", status: "maintenance", avgLatency: 234.2, reqPerMin: 464.0, errorRate: 1.72, uptime: round(96.64298065929242,2), version: "v2.6.1" },
    { method: "DELETE", path: "/api/v1/sessions", name: "Session Manager", status: "active", avgLatency: 125.3, reqPerMin: 1025.0, errorRate: 2.13, uptime: round(96.78461424038956,2), version: "v3.0.11" },
  ];
  private _evidence_colApiKeys = [
    { id: "ak-000001", name: "key-evid-001", created: "2026-04-18", lastUsed: "2026-04-17", status: "revoked", calls: 24533, rateLimit: 1000 },
    { id: "ak-000002", name: "key-evid-002", created: "2026-01-21", lastUsed: "2026-04-04", status: "revoked", calls: 45546, rateLimit: 1000 },
    { id: "ak-000003", name: "key-evid-003", created: "2026-05-18", lastUsed: "2026-04-17", status: "active", calls: 5992, rateLimit: 500 },
    { id: "ak-000004", name: "key-evid-004", created: "2026-05-22", lastUsed: "2026-04-14", status: "active", calls: 33600, rateLimit: 500 },
    { id: "ak-000005", name: "key-evid-005", created: "2026-06-10", lastUsed: "2026-04-07", status: "active", calls: 3824, rateLimit: 5000 },
    { id: "ak-000006", name: "key-evid-006", created: "2026-02-21", lastUsed: "2026-04-12", status: "revoked", calls: 4138, rateLimit: 5000 },
    { id: "ak-000007", name: "key-evid-007", created: "2026-04-21", lastUsed: "2026-04-06", status: "active", calls: 13244, rateLimit: 500 },
    { id: "ak-000008", name: "key-evid-008", created: "2026-01-01", lastUsed: "2026-04-15", status: "active", calls: 25721, rateLimit: 1000 },
  ];
  private _evidence_colApiHealthSummary() {
    const eps = this._evidence_colApiEndpoints;
  ...
  private _evidence_colGetApiByMethod(method: string) { return this._evidence_colApiEndpoints.filter(e=>e.method===method); }
  private _evidence_colGetSlowEndpoints() { return this._evidence_colApiEndpoints.filter(e=>e.avgLatency>200).sort((a,b)=>b.avgLatency-a.avgLatency); }
  private _evidence_colGetHighErrorEndpoints() { return this._evidence_colApiEndpoints.filter(e=>e.errorRate>1.0).sort((a,b)=>b.errorRate-a.errorRate); }

  // === Security Training Effectiveness (evidence_col) ===
  private _evidence_colTrainingModules = [
    { id: "TRN-001", name: "Security Fundamentals", completionRate: 64.7, avgScore: 58.4, behaviorChange: 51.9, enrolled: 296, completed: 35, duration: "98min", category: "mandatory" },
    { id: "TRN-002", name: "Phishing Awareness", completionRate: 70.6, avgScore: 71.9, behaviorChange: 32.1, enrolled: 311, completed: 80, duration: "118min", category: "mandatory" },
    { id: "TRN-003", name: "Social Engineering Defense", completionRate: 45.7, avgScore: 59.3, behaviorChange: 87.2, enrolled: 288, completed: 57, duration: "97min", category: "optional" },
    { id: "TRN-004", name: "Password Hygiene", completionRate: 49.0, avgScore: 82.1, behaviorChange: 79.2, enrolled: 320, completed: 288, duration: "95min", category: "mandatory" },
    { id: "TRN-005", name: "Data Classification", completionRate: 59.1, avgScore: 74.8, behaviorChange: 84.2, enrolled: 311, completed: 129, duration: "30min", category: "mandatory" },
    { id: "TRN-006", name: "Incident Response Basics", completionRate: 63.8, avgScore: 87.1, behaviorChange: 51.3, enrolled: 163, completed: 121, duration: "46min", category: "mandatory" },
    { id: "TRN-007", name: "Secure Coding", completionRate: 72.0, avgScore: 80.4, behaviorChange: 44.3, enrolled: 107, completed: 70, duration: "117min", category: "optional" },
    { id: "TRN-008", name: "Cloud Security", completionRate: 51.4, avgScore: 91.8, behaviorChange: 52.3, enrolled: 77, completed: 205, duration: "113min", category: "mandatory" },
    { id: "TRN-009", name: "Mobile Device Security", completionRate: 68.9, avgScore: 74.2, behaviorChange: 66.1, enrolled: 267, completed: 131, duration: "78min", category: "mandatory" },
    { id: "TRN-010", name: "Network Security", completionRate: 63.9, avgScore: 88.1, behaviorChange: 55.2, enrolled: 310, completed: 188, duration: "73min", category: "mandatory" },
    { id: "TRN-011", name: "Physical Security", completionRate: 48.1, avgScore: 84.5, behaviorChange: 87.8, enrolled: 160, completed: 437, duration: "63min", category: "optional" },
    { id: "TRN-012", name: "Regulatory Compliance", completionRate: 81.8, avgScore: 84.6, behaviorChange: 78.7, enrolled: 188, completed: 288, duration: "35min", category: "mandatory" },
    { id: "TRN-013", name: "Risk Management", completionRate: 77.7, avgScore: 63.4, behaviorChange: 46.6, enrolled: 91, completed: 134, duration: "86min", category: "mandatory" },
    { id: "TRN-014", name: "Cryptography Basics", completionRate: 75.1, avgScore: 85.7, behaviorChange: 52.2, enrolled: 292, completed: 389, duration: "18min", category: "mandatory" },
    { id: "TRN-015", name: "Access Control", completionRate: 75.9, avgScore: 83.3, behaviorChange: 59.4, enrolled: 72, completed: 358, duration: "75min", category: "optional" },
    { id: "TRN-016", name: "Vendor Management", completionRate: 57.9, avgScore: 57.6, behaviorChange: 49.0, enrolled: 343, completed: 72, duration: "51min", category: "mandatory" },
  ];
  private _evidence_colPhishingResults = [
    { month: "2026-01", sent: 454, clicked: 120, reported: 76, clickRate: round(26.431718061674008,1), reportRate: round(16.740088105726873,1) },
    { month: "2026-02", sent: 222, clicked: 36, reported: 87, clickRate: round(16.216216216216218,1), reportRate: round(39.189189189189186,1) },
    { month: "2026-03", sent: 655, clicked: 55, reported: 176, clickRate: round(8.396946564885496,1), reportRate: round(26.87022900763359,1) },
    { month: "2026-04", sent: 853, clicked: 246, reported: 277, clickRate: round(28.839390386869873,1), reportRate: round(32.4736225087925,1) },
    { month: "2026-05", sent: 769, clicked: 34, reported: 371, clickRate: round(4.421326397919375,1), reportRate: round(48.2444733420026,1) },
    { month: "2026-06", sent: 472, clicked: 66, reported: 228, clickRate: round(13.983050847457626,1), reportRate: round(48.30508474576271,1) },
  ];
  private _evidence_colTrainingROI = { totalInvestment: 55492, avgCostPerEmployee: 759, riskReductionPct: round(random.uniform(15,45),1), incidentReductionPct: round(random.uniform(10,35),1), complianceScoreGain: round(random.uniform(5,25),1) };
  private _evidence_colLearningPaths = [
    { name: "Beginner Security Analyst", totalModules: 8, completedModules: 16, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 10, enrolled: 152 },
    { name: "Advanced Threat Hunter", totalModules: 12, completedModules: 7, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 18, enrolled: 139 },
    { name: "Security Architect", totalModules: 15, completedModules: 2, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 25, enrolled: 195 },
    { name: "Incident Responder", totalModules: 14, completedModules: 11, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 15, enrolled: 187 },
    { name: "Compliance Specialist", totalModules: 8, completedModules: 11, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 43, enrolled: 113 },
    { name: "DevSecOps Engineer", totalModules: 9, completedModules: 10, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 70, enrolled: 40 },
  ];
  private _evidence_colGetOverallCompletion() {
    const mods = this._evidence_colTrainingModules;
    return round(mods.reduce((s,m)=>s+m.completionRate,0)/mods.length,1);
  }
  private _evidence_colGetTopPerformers() { return [...this._evidence_colTrainingModules].sort((a,b)=>b.avgScore-a.avgScore).slice(0,5); }
  private _evidence_colGetModulesNeedingAttention() { return this._evidence_colTrainingModules.filter(m=>m.completionRate<70||m.avgScore<65); }

  // === Security Governance Framework (evidence_col) ===
  private _evidence_colGovBodies = [
    { name: "Security Steering Committee", members: 11, chair: "CISO", meetingFreq: "Weekly", lastMeeting: "2026-04-16", nextMeeting: "2026-05-27", quorum: 6 },
    { name: "Risk Management Board", members: 8, chair: "CTO", meetingFreq: "Bi-weekly", lastMeeting: "2026-04-19", nextMeeting: "2026-05-01", quorum: 3 },
    { name: "Data Governance Council", members: 14, chair: "CRO", meetingFreq: "Monthly", lastMeeting: "2026-04-07", nextMeeting: "2026-05-08", quorum: 7 },
    { name: "Compliance Oversight Board", members: 7, chair: "CDO", meetingFreq: "Monthly", lastMeeting: "2026-04-05", nextMeeting: "2026-05-28", quorum: 8 },
    { name: "Architecture Review Board", members: 5, chair: "VP Eng", meetingFreq: "Bi-weekly", lastMeeting: "2026-04-05", nextMeeting: "2026-05-20", quorum: 6 },
    { name: "Change Advisory Board", members: 6, chair: "CISO", meetingFreq: "Weekly", lastMeeting: "2026-04-03", nextMeeting: "2026-05-22", quorum: 4 },
    { name: "Incident Review Board", members: 11, chair: "CIO", meetingFreq: "As needed", lastMeeting: "2026-04-21", nextMeeting: "2026-05-10", quorum: 7 },
    { name: "Vendor Risk Committee", members: 14, chair: "CFO", meetingFreq: "Quarterly", lastMeeting: "2026-04-20", nextMeeting: "2026-05-02", quorum: 3 },
  ];
  private _evidence_colDecisions = [
    { id: "DEC-0001", title: "Adopt zero-trust architecture framework", date: "2026-04-16", status: "approved", owner: "CISO" },
    ...
    { id: "DEC-0004", title: "Mandate MFA for all external access", date: "2026-03-10", status: "pending", owner: "CRO" },
    { id: "DEC-0005", title: "Establish bug bounty program", date: "2026-01-17", status: "approved", owner: "VP Eng" },
    { id: "DEC-0006", title: "Deploy EDR solution enterprise-wide", date: "2026-02-20", status: "approved", owner: "CISO" },
    { id: "DEC-0007", title: "Conduct annual penetration testing", date: "2026-03-26", status: "implemented", owner: "CTO" },
    ...
    { id: "DEC-0010", title: "Migrate to passwordless authentication", date: "2026-01-02", status: "approved", owner: "VP Eng" },
  ];
  private _evidence_colPolicyLifecycle = [
    { name: "Information Security Policy", version: "v2.0", status: "active", lastUpdated: "2026-02-01", nextReview: "2026-12-25", owner: "CISO" },
    { name: "Acceptable Use Policy", version: "v4.1", status: "active", lastUpdated: "2026-02-11", nextReview: "2026-7-25", owner: "Legal" },
    { name: "Data Retention Policy", version: "v2.2", status: "under-review", lastUpdated: "2026-01-02", nextReview: "2026-9-16", owner: "DPO" },
    { name: "Access Control Policy", version: "v2.1", status: "active", lastUpdated: "2026-01-09", nextReview: "2026-11-11", owner: "IAM Lead" },
    { name: "Incident Response Policy", version: "v1.1", status: "draft", lastUpdated: "2026-01-03", nextReview: "2026-8-19", owner: "IR Lead" },
    { name: "Business Continuity Plan", version: "v3.5", status: "active", lastUpdated: "2026-01-11", nextReview: "2026-11-11", owner: "BCP Mgr" },
    { name: "Vendor Management Policy", version: "v3.4", status: "active", lastUpdated: "2026-04-09", nextReview: "2026-12-02", owner: "Procurement" },
    { name: "Encryption Standard", version: "v3.3", status: "under-review", lastUpdated: "2026-01-16", nextReview: "2026-7-17", owner: "Security Arch" },
  ];
  private _evidence_colGovMaturityScore = { overall: 4.3, riskManagement: 4.5, compliance: 2.4, incidentResponse: 2.7, awareness: 2.5, technology: 5.4 };
  private _evidence_colGetPendingDecisions() { return this._evidence_colDecisions.filter(d=>d.status==='pending'||d.status==='in-progress'); }
  private _evidence_colGetActivePolicies() { return this._evidence_colPolicyLifecycle.filter(p=>p.status==='active'); }
  private _evidence_colGetEscalationPath() { return ["L1 Analyst","L2 Senior","Security Lead","CISO","Board"]; }

  // === Security Innovation Lab (evidence_col) ===
  private _evidence_colInnoProjects = [
    { id: "INN-001", name: "AI-Powered Threat Detection", description: "Machine learning models for real-time threat identification", status: "active", progress: 72, startDate: "2026-02-10", teamSize: 7, budget: 42429, milestones: 8, completedMilestones: 7 },
    { id: "INN-002", name: "Quantum-Resistant Cryptography", description: "Post-quantum encryption algorithm prototyping", status: "research", progress: 35, startDate: "2026-01-25", teamSize: 3, budget: 146743, milestones: 4, completedMilestones: 2 },
    { id: "INN-003", name: "Automated Red Teaming", description: "Autonomous penetration testing framework", status: "active", progress: 58, startDate: "2026-01-12", teamSize: 3, budget: 144458, milestones: 3, completedMilestones: 7 },
    { id: "INN-004", name: "Zero-Knowledge Authentication", description: "Privacy-preserving identity verification", status: "poc", progress: 88, startDate: "2026-03-22", teamSize: 4, budget: 107265, milestones: 3, completedMilestones: 5 },
    { id: "INN-005", name: "Blockchain Audit Trail", description: "Immutable security event logging", status: "active", progress: 45, startDate: "2026-03-16", teamSize: 8, budget: 37554, milestones: 6, completedMilestones: 9 },
    { id: "INN-006", name: "Behavioral Biometrics", description: "Continuous authentication via user behavior patterns", status: "research", progress: 22, startDate: "2026-03-23", teamSize: 3, budget: 160389, milestones: 4, completedMilestones: 8 },
    { id: "INN-007", name: "Deception Grid 2.0", description: "Advanced honeypot network with adaptive responses", status: "active", progress: 65, startDate: "2026-03-11", teamSize: 5, budget: 10367, milestones: 8, completedMilestones: 9 },
    { id: "INN-008", name: "Secure Enclave Integration", description: "Hardware-backed security for critical workloads", status: "poc", progress: 40, startDate: "2026-02-03", teamSize: 3, budget: 60107, milestones: 9, completedMilestones: 9 },
  ];
  private _evidence_colTechEvaluations = [
    { name: "Rust for Security Tools", status: "evaluating", score: 10.0, recommendation: "Adopt", vendor: "Open Source" },
    { name: "eBPF for Runtime Detection", status: "completed", score: 5.3, recommendation: "Adopt", vendor: "AWS" },
    { name: "Confidential Computing", status: "planned", score: 5.6, recommendation: "Investigate", vendor: "Azure" },
    { name: "Homomorphic Encryption", status: "evaluating", score: 5.2, recommendation: "Pilot", vendor: "GCP" },
    { name: "SASE Architecture", status: "completed", score: 4.6, recommendation: "Adopt", vendor: "Multiple" },
    { name: "SOAR Platform 3.0", status: "planned", score: 10.6, recommendation: "Monitor", vendor: "Splunk" },
  ];
  private _evidence_colCollaborationPartners = [
  ...
  private _evidence_colInnoMetrics = { totalProjects: 8, activeProjects: 4, avgTimeToValue: "102 days", pocSuccessRate: round(random.uniform(55,85),1), researchToProduction: round(random.uniform(20,50),1), innovationIndex: round(random.uniform(6.0,9.5),1) };
  private _evidence_colGetProjectByStatus(status: string) { return this._evidence_colInnoProjects.filter(p=>p.status===status); }
  private _evidence_colGetTopEvaluations() { return [...this._evidence_colTechEvaluations].sort((a,b)=>b.score-a.score).slice(0,3); }



  // === Compliance Dashboard Extension (evidence_col) ===
  private _evidence_colComplianceFrameworks = [
    { name: "SOC 2 Type II", description: "Trust Services Criteria", totalControls: 5, implementedControls: 5, status: "partially-compliant", lastAudit: "2026-03-02", nextAudit: "2026-9-02", evidenceCount: 307 },
    { name: "ISO 27001", description: "Information Security Management", totalControls: 114, implementedControls: 111, status: "compliant", lastAudit: "2026-01-02", nextAudit: "2026-9-02", evidenceCount: 403 },
    { name: "PCI DSS 4.0", description: "Payment Card Industry", totalControls: 12, implementedControls: 12, status: "in-review", lastAudit: "2026-02-26", nextAudit: "2026-12-26", evidenceCount: 216 },
    { name: "HIPAA", description: "Health Insurance Portability", totalControls: 18, implementedControls: 16, status: "compliant", lastAudit: "2026-04-12", nextAudit: "2026-11-04", evidenceCount: 479 },
    { name: "GDPR", description: "Data Protection Regulation", totalControls: 99, implementedControls: 66, status: "compliant", lastAudit: "2026-04-14", nextAudit: "2026-8-18", evidenceCount: 96 },
    { name: "NIST CSF 2.0", description: "Cybersecurity Framework", totalControls: 6, implementedControls: 5, status: "non-compliant", lastAudit: "2026-02-06", nextAudit: "2026-10-26", evidenceCount: 472 },
    { name: "FedRAMP", description: "Federal Risk Authorization", totalControls: 15, implementedControls: 7, status: "non-compliant", lastAudit: "2026-03-16", nextAudit: "2026-10-11", evidenceCount: 478 },
    { name: "SOX", description: "Sarbanes-Oxley Compliance", totalControls: 8, implementedControls: 4, status: "compliant", lastAudit: "2026-04-20", nextAudit: "2026-12-19", evidenceCount: 195 },
    { name: "CIS Controls v8", description: "Center for Internet Security", totalControls: 18, implementedControls: 17, status: "partially-compliant", lastAudit: "2026-03-23", nextAudit: "2026-7-10", evidenceCount: 370 },
    { name: "COBIT 2019", description: "IT Governance Framework", totalControls: 40, implementedControls: 39, status: "compliant", lastAudit: "2026-01-23", nextAudit: "2026-7-06", evidenceCount: 255 },
  ];
  private _evidence_colGetComplianceScore() {
    const fw = this._evidence_colComplianceFrameworks;
    return round(fw.reduce((s,f)=>s + (f.implementedControls/Math.max(f.totalControls,1))*100, 0) / fw.length, 1);
  }
  private _evidence_colGetGaps() {
    return this._evidence_colComplianceFrameworks.filter(f => f.status !== "compliant");
  }
  private _evidence_colAuditTrail = [
    { id: "AUD-0001", action: "Control tested", auditor: "Internal Audit", date: "2026-04-02", result: "pass", findings: 5 },
    { id: "AUD-0002", action: "Evidence collected", auditor: "External Auditor", date: "2026-04-07", result: "pass", findings: 2 },
    { id: "AUD-0003", action: "Gap identified", auditor: "Security Team", date: "2026-04-14", result: "fail", findings: 1 },
    { id: "AUD-0004", action: "Remediation completed", auditor: "Compliance Officer", date: "2026-04-22", result: "pass", findings: 2 },
    { id: "AUD-0005", action: "Policy updated", auditor: "IT Audit", date: "2026-04-22", result: "pass", findings: 4 },
    { id: "AUD-0006", action: "Training verified", auditor: "Risk Team", date: "2026-04-08", result: "pass", findings: 2 },
    { id: "AUD-0007", action: "Access reviewed", auditor: "QA Team", date: "2026-04-12", result: "pass", findings: 4 },
    { id: "AUD-0008", action: "Exception approved", auditor: "CISO Office", date: "2026-04-19", result: "conditional", findings: 0 },
    { id: "AUD-0009", action: "Risk accepted", auditor: "Board Audit", date: "2026-04-02", result: "pass", findings: 2 },
    { id: "AUD-0010", action: "Control enhanced", auditor: "Third Party", date: "2026-04-10", result: "pass", findings: 2 },
  ];

  // === Threat Intelligence Feed Extension (evidence_col) ===
  private _evidence_colThreatActors = [
    { name: "APT-29", alias: "Cozy Bear", origin: "Russia", type: "Nation-State", severity: "high", lastActivity: "2026-04-10", targets: "Finance", indicators: 362, ttps: 45 },
    { name: "APT-41", alias: "Double Dragon", origin: "China", type: "Nation-State", severity: "critical", lastActivity: "2026-04-23", targets: "Manufacturing", indicators: 43, ttps: 39 },
    { name: "Lazarus Group", alias: "Hidden Cobra", origin: "North Korea", type: "Nation-State", severity: "critical", lastActivity: "2026-04-18", targets: "Finance", indicators: 251, ttps: 24 },
    { name: "FIN7", alias: "Carbanak", origin: "Eastern Europe", type: "Financial", severity: "high", lastActivity: "2026-04-11", targets: "Manufacturing", indicators: 478, ttps: 38 },
    { name: "Conti", alias: "Wizard Spider", origin: "Russia", type: "Ransomware", severity: "critical", lastActivity: "2026-04-11", targets: "Healthcare", indicators: 176, ttps: 23 },
    { name: "LockBit", alias: "LockBit Gang", origin: "Unknown", type: "Ransomware", severity: "high", lastActivity: "2026-04-12", targets: "Government", indicators: 394, ttps: 11 },
    { name: "Cl0p", alias: "Cl0p Team", origin: "Unknown", type: "Ransomware", severity: "high", lastActivity: "2026-04-14", targets: "Government", indicators: 328, ttps: 25 },
    { name: "Sandworm", alias: "Unit 74455", origin: "Russia", type: "Nation-State", severity: "critical", lastActivity: "2026-04-04", targets: "Finance", indicators: 104, ttps: 13 },
  ];
  private _evidence_colIoCFeed = [
    { id: "ioc-000001", type: "ip", value: "232.0.45.63", confidence: 97, source: "VirusTotal", firstSeen: "2026-04-04", lastSeen: "2026-04-07" },
    { id: "ioc-000002", type: "ip", value: "13.56.236.208", confidence: 69, source: "MISP", firstSeen: "2026-04-03", lastSeen: "2026-04-02" },
    { id: "ioc-000003", type: "ip", value: "222.165.1.66", confidence: 96, source: "CrowdStrike", firstSeen: "2026-04-09", lastSeen: "2026-04-08" },
    { id: "ioc-000004", type: "ip", value: "131.71.197.95", confidence: 71, source: "AlienVault", firstSeen: "2026-04-11", lastSeen: "2026-04-21" },
    { id: "ioc-000005", type: "ip", value: "50.73.191.248", confidence: 57, source: "STIX", firstSeen: "2026-04-17", lastSeen: "2026-04-16" },
    { id: "ioc-000006", type: "ip", value: "9.193.207.247", confidence: 96, source: "Mandiant", firstSeen: "2026-04-01", lastSeen: "2026-04-14" },
    { id: "ioc-000007", type: "ip", value: "249.133.195.169", confidence: 93, source: "MISP", firstSeen: "2026-04-21", lastSeen: "2026-04-15" },
    { id: "ioc-000008", type: "ip", value: "96.53.76.40", confidence: 87, source: "CrowdStrike", firstSeen: "2026-04-11", lastSeen: "2026-04-02" },
    { id: "ioc-000009", type: "ip", value: "65.7.68.84", confidence: 92, source: "STIX", firstSeen: "2026-04-01", lastSeen: "2026-04-20" },
    { id: "ioc-000010", type: "ip", value: "129.23.226.26", confidence: 75, source: "MISP", firstSeen: "2026-04-17", lastSeen: "2026-04-16" },
    { id: "ioc-000011", type: "ip", value: "184.18.206.36", confidence: 46, source: "STIX", firstSeen: "2026-04-21", lastSeen: "2026-04-09" },
    { id: "ioc-000012", type: "ip", value: "104.212.163.128", confidence: 79, source: "STIX", firstSeen: "2026-04-02", lastSeen: "2026-04-19" },
    { id: "ioc-000013", type: "ip", value: "7.164.155.36", confidence: 54, source: "STIX", firstSeen: "2026-04-18", lastSeen: "2026-04-01" },
    { id: "ioc-000014", type: "ip", value: "70.247.135.232", confidence: 65, source: "Mandiant", firstSeen: "2026-04-10", lastSeen: "2026-04-03" },
    { id: "ioc-000015", type: "ip", value: "124.246.10.210", confidence: 79, source: "MISP", firstSeen: "2026-04-22", lastSeen: "2026-04-07" },
  ];
  private _evidence_colGetActiveThreats() { return this._evidence_colThreatActors.filter(a => a.severity === 'critical'); }
  private _evidence_colGetThreatSummary() {
    const actors = this._evidence_colThreatActors;
  ...
  // === Incident Management Extension (evidence_col) ===
  private _evidence_colIncidents = [
    { id: "INC-20260001", title: "Unauthorized access detected", severity: "critical", status: "open", assignedTo: "SOC L1", detectedAt: "2026-04-04T06:40", affectedAssets: 14, rootCause: "Misconfiguration" },
    { id: "INC-20260002", title: "Malware outbreak on workstation", severity: "high", status: "investigating", assignedTo: "SOC L2", detectedAt: "2026-04-14T05:07", affectedAssets: 25, rootCause: "Credential compromise" },
    { id: "INC-20260003", title: "Data leak from S3 bucket", severity: "medium", status: "contained", assignedTo: "IR Lead", detectedAt: "2026-04-21T10:45", affectedAssets: 29, rootCause: "Zero-day" },
    { id: "INC-20260004", title: "Phishing campaign targeting finance", severity: "low", status: "eradicated", assignedTo: "CISO", detectedAt: "2026-04-17T23:23", affectedAssets: 23, rootCause: "Human error" },
    { id: "INC-20260005", title: "DDoS attack on web services", severity: "critical", status: "recovered", assignedTo: "Security Eng", detectedAt: "2026-04-19T21:12", affectedAssets: 42, rootCause: "Policy violation" },
    { id: "INC-20260006", title: "Ransomware encryption attempt", severity: "high", status: "closed", assignedTo: "Forensics", detectedAt: "2026-04-20T23:50", affectedAssets: 33, rootCause: "Unknown" },
    { id: "INC-20260007", title: "Insider data exfiltration", severity: "medium", status: "open", assignedTo: "SOC L1", detectedAt: "2026-04-14T17:36", affectedAssets: 38, rootCause: "Misconfiguration" },
    { id: "INC-20260008", title: "API key exposure in repo", severity: "low", status: "investigating", assignedTo: "SOC L2", detectedAt: "2026-04-03T00:11", affectedAssets: 20, rootCause: "Credential compromise" },
    { id: "INC-20260009", title: "SQL injection on portal", severity: "critical", status: "contained", assignedTo: "IR Lead", detectedAt: "2026-04-06T00:53", affectedAssets: 29, rootCause: "Zero-day" },
    { id: "INC-20260010", title: "Brute force on VPN", severity: "high", status: "eradicated", assignedTo: "CISO", detectedAt: "2026-04-03T19:31", affectedAssets: 5, rootCause: "Human error" },
    { id: "INC-20260011", title: "Supply chain alert from vendor", severity: "medium", status: "recovered", assignedTo: "Security Eng", detectedAt: "2026-04-06T05:33", affectedAssets: 1, rootCause: "Policy violation" },
    { id: "INC-20260012", title: "Suspicious lateral movement", severity: "low", status: "closed", assignedTo: "Forensics", detectedAt: "2026-04-22T21:17", affectedAssets: 44, rootCause: "Unknown" },
  ];
  private _evidence_colGetIncidentStats() {
    const inc = this._evidence_colIncidents;
    return { total: inc.length, open: inc.filter(i=>i.status==="open").length, investigating: inc.filter(i=>i.status==="investigating").length, mttd: 43, mttr: 171 };
  }
  private _evidence_colGetSeverityDistribution() {
    const inc = this._evidence_colIncidents;
  ...
  render() {    if (this._evcRules.length === 0) { this._initEvcRules(); this._initEvcCvss(); this._runEvcAnomalyDetection(); this._generateEvcPredictions(); this._initEvcApprovals(); this._initEvcActivity(); this._initEvcNotifications(); }
...
<div class="tabs">
        ...
        ${this._activeTab === 'rules' ? html`
          ${this._renderEvcRules()}
          <div style="margin-top:12px;font-size:11px;font-weight:600;margin-bottom:6px">Category Treemap</div>
          <div style="background:#1a1d27;border-radius:8px;padding:12px">${this._renderEvcTreemapSVG()}</div>
          <div style="margin-top:12px;font-size:11px;font-weight:600;margin-bottom:6px">Data Flow (Sankey)</div>
          <div style="background:#1a1d27;border-radius:8px;padding:12px">${this._renderEvcSankeySVG()}</div>
          ${this._renderEvcActivity()}
        ` : nothing}
        ${this._activeTab === 'anomalies' ? html`
          ${this._renderEvcAnomalies()}
          ${this._renderEvcNotifications()}
        ` : nothing}
        ${this._activeTab === 'predictions' ? html`
          ${this._renderEvcPredictions()}
          ...
          <div style="background:#1a1d27;border-radius:8px;padding:12px">
            <table class="history-table"><thead><tr><th>ID</th><th>Base</th><th>Temporal</th><th>Environmental</th><th>Overall</th></tr></thead><tbody>
              ${this._evccvssData.map(c => html`<tr><td>${c.itemId}</td><td style="color:${c.base >= 7 ? '#ef4444' : c.base >= 4 ? '#eab308' : '#22c55e'}">${c.base}</td><td>${c.temporal}</td><td>${c.environmental}</td><td style="font-weight:700;color:${c.overall >= 7 ? '#ef4444' : c.overall >= 4 ? '#eab308' : '#22c55e'}">${c.overall}</td></tr>`)}
            </tbody></table>
          </div>
        ` : nothing}
        ${this._activeTab === 'approvals' ? html`
          ${this._renderEvcApprovals()}
        ` : nothing}
        ${this._activeTab === 'config' ? html`
          ${this._renderEvcConfig()}
        ` : nothing}
        ${this._activeTab === 'new' ? html`
          <div class="form-section">
            <div class="form-title">Create New Evidence Collector Entry</div>
            <div class="form-grid">
  ...
  @state() private _ecScenarios: {id:string;name:string;attackType:string;target:string;method:string;impactLow:number;impactHigh:number;confidence:number;mitigation:string;status:string}[] = [];
  @state() private _ecScenarioForm: {attackType:string;target:string;method:string} = {attackType:'',target:'',method:''};
  @state() private _ecScenarioCompare: boolean = false;
  @state() private _ecScenarioSelected: string[] = [];

  private _ecInitScenarios(): void {
    const saved = localStorage.getItem('ec_scenarios');
    if (saved) { try { this._ecScenarios = JSON.parse(saved); } catch { /* ignore */ } }
    if (this._ecScenarios.length === 0) {
      this._ecScenarios = [
        {id:'ec-s1',name:'Baseline Threat',attackType:'Phishing',target:'Employees',method:'Spear Email',impactLow:45,impactHigh:78,confidence:72,mitigation:'Security awareness training + email filtering',status:'active'},
        {id:'ec-s2',name:'Escalated Attack',attackType:'Ransomware',target:'Endpoints',method:'Drive-by Download',impactLow:65,impactHigh:95,confidence:58,mitigation:'EDR deployment + network segmentation',status:'saved'},
        {id:'ec-s3',name:'Insider Threat',attackType:'Data Exfiltration',target:'Databases',method:'SQL Injection',impactLow:55,impactHigh:88,confidence:65,mitigation:'DLP policies + query monitoring',status:'draft'},
      ];
    }
  }

  private _ecSaveScenarios(): void {
    localStorage.setItem('ec_scenarios', JSON.stringify(this._ecScenarios));
  }

  private _ecAddScenario(): void {
    const f = this._ecScenarioForm;
    if (!f.attackType || !f.target) return;
    this._ecScenarios = [...this._ecScenarios, {
      id: 'ec-s' + (this._ecScenarios.length + 1),
    ...
    this._ecScenarioForm = {attackType:'',target:'',method:''};
    this._ecSaveScenarios();
  }

  private _ecRenderScenarioEngine(): any {
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <button class="tab" @click=${() => { this._ecScenarioCompare = !this._ecScenarioCompare; }}>${this._ecScenarioCompare ? 'List View' : 'Compare'}</button>
        </div>
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:6px;margin-bottom:10px">
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._ecScenarioForm = {...this._ecScenarioForm, attackType: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Attack Type</option>
            ${attackTypes.map(a => html`<option value=${a} ${this._ecScenarioForm.attackType === a ? 'selected' : ''}>${a}</option>`)}
          </select>
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._ecScenarioForm = {...this._ecScenarioForm, target: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Target</option>
            ${targets.map(t => html`<option value=${t} ${this._ecScenarioForm.target === t ? 'selected' : ''}>${t}</option>`)}
          </select>
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._ecScenarioForm = {...this._ecScenarioForm, method: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Method</option>
            ${methods.map(m => html`<option value=${m} ${this._ecScenarioForm.method === m ? 'selected' : ''}>${m}</option>`)}
          </select>
        </div>
        <button style="background:#3b82f6;border:none;border-radius:4px;padding:4px 12px;color:#fff;font-size:11px;cursor:pointer" @click=${this._ecAddScenario}>Run Simulation</button>
      </div>
      ${this._ecScenarioCompare && this._ecScenarios.length >= 2 ? html`
        <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
          <div style="font-weight:600;font-size:12px;color:#e2e8f0;margin-bottom:8px">Side-by-Side Comparison</div>
          <div style="display:grid;grid-template-columns:repeat(${Math.min(3, this._ecScenarios.length)},1fr);gap:8px">
            ${this._ecScenarios.slice(0,3).map(s => html`
      ...
      <div style="background:#0f1117;border-radius:8px;padding:12px">
        <div style="font-weight:600;font-size:12px;color:#e2e8f0;margin-bottom:8px">Saved Scenarios (${this._ecScenarios.length})</div>
        ${this._ecScenarios.map(s => html`
  ...
  @state() private _ecTrendData: {day:number;value:number;anomaly:boolean}[] = [];
  @state() private _ecTrendZoom: {start:number;end:number} | null = null;
  @state() private _ecTrendMA: number = 7;

  private _ecInitTrendData(): void {
    ...
    this._ecTrendData = data;
  }

  private _ecCalcMA(window: number): number[] {
    const result: number[] = [];
    for (let i = 0; i < this._ecTrendData.length; i++) {
      const start = Math.max(0, i - window + 1);
      const slice = this._ecTrendData.slice(start, i + 1);
      result.push(slice.reduce((s, d) => s + d.value, 0) / slice.length);
    }
    return result;
  }

  private _ecGetStats(): {mean:number;median:number;stddev:number;trend:string} {
    const vals = this._ecTrendData.map(d => d.value);
    const n = vals.length;
  ...
  private _ecRenderTimeSeries(): any {
    const stats = this._ecGetStats();
    const filtered = this._ecTrendZoom ? this._ecTrendData.filter(d => d.day >= this._ecTrendZoom.start && d.day <= this._ecTrendZoom.end) : this._ecTrendData;
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px">
            <button class="tab ${this._ecTrendMA === 7 ? 'active' : ''}" @click=${() => { this._ecTrendMA = 7; }}>7D MA</button>
            <button class="tab ${this._ecTrendMA === 30 ? 'active' : ''}" @click=${() => { this._ecTrendMA = 30; }}>30D MA</button>
            <button class="tab" @click=${() => { this._ecTrendZoom = null; }}>Reset Zoom</button>
          </div>
        </div>
        <div style="position:relative;height:120px;background:#1a1d2e;border-radius:6px;overflow:hidden;margin-bottom:8px;cursor:crosshair" @click=${(e: any) => {
          ...
          this._ecTrendZoom = { start: Math.max(0, center - 10), end: Math.min(89, center + 10) };
        }}>
  ...
  @state() private _ecRoles: string[] = ['Admin','Analyst','Operator','Viewer','Auditor'];
  @state() private _ecActions: string[] = ['Create','Read','Update','Delete','Export','Approve'];
  @state() private _ecPermissions: { [role: string]: { [action: string]: boolean } } = {};
  @state() private _ecPermAudit: {role:string;action:string;changedBy:string;timestamp:string;oldVal:boolean;newVal:boolean}[] = [];
  @state() private _ecPermCompare: string[] = [];

  private _ecInitPermissions(): void {
    ...
    for (const role of this._ecRoles) {
      perms[role] = {};
      this._ecActions.forEach((a, i) => { perms[role][a] = defaults[role]?.[i] ?? false; });
    }
    this._ecPermissions = perms;
  }

  private _ecTogglePermission(role: string, action: string): void {
    const old = this._ecPermissions[role][action];
    this._ecPermissions = {...this._ecPermissions, [role]: {...this._ecPermissions[role], [action]: !old}};
    this._ecPermAudit.unshift({role,action,changedBy:'current_user',timestamp:new Date().toISOString(),oldVal:old,newVal:!old});
  }

  private _ecRenderRBAC(): any {
    const compareRoles = this._ecPermCompare.map(r => this._ecPermissions[r]).filter(Boolean);
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          <span style="font-weight:700;font-size:13px;color:#e2e8f0">RBAC Permission Matrix</span>
          <div style="display:flex;gap:4px">
            ${this._ecRoles.map(r => html`
              <button class="tab ${this._ecPermCompare.includes(r) ? 'active' : ''}" @click=${() => {
                this._ecPermCompare = this._ecPermCompare.includes(r) ? this._ecPermCompare.filter(x => x !== r) : [...this._ecPermCompare, r];
              }}>${r}</button>
            `)}
          </div>
        </div>
          ...
          <table style="width:100%;border-collapse:collapse;font-size:10px">
            <thead>
              <tr>
                ...
                ${this._ecActions.map(a => html`<th style="padding:6px;color:#6b7280;border-bottom:1px solid #2a2d3a;text-align:center">${a}</th>`)}
              </tr>
            </thead>
            <tbody>
              ${this._ecRoles.map(role => html`
                <tr style="border-bottom:1px solid #1a1d2e">
                  <td style="padding:6px;color:#e2e8f0;font-weight:600">${role}</td>
                  ${this._ecActions.map(action => html`
                    <td style="text-align:center;padding:6px">
                      <button style="width:28px;height:20px;border-radius:3px;border:1px solid #2a2d3a;background:${this._ecPermissions[role][action] ? '#22c55e' : '#1a1d2e'};cursor:pointer;color:#fff;font-size:10px" @click=${() => this._ecTogglePermission(role, action)}>${this._ecPermissions[role][action] ? 'Y' : 'N'}</button>
                    </td>
                  `)}
                </tr>
              `)}
        ...
        ${compareRoles.length >= 2 ? html`
          <div style="margin-top:10px;padding:8px;background:#1a1d2e;border-radius:6px">
            <div style="font-size:11px;font-weight:600;color:#e2e8f0;margin-bottom:6px">Role Diff: ${this._ecPermCompare.join(' vs ')}</div>
            ${this._ecActions.map(action => {
              ...
              return allSame ? nothing : html`
                <div style="display:flex;gap:8px;padding:3px 0;font-size:10px">
                  ...
                  ${compareRoles.map((r, i) => html`<span style="color:${r[action] ? '#22c55e' : '#ef4444'}">${this._ecPermCompare[i]}=${r[action] ? 'Y' : 'N'}</span>`)}
                </div>
              `;
            })}
          </div>
        ` : nothing}
        ${this._ecPermAudit.length > 0 ? html`
          <div style="margin-top:8px;font-size:9px;color:#6b7280">Recent: ${this._ecPermAudit.slice(0,3).map(a => html`<span style="margin-right:8px">${a.role}.${a.action}: ${a.oldVal ? 'Y' : 'N'}->${a.newVal ? 'Y' : 'N'}</span>`)}
        ` : nothing}
      </div>
    `;
  }
  ...
  // === REPORTING SUITE ===
  @state() private _ecReportTemplate: string = 'executive';
  @state() private _ecReportSchedule: string = 'weekly';
  @state() private _ecReportDistList: string[] = ['security-team@company.com','ciso@company.com'];
  @state() private _ecReportHistory: {id:string;template:string;generatedAt:string;status:string}[] = [];

  private _ecGenerateReport(): void {
    const id = 'rpt-' + Date.now();
    this._ecReportHistory.unshift({id,template:this._ecReportTemplate,generatedAt:new Date().toISOString(),status:'sent'});
  }

  private _ecRenderReporting(): any {
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:8px">
          <div>
            ...
            ${templates.map(t => html`
              <div style="padding:6px;background:${this._ecReportTemplate === t.key ? '#1e3a5f' : '#1a1d2e'};border:1px solid ${this._ecReportTemplate === t.key ? '#3b82f6' : '#2a2d3a'};border-radius:4px;margin-bottom:4px;cursor:pointer" @click=${() => { this._ecReportTemplate = t.key; }}>
          ...
          <div>
            ...
            <div style="display:flex;gap:4px;margin-bottom:8px">
              ${schedules.map(s => html`<button class="tab ${this._ecReportSchedule === s.key ? 'active' : ''}" @click=${() => { this._ecReportSchedule = s.key; }}>${s.label}</button>`)}
            </div>
            <div style="font-size:10px;color:#6b7280;margin-bottom:4px">Distribution</div>
            <div style="font-size:10px;color:#9ca3af">${this._ecReportDistList.map(d => html`<div>${d}</div>`)}</div>
            <div style="margin-top:6px;display:flex;gap:4px">
              <button style="background:#3b82f6;border:none;border-radius:4px;padding:4px 10px;color:#fff;font-size:10px;cursor:pointer" @click=${this._ecGenerateReport}>Generate</button>
        ...
        ${this._ecReportHistory.length > 0 ? html`
          <div style="border-top:1px solid #2a2d3a;padding-top:8px">
            ...
            ${this._ecReportHistory.slice(0,3).map(r => html`
  ...
  @state() private _ecHighContrast: boolean = false;
  @state() private _ecA11yAnnounce: string = '';
  @state() private _ecShortcutsVisible: boolean = false;
  @state() private _ecFocusTrap: boolean = false;

  private _ecShortcuts: Record<string, string> = {
  ...
  private _ecHandleKeydown(e: KeyboardEvent): void {
    if (e.key === 'Escape' && this._ecFocusTrap) { this._ecFocusTrap = false; this._ecAnnounce('Dialog closed'); }
    if (e.ctrlKey && e.shiftKey && e.key === 'H') { e.preventDefault(); this._ecHighContrast = !this._ecHighContrast; this._ecAnnounce('High contrast ' + (this._ecHighContrast ? 'enabled' : 'disabled')); }
    if (e.ctrlKey && e.shiftKey && e.key === 'A') { e.preventDefault(); this._ecShortcutsVisible = !this._ecShortcutsVisible; }
  }

  private _ecAnnounce(msg: string): void {
    this._ecA11yAnnounce = msg;
    setTimeout(() => { this._ecA11yAnnounce = ''; }, 2000);
  }

  private _ecRenderAccessibility(): any {
    return html`
      <div role="region" aria-label="Accessibility Controls" style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <button class="tab ${this._ecShortcutsVisible ? 'active' : ''}" @click=${() => { this._ecShortcutsVisible = !this._ecShortcutsVisible; }} aria-expanded=${this._ecShortcutsVisible}>Shortcuts</button>
        </div>
        <div style="display:flex;gap:8px;margin-bottom:8px">
          <label style="display:flex;align-items:center;gap:6px;font-size:11px;color:#e2e8f0;cursor:pointer">
            <input type="checkbox" .checked=${this._ecHighContrast} @change=${() => { this._ecHighContrast = !this._ecHighContrast; }} aria-label="Toggle high contrast mode">
            High Contrast
          </label>
        </div>
        ${this._ecShortcutsVisible ? html`
          <div role="list" aria-label="Keyboard shortcuts" style="background:#1a1d2e;border-radius:6px;padding:8px">
            ${Object.entries(this._ecShortcuts).map(([key, desc]) => html`
        ...
        ` : nothing}
        <div role="status" aria-live="polite" aria-atomic="true" style="position:absolute;left:-9999px">${this._ecA11yAnnounce}</div>
      </div>
    `;
  }
  ...
  connectedCallback(): void {
    ...
    this._ecInitScenarios();
    this._ecInitTrendData();
    this._ecInitPermissions();
    document.addEventListener('keydown', this._ecHandleKeydown.bind(this));
  }

  disconnectedCallback(): void {
    super.disconnectedCallback();
    document.removeEventListener('keydown', this._ecHandleKeydown.bind(this));
  }

  // === TAB INTEGRATION FOR EXTENDED FEATURES ===
  @state() private _ecActiveSubTab: string = 'scenario';
  ...
  private _ecGetAllSubTabs(): {key:string;label:string}[] {
    return [
  ...
  private _ecRenderSubPanel(): any {
    switch (this._ecActiveSubTab) {
      case 'scenario': return this._ecRenderScenarioEngine();
      case 'timeseries': return this._ecRenderTimeSeries();
      case 'rbac': return this._ecRenderRBAC();
      case 'reporting': return this._ecRenderReporting();
      case 'a11y': return this._ecRenderAccessibility();
      default: return nothing;
    }
  }

  private _ecRenderTabBar(): any {
    return html`
      <div style="display:flex;gap:4px;margin-bottom:12px;border-bottom:1px solid #2a2d3a;padding-bottom:8px;flex-wrap:wrap" role="tablist" aria-label="Extended panel features">
        ${this._ecGetAllSubTabs().map(t => html`
          <button class="tab ${this._ecActiveSubTab === t.key ? 'active' : ''}" @click=${() => { this._ecActiveSubTab = t.key; }} role="tab" aria-selected=${this._ecActiveSubTab === t.key}>${t.label}</button>
        `)}
      </div>
      <div role="tabpanel" aria-labelledby="ec-tab-${this._ecActiveSubTab}">
        ${this._ecRenderSubPanel()}
      </div>
    `;
  }
  ...
  @state() private _soarPlaybooks: Array<{
    ...
    {
      id: 'pb-soar-001', name: 'Evidence Collector Auto Response', status: 'active',
      steps: [
    ...
    {
      id: 'pb-soar-002', name: 'Evidence Collector Investigation Workflow', status: 'active',
      steps: [
    ...
    {
      id: 'pb-soar-003', name: 'Evidence Collector Compliance Scan', status: 'draft',
      steps: [
  ...
  @state() private _ecAle: number = 0;
  @state() private _ecSroi: number = 0;
  @state() private _ecCpi: number = 0;
  @state() private _ecBudgetAlloc: number = 0;
  @state() private _ecCostBenefit: number = 0;

  // Security Economics Calculator
  private ecInitEconomics() {
    this._ecAle = Math.round(2850000 + Math.random() * 4500000);
    this._ecSroi = Math.round(180 + Math.random() * 320);
    this._ecCpi = Math.round(45000 + Math.random() * 120000);
    this._ecBudgetAlloc = Math.round(2500000 + Math.random() * 3000000);
    this._ecCostBenefit = Math.round(220 + Math.random() * 180);
  }

  private _ecCalcAle(): { annual: number; perIncident: number; byCategory: Array<{name: string; value: number}> } {
    const base = this._ecAle;
    const categories = [
  ...
  private _ecCalcSroi(): Array<{year: number; investment: number; savings: number; roi: number}> {
    const baseInv = this._ecSroi * 10000;
  ...
  private _ecGetBudgetAlloc(): Array<{category: string; amount: number; pct: number; trend: string}> {
    const total = this._ecBudgetAlloc;
    const items = [
  ...
  private _ecGetCostBenefit(): Array<{control: string; cost: number; benefit: number; ratio: number; priority: string}> {
    const base = this._ecCostBenefit;
    const controls = [
  ...
  private _ecRenderEconomics() {
    const ale = this._ecCalcAle();
    const roi = this._ecCalcSroi();
    const budget = this._ecGetBudgetAlloc();
    const cb = this._ecGetCostBenefit();
    const cpi = this._ecCpi;
  ...
  @state() private _ecThreatLevel: any = null;
  @state() private _ecEmergingThreats: any = null;
  @state() private _ecThreatTrends: any = null;
  @state() private _ecSectorRadar: any = null;
  @state() private _ecActorActivity: any = null;

  // Threat Landscape Intelligence
  private ecInitThreatIntel() {
    this._ecThreatLevel = {
  ...
  private _ecRenderThreatIntel() {
    const tl = this._ecThreatLevel;
    const et = this._ecEmergingThreats;
    const sr = this._ecSectorRadar;
    const aa = this._ecActorActivity;
  ...
  @state() private _ecPolicies: any = null;
  @state() private _ecExceptions: any = null;
  @state() private _ecRiskRegister: any = null;
  @state() private _ecMeetings: any = null;
  @state() private _ecDeadlines: any = null;

  // Security Governance Dashboard
  private ecInitGovernance() {
    this._ecPolicies = [
  ...
  private _ecRenderGovernance() {
    const policies = this._ecPolicies;
    const risks = this._ecRiskRegister;
    const deadlines = this._ecDeadlines;
  ...
  @state() private _ecCriticalAssets: any = null;
  @state() private _ecAssetDeps: any = null;
  @state() private _ecEolAssets: any = null;
  @state() private _ecAssetRisk: any = null;

  // Asset Intelligence
  private ecInitAssetIntel() {
    this._ecCriticalAssets = [
    ...
    this._ecAssetRisk = { critical: 7, high: 23, medium: 45, low: 128, total: 203 };
  }

  private _ecRenderAssetIntel() {
    const assets = this._ecCriticalAssets;
    const eol = this._ecEolAssets;
    const ar = this._ecAssetRisk;
  ...
  @state() private _ecUserBaseline: any = null;
  @state() private _ecAnomalyRules: any = null;
  @state() private _ecDataAccess: any = null;
  @state() private _ecInsiderRisk: any = null;
  @state() private _evidenr15Timeline: Array<{id:string;time:string;event:string;severity:string;actor:string}> = [
  ...
  @state() private _evidenr15RootCauses: Array<{why:string;answer:string}> = [
  ...
  @state() private _evidenr15ImpactMatrix: Array<{system:string;users:number;data:string;revenue:string;status:string}> = [
  ...
  @state() private _evidenr15Actions: Array<{id:string;item:string;owner:string;deadline:string;priority:string;status:string}> = [
  ...
  @state() private _evidenr15Lessons: Array<{id:string;lesson:string;category:string;severity:string;applies_to:string}> = [
  ...
  @state() private _evidenr15ActiveTab: string = 'timeline';
  @state() private _evidenr15Benchmarks: Array<{metric:string;current:number;industry:number;target:number;unit:string;source:string}> = [
  ...
  @state() private _evidenr15MaturityLevels: Array<{domain:string;current:number;target:number;description:string}> = [
  ...
  @state() private _evidenr15QuarterlyData: Array<{quarter:string;score:number;improvement:number}> = [
  ...
  @state() private _evidenr15SelectedDomain: string = 'all';
  @state() private _evidenr15Alerts: Array<{id:string;name:string;severity:number;confidence:number;assetCrit:number;score:number;enriched:boolean;group:string;status:string;enrichData:Array<{key:string;value:string}>}> = [
  ...
  @state() private _evidenr15QualityMetrics: {fpRate:number;enrichSuccess:number;avgTriageTime:number;enrichedCount:number;totalCount:number} = {fpRate:0.12, enrichSuccess:0.78, avgTriageTime:4.5, enrichedCount:3, totalCount:5};
  @state() private _evidenr15RoutingRules: Array<{name:string;condition:string;channel:string;active:boolean}> = [
  ...
  @state() private _evidenr15Shapes: Array<{id:string;type:string;label:string;controls:string[]}> = [
  ...
  @state() private _evidenr15TrustBoundaries: Array<{from:string;to:string;label:string;strength:string}> = [
  ...
  @state() private _evidenr15ADRs: Array<{id:string;title:string;status:string;date:string;decision:string}> = [
  ...
  @state() private _evidenr15SelectedShape: string = '';
  @state() private _evidenr15Gauges: Array<{name:string;value:number;max:number;unit:string;status:string;color:string}> = [
  ...
  @state() private _evidenr15Anomalies: Array<{id:string;time:string;description:string;severity:string;acknowledged:boolean}> = [
  ...
  @state() private _evidenr15Integrations: Array<{name:string;status:string;uptime:number;lastCheck:string;latency:number}> = [
  ...
  @state() private _evidenr15AlertFatigue: Array<{analyst:string;alertsPerDay:number;escalated:number;dismissed:number;avgResponseMin:number}> = [
  ...
  @state() private _evidenr15SlaTarget: number = 99.9;

  // Insider Threat Detection
  private ecInitInsiderThreat() {
    this._ecUserBaseline = [
    ...
    this._ecInsiderRisk = { totalUsers: 2847, monitored: 342, flagged: 18, investigated: 5, confirmed: 1 };
  }

  private _ecRenderInsiderThreat() {
    const baseline = this._ecUserBaseline;
    const rules = this._ecAnomalyRules;
    const ir = this._ecInsiderRisk;
    ...
    return html`<div class="card" style="padding:14px;margin-bottom:8px">
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px;margin-bottom:10px;flex-wrap:wrap">
            ${['timeline','rootcause','impact','actions','lessons'].map(t => html`
              <button class="btn ${this._evidenr15ActiveTab === t ? 'btn-primary' : ''}" style="font-size:10px;padding:3px 8px" @click=${() => { this._evidenr15ActiveTab = t; }}>${t.charAt(0).toUpperCase() + t.slice(1)}</button>
            `)}
          </div>
          ${this._evidenr15ActiveTab === 'timeline' ? html`
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._evidenr15Timeline.map(e => html`
          ...
          ` : this._evidenr15ActiveTab === 'rootcause' ? html`
            <div style="margin-bottom:8px">${{__html: this._evidenr15RenderFishbone()}}</div>
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._evidenr15RootCauses.map((rc, i) => html`
          ...
          ` : this._evidenr15ActiveTab === 'impact' ? html`
            <div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:10px">
              ...
              <tbody>${this._evidenr15ImpactMatrix.map(imp => html`
          ...
          ` : this._evidenr15ActiveTab === 'actions' ? html`
            <div style="display:flex;gap:12px;margin-bottom:8px;font-size:10px;color:#888">
              ${Object.entries(this._evidenr15GetActionStats()).map(([k,v]) => html`<span>${k}: <b style="color:#ddd">${v}</b></span>`)}
            </div>
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._evidenr15Actions.map(a => html`
                <div style="display:flex;gap:8px;align-items:center;padding:6px;background:#1a1d27;border-radius:4px;cursor:pointer" @click=${() => this._evidenr15ToggleAction(a.id)}>
          ...
          ` : html`
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._evidenr15Lessons.map(l => html`
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px;margin-bottom:10px;flex-wrap:wrap">
            ${['all', ...this._evidenr15MaturityLevels.map(m => m.domain)].map(d => html`
              <button class="btn ${this._evidenr15SelectedDomain === d ? 'btn-primary' : ''}" style="font-size:9px;padding:2px 6px" @click=${() => { this._evidenr15SelectedDomain = d; }}>${d}</button>
            `)}
          </div>
          <div style="display:flex;gap:16px;margin-bottom:10px">
            <div style="text-align:center"><div style="color:#e0e0e0;font-size:20px;font-weight:bold">${this._evidenr15GetOverallMaturity()}/5</div><div style="color:#888;font-size:10px">Maturity Level</div></div>
            <div style="text-align:center"><div style="color:#4f4;font-size:20px;font-weight:bold">${this._evidenr15GetGapAnalysis().filter(g => g.isAbove).length}/${this._evidenr15Benchmarks.length}</div><div style="color:#888;font-size:10px">Above Industry</div></div>
          </div>
          <div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:10px">
            ...
            <tbody>${this._evidenr15GetGapAnalysis().map(b => html`
          ...
          <div style="margin-top:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Maturity by Domain</div>
            ${this._evidenr15MaturityLevels.filter(m => this._evidenr15SelectedDomain === 'all' || m.domain === this._evidenr15SelectedDomain).map(m => html`
          ...
          <div style="margin-top:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Quarterly Trend</div>
            <div style="display:flex;height:40px;align-items:flex-end;gap:4px">
              ${this._evidenr15QuarterlyData.map(q => html`<div style="flex:1;text-align:center"><div style="background:#4a9eff;height:${q.score * 0.5}px;border-radius:2px 2px 0 0" title="${q.score}"></div><div style="color:#666;font-size:8px;margin-top:2px">${q.quarter}</div></div>`)}
            </div>
          </div>
        </div>
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:12px;margin-bottom:8px;font-size:10px">
            <div style="display:flex;gap:4px;flex-wrap:wrap">${this._evidenr15GroupAlerts().map(g => html`<span style="color:#888;padding:2px 6px;background:#1a1d27;border-radius:3px">${g.group}: ${g.count}</span>`)}</div>
          </div>
          <div style="display:flex;gap:8px;margin-bottom:8px;font-size:10px;color:#888">
            <span>FP Rate: <b style="color:${this._evidenr15QualityMetrics.fpRate > 0.15 ? '#f44' : '#4f4'}">${(this._evidenr15QualityMetrics.fpRate * 100).toFixed(1)}%</b></span>
            <span>Enrich: <b style="color:#4a9eff">${(this._evidenr15QualityMetrics.enrichSuccess * 100).toFixed(0)}%</b></span>
            <span>Avg Triage: <b style="color:#ddd">${this._evidenr15QualityMetrics.avgTriageTime}m</b></span>
          </div>
          <div style="display:flex;flex-direction:column;gap:4px;max-height:200px;overflow-y:auto">
            ${this._evidenr15Alerts.sort((a, b) => this._evidenr15CalcScore(b) - this._evidenr15CalcScore(a)).map(a => {
              const score = this._evidenr15CalcScore(a);
              return html`
                <div style="padding:6px;background:#1a1d27;border-radius:4px;border-left:3px solid ${a.severity >= 4 ? '#f44' : a.severity >= 3 ? '#fa0' : '#4a9eff'}">
                  <div style="display:flex;justify-content:space-between;align-items:center">
                    ...
                    <button class="btn" style="font-size:9px;padding:1px 6px;margin-left:4px" @click=${() => this._evidenr15EnrichAlert(a.id)}>${a.enriched ? 'Re-enrich' : 'Enrich'}</button>
                  </div>
          ...
          <div style="margin-top:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Routing Rules</div>
            ${this._evidenr15RoutingRules.map(r => html`
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:8px;margin-bottom:8px;flex-wrap:wrap">
            ${this._evidenr15Shapes.map(s => {
              const v = this._evidenr15ValidateControl(s.id);
              return html`<div style="padding:4px 8px;background:#1a1d27;border-radius:3px;cursor:pointer;border:1px solid ${this._evidenr15SelectedShape === s.id ? '#4a9eff' : '#2a2d37'}" @click=${() => { this._evidenr15SelectedShape = this._evidenr15SelectedShape === s.id ? '' : s.id; }}>
          ...
          ${this._evidenr15SelectedShape ? html`
            ${(() => {
              const shape = this._evidenr15Shapes.find(s => s.id === this._evidenr15SelectedShape);
              const v = this._evidenr15ValidateControl(this._evidenr15SelectedShape);
              return shape ? html`
          ...
          <div style="margin-bottom:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Trust Boundaries</div>
            ${this._evidenr15TrustBoundaries.map(tb => html`
              <div style="display:flex;gap:6px;align-items:center;padding:3px;background:#1a1d27;border-radius:3px;margin-bottom:2px;font-size:9px">
                <span style="color:#ddd">${this._evidenr15Shapes.find(s => s.id === tb.from)?.label || tb.from}</span>
                <span style="color:#4a9eff">\u2194</span>
                <span style="color:#ddd">${this._evidenr15Shapes.find(s => s.id === tb.to)?.label || tb.to}</span>
          ...
          <div><div style="color:#888;font-size:10px;margin-bottom:4px">Architecture Decision Records</div>
            ${this._evidenr15ADRs.map(adr => html`
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:8px;margin-bottom:8px;flex-wrap:wrap">
            ${this._evidenr15Gauges.map(g => html`
          ...
          <div style="display:flex;gap:8px;margin-bottom:8px;align-items:center">
            ...
            <span style="color:${this._evidenr15GetOverallHealth().score >= 99 ? '#4f4' : '#fa0'};font-size:12px;font-weight:bold">${this._evidenr15GetOverallHealth().score}%</span>
            <span style="color:#888;font-size:10px">(Target: ${this._evidenr15SlaTarget}%)</span>
            <span style="color:#4f4;font-size:10px">${this._evidenr15GetOverallHealth().healthy} healthy</span>
            <span style="color:#fa0;font-size:10px">${this._evidenr15GetOverallHealth().degraded} degraded</span>
          </div>
          <div style="margin-bottom:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Anomaly Stream</div>
            ${this._evidenr15Anomalies.slice(0, 3).map(a => html`
              <div style="display:flex;gap:6px;align-items:center;padding:4px;background:#1a1d27;border-radius:3px;margin-bottom:2px;opacity:${a.acknowledged ? 0.5 : 1}">
                ...
                ${!a.acknowledged ? html`<button class="btn" style="font-size:8px;padding:1px 4px" @click=${() => this._evidenr15AckAnomaly(a.id)}>ACK</button>` : html`<span style="color:#4f4;font-size:9px">ACK'd</span>`}
              </div>
            `)}
          </div>
          <div style="margin-bottom:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Integration Health</div>
            ${this._evidenr15Integrations.map(i => html`
              <div style="display:flex;gap:6px;align-items:center;padding:3px;background:#1a1d27;border-radius:3px;margin-bottom:2px;font-size:9px">
          ...
          <div><div style="color:#888;font-size:10px;margin-bottom:4px">Alert Fatigue Analysis</div>
            <div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:9px">
              ...
              <tbody>${this._evidenr15AlertFatigue.map(af => html`
  ...
  private _evidenr15RenderFishbone(): string {
  ...
  private _evidenr15ToggleAction(id: string) {
    this._evidenr15Actions = this._evidenr15Actions.map(a => a.id === id ? {...a, status: a.status === 'pending' ? 'in_progress' : a.status === 'in_progress' ? 'completed' : 'pending'} : a);
  }

  private _evidenr15GetActionStats() {
    const total = this._evidenr15Actions.length;
    const done = this._evidenr15Actions.filter(a => a.status === 'completed').length;
    const inProg = this._evidenr15Actions.filter(a => a.status === 'in_progress').length;
    return { total, done, inProg, pending: total - done - inProg };
  }

  private _evidenr15GetOverallMaturity(): number {
    if (this._evidenr15SelectedDomain === 'all') {
      return Math.round(this._evidenr15MaturityLevels.reduce((s, m) => s + m.current, 0) / this._evidenr15MaturityLevels.length * 10) / 10;
    }
    const d = this._evidenr15MaturityLevels.find(m => m.domain === this._evidenr15SelectedDomain);
    return d ? d.current : 0;
  }

  private _evidenr15GetGapAnalysis() {
    return this._evidenr15Benchmarks.map(b => {
  ...
  private _evidenr15CalcScore(alert: any): number {
    return Math.round(alert.severity * alert.confidence * alert.assetCrit * 100) / 100;
  }

  private _evidenr15EnrichAlert(id: string) {
    this._evidenr15Alerts = this._evidenr15Alerts.map(a => {
      if (a.id !== id) return a;
      const score = this._evidenr15CalcScore(a);
  ...
  private _evidenr15GroupAlerts() {
    const groups: Record<string, number> = {};
    this._evidenr15Alerts.forEach(a => { groups[a.group] = (groups[a.group] || 0) + 1; });
    return Object.entries(groups).map(([g, c]) => ({group: g, count: c}));
  }

  private _evidenr15ValidateControl(shapeId: string): {valid:boolean;missing:string[]} {
    const shape = this._evidenr15Shapes.find(s => s.id === shapeId);
  ...
  private _evidenr15GetOverallHealth(): {healthy:number;degraded:number;down:number;score:number} {
    const online = this._evidenr15Integrations.filter(i => i.status === 'online').length;
    const degraded = this._evidenr15Integrations.filter(i => i.status === 'degraded').length;
    const total = this._evidenr15Integrations.length;
    return { healthy: online, degraded, down: total - online - degraded, score: Math.round(online / total * 100) };
  }

  private _evidenr15AckAnomaly(id: string) {
    this._evidenr15Anomalies = this._evidenr15Anomalies.map(a => a.id === id ? {...a, acknowledged: true} : a);
  }
...
// ===== DATA SOVEREIGNTY COMPLIANCE (R22) =====
  ...
  private _renderBudgetPlanning() {
    const budgetData = [
      { category: "Personnel & Training", planned: 4019000, actual: 2451000, utilization: 61.0, q1: "28%", q2: "33%", q3: "31%", q4: "23%" },
      { category: "Tooling & Licensing", planned: 4026000, actual: 2464000, utilization: 61.2, q1: "15%", q2: "22%", q3: "26%", q4: "24%" },
      { category: "Infrastructure Security", planned: 4033000, actual: 2477000, utilization: 61.4, q1: "18%", q2: "27%", q3: "21%", q4: "25%" },
      { category: "Compliance & Audit", planned: 4040000, actual: 2490000, utilization: 61.6, q1: "21%", q2: "32%", q3: "32%", q4: "10%" },
      { category: "Incident Response", planned: 4047000, actual: 2503000, utilization: 61.8, q1: "24%", q2: "21%", q3: "27%", q4: "11%" },
      { category: "Third-Party Assessments", planned: 4054000, actual: 2516000, utilization: 62.1, q1: "27%", q2: "26%", q3: "22%", q4: "12%" },
      { category: "Security Awareness", planned: 4061000, actual: 2529000, utilization: 62.3, q1: "30%", q2: "31%", q3: "33%", q4: "13%" },
      { category: "Research & Innovation", planned: 4068000, actual: 2542000, utilization: 62.5, q1: "17%", q2: "20%", q3: "28%", q4: "14%" },
    ];
    ...
    const headcount = [
      { team: "SOC Tier 1", current: 2, target: 16, gap: 5, avgSalary: "195k" },
      { team: "SOC Tier 2", current: 11, target: 15, gap: 4, avgSalary: "113k" },
      { team: "Threat Intel", current: 3, target: 14, gap: 3, avgSalary: "142k" },
      { team: "Red Team", current: 12, target: 13, gap: 2, avgSalary: "171k" },
      { team: "GRC", current: 4, target: 12, gap: 1, avgSalary: "89k" },
      { team: "AppSec", current: 13, target: 11, gap: 0, avgSalary: "118k" },
      { team: "Cloud Sec", current: 5, target: 10, gap: 5, avgSalary: "147k" },
      { team: "Identity & Access", current: 14, target: 9, gap: 4, avgSalary: "176k" },
    ];
    const vendorSpend = [
      { vendor: "CrowdStrike", annual: "170k", contractEnd: "2026-06", renewalRisk: "Low", satisfaction: 5 },
      { vendor: "Palo Alto", annual: "201k", contractEnd: "2026-07", renewalRisk: "Medium", satisfaction: 4 },
      { vendor: "Splunk", annual: "232k", contractEnd: "2026-08", renewalRisk: "High", satisfaction: 3 },
      { vendor: "Qualys", annual: "263k", contractEnd: "2026-09", renewalRisk: "Low", satisfaction: 5 },
      { vendor: "Rapid7", annual: "294k", contractEnd: "2026-10", renewalRisk: "Medium", satisfaction: 4 },
      { vendor: "Mandiant", annual: "325k", contractEnd: "2026-11", renewalRisk: "High", satisfaction: 3 },
      { vendor: "Zscaler", annual: "356k", contractEnd: "2026-12", renewalRisk: "Low", satisfaction: 5 },
      { vendor: "Duo Security", annual: "387k", contractEnd: "2026-01", renewalRisk: "Medium", satisfaction: 4 },
    ];
    const roiProjections = [
      { area: "Threat Detection", investment: "183k", projectedReturn: "1073k", roiMultiple: "3.2x", confidence: 89 },
      { area: "Incident Reduction", investment: "226k", projectedReturn: "1120k", roiMultiple: "3.1x", confidence: 70 },
      { area: "Compliance Savings", investment: "269k", projectedReturn: "1167k", roiMultiple: "3.0x", confidence: 87 },
      { area: "Automation Gains", investment: "312k", projectedReturn: "1214k", roiMultiple: "2.9x", confidence: 68 },
      { area: "Risk Avoidance", investment: "355k", projectedReturn: "1261k", roiMultiple: "2.8x", confidence: 85 },
    ];
    return html`
  ...
  private _renderMetricsNormalization() {
    const kpiCatalog = [
      { id: "kpi-1", name: "MTTD", owner: "SOC", unit: "minutes", target: 72, current: 93, benchmark: 95, collection: "auto", frequency: "realtime" },
      { id: "kpi-2", name: "MTTR", owner: "GRC", unit: "%", target: 75, current: 100, benchmark: 72, collection: "semi-auto", frequency: "daily" },
      { id: "kpi-3", name: "MTTC", owner: "AppSec", unit: "score", target: 78, current: 61, benchmark: 83, collection: "manual", frequency: "weekly" },
      { id: "kpi-4", name: "Vuln SLA Compliance", owner: "Cloud Sec", unit: "count", target: 81, current: 68, benchmark: 94, collection: "auto", frequency: "monthly" },
      { id: "kpi-5", name: "Patch Coverage", owner: "Identity", unit: "days", target: 84, current: 75, benchmark: 71, collection: "semi-auto", frequency: "realtime" },
      { id: "kpi-6", name: "Phishing Click Rate", owner: "Threat Intel", unit: "minutes", target: 87, current: 82, benchmark: 82, collection: "manual", frequency: "daily" },
      { id: "kpi-7", name: "Training Completion", owner: "Security Ops", unit: "%", target: 90, current: 89, benchmark: 93, collection: "auto", frequency: "weekly" },
      { id: "kpi-8", name: "Escalation Rate", owner: "Risk Mgmt", unit: "score", target: 93, current: 96, benchmark: 70, collection: "semi-auto", frequency: "monthly" },
      { id: "kpi-9", name: "False Positive Rate", owner: "SOC", unit: "count", target: 96, current: 57, benchmark: 81, collection: "manual", frequency: "realtime" },
      { id: "kpi-10", name: "Threat Intel Actionability", owner: "GRC", unit: "days", target: 99, current: 64, benchmark: 92, collection: "auto", frequency: "daily" },
      { id: "kpi-11", name: "Endpoint Compliance", owner: "AppSec", unit: "minutes", target: 72, current: 71, benchmark: 69, collection: "semi-auto", frequency: "weekly" },
      { id: "kpi-12", name: "Cloud Misconfig Score", owner: "Cloud Sec", unit: "%", target: 75, current: 78, benchmark: 80, collection: "manual", frequency: "monthly" },
      { id: "kpi-13", name: "Identity Anomaly Rate", owner: "Identity", unit: "score", target: 78, current: 85, benchmark: 91, collection: "auto", frequency: "realtime" },
      { id: "kpi-14", name: "DLP Events", owner: "Threat Intel", unit: "count", target: 81, current: 92, benchmark: 68, collection: "semi-auto", frequency: "daily" },
      { id: "kpi-15", name: "Vendor Risk Avg", owner: "Security Ops", unit: "days", target: 84, current: 99, benchmark: 79, collection: "manual", frequency: "weekly" },
      { id: "kpi-16", name: "Compliance Audit Pass Rate", owner: "Risk Mgmt", unit: "minutes", target: 87, current: 60, benchmark: 90, collection: "auto", frequency: "monthly" },
      { id: "kpi-17", name: "Awareness Score", owner: "SOC", unit: "%", target: 90, current: 67, benchmark: 67, collection: "semi-auto", frequency: "realtime" },
      { id: "kpi-18", name: "SOC Utilization", owner: "GRC", unit: "score", target: 93, current: 74, benchmark: 78, collection: "manual", frequency: "daily" },
      { id: "kpi-19", name: "Automation Coverage", owner: "AppSec", unit: "count", target: 96, current: 81, benchmark: 89, collection: "auto", frequency: "weekly" },
      { id: "kpi-20", name: "Risk Register Currency", owner: "Cloud Sec", unit: "days", target: 99, current: 88, benchmark: 66, collection: "semi-auto", frequency: "monthly" },
    ];
    const benchmarkSources = [
      { source: "NIST CSF", mappedKPIs: 5, alignment: 62, lastReview: "2026-03-25", status: "aligned" },
      { source: "CIS Controls v8", mappedKPIs: 6, alignment: 79, lastReview: "2026-04-20", status: "partial" },
      { source: "ISO 27001:2022", mappedKPIs: 7, alignment: 96, lastReview: "2026-05-15", status: "reviewing" },
      { source: "PCI DSS 4.0", mappedKPIs: 8, alignment: 74, lastReview: "2026-06-10", status: "aligned" },
      { source: "SOC 2 Type II", mappedKPIs: 3, alignment: 91, lastReview: "2026-01-05", status: "partial" },
      { source: "MITRE ATT&CK", mappedKPIs: 4, alignment: 69, lastReview: "2026-02-28", status: "reviewing" },
      { source: "SANS Top 20", mappedKPIs: 5, alignment: 86, lastReview: "2026-03-23", status: "aligned" },
      { source: "OWASP Top 10", mappedKPIs: 6, alignment: 64, lastReview: "2026-04-18", status: "partial" },
    ];
  ...
  private _renderThreatHuntingCampaigns() {
    const campaigns = [
      { id: "HC-1001", name: "Lateral Movement Sweep", status: "active", hypothesis: "H1: Actors using pass-the-hash for lateral movement", leadHunter: "Alice Chen", findings: 12, startDate: "2026-01-17", endDate: null, effectiveness: 66 },
      { id: "HC-1002", name: "Credential Harvesting Hunt", status: "completed", hypothesis: "H2: Actors using web shells for persistence", leadHunter: "Bob Martinez", findings: 15, startDate: "2026-04-28", endDate: "2026-05-06", effectiveness: 85 },
      { id: "HC-1003", name: "Persistence Mechanism Audit", status: "planned", hypothesis: "H3: Actors using scheduled tasks for data theft", leadHunter: "Carol Wu", findings: 18, startDate: "2026-03-11", endDate: null, effectiveness: 45 },
      { id: "HC-1004", name: "C2 Beacon Detection", status: "in-review", hypothesis: "H4: Actors using DNS tunneling for C2 communication", leadHunter: "Dave Kim", findings: 21, startDate: "2026-02-22", endDate: null, effectiveness: 64 },
      { id: "HC-1005", name: "Data Exfiltration Patterns", status: "active", hypothesis: "H5: Actors using encrypted channels for privilege escalation", leadHunter: "Eve Johnson", findings: 24, startDate: "2026-01-05", endDate: null, effectiveness: 83 },
      { id: "HC-1006", name: "Privilege Escalation Scan", status: "completed", hypothesis: "H6: Actors using token impersonation for defense evasion", leadHunter: "Frank Liu", findings: 27, startDate: "2026-04-16", endDate: "2026-06-18", effectiveness: 43 },
      { id: "HC-1007", name: "Supply Chain Implant Hunt", status: "planned", hypothesis: "H7: Actors using poisoned images for initial access", leadHunter: "Grace Park", findings: 30, startDate: "2026-03-27", endDate: null, effectiveness: 62 },
      { id: "HC-1008", name: "Insider Threat Indicators", status: "in-review", hypothesis: "H8: Actors using legitimate tools for credential access", leadHunter: "Hector Silva", findings: 33, startDate: "2026-02-10", endDate: null, effectiveness: 81 },
      { id: "HC-1009", name: "Cloud Metadata Analysis", status: "active", hypothesis: "H9: Actors using API keys for command execution", leadHunter: "Alice Chen", findings: 36, startDate: "2026-01-21", endDate: null, effectiveness: 41 },
      { id: "HC-1010", name: "DNS Tunnel Detection", status: "completed", hypothesis: "H10: Actors using encoded subdomains for exfiltration", leadHunter: "Bob Martinez", findings: 39, startDate: "2026-04-04", endDate: "2026-04-02", effectiveness: 60 },
      { id: "HC-1011", name: "Fileless Malware Search", status: "planned", hypothesis: "H11: Actors using WMI providers for discovery", leadHunter: "Carol Wu", findings: 42, startDate: "2026-03-15", endDate: null, effectiveness: 79 },
      { id: "HC-1012", name: "Zero-Day Exploit Traces", status: "in-review", hypothesis: "H12: Actors using exploit kits for collection", leadHunter: "Dave Kim", findings: 45, startDate: "2026-02-26", endDate: null, effectiveness: 98 },
    ];
    const hunterLeaderboard = [
      { hunter: "Alice Chen", campaigns: 4, findings: 21, highSeverity: 14, avgScore: 91, streak: 5 },
      { hunter: "Bob Martinez", campaigns: 14, findings: 50, highSeverity: 19, avgScore: 84, streak: 6 },
      { hunter: "Carol Wu", campaigns: 11, findings: 79, highSeverity: 24, avgScore: 77, streak: 7 },
      { hunter: "Dave Kim", campaigns: 8, findings: 108, highSeverity: 3, avgScore: 70, streak: 8 },
      { hunter: "Eve Johnson", campaigns: 5, findings: 21, highSeverity: 8, avgScore: 63, streak: 1 },
      { hunter: "Frank Liu", campaigns: 15, findings: 50, highSeverity: 13, avgScore: 56, streak: 2 },
      { hunter: "Grace Park", campaigns: 12, findings: 79, highSeverity: 18, avgScore: 93, streak: 3 },
      { hunter: "Hector Silva", campaigns: 9, findings: 108, highSeverity: 23, avgScore: 86, streak: 4 },
    ];
    const mitreMapping = [
      { tactic: "Initial Access", techniques: 5, campaigns: 1, coverage: 36 },
      { tactic: "Execution", techniques: 4, campaigns: 6, coverage: 87 },
      { tactic: "Persistence", techniques: 3, campaigns: 5, coverage: 67 },
      { tactic: "Privilege Escalation", techniques: 2, campaigns: 4, coverage: 47 },
      { tactic: "Defense Evasion", techniques: 12, campaigns: 3, coverage: 98 },
      { tactic: "Credential Access", techniques: 11, campaigns: 2, coverage: 78 },
      { tactic: "Discovery", techniques: 10, campaigns: 1, coverage: 58 },
      { tactic: "Lateral Movement", techniques: 9, campaigns: 6, coverage: 38 },
      { tactic: "Collection", techniques: 8, campaigns: 5, coverage: 89 },
      { tactic: "Exfiltration", techniques: 7, campaigns: 4, coverage: 69 },
      { tactic: "Command & Control", techniques: 6, campaigns: 3, coverage: 49 },
      { tactic: "Impact", techniques: 5, campaigns: 2, coverage: 100 },
    ];
    return html`
  ...
  private _renderControlInventory() {
    const controls = [
      { id: "CTL-2001", name: "MFA Enforcement", domain: "Access Control", status: "implemented", effectiveness: 63, lastTest: "2026-01-09", nextReview: "2026-09-09", owner: "SOC", risk: "Low" },
      { id: "CTL-2002", name: "Network Segmentation", domain: "Network Security", status: "partial", effectiveness: 14, lastTest: "2026-04-22", nextReview: "2026-10-28", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2003", name: "EDR Deployment", domain: "Endpoint Protection", status: "planned", effectiveness: 21, lastTest: "2026-03-07", nextReview: "2026-11-19", owner: "IT Ops", risk: "High" },
      { id: "CTL-2004", name: "DLP Policy", domain: "Data Protection", status: "gap", effectiveness: 28, lastTest: "2026-02-20", nextReview: "2026-12-10", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2005", name: "SSO Integration", domain: "Identity Management", status: "implemented", effectiveness: 75, lastTest: "2026-01-05", nextReview: "2026-05-01", owner: "IAM", risk: "Low" },
      { id: "CTL-2006", name: "SAST Pipeline", domain: "Application Security", status: "partial", effectiveness: 42, lastTest: "2026-04-18", nextReview: "2026-06-20", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2007", name: "CSPM Scanning", domain: "Cloud Security", status: "planned", effectiveness: 49, lastTest: "2026-03-03", nextReview: "2026-07-11", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2008", name: "Badge Access", domain: "Physical Security", status: "gap", effectiveness: 5, lastTest: "2026-02-16", nextReview: "2026-08-02", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2009", name: "Least Privilege", domain: "Access Control", status: "implemented", effectiveness: 87, lastTest: "2026-01-01", nextReview: "2026-09-21", owner: "SOC", risk: "Low" },
      { id: "CTL-2010", name: "Firewall Rules", domain: "Network Security", status: "partial", effectiveness: 19, lastTest: "2026-04-14", nextReview: "2026-10-12", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2011", name: "Disk Encryption", domain: "Endpoint Protection", status: "planned", effectiveness: 26, lastTest: "2026-03-27", nextReview: "2026-11-03", owner: "IT Ops", risk: "High" },
      { id: "CTL-2012", name: "Data Classification", domain: "Data Protection", status: "gap", effectiveness: 33, lastTest: "2026-02-12", nextReview: "2026-12-22", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2013", name: "PAM Implementation", domain: "Identity Management", status: "implemented", effectiveness: 40, lastTest: "2026-01-25", nextReview: "2026-05-13", owner: "IAM", risk: "Low" },
      { id: "CTL-2014", name: "DAST Pipeline", domain: "Application Security", status: "partial", effectiveness: 47, lastTest: "2026-04-10", nextReview: "2026-06-04", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2015", name: "IAM Policy Review", domain: "Cloud Security", status: "planned", effectiveness: 3, lastTest: "2026-03-23", nextReview: "2026-07-23", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2016", name: "Visitor Management", domain: "Physical Security", status: "gap", effectiveness: 10, lastTest: "2026-02-08", nextReview: "2026-08-14", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2017", name: "Access Reviews", domain: "Access Control", status: "implemented", effectiveness: 52, lastTest: "2026-01-21", nextReview: "2026-09-05", owner: "SOC", risk: "Low" },
      { id: "CTL-2018", name: "IDS/IPS Tuning", domain: "Network Security", status: "partial", effectiveness: 24, lastTest: "2026-04-06", nextReview: "2026-10-24", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2019", name: "Patch Management", domain: "Endpoint Protection", status: "planned", effectiveness: 31, lastTest: "2026-03-19", nextReview: "2026-11-15", owner: "IT Ops", risk: "High" },
      { id: "CTL-2020", name: "Backup Encryption", domain: "Data Protection", status: "gap", effectiveness: 38, lastTest: "2026-02-04", nextReview: "2026-12-06", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2021", name: "Password Policy", domain: "Identity Management", status: "implemented", effectiveness: 64, lastTest: "2026-01-17", nextReview: "2026-05-25", owner: "IAM", risk: "Low" },
      { id: "CTL-2022", name: "Container Scanning", domain: "Application Security", status: "partial", effectiveness: 1, lastTest: "2026-04-02", nextReview: "2026-06-16", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2023", name: "WAF Configuration", domain: "Cloud Security", status: "planned", effectiveness: 8, lastTest: "2026-03-15", nextReview: "2026-07-07", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2024", name: "CCTV Coverage", domain: "Physical Security", status: "gap", effectiveness: 15, lastTest: "2026-02-28", nextReview: "2026-08-26", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2025", name: "RBAC Enforcement", domain: "Access Control", status: "implemented", effectiveness: 76, lastTest: "2026-01-13", nextReview: "2026-09-17", owner: "SOC", risk: "Low" },
      { id: "CTL-2026", name: "VPN Management", domain: "Network Security", status: "partial", effectiveness: 29, lastTest: "2026-04-26", nextReview: "2026-10-08", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2027", name: "App Whitelisting", domain: "Endpoint Protection", status: "planned", effectiveness: 36, lastTest: "2026-03-11", nextReview: "2026-11-27", owner: "IT Ops", risk: "High" },
      { id: "CTL-2028", name: "Key Management", domain: "Data Protection", status: "gap", effectiveness: 43, lastTest: "2026-02-24", nextReview: "2026-12-18", owner: "Data Gov", risk: "Critical" },
    ];
    const gapAnalysis = [
      { gap: "Insufficient MFA coverage for legacy apps", severity: "High", remediationPlan: "Plan R3001", eta: "2026-Q3", estimatedCost: "131k" },
      { gap: "Missing network micro-segmentation", severity: "Medium", remediationPlan: "Plan R3002", eta: "2026-Q2", estimatedCost: "160k" },
      { gap: "Inconsistent EDR deployment", severity: "Medium", remediationPlan: "Plan R3003", eta: "2026-Q4", estimatedCost: "189k" },
      { gap: "DLP not covering cloud storage", severity: "Low", remediationPlan: "Plan R3004", eta: "2026-Q3", estimatedCost: "37k" },
      { gap: "SSO not integrated with all SaaS", severity: "High", remediationPlan: "Plan R3005", eta: "2026-Q2", estimatedCost: "66k" },
    ];
    return html`
  ...
  private _renderIncidentCostTracker() {
    const incidents = [
      { id: "INC-7001", name: "Security Incident 1", severity: "Critical", totalCost: 2163000, responseCost: 627270, recoveryCost: 735420, legalCost: 367710, regulatoryCost: 129780, insuranceClaim: 0, avoidedCost: 401000, date: "2026-01-01" },
      { id: "INC-7002", name: "Security Incident 2", severity: "High", totalCost: 2166000, responseCost: 324900, recoveryCost: 519840, legalCost: 303240, regulatoryCost: 259920, insuranceClaim: 866400, avoidedCost: 430000, date: "2026-04-10" },
      { id: "INC-7003", name: "Security Incident 3", severity: "Medium", totalCost: 2169000, responseCost: 477180, recoveryCost: 759150, legalCost: 238590, regulatoryCost: 151830, insuranceClaim: 0, avoidedCost: 459000, date: "2026-03-19" },
      { id: "INC-7004", name: "Security Incident 4", severity: "Low", totalCost: 2172000, responseCost: 629880, recoveryCost: 543000, legalCost: 173760, regulatoryCost: 282360, insuranceClaim: 760200, avoidedCost: 488000, date: "2026-02-28" },
      { id: "INC-7005", name: "Security Incident 5", severity: "Critical", totalCost: 2175000, responseCost: 326250, recoveryCost: 783000, legalCost: 108750, regulatoryCost: 174000, insuranceClaim: 0, avoidedCost: 21000, date: "2026-01-09" },
      { id: "INC-7006", name: "Security Incident 6", severity: "High", totalCost: 2178000, responseCost: 479160, recoveryCost: 566280, legalCost: 392040, regulatoryCost: 304920, insuranceClaim: 653400, avoidedCost: 50000, date: "2026-04-18" },
      { id: "INC-7007", name: "Security Incident 7", severity: "Medium", totalCost: 2181000, responseCost: 632490, recoveryCost: 806970, legalCost: 327150, regulatoryCost: 196290, insuranceClaim: 0, avoidedCost: 79000, date: "2026-03-27" },
      { id: "INC-7008", name: "Security Incident 8", severity: "Low", totalCost: 2184000, responseCost: 327600, recoveryCost: 589680, legalCost: 262080, regulatoryCost: 327600, insuranceClaim: 1659840, avoidedCost: 108000, date: "2026-02-08" },
      { id: "INC-7009", name: "Security Incident 9", severity: "Critical", totalCost: 2187000, responseCost: 481140, recoveryCost: 831060, legalCost: 196830, regulatoryCost: 218700, insuranceClaim: 0, avoidedCost: 137000, date: "2026-01-17" },
      { id: "INC-7010", name: "Security Incident 10", severity: "High", totalCost: 2190000, responseCost: 635100, recoveryCost: 613200, legalCost: 131400, regulatoryCost: 109500, insuranceClaim: 1554900, avoidedCost: 166000, date: "2026-04-26" },
      { id: "INC-7011", name: "Security Incident 11", severity: "Medium", totalCost: 2193000, responseCost: 328950, recoveryCost: 855270, legalCost: 416670, regulatoryCost: 241230, insuranceClaim: 0, avoidedCost: 195000, date: "2026-03-07" },
      { id: "INC-7012", name: "Security Incident 12", severity: "Low", totalCost: 2196000, responseCost: 483120, recoveryCost: 636840, legalCost: 351360, regulatoryCost: 131760, insuranceClaim: 1449360, avoidedCost: 224000, date: "2026-02-16" },
    ];
    const yearlyTrend = [
      { month: "Jan", incidents: 3, totalCost: "414k", avgCost: "45k", insured: 58 },
      { month: "Feb", incidents: 11, totalCost: "457k", avgCost: "92k", insured: 58 },
      { month: "Mar", incidents: 8, totalCost: "500k", avgCost: "139k", insured: 58 },
      { month: "Apr", incidents: 5, totalCost: "543k", avgCost: "186k", insured: 58 },
      { month: "May", incidents: 2, totalCost: "586k", avgCost: "52k", insured: 58 },
      { month: "Jun", incidents: 10, totalCost: "629k", avgCost: "99k", insured: 58 },
    ];
...
declare global { interface HTMLElementTagNameMap { 'sc-evidence-collector': ScEvidenceCollector; } }
