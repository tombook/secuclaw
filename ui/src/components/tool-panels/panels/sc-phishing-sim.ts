...
@customElement('sc-phishing-sim')
export class ScPhishingSim extends LitElement {
  static styles = css`
...
@state() private _tablePage = 1;
  ...
  @state() private _comments: CommentEntry[] = [
    { id: 'c1', author: 'soc-tier1', timestamp: '2026-04-23 04:00', text: 'Initial assessment started for Phishing Sim finding #1' },
  ...
  private _items: PanelItem[] = [
      {
            "id": "phishing-sim-1",
            "title": "Campaign Apr 2026: Invoice Scam",
            "severity": "medium",
            "status": "open",
            "category": "Security",
            "source": "SIEM",
            "description": "Sent: 500 | Opened: 45% | Clicked: 23% | Submitted creds: 8% | Template: Overdue invoice | Dept hit: Finance 34%",
      ...
      {
            "id": "phishing-sim-2",
            "title": "Campaign Mar 2026: IT Alert",
            "severity": "medium",
            "status": "in-progress",
            "category": "Network",
            "source": "EDR",
            "description": "Sent: 500 | Opened: 52% | Clicked: 18% | Submitted: 5% | Template: Password expiry | Improvement: -3% clicks",
      ...
      {
            "id": "phishing-sim-3",
            "title": "Campaign Feb 2026: CEO Urgent",
            "severity": "medium",
            "status": "resolved",
            "category": "Access",
            "source": "Scanner",
            "description": "Sent: 50 (execs only) | Opened: 80% | Clicked: 40% | Submitted: 20% | Template: Wire transfer | VIP risk: HIGH",
      ...
      {
            "id": "phishing-sim-4",
            "title": "Template Library: 12 templates",
            "severity": "medium",
            "status": "open",
            "category": "Compliance",
            "source": "Audit",
            "description": "Categories: Invoice, IT alert, HR update, CEO urgent, Package delivery, Doc share, Password reset, Bonus, Meeting, Covid",
      ...
      {
            "id": "phishing-sim-5",
            "title": "Phishing Sim Finding #5",
            "severity": "medium",
            "status": "open",
            "category": "Operations",
            "source": "Manual",
            "description": "Automated phishing sim assessment finding detected during routine scan of infrastructure component. Review and remediation recommended.",
  ...
  private _history: HistoryEntry[] = [
    { timestamp: '2026-04-23 04:15', action: 'Auto-correlated', user: 'system', details: 'Grouped related findings from Phishing Sim analysis' },
    { timestamp: '2026-04-23 03:00', action: 'Created', user: 'scanner', details: 'New Phishing Sim finding detected by automated assessment' },
    ...
    { timestamp: '2026-04-22 22:00', action: 'Resolved', user: 'security-eng', details: 'Remediation applied and verified for Phishing Sim finding' },
    { timestamp: '2026-04-22 18:00', action: 'Created', user: 'audit', details: 'Compliance audit identified Phishing Sim gap requiring remediation' },
    ...
    { timestamp: '2026-04-21 16:00', action: 'Resolved', user: 'soc-tier1', details: 'False positive confirmed - benign activity flagged by Phishing Sim scan' },
    { timestamp: '2026-04-21 12:00', action: 'Exported', user: 'compliance', details: 'Exported Phishing Sim findings for Q1 compliance report' },
  ];
...
private _workflowTasks: WorkflowTask[] = [
    { id: 'wt-1', title: 'Review Phishing Sim finding #1', status: 'active', assignee: 'soc-tier1', blockedBy: [], slaDeadline: '2026-04-23T12:00:00Z', priority: 'p1', createdAt: '2026-04-23T00:00:00Z', completedAt: null },
    ...
    { id: 'wt-3', title: 'Update Phishing Sim detection rules', status: 'blocked', assignee: 'soc-tier2', blockedBy: ['wt-2'], slaDeadline: '2026-04-24T00:00:00Z', priority: 'p2', createdAt: '2026-04-23T03:00:00Z', completedAt: null },
    ...
    { id: 'wt-8', title: 'Archive resolved Phishing Sim findings', status: 'failed', assignee: 'soc-tier1', blockedBy: [], slaDeadline: '2026-04-23T08:00:00Z', priority: 'p4', createdAt: '2026-04-22T22:00:00Z', completedAt: null },
  ];

private _executionHistory: ExecutionRecord[] = [
    {
      id: 'exec-1', name: 'Phishing Sim Full Assessment Run', startedAt: '2026-04-22T10:00:00Z', completedAt: '2026-04-22T10:12:00Z', status: 'success',
      steps: [
    ...
    {
      id: 'exec-2', name: 'Phishing Sim Delta Scan', startedAt: '2026-04-23T02:00:00Z', completedAt: '2026-04-23T02:05:00Z', status: 'failed',
      steps: [
  ...
  private _runExecution() {
    ...
    const exec: ExecutionRecord = {
      id: 'exec-' + Date.now(), name: 'Phishing Sim Assessment ' + new Date().toISOString().slice(0, 10), startedAt: new Date().toISOString(), completedAt: null, status: 'running', steps,
    };
  ...
  private _renderExecutionPanel(): unknown {
    ...
    return html`
      <div class="form-section">
        ...
        ` : html`<div class="empty-state">Click "Run Assessment" to start the Phishing Sim analysis pipeline</div>`}
      </div>
      <div class="form-section">
        ...
        <div class="settings-card">
          ...
          <div style="display:flex;gap:8px;margin-top:4px;">
            <button class="btn primary" @click=${() => {
              ...
              const a = document.createElement('a'); a.href = url; a.download = 'phishing-sim-config.json'; a.click();
    ...
    return html`
      <div style="margin-top:12px;">
        ...
        <div style="display:flex;gap:6px;margin-top:8px;">
          <input class="search-box" type="text" placeholder="Add a comment..." style="min-width:auto;flex:1;" id="phishing-sim-comment-input" />
          <button class="btn primary" @click=${() => {
            const input = this.shadowRoot?.querySelector('#phishing-sim-comment-input') as HTMLInputElement;
  ...
  private _exportJSON() {
    ...
    const url = URL.createObjectURL(blob);
    const a = document.createElement('a'); a.href = url; a.download = 'sc-phishing-sim-data.json'; a.click();
    URL.revokeObjectURL(url);
  }
  ...
  private _exportCSV() {
    ...
    const url = URL.createObjectURL(blob);
    const a = document.createElement('a'); a.href = url; a.download = 'sc-phishing-sim-data.csv'; a.click();
    URL.revokeObjectURL(url);
  }


  // --- Domain Rules Engine ---
  @state() private _psRules: { id: string; name: string; category: string; severity: Severity; enabled: boolean; lastEval: string; passRate: number }[] = [];
  private _initPsRules() {
    const rules = [
  ...
  private _evaluatePsRules(): { passed: number; failed: number; skipped: number; total: number } {
    let passed = 0, failed = 0, skipped = 0;
    this._psRules.forEach(r => { if (!r.enabled) { skipped++; } else if (r.passRate >= 80) { passed++; } else { failed++; } });
    return { passed, failed, skipped, total: this._psRules.length };
  }

  // --- CVSS Scoring ---
  @state() private _pscvssData: { itemId: string; vector: string; base: number; temporal: number; environmental: number; overall: number }[] = [];
  private _initPsCvss() {
    ...
    this._pscvssData = vectors.map((v, i) => {
  ...
  // --- Anomaly Detection ---
  @state() private _psanomalies: { id: string; type: string; severity: Severity; description: string; detected: string; confidence: number; affected: string[] }[] = [];
  private _runPsAnomalyDetection() {
    const types = [
    ...
    this._psanomalies = types.map((a, i) => ({
  ...
  // --- Trend Prediction ---
  @state() private _pspredictions: { horizon: string; metric: string; current: number; predicted: number; direction: 'up' | 'down' | 'stable'; confidence: number }[] = [];
  private _generatePsPredictions() {
    this._pspredictions = [
  ...
  // --- Approval Workflow ---
  @state() private _psApprovals: { id: string; title: string; requester: string; status: 'pending' | 'approved' | 'rejected' | 'expired'; createdAt: string; priority: Priority; type: string }[] = [];
  private _initPsApprovals() {
    this._psApprovals = [
  ...
  private _approvePsItem(id: string) { const item = this._psApprovals.find(a => a.id === id); if (item) item.status = 'approved'; this.requestUpdate(); }
  private _rejectPsItem(id: string) { const item = this._psApprovals.find(a => a.id === id); if (item) item.status = 'rejected'; this.requestUpdate(); }

  // --- Activity Feed ---
  @state() private _psActivity: { id: string; action: string; user: string; target: string; timestamp: string }[] = [];
  private _initPsActivity() {
    const actions = [
    ...
    this._psActivity = actions.map((a, i) => ({ id: 'ACT-' + String(i + 1).padStart(3, '0'), ...a, timestamp: new Date(Date.now() - i * 3600000).toISOString() }));
  }

  // --- Notification System ---
  @state() private _psNotifications: { id: string; message: string; type: 'info' | 'warning' | 'error' | 'success'; read: boolean; timestamp: string }[] = [];
  private _initPsNotifications() {
    this._psNotifications = [
  ...
  private _markPsNotifRead(id: string) { const n = this._psNotifications.find(x => x.id === id); if (n) n.read = true; this.requestUpdate(); }

  // --- Panel Configuration ---
  @state() private _psConfig: { layout: 'compact' | 'default' | 'expanded'; theme: 'dark' | 'midnight' | 'slate'; showAnomalies: boolean; showPredictions: boolean; autoRefresh: boolean; refreshInterval: number } = {
    layout: 'default', theme: 'dark', showAnomalies: true, showPredictions: true, autoRefresh: true, refreshInterval: 60,
  };
  private _psPresets: { name: string; config: typeof this._psConfig }[] = [
  ...
  private _applyPsPreset(preset: typeof this._psPresets[0]) { this._psConfig = { ...preset.config }; this.requestUpdate(); }

  private _renderPsTreemapSVG(): string {
    const categories = [
  ...
  private _renderPsSankeySVG(): string {
  ...
  // --- Render: Rules Engine ---
  private _renderPsRules(): any {
    const ev = this._evaluatePsRules();
    return html`
  ...
  private _renderPsAnomalies(): any {
  ...
  // --- Render: Approvals ---
  private _renderPsApprovals(): any {
          ...
          $${this._psApprovals.map(a => html`
            <div style="padding:6px 8px;background:#1f2937;border-radius:4px">
              ...
              $${a.status === 'pending' ? html`
                <div style="display:flex;gap:4px;margin-top:4px">
                  <button class="btn success" style="padding:2px 8px;font-size:9px" @click=$${() => this._approvePsItem(a.id)}>Approve</button>
                  <button class="btn error" style="padding:2px 8px;font-size:9px" @click=$${() => this._rejectPsItem(a.id)}>Reject</button>
                </div>` : nothing}
            </div>`)}
        </div>
      </div>`;
  ...
  private _renderPsNotifications(): any {
    const tc = (t: string) => t === 'error' ? '#ef4444' : t === 'warning' ? '#eab308' : t === 'success' ? '#22c55e' : '#3b82f6';
    const unread = this._psNotifications.filter(n => !n.read).length;
    return html`
      <div style="background:#1a1d27;border-radius:8px;padding:12px;margin-top:12px">
        ...
        <div style="display:flex;flex-direction:column;gap:4px;max-height:120px;overflow-y:auto">
          $${this._psNotifications.map(n => html`
            <div style="display:flex;align-items:center;gap:8px;padding:4px 8px;background:$${n.read ? '#1f2937' : '#252a36'};border-radius:4px;font-size:10px;opacity:$${n.read ? '0.6' : '1'};cursor:pointer" @click=$${() => this._markPsNotifRead(n.id)}>
      ...
      <div style="background:#1a1d27;border-radius:8px;padding:12px;margin-top:12px">
        ...
        <div style="display:flex;flex-direction:column;gap:6px;font-size:10px">
          <div style="display:flex;align-items:center;gap:8px">
            ...
            <select class="form-input" style="flex:1" @change=$${(e: Event) => { this._psConfig.layout = (e.target as HTMLSelectElement).value as any; this.requestUpdate(); }}>
              <option value="compact" ?selected=$${this._psConfig.layout === 'compact'}>Compact</option>
              <option value="default" ?selected=$${this._psConfig.layout === 'default'}>Default</option>
              <option value="expanded" ?selected=$${this._psConfig.layout === 'expanded'}>Expanded</option>
            </select>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Theme</span>
            <select class="form-input" style="flex:1" @change=$${(e: Event) => { this._psConfig.theme = (e.target as HTMLSelectElement).value as any; this.requestUpdate(); }}>
              <option value="dark" ?selected=$${this._psConfig.theme === 'dark'}>Dark</option>
              <option value="midnight" ?selected=$${this._psConfig.theme === 'midnight'}>Midnight</option>
              <option value="slate" ?selected=$${this._psConfig.theme === 'slate'}>Slate</option>
            </select>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Auto Refresh</span>
            <input type="checkbox" ?checked=$${this._psConfig.autoRefresh} @change=$${() => { this._psConfig.autoRefresh = !this._psConfig.autoRefresh; this.requestUpdate(); }}/>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Show Anomalies</span>
            <input type="checkbox" ?checked=$${this._psConfig.showAnomalies} @change=$${() => { this._psConfig.showAnomalies = !this._psConfig.showAnomalies; this.requestUpdate(); }}/>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Show Predictions</span>
            <input type="checkbox" ?checked=$${this._psConfig.showPredictions} @change=$${() => { this._psConfig.showPredictions = !this._psConfig.showPredictions; this.requestUpdate(); }}/>
          </div>
          <div style="margin-top:6px;font-weight:600">Presets</div>
          <div style="display:flex;gap:4px">
            $${this._psPresets.map(ps => html`<button class="btn" style="padding:2px 8px;font-size:9px" @click=$${() => this._applyPsPreset(ps)}>$${ps.name}</button>`)}
          </div>
        </div>
      </div>`;
  }
...
@state() private _spmNetworkSegment9 = { id: "NET-009", name: "Segment 9", subnet: "10.9.0.0/16", criticality: "high", deviceCount: 37, vulnerabilityCount: 3, lastScan: "2026-01-19" } as any;
  ...
  @state() private _phishingSimRiskTopTen: Array<{id:string;name:string;score:number;trend:string;owner:string;category:string;lastAssessed:string}> = [
  ...
  @state() private _phishingSimRiskCategories: Array<{category:string;count:number;avgScore:number;color:string}> = [
  ...
  @state() private _phishingSimRiskVelocity: Array<{week:string;newRisks:number;closedRisks:number;netChange:number}> = [
  ...
  @state() private _phishingSimRiskAppetite: {current:number;threshold:number;maxTolerated:number;status:string} = {
    current: 68, threshold: 55, maxTolerated: 80, status: 'Warning'
  };
  @state() private _phishingSimRiskOwnerMatrix: Array<{owner:string;criticalCount:number;highCount:number;mediumCount:number;complianceRate:number}> = [
  ...
  private _renderPhishingsimRiskDash(): TemplateResult {
    const riskItems = this._phishingSimRiskTopTen;
    const velocity = this._phishingSimRiskVelocity;
    const appetite = this._phishingSimRiskAppetite;
    return html`
  ...
  @state() private _phishingSimZones: Array<{id:string;name:string;trustLevel:number;subnet:string;devices:number;policy:string;lastAudit:string}> = [
  ...
  @state() private _phishingSimSegRules: Array<{id:string;source:string;dest:string;action:string;protocol:string;port:string;status:string;hits:number}> = [
  ...
  @state() private _phishingSimCrossZoneTraffic: Array<{source:string;dest:string;bytes:number;sessions:number;violations:number}> = [
  ...
  @state() private _phishingSimMicroSegGaps: Array<{id:string;zone:string;gapType:string;severity:string;recommendation:string}> = [
  ...
  private _renderPhishingsimNetworkSeg(): TemplateResult {
    const zones = this._phishingSimZones;
    const gaps = this._phishingSimMicroSegGaps;
    return html`
  ...
  @state() private _phishingSimContainerScans: Array<{image:string;registry:string;critical:number;high:number;medium:number;scanDate:string;status:string}> = [
  ...
  @state() private _phishingSimK8sPods: Array<{namespace:string;pod:string;securityContext:string;hostIPC:boolean;hostPID:boolean;privileged:boolean;riskLevel:string}> = [
  ...
  @state() private _phishingSimServerlessRisk: Array<{function:string;runtime:string;timeout:number;iamPerms:string;externalCalls:number;riskScore:number}> = [
  ...
  @state() private _phishingSimRuntimeAlerts: Array<{id:string;workload:string;alertType:string;severity:string;description:string;timestamp:string}> = [
  ...
  private _renderPhishingsimCloudWl(): TemplateResult {
    const containers = this._phishingSimContainerScans;
    const pods = this._phishingSimK8sPods;
    const alerts = this._phishingSimRuntimeAlerts;
    return html`
  ...
  @state() private _phishingSimCourses: Array<{id:string;title:string;category:string;duration:number;enrolled:number;completed:number;difficulty:string;rating:number}> = [
  ...
  @state() private _phishingSimLearningPaths: Array<{id:string;name:string;courseIds:string[];progress:number;enrolled:number}> = [
  ...
  @state() private _phishingSimDeptCompliance: Array<{dept:string;trainedPct:number;targetPct:number;avgScore:number;certCount:number}> = [
  ...
  @state() private _phishingSimSkillsGaps: Array<{skill:string;current:number;required:number;gap:number;priority:string}> = [
  ...
  private _renderPhishingsimTraining(): TemplateResult {
    const courses = this._phishingSimCourses;
    const deptComp = this._phishingSimDeptCompliance;
    return html`
  ...
  @state() private _complianceCalendarEvents: Array<{id: string; title: string; deadline: string; category: string; status: string; assignee: string; notes: string}> = [
    {id: 'cc-phishing-sim-001', title: 'SOX Section 404 Compliance Review', deadline: '2026-06-30', category: 'Regulatory', status: 'In Progress', assignee: 'Compliance Team', notes: 'Annual internal control assessment for financial reporting'},
    {id: 'cc-phishing-sim-002', title: 'GDPR Data Protection Impact Assessment', deadline: '2026-05-15', category: 'Privacy', status: 'Pending', assignee: 'DPO Office', notes: 'Quarterly DPIA for high-risk processing activities'},
    {id: 'cc-phishing-sim-003', title: 'ISO 27001 Surveillance Audit', deadline: '2026-07-20', category: 'Certification', status: 'Scheduled', assignee: 'QA Lead', notes: 'Stage 2 surveillance audit for ISMS certification renewal'},
    {id: 'cc-phishing-sim-004', title: 'PCI DSS v4.0 Gap Analysis', deadline: '2026-05-30', category: 'Payment', status: 'Not Started', assignee: 'Security Architect', notes: 'Assess current state against PCI DSS v4.0 requirements'},
    {id: 'cc-phishing-sim-005', title: 'NIST CSF Self-Assessment', deadline: '2026-08-15', category: 'Framework', status: 'Pending', assignee: 'CISO', notes: 'Biannual self-assessment against NIST Cybersecurity Framework'},
    {id: 'cc-phishing-sim-006', title: 'HIPAA Security Rule Audit', deadline: '2026-06-15', category: 'Healthcare', status: 'In Progress', assignee: 'Compliance Analyst', notes: 'Annual audit of administrative, physical, and technical safeguards'},
    {id: 'cc-phishing-sim-007', title: 'SOC 2 Type II Report Renewal', deadline: '2026-09-30', category: 'Audit', status: 'Scheduled', assignee: 'External Auditor', notes: 'Engage auditor for SOC 2 Type II examination period'},
    {id: 'cc-phishing-sim-008', title: 'FedRAMP Authorization Review', deadline: '2026-07-01', category: 'Government', status: 'Pending', assignee: 'FedRAMP PMO', notes: 'Review and update security authorization package'},
    {id: 'cc-phishing-sim-009', title: 'Annual Penetration Test', deadline: '2026-10-15', category: 'Testing', status: 'Not Started', assignee: 'Red Team Lead', notes: 'Comprehensive external and internal penetration testing engagement'},
    {id: 'cc-phishing-sim-010', title: 'Security Awareness Training Rollout', deadline: '2026-05-01', category: 'Training', status: 'Completed', assignee: 'Security Awareness Manager', notes: 'Q2 organization-wide security awareness training program'},
    {id: 'cc-phishing-sim-011', title: 'Vendor Security Review Cycle', deadline: '2026-06-01', category: 'Third Party', status: 'In Progress', assignee: 'Vendor Manager', notes: 'Quarterly review of critical vendor security posture and SLA compliance'},
    {id: 'cc-phishing-sim-012', title: 'Incident Response Plan Update', deadline: '2026-05-20', category: 'Operations', status: 'Pending', assignee: 'IR Team Lead', notes: 'Update IR procedures based on lessons learned from recent incidents'},
  ];
  ...
  @state() private _dataQualityMetrics: Array<{id: string; dataSource: string; completenessScore: number; accuracyScore: number; timelinessScore: number; consistencyScore: number; reliabilityRank: number; lastUpdated: string; issues: string[]; trend: string}> = [
    {id: 'dq-phishing-sim-001', dataSource: 'Vulnerability Scanner Feed', completenessScore: 94, accuracyScore: 91, timelinessScore: 88, consistencyScore: 95, reliabilityRank: 1, lastUpdated: '2026-04-23T08:00:00Z', issues: ['Minor delay in Nessus plugin updates'], trend: 'improving'},
    {id: 'dq-phishing-sim-002', dataSource: 'SIEM Event Logs', completenessScore: 87, accuracyScore: 93, timelinessScore: 96, consistencyScore: 89, reliabilityRank: 2, lastUpdated: '2026-04-23T07:30:00Z', issues: ['Some log sources showing gaps in off-hours'], trend: 'stable'},
    {id: 'dq-phishing-sim-003', dataSource: 'Asset Inventory Database', completenessScore: 82, accuracyScore: 78, timelinessScore: 75, consistencyScore: 84, reliabilityRank: 4, lastUpdated: '2026-04-22T18:00:00Z', issues: ['Shadow IT devices not fully cataloged', 'Decommissioned assets still listed'], trend: 'declining'},
    {id: 'dq-phishing-sim-004', dataSource: 'Threat Intelligence Platform', completenessScore: 91, accuracyScore: 89, timelinessScore: 92, consistencyScore: 87, reliabilityRank: 3, lastUpdated: '2026-04-23T06:00:00Z', issues: ['Some IOC sources lack confidence scoring'], trend: 'improving'},
    {id: 'dq-phishing-sim-005', dataSource: 'Identity Provider Logs', completenessScore: 96, accuracyScore: 97, timelinessScore: 98, consistencyScore: 96, reliabilityRank: 1, lastUpdated: '2026-04-23T09:00:00Z', issues: [], trend: 'stable'},
    {id: 'dq-phishing-sim-006', dataSource: 'Cloud Security Posture Data', completenessScore: 79, accuracyScore: 85, timelinessScore: 82, consistencyScore: 81, reliabilityRank: 5, lastUpdated: '2026-04-23T05:00:00Z', issues: ['Multi-cloud coverage gaps', 'API rate limiting affects scan frequency'], trend: 'declining'},
    {id: 'dq-phishing-sim-007', dataSource: 'Compliance Evidence Store', completenessScore: 88, accuracyScore: 86, timelinessScore: 80, consistencyScore: 83, reliabilityRank: 4, lastUpdated: '2026-04-21T14:00:00Z', issues: ['Manual evidence collection delays', 'Inconsistent formatting across frameworks'], trend: 'stable'},
    {id: 'dq-phishing-sim-008', dataSource: 'Network Flow Data', completenessScore: 92, accuracyScore: 90, timelinessScore: 94, consistencyScore: 91, reliabilityRank: 2, lastUpdated: '2026-04-23T08:30:00Z', issues: ['Encrypted traffic classification accuracy needs improvement'], trend: 'improving'},
  ];
  ...
  @state() private _workflowTemplates: Array<{id: string; name: string; description: string; category: string; steps: number; avgDuration: string; successRate: number; lastRun: string; manualInterventions: number; optimizationScore: number}> = [
    {id: 'wf-phishing-sim-001', name: 'Vulnerability Triage Pipeline', description: 'Automated vulnerability assessment, prioritization, and assignment workflow', category: 'Vulnerability Management', steps: 8, avgDuration: '12 min', successRate: 94.5, lastRun: '2026-04-23T06:00:00Z', manualInterventions: 2, optimizationScore: 87},
    {id: 'wf-phishing-sim-002', name: 'Incident Response Orchestration', description: 'End-to-end IR workflow from detection to containment and recovery', category: 'Incident Response', steps: 15, avgDuration: '45 min', successRate: 89.2, lastRun: '2026-04-22T14:30:00Z', manualInterventions: 5, optimizationScore: 72},
    {id: 'wf-phishing-sim-003', name: 'Access Request Approval Chain', description: 'Multi-level approval workflow for privileged access requests', category: 'Identity & Access', steps: 6, avgDuration: '4 hours', successRate: 97.1, lastRun: '2026-04-23T09:15:00Z', manualInterventions: 1, optimizationScore: 92},
    {id: 'wf-phishing-sim-004', name: 'Compliance Evidence Collection', description: 'Automated gathering and packaging of audit evidence artifacts', category: 'Compliance', steps: 10, avgDuration: '30 min', successRate: 91.8, lastRun: '2026-04-21T10:00:00Z', manualInterventions: 3, optimizationScore: 78},
    {id: 'wf-phishing-sim-005', name: 'Security Patch Deployment', description: 'Staged patch rollout with validation and rollback capability', category: 'Patch Management', steps: 12, avgDuration: '2 hours', successRate: 96.3, lastRun: '2026-04-20T22:00:00Z', manualInterventions: 1, optimizationScore: 85},
    {id: 'wf-phishing-sim-006', name: 'Threat Intelligence Enrichment', description: 'IOC enrichment and correlation with internal threat data', category: 'Threat Intelligence', steps: 7, avgDuration: '8 min', successRate: 93.7, lastRun: '2026-04-23T07:00:00Z', manualInterventions: 0, optimizationScore: 95},
    {id: 'wf-phishing-sim-007', name: 'Security Reporting Pipeline', description: 'Automated generation and distribution of security metrics reports', category: 'Reporting', steps: 5, avgDuration: '15 min', successRate: 98.9, lastRun: '2026-04-23T08:00:00Z', manualInterventions: 0, optimizationScore: 97},
    {id: 'wf-phishing-sim-008', name: 'Vendor Risk Assessment', description: 'Automated vendor security questionnaire distribution and scoring', category: 'Third Party', steps: 9, avgDuration: '3 days', successRate: 85.4, lastRun: '2026-04-19T11:00:00Z', manualInterventions: 4, optimizationScore: 65},
  ];
  ...
  @state() private _workflowExecutionHistory: Array<{workflowId: string; runDate: string; duration: string; status: string; trigger: string}> = [
    {workflowId: 'wf-phishing-sim-001', runDate: '2026-04-23T06:00:00Z', duration: '11 min 23 sec', status: 'Success', trigger: 'Scheduled'},
    {workflowId: 'wf-phishing-sim-002', runDate: '2026-04-22T14:30:00Z', duration: '42 min 15 sec', status: 'Success', trigger: 'Alert'},
    {workflowId: 'wf-phishing-sim-003', runDate: '2026-04-23T09:15:00Z', duration: '3h 45 min', status: 'Success', trigger: 'User Request'},
    {workflowId: 'wf-phishing-sim-001', runDate: '2026-04-22T06:00:00Z', duration: '13 min 08 sec', status: 'Partial', trigger: 'Scheduled'},
    {workflowId: 'wf-phishing-sim-004', runDate: '2026-04-21T10:00:00Z', duration: '28 min 42 sec', status: 'Success', trigger: 'Scheduled'},
  ];
  ...
  @state() private _knowledgeArticles: Array<{id: string; title: string; category: string; author: string; publishDate: string; views: number; rating: number; tags: string[]; summary: string; readTime: string}> = [
    {id: 'kb-phishing-sim-001', title: 'Zero Trust Architecture Implementation Guide', category: 'Architecture', author: 'Security Architecture Team', publishDate: '2026-03-15', views: 1842, rating: 4.8, tags: ['zero-trust', 'network', 'identity'], summary: 'Comprehensive guide for implementing zero trust principles across enterprise infrastructure', readTime: '15 min'},
    {id: 'kb-phishing-sim-002', title: 'Ransomware Defense Playbook 2026', category: 'Threats', author: 'Threat Intelligence Team', publishDate: '2026-04-01', views: 2341, rating: 4.9, tags: ['ransomware', 'incident-response', 'defense'], summary: 'Updated playbook with latest ransomware tactics, techniques, and defensive measures', readTime: '12 min'},
    {id: 'kb-phishing-sim-003', title: 'Cloud Security Best Practices for Multi-Cloud', category: 'Cloud', author: 'Cloud Security Team', publishDate: '2026-02-28', views: 1567, rating: 4.5, tags: ['cloud', 'aws', 'azure', 'gcp'], summary: 'Best practices for securing workloads across multiple cloud service providers', readTime: '18 min'},
    {id: 'kb-phishing-sim-004', title: 'API Security Testing Methodology', category: 'Testing', author: 'Red Team', publishDate: '2026-03-22', views: 987, rating: 4.6, tags: ['api', 'testing', 'owasp'], summary: 'Structured methodology for identifying and testing API security vulnerabilities', readTime: '10 min'},
    {id: 'kb-phishing-sim-005', title: 'Supply Chain Security Risk Management', category: 'Third Party', author: 'GRC Team', publishDate: '2026-01-20', views: 1234, rating: 4.3, tags: ['supply-chain', 'vendor', 'risk'], summary: 'Framework for managing security risks in the software supply chain', readTime: '14 min'},
    {id: 'kb-phishing-sim-006', title: 'Kubernetes Security Hardening Checklist', category: 'Container', author: 'Platform Security', publishDate: '2026-04-10', views: 2103, rating: 4.7, tags: ['kubernetes', 'container', 'hardening'], summary: 'Step-by-step hardening checklist for production Kubernetes clusters', readTime: '11 min'},
    {id: 'kb-phishing-sim-007', title: 'Security Metrics That Matter for Executives', category: 'Metrics', author: 'CISO Office', publishDate: '2026-03-05', views: 876, rating: 4.4, tags: ['metrics', 'kpi', 'reporting'], summary: 'Key security metrics and KPIs that resonate with board-level stakeholders', readTime: '8 min'},
    {id: 'kb-phishing-sim-008', title: 'Phishing Simulation Campaign Design', category: 'Awareness', author: 'Security Awareness Team', publishDate: '2026-02-15', views: 1456, rating: 4.5, tags: ['phishing', 'simulation', 'training'], summary: 'Designing effective phishing simulations that drive real behavioral change', readTime: '9 min'},
    {id: 'kb-phishing-sim-009', title: 'Data Loss Prevention Strategy and Implementation', category: 'Data Protection', author: 'Data Security Team', publishDate: '2026-03-28', views: 1678, rating: 4.6, tags: ['dlp', 'data-protection', 'compliance'], summary: 'Strategic approach to DLP covering people, process, and technology layers', readTime: '16 min'},
    {id: 'kb-phishing-sim-010', title: 'Security Automation with SOAR Platforms', category: 'Automation', author: 'SOC Engineering', publishDate: '2026-04-05', views: 1098, rating: 4.7, tags: ['soar', 'automation', 'soc'], summary: 'Building effective security automation playbooks using SOAR technology', readTime: '13 min'},
    {id: 'kb-phishing-sim-011', title: 'Third-Party Risk Assessment Framework', category: 'GRC', author: 'Vendor Management', publishDate: '2026-01-30', views: 1345, rating: 4.4, tags: ['vendor', 'risk', 'assessment'], summary: 'Structured framework for evaluating and monitoring third-party security risks', readTime: '12 min'},
    {id: 'kb-phishing-sim-012', title: 'Network Detection and Response Best Practices', category: 'Network', author: 'Network Security Team', publishDate: '2026-03-18', views: 1567, rating: 4.5, tags: ['ndr', 'network', 'detection'], summary: 'Implementing effective network detection and response capabilities', readTime: '14 min'},
    {id: 'kb-phishing-sim-013', title: 'Security Chaos Engineering Guide', category: 'Resilience', author: 'SRE Security', publishDate: '2026-04-12', views: 789, rating: 4.3, tags: ['chaos-engineering', 'resilience', 'testing'], summary: 'Applying chaos engineering principles to validate security controls', readTime: '10 min'},
    {id: 'kb-phishing-sim-014', title: 'Incident Communication Templates', category: 'Incident Response', author: 'IR Team', publishDate: '2026-02-22', views: 2234, rating: 4.8, tags: ['incident', 'communication', 'templates'], summary: 'Ready-to-use communication templates for security incident scenarios', readTime: '7 min'},
    {id: 'kb-phishing-sim-015', title: 'Endpoint Detection and Response Configuration', category: 'Endpoint', author: 'Endpoint Security', publishDate: '2026-03-08', views: 1345, rating: 4.5, tags: ['edr', 'endpoint', 'configuration'], summary: 'Optimal EDR configuration for maximum detection with minimal false positives', readTime: '11 min'},
    {id: 'kb-phishing-sim-016', title: 'Security Code Review Standards', category: 'Development', author: 'AppSec Team', publishDate: '2026-02-10', views: 1890, rating: 4.6, tags: ['code-review', 'secure-sdlc', 'standards'], summary: 'Standards and checklists for security-focused code reviews', readTime: '13 min'},
    {id: 'kb-phishing-sim-017', title: 'IoT Security Assessment Methodology', category: 'IoT', author: 'IoT Security Lab', publishDate: '2026-04-08', views: 654, rating: 4.2, tags: ['iot', 'embedded', 'assessment'], summary: 'Methodology for assessing security posture of IoT devices and ecosystems', readTime: '15 min'},
    {id: 'kb-phishing-sim-018', title: 'Passwordless Authentication Migration Guide', category: 'Identity', author: 'IAM Team', publishDate: '2026-03-25', views: 1678, rating: 4.7, tags: ['passwordless', 'authentication', 'mfa'], summary: 'Step-by-step migration plan from password-based to passwordless authentication', readTime: '12 min'},
    {id: 'kb-phishing-sim-019', title: 'Security Awareness Program Metrics', category: 'Awareness', author: 'Security Culture Team', publishDate: '2026-01-25', views: 1123, rating: 4.4, tags: ['awareness', 'metrics', 'culture'], summary: 'Measuring the effectiveness of your security awareness and training programs', readTime: '9 min'},
    {id: 'kb-phishing-sim-020', title: 'Deception Technology Deployment Guide', category: 'Detection', author: 'Blue Team', publishDate: '2026-04-15', views: 876, rating: 4.5, tags: ['deception', 'honeypot', 'detection'], summary: 'Planning and deploying deception technology for advanced threat detection', readTime: '11 min'},
  ];
  ...
  // --- Security Scenario Planning Methods (PHSI) ---
  private _initPhsiScenarios(): void {
    const worstCaseScenarios = [
      { id: "phsi-sc-01", name: "Ransomware Attack on Critical Infrastructure", category: "Malware", impact: 9500000, probability: 0.12, recoveryDays: 21, affectedSystems: 47, dataLossGb: 320, businessImpact: "critical" },
      { id: "phsi-sc-02", name: "Insider Data Exfiltration via Authorized Channels", category: "Insider Threat", impact: 7200000, probability: 0.18, recoveryDays: 14, affectedSystems: 12, dataLossGb: 85, businessImpact: "high" },
      { id: "phsi-sc-03", name: "Supply Chain Compromise via Third-Party Library", category: "Supply Chain", impact: 6800000, probability: 0.09, recoveryDays: 30, affectedSystems: 63, dataLossGb: 0, businessImpact: "critical" },
      { id: "phsi-sc-04", name: "Cloud Misconfiguration Leading to Public Exposure", category: "Cloud", impact: 4100000, probability: 0.22, recoveryDays: 7, affectedSystems: 8, dataLossGb: 450, businessImpact: "high" },
      { id: "phsi-sc-05", name: "Zero-Day Exploit in Core Application Framework", category: "Vulnerability", impact: 8900000, probability: 0.05, recoveryDays: 45, affectedSystems: 120, dataLossGb: 0, businessImpact: "critical" },
      { id: "phsi-sc-06", name: "Distributed Denial of Service on Customer-Facing Services", category: "Availability", impact: 3400000, probability: 0.25, recoveryDays: 3, affectedSystems: 15, dataLossGb: 0, businessImpact: "medium" },
      { id: "phsi-sc-07", name: "Credential Stuffing and Account Takeover Wave", category: "Identity", impact: 2800000, probability: 0.30, recoveryDays: 5, affectedSystems: 6, dataLossGb: 12, businessImpact: "medium" },
      { id: "phsi-sc-08", name: "Physical Security Breach at Data Center Facility", category: "Physical", impact: 12000000, probability: 0.02, recoveryDays: 60, affectedSystems: 200, dataLossGb: 5000, businessImpact: "critical" },
    ];
    this._phsiScenarios = worstCaseScenarios.map(s => ({ ...s, mitigationCost: Math.round(s.impact * 0.08), drillScheduled: false, lastDrillDate: null, drillScore: null, controlGaps: Math.floor(Math.random() * 5) + 1 }));
  }

  private _calculatePhsiScenarioRisk(): void {
    this._phsiScenarios.forEach(s => {
  ...
  private _schedulePhsiDrills(): void {
  ...
  private _phsiScenarioComparison(): Record<string, unknown>[] {
    return this._phsiScenarios.map(s => ({
  ...
  // --- Security Control Effectiveness Analytics (PHSI) ---
  private _initPhsiControls(): void {
    const controls = [
      { id: "phsi-ct-01", name: "Network Segmentation", type: "preventive", maturity: "defined", score: 82, target: 90, failures: 3, lastTest: "2026-03-15" },
      { id: "phsi-ct-02", name: "Endpoint Detection and Response", type: "detective", maturity: "managed", score: 88, target: 92, failures: 1, lastTest: "2026-04-01" },
      { id: "phsi-ct-03", name: "Data Loss Prevention", type: "preventive", maturity: "repeatable", score: 71, target: 85, failures: 7, lastTest: "2026-03-22" },
      { id: "phsi-ct-04", name: "Security Information and Event Management", type: "detective", maturity: "managed", score: 85, target: 90, failures: 2, lastTest: "2026-04-05" },
      { id: "phsi-ct-05", name: "Identity and Access Management", type: "preventive", maturity: "defined", score: 76, target: 88, failures: 5, lastTest: "2026-03-28" },
      { id: "phsi-ct-06", name: "Vulnerability Management", type: "corrective", maturity: "managed", score: 80, target: 90, failures: 4, lastTest: "2026-04-02" },
      { id: "phsi-ct-07", name: "Email Security Gateway", type: "preventive", maturity: "managed", score: 90, target: 95, failures: 1, lastTest: "2026-04-08" },
      { id: "phsi-ct-08", name: "Web Application Firewall", type: "preventive", maturity: "managed", score: 87, target: 92, failures: 2, lastTest: "2026-03-30" },
      { id: "phsi-ct-09", name: "Patch Management", type: "corrective", maturity: "defined", score: 68, target: 85, failures: 9, lastTest: "2026-03-18" },
      { id: "phsi-ct-10", name: "Encryption at Rest", type: "preventive", maturity: "managed", score: 93, target: 95, failures: 0, lastTest: "2026-04-10" },
      { id: "phsi-ct-11", name: "Encryption in Transit", type: "preventive", maturity: "optimized", score: 96, target: 98, failures: 0, lastTest: "2026-04-12" },
      { id: "phsi-ct-12", name: "Privileged Access Management", type: "preventive", maturity: "defined", score: 74, target: 88, failures: 6, lastTest: "2026-03-25" },
      { id: "phsi-ct-13", name: "Security Awareness Training", type: "preventive", maturity: "repeatable", score: 65, target: 80, failures: 11, lastTest: "2026-03-20" },
      { id: "phsi-ct-14", name: "Incident Response Plan", type: "corrective", maturity: "managed", score: 78, target: 88, failures: 4, lastTest: "2026-04-03" },
      { id: "phsi-ct-15", name: "Backup and Recovery", type: "corrective", maturity: "managed", score: 84, target: 92, failures: 3, lastTest: "2026-04-06" },
      { id: "phsi-ct-16", name: "Multi-Factor Authentication", type: "preventive", maturity: "managed", score: 91, target: 95, failures: 1, lastTest: "2026-04-09" },
      { id: "phsi-ct-17", name: "Network Traffic Analysis", type: "detective", maturity: "defined", score: 72, target: 85, failures: 5, lastTest: "2026-03-27" },
      { id: "phsi-ct-18", name: "Cloud Security Posture Management", type: "detective", maturity: "repeatable", score: 69, target: 82, failures: 8, lastTest: "2026-03-24" },
      { id: "phsi-ct-19", name: "Container Security Scanning", type: "preventive", maturity: "defined", score: 75, target: 85, failures: 5, lastTest: "2026-04-04" },
      { id: "phsi-ct-20", name: "API Security Gateway", type: "preventive", maturity: "repeatable", score: 70, target: 82, failures: 7, lastTest: "2026-03-29" },
      { id: "phsi-ct-21", name: "Threat Intelligence Platform", type: "detective", maturity: "managed", score: 83, target: 90, failures: 2, lastTest: "2026-04-07" },
      { id: "phsi-ct-22", name: "Database Activity Monitoring", type: "detective", maturity: "defined", score: 67, target: 80, failures: 8, lastTest: "2026-03-21" },
      { id: "phsi-ct-23", name: "Deception Technology", type: "detective", maturity: "initial", score: 55, target: 75, failures: 12, lastTest: "2026-03-16" },
      { id: "phsi-ct-24", name: "Security Orchestration Automation", type: "corrective", maturity: "repeatable", score: 73, target: 85, failures: 6, lastTest: "2026-04-01" },
      { id: "phsi-ct-25", name: "Third-Party Risk Assessment", type: "preventive", maturity: "defined", score: 64, target: 78, failures: 9, lastTest: "2026-03-19" },
    ];
    this._phsiControls = controls;
  }

  private _analyzePhsiControlEffectiveness(): void {
    const typeBreakdown: Record<string, { total: number; avgScore: number; avgFailures: number }> = {};
    this._phsiControls.forEach(c => {
    ...
    this._phsiControlTypeBreakdown = typeBreakdown;
  }

  private _phsiControlOptimization(): Record<string, unknown>[] {
    return this._phsiControls.filter(c => c.score < c.target).map(c => ({
  ...
  // --- Security Data Pipeline Health (PHSI) ---
  private _initPhsiPipelines(): void {
    const pipelines = [
      { id: "phsi-pl-01", name: "SIEM Log Ingestion", status: "healthy", healthScore: 94, latencyMs: 120, freshnessMin: 2, errorRate: 0.02, throughputMbps: 450, recordsPerSec: 12000, backPressure: 0.05, uptime: 99.97 },
      { id: "phsi-pl-02", name: "Threat Feed Aggregation", status: "healthy", healthScore: 91, latencyMs: 300, freshnessMin: 15, errorRate: 0.05, throughputMbps: 85, recordsPerSec: 3200, backPressure: 0.08, uptime: 99.92 },
      { id: "phsi-pl-03", name: "Vulnerability Scan Results", status: "degraded", healthScore: 72, latencyMs: 2500, freshnessMin: 60, errorRate: 0.15, throughputMbps: 25, recordsPerSec: 800, backPressure: 0.35, uptime: 98.50 },
      { id: "phsi-pl-04", name: "Endpoint Telemetry Stream", status: "healthy", healthScore: 88, latencyMs: 450, freshnessMin: 5, errorRate: 0.08, throughputMbps: 280, recordsPerSec: 8500, backPressure: 0.12, uptime: 99.85 },
      { id: "phsi-pl-05", name: "Cloud Audit Log Pipeline", status: "healthy", healthScore: 86, latencyMs: 600, freshnessMin: 10, errorRate: 0.06, throughputMbps: 150, recordsPerSec: 4500, backPressure: 0.10, uptime: 99.80 },
      { id: "phsi-pl-06", name: "Identity Event Stream", status: "warning", healthScore: 78, latencyMs: 1200, freshnessMin: 20, errorRate: 0.12, throughputMbps: 45, recordsPerSec: 1500, backPressure: 0.22, uptime: 99.40 },
      { id: "phsi-pl-07", name: "Network Flow Collection", status: "healthy", healthScore: 82, latencyMs: 800, freshnessMin: 8, errorRate: 0.09, throughputMbps: 650, recordsPerSec: 18000, backPressure: 0.15, uptime: 99.70 },
      { id: "phsi-pl-08", name: "DLP Incident Pipeline", status: "degraded", healthScore: 68, latencyMs: 3500, freshnessMin: 45, errorRate: 0.20, throughputMbps: 18, recordsPerSec: 500, backPressure: 0.42, uptime: 97.80 },
    ];
    this._phsiPipelines = pipelines.map(p => ({ ...p, dependencies: [], slaBreached: p.healthScore < 75, alertThreshold: p.errorRate > 0.15 }));
    this._phsiPipelines[0].dependencies = ["phsi-pl-04", "phsi-pl-07"];
    this._phsiPipelines[4].dependencies = ["phsi-pl-01"];
    this._phsiPipelines[5].dependencies = ["phsi-pl-02"];
    this._phsiPipelines[7].dependencies = ["phsi-pl-04", "phsi-pl-05"];
  }

  private _phsiPipelineTrend(): Record<string, unknown>[] {
    const hours = Array.from({ length: 24 }, (_, i) => `H${String(i).padStart(2, "0")}`);
    return this._phsiPipelines.map(p => ({
  ...
  // --- Security Stakeholder Report Generator (PHSI) ---
  private _initPhsiReportTemplates(): void {
    this._phsiReportTemplates = [
      { id: "phsi-rp-01", name: "Board Security Report", audience: "board", frequency: "quarterly", sections: 6, autoGenerate: true, lastGenerated: "2026-03-31", pages: 12 },
      { id: "phsi-rp-02", name: "Executive Risk Summary", audience: "executive", frequency: "monthly", sections: 8, autoGenerate: true, lastGenerated: "2026-04-01", pages: 8 },
      { id: "phsi-rp-03", name: "Technical Security Review", audience: "technical", frequency: "weekly", sections: 12, autoGenerate: true, lastGenerated: "2026-04-21", pages: 25 },
      { id: "phsi-rp-04", name: "Audit Compliance Report", audience: "audit", frequency: "quarterly", sections: 10, autoGenerate: false, lastGenerated: "2026-03-15", pages: 35 },
      { id: "phsi-rp-05", name: "Regulatory Filing Package", audience: "regulatory", frequency: "annual", sections: 15, autoGenerate: false, lastGenerated: "2025-12-31", pages: 48 },
    ];
  }

  private _generatePhsiExecSummary(): string {
    const totalRisk = this._phsiScenarios.reduce((sum: number, s: any) => sum + s.riskScore, 0);
    const avgControl = Math.round(this._phsiControls.reduce((sum: number, c: any) => sum + c.score, 0) / this._phsiControls.length);
    const degradedPipes = this._phsiPipelines.filter((p: any) => p.status !== "healthy").length;
    return `Overall risk exposure: ${(totalRisk / 1000000).toFixed(1)}M. Average control effectiveness: {avgControl}%. {degradedPipes} pipeline(s) need attention. {this._phsiScenarios.filter((s: any) => s.mitigationPriority === "immediate").length} scenarios require immediate action.`;
  }

  // --- Security Technology Radar (PHSI) ---
  private _initPhsiTechRadar(): void {
    this._phsiTechRadar = [
      { id: "phsi-tr-01", name: "AI-Powered Threat Detection", ring: "adopt", category: "Detection", maturity: 4, trend: "up", investment: "high", roi: 3.2, vendorCount: 8 },
      { id: "phsi-tr-02", name: "Zero Trust Architecture", ring: "adopt", category: "Architecture", maturity: 4, trend: "up", investment: "high", roi: 2.8, vendorCount: 12 },
      { id: "phsi-tr-03", name: "SASE/SSE Platform", ring: "trial", category: "Network", maturity: 3, trend: "up", investment: "medium", roi: 2.4, vendorCount: 10 },
      { id: "phsi-tr-04", name: "CNAPP Cloud Security", ring: "trial", category: "Cloud", maturity: 3, trend: "up", investment: "medium", roi: 2.1, vendorCount: 7 },
      { id: "phsi-tr-05", name: "Extended Detection and Response", ring: "adopt", category: "Detection", maturity: 4, trend: "stable", investment: "high", roi: 2.9, vendorCount: 9 },
      { id: "phsi-tr-06", name: "Quantum-Safe Cryptography", ring: "assess", category: "Crypto", maturity: 2, trend: "up", investment: "low", roi: 0.8, vendorCount: 4 },
      { id: "phsi-tr-07", name: "Security Service Edge", ring: "trial", category: "Network", maturity: 3, trend: "up", investment: "medium", roi: 2.0, vendorCount: 6 },
      { id: "phsi-tr-08", name: "SOAR 2.0 Autonomous SOC", ring: "assess", category: "Operations", maturity: 2, trend: "up", investment: "low", roi: 1.2, vendorCount: 5 },
      { id: "phsi-tr-09", name: "Software Supply Chain Security", ring: "trial", category: "DevSecOps", maturity: 3, trend: "up", investment: "medium", roi: 2.3, vendorCount: 8 },
      { id: "phsi-tr-10", name: "Identity Threat Detection", ring: "adopt", category: "Identity", maturity: 3, trend: "up", investment: "high", roi: 2.7, vendorCount: 7 },
      { id: "phsi-tr-11", name: "Data Security Posture Management", ring: "trial", category: "Data", maturity: 3, trend: "up", investment: "medium", roi: 2.2, vendorCount: 9 },
      { id: "phsi-tr-12", name: "Decentralized Identity Standards", ring: "hold", category: "Identity", maturity: 1, trend: "stable", investment: "low", roi: 0.5, vendorCount: 3 },
    ];
  }

  private _phsiRadarSummary(): Record<string, unknown> {
    const rings: Record<string, number> = { adopt: 0, trial: 0, assess: 0, hold: 0 };
    this._phsiTechRadar.forEach(t => { if (rings[t.ring as keyof typeof rings] !== undefined) rings[t.ring as keyof typeof rings]++; });
    return { adopt: rings.adopt, trial: rings.trial, assess: rings.assess, hold: rings.hold, total: this._phsiTechRadar.length, avgMaturity: 2.8, topInvestment: this._phsiTechRadar.filter(t => t.investment === "high").map(t => t.name) };
  }

  // --- PHSI Security Compliance Mapping Matrix ---
  private _initPhsiComplianceMatrix(): void {
    ...
    this._phsiComplianceMatrix = frameworks.map(fw => ({
  ...
  private _phsiComplianceTrend(): Record<string, unknown>[] {
    const quarters = ["Q1-2025", "Q2-2025", "Q3-2025", "Q4-2025", "Q1-2026", "Q2-2026"];
    return this._phsiComplianceMatrix.map(fw => ({
  ...
  // --- PHSI Threat Intelligence Correlation Engine ---
  private _initPhsiThreatIntel(): void {
    ...
    this._phsiThreatIntel = threatActors.map((actor, i) => ({
  ...
  private _phsiThreatCorrelation(): Record<string, unknown>[] {
    return this._phsiThreatIntel.filter(t => t.riskScore > 70).map(t => ({
  ...
  // --- PHSI Security Metrics Deep Dive ---
  private _initPhsiMetricsDeep(): void {
    ...
    this._phsiMetricsDeep = metricCategories.map(cat => ({
  ...
  private _phsiMetricsHeatmap(): number[][] {
    return this._phsiMetricsDeep.map(cat =>
      cat.metrics.map(m => Math.round((m.value / m.target) * 100))
    );
  }

  // --- PHSI Incident Cost Modeling ---
  private _initPhsiCostModel(): void {
    const incidentTypes = ["Data Breach", "Ransomware", "DDoS", "Insider Threat", "Phishing", "Supply Chain", "Cloud Misconfig", "Zero-Day"];
    this._phsiCostModel = incidentTypes.map(inc => ({
    ...
    this._phsiCostModel.forEach(m => { m.totalAnnualExposure = m.avgCost * m.frequency; });
  }

  private _phsiCostProjection(): Record<string, unknown>[] {
    return this._phsiCostModel.map(m => ({
  ...
  // --- PHSI Security Architecture Pattern Library ---
  private _initPhsiArchPatterns(): void {
    ...
    this._phsiArchPatterns = patterns.map((p, i) => ({
  ...
  private _phsiArchPatternAnalysis(): Record<string, unknown> {
    const implemented = this._phsiArchPatterns.filter(p => p.implementation > 75).length;
    const avgCoverage = Math.round(this._phsiArchPatterns.reduce((s: number, p: any) => s + p.coverage, 0) / this._phsiArchPatterns.length);
    return {
      totalPatterns: this._phsiArchPatterns.length, fullyImplemented: implemented, avgCoverage,
      avgRiskReduction: Math.round(this._phsiArchPatterns.reduce((s: number, p: any) => s + p.riskReduction, 0) / this._phsiArchPatterns.length),
      gaps: this._phsiArchPatterns.filter(p => p.implementation < 60).map(p => p.pattern),
      recommendations: this._phsiArchPatterns.filter(p => p.implementation < 70).map(p => ({ pattern: p.pattern, current: p.implementation, target: 85, effort: p.costComplexity }))
    };
  }
  ...
  private _b90RiskAssessmentWorkflow = [
  ...
  private _b90TreatmentOptions = [
    {id: 'b90-T-001', riskId: 'RSK-042', risk: 'Ransomware Attack on Critical Infrastructure', before: 20, after: 6, strategy: 'Mitigate', controls: ['Next-gen EDR with behavioral detection and automated response', 'Zero-trust network micro-segmentation isolating critical assets', 'Immutable offline backup rotation with quarterly recovery testing', 'Incident response retainer with 1-hour response SLA'], cost: '$450K/yr', roi: '78% reduction vs $2.8M potential loss', timeline: 'Q3 2026', status: 'approved' as const},
  ...
  private _b90TalentPositions = [
    ...
    {id: 'b90-H-002', title: 'Cloud Security Engineer', dept: 'Cloud Security', level: 'Mid-Senior', loc: 'SF/Remote', salary: '$155K-$180K', posted: '2026-03-20', applicants: 45, pipeline: 12, interviews: 6, offers: 2, urgency: 'high' as const, manager: 'Mike Johnson', skills: ['AWS/Azure/GCP', 'Terraform', 'Kubernetes', 'IAM', 'CSPM'], nice: ['CCSP', 'CKS', 'Serverless']},
    {id: 'b90-H-003', title: 'SOC Analyst L2', dept: 'Security Operations', level: 'Mid', loc: 'Austin TX', salary: '$105K-$130K', posted: '2026-04-01', applicants: 67, pipeline: 18, interviews: 8, offers: 0, urgency: 'medium' as const, manager: 'Lisa Park', skills: ['SIEM', 'Incident triage', 'Malware analysis', 'TCP/IP'], nice: ['GCIA', 'SOAR', 'Kill chain']},
    {id: 'b90-H-004', title: 'Staff Security Architect', dept: 'Architecture', level: 'Staff', loc: 'Remote US', salary: '$200K-$240K', posted: '2026-02-28', applicants: 12, pipeline: 3, interviews: 2, offers: 0, urgency: 'critical' as const, manager: 'David Lee', skills: ['Enterprise arch', 'Zero trust', 'Risk frameworks', 'Board comms'], nice: ['CISSP+SABSA', 'Team building', 'Speaker']},
    {id: 'b90-H-005', title: 'GRC Analyst', dept: 'GRC', level: 'Mid', loc: 'NY/Remote', salary: '$110K-$135K', posted: '2026-04-05', applicants: 34, pipeline: 9, interviews: 3, offers: 1, urgency: 'medium' as const, manager: 'Rachel Green', skills: ['ISO 27001', 'SOC 2', 'Risk assessment', 'Audit'], nice: ['CRISC', 'CISA', 'GDPR']},
    {id: 'b90-H-006', title: 'Threat Intel Analyst', dept: 'Threat Intel', level: 'Mid-Senior', loc: 'Remote US', salary: '$140K-$170K', posted: '2026-03-25', applicants: 19, pipeline: 5, interviews: 2, offers: 0, urgency: 'low' as const, manager: 'James Wilson', skills: ['MITRE ATT&CK', 'OSINT', 'Threat modeling', 'Reverse eng'], nice: ['CTIA', 'Nation-state', 'Dark web']},
    {id: 'b90-H-007', title: 'AppSec Engineer', dept: 'AppSec', level: 'Senior', loc: 'Seattle/Remote', salary: '$160K-$190K', posted: '2026-04-10', applicants: 28, pipeline: 7, interviews: 3, offers: 0, urgency: 'medium' as const, manager: 'Emily Zhang', skills: ['SAST/DAST/SCA', 'Secure SDLC', 'Code review', 'CI/CD'], nice: ['CSSLP', 'Mobile security']},
    {id: 'b90-H-008', title: 'IAM Engineer', dept: 'IAM', level: 'Mid', loc: 'Remote US', salary: '$135K-$160K', posted: '2026-04-08', applicants: 31, pipeline: 10, interviews: 5, offers: 1, urgency: 'medium' as const, manager: 'Chris Martinez', skills: ['Okta/Azure AD', 'SAML/OIDC', 'PAM', 'RBAC'], nice: ['CISSP', 'Zero trust IAM']}
  ];

  private _b90InterviewScorecard = [
  ...
  private _b90OnboardingSteps = [
    {id: 'b90-OB-01', item: 'Provision security-hardened laptop, monitors, peripherals, and configured workstation image with all required security tools', cat: 'IT Setup', day: 'Day 1', owner: 'IT Operations'},
    {id: 'b90-OB-02', item: 'Create AD account, email, Slack, VPN, SSO enrollment, and all required application access accounts', cat: 'Access', day: 'Day 1', owner: 'IAM Team'},
    {id: 'b90-OB-03', item: 'Grant security tooling access: SIEM console, EDR dashboard, vuln scanner, pentest platforms, SOAR', cat: 'Tools', day: 'Day 1-2', owner: 'SOC Manager'},
    {id: 'b90-OB-04', item: 'Complete MFA enrollment, security awareness onboarding course, and acceptable use policy acknowledgment', cat: 'Security', day: 'Day 1', owner: 'Awareness Team'},
    {id: 'b90-OB-05', item: 'Sign NDA, employment agreement, IP assignment, and code of conduct documents with HR', cat: 'HR', day: 'Day 1', owner: 'Human Resources'},
    {id: 'b90-OB-06', item: 'Introduction meetings with direct team members and key cross-functional stakeholders', cat: 'Integration', day: 'Week 1', owner: 'Hiring Manager'},
    {id: 'b90-OB-07', item: 'Security architecture overview, tooling walkthrough, and operational runbook review sessions', cat: 'Training', day: 'Week 1-2', owner: 'Security Architect'},
    {id: 'b90-OB-08', item: 'Shadow experienced team member on active incident response and threat hunting investigations', cat: 'Mentoring', day: 'Week 2-3', owner: 'SOC Lead'},
    {id: 'b90-OB-09', item: 'Set up individual certification study plan aligned with role requirements and career goals', cat: 'Development', day: 'Week 2', owner: 'Hiring Manager'},
    {id: 'b90-OB-10', item: 'Establish 30-60-90 day goals, define success metrics, and schedule first performance checkpoint', cat: 'Goals', day: 'Week 1', owner: 'Hiring Manager'}
  ];

  private _b90MetricsDashboard = [
    {id: 'b90-MTD-001', name: 'Mean Time to Detect (MTTD)', value: '4.2 hours', trend: 'improving' as const, target: '< 4 hours', source: 'SIEM - Splunk', method: 'Median time from first alert to analyst acknowledgment', owner: 'SOC Manager', sla: '4 hours', prev: '5.1 hours', spark: [5.8, 5.4, 5.1, 4.9, 4.7, 4.5, 4.3, 4.2], breakdown: [{src: 'Network IDS', pct: '35%', avg: '3.8h'}, {src: 'Endpoint EDR', pct: '28%', avg: '4.1h'}, {src: 'Email Gateway', pct: '22%', avg: '3.5h'}, {src: 'Cloud Security', pct: '10%', avg: '5.2h'}, {src: 'User Reports', pct: '5%', avg: '6.8h'}]},
    {id: 'b90-MTD-002', name: 'Mean Time to Respond (MTTR)', value: '2.8 hours', trend: 'stable' as const, target: '< 3 hours', source: 'SOAR - XSOAR', method: 'Median time from acknowledgment to first containment action', owner: 'IR Lead', sla: '3 hours', prev: '2.7 hours', spark: [3.2, 3.0, 2.9, 2.8, 2.8, 2.9, 2.8, 2.8], breakdown: [{src: 'Auto Playbooks', pct: '42%', avg: '1.2h'}, {src: 'Semi-Auto', pct: '33%', avg: '2.5h'}, {src: 'Manual', pct: '20%', avg: '5.1h'}, {src: 'L3 Escalation', pct: '5%', avg: '8.3h'}]},
    {id: 'b90-MTD-003', name: 'Patch Compliance Rate', value: '97.6%', trend: 'improving' as const, target: '> 95%', source: 'Tenable.io', method: 'Pct of critical/high vulns patched within SLA windows', owner: 'Vuln Manager', sla: '95%', prev: '96.1%', spark: [93.2, 94.1, 94.8, 95.3, 95.9, 96.4, 97.0, 97.6], breakdown: [{src: 'Critical (7d)', pct: '40%', rate: '99.2%'}, {src: 'High (30d)', pct: '35%', rate: '97.8%'}, {src: 'Medium (90d)', pct: '20%', rate: '95.1%'}, {src: 'Low (180d)', pct: '5%', rate: '89.4%'}]},
    {id: 'b90-MTD-004', name: 'Phishing Click Rate', value: '3.2%', trend: 'improving' as const, target: '< 5%', source: 'KnowBe4 + Proofpoint', method: 'Pct of users clicking simulated phishing links monthly', owner: 'Awareness Lead', sla: '5%', prev: '4.1%', spark: [6.8, 6.2, 5.5, 5.1, 4.6, 4.1, 3.6, 3.2], breakdown: [{src: 'Spear Phishing', pct: '35%', rate: '5.1%'}, {src: 'Generic Phishing', pct: '30%', rate: '2.8%'}, {src: 'BEC Sim', pct: '20%', rate: '3.5%'}, {src: 'SMS Phishing', pct: '15%', rate: '1.9%'}]},
    {id: 'b90-MTD-005', name: 'Security Posture Score', value: '784', trend: 'improving' as const, target: '> 750', source: 'SecurityScorecard', method: 'Composite: external 30%, compliance 25%, vuln 25%, config 20%', owner: 'CISO', sla: '> 750', prev: '771', spark: [748, 752, 758, 762, 768, 773, 778, 784], breakdown: [{src: 'External Rating', pct: '30%', score: '791'}, {src: 'Compliance', pct: '25%', score: '812'}, {src: 'Vuln Mgmt', pct: '25%', score: '745'}, {src: 'Config', pct: '20%', score: '769'}]},
    {id: 'b90-MTD-006', name: 'Vulnerability Backlog', value: '142', trend: 'improving' as const, target: '< 150', source: 'Tenable + Qualys', method: 'Total open vulns across all scanned assets tracked weekly', owner: 'Vuln Manager', sla: '< 150', prev: '168', spark: [210, 198, 185, 175, 165, 158, 150, 142], breakdown: [{src: 'Critical', pct: '8%', count: '11'}, {src: 'High', pct: '22%', count: '31'}, {src: 'Medium', pct: '45%', count: '64'}, {src: 'Low', pct: '25%', count: '36'}]}
  ];

  private _b90ArchReview = [
    {id: 'b90-AR-001', cat: 'Network', item: 'Network segmentation between trust zones with dedicated firewalls and granular ACLs', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Micro-segmentation via NSX across all production zones'},
    {id: 'b90-AR-002', cat: 'Network', item: 'DMZ architecture isolating public services from internal network', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Dual-firewall DMZ with WAF and DDoS mitigation'},
    {id: 'b90-AR-003', cat: 'Network', item: 'Least-privilege traffic flows with deny-by-default and quarterly review', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Explicit allow rules with automated drift detection'},
    {id: 'b90-AR-004', cat: 'Network', item: 'Encrypted external communications with IPSec/TLS 1.3 and PFS', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'IKEv2 with PFS, TLS 1.3 for all external APIs'},
    {id: 'b90-AR-005', cat: 'Identity', item: 'Centralized IdP with SSO and automated SCIM provisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Okta SSO SAML 2.0 for 247 apps with SCIM'},
    {id: 'b90-AR-006', cat: 'Identity', item: 'RBAC with quarterly reviews and automated deprovisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Quarterly recertification with JIT admin access'},
    {id: 'b90-AR-007', cat: 'Identity', item: 'PAM controlling all admin and service accounts with session recording', sev: 'high' as const, status: 'fail' as const, reviewer: 'IAM Lead', notes: '3 legacy accounts pending CyberArk enrollment'},
    {id: 'b90-AR-008', cat: 'Identity', item: 'MFA enforced for all users, hardware tokens for privileged access', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'FIDO2 for admins, push MFA for users, 99.8% enrollment'},
    {id: 'b90-AR-009', cat: 'Data', item: 'Data classification enforced with automated labeling on all repos', sev: 'high' as const, status: 'partial' as const, reviewer: 'Data Protection Lead', notes: 'Framework deployed, gaps on 4 legacy file shares'},
    {id: 'b90-AR-010', cat: 'Data', item: 'AES-256 encryption at rest for all sensitive data stores', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'Full-disk, TDE on DBs, SSE-KMS on cloud storage'},
    {id: 'b90-AR-011', cat: 'Data', item: 'DLP monitoring and preventing unauthorized data exfiltration', sev: 'high' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'DLP active on email, endpoint, cloud, and network'},
    {id: 'b90-AR-012', cat: 'Data', item: 'Encrypted off-site backups with quarterly restore testing', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Infrastructure Lead', notes: '3-2-1 strategy with immutable backups'},
    {id: 'b90-AR-013', cat: 'AppSec', item: 'Secure SDLC with SAST, DAST, SCA in all CI/CD pipelines', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: '34 pipelines with security gates and PR blocking'},
    {id: 'b90-AR-014', cat: 'AppSec', item: 'API gateway with auth, rate limiting, schema validation', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: 'Kong with OAuth2, rate limits, OpenAPI validation'},
    {id: 'b90-AR-015', cat: 'AppSec', item: 'Container security with image scanning and runtime protection', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Trivy scanning, Falco runtime in 80% of clusters'},
    {id: 'b90-AR-016', cat: 'Monitoring', item: 'SIEM collecting from all critical systems with correlation rules', sev: 'critical' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'Splunk 98% coverage with 1200+ correlation rules'},
    {id: 'b90-AR-017', cat: 'Monitoring', item: 'EDR with behavioral detection on all managed endpoints', sev: 'high' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'CrowdStrike on 99.2% endpoints with 24/7 MDR'},
    {id: 'b90-AR-018', cat: 'Monitoring', item: 'Executive dashboards with real-time posture visibility', sev: 'medium' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'PowerBI dashboards with weekly exec summaries'},
    {id: 'b90-AR-019', cat: 'Cloud', item: 'CSPM monitoring and remediating cloud misconfigurations', sev: 'high' as const, status: 'pass' as const, reviewer: 'Cloud Security Lead', notes: 'Prisma Cloud 450+ checks with auto-remediation'},
    {id: 'b90-AR-020', cat: 'Cloud', item: 'IaC templates scanned before deployment to production', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Checkov for Terraform, cfn-nag for CloudFormation pending'}
  ];

  private _getb90RiskProgress(): number {
    return Math.round(this._b90RiskAssessmentWorkflow.filter(s => s.status === 'completed').length / this._b90RiskAssessmentWorkflow.length * 100);
  }

  private _getb90TreatmentSummary(): {total: number; approved: number; avgReduction: number; investment: string} {
    const a = this._b90TreatmentOptions.filter(r => r.status === 'approved').length;
    const avg = this._b90TreatmentOptions.reduce((s, r) => s + ((r.before - r.after) / r.before * 100), 0) / this._b90TreatmentOptions.length;
    return {total: this._b90TreatmentOptions.length, approved: a, avgReduction: Math.round(avg), investment: '$1.125M annually'};
  }

  private _getb90RuleSummary(): {total: number; passing: number; failing: number; avgRate: number; violations: number} {
    const p = this._b90ComplianceRules.filter(r => r.result === 'pass').length;
    const f = this._b90ComplianceRules.filter(r => r.result === 'fail').length;
    const avg = this._b90ComplianceRules.reduce((s, r) => s + r.passRate, 0) / this._b90ComplianceRules.length;
    const v = this._b90ComplianceRules.reduce((s, r) => s + r.violations, 0);
    return {total: this._b90ComplianceRules.length, passing: p, failing: f, avgRate: Math.round(avg * 10) / 10, violations: v};
  }

  private _getb90PipelineStats(): {positions: number; applicants: number; interviewing: number; offers: number; critical: number} {
    const t = this._b90TalentPositions.length;
    const a = this._b90TalentPositions.reduce((s, p) => s + p.applicants, 0);
    const i = this._b90TalentPositions.reduce((s, p) => s + p.interviews, 0);
    const o = this._b90TalentPositions.reduce((s, p) => s + p.offers, 0);
    const c = this._b90TalentPositions.filter(x => x.urgency === 'critical').length;
    return {positions: t, applicants: a, interviewing: i, offers: o, critical: c};
  }

  private _getb90MetricTrends(): {improving: number; stable: number; total: number} {
    const imp = this._b90MetricsDashboard.filter(m => m.trend === 'improving').length;
    const stb = this._b90MetricsDashboard.filter(m => m.trend === 'stable').length;
    return {improving: imp, stable: stb, total: this._b90MetricsDashboard.length};
  }

  private _getb90ArchScore(): {total: number; passed: number; failed: number; partial: number; score: number} {
    const p = this._b90ArchReview.filter(c => c.status === 'pass').length;
    const f = this._b90ArchReview.filter(c => c.status === 'fail').length;
    const pa = this._b90ArchReview.filter(c => c.status === 'partial').length;
    return {total: this._b90ArchReview.length, passed: p, failed: f, partial: pa, score: Math.round((p / this._b90ArchReview.length) * 100)};
  }


  private _zb90IncidentScenarios = [
    {id: 'zb90-IS-001', name: 'Ransomware Outbreak in Production Environment', category: 'Malware', likelihood: 'Medium', impact: 'Critical', riskScore: 15, playbooks: ['IR-Ransomware-Isolate', 'IR-Ransomware-Eradicate', 'IR-Ransomway-Recover'], estimatedMTTD: '15min', estimatedMTTR: '4h', involvedTeams: ['SOC', 'IR', 'Infrastructure', 'Legal', 'Comms'], keyIndicators: ['Mass file encryption events', 'Ransom note deployment', 'Lateral movement via SMB/RDP', 'Backup deletion attempts'], mitigationControls: ['EDR behavioral detection', 'Network segmentation', 'Immutable backups', 'Email filtering'], lessonsLearned: 'Ensure offline backups are tested quarterly and Ransomware-specific playbooks are updated with latest threat intelligence', lastDrillDate: '2026-03-15', nextDrillDate: '2026-06-15'},
    {id: 'zb90-IS-002', name: 'Cloud Misconfiguration Leading to Data Exposure', category: 'Cloud', likelihood: 'High', impact: 'High', riskScore: 16, playbooks: ['IR-Cloud-Misconfig-Assess', 'IR-Cloud-Misconfig-Remediate', 'IR-Cloud-Misconfig-Notify'], estimatedMTTD: '2h', estimatedMTTR: '6h', involvedTeams: ['Cloud Security', 'SOC', 'Data Protection', 'Legal'], keyIndicators: ['Public S3 bucket exposure', 'Overly permissive IAM policies', 'Unencrypted database snapshots', 'Public API endpoint discovery'], mitigationControls: ['CSPM monitoring', 'IAM policy analyzer', 'Automated remediation', 'Cloud audit logging'], lessonsLearned: 'Implement CSPM with auto-remediation for common misconfigurations and conduct monthly cloud configuration reviews', lastDrillDate: '2026-02-20', nextDrillDate: '2026-05-20'},
    {id: 'zb90-IS-003', name: 'Insider Threat Data Exfiltration', category: 'Insider', likelihood: 'Low', impact: 'Critical', riskScore: 12, playbooks: ['IR-Insider-Investigate', 'IR-Insider-Contain', 'IR-Insider-Escalate'], estimatedMTTD: '8h', estimatedMTTR: '24h', involvedTeams: ['SOC', 'IR', 'HR', 'Legal', 'IAM'], keyIndicators: ['Anomalous data access patterns', 'Large file downloads to USB or cloud', 'Off-hours access to sensitive systems', 'Accessing data outside normal job scope'], mitigationControls: ['UEBA analytics', 'DLP policies', 'PAM controls', 'Access reviews'], lessonsLearned: 'Strengthen UEBA baselines and implement automated alerts for data access pattern anomalies', lastDrillDate: '2026-01-10', nextDrillDate: '2026-04-10'},
    {id: 'zb90-IS-004', name: 'Supply Chain Attack via Compromised Vendor Software', category: 'Supply Chain', likelihood: 'Low', impact: 'Critical', riskScore: 12, playbooks: ['IR-SupplyChain-Detect', 'IR-SupplyChain-Isolate', 'IR-SupplyChain-Remediate'], estimatedMTTD: '24h', estimatedMTTR: '72h', involvedTeams: ['SOC', 'IR', 'Procurement', 'Vendor Mgmt', 'Legal'], keyIndicators: ['Unexpected network connections from vendor software', 'Modified binaries or dependencies', 'Anomalous behavior from trusted applications', 'SBOM discrepancy alerts'], mitigationControls: ['SCA scanning', 'SBOM monitoring', 'Vendor security assessments', 'Network segmentation'], lessonsLearned: 'Require SBOM from all vendors and implement continuous monitoring of third-party component behavior', lastDrillDate: '2026-03-01', nextDrillDate: '2026-06-01'},
    {id: 'zb90-IS-005', name: 'Credential Stuffing Attack on Customer Portal', category: 'External Attack', likelihood: 'High', impact: 'Medium', riskScore: 12, playbooks: ['IR-CredentialStuffing-Detect', 'IR-CredentialStuffing-Block', 'IR-CredentialStuffing-Notify'], estimatedMTTD: '30min', estimatedMTTR: '2h', involvedTeams: ['SOC', 'AppSec', 'Customer Support', 'Comms'], keyIndicators: ['High volume of failed login attempts', 'Login attempts from known compromised credential lists', 'Unusual geographic distribution of login attempts', 'Account takeover indicators'], mitigationControls: ['WAF rate limiting', 'CAPTCHA on login', 'MFA enforcement', 'Credential monitoring service'], lessonsLearned: 'Deploy advanced bot detection on login endpoints and implement proactive credential monitoring for customer accounts', lastDrillDate: '2026-04-01', nextDrillDate: '2026-07-01'},
    {id: 'zb90-IS-006', name: 'Phishing Campaign Targeting Executive Team', category: 'Social Engineering', likelihood: 'High', impact: 'High', riskScore: 16, playbooks: ['IR-Phishing-Contain', 'IR-Phishing-Investigate', 'IR-Phishing-Notify'], estimatedMTTD: '1h', estimatedMTTR: '4h', involvedTeams: ['SOC', 'Awareness', 'Executive Office', 'IT'], keyIndicators: ['Sophisticated spear-phishing emails to C-suite', 'Business email compromise indicators', 'Redirected MFA approval requests', 'Unauthorized wire transfer attempts'], mitigationControls: ['AI email filtering', 'Executive awareness training', 'Out-of-band verification policy', 'DMARC/DKIM/SPF'], lessonsLearned: 'Implement additional email security controls for executive mailboxes and conduct monthly spear-phishing simulations', lastDrillDate: '2026-02-15', nextDrillDate: '2026-05-15'}
  ];

  private _zb90SecurityFrameworks = [
  ...
  private _getzb90ScenarioSummary(): {total: number; critical: number; high: number; drilled: number; avgRiskScore: number} {
    const crit = this._zb90IncidentScenarios.filter(s => s.impact === 'Critical').length;
    const high = this._zb90IncidentScenarios.filter(s => s.impact === 'High').length;
    const avg = this._zb90IncidentScenarios.reduce((s, x) => s + x.riskScore, 0) / this._zb90IncidentScenarios.length;
    return {total: this._zb90IncidentScenarios.length, critical: crit, high: high, drilled: this._zb90IncidentScenarios.length, avgRiskScore: Math.round(avg)};
  }

  private _getzb90VendorRiskSummary(): {total: number; approved: number; conditional: number; remediation: number; avgScore: number} {
    const approved = this._zb90ThirdPartyRiskData.filter(v => v.status === 'approved').length;
    const cond = this._zb90ThirdPartyRiskData.filter(v => v.status === 'conditional').length;
    const rem = this._zb90ThirdPartyRiskData.filter(v => v.status === 'remediation_required').length;
    const avg = this._zb90ThirdPartyRiskData.reduce((s, v) => s + v.riskScore, 0) / this._zb90ThirdPartyRiskData.length;
    return {total: this._zb90ThirdPartyRiskData.length, approved, conditional: cond, remediation: rem, avgScore: Math.round(avg)};
  }

  private _getzb90TrainingSummary(): {total: number; avgCompletion: number; avgScore: number; overdueUpdates: number} {
    const avgComp = this._zb90SecurityTrainingCatalog.reduce((s, t) => s + t.completionRate, 0) / this._zb90SecurityTrainingCatalog.length;
    const avgScore = this._zb90SecurityTrainingCatalog.filter(t => t.avgScore > 0).reduce((s, t) => s + t.avgScore, 0) / this._zb90SecurityTrainingCatalog.filter(t => t.avgScore > 0).length;
    return {total: this._zb90SecurityTrainingCatalog.length, avgCompletion: Math.round(avgComp * 10) / 10, avgScore: Math.round(avgScore), overdueUpdates: 0};
  }

  private _getzb90ToolHealthSummary(): {total: number; healthy: number; degraded: number; annualCost: string} {
    const healthy = this._zb90SecurityToolInventory.filter(t => t.health === 'healthy').length;
    const degraded = this._zb90SecurityToolInventory.filter(t => t.health === 'degraded').length;
    const cost = this._zb90SecurityToolInventory.reduce((s, t) => s + parseInt(t.annualCost.replace(/[^0-9]/g, '')), 0);
    return {total: this._zb90SecurityToolInventory.length, healthy, degraded, annualCost: '$' + (cost / 1000).toFixed(0) + 'K'};
  }


  private _xb90SecurityZones = [
    {zoneId: 'xb90-Z-001', name: 'Internet DMZ', trustLevel: 'Untrusted', subnet: '10.0.0.0/24', segmentation: 'Dual-firewall', firewallRules: 45, monitoring: 'Full packet capture', assets: ['Web servers', 'Load balancers', 'WAF appliances', 'Reverse proxy'], riskLevel: 'high' as const, lastAssessment: '2026-04-15', nextAssessment: '2026-07-15'},
    {zoneId: 'xb90-Z-002', name: 'Corporate Network', trustLevel: 'Trusted', subnet: '10.1.0.0/16', segmentation: 'VLAN + micro-seg', firewallRules: 128, monitoring: 'NetFlow + IDS', assets: ['Workstations', 'Printers', 'Meeting room systems', 'VoIP phones'], riskLevel: 'medium' as const, lastAssessment: '2026-04-10', nextAssessment: '2026-07-10'},
    {zoneId: 'xb90-Z-003', name: 'Production Data Center', trustLevel: 'Restricted', subnet: '10.2.0.0/16', segmentation: 'Full micro-segmentation', firewallRules: 256, monitoring: 'Full packet capture + EDR', assets: ['Application servers', 'Database clusters', 'Message queues', 'API gateways'], riskLevel: 'low' as const, lastAssessment: '2026-04-12', nextAssessment: '2026-07-12'},
    {zoneId: 'xb90-Z-004', name: 'Management Network', trustLevel: 'Restricted', subnet: '10.3.0.0/24', segmentation: 'Isolated VLAN', firewallRules: 32, monitoring: 'Syslog + SNMP', assets: ['Hypervisors', 'Switch management', 'Storage controllers', 'Backup appliances'], riskLevel: 'low' as const, lastAssessment: '2026-04-08', nextAssessment: '2026-07-08'},
    {zoneId: 'xb90-Z-005', name: 'Cloud Production', trustLevel: 'Restricted', subnet: 'VPC: 172.16.0.0/12', segmentation: 'Security groups + NACLs', firewallRules: 189, monitoring: 'VPC Flow Logs + GuardDuty', assets: ['Kubernetes clusters', 'Managed databases', 'Object storage', 'Serverless functions'], riskLevel: 'medium' as const, lastAssessment: '2026-04-18', nextAssessment: '2026-07-18'}
  ];

  private _xb90SecurityAlerts = [
    {id: 'xb90-AL-001', severity: 'critical', title: 'Active ransomware encryption detected on PROD-DB-01', source: 'CrowdStrike', timestamp: '2026-04-22T13:45:00Z', status: 'investigating', assignee: 'SOC Analyst J. Smith', asset: 'PROD-DB-01 (10.2.1.15)', mitreTechnique: 'T1486 - Data Encrypted for Impact', playbook: 'IR-Ransomware-Isolate', sla: '15 minutes', elapsed: '12 minutes', notes: 'EDR detected mass file encryption event pattern. Automated isolation triggered. IR team paged.'},
    {id: 'xb90-AL-002', severity: 'high', title: 'Impossible travel detected for user admin@company.com', source: 'Okta', timestamp: '2026-04-22T12:30:00Z', status: 'triaged', assignee: 'SOC Analyst M. Johnson', asset: 'Okta - admin@company.com', mitreTechnique: 'T1078 - Valid Accounts', playbook: 'IR-ImpossibleTravel', sla: '30 minutes', elapsed: '87 minutes', notes: 'Login from Tokyo followed by login from New York within 30 minutes. Account temporarily locked. User confirmed via out-of-band channel they are in New York.'},
    {id: 'xb90-AL-003', severity: 'high', title: 'Public S3 bucket discovered with customer PII exposure', source: 'Prisma Cloud', timestamp: '2026-04-22T11:15:00Z', status: 'remediating', assignee: 'Cloud Security Lead A. Chen', asset: 'AWS S3: customer-data-archive-2024', mitreTechnique: 'N/A - Misconfiguration', playbook: 'IR-Cloud-Misconfig-Remediate', sla: '1 hour', elapsed: '2.5 hours', notes: 'Bucket containing archived customer records was publicly accessible. Bucket blocked and encrypted. Data exposure assessment in progress.'},
    {id: 'xb90-AL-004', severity: 'medium', title: 'Anomalous data download by user jane.developer@company.com', source: 'Microsoft DLP', timestamp: '2026-04-22T10:00:00Z', status: 'investigating', assignee: 'SOC Analyst R. Davis', asset: 'Endpoint: WS-DEV-042', mitreTechnique: 'T1567 - Exfil Over Web Service', playbook: 'IR-DLP-Investigation', sla: '4 hours', elapsed: '3.5 hours', notes: 'User downloaded 4.2GB of source code files to personal Google Drive. Interview scheduled with user and manager.'},
    {id: 'xb90-AL-005', severity: 'medium', title: 'Credential stuffing attack detected on customer portal', source: 'Cloudflare WAF', timestamp: '2026-04-22T09:30:00Z', status: 'contained', assignee: 'SOC Analyst K. Wilson', asset: 'Customer Portal (portal.company.com)', mitreTechnique: 'T1110 - Brute Force', playbook: 'IR-CredentialStuffing-Block', sla: '2 hours', elapsed: '4 hours', notes: 'Rate limiting and CAPTCHA automatically deployed. 12,000 failed login attempts from 800 unique IPs blocked. No successful account takeovers confirmed.'},
    {id: 'xb90-AL-006', severity: 'low', title: 'SSL certificate expiring in 14 days for api.company.com', source: 'Certificate monitoring', timestamp: '2026-04-22T08:00:00Z', status: 'remediated', assignee: 'Infrastructure Lead T. Brown', asset: 'api.company.com', mitreTechnique: 'N/A', playbook: 'Certificate Renewal', sla: '30 days', elapsed: '16 days', notes: 'Automated renewal triggered via ACME. New certificate deployed successfully. No service interruption.'}
  ];

  private _xb90ComplianceFrameworks = [
  ...
  private _xb90DataClassificationPolicy = [
  ...
  private _getxb90ZoneSummary(): {total: number; highRisk: number; mediumRisk: number; lowRisk: number; totalRules: number} {
    const high = this._xb90SecurityZones.filter(z => z.riskLevel === 'high').length;
    const med = this._xb90SecurityZones.filter(z => z.riskLevel === 'medium').length;
    const low = this._xb90SecurityZones.filter(z => z.riskLevel === 'low').length;
    const rules = this._xb90SecurityZones.reduce((s, z) => s + z.firewallRules, 0);
    return {total: this._xb90SecurityZones.length, highRisk: high, mediumRisk: med, lowRisk: low, totalRules: rules};
  }

  private _getxb90AlertSummary(): {total: number; critical: number; high: number; medium: number; low: number; open: number; contained: number} {
    const crit = this._xb90SecurityAlerts.filter(a => a.severity === 'critical').length;
    const high = this._xb90SecurityAlerts.filter(a => a.severity === 'high').length;
    const med = this._xb90SecurityAlerts.filter(a => a.severity === 'medium').length;
    const low = this._xb90SecurityAlerts.filter(a => a.severity === 'low').length;
    const open = this._xb90SecurityAlerts.filter(a => a.status === 'investigating' || a.status === 'triaged').length;
    const contained = this._xb90SecurityAlerts.filter(a => a.status === 'contained' || a.status === 'remediated').length;
    return {total: this._xb90SecurityAlerts.length, critical: crit, high, medium: med, low, open, contained};
  }

  private _getxb90ComplianceSummary(): {total: number; fullyCompliant: number; mostlyCompliant: number; avgComplianceRate: number} {
    const full = this._xb90ComplianceFrameworks.filter(f => f.status === 'compliant').length;
    const mostly = this._xb90ComplianceFrameworks.filter(f => f.status === 'mostly_compliant').length;
    const avgRate = this._xb90ComplianceFrameworks.reduce((s, f) => s + (f.compliant / f.requirements * 100), 0) / this._xb90ComplianceFrameworks.length;
    return {total: this._xb90ComplianceFrameworks.length, fullyCompliant: full, mostlyCompliant: mostly, avgComplianceRate: Math.round(avgRate * 10) / 10};
  }
  ...
  // === Security Risk Register (phishing_sim) ===
  private _phishing_simRiskRegister = [
    { id: "RSK-PHI-0001", title: "Data breach from unpatched systems", owner: "CTO", category: "Financial", status: "mitigating", trend: "stable", severity: "low", likelihood: 3, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-20", nextReview: "2026-07-11" },
    { id: "RSK-PHI-0002", title: "Ransomware attack on critical infrastructure", owner: "CRO", category: "Strategic", status: "closed", trend: "decreasing", severity: "critical", likelihood: 5, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-20", nextReview: "2026-07-15" },
    { id: "RSK-PHI-0003", title: "Insider threat data exfiltration", owner: "VP Eng", category: "Compliance", status: "accepted", trend: "increasing", severity: "high", likelihood: 9, impact: 2, treatment: "Monitor and review quarterly", lastReview: "2026-04-23", nextReview: "2026-07-13" },
    { id: "RSK-PHI-0004", title: "Supply chain compromise", owner: "Security Lead", category: "Technical", status: "open", trend: "stable", severity: "high", likelihood: 6, impact: 2, treatment: "Monitor and review quarterly", lastReview: "2026-04-04", nextReview: "2026-07-27" },
    { id: "RSK-PHI-0005", title: "Cloud misconfiguration exposure", owner: "Risk Mgr", category: "Reputational", status: "mitigating", trend: "decreasing", severity: "high", likelihood: 5, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-18", nextReview: "2026-07-07" },
    { id: "RSK-PHI-0006", title: "Phishing campaign success rate", owner: "Compliance Dir", category: "Legal", status: "closed", trend: "increasing", severity: "low", likelihood: 4, impact: 5, treatment: "Monitor and review quarterly", lastReview: "2026-04-13", nextReview: "2026-07-10" },
    { id: "RSK-PHI-0007", title: "Third-party vendor data breach", owner: "IT Dir", category: "Regulatory", status: "accepted", trend: "stable", severity: "medium", likelihood: 8, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-17", nextReview: "2026-07-04" },
    { id: "RSK-PHI-0008", title: "Regulatory non-compliance penalty", owner: "DevOps Lead", category: "Third-Party", status: "open", trend: "decreasing", severity: "low", likelihood: 3, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-13", nextReview: "2026-07-26" },
    { id: "RSK-PHI-0009", title: "Zero-day exploit in production", owner: "Architect", category: "Human Capital", status: "mitigating", trend: "increasing", severity: "low", likelihood: 2, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-19", nextReview: "2026-07-28" },
    { id: "RSK-PHI-0010", title: "Insufficient access controls", owner: "CISO", category: "Operational", status: "closed", trend: "stable", severity: "medium", likelihood: 3, impact: 6, treatment: "Monitor and review quarterly", lastReview: "2026-04-03", nextReview: "2026-07-28" },
    { id: "RSK-PHI-0011", title: "DDoS attack on services", owner: "CTO", category: "Financial", status: "accepted", trend: "decreasing", severity: "medium", likelihood: 4, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-16", nextReview: "2026-07-22" },
    { id: "RSK-PHI-0012", title: "Social engineering attack", owner: "CRO", category: "Strategic", status: "open", trend: "increasing", severity: "high", likelihood: 1, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-15", nextReview: "2026-07-20" },
    { id: "RSK-PHI-0013", title: "API security vulnerability", owner: "VP Eng", category: "Compliance", status: "mitigating", trend: "stable", severity: "critical", likelihood: 7, impact: 4, treatment: "Monitor and review quarterly", lastReview: "2026-04-04", nextReview: "2026-07-18" },
    { id: "RSK-PHI-0014", title: "Mobile device compromise", owner: "Security Lead", category: "Technical", status: "closed", trend: "decreasing", severity: "high", likelihood: 9, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-10", nextReview: "2026-07-02" },
    { id: "RSK-PHI-0015", title: "Physical security breach", owner: "Risk Mgr", category: "Reputational", status: "accepted", trend: "increasing", severity: "critical", likelihood: 3, impact: 2, treatment: "Monitor and review quarterly", lastReview: "2026-04-17", nextReview: "2026-07-12" },
    { id: "RSK-PHI-0016", title: "Password policy weakness", owner: "Compliance Dir", category: "Legal", status: "open", trend: "stable", severity: "critical", likelihood: 10, impact: 5, treatment: "Monitor and review quarterly", lastReview: "2026-04-04", nextReview: "2026-07-07" },
    { id: "RSK-PHI-0017", title: "Network segmentation gap", owner: "IT Dir", category: "Regulatory", status: "mitigating", trend: "decreasing", severity: "critical", likelihood: 7, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-06", nextReview: "2026-07-06" },
    { id: "RSK-PHI-0018", title: "Encryption key management failure", owner: "DevOps Lead", category: "Third-Party", status: "closed", trend: "increasing", severity: "low", likelihood: 7, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-01", nextReview: "2026-07-13" },
    { id: "RSK-PHI-0019", title: "Audit trail tampering", owner: "Architect", category: "Human Capital", status: "accepted", trend: "stable", severity: "medium", likelihood: 2, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-09", nextReview: "2026-07-13" },
    { id: "RSK-PHI-0020", title: "Business email compromise", owner: "CISO", category: "Operational", status: "open", trend: "decreasing", severity: "critical", likelihood: 9, impact: 7, treatment: "Monitor and review quarterly", lastReview: "2026-04-07", nextReview: "2026-07-24" },
  ];
  private _phishing_simRiskFilter: string = 'all';
  private _phishing_simRiskSeverity: string = 'all';
  private _phishing_simRiskStatus: string = 'all';
  private _phishing_simExpandedRisk: string = '';
  private _phishing_simFilterRisks() {
    const reg = this._phishing_simRiskRegister;
    return reg.filter(r => {
      if (this._phishing_simRiskFilter !== "all" && r.category !== this._phishing_simRiskFilter) return false;
      if (this._phishing_simRiskSeverity !== "all" && r.severity !== this._phishing_simRiskSeverity) return false;
      if (this._phishing_simRiskStatus !== "all" && r.status !== this._phishing_simRiskStatus) return false;
      return true;
    });
  }
  private _phishing_simGetRiskScore(r: any) { return Math.round(r.likelihood * r.impact * 1.5); }
  private _phishing_simGetRiskTrendIcon(trend: string) {
    if (trend === "increasing") return "\u2191";
    if (trend === "decreasing") return "\u2193";
    return "\u2192";
  }
  private _phishing_simGetRiskColor(sev: string) {
    if (sev === "critical") return "#dc2626";
    if (sev === "high") return "#ea580c";
    if (sev === "medium") return "#d97706";
    return "#16a34a";
  }
  private _phishing_simGetRiskCounts() {
    const reg = this._phishing_simRiskRegister;
  ...
  private _phishing_simGetTreatmentProgress() {
    const reg = this._phishing_simRiskRegister;
    const treated = reg.filter(r => r.status === "mitigating" || r.status === "closed").length;
    return Math.round((treated / Math.max(reg.length, 1)) * 100);
  }

  // === Security Metrics API Gateway (phishing_sim) ===
  private _phishing_simApiEndpoints = [
    { method: "GET", path: "/api/v1/threats", name: "Threat Intelligence Feed", status: "active", avgLatency: 263.8, reqPerMin: 260.0, errorRate: 2.28, uptime: round(97.9463140932119,2), version: "v2.1.20" },
    { method: "POST", path: "/api/v1/scans/start", name: "Vulnerability Scanner", status: "active", avgLatency: 227.8, reqPerMin: 2373.0, errorRate: 1.95, uptime: round(98.7116614057953,2), version: "v1.9.2" },
    { method: "GET", path: "/api/v1/assets", name: "Asset Inventory", status: "active", avgLatency: 85.6, reqPerMin: 688.0, errorRate: 2.01, uptime: round(99.16019730103969,2), version: "v2.5.11" },
    { method: "POST", path: "/api/v1/alerts", name: "Alert Management", status: "active", avgLatency: 360.9, reqPerMin: 777.0, errorRate: 1.0, uptime: round(99.52199122908385,2), version: "v1.0.1" },
    { method: "GET", path: "/api/v1/compliance", name: "Compliance Status", status: "active", avgLatency: 78.5, reqPerMin: 553.0, errorRate: 2.27, uptime: round(99.31001078798946,2), version: "v3.7.8" },
    { method: "PUT", path: "/api/v1/policies", name: "Policy Engine", status: "active", avgLatency: 12.3, reqPerMin: 1902.0, errorRate: 0.15, uptime: round(96.58755962503952,2), version: "v3.0.0" },
    { method: "GET", path: "/api/v1/incidents", name: "Incident Tracker", status: "active", avgLatency: 177.8, reqPerMin: 197.0, errorRate: 1.71, uptime: round(99.62293267535144,2), version: "v1.7.12" },
    { method: "POST", path: "/api/v1/forensics", name: "Forensics Collector", status: "degraded", avgLatency: 262.8, reqPerMin: 180.0, errorRate: 0.62, uptime: round(98.971973696756,2), version: "v3.3.9" },
    { method: "GET", path: "/api/v1/risk/assess", name: "Risk Assessment", status: "active", avgLatency: 107.2, reqPerMin: 1566.0, errorRate: 1.8, uptime: round(96.18538754841414,2), version: "v3.3.9" },
    { method: "POST", path: "/api/v1/auth/verify", name: "Authentication", status: "active", avgLatency: 274.4, reqPerMin: 103.0, errorRate: 0.26, uptime: round(99.5546648799228,2), version: "v2.5.20" },
    { method: "GET", path: "/api/v1/logs/audit", name: "Audit Log Query", status: "active", avgLatency: 430.9, reqPerMin: 1981.0, errorRate: 2.44, uptime: round(98.76640674100709,2), version: "v1.5.7" },
    { method: "PUT", path: "/api/v1/users/roles", name: "Role Management", status: "active", avgLatency: 130.3, reqPerMin: 710.0, errorRate: 1.73, uptime: round(96.4637018938718,2), version: "v2.3.12" },
    { method: "POST", path: "/api/v1/encrypt", name: "Encryption Service", status: "active", avgLatency: 85.3, reqPerMin: 422.0, errorRate: 0.37, uptime: round(96.6926729613236,2), version: "v3.6.18" },
    { method: "GET", path: "/api/v1/network/topo", name: "Network Topology", status: "maintenance", avgLatency: 174.5, reqPerMin: 1723.0, errorRate: 1.41, uptime: round(97.98687639978313,2), version: "v1.2.14" },
    { method: "DELETE", path: "/api/v1/sessions", name: "Session Manager", status: "active", avgLatency: 332.3, reqPerMin: 844.0, errorRate: 1.3, uptime: round(98.73117173880146,2), version: "v2.1.13" },
  ];
  private _phishing_simApiKeys = [
    { id: "ak-000001", name: "key-phis-001", created: "2026-02-15", lastUsed: "2026-04-15", status: "revoked", calls: 36714, rateLimit: 500 },
    { id: "ak-000002", name: "key-phis-002", created: "2026-05-12", lastUsed: "2026-04-20", status: "active", calls: 16416, rateLimit: 1000 },
    { id: "ak-000003", name: "key-phis-003", created: "2026-05-11", lastUsed: "2026-04-11", status: "active", calls: 38226, rateLimit: 1000 },
    { id: "ak-000004", name: "key-phis-004", created: "2026-09-25", lastUsed: "2026-04-18", status: "active", calls: 16992, rateLimit: 1000 },
    { id: "ak-000005", name: "key-phis-005", created: "2026-06-11", lastUsed: "2026-04-20", status: "active", calls: 43662, rateLimit: 100 },
    { id: "ak-000006", name: "key-phis-006", created: "2026-07-08", lastUsed: "2026-04-12", status: "active", calls: 10024, rateLimit: 5000 },
    { id: "ak-000007", name: "key-phis-007", created: "2026-02-11", lastUsed: "2026-04-19", status: "active", calls: 34028, rateLimit: 500 },
    { id: "ak-000008", name: "key-phis-008", created: "2026-09-23", lastUsed: "2026-04-10", status: "active", calls: 41967, rateLimit: 500 },
  ];
  private _phishing_simApiHealthSummary() {
    const eps = this._phishing_simApiEndpoints;
  ...
  private _phishing_simGetApiByMethod(method: string) { return this._phishing_simApiEndpoints.filter(e=>e.method===method); }
  private _phishing_simGetSlowEndpoints() { return this._phishing_simApiEndpoints.filter(e=>e.avgLatency>200).sort((a,b)=>b.avgLatency-a.avgLatency); }
  private _phishing_simGetHighErrorEndpoints() { return this._phishing_simApiEndpoints.filter(e=>e.errorRate>1.0).sort((a,b)=>b.errorRate-a.errorRate); }

  // === Security Training Effectiveness (phishing_sim) ===
  private _phishing_simTrainingModules = [
    { id: "TRN-001", name: "Security Fundamentals", completionRate: 90.9, avgScore: 78.7, behaviorChange: 62.9, enrolled: 150, completed: 415, duration: "84min", category: "mandatory" },
    { id: "TRN-002", name: "Phishing Awareness", completionRate: 66.9, avgScore: 66.2, behaviorChange: 85.0, enrolled: 107, completed: 283, duration: "15min", category: "mandatory" },
    { id: "TRN-003", name: "Social Engineering Defense", completionRate: 85.4, avgScore: 73.8, behaviorChange: 87.3, enrolled: 371, completed: 234, duration: "68min", category: "optional" },
    { id: "TRN-004", name: "Password Hygiene", completionRate: 94.2, avgScore: 77.6, behaviorChange: 77.7, enrolled: 118, completed: 439, duration: "40min", category: "mandatory" },
    { id: "TRN-005", name: "Data Classification", completionRate: 60.0, avgScore: 67.9, behaviorChange: 67.7, enrolled: 215, completed: 347, duration: "99min", category: "mandatory" },
    { id: "TRN-006", name: "Incident Response Basics", completionRate: 87.6, avgScore: 64.1, behaviorChange: 61.4, enrolled: 457, completed: 445, duration: "98min", category: "mandatory" },
    { id: "TRN-007", name: "Secure Coding", completionRate: 83.7, avgScore: 88.0, behaviorChange: 46.6, enrolled: 220, completed: 331, duration: "102min", category: "optional" },
    { id: "TRN-008", name: "Cloud Security", completionRate: 91.0, avgScore: 71.0, behaviorChange: 84.7, enrolled: 208, completed: 288, duration: "80min", category: "mandatory" },
    { id: "TRN-009", name: "Mobile Device Security", completionRate: 50.5, avgScore: 75.3, behaviorChange: 80.9, enrolled: 392, completed: 144, duration: "120min", category: "mandatory" },
    { id: "TRN-010", name: "Network Security", completionRate: 45.8, avgScore: 59.5, behaviorChange: 72.2, enrolled: 466, completed: 200, duration: "97min", category: "mandatory" },
    { id: "TRN-011", name: "Physical Security", completionRate: 79.7, avgScore: 88.7, behaviorChange: 51.9, enrolled: 411, completed: 58, duration: "38min", category: "optional" },
    { id: "TRN-012", name: "Regulatory Compliance", completionRate: 83.5, avgScore: 79.8, behaviorChange: 58.8, enrolled: 410, completed: 401, duration: "115min", category: "mandatory" },
    { id: "TRN-013", name: "Risk Management", completionRate: 69.7, avgScore: 78.2, behaviorChange: 67.1, enrolled: 399, completed: 89, duration: "107min", category: "mandatory" },
    { id: "TRN-014", name: "Cryptography Basics", completionRate: 82.9, avgScore: 91.2, behaviorChange: 33.3, enrolled: 289, completed: 128, duration: "118min", category: "mandatory" },
    { id: "TRN-015", name: "Access Control", completionRate: 77.6, avgScore: 73.8, behaviorChange: 75.9, enrolled: 359, completed: 91, duration: "95min", category: "optional" },
    { id: "TRN-016", name: "Vendor Management", completionRate: 93.1, avgScore: 63.1, behaviorChange: 34.1, enrolled: 222, completed: 233, duration: "53min", category: "mandatory" },
  ];
  private _phishing_simPhishingResults = [
    { month: "2026-01", sent: 251, clicked: 59, reported: 25, clickRate: round(23.50597609561753,1), reportRate: round(9.9601593625498,1) },
    { month: "2026-02", sent: 670, clicked: 79, reported: 53, clickRate: round(11.791044776119403,1), reportRate: round(7.91044776119403,1) },
    { month: "2026-03", sent: 326, clicked: 54, reported: 155, clickRate: round(16.56441717791411,1), reportRate: round(47.54601226993865,1) },
    { month: "2026-04", sent: 988, clicked: 273, reported: 587, clickRate: round(27.631578947368425,1), reportRate: round(59.412955465587046,1) },
    { month: "2026-05", sent: 894, clicked: 151, reported: 52, clickRate: round(16.890380313199106,1), reportRate: round(5.8165548098434,1) },
    { month: "2026-06", sent: 432, clicked: 26, reported: 150, clickRate: round(6.018518518518518,1), reportRate: round(34.72222222222222,1) },
  ];
  private _phishing_simTrainingROI = { totalInvestment: 144130, avgCostPerEmployee: 213, riskReductionPct: round(random.uniform(15,45),1), incidentReductionPct: round(random.uniform(10,35),1), complianceScoreGain: round(random.uniform(5,25),1) };
  private _phishing_simLearningPaths = [
    { name: "Beginner Security Analyst", totalModules: 20, completedModules: 13, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 73, enrolled: 65 },
    { name: "Advanced Threat Hunter", totalModules: 14, completedModules: 8, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 42, enrolled: 75 },
    { name: "Security Architect", totalModules: 20, completedModules: 4, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 52, enrolled: 93 },
    { name: "Incident Responder", totalModules: 19, completedModules: 3, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 37, enrolled: 44 },
    { name: "Compliance Specialist", totalModules: 20, completedModules: 17, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 64, enrolled: 153 },
    { name: "DevSecOps Engineer", totalModules: 12, completedModules: 18, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 13, enrolled: 194 },
  ];
  private _phishing_simGetOverallCompletion() {
    const mods = this._phishing_simTrainingModules;
    return round(mods.reduce((s,m)=>s+m.completionRate,0)/mods.length,1);
  }
  private _phishing_simGetTopPerformers() { return [...this._phishing_simTrainingModules].sort((a,b)=>b.avgScore-a.avgScore).slice(0,5); }
  private _phishing_simGetModulesNeedingAttention() { return this._phishing_simTrainingModules.filter(m=>m.completionRate<70||m.avgScore<65); }

  // === Security Governance Framework (phishing_sim) ===
  private _phishing_simGovBodies = [
    { name: "Security Steering Committee", members: 8, chair: "CISO", meetingFreq: "Weekly", lastMeeting: "2026-04-20", nextMeeting: "2026-05-12", quorum: 6 },
    { name: "Risk Management Board", members: 10, chair: "CTO", meetingFreq: "Bi-weekly", lastMeeting: "2026-04-17", nextMeeting: "2026-05-24", quorum: 6 },
    { name: "Data Governance Council", members: 15, chair: "CRO", meetingFreq: "Monthly", lastMeeting: "2026-04-06", nextMeeting: "2026-05-04", quorum: 4 },
    { name: "Compliance Oversight Board", members: 12, chair: "CDO", meetingFreq: "Monthly", lastMeeting: "2026-04-11", nextMeeting: "2026-05-02", quorum: 5 },
    { name: "Architecture Review Board", members: 14, chair: "VP Eng", meetingFreq: "Bi-weekly", lastMeeting: "2026-04-06", nextMeeting: "2026-05-17", quorum: 6 },
    { name: "Change Advisory Board", members: 15, chair: "CISO", meetingFreq: "Weekly", lastMeeting: "2026-04-17", nextMeeting: "2026-05-07", quorum: 6 },
    { name: "Incident Review Board", members: 6, chair: "CIO", meetingFreq: "As needed", lastMeeting: "2026-04-21", nextMeeting: "2026-05-09", quorum: 5 },
    { name: "Vendor Risk Committee", members: 8, chair: "CFO", meetingFreq: "Quarterly", lastMeeting: "2026-04-04", nextMeeting: "2026-05-11", quorum: 5 },
  ];
  private _phishing_simDecisions = [
    { id: "DEC-0001", title: "Adopt zero-trust architecture framework", date: "2026-02-14", status: "approved", owner: "CISO" },
    { id: "DEC-0002", title: "Migrate to SIEM 2.0 platform", date: "2026-02-13", status: "implemented", owner: "CTO" },
    { id: "DEC-0003", title: "Implement DLP across all endpoints", date: "2026-04-08", status: "in-progress", owner: "Security Lead" },
    { id: "DEC-0004", title: "Mandate MFA for all external access", date: "2026-03-20", status: "pending", owner: "CRO" },
    { id: "DEC-0005", title: "Establish bug bounty program", date: "2026-04-26", status: "approved", owner: "VP Eng" },
    { id: "DEC-0006", title: "Deploy EDR solution enterprise-wide", date: "2026-03-01", status: "approved", owner: "CISO" },
    { id: "DEC-0007", title: "Conduct annual penetration testing", date: "2026-01-28", status: "implemented", owner: "CTO" },
    { id: "DEC-0008", title: "Implement network micro-segmentation", date: "2026-04-18", status: "in-progress", owner: "Security Lead" },
    { id: "DEC-0009", title: "Establish security champion program", date: "2026-01-05", status: "pending", owner: "CRO" },
    { id: "DEC-0010", title: "Migrate to passwordless authentication", date: "2026-04-11", status: "approved", owner: "VP Eng" },
  ];
  private _phishing_simPolicyLifecycle = [
    { name: "Information Security Policy", version: "v1.3", status: "active", lastUpdated: "2026-04-04", nextReview: "2026-12-03", owner: "CISO" },
    { name: "Acceptable Use Policy", version: "v4.1", status: "active", lastUpdated: "2026-02-23", nextReview: "2026-7-03", owner: "Legal" },
    { name: "Data Retention Policy", version: "v4.4", status: "under-review", lastUpdated: "2026-01-12", nextReview: "2026-7-18", owner: "DPO" },
    { name: "Access Control Policy", version: "v3.4", status: "active", lastUpdated: "2026-04-13", nextReview: "2026-7-12", owner: "IAM Lead" },
    { name: "Incident Response Policy", version: "v3.3", status: "draft", lastUpdated: "2026-03-15", nextReview: "2026-10-12", owner: "IR Lead" },
    { name: "Business Continuity Plan", version: "v4.2", status: "active", lastUpdated: "2026-01-01", nextReview: "2026-8-18", owner: "BCP Mgr" },
    { name: "Vendor Management Policy", version: "v1.5", status: "active", lastUpdated: "2026-03-05", nextReview: "2026-12-09", owner: "Procurement" },
    { name: "Encryption Standard", version: "v4.1", status: "under-review", lastUpdated: "2026-04-20", nextReview: "2026-9-08", owner: "Security Arch" },
  ];
  private _phishing_simGovMaturityScore = { overall: 5.0, riskManagement: 5.9, compliance: 5.5, incidentResponse: 3.2, awareness: 2.6, technology: 3.5 };
  private _phishing_simGetPendingDecisions() { return this._phishing_simDecisions.filter(d=>d.status==='pending'||d.status==='in-progress'); }
  private _phishing_simGetActivePolicies() { return this._phishing_simPolicyLifecycle.filter(p=>p.status==='active'); }
  private _phishing_simGetEscalationPath() { return ["L1 Analyst","L2 Senior","Security Lead","CISO","Board"]; }

  // === Security Innovation Lab (phishing_sim) ===
  private _phishing_simInnoProjects = [
    { id: "INN-001", name: "AI-Powered Threat Detection", description: "Machine learning models for real-time threat identification", status: "active", progress: 72, startDate: "2026-01-04", teamSize: 8, budget: 19833, milestones: 7, completedMilestones: 5 },
    { id: "INN-002", name: "Quantum-Resistant Cryptography", description: "Post-quantum encryption algorithm prototyping", status: "research", progress: 35, startDate: "2026-02-19", teamSize: 8, budget: 147837, milestones: 9, completedMilestones: 7 },
    { id: "INN-003", name: "Automated Red Teaming", description: "Autonomous penetration testing framework", status: "active", progress: 58, startDate: "2026-01-09", teamSize: 6, budget: 100585, milestones: 10, completedMilestones: 3 },
    { id: "INN-004", name: "Zero-Knowledge Authentication", description: "Privacy-preserving identity verification", status: "poc", progress: 88, startDate: "2026-01-10", teamSize: 6, budget: 108755, milestones: 8, completedMilestones: 5 },
    { id: "INN-005", name: "Blockchain Audit Trail", description: "Immutable security event logging", status: "active", progress: 45, startDate: "2026-01-19", teamSize: 5, budget: 93839, milestones: 4, completedMilestones: 7 },
    { id: "INN-006", name: "Behavioral Biometrics", description: "Continuous authentication via user behavior patterns", status: "research", progress: 22, startDate: "2026-01-11", teamSize: 6, budget: 170028, milestones: 5, completedMilestones: 5 },
    { id: "INN-007", name: "Deception Grid 2.0", description: "Advanced honeypot network with adaptive responses", status: "active", progress: 65, startDate: "2026-01-02", teamSize: 7, budget: 59819, milestones: 5, completedMilestones: 1 },
    { id: "INN-008", name: "Secure Enclave Integration", description: "Hardware-backed security for critical workloads", status: "poc", progress: 40, startDate: "2026-03-02", teamSize: 3, budget: 32198, milestones: 8, completedMilestones: 7 },
  ];
  private _phishing_simTechEvaluations = [
    ...
    { name: "SASE Architecture", status: "completed", score: 5.9, recommendation: "Adopt", vendor: "Multiple" },
    { name: "SOAR Platform 3.0", status: "planned", score: 4.9, recommendation: "Monitor", vendor: "Splunk" },
  ];
  private _phishing_simCollaborationPartners = [
  ...
  private _phishing_simInnoMetrics = { totalProjects: 8, activeProjects: 4, avgTimeToValue: "71 days", pocSuccessRate: round(random.uniform(55,85),1), researchToProduction: round(random.uniform(20,50),1), innovationIndex: round(random.uniform(6.0,9.5),1) };
  private _phishing_simGetProjectByStatus(status: string) { return this._phishing_simInnoProjects.filter(p=>p.status===status); }
  private _phishing_simGetTopEvaluations() { return [...this._phishing_simTechEvaluations].sort((a,b)=>b.score-a.score).slice(0,3); }



  // === Compliance Dashboard Extension (phishing_sim) ===
  private _phishing_simComplianceFrameworks = [
    { name: "SOC 2 Type II", description: "Trust Services Criteria", totalControls: 5, implementedControls: 2, status: "partially-compliant", lastAudit: "2026-02-07", nextAudit: "2026-10-16", evidenceCount: 335 },
    { name: "ISO 27001", description: "Information Security Management", totalControls: 114, implementedControls: 69, status: "non-compliant", lastAudit: "2026-04-25", nextAudit: "2026-11-08", evidenceCount: 129 },
    { name: "PCI DSS 4.0", description: "Payment Card Industry", totalControls: 12, implementedControls: 7, status: "partially-compliant", lastAudit: "2026-01-06", nextAudit: "2026-7-25", evidenceCount: 244 },
    { name: "HIPAA", description: "Health Insurance Portability", totalControls: 18, implementedControls: 10, status: "in-review", lastAudit: "2026-02-02", nextAudit: "2026-11-06", evidenceCount: 484 },
    { name: "GDPR", description: "Data Protection Regulation", totalControls: 99, implementedControls: 63, status: "partially-compliant", lastAudit: "2026-04-14", nextAudit: "2026-12-07", evidenceCount: 293 },
    { name: "NIST CSF 2.0", description: "Cybersecurity Framework", totalControls: 6, implementedControls: 5, status: "in-review", lastAudit: "2026-03-19", nextAudit: "2026-12-19", evidenceCount: 281 },
    { name: "FedRAMP", description: "Federal Risk Authorization", totalControls: 15, implementedControls: 13, status: "in-review", lastAudit: "2026-01-27", nextAudit: "2026-11-10", evidenceCount: 394 },
    { name: "SOX", description: "Sarbanes-Oxley Compliance", totalControls: 8, implementedControls: 7, status: "in-review", lastAudit: "2026-02-05", nextAudit: "2026-10-26", evidenceCount: 468 },
    { name: "CIS Controls v8", description: "Center for Internet Security", totalControls: 18, implementedControls: 10, status: "compliant", lastAudit: "2026-02-03", nextAudit: "2026-8-10", evidenceCount: 358 },
    { name: "COBIT 2019", description: "IT Governance Framework", totalControls: 40, implementedControls: 36, status: "in-review", lastAudit: "2026-01-12", nextAudit: "2026-12-17", evidenceCount: 497 },
  ];
  private _phishing_simGetComplianceScore() {
    const fw = this._phishing_simComplianceFrameworks;
    return round(fw.reduce((s,f)=>s + (f.implementedControls/Math.max(f.totalControls,1))*100, 0) / fw.length, 1);
  }
  private _phishing_simGetGaps() {
    return this._phishing_simComplianceFrameworks.filter(f => f.status !== "compliant");
  }
  private _phishing_simAuditTrail = [
    { id: "AUD-0001", action: "Control tested", auditor: "Internal Audit", date: "2026-04-18", result: "pass", findings: 2 },
    { id: "AUD-0002", action: "Evidence collected", auditor: "External Auditor", date: "2026-04-21", result: "pass", findings: 4 },
    ...
    { id: "AUD-0005", action: "Policy updated", auditor: "IT Audit", date: "2026-04-16", result: "pass", findings: 1 },
    { id: "AUD-0006", action: "Training verified", auditor: "Risk Team", date: "2026-04-15", result: "pass", findings: 0 },
    { id: "AUD-0007", action: "Access reviewed", auditor: "QA Team", date: "2026-04-13", result: "pass", findings: 4 },
    { id: "AUD-0008", action: "Exception approved", auditor: "CISO Office", date: "2026-04-22", result: "conditional", findings: 1 },
    { id: "AUD-0009", action: "Risk accepted", auditor: "Board Audit", date: "2026-04-19", result: "pass", findings: 2 },
    { id: "AUD-0010", action: "Control enhanced", auditor: "Third Party", date: "2026-04-16", result: "pass", findings: 0 },
  ];

  // === Threat Intelligence Feed Extension (phishing_sim) ===
  private _phishing_simThreatActors = [
    { name: "APT-29", alias: "Cozy Bear", origin: "Russia", type: "Nation-State", severity: "high", lastActivity: "2026-04-02", targets: "Healthcare", indicators: 215, ttps: 12 },
    { name: "APT-41", alias: "Double Dragon", origin: "China", type: "Nation-State", severity: "critical", lastActivity: "2026-04-08", targets: "Energy", indicators: 164, ttps: 46 },
    { name: "Lazarus Group", alias: "Hidden Cobra", origin: "North Korea", type: "Nation-State", severity: "critical", lastActivity: "2026-04-16", targets: "Government", indicators: 467, ttps: 48 },
    { name: "FIN7", alias: "Carbanak", origin: "Eastern Europe", type: "Financial", severity: "high", lastActivity: "2026-04-15", targets: "Healthcare", indicators: 286, ttps: 8 },
    { name: "Conti", alias: "Wizard Spider", origin: "Russia", type: "Ransomware", severity: "critical", lastActivity: "2026-04-11", targets: "Energy", indicators: 98, ttps: 13 },
    { name: "LockBit", alias: "LockBit Gang", origin: "Unknown", type: "Ransomware", severity: "high", lastActivity: "2026-04-20", targets: "Finance", indicators: 461, ttps: 30 },
    { name: "Cl0p", alias: "Cl0p Team", origin: "Unknown", type: "Ransomware", severity: "high", lastActivity: "2026-04-01", targets: "Healthcare", indicators: 204, ttps: 6 },
    { name: "Sandworm", alias: "Unit 74455", origin: "Russia", type: "Nation-State", severity: "critical", lastActivity: "2026-04-11", targets: "Manufacturing", indicators: 147, ttps: 32 },
  ];
  private _phishing_simIoCFeed = [
    { id: "ioc-000001", type: "ip", value: "208.122.130.172", confidence: 99, source: "STIX", firstSeen: "2026-04-14", lastSeen: "2026-04-23" },
    { id: "ioc-000002", type: "ip", value: "110.237.127.135", confidence: 59, source: "AlienVault", firstSeen: "2026-04-01", lastSeen: "2026-04-13" },
    { id: "ioc-000003", type: "ip", value: "149.165.139.117", confidence: 95, source: "MISP", firstSeen: "2026-04-11", lastSeen: "2026-04-08" },
    { id: "ioc-000004", type: "ip", value: "158.39.92.88", confidence: 72, source: "CrowdStrike", firstSeen: "2026-04-23", lastSeen: "2026-04-08" },
    { id: "ioc-000005", type: "ip", value: "30.147.210.184", confidence: 84, source: "Mandiant", firstSeen: "2026-04-19", lastSeen: "2026-04-09" },
    { id: "ioc-000006", type: "ip", value: "193.243.142.41", confidence: 59, source: "AlienVault", firstSeen: "2026-04-08", lastSeen: "2026-04-06" },
    { id: "ioc-000007", type: "ip", value: "192.20.27.27", confidence: 97, source: "MISP", firstSeen: "2026-04-19", lastSeen: "2026-04-22" },
    { id: "ioc-000008", type: "ip", value: "248.186.29.139", confidence: 82, source: "STIX", firstSeen: "2026-04-02", lastSeen: "2026-04-08" },
    { id: "ioc-000009", type: "ip", value: "56.119.116.180", confidence: 44, source: "MISP", firstSeen: "2026-04-07", lastSeen: "2026-04-06" },
    { id: "ioc-000010", type: "ip", value: "235.51.226.94", confidence: 95, source: "AlienVault", firstSeen: "2026-04-04", lastSeen: "2026-04-07" },
    { id: "ioc-000011", type: "ip", value: "77.203.18.175", confidence: 79, source: "VirusTotal", firstSeen: "2026-04-23", lastSeen: "2026-04-23" },
    { id: "ioc-000012", type: "ip", value: "229.79.167.204", confidence: 61, source: "CrowdStrike", firstSeen: "2026-04-10", lastSeen: "2026-04-22" },
    { id: "ioc-000013", type: "ip", value: "62.186.100.162", confidence: 99, source: "CrowdStrike", firstSeen: "2026-04-05", lastSeen: "2026-04-08" },
    { id: "ioc-000014", type: "ip", value: "242.6.51.212", confidence: 44, source: "VirusTotal", firstSeen: "2026-04-07", lastSeen: "2026-04-21" },
    { id: "ioc-000015", type: "ip", value: "128.5.192.197", confidence: 48, source: "CrowdStrike", firstSeen: "2026-04-01", lastSeen: "2026-04-19" },
  ];
  private _phishing_simGetActiveThreats() { return this._phishing_simThreatActors.filter(a => a.severity === 'critical'); }
  private _phishing_simGetThreatSummary() {
    const actors = this._phishing_simThreatActors;
  ...
  // === Incident Management Extension (phishing_sim) ===
  private _phishing_simIncidents = [
    { id: "INC-20260001", title: "Unauthorized access detected", severity: "critical", status: "open", assignedTo: "SOC L1", detectedAt: "2026-04-09T12:43", affectedAssets: 9, rootCause: "Misconfiguration" },
    { id: "INC-20260002", title: "Malware outbreak on workstation", severity: "high", status: "investigating", assignedTo: "SOC L2", detectedAt: "2026-04-21T15:42", affectedAssets: 45, rootCause: "Credential compromise" },
    { id: "INC-20260003", title: "Data leak from S3 bucket", severity: "medium", status: "contained", assignedTo: "IR Lead", detectedAt: "2026-04-21T13:16", affectedAssets: 7, rootCause: "Zero-day" },
    { id: "INC-20260004", title: "Phishing campaign targeting finance", severity: "low", status: "eradicated", assignedTo: "CISO", detectedAt: "2026-04-01T16:22", affectedAssets: 39, rootCause: "Human error" },
    { id: "INC-20260005", title: "DDoS attack on web services", severity: "critical", status: "recovered", assignedTo: "Security Eng", detectedAt: "2026-04-04T16:43", affectedAssets: 31, rootCause: "Policy violation" },
    { id: "INC-20260006", title: "Ransomware encryption attempt", severity: "high", status: "closed", assignedTo: "Forensics", detectedAt: "2026-04-17T21:13", affectedAssets: 17, rootCause: "Unknown" },
    { id: "INC-20260007", title: "Insider data exfiltration", severity: "medium", status: "open", assignedTo: "SOC L1", detectedAt: "2026-04-01T07:51", affectedAssets: 19, rootCause: "Misconfiguration" },
    { id: "INC-20260008", title: "API key exposure in repo", severity: "low", status: "investigating", assignedTo: "SOC L2", detectedAt: "2026-04-18T13:58", affectedAssets: 20, rootCause: "Credential compromise" },
    { id: "INC-20260009", title: "SQL injection on portal", severity: "critical", status: "contained", assignedTo: "IR Lead", detectedAt: "2026-04-16T12:57", affectedAssets: 4, rootCause: "Zero-day" },
    { id: "INC-20260010", title: "Brute force on VPN", severity: "high", status: "eradicated", assignedTo: "CISO", detectedAt: "2026-04-21T03:08", affectedAssets: 8, rootCause: "Human error" },
    { id: "INC-20260011", title: "Supply chain alert from vendor", severity: "medium", status: "recovered", assignedTo: "Security Eng", detectedAt: "2026-04-05T22:28", affectedAssets: 12, rootCause: "Policy violation" },
    { id: "INC-20260012", title: "Suspicious lateral movement", severity: "low", status: "closed", assignedTo: "Forensics", detectedAt: "2026-04-20T15:48", affectedAssets: 42, rootCause: "Unknown" },
  ];
  private _phishing_simGetIncidentStats() {
    const inc = this._phishing_simIncidents;
    return { total: inc.length, open: inc.filter(i=>i.status==="open").length, investigating: inc.filter(i=>i.status==="investigating").length, mttd: 23, mttr: 127 };
  }
  private _phishing_simGetSeverityDistribution() {
    const inc = this._phishing_simIncidents;
...
<div class="tabs">
        ...
        ${this._activeTab === 'rules' ? html`
          ...
          <div style="background:#1a1d27;border-radius:8px;padding:12px">${this._renderPsTreemapSVG()}</div>
          <div style="margin-top:12px;font-size:11px;font-weight:600;margin-bottom:6px">Data Flow (Sankey)</div>
          <div style="background:#1a1d27;border-radius:8px;padding:12px">${this._renderPsSankeySVG()}</div>
          ${this._renderPsActivity()}
        ` : nothing}
        ${this._activeTab === 'anomalies' ? html`
          ${this._renderPsAnomalies()}
          ${this._renderPsNotifications()}
        ` : nothing}
        ${this._activeTab === 'predictions' ? html`
          ${this._renderPsPredictions()}
          ...
          <div style="background:#1a1d27;border-radius:8px;padding:12px">
            <table class="history-table"><thead><tr><th>ID</th><th>Base</th><th>Temporal</th><th>Environmental</th><th>Overall</th></tr></thead><tbody>
              ${this._pscvssData.map(c => html`<tr><td>${c.itemId}</td><td style="color:${c.base >= 7 ? '#ef4444' : c.base >= 4 ? '#eab308' : '#22c55e'}">${c.base}</td><td>${c.temporal}</td><td>${c.environmental}</td><td style="font-weight:700;color:${c.overall >= 7 ? '#ef4444' : c.overall >= 4 ? '#eab308' : '#22c55e'}">${c.overall}</td></tr>`)}
            </tbody></table>
          </div>
        ` : nothing}
        ${this._activeTab === 'approvals' ? html`
          ${this._renderPsApprovals()}
        ` : nothing}
        ${this._activeTab === 'config' ? html`
          ${this._renderPsConfig()}
        ` : nothing}
        ${this._activeTab === 'new' ? html`
          <div class="form-section">
            <div class="form-title">Create New Phishing Sim Entry</div>
            <div class="form-grid">
  ...
  @state() private _psScenarios: {id:string;name:string;attackType:string;target:string;method:string;impactLow:number;impactHigh:number;confidence:number;mitigation:string;status:string}[] = [];
  @state() private _psScenarioForm: {attackType:string;target:string;method:string} = {attackType:'',target:'',method:''};
  @state() private _psScenarioCompare: boolean = false;
  @state() private _psScenarioSelected: string[] = [];

  private _psInitScenarios(): void {
    const saved = localStorage.getItem('ps_scenarios');
    if (saved) { try { this._psScenarios = JSON.parse(saved); } catch { /* ignore */ } }
    if (this._psScenarios.length === 0) {
      this._psScenarios = [
        {id:'ps-s1',name:'Baseline Threat',attackType:'Phishing',target:'Employees',method:'Spear Email',impactLow:45,impactHigh:78,confidence:72,mitigation:'Security awareness training + email filtering',status:'active'},
        {id:'ps-s2',name:'Escalated Attack',attackType:'Ransomware',target:'Endpoints',method:'Drive-by Download',impactLow:65,impactHigh:95,confidence:58,mitigation:'EDR deployment + network segmentation',status:'saved'},
        {id:'ps-s3',name:'Insider Threat',attackType:'Data Exfiltration',target:'Databases',method:'SQL Injection',impactLow:55,impactHigh:88,confidence:65,mitigation:'DLP policies + query monitoring',status:'draft'},
      ];
    }
  }

  private _psSaveScenarios(): void {
    localStorage.setItem('ps_scenarios', JSON.stringify(this._psScenarios));
  }

  private _psAddScenario(): void {
    const f = this._psScenarioForm;
    if (!f.attackType || !f.target) return;
    this._psScenarios = [...this._psScenarios, {
      id: 'ps-s' + (this._psScenarios.length + 1),
    ...
    this._psScenarioForm = {attackType:'',target:'',method:''};
    this._psSaveScenarios();
  }

  private _psRenderScenarioEngine(): any {
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <button class="tab" @click=${() => { this._psScenarioCompare = !this._psScenarioCompare; }}>${this._psScenarioCompare ? 'List View' : 'Compare'}</button>
        </div>
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:6px;margin-bottom:10px">
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._psScenarioForm = {...this._psScenarioForm, attackType: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Attack Type</option>
            ${attackTypes.map(a => html`<option value=${a} ${this._psScenarioForm.attackType === a ? 'selected' : ''}>${a}</option>`)}
          </select>
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._psScenarioForm = {...this._psScenarioForm, target: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Target</option>
            ${targets.map(t => html`<option value=${t} ${this._psScenarioForm.target === t ? 'selected' : ''}>${t}</option>`)}
          </select>
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._psScenarioForm = {...this._psScenarioForm, method: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Method</option>
            ${methods.map(m => html`<option value=${m} ${this._psScenarioForm.method === m ? 'selected' : ''}>${m}</option>`)}
          </select>
        </div>
        <button style="background:#3b82f6;border:none;border-radius:4px;padding:4px 12px;color:#fff;font-size:11px;cursor:pointer" @click=${this._psAddScenario}>Run Simulation</button>
      </div>
      ${this._psScenarioCompare && this._psScenarios.length >= 2 ? html`
        <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
          <div style="font-weight:600;font-size:12px;color:#e2e8f0;margin-bottom:8px">Side-by-Side Comparison</div>
          <div style="display:grid;grid-template-columns:repeat(${Math.min(3, this._psScenarios.length)},1fr);gap:8px">
            ${this._psScenarios.slice(0,3).map(s => html`
      ...
      <div style="background:#0f1117;border-radius:8px;padding:12px">
        <div style="font-weight:600;font-size:12px;color:#e2e8f0;margin-bottom:8px">Saved Scenarios (${this._psScenarios.length})</div>
        ${this._psScenarios.map(s => html`
  ...
  @state() private _psTrendData: {day:number;value:number;anomaly:boolean}[] = [];
  @state() private _psTrendZoom: {start:number;end:number} | null = null;
  @state() private _psTrendMA: number = 7;

  private _psInitTrendData(): void {
    ...
    this._psTrendData = data;
  }

  private _psCalcMA(window: number): number[] {
    const result: number[] = [];
    for (let i = 0; i < this._psTrendData.length; i++) {
      const start = Math.max(0, i - window + 1);
      const slice = this._psTrendData.slice(start, i + 1);
      result.push(slice.reduce((s, d) => s + d.value, 0) / slice.length);
    }
    return result;
  }

  private _psGetStats(): {mean:number;median:number;stddev:number;trend:string} {
    const vals = this._psTrendData.map(d => d.value);
    const n = vals.length;
  ...
  private _psRenderTimeSeries(): any {
    const stats = this._psGetStats();
    const filtered = this._psTrendZoom ? this._psTrendData.filter(d => d.day >= this._psTrendZoom.start && d.day <= this._psTrendZoom.end) : this._psTrendData;
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px">
            <button class="tab ${this._psTrendMA === 7 ? 'active' : ''}" @click=${() => { this._psTrendMA = 7; }}>7D MA</button>
            <button class="tab ${this._psTrendMA === 30 ? 'active' : ''}" @click=${() => { this._psTrendMA = 30; }}>30D MA</button>
            <button class="tab" @click=${() => { this._psTrendZoom = null; }}>Reset Zoom</button>
          </div>
        </div>
        <div style="position:relative;height:120px;background:#1a1d2e;border-radius:6px;overflow:hidden;margin-bottom:8px;cursor:crosshair" @click=${(e: any) => {
          ...
          this._psTrendZoom = { start: Math.max(0, center - 10), end: Math.min(89, center + 10) };
        }}>
  ...
  @state() private _psRoles: string[] = ['Admin','Analyst','Operator','Viewer','Auditor'];
  @state() private _psActions: string[] = ['Create','Read','Update','Delete','Export','Approve'];
  @state() private _psPermissions: { [role: string]: { [action: string]: boolean } } = {};
  @state() private _psPermAudit: {role:string;action:string;changedBy:string;timestamp:string;oldVal:boolean;newVal:boolean}[] = [];
  @state() private _psPermCompare: string[] = [];

  private _psInitPermissions(): void {
    ...
    for (const role of this._psRoles) {
      perms[role] = {};
      this._psActions.forEach((a, i) => { perms[role][a] = defaults[role]?.[i] ?? false; });
    }
    this._psPermissions = perms;
  }

  private _psTogglePermission(role: string, action: string): void {
    const old = this._psPermissions[role][action];
    this._psPermissions = {...this._psPermissions, [role]: {...this._psPermissions[role], [action]: !old}};
    this._psPermAudit.unshift({role,action,changedBy:'current_user',timestamp:new Date().toISOString(),oldVal:old,newVal:!old});
  }

  private _psRenderRBAC(): any {
    const compareRoles = this._psPermCompare.map(r => this._psPermissions[r]).filter(Boolean);
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          <span style="font-weight:700;font-size:13px;color:#e2e8f0">RBAC Permission Matrix</span>
          <div style="display:flex;gap:4px">
            ${this._psRoles.map(r => html`
              <button class="tab ${this._psPermCompare.includes(r) ? 'active' : ''}" @click=${() => {
                this._psPermCompare = this._psPermCompare.includes(r) ? this._psPermCompare.filter(x => x !== r) : [...this._psPermCompare, r];
              }}>${r}</button>
            `)}
          </div>
        </div>
          ...
          <table style="width:100%;border-collapse:collapse;font-size:10px">
            <thead>
              <tr>
                ...
                ${this._psActions.map(a => html`<th style="padding:6px;color:#6b7280;border-bottom:1px solid #2a2d3a;text-align:center">${a}</th>`)}
              </tr>
            </thead>
            <tbody>
              ${this._psRoles.map(role => html`
                <tr style="border-bottom:1px solid #1a1d2e">
                  <td style="padding:6px;color:#e2e8f0;font-weight:600">${role}</td>
                  ${this._psActions.map(action => html`
                    <td style="text-align:center;padding:6px">
                      <button style="width:28px;height:20px;border-radius:3px;border:1px solid #2a2d3a;background:${this._psPermissions[role][action] ? '#22c55e' : '#1a1d2e'};cursor:pointer;color:#fff;font-size:10px" @click=${() => this._psTogglePermission(role, action)}>${this._psPermissions[role][action] ? 'Y' : 'N'}</button>
                    </td>
                  `)}
                </tr>
              `)}
        ...
        ${compareRoles.length >= 2 ? html`
          <div style="margin-top:10px;padding:8px;background:#1a1d2e;border-radius:6px">
            <div style="font-size:11px;font-weight:600;color:#e2e8f0;margin-bottom:6px">Role Diff: ${this._psPermCompare.join(' vs ')}</div>
            ${this._psActions.map(action => {
              ...
              return allSame ? nothing : html`
                <div style="display:flex;gap:8px;padding:3px 0;font-size:10px">
                  ...
                  ${compareRoles.map((r, i) => html`<span style="color:${r[action] ? '#22c55e' : '#ef4444'}">${this._psPermCompare[i]}=${r[action] ? 'Y' : 'N'}</span>`)}
                </div>
              `;
            })}
          </div>
        ` : nothing}
        ${this._psPermAudit.length > 0 ? html`
          <div style="margin-top:8px;font-size:9px;color:#6b7280">Recent: ${this._psPermAudit.slice(0,3).map(a => html`<span style="margin-right:8px">${a.role}.${a.action}: ${a.oldVal ? 'Y' : 'N'}->${a.newVal ? 'Y' : 'N'}</span>`)}
        ` : nothing}
      </div>
    `;
  }
  ...
  // === REPORTING SUITE ===
  @state() private _psReportTemplate: string = 'executive';
  @state() private _psReportSchedule: string = 'weekly';
  @state() private _psReportDistList: string[] = ['security-team@company.com','ciso@company.com'];
  @state() private _psReportHistory: {id:string;template:string;generatedAt:string;status:string}[] = [];

  private _psGenerateReport(): void {
    const id = 'rpt-' + Date.now();
    this._psReportHistory.unshift({id,template:this._psReportTemplate,generatedAt:new Date().toISOString(),status:'sent'});
  }

  private _psRenderReporting(): any {
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:8px">
          <div>
            ...
            ${templates.map(t => html`
              <div style="padding:6px;background:${this._psReportTemplate === t.key ? '#1e3a5f' : '#1a1d2e'};border:1px solid ${this._psReportTemplate === t.key ? '#3b82f6' : '#2a2d3a'};border-radius:4px;margin-bottom:4px;cursor:pointer" @click=${() => { this._psReportTemplate = t.key; }}>
          ...
          <div>
            ...
            <div style="display:flex;gap:4px;margin-bottom:8px">
              ${schedules.map(s => html`<button class="tab ${this._psReportSchedule === s.key ? 'active' : ''}" @click=${() => { this._psReportSchedule = s.key; }}>${s.label}</button>`)}
            </div>
            <div style="font-size:10px;color:#6b7280;margin-bottom:4px">Distribution</div>
            <div style="font-size:10px;color:#9ca3af">${this._psReportDistList.map(d => html`<div>${d}</div>`)}</div>
            <div style="margin-top:6px;display:flex;gap:4px">
              <button style="background:#3b82f6;border:none;border-radius:4px;padding:4px 10px;color:#fff;font-size:10px;cursor:pointer" @click=${this._psGenerateReport}>Generate</button>
        ...
        ${this._psReportHistory.length > 0 ? html`
          <div style="border-top:1px solid #2a2d3a;padding-top:8px">
            ...
            ${this._psReportHistory.slice(0,3).map(r => html`
  ...
  @state() private _psHighContrast: boolean = false;
  @state() private _psA11yAnnounce: string = '';
  @state() private _psShortcutsVisible: boolean = false;
  @state() private _psFocusTrap: boolean = false;

  private _psShortcuts: Record<string, string> = {
  ...
  private _psHandleKeydown(e: KeyboardEvent): void {
    if (e.key === 'Escape' && this._psFocusTrap) { this._psFocusTrap = false; this._psAnnounce('Dialog closed'); }
    if (e.ctrlKey && e.shiftKey && e.key === 'H') { e.preventDefault(); this._psHighContrast = !this._psHighContrast; this._psAnnounce('High contrast ' + (this._psHighContrast ? 'enabled' : 'disabled')); }
    if (e.ctrlKey && e.shiftKey && e.key === 'A') { e.preventDefault(); this._psShortcutsVisible = !this._psShortcutsVisible; }
  }

  private _psAnnounce(msg: string): void {
    this._psA11yAnnounce = msg;
    setTimeout(() => { this._psA11yAnnounce = ''; }, 2000);
  }

  private _psRenderAccessibility(): any {
    return html`
      <div role="region" aria-label="Accessibility Controls" style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <button class="tab ${this._psShortcutsVisible ? 'active' : ''}" @click=${() => { this._psShortcutsVisible = !this._psShortcutsVisible; }} aria-expanded=${this._psShortcutsVisible}>Shortcuts</button>
        </div>
        <div style="display:flex;gap:8px;margin-bottom:8px">
          <label style="display:flex;align-items:center;gap:6px;font-size:11px;color:#e2e8f0;cursor:pointer">
            <input type="checkbox" .checked=${this._psHighContrast} @change=${() => { this._psHighContrast = !this._psHighContrast; }} aria-label="Toggle high contrast mode">
            High Contrast
          </label>
        </div>
        ${this._psShortcutsVisible ? html`
          <div role="list" aria-label="Keyboard shortcuts" style="background:#1a1d2e;border-radius:6px;padding:8px">
            ${Object.entries(this._psShortcuts).map(([key, desc]) => html`
        ...
        ` : nothing}
        <div role="status" aria-live="polite" aria-atomic="true" style="position:absolute;left:-9999px">${this._psA11yAnnounce}</div>
      </div>
    `;
  }
  ...
  connectedCallback(): void {
    ...
    this._psInitScenarios();
    this._psInitTrendData();
    this._psInitPermissions();
    document.addEventListener('keydown', this._psHandleKeydown.bind(this));
  }

  disconnectedCallback(): void {
    super.disconnectedCallback();
    document.removeEventListener('keydown', this._psHandleKeydown.bind(this));
  }

  // === TAB INTEGRATION FOR EXTENDED FEATURES ===
  @state() private _psActiveSubTab: string = 'scenario';
  ...
  private _psGetAllSubTabs(): {key:string;label:string}[] {
    return [
  ...
  private _psRenderSubPanel(): any {
    switch (this._psActiveSubTab) {
      case 'scenario': return this._psRenderScenarioEngine();
      case 'timeseries': return this._psRenderTimeSeries();
      case 'rbac': return this._psRenderRBAC();
      case 'reporting': return this._psRenderReporting();
      case 'a11y': return this._psRenderAccessibility();
      default: return nothing;
    }
  }

  private _psRenderTabBar(): any {
    return html`
      <div style="display:flex;gap:4px;margin-bottom:12px;border-bottom:1px solid #2a2d3a;padding-bottom:8px;flex-wrap:wrap" role="tablist" aria-label="Extended panel features">
        ${this._psGetAllSubTabs().map(t => html`
          <button class="tab ${this._psActiveSubTab === t.key ? 'active' : ''}" @click=${() => { this._psActiveSubTab = t.key; }} role="tab" aria-selected=${this._psActiveSubTab === t.key}>${t.label}</button>
        `)}
      </div>
      <div role="tabpanel" aria-labelledby="ps-tab-${this._psActiveSubTab}">
        ${this._psRenderSubPanel()}
      </div>
    `;
  }
  ...
  @state() private _soarPlaybooks: Array<{
    ...
    {
      id: 'pb-soar-001', name: 'Phishing Sim Auto Response', status: 'active',
      steps: [
    ...
    {
      id: 'pb-soar-002', name: 'Phishing Sim Investigation Workflow', status: 'active',
      steps: [
    ...
    {
      id: 'pb-soar-003', name: 'Phishing Sim Compliance Scan', status: 'draft',
      steps: [
  ...
  @state() private _psAle: number = 0;
  @state() private _psSroi: number = 0;
  @state() private _psCpi: number = 0;
  @state() private _psBudgetAlloc: number = 0;
  @state() private _psCostBenefit: number = 0;

  // Security Economics Calculator
  private psInitEconomics() {
    this._psAle = Math.round(2850000 + Math.random() * 4500000);
    this._psSroi = Math.round(180 + Math.random() * 320);
    this._psCpi = Math.round(45000 + Math.random() * 120000);
    this._psBudgetAlloc = Math.round(2500000 + Math.random() * 3000000);
    this._psCostBenefit = Math.round(220 + Math.random() * 180);
  }

  private _psCalcAle(): { annual: number; perIncident: number; byCategory: Array<{name: string; value: number}> } {
    const base = this._psAle;
    const categories = [
  ...
  private _psCalcSroi(): Array<{year: number; investment: number; savings: number; roi: number}> {
    const baseInv = this._psSroi * 10000;
  ...
  private _psGetBudgetAlloc(): Array<{category: string; amount: number; pct: number; trend: string}> {
    const total = this._psBudgetAlloc;
    const items = [
  ...
  private _psGetCostBenefit(): Array<{control: string; cost: number; benefit: number; ratio: number; priority: string}> {
    const base = this._psCostBenefit;
    const controls = [
  ...
  private _psRenderEconomics() {
    const ale = this._psCalcAle();
    const roi = this._psCalcSroi();
    const budget = this._psGetBudgetAlloc();
    const cb = this._psGetCostBenefit();
    const cpi = this._psCpi;
  ...
  @state() private _psThreatLevel: any = null;
  @state() private _psEmergingThreats: any = null;
  @state() private _psThreatTrends: any = null;
  @state() private _psSectorRadar: any = null;
  @state() private _psActorActivity: any = null;

  // Threat Landscape Intelligence
  private psInitThreatIntel() {
    this._psThreatLevel = {
  ...
  private _psRenderThreatIntel() {
    const tl = this._psThreatLevel;
    const et = this._psEmergingThreats;
    const sr = this._psSectorRadar;
    const aa = this._psActorActivity;
  ...
  @state() private _psPolicies: any = null;
  @state() private _psExceptions: any = null;
  @state() private _psRiskRegister: any = null;
  @state() private _psMeetings: any = null;
  @state() private _psDeadlines: any = null;

  // Security Governance Dashboard
  private psInitGovernance() {
    this._psPolicies = [
  ...
  private _psRenderGovernance() {
    const policies = this._psPolicies;
    const risks = this._psRiskRegister;
    const deadlines = this._psDeadlines;
  ...
  @state() private _psCriticalAssets: any = null;
  @state() private _psAssetDeps: any = null;
  @state() private _psEolAssets: any = null;
  @state() private _psAssetRisk: any = null;

  // Asset Intelligence
  private psInitAssetIntel() {
    this._psCriticalAssets = [
    ...
    this._psAssetRisk = { critical: 7, high: 23, medium: 45, low: 128, total: 203 };
  }

  private _psRenderAssetIntel() {
    const assets = this._psCriticalAssets;
    const eol = this._psEolAssets;
    const ar = this._psAssetRisk;
  ...
  @state() private _psUserBaseline: any = null;
  @state() private _psAnomalyRules: any = null;
  @state() private _psDataAccess: any = null;
  @state() private _psInsiderRisk: any = null;
  ...
  private psInitInsiderThreat() {
    this._psUserBaseline = [
    ...
    this._psInsiderRisk = { totalUsers: 2847, monitored: 342, flagged: 18, investigated: 5, confirmed: 1 };
  }

  private _psRenderInsiderThreat() {
    const baseline = this._psUserBaseline;
    const rules = this._psAnomalyRules;
    const ir = this._psInsiderRisk;
...
// ===== DATA SOVEREIGNTY COMPLIANCE (R22) =====
  ...
  private _renderBudgetPlanning() {
    const budgetData = [
      { category: "Personnel & Training", planned: 4346000, actual: 1312000, utilization: 30.2, q1: "29%", q2: "34%", q3: "32%", q4: "24%" },
      { category: "Tooling & Licensing", planned: 4353000, actual: 1325000, utilization: 30.4, q1: "16%", q2: "23%", q3: "27%", q4: "25%" },
      { category: "Infrastructure Security", planned: 4360000, actual: 1338000, utilization: 30.7, q1: "19%", q2: "28%", q3: "22%", q4: "10%" },
      { category: "Compliance & Audit", planned: 4367000, actual: 1351000, utilization: 30.9, q1: "22%", q2: "33%", q3: "33%", q4: "11%" },
      { category: "Incident Response", planned: 4374000, actual: 1364000, utilization: 31.2, q1: "25%", q2: "22%", q3: "28%", q4: "12%" },
      { category: "Third-Party Assessments", planned: 4381000, actual: 1377000, utilization: 31.4, q1: "28%", q2: "27%", q3: "23%", q4: "13%" },
      { category: "Security Awareness", planned: 4388000, actual: 1390000, utilization: 31.7, q1: "15%", q2: "32%", q3: "18%", q4: "14%" },
      { category: "Research & Innovation", planned: 4395000, actual: 1403000, utilization: 31.9, q1: "18%", q2: "21%", q3: "29%", q4: "15%" },
    ];
    ...
    const headcount = [
      { team: "SOC Tier 1", current: 12, target: 5, gap: 0, avgSalary: "184k" },
      { team: "SOC Tier 2", current: 4, target: 4, gap: 5, avgSalary: "102k" },
      { team: "Threat Intel", current: 13, target: 3, gap: 4, avgSalary: "131k" },
      { team: "Red Team", current: 5, target: 22, gap: 3, avgSalary: "160k" },
      { team: "GRC", current: 14, target: 21, gap: 2, avgSalary: "189k" },
      { team: "AppSec", current: 6, target: 20, gap: 1, avgSalary: "107k" },
      { team: "Cloud Sec", current: 15, target: 19, gap: 0, avgSalary: "136k" },
      { team: "Identity & Access", current: 7, target: 18, gap: 5, avgSalary: "165k" },
    ];
    const vendorSpend = [
      { vendor: "CrowdStrike", annual: "769k", contractEnd: "2026-07", renewalRisk: "Low", satisfaction: 3 },
      { vendor: "Palo Alto", annual: "800k", contractEnd: "2026-08", renewalRisk: "Medium", satisfaction: 5 },
      { vendor: "Splunk", annual: "80k", contractEnd: "2026-09", renewalRisk: "High", satisfaction: 4 },
      { vendor: "Qualys", annual: "111k", contractEnd: "2026-10", renewalRisk: "Low", satisfaction: 3 },
      { vendor: "Rapid7", annual: "142k", contractEnd: "2026-11", renewalRisk: "Medium", satisfaction: 5 },
      { vendor: "Mandiant", annual: "173k", contractEnd: "2026-12", renewalRisk: "High", satisfaction: 4 },
      { vendor: "Zscaler", annual: "204k", contractEnd: "2026-01", renewalRisk: "Low", satisfaction: 3 },
      { vendor: "Duo Security", annual: "235k", contractEnd: "2026-02", renewalRisk: "Medium", satisfaction: 5 },
    ];
    const roiProjections = [
      { area: "Threat Detection", investment: "736k", projectedReturn: "2009k", roiMultiple: "3.7x", confidence: 66 },
      { area: "Incident Reduction", investment: "779k", projectedReturn: "2056k", roiMultiple: "3.6x", confidence: 83 },
      { area: "Compliance Savings", investment: "822k", projectedReturn: "2103k", roiMultiple: "3.5x", confidence: 64 },
      { area: "Automation Gains", investment: "865k", projectedReturn: "2150k", roiMultiple: "3.4x", confidence: 81 },
      { area: "Risk Avoidance", investment: "107k", projectedReturn: "2197k", roiMultiple: "3.3x", confidence: 62 },
    ];
    return html`
  ...
  private _renderMetricsNormalization() {
    const kpiCatalog = [
      { id: "kpi-1", name: "MTTD", owner: "SOC", unit: "minutes", target: 91, current: 92, benchmark: 88, collection: "auto", frequency: "realtime" },
      { id: "kpi-2", name: "MTTR", owner: "GRC", unit: "%", target: 94, current: 99, benchmark: 65, collection: "semi-auto", frequency: "daily" },
      { id: "kpi-3", name: "MTTC", owner: "AppSec", unit: "score", target: 97, current: 60, benchmark: 76, collection: "manual", frequency: "weekly" },
      { id: "kpi-4", name: "Vuln SLA Compliance", owner: "Cloud Sec", unit: "count", target: 70, current: 67, benchmark: 87, collection: "auto", frequency: "monthly" },
      { id: "kpi-5", name: "Patch Coverage", owner: "Identity", unit: "days", target: 73, current: 74, benchmark: 98, collection: "semi-auto", frequency: "realtime" },
      { id: "kpi-6", name: "Phishing Click Rate", owner: "Threat Intel", unit: "minutes", target: 76, current: 81, benchmark: 75, collection: "manual", frequency: "daily" },
      { id: "kpi-7", name: "Training Completion", owner: "Security Ops", unit: "%", target: 79, current: 88, benchmark: 86, collection: "auto", frequency: "weekly" },
      { id: "kpi-8", name: "Escalation Rate", owner: "Risk Mgmt", unit: "score", target: 82, current: 95, benchmark: 97, collection: "semi-auto", frequency: "monthly" },
      { id: "kpi-9", name: "False Positive Rate", owner: "SOC", unit: "count", target: 85, current: 56, benchmark: 74, collection: "manual", frequency: "realtime" },
      { id: "kpi-10", name: "Threat Intel Actionability", owner: "GRC", unit: "days", target: 88, current: 63, benchmark: 85, collection: "auto", frequency: "daily" },
      { id: "kpi-11", name: "Endpoint Compliance", owner: "AppSec", unit: "minutes", target: 91, current: 70, benchmark: 96, collection: "semi-auto", frequency: "weekly" },
      { id: "kpi-12", name: "Cloud Misconfig Score", owner: "Cloud Sec", unit: "%", target: 94, current: 77, benchmark: 73, collection: "manual", frequency: "monthly" },
      { id: "kpi-13", name: "Identity Anomaly Rate", owner: "Identity", unit: "score", target: 97, current: 84, benchmark: 84, collection: "auto", frequency: "realtime" },
      { id: "kpi-14", name: "DLP Events", owner: "Threat Intel", unit: "count", target: 70, current: 91, benchmark: 95, collection: "semi-auto", frequency: "daily" },
      { id: "kpi-15", name: "Vendor Risk Avg", owner: "Security Ops", unit: "days", target: 73, current: 98, benchmark: 72, collection: "manual", frequency: "weekly" },
      { id: "kpi-16", name: "Compliance Audit Pass Rate", owner: "Risk Mgmt", unit: "minutes", target: 76, current: 59, benchmark: 83, collection: "auto", frequency: "monthly" },
      { id: "kpi-17", name: "Awareness Score", owner: "SOC", unit: "%", target: 79, current: 66, benchmark: 94, collection: "semi-auto", frequency: "realtime" },
      { id: "kpi-18", name: "SOC Utilization", owner: "GRC", unit: "score", target: 82, current: 73, benchmark: 71, collection: "manual", frequency: "daily" },
      { id: "kpi-19", name: "Automation Coverage", owner: "AppSec", unit: "count", target: 85, current: 80, benchmark: 82, collection: "auto", frequency: "weekly" },
      { id: "kpi-20", name: "Risk Register Currency", owner: "Cloud Sec", unit: "days", target: 88, current: 87, benchmark: 93, collection: "semi-auto", frequency: "monthly" },
    ];
    const benchmarkSources = [
      { source: "NIST CSF", mappedKPIs: 6, alignment: 93, lastReview: "2026-04-10", status: "aligned" },
      { source: "CIS Controls v8", mappedKPIs: 7, alignment: 71, lastReview: "2026-05-05", status: "partial" },
      { source: "ISO 27001:2022", mappedKPIs: 8, alignment: 88, lastReview: "2026-06-28", status: "reviewing" },
      { source: "PCI DSS 4.0", mappedKPIs: 3, alignment: 66, lastReview: "2026-01-23", status: "aligned" },
      { source: "SOC 2 Type II", mappedKPIs: 4, alignment: 83, lastReview: "2026-02-18", status: "partial" },
      { source: "MITRE ATT&CK", mappedKPIs: 5, alignment: 61, lastReview: "2026-03-13", status: "reviewing" },
      { source: "SANS Top 20", mappedKPIs: 6, alignment: 78, lastReview: "2026-04-08", status: "aligned" },
      { source: "OWASP Top 10", mappedKPIs: 7, alignment: 95, lastReview: "2026-05-03", status: "partial" },
    ];
  ...
  private _renderThreatHuntingCampaigns() {
    const campaigns = [
      { id: "HC-1001", name: "Lateral Movement Sweep", status: "active", hypothesis: "H1: Actors using pass-the-hash for lateral movement", leadHunter: "Alice Chen", findings: 13, startDate: "2026-02-02", endDate: null, effectiveness: 92 },
      { id: "HC-1002", name: "Credential Harvesting Hunt", status: "completed", hypothesis: "H2: Actors using web shells for persistence", leadHunter: "Bob Martinez", findings: 16, startDate: "2026-01-13", endDate: "2026-06-19", effectiveness: 52 },
      { id: "HC-1003", name: "Persistence Mechanism Audit", status: "planned", hypothesis: "H3: Actors using scheduled tasks for data theft", leadHunter: "Carol Wu", findings: 19, startDate: "2026-04-24", endDate: null, effectiveness: 71 },
      { id: "HC-1004", name: "C2 Beacon Detection", status: "in-review", hypothesis: "H4: Actors using DNS tunneling for C2 communication", leadHunter: "Dave Kim", findings: 22, startDate: "2026-03-07", endDate: null, effectiveness: 90 },
      { id: "HC-1005", name: "Data Exfiltration Patterns", status: "active", hypothesis: "H5: Actors using encrypted channels for privilege escalation", leadHunter: "Eve Johnson", findings: 25, startDate: "2026-02-18", endDate: null, effectiveness: 50 },
      { id: "HC-1006", name: "Privilege Escalation Scan", status: "completed", hypothesis: "H6: Actors using token impersonation for defense evasion", leadHunter: "Frank Liu", findings: 28, startDate: "2026-01-01", endDate: "2026-04-03", effectiveness: 69 },
      { id: "HC-1007", name: "Supply Chain Implant Hunt", status: "planned", hypothesis: "H7: Actors using poisoned images for initial access", leadHunter: "Grace Park", findings: 31, startDate: "2026-04-12", endDate: null, effectiveness: 88 },
      { id: "HC-1008", name: "Insider Threat Indicators", status: "in-review", hypothesis: "H8: Actors using legitimate tools for credential access", leadHunter: "Hector Silva", findings: 34, startDate: "2026-03-23", endDate: null, effectiveness: 48 },
      { id: "HC-1009", name: "Cloud Metadata Analysis", status: "active", hypothesis: "H9: Actors using API keys for command execution", leadHunter: "Alice Chen", findings: 37, startDate: "2026-02-06", endDate: null, effectiveness: 67 },
      { id: "HC-1010", name: "DNS Tunnel Detection", status: "completed", hypothesis: "H10: Actors using encoded subdomains for exfiltration", leadHunter: "Bob Martinez", findings: 40, startDate: "2026-01-17", endDate: "2026-05-15", effectiveness: 86 },
      { id: "HC-1011", name: "Fileless Malware Search", status: "planned", hypothesis: "H11: Actors using WMI providers for discovery", leadHunter: "Carol Wu", findings: 43, startDate: "2026-04-28", endDate: null, effectiveness: 46 },
      { id: "HC-1012", name: "Zero-Day Exploit Traces", status: "in-review", hypothesis: "H12: Actors using exploit kits for collection", leadHunter: "Dave Kim", findings: 46, startDate: "2026-03-11", endDate: null, effectiveness: 65 },
    ];
    const hunterLeaderboard = [
      { hunter: "Alice Chen", campaigns: 9, findings: 118, highSeverity: 19, avgScore: 64, streak: 6 },
      { hunter: "Bob Martinez", campaigns: 6, findings: 31, highSeverity: 24, avgScore: 57, streak: 7 },
      { hunter: "Carol Wu", campaigns: 3, findings: 60, highSeverity: 3, avgScore: 94, streak: 8 },
      { hunter: "Dave Kim", campaigns: 13, findings: 89, highSeverity: 8, avgScore: 87, streak: 1 },
      { hunter: "Eve Johnson", campaigns: 10, findings: 118, highSeverity: 13, avgScore: 80, streak: 2 },
      { hunter: "Frank Liu", campaigns: 7, findings: 31, highSeverity: 18, avgScore: 73, streak: 3 },
      { hunter: "Grace Park", campaigns: 4, findings: 60, highSeverity: 23, avgScore: 66, streak: 4 },
      { hunter: "Hector Silva", campaigns: 14, findings: 89, highSeverity: 2, avgScore: 59, streak: 5 },
    ];
    const mitreMapping = [
      { tactic: "Initial Access", techniques: 11, campaigns: 2, coverage: 48 },
      { tactic: "Execution", techniques: 10, campaigns: 1, coverage: 99 },
      { tactic: "Persistence", techniques: 9, campaigns: 6, coverage: 79 },
      { tactic: "Privilege Escalation", techniques: 8, campaigns: 5, coverage: 59 },
      { tactic: "Defense Evasion", techniques: 7, campaigns: 4, coverage: 39 },
      { tactic: "Credential Access", techniques: 6, campaigns: 3, coverage: 90 },
      { tactic: "Discovery", techniques: 5, campaigns: 2, coverage: 70 },
      { tactic: "Lateral Movement", techniques: 4, campaigns: 1, coverage: 50 },
      { tactic: "Collection", techniques: 3, campaigns: 6, coverage: 30 },
      { tactic: "Exfiltration", techniques: 2, campaigns: 5, coverage: 81 },
      { tactic: "Command & Control", techniques: 12, campaigns: 4, coverage: 61 },
      { tactic: "Impact", techniques: 11, campaigns: 3, coverage: 41 },
    ];
    return html`
  ...
  private _renderControlInventory() {
    const controls = [
      { id: "CTL-2001", name: "MFA Enforcement", domain: "Access Control", status: "implemented", effectiveness: 89, lastTest: "2026-02-22", nextReview: "2026-10-22", owner: "SOC", risk: "Low" },
      { id: "CTL-2002", name: "Network Segmentation", domain: "Network Security", status: "partial", effectiveness: 24, lastTest: "2026-01-07", nextReview: "2026-11-13", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2003", name: "EDR Deployment", domain: "Endpoint Protection", status: "planned", effectiveness: 31, lastTest: "2026-04-20", nextReview: "2026-12-04", owner: "IT Ops", risk: "High" },
      { id: "CTL-2004", name: "DLP Policy", domain: "Data Protection", status: "gap", effectiveness: 38, lastTest: "2026-03-05", nextReview: "2026-05-23", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2005", name: "SSO Integration", domain: "Identity Management", status: "implemented", effectiveness: 42, lastTest: "2026-02-18", nextReview: "2026-06-14", owner: "IAM", risk: "Low" },
      { id: "CTL-2006", name: "SAST Pipeline", domain: "Application Security", status: "partial", effectiveness: 1, lastTest: "2026-01-03", nextReview: "2026-07-05", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2007", name: "CSPM Scanning", domain: "Cloud Security", status: "planned", effectiveness: 8, lastTest: "2026-04-16", nextReview: "2026-08-24", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2008", name: "Badge Access", domain: "Physical Security", status: "gap", effectiveness: 15, lastTest: "2026-03-01", nextReview: "2026-09-15", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2009", name: "Least Privilege", domain: "Access Control", status: "implemented", effectiveness: 54, lastTest: "2026-02-14", nextReview: "2026-10-06", owner: "SOC", risk: "Low" },
      { id: "CTL-2010", name: "Firewall Rules", domain: "Network Security", status: "partial", effectiveness: 29, lastTest: "2026-01-27", nextReview: "2026-11-25", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2011", name: "Disk Encryption", domain: "Endpoint Protection", status: "planned", effectiveness: 36, lastTest: "2026-04-12", nextReview: "2026-12-16", owner: "IT Ops", risk: "High" },
      { id: "CTL-2012", name: "Data Classification", domain: "Data Protection", status: "gap", effectiveness: 43, lastTest: "2026-03-25", nextReview: "2026-05-07", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2013", name: "PAM Implementation", domain: "Identity Management", status: "implemented", effectiveness: 66, lastTest: "2026-02-10", nextReview: "2026-06-26", owner: "IAM", risk: "Low" },
      { id: "CTL-2014", name: "DAST Pipeline", domain: "Application Security", status: "partial", effectiveness: 6, lastTest: "2026-01-23", nextReview: "2026-07-17", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2015", name: "IAM Policy Review", domain: "Cloud Security", status: "planned", effectiveness: 13, lastTest: "2026-04-08", nextReview: "2026-08-08", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2016", name: "Visitor Management", domain: "Physical Security", status: "gap", effectiveness: 20, lastTest: "2026-03-21", nextReview: "2026-09-27", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2017", name: "Access Reviews", domain: "Access Control", status: "implemented", effectiveness: 78, lastTest: "2026-02-06", nextReview: "2026-10-18", owner: "SOC", risk: "Low" },
      { id: "CTL-2018", name: "IDS/IPS Tuning", domain: "Network Security", status: "partial", effectiveness: 34, lastTest: "2026-01-19", nextReview: "2026-11-09", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2019", name: "Patch Management", domain: "Endpoint Protection", status: "planned", effectiveness: 41, lastTest: "2026-04-04", nextReview: "2026-12-28", owner: "IT Ops", risk: "High" },
      { id: "CTL-2020", name: "Backup Encryption", domain: "Data Protection", status: "gap", effectiveness: 48, lastTest: "2026-03-17", nextReview: "2026-05-19", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2021", name: "Password Policy", domain: "Identity Management", status: "implemented", effectiveness: 90, lastTest: "2026-02-02", nextReview: "2026-06-10", owner: "IAM", risk: "Low" },
      { id: "CTL-2022", name: "Container Scanning", domain: "Application Security", status: "partial", effectiveness: 11, lastTest: "2026-01-15", nextReview: "2026-07-01", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2023", name: "WAF Configuration", domain: "Cloud Security", status: "planned", effectiveness: 18, lastTest: "2026-04-28", nextReview: "2026-08-20", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2024", name: "CCTV Coverage", domain: "Physical Security", status: "gap", effectiveness: 25, lastTest: "2026-03-13", nextReview: "2026-09-11", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2025", name: "RBAC Enforcement", domain: "Access Control", status: "implemented", effectiveness: 43, lastTest: "2026-02-26", nextReview: "2026-10-02", owner: "SOC", risk: "Low" },
      { id: "CTL-2026", name: "VPN Management", domain: "Network Security", status: "partial", effectiveness: 39, lastTest: "2026-01-11", nextReview: "2026-11-21", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2027", name: "App Whitelisting", domain: "Endpoint Protection", status: "planned", effectiveness: 46, lastTest: "2026-04-24", nextReview: "2026-12-12", owner: "IT Ops", risk: "High" },
      { id: "CTL-2028", name: "Key Management", domain: "Data Protection", status: "gap", effectiveness: 2, lastTest: "2026-03-09", nextReview: "2026-05-03", owner: "Data Gov", risk: "Critical" },
    ];
    const gapAnalysis = [
      { gap: "Insufficient MFA coverage for legacy apps", severity: "High", remediationPlan: "Plan R3001", eta: "2026-Q4", estimatedCost: "181k" },
      { gap: "Missing network micro-segmentation", severity: "Medium", remediationPlan: "Plan R3002", eta: "2026-Q3", estimatedCost: "29k" },
      { gap: "Inconsistent EDR deployment", severity: "Medium", remediationPlan: "Plan R3003", eta: "2026-Q2", estimatedCost: "58k" },
      { gap: "DLP not covering cloud storage", severity: "Low", remediationPlan: "Plan R3004", eta: "2026-Q4", estimatedCost: "87k" },
      { gap: "SSO not integrated with all SaaS", severity: "High", remediationPlan: "Plan R3005", eta: "2026-Q3", estimatedCost: "116k" },
    ];
    return html`
  ...
  private _renderIncidentCostTracker() {
    const incidents = [
      { id: "INC-7001", name: "Security Incident 1", severity: "Critical", totalCost: 1758000, responseCost: 369180, recoveryCost: 457080, legalCost: 316440, regulatoryCost: 210960, insuranceClaim: 1371240, avoidedCost: 306000, date: "2026-02-14" },
      { id: "INC-7002", name: "Security Incident 2", severity: "High", totalCost: 1761000, responseCost: 493080, recoveryCost: 651570, legalCost: 264150, regulatoryCost: 123270, insuranceClaim: 0, avoidedCost: 335000, date: "2026-01-23" },
      { id: "INC-7003", name: "Security Incident 3", severity: "Medium", totalCost: 1764000, responseCost: 617400, recoveryCost: 476280, legalCost: 211680, regulatoryCost: 229320, insuranceClaim: 1287720, avoidedCost: 364000, date: "2026-04-04" },
      { id: "INC-7004", name: "Security Incident 4", severity: "Low", totalCost: 1767000, responseCost: 371070, recoveryCost: 671460, legalCost: 159030, regulatoryCost: 141360, insuranceClaim: 0, avoidedCost: 393000, date: "2026-03-13" },
      { id: "INC-7005", name: "Security Incident 5", severity: "Critical", totalCost: 1770000, responseCost: 495600, recoveryCost: 495600, legalCost: 106200, regulatoryCost: 247800, insuranceClaim: 1203600, avoidedCost: 422000, date: "2026-02-22" },
      { id: "INC-7006", name: "Security Incident 6", severity: "High", totalCost: 1773000, responseCost: 620550, recoveryCost: 691470, legalCost: 336870, regulatoryCost: 159570, insuranceClaim: 0, avoidedCost: 451000, date: "2026-01-03" },
      { id: "INC-7007", name: "Security Incident 7", severity: "Medium", totalCost: 1776000, responseCost: 372960, recoveryCost: 515040, legalCost: 284160, regulatoryCost: 266400, insuranceClaim: 1118880, avoidedCost: 480000, date: "2026-04-12" },
      { id: "INC-7008", name: "Security Incident 8", severity: "Low", totalCost: 1779000, responseCost: 498120, recoveryCost: 711600, legalCost: 231270, regulatoryCost: 177900, insuranceClaim: 0, avoidedCost: 13000, date: "2026-03-21" },
      { id: "INC-7009", name: "Security Incident 9", severity: "Critical", totalCost: 1782000, responseCost: 623700, recoveryCost: 534600, legalCost: 178200, regulatoryCost: 89100, insuranceClaim: 1033560, avoidedCost: 42000, date: "2026-02-02" },
      { id: "INC-7010", name: "Security Incident 10", severity: "High", totalCost: 1785000, responseCost: 374850, recoveryCost: 357000, legalCost: 124950, regulatoryCost: 196350, insuranceClaim: 0, avoidedCost: 71000, date: "2026-01-11" },
      { id: "INC-7011", name: "Security Incident 11", severity: "Medium", totalCost: 1788000, responseCost: 500640, recoveryCost: 554280, legalCost: 357600, regulatoryCost: 107280, insuranceClaim: 947640, avoidedCost: 100000, date: "2026-04-20" },
      { id: "INC-7012", name: "Security Incident 12", severity: "Low", totalCost: 1791000, responseCost: 626850, recoveryCost: 376110, legalCost: 304470, regulatoryCost: 214920, insuranceClaim: 0, avoidedCost: 129000, date: "2026-03-01" },
    ];
    const yearlyTrend = [
      { month: "Jan", incidents: 9, totalCost: "262k", avgCost: "95k", insured: 68 },
      { month: "Feb", incidents: 6, totalCost: "305k", avgCost: "142k", insured: 68 },
      { month: "Mar", incidents: 3, totalCost: "348k", avgCost: "189k", insured: 68 },
      { month: "Apr", incidents: 11, totalCost: "391k", avgCost: "55k", insured: 68 },
      { month: "May", incidents: 8, totalCost: "434k", avgCost: "102k", insured: 68 },
      { month: "Jun", incidents: 5, totalCost: "477k", avgCost: "149k", insured: 68 },
    ];
...
declare global { interface HTMLElementTagNameMap { 'sc-phishing-sim': ScPhishingSim; } }
