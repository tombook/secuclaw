...
export class ScRiskGauge extends LitElement {
  ...
  private _data: MockItem[] = [
    {name:"Overall Risk Score: 7.2/10",status:"scanning",risk:"high",detail:"Critical: 12 findings. Attack surface: 847 exposed services. MTTD: 14min. MTTR: 2.3h."},
    {name:"External Attack Surface",status:"exposed",risk:"critical",detail:"2,340 internet-facing assets. 156 with critical vulns. 3 phishing-susceptible domains."},
    {name:"Internal Network Security",status:"improving",risk:"high",detail:"Lateral movement possible in 3/5 segments. 89% patch compliance. 4 outdated service accounts."},
    {name:"Application Security",status:"stable",risk:"medium",detail:"SAST: 23 high findings. DAST: 7 exploitable. SCA: 12 vulnerable dependencies. Code coverage: 67%."}
  ];
  ...
  render() {
    ...
    return html`<div class="panel"><div class="pt">Risk Gauge</div>
