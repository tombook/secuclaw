...
@customElement('sc-network-topo')
export class ScNetworkTopo extends LitElement {
  static styles = css`
...
@state() private _tablePage = 1;
  ...
  @state() private _comments: CommentEntry[] = [
    { id: 'c1', author: 'soc-tier1', timestamp: '2026-04-23 04:00', text: 'Initial assessment started for Network Topo finding #1' },
  ...
  private _items: PanelItem[] = [
      {
            "id": "network-topo-1",
            "title": "Internet Zone (Public)",
            "severity": "high",
            "status": "open",
            "category": "Security",
            "source": "SIEM",
            "description": "WAF: Cloudflare | CDN: Static assets | DDoS protection | Rate limiting: 10K/min | Bot management",
      ...
      {
            "id": "network-topo-2",
            "title": "DMZ (Semi-trusted)",
            "severity": "critical",
            "status": "in-progress",
            "category": "Network",
            "source": "EDR",
            "description": "Reverse proxy: Nginx | Load balancer: HAProxy | Mail relay: Postfix | IDS: Suricata | VLAN 100",
      ...
      {
            "id": "network-topo-3",
            "title": "Application Tier (Trusted)",
            "severity": "medium",
            "status": "resolved",
            "category": "Access",
            "source": "Scanner",
            "description": "K8s cluster: 24 pods | Service mesh: Istio | API gateway: Kong | mTLS enabled | VLAN 200",
      ...
      {
            "id": "network-topo-4",
            "title": "Data Tier (Restricted)",
            "severity": "critical",
            "status": "open",
            "category": "Compliance",
            "source": "Audit",
            "description": "MySQL cluster: 3 nodes | Redis sentinel | S3 buckets (encrypted) | No direct internet access | VLAN 300",
      ...
      {
            "id": "network-topo-5",
            "title": "Management Tier (Isolated)",
            "severity": "high",
            "status": "in-progress",
            "category": "Operations",
            "source": "Manual",
            "description": "Jump box only | Bastion host | Session recording | No internet | VPN + MFA required | VLAN 400",
      ...
      {
            "id": "network-topo-6",
            "title": "Network Topo Finding #6",
            "severity": "high",
            "status": "open",
            "category": "Security",
            "source": "SIEM",
            "description": "Automated network topo assessment finding detected during routine scan of infrastructure component. Review and remediation recommended.",
  ...
  private _history: HistoryEntry[] = [
    { timestamp: '2026-04-23 04:15', action: 'Auto-correlated', user: 'system', details: 'Grouped related findings from Network Topo analysis' },
    { timestamp: '2026-04-23 03:00', action: 'Created', user: 'scanner', details: 'New Network Topo finding detected by automated assessment' },
    ...
    { timestamp: '2026-04-22 22:00', action: 'Resolved', user: 'security-eng', details: 'Remediation applied and verified for Network Topo finding' },
    { timestamp: '2026-04-22 18:00', action: 'Created', user: 'audit', details: 'Compliance audit identified Network Topo gap requiring remediation' },
    ...
    { timestamp: '2026-04-21 16:00', action: 'Resolved', user: 'soc-tier1', details: 'False positive confirmed - benign activity flagged by Network Topo scan' },
    { timestamp: '2026-04-21 12:00', action: 'Exported', user: 'compliance', details: 'Exported Network Topo findings for Q1 compliance report' },
  ];
...
private _workflowTasks: WorkflowTask[] = [
    { id: 'wt-1', title: 'Review Network Topo finding #1', status: 'active', assignee: 'soc-tier1', blockedBy: [], slaDeadline: '2026-04-23T12:00:00Z', priority: 'p1', createdAt: '2026-04-23T00:00:00Z', completedAt: null },
    ...
    { id: 'wt-3', title: 'Update Network Topo detection rules', status: 'blocked', assignee: 'soc-tier2', blockedBy: ['wt-2'], slaDeadline: '2026-04-24T00:00:00Z', priority: 'p2', createdAt: '2026-04-23T03:00:00Z', completedAt: null },
    ...
    { id: 'wt-8', title: 'Archive resolved Network Topo findings', status: 'failed', assignee: 'soc-tier1', blockedBy: [], slaDeadline: '2026-04-23T08:00:00Z', priority: 'p4', createdAt: '2026-04-22T22:00:00Z', completedAt: null },
  ];

private _executionHistory: ExecutionRecord[] = [
    {
      id: 'exec-1', name: 'Network Topo Full Assessment Run', startedAt: '2026-04-22T10:00:00Z', completedAt: '2026-04-22T10:12:00Z', status: 'success',
      steps: [
    ...
    {
      id: 'exec-2', name: 'Network Topo Delta Scan', startedAt: '2026-04-23T02:00:00Z', completedAt: '2026-04-23T02:05:00Z', status: 'failed',
      steps: [
  ...
  private _runExecution() {
    ...
    const exec: ExecutionRecord = {
      id: 'exec-' + Date.now(), name: 'Network Topo Assessment ' + new Date().toISOString().slice(0, 10), startedAt: new Date().toISOString(), completedAt: null, status: 'running', steps,
    };
  ...
  private _renderExecutionPanel(): unknown {
    ...
    return html`
      <div class="form-section">
        ...
        ` : html`<div class="empty-state">Click "Run Assessment" to start the Network Topo analysis pipeline</div>`}
      </div>
      <div class="form-section">
        ...
        <div class="settings-card">
          ...
          <div style="display:flex;gap:8px;margin-top:4px;">
            <button class="btn primary" @click=${() => {
              ...
              const a = document.createElement('a'); a.href = url; a.download = 'network-topo-config.json'; a.click();
    ...
    return html`
      <div style="margin-top:12px;">
        ...
        <div style="display:flex;gap:6px;margin-top:8px;">
          <input class="search-box" type="text" placeholder="Add a comment..." style="min-width:auto;flex:1;" id="network-topo-comment-input" />
          <button class="btn primary" @click=${() => {
            const input = this.shadowRoot?.querySelector('#network-topo-comment-input') as HTMLInputElement;
  ...
  private _exportJSON() {
    ...
    const url = URL.createObjectURL(blob);
    const a = document.createElement('a'); a.href = url; a.download = 'sc-network-topo-data.json'; a.click();
    URL.revokeObjectURL(url);
  }
  ...
  private _exportCSV() {
    ...
    const url = URL.createObjectURL(blob);
    const a = document.createElement('a'); a.href = url; a.download = 'sc-network-topo-data.csv'; a.click();
    URL.revokeObjectURL(url);
  }


  // --- Domain Rules Engine ---
  @state() private _ntRules: { id: string; name: string; category: string; severity: Severity; enabled: boolean; lastEval: string; passRate: number }[] = [];
  private _initNtRules() {
    const rules = [
  ...
  private _evaluateNtRules(): { passed: number; failed: number; skipped: number; total: number } {
    let passed = 0, failed = 0, skipped = 0;
    this._ntRules.forEach(r => { if (!r.enabled) { skipped++; } else if (r.passRate >= 80) { passed++; } else { failed++; } });
    return { passed, failed, skipped, total: this._ntRules.length };
  }

  // --- CVSS Scoring ---
  @state() private _ntcvssData: { itemId: string; vector: string; base: number; temporal: number; environmental: number; overall: number }[] = [];
  private _initNtCvss() {
    ...
    this._ntcvssData = vectors.map((v, i) => {
  ...
  // --- Anomaly Detection ---
  @state() private _ntanomalies: { id: string; type: string; severity: Severity; description: string; detected: string; confidence: number; affected: string[] }[] = [];
  private _runNtAnomalyDetection() {
    const types = [
    ...
    this._ntanomalies = types.map((a, i) => ({
  ...
  // --- Trend Prediction ---
  @state() private _ntpredictions: { horizon: string; metric: string; current: number; predicted: number; direction: 'up' | 'down' | 'stable'; confidence: number }[] = [];
  private _generateNtPredictions() {
    this._ntpredictions = [
  ...
  // --- Approval Workflow ---
  @state() private _ntApprovals: { id: string; title: string; requester: string; status: 'pending' | 'approved' | 'rejected' | 'expired'; createdAt: string; priority: Priority; type: string }[] = [];
  private _initNtApprovals() {
    this._ntApprovals = [
  ...
  private _approveNtItem(id: string) { const item = this._ntApprovals.find(a => a.id === id); if (item) item.status = 'approved'; this.requestUpdate(); }
  private _rejectNtItem(id: string) { const item = this._ntApprovals.find(a => a.id === id); if (item) item.status = 'rejected'; this.requestUpdate(); }

  // --- Activity Feed ---
  @state() private _ntActivity: { id: string; action: string; user: string; target: string; timestamp: string }[] = [];
  private _initNtActivity() {
    const actions = [
    ...
    this._ntActivity = actions.map((a, i) => ({ id: 'ACT-' + String(i + 1).padStart(3, '0'), ...a, timestamp: new Date(Date.now() - i * 3600000).toISOString() }));
  }

  // --- Notification System ---
  @state() private _ntNotifications: { id: string; message: string; type: 'info' | 'warning' | 'error' | 'success'; read: boolean; timestamp: string }[] = [];
  private _initNtNotifications() {
    this._ntNotifications = [
  ...
  private _markNtNotifRead(id: string) { const n = this._ntNotifications.find(x => x.id === id); if (n) n.read = true; this.requestUpdate(); }

  // --- Panel Configuration ---
  @state() private _ntConfig: { layout: 'compact' | 'default' | 'expanded'; theme: 'dark' | 'midnight' | 'slate'; showAnomalies: boolean; showPredictions: boolean; autoRefresh: boolean; refreshInterval: number } = {
    layout: 'default', theme: 'dark', showAnomalies: true, showPredictions: true, autoRefresh: true, refreshInterval: 60,
  };
  private _ntPresets: { name: string; config: typeof this._ntConfig }[] = [
  ...
  private _applyNtPreset(preset: typeof this._ntPresets[0]) { this._ntConfig = { ...preset.config }; this.requestUpdate(); }

  private _renderNtTreemapSVG(): string {
    const categories = [
  ...
  private _renderNtSankeySVG(): string {
  ...
  // --- Render: Rules Engine ---
  private _renderNtRules(): any {
    const ev = this._evaluateNtRules();
    return html`
  ...
  private _renderNtAnomalies(): any {
  ...
  // --- Render: Approvals ---
  private _renderNtApprovals(): any {
          ...
          $${this._ntApprovals.map(a => html`
            <div style="padding:6px 8px;background:#1f2937;border-radius:4px">
              ...
              $${a.status === 'pending' ? html`
                <div style="display:flex;gap:4px;margin-top:4px">
                  <button class="btn success" style="padding:2px 8px;font-size:9px" @click=$${() => this._approveNtItem(a.id)}>Approve</button>
                  <button class="btn error" style="padding:2px 8px;font-size:9px" @click=$${() => this._rejectNtItem(a.id)}>Reject</button>
                </div>` : nothing}
            </div>`)}
        </div>
      </div>`;
  ...
  private _renderNtNotifications(): any {
    const tc = (t: string) => t === 'error' ? '#ef4444' : t === 'warning' ? '#eab308' : t === 'success' ? '#22c55e' : '#3b82f6';
    const unread = this._ntNotifications.filter(n => !n.read).length;
    return html`
      <div style="background:#1a1d27;border-radius:8px;padding:12px;margin-top:12px">
        ...
        <div style="display:flex;flex-direction:column;gap:4px;max-height:120px;overflow-y:auto">
          $${this._ntNotifications.map(n => html`
            <div style="display:flex;align-items:center;gap:8px;padding:4px 8px;background:$${n.read ? '#1f2937' : '#252a36'};border-radius:4px;font-size:10px;opacity:$${n.read ? '0.6' : '1'};cursor:pointer" @click=$${() => this._markNtNotifRead(n.id)}>
      ...
      <div style="background:#1a1d27;border-radius:8px;padding:12px;margin-top:12px">
        ...
        <div style="display:flex;flex-direction:column;gap:6px;font-size:10px">
          <div style="display:flex;align-items:center;gap:8px">
            ...
            <select class="form-input" style="flex:1" @change=$${(e: Event) => { this._ntConfig.layout = (e.target as HTMLSelectElement).value as any; this.requestUpdate(); }}>
              <option value="compact" ?selected=$${this._ntConfig.layout === 'compact'}>Compact</option>
              <option value="default" ?selected=$${this._ntConfig.layout === 'default'}>Default</option>
              <option value="expanded" ?selected=$${this._ntConfig.layout === 'expanded'}>Expanded</option>
            </select>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Theme</span>
            <select class="form-input" style="flex:1" @change=$${(e: Event) => { this._ntConfig.theme = (e.target as HTMLSelectElement).value as any; this.requestUpdate(); }}>
              <option value="dark" ?selected=$${this._ntConfig.theme === 'dark'}>Dark</option>
              <option value="midnight" ?selected=$${this._ntConfig.theme === 'midnight'}>Midnight</option>
              <option value="slate" ?selected=$${this._ntConfig.theme === 'slate'}>Slate</option>
            </select>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Auto Refresh</span>
            <input type="checkbox" ?checked=$${this._ntConfig.autoRefresh} @change=$${() => { this._ntConfig.autoRefresh = !this._ntConfig.autoRefresh; this.requestUpdate(); }}/>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Show Anomalies</span>
            <input type="checkbox" ?checked=$${this._ntConfig.showAnomalies} @change=$${() => { this._ntConfig.showAnomalies = !this._ntConfig.showAnomalies; this.requestUpdate(); }}/>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Show Predictions</span>
            <input type="checkbox" ?checked=$${this._ntConfig.showPredictions} @change=$${() => { this._ntConfig.showPredictions = !this._ntConfig.showPredictions; this.requestUpdate(); }}/>
          </div>
          <div style="margin-top:6px;font-weight:600">Presets</div>
          <div style="display:flex;gap:4px">
            $${this._ntPresets.map(ps => html`<button class="btn" style="padding:2px 8px;font-size:9px" @click=$${() => this._applyNtPreset(ps)}>$${ps.name}</button>`)}
          </div>
        </div>
      </div>`;
  }
...
@state() private _spmComplianceCheck6 = { id: "CHK-006", control: "Control 6", framework: "NIST 800-53", status: "pass", evidenceCount: 4, lastAudit: "2026-01-11", nextAudit: "2026-04-11", findings: 2 } as any;
  ...
  @state() private _networkTopoCourses: Array<{id:string;title:string;category:string;duration:number;enrolled:number;completed:number;difficulty:string;rating:number}> = [
  ...
  @state() private _networkTopoLearningPaths: Array<{id:string;name:string;courseIds:string[];progress:number;enrolled:number}> = [
  ...
  @state() private _networkTopoDeptCompliance: Array<{dept:string;trainedPct:number;targetPct:number;avgScore:number;certCount:number}> = [
  ...
  @state() private _networkTopoSkillsGaps: Array<{skill:string;current:number;required:number;gap:number;priority:string}> = [
  ...
  private _renderNetworktopoTraining(): TemplateResult {
    const courses = this._networkTopoCourses;
    const deptComp = this._networkTopoDeptCompliance;
    return html`
  ...
  @state() private _networkTopoCorrRules: Array<{id:string;name:string;sources:string[];logic:string;severity:string;active:boolean;lastTriggered:string}> = [
  ...
  @state() private _networkTopoEventTimeline: Array<{timestamp:string;source:string;eventType:string;details:string;correlated:boolean}> = [
  ...
  @state() private _networkTopoFalsePosMetrics: {totalEvents:number;correlatedEvents:number;falsePositives:number;fpRate:number;topFpRules:string[]} = {
  ...
  @state() private _networkTopoEventPatterns: Array<{id:string;pattern:string;frequency:number;firstSeen:string;lastSeen:string;status:string}> = [
  ...
  private _renderNetworktopoEventCorr(): TemplateResult {
    const rules = this._networkTopoCorrRules;
    const timeline = this._networkTopoEventTimeline;
    const fpMetrics = this._networkTopoFalsePosMetrics;
    return html`
  ...
  @state() private _networkTopoRiskTopTen: Array<{id:string;name:string;score:number;trend:string;owner:string;category:string;lastAssessed:string}> = [
  ...
  @state() private _networkTopoRiskCategories: Array<{category:string;count:number;avgScore:number;color:string}> = [
  ...
  @state() private _networkTopoRiskVelocity: Array<{week:string;newRisks:number;closedRisks:number;netChange:number}> = [
  ...
  @state() private _networkTopoRiskAppetite: {current:number;threshold:number;maxTolerated:number;status:string} = {
    current: 68, threshold: 55, maxTolerated: 80, status: 'Warning'
  };
  @state() private _networkTopoRiskOwnerMatrix: Array<{owner:string;criticalCount:number;highCount:number;mediumCount:number;complianceRate:number}> = [
  ...
  private _renderNetworktopoRiskDash(): TemplateResult {
    const riskItems = this._networkTopoRiskTopTen;
    const velocity = this._networkTopoRiskVelocity;
    const appetite = this._networkTopoRiskAppetite;
    return html`
  ...
  @state() private _networkTopoZones: Array<{id:string;name:string;trustLevel:number;subnet:string;devices:number;policy:string;lastAudit:string}> = [
  ...
  @state() private _networkTopoSegRules: Array<{id:string;source:string;dest:string;action:string;protocol:string;port:string;status:string;hits:number}> = [
  ...
  @state() private _networkTopoCrossZoneTraffic: Array<{source:string;dest:string;bytes:number;sessions:number;violations:number}> = [
  ...
  @state() private _networkTopoMicroSegGaps: Array<{id:string;zone:string;gapType:string;severity:string;recommendation:string}> = [
  ...
  private _renderNetworktopoNetworkSeg(): TemplateResult {
    const zones = this._networkTopoZones;
    const gaps = this._networkTopoMicroSegGaps;
    return html`
  ...
  @state() private _complianceCalendarEvents: Array<{id: string; title: string; deadline: string; category: string; status: string; assignee: string; notes: string}> = [
    {id: 'cc-network-topo-001', title: 'SOX Section 404 Compliance Review', deadline: '2026-06-30', category: 'Regulatory', status: 'In Progress', assignee: 'Compliance Team', notes: 'Annual internal control assessment for financial reporting'},
    {id: 'cc-network-topo-002', title: 'GDPR Data Protection Impact Assessment', deadline: '2026-05-15', category: 'Privacy', status: 'Pending', assignee: 'DPO Office', notes: 'Quarterly DPIA for high-risk processing activities'},
    {id: 'cc-network-topo-003', title: 'ISO 27001 Surveillance Audit', deadline: '2026-07-20', category: 'Certification', status: 'Scheduled', assignee: 'QA Lead', notes: 'Stage 2 surveillance audit for ISMS certification renewal'},
    {id: 'cc-network-topo-004', title: 'PCI DSS v4.0 Gap Analysis', deadline: '2026-05-30', category: 'Payment', status: 'Not Started', assignee: 'Security Architect', notes: 'Assess current state against PCI DSS v4.0 requirements'},
    {id: 'cc-network-topo-005', title: 'NIST CSF Self-Assessment', deadline: '2026-08-15', category: 'Framework', status: 'Pending', assignee: 'CISO', notes: 'Biannual self-assessment against NIST Cybersecurity Framework'},
    {id: 'cc-network-topo-006', title: 'HIPAA Security Rule Audit', deadline: '2026-06-15', category: 'Healthcare', status: 'In Progress', assignee: 'Compliance Analyst', notes: 'Annual audit of administrative, physical, and technical safeguards'},
    {id: 'cc-network-topo-007', title: 'SOC 2 Type II Report Renewal', deadline: '2026-09-30', category: 'Audit', status: 'Scheduled', assignee: 'External Auditor', notes: 'Engage auditor for SOC 2 Type II examination period'},
    {id: 'cc-network-topo-008', title: 'FedRAMP Authorization Review', deadline: '2026-07-01', category: 'Government', status: 'Pending', assignee: 'FedRAMP PMO', notes: 'Review and update security authorization package'},
    {id: 'cc-network-topo-009', title: 'Annual Penetration Test', deadline: '2026-10-15', category: 'Testing', status: 'Not Started', assignee: 'Red Team Lead', notes: 'Comprehensive external and internal penetration testing engagement'},
    {id: 'cc-network-topo-010', title: 'Security Awareness Training Rollout', deadline: '2026-05-01', category: 'Training', status: 'Completed', assignee: 'Security Awareness Manager', notes: 'Q2 organization-wide security awareness training program'},
    {id: 'cc-network-topo-011', title: 'Vendor Security Review Cycle', deadline: '2026-06-01', category: 'Third Party', status: 'In Progress', assignee: 'Vendor Manager', notes: 'Quarterly review of critical vendor security posture and SLA compliance'},
    {id: 'cc-network-topo-012', title: 'Incident Response Plan Update', deadline: '2026-05-20', category: 'Operations', status: 'Pending', assignee: 'IR Team Lead', notes: 'Update IR procedures based on lessons learned from recent incidents'},
  ];
  ...
  @state() private _dataQualityMetrics: Array<{id: string; dataSource: string; completenessScore: number; accuracyScore: number; timelinessScore: number; consistencyScore: number; reliabilityRank: number; lastUpdated: string; issues: string[]; trend: string}> = [
    {id: 'dq-network-topo-001', dataSource: 'Vulnerability Scanner Feed', completenessScore: 94, accuracyScore: 91, timelinessScore: 88, consistencyScore: 95, reliabilityRank: 1, lastUpdated: '2026-04-23T08:00:00Z', issues: ['Minor delay in Nessus plugin updates'], trend: 'improving'},
    {id: 'dq-network-topo-002', dataSource: 'SIEM Event Logs', completenessScore: 87, accuracyScore: 93, timelinessScore: 96, consistencyScore: 89, reliabilityRank: 2, lastUpdated: '2026-04-23T07:30:00Z', issues: ['Some log sources showing gaps in off-hours'], trend: 'stable'},
    {id: 'dq-network-topo-003', dataSource: 'Asset Inventory Database', completenessScore: 82, accuracyScore: 78, timelinessScore: 75, consistencyScore: 84, reliabilityRank: 4, lastUpdated: '2026-04-22T18:00:00Z', issues: ['Shadow IT devices not fully cataloged', 'Decommissioned assets still listed'], trend: 'declining'},
    {id: 'dq-network-topo-004', dataSource: 'Threat Intelligence Platform', completenessScore: 91, accuracyScore: 89, timelinessScore: 92, consistencyScore: 87, reliabilityRank: 3, lastUpdated: '2026-04-23T06:00:00Z', issues: ['Some IOC sources lack confidence scoring'], trend: 'improving'},
    {id: 'dq-network-topo-005', dataSource: 'Identity Provider Logs', completenessScore: 96, accuracyScore: 97, timelinessScore: 98, consistencyScore: 96, reliabilityRank: 1, lastUpdated: '2026-04-23T09:00:00Z', issues: [], trend: 'stable'},
    {id: 'dq-network-topo-006', dataSource: 'Cloud Security Posture Data', completenessScore: 79, accuracyScore: 85, timelinessScore: 82, consistencyScore: 81, reliabilityRank: 5, lastUpdated: '2026-04-23T05:00:00Z', issues: ['Multi-cloud coverage gaps', 'API rate limiting affects scan frequency'], trend: 'declining'},
    {id: 'dq-network-topo-007', dataSource: 'Compliance Evidence Store', completenessScore: 88, accuracyScore: 86, timelinessScore: 80, consistencyScore: 83, reliabilityRank: 4, lastUpdated: '2026-04-21T14:00:00Z', issues: ['Manual evidence collection delays', 'Inconsistent formatting across frameworks'], trend: 'stable'},
    {id: 'dq-network-topo-008', dataSource: 'Network Flow Data', completenessScore: 92, accuracyScore: 90, timelinessScore: 94, consistencyScore: 91, reliabilityRank: 2, lastUpdated: '2026-04-23T08:30:00Z', issues: ['Encrypted traffic classification accuracy needs improvement'], trend: 'improving'},
  ];
  ...
  @state() private _workflowTemplates: Array<{id: string; name: string; description: string; category: string; steps: number; avgDuration: string; successRate: number; lastRun: string; manualInterventions: number; optimizationScore: number}> = [
    {id: 'wf-network-topo-001', name: 'Vulnerability Triage Pipeline', description: 'Automated vulnerability assessment, prioritization, and assignment workflow', category: 'Vulnerability Management', steps: 8, avgDuration: '12 min', successRate: 94.5, lastRun: '2026-04-23T06:00:00Z', manualInterventions: 2, optimizationScore: 87},
    {id: 'wf-network-topo-002', name: 'Incident Response Orchestration', description: 'End-to-end IR workflow from detection to containment and recovery', category: 'Incident Response', steps: 15, avgDuration: '45 min', successRate: 89.2, lastRun: '2026-04-22T14:30:00Z', manualInterventions: 5, optimizationScore: 72},
    {id: 'wf-network-topo-003', name: 'Access Request Approval Chain', description: 'Multi-level approval workflow for privileged access requests', category: 'Identity & Access', steps: 6, avgDuration: '4 hours', successRate: 97.1, lastRun: '2026-04-23T09:15:00Z', manualInterventions: 1, optimizationScore: 92},
    {id: 'wf-network-topo-004', name: 'Compliance Evidence Collection', description: 'Automated gathering and packaging of audit evidence artifacts', category: 'Compliance', steps: 10, avgDuration: '30 min', successRate: 91.8, lastRun: '2026-04-21T10:00:00Z', manualInterventions: 3, optimizationScore: 78},
    {id: 'wf-network-topo-005', name: 'Security Patch Deployment', description: 'Staged patch rollout with validation and rollback capability', category: 'Patch Management', steps: 12, avgDuration: '2 hours', successRate: 96.3, lastRun: '2026-04-20T22:00:00Z', manualInterventions: 1, optimizationScore: 85},
    {id: 'wf-network-topo-006', name: 'Threat Intelligence Enrichment', description: 'IOC enrichment and correlation with internal threat data', category: 'Threat Intelligence', steps: 7, avgDuration: '8 min', successRate: 93.7, lastRun: '2026-04-23T07:00:00Z', manualInterventions: 0, optimizationScore: 95},
    {id: 'wf-network-topo-007', name: 'Security Reporting Pipeline', description: 'Automated generation and distribution of security metrics reports', category: 'Reporting', steps: 5, avgDuration: '15 min', successRate: 98.9, lastRun: '2026-04-23T08:00:00Z', manualInterventions: 0, optimizationScore: 97},
    {id: 'wf-network-topo-008', name: 'Vendor Risk Assessment', description: 'Automated vendor security questionnaire distribution and scoring', category: 'Third Party', steps: 9, avgDuration: '3 days', successRate: 85.4, lastRun: '2026-04-19T11:00:00Z', manualInterventions: 4, optimizationScore: 65},
  ];
  ...
  @state() private _workflowExecutionHistory: Array<{workflowId: string; runDate: string; duration: string; status: string; trigger: string}> = [
    {workflowId: 'wf-network-topo-001', runDate: '2026-04-23T06:00:00Z', duration: '11 min 23 sec', status: 'Success', trigger: 'Scheduled'},
    {workflowId: 'wf-network-topo-002', runDate: '2026-04-22T14:30:00Z', duration: '42 min 15 sec', status: 'Success', trigger: 'Alert'},
    {workflowId: 'wf-network-topo-003', runDate: '2026-04-23T09:15:00Z', duration: '3h 45 min', status: 'Success', trigger: 'User Request'},
    {workflowId: 'wf-network-topo-001', runDate: '2026-04-22T06:00:00Z', duration: '13 min 08 sec', status: 'Partial', trigger: 'Scheduled'},
    {workflowId: 'wf-network-topo-004', runDate: '2026-04-21T10:00:00Z', duration: '28 min 42 sec', status: 'Success', trigger: 'Scheduled'},
  ];
  ...
  @state() private _knowledgeArticles: Array<{id: string; title: string; category: string; author: string; publishDate: string; views: number; rating: number; tags: string[]; summary: string; readTime: string}> = [
    {id: 'kb-network-topo-001', title: 'Zero Trust Architecture Implementation Guide', category: 'Architecture', author: 'Security Architecture Team', publishDate: '2026-03-15', views: 1842, rating: 4.8, tags: ['zero-trust', 'network', 'identity'], summary: 'Comprehensive guide for implementing zero trust principles across enterprise infrastructure', readTime: '15 min'},
    {id: 'kb-network-topo-002', title: 'Ransomware Defense Playbook 2026', category: 'Threats', author: 'Threat Intelligence Team', publishDate: '2026-04-01', views: 2341, rating: 4.9, tags: ['ransomware', 'incident-response', 'defense'], summary: 'Updated playbook with latest ransomware tactics, techniques, and defensive measures', readTime: '12 min'},
    {id: 'kb-network-topo-003', title: 'Cloud Security Best Practices for Multi-Cloud', category: 'Cloud', author: 'Cloud Security Team', publishDate: '2026-02-28', views: 1567, rating: 4.5, tags: ['cloud', 'aws', 'azure', 'gcp'], summary: 'Best practices for securing workloads across multiple cloud service providers', readTime: '18 min'},
    {id: 'kb-network-topo-004', title: 'API Security Testing Methodology', category: 'Testing', author: 'Red Team', publishDate: '2026-03-22', views: 987, rating: 4.6, tags: ['api', 'testing', 'owasp'], summary: 'Structured methodology for identifying and testing API security vulnerabilities', readTime: '10 min'},
    {id: 'kb-network-topo-005', title: 'Supply Chain Security Risk Management', category: 'Third Party', author: 'GRC Team', publishDate: '2026-01-20', views: 1234, rating: 4.3, tags: ['supply-chain', 'vendor', 'risk'], summary: 'Framework for managing security risks in the software supply chain', readTime: '14 min'},
    {id: 'kb-network-topo-006', title: 'Kubernetes Security Hardening Checklist', category: 'Container', author: 'Platform Security', publishDate: '2026-04-10', views: 2103, rating: 4.7, tags: ['kubernetes', 'container', 'hardening'], summary: 'Step-by-step hardening checklist for production Kubernetes clusters', readTime: '11 min'},
    {id: 'kb-network-topo-007', title: 'Security Metrics That Matter for Executives', category: 'Metrics', author: 'CISO Office', publishDate: '2026-03-05', views: 876, rating: 4.4, tags: ['metrics', 'kpi', 'reporting'], summary: 'Key security metrics and KPIs that resonate with board-level stakeholders', readTime: '8 min'},
    {id: 'kb-network-topo-008', title: 'Phishing Simulation Campaign Design', category: 'Awareness', author: 'Security Awareness Team', publishDate: '2026-02-15', views: 1456, rating: 4.5, tags: ['phishing', 'simulation', 'training'], summary: 'Designing effective phishing simulations that drive real behavioral change', readTime: '9 min'},
    {id: 'kb-network-topo-009', title: 'Data Loss Prevention Strategy and Implementation', category: 'Data Protection', author: 'Data Security Team', publishDate: '2026-03-28', views: 1678, rating: 4.6, tags: ['dlp', 'data-protection', 'compliance'], summary: 'Strategic approach to DLP covering people, process, and technology layers', readTime: '16 min'},
    {id: 'kb-network-topo-010', title: 'Security Automation with SOAR Platforms', category: 'Automation', author: 'SOC Engineering', publishDate: '2026-04-05', views: 1098, rating: 4.7, tags: ['soar', 'automation', 'soc'], summary: 'Building effective security automation playbooks using SOAR technology', readTime: '13 min'},
    {id: 'kb-network-topo-011', title: 'Third-Party Risk Assessment Framework', category: 'GRC', author: 'Vendor Management', publishDate: '2026-01-30', views: 1345, rating: 4.4, tags: ['vendor', 'risk', 'assessment'], summary: 'Structured framework for evaluating and monitoring third-party security risks', readTime: '12 min'},
    {id: 'kb-network-topo-012', title: 'Network Detection and Response Best Practices', category: 'Network', author: 'Network Security Team', publishDate: '2026-03-18', views: 1567, rating: 4.5, tags: ['ndr', 'network', 'detection'], summary: 'Implementing effective network detection and response capabilities', readTime: '14 min'},
    {id: 'kb-network-topo-013', title: 'Security Chaos Engineering Guide', category: 'Resilience', author: 'SRE Security', publishDate: '2026-04-12', views: 789, rating: 4.3, tags: ['chaos-engineering', 'resilience', 'testing'], summary: 'Applying chaos engineering principles to validate security controls', readTime: '10 min'},
    {id: 'kb-network-topo-014', title: 'Incident Communication Templates', category: 'Incident Response', author: 'IR Team', publishDate: '2026-02-22', views: 2234, rating: 4.8, tags: ['incident', 'communication', 'templates'], summary: 'Ready-to-use communication templates for security incident scenarios', readTime: '7 min'},
    {id: 'kb-network-topo-015', title: 'Endpoint Detection and Response Configuration', category: 'Endpoint', author: 'Endpoint Security', publishDate: '2026-03-08', views: 1345, rating: 4.5, tags: ['edr', 'endpoint', 'configuration'], summary: 'Optimal EDR configuration for maximum detection with minimal false positives', readTime: '11 min'},
    {id: 'kb-network-topo-016', title: 'Security Code Review Standards', category: 'Development', author: 'AppSec Team', publishDate: '2026-02-10', views: 1890, rating: 4.6, tags: ['code-review', 'secure-sdlc', 'standards'], summary: 'Standards and checklists for security-focused code reviews', readTime: '13 min'},
    {id: 'kb-network-topo-017', title: 'IoT Security Assessment Methodology', category: 'IoT', author: 'IoT Security Lab', publishDate: '2026-04-08', views: 654, rating: 4.2, tags: ['iot', 'embedded', 'assessment'], summary: 'Methodology for assessing security posture of IoT devices and ecosystems', readTime: '15 min'},
    {id: 'kb-network-topo-018', title: 'Passwordless Authentication Migration Guide', category: 'Identity', author: 'IAM Team', publishDate: '2026-03-25', views: 1678, rating: 4.7, tags: ['passwordless', 'authentication', 'mfa'], summary: 'Step-by-step migration plan from password-based to passwordless authentication', readTime: '12 min'},
    {id: 'kb-network-topo-019', title: 'Security Awareness Program Metrics', category: 'Awareness', author: 'Security Culture Team', publishDate: '2026-01-25', views: 1123, rating: 4.4, tags: ['awareness', 'metrics', 'culture'], summary: 'Measuring the effectiveness of your security awareness and training programs', readTime: '9 min'},
    {id: 'kb-network-topo-020', title: 'Deception Technology Deployment Guide', category: 'Detection', author: 'Blue Team', publishDate: '2026-04-15', views: 876, rating: 4.5, tags: ['deception', 'honeypot', 'detection'], summary: 'Planning and deploying deception technology for advanced threat detection', readTime: '11 min'},
  ];
  ...
  // --- Security Scenario Planning Methods (NETO) ---
  private _initNetoScenarios(): void {
    const worstCaseScenarios = [
      { id: "neto-sc-01", name: "Ransomware Attack on Critical Infrastructure", category: "Malware", impact: 9500000, probability: 0.12, recoveryDays: 21, affectedSystems: 47, dataLossGb: 320, businessImpact: "critical" },
      { id: "neto-sc-02", name: "Insider Data Exfiltration via Authorized Channels", category: "Insider Threat", impact: 7200000, probability: 0.18, recoveryDays: 14, affectedSystems: 12, dataLossGb: 85, businessImpact: "high" },
      { id: "neto-sc-03", name: "Supply Chain Compromise via Third-Party Library", category: "Supply Chain", impact: 6800000, probability: 0.09, recoveryDays: 30, affectedSystems: 63, dataLossGb: 0, businessImpact: "critical" },
      { id: "neto-sc-04", name: "Cloud Misconfiguration Leading to Public Exposure", category: "Cloud", impact: 4100000, probability: 0.22, recoveryDays: 7, affectedSystems: 8, dataLossGb: 450, businessImpact: "high" },
      { id: "neto-sc-05", name: "Zero-Day Exploit in Core Application Framework", category: "Vulnerability", impact: 8900000, probability: 0.05, recoveryDays: 45, affectedSystems: 120, dataLossGb: 0, businessImpact: "critical" },
      { id: "neto-sc-06", name: "Distributed Denial of Service on Customer-Facing Services", category: "Availability", impact: 3400000, probability: 0.25, recoveryDays: 3, affectedSystems: 15, dataLossGb: 0, businessImpact: "medium" },
      { id: "neto-sc-07", name: "Credential Stuffing and Account Takeover Wave", category: "Identity", impact: 2800000, probability: 0.30, recoveryDays: 5, affectedSystems: 6, dataLossGb: 12, businessImpact: "medium" },
      { id: "neto-sc-08", name: "Physical Security Breach at Data Center Facility", category: "Physical", impact: 12000000, probability: 0.02, recoveryDays: 60, affectedSystems: 200, dataLossGb: 5000, businessImpact: "critical" },
    ];
    this._netoScenarios = worstCaseScenarios.map(s => ({ ...s, mitigationCost: Math.round(s.impact * 0.08), drillScheduled: false, lastDrillDate: null, drillScore: null, controlGaps: Math.floor(Math.random() * 5) + 1 }));
  }

  private _calculateNetoScenarioRisk(): void {
    this._netoScenarios.forEach(s => {
  ...
  private _scheduleNetoDrills(): void {
  ...
  private _netoScenarioComparison(): Record<string, unknown>[] {
    return this._netoScenarios.map(s => ({
  ...
  // --- Security Control Effectiveness Analytics (NETO) ---
  private _initNetoControls(): void {
    const controls = [
      { id: "neto-ct-01", name: "Network Segmentation", type: "preventive", maturity: "defined", score: 82, target: 90, failures: 3, lastTest: "2026-03-15" },
      { id: "neto-ct-02", name: "Endpoint Detection and Response", type: "detective", maturity: "managed", score: 88, target: 92, failures: 1, lastTest: "2026-04-01" },
      { id: "neto-ct-03", name: "Data Loss Prevention", type: "preventive", maturity: "repeatable", score: 71, target: 85, failures: 7, lastTest: "2026-03-22" },
      { id: "neto-ct-04", name: "Security Information and Event Management", type: "detective", maturity: "managed", score: 85, target: 90, failures: 2, lastTest: "2026-04-05" },
      { id: "neto-ct-05", name: "Identity and Access Management", type: "preventive", maturity: "defined", score: 76, target: 88, failures: 5, lastTest: "2026-03-28" },
      { id: "neto-ct-06", name: "Vulnerability Management", type: "corrective", maturity: "managed", score: 80, target: 90, failures: 4, lastTest: "2026-04-02" },
      { id: "neto-ct-07", name: "Email Security Gateway", type: "preventive", maturity: "managed", score: 90, target: 95, failures: 1, lastTest: "2026-04-08" },
      { id: "neto-ct-08", name: "Web Application Firewall", type: "preventive", maturity: "managed", score: 87, target: 92, failures: 2, lastTest: "2026-03-30" },
      { id: "neto-ct-09", name: "Patch Management", type: "corrective", maturity: "defined", score: 68, target: 85, failures: 9, lastTest: "2026-03-18" },
      { id: "neto-ct-10", name: "Encryption at Rest", type: "preventive", maturity: "managed", score: 93, target: 95, failures: 0, lastTest: "2026-04-10" },
      { id: "neto-ct-11", name: "Encryption in Transit", type: "preventive", maturity: "optimized", score: 96, target: 98, failures: 0, lastTest: "2026-04-12" },
      { id: "neto-ct-12", name: "Privileged Access Management", type: "preventive", maturity: "defined", score: 74, target: 88, failures: 6, lastTest: "2026-03-25" },
      { id: "neto-ct-13", name: "Security Awareness Training", type: "preventive", maturity: "repeatable", score: 65, target: 80, failures: 11, lastTest: "2026-03-20" },
      { id: "neto-ct-14", name: "Incident Response Plan", type: "corrective", maturity: "managed", score: 78, target: 88, failures: 4, lastTest: "2026-04-03" },
      { id: "neto-ct-15", name: "Backup and Recovery", type: "corrective", maturity: "managed", score: 84, target: 92, failures: 3, lastTest: "2026-04-06" },
      { id: "neto-ct-16", name: "Multi-Factor Authentication", type: "preventive", maturity: "managed", score: 91, target: 95, failures: 1, lastTest: "2026-04-09" },
      { id: "neto-ct-17", name: "Network Traffic Analysis", type: "detective", maturity: "defined", score: 72, target: 85, failures: 5, lastTest: "2026-03-27" },
      { id: "neto-ct-18", name: "Cloud Security Posture Management", type: "detective", maturity: "repeatable", score: 69, target: 82, failures: 8, lastTest: "2026-03-24" },
      { id: "neto-ct-19", name: "Container Security Scanning", type: "preventive", maturity: "defined", score: 75, target: 85, failures: 5, lastTest: "2026-04-04" },
      { id: "neto-ct-20", name: "API Security Gateway", type: "preventive", maturity: "repeatable", score: 70, target: 82, failures: 7, lastTest: "2026-03-29" },
      { id: "neto-ct-21", name: "Threat Intelligence Platform", type: "detective", maturity: "managed", score: 83, target: 90, failures: 2, lastTest: "2026-04-07" },
      { id: "neto-ct-22", name: "Database Activity Monitoring", type: "detective", maturity: "defined", score: 67, target: 80, failures: 8, lastTest: "2026-03-21" },
      { id: "neto-ct-23", name: "Deception Technology", type: "detective", maturity: "initial", score: 55, target: 75, failures: 12, lastTest: "2026-03-16" },
      { id: "neto-ct-24", name: "Security Orchestration Automation", type: "corrective", maturity: "repeatable", score: 73, target: 85, failures: 6, lastTest: "2026-04-01" },
      { id: "neto-ct-25", name: "Third-Party Risk Assessment", type: "preventive", maturity: "defined", score: 64, target: 78, failures: 9, lastTest: "2026-03-19" },
    ];
    this._netoControls = controls;
  }

  private _analyzeNetoControlEffectiveness(): void {
    const typeBreakdown: Record<string, { total: number; avgScore: number; avgFailures: number }> = {};
    this._netoControls.forEach(c => {
    ...
    this._netoControlTypeBreakdown = typeBreakdown;
  }

  private _netoControlOptimization(): Record<string, unknown>[] {
    return this._netoControls.filter(c => c.score < c.target).map(c => ({
  ...
  // --- Security Data Pipeline Health (NETO) ---
  private _initNetoPipelines(): void {
    const pipelines = [
      { id: "neto-pl-01", name: "SIEM Log Ingestion", status: "healthy", healthScore: 94, latencyMs: 120, freshnessMin: 2, errorRate: 0.02, throughputMbps: 450, recordsPerSec: 12000, backPressure: 0.05, uptime: 99.97 },
      { id: "neto-pl-02", name: "Threat Feed Aggregation", status: "healthy", healthScore: 91, latencyMs: 300, freshnessMin: 15, errorRate: 0.05, throughputMbps: 85, recordsPerSec: 3200, backPressure: 0.08, uptime: 99.92 },
      { id: "neto-pl-03", name: "Vulnerability Scan Results", status: "degraded", healthScore: 72, latencyMs: 2500, freshnessMin: 60, errorRate: 0.15, throughputMbps: 25, recordsPerSec: 800, backPressure: 0.35, uptime: 98.50 },
      { id: "neto-pl-04", name: "Endpoint Telemetry Stream", status: "healthy", healthScore: 88, latencyMs: 450, freshnessMin: 5, errorRate: 0.08, throughputMbps: 280, recordsPerSec: 8500, backPressure: 0.12, uptime: 99.85 },
      { id: "neto-pl-05", name: "Cloud Audit Log Pipeline", status: "healthy", healthScore: 86, latencyMs: 600, freshnessMin: 10, errorRate: 0.06, throughputMbps: 150, recordsPerSec: 4500, backPressure: 0.10, uptime: 99.80 },
      { id: "neto-pl-06", name: "Identity Event Stream", status: "warning", healthScore: 78, latencyMs: 1200, freshnessMin: 20, errorRate: 0.12, throughputMbps: 45, recordsPerSec: 1500, backPressure: 0.22, uptime: 99.40 },
      { id: "neto-pl-07", name: "Network Flow Collection", status: "healthy", healthScore: 82, latencyMs: 800, freshnessMin: 8, errorRate: 0.09, throughputMbps: 650, recordsPerSec: 18000, backPressure: 0.15, uptime: 99.70 },
      { id: "neto-pl-08", name: "DLP Incident Pipeline", status: "degraded", healthScore: 68, latencyMs: 3500, freshnessMin: 45, errorRate: 0.20, throughputMbps: 18, recordsPerSec: 500, backPressure: 0.42, uptime: 97.80 },
    ];
    this._netoPipelines = pipelines.map(p => ({ ...p, dependencies: [], slaBreached: p.healthScore < 75, alertThreshold: p.errorRate > 0.15 }));
    this._netoPipelines[0].dependencies = ["neto-pl-04", "neto-pl-07"];
    this._netoPipelines[4].dependencies = ["neto-pl-01"];
    this._netoPipelines[5].dependencies = ["neto-pl-02"];
    this._netoPipelines[7].dependencies = ["neto-pl-04", "neto-pl-05"];
  }

  private _netoPipelineTrend(): Record<string, unknown>[] {
    const hours = Array.from({ length: 24 }, (_, i) => `H${String(i).padStart(2, "0")}`);
    return this._netoPipelines.map(p => ({
  ...
  // --- Security Stakeholder Report Generator (NETO) ---
  private _initNetoReportTemplates(): void {
    this._netoReportTemplates = [
      { id: "neto-rp-01", name: "Board Security Report", audience: "board", frequency: "quarterly", sections: 6, autoGenerate: true, lastGenerated: "2026-03-31", pages: 12 },
      { id: "neto-rp-02", name: "Executive Risk Summary", audience: "executive", frequency: "monthly", sections: 8, autoGenerate: true, lastGenerated: "2026-04-01", pages: 8 },
      { id: "neto-rp-03", name: "Technical Security Review", audience: "technical", frequency: "weekly", sections: 12, autoGenerate: true, lastGenerated: "2026-04-21", pages: 25 },
      { id: "neto-rp-04", name: "Audit Compliance Report", audience: "audit", frequency: "quarterly", sections: 10, autoGenerate: false, lastGenerated: "2026-03-15", pages: 35 },
      { id: "neto-rp-05", name: "Regulatory Filing Package", audience: "regulatory", frequency: "annual", sections: 15, autoGenerate: false, lastGenerated: "2025-12-31", pages: 48 },
    ];
  }

  private _generateNetoExecSummary(): string {
    const totalRisk = this._netoScenarios.reduce((sum: number, s: any) => sum + s.riskScore, 0);
    const avgControl = Math.round(this._netoControls.reduce((sum: number, c: any) => sum + c.score, 0) / this._netoControls.length);
    const degradedPipes = this._netoPipelines.filter((p: any) => p.status !== "healthy").length;
    return `Overall risk exposure: ${(totalRisk / 1000000).toFixed(1)}M. Average control effectiveness: {avgControl}%. {degradedPipes} pipeline(s) need attention. {this._netoScenarios.filter((s: any) => s.mitigationPriority === "immediate").length} scenarios require immediate action.`;
  }

  // --- Security Technology Radar (NETO) ---
  private _initNetoTechRadar(): void {
    this._netoTechRadar = [
      { id: "neto-tr-01", name: "AI-Powered Threat Detection", ring: "adopt", category: "Detection", maturity: 4, trend: "up", investment: "high", roi: 3.2, vendorCount: 8 },
      { id: "neto-tr-02", name: "Zero Trust Architecture", ring: "adopt", category: "Architecture", maturity: 4, trend: "up", investment: "high", roi: 2.8, vendorCount: 12 },
      { id: "neto-tr-03", name: "SASE/SSE Platform", ring: "trial", category: "Network", maturity: 3, trend: "up", investment: "medium", roi: 2.4, vendorCount: 10 },
      { id: "neto-tr-04", name: "CNAPP Cloud Security", ring: "trial", category: "Cloud", maturity: 3, trend: "up", investment: "medium", roi: 2.1, vendorCount: 7 },
      { id: "neto-tr-05", name: "Extended Detection and Response", ring: "adopt", category: "Detection", maturity: 4, trend: "stable", investment: "high", roi: 2.9, vendorCount: 9 },
      { id: "neto-tr-06", name: "Quantum-Safe Cryptography", ring: "assess", category: "Crypto", maturity: 2, trend: "up", investment: "low", roi: 0.8, vendorCount: 4 },
      { id: "neto-tr-07", name: "Security Service Edge", ring: "trial", category: "Network", maturity: 3, trend: "up", investment: "medium", roi: 2.0, vendorCount: 6 },
      { id: "neto-tr-08", name: "SOAR 2.0 Autonomous SOC", ring: "assess", category: "Operations", maturity: 2, trend: "up", investment: "low", roi: 1.2, vendorCount: 5 },
      { id: "neto-tr-09", name: "Software Supply Chain Security", ring: "trial", category: "DevSecOps", maturity: 3, trend: "up", investment: "medium", roi: 2.3, vendorCount: 8 },
      { id: "neto-tr-10", name: "Identity Threat Detection", ring: "adopt", category: "Identity", maturity: 3, trend: "up", investment: "high", roi: 2.7, vendorCount: 7 },
      { id: "neto-tr-11", name: "Data Security Posture Management", ring: "trial", category: "Data", maturity: 3, trend: "up", investment: "medium", roi: 2.2, vendorCount: 9 },
      { id: "neto-tr-12", name: "Decentralized Identity Standards", ring: "hold", category: "Identity", maturity: 1, trend: "stable", investment: "low", roi: 0.5, vendorCount: 3 },
    ];
  }

  private _netoRadarSummary(): Record<string, unknown> {
    const rings: Record<string, number> = { adopt: 0, trial: 0, assess: 0, hold: 0 };
    this._netoTechRadar.forEach(t => { if (rings[t.ring as keyof typeof rings] !== undefined) rings[t.ring as keyof typeof rings]++; });
    return { adopt: rings.adopt, trial: rings.trial, assess: rings.assess, hold: rings.hold, total: this._netoTechRadar.length, avgMaturity: 2.8, topInvestment: this._netoTechRadar.filter(t => t.investment === "high").map(t => t.name) };
  }

  // --- NETO Security Compliance Mapping Matrix ---
  private _initNetoComplianceMatrix(): void {
    ...
    this._netoComplianceMatrix = frameworks.map(fw => ({
  ...
  private _netoComplianceTrend(): Record<string, unknown>[] {
    const quarters = ["Q1-2025", "Q2-2025", "Q3-2025", "Q4-2025", "Q1-2026", "Q2-2026"];
    return this._netoComplianceMatrix.map(fw => ({
  ...
  // --- NETO Threat Intelligence Correlation Engine ---
  private _initNetoThreatIntel(): void {
    ...
    this._netoThreatIntel = threatActors.map((actor, i) => ({
  ...
  private _netoThreatCorrelation(): Record<string, unknown>[] {
    return this._netoThreatIntel.filter(t => t.riskScore > 70).map(t => ({
  ...
  // --- NETO Security Metrics Deep Dive ---
  private _initNetoMetricsDeep(): void {
    ...
    this._netoMetricsDeep = metricCategories.map(cat => ({
  ...
  private _netoMetricsHeatmap(): number[][] {
    return this._netoMetricsDeep.map(cat =>
      cat.metrics.map(m => Math.round((m.value / m.target) * 100))
    );
  }

  // --- NETO Incident Cost Modeling ---
  private _initNetoCostModel(): void {
    const incidentTypes = ["Data Breach", "Ransomware", "DDoS", "Insider Threat", "Phishing", "Supply Chain", "Cloud Misconfig", "Zero-Day"];
    this._netoCostModel = incidentTypes.map(inc => ({
    ...
    this._netoCostModel.forEach(m => { m.totalAnnualExposure = m.avgCost * m.frequency; });
  }

  private _netoCostProjection(): Record<string, unknown>[] {
    return this._netoCostModel.map(m => ({
  ...
  // --- NETO Security Architecture Pattern Library ---
  private _initNetoArchPatterns(): void {
    ...
    this._netoArchPatterns = patterns.map((p, i) => ({
  ...
  private _netoArchPatternAnalysis(): Record<string, unknown> {
    const implemented = this._netoArchPatterns.filter(p => p.implementation > 75).length;
    const avgCoverage = Math.round(this._netoArchPatterns.reduce((s: number, p: any) => s + p.coverage, 0) / this._netoArchPatterns.length);
    return {
      totalPatterns: this._netoArchPatterns.length, fullyImplemented: implemented, avgCoverage,
      avgRiskReduction: Math.round(this._netoArchPatterns.reduce((s: number, p: any) => s + p.riskReduction, 0) / this._netoArchPatterns.length),
      gaps: this._netoArchPatterns.filter(p => p.implementation < 60).map(p => p.pattern),
      recommendations: this._netoArchPatterns.filter(p => p.implementation < 70).map(p => ({ pattern: p.pattern, current: p.implementation, target: 85, effort: p.costComplexity }))
    };
  }
  ...
  private _51eRiskAssessmentWorkflow = [
  ...
  private _51eTalentPositions = [
    ...
    {id: '51e-H-002', title: 'Cloud Security Engineer', dept: 'Cloud Security', level: 'Mid-Senior', loc: 'SF/Remote', salary: '$155K-$180K', posted: '2026-03-20', applicants: 45, pipeline: 12, interviews: 6, offers: 2, urgency: 'high' as const, manager: 'Mike Johnson', skills: ['AWS/Azure/GCP', 'Terraform', 'Kubernetes', 'IAM', 'CSPM'], nice: ['CCSP', 'CKS', 'Serverless']},
    {id: '51e-H-003', title: 'SOC Analyst L2', dept: 'Security Operations', level: 'Mid', loc: 'Austin TX', salary: '$105K-$130K', posted: '2026-04-01', applicants: 67, pipeline: 18, interviews: 8, offers: 0, urgency: 'medium' as const, manager: 'Lisa Park', skills: ['SIEM', 'Incident triage', 'Malware analysis', 'TCP/IP'], nice: ['GCIA', 'SOAR', 'Kill chain']},
    ...
    {id: '51e-H-005', title: 'GRC Analyst', dept: 'GRC', level: 'Mid', loc: 'NY/Remote', salary: '$110K-$135K', posted: '2026-04-05', applicants: 34, pipeline: 9, interviews: 3, offers: 1, urgency: 'medium' as const, manager: 'Rachel Green', skills: ['ISO 27001', 'SOC 2', 'Risk assessment', 'Audit'], nice: ['CRISC', 'CISA', 'GDPR']},
    {id: '51e-H-006', title: 'Threat Intel Analyst', dept: 'Threat Intel', level: 'Mid-Senior', loc: 'Remote US', salary: '$140K-$170K', posted: '2026-03-25', applicants: 19, pipeline: 5, interviews: 2, offers: 0, urgency: 'low' as const, manager: 'James Wilson', skills: ['MITRE ATT&CK', 'OSINT', 'Threat modeling', 'Reverse eng'], nice: ['CTIA', 'Nation-state', 'Dark web']},
    {id: '51e-H-007', title: 'AppSec Engineer', dept: 'AppSec', level: 'Senior', loc: 'Seattle/Remote', salary: '$160K-$190K', posted: '2026-04-10', applicants: 28, pipeline: 7, interviews: 3, offers: 0, urgency: 'medium' as const, manager: 'Emily Zhang', skills: ['SAST/DAST/SCA', 'Secure SDLC', 'Code review', 'CI/CD'], nice: ['CSSLP', 'Mobile security']},
    {id: '51e-H-008', title: 'IAM Engineer', dept: 'IAM', level: 'Mid', loc: 'Remote US', salary: '$135K-$160K', posted: '2026-04-08', applicants: 31, pipeline: 10, interviews: 5, offers: 1, urgency: 'medium' as const, manager: 'Chris Martinez', skills: ['Okta/Azure AD', 'SAML/OIDC', 'PAM', 'RBAC'], nice: ['CISSP', 'Zero trust IAM']}
  ];

  private _51eInterviewScorecard = [
  ...
  private _51eOnboardingSteps = [
    {id: '51e-OB-01', item: 'Provision security-hardened laptop, monitors, peripherals, and configured workstation image with all required security tools', cat: 'IT Setup', day: 'Day 1', owner: 'IT Operations'},
    {id: '51e-OB-02', item: 'Create AD account, email, Slack, VPN, SSO enrollment, and all required application access accounts', cat: 'Access', day: 'Day 1', owner: 'IAM Team'},
    {id: '51e-OB-03', item: 'Grant security tooling access: SIEM console, EDR dashboard, vuln scanner, pentest platforms, SOAR', cat: 'Tools', day: 'Day 1-2', owner: 'SOC Manager'},
    {id: '51e-OB-04', item: 'Complete MFA enrollment, security awareness onboarding course, and acceptable use policy acknowledgment', cat: 'Security', day: 'Day 1', owner: 'Awareness Team'},
    {id: '51e-OB-05', item: 'Sign NDA, employment agreement, IP assignment, and code of conduct documents with HR', cat: 'HR', day: 'Day 1', owner: 'Human Resources'},
    {id: '51e-OB-06', item: 'Introduction meetings with direct team members and key cross-functional stakeholders', cat: 'Integration', day: 'Week 1', owner: 'Hiring Manager'},
    {id: '51e-OB-07', item: 'Security architecture overview, tooling walkthrough, and operational runbook review sessions', cat: 'Training', day: 'Week 1-2', owner: 'Security Architect'},
    {id: '51e-OB-08', item: 'Shadow experienced team member on active incident response and threat hunting investigations', cat: 'Mentoring', day: 'Week 2-3', owner: 'SOC Lead'},
    {id: '51e-OB-09', item: 'Set up individual certification study plan aligned with role requirements and career goals', cat: 'Development', day: 'Week 2', owner: 'Hiring Manager'},
    {id: '51e-OB-10', item: 'Establish 30-60-90 day goals, define success metrics, and schedule first performance checkpoint', cat: 'Goals', day: 'Week 1', owner: 'Hiring Manager'}
  ];

  private _51eMetricsDashboard = [
  ...
  private _51eArchReview = [
    {id: '51e-AR-001', cat: 'Network', item: 'Network segmentation between trust zones with dedicated firewalls and granular ACLs', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Micro-segmentation via NSX across all production zones'},
    {id: '51e-AR-002', cat: 'Network', item: 'DMZ architecture isolating public services from internal network', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Dual-firewall DMZ with WAF and DDoS mitigation'},
    {id: '51e-AR-003', cat: 'Network', item: 'Least-privilege traffic flows with deny-by-default and quarterly review', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Explicit allow rules with automated drift detection'},
    {id: '51e-AR-004', cat: 'Network', item: 'Encrypted external communications with IPSec/TLS 1.3 and PFS', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'IKEv2 with PFS, TLS 1.3 for all external APIs'},
    {id: '51e-AR-005', cat: 'Identity', item: 'Centralized IdP with SSO and automated SCIM provisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Okta SSO SAML 2.0 for 247 apps with SCIM'},
    {id: '51e-AR-006', cat: 'Identity', item: 'RBAC with quarterly reviews and automated deprovisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Quarterly recertification with JIT admin access'},
    {id: '51e-AR-007', cat: 'Identity', item: 'PAM controlling all admin and service accounts with session recording', sev: 'high' as const, status: 'fail' as const, reviewer: 'IAM Lead', notes: '3 legacy accounts pending CyberArk enrollment'},
    {id: '51e-AR-008', cat: 'Identity', item: 'MFA enforced for all users, hardware tokens for privileged access', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'FIDO2 for admins, push MFA for users, 99.8% enrollment'},
    {id: '51e-AR-009', cat: 'Data', item: 'Data classification enforced with automated labeling on all repos', sev: 'high' as const, status: 'partial' as const, reviewer: 'Data Protection Lead', notes: 'Framework deployed, gaps on 4 legacy file shares'},
    {id: '51e-AR-010', cat: 'Data', item: 'AES-256 encryption at rest for all sensitive data stores', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'Full-disk, TDE on DBs, SSE-KMS on cloud storage'},
    {id: '51e-AR-011', cat: 'Data', item: 'DLP monitoring and preventing unauthorized data exfiltration', sev: 'high' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'DLP active on email, endpoint, cloud, and network'},
    {id: '51e-AR-012', cat: 'Data', item: 'Encrypted off-site backups with quarterly restore testing', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Infrastructure Lead', notes: '3-2-1 strategy with immutable backups'},
    {id: '51e-AR-013', cat: 'AppSec', item: 'Secure SDLC with SAST, DAST, SCA in all CI/CD pipelines', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: '34 pipelines with security gates and PR blocking'},
    {id: '51e-AR-014', cat: 'AppSec', item: 'API gateway with auth, rate limiting, schema validation', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: 'Kong with OAuth2, rate limits, OpenAPI validation'},
    {id: '51e-AR-015', cat: 'AppSec', item: 'Container security with image scanning and runtime protection', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Trivy scanning, Falco runtime in 80% of clusters'},
    {id: '51e-AR-016', cat: 'Monitoring', item: 'SIEM collecting from all critical systems with correlation rules', sev: 'critical' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'Splunk 98% coverage with 1200+ correlation rules'},
    {id: '51e-AR-017', cat: 'Monitoring', item: 'EDR with behavioral detection on all managed endpoints', sev: 'high' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'CrowdStrike on 99.2% endpoints with 24/7 MDR'},
    {id: '51e-AR-018', cat: 'Monitoring', item: 'Executive dashboards with real-time posture visibility', sev: 'medium' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'PowerBI dashboards with weekly exec summaries'},
    {id: '51e-AR-019', cat: 'Cloud', item: 'CSPM monitoring and remediating cloud misconfigurations', sev: 'high' as const, status: 'pass' as const, reviewer: 'Cloud Security Lead', notes: 'Prisma Cloud 450+ checks with auto-remediation'},
    {id: '51e-AR-020', cat: 'Cloud', item: 'IaC templates scanned before deployment to production', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Checkov for Terraform, cfn-nag for CloudFormation pending'}
  ];

  private _get51eRiskProgress(): number {
    return Math.round(this._51eRiskAssessmentWorkflow.filter(s => s.status === 'completed').length / this._51eRiskAssessmentWorkflow.length * 100);
  }

  private _get51eTreatmentSummary(): {total: number; approved: number; avgReduction: number; investment: string} {
    const a = this._51eTreatmentOptions.filter(r => r.status === 'approved').length;
    const avg = this._51eTreatmentOptions.reduce((s, r) => s + ((r.before - r.after) / r.before * 100), 0) / this._51eTreatmentOptions.length;
    return {total: this._51eTreatmentOptions.length, approved: a, avgReduction: Math.round(avg), investment: '$1.125M annually'};
  }

  private _get51eRuleSummary(): {total: number; passing: number; failing: number; avgRate: number; violations: number} {
    const p = this._51eComplianceRules.filter(r => r.result === 'pass').length;
    const f = this._51eComplianceRules.filter(r => r.result === 'fail').length;
    const avg = this._51eComplianceRules.reduce((s, r) => s + r.passRate, 0) / this._51eComplianceRules.length;
    const v = this._51eComplianceRules.reduce((s, r) => s + r.violations, 0);
    return {total: this._51eComplianceRules.length, passing: p, failing: f, avgRate: Math.round(avg * 10) / 10, violations: v};
  }

  private _get51ePipelineStats(): {positions: number; applicants: number; interviewing: number; offers: number; critical: number} {
    const t = this._51eTalentPositions.length;
    const a = this._51eTalentPositions.reduce((s, p) => s + p.applicants, 0);
    const i = this._51eTalentPositions.reduce((s, p) => s + p.interviews, 0);
    const o = this._51eTalentPositions.reduce((s, p) => s + p.offers, 0);
    const c = this._51eTalentPositions.filter(x => x.urgency === 'critical').length;
    return {positions: t, applicants: a, interviewing: i, offers: o, critical: c};
  }

  private _get51eMetricTrends(): {improving: number; stable: number; total: number} {
    const imp = this._51eMetricsDashboard.filter(m => m.trend === 'improving').length;
    const stb = this._51eMetricsDashboard.filter(m => m.trend === 'stable').length;
    return {improving: imp, stable: stb, total: this._51eMetricsDashboard.length};
  }

  private _get51eArchScore(): {total: number; passed: number; failed: number; partial: number; score: number} {
    const p = this._51eArchReview.filter(c => c.status === 'pass').length;
    const f = this._51eArchReview.filter(c => c.status === 'fail').length;
    const pa = this._51eArchReview.filter(c => c.status === 'partial').length;
    return {total: this._51eArchReview.length, passed: p, failed: f, partial: pa, score: Math.round((p / this._51eArchReview.length) * 100)};
  }


  private _z51eIncidentScenarios = [
    {id: 'z51e-IS-001', name: 'Ransomware Outbreak in Production Environment', category: 'Malware', likelihood: 'Medium', impact: 'Critical', riskScore: 15, playbooks: ['IR-Ransomware-Isolate', 'IR-Ransomware-Eradicate', 'IR-Ransomway-Recover'], estimatedMTTD: '15min', estimatedMTTR: '4h', involvedTeams: ['SOC', 'IR', 'Infrastructure', 'Legal', 'Comms'], keyIndicators: ['Mass file encryption events', 'Ransom note deployment', 'Lateral movement via SMB/RDP', 'Backup deletion attempts'], mitigationControls: ['EDR behavioral detection', 'Network segmentation', 'Immutable backups', 'Email filtering'], lessonsLearned: 'Ensure offline backups are tested quarterly and Ransomware-specific playbooks are updated with latest threat intelligence', lastDrillDate: '2026-03-15', nextDrillDate: '2026-06-15'},
    {id: 'z51e-IS-002', name: 'Cloud Misconfiguration Leading to Data Exposure', category: 'Cloud', likelihood: 'High', impact: 'High', riskScore: 16, playbooks: ['IR-Cloud-Misconfig-Assess', 'IR-Cloud-Misconfig-Remediate', 'IR-Cloud-Misconfig-Notify'], estimatedMTTD: '2h', estimatedMTTR: '6h', involvedTeams: ['Cloud Security', 'SOC', 'Data Protection', 'Legal'], keyIndicators: ['Public S3 bucket exposure', 'Overly permissive IAM policies', 'Unencrypted database snapshots', 'Public API endpoint discovery'], mitigationControls: ['CSPM monitoring', 'IAM policy analyzer', 'Automated remediation', 'Cloud audit logging'], lessonsLearned: 'Implement CSPM with auto-remediation for common misconfigurations and conduct monthly cloud configuration reviews', lastDrillDate: '2026-02-20', nextDrillDate: '2026-05-20'},
    {id: 'z51e-IS-003', name: 'Insider Threat Data Exfiltration', category: 'Insider', likelihood: 'Low', impact: 'Critical', riskScore: 12, playbooks: ['IR-Insider-Investigate', 'IR-Insider-Contain', 'IR-Insider-Escalate'], estimatedMTTD: '8h', estimatedMTTR: '24h', involvedTeams: ['SOC', 'IR', 'HR', 'Legal', 'IAM'], keyIndicators: ['Anomalous data access patterns', 'Large file downloads to USB or cloud', 'Off-hours access to sensitive systems', 'Accessing data outside normal job scope'], mitigationControls: ['UEBA analytics', 'DLP policies', 'PAM controls', 'Access reviews'], lessonsLearned: 'Strengthen UEBA baselines and implement automated alerts for data access pattern anomalies', lastDrillDate: '2026-01-10', nextDrillDate: '2026-04-10'},
    {id: 'z51e-IS-004', name: 'Supply Chain Attack via Compromised Vendor Software', category: 'Supply Chain', likelihood: 'Low', impact: 'Critical', riskScore: 12, playbooks: ['IR-SupplyChain-Detect', 'IR-SupplyChain-Isolate', 'IR-SupplyChain-Remediate'], estimatedMTTD: '24h', estimatedMTTR: '72h', involvedTeams: ['SOC', 'IR', 'Procurement', 'Vendor Mgmt', 'Legal'], keyIndicators: ['Unexpected network connections from vendor software', 'Modified binaries or dependencies', 'Anomalous behavior from trusted applications', 'SBOM discrepancy alerts'], mitigationControls: ['SCA scanning', 'SBOM monitoring', 'Vendor security assessments', 'Network segmentation'], lessonsLearned: 'Require SBOM from all vendors and implement continuous monitoring of third-party component behavior', lastDrillDate: '2026-03-01', nextDrillDate: '2026-06-01'},
    {id: 'z51e-IS-005', name: 'Credential Stuffing Attack on Customer Portal', category: 'External Attack', likelihood: 'High', impact: 'Medium', riskScore: 12, playbooks: ['IR-CredentialStuffing-Detect', 'IR-CredentialStuffing-Block', 'IR-CredentialStuffing-Notify'], estimatedMTTD: '30min', estimatedMTTR: '2h', involvedTeams: ['SOC', 'AppSec', 'Customer Support', 'Comms'], keyIndicators: ['High volume of failed login attempts', 'Login attempts from known compromised credential lists', 'Unusual geographic distribution of login attempts', 'Account takeover indicators'], mitigationControls: ['WAF rate limiting', 'CAPTCHA on login', 'MFA enforcement', 'Credential monitoring service'], lessonsLearned: 'Deploy advanced bot detection on login endpoints and implement proactive credential monitoring for customer accounts', lastDrillDate: '2026-04-01', nextDrillDate: '2026-07-01'},
    {id: 'z51e-IS-006', name: 'Phishing Campaign Targeting Executive Team', category: 'Social Engineering', likelihood: 'High', impact: 'High', riskScore: 16, playbooks: ['IR-Phishing-Contain', 'IR-Phishing-Investigate', 'IR-Phishing-Notify'], estimatedMTTD: '1h', estimatedMTTR: '4h', involvedTeams: ['SOC', 'Awareness', 'Executive Office', 'IT'], keyIndicators: ['Sophisticated spear-phishing emails to C-suite', 'Business email compromise indicators', 'Redirected MFA approval requests', 'Unauthorized wire transfer attempts'], mitigationControls: ['AI email filtering', 'Executive awareness training', 'Out-of-band verification policy', 'DMARC/DKIM/SPF'], lessonsLearned: 'Implement additional email security controls for executive mailboxes and conduct monthly spear-phishing simulations', lastDrillDate: '2026-02-15', nextDrillDate: '2026-05-15'}
  ];

  private _z51eSecurityFrameworks = [
  ...
  private _getz51eScenarioSummary(): {total: number; critical: number; high: number; drilled: number; avgRiskScore: number} {
    const crit = this._z51eIncidentScenarios.filter(s => s.impact === 'Critical').length;
    const high = this._z51eIncidentScenarios.filter(s => s.impact === 'High').length;
    const avg = this._z51eIncidentScenarios.reduce((s, x) => s + x.riskScore, 0) / this._z51eIncidentScenarios.length;
    return {total: this._z51eIncidentScenarios.length, critical: crit, high: high, drilled: this._z51eIncidentScenarios.length, avgRiskScore: Math.round(avg)};
  }

  private _getz51eVendorRiskSummary(): {total: number; approved: number; conditional: number; remediation: number; avgScore: number} {
    const approved = this._z51eThirdPartyRiskData.filter(v => v.status === 'approved').length;
    const cond = this._z51eThirdPartyRiskData.filter(v => v.status === 'conditional').length;
    const rem = this._z51eThirdPartyRiskData.filter(v => v.status === 'remediation_required').length;
    const avg = this._z51eThirdPartyRiskData.reduce((s, v) => s + v.riskScore, 0) / this._z51eThirdPartyRiskData.length;
    return {total: this._z51eThirdPartyRiskData.length, approved, conditional: cond, remediation: rem, avgScore: Math.round(avg)};
  }

  private _getz51eTrainingSummary(): {total: number; avgCompletion: number; avgScore: number; overdueUpdates: number} {
    const avgComp = this._z51eSecurityTrainingCatalog.reduce((s, t) => s + t.completionRate, 0) / this._z51eSecurityTrainingCatalog.length;
    const avgScore = this._z51eSecurityTrainingCatalog.filter(t => t.avgScore > 0).reduce((s, t) => s + t.avgScore, 0) / this._z51eSecurityTrainingCatalog.filter(t => t.avgScore > 0).length;
    return {total: this._z51eSecurityTrainingCatalog.length, avgCompletion: Math.round(avgComp * 10) / 10, avgScore: Math.round(avgScore), overdueUpdates: 0};
  }

  private _getz51eToolHealthSummary(): {total: number; healthy: number; degraded: number; annualCost: string} {
    const healthy = this._z51eSecurityToolInventory.filter(t => t.health === 'healthy').length;
    const degraded = this._z51eSecurityToolInventory.filter(t => t.health === 'degraded').length;
    const cost = this._z51eSecurityToolInventory.reduce((s, t) => s + parseInt(t.annualCost.replace(/[^0-9]/g, '')), 0);
    return {total: this._z51eSecurityToolInventory.length, healthy, degraded, annualCost: '$' + (cost / 1000).toFixed(0) + 'K'};
  }


  private _x51eSecurityZones = [
    {zoneId: 'x51e-Z-001', name: 'Internet DMZ', trustLevel: 'Untrusted', subnet: '10.0.0.0/24', segmentation: 'Dual-firewall', firewallRules: 45, monitoring: 'Full packet capture', assets: ['Web servers', 'Load balancers', 'WAF appliances', 'Reverse proxy'], riskLevel: 'high' as const, lastAssessment: '2026-04-15', nextAssessment: '2026-07-15'},
    {zoneId: 'x51e-Z-002', name: 'Corporate Network', trustLevel: 'Trusted', subnet: '10.1.0.0/16', segmentation: 'VLAN + micro-seg', firewallRules: 128, monitoring: 'NetFlow + IDS', assets: ['Workstations', 'Printers', 'Meeting room systems', 'VoIP phones'], riskLevel: 'medium' as const, lastAssessment: '2026-04-10', nextAssessment: '2026-07-10'},
    {zoneId: 'x51e-Z-003', name: 'Production Data Center', trustLevel: 'Restricted', subnet: '10.2.0.0/16', segmentation: 'Full micro-segmentation', firewallRules: 256, monitoring: 'Full packet capture + EDR', assets: ['Application servers', 'Database clusters', 'Message queues', 'API gateways'], riskLevel: 'low' as const, lastAssessment: '2026-04-12', nextAssessment: '2026-07-12'},
    {zoneId: 'x51e-Z-004', name: 'Management Network', trustLevel: 'Restricted', subnet: '10.3.0.0/24', segmentation: 'Isolated VLAN', firewallRules: 32, monitoring: 'Syslog + SNMP', assets: ['Hypervisors', 'Switch management', 'Storage controllers', 'Backup appliances'], riskLevel: 'low' as const, lastAssessment: '2026-04-08', nextAssessment: '2026-07-08'},
    {zoneId: 'x51e-Z-005', name: 'Cloud Production', trustLevel: 'Restricted', subnet: 'VPC: 172.16.0.0/12', segmentation: 'Security groups + NACLs', firewallRules: 189, monitoring: 'VPC Flow Logs + GuardDuty', assets: ['Kubernetes clusters', 'Managed databases', 'Object storage', 'Serverless functions'], riskLevel: 'medium' as const, lastAssessment: '2026-04-18', nextAssessment: '2026-07-18'}
  ];

  private _x51eSecurityAlerts = [
    {id: 'x51e-AL-001', severity: 'critical', title: 'Active ransomware encryption detected on PROD-DB-01', source: 'CrowdStrike', timestamp: '2026-04-22T13:45:00Z', status: 'investigating', assignee: 'SOC Analyst J. Smith', asset: 'PROD-DB-01 (10.2.1.15)', mitreTechnique: 'T1486 - Data Encrypted for Impact', playbook: 'IR-Ransomware-Isolate', sla: '15 minutes', elapsed: '12 minutes', notes: 'EDR detected mass file encryption event pattern. Automated isolation triggered. IR team paged.'},
    {id: 'x51e-AL-002', severity: 'high', title: 'Impossible travel detected for user admin@company.com', source: 'Okta', timestamp: '2026-04-22T12:30:00Z', status: 'triaged', assignee: 'SOC Analyst M. Johnson', asset: 'Okta - admin@company.com', mitreTechnique: 'T1078 - Valid Accounts', playbook: 'IR-ImpossibleTravel', sla: '30 minutes', elapsed: '87 minutes', notes: 'Login from Tokyo followed by login from New York within 30 minutes. Account temporarily locked. User confirmed via out-of-band channel they are in New York.'},
    {id: 'x51e-AL-003', severity: 'high', title: 'Public S3 bucket discovered with customer PII exposure', source: 'Prisma Cloud', timestamp: '2026-04-22T11:15:00Z', status: 'remediating', assignee: 'Cloud Security Lead A. Chen', asset: 'AWS S3: customer-data-archive-2024', mitreTechnique: 'N/A - Misconfiguration', playbook: 'IR-Cloud-Misconfig-Remediate', sla: '1 hour', elapsed: '2.5 hours', notes: 'Bucket containing archived customer records was publicly accessible. Bucket blocked and encrypted. Data exposure assessment in progress.'},
    {id: 'x51e-AL-004', severity: 'medium', title: 'Anomalous data download by user jane.developer@company.com', source: 'Microsoft DLP', timestamp: '2026-04-22T10:00:00Z', status: 'investigating', assignee: 'SOC Analyst R. Davis', asset: 'Endpoint: WS-DEV-042', mitreTechnique: 'T1567 - Exfil Over Web Service', playbook: 'IR-DLP-Investigation', sla: '4 hours', elapsed: '3.5 hours', notes: 'User downloaded 4.2GB of source code files to personal Google Drive. Interview scheduled with user and manager.'},
    {id: 'x51e-AL-005', severity: 'medium', title: 'Credential stuffing attack detected on customer portal', source: 'Cloudflare WAF', timestamp: '2026-04-22T09:30:00Z', status: 'contained', assignee: 'SOC Analyst K. Wilson', asset: 'Customer Portal (portal.company.com)', mitreTechnique: 'T1110 - Brute Force', playbook: 'IR-CredentialStuffing-Block', sla: '2 hours', elapsed: '4 hours', notes: 'Rate limiting and CAPTCHA automatically deployed. 12,000 failed login attempts from 800 unique IPs blocked. No successful account takeovers confirmed.'},
    {id: 'x51e-AL-006', severity: 'low', title: 'SSL certificate expiring in 14 days for api.company.com', source: 'Certificate monitoring', timestamp: '2026-04-22T08:00:00Z', status: 'remediated', assignee: 'Infrastructure Lead T. Brown', asset: 'api.company.com', mitreTechnique: 'N/A', playbook: 'Certificate Renewal', sla: '30 days', elapsed: '16 days', notes: 'Automated renewal triggered via ACME. New certificate deployed successfully. No service interruption.'}
  ];

  private _x51eComplianceFrameworks = [
  ...
  private _x51eDataClassificationPolicy = [
  ...
  private _getx51eZoneSummary(): {total: number; highRisk: number; mediumRisk: number; lowRisk: number; totalRules: number} {
    const high = this._x51eSecurityZones.filter(z => z.riskLevel === 'high').length;
    const med = this._x51eSecurityZones.filter(z => z.riskLevel === 'medium').length;
    const low = this._x51eSecurityZones.filter(z => z.riskLevel === 'low').length;
    const rules = this._x51eSecurityZones.reduce((s, z) => s + z.firewallRules, 0);
    return {total: this._x51eSecurityZones.length, highRisk: high, mediumRisk: med, lowRisk: low, totalRules: rules};
  }

  private _getx51eAlertSummary(): {total: number; critical: number; high: number; medium: number; low: number; open: number; contained: number} {
    const crit = this._x51eSecurityAlerts.filter(a => a.severity === 'critical').length;
    const high = this._x51eSecurityAlerts.filter(a => a.severity === 'high').length;
    const med = this._x51eSecurityAlerts.filter(a => a.severity === 'medium').length;
    const low = this._x51eSecurityAlerts.filter(a => a.severity === 'low').length;
    const open = this._x51eSecurityAlerts.filter(a => a.status === 'investigating' || a.status === 'triaged').length;
    const contained = this._x51eSecurityAlerts.filter(a => a.status === 'contained' || a.status === 'remediated').length;
    return {total: this._x51eSecurityAlerts.length, critical: crit, high, medium: med, low, open, contained};
  }

  private _getx51eComplianceSummary(): {total: number; fullyCompliant: number; mostlyCompliant: number; avgComplianceRate: number} {
    const full = this._x51eComplianceFrameworks.filter(f => f.status === 'compliant').length;
    const mostly = this._x51eComplianceFrameworks.filter(f => f.status === 'mostly_compliant').length;
    const avgRate = this._x51eComplianceFrameworks.reduce((s, f) => s + (f.compliant / f.requirements * 100), 0) / this._x51eComplianceFrameworks.length;
    return {total: this._x51eComplianceFrameworks.length, fullyCompliant: full, mostlyCompliant: mostly, avgComplianceRate: Math.round(avgRate * 10) / 10};
  }
  ...
  // === Security Risk Register (network_topo) ===
  private _network_topoRiskRegister = [
    { id: "RSK-NET-0001", title: "Data breach from unpatched systems", owner: "CTO", category: "Financial", status: "mitigating", trend: "stable", severity: "low", likelihood: 5, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-19", nextReview: "2026-07-06" },
    { id: "RSK-NET-0002", title: "Ransomware attack on critical infrastructure", owner: "CRO", category: "Strategic", status: "closed", trend: "decreasing", severity: "medium", likelihood: 3, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-23", nextReview: "2026-07-01" },
    { id: "RSK-NET-0003", title: "Insider threat data exfiltration", owner: "VP Eng", category: "Compliance", status: "accepted", trend: "increasing", severity: "critical", likelihood: 1, impact: 1, treatment: "Monitor and review quarterly", lastReview: "2026-04-16", nextReview: "2026-07-12" },
    { id: "RSK-NET-0004", title: "Supply chain compromise", owner: "Security Lead", category: "Technical", status: "open", trend: "stable", severity: "critical", likelihood: 3, impact: 4, treatment: "Monitor and review quarterly", lastReview: "2026-04-06", nextReview: "2026-07-07" },
    { id: "RSK-NET-0005", title: "Cloud misconfiguration exposure", owner: "Risk Mgr", category: "Reputational", status: "mitigating", trend: "decreasing", severity: "medium", likelihood: 4, impact: 5, treatment: "Monitor and review quarterly", lastReview: "2026-04-10", nextReview: "2026-07-08" },
    { id: "RSK-NET-0006", title: "Phishing campaign success rate", owner: "Compliance Dir", category: "Legal", status: "closed", trend: "increasing", severity: "high", likelihood: 1, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-22", nextReview: "2026-07-17" },
    { id: "RSK-NET-0007", title: "Third-party vendor data breach", owner: "IT Dir", category: "Regulatory", status: "accepted", trend: "stable", severity: "medium", likelihood: 4, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-18", nextReview: "2026-07-11" },
    { id: "RSK-NET-0008", title: "Regulatory non-compliance penalty", owner: "DevOps Lead", category: "Third-Party", status: "open", trend: "decreasing", severity: "critical", likelihood: 4, impact: 1, treatment: "Monitor and review quarterly", lastReview: "2026-04-17", nextReview: "2026-07-24" },
    { id: "RSK-NET-0009", title: "Zero-day exploit in production", owner: "Architect", category: "Human Capital", status: "mitigating", trend: "increasing", severity: "high", likelihood: 5, impact: 1, treatment: "Monitor and review quarterly", lastReview: "2026-04-09", nextReview: "2026-07-04" },
    { id: "RSK-NET-0010", title: "Insufficient access controls", owner: "CISO", category: "Operational", status: "closed", trend: "stable", severity: "high", likelihood: 9, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-16", nextReview: "2026-07-27" },
    { id: "RSK-NET-0011", title: "DDoS attack on services", owner: "CTO", category: "Financial", status: "accepted", trend: "decreasing", severity: "low", likelihood: 3, impact: 6, treatment: "Monitor and review quarterly", lastReview: "2026-04-04", nextReview: "2026-07-18" },
    { id: "RSK-NET-0012", title: "Social engineering attack", owner: "CRO", category: "Strategic", status: "open", trend: "increasing", severity: "high", likelihood: 6, impact: 6, treatment: "Monitor and review quarterly", lastReview: "2026-04-20", nextReview: "2026-07-23" },
    { id: "RSK-NET-0013", title: "API security vulnerability", owner: "VP Eng", category: "Compliance", status: "mitigating", trend: "stable", severity: "high", likelihood: 6, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-19", nextReview: "2026-07-22" },
    { id: "RSK-NET-0014", title: "Mobile device compromise", owner: "Security Lead", category: "Technical", status: "closed", trend: "decreasing", severity: "high", likelihood: 4, impact: 6, treatment: "Monitor and review quarterly", lastReview: "2026-04-11", nextReview: "2026-07-11" },
    { id: "RSK-NET-0015", title: "Physical security breach", owner: "Risk Mgr", category: "Reputational", status: "accepted", trend: "increasing", severity: "medium", likelihood: 1, impact: 4, treatment: "Monitor and review quarterly", lastReview: "2026-04-08", nextReview: "2026-07-08" },
    { id: "RSK-NET-0016", title: "Password policy weakness", owner: "Compliance Dir", category: "Legal", status: "open", trend: "stable", severity: "high", likelihood: 8, impact: 4, treatment: "Monitor and review quarterly", lastReview: "2026-04-05", nextReview: "2026-07-21" },
    { id: "RSK-NET-0017", title: "Network segmentation gap", owner: "IT Dir", category: "Regulatory", status: "mitigating", trend: "decreasing", severity: "high", likelihood: 2, impact: 5, treatment: "Monitor and review quarterly", lastReview: "2026-04-13", nextReview: "2026-07-14" },
    { id: "RSK-NET-0018", title: "Encryption key management failure", owner: "DevOps Lead", category: "Third-Party", status: "closed", trend: "increasing", severity: "low", likelihood: 10, impact: 4, treatment: "Monitor and review quarterly", lastReview: "2026-04-03", nextReview: "2026-07-26" },
    { id: "RSK-NET-0019", title: "Audit trail tampering", owner: "Architect", category: "Human Capital", status: "accepted", trend: "stable", severity: "high", likelihood: 10, impact: 7, treatment: "Monitor and review quarterly", lastReview: "2026-04-04", nextReview: "2026-07-12" },
    { id: "RSK-NET-0020", title: "Business email compromise", owner: "CISO", category: "Operational", status: "open", trend: "decreasing", severity: "critical", likelihood: 1, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-23", nextReview: "2026-07-07" },
  ];
  private _network_topoRiskFilter: string = 'all';
  private _network_topoRiskSeverity: string = 'all';
  private _network_topoRiskStatus: string = 'all';
  private _network_topoExpandedRisk: string = '';
  private _network_topoFilterRisks() {
    const reg = this._network_topoRiskRegister;
    return reg.filter(r => {
      if (this._network_topoRiskFilter !== "all" && r.category !== this._network_topoRiskFilter) return false;
      if (this._network_topoRiskSeverity !== "all" && r.severity !== this._network_topoRiskSeverity) return false;
      if (this._network_topoRiskStatus !== "all" && r.status !== this._network_topoRiskStatus) return false;
      return true;
    });
  }
  private _network_topoGetRiskScore(r: any) { return Math.round(r.likelihood * r.impact * 1.5); }
  private _network_topoGetRiskTrendIcon(trend: string) {
    if (trend === "increasing") return "\u2191";
    if (trend === "decreasing") return "\u2193";
    return "\u2192";
  }
  private _network_topoGetRiskColor(sev: string) {
    if (sev === "critical") return "#dc2626";
    if (sev === "high") return "#ea580c";
    if (sev === "medium") return "#d97706";
    return "#16a34a";
  }
  private _network_topoGetRiskCounts() {
    const reg = this._network_topoRiskRegister;
  ...
  private _network_topoGetTreatmentProgress() {
    const reg = this._network_topoRiskRegister;
    const treated = reg.filter(r => r.status === "mitigating" || r.status === "closed").length;
    return Math.round((treated / Math.max(reg.length, 1)) * 100);
  }

  // === Security Metrics API Gateway (network_topo) ===
  private _network_topoApiEndpoints = [
    { method: "GET", path: "/api/v1/threats", name: "Threat Intelligence Feed", status: "active", avgLatency: 220.7, reqPerMin: 142.0, errorRate: 1.82, uptime: round(95.8001104098562,2), version: "v1.6.14" },
    { method: "POST", path: "/api/v1/scans/start", name: "Vulnerability Scanner", status: "active", avgLatency: 41.3, reqPerMin: 1874.0, errorRate: 0.45, uptime: round(99.68593796578674,2), version: "v1.5.4" },
    { method: "GET", path: "/api/v1/assets", name: "Asset Inventory", status: "active", avgLatency: 292.3, reqPerMin: 2364.0, errorRate: 1.87, uptime: round(95.0862954374904,2), version: "v2.2.13" },
    { method: "POST", path: "/api/v1/alerts", name: "Alert Management", status: "active", avgLatency: 197.2, reqPerMin: 1526.0, errorRate: 1.13, uptime: round(98.13281904608681,2), version: "v3.6.9" },
    { method: "GET", path: "/api/v1/compliance", name: "Compliance Status", status: "active", avgLatency: 184.8, reqPerMin: 1664.0, errorRate: 2.45, uptime: round(99.29659160163449,2), version: "v1.1.19" },
    { method: "PUT", path: "/api/v1/policies", name: "Policy Engine", status: "active", avgLatency: 307.9, reqPerMin: 827.0, errorRate: 0.84, uptime: round(99.08419487682069,2), version: "v3.4.19" },
    { method: "GET", path: "/api/v1/incidents", name: "Incident Tracker", status: "active", avgLatency: 216.6, reqPerMin: 357.0, errorRate: 0.9, uptime: round(98.04074647172148,2), version: "v1.3.0" },
    { method: "POST", path: "/api/v1/forensics", name: "Forensics Collector", status: "degraded", avgLatency: 172.8, reqPerMin: 2244.0, errorRate: 1.96, uptime: round(98.98416610631732,2), version: "v3.2.16" },
    { method: "GET", path: "/api/v1/risk/assess", name: "Risk Assessment", status: "active", avgLatency: 18.6, reqPerMin: 2013.0, errorRate: 1.38, uptime: round(95.80048796677355,2), version: "v2.5.0" },
    { method: "POST", path: "/api/v1/auth/verify", name: "Authentication", status: "active", avgLatency: 432.1, reqPerMin: 866.0, errorRate: 2.38, uptime: round(95.59848205919863,2), version: "v1.0.7" },
    { method: "GET", path: "/api/v1/logs/audit", name: "Audit Log Query", status: "active", avgLatency: 384.3, reqPerMin: 122.0, errorRate: 0.83, uptime: round(96.4645053782907,2), version: "v1.0.2" },
    { method: "PUT", path: "/api/v1/users/roles", name: "Role Management", status: "active", avgLatency: 162.5, reqPerMin: 1692.0, errorRate: 1.41, uptime: round(98.22077585837405,2), version: "v2.9.17" },
    { method: "POST", path: "/api/v1/encrypt", name: "Encryption Service", status: "active", avgLatency: 206.4, reqPerMin: 2337.0, errorRate: 2.4, uptime: round(96.28316785024516,2), version: "v1.0.14" },
    { method: "GET", path: "/api/v1/network/topo", name: "Network Topology", status: "maintenance", avgLatency: 391.1, reqPerMin: 253.0, errorRate: 0.75, uptime: round(96.51553637260018,2), version: "v3.4.14" },
    { method: "DELETE", path: "/api/v1/sessions", name: "Session Manager", status: "active", avgLatency: 435.1, reqPerMin: 2248.0, errorRate: 2.26, uptime: round(99.79467804492657,2), version: "v3.2.5" },
  ];
  private _network_topoApiKeys = [
    { id: "ak-000001", name: "key-netw-001", created: "2026-05-14", lastUsed: "2026-04-18", status: "active", calls: 37077, rateLimit: 5000 },
    { id: "ak-000002", name: "key-netw-002", created: "2026-02-11", lastUsed: "2026-04-11", status: "revoked", calls: 9077, rateLimit: 500 },
    { id: "ak-000003", name: "key-netw-003", created: "2026-05-01", lastUsed: "2026-04-15", status: "active", calls: 45279, rateLimit: 100 },
    { id: "ak-000004", name: "key-netw-004", created: "2026-03-15", lastUsed: "2026-04-07", status: "active", calls: 18412, rateLimit: 500 },
    { id: "ak-000005", name: "key-netw-005", created: "2026-06-26", lastUsed: "2026-04-10", status: "revoked", calls: 33637, rateLimit: 500 },
    { id: "ak-000006", name: "key-netw-006", created: "2026-01-05", lastUsed: "2026-04-09", status: "active", calls: 49839, rateLimit: 100 },
    { id: "ak-000007", name: "key-netw-007", created: "2026-05-27", lastUsed: "2026-04-01", status: "revoked", calls: 34835, rateLimit: 1000 },
    { id: "ak-000008", name: "key-netw-008", created: "2026-05-08", lastUsed: "2026-04-01", status: "active", calls: 37131, rateLimit: 500 },
  ];
  private _network_topoApiHealthSummary() {
    const eps = this._network_topoApiEndpoints;
  ...
  private _network_topoGetApiByMethod(method: string) { return this._network_topoApiEndpoints.filter(e=>e.method===method); }
  private _network_topoGetSlowEndpoints() { return this._network_topoApiEndpoints.filter(e=>e.avgLatency>200).sort((a,b)=>b.avgLatency-a.avgLatency); }
  private _network_topoGetHighErrorEndpoints() { return this._network_topoApiEndpoints.filter(e=>e.errorRate>1.0).sort((a,b)=>b.errorRate-a.errorRate); }

  // === Security Training Effectiveness (network_topo) ===
  private _network_topoTrainingModules = [
    { id: "TRN-001", name: "Security Fundamentals", completionRate: 72.0, avgScore: 70.4, behaviorChange: 48.1, enrolled: 178, completed: 352, duration: "42min", category: "mandatory" },
    { id: "TRN-002", name: "Phishing Awareness", completionRate: 93.7, avgScore: 56.2, behaviorChange: 70.9, enrolled: 382, completed: 115, duration: "19min", category: "mandatory" },
    { id: "TRN-003", name: "Social Engineering Defense", completionRate: 68.1, avgScore: 55.5, behaviorChange: 72.3, enrolled: 90, completed: 331, duration: "83min", category: "optional" },
    { id: "TRN-004", name: "Password Hygiene", completionRate: 79.6, avgScore: 66.4, behaviorChange: 44.4, enrolled: 161, completed: 448, duration: "94min", category: "mandatory" },
    { id: "TRN-005", name: "Data Classification", completionRate: 60.0, avgScore: 93.9, behaviorChange: 51.4, enrolled: 255, completed: 326, duration: "67min", category: "mandatory" },
    { id: "TRN-006", name: "Incident Response Basics", completionRate: 97.0, avgScore: 58.8, behaviorChange: 30.8, enrolled: 422, completed: 37, duration: "48min", category: "mandatory" },
    { id: "TRN-007", name: "Secure Coding", completionRate: 45.2, avgScore: 61.8, behaviorChange: 48.3, enrolled: 383, completed: 244, duration: "78min", category: "optional" },
    { id: "TRN-008", name: "Cloud Security", completionRate: 61.1, avgScore: 75.3, behaviorChange: 54.7, enrolled: 203, completed: 390, duration: "69min", category: "mandatory" },
    { id: "TRN-009", name: "Mobile Device Security", completionRate: 85.0, avgScore: 81.4, behaviorChange: 57.9, enrolled: 372, completed: 450, duration: "60min", category: "mandatory" },
    { id: "TRN-010", name: "Network Security", completionRate: 58.0, avgScore: 92.8, behaviorChange: 31.8, enrolled: 333, completed: 292, duration: "15min", category: "mandatory" },
    { id: "TRN-011", name: "Physical Security", completionRate: 83.1, avgScore: 64.8, behaviorChange: 72.1, enrolled: 251, completed: 421, duration: "58min", category: "optional" },
    { id: "TRN-012", name: "Regulatory Compliance", completionRate: 47.0, avgScore: 81.0, behaviorChange: 78.9, enrolled: 287, completed: 328, duration: "74min", category: "mandatory" },
    { id: "TRN-013", name: "Risk Management", completionRate: 90.3, avgScore: 69.5, behaviorChange: 80.5, enrolled: 154, completed: 265, duration: "62min", category: "mandatory" },
    { id: "TRN-014", name: "Cryptography Basics", completionRate: 56.1, avgScore: 85.7, behaviorChange: 67.8, enrolled: 479, completed: 141, duration: "114min", category: "mandatory" },
    { id: "TRN-015", name: "Access Control", completionRate: 51.3, avgScore: 56.3, behaviorChange: 46.1, enrolled: 476, completed: 432, duration: "107min", category: "optional" },
    { id: "TRN-016", name: "Vendor Management", completionRate: 45.2, avgScore: 62.1, behaviorChange: 58.4, enrolled: 378, completed: 250, duration: "77min", category: "mandatory" },
  ];
  private _network_topoPhishingResults = [
    { month: "2026-01", sent: 400, clicked: 56, reported: 102, clickRate: round(14.000000000000002,1), reportRate: round(25.5,1) },
    { month: "2026-02", sent: 805, clicked: 162, reported: 377, clickRate: round(20.124223602484474,1), reportRate: round(46.83229813664596,1) },
    { month: "2026-03", sent: 316, clicked: 65, reported: 20, clickRate: round(20.569620253164558,1), reportRate: round(6.329113924050633,1) },
    { month: "2026-04", sent: 221, clicked: 63, reported: 23, clickRate: round(28.50678733031674,1), reportRate: round(10.407239819004525,1) },
    { month: "2026-05", sent: 269, clicked: 45, reported: 90, clickRate: round(16.728624535315987,1), reportRate: round(33.457249070631974,1) },
    { month: "2026-06", sent: 651, clicked: 134, reported: 346, clickRate: round(20.583717357910906,1), reportRate: round(53.149001536098304,1) },
  ];
  private _network_topoTrainingROI = { totalInvestment: 73989, avgCostPerEmployee: 241, riskReductionPct: round(random.uniform(15,45),1), incidentReductionPct: round(random.uniform(10,35),1), complianceScoreGain: round(random.uniform(5,25),1) };
  private _network_topoLearningPaths = [
    { name: "Beginner Security Analyst", totalModules: 13, completedModules: 3, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 69, enrolled: 39 },
    { name: "Advanced Threat Hunter", totalModules: 8, completedModules: 16, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 59, enrolled: 194 },
    { name: "Security Architect", totalModules: 10, completedModules: 9, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 34, enrolled: 100 },
    { name: "Incident Responder", totalModules: 14, completedModules: 8, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 33, enrolled: 135 },
    { name: "Compliance Specialist", totalModules: 20, completedModules: 18, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 24, enrolled: 156 },
    { name: "DevSecOps Engineer", totalModules: 10, completedModules: 5, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 12, enrolled: 96 },
  ];
  private _network_topoGetOverallCompletion() {
    const mods = this._network_topoTrainingModules;
    return round(mods.reduce((s,m)=>s+m.completionRate,0)/mods.length,1);
  }
  private _network_topoGetTopPerformers() { return [...this._network_topoTrainingModules].sort((a,b)=>b.avgScore-a.avgScore).slice(0,5); }
  private _network_topoGetModulesNeedingAttention() { return this._network_topoTrainingModules.filter(m=>m.completionRate<70||m.avgScore<65); }

  // === Security Governance Framework (network_topo) ===
  private _network_topoGovBodies = [
    { name: "Security Steering Committee", members: 15, chair: "CISO", meetingFreq: "Weekly", lastMeeting: "2026-04-21", nextMeeting: "2026-05-13", quorum: 8 },
    { name: "Risk Management Board", members: 12, chair: "CTO", meetingFreq: "Bi-weekly", lastMeeting: "2026-04-08", nextMeeting: "2026-05-21", quorum: 4 },
    { name: "Data Governance Council", members: 15, chair: "CRO", meetingFreq: "Monthly", lastMeeting: "2026-04-03", nextMeeting: "2026-05-06", quorum: 3 },
    { name: "Compliance Oversight Board", members: 14, chair: "CDO", meetingFreq: "Monthly", lastMeeting: "2026-04-02", nextMeeting: "2026-05-04", quorum: 5 },
    { name: "Architecture Review Board", members: 15, chair: "VP Eng", meetingFreq: "Bi-weekly", lastMeeting: "2026-04-04", nextMeeting: "2026-05-01", quorum: 7 },
    { name: "Change Advisory Board", members: 15, chair: "CISO", meetingFreq: "Weekly", lastMeeting: "2026-04-02", nextMeeting: "2026-05-08", quorum: 8 },
    { name: "Incident Review Board", members: 7, chair: "CIO", meetingFreq: "As needed", lastMeeting: "2026-04-06", nextMeeting: "2026-05-27", quorum: 4 },
    { name: "Vendor Risk Committee", members: 8, chair: "CFO", meetingFreq: "Quarterly", lastMeeting: "2026-04-13", nextMeeting: "2026-05-06", quorum: 5 },
  ];
  private _network_topoDecisions = [
    { id: "DEC-0001", title: "Adopt zero-trust architecture framework", date: "2026-04-22", status: "approved", owner: "CISO" },
    { id: "DEC-0002", title: "Migrate to SIEM 2.0 platform", date: "2026-03-19", status: "implemented", owner: "CTO" },
    { id: "DEC-0003", title: "Implement DLP across all endpoints", date: "2026-03-09", status: "in-progress", owner: "Security Lead" },
    { id: "DEC-0004", title: "Mandate MFA for all external access", date: "2026-03-16", status: "pending", owner: "CRO" },
    { id: "DEC-0005", title: "Establish bug bounty program", date: "2026-03-06", status: "approved", owner: "VP Eng" },
    { id: "DEC-0006", title: "Deploy EDR solution enterprise-wide", date: "2026-01-20", status: "approved", owner: "CISO" },
    { id: "DEC-0007", title: "Conduct annual penetration testing", date: "2026-02-02", status: "implemented", owner: "CTO" },
    { id: "DEC-0008", title: "Implement network micro-segmentation", date: "2026-01-23", status: "in-progress", owner: "Security Lead" },
  ...
  private _network_topoPolicyLifecycle = [
    { name: "Information Security Policy", version: "v4.2", status: "active", lastUpdated: "2026-02-21", nextReview: "2026-12-15", owner: "CISO" },
    { name: "Acceptable Use Policy", version: "v1.5", status: "active", lastUpdated: "2026-03-21", nextReview: "2026-7-23", owner: "Legal" },
    { name: "Data Retention Policy", version: "v3.3", status: "under-review", lastUpdated: "2026-02-09", nextReview: "2026-10-17", owner: "DPO" },
    { name: "Access Control Policy", version: "v3.0", status: "active", lastUpdated: "2026-04-26", nextReview: "2026-9-20", owner: "IAM Lead" },
    { name: "Incident Response Policy", version: "v1.0", status: "draft", lastUpdated: "2026-03-24", nextReview: "2026-12-18", owner: "IR Lead" },
    { name: "Business Continuity Plan", version: "v4.2", status: "active", lastUpdated: "2026-01-20", nextReview: "2026-12-10", owner: "BCP Mgr" },
    { name: "Vendor Management Policy", version: "v3.1", status: "active", lastUpdated: "2026-01-26", nextReview: "2026-7-18", owner: "Procurement" },
    { name: "Encryption Standard", version: "v1.3", status: "under-review", lastUpdated: "2026-04-16", nextReview: "2026-8-26", owner: "Security Arch" },
  ];
  private _network_topoGovMaturityScore = { overall: 4.4, riskManagement: 5.3, compliance: 4.8, incidentResponse: 5.4, awareness: 2.1, technology: 5.1 };
  private _network_topoGetPendingDecisions() { return this._network_topoDecisions.filter(d=>d.status==='pending'||d.status==='in-progress'); }
  private _network_topoGetActivePolicies() { return this._network_topoPolicyLifecycle.filter(p=>p.status==='active'); }
  private _network_topoGetEscalationPath() { return ["L1 Analyst","L2 Senior","Security Lead","CISO","Board"]; }

  // === Security Innovation Lab (network_topo) ===
  private _network_topoInnoProjects = [
    { id: "INN-001", name: "AI-Powered Threat Detection", description: "Machine learning models for real-time threat identification", status: "active", progress: 72, startDate: "2026-01-06", teamSize: 3, budget: 30891, milestones: 6, completedMilestones: 4 },
    { id: "INN-002", name: "Quantum-Resistant Cryptography", description: "Post-quantum encryption algorithm prototyping", status: "research", progress: 35, startDate: "2026-03-12", teamSize: 5, budget: 55500, milestones: 4, completedMilestones: 2 },
    { id: "INN-003", name: "Automated Red Teaming", description: "Autonomous penetration testing framework", status: "active", progress: 58, startDate: "2026-01-28", teamSize: 3, budget: 198170, milestones: 4, completedMilestones: 7 },
    { id: "INN-004", name: "Zero-Knowledge Authentication", description: "Privacy-preserving identity verification", status: "poc", progress: 88, startDate: "2026-03-25", teamSize: 4, budget: 148076, milestones: 5, completedMilestones: 3 },
    { id: "INN-005", name: "Blockchain Audit Trail", description: "Immutable security event logging", status: "active", progress: 45, startDate: "2026-03-25", teamSize: 4, budget: 120922, milestones: 7, completedMilestones: 3 },
    { id: "INN-006", name: "Behavioral Biometrics", description: "Continuous authentication via user behavior patterns", status: "research", progress: 22, startDate: "2026-01-05", teamSize: 6, budget: 18710, milestones: 8, completedMilestones: 5 },
    { id: "INN-007", name: "Deception Grid 2.0", description: "Advanced honeypot network with adaptive responses", status: "active", progress: 65, startDate: "2026-03-28", teamSize: 6, budget: 51916, milestones: 6, completedMilestones: 9 },
    { id: "INN-008", name: "Secure Enclave Integration", description: "Hardware-backed security for critical workloads", status: "poc", progress: 40, startDate: "2026-01-04", teamSize: 5, budget: 183585, milestones: 7, completedMilestones: 2 },
  ];
  private _network_topoTechEvaluations = [
    { name: "Rust for Security Tools", status: "evaluating", score: 4.5, recommendation: "Adopt", vendor: "Open Source" },
    { name: "eBPF for Runtime Detection", status: "completed", score: 6.4, recommendation: "Adopt", vendor: "AWS" },
  ...
  private _network_topoCollaborationPartners = [
  ...
  private _network_topoInnoMetrics = { totalProjects: 8, activeProjects: 4, avgTimeToValue: "104 days", pocSuccessRate: round(random.uniform(55,85),1), researchToProduction: round(random.uniform(20,50),1), innovationIndex: round(random.uniform(6.0,9.5),1) };
  private _network_topoGetProjectByStatus(status: string) { return this._network_topoInnoProjects.filter(p=>p.status===status); }
  private _network_topoGetTopEvaluations() { return [...this._network_topoTechEvaluations].sort((a,b)=>b.score-a.score).slice(0,3); }



  // === Compliance Dashboard Extension (network_topo) ===
  private _network_topoComplianceFrameworks = [
    { name: "SOC 2 Type II", description: "Trust Services Criteria", totalControls: 5, implementedControls: 4, status: "in-review", lastAudit: "2026-04-12", nextAudit: "2026-8-18", evidenceCount: 459 },
    { name: "ISO 27001", description: "Information Security Management", totalControls: 114, implementedControls: 93, status: "partially-compliant", lastAudit: "2026-03-26", nextAudit: "2026-12-23", evidenceCount: 408 },
    { name: "PCI DSS 4.0", description: "Payment Card Industry", totalControls: 12, implementedControls: 11, status: "in-review", lastAudit: "2026-01-26", nextAudit: "2026-9-11", evidenceCount: 315 },
    { name: "HIPAA", description: "Health Insurance Portability", totalControls: 18, implementedControls: 12, status: "in-review", lastAudit: "2026-03-28", nextAudit: "2026-7-21", evidenceCount: 269 },
    { name: "GDPR", description: "Data Protection Regulation", totalControls: 99, implementedControls: 94, status: "non-compliant", lastAudit: "2026-01-24", nextAudit: "2026-10-24", evidenceCount: 161 },
    { name: "NIST CSF 2.0", description: "Cybersecurity Framework", totalControls: 6, implementedControls: 6, status: "partially-compliant", lastAudit: "2026-02-06", nextAudit: "2026-11-16", evidenceCount: 130 },
    { name: "FedRAMP", description: "Federal Risk Authorization", totalControls: 15, implementedControls: 8, status: "non-compliant", lastAudit: "2026-02-11", nextAudit: "2026-10-23", evidenceCount: 432 },
    { name: "SOX", description: "Sarbanes-Oxley Compliance", totalControls: 8, implementedControls: 5, status: "partially-compliant", lastAudit: "2026-02-03", nextAudit: "2026-9-15", evidenceCount: 487 },
    { name: "CIS Controls v8", description: "Center for Internet Security", totalControls: 18, implementedControls: 13, status: "non-compliant", lastAudit: "2026-03-15", nextAudit: "2026-12-02", evidenceCount: 487 },
    { name: "COBIT 2019", description: "IT Governance Framework", totalControls: 40, implementedControls: 23, status: "in-review", lastAudit: "2026-03-15", nextAudit: "2026-9-01", evidenceCount: 431 },
  ];
  private _network_topoGetComplianceScore() {
    const fw = this._network_topoComplianceFrameworks;
    return round(fw.reduce((s,f)=>s + (f.implementedControls/Math.max(f.totalControls,1))*100, 0) / fw.length, 1);
  }
  private _network_topoGetGaps() {
    return this._network_topoComplianceFrameworks.filter(f => f.status !== "compliant");
  }
  private _network_topoAuditTrail = [
    { id: "AUD-0001", action: "Control tested", auditor: "Internal Audit", date: "2026-04-01", result: "pass", findings: 1 },
    { id: "AUD-0002", action: "Evidence collected", auditor: "External Auditor", date: "2026-04-06", result: "pass", findings: 3 },
    { id: "AUD-0003", action: "Gap identified", auditor: "Security Team", date: "2026-04-22", result: "fail", findings: 3 },
    ...
    { id: "AUD-0006", action: "Training verified", auditor: "Risk Team", date: "2026-04-20", result: "pass", findings: 5 },
  ...
  // === Threat Intelligence Feed Extension (network_topo) ===
  private _network_topoThreatActors = [
    { name: "APT-29", alias: "Cozy Bear", origin: "Russia", type: "Nation-State", severity: "high", lastActivity: "2026-04-19", targets: "Government", indicators: 242, ttps: 8 },
    { name: "APT-41", alias: "Double Dragon", origin: "China", type: "Nation-State", severity: "critical", lastActivity: "2026-04-06", targets: "Government", indicators: 270, ttps: 14 },
    { name: "Lazarus Group", alias: "Hidden Cobra", origin: "North Korea", type: "Nation-State", severity: "critical", lastActivity: "2026-04-17", targets: "Manufacturing", indicators: 338, ttps: 14 },
    { name: "FIN7", alias: "Carbanak", origin: "Eastern Europe", type: "Financial", severity: "high", lastActivity: "2026-04-03", targets: "Finance", indicators: 270, ttps: 19 },
    { name: "Conti", alias: "Wizard Spider", origin: "Russia", type: "Ransomware", severity: "critical", lastActivity: "2026-04-06", targets: "Healthcare", indicators: 39, ttps: 38 },
    { name: "LockBit", alias: "LockBit Gang", origin: "Unknown", type: "Ransomware", severity: "high", lastActivity: "2026-04-18", targets: "Finance", indicators: 376, ttps: 30 },
    { name: "Cl0p", alias: "Cl0p Team", origin: "Unknown", type: "Ransomware", severity: "high", lastActivity: "2026-04-17", targets: "Energy", indicators: 292, ttps: 12 },
    { name: "Sandworm", alias: "Unit 74455", origin: "Russia", type: "Nation-State", severity: "critical", lastActivity: "2026-04-12", targets: "Energy", indicators: 217, ttps: 39 },
  ];
  private _network_topoIoCFeed = [
    { id: "ioc-000001", type: "ip", value: "21.145.199.85", confidence: 55, source: "CrowdStrike", firstSeen: "2026-04-02", lastSeen: "2026-04-05" },
    { id: "ioc-000002", type: "ip", value: "3.169.175.247", confidence: 63, source: "STIX", firstSeen: "2026-04-06", lastSeen: "2026-04-16" },
    { id: "ioc-000003", type: "ip", value: "117.196.159.242", confidence: 83, source: "STIX", firstSeen: "2026-04-23", lastSeen: "2026-04-08" },
    { id: "ioc-000004", type: "ip", value: "202.95.108.3", confidence: 82, source: "CrowdStrike", firstSeen: "2026-04-14", lastSeen: "2026-04-16" },
    { id: "ioc-000005", type: "ip", value: "167.224.120.155", confidence: 47, source: "CrowdStrike", firstSeen: "2026-04-04", lastSeen: "2026-04-16" },
    { id: "ioc-000006", type: "ip", value: "171.151.86.52", confidence: 53, source: "AlienVault", firstSeen: "2026-04-08", lastSeen: "2026-04-17" },
    { id: "ioc-000007", type: "ip", value: "237.91.218.194", confidence: 47, source: "AlienVault", firstSeen: "2026-04-07", lastSeen: "2026-04-18" },
    { id: "ioc-000008", type: "ip", value: "85.252.82.61", confidence: 76, source: "AlienVault", firstSeen: "2026-04-05", lastSeen: "2026-04-06" },
    { id: "ioc-000009", type: "ip", value: "209.9.157.154", confidence: 99, source: "VirusTotal", firstSeen: "2026-04-06", lastSeen: "2026-04-07" },
    { id: "ioc-000010", type: "ip", value: "8.247.170.101", confidence: 63, source: "MISP", firstSeen: "2026-04-14", lastSeen: "2026-04-13" },
    { id: "ioc-000011", type: "ip", value: "140.183.195.210", confidence: 86, source: "VirusTotal", firstSeen: "2026-04-21", lastSeen: "2026-04-11" },
    { id: "ioc-000012", type: "ip", value: "113.248.135.182", confidence: 74, source: "VirusTotal", firstSeen: "2026-04-20", lastSeen: "2026-04-03" },
    { id: "ioc-000013", type: "ip", value: "170.40.134.105", confidence: 94, source: "AlienVault", firstSeen: "2026-04-10", lastSeen: "2026-04-22" },
    { id: "ioc-000014", type: "ip", value: "187.109.163.84", confidence: 92, source: "CrowdStrike", firstSeen: "2026-04-07", lastSeen: "2026-04-19" },
    { id: "ioc-000015", type: "ip", value: "66.60.137.136", confidence: 92, source: "CrowdStrike", firstSeen: "2026-04-15", lastSeen: "2026-04-10" },
  ];
  private _network_topoGetActiveThreats() { return this._network_topoThreatActors.filter(a => a.severity === 'critical'); }
  private _network_topoGetThreatSummary() {
    const actors = this._network_topoThreatActors;
  ...
  // === Incident Management Extension (network_topo) ===
  private _network_topoIncidents = [
    { id: "INC-20260001", title: "Unauthorized access detected", severity: "critical", status: "open", assignedTo: "SOC L1", detectedAt: "2026-04-07T10:58", affectedAssets: 17, rootCause: "Misconfiguration" },
    { id: "INC-20260002", title: "Malware outbreak on workstation", severity: "high", status: "investigating", assignedTo: "SOC L2", detectedAt: "2026-04-23T14:13", affectedAssets: 7, rootCause: "Credential compromise" },
    { id: "INC-20260003", title: "Data leak from S3 bucket", severity: "medium", status: "contained", assignedTo: "IR Lead", detectedAt: "2026-04-23T09:14", affectedAssets: 38, rootCause: "Zero-day" },
    { id: "INC-20260004", title: "Phishing campaign targeting finance", severity: "low", status: "eradicated", assignedTo: "CISO", detectedAt: "2026-04-06T17:49", affectedAssets: 11, rootCause: "Human error" },
    { id: "INC-20260005", title: "DDoS attack on web services", severity: "critical", status: "recovered", assignedTo: "Security Eng", detectedAt: "2026-04-02T21:35", affectedAssets: 48, rootCause: "Policy violation" },
    { id: "INC-20260006", title: "Ransomware encryption attempt", severity: "high", status: "closed", assignedTo: "Forensics", detectedAt: "2026-04-07T17:08", affectedAssets: 10, rootCause: "Unknown" },
    { id: "INC-20260007", title: "Insider data exfiltration", severity: "medium", status: "open", assignedTo: "SOC L1", detectedAt: "2026-04-09T06:29", affectedAssets: 43, rootCause: "Misconfiguration" },
    { id: "INC-20260008", title: "API key exposure in repo", severity: "low", status: "investigating", assignedTo: "SOC L2", detectedAt: "2026-04-15T21:47", affectedAssets: 29, rootCause: "Credential compromise" },
    { id: "INC-20260009", title: "SQL injection on portal", severity: "critical", status: "contained", assignedTo: "IR Lead", detectedAt: "2026-04-21T12:30", affectedAssets: 23, rootCause: "Zero-day" },
    { id: "INC-20260010", title: "Brute force on VPN", severity: "high", status: "eradicated", assignedTo: "CISO", detectedAt: "2026-04-08T11:58", affectedAssets: 13, rootCause: "Human error" },
    { id: "INC-20260011", title: "Supply chain alert from vendor", severity: "medium", status: "recovered", assignedTo: "Security Eng", detectedAt: "2026-04-23T17:33", affectedAssets: 18, rootCause: "Policy violation" },
    { id: "INC-20260012", title: "Suspicious lateral movement", severity: "low", status: "closed", assignedTo: "Forensics", detectedAt: "2026-04-02T03:33", affectedAssets: 7, rootCause: "Unknown" },
  ];
  private _network_topoGetIncidentStats() {
    const inc = this._network_topoIncidents;
    return { total: inc.length, open: inc.filter(i=>i.status==="open").length, investigating: inc.filter(i=>i.status==="investigating").length, mttd: 40, mttr: 105 };
  }
  private _network_topoGetSeverityDistribution() {
    const inc = this._network_topoIncidents;
...
<div class="tabs">
        ...
        ${this._activeTab === 'rules' ? html`
          ...
          <div style="background:#1a1d27;border-radius:8px;padding:12px">${this._renderNtTreemapSVG()}</div>
          <div style="margin-top:12px;font-size:11px;font-weight:600;margin-bottom:6px">Data Flow (Sankey)</div>
          <div style="background:#1a1d27;border-radius:8px;padding:12px">${this._renderNtSankeySVG()}</div>
          ${this._renderNtActivity()}
        ` : nothing}
        ${this._activeTab === 'anomalies' ? html`
          ${this._renderNtAnomalies()}
          ${this._renderNtNotifications()}
        ` : nothing}
        ${this._activeTab === 'predictions' ? html`
          ${this._renderNtPredictions()}
          ...
          <div style="background:#1a1d27;border-radius:8px;padding:12px">
            <table class="history-table"><thead><tr><th>ID</th><th>Base</th><th>Temporal</th><th>Environmental</th><th>Overall</th></tr></thead><tbody>
              ${this._ntcvssData.map(c => html`<tr><td>${c.itemId}</td><td style="color:${c.base >= 7 ? '#ef4444' : c.base >= 4 ? '#eab308' : '#22c55e'}">${c.base}</td><td>${c.temporal}</td><td>${c.environmental}</td><td style="font-weight:700;color:${c.overall >= 7 ? '#ef4444' : c.overall >= 4 ? '#eab308' : '#22c55e'}">${c.overall}</td></tr>`)}
            </tbody></table>
          </div>
        ` : nothing}
        ${this._activeTab === 'approvals' ? html`
          ${this._renderNtApprovals()}
        ` : nothing}
        ${this._activeTab === 'config' ? html`
          ${this._renderNtConfig()}
        ` : nothing}
        ${this._activeTab === 'new' ? html`
          <div class="form-section">
            <div class="form-title">Create New Network Topo Entry</div>
            <div class="form-grid">
  ...
  @state() private _ntScenarios: {id:string;name:string;attackType:string;target:string;method:string;impactLow:number;impactHigh:number;confidence:number;mitigation:string;status:string}[] = [];
  @state() private _ntScenarioForm: {attackType:string;target:string;method:string} = {attackType:'',target:'',method:''};
  @state() private _ntScenarioCompare: boolean = false;
  @state() private _ntScenarioSelected: string[] = [];

  private _ntInitScenarios(): void {
    const saved = localStorage.getItem('nt_scenarios');
    if (saved) { try { this._ntScenarios = JSON.parse(saved); } catch { /* ignore */ } }
    if (this._ntScenarios.length === 0) {
      this._ntScenarios = [
        {id:'nt-s1',name:'Baseline Threat',attackType:'Phishing',target:'Employees',method:'Spear Email',impactLow:45,impactHigh:78,confidence:72,mitigation:'Security awareness training + email filtering',status:'active'},
        {id:'nt-s2',name:'Escalated Attack',attackType:'Ransomware',target:'Endpoints',method:'Drive-by Download',impactLow:65,impactHigh:95,confidence:58,mitigation:'EDR deployment + network segmentation',status:'saved'},
        {id:'nt-s3',name:'Insider Threat',attackType:'Data Exfiltration',target:'Databases',method:'SQL Injection',impactLow:55,impactHigh:88,confidence:65,mitigation:'DLP policies + query monitoring',status:'draft'},
      ];
    }
  }

  private _ntSaveScenarios(): void {
    localStorage.setItem('nt_scenarios', JSON.stringify(this._ntScenarios));
  }

  private _ntAddScenario(): void {
    const f = this._ntScenarioForm;
    if (!f.attackType || !f.target) return;
    this._ntScenarios = [...this._ntScenarios, {
      id: 'nt-s' + (this._ntScenarios.length + 1),
    ...
    this._ntScenarioForm = {attackType:'',target:'',method:''};
    this._ntSaveScenarios();
  }

  private _ntRenderScenarioEngine(): any {
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <button class="tab" @click=${() => { this._ntScenarioCompare = !this._ntScenarioCompare; }}>${this._ntScenarioCompare ? 'List View' : 'Compare'}</button>
        </div>
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:6px;margin-bottom:10px">
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._ntScenarioForm = {...this._ntScenarioForm, attackType: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Attack Type</option>
            ${attackTypes.map(a => html`<option value=${a} ${this._ntScenarioForm.attackType === a ? 'selected' : ''}>${a}</option>`)}
          </select>
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._ntScenarioForm = {...this._ntScenarioForm, target: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Target</option>
            ${targets.map(t => html`<option value=${t} ${this._ntScenarioForm.target === t ? 'selected' : ''}>${t}</option>`)}
          </select>
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._ntScenarioForm = {...this._ntScenarioForm, method: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Method</option>
            ${methods.map(m => html`<option value=${m} ${this._ntScenarioForm.method === m ? 'selected' : ''}>${m}</option>`)}
          </select>
        </div>
        <button style="background:#3b82f6;border:none;border-radius:4px;padding:4px 12px;color:#fff;font-size:11px;cursor:pointer" @click=${this._ntAddScenario}>Run Simulation</button>
      </div>
      ${this._ntScenarioCompare && this._ntScenarios.length >= 2 ? html`
        <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
          <div style="font-weight:600;font-size:12px;color:#e2e8f0;margin-bottom:8px">Side-by-Side Comparison</div>
          <div style="display:grid;grid-template-columns:repeat(${Math.min(3, this._ntScenarios.length)},1fr);gap:8px">
            ${this._ntScenarios.slice(0,3).map(s => html`
      ...
      <div style="background:#0f1117;border-radius:8px;padding:12px">
        <div style="font-weight:600;font-size:12px;color:#e2e8f0;margin-bottom:8px">Saved Scenarios (${this._ntScenarios.length})</div>
        ${this._ntScenarios.map(s => html`
  ...
  @state() private _ntTrendData: {day:number;value:number;anomaly:boolean}[] = [];
  @state() private _ntTrendZoom: {start:number;end:number} | null = null;
  @state() private _ntTrendMA: number = 7;

  private _ntInitTrendData(): void {
    ...
    this._ntTrendData = data;
  }

  private _ntCalcMA(window: number): number[] {
    const result: number[] = [];
    for (let i = 0; i < this._ntTrendData.length; i++) {
      const start = Math.max(0, i - window + 1);
      const slice = this._ntTrendData.slice(start, i + 1);
      result.push(slice.reduce((s, d) => s + d.value, 0) / slice.length);
    }
    return result;
  }

  private _ntGetStats(): {mean:number;median:number;stddev:number;trend:string} {
    const vals = this._ntTrendData.map(d => d.value);
    const n = vals.length;
  ...
  private _ntRenderTimeSeries(): any {
    const stats = this._ntGetStats();
    const filtered = this._ntTrendZoom ? this._ntTrendData.filter(d => d.day >= this._ntTrendZoom.start && d.day <= this._ntTrendZoom.end) : this._ntTrendData;
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px">
            <button class="tab ${this._ntTrendMA === 7 ? 'active' : ''}" @click=${() => { this._ntTrendMA = 7; }}>7D MA</button>
            <button class="tab ${this._ntTrendMA === 30 ? 'active' : ''}" @click=${() => { this._ntTrendMA = 30; }}>30D MA</button>
            <button class="tab" @click=${() => { this._ntTrendZoom = null; }}>Reset Zoom</button>
          </div>
        </div>
        <div style="position:relative;height:120px;background:#1a1d2e;border-radius:6px;overflow:hidden;margin-bottom:8px;cursor:crosshair" @click=${(e: any) => {
          ...
          this._ntTrendZoom = { start: Math.max(0, center - 10), end: Math.min(89, center + 10) };
        }}>
  ...
  @state() private _ntRoles: string[] = ['Admin','Analyst','Operator','Viewer','Auditor'];
  @state() private _ntActions: string[] = ['Create','Read','Update','Delete','Export','Approve'];
  @state() private _ntPermissions: { [role: string]: { [action: string]: boolean } } = {};
  @state() private _ntPermAudit: {role:string;action:string;changedBy:string;timestamp:string;oldVal:boolean;newVal:boolean}[] = [];
  @state() private _ntPermCompare: string[] = [];

  private _ntInitPermissions(): void {
    ...
    for (const role of this._ntRoles) {
      perms[role] = {};
      this._ntActions.forEach((a, i) => { perms[role][a] = defaults[role]?.[i] ?? false; });
    }
    this._ntPermissions = perms;
  }

  private _ntTogglePermission(role: string, action: string): void {
    const old = this._ntPermissions[role][action];
    this._ntPermissions = {...this._ntPermissions, [role]: {...this._ntPermissions[role], [action]: !old}};
    this._ntPermAudit.unshift({role,action,changedBy:'current_user',timestamp:new Date().toISOString(),oldVal:old,newVal:!old});
  }

  private _ntRenderRBAC(): any {
    const compareRoles = this._ntPermCompare.map(r => this._ntPermissions[r]).filter(Boolean);
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          <span style="font-weight:700;font-size:13px;color:#e2e8f0">RBAC Permission Matrix</span>
          <div style="display:flex;gap:4px">
            ${this._ntRoles.map(r => html`
              <button class="tab ${this._ntPermCompare.includes(r) ? 'active' : ''}" @click=${() => {
                this._ntPermCompare = this._ntPermCompare.includes(r) ? this._ntPermCompare.filter(x => x !== r) : [...this._ntPermCompare, r];
              }}>${r}</button>
            `)}
          </div>
        </div>
          ...
          <table style="width:100%;border-collapse:collapse;font-size:10px">
            <thead>
              <tr>
                ...
                ${this._ntActions.map(a => html`<th style="padding:6px;color:#6b7280;border-bottom:1px solid #2a2d3a;text-align:center">${a}</th>`)}
              </tr>
            </thead>
            <tbody>
              ${this._ntRoles.map(role => html`
                <tr style="border-bottom:1px solid #1a1d2e">
                  <td style="padding:6px;color:#e2e8f0;font-weight:600">${role}</td>
                  ${this._ntActions.map(action => html`
                    <td style="text-align:center;padding:6px">
                      <button style="width:28px;height:20px;border-radius:3px;border:1px solid #2a2d3a;background:${this._ntPermissions[role][action] ? '#22c55e' : '#1a1d2e'};cursor:pointer;color:#fff;font-size:10px" @click=${() => this._ntTogglePermission(role, action)}>${this._ntPermissions[role][action] ? 'Y' : 'N'}</button>
                    </td>
                  `)}
                </tr>
              `)}
        ...
        ${compareRoles.length >= 2 ? html`
          <div style="margin-top:10px;padding:8px;background:#1a1d2e;border-radius:6px">
            <div style="font-size:11px;font-weight:600;color:#e2e8f0;margin-bottom:6px">Role Diff: ${this._ntPermCompare.join(' vs ')}</div>
            ${this._ntActions.map(action => {
              ...
              return allSame ? nothing : html`
                <div style="display:flex;gap:8px;padding:3px 0;font-size:10px">
                  ...
                  ${compareRoles.map((r, i) => html`<span style="color:${r[action] ? '#22c55e' : '#ef4444'}">${this._ntPermCompare[i]}=${r[action] ? 'Y' : 'N'}</span>`)}
                </div>
              `;
            })}
          </div>
        ` : nothing}
        ${this._ntPermAudit.length > 0 ? html`
          <div style="margin-top:8px;font-size:9px;color:#6b7280">Recent: ${this._ntPermAudit.slice(0,3).map(a => html`<span style="margin-right:8px">${a.role}.${a.action}: ${a.oldVal ? 'Y' : 'N'}->${a.newVal ? 'Y' : 'N'}</span>`)}
        ` : nothing}
      </div>
    `;
  }
  ...
  // === REPORTING SUITE ===
  @state() private _ntReportTemplate: string = 'executive';
  @state() private _ntReportSchedule: string = 'weekly';
  @state() private _ntReportDistList: string[] = ['security-team@company.com','ciso@company.com'];
  @state() private _ntReportHistory: {id:string;template:string;generatedAt:string;status:string}[] = [];

  private _ntGenerateReport(): void {
    const id = 'rpt-' + Date.now();
    this._ntReportHistory.unshift({id,template:this._ntReportTemplate,generatedAt:new Date().toISOString(),status:'sent'});
  }

  private _ntRenderReporting(): any {
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:8px">
          <div>
            ...
            ${templates.map(t => html`
              <div style="padding:6px;background:${this._ntReportTemplate === t.key ? '#1e3a5f' : '#1a1d2e'};border:1px solid ${this._ntReportTemplate === t.key ? '#3b82f6' : '#2a2d3a'};border-radius:4px;margin-bottom:4px;cursor:pointer" @click=${() => { this._ntReportTemplate = t.key; }}>
          ...
          <div>
            ...
            <div style="display:flex;gap:4px;margin-bottom:8px">
              ${schedules.map(s => html`<button class="tab ${this._ntReportSchedule === s.key ? 'active' : ''}" @click=${() => { this._ntReportSchedule = s.key; }}>${s.label}</button>`)}
            </div>
            <div style="font-size:10px;color:#6b7280;margin-bottom:4px">Distribution</div>
            <div style="font-size:10px;color:#9ca3af">${this._ntReportDistList.map(d => html`<div>${d}</div>`)}</div>
            <div style="margin-top:6px;display:flex;gap:4px">
              <button style="background:#3b82f6;border:none;border-radius:4px;padding:4px 10px;color:#fff;font-size:10px;cursor:pointer" @click=${this._ntGenerateReport}>Generate</button>
        ...
        ${this._ntReportHistory.length > 0 ? html`
          <div style="border-top:1px solid #2a2d3a;padding-top:8px">
            ...
            ${this._ntReportHistory.slice(0,3).map(r => html`
  ...
  @state() private _ntHighContrast: boolean = false;
  @state() private _ntA11yAnnounce: string = '';
  @state() private _ntShortcutsVisible: boolean = false;
  @state() private _ntFocusTrap: boolean = false;

  private _ntShortcuts: Record<string, string> = {
  ...
  private _ntHandleKeydown(e: KeyboardEvent): void {
    if (e.key === 'Escape' && this._ntFocusTrap) { this._ntFocusTrap = false; this._ntAnnounce('Dialog closed'); }
    if (e.ctrlKey && e.shiftKey && e.key === 'H') { e.preventDefault(); this._ntHighContrast = !this._ntHighContrast; this._ntAnnounce('High contrast ' + (this._ntHighContrast ? 'enabled' : 'disabled')); }
    if (e.ctrlKey && e.shiftKey && e.key === 'A') { e.preventDefault(); this._ntShortcutsVisible = !this._ntShortcutsVisible; }
  }

  private _ntAnnounce(msg: string): void {
    this._ntA11yAnnounce = msg;
    setTimeout(() => { this._ntA11yAnnounce = ''; }, 2000);
  }

  private _ntRenderAccessibility(): any {
    return html`
      <div role="region" aria-label="Accessibility Controls" style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <button class="tab ${this._ntShortcutsVisible ? 'active' : ''}" @click=${() => { this._ntShortcutsVisible = !this._ntShortcutsVisible; }} aria-expanded=${this._ntShortcutsVisible}>Shortcuts</button>
        </div>
        <div style="display:flex;gap:8px;margin-bottom:8px">
          <label style="display:flex;align-items:center;gap:6px;font-size:11px;color:#e2e8f0;cursor:pointer">
            <input type="checkbox" .checked=${this._ntHighContrast} @change=${() => { this._ntHighContrast = !this._ntHighContrast; }} aria-label="Toggle high contrast mode">
            High Contrast
          </label>
        </div>
        ${this._ntShortcutsVisible ? html`
          <div role="list" aria-label="Keyboard shortcuts" style="background:#1a1d2e;border-radius:6px;padding:8px">
            ${Object.entries(this._ntShortcuts).map(([key, desc]) => html`
        ...
        ` : nothing}
        <div role="status" aria-live="polite" aria-atomic="true" style="position:absolute;left:-9999px">${this._ntA11yAnnounce}</div>
      </div>
    `;
  }
  ...
  connectedCallback(): void {
    ...
    this._ntInitScenarios();
    this._ntInitTrendData();
    this._ntInitPermissions();
    document.addEventListener('keydown', this._ntHandleKeydown.bind(this));
  }

  disconnectedCallback(): void {
    super.disconnectedCallback();
    document.removeEventListener('keydown', this._ntHandleKeydown.bind(this));
  }

  // === TAB INTEGRATION FOR EXTENDED FEATURES ===
  @state() private _ntActiveSubTab: string = 'scenario';
  ...
  private _ntGetAllSubTabs(): {key:string;label:string}[] {
    return [
  ...
  private _ntRenderSubPanel(): any {
    switch (this._ntActiveSubTab) {
      case 'scenario': return this._ntRenderScenarioEngine();
      case 'timeseries': return this._ntRenderTimeSeries();
      case 'rbac': return this._ntRenderRBAC();
      case 'reporting': return this._ntRenderReporting();
      case 'a11y': return this._ntRenderAccessibility();
      default: return nothing;
    }
  }

  private _ntRenderTabBar(): any {
    return html`
      <div style="display:flex;gap:4px;margin-bottom:12px;border-bottom:1px solid #2a2d3a;padding-bottom:8px;flex-wrap:wrap" role="tablist" aria-label="Extended panel features">
        ${this._ntGetAllSubTabs().map(t => html`
          <button class="tab ${this._ntActiveSubTab === t.key ? 'active' : ''}" @click=${() => { this._ntActiveSubTab = t.key; }} role="tab" aria-selected=${this._ntActiveSubTab === t.key}>${t.label}</button>
        `)}
      </div>
      <div role="tabpanel" aria-labelledby="nt-tab-${this._ntActiveSubTab}">
        ${this._ntRenderSubPanel()}
      </div>
    `;
  }
  ...
  @state() private _soarPlaybooks: Array<{
    ...
    {
      id: 'pb-soar-001', name: 'Network Topo Auto Response', status: 'active',
      steps: [
    ...
    {
      id: 'pb-soar-002', name: 'Network Topo Investigation Workflow', status: 'active',
      steps: [
    ...
    {
      id: 'pb-soar-003', name: 'Network Topo Compliance Scan', status: 'draft',
      steps: [
  ...
  @state() private _ntAle: number = 0;
  @state() private _ntSroi: number = 0;
  @state() private _ntCpi: number = 0;
  @state() private _ntBudgetAlloc: number = 0;
  @state() private _ntCostBenefit: number = 0;

  // Security Economics Calculator
  private ntInitEconomics() {
    this._ntAle = Math.round(2850000 + Math.random() * 4500000);
    this._ntSroi = Math.round(180 + Math.random() * 320);
    this._ntCpi = Math.round(45000 + Math.random() * 120000);
    this._ntBudgetAlloc = Math.round(2500000 + Math.random() * 3000000);
    this._ntCostBenefit = Math.round(220 + Math.random() * 180);
  }

  private _ntCalcAle(): { annual: number; perIncident: number; byCategory: Array<{name: string; value: number}> } {
    const base = this._ntAle;
    const categories = [
  ...
  private _ntCalcSroi(): Array<{year: number; investment: number; savings: number; roi: number}> {
    const baseInv = this._ntSroi * 10000;
  ...
  private _ntGetBudgetAlloc(): Array<{category: string; amount: number; pct: number; trend: string}> {
    const total = this._ntBudgetAlloc;
    const items = [
  ...
  private _ntGetCostBenefit(): Array<{control: string; cost: number; benefit: number; ratio: number; priority: string}> {
    const base = this._ntCostBenefit;
    const controls = [
  ...
  private _ntRenderEconomics() {
    const ale = this._ntCalcAle();
    const roi = this._ntCalcSroi();
    const budget = this._ntGetBudgetAlloc();
    const cb = this._ntGetCostBenefit();
    const cpi = this._ntCpi;
  ...
  @state() private _ntThreatLevel: any = null;
  @state() private _ntEmergingThreats: any = null;
  @state() private _ntThreatTrends: any = null;
  @state() private _ntSectorRadar: any = null;
  @state() private _ntActorActivity: any = null;

  // Threat Landscape Intelligence
  private ntInitThreatIntel() {
    this._ntThreatLevel = {
  ...
  private _ntRenderThreatIntel() {
    const tl = this._ntThreatLevel;
    const et = this._ntEmergingThreats;
    const sr = this._ntSectorRadar;
    const aa = this._ntActorActivity;
  ...
  @state() private _ntPolicies: any = null;
  @state() private _ntExceptions: any = null;
  @state() private _ntRiskRegister: any = null;
  @state() private _ntMeetings: any = null;
  @state() private _ntDeadlines: any = null;

  // Security Governance Dashboard
  private ntInitGovernance() {
    this._ntPolicies = [
  ...
  private _ntRenderGovernance() {
    const policies = this._ntPolicies;
    const risks = this._ntRiskRegister;
    const deadlines = this._ntDeadlines;
  ...
  @state() private _ntCriticalAssets: any = null;
  @state() private _ntAssetDeps: any = null;
  @state() private _ntEolAssets: any = null;
  @state() private _ntAssetRisk: any = null;

  // Asset Intelligence
  private ntInitAssetIntel() {
    this._ntCriticalAssets = [
    ...
    this._ntAssetRisk = { critical: 7, high: 23, medium: 45, low: 128, total: 203 };
  }

  private _ntRenderAssetIntel() {
    const assets = this._ntCriticalAssets;
    const eol = this._ntEolAssets;
    const ar = this._ntAssetRisk;
  ...
  @state() private _ntUserBaseline: any = null;
  @state() private _ntAnomalyRules: any = null;
  @state() private _ntDataAccess: any = null;
  @state() private _ntInsiderRisk: any = null;
  ...
  private ntInitInsiderThreat() {
    this._ntUserBaseline = [
    ...
    this._ntInsiderRisk = { totalUsers: 2847, monitored: 342, flagged: 18, investigated: 5, confirmed: 1 };
  }

  private _ntRenderInsiderThreat() {
    const baseline = this._ntUserBaseline;
    const rules = this._ntAnomalyRules;
    const ir = this._ntInsiderRisk;
...
// ===== THREAT ACTOR PROFILE DATABASE (R22) =====
  ...
  private _renderBudgetPlanning() {
    const budgetData = [
      { category: "Personnel & Training", planned: 949000, actual: 4800000, utilization: 505.8, q1: "27%", q2: "32%", q3: "30%", q4: "22%" },
      { category: "Tooling & Licensing", planned: 956000, actual: 712000, utilization: 74.5, q1: "30%", q2: "21%", q3: "25%", q4: "23%" },
      { category: "Infrastructure Security", planned: 963000, actual: 725000, utilization: 75.3, q1: "17%", q2: "26%", q3: "20%", q4: "24%" },
      { category: "Compliance & Audit", planned: 970000, actual: 738000, utilization: 76.1, q1: "20%", q2: "31%", q3: "31%", q4: "25%" },
      { category: "Incident Response", planned: 977000, actual: 751000, utilization: 76.9, q1: "23%", q2: "20%", q3: "26%", q4: "10%" },
      { category: "Third-Party Assessments", planned: 984000, actual: 764000, utilization: 77.6, q1: "26%", q2: "25%", q3: "21%", q4: "11%" },
      { category: "Security Awareness", planned: 991000, actual: 777000, utilization: 78.4, q1: "29%", q2: "30%", q3: "32%", q4: "12%" },
      { category: "Research & Innovation", planned: 998000, actual: 790000, utilization: 79.2, q1: "16%", q2: "35%", q3: "27%", q4: "13%" },
    ];
    ...
    const headcount = [
      { team: "SOC Tier 1", current: 3, target: 15, gap: 2, avgSalary: "114k" },
      { team: "SOC Tier 2", current: 12, target: 14, gap: 1, avgSalary: "143k" },
      { team: "Threat Intel", current: 4, target: 13, gap: 0, avgSalary: "172k" },
      { team: "Red Team", current: 13, target: 12, gap: 5, avgSalary: "90k" },
      { team: "GRC", current: 5, target: 11, gap: 4, avgSalary: "119k" },
      { team: "AppSec", current: 14, target: 10, gap: 3, avgSalary: "148k" },
      { team: "Cloud Sec", current: 6, target: 9, gap: 2, avgSalary: "177k" },
      { team: "Identity & Access", current: 15, target: 8, gap: 1, avgSalary: "95k" },
    ];
    const vendorSpend = [
      { vendor: "CrowdStrike", annual: "328k", contractEnd: "2026-09", renewalRisk: "Low", satisfaction: 5 },
      { vendor: "Palo Alto", annual: "359k", contractEnd: "2026-10", renewalRisk: "Medium", satisfaction: 4 },
      { vendor: "Splunk", annual: "390k", contractEnd: "2026-11", renewalRisk: "High", satisfaction: 3 },
      { vendor: "Qualys", annual: "421k", contractEnd: "2026-12", renewalRisk: "Low", satisfaction: 5 },
      { vendor: "Rapid7", annual: "452k", contractEnd: "2026-01", renewalRisk: "Medium", satisfaction: 4 },
      { vendor: "Mandiant", annual: "483k", contractEnd: "2026-02", renewalRisk: "High", satisfaction: 3 },
      { vendor: "Zscaler", annual: "514k", contractEnd: "2026-03", renewalRisk: "Low", satisfaction: 5 },
      { vendor: "Duo Security", annual: "545k", contractEnd: "2026-04", renewalRisk: "Medium", satisfaction: 4 },
    ];
    const roiProjections = [
      { area: "Threat Detection", investment: "714k", projectedReturn: "660k", roiMultiple: "1.9x", confidence: 80 },
      { area: "Incident Reduction", investment: "757k", projectedReturn: "707k", roiMultiple: "1.8x", confidence: 61 },
      { area: "Compliance Savings", investment: "800k", projectedReturn: "754k", roiMultiple: "1.7x", confidence: 78 },
      { area: "Automation Gains", investment: "843k", projectedReturn: "801k", roiMultiple: "1.6x", confidence: 95 },
      { area: "Risk Avoidance", investment: "886k", projectedReturn: "848k", roiMultiple: "1.5x", confidence: 76 },
    ];
    return html`
  ...
  private _renderMetricsNormalization() {
    const kpiCatalog = [
      { id: "kpi-1", name: "MTTD", owner: "SOC", unit: "minutes", target: 81, current: 98, benchmark: 96, collection: "auto", frequency: "realtime" },
      { id: "kpi-2", name: "MTTR", owner: "GRC", unit: "%", target: 84, current: 59, benchmark: 73, collection: "semi-auto", frequency: "daily" },
      { id: "kpi-3", name: "MTTC", owner: "AppSec", unit: "score", target: 87, current: 66, benchmark: 84, collection: "manual", frequency: "weekly" },
      { id: "kpi-4", name: "Vuln SLA Compliance", owner: "Cloud Sec", unit: "count", target: 90, current: 73, benchmark: 95, collection: "auto", frequency: "monthly" },
      { id: "kpi-5", name: "Patch Coverage", owner: "Identity", unit: "days", target: 93, current: 80, benchmark: 72, collection: "semi-auto", frequency: "realtime" },
      { id: "kpi-6", name: "Phishing Click Rate", owner: "Threat Intel", unit: "minutes", target: 96, current: 87, benchmark: 83, collection: "manual", frequency: "daily" },
      { id: "kpi-7", name: "Training Completion", owner: "Security Ops", unit: "%", target: 99, current: 94, benchmark: 94, collection: "auto", frequency: "weekly" },
      { id: "kpi-8", name: "Escalation Rate", owner: "Risk Mgmt", unit: "score", target: 72, current: 55, benchmark: 71, collection: "semi-auto", frequency: "monthly" },
      { id: "kpi-9", name: "False Positive Rate", owner: "SOC", unit: "count", target: 75, current: 62, benchmark: 82, collection: "manual", frequency: "realtime" },
      { id: "kpi-10", name: "Threat Intel Actionability", owner: "GRC", unit: "days", target: 78, current: 69, benchmark: 93, collection: "auto", frequency: "daily" },
      { id: "kpi-11", name: "Endpoint Compliance", owner: "AppSec", unit: "minutes", target: 81, current: 76, benchmark: 70, collection: "semi-auto", frequency: "weekly" },
      { id: "kpi-12", name: "Cloud Misconfig Score", owner: "Cloud Sec", unit: "%", target: 84, current: 83, benchmark: 81, collection: "manual", frequency: "monthly" },
      { id: "kpi-13", name: "Identity Anomaly Rate", owner: "Identity", unit: "score", target: 87, current: 90, benchmark: 92, collection: "auto", frequency: "realtime" },
      { id: "kpi-14", name: "DLP Events", owner: "Threat Intel", unit: "count", target: 90, current: 97, benchmark: 69, collection: "semi-auto", frequency: "daily" },
      { id: "kpi-15", name: "Vendor Risk Avg", owner: "Security Ops", unit: "days", target: 93, current: 58, benchmark: 80, collection: "manual", frequency: "weekly" },
      { id: "kpi-16", name: "Compliance Audit Pass Rate", owner: "Risk Mgmt", unit: "minutes", target: 96, current: 65, benchmark: 91, collection: "auto", frequency: "monthly" },
      { id: "kpi-17", name: "Awareness Score", owner: "SOC", unit: "%", target: 99, current: 72, benchmark: 68, collection: "semi-auto", frequency: "realtime" },
      { id: "kpi-18", name: "SOC Utilization", owner: "GRC", unit: "score", target: 72, current: 79, benchmark: 79, collection: "manual", frequency: "daily" },
      { id: "kpi-19", name: "Automation Coverage", owner: "AppSec", unit: "count", target: 75, current: 86, benchmark: 90, collection: "auto", frequency: "weekly" },
      { id: "kpi-20", name: "Risk Register Currency", owner: "Cloud Sec", unit: "days", target: 78, current: 93, benchmark: 67, collection: "semi-auto", frequency: "monthly" },
    ];
    const benchmarkSources = [
      { source: "NIST CSF", mappedKPIs: 8, alignment: 62, lastReview: "2026-06-20", status: "aligned" },
      { source: "CIS Controls v8", mappedKPIs: 3, alignment: 79, lastReview: "2026-01-15", status: "partial" },
      { source: "ISO 27001:2022", mappedKPIs: 4, alignment: 96, lastReview: "2026-02-10", status: "reviewing" },
      { source: "PCI DSS 4.0", mappedKPIs: 5, alignment: 74, lastReview: "2026-03-05", status: "aligned" },
      { source: "SOC 2 Type II", mappedKPIs: 6, alignment: 91, lastReview: "2026-04-28", status: "partial" },
      { source: "MITRE ATT&CK", mappedKPIs: 7, alignment: 69, lastReview: "2026-05-23", status: "reviewing" },
      { source: "SANS Top 20", mappedKPIs: 8, alignment: 86, lastReview: "2026-06-18", status: "aligned" },
      { source: "OWASP Top 10", mappedKPIs: 3, alignment: 64, lastReview: "2026-01-13", status: "partial" },
    ];
  ...
  private _renderThreatHuntingCampaigns() {
    const campaigns = [
      { id: "HC-1001", name: "Lateral Movement Sweep", status: "active", hypothesis: "H1: Actors using pass-the-hash for lateral movement", leadHunter: "Alice Chen", findings: 27, startDate: "2026-04-12", endDate: null, effectiveness: 70 },
      { id: "HC-1002", name: "Credential Harvesting Hunt", status: "completed", hypothesis: "H2: Actors using web shells for persistence", leadHunter: "Bob Martinez", findings: 30, startDate: "2026-03-23", endDate: "2026-05-01", effectiveness: 89 },
      { id: "HC-1003", name: "Persistence Mechanism Audit", status: "planned", hypothesis: "H3: Actors using scheduled tasks for data theft", leadHunter: "Carol Wu", findings: 33, startDate: "2026-02-06", endDate: null, effectiveness: 49 },
      { id: "HC-1004", name: "C2 Beacon Detection", status: "in-review", hypothesis: "H4: Actors using DNS tunneling for C2 communication", leadHunter: "Dave Kim", findings: 36, startDate: "2026-01-17", endDate: null, effectiveness: 68 },
      { id: "HC-1005", name: "Data Exfiltration Patterns", status: "active", hypothesis: "H5: Actors using encrypted channels for privilege escalation", leadHunter: "Eve Johnson", findings: 39, startDate: "2026-04-28", endDate: null, effectiveness: 87 },
      { id: "HC-1006", name: "Privilege Escalation Scan", status: "completed", hypothesis: "H6: Actors using token impersonation for defense evasion", leadHunter: "Frank Liu", findings: 42, startDate: "2026-03-11", endDate: "2026-06-13", effectiveness: 47 },
      { id: "HC-1007", name: "Supply Chain Implant Hunt", status: "planned", hypothesis: "H7: Actors using poisoned images for initial access", leadHunter: "Grace Park", findings: 45, startDate: "2026-02-22", endDate: null, effectiveness: 66 },
      { id: "HC-1008", name: "Insider Threat Indicators", status: "in-review", hypothesis: "H8: Actors using legitimate tools for credential access", leadHunter: "Hector Silva", findings: 0, startDate: "2026-01-05", endDate: null, effectiveness: 85 },
      { id: "HC-1009", name: "Cloud Metadata Analysis", status: "active", hypothesis: "H9: Actors using API keys for command execution", leadHunter: "Alice Chen", findings: 3, startDate: "2026-04-16", endDate: null, effectiveness: 45 },
      { id: "HC-1010", name: "DNS Tunnel Detection", status: "completed", hypothesis: "H10: Actors using encoded subdomains for exfiltration", leadHunter: "Bob Martinez", findings: 6, startDate: "2026-03-27", endDate: "2026-04-25", effectiveness: 64 },
      { id: "HC-1011", name: "Fileless Malware Search", status: "planned", hypothesis: "H11: Actors using WMI providers for discovery", leadHunter: "Carol Wu", findings: 9, startDate: "2026-02-10", endDate: null, effectiveness: 83 },
      { id: "HC-1012", name: "Zero-Day Exploit Traces", status: "in-review", hypothesis: "H12: Actors using exploit kits for collection", leadHunter: "Dave Kim", findings: 12, startDate: "2026-01-21", endDate: null, effectiveness: 43 },
    ];
    const hunterLeaderboard = [
      { hunter: "Alice Chen", campaigns: 4, findings: 60, highSeverity: 1, avgScore: 66, streak: 4 },
      { hunter: "Bob Martinez", campaigns: 14, findings: 89, highSeverity: 6, avgScore: 59, streak: 5 },
      { hunter: "Carol Wu", campaigns: 11, findings: 118, highSeverity: 11, avgScore: 96, streak: 6 },
      { hunter: "Dave Kim", campaigns: 8, findings: 31, highSeverity: 16, avgScore: 89, streak: 7 },
      { hunter: "Eve Johnson", campaigns: 5, findings: 60, highSeverity: 21, avgScore: 82, streak: 8 },
      { hunter: "Frank Liu", campaigns: 15, findings: 89, highSeverity: 0, avgScore: 75, streak: 1 },
      { hunter: "Grace Park", campaigns: 12, findings: 118, highSeverity: 5, avgScore: 68, streak: 2 },
      { hunter: "Hector Silva", campaigns: 9, findings: 31, highSeverity: 10, avgScore: 61, streak: 3 },
    ];
    const mitreMapping = [
      { tactic: "Initial Access", techniques: 2, campaigns: 4, coverage: 68 },
      { tactic: "Execution", techniques: 12, campaigns: 3, coverage: 48 },
      { tactic: "Persistence", techniques: 11, campaigns: 2, coverage: 99 },
      { tactic: "Privilege Escalation", techniques: 10, campaigns: 1, coverage: 79 },
      { tactic: "Defense Evasion", techniques: 9, campaigns: 6, coverage: 59 },
      { tactic: "Credential Access", techniques: 8, campaigns: 5, coverage: 39 },
      { tactic: "Discovery", techniques: 7, campaigns: 4, coverage: 90 },
      { tactic: "Lateral Movement", techniques: 6, campaigns: 3, coverage: 70 },
      { tactic: "Collection", techniques: 5, campaigns: 2, coverage: 50 },
      { tactic: "Exfiltration", techniques: 4, campaigns: 1, coverage: 30 },
      { tactic: "Command & Control", techniques: 3, campaigns: 6, coverage: 81 },
      { tactic: "Impact", techniques: 2, campaigns: 5, coverage: 61 },
    ];
    return html`
  ...
  private _renderControlInventory() {
    const controls = [
      { id: "CTL-2001", name: "MFA Enforcement", domain: "Access Control", status: "implemented", effectiveness: 67, lastTest: "2026-04-04", nextReview: "2026-08-04", owner: "SOC", risk: "Low" },
      { id: "CTL-2002", name: "Network Segmentation", domain: "Network Security", status: "partial", effectiveness: 32, lastTest: "2026-03-17", nextReview: "2026-09-23", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2003", name: "EDR Deployment", domain: "Endpoint Protection", status: "planned", effectiveness: 39, lastTest: "2026-02-02", nextReview: "2026-10-14", owner: "IT Ops", risk: "High" },
      { id: "CTL-2004", name: "DLP Policy", domain: "Data Protection", status: "gap", effectiveness: 46, lastTest: "2026-01-15", nextReview: "2026-11-05", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2005", name: "SSO Integration", domain: "Identity Management", status: "implemented", effectiveness: 79, lastTest: "2026-04-28", nextReview: "2026-12-24", owner: "IAM", risk: "Low" },
      { id: "CTL-2006", name: "SAST Pipeline", domain: "Application Security", status: "partial", effectiveness: 9, lastTest: "2026-03-13", nextReview: "2026-05-15", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2007", name: "CSPM Scanning", domain: "Cloud Security", status: "planned", effectiveness: 16, lastTest: "2026-02-26", nextReview: "2026-06-06", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2008", name: "Badge Access", domain: "Physical Security", status: "gap", effectiveness: 23, lastTest: "2026-01-11", nextReview: "2026-07-25", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2009", name: "Least Privilege", domain: "Access Control", status: "implemented", effectiveness: 91, lastTest: "2026-04-24", nextReview: "2026-08-16", owner: "SOC", risk: "Low" },
      { id: "CTL-2010", name: "Firewall Rules", domain: "Network Security", status: "partial", effectiveness: 37, lastTest: "2026-03-09", nextReview: "2026-09-07", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2011", name: "Disk Encryption", domain: "Endpoint Protection", status: "planned", effectiveness: 44, lastTest: "2026-02-22", nextReview: "2026-10-26", owner: "IT Ops", risk: "High" },
      { id: "CTL-2012", name: "Data Classification", domain: "Data Protection", status: "gap", effectiveness: 0, lastTest: "2026-01-07", nextReview: "2026-11-17", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2013", name: "PAM Implementation", domain: "Identity Management", status: "implemented", effectiveness: 44, lastTest: "2026-04-20", nextReview: "2026-12-08", owner: "IAM", risk: "Low" },
      { id: "CTL-2014", name: "DAST Pipeline", domain: "Application Security", status: "partial", effectiveness: 14, lastTest: "2026-03-05", nextReview: "2026-05-27", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2015", name: "IAM Policy Review", domain: "Cloud Security", status: "planned", effectiveness: 21, lastTest: "2026-02-18", nextReview: "2026-06-18", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2016", name: "Visitor Management", domain: "Physical Security", status: "gap", effectiveness: 28, lastTest: "2026-01-03", nextReview: "2026-07-09", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2017", name: "Access Reviews", domain: "Access Control", status: "implemented", effectiveness: 56, lastTest: "2026-04-16", nextReview: "2026-08-28", owner: "SOC", risk: "Low" },
      { id: "CTL-2018", name: "IDS/IPS Tuning", domain: "Network Security", status: "partial", effectiveness: 42, lastTest: "2026-03-01", nextReview: "2026-09-19", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2019", name: "Patch Management", domain: "Endpoint Protection", status: "planned", effectiveness: 49, lastTest: "2026-02-14", nextReview: "2026-10-10", owner: "IT Ops", risk: "High" },
      { id: "CTL-2020", name: "Backup Encryption", domain: "Data Protection", status: "gap", effectiveness: 5, lastTest: "2026-01-27", nextReview: "2026-11-01", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2021", name: "Password Policy", domain: "Identity Management", status: "implemented", effectiveness: 68, lastTest: "2026-04-12", nextReview: "2026-12-20", owner: "IAM", risk: "Low" },
      { id: "CTL-2022", name: "Container Scanning", domain: "Application Security", status: "partial", effectiveness: 19, lastTest: "2026-03-25", nextReview: "2026-05-11", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2023", name: "WAF Configuration", domain: "Cloud Security", status: "planned", effectiveness: 26, lastTest: "2026-02-10", nextReview: "2026-06-02", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2024", name: "CCTV Coverage", domain: "Physical Security", status: "gap", effectiveness: 33, lastTest: "2026-01-23", nextReview: "2026-07-21", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2025", name: "RBAC Enforcement", domain: "Access Control", status: "implemented", effectiveness: 80, lastTest: "2026-04-08", nextReview: "2026-08-12", owner: "SOC", risk: "Low" },
      { id: "CTL-2026", name: "VPN Management", domain: "Network Security", status: "partial", effectiveness: 47, lastTest: "2026-03-21", nextReview: "2026-09-03", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2027", name: "App Whitelisting", domain: "Endpoint Protection", status: "planned", effectiveness: 3, lastTest: "2026-02-06", nextReview: "2026-10-22", owner: "IT Ops", risk: "High" },
      { id: "CTL-2028", name: "Key Management", domain: "Data Protection", status: "gap", effectiveness: 10, lastTest: "2026-01-19", nextReview: "2026-11-13", owner: "Data Gov", risk: "Critical" },
    ];
    const gapAnalysis = [
      { gap: "Insufficient MFA coverage for legacy apps", severity: "High", remediationPlan: "Plan R3001", eta: "2026-Q3", estimatedCost: "142k" },
      { gap: "Missing network micro-segmentation", severity: "Medium", remediationPlan: "Plan R3002", eta: "2026-Q2", estimatedCost: "171k" },
      { gap: "Inconsistent EDR deployment", severity: "Medium", remediationPlan: "Plan R3003", eta: "2026-Q4", estimatedCost: "200k" },
      { gap: "DLP not covering cloud storage", severity: "Low", remediationPlan: "Plan R3004", eta: "2026-Q3", estimatedCost: "48k" },
      { gap: "SSO not integrated with all SaaS", severity: "High", remediationPlan: "Plan R3005", eta: "2026-Q2", estimatedCost: "77k" },
    ];
    return html`
  ...
  private _renderIncidentCostTracker() {
    const incidents = [
      { id: "INC-7001", name: "Security Incident 1", severity: "Critical", totalCost: 1565000, responseCost: 266050, recoveryCost: 344300, legalCost: 250400, regulatoryCost: 219100, insuranceClaim: 547750, avoidedCost: 240000, date: "2026-04-24" },
      { id: "INC-7002", name: "Security Incident 2", severity: "High", totalCost: 1568000, responseCost: 376320, recoveryCost: 517440, legalCost: 203840, regulatoryCost: 141120, insuranceClaim: 0, avoidedCost: 269000, date: "2026-03-05" },
      { id: "INC-7003", name: "Security Incident 3", severity: "Medium", totalCost: 1571000, responseCost: 487010, recoveryCost: 361330, legalCost: 157100, regulatoryCost: 235650, insuranceClaim: 471300, avoidedCost: 298000, date: "2026-02-14" },
      { id: "INC-7004", name: "Security Incident 4", severity: "Low", totalCost: 1574000, responseCost: 267580, recoveryCost: 535160, legalCost: 110180, regulatoryCost: 157400, insuranceClaim: 0, avoidedCost: 327000, date: "2026-01-23" },
      { id: "INC-7005", name: "Security Incident 5", severity: "Critical", totalCost: 1577000, responseCost: 378480, recoveryCost: 378480, legalCost: 315400, regulatoryCost: 78850, insuranceClaim: 1198520, avoidedCost: 356000, date: "2026-04-04" },
      { id: "INC-7006", name: "Security Incident 6", severity: "High", totalCost: 1580000, responseCost: 489800, recoveryCost: 553000, legalCost: 268600, regulatoryCost: 173800, insuranceClaim: 0, avoidedCost: 385000, date: "2026-03-13" },
      { id: "INC-7007", name: "Security Incident 7", severity: "Medium", totalCost: 1583000, responseCost: 269110, recoveryCost: 395750, legalCost: 221620, regulatoryCost: 94980, insuranceClaim: 1123930, avoidedCost: 414000, date: "2026-02-22" },
      { id: "INC-7008", name: "Security Incident 8", severity: "Low", totalCost: 1586000, responseCost: 380640, recoveryCost: 570960, legalCost: 174460, regulatoryCost: 190320, insuranceClaim: 0, avoidedCost: 443000, date: "2026-01-03" },
      { id: "INC-7009", name: "Security Incident 9", severity: "Critical", totalCost: 1589000, responseCost: 492590, recoveryCost: 413140, legalCost: 127120, regulatoryCost: 111230, insuranceClaim: 1048740, avoidedCost: 472000, date: "2026-04-12" },
      { id: "INC-7010", name: "Security Incident 10", severity: "High", totalCost: 1592000, responseCost: 270640, recoveryCost: 589040, legalCost: 79600, regulatoryCost: 206960, insuranceClaim: 0, avoidedCost: 5000, date: "2026-03-21" },
      { id: "INC-7011", name: "Security Incident 11", severity: "Medium", totalCost: 1595000, responseCost: 382800, recoveryCost: 430650, legalCost: 287100, regulatoryCost: 127600, insuranceClaim: 972950, avoidedCost: 34000, date: "2026-02-02" },
      { id: "INC-7012", name: "Security Incident 12", severity: "Low", totalCost: 1598000, responseCost: 495380, recoveryCost: 607240, legalCost: 239700, regulatoryCost: 223720, insuranceClaim: 0, avoidedCost: 63000, date: "2026-01-11" },
    ];
    const yearlyTrend = [
      { month: "Jan", incidents: 11, totalCost: "572k", avgCost: "56k", insured: 25 },
      { month: "Feb", incidents: 8, totalCost: "615k", avgCost: "103k", insured: 25 },
      { month: "Mar", incidents: 5, totalCost: "658k", avgCost: "150k", insured: 25 },
      { month: "Apr", incidents: 2, totalCost: "701k", avgCost: "197k", insured: 25 },
      { month: "May", incidents: 10, totalCost: "744k", avgCost: "63k", insured: 25 },
      { month: "Jun", incidents: 7, totalCost: "787k", avgCost: "110k", insured: 25 },
    ];
...
declare global { interface HTMLElementTagNameMap { 'sc-network-topo': ScNetworkTopo; } }
