...
export class ScVendorScorecard extends LitElement {
  ...
  private _data: MockItem[] = [
    {name:"CloudCorp (AWS)",status:"tier-1",risk:"low",detail:"Security score: 92/100 | SOC 2: Current | ISO 27001: Yes | Pen test: Annual | SLA: 99.99% | Contract: 2028"},
    {name:"DataSoft (DB Vendor)",status:"tier-2",risk:"medium",detail:"Security score: 78/100 | SOC 2: Expired | ISO 27001: No | Pen test: Never | SLA: 99.9% | Renewal: Q3"},
    {name:"SecureNet (VPN)",status:"tier-2",risk:"high",detail:"Security score: 65/100 | Incident: 2 in 2025 | Patch cadence: Slow | SLA breaches: 3 | Under review"},
    {name:"FinPay (Payment Processor)",status:"tier-1",risk:"low",detail:"Security score: 95/100 | PCI DSS: Level 1 | Pen test: Quarterly | SLA: 99.999% | PCI audit: Current"}
  ];
  ...
  render() {
    ...
    return html`<div class="panel"><div class="pt">Vendor Scorecard</div>
