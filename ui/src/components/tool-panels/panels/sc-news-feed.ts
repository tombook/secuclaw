...
@customElement('sc-news-feed')
export class ScNewsFeed extends LitElement {
  static styles = css`
...
@state() private _tablePage = 1;
  ...
  @state() private _comments: CommentEntry[] = [
    { id: 'c1', author: 'soc-tier1', timestamp: '2026-04-23 04:00', text: 'Initial assessment started for News Feed finding #1' },
  ...
  private _items: PanelItem[] = [
      {
            "id": "news-feed-1",
            "title": "CISA: Critical Vulnerability in OpenSSL 3.2",
            "severity": "critical",
            "status": "open",
            "category": "Security",
            "source": "SIEM",
            "description": "Source: CISA | Category: CVE | CVSS: 9.8 | Our exposure: 23 assets | Action: Emergency patch",
      ...
      {
            "id": "news-feed-2",
            "title": "NIST: Updated Cybersecurity Framework 2.0",
            "severity": "medium",
            "status": "in-progress",
            "category": "Network",
            "source": "EDR",
            "description": "Source: NIST | Category: Framework | Impact: Governance structure | Action: Gap assessment",
      ...
      {
            "id": "news-feed-3",
            "title": "GDPR: New Schrems III Ruling Impact",
            "severity": "high",
            "status": "resolved",
            "category": "Access",
            "source": "Scanner",
            "description": "Source: EDPB | Category: Regulatory | Impact: EU-US transfers | Action: Legal review",
      ...
      {
            "id": "news-feed-4",
            "title": "MITRE: ATT&CK v15 Released",
            "severity": "low",
            "status": "open",
            "category": "Compliance",
            "source": "Audit",
            "description": "Source: MITRE | Category: Research | New techniques: 12 | Action: Update detection rules",
      ...
      {
            "id": "news-feed-5",
            "title": "Industry: Cloud Security Alliance Summit",
            "severity": "low",
            "status": "in-progress",
            "category": "Operations",
            "source": "Manual",
            "description": "Source: CSA | Category: Industry | Date: May 2026 | Action: Register team",
      ...
      {
            "id": "news-feed-6",
            "title": "News Feed Finding #6",
            "severity": "high",
            "status": "open",
            "category": "Security",
            "source": "SIEM",
            "description": "Automated news feed assessment finding detected during routine scan of infrastructure component. Review and remediation recommended.",
  ...
  private _history: HistoryEntry[] = [
    { timestamp: '2026-04-23 04:15', action: 'Auto-correlated', user: 'system', details: 'Grouped related findings from News Feed analysis' },
    { timestamp: '2026-04-23 03:00', action: 'Created', user: 'scanner', details: 'New News Feed finding detected by automated assessment' },
    ...
    { timestamp: '2026-04-22 22:00', action: 'Resolved', user: 'security-eng', details: 'Remediation applied and verified for News Feed finding' },
    { timestamp: '2026-04-22 18:00', action: 'Created', user: 'audit', details: 'Compliance audit identified News Feed gap requiring remediation' },
    ...
    { timestamp: '2026-04-21 16:00', action: 'Resolved', user: 'soc-tier1', details: 'False positive confirmed - benign activity flagged by News Feed scan' },
    { timestamp: '2026-04-21 12:00', action: 'Exported', user: 'compliance', details: 'Exported News Feed findings for Q1 compliance report' },
  ];
...
private _workflowTasks: WorkflowTask[] = [
    { id: 'wt-1', title: 'Review News Feed finding #1', status: 'active', assignee: 'soc-tier1', blockedBy: [], slaDeadline: '2026-04-23T12:00:00Z', priority: 'p1', createdAt: '2026-04-23T00:00:00Z', completedAt: null },
    ...
    { id: 'wt-3', title: 'Update News Feed detection rules', status: 'blocked', assignee: 'soc-tier2', blockedBy: ['wt-2'], slaDeadline: '2026-04-24T00:00:00Z', priority: 'p2', createdAt: '2026-04-23T03:00:00Z', completedAt: null },
    ...
    { id: 'wt-8', title: 'Archive resolved News Feed findings', status: 'failed', assignee: 'soc-tier1', blockedBy: [], slaDeadline: '2026-04-23T08:00:00Z', priority: 'p4', createdAt: '2026-04-22T22:00:00Z', completedAt: null },
  ];

private _executionHistory: ExecutionRecord[] = [
    {
      id: 'exec-1', name: 'News Feed Full Assessment Run', startedAt: '2026-04-22T10:00:00Z', completedAt: '2026-04-22T10:12:00Z', status: 'success',
      steps: [
    ...
    {
      id: 'exec-2', name: 'News Feed Delta Scan', startedAt: '2026-04-23T02:00:00Z', completedAt: '2026-04-23T02:05:00Z', status: 'failed',
      steps: [
  ...
  private _runExecution() {
    ...
    const exec: ExecutionRecord = {
      id: 'exec-' + Date.now(), name: 'News Feed Assessment ' + new Date().toISOString().slice(0, 10), startedAt: new Date().toISOString(), completedAt: null, status: 'running', steps,
    };
  ...
  private _renderExecutionPanel(): unknown {
    ...
    return html`
      <div class="form-section">
        ...
        ` : html`<div class="empty-state">Click "Run Assessment" to start the News Feed analysis pipeline</div>`}
      </div>
      <div class="form-section">
        ...
        <div class="settings-card">
          ...
          <div style="display:flex;gap:8px;margin-top:4px;">
            <button class="btn primary" @click=${() => {
              ...
              const a = document.createElement('a'); a.href = url; a.download = 'news-feed-config.json'; a.click();
    ...
    return html`
      <div style="margin-top:12px;">
        ...
        <div style="display:flex;gap:6px;margin-top:8px;">
          <input class="search-box" type="text" placeholder="Add a comment..." style="min-width:auto;flex:1;" id="news-feed-comment-input" />
          <button class="btn primary" @click=${() => {
            const input = this.shadowRoot?.querySelector('#news-feed-comment-input') as HTMLInputElement;
  ...
  private _exportJSON() {
    ...
    const url = URL.createObjectURL(blob);
    const a = document.createElement('a'); a.href = url; a.download = 'sc-news-feed-data.json'; a.click();
    URL.revokeObjectURL(url);
  }
  ...
  private _exportCSV() {
    ...
    const url = URL.createObjectURL(blob);
    const a = document.createElement('a'); a.href = url; a.download = 'sc-news-feed-data.csv'; a.click();
    URL.revokeObjectURL(url);
  }


  // --- Domain Rules Engine ---
  @state() private _nfRules: { id: string; name: string; category: string; severity: Severity; enabled: boolean; lastEval: string; passRate: number }[] = [];
  private _initNfRules() {
    const rules = [
  ...
  private _evaluateNfRules(): { passed: number; failed: number; skipped: number; total: number } {
    let passed = 0, failed = 0, skipped = 0;
    this._nfRules.forEach(r => { if (!r.enabled) { skipped++; } else if (r.passRate >= 80) { passed++; } else { failed++; } });
    return { passed, failed, skipped, total: this._nfRules.length };
  }

  // --- CVSS Scoring ---
  @state() private _nfcvssData: { itemId: string; vector: string; base: number; temporal: number; environmental: number; overall: number }[] = [];
  private _initNfCvss() {
    ...
    this._nfcvssData = vectors.map((v, i) => {
  ...
  // --- Anomaly Detection ---
  @state() private _nfanomalies: { id: string; type: string; severity: Severity; description: string; detected: string; confidence: number; affected: string[] }[] = [];
  private _runNfAnomalyDetection() {
    const types = [
    ...
    this._nfanomalies = types.map((a, i) => ({
  ...
  // --- Trend Prediction ---
  @state() private _nfpredictions: { horizon: string; metric: string; current: number; predicted: number; direction: 'up' | 'down' | 'stable'; confidence: number }[] = [];
  private _generateNfPredictions() {
    this._nfpredictions = [
  ...
  // --- Approval Workflow ---
  @state() private _nfApprovals: { id: string; title: string; requester: string; status: 'pending' | 'approved' | 'rejected' | 'expired'; createdAt: string; priority: Priority; type: string }[] = [];
  private _initNfApprovals() {
    this._nfApprovals = [
  ...
  private _approveNfItem(id: string) { const item = this._nfApprovals.find(a => a.id === id); if (item) item.status = 'approved'; this.requestUpdate(); }
  private _rejectNfItem(id: string) { const item = this._nfApprovals.find(a => a.id === id); if (item) item.status = 'rejected'; this.requestUpdate(); }

  // --- Activity Feed ---
  @state() private _nfActivity: { id: string; action: string; user: string; target: string; timestamp: string }[] = [];
  private _initNfActivity() {
    const actions = [
    ...
    this._nfActivity = actions.map((a, i) => ({ id: 'ACT-' + String(i + 1).padStart(3, '0'), ...a, timestamp: new Date(Date.now() - i * 3600000).toISOString() }));
  }

  // --- Notification System ---
  @state() private _nfNotifications: { id: string; message: string; type: 'info' | 'warning' | 'error' | 'success'; read: boolean; timestamp: string }[] = [];
  private _initNfNotifications() {
    this._nfNotifications = [
  ...
  private _markNfNotifRead(id: string) { const n = this._nfNotifications.find(x => x.id === id); if (n) n.read = true; this.requestUpdate(); }

  // --- Panel Configuration ---
  @state() private _nfConfig: { layout: 'compact' | 'default' | 'expanded'; theme: 'dark' | 'midnight' | 'slate'; showAnomalies: boolean; showPredictions: boolean; autoRefresh: boolean; refreshInterval: number } = {
    layout: 'default', theme: 'dark', showAnomalies: true, showPredictions: true, autoRefresh: true, refreshInterval: 60,
  };
  private _nfPresets: { name: string; config: typeof this._nfConfig }[] = [
  ...
  private _applyNfPreset(preset: typeof this._nfPresets[0]) { this._nfConfig = { ...preset.config }; this.requestUpdate(); }

  private _renderNfTreemapSVG(): string {
    const categories = [
  ...
  private _renderNfSankeySVG(): string {
  ...
  // --- Render: Rules Engine ---
  private _renderNfRules(): any {
    const ev = this._evaluateNfRules();
    return html`
  ...
  private _renderNfAnomalies(): any {
  ...
  // --- Render: Approvals ---
  private _renderNfApprovals(): any {
          ...
          $${this._nfApprovals.map(a => html`
            <div style="padding:6px 8px;background:#1f2937;border-radius:4px">
              ...
              $${a.status === 'pending' ? html`
                <div style="display:flex;gap:4px;margin-top:4px">
                  <button class="btn success" style="padding:2px 8px;font-size:9px" @click=$${() => this._approveNfItem(a.id)}>Approve</button>
                  <button class="btn error" style="padding:2px 8px;font-size:9px" @click=$${() => this._rejectNfItem(a.id)}>Reject</button>
                </div>` : nothing}
            </div>`)}
        </div>
      </div>`;
  ...
  private _renderNfNotifications(): any {
    const tc = (t: string) => t === 'error' ? '#ef4444' : t === 'warning' ? '#eab308' : t === 'success' ? '#22c55e' : '#3b82f6';
    const unread = this._nfNotifications.filter(n => !n.read).length;
    return html`
      <div style="background:#1a1d27;border-radius:8px;padding:12px;margin-top:12px">
        ...
        <div style="display:flex;flex-direction:column;gap:4px;max-height:120px;overflow-y:auto">
          $${this._nfNotifications.map(n => html`
            <div style="display:flex;align-items:center;gap:8px;padding:4px 8px;background:$${n.read ? '#1f2937' : '#252a36'};border-radius:4px;font-size:10px;opacity:$${n.read ? '0.6' : '1'};cursor:pointer" @click=$${() => this._markNfNotifRead(n.id)}>
      ...
      <div style="background:#1a1d27;border-radius:8px;padding:12px;margin-top:12px">
        ...
        <div style="display:flex;flex-direction:column;gap:6px;font-size:10px">
          <div style="display:flex;align-items:center;gap:8px">
            ...
            <select class="form-input" style="flex:1" @change=$${(e: Event) => { this._nfConfig.layout = (e.target as HTMLSelectElement).value as any; this.requestUpdate(); }}>
              <option value="compact" ?selected=$${this._nfConfig.layout === 'compact'}>Compact</option>
              <option value="default" ?selected=$${this._nfConfig.layout === 'default'}>Default</option>
              <option value="expanded" ?selected=$${this._nfConfig.layout === 'expanded'}>Expanded</option>
            </select>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Theme</span>
            <select class="form-input" style="flex:1" @change=$${(e: Event) => { this._nfConfig.theme = (e.target as HTMLSelectElement).value as any; this.requestUpdate(); }}>
              <option value="dark" ?selected=$${this._nfConfig.theme === 'dark'}>Dark</option>
              <option value="midnight" ?selected=$${this._nfConfig.theme === 'midnight'}>Midnight</option>
              <option value="slate" ?selected=$${this._nfConfig.theme === 'slate'}>Slate</option>
            </select>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Auto Refresh</span>
            <input type="checkbox" ?checked=$${this._nfConfig.autoRefresh} @change=$${() => { this._nfConfig.autoRefresh = !this._nfConfig.autoRefresh; this.requestUpdate(); }}/>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Show Anomalies</span>
            <input type="checkbox" ?checked=$${this._nfConfig.showAnomalies} @change=$${() => { this._nfConfig.showAnomalies = !this._nfConfig.showAnomalies; this.requestUpdate(); }}/>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Show Predictions</span>
            <input type="checkbox" ?checked=$${this._nfConfig.showPredictions} @change=$${() => { this._nfConfig.showPredictions = !this._nfConfig.showPredictions; this.requestUpdate(); }}/>
          </div>
          <div style="margin-top:6px;font-weight:600">Presets</div>
          <div style="display:flex;gap:4px">
            $${this._nfPresets.map(ps => html`<button class="btn" style="padding:2px 8px;font-size:9px" @click=$${() => this._applyNfPreset(ps)}>$${ps.name}</button>`)}
          </div>
        </div>
      </div>`;
  }
  ...
  // === Threat Model Extended Data ===
  @state() private _threatModelHistory = [
    { modelId: 'TM-A001', version: '1.0', date: '2025-06-15', components: 18, threats: 32, mitigations: 25, riskScore: 85 },
    { modelId: 'TM-A001', version: '1.5', date: '2025-09-20', components: 20, threats: 38, mitigations: 34, riskScore: 78 },
    { modelId: 'TM-A001', version: '2.0', date: '2025-12-10', components: 22, threats: 42, mitigations: 40, riskScore: 74 },
    { modelId: 'TM-A001', version: '2.3', date: '2026-01-15', components: 24, threats: 45, mitigations: 42, riskScore: 72 },
  ] as any[];
  @state() private _threatMitigationTracking = [
    { threatId: 'T-001', description: 'SQL Injection via login form', status: 'mitigated',
      mitigation: 'Parameterized queries + input validation', residualRisk: 'low', lastVerified: '2026-01-10' },
    { threatId: 'T-002', description: 'XSS in search results', status: 'mitigated',
      mitigation: 'Output encoding + CSP headers', residualRisk: 'low', lastVerified: '2026-01-08' },
    { threatId: 'T-003', description: 'Privilege escalation via API', status: 'partially-mitigated',
      mitigation: 'RBAC implemented, missing attribute-based checks', residualRisk: 'medium', lastVerified: '2026-01-12' },
    { threatId: 'T-004', description: 'Data exfiltration via logs', status: 'unmitigated',
      mitigation: 'Planned: implement log sanitization', residualRisk: 'high', lastVerified: null },
    { threatId: 'T-005', description: 'Supply chain dependency attack', status: 'partially-mitigated',
      mitigation: 'SBOM scanning enabled, missing runtime verification', residualRisk: 'medium', lastVerified: '2026-01-05' },
  ] as any[];
  @state() private _threatAttackTreeTemplates = [
    { name: 'Authentication Bypass', goal: 'Gain unauthorized access', steps: [
      { step: 1, action: 'Reconnaissance', description: 'Identify auth endpoints and mechanisms' },
      { step: 2, action: 'Credential Harvesting', description: 'Phishing, brute force, or credential stuffing' },
      { step: 3, action: 'Authentication Bypass', description: 'Exploit weak auth or session management' },
      { step: 4, action: 'Privilege Escalation', description: 'Lateral movement to higher privileges' },
    ]},
    { name: 'Data Exfiltration', goal: 'Extract sensitive data', steps: [
      { step: 1, action: 'Initial Access', description: 'Compromise endpoint via vulnerability' },
      { step: 2, action: 'Internal Reconnaissance', description: 'Map data stores and access paths' },
      { step: 3, action: 'Data Collection', description: 'Aggregate target data from multiple sources' },
      { step: 4, action: 'Exfiltration', description: 'Transfer data via encrypted channel' },
    ]},
  ] as any[];

  private _calculateThreatCoverage(model: any): number {
    if (model.threats === 0) return 100;
    return Math.round((model.mitigations / model.threats) * 100);
  }

  private _identifyCriticalThreats(): any[] {
    return this._threatMitigationTracking.filter(t => t.status === 'unmitigated' || t.residualRisk === 'high');
  }

  private _generateThreatReportSummary(): { total: number; mitigated: number; partial: number; unmitigated: number; coverage: number } {
    const all = this._threatMitigationTracking;
    const mitigated = all.filter(t => t.status === 'mitigated').length;
    const partial = all.filter(t => t.status === 'partially-mitigated').length;
    const unmitigated = all.filter(t => t.status === 'unmitigated').length;
    return { total: all.length, mitigated, partial, unmitigated, coverage: Math.round((mitigated / all.length) * 100) };
  }
...
@state() private _spmNetworkSegment9 = { id: "NET-009", name: "Segment 9", subnet: "10.9.0.0/16", criticality: "high", deviceCount: 37, vulnerabilityCount: 3, lastScan: "2026-01-19" } as any;
  ...
  @state() private _newsFeedCourses: Array<{id:string;title:string;category:string;duration:number;enrolled:number;completed:number;difficulty:string;rating:number}> = [
  ...
  @state() private _newsFeedLearningPaths: Array<{id:string;name:string;courseIds:string[];progress:number;enrolled:number}> = [
  ...
  @state() private _newsFeedDeptCompliance: Array<{dept:string;trainedPct:number;targetPct:number;avgScore:number;certCount:number}> = [
  ...
  @state() private _newsFeedSkillsGaps: Array<{skill:string;current:number;required:number;gap:number;priority:string}> = [
  ...
  private _renderNewsfeedTraining(): TemplateResult {
    const courses = this._newsFeedCourses;
    const deptComp = this._newsFeedDeptCompliance;
    return html`
  ...
  @state() private _newsFeedZones: Array<{id:string;name:string;trustLevel:number;subnet:string;devices:number;policy:string;lastAudit:string}> = [
  ...
  @state() private _newsFeedSegRules: Array<{id:string;source:string;dest:string;action:string;protocol:string;port:string;status:string;hits:number}> = [
  ...
  @state() private _newsFeedCrossZoneTraffic: Array<{source:string;dest:string;bytes:number;sessions:number;violations:number}> = [
  ...
  @state() private _newsFeedMicroSegGaps: Array<{id:string;zone:string;gapType:string;severity:string;recommendation:string}> = [
  ...
  private _renderNewsfeedNetworkSeg(): TemplateResult {
    const zones = this._newsFeedZones;
    const gaps = this._newsFeedMicroSegGaps;
    return html`
  ...
  @state() private _newsFeedContainerScans: Array<{image:string;registry:string;critical:number;high:number;medium:number;scanDate:string;status:string}> = [
  ...
  @state() private _newsFeedK8sPods: Array<{namespace:string;pod:string;securityContext:string;hostIPC:boolean;hostPID:boolean;privileged:boolean;riskLevel:string}> = [
  ...
  @state() private _newsFeedServerlessRisk: Array<{function:string;runtime:string;timeout:number;iamPerms:string;externalCalls:number;riskScore:number}> = [
  ...
  @state() private _newsFeedRuntimeAlerts: Array<{id:string;workload:string;alertType:string;severity:string;description:string;timestamp:string}> = [
  ...
  private _renderNewsfeedCloudWl(): TemplateResult {
    const containers = this._newsFeedContainerScans;
    const pods = this._newsFeedK8sPods;
    const alerts = this._newsFeedRuntimeAlerts;
    return html`
  ...
  @state() private _newsFeedCorrRules: Array<{id:string;name:string;sources:string[];logic:string;severity:string;active:boolean;lastTriggered:string}> = [
  ...
  @state() private _newsFeedEventTimeline: Array<{timestamp:string;source:string;eventType:string;details:string;correlated:boolean}> = [
  ...
  @state() private _newsFeedFalsePosMetrics: {totalEvents:number;correlatedEvents:number;falsePositives:number;fpRate:number;topFpRules:string[]} = {
  ...
  @state() private _newsFeedEventPatterns: Array<{id:string;pattern:string;frequency:number;firstSeen:string;lastSeen:string;status:string}> = [
  ...
  private _renderNewsfeedEventCorr(): TemplateResult {
    const rules = this._newsFeedCorrRules;
    const timeline = this._newsFeedEventTimeline;
    const fpMetrics = this._newsFeedFalsePosMetrics;
    return html`
  ...
  @state() private _complianceCalendarEvents: Array<{id: string; title: string; deadline: string; category: string; status: string; assignee: string; notes: string}> = [
    {id: 'cc-news-feed-001', title: 'SOX Section 404 Compliance Review', deadline: '2026-06-30', category: 'Regulatory', status: 'In Progress', assignee: 'Compliance Team', notes: 'Annual internal control assessment for financial reporting'},
    {id: 'cc-news-feed-002', title: 'GDPR Data Protection Impact Assessment', deadline: '2026-05-15', category: 'Privacy', status: 'Pending', assignee: 'DPO Office', notes: 'Quarterly DPIA for high-risk processing activities'},
    {id: 'cc-news-feed-003', title: 'ISO 27001 Surveillance Audit', deadline: '2026-07-20', category: 'Certification', status: 'Scheduled', assignee: 'QA Lead', notes: 'Stage 2 surveillance audit for ISMS certification renewal'},
    {id: 'cc-news-feed-004', title: 'PCI DSS v4.0 Gap Analysis', deadline: '2026-05-30', category: 'Payment', status: 'Not Started', assignee: 'Security Architect', notes: 'Assess current state against PCI DSS v4.0 requirements'},
    {id: 'cc-news-feed-005', title: 'NIST CSF Self-Assessment', deadline: '2026-08-15', category: 'Framework', status: 'Pending', assignee: 'CISO', notes: 'Biannual self-assessment against NIST Cybersecurity Framework'},
    {id: 'cc-news-feed-006', title: 'HIPAA Security Rule Audit', deadline: '2026-06-15', category: 'Healthcare', status: 'In Progress', assignee: 'Compliance Analyst', notes: 'Annual audit of administrative, physical, and technical safeguards'},
    {id: 'cc-news-feed-007', title: 'SOC 2 Type II Report Renewal', deadline: '2026-09-30', category: 'Audit', status: 'Scheduled', assignee: 'External Auditor', notes: 'Engage auditor for SOC 2 Type II examination period'},
    {id: 'cc-news-feed-008', title: 'FedRAMP Authorization Review', deadline: '2026-07-01', category: 'Government', status: 'Pending', assignee: 'FedRAMP PMO', notes: 'Review and update security authorization package'},
    {id: 'cc-news-feed-009', title: 'Annual Penetration Test', deadline: '2026-10-15', category: 'Testing', status: 'Not Started', assignee: 'Red Team Lead', notes: 'Comprehensive external and internal penetration testing engagement'},
    {id: 'cc-news-feed-010', title: 'Security Awareness Training Rollout', deadline: '2026-05-01', category: 'Training', status: 'Completed', assignee: 'Security Awareness Manager', notes: 'Q2 organization-wide security awareness training program'},
    {id: 'cc-news-feed-011', title: 'Vendor Security Review Cycle', deadline: '2026-06-01', category: 'Third Party', status: 'In Progress', assignee: 'Vendor Manager', notes: 'Quarterly review of critical vendor security posture and SLA compliance'},
    {id: 'cc-news-feed-012', title: 'Incident Response Plan Update', deadline: '2026-05-20', category: 'Operations', status: 'Pending', assignee: 'IR Team Lead', notes: 'Update IR procedures based on lessons learned from recent incidents'},
  ];
  ...
  @state() private _dataQualityMetrics: Array<{id: string; dataSource: string; completenessScore: number; accuracyScore: number; timelinessScore: number; consistencyScore: number; reliabilityRank: number; lastUpdated: string; issues: string[]; trend: string}> = [
    {id: 'dq-news-feed-001', dataSource: 'Vulnerability Scanner Feed', completenessScore: 94, accuracyScore: 91, timelinessScore: 88, consistencyScore: 95, reliabilityRank: 1, lastUpdated: '2026-04-23T08:00:00Z', issues: ['Minor delay in Nessus plugin updates'], trend: 'improving'},
    {id: 'dq-news-feed-002', dataSource: 'SIEM Event Logs', completenessScore: 87, accuracyScore: 93, timelinessScore: 96, consistencyScore: 89, reliabilityRank: 2, lastUpdated: '2026-04-23T07:30:00Z', issues: ['Some log sources showing gaps in off-hours'], trend: 'stable'},
    {id: 'dq-news-feed-003', dataSource: 'Asset Inventory Database', completenessScore: 82, accuracyScore: 78, timelinessScore: 75, consistencyScore: 84, reliabilityRank: 4, lastUpdated: '2026-04-22T18:00:00Z', issues: ['Shadow IT devices not fully cataloged', 'Decommissioned assets still listed'], trend: 'declining'},
    {id: 'dq-news-feed-004', dataSource: 'Threat Intelligence Platform', completenessScore: 91, accuracyScore: 89, timelinessScore: 92, consistencyScore: 87, reliabilityRank: 3, lastUpdated: '2026-04-23T06:00:00Z', issues: ['Some IOC sources lack confidence scoring'], trend: 'improving'},
    {id: 'dq-news-feed-005', dataSource: 'Identity Provider Logs', completenessScore: 96, accuracyScore: 97, timelinessScore: 98, consistencyScore: 96, reliabilityRank: 1, lastUpdated: '2026-04-23T09:00:00Z', issues: [], trend: 'stable'},
    {id: 'dq-news-feed-006', dataSource: 'Cloud Security Posture Data', completenessScore: 79, accuracyScore: 85, timelinessScore: 82, consistencyScore: 81, reliabilityRank: 5, lastUpdated: '2026-04-23T05:00:00Z', issues: ['Multi-cloud coverage gaps', 'API rate limiting affects scan frequency'], trend: 'declining'},
    {id: 'dq-news-feed-007', dataSource: 'Compliance Evidence Store', completenessScore: 88, accuracyScore: 86, timelinessScore: 80, consistencyScore: 83, reliabilityRank: 4, lastUpdated: '2026-04-21T14:00:00Z', issues: ['Manual evidence collection delays', 'Inconsistent formatting across frameworks'], trend: 'stable'},
    {id: 'dq-news-feed-008', dataSource: 'Network Flow Data', completenessScore: 92, accuracyScore: 90, timelinessScore: 94, consistencyScore: 91, reliabilityRank: 2, lastUpdated: '2026-04-23T08:30:00Z', issues: ['Encrypted traffic classification accuracy needs improvement'], trend: 'improving'},
  ];
  ...
  @state() private _workflowTemplates: Array<{id: string; name: string; description: string; category: string; steps: number; avgDuration: string; successRate: number; lastRun: string; manualInterventions: number; optimizationScore: number}> = [
    {id: 'wf-news-feed-001', name: 'Vulnerability Triage Pipeline', description: 'Automated vulnerability assessment, prioritization, and assignment workflow', category: 'Vulnerability Management', steps: 8, avgDuration: '12 min', successRate: 94.5, lastRun: '2026-04-23T06:00:00Z', manualInterventions: 2, optimizationScore: 87},
    {id: 'wf-news-feed-002', name: 'Incident Response Orchestration', description: 'End-to-end IR workflow from detection to containment and recovery', category: 'Incident Response', steps: 15, avgDuration: '45 min', successRate: 89.2, lastRun: '2026-04-22T14:30:00Z', manualInterventions: 5, optimizationScore: 72},
    {id: 'wf-news-feed-003', name: 'Access Request Approval Chain', description: 'Multi-level approval workflow for privileged access requests', category: 'Identity & Access', steps: 6, avgDuration: '4 hours', successRate: 97.1, lastRun: '2026-04-23T09:15:00Z', manualInterventions: 1, optimizationScore: 92},
    {id: 'wf-news-feed-004', name: 'Compliance Evidence Collection', description: 'Automated gathering and packaging of audit evidence artifacts', category: 'Compliance', steps: 10, avgDuration: '30 min', successRate: 91.8, lastRun: '2026-04-21T10:00:00Z', manualInterventions: 3, optimizationScore: 78},
    {id: 'wf-news-feed-005', name: 'Security Patch Deployment', description: 'Staged patch rollout with validation and rollback capability', category: 'Patch Management', steps: 12, avgDuration: '2 hours', successRate: 96.3, lastRun: '2026-04-20T22:00:00Z', manualInterventions: 1, optimizationScore: 85},
    {id: 'wf-news-feed-006', name: 'Threat Intelligence Enrichment', description: 'IOC enrichment and correlation with internal threat data', category: 'Threat Intelligence', steps: 7, avgDuration: '8 min', successRate: 93.7, lastRun: '2026-04-23T07:00:00Z', manualInterventions: 0, optimizationScore: 95},
    {id: 'wf-news-feed-007', name: 'Security Reporting Pipeline', description: 'Automated generation and distribution of security metrics reports', category: 'Reporting', steps: 5, avgDuration: '15 min', successRate: 98.9, lastRun: '2026-04-23T08:00:00Z', manualInterventions: 0, optimizationScore: 97},
    {id: 'wf-news-feed-008', name: 'Vendor Risk Assessment', description: 'Automated vendor security questionnaire distribution and scoring', category: 'Third Party', steps: 9, avgDuration: '3 days', successRate: 85.4, lastRun: '2026-04-19T11:00:00Z', manualInterventions: 4, optimizationScore: 65},
  ];
  ...
  @state() private _workflowExecutionHistory: Array<{workflowId: string; runDate: string; duration: string; status: string; trigger: string}> = [
    {workflowId: 'wf-news-feed-001', runDate: '2026-04-23T06:00:00Z', duration: '11 min 23 sec', status: 'Success', trigger: 'Scheduled'},
    {workflowId: 'wf-news-feed-002', runDate: '2026-04-22T14:30:00Z', duration: '42 min 15 sec', status: 'Success', trigger: 'Alert'},
    {workflowId: 'wf-news-feed-003', runDate: '2026-04-23T09:15:00Z', duration: '3h 45 min', status: 'Success', trigger: 'User Request'},
    {workflowId: 'wf-news-feed-001', runDate: '2026-04-22T06:00:00Z', duration: '13 min 08 sec', status: 'Partial', trigger: 'Scheduled'},
    {workflowId: 'wf-news-feed-004', runDate: '2026-04-21T10:00:00Z', duration: '28 min 42 sec', status: 'Success', trigger: 'Scheduled'},
  ];
  ...
  @state() private _knowledgeArticles: Array<{id: string; title: string; category: string; author: string; publishDate: string; views: number; rating: number; tags: string[]; summary: string; readTime: string}> = [
    {id: 'kb-news-feed-001', title: 'Zero Trust Architecture Implementation Guide', category: 'Architecture', author: 'Security Architecture Team', publishDate: '2026-03-15', views: 1842, rating: 4.8, tags: ['zero-trust', 'network', 'identity'], summary: 'Comprehensive guide for implementing zero trust principles across enterprise infrastructure', readTime: '15 min'},
    {id: 'kb-news-feed-002', title: 'Ransomware Defense Playbook 2026', category: 'Threats', author: 'Threat Intelligence Team', publishDate: '2026-04-01', views: 2341, rating: 4.9, tags: ['ransomware', 'incident-response', 'defense'], summary: 'Updated playbook with latest ransomware tactics, techniques, and defensive measures', readTime: '12 min'},
    {id: 'kb-news-feed-003', title: 'Cloud Security Best Practices for Multi-Cloud', category: 'Cloud', author: 'Cloud Security Team', publishDate: '2026-02-28', views: 1567, rating: 4.5, tags: ['cloud', 'aws', 'azure', 'gcp'], summary: 'Best practices for securing workloads across multiple cloud service providers', readTime: '18 min'},
    {id: 'kb-news-feed-004', title: 'API Security Testing Methodology', category: 'Testing', author: 'Red Team', publishDate: '2026-03-22', views: 987, rating: 4.6, tags: ['api', 'testing', 'owasp'], summary: 'Structured methodology for identifying and testing API security vulnerabilities', readTime: '10 min'},
    {id: 'kb-news-feed-005', title: 'Supply Chain Security Risk Management', category: 'Third Party', author: 'GRC Team', publishDate: '2026-01-20', views: 1234, rating: 4.3, tags: ['supply-chain', 'vendor', 'risk'], summary: 'Framework for managing security risks in the software supply chain', readTime: '14 min'},
    {id: 'kb-news-feed-006', title: 'Kubernetes Security Hardening Checklist', category: 'Container', author: 'Platform Security', publishDate: '2026-04-10', views: 2103, rating: 4.7, tags: ['kubernetes', 'container', 'hardening'], summary: 'Step-by-step hardening checklist for production Kubernetes clusters', readTime: '11 min'},
    {id: 'kb-news-feed-007', title: 'Security Metrics That Matter for Executives', category: 'Metrics', author: 'CISO Office', publishDate: '2026-03-05', views: 876, rating: 4.4, tags: ['metrics', 'kpi', 'reporting'], summary: 'Key security metrics and KPIs that resonate with board-level stakeholders', readTime: '8 min'},
    {id: 'kb-news-feed-008', title: 'Phishing Simulation Campaign Design', category: 'Awareness', author: 'Security Awareness Team', publishDate: '2026-02-15', views: 1456, rating: 4.5, tags: ['phishing', 'simulation', 'training'], summary: 'Designing effective phishing simulations that drive real behavioral change', readTime: '9 min'},
    {id: 'kb-news-feed-009', title: 'Data Loss Prevention Strategy and Implementation', category: 'Data Protection', author: 'Data Security Team', publishDate: '2026-03-28', views: 1678, rating: 4.6, tags: ['dlp', 'data-protection', 'compliance'], summary: 'Strategic approach to DLP covering people, process, and technology layers', readTime: '16 min'},
    {id: 'kb-news-feed-010', title: 'Security Automation with SOAR Platforms', category: 'Automation', author: 'SOC Engineering', publishDate: '2026-04-05', views: 1098, rating: 4.7, tags: ['soar', 'automation', 'soc'], summary: 'Building effective security automation playbooks using SOAR technology', readTime: '13 min'},
    {id: 'kb-news-feed-011', title: 'Third-Party Risk Assessment Framework', category: 'GRC', author: 'Vendor Management', publishDate: '2026-01-30', views: 1345, rating: 4.4, tags: ['vendor', 'risk', 'assessment'], summary: 'Structured framework for evaluating and monitoring third-party security risks', readTime: '12 min'},
    {id: 'kb-news-feed-012', title: 'Network Detection and Response Best Practices', category: 'Network', author: 'Network Security Team', publishDate: '2026-03-18', views: 1567, rating: 4.5, tags: ['ndr', 'network', 'detection'], summary: 'Implementing effective network detection and response capabilities', readTime: '14 min'},
    {id: 'kb-news-feed-013', title: 'Security Chaos Engineering Guide', category: 'Resilience', author: 'SRE Security', publishDate: '2026-04-12', views: 789, rating: 4.3, tags: ['chaos-engineering', 'resilience', 'testing'], summary: 'Applying chaos engineering principles to validate security controls', readTime: '10 min'},
    {id: 'kb-news-feed-014', title: 'Incident Communication Templates', category: 'Incident Response', author: 'IR Team', publishDate: '2026-02-22', views: 2234, rating: 4.8, tags: ['incident', 'communication', 'templates'], summary: 'Ready-to-use communication templates for security incident scenarios', readTime: '7 min'},
    {id: 'kb-news-feed-015', title: 'Endpoint Detection and Response Configuration', category: 'Endpoint', author: 'Endpoint Security', publishDate: '2026-03-08', views: 1345, rating: 4.5, tags: ['edr', 'endpoint', 'configuration'], summary: 'Optimal EDR configuration for maximum detection with minimal false positives', readTime: '11 min'},
    {id: 'kb-news-feed-016', title: 'Security Code Review Standards', category: 'Development', author: 'AppSec Team', publishDate: '2026-02-10', views: 1890, rating: 4.6, tags: ['code-review', 'secure-sdlc', 'standards'], summary: 'Standards and checklists for security-focused code reviews', readTime: '13 min'},
    {id: 'kb-news-feed-017', title: 'IoT Security Assessment Methodology', category: 'IoT', author: 'IoT Security Lab', publishDate: '2026-04-08', views: 654, rating: 4.2, tags: ['iot', 'embedded', 'assessment'], summary: 'Methodology for assessing security posture of IoT devices and ecosystems', readTime: '15 min'},
    {id: 'kb-news-feed-018', title: 'Passwordless Authentication Migration Guide', category: 'Identity', author: 'IAM Team', publishDate: '2026-03-25', views: 1678, rating: 4.7, tags: ['passwordless', 'authentication', 'mfa'], summary: 'Step-by-step migration plan from password-based to passwordless authentication', readTime: '12 min'},
    {id: 'kb-news-feed-019', title: 'Security Awareness Program Metrics', category: 'Awareness', author: 'Security Culture Team', publishDate: '2026-01-25', views: 1123, rating: 4.4, tags: ['awareness', 'metrics', 'culture'], summary: 'Measuring the effectiveness of your security awareness and training programs', readTime: '9 min'},
    {id: 'kb-news-feed-020', title: 'Deception Technology Deployment Guide', category: 'Detection', author: 'Blue Team', publishDate: '2026-04-15', views: 876, rating: 4.5, tags: ['deception', 'honeypot', 'detection'], summary: 'Planning and deploying deception technology for advanced threat detection', readTime: '11 min'},
  ];
  ...
  // --- Security Scenario Planning Methods (NEFE) ---
  private _initNefeScenarios(): void {
    const worstCaseScenarios = [
      { id: "nefe-sc-01", name: "Ransomware Attack on Critical Infrastructure", category: "Malware", impact: 9500000, probability: 0.12, recoveryDays: 21, affectedSystems: 47, dataLossGb: 320, businessImpact: "critical" },
      { id: "nefe-sc-02", name: "Insider Data Exfiltration via Authorized Channels", category: "Insider Threat", impact: 7200000, probability: 0.18, recoveryDays: 14, affectedSystems: 12, dataLossGb: 85, businessImpact: "high" },
      { id: "nefe-sc-03", name: "Supply Chain Compromise via Third-Party Library", category: "Supply Chain", impact: 6800000, probability: 0.09, recoveryDays: 30, affectedSystems: 63, dataLossGb: 0, businessImpact: "critical" },
      { id: "nefe-sc-04", name: "Cloud Misconfiguration Leading to Public Exposure", category: "Cloud", impact: 4100000, probability: 0.22, recoveryDays: 7, affectedSystems: 8, dataLossGb: 450, businessImpact: "high" },
      { id: "nefe-sc-05", name: "Zero-Day Exploit in Core Application Framework", category: "Vulnerability", impact: 8900000, probability: 0.05, recoveryDays: 45, affectedSystems: 120, dataLossGb: 0, businessImpact: "critical" },
      { id: "nefe-sc-06", name: "Distributed Denial of Service on Customer-Facing Services", category: "Availability", impact: 3400000, probability: 0.25, recoveryDays: 3, affectedSystems: 15, dataLossGb: 0, businessImpact: "medium" },
      { id: "nefe-sc-07", name: "Credential Stuffing and Account Takeover Wave", category: "Identity", impact: 2800000, probability: 0.30, recoveryDays: 5, affectedSystems: 6, dataLossGb: 12, businessImpact: "medium" },
      { id: "nefe-sc-08", name: "Physical Security Breach at Data Center Facility", category: "Physical", impact: 12000000, probability: 0.02, recoveryDays: 60, affectedSystems: 200, dataLossGb: 5000, businessImpact: "critical" },
    ];
    this._nefeScenarios = worstCaseScenarios.map(s => ({ ...s, mitigationCost: Math.round(s.impact * 0.08), drillScheduled: false, lastDrillDate: null, drillScore: null, controlGaps: Math.floor(Math.random() * 5) + 1 }));
  }

  private _calculateNefeScenarioRisk(): void {
    this._nefeScenarios.forEach(s => {
  ...
  private _scheduleNefeDrills(): void {
  ...
  private _nefeScenarioComparison(): Record<string, unknown>[] {
    return this._nefeScenarios.map(s => ({
  ...
  // --- Security Control Effectiveness Analytics (NEFE) ---
  private _initNefeControls(): void {
    const controls = [
      { id: "nefe-ct-01", name: "Network Segmentation", type: "preventive", maturity: "defined", score: 82, target: 90, failures: 3, lastTest: "2026-03-15" },
      { id: "nefe-ct-02", name: "Endpoint Detection and Response", type: "detective", maturity: "managed", score: 88, target: 92, failures: 1, lastTest: "2026-04-01" },
      { id: "nefe-ct-03", name: "Data Loss Prevention", type: "preventive", maturity: "repeatable", score: 71, target: 85, failures: 7, lastTest: "2026-03-22" },
      { id: "nefe-ct-04", name: "Security Information and Event Management", type: "detective", maturity: "managed", score: 85, target: 90, failures: 2, lastTest: "2026-04-05" },
      { id: "nefe-ct-05", name: "Identity and Access Management", type: "preventive", maturity: "defined", score: 76, target: 88, failures: 5, lastTest: "2026-03-28" },
      { id: "nefe-ct-06", name: "Vulnerability Management", type: "corrective", maturity: "managed", score: 80, target: 90, failures: 4, lastTest: "2026-04-02" },
      { id: "nefe-ct-07", name: "Email Security Gateway", type: "preventive", maturity: "managed", score: 90, target: 95, failures: 1, lastTest: "2026-04-08" },
      { id: "nefe-ct-08", name: "Web Application Firewall", type: "preventive", maturity: "managed", score: 87, target: 92, failures: 2, lastTest: "2026-03-30" },
      { id: "nefe-ct-09", name: "Patch Management", type: "corrective", maturity: "defined", score: 68, target: 85, failures: 9, lastTest: "2026-03-18" },
      { id: "nefe-ct-10", name: "Encryption at Rest", type: "preventive", maturity: "managed", score: 93, target: 95, failures: 0, lastTest: "2026-04-10" },
      { id: "nefe-ct-11", name: "Encryption in Transit", type: "preventive", maturity: "optimized", score: 96, target: 98, failures: 0, lastTest: "2026-04-12" },
      { id: "nefe-ct-12", name: "Privileged Access Management", type: "preventive", maturity: "defined", score: 74, target: 88, failures: 6, lastTest: "2026-03-25" },
      { id: "nefe-ct-13", name: "Security Awareness Training", type: "preventive", maturity: "repeatable", score: 65, target: 80, failures: 11, lastTest: "2026-03-20" },
      { id: "nefe-ct-14", name: "Incident Response Plan", type: "corrective", maturity: "managed", score: 78, target: 88, failures: 4, lastTest: "2026-04-03" },
      { id: "nefe-ct-15", name: "Backup and Recovery", type: "corrective", maturity: "managed", score: 84, target: 92, failures: 3, lastTest: "2026-04-06" },
      { id: "nefe-ct-16", name: "Multi-Factor Authentication", type: "preventive", maturity: "managed", score: 91, target: 95, failures: 1, lastTest: "2026-04-09" },
      { id: "nefe-ct-17", name: "Network Traffic Analysis", type: "detective", maturity: "defined", score: 72, target: 85, failures: 5, lastTest: "2026-03-27" },
      { id: "nefe-ct-18", name: "Cloud Security Posture Management", type: "detective", maturity: "repeatable", score: 69, target: 82, failures: 8, lastTest: "2026-03-24" },
      { id: "nefe-ct-19", name: "Container Security Scanning", type: "preventive", maturity: "defined", score: 75, target: 85, failures: 5, lastTest: "2026-04-04" },
      { id: "nefe-ct-20", name: "API Security Gateway", type: "preventive", maturity: "repeatable", score: 70, target: 82, failures: 7, lastTest: "2026-03-29" },
      { id: "nefe-ct-21", name: "Threat Intelligence Platform", type: "detective", maturity: "managed", score: 83, target: 90, failures: 2, lastTest: "2026-04-07" },
      { id: "nefe-ct-22", name: "Database Activity Monitoring", type: "detective", maturity: "defined", score: 67, target: 80, failures: 8, lastTest: "2026-03-21" },
      { id: "nefe-ct-23", name: "Deception Technology", type: "detective", maturity: "initial", score: 55, target: 75, failures: 12, lastTest: "2026-03-16" },
      { id: "nefe-ct-24", name: "Security Orchestration Automation", type: "corrective", maturity: "repeatable", score: 73, target: 85, failures: 6, lastTest: "2026-04-01" },
      { id: "nefe-ct-25", name: "Third-Party Risk Assessment", type: "preventive", maturity: "defined", score: 64, target: 78, failures: 9, lastTest: "2026-03-19" },
    ];
    this._nefeControls = controls;
  }

  private _analyzeNefeControlEffectiveness(): void {
    const typeBreakdown: Record<string, { total: number; avgScore: number; avgFailures: number }> = {};
    this._nefeControls.forEach(c => {
    ...
    this._nefeControlTypeBreakdown = typeBreakdown;
  }

  private _nefeControlOptimization(): Record<string, unknown>[] {
    return this._nefeControls.filter(c => c.score < c.target).map(c => ({
  ...
  // --- Security Data Pipeline Health (NEFE) ---
  private _initNefePipelines(): void {
    const pipelines = [
      { id: "nefe-pl-01", name: "SIEM Log Ingestion", status: "healthy", healthScore: 94, latencyMs: 120, freshnessMin: 2, errorRate: 0.02, throughputMbps: 450, recordsPerSec: 12000, backPressure: 0.05, uptime: 99.97 },
      { id: "nefe-pl-02", name: "Threat Feed Aggregation", status: "healthy", healthScore: 91, latencyMs: 300, freshnessMin: 15, errorRate: 0.05, throughputMbps: 85, recordsPerSec: 3200, backPressure: 0.08, uptime: 99.92 },
      { id: "nefe-pl-03", name: "Vulnerability Scan Results", status: "degraded", healthScore: 72, latencyMs: 2500, freshnessMin: 60, errorRate: 0.15, throughputMbps: 25, recordsPerSec: 800, backPressure: 0.35, uptime: 98.50 },
      { id: "nefe-pl-04", name: "Endpoint Telemetry Stream", status: "healthy", healthScore: 88, latencyMs: 450, freshnessMin: 5, errorRate: 0.08, throughputMbps: 280, recordsPerSec: 8500, backPressure: 0.12, uptime: 99.85 },
      { id: "nefe-pl-05", name: "Cloud Audit Log Pipeline", status: "healthy", healthScore: 86, latencyMs: 600, freshnessMin: 10, errorRate: 0.06, throughputMbps: 150, recordsPerSec: 4500, backPressure: 0.10, uptime: 99.80 },
      { id: "nefe-pl-06", name: "Identity Event Stream", status: "warning", healthScore: 78, latencyMs: 1200, freshnessMin: 20, errorRate: 0.12, throughputMbps: 45, recordsPerSec: 1500, backPressure: 0.22, uptime: 99.40 },
      { id: "nefe-pl-07", name: "Network Flow Collection", status: "healthy", healthScore: 82, latencyMs: 800, freshnessMin: 8, errorRate: 0.09, throughputMbps: 650, recordsPerSec: 18000, backPressure: 0.15, uptime: 99.70 },
      { id: "nefe-pl-08", name: "DLP Incident Pipeline", status: "degraded", healthScore: 68, latencyMs: 3500, freshnessMin: 45, errorRate: 0.20, throughputMbps: 18, recordsPerSec: 500, backPressure: 0.42, uptime: 97.80 },
    ];
    this._nefePipelines = pipelines.map(p => ({ ...p, dependencies: [], slaBreached: p.healthScore < 75, alertThreshold: p.errorRate > 0.15 }));
    this._nefePipelines[0].dependencies = ["nefe-pl-04", "nefe-pl-07"];
    this._nefePipelines[4].dependencies = ["nefe-pl-01"];
    this._nefePipelines[5].dependencies = ["nefe-pl-02"];
    this._nefePipelines[7].dependencies = ["nefe-pl-04", "nefe-pl-05"];
  }

  private _nefePipelineTrend(): Record<string, unknown>[] {
    const hours = Array.from({ length: 24 }, (_, i) => `H${String(i).padStart(2, "0")}`);
    return this._nefePipelines.map(p => ({
  ...
  // --- Security Stakeholder Report Generator (NEFE) ---
  private _initNefeReportTemplates(): void {
    this._nefeReportTemplates = [
      { id: "nefe-rp-01", name: "Board Security Report", audience: "board", frequency: "quarterly", sections: 6, autoGenerate: true, lastGenerated: "2026-03-31", pages: 12 },
      { id: "nefe-rp-02", name: "Executive Risk Summary", audience: "executive", frequency: "monthly", sections: 8, autoGenerate: true, lastGenerated: "2026-04-01", pages: 8 },
      { id: "nefe-rp-03", name: "Technical Security Review", audience: "technical", frequency: "weekly", sections: 12, autoGenerate: true, lastGenerated: "2026-04-21", pages: 25 },
      { id: "nefe-rp-04", name: "Audit Compliance Report", audience: "audit", frequency: "quarterly", sections: 10, autoGenerate: false, lastGenerated: "2026-03-15", pages: 35 },
      { id: "nefe-rp-05", name: "Regulatory Filing Package", audience: "regulatory", frequency: "annual", sections: 15, autoGenerate: false, lastGenerated: "2025-12-31", pages: 48 },
    ];
  }

  private _generateNefeExecSummary(): string {
    const totalRisk = this._nefeScenarios.reduce((sum: number, s: any) => sum + s.riskScore, 0);
    const avgControl = Math.round(this._nefeControls.reduce((sum: number, c: any) => sum + c.score, 0) / this._nefeControls.length);
    const degradedPipes = this._nefePipelines.filter((p: any) => p.status !== "healthy").length;
    return `Overall risk exposure: ${(totalRisk / 1000000).toFixed(1)}M. Average control effectiveness: {avgControl}%. {degradedPipes} pipeline(s) need attention. {this._nefeScenarios.filter((s: any) => s.mitigationPriority === "immediate").length} scenarios require immediate action.`;
  }

  // --- Security Technology Radar (NEFE) ---
  private _initNefeTechRadar(): void {
    this._nefeTechRadar = [
      { id: "nefe-tr-01", name: "AI-Powered Threat Detection", ring: "adopt", category: "Detection", maturity: 4, trend: "up", investment: "high", roi: 3.2, vendorCount: 8 },
      { id: "nefe-tr-02", name: "Zero Trust Architecture", ring: "adopt", category: "Architecture", maturity: 4, trend: "up", investment: "high", roi: 2.8, vendorCount: 12 },
      { id: "nefe-tr-03", name: "SASE/SSE Platform", ring: "trial", category: "Network", maturity: 3, trend: "up", investment: "medium", roi: 2.4, vendorCount: 10 },
      { id: "nefe-tr-04", name: "CNAPP Cloud Security", ring: "trial", category: "Cloud", maturity: 3, trend: "up", investment: "medium", roi: 2.1, vendorCount: 7 },
      { id: "nefe-tr-05", name: "Extended Detection and Response", ring: "adopt", category: "Detection", maturity: 4, trend: "stable", investment: "high", roi: 2.9, vendorCount: 9 },
      { id: "nefe-tr-06", name: "Quantum-Safe Cryptography", ring: "assess", category: "Crypto", maturity: 2, trend: "up", investment: "low", roi: 0.8, vendorCount: 4 },
      { id: "nefe-tr-07", name: "Security Service Edge", ring: "trial", category: "Network", maturity: 3, trend: "up", investment: "medium", roi: 2.0, vendorCount: 6 },
      { id: "nefe-tr-08", name: "SOAR 2.0 Autonomous SOC", ring: "assess", category: "Operations", maturity: 2, trend: "up", investment: "low", roi: 1.2, vendorCount: 5 },
      { id: "nefe-tr-09", name: "Software Supply Chain Security", ring: "trial", category: "DevSecOps", maturity: 3, trend: "up", investment: "medium", roi: 2.3, vendorCount: 8 },
      { id: "nefe-tr-10", name: "Identity Threat Detection", ring: "adopt", category: "Identity", maturity: 3, trend: "up", investment: "high", roi: 2.7, vendorCount: 7 },
      { id: "nefe-tr-11", name: "Data Security Posture Management", ring: "trial", category: "Data", maturity: 3, trend: "up", investment: "medium", roi: 2.2, vendorCount: 9 },
      { id: "nefe-tr-12", name: "Decentralized Identity Standards", ring: "hold", category: "Identity", maturity: 1, trend: "stable", investment: "low", roi: 0.5, vendorCount: 3 },
    ];
  }

  private _nefeRadarSummary(): Record<string, unknown> {
    const rings: Record<string, number> = { adopt: 0, trial: 0, assess: 0, hold: 0 };
    this._nefeTechRadar.forEach(t => { if (rings[t.ring as keyof typeof rings] !== undefined) rings[t.ring as keyof typeof rings]++; });
    return { adopt: rings.adopt, trial: rings.trial, assess: rings.assess, hold: rings.hold, total: this._nefeTechRadar.length, avgMaturity: 2.8, topInvestment: this._nefeTechRadar.filter(t => t.investment === "high").map(t => t.name) };
  }

  // --- NEFE Security Compliance Mapping Matrix ---
  private _initNefeComplianceMatrix(): void {
    ...
    this._nefeComplianceMatrix = frameworks.map(fw => ({
  ...
  private _nefeComplianceTrend(): Record<string, unknown>[] {
    const quarters = ["Q1-2025", "Q2-2025", "Q3-2025", "Q4-2025", "Q1-2026", "Q2-2026"];
    return this._nefeComplianceMatrix.map(fw => ({
  ...
  // --- NEFE Threat Intelligence Correlation Engine ---
  private _initNefeThreatIntel(): void {
    ...
    this._nefeThreatIntel = threatActors.map((actor, i) => ({
  ...
  private _nefeThreatCorrelation(): Record<string, unknown>[] {
    return this._nefeThreatIntel.filter(t => t.riskScore > 70).map(t => ({
  ...
  // --- NEFE Security Metrics Deep Dive ---
  private _initNefeMetricsDeep(): void {
    ...
    this._nefeMetricsDeep = metricCategories.map(cat => ({
  ...
  private _nefeMetricsHeatmap(): number[][] {
    return this._nefeMetricsDeep.map(cat =>
      cat.metrics.map(m => Math.round((m.value / m.target) * 100))
    );
  }

  // --- NEFE Incident Cost Modeling ---
  private _initNefeCostModel(): void {
    const incidentTypes = ["Data Breach", "Ransomware", "DDoS", "Insider Threat", "Phishing", "Supply Chain", "Cloud Misconfig", "Zero-Day"];
    this._nefeCostModel = incidentTypes.map(inc => ({
    ...
    this._nefeCostModel.forEach(m => { m.totalAnnualExposure = m.avgCost * m.frequency; });
  }

  private _nefeCostProjection(): Record<string, unknown>[] {
    return this._nefeCostModel.map(m => ({
  ...
  // --- NEFE Security Architecture Pattern Library ---
  private _initNefeArchPatterns(): void {
    ...
    this._nefeArchPatterns = patterns.map((p, i) => ({
  ...
  private _nefeArchPatternAnalysis(): Record<string, unknown> {
    const implemented = this._nefeArchPatterns.filter(p => p.implementation > 75).length;
    const avgCoverage = Math.round(this._nefeArchPatterns.reduce((s: number, p: any) => s + p.coverage, 0) / this._nefeArchPatterns.length);
    return {
      totalPatterns: this._nefeArchPatterns.length, fullyImplemented: implemented, avgCoverage,
      avgRiskReduction: Math.round(this._nefeArchPatterns.reduce((s: number, p: any) => s + p.riskReduction, 0) / this._nefeArchPatterns.length),
      gaps: this._nefeArchPatterns.filter(p => p.implementation < 60).map(p => p.pattern),
      recommendations: this._nefeArchPatterns.filter(p => p.implementation < 70).map(p => ({ pattern: p.pattern, current: p.implementation, target: 85, effort: p.costComplexity }))
    };
  }
  ...
  private _getnfdRiskProgress(): number {
    const completed = this._nfdRiskSteps.filter(s => s.status === 'completed').length;
    return Math.round((completed / this._nfdRiskSteps.length) * 100);
  }

  private _getnfdTreatmentSummary(): {total: number; approved: number; inReview: number; avgReduction: number; totalInvestment: string} {
    const approved = this._nfdTreatmentRecords.filter(r => r.status === 'approved').length;
    const inReview = this._nfdTreatmentRecords.filter(r => r.status === 'in_review').length;
    const avgRed = this._nfdTreatmentRecords.reduce((s, r) => s + ((r.currentScore - r.residualScore) / r.currentScore * 100), 0) / this._nfdTreatmentRecords.length;
    return {total: this._nfdTreatmentRecords.length, approved, inReview, avgReduction: Math.round(avgRed), totalInvestment: '$905K annually'};
  }

  private _nfdAutoRules = [
    {id: 'nfd-CAR-001', name: 'Password Policy Compliance Check', framework: 'NIST 800-53 IA-5', desc: 'Verify all user accounts meet minimum password complexity requirements including length, character diversity, and rotation', enabled: true as const, frequency: 'Daily', lastRun: '2026-04-22T14:00:00Z', lastResult: 'pass' as const, passRate: 94.2, violations: 12, autoRemediate: true as const, remediation: 'Force password reset on non-compliant accounts within 24h', history: [{d: '2026-04-22', r: 'pass', v: 12}, {d: '2026-04-21', r: 'pass', v: 14}, {d: '2026-04-20', r: 'fail', v: 18}]},
  ...
  private _nfdDriftAlerts = [
    ...
    {ruleId: 'nfd-CAR-005', ruleName: 'Firewall Rule Baseline Compliance', direction: 'improvement' as const, prevRate: 89.8, currRate: 91.3, delta: 1.5, severity: 'info' as const, detected: '2026-04-22T06:00:00Z', rootCause: 'Automated remediation workflow cleaned up orphaned firewall rules', remediation: 'Continue automated cleanup on weekly schedule'},
    {ruleId: 'nfd-CAR-011', ruleName: 'Endpoint Detection Status', direction: 'improvement' as const, prevRate: 95.1, currRate: 96.2, delta: 1.1, severity: 'info' as const, detected: '2026-04-22T10:00:00Z', rootCause: 'RMM integration enabled bulk EDR reinstallation on offline endpoints', remediation: 'No action needed, improvement trend expected to continue'}
  ];

  private _getnfdRuleSummary(): {total: number; enabled: number; passing: number; failing: number; avgPassRate: number; autoRemRate: number; totalVulns: number} {
    const enabled = this._nfdAutoRules.filter(r => r.enabled).length;
    const passing = this._nfdAutoRules.filter(r => r.lastResult === 'pass').length;
    const failing = this._nfdAutoRules.filter(r => r.lastResult === 'fail').length;
    const avgRate = this._nfdAutoRules.reduce((s, r) => s + r.passRate, 0) / this._nfdAutoRules.length;
    const autoRate = this._nfdAutoRules.filter(r => r.autoRemediate).length / this._nfdAutoRules.length * 100;
    const totalVulns = this._nfdAutoRules.reduce((s, r) => s + r.violations, 0);
    return {total: this._nfdAutoRules.length, enabled, passing, failing, avgPassRate: Math.round(avgRate * 10) / 10, autoRemRate: Math.round(autoRate), totalVulns};
  }

  private _getnfdEffectiveness(): {autoRemSuccessRate: number; avgRemTime: string; falsePositiveRate: number; coverageScore: number; costSavings: string} {
  ...
  private _nfdOnboardingChecklist = [
    {id: 'nfd-OB-001', item: 'Provision laptop, monitors, peripherals, and hardened workstation image', cat: 'IT Setup', day: 'Day 1', owner: 'IT Ops'},
    {id: 'nfd-OB-002', item: 'Create AD account, email, Slack, VPN, SSO, and application access', cat: 'Access', day: 'Day 1', owner: 'IAM Team'},
    {id: 'nfd-OB-003', item: 'Grant security tooling access: SIEM, EDR, vuln scanner, pentest platforms', cat: 'Tools', day: 'Day 1-2', owner: 'SOC Manager'},
    {id: 'nfd-OB-004', item: 'Complete MFA enrollment, security awareness onboarding, and AUP', cat: 'Security', day: 'Day 1', owner: 'Awareness Team'},
    {id: 'nfd-OB-005', item: 'Sign NDA, employment agreement, IP assignment, and code of conduct', cat: 'HR', day: 'Day 1', owner: 'HR'},
    {id: 'nfd-OB-006', item: 'Team introduction meetings with direct team and key stakeholders', cat: 'Integration', day: 'Week 1', owner: 'Hiring Manager'},
    {id: 'nfd-OB-007', item: 'Security architecture overview, tooling walkthrough, and runbook review', cat: 'Training', day: 'Week 1-2', owner: 'Security Architect'},
    {id: 'nfd-OB-008', item: 'Shadow experienced team member on active incident response and threat hunting', cat: 'Mentoring', day: 'Week 2-3', owner: 'SOC Team Lead'},
    {id: 'nfd-OB-009', item: 'Set up individual certification study plan aligned with career goals', cat: 'Development', day: 'Week 2', owner: 'Hiring Manager'},
    {id: 'nfd-OB-010', item: 'Establish 30-60-90 day goals and first performance review checkpoint', cat: 'Goals', day: 'Week 1', owner: 'Hiring Manager'}
  ];

  private _nfdRetentionRisks = [
  ...
  private _getnfdPipelineSummary(): {total: number; applicants: number; inPipeline: number; interviewing: number; offers: number; critical: number; avgFillDays: number} {
    const total = this._nfdOpenPositions.length;
    const apps = this._nfdOpenPositions.reduce((s, p) => s + p.applicants, 0);
    const pipe = this._nfdOpenPositions.reduce((s, p) => s + p.pipeline, 0);
    const ints = this._nfdOpenPositions.reduce((s, p) => s + p.interviews, 0);
    const offs = this._nfdOpenPositions.reduce((s, p) => s + p.offers, 0);
    const crit = this._nfdOpenPositions.filter(p => p.urgency === 'critical').length;
    return {total, applicants: apps, inPipeline: pipe, interviewing: ints, offers: offs, critical: crit, avgFillDays: 47};
  }

  private _nfdMetricDetails = [
    {id: 'nfd-M-001', name: 'Mean Time to Detect (MTTD)', value: '4.2 hours', trend: 'improving' as const, target: '< 4 hours', unit: 'hours', source: 'SIEM - Splunk', methodology: 'Median time from first alert to analyst acknowledgment in SOAR platform', owner: 'SOC Manager', sla: '4 hours', prev: '5.1 hours', sparkData: [5.8, 5.4, 5.1, 4.9, 4.7, 4.5, 4.3, 4.2], period: 'Last 8 weeks', breakdown: [{src: 'Network IDS', pct: '35%', avg: '3.8h'}, {src: 'Endpoint EDR', pct: '28%', avg: '4.1h'}, {src: 'Email Gateway', pct: '22%', avg: '3.5h'}, {src: 'Cloud Security', pct: '10%', avg: '5.2h'}, {src: 'User Reports', pct: '5%', avg: '6.8h'}]},
    {id: 'nfd-M-002', name: 'Mean Time to Respond (MTTR)', value: '2.8 hours', trend: 'stable' as const, target: '< 3 hours', unit: 'hours', source: 'SOAR - Cortex XSOAR', methodology: 'Median time from analyst acknowledgment to first containment action executed', owner: 'IR Lead', sla: '3 hours', prev: '2.7 hours', sparkData: [3.2, 3.0, 2.9, 2.8, 2.8, 2.9, 2.8, 2.8], period: 'Last 8 weeks', breakdown: [{src: 'Automated Playbooks', pct: '42%', avg: '1.2h'}, {src: 'Semi-automated', pct: '33%', avg: '2.5h'}, {src: 'Manual Investigation', pct: '20%', avg: '5.1h'}, {src: 'L3 Escalation', pct: '5%', avg: '8.3h'}]},
    {id: 'nfd-M-003', name: 'Patch Compliance Rate', value: '97.6%', trend: 'improving' as const, target: '> 95%', unit: 'percent', source: 'Tenable.io', methodology: 'Percentage of critical/high vulns patched within SLA windows', owner: 'Vuln Manager', sla: '95%', prev: '96.1%', sparkData: [93.2, 94.1, 94.8, 95.3, 95.9, 96.4, 97.0, 97.6], period: 'Last 8 weeks', breakdown: [{src: 'Critical (7d SLA)', pct: '40%', rate: '99.2%'}, {src: 'High (30d SLA)', pct: '35%', rate: '97.8%'}, {src: 'Medium (90d SLA)', pct: '20%', rate: '95.1%'}, {src: 'Low (180d SLA)', pct: '5%', rate: '89.4%'}]},
    {id: 'nfd-M-004', name: 'Phishing Click Rate', value: '3.2%', trend: 'improving' as const, target: '< 5%', unit: 'percent', source: 'KnowBe4 + Proofpoint', methodology: 'Percentage of users clicking links in simulated phishing campaigns', owner: 'Awareness Lead', sla: '5%', prev: '4.1%', sparkData: [6.8, 6.2, 5.5, 5.1, 4.6, 4.1, 3.6, 3.2], period: 'Last 8 months', breakdown: [{src: 'Spear Phishing', pct: '35%', rate: '5.1%'}, {src: 'Generic Phishing', pct: '30%', rate: '2.8%'}, {src: 'BEC Simulation', pct: '20%', rate: '3.5%'}, {src: 'SMS Phishing', pct: '15%', rate: '1.9%'}]},
    {id: 'nfd-M-005', name: 'Security Posture Score', value: '784', trend: 'improving' as const, target: '> 750', unit: 'score', source: 'SecurityScorecard + Internal', methodology: 'Composite: external rating 30%, compliance 25%, vuln mgmt 25%, config 20%', owner: 'CISO', sla: '> 750', prev: '771', sparkData: [748, 752, 758, 762, 768, 773, 778, 784], period: 'Last 8 weeks', breakdown: [{src: 'External Rating', pct: '30%', score: '791'}, {src: 'Compliance Score', pct: '25%', score: '812'}, {src: 'Vuln Management', pct: '25%', score: '745'}, {src: 'Config Hardening', pct: '20%', score: '769'}]},
    {id: 'nfd-M-006', name: 'Vulnerability Backlog', value: '142', trend: 'improving' as const, target: '< 150', unit: 'count', source: 'Tenable + Qualys', methodology: 'Total open vulns across all scanned assets tracked weekly', owner: 'Vuln Manager', sla: '< 150', prev: '168', sparkData: [210, 198, 185, 175, 165, 158, 150, 142], period: 'Last 8 weeks', breakdown: [{src: 'Critical (CVSS 9+)', pct: '8%', count: '11'}, {src: 'High (CVSS 7-8)', pct: '22%', count: '31'}, {src: 'Medium (CVSS 4-6)', pct: '45%', count: '64'}, {src: 'Low (CVSS 0-3)', pct: '25%', count: '36'}]}
  ];

  private _getnfdMetricTrends(): {improving: number; stable: number; declining: number; total: number} {
    const imp = this._nfdMetricDetails.filter(m => m.trend === 'improving').length;
    const stb = this._nfdMetricDetails.filter(m => m.trend === 'stable').length;
    const dec = this._nfdMetricDetails.filter(m => m.trend === 'declining').length;
    return {improving: imp, stable: stb, declining: dec, total: this._nfdMetricDetails.length};
  }

  private _nfdArchChecklist = [
    {id: 'nfd-A-001', cat: 'Network Architecture', item: 'Network segmentation between trust zones with dedicated firewalls and granular ACLs', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Micro-segmentation via NSX across all production zones'},
    {id: 'nfd-A-002', cat: 'Network Architecture', item: 'DMZ architecture isolates public-facing services from internal network', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Dual-firewall DMZ with WAF and reverse proxy'},
    {id: 'nfd-A-003', cat: 'Network Architecture', item: 'Traffic flows enforce least-privilege with deny-by-default policies', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Explicit allow rules with quarterly review cycle'},
    {id: 'nfd-A-004', cat: 'Network Architecture', item: 'External communications encrypted with IPSec or TLS 1.3 with PFS', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'IKEv2 with PFS, TLS 1.3 for external APIs'},
    {id: 'nfd-A-005', cat: 'Identity and Access', item: 'Centralized IdP manages all accounts with SSO and automated provisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Okta SSO SAML 2.0 for 247 apps with SCIM'},
    {id: 'nfd-A-006', cat: 'Identity and Access', item: 'RBAC with quarterly access reviews and automated deprovisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Quarterly recertification with JIT admin access'},
    {id: 'nfd-A-007', cat: 'Identity and Access', item: 'PAM controls all administrative and service accounts with session recording', sev: 'high' as const, status: 'fail' as const, reviewer: 'IAM Lead', notes: '3 legacy accounts pending CyberArk enrollment'},
    {id: 'nfd-A-008', cat: 'Identity and Access', item: 'MFA enforced for all users, hardware tokens for privileged access', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'FIDO2 for admins, push MFA for users, 99.8% enrollment'},
    {id: 'nfd-A-009', cat: 'Data Protection', item: 'Data classification enforced with automated labeling on all repos', sev: 'high' as const, status: 'partial' as const, reviewer: 'Data Protection Lead', notes: 'Framework defined, gaps on 4 legacy file shares'},
    {id: 'nfd-A-010', cat: 'Data Protection', item: 'AES-256 encryption at rest for all sensitive data stores', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'Full-disk, TDE on DBs, SSE-KMS on cloud storage'},
    {id: 'nfd-A-011', cat: 'Data Protection', item: 'DLP controls monitor and prevent unauthorized data exfiltration', sev: 'high' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'DLP active on email, endpoint, cloud, and network'},
    {id: 'nfd-A-012', cat: 'Data Protection', item: 'Encrypted off-site backups with quarterly tested restore procedures', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Infrastructure Lead', notes: '3-2-1 strategy with immutable backups'},
    {id: 'nfd-A-013', cat: 'Application Security', item: 'Secure SDLC with mandatory SAST, DAST, SCA in all CI/CD pipelines', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: '34 pipelines with security gates and PR blocking'},
    {id: 'nfd-A-014', cat: 'Application Security', item: 'API gateway with auth, rate limiting, and schema validation', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: 'Kong with OAuth2, rate limits, OpenAPI validation'},
    {id: 'nfd-A-015', cat: 'Application Security', item: 'Container security with image scanning, runtime protection, network policies', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Trivy scanning, Falco runtime in 80% of clusters'},
    {id: 'nfd-A-016', cat: 'Monitoring', item: 'SIEM collects from all critical systems with real-time correlation', sev: 'critical' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'Splunk 98% coverage with 1200+ correlation rules'},
    {id: 'nfd-A-017', cat: 'Monitoring', item: 'EDR with behavioral detection on all managed endpoints', sev: 'high' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'CrowdStrike on 99.2% endpoints with 24/7 MDR'},
    {id: 'nfd-A-018', cat: 'Monitoring', item: 'Executive dashboards with real-time posture visibility', sev: 'medium' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'PowerBI dashboards with weekly executive summaries'},
    {id: 'nfd-A-019', cat: 'Cloud Security', item: 'CSPM monitors and remediates cloud misconfigurations continuously', sev: 'high' as const, status: 'pass' as const, reviewer: 'Cloud Security Lead', notes: 'Prisma Cloud with 450+ checks and auto-remediation'},
    {id: 'nfd-A-020', cat: 'Cloud Security', item: 'IaC templates scanned for misconfigurations before deployment', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Checkov for Terraform, cfn-nag for CloudFormation pending'}
  ];

  private _nfdDesignPatterns = [
  ...
  private _getnfdArchSummary(): {total: number; passed: number; failed: number; partial: number; criticalFails: number; score: number} {
    const p = this._nfdArchChecklist.filter(c => c.status === 'pass').length;
    const f = this._nfdArchChecklist.filter(c => c.status === 'fail').length;
    const pa = this._nfdArchChecklist.filter(c => c.status === 'partial').length;
    const cf = this._nfdArchChecklist.filter(c => c.status === 'fail' && c.sev === 'critical').length;
    return {total: this._nfdArchChecklist.length, passed: p, failed: f, partial: pa, criticalFails: cf, score: Math.round((p / this._nfdArchChecklist.length) * 100)};
  }

  private _getnfdApprovalStatus(): {stage: string; approvers: Array<{name: string; role: string; status: string}>; nextAction: string} {
  ...
  private _408RiskAssessmentWorkflow = [
  ...
  private _408TalentPositions = [
    ...
    {id: '408-H-002', title: 'Cloud Security Engineer', dept: 'Cloud Security', level: 'Mid-Senior', loc: 'SF/Remote', salary: '$155K-$180K', posted: '2026-03-20', applicants: 45, pipeline: 12, interviews: 6, offers: 2, urgency: 'high' as const, manager: 'Mike Johnson', skills: ['AWS/Azure/GCP', 'Terraform', 'Kubernetes', 'IAM', 'CSPM'], nice: ['CCSP', 'CKS', 'Serverless']},
    {id: '408-H-003', title: 'SOC Analyst L2', dept: 'Security Operations', level: 'Mid', loc: 'Austin TX', salary: '$105K-$130K', posted: '2026-04-01', applicants: 67, pipeline: 18, interviews: 8, offers: 0, urgency: 'medium' as const, manager: 'Lisa Park', skills: ['SIEM', 'Incident triage', 'Malware analysis', 'TCP/IP'], nice: ['GCIA', 'SOAR', 'Kill chain']},
    ...
    {id: '408-H-005', title: 'GRC Analyst', dept: 'GRC', level: 'Mid', loc: 'NY/Remote', salary: '$110K-$135K', posted: '2026-04-05', applicants: 34, pipeline: 9, interviews: 3, offers: 1, urgency: 'medium' as const, manager: 'Rachel Green', skills: ['ISO 27001', 'SOC 2', 'Risk assessment', 'Audit'], nice: ['CRISC', 'CISA', 'GDPR']},
    {id: '408-H-006', title: 'Threat Intel Analyst', dept: 'Threat Intel', level: 'Mid-Senior', loc: 'Remote US', salary: '$140K-$170K', posted: '2026-03-25', applicants: 19, pipeline: 5, interviews: 2, offers: 0, urgency: 'low' as const, manager: 'James Wilson', skills: ['MITRE ATT&CK', 'OSINT', 'Threat modeling', 'Reverse eng'], nice: ['CTIA', 'Nation-state', 'Dark web']},
    {id: '408-H-007', title: 'AppSec Engineer', dept: 'AppSec', level: 'Senior', loc: 'Seattle/Remote', salary: '$160K-$190K', posted: '2026-04-10', applicants: 28, pipeline: 7, interviews: 3, offers: 0, urgency: 'medium' as const, manager: 'Emily Zhang', skills: ['SAST/DAST/SCA', 'Secure SDLC', 'Code review', 'CI/CD'], nice: ['CSSLP', 'Mobile security']},
    {id: '408-H-008', title: 'IAM Engineer', dept: 'IAM', level: 'Mid', loc: 'Remote US', salary: '$135K-$160K', posted: '2026-04-08', applicants: 31, pipeline: 10, interviews: 5, offers: 1, urgency: 'medium' as const, manager: 'Chris Martinez', skills: ['Okta/Azure AD', 'SAML/OIDC', 'PAM', 'RBAC'], nice: ['CISSP', 'Zero trust IAM']}
  ];

  private _408InterviewScorecard = [
    {category: 'Technical Proficiency', weight: 40, criteria: [
  ...
  private _408OnboardingSteps = [
    {id: '408-OB-01', item: 'Provision security-hardened laptop, monitors, peripherals, and configured workstation image with all required security tools', cat: 'IT Setup', day: 'Day 1', owner: 'IT Operations'},
    {id: '408-OB-02', item: 'Create AD account, email, Slack, VPN, SSO enrollment, and all required application access accounts', cat: 'Access', day: 'Day 1', owner: 'IAM Team'},
    {id: '408-OB-03', item: 'Grant security tooling access: SIEM console, EDR dashboard, vuln scanner, pentest platforms, SOAR', cat: 'Tools', day: 'Day 1-2', owner: 'SOC Manager'},
    {id: '408-OB-04', item: 'Complete MFA enrollment, security awareness onboarding course, and acceptable use policy acknowledgment', cat: 'Security', day: 'Day 1', owner: 'Awareness Team'},
    {id: '408-OB-05', item: 'Sign NDA, employment agreement, IP assignment, and code of conduct documents with HR', cat: 'HR', day: 'Day 1', owner: 'Human Resources'},
    {id: '408-OB-06', item: 'Introduction meetings with direct team members and key cross-functional stakeholders', cat: 'Integration', day: 'Week 1', owner: 'Hiring Manager'},
    {id: '408-OB-07', item: 'Security architecture overview, tooling walkthrough, and operational runbook review sessions', cat: 'Training', day: 'Week 1-2', owner: 'Security Architect'},
    {id: '408-OB-08', item: 'Shadow experienced team member on active incident response and threat hunting investigations', cat: 'Mentoring', day: 'Week 2-3', owner: 'SOC Lead'},
    {id: '408-OB-09', item: 'Set up individual certification study plan aligned with role requirements and career goals', cat: 'Development', day: 'Week 2', owner: 'Hiring Manager'},
    {id: '408-OB-10', item: 'Establish 30-60-90 day goals, define success metrics, and schedule first performance checkpoint', cat: 'Goals', day: 'Week 1', owner: 'Hiring Manager'}
  ];

  private _408MetricsDashboard = [
  ...
  private _408ArchReview = [
    {id: '408-AR-001', cat: 'Network', item: 'Network segmentation between trust zones with dedicated firewalls and granular ACLs', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Micro-segmentation via NSX across all production zones'},
    {id: '408-AR-002', cat: 'Network', item: 'DMZ architecture isolating public services from internal network', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Dual-firewall DMZ with WAF and DDoS mitigation'},
    {id: '408-AR-003', cat: 'Network', item: 'Least-privilege traffic flows with deny-by-default and quarterly review', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Explicit allow rules with automated drift detection'},
    {id: '408-AR-004', cat: 'Network', item: 'Encrypted external communications with IPSec/TLS 1.3 and PFS', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'IKEv2 with PFS, TLS 1.3 for all external APIs'},
    {id: '408-AR-005', cat: 'Identity', item: 'Centralized IdP with SSO and automated SCIM provisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Okta SSO SAML 2.0 for 247 apps with SCIM'},
    {id: '408-AR-006', cat: 'Identity', item: 'RBAC with quarterly reviews and automated deprovisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Quarterly recertification with JIT admin access'},
    {id: '408-AR-007', cat: 'Identity', item: 'PAM controlling all admin and service accounts with session recording', sev: 'high' as const, status: 'fail' as const, reviewer: 'IAM Lead', notes: '3 legacy accounts pending CyberArk enrollment'},
    {id: '408-AR-008', cat: 'Identity', item: 'MFA enforced for all users, hardware tokens for privileged access', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'FIDO2 for admins, push MFA for users, 99.8% enrollment'},
    {id: '408-AR-009', cat: 'Data', item: 'Data classification enforced with automated labeling on all repos', sev: 'high' as const, status: 'partial' as const, reviewer: 'Data Protection Lead', notes: 'Framework deployed, gaps on 4 legacy file shares'},
    {id: '408-AR-010', cat: 'Data', item: 'AES-256 encryption at rest for all sensitive data stores', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'Full-disk, TDE on DBs, SSE-KMS on cloud storage'},
    {id: '408-AR-011', cat: 'Data', item: 'DLP monitoring and preventing unauthorized data exfiltration', sev: 'high' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'DLP active on email, endpoint, cloud, and network'},
    {id: '408-AR-012', cat: 'Data', item: 'Encrypted off-site backups with quarterly restore testing', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Infrastructure Lead', notes: '3-2-1 strategy with immutable backups'},
    {id: '408-AR-013', cat: 'AppSec', item: 'Secure SDLC with SAST, DAST, SCA in all CI/CD pipelines', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: '34 pipelines with security gates and PR blocking'},
    {id: '408-AR-014', cat: 'AppSec', item: 'API gateway with auth, rate limiting, schema validation', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: 'Kong with OAuth2, rate limits, OpenAPI validation'},
    {id: '408-AR-015', cat: 'AppSec', item: 'Container security with image scanning and runtime protection', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Trivy scanning, Falco runtime in 80% of clusters'},
    {id: '408-AR-016', cat: 'Monitoring', item: 'SIEM collecting from all critical systems with correlation rules', sev: 'critical' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'Splunk 98% coverage with 1200+ correlation rules'},
    {id: '408-AR-017', cat: 'Monitoring', item: 'EDR with behavioral detection on all managed endpoints', sev: 'high' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'CrowdStrike on 99.2% endpoints with 24/7 MDR'},
    {id: '408-AR-018', cat: 'Monitoring', item: 'Executive dashboards with real-time posture visibility', sev: 'medium' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'PowerBI dashboards with weekly exec summaries'},
    {id: '408-AR-019', cat: 'Cloud', item: 'CSPM monitoring and remediating cloud misconfigurations', sev: 'high' as const, status: 'pass' as const, reviewer: 'Cloud Security Lead', notes: 'Prisma Cloud 450+ checks with auto-remediation'},
    {id: '408-AR-020', cat: 'Cloud', item: 'IaC templates scanned before deployment to production', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Checkov for Terraform, cfn-nag for CloudFormation pending'}
  ];

  private _get408RiskProgress(): number {
    return Math.round(this._408RiskAssessmentWorkflow.filter(s => s.status === 'completed').length / this._408RiskAssessmentWorkflow.length * 100);
  }

  private _get408TreatmentSummary(): {total: number; approved: number; avgReduction: number; investment: string} {
    const a = this._408TreatmentOptions.filter(r => r.status === 'approved').length;
    const avg = this._408TreatmentOptions.reduce((s, r) => s + ((r.before - r.after) / r.before * 100), 0) / this._408TreatmentOptions.length;
    return {total: this._408TreatmentOptions.length, approved: a, avgReduction: Math.round(avg), investment: '$1.125M annually'};
  }

  private _get408RuleSummary(): {total: number; passing: number; failing: number; avgRate: number; violations: number} {
    const p = this._408ComplianceRules.filter(r => r.result === 'pass').length;
    const f = this._408ComplianceRules.filter(r => r.result === 'fail').length;
    const avg = this._408ComplianceRules.reduce((s, r) => s + r.passRate, 0) / this._408ComplianceRules.length;
    const v = this._408ComplianceRules.reduce((s, r) => s + r.violations, 0);
    return {total: this._408ComplianceRules.length, passing: p, failing: f, avgRate: Math.round(avg * 10) / 10, violations: v};
  }

  private _get408PipelineStats(): {positions: number; applicants: number; interviewing: number; offers: number; critical: number} {
    const t = this._408TalentPositions.length;
    const a = this._408TalentPositions.reduce((s, p) => s + p.applicants, 0);
    const i = this._408TalentPositions.reduce((s, p) => s + p.interviews, 0);
    const o = this._408TalentPositions.reduce((s, p) => s + p.offers, 0);
    const c = this._408TalentPositions.filter(x => x.urgency === 'critical').length;
    return {positions: t, applicants: a, interviewing: i, offers: o, critical: c};
  }

  private _get408MetricTrends(): {improving: number; stable: number; total: number} {
    const imp = this._408MetricsDashboard.filter(m => m.trend === 'improving').length;
    const stb = this._408MetricsDashboard.filter(m => m.trend === 'stable').length;
    return {improving: imp, stable: stb, total: this._408MetricsDashboard.length};
  }

  private _get408ArchScore(): {total: number; passed: number; failed: number; partial: number; score: number} {
    const p = this._408ArchReview.filter(c => c.status === 'pass').length;
    const f = this._408ArchReview.filter(c => c.status === 'fail').length;
    const pa = this._408ArchReview.filter(c => c.status === 'partial').length;
    return {total: this._408ArchReview.length, passed: p, failed: f, partial: pa, score: Math.round((p / this._408ArchReview.length) * 100)};
  }
  ...
  // === Security Risk Register (news_feed) ===
  private _news_feedRiskRegister = [
    { id: "RSK-NEW-0001", title: "Data breach from unpatched systems", owner: "CTO", category: "Financial", status: "mitigating", trend: "stable", severity: "critical", likelihood: 9, impact: 2, treatment: "Monitor and review quarterly", lastReview: "2026-04-09", nextReview: "2026-07-23" },
    { id: "RSK-NEW-0002", title: "Ransomware attack on critical infrastructure", owner: "CRO", category: "Strategic", status: "closed", trend: "decreasing", severity: "critical", likelihood: 7, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-05", nextReview: "2026-07-02" },
    { id: "RSK-NEW-0003", title: "Insider threat data exfiltration", owner: "VP Eng", category: "Compliance", status: "accepted", trend: "increasing", severity: "medium", likelihood: 10, impact: 1, treatment: "Monitor and review quarterly", lastReview: "2026-04-22", nextReview: "2026-07-01" },
    { id: "RSK-NEW-0004", title: "Supply chain compromise", owner: "Security Lead", category: "Technical", status: "open", trend: "stable", severity: "high", likelihood: 3, impact: 4, treatment: "Monitor and review quarterly", lastReview: "2026-04-22", nextReview: "2026-07-27" },
    { id: "RSK-NEW-0005", title: "Cloud misconfiguration exposure", owner: "Risk Mgr", category: "Reputational", status: "mitigating", trend: "decreasing", severity: "critical", likelihood: 5, impact: 5, treatment: "Monitor and review quarterly", lastReview: "2026-04-18", nextReview: "2026-07-01" },
    { id: "RSK-NEW-0006", title: "Phishing campaign success rate", owner: "Compliance Dir", category: "Legal", status: "closed", trend: "increasing", severity: "low", likelihood: 8, impact: 6, treatment: "Monitor and review quarterly", lastReview: "2026-04-15", nextReview: "2026-07-19" },
    { id: "RSK-NEW-0007", title: "Third-party vendor data breach", owner: "IT Dir", category: "Regulatory", status: "accepted", trend: "stable", severity: "high", likelihood: 1, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-14", nextReview: "2026-07-20" },
    { id: "RSK-NEW-0008", title: "Regulatory non-compliance penalty", owner: "DevOps Lead", category: "Third-Party", status: "open", trend: "decreasing", severity: "critical", likelihood: 2, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-18", nextReview: "2026-07-19" },
    { id: "RSK-NEW-0009", title: "Zero-day exploit in production", owner: "Architect", category: "Human Capital", status: "mitigating", trend: "increasing", severity: "medium", likelihood: 8, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-06", nextReview: "2026-07-17" },
    { id: "RSK-NEW-0010", title: "Insufficient access controls", owner: "CISO", category: "Operational", status: "closed", trend: "stable", severity: "low", likelihood: 4, impact: 7, treatment: "Monitor and review quarterly", lastReview: "2026-04-22", nextReview: "2026-07-21" },
    { id: "RSK-NEW-0011", title: "DDoS attack on services", owner: "CTO", category: "Financial", status: "accepted", trend: "decreasing", severity: "medium", likelihood: 1, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-06", nextReview: "2026-07-24" },
    { id: "RSK-NEW-0012", title: "Social engineering attack", owner: "CRO", category: "Strategic", status: "open", trend: "increasing", severity: "critical", likelihood: 3, impact: 6, treatment: "Monitor and review quarterly", lastReview: "2026-04-02", nextReview: "2026-07-03" },
    { id: "RSK-NEW-0013", title: "API security vulnerability", owner: "VP Eng", category: "Compliance", status: "mitigating", trend: "stable", severity: "medium", likelihood: 7, impact: 6, treatment: "Monitor and review quarterly", lastReview: "2026-04-20", nextReview: "2026-07-25" },
    { id: "RSK-NEW-0014", title: "Mobile device compromise", owner: "Security Lead", category: "Technical", status: "closed", trend: "decreasing", severity: "critical", likelihood: 5, impact: 5, treatment: "Monitor and review quarterly", lastReview: "2026-04-10", nextReview: "2026-07-15" },
    { id: "RSK-NEW-0015", title: "Physical security breach", owner: "Risk Mgr", category: "Reputational", status: "accepted", trend: "increasing", severity: "medium", likelihood: 3, impact: 5, treatment: "Monitor and review quarterly", lastReview: "2026-04-13", nextReview: "2026-07-23" },
    { id: "RSK-NEW-0016", title: "Password policy weakness", owner: "Compliance Dir", category: "Legal", status: "open", trend: "stable", severity: "high", likelihood: 6, impact: 4, treatment: "Monitor and review quarterly", lastReview: "2026-04-12", nextReview: "2026-07-23" },
    { id: "RSK-NEW-0017", title: "Network segmentation gap", owner: "IT Dir", category: "Regulatory", status: "mitigating", trend: "decreasing", severity: "high", likelihood: 6, impact: 2, treatment: "Monitor and review quarterly", lastReview: "2026-04-16", nextReview: "2026-07-18" },
    { id: "RSK-NEW-0018", title: "Encryption key management failure", owner: "DevOps Lead", category: "Third-Party", status: "closed", trend: "increasing", severity: "critical", likelihood: 1, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-03", nextReview: "2026-07-20" },
    { id: "RSK-NEW-0019", title: "Audit trail tampering", owner: "Architect", category: "Human Capital", status: "accepted", trend: "stable", severity: "high", likelihood: 10, impact: 7, treatment: "Monitor and review quarterly", lastReview: "2026-04-23", nextReview: "2026-07-08" },
    { id: "RSK-NEW-0020", title: "Business email compromise", owner: "CISO", category: "Operational", status: "open", trend: "decreasing", severity: "medium", likelihood: 1, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-22", nextReview: "2026-07-11" },
  ];
  private _news_feedRiskFilter: string = 'all';
  private _news_feedRiskSeverity: string = 'all';
  private _news_feedRiskStatus: string = 'all';
  private _news_feedExpandedRisk: string = '';
  private _news_feedFilterRisks() {
    const reg = this._news_feedRiskRegister;
    return reg.filter(r => {
      if (this._news_feedRiskFilter !== "all" && r.category !== this._news_feedRiskFilter) return false;
      if (this._news_feedRiskSeverity !== "all" && r.severity !== this._news_feedRiskSeverity) return false;
      if (this._news_feedRiskStatus !== "all" && r.status !== this._news_feedRiskStatus) return false;
      return true;
    });
  }
  private _news_feedGetRiskScore(r: any) { return Math.round(r.likelihood * r.impact * 1.5); }
  private _news_feedGetRiskTrendIcon(trend: string) {
    if (trend === "increasing") return "\u2191";
    if (trend === "decreasing") return "\u2193";
    return "\u2192";
  }
  private _news_feedGetRiskColor(sev: string) {
    if (sev === "critical") return "#dc2626";
    if (sev === "high") return "#ea580c";
    if (sev === "medium") return "#d97706";
    return "#16a34a";
  }
  private _news_feedGetRiskCounts() {
    const reg = this._news_feedRiskRegister;
  ...
  private _news_feedGetTreatmentProgress() {
    const reg = this._news_feedRiskRegister;
    const treated = reg.filter(r => r.status === "mitigating" || r.status === "closed").length;
    return Math.round((treated / Math.max(reg.length, 1)) * 100);
  }

  // === Security Metrics API Gateway (news_feed) ===
  private _news_feedApiEndpoints = [
    { method: "GET", path: "/api/v1/threats", name: "Threat Intelligence Feed", status: "active", avgLatency: 137.3, reqPerMin: 1489.0, errorRate: 2.36, uptime: round(98.74499350786385,2), version: "v1.1.18" },
    { method: "POST", path: "/api/v1/scans/start", name: "Vulnerability Scanner", status: "active", avgLatency: 54.4, reqPerMin: 1633.0, errorRate: 1.81, uptime: round(98.05679807976466,2), version: "v2.7.10" },
    { method: "GET", path: "/api/v1/assets", name: "Asset Inventory", status: "active", avgLatency: 322.0, reqPerMin: 2287.0, errorRate: 2.31, uptime: round(97.26537487544704,2), version: "v1.9.19" },
    { method: "POST", path: "/api/v1/alerts", name: "Alert Management", status: "active", avgLatency: 442.3, reqPerMin: 1541.0, errorRate: 0.05, uptime: round(96.54766417214984,2), version: "v1.7.19" },
    { method: "GET", path: "/api/v1/compliance", name: "Compliance Status", status: "active", avgLatency: 146.0, reqPerMin: 601.0, errorRate: 0.84, uptime: round(97.43769558705901,2), version: "v1.9.6" },
    { method: "PUT", path: "/api/v1/policies", name: "Policy Engine", status: "active", avgLatency: 221.3, reqPerMin: 1620.0, errorRate: 1.84, uptime: round(95.10029893322343,2), version: "v3.2.17" },
    { method: "GET", path: "/api/v1/incidents", name: "Incident Tracker", status: "active", avgLatency: 87.5, reqPerMin: 2147.0, errorRate: 0.17, uptime: round(98.97644557617893,2), version: "v2.5.3" },
    { method: "POST", path: "/api/v1/forensics", name: "Forensics Collector", status: "degraded", avgLatency: 285.2, reqPerMin: 1041.0, errorRate: 2.21, uptime: round(95.82744433254534,2), version: "v1.2.3" },
    { method: "GET", path: "/api/v1/risk/assess", name: "Risk Assessment", status: "active", avgLatency: 428.4, reqPerMin: 1084.0, errorRate: 2.18, uptime: round(97.60901613402018,2), version: "v3.7.18" },
    { method: "POST", path: "/api/v1/auth/verify", name: "Authentication", status: "active", avgLatency: 116.1, reqPerMin: 702.0, errorRate: 1.98, uptime: round(99.29486852565903,2), version: "v2.6.4" },
    { method: "GET", path: "/api/v1/logs/audit", name: "Audit Log Query", status: "active", avgLatency: 415.2, reqPerMin: 1462.0, errorRate: 2.16, uptime: round(97.81712594109072,2), version: "v1.9.5" },
    { method: "PUT", path: "/api/v1/users/roles", name: "Role Management", status: "active", avgLatency: 435.0, reqPerMin: 171.0, errorRate: 0.72, uptime: round(98.24787852086305,2), version: "v2.9.20" },
    { method: "POST", path: "/api/v1/encrypt", name: "Encryption Service", status: "active", avgLatency: 290.5, reqPerMin: 2061.0, errorRate: 1.56, uptime: round(95.03914554171021,2), version: "v3.0.4" },
    { method: "GET", path: "/api/v1/network/topo", name: "Network Topology", status: "maintenance", avgLatency: 141.4, reqPerMin: 67.0, errorRate: 0.08, uptime: round(97.2937111224115,2), version: "v2.7.18" },
    { method: "DELETE", path: "/api/v1/sessions", name: "Session Manager", status: "active", avgLatency: 71.4, reqPerMin: 2052.0, errorRate: 2.48, uptime: round(99.17821009347955,2), version: "v3.3.14" },
  ];
  private _news_feedApiKeys = [
    { id: "ak-000001", name: "key-news-001", created: "2026-09-19", lastUsed: "2026-04-14", status: "active", calls: 18881, rateLimit: 100 },
    { id: "ak-000002", name: "key-news-002", created: "2026-06-14", lastUsed: "2026-04-08", status: "active", calls: 23783, rateLimit: 500 },
    { id: "ak-000003", name: "key-news-003", created: "2026-08-09", lastUsed: "2026-04-21", status: "active", calls: 30355, rateLimit: 5000 },
    { id: "ak-000004", name: "key-news-004", created: "2026-04-17", lastUsed: "2026-04-09", status: "revoked", calls: 12914, rateLimit: 500 },
    { id: "ak-000005", name: "key-news-005", created: "2026-06-21", lastUsed: "2026-04-07", status: "active", calls: 3493, rateLimit: 5000 },
    { id: "ak-000006", name: "key-news-006", created: "2026-07-08", lastUsed: "2026-04-08", status: "active", calls: 37541, rateLimit: 5000 },
    { id: "ak-000007", name: "key-news-007", created: "2026-04-15", lastUsed: "2026-04-04", status: "active", calls: 9167, rateLimit: 500 },
    { id: "ak-000008", name: "key-news-008", created: "2026-06-14", lastUsed: "2026-04-05", status: "active", calls: 38267, rateLimit: 100 },
  ];
  private _news_feedApiHealthSummary() {
    const eps = this._news_feedApiEndpoints;
  ...
  private _news_feedGetApiByMethod(method: string) { return this._news_feedApiEndpoints.filter(e=>e.method===method); }
  private _news_feedGetSlowEndpoints() { return this._news_feedApiEndpoints.filter(e=>e.avgLatency>200).sort((a,b)=>b.avgLatency-a.avgLatency); }
  private _news_feedGetHighErrorEndpoints() { return this._news_feedApiEndpoints.filter(e=>e.errorRate>1.0).sort((a,b)=>b.errorRate-a.errorRate); }

  // === Security Training Effectiveness (news_feed) ===
  private _news_feedTrainingModules = [
    { id: "TRN-001", name: "Security Fundamentals", completionRate: 59.5, avgScore: 63.1, behaviorChange: 69.6, enrolled: 170, completed: 442, duration: "118min", category: "mandatory" },
    { id: "TRN-002", name: "Phishing Awareness", completionRate: 92.7, avgScore: 84.1, behaviorChange: 31.7, enrolled: 487, completed: 108, duration: "107min", category: "mandatory" },
    { id: "TRN-003", name: "Social Engineering Defense", completionRate: 64.8, avgScore: 92.2, behaviorChange: 61.1, enrolled: 341, completed: 355, duration: "46min", category: "optional" },
    { id: "TRN-004", name: "Password Hygiene", completionRate: 78.5, avgScore: 71.8, behaviorChange: 63.5, enrolled: 217, completed: 52, duration: "87min", category: "mandatory" },
    { id: "TRN-005", name: "Data Classification", completionRate: 72.9, avgScore: 90.0, behaviorChange: 74.3, enrolled: 80, completed: 70, duration: "65min", category: "mandatory" },
    { id: "TRN-006", name: "Incident Response Basics", completionRate: 68.0, avgScore: 85.5, behaviorChange: 70.0, enrolled: 185, completed: 179, duration: "63min", category: "mandatory" },
    { id: "TRN-007", name: "Secure Coding", completionRate: 46.8, avgScore: 92.3, behaviorChange: 53.9, enrolled: 211, completed: 51, duration: "27min", category: "optional" },
    { id: "TRN-008", name: "Cloud Security", completionRate: 93.5, avgScore: 55.9, behaviorChange: 39.0, enrolled: 99, completed: 292, duration: "102min", category: "mandatory" },
    { id: "TRN-009", name: "Mobile Device Security", completionRate: 79.8, avgScore: 61.3, behaviorChange: 49.4, enrolled: 384, completed: 114, duration: "44min", category: "mandatory" },
    { id: "TRN-010", name: "Network Security", completionRate: 60.6, avgScore: 90.0, behaviorChange: 77.2, enrolled: 360, completed: 141, duration: "92min", category: "mandatory" },
    { id: "TRN-011", name: "Physical Security", completionRate: 50.8, avgScore: 56.8, behaviorChange: 81.3, enrolled: 249, completed: 238, duration: "55min", category: "optional" },
    { id: "TRN-012", name: "Regulatory Compliance", completionRate: 48.1, avgScore: 80.1, behaviorChange: 50.5, enrolled: 61, completed: 420, duration: "32min", category: "mandatory" },
    { id: "TRN-013", name: "Risk Management", completionRate: 90.2, avgScore: 85.2, behaviorChange: 72.5, enrolled: 327, completed: 194, duration: "108min", category: "mandatory" },
    { id: "TRN-014", name: "Cryptography Basics", completionRate: 90.8, avgScore: 85.1, behaviorChange: 40.1, enrolled: 117, completed: 396, duration: "66min", category: "mandatory" },
    { id: "TRN-015", name: "Access Control", completionRate: 53.2, avgScore: 82.0, behaviorChange: 71.6, enrolled: 328, completed: 236, duration: "77min", category: "optional" },
    { id: "TRN-016", name: "Vendor Management", completionRate: 59.2, avgScore: 70.2, behaviorChange: 32.8, enrolled: 339, completed: 46, duration: "45min", category: "mandatory" },
  ];
  private _news_feedPhishingResults = [
    { month: "2026-01", sent: 970, clicked: 252, reported: 79, clickRate: round(25.979381443298973,1), reportRate: round(8.144329896907216,1) },
    { month: "2026-02", sent: 454, clicked: 16, reported: 119, clickRate: round(3.524229074889868,1), reportRate: round(26.21145374449339,1) },
    { month: "2026-03", sent: 554, clicked: 11, reported: 319, clickRate: round(1.9855595667870036,1), reportRate: round(57.5812274368231,1) },
    { month: "2026-04", sent: 525, clicked: 149, reported: 131, clickRate: round(28.38095238095238,1), reportRate: round(24.952380952380953,1) },
    { month: "2026-05", sent: 202, clicked: 26, reported: 44, clickRate: round(12.871287128712872,1), reportRate: round(21.782178217821784,1) },
    { month: "2026-06", sent: 260, clicked: 62, reported: 47, clickRate: round(23.846153846153847,1), reportRate: round(18.076923076923077,1) },
  ];
  private _news_feedTrainingROI = { totalInvestment: 85733, avgCostPerEmployee: 693, riskReductionPct: round(random.uniform(15,45),1), incidentReductionPct: round(random.uniform(10,35),1), complianceScoreGain: round(random.uniform(5,25),1) };
  private _news_feedLearningPaths = [
    { name: "Beginner Security Analyst", totalModules: 17, completedModules: 6, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 44, enrolled: 49 },
    { name: "Advanced Threat Hunter", totalModules: 13, completedModules: 5, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 69, enrolled: 95 },
    { name: "Security Architect", totalModules: 14, completedModules: 8, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 27, enrolled: 194 },
    { name: "Incident Responder", totalModules: 20, completedModules: 11, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 22, enrolled: 61 },
    { name: "Compliance Specialist", totalModules: 9, completedModules: 10, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 76, enrolled: 97 },
    { name: "DevSecOps Engineer", totalModules: 8, completedModules: 12, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 24, enrolled: 61 },
  ];
  private _news_feedGetOverallCompletion() {
    const mods = this._news_feedTrainingModules;
    return round(mods.reduce((s,m)=>s+m.completionRate,0)/mods.length,1);
  }
  private _news_feedGetTopPerformers() { return [...this._news_feedTrainingModules].sort((a,b)=>b.avgScore-a.avgScore).slice(0,5); }
  private _news_feedGetModulesNeedingAttention() { return this._news_feedTrainingModules.filter(m=>m.completionRate<70||m.avgScore<65); }

  // === Security Governance Framework (news_feed) ===
  private _news_feedGovBodies = [
    { name: "Security Steering Committee", members: 12, chair: "CISO", meetingFreq: "Weekly", lastMeeting: "2026-04-16", nextMeeting: "2026-05-07", quorum: 6 },
    { name: "Risk Management Board", members: 7, chair: "CTO", meetingFreq: "Bi-weekly", lastMeeting: "2026-04-19", nextMeeting: "2026-05-25", quorum: 3 },
    { name: "Data Governance Council", members: 12, chair: "CRO", meetingFreq: "Monthly", lastMeeting: "2026-04-18", nextMeeting: "2026-05-13", quorum: 3 },
    { name: "Compliance Oversight Board", members: 7, chair: "CDO", meetingFreq: "Monthly", lastMeeting: "2026-04-01", nextMeeting: "2026-05-09", quorum: 5 },
    { name: "Architecture Review Board", members: 13, chair: "VP Eng", meetingFreq: "Bi-weekly", lastMeeting: "2026-04-17", nextMeeting: "2026-05-26", quorum: 5 },
    { name: "Change Advisory Board", members: 6, chair: "CISO", meetingFreq: "Weekly", lastMeeting: "2026-04-13", nextMeeting: "2026-05-22", quorum: 5 },
    { name: "Incident Review Board", members: 10, chair: "CIO", meetingFreq: "As needed", lastMeeting: "2026-04-17", nextMeeting: "2026-05-02", quorum: 3 },
    { name: "Vendor Risk Committee", members: 8, chair: "CFO", meetingFreq: "Quarterly", lastMeeting: "2026-04-03", nextMeeting: "2026-05-15", quorum: 5 },
  ];
  private _news_feedDecisions = [
    { id: "DEC-0001", title: "Adopt zero-trust architecture framework", date: "2026-02-03", status: "approved", owner: "CISO" },
    { id: "DEC-0002", title: "Migrate to SIEM 2.0 platform", date: "2026-01-23", status: "implemented", owner: "CTO" },
    { id: "DEC-0003", title: "Implement DLP across all endpoints", date: "2026-03-10", status: "in-progress", owner: "Security Lead" },
    { id: "DEC-0004", title: "Mandate MFA for all external access", date: "2026-03-07", status: "pending", owner: "CRO" },
    { id: "DEC-0005", title: "Establish bug bounty program", date: "2026-04-15", status: "approved", owner: "VP Eng" },
    { id: "DEC-0006", title: "Deploy EDR solution enterprise-wide", date: "2026-04-15", status: "approved", owner: "CISO" },
    { id: "DEC-0007", title: "Conduct annual penetration testing", date: "2026-02-10", status: "implemented", owner: "CTO" },
    { id: "DEC-0008", title: "Implement network micro-segmentation", date: "2026-02-17", status: "in-progress", owner: "Security Lead" },
    { id: "DEC-0009", title: "Establish security champion program", date: "2026-01-28", status: "pending", owner: "CRO" },
    { id: "DEC-0010", title: "Migrate to passwordless authentication", date: "2026-04-12", status: "approved", owner: "VP Eng" },
  ];
  private _news_feedPolicyLifecycle = [
    { name: "Information Security Policy", version: "v3.0", status: "active", lastUpdated: "2026-03-23", nextReview: "2026-12-26", owner: "CISO" },
    { name: "Acceptable Use Policy", version: "v1.5", status: "active", lastUpdated: "2026-03-04", nextReview: "2026-12-06", owner: "Legal" },
    { name: "Data Retention Policy", version: "v4.2", status: "under-review", lastUpdated: "2026-03-28", nextReview: "2026-9-11", owner: "DPO" },
    { name: "Access Control Policy", version: "v1.3", status: "active", lastUpdated: "2026-02-13", nextReview: "2026-12-21", owner: "IAM Lead" },
    { name: "Incident Response Policy", version: "v1.1", status: "draft", lastUpdated: "2026-04-14", nextReview: "2026-8-21", owner: "IR Lead" },
    { name: "Business Continuity Plan", version: "v2.1", status: "active", lastUpdated: "2026-02-20", nextReview: "2026-10-18", owner: "BCP Mgr" },
    { name: "Vendor Management Policy", version: "v2.1", status: "active", lastUpdated: "2026-04-03", nextReview: "2026-8-14", owner: "Procurement" },
    { name: "Encryption Standard", version: "v2.5", status: "under-review", lastUpdated: "2026-03-03", nextReview: "2026-10-04", owner: "Security Arch" },
  ];
  private _news_feedGovMaturityScore = { overall: 5.1, riskManagement: 3.7, compliance: 2.9, incidentResponse: 2.7, awareness: 4.4, technology: 5.3 };
  private _news_feedGetPendingDecisions() { return this._news_feedDecisions.filter(d=>d.status==='pending'||d.status==='in-progress'); }
  private _news_feedGetActivePolicies() { return this._news_feedPolicyLifecycle.filter(p=>p.status==='active'); }
  private _news_feedGetEscalationPath() { return ["L1 Analyst","L2 Senior","Security Lead","CISO","Board"]; }

  // === Security Innovation Lab (news_feed) ===
  private _news_feedInnoProjects = [
    { id: "INN-001", name: "AI-Powered Threat Detection", description: "Machine learning models for real-time threat identification", status: "active", progress: 72, startDate: "2026-02-12", teamSize: 2, budget: 102626, milestones: 9, completedMilestones: 8 },
    { id: "INN-002", name: "Quantum-Resistant Cryptography", description: "Post-quantum encryption algorithm prototyping", status: "research", progress: 35, startDate: "2026-01-19", teamSize: 4, budget: 26980, milestones: 6, completedMilestones: 4 },
    { id: "INN-003", name: "Automated Red Teaming", description: "Autonomous penetration testing framework", status: "active", progress: 58, startDate: "2026-03-12", teamSize: 4, budget: 37582, milestones: 3, completedMilestones: 4 },
    { id: "INN-004", name: "Zero-Knowledge Authentication", description: "Privacy-preserving identity verification", status: "poc", progress: 88, startDate: "2026-01-06", teamSize: 5, budget: 128675, milestones: 9, completedMilestones: 8 },
    { id: "INN-005", name: "Blockchain Audit Trail", description: "Immutable security event logging", status: "active", progress: 45, startDate: "2026-02-04", teamSize: 5, budget: 14734, milestones: 6, completedMilestones: 6 },
    { id: "INN-006", name: "Behavioral Biometrics", description: "Continuous authentication via user behavior patterns", status: "research", progress: 22, startDate: "2026-03-11", teamSize: 2, budget: 85653, milestones: 6, completedMilestones: 9 },
    { id: "INN-007", name: "Deception Grid 2.0", description: "Advanced honeypot network with adaptive responses", status: "active", progress: 65, startDate: "2026-01-04", teamSize: 5, budget: 107555, milestones: 4, completedMilestones: 7 },
    { id: "INN-008", name: "Secure Enclave Integration", description: "Hardware-backed security for critical workloads", status: "poc", progress: 40, startDate: "2026-03-17", teamSize: 7, budget: 41277, milestones: 8, completedMilestones: 6 },
  ];
  private _news_feedTechEvaluations = [
    { name: "Rust for Security Tools", status: "evaluating", score: 9.4, recommendation: "Adopt", vendor: "Open Source" },
    ...
    { name: "Homomorphic Encryption", status: "evaluating", score: 5.3, recommendation: "Pilot", vendor: "GCP" },
    { name: "SASE Architecture", status: "completed", score: 9.2, recommendation: "Adopt", vendor: "Multiple" },
    { name: "SOAR Platform 3.0", status: "planned", score: 9.9, recommendation: "Monitor", vendor: "Splunk" },
  ];
  private _news_feedCollaborationPartners = [
  ...
  private _news_feedInnoMetrics = { totalProjects: 8, activeProjects: 4, avgTimeToValue: "153 days", pocSuccessRate: round(random.uniform(55,85),1), researchToProduction: round(random.uniform(20,50),1), innovationIndex: round(random.uniform(6.0,9.5),1) };
  private _news_feedGetProjectByStatus(status: string) { return this._news_feedInnoProjects.filter(p=>p.status===status); }
  private _news_feedGetTopEvaluations() { return [...this._news_feedTechEvaluations].sort((a,b)=>b.score-a.score).slice(0,3); }



  // === Compliance Dashboard Extension (news_feed) ===
  private _news_feedComplianceFrameworks = [
    { name: "SOC 2 Type II", description: "Trust Services Criteria", totalControls: 5, implementedControls: 3, status: "non-compliant", lastAudit: "2026-01-26", nextAudit: "2026-8-07", evidenceCount: 493 },
    { name: "ISO 27001", description: "Information Security Management", totalControls: 114, implementedControls: 62, status: "compliant", lastAudit: "2026-04-21", nextAudit: "2026-10-27", evidenceCount: 83 },
    { name: "PCI DSS 4.0", description: "Payment Card Industry", totalControls: 12, implementedControls: 7, status: "partially-compliant", lastAudit: "2026-04-23", nextAudit: "2026-12-10", evidenceCount: 51 },
    { name: "HIPAA", description: "Health Insurance Portability", totalControls: 18, implementedControls: 15, status: "non-compliant", lastAudit: "2026-03-08", nextAudit: "2026-8-12", evidenceCount: 496 },
    { name: "GDPR", description: "Data Protection Regulation", totalControls: 99, implementedControls: 60, status: "partially-compliant", lastAudit: "2026-01-14", nextAudit: "2026-10-10", evidenceCount: 61 },
    { name: "NIST CSF 2.0", description: "Cybersecurity Framework", totalControls: 6, implementedControls: 4, status: "in-review", lastAudit: "2026-03-28", nextAudit: "2026-7-23", evidenceCount: 169 },
    { name: "FedRAMP", description: "Federal Risk Authorization", totalControls: 15, implementedControls: 7, status: "in-review", lastAudit: "2026-01-06", nextAudit: "2026-12-10", evidenceCount: 265 },
    { name: "SOX", description: "Sarbanes-Oxley Compliance", totalControls: 8, implementedControls: 6, status: "partially-compliant", lastAudit: "2026-01-15", nextAudit: "2026-8-19", evidenceCount: 298 },
    { name: "CIS Controls v8", description: "Center for Internet Security", totalControls: 18, implementedControls: 16, status: "partially-compliant", lastAudit: "2026-01-19", nextAudit: "2026-9-16", evidenceCount: 480 },
    { name: "COBIT 2019", description: "IT Governance Framework", totalControls: 40, implementedControls: 25, status: "partially-compliant", lastAudit: "2026-03-02", nextAudit: "2026-10-16", evidenceCount: 129 },
  ];
  private _news_feedGetComplianceScore() {
    const fw = this._news_feedComplianceFrameworks;
    return round(fw.reduce((s,f)=>s + (f.implementedControls/Math.max(f.totalControls,1))*100, 0) / fw.length, 1);
  }
  private _news_feedGetGaps() {
    return this._news_feedComplianceFrameworks.filter(f => f.status !== "compliant");
  }
  private _news_feedAuditTrail = [
    { id: "AUD-0001", action: "Control tested", auditor: "Internal Audit", date: "2026-04-14", result: "pass", findings: 0 },
    { id: "AUD-0002", action: "Evidence collected", auditor: "External Auditor", date: "2026-04-08", result: "pass", findings: 0 },
    { id: "AUD-0003", action: "Gap identified", auditor: "Security Team", date: "2026-04-10", result: "fail", findings: 2 },
    { id: "AUD-0004", action: "Remediation completed", auditor: "Compliance Officer", date: "2026-04-19", result: "pass", findings: 3 },
    { id: "AUD-0005", action: "Policy updated", auditor: "IT Audit", date: "2026-04-15", result: "pass", findings: 3 },
    { id: "AUD-0006", action: "Training verified", auditor: "Risk Team", date: "2026-04-10", result: "pass", findings: 2 },
    { id: "AUD-0007", action: "Access reviewed", auditor: "QA Team", date: "2026-04-11", result: "pass", findings: 4 },
    { id: "AUD-0008", action: "Exception approved", auditor: "CISO Office", date: "2026-04-19", result: "conditional", findings: 5 },
    { id: "AUD-0009", action: "Risk accepted", auditor: "Board Audit", date: "2026-04-16", result: "pass", findings: 5 },
    { id: "AUD-0010", action: "Control enhanced", auditor: "Third Party", date: "2026-04-20", result: "pass", findings: 0 },
  ];

  // === Threat Intelligence Feed Extension (news_feed) ===
  private _news_feedThreatActors = [
    { name: "APT-29", alias: "Cozy Bear", origin: "Russia", type: "Nation-State", severity: "high", lastActivity: "2026-04-01", targets: "Technology", indicators: 463, ttps: 24 },
    { name: "APT-41", alias: "Double Dragon", origin: "China", type: "Nation-State", severity: "critical", lastActivity: "2026-04-03", targets: "Manufacturing", indicators: 332, ttps: 10 },
    { name: "Lazarus Group", alias: "Hidden Cobra", origin: "North Korea", type: "Nation-State", severity: "critical", lastActivity: "2026-04-09", targets: "Energy", indicators: 311, ttps: 19 },
    { name: "FIN7", alias: "Carbanak", origin: "Eastern Europe", type: "Financial", severity: "high", lastActivity: "2026-04-02", targets: "Technology", indicators: 420, ttps: 30 },
    { name: "Conti", alias: "Wizard Spider", origin: "Russia", type: "Ransomware", severity: "critical", lastActivity: "2026-04-14", targets: "Energy", indicators: 106, ttps: 39 },
    { name: "LockBit", alias: "LockBit Gang", origin: "Unknown", type: "Ransomware", severity: "high", lastActivity: "2026-04-14", targets: "Energy", indicators: 126, ttps: 43 },
    { name: "Cl0p", alias: "Cl0p Team", origin: "Unknown", type: "Ransomware", severity: "high", lastActivity: "2026-04-14", targets: "Finance", indicators: 67, ttps: 26 },
    { name: "Sandworm", alias: "Unit 74455", origin: "Russia", type: "Nation-State", severity: "critical", lastActivity: "2026-04-05", targets: "Government", indicators: 134, ttps: 47 },
  ];
  private _news_feedIoCFeed = [
    { id: "ioc-000001", type: "ip", value: "16.158.78.232", confidence: 96, source: "CrowdStrike", firstSeen: "2026-04-17", lastSeen: "2026-04-22" },
    { id: "ioc-000002", type: "ip", value: "121.56.255.18", confidence: 75, source: "Mandiant", firstSeen: "2026-04-02", lastSeen: "2026-04-16" },
    { id: "ioc-000003", type: "ip", value: "14.232.237.4", confidence: 69, source: "STIX", firstSeen: "2026-04-15", lastSeen: "2026-04-01" },
    { id: "ioc-000004", type: "ip", value: "175.249.221.199", confidence: 45, source: "MISP", firstSeen: "2026-04-11", lastSeen: "2026-04-12" },
    { id: "ioc-000005", type: "ip", value: "172.248.235.22", confidence: 64, source: "Mandiant", firstSeen: "2026-04-19", lastSeen: "2026-04-14" },
    { id: "ioc-000006", type: "ip", value: "211.143.40.12", confidence: 88, source: "VirusTotal", firstSeen: "2026-04-08", lastSeen: "2026-04-17" },
    { id: "ioc-000007", type: "ip", value: "118.85.127.99", confidence: 51, source: "VirusTotal", firstSeen: "2026-04-08", lastSeen: "2026-04-02" },
    { id: "ioc-000008", type: "ip", value: "141.165.236.205", confidence: 70, source: "Mandiant", firstSeen: "2026-04-06", lastSeen: "2026-04-16" },
    { id: "ioc-000009", type: "ip", value: "249.245.174.90", confidence: 60, source: "CrowdStrike", firstSeen: "2026-04-02", lastSeen: "2026-04-11" },
    { id: "ioc-000010", type: "ip", value: "94.228.148.106", confidence: 63, source: "CrowdStrike", firstSeen: "2026-04-18", lastSeen: "2026-04-17" },
    { id: "ioc-000011", type: "ip", value: "174.156.78.142", confidence: 98, source: "MISP", firstSeen: "2026-04-07", lastSeen: "2026-04-21" },
    { id: "ioc-000012", type: "ip", value: "110.217.118.224", confidence: 86, source: "STIX", firstSeen: "2026-04-16", lastSeen: "2026-04-03" },
    { id: "ioc-000013", type: "ip", value: "191.92.5.118", confidence: 79, source: "AlienVault", firstSeen: "2026-04-22", lastSeen: "2026-04-09" },
    { id: "ioc-000014", type: "ip", value: "198.249.211.244", confidence: 75, source: "STIX", firstSeen: "2026-04-09", lastSeen: "2026-04-16" },
    { id: "ioc-000015", type: "ip", value: "197.9.125.158", confidence: 42, source: "VirusTotal", firstSeen: "2026-04-07", lastSeen: "2026-04-19" },
  ];
  private _news_feedGetActiveThreats() { return this._news_feedThreatActors.filter(a => a.severity === 'critical'); }
  private _news_feedGetThreatSummary() {
    const actors = this._news_feedThreatActors;
  ...
  // === Incident Management Extension (news_feed) ===
  private _news_feedIncidents = [
    { id: "INC-20260001", title: "Unauthorized access detected", severity: "critical", status: "open", assignedTo: "SOC L1", detectedAt: "2026-04-07T11:38", affectedAssets: 37, rootCause: "Misconfiguration" },
    { id: "INC-20260002", title: "Malware outbreak on workstation", severity: "high", status: "investigating", assignedTo: "SOC L2", detectedAt: "2026-04-12T13:23", affectedAssets: 11, rootCause: "Credential compromise" },
    { id: "INC-20260003", title: "Data leak from S3 bucket", severity: "medium", status: "contained", assignedTo: "IR Lead", detectedAt: "2026-04-03T06:08", affectedAssets: 7, rootCause: "Zero-day" },
    { id: "INC-20260004", title: "Phishing campaign targeting finance", severity: "low", status: "eradicated", assignedTo: "CISO", detectedAt: "2026-04-19T04:48", affectedAssets: 18, rootCause: "Human error" },
    { id: "INC-20260005", title: "DDoS attack on web services", severity: "critical", status: "recovered", assignedTo: "Security Eng", detectedAt: "2026-04-20T06:00", affectedAssets: 5, rootCause: "Policy violation" },
    { id: "INC-20260006", title: "Ransomware encryption attempt", severity: "high", status: "closed", assignedTo: "Forensics", detectedAt: "2026-04-16T04:31", affectedAssets: 10, rootCause: "Unknown" },
    { id: "INC-20260007", title: "Insider data exfiltration", severity: "medium", status: "open", assignedTo: "SOC L1", detectedAt: "2026-04-04T00:04", affectedAssets: 22, rootCause: "Misconfiguration" },
    { id: "INC-20260008", title: "API key exposure in repo", severity: "low", status: "investigating", assignedTo: "SOC L2", detectedAt: "2026-04-12T07:48", affectedAssets: 7, rootCause: "Credential compromise" },
    { id: "INC-20260009", title: "SQL injection on portal", severity: "critical", status: "contained", assignedTo: "IR Lead", detectedAt: "2026-04-14T17:31", affectedAssets: 7, rootCause: "Zero-day" },
    { id: "INC-20260010", title: "Brute force on VPN", severity: "high", status: "eradicated", assignedTo: "CISO", detectedAt: "2026-04-15T04:55", affectedAssets: 36, rootCause: "Human error" },
    { id: "INC-20260011", title: "Supply chain alert from vendor", severity: "medium", status: "recovered", assignedTo: "Security Eng", detectedAt: "2026-04-18T11:59", affectedAssets: 45, rootCause: "Policy violation" },
    { id: "INC-20260012", title: "Suspicious lateral movement", severity: "low", status: "closed", assignedTo: "Forensics", detectedAt: "2026-04-20T18:31", affectedAssets: 43, rootCause: "Unknown" },
  ];
  private _news_feedGetIncidentStats() {
    const inc = this._news_feedIncidents;
    return { total: inc.length, open: inc.filter(i=>i.status==="open").length, investigating: inc.filter(i=>i.status==="investigating").length, mttd: 25, mttr: 175 };
  }
  private _news_feedGetSeverityDistribution() {
    const inc = this._news_feedIncidents;
  ...
  render() {    if (this._nfRules.length === 0) { this._initNfRules(); this._initNfCvss(); this._runNfAnomalyDetection(); this._generateNfPredictions(); this._initNfApprovals(); this._initNfActivity(); this._initNfNotifications(); }
...
<div class="tabs">
        ...
        ${this._activeTab === 'rules' ? html`
          ...
          <div style="background:#1a1d27;border-radius:8px;padding:12px">${this._renderNfTreemapSVG()}</div>
          <div style="margin-top:12px;font-size:11px;font-weight:600;margin-bottom:6px">Data Flow (Sankey)</div>
          <div style="background:#1a1d27;border-radius:8px;padding:12px">${this._renderNfSankeySVG()}</div>
          ${this._renderNfActivity()}
        ` : nothing}
        ${this._activeTab === 'anomalies' ? html`
          ${this._renderNfAnomalies()}
          ${this._renderNfNotifications()}
        ` : nothing}
        ${this._activeTab === 'predictions' ? html`
          ${this._renderNfPredictions()}
          ...
          <div style="background:#1a1d27;border-radius:8px;padding:12px">
            <table class="history-table"><thead><tr><th>ID</th><th>Base</th><th>Temporal</th><th>Environmental</th><th>Overall</th></tr></thead><tbody>
              ${this._nfcvssData.map(c => html`<tr><td>${c.itemId}</td><td style="color:${c.base >= 7 ? '#ef4444' : c.base >= 4 ? '#eab308' : '#22c55e'}">${c.base}</td><td>${c.temporal}</td><td>${c.environmental}</td><td style="font-weight:700;color:${c.overall >= 7 ? '#ef4444' : c.overall >= 4 ? '#eab308' : '#22c55e'}">${c.overall}</td></tr>`)}
            </tbody></table>
          </div>
        ` : nothing}
        ${this._activeTab === 'approvals' ? html`
          ${this._renderNfApprovals()}
        ` : nothing}
        ${this._activeTab === 'config' ? html`
          ${this._renderNfConfig()}
        ` : nothing}
        ${this._activeTab === 'new' ? html`
          <div class="form-section">
            <div class="form-title">Create New News Feed Entry</div>
            <div class="form-grid">
  ...
  @state() private _nfScenarios: {id:string;name:string;attackType:string;target:string;method:string;impactLow:number;impactHigh:number;confidence:number;mitigation:string;status:string}[] = [];
  @state() private _nfScenarioForm: {attackType:string;target:string;method:string} = {attackType:'',target:'',method:''};
  @state() private _nfScenarioCompare: boolean = false;
  @state() private _nfScenarioSelected: string[] = [];

  private _nfInitScenarios(): void {
    const saved = localStorage.getItem('nf_scenarios');
    if (saved) { try { this._nfScenarios = JSON.parse(saved); } catch { /* ignore */ } }
    if (this._nfScenarios.length === 0) {
      this._nfScenarios = [
        {id:'nf-s1',name:'Baseline Threat',attackType:'Phishing',target:'Employees',method:'Spear Email',impactLow:45,impactHigh:78,confidence:72,mitigation:'Security awareness training + email filtering',status:'active'},
        {id:'nf-s2',name:'Escalated Attack',attackType:'Ransomware',target:'Endpoints',method:'Drive-by Download',impactLow:65,impactHigh:95,confidence:58,mitigation:'EDR deployment + network segmentation',status:'saved'},
        {id:'nf-s3',name:'Insider Threat',attackType:'Data Exfiltration',target:'Databases',method:'SQL Injection',impactLow:55,impactHigh:88,confidence:65,mitigation:'DLP policies + query monitoring',status:'draft'},
      ];
    }
  }

  private _nfSaveScenarios(): void {
    localStorage.setItem('nf_scenarios', JSON.stringify(this._nfScenarios));
  }

  private _nfAddScenario(): void {
    const f = this._nfScenarioForm;
    if (!f.attackType || !f.target) return;
    this._nfScenarios = [...this._nfScenarios, {
      id: 'nf-s' + (this._nfScenarios.length + 1),
    ...
    this._nfScenarioForm = {attackType:'',target:'',method:''};
    this._nfSaveScenarios();
  }

  private _nfRenderScenarioEngine(): any {
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <button class="tab" @click=${() => { this._nfScenarioCompare = !this._nfScenarioCompare; }}>${this._nfScenarioCompare ? 'List View' : 'Compare'}</button>
        </div>
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:6px;margin-bottom:10px">
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._nfScenarioForm = {...this._nfScenarioForm, attackType: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Attack Type</option>
            ${attackTypes.map(a => html`<option value=${a} ${this._nfScenarioForm.attackType === a ? 'selected' : ''}>${a}</option>`)}
          </select>
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._nfScenarioForm = {...this._nfScenarioForm, target: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Target</option>
            ${targets.map(t => html`<option value=${t} ${this._nfScenarioForm.target === t ? 'selected' : ''}>${t}</option>`)}
          </select>
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._nfScenarioForm = {...this._nfScenarioForm, method: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Method</option>
            ${methods.map(m => html`<option value=${m} ${this._nfScenarioForm.method === m ? 'selected' : ''}>${m}</option>`)}
          </select>
        </div>
        <button style="background:#3b82f6;border:none;border-radius:4px;padding:4px 12px;color:#fff;font-size:11px;cursor:pointer" @click=${this._nfAddScenario}>Run Simulation</button>
      </div>
      ${this._nfScenarioCompare && this._nfScenarios.length >= 2 ? html`
        <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
          <div style="font-weight:600;font-size:12px;color:#e2e8f0;margin-bottom:8px">Side-by-Side Comparison</div>
          <div style="display:grid;grid-template-columns:repeat(${Math.min(3, this._nfScenarios.length)},1fr);gap:8px">
            ${this._nfScenarios.slice(0,3).map(s => html`
      ...
      <div style="background:#0f1117;border-radius:8px;padding:12px">
        <div style="font-weight:600;font-size:12px;color:#e2e8f0;margin-bottom:8px">Saved Scenarios (${this._nfScenarios.length})</div>
        ${this._nfScenarios.map(s => html`
  ...
  @state() private _nfTrendData: {day:number;value:number;anomaly:boolean}[] = [];
  @state() private _nfTrendZoom: {start:number;end:number} | null = null;
  @state() private _nfTrendMA: number = 7;

  private _nfInitTrendData(): void {
    ...
    this._nfTrendData = data;
  }

  private _nfCalcMA(window: number): number[] {
    const result: number[] = [];
    for (let i = 0; i < this._nfTrendData.length; i++) {
      const start = Math.max(0, i - window + 1);
      const slice = this._nfTrendData.slice(start, i + 1);
      result.push(slice.reduce((s, d) => s + d.value, 0) / slice.length);
    }
    return result;
  }

  private _nfGetStats(): {mean:number;median:number;stddev:number;trend:string} {
    const vals = this._nfTrendData.map(d => d.value);
    const n = vals.length;
  ...
  private _nfRenderTimeSeries(): any {
    const stats = this._nfGetStats();
    const filtered = this._nfTrendZoom ? this._nfTrendData.filter(d => d.day >= this._nfTrendZoom.start && d.day <= this._nfTrendZoom.end) : this._nfTrendData;
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px">
            <button class="tab ${this._nfTrendMA === 7 ? 'active' : ''}" @click=${() => { this._nfTrendMA = 7; }}>7D MA</button>
            <button class="tab ${this._nfTrendMA === 30 ? 'active' : ''}" @click=${() => { this._nfTrendMA = 30; }}>30D MA</button>
            <button class="tab" @click=${() => { this._nfTrendZoom = null; }}>Reset Zoom</button>
          </div>
        </div>
        <div style="position:relative;height:120px;background:#1a1d2e;border-radius:6px;overflow:hidden;margin-bottom:8px;cursor:crosshair" @click=${(e: any) => {
          ...
          this._nfTrendZoom = { start: Math.max(0, center - 10), end: Math.min(89, center + 10) };
        }}>
  ...
  @state() private _nfRoles: string[] = ['Admin','Analyst','Operator','Viewer','Auditor'];
  @state() private _nfActions: string[] = ['Create','Read','Update','Delete','Export','Approve'];
  @state() private _nfPermissions: { [role: string]: { [action: string]: boolean } } = {};
  @state() private _nfPermAudit: {role:string;action:string;changedBy:string;timestamp:string;oldVal:boolean;newVal:boolean}[] = [];
  @state() private _nfPermCompare: string[] = [];

  private _nfInitPermissions(): void {
    ...
    for (const role of this._nfRoles) {
      perms[role] = {};
      this._nfActions.forEach((a, i) => { perms[role][a] = defaults[role]?.[i] ?? false; });
    }
    this._nfPermissions = perms;
  }

  private _nfTogglePermission(role: string, action: string): void {
    const old = this._nfPermissions[role][action];
    this._nfPermissions = {...this._nfPermissions, [role]: {...this._nfPermissions[role], [action]: !old}};
    this._nfPermAudit.unshift({role,action,changedBy:'current_user',timestamp:new Date().toISOString(),oldVal:old,newVal:!old});
  }

  private _nfRenderRBAC(): any {
    const compareRoles = this._nfPermCompare.map(r => this._nfPermissions[r]).filter(Boolean);
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          <span style="font-weight:700;font-size:13px;color:#e2e8f0">RBAC Permission Matrix</span>
          <div style="display:flex;gap:4px">
            ${this._nfRoles.map(r => html`
              <button class="tab ${this._nfPermCompare.includes(r) ? 'active' : ''}" @click=${() => {
                this._nfPermCompare = this._nfPermCompare.includes(r) ? this._nfPermCompare.filter(x => x !== r) : [...this._nfPermCompare, r];
              }}>${r}</button>
            `)}
          </div>
        </div>
          ...
          <table style="width:100%;border-collapse:collapse;font-size:10px">
            <thead>
              <tr>
                ...
                ${this._nfActions.map(a => html`<th style="padding:6px;color:#6b7280;border-bottom:1px solid #2a2d3a;text-align:center">${a}</th>`)}
              </tr>
            </thead>
            <tbody>
              ${this._nfRoles.map(role => html`
                <tr style="border-bottom:1px solid #1a1d2e">
                  <td style="padding:6px;color:#e2e8f0;font-weight:600">${role}</td>
                  ${this._nfActions.map(action => html`
                    <td style="text-align:center;padding:6px">
                      <button style="width:28px;height:20px;border-radius:3px;border:1px solid #2a2d3a;background:${this._nfPermissions[role][action] ? '#22c55e' : '#1a1d2e'};cursor:pointer;color:#fff;font-size:10px" @click=${() => this._nfTogglePermission(role, action)}>${this._nfPermissions[role][action] ? 'Y' : 'N'}</button>
                    </td>
                  `)}
                </tr>
              `)}
        ...
        ${compareRoles.length >= 2 ? html`
          <div style="margin-top:10px;padding:8px;background:#1a1d2e;border-radius:6px">
            <div style="font-size:11px;font-weight:600;color:#e2e8f0;margin-bottom:6px">Role Diff: ${this._nfPermCompare.join(' vs ')}</div>
            ${this._nfActions.map(action => {
              ...
              return allSame ? nothing : html`
                <div style="display:flex;gap:8px;padding:3px 0;font-size:10px">
                  ...
                  ${compareRoles.map((r, i) => html`<span style="color:${r[action] ? '#22c55e' : '#ef4444'}">${this._nfPermCompare[i]}=${r[action] ? 'Y' : 'N'}</span>`)}
                </div>
              `;
            })}
          </div>
        ` : nothing}
        ${this._nfPermAudit.length > 0 ? html`
          <div style="margin-top:8px;font-size:9px;color:#6b7280">Recent: ${this._nfPermAudit.slice(0,3).map(a => html`<span style="margin-right:8px">${a.role}.${a.action}: ${a.oldVal ? 'Y' : 'N'}->${a.newVal ? 'Y' : 'N'}</span>`)}
        ` : nothing}
      </div>
    `;
  }
  ...
  // === REPORTING SUITE ===
  @state() private _nfReportTemplate: string = 'executive';
  @state() private _nfReportSchedule: string = 'weekly';
  @state() private _nfReportDistList: string[] = ['security-team@company.com','ciso@company.com'];
  @state() private _nfReportHistory: {id:string;template:string;generatedAt:string;status:string}[] = [];

  private _nfGenerateReport(): void {
    const id = 'rpt-' + Date.now();
    this._nfReportHistory.unshift({id,template:this._nfReportTemplate,generatedAt:new Date().toISOString(),status:'sent'});
  }

  private _nfRenderReporting(): any {
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:8px">
          <div>
            ...
            ${templates.map(t => html`
              <div style="padding:6px;background:${this._nfReportTemplate === t.key ? '#1e3a5f' : '#1a1d2e'};border:1px solid ${this._nfReportTemplate === t.key ? '#3b82f6' : '#2a2d3a'};border-radius:4px;margin-bottom:4px;cursor:pointer" @click=${() => { this._nfReportTemplate = t.key; }}>
          ...
          <div>
            ...
            <div style="display:flex;gap:4px;margin-bottom:8px">
              ${schedules.map(s => html`<button class="tab ${this._nfReportSchedule === s.key ? 'active' : ''}" @click=${() => { this._nfReportSchedule = s.key; }}>${s.label}</button>`)}
            </div>
            <div style="font-size:10px;color:#6b7280;margin-bottom:4px">Distribution</div>
            <div style="font-size:10px;color:#9ca3af">${this._nfReportDistList.map(d => html`<div>${d}</div>`)}</div>
            <div style="margin-top:6px;display:flex;gap:4px">
              <button style="background:#3b82f6;border:none;border-radius:4px;padding:4px 10px;color:#fff;font-size:10px;cursor:pointer" @click=${this._nfGenerateReport}>Generate</button>
        ...
        ${this._nfReportHistory.length > 0 ? html`
          <div style="border-top:1px solid #2a2d3a;padding-top:8px">
            ...
            ${this._nfReportHistory.slice(0,3).map(r => html`
  ...
  @state() private _nfHighContrast: boolean = false;
  @state() private _nfA11yAnnounce: string = '';
  @state() private _nfShortcutsVisible: boolean = false;
  @state() private _nfFocusTrap: boolean = false;

  private _nfShortcuts: Record<string, string> = {
  ...
  private _nfHandleKeydown(e: KeyboardEvent): void {
    if (e.key === 'Escape' && this._nfFocusTrap) { this._nfFocusTrap = false; this._nfAnnounce('Dialog closed'); }
    if (e.ctrlKey && e.shiftKey && e.key === 'H') { e.preventDefault(); this._nfHighContrast = !this._nfHighContrast; this._nfAnnounce('High contrast ' + (this._nfHighContrast ? 'enabled' : 'disabled')); }
    if (e.ctrlKey && e.shiftKey && e.key === 'A') { e.preventDefault(); this._nfShortcutsVisible = !this._nfShortcutsVisible; }
  }

  private _nfAnnounce(msg: string): void {
    this._nfA11yAnnounce = msg;
    setTimeout(() => { this._nfA11yAnnounce = ''; }, 2000);
  }

  private _nfRenderAccessibility(): any {
    return html`
      <div role="region" aria-label="Accessibility Controls" style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <button class="tab ${this._nfShortcutsVisible ? 'active' : ''}" @click=${() => { this._nfShortcutsVisible = !this._nfShortcutsVisible; }} aria-expanded=${this._nfShortcutsVisible}>Shortcuts</button>
        </div>
        <div style="display:flex;gap:8px;margin-bottom:8px">
          <label style="display:flex;align-items:center;gap:6px;font-size:11px;color:#e2e8f0;cursor:pointer">
            <input type="checkbox" .checked=${this._nfHighContrast} @change=${() => { this._nfHighContrast = !this._nfHighContrast; }} aria-label="Toggle high contrast mode">
            High Contrast
          </label>
        </div>
        ${this._nfShortcutsVisible ? html`
          <div role="list" aria-label="Keyboard shortcuts" style="background:#1a1d2e;border-radius:6px;padding:8px">
            ${Object.entries(this._nfShortcuts).map(([key, desc]) => html`
        ...
        ` : nothing}
        <div role="status" aria-live="polite" aria-atomic="true" style="position:absolute;left:-9999px">${this._nfA11yAnnounce}</div>
      </div>
    `;
  }
  ...
  connectedCallback(): void {
    ...
    this._nfInitScenarios();
    this._nfInitTrendData();
    this._nfInitPermissions();
    document.addEventListener('keydown', this._nfHandleKeydown.bind(this));
  }

  disconnectedCallback(): void {
    super.disconnectedCallback();
    document.removeEventListener('keydown', this._nfHandleKeydown.bind(this));
  }

  // === TAB INTEGRATION FOR EXTENDED FEATURES ===
  @state() private _nfActiveSubTab: string = 'scenario';
  ...
  private _nfGetAllSubTabs(): {key:string;label:string}[] {
    return [
  ...
  private _nfRenderSubPanel(): any {
    switch (this._nfActiveSubTab) {
      case 'scenario': return this._nfRenderScenarioEngine();
      case 'timeseries': return this._nfRenderTimeSeries();
      case 'rbac': return this._nfRenderRBAC();
      case 'reporting': return this._nfRenderReporting();
      case 'a11y': return this._nfRenderAccessibility();
      default: return nothing;
    }
  }

  private _nfRenderTabBar(): any {
    return html`
      <div style="display:flex;gap:4px;margin-bottom:12px;border-bottom:1px solid #2a2d3a;padding-bottom:8px;flex-wrap:wrap" role="tablist" aria-label="Extended panel features">
        ${this._nfGetAllSubTabs().map(t => html`
          <button class="tab ${this._nfActiveSubTab === t.key ? 'active' : ''}" @click=${() => { this._nfActiveSubTab = t.key; }} role="tab" aria-selected=${this._nfActiveSubTab === t.key}>${t.label}</button>
        `)}
      </div>
      <div role="tabpanel" aria-labelledby="nf-tab-${this._nfActiveSubTab}">
        ${this._nfRenderSubPanel()}
      </div>
    `;
  }
  ...
  @state() private _soarPlaybooks: Array<{
    ...
    {
      id: 'pb-soar-001', name: 'News Feed Auto Response', status: 'active',
      steps: [
    ...
    {
      id: 'pb-soar-002', name: 'News Feed Investigation Workflow', status: 'active',
      steps: [
    ...
    {
      id: 'pb-soar-003', name: 'News Feed Compliance Scan', status: 'draft',
      steps: [
  ...
  @state() private _nfAle: number = 0;
  @state() private _nfSroi: number = 0;
  @state() private _nfCpi: number = 0;
  @state() private _nfBudgetAlloc: number = 0;
  @state() private _nfCostBenefit: number = 0;

  // Security Economics Calculator
  private nfInitEconomics() {
    this._nfAle = Math.round(2850000 + Math.random() * 4500000);
    this._nfSroi = Math.round(180 + Math.random() * 320);
    this._nfCpi = Math.round(45000 + Math.random() * 120000);
    this._nfBudgetAlloc = Math.round(2500000 + Math.random() * 3000000);
    this._nfCostBenefit = Math.round(220 + Math.random() * 180);
  }

  private _nfCalcAle(): { annual: number; perIncident: number; byCategory: Array<{name: string; value: number}> } {
    const base = this._nfAle;
    const categories = [
  ...
  private _nfCalcSroi(): Array<{year: number; investment: number; savings: number; roi: number}> {
    const baseInv = this._nfSroi * 10000;
  ...
  private _nfGetBudgetAlloc(): Array<{category: string; amount: number; pct: number; trend: string}> {
    const total = this._nfBudgetAlloc;
    const items = [
  ...
  private _nfGetCostBenefit(): Array<{control: string; cost: number; benefit: number; ratio: number; priority: string}> {
    const base = this._nfCostBenefit;
    const controls = [
  ...
  private _nfRenderEconomics() {
    const ale = this._nfCalcAle();
    const roi = this._nfCalcSroi();
    const budget = this._nfGetBudgetAlloc();
    const cb = this._nfGetCostBenefit();
    const cpi = this._nfCpi;
  ...
  @state() private _nfThreatLevel: any = null;
  @state() private _nfEmergingThreats: any = null;
  @state() private _nfThreatTrends: any = null;
  @state() private _nfSectorRadar: any = null;
  @state() private _nfActorActivity: any = null;

  // Threat Landscape Intelligence
  private nfInitThreatIntel() {
    this._nfThreatLevel = {
  ...
  private _nfRenderThreatIntel() {
    const tl = this._nfThreatLevel;
    const et = this._nfEmergingThreats;
    const sr = this._nfSectorRadar;
    const aa = this._nfActorActivity;
  ...
  @state() private _nfPolicies: any = null;
  @state() private _nfExceptions: any = null;
  @state() private _nfRiskRegister: any = null;
  @state() private _nfMeetings: any = null;
  @state() private _nfDeadlines: any = null;

  // Security Governance Dashboard
  private nfInitGovernance() {
    this._nfPolicies = [
  ...
  private _nfRenderGovernance() {
    const policies = this._nfPolicies;
    const risks = this._nfRiskRegister;
    const deadlines = this._nfDeadlines;
  ...
  @state() private _nfCriticalAssets: any = null;
  @state() private _nfAssetDeps: any = null;
  @state() private _nfEolAssets: any = null;
  @state() private _nfAssetRisk: any = null;

  // Asset Intelligence
  private nfInitAssetIntel() {
    this._nfCriticalAssets = [
    ...
    this._nfAssetRisk = { critical: 7, high: 23, medium: 45, low: 128, total: 203 };
  }

  private _nfRenderAssetIntel() {
    const assets = this._nfCriticalAssets;
    const eol = this._nfEolAssets;
    const ar = this._nfAssetRisk;
  ...
  @state() private _nfUserBaseline: any = null;
  @state() private _nfAnomalyRules: any = null;
  @state() private _nfDataAccess: any = null;
  @state() private _nfInsiderRisk: any = null;
  @state() private _newsfer15Timeline: Array<{id:string;time:string;event:string;severity:string;actor:string}> = [
  ...
  @state() private _newsfer15RootCauses: Array<{why:string;answer:string}> = [
  ...
  @state() private _newsfer15ImpactMatrix: Array<{system:string;users:number;data:string;revenue:string;status:string}> = [
  ...
  @state() private _newsfer15Actions: Array<{id:string;item:string;owner:string;deadline:string;priority:string;status:string}> = [
  ...
  @state() private _newsfer15Lessons: Array<{id:string;lesson:string;category:string;severity:string;applies_to:string}> = [
  ...
  @state() private _newsfer15ActiveTab: string = 'timeline';
  @state() private _newsfer15Benchmarks: Array<{metric:string;current:number;industry:number;target:number;unit:string;source:string}> = [
  ...
  @state() private _newsfer15MaturityLevels: Array<{domain:string;current:number;target:number;description:string}> = [
  ...
  @state() private _newsfer15QuarterlyData: Array<{quarter:string;score:number;improvement:number}> = [
  ...
  @state() private _newsfer15SelectedDomain: string = 'all';
  @state() private _newsfer15Alerts: Array<{id:string;name:string;severity:number;confidence:number;assetCrit:number;score:number;enriched:boolean;group:string;status:string;enrichData:Array<{key:string;value:string}>}> = [
  ...
  @state() private _newsfer15QualityMetrics: {fpRate:number;enrichSuccess:number;avgTriageTime:number;enrichedCount:number;totalCount:number} = {fpRate:0.12, enrichSuccess:0.78, avgTriageTime:4.5, enrichedCount:3, totalCount:5};
  @state() private _newsfer15RoutingRules: Array<{name:string;condition:string;channel:string;active:boolean}> = [
  ...
  @state() private _newsfer15Shapes: Array<{id:string;type:string;label:string;controls:string[]}> = [
  ...
  @state() private _newsfer15TrustBoundaries: Array<{from:string;to:string;label:string;strength:string}> = [
  ...
  @state() private _newsfer15ADRs: Array<{id:string;title:string;status:string;date:string;decision:string}> = [
  ...
  @state() private _newsfer15SelectedShape: string = '';
  @state() private _newsfer15Gauges: Array<{name:string;value:number;max:number;unit:string;status:string;color:string}> = [
  ...
  @state() private _newsfer15Anomalies: Array<{id:string;time:string;description:string;severity:string;acknowledged:boolean}> = [
  ...
  @state() private _newsfer15Integrations: Array<{name:string;status:string;uptime:number;lastCheck:string;latency:number}> = [
  ...
  @state() private _newsfer15AlertFatigue: Array<{analyst:string;alertsPerDay:number;escalated:number;dismissed:number;avgResponseMin:number}> = [
  ...
  @state() private _newsfer15SlaTarget: number = 99.9;

  // Insider Threat Detection
  private nfInitInsiderThreat() {
    this._nfUserBaseline = [
    ...
    this._nfInsiderRisk = { totalUsers: 2847, monitored: 342, flagged: 18, investigated: 5, confirmed: 1 };
  }

  private _nfRenderInsiderThreat() {
    const baseline = this._nfUserBaseline;
    const rules = this._nfAnomalyRules;
    const ir = this._nfInsiderRisk;
    ...
    return html`<div class="card" style="padding:14px;margin-bottom:8px">
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px;margin-bottom:10px;flex-wrap:wrap">
            ${['timeline','rootcause','impact','actions','lessons'].map(t => html`
              <button class="btn ${this._newsfer15ActiveTab === t ? 'btn-primary' : ''}" style="font-size:10px;padding:3px 8px" @click=${() => { this._newsfer15ActiveTab = t; }}>${t.charAt(0).toUpperCase() + t.slice(1)}</button>
            `)}
          </div>
          ${this._newsfer15ActiveTab === 'timeline' ? html`
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._newsfer15Timeline.map(e => html`
          ...
          ` : this._newsfer15ActiveTab === 'rootcause' ? html`
            <div style="margin-bottom:8px">${{__html: this._newsfer15RenderFishbone()}}</div>
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._newsfer15RootCauses.map((rc, i) => html`
          ...
          ` : this._newsfer15ActiveTab === 'impact' ? html`
            <div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:10px">
              ...
              <tbody>${this._newsfer15ImpactMatrix.map(imp => html`
          ...
          ` : this._newsfer15ActiveTab === 'actions' ? html`
            <div style="display:flex;gap:12px;margin-bottom:8px;font-size:10px;color:#888">
              ${Object.entries(this._newsfer15GetActionStats()).map(([k,v]) => html`<span>${k}: <b style="color:#ddd">${v}</b></span>`)}
            </div>
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._newsfer15Actions.map(a => html`
                <div style="display:flex;gap:8px;align-items:center;padding:6px;background:#1a1d27;border-radius:4px;cursor:pointer" @click=${() => this._newsfer15ToggleAction(a.id)}>
          ...
          ` : html`
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._newsfer15Lessons.map(l => html`
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px;margin-bottom:10px;flex-wrap:wrap">
            ${['all', ...this._newsfer15MaturityLevels.map(m => m.domain)].map(d => html`
              <button class="btn ${this._newsfer15SelectedDomain === d ? 'btn-primary' : ''}" style="font-size:9px;padding:2px 6px" @click=${() => { this._newsfer15SelectedDomain = d; }}>${d}</button>
            `)}
          </div>
          <div style="display:flex;gap:16px;margin-bottom:10px">
            <div style="text-align:center"><div style="color:#e0e0e0;font-size:20px;font-weight:bold">${this._newsfer15GetOverallMaturity()}/5</div><div style="color:#888;font-size:10px">Maturity Level</div></div>
            <div style="text-align:center"><div style="color:#4f4;font-size:20px;font-weight:bold">${this._newsfer15GetGapAnalysis().filter(g => g.isAbove).length}/${this._newsfer15Benchmarks.length}</div><div style="color:#888;font-size:10px">Above Industry</div></div>
          </div>
          <div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:10px">
            ...
            <tbody>${this._newsfer15GetGapAnalysis().map(b => html`
          ...
          <div style="margin-top:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Maturity by Domain</div>
            ${this._newsfer15MaturityLevels.filter(m => this._newsfer15SelectedDomain === 'all' || m.domain === this._newsfer15SelectedDomain).map(m => html`
          ...
          <div style="margin-top:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Quarterly Trend</div>
            <div style="display:flex;height:40px;align-items:flex-end;gap:4px">
              ${this._newsfer15QuarterlyData.map(q => html`<div style="flex:1;text-align:center"><div style="background:#4a9eff;height:${q.score * 0.5}px;border-radius:2px 2px 0 0" title="${q.score}"></div><div style="color:#666;font-size:8px;margin-top:2px">${q.quarter}</div></div>`)}
            </div>
          </div>
        </div>
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:12px;margin-bottom:8px;font-size:10px">
            <div style="display:flex;gap:4px;flex-wrap:wrap">${this._newsfer15GroupAlerts().map(g => html`<span style="color:#888;padding:2px 6px;background:#1a1d27;border-radius:3px">${g.group}: ${g.count}</span>`)}</div>
          </div>
          <div style="display:flex;gap:8px;margin-bottom:8px;font-size:10px;color:#888">
            <span>FP Rate: <b style="color:${this._newsfer15QualityMetrics.fpRate > 0.15 ? '#f44' : '#4f4'}">${(this._newsfer15QualityMetrics.fpRate * 100).toFixed(1)}%</b></span>
            <span>Enrich: <b style="color:#4a9eff">${(this._newsfer15QualityMetrics.enrichSuccess * 100).toFixed(0)}%</b></span>
            <span>Avg Triage: <b style="color:#ddd">${this._newsfer15QualityMetrics.avgTriageTime}m</b></span>
          </div>
          <div style="display:flex;flex-direction:column;gap:4px;max-height:200px;overflow-y:auto">
            ${this._newsfer15Alerts.sort((a, b) => this._newsfer15CalcScore(b) - this._newsfer15CalcScore(a)).map(a => {
              const score = this._newsfer15CalcScore(a);
              return html`
                <div style="padding:6px;background:#1a1d27;border-radius:4px;border-left:3px solid ${a.severity >= 4 ? '#f44' : a.severity >= 3 ? '#fa0' : '#4a9eff'}">
                  <div style="display:flex;justify-content:space-between;align-items:center">
                    ...
                    <button class="btn" style="font-size:9px;padding:1px 6px;margin-left:4px" @click=${() => this._newsfer15EnrichAlert(a.id)}>${a.enriched ? 'Re-enrich' : 'Enrich'}</button>
                  </div>
          ...
          <div style="margin-top:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Routing Rules</div>
            ${this._newsfer15RoutingRules.map(r => html`
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:8px;margin-bottom:8px;flex-wrap:wrap">
            ${this._newsfer15Shapes.map(s => {
              const v = this._newsfer15ValidateControl(s.id);
              return html`<div style="padding:4px 8px;background:#1a1d27;border-radius:3px;cursor:pointer;border:1px solid ${this._newsfer15SelectedShape === s.id ? '#4a9eff' : '#2a2d37'}" @click=${() => { this._newsfer15SelectedShape = this._newsfer15SelectedShape === s.id ? '' : s.id; }}>
          ...
          ${this._newsfer15SelectedShape ? html`
            ${(() => {
              const shape = this._newsfer15Shapes.find(s => s.id === this._newsfer15SelectedShape);
              const v = this._newsfer15ValidateControl(this._newsfer15SelectedShape);
              return shape ? html`
          ...
          <div style="margin-bottom:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Trust Boundaries</div>
            ${this._newsfer15TrustBoundaries.map(tb => html`
              <div style="display:flex;gap:6px;align-items:center;padding:3px;background:#1a1d27;border-radius:3px;margin-bottom:2px;font-size:9px">
                <span style="color:#ddd">${this._newsfer15Shapes.find(s => s.id === tb.from)?.label || tb.from}</span>
                <span style="color:#4a9eff">\u2194</span>
                <span style="color:#ddd">${this._newsfer15Shapes.find(s => s.id === tb.to)?.label || tb.to}</span>
          ...
          <div><div style="color:#888;font-size:10px;margin-bottom:4px">Architecture Decision Records</div>
            ${this._newsfer15ADRs.map(adr => html`
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:8px;margin-bottom:8px;flex-wrap:wrap">
            ${this._newsfer15Gauges.map(g => html`
          ...
          <div style="display:flex;gap:8px;margin-bottom:8px;align-items:center">
            ...
            <span style="color:${this._newsfer15GetOverallHealth().score >= 99 ? '#4f4' : '#fa0'};font-size:12px;font-weight:bold">${this._newsfer15GetOverallHealth().score}%</span>
            <span style="color:#888;font-size:10px">(Target: ${this._newsfer15SlaTarget}%)</span>
            <span style="color:#4f4;font-size:10px">${this._newsfer15GetOverallHealth().healthy} healthy</span>
            <span style="color:#fa0;font-size:10px">${this._newsfer15GetOverallHealth().degraded} degraded</span>
          </div>
          <div style="margin-bottom:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Anomaly Stream</div>
            ${this._newsfer15Anomalies.slice(0, 3).map(a => html`
              <div style="display:flex;gap:6px;align-items:center;padding:4px;background:#1a1d27;border-radius:3px;margin-bottom:2px;opacity:${a.acknowledged ? 0.5 : 1}">
                ...
                ${!a.acknowledged ? html`<button class="btn" style="font-size:8px;padding:1px 4px" @click=${() => this._newsfer15AckAnomaly(a.id)}>ACK</button>` : html`<span style="color:#4f4;font-size:9px">ACK'd</span>`}
              </div>
            `)}
          </div>
          <div style="margin-bottom:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Integration Health</div>
            ${this._newsfer15Integrations.map(i => html`
              <div style="display:flex;gap:6px;align-items:center;padding:3px;background:#1a1d27;border-radius:3px;margin-bottom:2px;font-size:9px">
          ...
          <div><div style="color:#888;font-size:10px;margin-bottom:4px">Alert Fatigue Analysis</div>
            <div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:9px">
              ...
              <tbody>${this._newsfer15AlertFatigue.map(af => html`
  ...
  private _newsfer15RenderFishbone(): string {
  ...
  private _newsfer15ToggleAction(id: string) {
    this._newsfer15Actions = this._newsfer15Actions.map(a => a.id === id ? {...a, status: a.status === 'pending' ? 'in_progress' : a.status === 'in_progress' ? 'completed' : 'pending'} : a);
  }

  private _newsfer15GetActionStats() {
    const total = this._newsfer15Actions.length;
    const done = this._newsfer15Actions.filter(a => a.status === 'completed').length;
    const inProg = this._newsfer15Actions.filter(a => a.status === 'in_progress').length;
    return { total, done, inProg, pending: total - done - inProg };
  }

  private _newsfer15GetOverallMaturity(): number {
    if (this._newsfer15SelectedDomain === 'all') {
      return Math.round(this._newsfer15MaturityLevels.reduce((s, m) => s + m.current, 0) / this._newsfer15MaturityLevels.length * 10) / 10;
    }
    const d = this._newsfer15MaturityLevels.find(m => m.domain === this._newsfer15SelectedDomain);
    return d ? d.current : 0;
  }

  private _newsfer15GetGapAnalysis() {
    return this._newsfer15Benchmarks.map(b => {
  ...
  private _newsfer15CalcScore(alert: any): number {
    return Math.round(alert.severity * alert.confidence * alert.assetCrit * 100) / 100;
  }

  private _newsfer15EnrichAlert(id: string) {
    this._newsfer15Alerts = this._newsfer15Alerts.map(a => {
      if (a.id !== id) return a;
      const score = this._newsfer15CalcScore(a);
  ...
  private _newsfer15GroupAlerts() {
    const groups: Record<string, number> = {};
    this._newsfer15Alerts.forEach(a => { groups[a.group] = (groups[a.group] || 0) + 1; });
    return Object.entries(groups).map(([g, c]) => ({group: g, count: c}));
  }

  private _newsfer15ValidateControl(shapeId: string): {valid:boolean;missing:string[]} {
    const shape = this._newsfer15Shapes.find(s => s.id === shapeId);
  ...
  private _newsfer15GetOverallHealth(): {healthy:number;degraded:number;down:number;score:number} {
    const online = this._newsfer15Integrations.filter(i => i.status === 'online').length;
    const degraded = this._newsfer15Integrations.filter(i => i.status === 'degraded').length;
    const total = this._newsfer15Integrations.length;
    return { healthy: online, degraded, down: total - online - degraded, score: Math.round(online / total * 100) };
  }

  private _newsfer15AckAnomaly(id: string) {
    this._newsfer15Anomalies = this._newsfer15Anomalies.map(a => a.id === id ? {...a, acknowledged: true} : a);
  }
...
// ===== DATA SOVEREIGNTY COMPLIANCE (R22) =====
  ...
  private _renderBudgetPlanning() {
    const budgetData = [
      { category: "Personnel & Training", planned: 3140000, actual: 1509000, utilization: 48.1, q1: "26%", q2: "31%", q3: "29%", q4: "21%" },
      { category: "Tooling & Licensing", planned: 3147000, actual: 1522000, utilization: 48.4, q1: "29%", q2: "20%", q3: "24%", q4: "22%" },
      { category: "Infrastructure Security", planned: 3154000, actual: 1535000, utilization: 48.7, q1: "16%", q2: "25%", q3: "19%", q4: "23%" },
      { category: "Compliance & Audit", planned: 3161000, actual: 1548000, utilization: 49.0, q1: "19%", q2: "30%", q3: "30%", q4: "24%" },
      { category: "Incident Response", planned: 3168000, actual: 1561000, utilization: 49.3, q1: "22%", q2: "35%", q3: "25%", q4: "25%" },
      { category: "Third-Party Assessments", planned: 3175000, actual: 1574000, utilization: 49.6, q1: "25%", q2: "24%", q3: "20%", q4: "10%" },
      { category: "Security Awareness", planned: 3182000, actual: 1587000, utilization: 49.9, q1: "28%", q2: "29%", q3: "31%", q4: "11%" },
      { category: "Research & Innovation", planned: 3189000, actual: 1600000, utilization: 50.2, q1: "15%", q2: "34%", q3: "26%", q4: "12%" },
    ];
    ...
    const headcount = [
      { team: "SOC Tier 1", current: 6, target: 18, gap: 5, avgSalary: "153k" },
      { team: "SOC Tier 2", current: 15, target: 17, gap: 4, avgSalary: "182k" },
      { team: "Threat Intel", current: 7, target: 16, gap: 3, avgSalary: "100k" },
      { team: "Red Team", current: 16, target: 15, gap: 2, avgSalary: "129k" },
      { team: "GRC", current: 8, target: 14, gap: 1, avgSalary: "158k" },
      { team: "AppSec", current: 17, target: 13, gap: 0, avgSalary: "187k" },
      { team: "Cloud Sec", current: 9, target: 12, gap: 5, avgSalary: "105k" },
      { team: "Identity & Access", current: 18, target: 11, gap: 4, avgSalary: "134k" },
    ];
    const vendorSpend = [
      { vendor: "CrowdStrike", annual: "294k", contractEnd: "2026-12", renewalRisk: "Low", satisfaction: 5 },
      { vendor: "Palo Alto", annual: "325k", contractEnd: "2026-01", renewalRisk: "Medium", satisfaction: 4 },
      { vendor: "Splunk", annual: "356k", contractEnd: "2026-02", renewalRisk: "High", satisfaction: 3 },
      { vendor: "Qualys", annual: "387k", contractEnd: "2026-03", renewalRisk: "Low", satisfaction: 5 },
      { vendor: "Rapid7", annual: "418k", contractEnd: "2026-04", renewalRisk: "Medium", satisfaction: 4 },
      { vendor: "Mandiant", annual: "449k", contractEnd: "2026-05", renewalRisk: "High", satisfaction: 3 },
      { vendor: "Zscaler", annual: "480k", contractEnd: "2026-06", renewalRisk: "Low", satisfaction: 5 },
      { vendor: "Duo Security", annual: "511k", contractEnd: "2026-07", renewalRisk: "Medium", satisfaction: 4 },
    ];
    const roiProjections = [
      { area: "Threat Detection", investment: "138k", projectedReturn: "1789k", roiMultiple: "3.4x", confidence: 71 },
      { area: "Incident Reduction", investment: "181k", projectedReturn: "1836k", roiMultiple: "3.3x", confidence: 88 },
      { area: "Compliance Savings", investment: "224k", projectedReturn: "1883k", roiMultiple: "3.2x", confidence: 69 },
      { area: "Automation Gains", investment: "267k", projectedReturn: "1930k", roiMultiple: "3.1x", confidence: 86 },
      { area: "Risk Avoidance", investment: "310k", projectedReturn: "1977k", roiMultiple: "3.0x", confidence: 67 },
    ];
    return html`
  ...
  private _renderMetricsNormalization() {
    const kpiCatalog = [
      { id: "kpi-1", name: "MTTD", owner: "SOC", unit: "minutes", target: 84, current: 77, benchmark: 65, collection: "auto", frequency: "realtime" },
      { id: "kpi-2", name: "MTTR", owner: "GRC", unit: "%", target: 87, current: 84, benchmark: 76, collection: "semi-auto", frequency: "daily" },
      { id: "kpi-3", name: "MTTC", owner: "AppSec", unit: "score", target: 90, current: 91, benchmark: 87, collection: "manual", frequency: "weekly" },
      { id: "kpi-4", name: "Vuln SLA Compliance", owner: "Cloud Sec", unit: "count", target: 93, current: 98, benchmark: 98, collection: "auto", frequency: "monthly" },
      { id: "kpi-5", name: "Patch Coverage", owner: "Identity", unit: "days", target: 96, current: 59, benchmark: 75, collection: "semi-auto", frequency: "realtime" },
      { id: "kpi-6", name: "Phishing Click Rate", owner: "Threat Intel", unit: "minutes", target: 99, current: 66, benchmark: 86, collection: "manual", frequency: "daily" },
      { id: "kpi-7", name: "Training Completion", owner: "Security Ops", unit: "%", target: 72, current: 73, benchmark: 97, collection: "auto", frequency: "weekly" },
      { id: "kpi-8", name: "Escalation Rate", owner: "Risk Mgmt", unit: "score", target: 75, current: 80, benchmark: 74, collection: "semi-auto", frequency: "monthly" },
      { id: "kpi-9", name: "False Positive Rate", owner: "SOC", unit: "count", target: 78, current: 87, benchmark: 85, collection: "manual", frequency: "realtime" },
      { id: "kpi-10", name: "Threat Intel Actionability", owner: "GRC", unit: "days", target: 81, current: 94, benchmark: 96, collection: "auto", frequency: "daily" },
      { id: "kpi-11", name: "Endpoint Compliance", owner: "AppSec", unit: "minutes", target: 84, current: 55, benchmark: 73, collection: "semi-auto", frequency: "weekly" },
      { id: "kpi-12", name: "Cloud Misconfig Score", owner: "Cloud Sec", unit: "%", target: 87, current: 62, benchmark: 84, collection: "manual", frequency: "monthly" },
      { id: "kpi-13", name: "Identity Anomaly Rate", owner: "Identity", unit: "score", target: 90, current: 69, benchmark: 95, collection: "auto", frequency: "realtime" },
      { id: "kpi-14", name: "DLP Events", owner: "Threat Intel", unit: "count", target: 93, current: 76, benchmark: 72, collection: "semi-auto", frequency: "daily" },
      { id: "kpi-15", name: "Vendor Risk Avg", owner: "Security Ops", unit: "days", target: 96, current: 83, benchmark: 83, collection: "manual", frequency: "weekly" },
      { id: "kpi-16", name: "Compliance Audit Pass Rate", owner: "Risk Mgmt", unit: "minutes", target: 99, current: 90, benchmark: 94, collection: "auto", frequency: "monthly" },
      { id: "kpi-17", name: "Awareness Score", owner: "SOC", unit: "%", target: 72, current: 97, benchmark: 71, collection: "semi-auto", frequency: "realtime" },
      { id: "kpi-18", name: "SOC Utilization", owner: "GRC", unit: "score", target: 75, current: 58, benchmark: 82, collection: "manual", frequency: "daily" },
      { id: "kpi-19", name: "Automation Coverage", owner: "AppSec", unit: "count", target: 78, current: 65, benchmark: 93, collection: "auto", frequency: "weekly" },
      { id: "kpi-20", name: "Risk Register Currency", owner: "Cloud Sec", unit: "days", target: 81, current: 72, benchmark: 70, collection: "semi-auto", frequency: "monthly" },
    ];
    const benchmarkSources = [
      { source: "NIST CSF", mappedKPIs: 5, alignment: 77, lastReview: "2026-03-19", status: "aligned" },
      { source: "CIS Controls v8", mappedKPIs: 6, alignment: 94, lastReview: "2026-04-14", status: "partial" },
      { source: "ISO 27001:2022", mappedKPIs: 7, alignment: 72, lastReview: "2026-05-09", status: "reviewing" },
      { source: "PCI DSS 4.0", mappedKPIs: 8, alignment: 89, lastReview: "2026-06-04", status: "aligned" },
      { source: "SOC 2 Type II", mappedKPIs: 3, alignment: 67, lastReview: "2026-01-27", status: "partial" },
      { source: "MITRE ATT&CK", mappedKPIs: 4, alignment: 84, lastReview: "2026-02-22", status: "reviewing" },
      { source: "SANS Top 20", mappedKPIs: 5, alignment: 62, lastReview: "2026-03-17", status: "aligned" },
      { source: "OWASP Top 10", mappedKPIs: 6, alignment: 79, lastReview: "2026-04-12", status: "partial" },
    ];
  ...
  private _renderThreatHuntingCampaigns() {
    const campaigns = [
      { id: "HC-1001", name: "Lateral Movement Sweep", status: "active", hypothesis: "H1: Actors using pass-the-hash for lateral movement", leadHunter: "Alice Chen", findings: 42, startDate: "2026-03-11", endDate: null, effectiveness: 52 },
      { id: "HC-1002", name: "Credential Harvesting Hunt", status: "completed", hypothesis: "H2: Actors using web shells for persistence", leadHunter: "Bob Martinez", findings: 45, startDate: "2026-02-22", endDate: "2026-05-28", effectiveness: 71 },
      { id: "HC-1003", name: "Persistence Mechanism Audit", status: "planned", hypothesis: "H3: Actors using scheduled tasks for data theft", leadHunter: "Carol Wu", findings: 0, startDate: "2026-01-05", endDate: null, effectiveness: 90 },
      { id: "HC-1004", name: "C2 Beacon Detection", status: "in-review", hypothesis: "H4: Actors using DNS tunneling for C2 communication", leadHunter: "Dave Kim", findings: 3, startDate: "2026-04-16", endDate: null, effectiveness: 50 },
      { id: "HC-1005", name: "Data Exfiltration Patterns", status: "active", hypothesis: "H5: Actors using encrypted channels for privilege escalation", leadHunter: "Eve Johnson", findings: 6, startDate: "2026-03-27", endDate: null, effectiveness: 69 },
      { id: "HC-1006", name: "Privilege Escalation Scan", status: "completed", hypothesis: "H6: Actors using token impersonation for defense evasion", leadHunter: "Frank Liu", findings: 9, startDate: "2026-02-10", endDate: "2026-06-12", effectiveness: 88 },
      { id: "HC-1007", name: "Supply Chain Implant Hunt", status: "planned", hypothesis: "H7: Actors using poisoned images for initial access", leadHunter: "Grace Park", findings: 12, startDate: "2026-01-21", endDate: null, effectiveness: 48 },
      { id: "HC-1008", name: "Insider Threat Indicators", status: "in-review", hypothesis: "H8: Actors using legitimate tools for credential access", leadHunter: "Hector Silva", findings: 15, startDate: "2026-04-04", endDate: null, effectiveness: 67 },
      { id: "HC-1009", name: "Cloud Metadata Analysis", status: "active", hypothesis: "H9: Actors using API keys for command execution", leadHunter: "Alice Chen", findings: 18, startDate: "2026-03-15", endDate: null, effectiveness: 86 },
      { id: "HC-1010", name: "DNS Tunnel Detection", status: "completed", hypothesis: "H10: Actors using encoded subdomains for exfiltration", leadHunter: "Bob Martinez", findings: 21, startDate: "2026-02-26", endDate: "2026-04-24", effectiveness: 46 },
      { id: "HC-1011", name: "Fileless Malware Search", status: "planned", hypothesis: "H11: Actors using WMI providers for discovery", leadHunter: "Carol Wu", findings: 24, startDate: "2026-01-09", endDate: null, effectiveness: 65 },
      { id: "HC-1012", name: "Zero-Day Exploit Traces", status: "in-review", hypothesis: "H12: Actors using exploit kits for collection", leadHunter: "Dave Kim", findings: 27, startDate: "2026-04-20", endDate: null, effectiveness: 84 },
    ];
    const hunterLeaderboard = [
      { hunter: "Alice Chen", campaigns: 6, findings: 79, highSeverity: 16, avgScore: 93, streak: 3 },
      { hunter: "Bob Martinez", campaigns: 3, findings: 108, highSeverity: 21, avgScore: 86, streak: 4 },
      { hunter: "Carol Wu", campaigns: 13, findings: 21, highSeverity: 0, avgScore: 79, streak: 5 },
      { hunter: "Dave Kim", campaigns: 10, findings: 50, highSeverity: 5, avgScore: 72, streak: 6 },
      { hunter: "Eve Johnson", campaigns: 7, findings: 79, highSeverity: 10, avgScore: 65, streak: 7 },
      { hunter: "Frank Liu", campaigns: 4, findings: 108, highSeverity: 15, avgScore: 58, streak: 8 },
      { hunter: "Grace Park", campaigns: 14, findings: 21, highSeverity: 20, avgScore: 95, streak: 1 },
      { hunter: "Hector Silva", campaigns: 11, findings: 50, highSeverity: 25, avgScore: 88, streak: 2 },
    ];
    const mitreMapping = [
      { tactic: "Initial Access", techniques: 7, campaigns: 1, coverage: 53 },
      { tactic: "Execution", techniques: 6, campaigns: 6, coverage: 33 },
      { tactic: "Persistence", techniques: 5, campaigns: 5, coverage: 84 },
      { tactic: "Privilege Escalation", techniques: 4, campaigns: 4, coverage: 64 },
      { tactic: "Defense Evasion", techniques: 3, campaigns: 3, coverage: 44 },
      { tactic: "Credential Access", techniques: 2, campaigns: 2, coverage: 95 },
      { tactic: "Discovery", techniques: 12, campaigns: 1, coverage: 75 },
      { tactic: "Lateral Movement", techniques: 11, campaigns: 6, coverage: 55 },
      { tactic: "Collection", techniques: 10, campaigns: 5, coverage: 35 },
      { tactic: "Exfiltration", techniques: 9, campaigns: 4, coverage: 86 },
      { tactic: "Command & Control", techniques: 8, campaigns: 3, coverage: 66 },
      { tactic: "Impact", techniques: 7, campaigns: 2, coverage: 46 },
    ];
    return html`
  ...
  private _renderControlInventory() {
    const controls = [
      { id: "CTL-2001", name: "MFA Enforcement", domain: "Access Control", status: "implemented", effectiveness: 49, lastTest: "2026-03-03", nextReview: "2026-07-03", owner: "SOC", risk: "Low" },
      { id: "CTL-2002", name: "Network Segmentation", domain: "Network Security", status: "partial", effectiveness: 35, lastTest: "2026-02-16", nextReview: "2026-08-22", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2003", name: "EDR Deployment", domain: "Endpoint Protection", status: "planned", effectiveness: 42, lastTest: "2026-01-01", nextReview: "2026-09-13", owner: "IT Ops", risk: "High" },
      { id: "CTL-2004", name: "DLP Policy", domain: "Data Protection", status: "gap", effectiveness: 49, lastTest: "2026-04-14", nextReview: "2026-10-04", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2005", name: "SSO Integration", domain: "Identity Management", status: "implemented", effectiveness: 61, lastTest: "2026-03-27", nextReview: "2026-11-23", owner: "IAM", risk: "Low" },
      { id: "CTL-2006", name: "SAST Pipeline", domain: "Application Security", status: "partial", effectiveness: 12, lastTest: "2026-02-12", nextReview: "2026-12-14", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2007", name: "CSPM Scanning", domain: "Cloud Security", status: "planned", effectiveness: 19, lastTest: "2026-01-25", nextReview: "2026-05-05", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2008", name: "Badge Access", domain: "Physical Security", status: "gap", effectiveness: 26, lastTest: "2026-04-10", nextReview: "2026-06-24", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2009", name: "Least Privilege", domain: "Access Control", status: "implemented", effectiveness: 73, lastTest: "2026-03-23", nextReview: "2026-07-15", owner: "SOC", risk: "Low" },
      { id: "CTL-2010", name: "Firewall Rules", domain: "Network Security", status: "partial", effectiveness: 40, lastTest: "2026-02-08", nextReview: "2026-08-06", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2011", name: "Disk Encryption", domain: "Endpoint Protection", status: "planned", effectiveness: 47, lastTest: "2026-01-21", nextReview: "2026-09-25", owner: "IT Ops", risk: "High" },
      { id: "CTL-2012", name: "Data Classification", domain: "Data Protection", status: "gap", effectiveness: 3, lastTest: "2026-04-06", nextReview: "2026-10-16", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2013", name: "PAM Implementation", domain: "Identity Management", status: "implemented", effectiveness: 85, lastTest: "2026-03-19", nextReview: "2026-11-07", owner: "IAM", risk: "Low" },
      { id: "CTL-2014", name: "DAST Pipeline", domain: "Application Security", status: "partial", effectiveness: 17, lastTest: "2026-02-04", nextReview: "2026-12-26", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2015", name: "IAM Policy Review", domain: "Cloud Security", status: "planned", effectiveness: 24, lastTest: "2026-01-17", nextReview: "2026-05-17", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2016", name: "Visitor Management", domain: "Physical Security", status: "gap", effectiveness: 31, lastTest: "2026-04-02", nextReview: "2026-06-08", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2017", name: "Access Reviews", domain: "Access Control", status: "implemented", effectiveness: 97, lastTest: "2026-03-15", nextReview: "2026-07-27", owner: "SOC", risk: "Low" },
      { id: "CTL-2018", name: "IDS/IPS Tuning", domain: "Network Security", status: "partial", effectiveness: 45, lastTest: "2026-02-28", nextReview: "2026-08-18", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2019", name: "Patch Management", domain: "Endpoint Protection", status: "planned", effectiveness: 1, lastTest: "2026-01-13", nextReview: "2026-09-09", owner: "IT Ops", risk: "High" },
      { id: "CTL-2020", name: "Backup Encryption", domain: "Data Protection", status: "gap", effectiveness: 8, lastTest: "2026-04-26", nextReview: "2026-10-28", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2021", name: "Password Policy", domain: "Identity Management", status: "implemented", effectiveness: 50, lastTest: "2026-03-11", nextReview: "2026-11-19", owner: "IAM", risk: "Low" },
      { id: "CTL-2022", name: "Container Scanning", domain: "Application Security", status: "partial", effectiveness: 22, lastTest: "2026-02-24", nextReview: "2026-12-10", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2023", name: "WAF Configuration", domain: "Cloud Security", status: "planned", effectiveness: 29, lastTest: "2026-01-09", nextReview: "2026-05-01", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2024", name: "CCTV Coverage", domain: "Physical Security", status: "gap", effectiveness: 36, lastTest: "2026-04-22", nextReview: "2026-06-20", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2025", name: "RBAC Enforcement", domain: "Access Control", status: "implemented", effectiveness: 62, lastTest: "2026-03-07", nextReview: "2026-07-11", owner: "SOC", risk: "Low" },
      { id: "CTL-2026", name: "VPN Management", domain: "Network Security", status: "partial", effectiveness: 50, lastTest: "2026-02-20", nextReview: "2026-08-02", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2027", name: "App Whitelisting", domain: "Endpoint Protection", status: "planned", effectiveness: 6, lastTest: "2026-01-05", nextReview: "2026-09-21", owner: "IT Ops", risk: "High" },
      { id: "CTL-2028", name: "Key Management", domain: "Data Protection", status: "gap", effectiveness: 13, lastTest: "2026-04-18", nextReview: "2026-10-12", owner: "Data Gov", risk: "Critical" },
    ];
    const gapAnalysis = [
      { gap: "Insufficient MFA coverage for legacy apps", severity: "High", remediationPlan: "Plan R3001", eta: "2026-Q3", estimatedCost: "158k" },
      { gap: "Missing network micro-segmentation", severity: "Medium", remediationPlan: "Plan R3002", eta: "2026-Q2", estimatedCost: "187k" },
      { gap: "Inconsistent EDR deployment", severity: "Medium", remediationPlan: "Plan R3003", eta: "2026-Q4", estimatedCost: "35k" },
      { gap: "DLP not covering cloud storage", severity: "Low", remediationPlan: "Plan R3004", eta: "2026-Q3", estimatedCost: "64k" },
      { gap: "SSO not integrated with all SaaS", severity: "High", remediationPlan: "Plan R3005", eta: "2026-Q2", estimatedCost: "93k" },
    ];
    return html`
  ...
  private _renderIncidentCostTracker() {
    const incidents = [
      { id: "INC-7001", name: "Security Incident 1", severity: "Critical", totalCost: 424000, responseCost: 97520, recoveryCost: 118720, legalCost: 63600, regulatoryCost: 33920, insuranceClaim: 0, avoidedCost: 47000, date: "2026-03-23" },
      { id: "INC-7002", name: "Security Incident 2", severity: "High", totalCost: 427000, responseCost: 128100, recoveryCost: 166530, legalCost: 51240, regulatoryCost: 59780, insuranceClaim: 260470, avoidedCost: 76000, date: "2026-02-04" },
      { id: "INC-7003", name: "Security Incident 3", severity: "Medium", totalCost: 430000, responseCost: 68800, recoveryCost: 124700, legalCost: 38700, regulatoryCost: 38700, insuranceClaim: 0, avoidedCost: 105000, date: "2026-01-13" },
      { id: "INC-7004", name: "Security Incident 4", severity: "Low", totalCost: 433000, responseCost: 99590, recoveryCost: 173200, legalCost: 25980, regulatoryCost: 64950, insuranceClaim: 242480, avoidedCost: 134000, date: "2026-04-22" },
      { id: "INC-7005", name: "Security Incident 5", severity: "Critical", totalCost: 436000, responseCost: 130800, recoveryCost: 130800, legalCost: 82840, regulatoryCost: 43600, insuranceClaim: 0, avoidedCost: 163000, date: "2026-03-03" },
      { id: "INC-7006", name: "Security Incident 6", severity: "High", totalCost: 439000, responseCost: 70240, recoveryCost: 87800, legalCost: 70240, regulatoryCost: 21950, insuranceClaim: 223890, avoidedCost: 192000, date: "2026-02-12" },
      { id: "INC-7007", name: "Security Incident 7", severity: "Medium", totalCost: 442000, responseCost: 101660, recoveryCost: 137020, legalCost: 57460, regulatoryCost: 48620, insuranceClaim: 0, avoidedCost: 221000, date: "2026-01-21" },
      { id: "INC-7008", name: "Security Incident 8", severity: "Low", totalCost: 445000, responseCost: 133500, recoveryCost: 93450, legalCost: 44500, regulatoryCost: 26700, insuranceClaim: 204700, avoidedCost: 250000, date: "2026-04-02" },
      { id: "INC-7009", name: "Security Incident 9", severity: "Critical", totalCost: 448000, responseCost: 71680, recoveryCost: 143360, legalCost: 31360, regulatoryCost: 53760, insuranceClaim: 0, avoidedCost: 279000, date: "2026-03-11" },
      { id: "INC-7010", name: "Security Incident 10", severity: "High", totalCost: 451000, responseCost: 103730, recoveryCost: 99220, legalCost: 90200, regulatoryCost: 31570, insuranceClaim: 184910, avoidedCost: 308000, date: "2026-02-20" },
      { id: "INC-7011", name: "Security Incident 11", severity: "Medium", totalCost: 454000, responseCost: 136200, recoveryCost: 149820, legalCost: 77180, regulatoryCost: 59020, insuranceClaim: 0, avoidedCost: 337000, date: "2026-01-01" },
      { id: "INC-7012", name: "Security Incident 12", severity: "Low", totalCost: 457000, responseCost: 73120, recoveryCost: 105110, legalCost: 63980, regulatoryCost: 36560, insuranceClaim: 164520, avoidedCost: 366000, date: "2026-04-10" },
    ];
    const yearlyTrend = [
      { month: "Jan", incidents: 5, totalCost: "538k", avgCost: "72k", insured: 28 },
      { month: "Feb", incidents: 2, totalCost: "581k", avgCost: "119k", insured: 28 },
      { month: "Mar", incidents: 10, totalCost: "624k", avgCost: "166k", insured: 28 },
      { month: "Apr", incidents: 7, totalCost: "667k", avgCost: "32k", insured: 28 },
      { month: "May", incidents: 4, totalCost: "710k", avgCost: "79k", insured: 28 },
      { month: "Jun", incidents: 12, totalCost: "753k", avgCost: "126k", insured: 28 },
    ];
...
declare global { interface HTMLElementTagNameMap { 'sc-news-feed': ScNewsFeed; } }
