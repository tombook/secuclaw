...
export class ScThreatHunting extends LitElement {
  ...
  private _data: MockItem[] = [
    {name:"Hypothesis: C2 Beacon Detection",status:"active",risk:"critical",detail:"Searching for TLS beacons with >300s sleep + low entropy payload. Found: 3 suspicious flows."},
    {name:"Hypothesis: Living-off-the-Land",status:"active",risk:"high",detail:"Hunting certutil.exe, bitsadmin.exe, msiexec.exe network activity. Found: 2 anomalies."},
    {name:"Hypothesis: Credential Dumping",status:"active",risk:"critical",detail:"Monitoring LSASS access patterns + sekurla::logonpasswords YARA. Found: 1 process injection."},
    {name:"Hypothesis: DNS Tunneling",status:"completed",risk:"high",detail:"Analyzed TXT query frequency + length + entropy. Found: 0 new tunnels. Last check: 4h ago."},
    {name:"Hypothesis: Lateral Movement",status:"active",risk:"medium",detail:"Hunting PsExec, WMI, DCOM patterns across segments. Found: 4 suspicious SMB sessions."}
  ];
  ...
  render() {
    ...
    return html`<div class="panel"><div class="pt">Threat Hunting</div>
