/**
 * sc-threat-hunting - Threat Hunting
...
export class ScThreatHunting extends LitElement {
  static styles = css`
...
@state() private _tablePage = 1;
  ...
  @state() private _comments: CommentEntry[] = [
    { id: 'c1', author: 'soc-tier1', timestamp: '2026-04-23 04:00', text: 'Initial assessment started for Threat Hunting finding #1' },
  ...
  private _items: PanelItem[] = [
      {
            "id": "threat-hunting-1",
            "title": "Hypothesis: C2 Beacon Detection",
            "severity": "critical",
            "status": "open",
            "category": "Security",
            "source": "SIEM",
            "description": "Searching for TLS beacons with >300s sleep + low entropy payload. Found: 3 suspicious flows.",
      ...
      {
            "id": "threat-hunting-2",
            "title": "Hypothesis: Living-off-the-Land",
            "severity": "high",
            "status": "in-progress",
            "category": "Network",
            "source": "EDR",
            "description": "Hunting certutil.exe, bitsadmin.exe, msiexec.exe network activity. Found: 2 anomalies.",
      ...
      {
            "id": "threat-hunting-3",
            "title": "Hypothesis: Credential Dumping",
            "severity": "critical",
            "status": "resolved",
            "category": "Access",
            "source": "Scanner",
            "description": "Monitoring LSASS access patterns + sekurla::logonpasswords YARA. Found: 1 process injection.",
      ...
      {
            "id": "threat-hunting-4",
            "title": "Hypothesis: DNS Tunneling",
            "severity": "high",
            "status": "open",
            "category": "Compliance",
            "source": "Audit",
            "description": "Analyzed TXT query frequency + length + entropy. Found: 0 new tunnels. Last check: 4h ago.",
      ...
      {
            "id": "threat-hunting-5",
            "title": "Hypothesis: Lateral Movement",
            "severity": "medium",
            "status": "in-progress",
            "category": "Operations",
            "source": "Manual",
            "description": "Hunting PsExec, WMI, DCOM patterns across segments. Found: 4 suspicious SMB sessions.",
      ...
      {
            "id": "threat-hunting-6",
            "title": "Threat Hunting Finding #6",
            "severity": "high",
            "status": "open",
            "category": "Security",
            "source": "SIEM",
            "description": "Automated threat hunting assessment finding detected during routine scan of infrastructure component. Review and remediation recommended.",
      ...
      {
            "id": "threat-hunting-7",
            "title": "Threat Hunting Finding #7",
            "severity": "low",
            "status": "open",
            "category": "Network",
            "source": "EDR",
      ...
      {
            "id": "threat-hunting-8",
            "title": "Threat Hunting Finding #8",
            "severity": "medium",
            "status": "open",
            "category": "Access",
            "source": "Scanner",
      ...
      {
            "id": "threat-hunting-9",
            "title": "Threat Hunting Finding #9",
            "severity": "high",
            "status": "open",
            "category": "Compliance",
            "source": "Audit",
      ...
      {
            "id": "threat-hunting-10",
            "title": "Threat Hunting Finding #10",
            "severity": "low",
            "status": "open",
            "category": "Operations",
            "source": "Manual",
  ...
  private _history: HistoryEntry[] = [
    { timestamp: '2026-04-23 04:15', action: 'Auto-correlated', user: 'system', details: 'Grouped related findings from Threat Hunting analysis' },
    { timestamp: '2026-04-23 03:00', action: 'Created', user: 'scanner', details: 'New Threat Hunting finding detected by automated assessment' },
    ...
    { timestamp: '2026-04-22 22:00', action: 'Resolved', user: 'security-eng', details: 'Remediation applied and verified for Threat Hunting finding' },
    { timestamp: '2026-04-22 18:00', action: 'Created', user: 'audit', details: 'Compliance audit identified Threat Hunting gap requiring remediation' },
    ...
    { timestamp: '2026-04-21 16:00', action: 'Resolved', user: 'soc-tier1', details: 'False positive confirmed - benign activity flagged by Threat Hunting scan' },
    { timestamp: '2026-04-21 12:00', action: 'Exported', user: 'compliance', details: 'Exported Threat Hunting findings for Q1 compliance report' },
  ];
...
private _workflowTasks: WorkflowTask[] = [
    { id: 'wt-1', title: 'Review Threat Hunting finding #1', status: 'active', assignee: 'soc-tier1', blockedBy: [], slaDeadline: '2026-04-23T12:00:00Z', priority: 'p1', createdAt: '2026-04-23T00:00:00Z', completedAt: null },
    ...
    { id: 'wt-3', title: 'Update Threat Hunting detection rules', status: 'blocked', assignee: 'soc-tier2', blockedBy: ['wt-2'], slaDeadline: '2026-04-24T00:00:00Z', priority: 'p2', createdAt: '2026-04-23T03:00:00Z', completedAt: null },
    ...
    { id: 'wt-8', title: 'Archive resolved Threat Hunting findings', status: 'failed', assignee: 'soc-tier1', blockedBy: [], slaDeadline: '2026-04-23T08:00:00Z', priority: 'p4', createdAt: '2026-04-22T22:00:00Z', completedAt: null },
  ];

private _executionHistory: ExecutionRecord[] = [
    {
      id: 'exec-1', name: 'Threat Hunting Full Assessment Run', startedAt: '2026-04-22T10:00:00Z', completedAt: '2026-04-22T10:12:00Z', status: 'success',
      steps: [
    ...
    {
      id: 'exec-2', name: 'Threat Hunting Delta Scan', startedAt: '2026-04-23T02:00:00Z', completedAt: '2026-04-23T02:05:00Z', status: 'failed',
      steps: [
  ...
  private _runExecution() {
    ...
    const exec: ExecutionRecord = {
      id: 'exec-' + Date.now(), name: 'Threat Hunting Assessment ' + new Date().toISOString().slice(0, 10), startedAt: new Date().toISOString(), completedAt: null, status: 'running', steps,
    };
  ...
  private _renderExecutionPanel(): unknown {
    ...
    return html`
      <div class="form-section">
        ...
        ` : html`<div class="empty-state">Click "Run Assessment" to start the Threat Hunting analysis pipeline</div>`}
      </div>
      <div class="form-section">
        ...
        <div class="settings-card">
          ...
          <div style="display:flex;gap:8px;margin-top:4px;">
            <button class="btn primary" @click=${() => {
              ...
              const a = document.createElement('a'); a.href = url; a.download = 'threat-hunting-config.json'; a.click();
    ...
    return html`
      <div style="margin-top:12px;">
        ...
        <div style="display:flex;gap:6px;margin-top:8px;">
          <input class="search-box" type="text" placeholder="Add a comment..." style="min-width:auto;flex:1;" id="threat-hunting-comment-input" />
          <button class="btn primary" @click=${() => {
            const input = this.shadowRoot?.querySelector('#threat-hunting-comment-input') as HTMLInputElement;
  ...
  private _exportJSON() {
    ...
    const url = URL.createObjectURL(blob);
    const a = document.createElement('a'); a.href = url; a.download = 'sc-threat-hunting-data.json'; a.click();
    URL.revokeObjectURL(url);
  }
  ...
  private _exportCSV() {
    ...
    const url = URL.createObjectURL(blob);
    const a = document.createElement('a'); a.href = url; a.download = 'sc-threat-hunting-data.csv'; a.click();
    URL.revokeObjectURL(url);
  }


  // --- Domain Rules Engine ---
  @state() private _thRules: { id: string; name: string; category: string; severity: Severity; enabled: boolean; lastEval: string; passRate: number }[] = [];
  private _initThRules() {
    const rules = [
  ...
  private _evaluateThRules(): { passed: number; failed: number; skipped: number; total: number } {
    let passed = 0, failed = 0, skipped = 0;
    this._thRules.forEach(r => { if (!r.enabled) { skipped++; } else if (r.passRate >= 80) { passed++; } else { failed++; } });
    return { passed, failed, skipped, total: this._thRules.length };
  }

  // --- CVSS Scoring ---
  @state() private _thcvssData: { itemId: string; vector: string; base: number; temporal: number; environmental: number; overall: number }[] = [];
  private _initThCvss() {
    ...
    this._thcvssData = vectors.map((v, i) => {
  ...
  // --- Anomaly Detection ---
  @state() private _thanomalies: { id: string; type: string; severity: Severity; description: string; detected: string; confidence: number; affected: string[] }[] = [];
  private _runThAnomalyDetection() {
    const types = [
    ...
    this._thanomalies = types.map((a, i) => ({
  ...
  // --- Trend Prediction ---
  @state() private _thpredictions: { horizon: string; metric: string; current: number; predicted: number; direction: 'up' | 'down' | 'stable'; confidence: number }[] = [];
  private _generateThPredictions() {
    this._thpredictions = [
  ...
  // --- Approval Workflow ---
  @state() private _thApprovals: { id: string; title: string; requester: string; status: 'pending' | 'approved' | 'rejected' | 'expired'; createdAt: string; priority: Priority; type: string }[] = [];
  private _initThApprovals() {
    this._thApprovals = [
  ...
  private _approveThItem(id: string) { const item = this._thApprovals.find(a => a.id === id); if (item) item.status = 'approved'; this.requestUpdate(); }
  private _rejectThItem(id: string) { const item = this._thApprovals.find(a => a.id === id); if (item) item.status = 'rejected'; this.requestUpdate(); }

  // --- Activity Feed ---
  @state() private _thActivity: { id: string; action: string; user: string; target: string; timestamp: string }[] = [];
  private _initThActivity() {
    const actions = [
    ...
    this._thActivity = actions.map((a, i) => ({ id: 'ACT-' + String(i + 1).padStart(3, '0'), ...a, timestamp: new Date(Date.now() - i * 3600000).toISOString() }));
  }

  // --- Notification System ---
  @state() private _thNotifications: { id: string; message: string; type: 'info' | 'warning' | 'error' | 'success'; read: boolean; timestamp: string }[] = [];
  private _initThNotifications() {
    this._thNotifications = [
  ...
  private _markThNotifRead(id: string) { const n = this._thNotifications.find(x => x.id === id); if (n) n.read = true; this.requestUpdate(); }

  // --- Panel Configuration ---
  @state() private _thConfig: { layout: 'compact' | 'default' | 'expanded'; theme: 'dark' | 'midnight' | 'slate'; showAnomalies: boolean; showPredictions: boolean; autoRefresh: boolean; refreshInterval: number } = {
    layout: 'default', theme: 'dark', showAnomalies: true, showPredictions: true, autoRefresh: true, refreshInterval: 60,
  };
  private _thPresets: { name: string; config: typeof this._thConfig }[] = [
  ...
  private _applyThPreset(preset: typeof this._thPresets[0]) { this._thConfig = { ...preset.config }; this.requestUpdate(); }

  private _renderThTreemapSVG(): string {
    const categories = [
  ...
  private _renderThSankeySVG(): string {
  ...
  // --- Render: Rules Engine ---
  private _renderThRules(): any {
    const ev = this._evaluateThRules();
    return html`
  ...
  private _renderThAnomalies(): any {
  ...
  // --- Render: Approvals ---
  private _renderThApprovals(): any {
          ...
          $${this._thApprovals.map(a => html`
            <div style="padding:6px 8px;background:#1f2937;border-radius:4px">
              ...
              $${a.status === 'pending' ? html`
                <div style="display:flex;gap:4px;margin-top:4px">
                  <button class="btn success" style="padding:2px 8px;font-size:9px" @click=$${() => this._approveThItem(a.id)}>Approve</button>
                  <button class="btn error" style="padding:2px 8px;font-size:9px" @click=$${() => this._rejectThItem(a.id)}>Reject</button>
                </div>` : nothing}
            </div>`)}
        </div>
      </div>`;
  ...
  private _renderThNotifications(): any {
    const tc = (t: string) => t === 'error' ? '#ef4444' : t === 'warning' ? '#eab308' : t === 'success' ? '#22c55e' : '#3b82f6';
    const unread = this._thNotifications.filter(n => !n.read).length;
    return html`
      <div style="background:#1a1d27;border-radius:8px;padding:12px;margin-top:12px">
        ...
        <div style="display:flex;flex-direction:column;gap:4px;max-height:120px;overflow-y:auto">
          $${this._thNotifications.map(n => html`
            <div style="display:flex;align-items:center;gap:8px;padding:4px 8px;background:$${n.read ? '#1f2937' : '#252a36'};border-radius:4px;font-size:10px;opacity:$${n.read ? '0.6' : '1'};cursor:pointer" @click=$${() => this._markThNotifRead(n.id)}>
      ...
      <div style="background:#1a1d27;border-radius:8px;padding:12px;margin-top:12px">
        ...
        <div style="display:flex;flex-direction:column;gap:6px;font-size:10px">
          <div style="display:flex;align-items:center;gap:8px">
            ...
            <select class="form-input" style="flex:1" @change=$${(e: Event) => { this._thConfig.layout = (e.target as HTMLSelectElement).value as any; this.requestUpdate(); }}>
              <option value="compact" ?selected=$${this._thConfig.layout === 'compact'}>Compact</option>
              <option value="default" ?selected=$${this._thConfig.layout === 'default'}>Default</option>
              <option value="expanded" ?selected=$${this._thConfig.layout === 'expanded'}>Expanded</option>
            </select>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Theme</span>
            <select class="form-input" style="flex:1" @change=$${(e: Event) => { this._thConfig.theme = (e.target as HTMLSelectElement).value as any; this.requestUpdate(); }}>
              <option value="dark" ?selected=$${this._thConfig.theme === 'dark'}>Dark</option>
              <option value="midnight" ?selected=$${this._thConfig.theme === 'midnight'}>Midnight</option>
              <option value="slate" ?selected=$${this._thConfig.theme === 'slate'}>Slate</option>
            </select>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Auto Refresh</span>
            <input type="checkbox" ?checked=$${this._thConfig.autoRefresh} @change=$${() => { this._thConfig.autoRefresh = !this._thConfig.autoRefresh; this.requestUpdate(); }}/>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Show Anomalies</span>
            <input type="checkbox" ?checked=$${this._thConfig.showAnomalies} @change=$${() => { this._thConfig.showAnomalies = !this._thConfig.showAnomalies; this.requestUpdate(); }}/>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Show Predictions</span>
            <input type="checkbox" ?checked=$${this._thConfig.showPredictions} @change=$${() => { this._thConfig.showPredictions = !this._thConfig.showPredictions; this.requestUpdate(); }}/>
          </div>
          <div style="margin-top:6px;font-weight:600">Presets</div>
          <div style="display:flex;gap:4px">
            $${this._thPresets.map(ps => html`<button class="btn" style="padding:2px 8px;font-size:9px" @click=$${() => this._applyThPreset(ps)}>$${ps.name}</button>`)}
          </div>
        </div>
      </div>`;
  }
  ...
  @state() private _threatHuntinContainerScans: Array<{image:string;registry:string;critical:number;high:number;medium:number;scanDate:string;status:string}> = [
  ...
  @state() private _threatHuntinK8sPods: Array<{namespace:string;pod:string;securityContext:string;hostIPC:boolean;hostPID:boolean;privileged:boolean;riskLevel:string}> = [
  ...
  @state() private _threatHuntinServerlessRisk: Array<{function:string;runtime:string;timeout:number;iamPerms:string;externalCalls:number;riskScore:number}> = [
  ...
  @state() private _threatHuntinRuntimeAlerts: Array<{id:string;workload:string;alertType:string;severity:string;description:string;timestamp:string}> = [
  ...
  private _renderThreathuntinCloudWl(): TemplateResult {
    const containers = this._threatHuntinContainerScans;
    const pods = this._threatHuntinK8sPods;
    const alerts = this._threatHuntinRuntimeAlerts;
    return html`
  ...
  @state() private _complianceCalendarEvents: Array<{id: string; title: string; deadline: string; category: string; status: string; assignee: string; notes: string}> = [
    {id: 'cc-threat-hunting-001', title: 'SOX Section 404 Compliance Review', deadline: '2026-06-30', category: 'Regulatory', status: 'In Progress', assignee: 'Compliance Team', notes: 'Annual internal control assessment for financial reporting'},
    {id: 'cc-threat-hunting-002', title: 'GDPR Data Protection Impact Assessment', deadline: '2026-05-15', category: 'Privacy', status: 'Pending', assignee: 'DPO Office', notes: 'Quarterly DPIA for high-risk processing activities'},
    {id: 'cc-threat-hunting-003', title: 'ISO 27001 Surveillance Audit', deadline: '2026-07-20', category: 'Certification', status: 'Scheduled', assignee: 'QA Lead', notes: 'Stage 2 surveillance audit for ISMS certification renewal'},
    {id: 'cc-threat-hunting-004', title: 'PCI DSS v4.0 Gap Analysis', deadline: '2026-05-30', category: 'Payment', status: 'Not Started', assignee: 'Security Architect', notes: 'Assess current state against PCI DSS v4.0 requirements'},
    {id: 'cc-threat-hunting-005', title: 'NIST CSF Self-Assessment', deadline: '2026-08-15', category: 'Framework', status: 'Pending', assignee: 'CISO', notes: 'Biannual self-assessment against NIST Cybersecurity Framework'},
    {id: 'cc-threat-hunting-006', title: 'HIPAA Security Rule Audit', deadline: '2026-06-15', category: 'Healthcare', status: 'In Progress', assignee: 'Compliance Analyst', notes: 'Annual audit of administrative, physical, and technical safeguards'},
    {id: 'cc-threat-hunting-007', title: 'SOC 2 Type II Report Renewal', deadline: '2026-09-30', category: 'Audit', status: 'Scheduled', assignee: 'External Auditor', notes: 'Engage auditor for SOC 2 Type II examination period'},
    {id: 'cc-threat-hunting-008', title: 'FedRAMP Authorization Review', deadline: '2026-07-01', category: 'Government', status: 'Pending', assignee: 'FedRAMP PMO', notes: 'Review and update security authorization package'},
    {id: 'cc-threat-hunting-009', title: 'Annual Penetration Test', deadline: '2026-10-15', category: 'Testing', status: 'Not Started', assignee: 'Red Team Lead', notes: 'Comprehensive external and internal penetration testing engagement'},
    {id: 'cc-threat-hunting-010', title: 'Security Awareness Training Rollout', deadline: '2026-05-01', category: 'Training', status: 'Completed', assignee: 'Security Awareness Manager', notes: 'Q2 organization-wide security awareness training program'},
    {id: 'cc-threat-hunting-011', title: 'Vendor Security Review Cycle', deadline: '2026-06-01', category: 'Third Party', status: 'In Progress', assignee: 'Vendor Manager', notes: 'Quarterly review of critical vendor security posture and SLA compliance'},
    {id: 'cc-threat-hunting-012', title: 'Incident Response Plan Update', deadline: '2026-05-20', category: 'Operations', status: 'Pending', assignee: 'IR Team Lead', notes: 'Update IR procedures based on lessons learned from recent incidents'},
  ];
  ...
  @state() private _dataQualityMetrics: Array<{id: string; dataSource: string; completenessScore: number; accuracyScore: number; timelinessScore: number; consistencyScore: number; reliabilityRank: number; lastUpdated: string; issues: string[]; trend: string}> = [
    {id: 'dq-threat-hunting-001', dataSource: 'Vulnerability Scanner Feed', completenessScore: 94, accuracyScore: 91, timelinessScore: 88, consistencyScore: 95, reliabilityRank: 1, lastUpdated: '2026-04-23T08:00:00Z', issues: ['Minor delay in Nessus plugin updates'], trend: 'improving'},
    {id: 'dq-threat-hunting-002', dataSource: 'SIEM Event Logs', completenessScore: 87, accuracyScore: 93, timelinessScore: 96, consistencyScore: 89, reliabilityRank: 2, lastUpdated: '2026-04-23T07:30:00Z', issues: ['Some log sources showing gaps in off-hours'], trend: 'stable'},
    {id: 'dq-threat-hunting-003', dataSource: 'Asset Inventory Database', completenessScore: 82, accuracyScore: 78, timelinessScore: 75, consistencyScore: 84, reliabilityRank: 4, lastUpdated: '2026-04-22T18:00:00Z', issues: ['Shadow IT devices not fully cataloged', 'Decommissioned assets still listed'], trend: 'declining'},
    {id: 'dq-threat-hunting-004', dataSource: 'Threat Intelligence Platform', completenessScore: 91, accuracyScore: 89, timelinessScore: 92, consistencyScore: 87, reliabilityRank: 3, lastUpdated: '2026-04-23T06:00:00Z', issues: ['Some IOC sources lack confidence scoring'], trend: 'improving'},
    {id: 'dq-threat-hunting-005', dataSource: 'Identity Provider Logs', completenessScore: 96, accuracyScore: 97, timelinessScore: 98, consistencyScore: 96, reliabilityRank: 1, lastUpdated: '2026-04-23T09:00:00Z', issues: [], trend: 'stable'},
    {id: 'dq-threat-hunting-006', dataSource: 'Cloud Security Posture Data', completenessScore: 79, accuracyScore: 85, timelinessScore: 82, consistencyScore: 81, reliabilityRank: 5, lastUpdated: '2026-04-23T05:00:00Z', issues: ['Multi-cloud coverage gaps', 'API rate limiting affects scan frequency'], trend: 'declining'},
    {id: 'dq-threat-hunting-007', dataSource: 'Compliance Evidence Store', completenessScore: 88, accuracyScore: 86, timelinessScore: 80, consistencyScore: 83, reliabilityRank: 4, lastUpdated: '2026-04-21T14:00:00Z', issues: ['Manual evidence collection delays', 'Inconsistent formatting across frameworks'], trend: 'stable'},
    {id: 'dq-threat-hunting-008', dataSource: 'Network Flow Data', completenessScore: 92, accuracyScore: 90, timelinessScore: 94, consistencyScore: 91, reliabilityRank: 2, lastUpdated: '2026-04-23T08:30:00Z', issues: ['Encrypted traffic classification accuracy needs improvement'], trend: 'improving'},
  ];
  ...
  @state() private _workflowTemplates: Array<{id: string; name: string; description: string; category: string; steps: number; avgDuration: string; successRate: number; lastRun: string; manualInterventions: number; optimizationScore: number}> = [
    {id: 'wf-threat-hunting-001', name: 'Vulnerability Triage Pipeline', description: 'Automated vulnerability assessment, prioritization, and assignment workflow', category: 'Vulnerability Management', steps: 8, avgDuration: '12 min', successRate: 94.5, lastRun: '2026-04-23T06:00:00Z', manualInterventions: 2, optimizationScore: 87},
    {id: 'wf-threat-hunting-002', name: 'Incident Response Orchestration', description: 'End-to-end IR workflow from detection to containment and recovery', category: 'Incident Response', steps: 15, avgDuration: '45 min', successRate: 89.2, lastRun: '2026-04-22T14:30:00Z', manualInterventions: 5, optimizationScore: 72},
    {id: 'wf-threat-hunting-003', name: 'Access Request Approval Chain', description: 'Multi-level approval workflow for privileged access requests', category: 'Identity & Access', steps: 6, avgDuration: '4 hours', successRate: 97.1, lastRun: '2026-04-23T09:15:00Z', manualInterventions: 1, optimizationScore: 92},
    {id: 'wf-threat-hunting-004', name: 'Compliance Evidence Collection', description: 'Automated gathering and packaging of audit evidence artifacts', category: 'Compliance', steps: 10, avgDuration: '30 min', successRate: 91.8, lastRun: '2026-04-21T10:00:00Z', manualInterventions: 3, optimizationScore: 78},
    {id: 'wf-threat-hunting-005', name: 'Security Patch Deployment', description: 'Staged patch rollout with validation and rollback capability', category: 'Patch Management', steps: 12, avgDuration: '2 hours', successRate: 96.3, lastRun: '2026-04-20T22:00:00Z', manualInterventions: 1, optimizationScore: 85},
    {id: 'wf-threat-hunting-006', name: 'Threat Intelligence Enrichment', description: 'IOC enrichment and correlation with internal threat data', category: 'Threat Intelligence', steps: 7, avgDuration: '8 min', successRate: 93.7, lastRun: '2026-04-23T07:00:00Z', manualInterventions: 0, optimizationScore: 95},
    {id: 'wf-threat-hunting-007', name: 'Security Reporting Pipeline', description: 'Automated generation and distribution of security metrics reports', category: 'Reporting', steps: 5, avgDuration: '15 min', successRate: 98.9, lastRun: '2026-04-23T08:00:00Z', manualInterventions: 0, optimizationScore: 97},
    {id: 'wf-threat-hunting-008', name: 'Vendor Risk Assessment', description: 'Automated vendor security questionnaire distribution and scoring', category: 'Third Party', steps: 9, avgDuration: '3 days', successRate: 85.4, lastRun: '2026-04-19T11:00:00Z', manualInterventions: 4, optimizationScore: 65},
  ];
  ...
  @state() private _workflowExecutionHistory: Array<{workflowId: string; runDate: string; duration: string; status: string; trigger: string}> = [
    {workflowId: 'wf-threat-hunting-001', runDate: '2026-04-23T06:00:00Z', duration: '11 min 23 sec', status: 'Success', trigger: 'Scheduled'},
    {workflowId: 'wf-threat-hunting-002', runDate: '2026-04-22T14:30:00Z', duration: '42 min 15 sec', status: 'Success', trigger: 'Alert'},
    {workflowId: 'wf-threat-hunting-003', runDate: '2026-04-23T09:15:00Z', duration: '3h 45 min', status: 'Success', trigger: 'User Request'},
    {workflowId: 'wf-threat-hunting-001', runDate: '2026-04-22T06:00:00Z', duration: '13 min 08 sec', status: 'Partial', trigger: 'Scheduled'},
    {workflowId: 'wf-threat-hunting-004', runDate: '2026-04-21T10:00:00Z', duration: '28 min 42 sec', status: 'Success', trigger: 'Scheduled'},
  ];
  ...
  @state() private _knowledgeArticles: Array<{id: string; title: string; category: string; author: string; publishDate: string; views: number; rating: number; tags: string[]; summary: string; readTime: string}> = [
    {id: 'kb-threat-hunting-001', title: 'Zero Trust Architecture Implementation Guide', category: 'Architecture', author: 'Security Architecture Team', publishDate: '2026-03-15', views: 1842, rating: 4.8, tags: ['zero-trust', 'network', 'identity'], summary: 'Comprehensive guide for implementing zero trust principles across enterprise infrastructure', readTime: '15 min'},
    {id: 'kb-threat-hunting-002', title: 'Ransomware Defense Playbook 2026', category: 'Threats', author: 'Threat Intelligence Team', publishDate: '2026-04-01', views: 2341, rating: 4.9, tags: ['ransomware', 'incident-response', 'defense'], summary: 'Updated playbook with latest ransomware tactics, techniques, and defensive measures', readTime: '12 min'},
    {id: 'kb-threat-hunting-003', title: 'Cloud Security Best Practices for Multi-Cloud', category: 'Cloud', author: 'Cloud Security Team', publishDate: '2026-02-28', views: 1567, rating: 4.5, tags: ['cloud', 'aws', 'azure', 'gcp'], summary: 'Best practices for securing workloads across multiple cloud service providers', readTime: '18 min'},
    {id: 'kb-threat-hunting-004', title: 'API Security Testing Methodology', category: 'Testing', author: 'Red Team', publishDate: '2026-03-22', views: 987, rating: 4.6, tags: ['api', 'testing', 'owasp'], summary: 'Structured methodology for identifying and testing API security vulnerabilities', readTime: '10 min'},
    {id: 'kb-threat-hunting-005', title: 'Supply Chain Security Risk Management', category: 'Third Party', author: 'GRC Team', publishDate: '2026-01-20', views: 1234, rating: 4.3, tags: ['supply-chain', 'vendor', 'risk'], summary: 'Framework for managing security risks in the software supply chain', readTime: '14 min'},
    {id: 'kb-threat-hunting-006', title: 'Kubernetes Security Hardening Checklist', category: 'Container', author: 'Platform Security', publishDate: '2026-04-10', views: 2103, rating: 4.7, tags: ['kubernetes', 'container', 'hardening'], summary: 'Step-by-step hardening checklist for production Kubernetes clusters', readTime: '11 min'},
    {id: 'kb-threat-hunting-007', title: 'Security Metrics That Matter for Executives', category: 'Metrics', author: 'CISO Office', publishDate: '2026-03-05', views: 876, rating: 4.4, tags: ['metrics', 'kpi', 'reporting'], summary: 'Key security metrics and KPIs that resonate with board-level stakeholders', readTime: '8 min'},
    {id: 'kb-threat-hunting-008', title: 'Phishing Simulation Campaign Design', category: 'Awareness', author: 'Security Awareness Team', publishDate: '2026-02-15', views: 1456, rating: 4.5, tags: ['phishing', 'simulation', 'training'], summary: 'Designing effective phishing simulations that drive real behavioral change', readTime: '9 min'},
    {id: 'kb-threat-hunting-009', title: 'Data Loss Prevention Strategy and Implementation', category: 'Data Protection', author: 'Data Security Team', publishDate: '2026-03-28', views: 1678, rating: 4.6, tags: ['dlp', 'data-protection', 'compliance'], summary: 'Strategic approach to DLP covering people, process, and technology layers', readTime: '16 min'},
    {id: 'kb-threat-hunting-010', title: 'Security Automation with SOAR Platforms', category: 'Automation', author: 'SOC Engineering', publishDate: '2026-04-05', views: 1098, rating: 4.7, tags: ['soar', 'automation', 'soc'], summary: 'Building effective security automation playbooks using SOAR technology', readTime: '13 min'},
    {id: 'kb-threat-hunting-011', title: 'Third-Party Risk Assessment Framework', category: 'GRC', author: 'Vendor Management', publishDate: '2026-01-30', views: 1345, rating: 4.4, tags: ['vendor', 'risk', 'assessment'], summary: 'Structured framework for evaluating and monitoring third-party security risks', readTime: '12 min'},
    {id: 'kb-threat-hunting-012', title: 'Network Detection and Response Best Practices', category: 'Network', author: 'Network Security Team', publishDate: '2026-03-18', views: 1567, rating: 4.5, tags: ['ndr', 'network', 'detection'], summary: 'Implementing effective network detection and response capabilities', readTime: '14 min'},
    {id: 'kb-threat-hunting-013', title: 'Security Chaos Engineering Guide', category: 'Resilience', author: 'SRE Security', publishDate: '2026-04-12', views: 789, rating: 4.3, tags: ['chaos-engineering', 'resilience', 'testing'], summary: 'Applying chaos engineering principles to validate security controls', readTime: '10 min'},
    {id: 'kb-threat-hunting-014', title: 'Incident Communication Templates', category: 'Incident Response', author: 'IR Team', publishDate: '2026-02-22', views: 2234, rating: 4.8, tags: ['incident', 'communication', 'templates'], summary: 'Ready-to-use communication templates for security incident scenarios', readTime: '7 min'},
    {id: 'kb-threat-hunting-015', title: 'Endpoint Detection and Response Configuration', category: 'Endpoint', author: 'Endpoint Security', publishDate: '2026-03-08', views: 1345, rating: 4.5, tags: ['edr', 'endpoint', 'configuration'], summary: 'Optimal EDR configuration for maximum detection with minimal false positives', readTime: '11 min'},
    {id: 'kb-threat-hunting-016', title: 'Security Code Review Standards', category: 'Development', author: 'AppSec Team', publishDate: '2026-02-10', views: 1890, rating: 4.6, tags: ['code-review', 'secure-sdlc', 'standards'], summary: 'Standards and checklists for security-focused code reviews', readTime: '13 min'},
    {id: 'kb-threat-hunting-017', title: 'IoT Security Assessment Methodology', category: 'IoT', author: 'IoT Security Lab', publishDate: '2026-04-08', views: 654, rating: 4.2, tags: ['iot', 'embedded', 'assessment'], summary: 'Methodology for assessing security posture of IoT devices and ecosystems', readTime: '15 min'},
    {id: 'kb-threat-hunting-018', title: 'Passwordless Authentication Migration Guide', category: 'Identity', author: 'IAM Team', publishDate: '2026-03-25', views: 1678, rating: 4.7, tags: ['passwordless', 'authentication', 'mfa'], summary: 'Step-by-step migration plan from password-based to passwordless authentication', readTime: '12 min'},
    {id: 'kb-threat-hunting-019', title: 'Security Awareness Program Metrics', category: 'Awareness', author: 'Security Culture Team', publishDate: '2026-01-25', views: 1123, rating: 4.4, tags: ['awareness', 'metrics', 'culture'], summary: 'Measuring the effectiveness of your security awareness and training programs', readTime: '9 min'},
    {id: 'kb-threat-hunting-020', title: 'Deception Technology Deployment Guide', category: 'Detection', author: 'Blue Team', publishDate: '2026-04-15', views: 876, rating: 4.5, tags: ['deception', 'honeypot', 'detection'], summary: 'Planning and deploying deception technology for advanced threat detection', readTime: '11 min'},
  ];
  ...
  // --- Security Scenario Planning Methods (THHU) ---
  private _initThhuScenarios(): void {
    const worstCaseScenarios = [
      { id: "thhu-sc-01", name: "Ransomware Attack on Critical Infrastructure", category: "Malware", impact: 9500000, probability: 0.12, recoveryDays: 21, affectedSystems: 47, dataLossGb: 320, businessImpact: "critical" },
      { id: "thhu-sc-02", name: "Insider Data Exfiltration via Authorized Channels", category: "Insider Threat", impact: 7200000, probability: 0.18, recoveryDays: 14, affectedSystems: 12, dataLossGb: 85, businessImpact: "high" },
      { id: "thhu-sc-03", name: "Supply Chain Compromise via Third-Party Library", category: "Supply Chain", impact: 6800000, probability: 0.09, recoveryDays: 30, affectedSystems: 63, dataLossGb: 0, businessImpact: "critical" },
      { id: "thhu-sc-04", name: "Cloud Misconfiguration Leading to Public Exposure", category: "Cloud", impact: 4100000, probability: 0.22, recoveryDays: 7, affectedSystems: 8, dataLossGb: 450, businessImpact: "high" },
      { id: "thhu-sc-05", name: "Zero-Day Exploit in Core Application Framework", category: "Vulnerability", impact: 8900000, probability: 0.05, recoveryDays: 45, affectedSystems: 120, dataLossGb: 0, businessImpact: "critical" },
      { id: "thhu-sc-06", name: "Distributed Denial of Service on Customer-Facing Services", category: "Availability", impact: 3400000, probability: 0.25, recoveryDays: 3, affectedSystems: 15, dataLossGb: 0, businessImpact: "medium" },
      { id: "thhu-sc-07", name: "Credential Stuffing and Account Takeover Wave", category: "Identity", impact: 2800000, probability: 0.30, recoveryDays: 5, affectedSystems: 6, dataLossGb: 12, businessImpact: "medium" },
      { id: "thhu-sc-08", name: "Physical Security Breach at Data Center Facility", category: "Physical", impact: 12000000, probability: 0.02, recoveryDays: 60, affectedSystems: 200, dataLossGb: 5000, businessImpact: "critical" },
    ];
    this._thhuScenarios = worstCaseScenarios.map(s => ({ ...s, mitigationCost: Math.round(s.impact * 0.08), drillScheduled: false, lastDrillDate: null, drillScore: null, controlGaps: Math.floor(Math.random() * 5) + 1 }));
  }

  private _calculateThhuScenarioRisk(): void {
    this._thhuScenarios.forEach(s => {
  ...
  private _scheduleThhuDrills(): void {
  ...
  private _thhuScenarioComparison(): Record<string, unknown>[] {
    return this._thhuScenarios.map(s => ({
  ...
  // --- Security Control Effectiveness Analytics (THHU) ---
  private _initThhuControls(): void {
    const controls = [
      { id: "thhu-ct-01", name: "Network Segmentation", type: "preventive", maturity: "defined", score: 82, target: 90, failures: 3, lastTest: "2026-03-15" },
      { id: "thhu-ct-02", name: "Endpoint Detection and Response", type: "detective", maturity: "managed", score: 88, target: 92, failures: 1, lastTest: "2026-04-01" },
      { id: "thhu-ct-03", name: "Data Loss Prevention", type: "preventive", maturity: "repeatable", score: 71, target: 85, failures: 7, lastTest: "2026-03-22" },
      { id: "thhu-ct-04", name: "Security Information and Event Management", type: "detective", maturity: "managed", score: 85, target: 90, failures: 2, lastTest: "2026-04-05" },
      { id: "thhu-ct-05", name: "Identity and Access Management", type: "preventive", maturity: "defined", score: 76, target: 88, failures: 5, lastTest: "2026-03-28" },
      { id: "thhu-ct-06", name: "Vulnerability Management", type: "corrective", maturity: "managed", score: 80, target: 90, failures: 4, lastTest: "2026-04-02" },
      { id: "thhu-ct-07", name: "Email Security Gateway", type: "preventive", maturity: "managed", score: 90, target: 95, failures: 1, lastTest: "2026-04-08" },
      { id: "thhu-ct-08", name: "Web Application Firewall", type: "preventive", maturity: "managed", score: 87, target: 92, failures: 2, lastTest: "2026-03-30" },
      { id: "thhu-ct-09", name: "Patch Management", type: "corrective", maturity: "defined", score: 68, target: 85, failures: 9, lastTest: "2026-03-18" },
      { id: "thhu-ct-10", name: "Encryption at Rest", type: "preventive", maturity: "managed", score: 93, target: 95, failures: 0, lastTest: "2026-04-10" },
      { id: "thhu-ct-11", name: "Encryption in Transit", type: "preventive", maturity: "optimized", score: 96, target: 98, failures: 0, lastTest: "2026-04-12" },
      { id: "thhu-ct-12", name: "Privileged Access Management", type: "preventive", maturity: "defined", score: 74, target: 88, failures: 6, lastTest: "2026-03-25" },
      { id: "thhu-ct-13", name: "Security Awareness Training", type: "preventive", maturity: "repeatable", score: 65, target: 80, failures: 11, lastTest: "2026-03-20" },
      { id: "thhu-ct-14", name: "Incident Response Plan", type: "corrective", maturity: "managed", score: 78, target: 88, failures: 4, lastTest: "2026-04-03" },
      { id: "thhu-ct-15", name: "Backup and Recovery", type: "corrective", maturity: "managed", score: 84, target: 92, failures: 3, lastTest: "2026-04-06" },
      { id: "thhu-ct-16", name: "Multi-Factor Authentication", type: "preventive", maturity: "managed", score: 91, target: 95, failures: 1, lastTest: "2026-04-09" },
      { id: "thhu-ct-17", name: "Network Traffic Analysis", type: "detective", maturity: "defined", score: 72, target: 85, failures: 5, lastTest: "2026-03-27" },
      { id: "thhu-ct-18", name: "Cloud Security Posture Management", type: "detective", maturity: "repeatable", score: 69, target: 82, failures: 8, lastTest: "2026-03-24" },
      { id: "thhu-ct-19", name: "Container Security Scanning", type: "preventive", maturity: "defined", score: 75, target: 85, failures: 5, lastTest: "2026-04-04" },
      { id: "thhu-ct-20", name: "API Security Gateway", type: "preventive", maturity: "repeatable", score: 70, target: 82, failures: 7, lastTest: "2026-03-29" },
      { id: "thhu-ct-21", name: "Threat Intelligence Platform", type: "detective", maturity: "managed", score: 83, target: 90, failures: 2, lastTest: "2026-04-07" },
      { id: "thhu-ct-22", name: "Database Activity Monitoring", type: "detective", maturity: "defined", score: 67, target: 80, failures: 8, lastTest: "2026-03-21" },
      { id: "thhu-ct-23", name: "Deception Technology", type: "detective", maturity: "initial", score: 55, target: 75, failures: 12, lastTest: "2026-03-16" },
      { id: "thhu-ct-24", name: "Security Orchestration Automation", type: "corrective", maturity: "repeatable", score: 73, target: 85, failures: 6, lastTest: "2026-04-01" },
      { id: "thhu-ct-25", name: "Third-Party Risk Assessment", type: "preventive", maturity: "defined", score: 64, target: 78, failures: 9, lastTest: "2026-03-19" },
    ];
    this._thhuControls = controls;
  }

  private _analyzeThhuControlEffectiveness(): void {
    const typeBreakdown: Record<string, { total: number; avgScore: number; avgFailures: number }> = {};
    this._thhuControls.forEach(c => {
    ...
    this._thhuControlTypeBreakdown = typeBreakdown;
  }

  private _thhuControlOptimization(): Record<string, unknown>[] {
    return this._thhuControls.filter(c => c.score < c.target).map(c => ({
  ...
  // --- Security Data Pipeline Health (THHU) ---
  private _initThhuPipelines(): void {
    const pipelines = [
      { id: "thhu-pl-01", name: "SIEM Log Ingestion", status: "healthy", healthScore: 94, latencyMs: 120, freshnessMin: 2, errorRate: 0.02, throughputMbps: 450, recordsPerSec: 12000, backPressure: 0.05, uptime: 99.97 },
      { id: "thhu-pl-02", name: "Threat Feed Aggregation", status: "healthy", healthScore: 91, latencyMs: 300, freshnessMin: 15, errorRate: 0.05, throughputMbps: 85, recordsPerSec: 3200, backPressure: 0.08, uptime: 99.92 },
      { id: "thhu-pl-03", name: "Vulnerability Scan Results", status: "degraded", healthScore: 72, latencyMs: 2500, freshnessMin: 60, errorRate: 0.15, throughputMbps: 25, recordsPerSec: 800, backPressure: 0.35, uptime: 98.50 },
      { id: "thhu-pl-04", name: "Endpoint Telemetry Stream", status: "healthy", healthScore: 88, latencyMs: 450, freshnessMin: 5, errorRate: 0.08, throughputMbps: 280, recordsPerSec: 8500, backPressure: 0.12, uptime: 99.85 },
      { id: "thhu-pl-05", name: "Cloud Audit Log Pipeline", status: "healthy", healthScore: 86, latencyMs: 600, freshnessMin: 10, errorRate: 0.06, throughputMbps: 150, recordsPerSec: 4500, backPressure: 0.10, uptime: 99.80 },
      { id: "thhu-pl-06", name: "Identity Event Stream", status: "warning", healthScore: 78, latencyMs: 1200, freshnessMin: 20, errorRate: 0.12, throughputMbps: 45, recordsPerSec: 1500, backPressure: 0.22, uptime: 99.40 },
      { id: "thhu-pl-07", name: "Network Flow Collection", status: "healthy", healthScore: 82, latencyMs: 800, freshnessMin: 8, errorRate: 0.09, throughputMbps: 650, recordsPerSec: 18000, backPressure: 0.15, uptime: 99.70 },
      { id: "thhu-pl-08", name: "DLP Incident Pipeline", status: "degraded", healthScore: 68, latencyMs: 3500, freshnessMin: 45, errorRate: 0.20, throughputMbps: 18, recordsPerSec: 500, backPressure: 0.42, uptime: 97.80 },
    ];
    this._thhuPipelines = pipelines.map(p => ({ ...p, dependencies: [], slaBreached: p.healthScore < 75, alertThreshold: p.errorRate > 0.15 }));
    this._thhuPipelines[0].dependencies = ["thhu-pl-04", "thhu-pl-07"];
    this._thhuPipelines[4].dependencies = ["thhu-pl-01"];
    this._thhuPipelines[5].dependencies = ["thhu-pl-02"];
    this._thhuPipelines[7].dependencies = ["thhu-pl-04", "thhu-pl-05"];
  }

  private _thhuPipelineTrend(): Record<string, unknown>[] {
    const hours = Array.from({ length: 24 }, (_, i) => `H${String(i).padStart(2, "0")}`);
    return this._thhuPipelines.map(p => ({
  ...
  // --- Security Stakeholder Report Generator (THHU) ---
  private _initThhuReportTemplates(): void {
    this._thhuReportTemplates = [
      { id: "thhu-rp-01", name: "Board Security Report", audience: "board", frequency: "quarterly", sections: 6, autoGenerate: true, lastGenerated: "2026-03-31", pages: 12 },
      { id: "thhu-rp-02", name: "Executive Risk Summary", audience: "executive", frequency: "monthly", sections: 8, autoGenerate: true, lastGenerated: "2026-04-01", pages: 8 },
      { id: "thhu-rp-03", name: "Technical Security Review", audience: "technical", frequency: "weekly", sections: 12, autoGenerate: true, lastGenerated: "2026-04-21", pages: 25 },
      { id: "thhu-rp-04", name: "Audit Compliance Report", audience: "audit", frequency: "quarterly", sections: 10, autoGenerate: false, lastGenerated: "2026-03-15", pages: 35 },
      { id: "thhu-rp-05", name: "Regulatory Filing Package", audience: "regulatory", frequency: "annual", sections: 15, autoGenerate: false, lastGenerated: "2025-12-31", pages: 48 },
    ];
  }

  private _generateThhuExecSummary(): string {
    const totalRisk = this._thhuScenarios.reduce((sum: number, s: any) => sum + s.riskScore, 0);
    const avgControl = Math.round(this._thhuControls.reduce((sum: number, c: any) => sum + c.score, 0) / this._thhuControls.length);
    const degradedPipes = this._thhuPipelines.filter((p: any) => p.status !== "healthy").length;
    return `Overall risk exposure: ${(totalRisk / 1000000).toFixed(1)}M. Average control effectiveness: {avgControl}%. {degradedPipes} pipeline(s) need attention. {this._thhuScenarios.filter((s: any) => s.mitigationPriority === "immediate").length} scenarios require immediate action.`;
  }

  // --- Security Technology Radar (THHU) ---
  private _initThhuTechRadar(): void {
    this._thhuTechRadar = [
      { id: "thhu-tr-01", name: "AI-Powered Threat Detection", ring: "adopt", category: "Detection", maturity: 4, trend: "up", investment: "high", roi: 3.2, vendorCount: 8 },
      { id: "thhu-tr-02", name: "Zero Trust Architecture", ring: "adopt", category: "Architecture", maturity: 4, trend: "up", investment: "high", roi: 2.8, vendorCount: 12 },
      { id: "thhu-tr-03", name: "SASE/SSE Platform", ring: "trial", category: "Network", maturity: 3, trend: "up", investment: "medium", roi: 2.4, vendorCount: 10 },
      { id: "thhu-tr-04", name: "CNAPP Cloud Security", ring: "trial", category: "Cloud", maturity: 3, trend: "up", investment: "medium", roi: 2.1, vendorCount: 7 },
      { id: "thhu-tr-05", name: "Extended Detection and Response", ring: "adopt", category: "Detection", maturity: 4, trend: "stable", investment: "high", roi: 2.9, vendorCount: 9 },
      { id: "thhu-tr-06", name: "Quantum-Safe Cryptography", ring: "assess", category: "Crypto", maturity: 2, trend: "up", investment: "low", roi: 0.8, vendorCount: 4 },
      { id: "thhu-tr-07", name: "Security Service Edge", ring: "trial", category: "Network", maturity: 3, trend: "up", investment: "medium", roi: 2.0, vendorCount: 6 },
      { id: "thhu-tr-08", name: "SOAR 2.0 Autonomous SOC", ring: "assess", category: "Operations", maturity: 2, trend: "up", investment: "low", roi: 1.2, vendorCount: 5 },
      { id: "thhu-tr-09", name: "Software Supply Chain Security", ring: "trial", category: "DevSecOps", maturity: 3, trend: "up", investment: "medium", roi: 2.3, vendorCount: 8 },
      { id: "thhu-tr-10", name: "Identity Threat Detection", ring: "adopt", category: "Identity", maturity: 3, trend: "up", investment: "high", roi: 2.7, vendorCount: 7 },
      { id: "thhu-tr-11", name: "Data Security Posture Management", ring: "trial", category: "Data", maturity: 3, trend: "up", investment: "medium", roi: 2.2, vendorCount: 9 },
      { id: "thhu-tr-12", name: "Decentralized Identity Standards", ring: "hold", category: "Identity", maturity: 1, trend: "stable", investment: "low", roi: 0.5, vendorCount: 3 },
    ];
  }

  private _thhuRadarSummary(): Record<string, unknown> {
    const rings: Record<string, number> = { adopt: 0, trial: 0, assess: 0, hold: 0 };
    this._thhuTechRadar.forEach(t => { if (rings[t.ring as keyof typeof rings] !== undefined) rings[t.ring as keyof typeof rings]++; });
    return { adopt: rings.adopt, trial: rings.trial, assess: rings.assess, hold: rings.hold, total: this._thhuTechRadar.length, avgMaturity: 2.8, topInvestment: this._thhuTechRadar.filter(t => t.investment === "high").map(t => t.name) };
  }

  // --- THHU Security Compliance Mapping Matrix ---
  private _initThhuComplianceMatrix(): void {
    ...
    this._thhuComplianceMatrix = frameworks.map(fw => ({
  ...
  private _thhuComplianceTrend(): Record<string, unknown>[] {
    const quarters = ["Q1-2025", "Q2-2025", "Q3-2025", "Q4-2025", "Q1-2026", "Q2-2026"];
    return this._thhuComplianceMatrix.map(fw => ({
  ...
  // --- THHU Threat Intelligence Correlation Engine ---
  private _initThhuThreatIntel(): void {
    ...
    this._thhuThreatIntel = threatActors.map((actor, i) => ({
  ...
  private _thhuThreatCorrelation(): Record<string, unknown>[] {
    return this._thhuThreatIntel.filter(t => t.riskScore > 70).map(t => ({
  ...
  // --- THHU Security Metrics Deep Dive ---
  private _initThhuMetricsDeep(): void {
    ...
    this._thhuMetricsDeep = metricCategories.map(cat => ({
  ...
  private _thhuMetricsHeatmap(): number[][] {
    return this._thhuMetricsDeep.map(cat =>
      cat.metrics.map(m => Math.round((m.value / m.target) * 100))
    );
  }

  // --- THHU Incident Cost Modeling ---
  private _initThhuCostModel(): void {
    const incidentTypes = ["Data Breach", "Ransomware", "DDoS", "Insider Threat", "Phishing", "Supply Chain", "Cloud Misconfig", "Zero-Day"];
    this._thhuCostModel = incidentTypes.map(inc => ({
    ...
    this._thhuCostModel.forEach(m => { m.totalAnnualExposure = m.avgCost * m.frequency; });
  }

  private _thhuCostProjection(): Record<string, unknown>[] {
    return this._thhuCostModel.map(m => ({
  ...
  // --- THHU Security Architecture Pattern Library ---
  private _initThhuArchPatterns(): void {
    ...
    this._thhuArchPatterns = patterns.map((p, i) => ({
  ...
  private _thhuArchPatternAnalysis(): Record<string, unknown> {
    const implemented = this._thhuArchPatterns.filter(p => p.implementation > 75).length;
    const avgCoverage = Math.round(this._thhuArchPatterns.reduce((s: number, p: any) => s + p.coverage, 0) / this._thhuArchPatterns.length);
    return {
      totalPatterns: this._thhuArchPatterns.length, fullyImplemented: implemented, avgCoverage,
      avgRiskReduction: Math.round(this._thhuArchPatterns.reduce((s: number, p: any) => s + p.riskReduction, 0) / this._thhuArchPatterns.length),
      gaps: this._thhuArchPatterns.filter(p => p.implementation < 60).map(p => p.pattern),
      recommendations: this._thhuArchPatterns.filter(p => p.implementation < 70).map(p => ({ pattern: p.pattern, current: p.implementation, target: 85, effort: p.costComplexity }))
    };
  }
  ...
  private _de0RiskAssessmentWorkflow = [
  ...
  private _de0TreatmentOptions = [
    {id: 'de0-T-001', riskId: 'RSK-042', risk: 'Ransomware Attack on Critical Infrastructure', before: 20, after: 6, strategy: 'Mitigate', controls: ['Next-gen EDR with behavioral detection and automated response', 'Zero-trust network micro-segmentation isolating critical assets', 'Immutable offline backup rotation with quarterly recovery testing', 'Incident response retainer with 1-hour response SLA'], cost: '$450K/yr', roi: '78% reduction vs $2.8M potential loss', timeline: 'Q3 2026', status: 'approved' as const},
  ...
  private _de0TalentPositions = [
    ...
    {id: 'de0-H-002', title: 'Cloud Security Engineer', dept: 'Cloud Security', level: 'Mid-Senior', loc: 'SF/Remote', salary: '$155K-$180K', posted: '2026-03-20', applicants: 45, pipeline: 12, interviews: 6, offers: 2, urgency: 'high' as const, manager: 'Mike Johnson', skills: ['AWS/Azure/GCP', 'Terraform', 'Kubernetes', 'IAM', 'CSPM'], nice: ['CCSP', 'CKS', 'Serverless']},
    {id: 'de0-H-003', title: 'SOC Analyst L2', dept: 'Security Operations', level: 'Mid', loc: 'Austin TX', salary: '$105K-$130K', posted: '2026-04-01', applicants: 67, pipeline: 18, interviews: 8, offers: 0, urgency: 'medium' as const, manager: 'Lisa Park', skills: ['SIEM', 'Incident triage', 'Malware analysis', 'TCP/IP'], nice: ['GCIA', 'SOAR', 'Kill chain']},
    {id: 'de0-H-004', title: 'Staff Security Architect', dept: 'Architecture', level: 'Staff', loc: 'Remote US', salary: '$200K-$240K', posted: '2026-02-28', applicants: 12, pipeline: 3, interviews: 2, offers: 0, urgency: 'critical' as const, manager: 'David Lee', skills: ['Enterprise arch', 'Zero trust', 'Risk frameworks', 'Board comms'], nice: ['CISSP+SABSA', 'Team building', 'Speaker']},
    {id: 'de0-H-005', title: 'GRC Analyst', dept: 'GRC', level: 'Mid', loc: 'NY/Remote', salary: '$110K-$135K', posted: '2026-04-05', applicants: 34, pipeline: 9, interviews: 3, offers: 1, urgency: 'medium' as const, manager: 'Rachel Green', skills: ['ISO 27001', 'SOC 2', 'Risk assessment', 'Audit'], nice: ['CRISC', 'CISA', 'GDPR']},
    {id: 'de0-H-006', title: 'Threat Intel Analyst', dept: 'Threat Intel', level: 'Mid-Senior', loc: 'Remote US', salary: '$140K-$170K', posted: '2026-03-25', applicants: 19, pipeline: 5, interviews: 2, offers: 0, urgency: 'low' as const, manager: 'James Wilson', skills: ['MITRE ATT&CK', 'OSINT', 'Threat modeling', 'Reverse eng'], nice: ['CTIA', 'Nation-state', 'Dark web']},
    {id: 'de0-H-007', title: 'AppSec Engineer', dept: 'AppSec', level: 'Senior', loc: 'Seattle/Remote', salary: '$160K-$190K', posted: '2026-04-10', applicants: 28, pipeline: 7, interviews: 3, offers: 0, urgency: 'medium' as const, manager: 'Emily Zhang', skills: ['SAST/DAST/SCA', 'Secure SDLC', 'Code review', 'CI/CD'], nice: ['CSSLP', 'Mobile security']},
    {id: 'de0-H-008', title: 'IAM Engineer', dept: 'IAM', level: 'Mid', loc: 'Remote US', salary: '$135K-$160K', posted: '2026-04-08', applicants: 31, pipeline: 10, interviews: 5, offers: 1, urgency: 'medium' as const, manager: 'Chris Martinez', skills: ['Okta/Azure AD', 'SAML/OIDC', 'PAM', 'RBAC'], nice: ['CISSP', 'Zero trust IAM']}
  ];

  private _de0InterviewScorecard = [
  ...
  private _de0OnboardingSteps = [
    {id: 'de0-OB-01', item: 'Provision security-hardened laptop, monitors, peripherals, and configured workstation image with all required security tools', cat: 'IT Setup', day: 'Day 1', owner: 'IT Operations'},
    {id: 'de0-OB-02', item: 'Create AD account, email, Slack, VPN, SSO enrollment, and all required application access accounts', cat: 'Access', day: 'Day 1', owner: 'IAM Team'},
    {id: 'de0-OB-03', item: 'Grant security tooling access: SIEM console, EDR dashboard, vuln scanner, pentest platforms, SOAR', cat: 'Tools', day: 'Day 1-2', owner: 'SOC Manager'},
    {id: 'de0-OB-04', item: 'Complete MFA enrollment, security awareness onboarding course, and acceptable use policy acknowledgment', cat: 'Security', day: 'Day 1', owner: 'Awareness Team'},
    {id: 'de0-OB-05', item: 'Sign NDA, employment agreement, IP assignment, and code of conduct documents with HR', cat: 'HR', day: 'Day 1', owner: 'Human Resources'},
    {id: 'de0-OB-06', item: 'Introduction meetings with direct team members and key cross-functional stakeholders', cat: 'Integration', day: 'Week 1', owner: 'Hiring Manager'},
    {id: 'de0-OB-07', item: 'Security architecture overview, tooling walkthrough, and operational runbook review sessions', cat: 'Training', day: 'Week 1-2', owner: 'Security Architect'},
    {id: 'de0-OB-08', item: 'Shadow experienced team member on active incident response and threat hunting investigations', cat: 'Mentoring', day: 'Week 2-3', owner: 'SOC Lead'},
    {id: 'de0-OB-09', item: 'Set up individual certification study plan aligned with role requirements and career goals', cat: 'Development', day: 'Week 2', owner: 'Hiring Manager'},
    {id: 'de0-OB-10', item: 'Establish 30-60-90 day goals, define success metrics, and schedule first performance checkpoint', cat: 'Goals', day: 'Week 1', owner: 'Hiring Manager'}
  ];

  private _de0MetricsDashboard = [
    {id: 'de0-MTD-001', name: 'Mean Time to Detect (MTTD)', value: '4.2 hours', trend: 'improving' as const, target: '< 4 hours', source: 'SIEM - Splunk', method: 'Median time from first alert to analyst acknowledgment', owner: 'SOC Manager', sla: '4 hours', prev: '5.1 hours', spark: [5.8, 5.4, 5.1, 4.9, 4.7, 4.5, 4.3, 4.2], breakdown: [{src: 'Network IDS', pct: '35%', avg: '3.8h'}, {src: 'Endpoint EDR', pct: '28%', avg: '4.1h'}, {src: 'Email Gateway', pct: '22%', avg: '3.5h'}, {src: 'Cloud Security', pct: '10%', avg: '5.2h'}, {src: 'User Reports', pct: '5%', avg: '6.8h'}]},
    {id: 'de0-MTD-002', name: 'Mean Time to Respond (MTTR)', value: '2.8 hours', trend: 'stable' as const, target: '< 3 hours', source: 'SOAR - XSOAR', method: 'Median time from acknowledgment to first containment action', owner: 'IR Lead', sla: '3 hours', prev: '2.7 hours', spark: [3.2, 3.0, 2.9, 2.8, 2.8, 2.9, 2.8, 2.8], breakdown: [{src: 'Auto Playbooks', pct: '42%', avg: '1.2h'}, {src: 'Semi-Auto', pct: '33%', avg: '2.5h'}, {src: 'Manual', pct: '20%', avg: '5.1h'}, {src: 'L3 Escalation', pct: '5%', avg: '8.3h'}]},
    {id: 'de0-MTD-003', name: 'Patch Compliance Rate', value: '97.6%', trend: 'improving' as const, target: '> 95%', source: 'Tenable.io', method: 'Pct of critical/high vulns patched within SLA windows', owner: 'Vuln Manager', sla: '95%', prev: '96.1%', spark: [93.2, 94.1, 94.8, 95.3, 95.9, 96.4, 97.0, 97.6], breakdown: [{src: 'Critical (7d)', pct: '40%', rate: '99.2%'}, {src: 'High (30d)', pct: '35%', rate: '97.8%'}, {src: 'Medium (90d)', pct: '20%', rate: '95.1%'}, {src: 'Low (180d)', pct: '5%', rate: '89.4%'}]},
    {id: 'de0-MTD-004', name: 'Phishing Click Rate', value: '3.2%', trend: 'improving' as const, target: '< 5%', source: 'KnowBe4 + Proofpoint', method: 'Pct of users clicking simulated phishing links monthly', owner: 'Awareness Lead', sla: '5%', prev: '4.1%', spark: [6.8, 6.2, 5.5, 5.1, 4.6, 4.1, 3.6, 3.2], breakdown: [{src: 'Spear Phishing', pct: '35%', rate: '5.1%'}, {src: 'Generic Phishing', pct: '30%', rate: '2.8%'}, {src: 'BEC Sim', pct: '20%', rate: '3.5%'}, {src: 'SMS Phishing', pct: '15%', rate: '1.9%'}]},
    {id: 'de0-MTD-005', name: 'Security Posture Score', value: '784', trend: 'improving' as const, target: '> 750', source: 'SecurityScorecard', method: 'Composite: external 30%, compliance 25%, vuln 25%, config 20%', owner: 'CISO', sla: '> 750', prev: '771', spark: [748, 752, 758, 762, 768, 773, 778, 784], breakdown: [{src: 'External Rating', pct: '30%', score: '791'}, {src: 'Compliance', pct: '25%', score: '812'}, {src: 'Vuln Mgmt', pct: '25%', score: '745'}, {src: 'Config', pct: '20%', score: '769'}]},
    {id: 'de0-MTD-006', name: 'Vulnerability Backlog', value: '142', trend: 'improving' as const, target: '< 150', source: 'Tenable + Qualys', method: 'Total open vulns across all scanned assets tracked weekly', owner: 'Vuln Manager', sla: '< 150', prev: '168', spark: [210, 198, 185, 175, 165, 158, 150, 142], breakdown: [{src: 'Critical', pct: '8%', count: '11'}, {src: 'High', pct: '22%', count: '31'}, {src: 'Medium', pct: '45%', count: '64'}, {src: 'Low', pct: '25%', count: '36'}]}
  ];

  private _de0ArchReview = [
    {id: 'de0-AR-001', cat: 'Network', item: 'Network segmentation between trust zones with dedicated firewalls and granular ACLs', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Micro-segmentation via NSX across all production zones'},
    {id: 'de0-AR-002', cat: 'Network', item: 'DMZ architecture isolating public services from internal network', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Dual-firewall DMZ with WAF and DDoS mitigation'},
    {id: 'de0-AR-003', cat: 'Network', item: 'Least-privilege traffic flows with deny-by-default and quarterly review', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Explicit allow rules with automated drift detection'},
    {id: 'de0-AR-004', cat: 'Network', item: 'Encrypted external communications with IPSec/TLS 1.3 and PFS', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'IKEv2 with PFS, TLS 1.3 for all external APIs'},
    {id: 'de0-AR-005', cat: 'Identity', item: 'Centralized IdP with SSO and automated SCIM provisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Okta SSO SAML 2.0 for 247 apps with SCIM'},
    {id: 'de0-AR-006', cat: 'Identity', item: 'RBAC with quarterly reviews and automated deprovisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Quarterly recertification with JIT admin access'},
    {id: 'de0-AR-007', cat: 'Identity', item: 'PAM controlling all admin and service accounts with session recording', sev: 'high' as const, status: 'fail' as const, reviewer: 'IAM Lead', notes: '3 legacy accounts pending CyberArk enrollment'},
    {id: 'de0-AR-008', cat: 'Identity', item: 'MFA enforced for all users, hardware tokens for privileged access', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'FIDO2 for admins, push MFA for users, 99.8% enrollment'},
    {id: 'de0-AR-009', cat: 'Data', item: 'Data classification enforced with automated labeling on all repos', sev: 'high' as const, status: 'partial' as const, reviewer: 'Data Protection Lead', notes: 'Framework deployed, gaps on 4 legacy file shares'},
    {id: 'de0-AR-010', cat: 'Data', item: 'AES-256 encryption at rest for all sensitive data stores', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'Full-disk, TDE on DBs, SSE-KMS on cloud storage'},
    {id: 'de0-AR-011', cat: 'Data', item: 'DLP monitoring and preventing unauthorized data exfiltration', sev: 'high' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'DLP active on email, endpoint, cloud, and network'},
    {id: 'de0-AR-012', cat: 'Data', item: 'Encrypted off-site backups with quarterly restore testing', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Infrastructure Lead', notes: '3-2-1 strategy with immutable backups'},
    {id: 'de0-AR-013', cat: 'AppSec', item: 'Secure SDLC with SAST, DAST, SCA in all CI/CD pipelines', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: '34 pipelines with security gates and PR blocking'},
    {id: 'de0-AR-014', cat: 'AppSec', item: 'API gateway with auth, rate limiting, schema validation', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: 'Kong with OAuth2, rate limits, OpenAPI validation'},
    {id: 'de0-AR-015', cat: 'AppSec', item: 'Container security with image scanning and runtime protection', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Trivy scanning, Falco runtime in 80% of clusters'},
    {id: 'de0-AR-016', cat: 'Monitoring', item: 'SIEM collecting from all critical systems with correlation rules', sev: 'critical' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'Splunk 98% coverage with 1200+ correlation rules'},
    {id: 'de0-AR-017', cat: 'Monitoring', item: 'EDR with behavioral detection on all managed endpoints', sev: 'high' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'CrowdStrike on 99.2% endpoints with 24/7 MDR'},
    {id: 'de0-AR-018', cat: 'Monitoring', item: 'Executive dashboards with real-time posture visibility', sev: 'medium' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'PowerBI dashboards with weekly exec summaries'},
    {id: 'de0-AR-019', cat: 'Cloud', item: 'CSPM monitoring and remediating cloud misconfigurations', sev: 'high' as const, status: 'pass' as const, reviewer: 'Cloud Security Lead', notes: 'Prisma Cloud 450+ checks with auto-remediation'},
    {id: 'de0-AR-020', cat: 'Cloud', item: 'IaC templates scanned before deployment to production', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Checkov for Terraform, cfn-nag for CloudFormation pending'}
  ];

  private _getde0RiskProgress(): number {
    return Math.round(this._de0RiskAssessmentWorkflow.filter(s => s.status === 'completed').length / this._de0RiskAssessmentWorkflow.length * 100);
  }

  private _getde0TreatmentSummary(): {total: number; approved: number; avgReduction: number; investment: string} {
    const a = this._de0TreatmentOptions.filter(r => r.status === 'approved').length;
    const avg = this._de0TreatmentOptions.reduce((s, r) => s + ((r.before - r.after) / r.before * 100), 0) / this._de0TreatmentOptions.length;
    return {total: this._de0TreatmentOptions.length, approved: a, avgReduction: Math.round(avg), investment: '$1.125M annually'};
  }

  private _getde0RuleSummary(): {total: number; passing: number; failing: number; avgRate: number; violations: number} {
    const p = this._de0ComplianceRules.filter(r => r.result === 'pass').length;
    const f = this._de0ComplianceRules.filter(r => r.result === 'fail').length;
    const avg = this._de0ComplianceRules.reduce((s, r) => s + r.passRate, 0) / this._de0ComplianceRules.length;
    const v = this._de0ComplianceRules.reduce((s, r) => s + r.violations, 0);
    return {total: this._de0ComplianceRules.length, passing: p, failing: f, avgRate: Math.round(avg * 10) / 10, violations: v};
  }

  private _getde0PipelineStats(): {positions: number; applicants: number; interviewing: number; offers: number; critical: number} {
    const t = this._de0TalentPositions.length;
    const a = this._de0TalentPositions.reduce((s, p) => s + p.applicants, 0);
    const i = this._de0TalentPositions.reduce((s, p) => s + p.interviews, 0);
    const o = this._de0TalentPositions.reduce((s, p) => s + p.offers, 0);
    const c = this._de0TalentPositions.filter(x => x.urgency === 'critical').length;
    return {positions: t, applicants: a, interviewing: i, offers: o, critical: c};
  }

  private _getde0MetricTrends(): {improving: number; stable: number; total: number} {
    const imp = this._de0MetricsDashboard.filter(m => m.trend === 'improving').length;
    const stb = this._de0MetricsDashboard.filter(m => m.trend === 'stable').length;
    return {improving: imp, stable: stb, total: this._de0MetricsDashboard.length};
  }

  private _getde0ArchScore(): {total: number; passed: number; failed: number; partial: number; score: number} {
    const p = this._de0ArchReview.filter(c => c.status === 'pass').length;
    const f = this._de0ArchReview.filter(c => c.status === 'fail').length;
    const pa = this._de0ArchReview.filter(c => c.status === 'partial').length;
    return {total: this._de0ArchReview.length, passed: p, failed: f, partial: pa, score: Math.round((p / this._de0ArchReview.length) * 100)};
  }


  private _zde0IncidentScenarios = [
    {id: 'zde0-IS-001', name: 'Ransomware Outbreak in Production Environment', category: 'Malware', likelihood: 'Medium', impact: 'Critical', riskScore: 15, playbooks: ['IR-Ransomware-Isolate', 'IR-Ransomware-Eradicate', 'IR-Ransomway-Recover'], estimatedMTTD: '15min', estimatedMTTR: '4h', involvedTeams: ['SOC', 'IR', 'Infrastructure', 'Legal', 'Comms'], keyIndicators: ['Mass file encryption events', 'Ransom note deployment', 'Lateral movement via SMB/RDP', 'Backup deletion attempts'], mitigationControls: ['EDR behavioral detection', 'Network segmentation', 'Immutable backups', 'Email filtering'], lessonsLearned: 'Ensure offline backups are tested quarterly and Ransomware-specific playbooks are updated with latest threat intelligence', lastDrillDate: '2026-03-15', nextDrillDate: '2026-06-15'},
    {id: 'zde0-IS-002', name: 'Cloud Misconfiguration Leading to Data Exposure', category: 'Cloud', likelihood: 'High', impact: 'High', riskScore: 16, playbooks: ['IR-Cloud-Misconfig-Assess', 'IR-Cloud-Misconfig-Remediate', 'IR-Cloud-Misconfig-Notify'], estimatedMTTD: '2h', estimatedMTTR: '6h', involvedTeams: ['Cloud Security', 'SOC', 'Data Protection', 'Legal'], keyIndicators: ['Public S3 bucket exposure', 'Overly permissive IAM policies', 'Unencrypted database snapshots', 'Public API endpoint discovery'], mitigationControls: ['CSPM monitoring', 'IAM policy analyzer', 'Automated remediation', 'Cloud audit logging'], lessonsLearned: 'Implement CSPM with auto-remediation for common misconfigurations and conduct monthly cloud configuration reviews', lastDrillDate: '2026-02-20', nextDrillDate: '2026-05-20'},
    {id: 'zde0-IS-003', name: 'Insider Threat Data Exfiltration', category: 'Insider', likelihood: 'Low', impact: 'Critical', riskScore: 12, playbooks: ['IR-Insider-Investigate', 'IR-Insider-Contain', 'IR-Insider-Escalate'], estimatedMTTD: '8h', estimatedMTTR: '24h', involvedTeams: ['SOC', 'IR', 'HR', 'Legal', 'IAM'], keyIndicators: ['Anomalous data access patterns', 'Large file downloads to USB or cloud', 'Off-hours access to sensitive systems', 'Accessing data outside normal job scope'], mitigationControls: ['UEBA analytics', 'DLP policies', 'PAM controls', 'Access reviews'], lessonsLearned: 'Strengthen UEBA baselines and implement automated alerts for data access pattern anomalies', lastDrillDate: '2026-01-10', nextDrillDate: '2026-04-10'},
    {id: 'zde0-IS-004', name: 'Supply Chain Attack via Compromised Vendor Software', category: 'Supply Chain', likelihood: 'Low', impact: 'Critical', riskScore: 12, playbooks: ['IR-SupplyChain-Detect', 'IR-SupplyChain-Isolate', 'IR-SupplyChain-Remediate'], estimatedMTTD: '24h', estimatedMTTR: '72h', involvedTeams: ['SOC', 'IR', 'Procurement', 'Vendor Mgmt', 'Legal'], keyIndicators: ['Unexpected network connections from vendor software', 'Modified binaries or dependencies', 'Anomalous behavior from trusted applications', 'SBOM discrepancy alerts'], mitigationControls: ['SCA scanning', 'SBOM monitoring', 'Vendor security assessments', 'Network segmentation'], lessonsLearned: 'Require SBOM from all vendors and implement continuous monitoring of third-party component behavior', lastDrillDate: '2026-03-01', nextDrillDate: '2026-06-01'},
    {id: 'zde0-IS-005', name: 'Credential Stuffing Attack on Customer Portal', category: 'External Attack', likelihood: 'High', impact: 'Medium', riskScore: 12, playbooks: ['IR-CredentialStuffing-Detect', 'IR-CredentialStuffing-Block', 'IR-CredentialStuffing-Notify'], estimatedMTTD: '30min', estimatedMTTR: '2h', involvedTeams: ['SOC', 'AppSec', 'Customer Support', 'Comms'], keyIndicators: ['High volume of failed login attempts', 'Login attempts from known compromised credential lists', 'Unusual geographic distribution of login attempts', 'Account takeover indicators'], mitigationControls: ['WAF rate limiting', 'CAPTCHA on login', 'MFA enforcement', 'Credential monitoring service'], lessonsLearned: 'Deploy advanced bot detection on login endpoints and implement proactive credential monitoring for customer accounts', lastDrillDate: '2026-04-01', nextDrillDate: '2026-07-01'},
    {id: 'zde0-IS-006', name: 'Phishing Campaign Targeting Executive Team', category: 'Social Engineering', likelihood: 'High', impact: 'High', riskScore: 16, playbooks: ['IR-Phishing-Contain', 'IR-Phishing-Investigate', 'IR-Phishing-Notify'], estimatedMTTD: '1h', estimatedMTTR: '4h', involvedTeams: ['SOC', 'Awareness', 'Executive Office', 'IT'], keyIndicators: ['Sophisticated spear-phishing emails to C-suite', 'Business email compromise indicators', 'Redirected MFA approval requests', 'Unauthorized wire transfer attempts'], mitigationControls: ['AI email filtering', 'Executive awareness training', 'Out-of-band verification policy', 'DMARC/DKIM/SPF'], lessonsLearned: 'Implement additional email security controls for executive mailboxes and conduct monthly spear-phishing simulations', lastDrillDate: '2026-02-15', nextDrillDate: '2026-05-15'}
  ];

  private _zde0SecurityFrameworks = [
  ...
  private _getzde0ScenarioSummary(): {total: number; critical: number; high: number; drilled: number; avgRiskScore: number} {
    const crit = this._zde0IncidentScenarios.filter(s => s.impact === 'Critical').length;
    const high = this._zde0IncidentScenarios.filter(s => s.impact === 'High').length;
    const avg = this._zde0IncidentScenarios.reduce((s, x) => s + x.riskScore, 0) / this._zde0IncidentScenarios.length;
    return {total: this._zde0IncidentScenarios.length, critical: crit, high: high, drilled: this._zde0IncidentScenarios.length, avgRiskScore: Math.round(avg)};
  }

  private _getzde0VendorRiskSummary(): {total: number; approved: number; conditional: number; remediation: number; avgScore: number} {
    const approved = this._zde0ThirdPartyRiskData.filter(v => v.status === 'approved').length;
    const cond = this._zde0ThirdPartyRiskData.filter(v => v.status === 'conditional').length;
    const rem = this._zde0ThirdPartyRiskData.filter(v => v.status === 'remediation_required').length;
    const avg = this._zde0ThirdPartyRiskData.reduce((s, v) => s + v.riskScore, 0) / this._zde0ThirdPartyRiskData.length;
    return {total: this._zde0ThirdPartyRiskData.length, approved, conditional: cond, remediation: rem, avgScore: Math.round(avg)};
  }

  private _getzde0TrainingSummary(): {total: number; avgCompletion: number; avgScore: number; overdueUpdates: number} {
    const avgComp = this._zde0SecurityTrainingCatalog.reduce((s, t) => s + t.completionRate, 0) / this._zde0SecurityTrainingCatalog.length;
    const avgScore = this._zde0SecurityTrainingCatalog.filter(t => t.avgScore > 0).reduce((s, t) => s + t.avgScore, 0) / this._zde0SecurityTrainingCatalog.filter(t => t.avgScore > 0).length;
    return {total: this._zde0SecurityTrainingCatalog.length, avgCompletion: Math.round(avgComp * 10) / 10, avgScore: Math.round(avgScore), overdueUpdates: 0};
  }

  private _getzde0ToolHealthSummary(): {total: number; healthy: number; degraded: number; annualCost: string} {
    const healthy = this._zde0SecurityToolInventory.filter(t => t.health === 'healthy').length;
    const degraded = this._zde0SecurityToolInventory.filter(t => t.health === 'degraded').length;
    const cost = this._zde0SecurityToolInventory.reduce((s, t) => s + parseInt(t.annualCost.replace(/[^0-9]/g, '')), 0);
    return {total: this._zde0SecurityToolInventory.length, healthy, degraded, annualCost: '$' + (cost / 1000).toFixed(0) + 'K'};
  }


  private _xde0SecurityZones = [
    {zoneId: 'xde0-Z-001', name: 'Internet DMZ', trustLevel: 'Untrusted', subnet: '10.0.0.0/24', segmentation: 'Dual-firewall', firewallRules: 45, monitoring: 'Full packet capture', assets: ['Web servers', 'Load balancers', 'WAF appliances', 'Reverse proxy'], riskLevel: 'high' as const, lastAssessment: '2026-04-15', nextAssessment: '2026-07-15'},
    {zoneId: 'xde0-Z-002', name: 'Corporate Network', trustLevel: 'Trusted', subnet: '10.1.0.0/16', segmentation: 'VLAN + micro-seg', firewallRules: 128, monitoring: 'NetFlow + IDS', assets: ['Workstations', 'Printers', 'Meeting room systems', 'VoIP phones'], riskLevel: 'medium' as const, lastAssessment: '2026-04-10', nextAssessment: '2026-07-10'},
    {zoneId: 'xde0-Z-003', name: 'Production Data Center', trustLevel: 'Restricted', subnet: '10.2.0.0/16', segmentation: 'Full micro-segmentation', firewallRules: 256, monitoring: 'Full packet capture + EDR', assets: ['Application servers', 'Database clusters', 'Message queues', 'API gateways'], riskLevel: 'low' as const, lastAssessment: '2026-04-12', nextAssessment: '2026-07-12'},
    {zoneId: 'xde0-Z-004', name: 'Management Network', trustLevel: 'Restricted', subnet: '10.3.0.0/24', segmentation: 'Isolated VLAN', firewallRules: 32, monitoring: 'Syslog + SNMP', assets: ['Hypervisors', 'Switch management', 'Storage controllers', 'Backup appliances'], riskLevel: 'low' as const, lastAssessment: '2026-04-08', nextAssessment: '2026-07-08'},
    {zoneId: 'xde0-Z-005', name: 'Cloud Production', trustLevel: 'Restricted', subnet: 'VPC: 172.16.0.0/12', segmentation: 'Security groups + NACLs', firewallRules: 189, monitoring: 'VPC Flow Logs + GuardDuty', assets: ['Kubernetes clusters', 'Managed databases', 'Object storage', 'Serverless functions'], riskLevel: 'medium' as const, lastAssessment: '2026-04-18', nextAssessment: '2026-07-18'}
  ];

  private _xde0SecurityAlerts = [
    {id: 'xde0-AL-001', severity: 'critical', title: 'Active ransomware encryption detected on PROD-DB-01', source: 'CrowdStrike', timestamp: '2026-04-22T13:45:00Z', status: 'investigating', assignee: 'SOC Analyst J. Smith', asset: 'PROD-DB-01 (10.2.1.15)', mitreTechnique: 'T1486 - Data Encrypted for Impact', playbook: 'IR-Ransomware-Isolate', sla: '15 minutes', elapsed: '12 minutes', notes: 'EDR detected mass file encryption event pattern. Automated isolation triggered. IR team paged.'},
    {id: 'xde0-AL-002', severity: 'high', title: 'Impossible travel detected for user admin@company.com', source: 'Okta', timestamp: '2026-04-22T12:30:00Z', status: 'triaged', assignee: 'SOC Analyst M. Johnson', asset: 'Okta - admin@company.com', mitreTechnique: 'T1078 - Valid Accounts', playbook: 'IR-ImpossibleTravel', sla: '30 minutes', elapsed: '87 minutes', notes: 'Login from Tokyo followed by login from New York within 30 minutes. Account temporarily locked. User confirmed via out-of-band channel they are in New York.'},
    {id: 'xde0-AL-003', severity: 'high', title: 'Public S3 bucket discovered with customer PII exposure', source: 'Prisma Cloud', timestamp: '2026-04-22T11:15:00Z', status: 'remediating', assignee: 'Cloud Security Lead A. Chen', asset: 'AWS S3: customer-data-archive-2024', mitreTechnique: 'N/A - Misconfiguration', playbook: 'IR-Cloud-Misconfig-Remediate', sla: '1 hour', elapsed: '2.5 hours', notes: 'Bucket containing archived customer records was publicly accessible. Bucket blocked and encrypted. Data exposure assessment in progress.'},
    {id: 'xde0-AL-004', severity: 'medium', title: 'Anomalous data download by user jane.developer@company.com', source: 'Microsoft DLP', timestamp: '2026-04-22T10:00:00Z', status: 'investigating', assignee: 'SOC Analyst R. Davis', asset: 'Endpoint: WS-DEV-042', mitreTechnique: 'T1567 - Exfil Over Web Service', playbook: 'IR-DLP-Investigation', sla: '4 hours', elapsed: '3.5 hours', notes: 'User downloaded 4.2GB of source code files to personal Google Drive. Interview scheduled with user and manager.'},
    {id: 'xde0-AL-005', severity: 'medium', title: 'Credential stuffing attack detected on customer portal', source: 'Cloudflare WAF', timestamp: '2026-04-22T09:30:00Z', status: 'contained', assignee: 'SOC Analyst K. Wilson', asset: 'Customer Portal (portal.company.com)', mitreTechnique: 'T1110 - Brute Force', playbook: 'IR-CredentialStuffing-Block', sla: '2 hours', elapsed: '4 hours', notes: 'Rate limiting and CAPTCHA automatically deployed. 12,000 failed login attempts from 800 unique IPs blocked. No successful account takeovers confirmed.'},
    {id: 'xde0-AL-006', severity: 'low', title: 'SSL certificate expiring in 14 days for api.company.com', source: 'Certificate monitoring', timestamp: '2026-04-22T08:00:00Z', status: 'remediated', assignee: 'Infrastructure Lead T. Brown', asset: 'api.company.com', mitreTechnique: 'N/A', playbook: 'Certificate Renewal', sla: '30 days', elapsed: '16 days', notes: 'Automated renewal triggered via ACME. New certificate deployed successfully. No service interruption.'}
  ];

  private _xde0ComplianceFrameworks = [
  ...
  private _xde0DataClassificationPolicy = [
  ...
  private _getxde0ZoneSummary(): {total: number; highRisk: number; mediumRisk: number; lowRisk: number; totalRules: number} {
    const high = this._xde0SecurityZones.filter(z => z.riskLevel === 'high').length;
    const med = this._xde0SecurityZones.filter(z => z.riskLevel === 'medium').length;
    const low = this._xde0SecurityZones.filter(z => z.riskLevel === 'low').length;
    const rules = this._xde0SecurityZones.reduce((s, z) => s + z.firewallRules, 0);
    return {total: this._xde0SecurityZones.length, highRisk: high, mediumRisk: med, lowRisk: low, totalRules: rules};
  }

  private _getxde0AlertSummary(): {total: number; critical: number; high: number; medium: number; low: number; open: number; contained: number} {
    const crit = this._xde0SecurityAlerts.filter(a => a.severity === 'critical').length;
    const high = this._xde0SecurityAlerts.filter(a => a.severity === 'high').length;
    const med = this._xde0SecurityAlerts.filter(a => a.severity === 'medium').length;
    const low = this._xde0SecurityAlerts.filter(a => a.severity === 'low').length;
    const open = this._xde0SecurityAlerts.filter(a => a.status === 'investigating' || a.status === 'triaged').length;
    const contained = this._xde0SecurityAlerts.filter(a => a.status === 'contained' || a.status === 'remediated').length;
    return {total: this._xde0SecurityAlerts.length, critical: crit, high, medium: med, low, open, contained};
  }

  private _getxde0ComplianceSummary(): {total: number; fullyCompliant: number; mostlyCompliant: number; avgComplianceRate: number} {
    const full = this._xde0ComplianceFrameworks.filter(f => f.status === 'compliant').length;
    const mostly = this._xde0ComplianceFrameworks.filter(f => f.status === 'mostly_compliant').length;
    const avgRate = this._xde0ComplianceFrameworks.reduce((s, f) => s + (f.compliant / f.requirements * 100), 0) / this._xde0ComplianceFrameworks.length;
    return {total: this._xde0ComplianceFrameworks.length, fullyCompliant: full, mostlyCompliant: mostly, avgComplianceRate: Math.round(avgRate * 10) / 10};
  }
  ...
  private _threat_huntiRiskRegister = [
    { id: "RSK-THR-0001", title: "Data breach from unpatched systems", owner: "CTO", category: "Financial", status: "mitigating", trend: "stable", severity: "high", likelihood: 7, impact: 7, treatment: "Monitor and review quarterly", lastReview: "2026-04-18", nextReview: "2026-07-14" },
    { id: "RSK-THR-0002", title: "Ransomware attack on critical infrastructure", owner: "CRO", category: "Strategic", status: "closed", trend: "decreasing", severity: "high", likelihood: 7, impact: 4, treatment: "Monitor and review quarterly", lastReview: "2026-04-03", nextReview: "2026-07-03" },
    { id: "RSK-THR-0003", title: "Insider threat data exfiltration", owner: "VP Eng", category: "Compliance", status: "accepted", trend: "increasing", severity: "low", likelihood: 10, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-18", nextReview: "2026-07-25" },
    { id: "RSK-THR-0004", title: "Supply chain compromise", owner: "Security Lead", category: "Technical", status: "open", trend: "stable", severity: "low", likelihood: 10, impact: 5, treatment: "Monitor and review quarterly", lastReview: "2026-04-22", nextReview: "2026-07-26" },
    { id: "RSK-THR-0005", title: "Cloud misconfiguration exposure", owner: "Risk Mgr", category: "Reputational", status: "mitigating", trend: "decreasing", severity: "low", likelihood: 1, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-10", nextReview: "2026-07-07" },
    { id: "RSK-THR-0006", title: "Phishing campaign success rate", owner: "Compliance Dir", category: "Legal", status: "closed", trend: "increasing", severity: "low", likelihood: 6, impact: 6, treatment: "Monitor and review quarterly", lastReview: "2026-04-16", nextReview: "2026-07-12" },
    { id: "RSK-THR-0007", title: "Third-party vendor data breach", owner: "IT Dir", category: "Regulatory", status: "accepted", trend: "stable", severity: "critical", likelihood: 7, impact: 6, treatment: "Monitor and review quarterly", lastReview: "2026-04-07", nextReview: "2026-07-24" },
    { id: "RSK-THR-0008", title: "Regulatory non-compliance penalty", owner: "DevOps Lead", category: "Third-Party", status: "open", trend: "decreasing", severity: "high", likelihood: 6, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-18", nextReview: "2026-07-22" },
    { id: "RSK-THR-0009", title: "Zero-day exploit in production", owner: "Architect", category: "Human Capital", status: "mitigating", trend: "increasing", severity: "high", likelihood: 9, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-19", nextReview: "2026-07-10" },
    { id: "RSK-THR-0010", title: "Insufficient access controls", owner: "CISO", category: "Operational", status: "closed", trend: "stable", severity: "critical", likelihood: 4, impact: 2, treatment: "Monitor and review quarterly", lastReview: "2026-04-17", nextReview: "2026-07-03" },
    { id: "RSK-THR-0011", title: "DDoS attack on services", owner: "CTO", category: "Financial", status: "accepted", trend: "decreasing", severity: "medium", likelihood: 8, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-04", nextReview: "2026-07-19" },
    { id: "RSK-THR-0012", title: "Social engineering attack", owner: "CRO", category: "Strategic", status: "open", trend: "increasing", severity: "critical", likelihood: 10, impact: 6, treatment: "Monitor and review quarterly", lastReview: "2026-04-17", nextReview: "2026-07-05" },
    { id: "RSK-THR-0013", title: "API security vulnerability", owner: "VP Eng", category: "Compliance", status: "mitigating", trend: "stable", severity: "low", likelihood: 10, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-10", nextReview: "2026-07-04" },
    { id: "RSK-THR-0014", title: "Mobile device compromise", owner: "Security Lead", category: "Technical", status: "closed", trend: "decreasing", severity: "critical", likelihood: 3, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-04", nextReview: "2026-07-06" },
    { id: "RSK-THR-0015", title: "Physical security breach", owner: "Risk Mgr", category: "Reputational", status: "accepted", trend: "increasing", severity: "low", likelihood: 5, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-04", nextReview: "2026-07-20" },
    { id: "RSK-THR-0016", title: "Password policy weakness", owner: "Compliance Dir", category: "Legal", status: "open", trend: "stable", severity: "medium", likelihood: 2, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-07", nextReview: "2026-07-09" },
    { id: "RSK-THR-0017", title: "Network segmentation gap", owner: "IT Dir", category: "Regulatory", status: "mitigating", trend: "decreasing", severity: "critical", likelihood: 1, impact: 6, treatment: "Monitor and review quarterly", lastReview: "2026-04-10", nextReview: "2026-07-21" },
    { id: "RSK-THR-0018", title: "Encryption key management failure", owner: "DevOps Lead", category: "Third-Party", status: "closed", trend: "increasing", severity: "medium", likelihood: 4, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-09", nextReview: "2026-07-10" },
    { id: "RSK-THR-0019", title: "Audit trail tampering", owner: "Architect", category: "Human Capital", status: "accepted", trend: "stable", severity: "medium", likelihood: 1, impact: 2, treatment: "Monitor and review quarterly", lastReview: "2026-04-20", nextReview: "2026-07-25" },
    { id: "RSK-THR-0020", title: "Business email compromise", owner: "CISO", category: "Operational", status: "open", trend: "decreasing", severity: "high", likelihood: 8, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-16", nextReview: "2026-07-08" },
  ];
  ...
  private _threat_huntiApiEndpoints = [
    { method: "GET", path: "/api/v1/threats", name: "Threat Intelligence Feed", status: "active", avgLatency: 201.6, reqPerMin: 1156.0, errorRate: 0.53, uptime: round(98.18753521798098,2), version: "v2.8.9" },
    { method: "POST", path: "/api/v1/scans/start", name: "Vulnerability Scanner", status: "active", avgLatency: 296.5, reqPerMin: 1484.0, errorRate: 2.04, uptime: round(95.36311584178932,2), version: "v1.0.11" },
    { method: "GET", path: "/api/v1/assets", name: "Asset Inventory", status: "active", avgLatency: 226.4, reqPerMin: 1029.0, errorRate: 0.77, uptime: round(96.99473762307478,2), version: "v1.5.2" },
    { method: "POST", path: "/api/v1/alerts", name: "Alert Management", status: "active", avgLatency: 52.1, reqPerMin: 2311.0, errorRate: 0.63, uptime: round(98.56581359890247,2), version: "v3.7.6" },
    { method: "GET", path: "/api/v1/compliance", name: "Compliance Status", status: "active", avgLatency: 221.1, reqPerMin: 1875.0, errorRate: 0.08, uptime: round(98.1104004570623,2), version: "v2.9.13" },
    { method: "PUT", path: "/api/v1/policies", name: "Policy Engine", status: "active", avgLatency: 366.9, reqPerMin: 123.0, errorRate: 1.45, uptime: round(99.3012684403064,2), version: "v2.4.13" },
    { method: "GET", path: "/api/v1/incidents", name: "Incident Tracker", status: "active", avgLatency: 358.3, reqPerMin: 343.0, errorRate: 1.84, uptime: round(98.2588985733078,2), version: "v3.7.1" },
    { method: "POST", path: "/api/v1/forensics", name: "Forensics Collector", status: "degraded", avgLatency: 63.8, reqPerMin: 418.0, errorRate: 2.24, uptime: round(98.37246614346051,2), version: "v2.6.3" },
    { method: "GET", path: "/api/v1/risk/assess", name: "Risk Assessment", status: "active", avgLatency: 135.6, reqPerMin: 1425.0, errorRate: 0.02, uptime: round(98.49961648264909,2), version: "v3.0.8" },
    { method: "POST", path: "/api/v1/auth/verify", name: "Authentication", status: "active", avgLatency: 442.6, reqPerMin: 1344.0, errorRate: 1.62, uptime: round(97.49868642633238,2), version: "v1.6.5" },
    { method: "GET", path: "/api/v1/logs/audit", name: "Audit Log Query", status: "active", avgLatency: 410.7, reqPerMin: 1627.0, errorRate: 2.28, uptime: round(97.03960322047011,2), version: "v1.4.8" },
    { method: "PUT", path: "/api/v1/users/roles", name: "Role Management", status: "active", avgLatency: 368.8, reqPerMin: 660.0, errorRate: 2.22, uptime: round(95.12557610029573,2), version: "v3.0.5" },
    { method: "POST", path: "/api/v1/encrypt", name: "Encryption Service", status: "active", avgLatency: 38.5, reqPerMin: 165.0, errorRate: 0.42, uptime: round(98.00642476370864,2), version: "v3.2.0" },
    { method: "GET", path: "/api/v1/network/topo", name: "Network Topology", status: "maintenance", avgLatency: 245.1, reqPerMin: 938.0, errorRate: 0.53, uptime: round(97.24825516211604,2), version: "v3.1.17" },
    { method: "DELETE", path: "/api/v1/sessions", name: "Session Manager", status: "active", avgLatency: 202.0, reqPerMin: 391.0, errorRate: 1.16, uptime: round(95.12751870328188,2), version: "v1.6.3" },
  ];
  private _threat_huntiApiKeys = [
    { id: "ak-000001", name: "key-thre-001", created: "2026-03-05", lastUsed: "2026-04-19", status: "active", calls: 39197, rateLimit: 100 },
    { id: "ak-000002", name: "key-thre-002", created: "2026-04-11", lastUsed: "2026-04-17", status: "revoked", calls: 46592, rateLimit: 5000 },
    { id: "ak-000003", name: "key-thre-003", created: "2026-03-28", lastUsed: "2026-04-17", status: "revoked", calls: 35238, rateLimit: 100 },
    { id: "ak-000004", name: "key-thre-004", created: "2026-06-12", lastUsed: "2026-04-15", status: "active", calls: 27422, rateLimit: 1000 },
    { id: "ak-000005", name: "key-thre-005", created: "2026-09-08", lastUsed: "2026-04-21", status: "revoked", calls: 22704, rateLimit: 5000 },
    { id: "ak-000006", name: "key-thre-006", created: "2026-05-08", lastUsed: "2026-04-03", status: "active", calls: 14937, rateLimit: 5000 },
    { id: "ak-000007", name: "key-thre-007", created: "2026-05-17", lastUsed: "2026-04-16", status: "active", calls: 28970, rateLimit: 500 },
    { id: "ak-000008", name: "key-thre-008", created: "2026-08-23", lastUsed: "2026-04-10", status: "revoked", calls: 13181, rateLimit: 5000 },
  ];
  ...
  private _threat_huntiTrainingModules = [
    { id: "TRN-001", name: "Security Fundamentals", completionRate: 74.2, avgScore: 66.3, behaviorChange: 50.1, enrolled: 419, completed: 128, duration: "83min", category: "mandatory" },
    { id: "TRN-002", name: "Phishing Awareness", completionRate: 66.7, avgScore: 57.4, behaviorChange: 73.7, enrolled: 338, completed: 399, duration: "41min", category: "mandatory" },
    { id: "TRN-003", name: "Social Engineering Defense", completionRate: 59.8, avgScore: 76.2, behaviorChange: 45.9, enrolled: 353, completed: 116, duration: "91min", category: "optional" },
    { id: "TRN-004", name: "Password Hygiene", completionRate: 46.6, avgScore: 58.8, behaviorChange: 81.5, enrolled: 487, completed: 134, duration: "78min", category: "mandatory" },
    { id: "TRN-005", name: "Data Classification", completionRate: 89.8, avgScore: 75.4, behaviorChange: 70.0, enrolled: 216, completed: 402, duration: "105min", category: "mandatory" },
    { id: "TRN-006", name: "Incident Response Basics", completionRate: 89.1, avgScore: 68.9, behaviorChange: 86.3, enrolled: 114, completed: 115, duration: "30min", category: "mandatory" },
    { id: "TRN-007", name: "Secure Coding", completionRate: 62.4, avgScore: 73.6, behaviorChange: 33.7, enrolled: 67, completed: 367, duration: "111min", category: "optional" },
    { id: "TRN-008", name: "Cloud Security", completionRate: 49.6, avgScore: 58.3, behaviorChange: 56.7, enrolled: 371, completed: 25, duration: "50min", category: "mandatory" },
    { id: "TRN-009", name: "Mobile Device Security", completionRate: 82.1, avgScore: 71.5, behaviorChange: 53.1, enrolled: 309, completed: 164, duration: "56min", category: "mandatory" },
    { id: "TRN-010", name: "Network Security", completionRate: 79.4, avgScore: 64.4, behaviorChange: 64.9, enrolled: 351, completed: 448, duration: "35min", category: "mandatory" },
    { id: "TRN-011", name: "Physical Security", completionRate: 52.2, avgScore: 75.4, behaviorChange: 66.5, enrolled: 464, completed: 62, duration: "83min", category: "optional" },
    { id: "TRN-012", name: "Regulatory Compliance", completionRate: 90.5, avgScore: 89.5, behaviorChange: 57.6, enrolled: 87, completed: 174, duration: "73min", category: "mandatory" },
    { id: "TRN-013", name: "Risk Management", completionRate: 64.3, avgScore: 78.9, behaviorChange: 58.1, enrolled: 168, completed: 283, duration: "75min", category: "mandatory" },
    { id: "TRN-014", name: "Cryptography Basics", completionRate: 72.2, avgScore: 84.9, behaviorChange: 76.9, enrolled: 177, completed: 67, duration: "38min", category: "mandatory" },
    { id: "TRN-015", name: "Access Control", completionRate: 92.1, avgScore: 58.3, behaviorChange: 51.2, enrolled: 136, completed: 39, duration: "97min", category: "optional" },
    { id: "TRN-016", name: "Vendor Management", completionRate: 50.9, avgScore: 69.4, behaviorChange: 54.7, enrolled: 340, completed: 165, duration: "87min", category: "mandatory" },
  ];
  private _threat_huntiPhishingResults = [
    { month: "2026-01", sent: 316, clicked: 5, reported: 93, clickRate: round(1.5822784810126582,1), reportRate: round(29.430379746835445,1) },
    { month: "2026-02", sent: 234, clicked: 20, reported: 95, clickRate: round(8.547008547008547,1), reportRate: round(40.598290598290596,1) },
    { month: "2026-03", sent: 698, clicked: 131, reported: 47, clickRate: round(18.76790830945559,1), reportRate: round(6.73352435530086,1) },
    { month: "2026-04", sent: 537, clicked: 62, reported: 250, clickRate: round(11.54562383612663,1), reportRate: round(46.55493482309125,1) },
    { month: "2026-05", sent: 598, clicked: 83, reported: 50, clickRate: round(13.879598662207357,1), reportRate: round(8.361204013377927,1) },
    { month: "2026-06", sent: 540, clicked: 124, reported: 91, clickRate: round(22.962962962962962,1), reportRate: round(16.85185185185185,1) },
  ];
  private _threat_huntiTrainingROI = { totalInvestment: 195201, avgCostPerEmployee: 301, riskReductionPct: round(random.uniform(15,45),1), incidentReductionPct: round(random.uniform(10,35),1), complianceScoreGain: round(random.uniform(5,25),1) };
  private _threat_huntiLearningPaths = [
    { name: "Beginner Security Analyst", totalModules: 15, completedModules: 6, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 68, enrolled: 124 },
    { name: "Advanced Threat Hunter", totalModules: 18, completedModules: 16, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 54, enrolled: 107 },
    { name: "Security Architect", totalModules: 19, completedModules: 10, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 22, enrolled: 112 },
    { name: "Incident Responder", totalModules: 20, completedModules: 13, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 70, enrolled: 128 },
    { name: "Compliance Specialist", totalModules: 18, completedModules: 6, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 24, enrolled: 82 },
    { name: "DevSecOps Engineer", totalModules: 10, completedModules: 15, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 11, enrolled: 131 },
  ];
  ...
  private _threat_huntiGovBodies = [
    { name: "Security Steering Committee", members: 13, chair: "CISO", meetingFreq: "Weekly", lastMeeting: "2026-04-16", nextMeeting: "2026-05-08", quorum: 8 },
    { name: "Risk Management Board", members: 12, chair: "CTO", meetingFreq: "Bi-weekly", lastMeeting: "2026-04-21", nextMeeting: "2026-05-11", quorum: 7 },
    { name: "Data Governance Council", members: 10, chair: "CRO", meetingFreq: "Monthly", lastMeeting: "2026-04-14", nextMeeting: "2026-05-19", quorum: 8 },
    { name: "Compliance Oversight Board", members: 12, chair: "CDO", meetingFreq: "Monthly", lastMeeting: "2026-04-13", nextMeeting: "2026-05-21", quorum: 8 },
    { name: "Architecture Review Board", members: 13, chair: "VP Eng", meetingFreq: "Bi-weekly", lastMeeting: "2026-04-08", nextMeeting: "2026-05-01", quorum: 6 },
    { name: "Change Advisory Board", members: 10, chair: "CISO", meetingFreq: "Weekly", lastMeeting: "2026-04-18", nextMeeting: "2026-05-20", quorum: 5 },
    { name: "Incident Review Board", members: 6, chair: "CIO", meetingFreq: "As needed", lastMeeting: "2026-04-15", nextMeeting: "2026-05-12", quorum: 6 },
    { name: "Vendor Risk Committee", members: 14, chair: "CFO", meetingFreq: "Quarterly", lastMeeting: "2026-04-21", nextMeeting: "2026-05-20", quorum: 6 },
  ];
  private _threat_huntiDecisions = [
    ...
    { id: "DEC-0002", title: "Migrate to SIEM 2.0 platform", date: "2026-01-17", status: "implemented", owner: "CTO" },
    ...
    { id: "DEC-0005", title: "Establish bug bounty program", date: "2026-03-19", status: "approved", owner: "VP Eng" },
    ...
    { id: "DEC-0010", title: "Migrate to passwordless authentication", date: "2026-02-03", status: "approved", owner: "VP Eng" },
  ];
  private _threat_huntiPolicyLifecycle = [
    { name: "Information Security Policy", version: "v3.5", status: "active", lastUpdated: "2026-03-24", nextReview: "2026-9-22", owner: "CISO" },
    { name: "Acceptable Use Policy", version: "v3.4", status: "active", lastUpdated: "2026-02-03", nextReview: "2026-7-01", owner: "Legal" },
    { name: "Data Retention Policy", version: "v4.3", status: "under-review", lastUpdated: "2026-04-22", nextReview: "2026-10-03", owner: "DPO" },
    { name: "Access Control Policy", version: "v2.3", status: "active", lastUpdated: "2026-04-17", nextReview: "2026-8-21", owner: "IAM Lead" },
    { name: "Incident Response Policy", version: "v2.4", status: "draft", lastUpdated: "2026-04-11", nextReview: "2026-10-10", owner: "IR Lead" },
    { name: "Business Continuity Plan", version: "v3.2", status: "active", lastUpdated: "2026-01-08", nextReview: "2026-12-19", owner: "BCP Mgr" },
    { name: "Vendor Management Policy", version: "v2.0", status: "active", lastUpdated: "2026-02-09", nextReview: "2026-12-10", owner: "Procurement" },
    { name: "Encryption Standard", version: "v1.2", status: "under-review", lastUpdated: "2026-03-06", nextReview: "2026-12-27", owner: "Security Arch" },
  ];
  private _threat_huntiGovMaturityScore = { overall: 3.4, riskManagement: 2.4, compliance: 3.7, incidentResponse: 2.1, awareness: 4.4, technology: 2.5 };
  ...
  private _threat_huntiInnoProjects = [
    { id: "INN-001", name: "AI-Powered Threat Detection", description: "Machine learning models for real-time threat identification", status: "active", progress: 72, startDate: "2026-03-08", teamSize: 4, budget: 28710, milestones: 6, completedMilestones: 5 },
    { id: "INN-002", name: "Quantum-Resistant Cryptography", description: "Post-quantum encryption algorithm prototyping", status: "research", progress: 35, startDate: "2026-02-28", teamSize: 8, budget: 167372, milestones: 6, completedMilestones: 8 },
    { id: "INN-003", name: "Automated Red Teaming", description: "Autonomous penetration testing framework", status: "active", progress: 58, startDate: "2026-02-25", teamSize: 2, budget: 114233, milestones: 10, completedMilestones: 7 },
    { id: "INN-004", name: "Zero-Knowledge Authentication", description: "Privacy-preserving identity verification", status: "poc", progress: 88, startDate: "2026-03-28", teamSize: 2, budget: 164107, milestones: 10, completedMilestones: 2 },
    { id: "INN-005", name: "Blockchain Audit Trail", description: "Immutable security event logging", status: "active", progress: 45, startDate: "2026-03-19", teamSize: 2, budget: 157466, milestones: 3, completedMilestones: 6 },
    { id: "INN-006", name: "Behavioral Biometrics", description: "Continuous authentication via user behavior patterns", status: "research", progress: 22, startDate: "2026-01-12", teamSize: 6, budget: 39710, milestones: 8, completedMilestones: 2 },
    { id: "INN-007", name: "Deception Grid 2.0", description: "Advanced honeypot network with adaptive responses", status: "active", progress: 65, startDate: "2026-02-11", teamSize: 2, budget: 158637, milestones: 3, completedMilestones: 8 },
    { id: "INN-008", name: "Secure Enclave Integration", description: "Hardware-backed security for critical workloads", status: "poc", progress: 40, startDate: "2026-02-13", teamSize: 7, budget: 197054, milestones: 8, completedMilestones: 9 },
  ];
  private _threat_huntiTechEvaluations = [
    { name: "Rust for Security Tools", status: "evaluating", score: 8.3, recommendation: "Adopt", vendor: "Open Source" },
    ...
    { name: "Homomorphic Encryption", status: "evaluating", score: 6.4, recommendation: "Pilot", vendor: "GCP" },
    { name: "SASE Architecture", status: "completed", score: 5.8, recommendation: "Adopt", vendor: "Multiple" },
    { name: "SOAR Platform 3.0", status: "planned", score: 10.5, recommendation: "Monitor", vendor: "Splunk" },
  ];
  ...
  private _threat_huntiInnoMetrics = { totalProjects: 8, activeProjects: 4, avgTimeToValue: "87 days", pocSuccessRate: round(random.uniform(55,85),1), researchToProduction: round(random.uniform(20,50),1), innovationIndex: round(random.uniform(6.0,9.5),1) };
  ...
  private _threat_huntiComplianceFrameworks = [
    { name: "SOC 2 Type II", description: "Trust Services Criteria", totalControls: 5, implementedControls: 4, status: "compliant", lastAudit: "2026-03-14", nextAudit: "2026-10-07", evidenceCount: 386 },
    { name: "ISO 27001", description: "Information Security Management", totalControls: 114, implementedControls: 68, status: "non-compliant", lastAudit: "2026-03-08", nextAudit: "2026-12-12", evidenceCount: 373 },
    { name: "PCI DSS 4.0", description: "Payment Card Industry", totalControls: 12, implementedControls: 12, status: "non-compliant", lastAudit: "2026-04-14", nextAudit: "2026-10-10", evidenceCount: 204 },
    { name: "HIPAA", description: "Health Insurance Portability", totalControls: 18, implementedControls: 15, status: "in-review", lastAudit: "2026-02-19", nextAudit: "2026-11-12", evidenceCount: 233 },
    { name: "GDPR", description: "Data Protection Regulation", totalControls: 99, implementedControls: 58, status: "in-review", lastAudit: "2026-04-18", nextAudit: "2026-9-11", evidenceCount: 334 },
    { name: "NIST CSF 2.0", description: "Cybersecurity Framework", totalControls: 6, implementedControls: 3, status: "partially-compliant", lastAudit: "2026-03-07", nextAudit: "2026-12-07", evidenceCount: 91 },
    { name: "FedRAMP", description: "Federal Risk Authorization", totalControls: 15, implementedControls: 8, status: "partially-compliant", lastAudit: "2026-02-16", nextAudit: "2026-9-27", evidenceCount: 230 },
    { name: "SOX", description: "Sarbanes-Oxley Compliance", totalControls: 8, implementedControls: 7, status: "non-compliant", lastAudit: "2026-04-08", nextAudit: "2026-8-26", evidenceCount: 233 },
    { name: "CIS Controls v8", description: "Center for Internet Security", totalControls: 18, implementedControls: 18, status: "partially-compliant", lastAudit: "2026-01-05", nextAudit: "2026-10-03", evidenceCount: 459 },
    { name: "COBIT 2019", description: "IT Governance Framework", totalControls: 40, implementedControls: 34, status: "compliant", lastAudit: "2026-01-22", nextAudit: "2026-7-16", evidenceCount: 412 },
  ];
  ...
  private _threat_huntiAuditTrail = [
    { id: "AUD-0001", action: "Control tested", auditor: "Internal Audit", date: "2026-04-03", result: "pass", findings: 1 },
    { id: "AUD-0002", action: "Evidence collected", auditor: "External Auditor", date: "2026-04-05", result: "pass", findings: 3 },
    { id: "AUD-0003", action: "Gap identified", auditor: "Security Team", date: "2026-04-08", result: "fail", findings: 2 },
    { id: "AUD-0004", action: "Remediation completed", auditor: "Compliance Officer", date: "2026-04-10", result: "pass", findings: 3 },
    { id: "AUD-0005", action: "Policy updated", auditor: "IT Audit", date: "2026-04-13", result: "pass", findings: 5 },
    ...
    { id: "AUD-0009", action: "Risk accepted", auditor: "Board Audit", date: "2026-04-04", result: "pass", findings: 3 },
    { id: "AUD-0010", action: "Control enhanced", auditor: "Third Party", date: "2026-04-12", result: "pass", findings: 2 },
  ];

  // === Threat Intelligence Feed Extension (threat_hunti) ===
  private _threat_huntiThreatActors = [
    { name: "APT-29", alias: "Cozy Bear", origin: "Russia", type: "Nation-State", severity: "high", lastActivity: "2026-04-23", targets: "Government", indicators: 91, ttps: 18 },
    { name: "APT-41", alias: "Double Dragon", origin: "China", type: "Nation-State", severity: "critical", lastActivity: "2026-04-08", targets: "Energy", indicators: 245, ttps: 11 },
    { name: "Lazarus Group", alias: "Hidden Cobra", origin: "North Korea", type: "Nation-State", severity: "critical", lastActivity: "2026-04-14", targets: "Manufacturing", indicators: 359, ttps: 14 },
    { name: "FIN7", alias: "Carbanak", origin: "Eastern Europe", type: "Financial", severity: "high", lastActivity: "2026-04-04", targets: "Technology", indicators: 22, ttps: 31 },
    { name: "Conti", alias: "Wizard Spider", origin: "Russia", type: "Ransomware", severity: "critical", lastActivity: "2026-04-13", targets: "Government", indicators: 493, ttps: 36 },
    { name: "LockBit", alias: "LockBit Gang", origin: "Unknown", type: "Ransomware", severity: "high", lastActivity: "2026-04-10", targets: "Manufacturing", indicators: 30, ttps: 46 },
    { name: "Cl0p", alias: "Cl0p Team", origin: "Unknown", type: "Ransomware", severity: "high", lastActivity: "2026-04-09", targets: "Government", indicators: 308, ttps: 6 },
    { name: "Sandworm", alias: "Unit 74455", origin: "Russia", type: "Nation-State", severity: "critical", lastActivity: "2026-04-11", targets: "Technology", indicators: 135, ttps: 27 },
  ];
  private _threat_huntiIoCFeed = [
    { id: "ioc-000001", type: "ip", value: "175.112.249.99", confidence: 55, source: "VirusTotal", firstSeen: "2026-04-20", lastSeen: "2026-04-15" },
    { id: "ioc-000002", type: "ip", value: "78.41.217.171", confidence: 80, source: "VirusTotal", firstSeen: "2026-04-11", lastSeen: "2026-04-04" },
    { id: "ioc-000003", type: "ip", value: "172.80.122.119", confidence: 95, source: "VirusTotal", firstSeen: "2026-04-11", lastSeen: "2026-04-09" },
    { id: "ioc-000004", type: "ip", value: "155.80.204.54", confidence: 91, source: "Mandiant", firstSeen: "2026-04-23", lastSeen: "2026-04-06" },
    { id: "ioc-000005", type: "ip", value: "2.195.190.116", confidence: 50, source: "AlienVault", firstSeen: "2026-04-14", lastSeen: "2026-04-16" },
    { id: "ioc-000006", type: "ip", value: "248.46.92.65", confidence: 86, source: "Mandiant", firstSeen: "2026-04-01", lastSeen: "2026-04-08" },
    { id: "ioc-000007", type: "ip", value: "12.125.123.149", confidence: 84, source: "MISP", firstSeen: "2026-04-06", lastSeen: "2026-04-14" },
    { id: "ioc-000008", type: "ip", value: "221.125.10.193", confidence: 60, source: "Mandiant", firstSeen: "2026-04-20", lastSeen: "2026-04-01" },
    { id: "ioc-000009", type: "ip", value: "38.123.254.125", confidence: 61, source: "CrowdStrike", firstSeen: "2026-04-07", lastSeen: "2026-04-13" },
    { id: "ioc-000010", type: "ip", value: "42.143.241.145", confidence: 97, source: "STIX", firstSeen: "2026-04-16", lastSeen: "2026-04-08" },
    { id: "ioc-000011", type: "ip", value: "167.176.0.155", confidence: 46, source: "Mandiant", firstSeen: "2026-04-03", lastSeen: "2026-04-23" },
    { id: "ioc-000012", type: "ip", value: "119.91.137.27", confidence: 97, source: "VirusTotal", firstSeen: "2026-04-23", lastSeen: "2026-04-23" },
    { id: "ioc-000013", type: "ip", value: "113.34.1.223", confidence: 99, source: "CrowdStrike", firstSeen: "2026-04-21", lastSeen: "2026-04-07" },
    { id: "ioc-000014", type: "ip", value: "24.59.40.1", confidence: 60, source: "Mandiant", firstSeen: "2026-04-09", lastSeen: "2026-04-20" },
    { id: "ioc-000015", type: "ip", value: "55.123.7.120", confidence: 92, source: "AlienVault", firstSeen: "2026-04-13", lastSeen: "2026-04-08" },
  ];
  ...
  private _threat_huntiIncidents = [
    { id: "INC-20260001", title: "Unauthorized access detected", severity: "critical", status: "open", assignedTo: "SOC L1", detectedAt: "2026-04-16T10:23", affectedAssets: 28, rootCause: "Misconfiguration" },
    { id: "INC-20260002", title: "Malware outbreak on workstation", severity: "high", status: "investigating", assignedTo: "SOC L2", detectedAt: "2026-04-17T17:10", affectedAssets: 25, rootCause: "Credential compromise" },
    { id: "INC-20260003", title: "Data leak from S3 bucket", severity: "medium", status: "contained", assignedTo: "IR Lead", detectedAt: "2026-04-21T03:02", affectedAssets: 40, rootCause: "Zero-day" },
    { id: "INC-20260004", title: "Phishing campaign targeting finance", severity: "low", status: "eradicated", assignedTo: "CISO", detectedAt: "2026-04-20T11:20", affectedAssets: 14, rootCause: "Human error" },
    { id: "INC-20260005", title: "DDoS attack on web services", severity: "critical", status: "recovered", assignedTo: "Security Eng", detectedAt: "2026-04-03T16:55", affectedAssets: 42, rootCause: "Policy violation" },
    { id: "INC-20260006", title: "Ransomware encryption attempt", severity: "high", status: "closed", assignedTo: "Forensics", detectedAt: "2026-04-05T18:46", affectedAssets: 29, rootCause: "Unknown" },
    { id: "INC-20260007", title: "Insider data exfiltration", severity: "medium", status: "open", assignedTo: "SOC L1", detectedAt: "2026-04-02T00:53", affectedAssets: 49, rootCause: "Misconfiguration" },
    { id: "INC-20260008", title: "API key exposure in repo", severity: "low", status: "investigating", assignedTo: "SOC L2", detectedAt: "2026-04-21T23:07", affectedAssets: 47, rootCause: "Credential compromise" },
    { id: "INC-20260009", title: "SQL injection on portal", severity: "critical", status: "contained", assignedTo: "IR Lead", detectedAt: "2026-04-02T09:03", affectedAssets: 23, rootCause: "Zero-day" },
    { id: "INC-20260010", title: "Brute force on VPN", severity: "high", status: "eradicated", assignedTo: "CISO", detectedAt: "2026-04-04T10:58", affectedAssets: 13, rootCause: "Human error" },
    { id: "INC-20260011", title: "Supply chain alert from vendor", severity: "medium", status: "recovered", assignedTo: "Security Eng", detectedAt: "2026-04-23T22:34", affectedAssets: 22, rootCause: "Policy violation" },
    { id: "INC-20260012", title: "Suspicious lateral movement", severity: "low", status: "closed", assignedTo: "Forensics", detectedAt: "2026-04-09T18:24", affectedAssets: 20, rootCause: "Unknown" },
  ];
  private _threat_huntiGetIncidentStats() {
    const inc = this._threat_huntiIncidents;
    return { total: inc.length, open: inc.filter(i=>i.status==="open").length, investigating: inc.filter(i=>i.status==="investigating").length, mttd: 22, mttr: 164 };
  }
  ...
  render() {    if (this._thRules.length === 0) { this._initThRules(); this._initThCvss(); this._runThAnomalyDetection(); this._generateThPredictions(); this._initThApprovals(); this._initThActivity(); this._initThNotifications(); }
...
<div class="tabs">
        ...
        ${this._activeTab === 'rules' ? html`
          ...
          <div style="background:#1a1d27;border-radius:8px;padding:12px">${this._renderThTreemapSVG()}</div>
          <div style="margin-top:12px;font-size:11px;font-weight:600;margin-bottom:6px">Data Flow (Sankey)</div>
          <div style="background:#1a1d27;border-radius:8px;padding:12px">${this._renderThSankeySVG()}</div>
          ${this._renderThActivity()}
        ` : nothing}
        ${this._activeTab === 'anomalies' ? html`
          ${this._renderThAnomalies()}
          ${this._renderThNotifications()}
        ` : nothing}
        ${this._activeTab === 'predictions' ? html`
          ${this._renderThPredictions()}
          ...
          <div style="background:#1a1d27;border-radius:8px;padding:12px">
            <table class="history-table"><thead><tr><th>ID</th><th>Base</th><th>Temporal</th><th>Environmental</th><th>Overall</th></tr></thead><tbody>
              ${this._thcvssData.map(c => html`<tr><td>${c.itemId}</td><td style="color:${c.base >= 7 ? '#ef4444' : c.base >= 4 ? '#eab308' : '#22c55e'}">${c.base}</td><td>${c.temporal}</td><td>${c.environmental}</td><td style="font-weight:700;color:${c.overall >= 7 ? '#ef4444' : c.overall >= 4 ? '#eab308' : '#22c55e'}">${c.overall}</td></tr>`)}
            </tbody></table>
          </div>
        ` : nothing}
        ${this._activeTab === 'approvals' ? html`
          ${this._renderThApprovals()}
        ` : nothing}
        ${this._activeTab === 'config' ? html`
          ${this._renderThConfig()}
        ` : nothing}
        ${this._activeTab === 'new' ? html`
          <div class="form-section">
            <div class="form-title">Create New Threat Hunting Entry</div>
            <div class="form-grid">
  ...
  @state() private _thScenarios: {id:string;name:string;attackType:string;target:string;method:string;impactLow:number;impactHigh:number;confidence:number;mitigation:string;status:string}[] = [];
  @state() private _thScenarioForm: {attackType:string;target:string;method:string} = {attackType:'',target:'',method:''};
  @state() private _thScenarioCompare: boolean = false;
  @state() private _thScenarioSelected: string[] = [];

  private _thInitScenarios(): void {
    const saved = localStorage.getItem('th_scenarios');
    if (saved) { try { this._thScenarios = JSON.parse(saved); } catch { /* ignore */ } }
    if (this._thScenarios.length === 0) {
      this._thScenarios = [
        {id:'th-s1',name:'Baseline Threat',attackType:'Phishing',target:'Employees',method:'Spear Email',impactLow:45,impactHigh:78,confidence:72,mitigation:'Security awareness training + email filtering',status:'active'},
        {id:'th-s2',name:'Escalated Attack',attackType:'Ransomware',target:'Endpoints',method:'Drive-by Download',impactLow:65,impactHigh:95,confidence:58,mitigation:'EDR deployment + network segmentation',status:'saved'},
        {id:'th-s3',name:'Insider Threat',attackType:'Data Exfiltration',target:'Databases',method:'SQL Injection',impactLow:55,impactHigh:88,confidence:65,mitigation:'DLP policies + query monitoring',status:'draft'},
      ];
    }
  }

  private _thSaveScenarios(): void {
    localStorage.setItem('th_scenarios', JSON.stringify(this._thScenarios));
  }

  private _thAddScenario(): void {
    const f = this._thScenarioForm;
    if (!f.attackType || !f.target) return;
    this._thScenarios = [...this._thScenarios, {
      id: 'th-s' + (this._thScenarios.length + 1),
    ...
    this._thScenarioForm = {attackType:'',target:'',method:''};
    this._thSaveScenarios();
  }

  private _thRenderScenarioEngine(): any {
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <button class="tab" @click=${() => { this._thScenarioCompare = !this._thScenarioCompare; }}>${this._thScenarioCompare ? 'List View' : 'Compare'}</button>
        </div>
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:6px;margin-bottom:10px">
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._thScenarioForm = {...this._thScenarioForm, attackType: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Attack Type</option>
            ${attackTypes.map(a => html`<option value=${a} ${this._thScenarioForm.attackType === a ? 'selected' : ''}>${a}</option>`)}
          </select>
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._thScenarioForm = {...this._thScenarioForm, target: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Target</option>
            ${targets.map(t => html`<option value=${t} ${this._thScenarioForm.target === t ? 'selected' : ''}>${t}</option>`)}
          </select>
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._thScenarioForm = {...this._thScenarioForm, method: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Method</option>
            ${methods.map(m => html`<option value=${m} ${this._thScenarioForm.method === m ? 'selected' : ''}>${m}</option>`)}
          </select>
        </div>
        <button style="background:#3b82f6;border:none;border-radius:4px;padding:4px 12px;color:#fff;font-size:11px;cursor:pointer" @click=${this._thAddScenario}>Run Simulation</button>
      </div>
      ${this._thScenarioCompare && this._thScenarios.length >= 2 ? html`
        <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
          <div style="font-weight:600;font-size:12px;color:#e2e8f0;margin-bottom:8px">Side-by-Side Comparison</div>
          <div style="display:grid;grid-template-columns:repeat(${Math.min(3, this._thScenarios.length)},1fr);gap:8px">
            ${this._thScenarios.slice(0,3).map(s => html`
      ...
      <div style="background:#0f1117;border-radius:8px;padding:12px">
        <div style="font-weight:600;font-size:12px;color:#e2e8f0;margin-bottom:8px">Saved Scenarios (${this._thScenarios.length})</div>
        ${this._thScenarios.map(s => html`
  ...
  @state() private _thTrendData: {day:number;value:number;anomaly:boolean}[] = [];
  @state() private _thTrendZoom: {start:number;end:number} | null = null;
  @state() private _thTrendMA: number = 7;

  private _thInitTrendData(): void {
    ...
    this._thTrendData = data;
  }

  private _thCalcMA(window: number): number[] {
    const result: number[] = [];
    for (let i = 0; i < this._thTrendData.length; i++) {
      const start = Math.max(0, i - window + 1);
      const slice = this._thTrendData.slice(start, i + 1);
      result.push(slice.reduce((s, d) => s + d.value, 0) / slice.length);
    }
    return result;
  }

  private _thGetStats(): {mean:number;median:number;stddev:number;trend:string} {
    const vals = this._thTrendData.map(d => d.value);
    const n = vals.length;
  ...
  private _thRenderTimeSeries(): any {
    const stats = this._thGetStats();
    const filtered = this._thTrendZoom ? this._thTrendData.filter(d => d.day >= this._thTrendZoom.start && d.day <= this._thTrendZoom.end) : this._thTrendData;
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px">
            <button class="tab ${this._thTrendMA === 7 ? 'active' : ''}" @click=${() => { this._thTrendMA = 7; }}>7D MA</button>
            <button class="tab ${this._thTrendMA === 30 ? 'active' : ''}" @click=${() => { this._thTrendMA = 30; }}>30D MA</button>
            <button class="tab" @click=${() => { this._thTrendZoom = null; }}>Reset Zoom</button>
          </div>
        </div>
        <div style="position:relative;height:120px;background:#1a1d2e;border-radius:6px;overflow:hidden;margin-bottom:8px;cursor:crosshair" @click=${(e: any) => {
          ...
          this._thTrendZoom = { start: Math.max(0, center - 10), end: Math.min(89, center + 10) };
        }}>
  ...
  @state() private _thRoles: string[] = ['Admin','Analyst','Operator','Viewer','Auditor'];
  @state() private _thActions: string[] = ['Create','Read','Update','Delete','Export','Approve'];
  @state() private _thPermissions: { [role: string]: { [action: string]: boolean } } = {};
  @state() private _thPermAudit: {role:string;action:string;changedBy:string;timestamp:string;oldVal:boolean;newVal:boolean}[] = [];
  @state() private _thPermCompare: string[] = [];

  private _thInitPermissions(): void {
    ...
    for (const role of this._thRoles) {
      perms[role] = {};
      this._thActions.forEach((a, i) => { perms[role][a] = defaults[role]?.[i] ?? false; });
    }
    this._thPermissions = perms;
  }

  private _thTogglePermission(role: string, action: string): void {
    const old = this._thPermissions[role][action];
    this._thPermissions = {...this._thPermissions, [role]: {...this._thPermissions[role], [action]: !old}};
    this._thPermAudit.unshift({role,action,changedBy:'current_user',timestamp:new Date().toISOString(),oldVal:old,newVal:!old});
  }

  private _thRenderRBAC(): any {
    const compareRoles = this._thPermCompare.map(r => this._thPermissions[r]).filter(Boolean);
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          <span style="font-weight:700;font-size:13px;color:#e2e8f0">RBAC Permission Matrix</span>
          <div style="display:flex;gap:4px">
            ${this._thRoles.map(r => html`
              <button class="tab ${this._thPermCompare.includes(r) ? 'active' : ''}" @click=${() => {
                this._thPermCompare = this._thPermCompare.includes(r) ? this._thPermCompare.filter(x => x !== r) : [...this._thPermCompare, r];
              }}>${r}</button>
            `)}
          </div>
        </div>
          ...
          <table style="width:100%;border-collapse:collapse;font-size:10px">
            <thead>
              <tr>
                ...
                ${this._thActions.map(a => html`<th style="padding:6px;color:#6b7280;border-bottom:1px solid #2a2d3a;text-align:center">${a}</th>`)}
              </tr>
            </thead>
            <tbody>
              ${this._thRoles.map(role => html`
                <tr style="border-bottom:1px solid #1a1d2e">
                  <td style="padding:6px;color:#e2e8f0;font-weight:600">${role}</td>
                  ${this._thActions.map(action => html`
                    <td style="text-align:center;padding:6px">
                      <button style="width:28px;height:20px;border-radius:3px;border:1px solid #2a2d3a;background:${this._thPermissions[role][action] ? '#22c55e' : '#1a1d2e'};cursor:pointer;color:#fff;font-size:10px" @click=${() => this._thTogglePermission(role, action)}>${this._thPermissions[role][action] ? 'Y' : 'N'}</button>
                    </td>
                  `)}
                </tr>
              `)}
        ...
        ${compareRoles.length >= 2 ? html`
          <div style="margin-top:10px;padding:8px;background:#1a1d2e;border-radius:6px">
            <div style="font-size:11px;font-weight:600;color:#e2e8f0;margin-bottom:6px">Role Diff: ${this._thPermCompare.join(' vs ')}</div>
            ${this._thActions.map(action => {
              ...
              return allSame ? nothing : html`
                <div style="display:flex;gap:8px;padding:3px 0;font-size:10px">
                  ...
                  ${compareRoles.map((r, i) => html`<span style="color:${r[action] ? '#22c55e' : '#ef4444'}">${this._thPermCompare[i]}=${r[action] ? 'Y' : 'N'}</span>`)}
                </div>
              `;
            })}
          </div>
        ` : nothing}
        ${this._thPermAudit.length > 0 ? html`
          <div style="margin-top:8px;font-size:9px;color:#6b7280">Recent: ${this._thPermAudit.slice(0,3).map(a => html`<span style="margin-right:8px">${a.role}.${a.action}: ${a.oldVal ? 'Y' : 'N'}->${a.newVal ? 'Y' : 'N'}</span>`)}
        ` : nothing}
      </div>
    `;
  }
  ...
  // === REPORTING SUITE ===
  @state() private _thReportTemplate: string = 'executive';
  @state() private _thReportSchedule: string = 'weekly';
  @state() private _thReportDistList: string[] = ['security-team@company.com','ciso@company.com'];
  @state() private _thReportHistory: {id:string;template:string;generatedAt:string;status:string}[] = [];

  private _thGenerateReport(): void {
    const id = 'rpt-' + Date.now();
    this._thReportHistory.unshift({id,template:this._thReportTemplate,generatedAt:new Date().toISOString(),status:'sent'});
  }

  private _thRenderReporting(): any {
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:8px">
          <div>
            ...
            ${templates.map(t => html`
              <div style="padding:6px;background:${this._thReportTemplate === t.key ? '#1e3a5f' : '#1a1d2e'};border:1px solid ${this._thReportTemplate === t.key ? '#3b82f6' : '#2a2d3a'};border-radius:4px;margin-bottom:4px;cursor:pointer" @click=${() => { this._thReportTemplate = t.key; }}>
          ...
          <div>
            ...
            <div style="display:flex;gap:4px;margin-bottom:8px">
              ${schedules.map(s => html`<button class="tab ${this._thReportSchedule === s.key ? 'active' : ''}" @click=${() => { this._thReportSchedule = s.key; }}>${s.label}</button>`)}
            </div>
            <div style="font-size:10px;color:#6b7280;margin-bottom:4px">Distribution</div>
            <div style="font-size:10px;color:#9ca3af">${this._thReportDistList.map(d => html`<div>${d}</div>`)}</div>
            <div style="margin-top:6px;display:flex;gap:4px">
              <button style="background:#3b82f6;border:none;border-radius:4px;padding:4px 10px;color:#fff;font-size:10px;cursor:pointer" @click=${this._thGenerateReport}>Generate</button>
        ...
        ${this._thReportHistory.length > 0 ? html`
          <div style="border-top:1px solid #2a2d3a;padding-top:8px">
            ...
            ${this._thReportHistory.slice(0,3).map(r => html`
  ...
  @state() private _thHighContrast: boolean = false;
  @state() private _thA11yAnnounce: string = '';
  @state() private _thShortcutsVisible: boolean = false;
  @state() private _thFocusTrap: boolean = false;

  private _thShortcuts: Record<string, string> = {
  ...
  private _thHandleKeydown(e: KeyboardEvent): void {
    if (e.key === 'Escape' && this._thFocusTrap) { this._thFocusTrap = false; this._thAnnounce('Dialog closed'); }
    if (e.ctrlKey && e.shiftKey && e.key === 'H') { e.preventDefault(); this._thHighContrast = !this._thHighContrast; this._thAnnounce('High contrast ' + (this._thHighContrast ? 'enabled' : 'disabled')); }
    if (e.ctrlKey && e.shiftKey && e.key === 'A') { e.preventDefault(); this._thShortcutsVisible = !this._thShortcutsVisible; }
  }

  private _thAnnounce(msg: string): void {
    this._thA11yAnnounce = msg;
    setTimeout(() => { this._thA11yAnnounce = ''; }, 2000);
  }

  private _thRenderAccessibility(): any {
    return html`
      <div role="region" aria-label="Accessibility Controls" style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <button class="tab ${this._thShortcutsVisible ? 'active' : ''}" @click=${() => { this._thShortcutsVisible = !this._thShortcutsVisible; }} aria-expanded=${this._thShortcutsVisible}>Shortcuts</button>
        </div>
        <div style="display:flex;gap:8px;margin-bottom:8px">
          <label style="display:flex;align-items:center;gap:6px;font-size:11px;color:#e2e8f0;cursor:pointer">
            <input type="checkbox" .checked=${this._thHighContrast} @change=${() => { this._thHighContrast = !this._thHighContrast; }} aria-label="Toggle high contrast mode">
            High Contrast
          </label>
        </div>
        ${this._thShortcutsVisible ? html`
          <div role="list" aria-label="Keyboard shortcuts" style="background:#1a1d2e;border-radius:6px;padding:8px">
            ${Object.entries(this._thShortcuts).map(([key, desc]) => html`
        ...
        ` : nothing}
        <div role="status" aria-live="polite" aria-atomic="true" style="position:absolute;left:-9999px">${this._thA11yAnnounce}</div>
      </div>
    `;
  }
  ...
  connectedCallback(): void {
    ...
    this._thInitScenarios();
    this._thInitTrendData();
    this._thInitPermissions();
    document.addEventListener('keydown', this._thHandleKeydown.bind(this));
  }

  disconnectedCallback(): void {
    super.disconnectedCallback();
    document.removeEventListener('keydown', this._thHandleKeydown.bind(this));
  }

  // === TAB INTEGRATION FOR EXTENDED FEATURES ===
  @state() private _thActiveSubTab: string = 'scenario';
  ...
  private _thGetAllSubTabs(): {key:string;label:string}[] {
    return [
  ...
  private _thRenderSubPanel(): any {
    switch (this._thActiveSubTab) {
      case 'scenario': return this._thRenderScenarioEngine();
      case 'timeseries': return this._thRenderTimeSeries();
      case 'rbac': return this._thRenderRBAC();
      case 'reporting': return this._thRenderReporting();
      case 'a11y': return this._thRenderAccessibility();
      default: return nothing;
    }
  }

  private _thRenderTabBar(): any {
    return html`
      <div style="display:flex;gap:4px;margin-bottom:12px;border-bottom:1px solid #2a2d3a;padding-bottom:8px;flex-wrap:wrap" role="tablist" aria-label="Extended panel features">
        ${this._thGetAllSubTabs().map(t => html`
          <button class="tab ${this._thActiveSubTab === t.key ? 'active' : ''}" @click=${() => { this._thActiveSubTab = t.key; }} role="tab" aria-selected=${this._thActiveSubTab === t.key}>${t.label}</button>
        `)}
      </div>
      <div role="tabpanel" aria-labelledby="th-tab-${this._thActiveSubTab}">
        ${this._thRenderSubPanel()}
      </div>
    `;
  }
  ...
  @state() private _soarPlaybooks: Array<{
    ...
    {
      id: 'pb-soar-001', name: 'Threat Hunting Auto Response', status: 'active',
      steps: [
    ...
    {
      id: 'pb-soar-002', name: 'Threat Hunting Investigation Workflow', status: 'active',
      steps: [
    ...
    {
      id: 'pb-soar-003', name: 'Threat Hunting Compliance Scan', status: 'draft',
      steps: [
  ...
  @state() private _thAle: number = 0;
  @state() private _thSroi: number = 0;
  @state() private _thCpi: number = 0;
  @state() private _thBudgetAlloc: number = 0;
  @state() private _thCostBenefit: number = 0;

  // Security Economics Calculator
  private thInitEconomics() {
    this._thAle = Math.round(2850000 + Math.random() * 4500000);
    this._thSroi = Math.round(180 + Math.random() * 320);
    this._thCpi = Math.round(45000 + Math.random() * 120000);
    this._thBudgetAlloc = Math.round(2500000 + Math.random() * 3000000);
    this._thCostBenefit = Math.round(220 + Math.random() * 180);
  }

  private _thCalcAle(): { annual: number; perIncident: number; byCategory: Array<{name: string; value: number}> } {
    const base = this._thAle;
    const categories = [
  ...
  private _thCalcSroi(): Array<{year: number; investment: number; savings: number; roi: number}> {
    const baseInv = this._thSroi * 10000;
  ...
  private _thGetBudgetAlloc(): Array<{category: string; amount: number; pct: number; trend: string}> {
    const total = this._thBudgetAlloc;
    const items = [
  ...
  private _thGetCostBenefit(): Array<{control: string; cost: number; benefit: number; ratio: number; priority: string}> {
    const base = this._thCostBenefit;
    const controls = [
  ...
  private _thRenderEconomics() {
    const ale = this._thCalcAle();
    const roi = this._thCalcSroi();
    const budget = this._thGetBudgetAlloc();
    const cb = this._thGetCostBenefit();
    const cpi = this._thCpi;
  ...
  @state() private _thThreatLevel: any = null;
  @state() private _thEmergingThreats: any = null;
  @state() private _thThreatTrends: any = null;
  @state() private _thSectorRadar: any = null;
  @state() private _thActorActivity: any = null;

  // Threat Landscape Intelligence
  private thInitThreatIntel() {
    this._thThreatLevel = {
  ...
  private _thRenderThreatIntel() {
    const tl = this._thThreatLevel;
    const et = this._thEmergingThreats;
    const sr = this._thSectorRadar;
    const aa = this._thActorActivity;
  ...
  @state() private _thPolicies: any = null;
  @state() private _thExceptions: any = null;
  @state() private _thRiskRegister: any = null;
  @state() private _thMeetings: any = null;
  @state() private _thDeadlines: any = null;

  // Security Governance Dashboard
  private thInitGovernance() {
    this._thPolicies = [
  ...
  private _thRenderGovernance() {
    const policies = this._thPolicies;
    const risks = this._thRiskRegister;
    const deadlines = this._thDeadlines;
  ...
  @state() private _thCriticalAssets: any = null;
  @state() private _thAssetDeps: any = null;
  @state() private _thEolAssets: any = null;
  @state() private _thAssetRisk: any = null;

  // Asset Intelligence
  private thInitAssetIntel() {
    this._thCriticalAssets = [
    ...
    this._thAssetRisk = { critical: 7, high: 23, medium: 45, low: 128, total: 203 };
  }

  private _thRenderAssetIntel() {
    const assets = this._thCriticalAssets;
    const eol = this._thEolAssets;
    const ar = this._thAssetRisk;
  ...
  @state() private _thUserBaseline: any = null;
  @state() private _thAnomalyRules: any = null;
  @state() private _thDataAccess: any = null;
  @state() private _thInsiderRisk: any = null;
  ...
  private thInitInsiderThreat() {
    this._thUserBaseline = [
    ...
    this._thInsiderRisk = { totalUsers: 2847, monitored: 342, flagged: 18, investigated: 5, confirmed: 1 };
  }

  private _thRenderInsiderThreat() {
    const baseline = this._thUserBaseline;
    const rules = this._thAnomalyRules;
    const ir = this._thInsiderRisk;
...
// ===== SECURITY CONTROL TESTING (R22) =====
  ...
  private _renderBudgetPlanning() {
    const budgetData = [
      { category: "Personnel & Training", planned: 3408000, actual: 3632000, utilization: 106.6, q1: "26%", q2: "31%", q3: "29%", q4: "21%" },
      { category: "Tooling & Licensing", planned: 3415000, actual: 3645000, utilization: 106.7, q1: "29%", q2: "20%", q3: "24%", q4: "22%" },
      { category: "Infrastructure Security", planned: 3422000, actual: 3658000, utilization: 106.9, q1: "16%", q2: "25%", q3: "19%", q4: "23%" },
      { category: "Compliance & Audit", planned: 3429000, actual: 3671000, utilization: 107.1, q1: "19%", q2: "30%", q3: "30%", q4: "24%" },
      { category: "Incident Response", planned: 3436000, actual: 3684000, utilization: 107.2, q1: "22%", q2: "35%", q3: "25%", q4: "25%" },
      { category: "Third-Party Assessments", planned: 3443000, actual: 3697000, utilization: 107.4, q1: "25%", q2: "24%", q3: "20%", q4: "10%" },
      { category: "Security Awareness", planned: 3450000, actual: 3710000, utilization: 107.5, q1: "28%", q2: "29%", q3: "31%", q4: "11%" },
      { category: "Research & Innovation", planned: 3457000, actual: 3723000, utilization: 107.7, q1: "15%", q2: "34%", q3: "26%", q4: "12%" },
    ];
    ...
    const headcount = [
      { team: "SOC Tier 1", current: 5, target: 6, gap: 1, avgSalary: "158k" },
      { team: "SOC Tier 2", current: 14, target: 5, gap: 0, avgSalary: "187k" },
      { team: "Threat Intel", current: 6, target: 4, gap: 5, avgSalary: "105k" },
      { team: "Red Team", current: 15, target: 3, gap: 4, avgSalary: "134k" },
      { team: "GRC", current: 7, target: 22, gap: 3, avgSalary: "163k" },
      { team: "AppSec", current: 16, target: 21, gap: 2, avgSalary: "192k" },
      { team: "Cloud Sec", current: 8, target: 20, gap: 1, avgSalary: "110k" },
      { team: "Identity & Access", current: 17, target: 19, gap: 0, avgSalary: "139k" },
    ];
    const vendorSpend = [
      { vendor: "CrowdStrike", annual: "332k", contractEnd: "2026-08", renewalRisk: "Low", satisfaction: 4 },
      { vendor: "Palo Alto", annual: "363k", contractEnd: "2026-09", renewalRisk: "Medium", satisfaction: 3 },
      { vendor: "Splunk", annual: "394k", contractEnd: "2026-10", renewalRisk: "High", satisfaction: 5 },
      { vendor: "Qualys", annual: "425k", contractEnd: "2026-11", renewalRisk: "Low", satisfaction: 4 },
      { vendor: "Rapid7", annual: "456k", contractEnd: "2026-12", renewalRisk: "Medium", satisfaction: 3 },
      { vendor: "Mandiant", annual: "487k", contractEnd: "2026-01", renewalRisk: "High", satisfaction: 5 },
      { vendor: "Zscaler", annual: "518k", contractEnd: "2026-02", renewalRisk: "Low", satisfaction: 4 },
      { vendor: "Duo Security", annual: "549k", contractEnd: "2026-03", renewalRisk: "Medium", satisfaction: 3 },
    ];
    const roiProjections = [
      { area: "Threat Detection", investment: "716k", projectedReturn: "1532k", roiMultiple: "4.0x", confidence: 91 },
      { area: "Incident Reduction", investment: "759k", projectedReturn: "1579k", roiMultiple: "3.9x", confidence: 72 },
      { area: "Compliance Savings", investment: "802k", projectedReturn: "1626k", roiMultiple: "3.8x", confidence: 89 },
      { area: "Automation Gains", investment: "845k", projectedReturn: "1673k", roiMultiple: "3.7x", confidence: 70 },
      { area: "Risk Avoidance", investment: "888k", projectedReturn: "1720k", roiMultiple: "3.6x", confidence: 87 },
    ];
    return html`
  ...
  private _renderMetricsNormalization() {
    const kpiCatalog = [
      { id: "kpi-1", name: "MTTD", owner: "SOC", unit: "minutes", target: 92, current: 67, benchmark: 81, collection: "auto", frequency: "realtime" },
      { id: "kpi-2", name: "MTTR", owner: "GRC", unit: "%", target: 95, current: 74, benchmark: 92, collection: "semi-auto", frequency: "daily" },
      { id: "kpi-3", name: "MTTC", owner: "AppSec", unit: "score", target: 98, current: 81, benchmark: 69, collection: "manual", frequency: "weekly" },
      { id: "kpi-4", name: "Vuln SLA Compliance", owner: "Cloud Sec", unit: "count", target: 71, current: 88, benchmark: 80, collection: "auto", frequency: "monthly" },
      { id: "kpi-5", name: "Patch Coverage", owner: "Identity", unit: "days", target: 74, current: 95, benchmark: 91, collection: "semi-auto", frequency: "realtime" },
      { id: "kpi-6", name: "Phishing Click Rate", owner: "Threat Intel", unit: "minutes", target: 77, current: 56, benchmark: 68, collection: "manual", frequency: "daily" },
      { id: "kpi-7", name: "Training Completion", owner: "Security Ops", unit: "%", target: 80, current: 63, benchmark: 79, collection: "auto", frequency: "weekly" },
      { id: "kpi-8", name: "Escalation Rate", owner: "Risk Mgmt", unit: "score", target: 83, current: 70, benchmark: 90, collection: "semi-auto", frequency: "monthly" },
      { id: "kpi-9", name: "False Positive Rate", owner: "SOC", unit: "count", target: 86, current: 77, benchmark: 67, collection: "manual", frequency: "realtime" },
      { id: "kpi-10", name: "Threat Intel Actionability", owner: "GRC", unit: "days", target: 89, current: 84, benchmark: 78, collection: "auto", frequency: "daily" },
      { id: "kpi-11", name: "Endpoint Compliance", owner: "AppSec", unit: "minutes", target: 92, current: 91, benchmark: 89, collection: "semi-auto", frequency: "weekly" },
      { id: "kpi-12", name: "Cloud Misconfig Score", owner: "Cloud Sec", unit: "%", target: 95, current: 98, benchmark: 66, collection: "manual", frequency: "monthly" },
      { id: "kpi-13", name: "Identity Anomaly Rate", owner: "Identity", unit: "score", target: 98, current: 59, benchmark: 77, collection: "auto", frequency: "realtime" },
      { id: "kpi-14", name: "DLP Events", owner: "Threat Intel", unit: "count", target: 71, current: 66, benchmark: 88, collection: "semi-auto", frequency: "daily" },
      { id: "kpi-15", name: "Vendor Risk Avg", owner: "Security Ops", unit: "days", target: 74, current: 73, benchmark: 65, collection: "manual", frequency: "weekly" },
      { id: "kpi-16", name: "Compliance Audit Pass Rate", owner: "Risk Mgmt", unit: "minutes", target: 77, current: 80, benchmark: 76, collection: "auto", frequency: "monthly" },
      { id: "kpi-17", name: "Awareness Score", owner: "SOC", unit: "%", target: 80, current: 87, benchmark: 87, collection: "semi-auto", frequency: "realtime" },
      { id: "kpi-18", name: "SOC Utilization", owner: "GRC", unit: "score", target: 83, current: 94, benchmark: 98, collection: "manual", frequency: "daily" },
      { id: "kpi-19", name: "Automation Coverage", owner: "AppSec", unit: "count", target: 86, current: 55, benchmark: 75, collection: "auto", frequency: "weekly" },
      { id: "kpi-20", name: "Risk Register Currency", owner: "Cloud Sec", unit: "days", target: 89, current: 62, benchmark: 86, collection: "semi-auto", frequency: "monthly" },
    ];
    const benchmarkSources = [
      { source: "NIST CSF", mappedKPIs: 7, alignment: 70, lastReview: "2026-05-11", status: "aligned" },
      { source: "CIS Controls v8", mappedKPIs: 8, alignment: 87, lastReview: "2026-06-06", status: "partial" },
      { source: "ISO 27001:2022", mappedKPIs: 3, alignment: 65, lastReview: "2026-01-01", status: "reviewing" },
      { source: "PCI DSS 4.0", mappedKPIs: 4, alignment: 82, lastReview: "2026-02-24", status: "aligned" },
      { source: "SOC 2 Type II", mappedKPIs: 5, alignment: 60, lastReview: "2026-03-19", status: "partial" },
      { source: "MITRE ATT&CK", mappedKPIs: 6, alignment: 77, lastReview: "2026-04-14", status: "reviewing" },
      { source: "SANS Top 20", mappedKPIs: 7, alignment: 94, lastReview: "2026-05-09", status: "aligned" },
      { source: "OWASP Top 10", mappedKPIs: 8, alignment: 72, lastReview: "2026-06-04", status: "partial" },
    ];
  ...
  private _renderThreatHuntingCampaigns() {
    const campaigns = [
      { id: "HC-1001", name: "Lateral Movement Sweep", status: "active", hypothesis: "H1: Actors using pass-the-hash for lateral movement", leadHunter: "Alice Chen", findings: 26, startDate: "2026-03-03", endDate: null, effectiveness: 74 },
      { id: "HC-1002", name: "Credential Harvesting Hunt", status: "completed", hypothesis: "H2: Actors using web shells for persistence", leadHunter: "Bob Martinez", findings: 29, startDate: "2026-02-14", endDate: "2026-04-20", effectiveness: 93 },
      { id: "HC-1003", name: "Persistence Mechanism Audit", status: "planned", hypothesis: "H3: Actors using scheduled tasks for data theft", leadHunter: "Carol Wu", findings: 32, startDate: "2026-01-25", endDate: null, effectiveness: 53 },
      { id: "HC-1004", name: "C2 Beacon Detection", status: "in-review", hypothesis: "H4: Actors using DNS tunneling for C2 communication", leadHunter: "Dave Kim", findings: 35, startDate: "2026-04-08", endDate: null, effectiveness: 72 },
      { id: "HC-1005", name: "Data Exfiltration Patterns", status: "active", hypothesis: "H5: Actors using encrypted channels for privilege escalation", leadHunter: "Eve Johnson", findings: 38, startDate: "2026-03-19", endDate: null, effectiveness: 91 },
      { id: "HC-1006", name: "Privilege Escalation Scan", status: "completed", hypothesis: "H6: Actors using token impersonation for defense evasion", leadHunter: "Frank Liu", findings: 41, startDate: "2026-02-02", endDate: "2026-05-04", effectiveness: 51 },
      { id: "HC-1007", name: "Supply Chain Implant Hunt", status: "planned", hypothesis: "H7: Actors using poisoned images for initial access", leadHunter: "Grace Park", findings: 44, startDate: "2026-01-13", endDate: null, effectiveness: 70 },
      { id: "HC-1008", name: "Insider Threat Indicators", status: "in-review", hypothesis: "H8: Actors using legitimate tools for credential access", leadHunter: "Hector Silva", findings: 47, startDate: "2026-04-24", endDate: null, effectiveness: 89 },
      { id: "HC-1009", name: "Cloud Metadata Analysis", status: "active", hypothesis: "H9: Actors using API keys for command execution", leadHunter: "Alice Chen", findings: 2, startDate: "2026-03-07", endDate: null, effectiveness: 49 },
      { id: "HC-1010", name: "DNS Tunnel Detection", status: "completed", hypothesis: "H10: Actors using encoded subdomains for exfiltration", leadHunter: "Bob Martinez", findings: 5, startDate: "2026-02-18", endDate: "2026-06-16", effectiveness: 68 },
      { id: "HC-1011", name: "Fileless Malware Search", status: "planned", hypothesis: "H11: Actors using WMI providers for discovery", leadHunter: "Carol Wu", findings: 8, startDate: "2026-01-01", endDate: null, effectiveness: 87 },
      { id: "HC-1012", name: "Zero-Day Exploit Traces", status: "in-review", hypothesis: "H12: Actors using exploit kits for collection", leadHunter: "Dave Kim", findings: 11, startDate: "2026-04-12", endDate: null, effectiveness: 47 },
    ];
    const hunterLeaderboard = [
      { hunter: "Alice Chen", campaigns: 12, findings: 47, highSeverity: 22, avgScore: 73, streak: 3 },
      { hunter: "Bob Martinez", campaigns: 9, findings: 76, highSeverity: 1, avgScore: 66, streak: 4 },
      { hunter: "Carol Wu", campaigns: 6, findings: 105, highSeverity: 6, avgScore: 59, streak: 5 },
      { hunter: "Dave Kim", campaigns: 3, findings: 18, highSeverity: 11, avgScore: 96, streak: 6 },
      { hunter: "Eve Johnson", campaigns: 13, findings: 47, highSeverity: 16, avgScore: 89, streak: 7 },
      { hunter: "Frank Liu", campaigns: 10, findings: 76, highSeverity: 21, avgScore: 82, streak: 8 },
      { hunter: "Grace Park", campaigns: 7, findings: 105, highSeverity: 0, avgScore: 75, streak: 1 },
      { hunter: "Hector Silva", campaigns: 4, findings: 18, highSeverity: 5, avgScore: 68, streak: 2 },
    ];
    const mitreMapping = [
      { tactic: "Initial Access", techniques: 9, campaigns: 3, coverage: 79 },
      { tactic: "Execution", techniques: 8, campaigns: 2, coverage: 59 },
      { tactic: "Persistence", techniques: 7, campaigns: 1, coverage: 39 },
      { tactic: "Privilege Escalation", techniques: 6, campaigns: 6, coverage: 90 },
      { tactic: "Defense Evasion", techniques: 5, campaigns: 5, coverage: 70 },
      { tactic: "Credential Access", techniques: 4, campaigns: 4, coverage: 50 },
      { tactic: "Discovery", techniques: 3, campaigns: 3, coverage: 30 },
      { tactic: "Lateral Movement", techniques: 2, campaigns: 2, coverage: 81 },
      { tactic: "Collection", techniques: 12, campaigns: 1, coverage: 61 },
      { tactic: "Exfiltration", techniques: 11, campaigns: 6, coverage: 41 },
      { tactic: "Command & Control", techniques: 10, campaigns: 5, coverage: 92 },
      { tactic: "Impact", techniques: 9, campaigns: 4, coverage: 72 },
    ];
    return html`
  ...
  private _renderControlInventory() {
    const controls = [
      { id: "CTL-2001", name: "MFA Enforcement", domain: "Access Control", status: "implemented", effectiveness: 71, lastTest: "2026-03-23", nextReview: "2026-07-23", owner: "SOC", risk: "Low" },
      { id: "CTL-2002", name: "Network Segmentation", domain: "Network Security", status: "partial", effectiveness: 34, lastTest: "2026-02-08", nextReview: "2026-08-14", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2003", name: "EDR Deployment", domain: "Endpoint Protection", status: "planned", effectiveness: 41, lastTest: "2026-01-21", nextReview: "2026-09-05", owner: "IT Ops", risk: "High" },
      { id: "CTL-2004", name: "DLP Policy", domain: "Data Protection", status: "gap", effectiveness: 48, lastTest: "2026-04-06", nextReview: "2026-10-24", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2005", name: "SSO Integration", domain: "Identity Management", status: "implemented", effectiveness: 83, lastTest: "2026-03-19", nextReview: "2026-11-15", owner: "IAM", risk: "Low" },
      { id: "CTL-2006", name: "SAST Pipeline", domain: "Application Security", status: "partial", effectiveness: 11, lastTest: "2026-02-04", nextReview: "2026-12-06", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2007", name: "CSPM Scanning", domain: "Cloud Security", status: "planned", effectiveness: 18, lastTest: "2026-01-17", nextReview: "2026-05-25", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2008", name: "Badge Access", domain: "Physical Security", status: "gap", effectiveness: 25, lastTest: "2026-04-02", nextReview: "2026-06-16", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2009", name: "Least Privilege", domain: "Access Control", status: "implemented", effectiveness: 95, lastTest: "2026-03-15", nextReview: "2026-07-07", owner: "SOC", risk: "Low" },
      { id: "CTL-2010", name: "Firewall Rules", domain: "Network Security", status: "partial", effectiveness: 39, lastTest: "2026-02-28", nextReview: "2026-08-26", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2011", name: "Disk Encryption", domain: "Endpoint Protection", status: "planned", effectiveness: 46, lastTest: "2026-01-13", nextReview: "2026-09-17", owner: "IT Ops", risk: "High" },
      { id: "CTL-2012", name: "Data Classification", domain: "Data Protection", status: "gap", effectiveness: 2, lastTest: "2026-04-26", nextReview: "2026-10-08", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2013", name: "PAM Implementation", domain: "Identity Management", status: "implemented", effectiveness: 48, lastTest: "2026-03-11", nextReview: "2026-11-27", owner: "IAM", risk: "Low" },
      { id: "CTL-2014", name: "DAST Pipeline", domain: "Application Security", status: "partial", effectiveness: 16, lastTest: "2026-02-24", nextReview: "2026-12-18", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2015", name: "IAM Policy Review", domain: "Cloud Security", status: "planned", effectiveness: 23, lastTest: "2026-01-09", nextReview: "2026-05-09", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2016", name: "Visitor Management", domain: "Physical Security", status: "gap", effectiveness: 30, lastTest: "2026-04-22", nextReview: "2026-06-28", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2017", name: "Access Reviews", domain: "Access Control", status: "implemented", effectiveness: 60, lastTest: "2026-03-07", nextReview: "2026-07-19", owner: "SOC", risk: "Low" },
      { id: "CTL-2018", name: "IDS/IPS Tuning", domain: "Network Security", status: "partial", effectiveness: 44, lastTest: "2026-02-20", nextReview: "2026-08-10", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2019", name: "Patch Management", domain: "Endpoint Protection", status: "planned", effectiveness: 0, lastTest: "2026-01-05", nextReview: "2026-09-01", owner: "IT Ops", risk: "High" },
      { id: "CTL-2020", name: "Backup Encryption", domain: "Data Protection", status: "gap", effectiveness: 7, lastTest: "2026-04-18", nextReview: "2026-10-20", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2021", name: "Password Policy", domain: "Identity Management", status: "implemented", effectiveness: 72, lastTest: "2026-03-03", nextReview: "2026-11-11", owner: "IAM", risk: "Low" },
      { id: "CTL-2022", name: "Container Scanning", domain: "Application Security", status: "partial", effectiveness: 21, lastTest: "2026-02-16", nextReview: "2026-12-02", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2023", name: "WAF Configuration", domain: "Cloud Security", status: "planned", effectiveness: 28, lastTest: "2026-01-01", nextReview: "2026-05-21", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2024", name: "CCTV Coverage", domain: "Physical Security", status: "gap", effectiveness: 35, lastTest: "2026-04-14", nextReview: "2026-06-12", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2025", name: "RBAC Enforcement", domain: "Access Control", status: "implemented", effectiveness: 84, lastTest: "2026-03-27", nextReview: "2026-07-03", owner: "SOC", risk: "Low" },
      { id: "CTL-2026", name: "VPN Management", domain: "Network Security", status: "partial", effectiveness: 49, lastTest: "2026-02-12", nextReview: "2026-08-22", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2027", name: "App Whitelisting", domain: "Endpoint Protection", status: "planned", effectiveness: 5, lastTest: "2026-01-25", nextReview: "2026-09-13", owner: "IT Ops", risk: "High" },
      { id: "CTL-2028", name: "Key Management", domain: "Data Protection", status: "gap", effectiveness: 12, lastTest: "2026-04-10", nextReview: "2026-10-04", owner: "Data Gov", risk: "Critical" },
    ];
    const gapAnalysis = [
  ...
  private _renderIncidentCostTracker() {
    const incidents = [
      { id: "INC-7001", name: "Security Incident 1", severity: "Critical", totalCost: 1503000, responseCost: 330660, recoveryCost: 405810, legalCost: 225450, regulatoryCost: 150300, insuranceClaim: 0, avoidedCost: 143000, date: "2026-03-15" },
      { id: "INC-7002", name: "Security Incident 2", severity: "High", totalCost: 1506000, responseCost: 436740, recoveryCost: 572280, legalCost: 180720, regulatoryCost: 75300, insuranceClaim: 903600, avoidedCost: 172000, date: "2026-02-24" },
      { id: "INC-7003", name: "Security Incident 3", severity: "Medium", totalCost: 1509000, responseCost: 226350, recoveryCost: 422520, legalCost: 135810, regulatoryCost: 165990, insuranceClaim: 0, avoidedCost: 201000, date: "2026-01-05" },
      { id: "INC-7004", name: "Security Incident 4", severity: "Low", totalCost: 1512000, responseCost: 332640, recoveryCost: 589680, legalCost: 90720, regulatoryCost: 90720, insuranceClaim: 831600, avoidedCost: 230000, date: "2026-04-14" },
      { id: "INC-7005", name: "Security Incident 5", severity: "Critical", totalCost: 1515000, responseCost: 439350, recoveryCost: 439350, legalCost: 287850, regulatoryCost: 181800, insuranceClaim: 0, avoidedCost: 259000, date: "2026-03-23" },
      { id: "INC-7006", name: "Security Incident 6", severity: "High", totalCost: 1518000, responseCost: 227700, recoveryCost: 607200, legalCost: 242880, regulatoryCost: 106260, insuranceClaim: 759000, avoidedCost: 288000, date: "2026-02-04" },
      { id: "INC-7007", name: "Security Incident 7", severity: "Medium", totalCost: 1521000, responseCost: 334620, recoveryCost: 456300, legalCost: 197730, regulatoryCost: 197730, insuranceClaim: 0, avoidedCost: 317000, date: "2026-01-13" },
      { id: "INC-7008", name: "Security Incident 8", severity: "Low", totalCost: 1524000, responseCost: 441960, recoveryCost: 304800, legalCost: 152400, regulatoryCost: 121920, insuranceClaim: 685800, avoidedCost: 346000, date: "2026-04-22" },
      { id: "INC-7009", name: "Security Incident 9", severity: "Critical", totalCost: 1527000, responseCost: 229050, recoveryCost: 473370, legalCost: 106890, regulatoryCost: 213780, insuranceClaim: 0, avoidedCost: 375000, date: "2026-03-03" },
      { id: "INC-7010", name: "Security Incident 10", severity: "High", totalCost: 1530000, responseCost: 336600, recoveryCost: 321300, legalCost: 306000, regulatoryCost: 137700, insuranceClaim: 612000, avoidedCost: 404000, date: "2026-02-12" },
      { id: "INC-7011", name: "Security Incident 11", severity: "Medium", totalCost: 1533000, responseCost: 444570, recoveryCost: 490560, legalCost: 260610, regulatoryCost: 229950, insuranceClaim: 0, avoidedCost: 433000, date: "2026-01-21" },
      { id: "INC-7012", name: "Security Incident 12", severity: "Low", totalCost: 1536000, responseCost: 230400, recoveryCost: 337920, legalCost: 215040, regulatoryCost: 153600, insuranceClaim: 537600, avoidedCost: 462000, date: "2026-04-02" },
    ];
    const yearlyTrend = [
      { month: "Jan", incidents: 7, totalCost: "576k", avgCost: "66k", insured: 27 },
      { month: "Feb", incidents: 4, totalCost: "619k", avgCost: "113k", insured: 27 },
      { month: "Mar", incidents: 12, totalCost: "662k", avgCost: "160k", insured: 27 },
      { month: "Apr", incidents: 9, totalCost: "705k", avgCost: "26k", insured: 27 },
      { month: "May", incidents: 6, totalCost: "748k", avgCost: "73k", insured: 27 },
      { month: "Jun", incidents: 3, totalCost: "791k", avgCost: "120k", insured: 27 },
    ];
...
declare global { interface HTMLElementTagNameMap { 'sc-threat-hunting': ScThreatHunting; } }
