...
export class ScBiaAnalysis extends LitElement {
  ...
  private _data: MockItem[] = [
    {name:"Core Banking (Revenue: $2M/day)",status:"analyzed",risk:"critical",detail:"Impact: Revenue loss $83K/hr | MTPD: 4h | Dependencies: DB, Payment, Auth | Priority: P1"},
    {name:"Payment Gateway ($500K/day)",status:"analyzed",risk:"critical",detail:"Impact: Revenue loss $21K/hr | MTPD: 2h | Dependencies: Bank APIs, Fraud engine | Priority: P1"},
    {name:"Customer Portal ($50K/day)",status:"analyzed",risk:"high",detail:"Impact: Revenue loss $2K/hr + reputation | MTPD: 8h | Dependencies: Web, API, Search | Priority: P2"},
    {name:"Internal HR ($5K/day)",status:"analyzed",risk:"medium",detail:"Impact: Operational disruption | MTPD: 24h | Dependencies: AD, Email, Payroll | Priority: P3"}
  ];
  ...
  render() {
    ...
    return html`<div class="panel"><div class="pt">Bia Analysis</div>
