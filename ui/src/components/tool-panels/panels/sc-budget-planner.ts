/**
 * sc-budget-planner - Budget Planner
...
@customElement('sc-budget-planner')
export class ScBudgetPlanner extends LitElement {
  static styles = css`
...
@state() private _tablePage = 1;
  ...
  @state() private _comments: CommentEntry[] = [
    { id: 'c1', author: 'soc-tier1', timestamp: '2026-04-23 04:00', text: 'Initial assessment started for Budget Planner finding #1' },
  ...
  private _items: PanelItem[] = [
      {
            "id": "budget-planner-1",
            "title": "Security Tools & Licenses",
            "severity": "high",
            "status": "open",
            "category": "Security",
            "source": "SIEM",
            "description": "Budget: $1.2M | Spent: $980K | Remaining: $220K | Burn rate: On track | Major: SIEM renewal Q3",
      ...
      },
      {
            ...
            "category": "Network",
            "source": "EDR",
            "description": "Budget: $800K | Spent: $600K | Remaining: $200K | Headcount: 8 FTE | Open reqs: 2",
      ...
      },
      {
            ...
            "category": "Access",
            "source": "Scanner",
            "description": "Budget: $200K | Spent: $85K | Remaining: $115K | Certs completed: 4 | Conferences: 2 planned",
      ...
      },
      {
            ...
            "category": "Compliance",
            "source": "Audit",
            "description": "Budget: $200K | Spent: $150K | Remaining: $50K | SOC 2 audit: Booked | Pen test: Completed",
      ...
      {
            "id": "budget-planner-5",
            "title": "Budget Planner Finding #5",
            "severity": "medium",
            "status": "open",
            "category": "Operations",
            "source": "Manual",
            "description": "Automated budget planner assessment finding detected during routine scan of infrastructure component. Review and remediation recommended.",
      ...
      {
            "id": "budget-planner-6",
            "title": "Budget Planner Finding #6",
            "severity": "high",
            "status": "open",
            "category": "Security",
            "source": "SIEM",
      ...
      {
            "id": "budget-planner-7",
            "title": "Budget Planner Finding #7",
            "severity": "low",
            "status": "open",
            "category": "Network",
            "source": "EDR",
      ...
      {
            "id": "budget-planner-8",
            "title": "Budget Planner Finding #8",
            "severity": "medium",
            "status": "open",
            "category": "Access",
            "source": "Scanner",
      ...
      {
            "id": "budget-planner-9",
            "title": "Budget Planner Finding #9",
            "severity": "high",
            "status": "open",
            "category": "Compliance",
            "source": "Audit",
      ...
      {
            "id": "budget-planner-10",
            "title": "Budget Planner Finding #10",
            "severity": "low",
            "status": "open",
            "category": "Operations",
            "source": "Manual",
  ...
  private _history: HistoryEntry[] = [
    { timestamp: '2026-04-23 04:15', action: 'Auto-correlated', user: 'system', details: 'Grouped related findings from Budget Planner analysis' },
    { timestamp: '2026-04-23 03:00', action: 'Created', user: 'scanner', details: 'New Budget Planner finding detected by automated assessment' },
    ...
    { timestamp: '2026-04-22 22:00', action: 'Resolved', user: 'security-eng', details: 'Remediation applied and verified for Budget Planner finding' },
    { timestamp: '2026-04-22 18:00', action: 'Created', user: 'audit', details: 'Compliance audit identified Budget Planner gap requiring remediation' },
    ...
    { timestamp: '2026-04-21 16:00', action: 'Resolved', user: 'soc-tier1', details: 'False positive confirmed - benign activity flagged by Budget Planner scan' },
    { timestamp: '2026-04-21 12:00', action: 'Exported', user: 'compliance', details: 'Exported Budget Planner findings for Q1 compliance report' },
  ];
...
private _workflowTasks: WorkflowTask[] = [
    { id: 'wt-1', title: 'Review Budget Planner finding #1', status: 'active', assignee: 'soc-tier1', blockedBy: [], slaDeadline: '2026-04-23T12:00:00Z', priority: 'p1', createdAt: '2026-04-23T00:00:00Z', completedAt: null },
    ...
    { id: 'wt-3', title: 'Update Budget Planner detection rules', status: 'blocked', assignee: 'soc-tier2', blockedBy: ['wt-2'], slaDeadline: '2026-04-24T00:00:00Z', priority: 'p2', createdAt: '2026-04-23T03:00:00Z', completedAt: null },
    ...
    { id: 'wt-8', title: 'Archive resolved Budget Planner findings', status: 'failed', assignee: 'soc-tier1', blockedBy: [], slaDeadline: '2026-04-23T08:00:00Z', priority: 'p4', createdAt: '2026-04-22T22:00:00Z', completedAt: null },
  ];

private _executionHistory: ExecutionRecord[] = [
    {
      id: 'exec-1', name: 'Budget Planner Full Assessment Run', startedAt: '2026-04-22T10:00:00Z', completedAt: '2026-04-22T10:12:00Z', status: 'success',
      steps: [
    ...
    {
      id: 'exec-2', name: 'Budget Planner Delta Scan', startedAt: '2026-04-23T02:00:00Z', completedAt: '2026-04-23T02:05:00Z', status: 'failed',
      steps: [
  ...
  private _runExecution() {
    ...
    const exec: ExecutionRecord = {
      id: 'exec-' + Date.now(), name: 'Budget Planner Assessment ' + new Date().toISOString().slice(0, 10), startedAt: new Date().toISOString(), completedAt: null, status: 'running', steps,
    };
  ...
  private _renderExecutionPanel(): unknown {
    ...
    return html`
      <div class="form-section">
        ...
        ` : html`<div class="empty-state">Click "Run Assessment" to start the Budget Planner analysis pipeline</div>`}
      </div>
      <div class="form-section">
        ...
        <div class="settings-card">
          ...
          <div style="display:flex;gap:8px;margin-top:4px;">
            <button class="btn primary" @click=${() => {
              ...
              const a = document.createElement('a'); a.href = url; a.download = 'budget-planner-config.json'; a.click();
    ...
    return html`
      <div style="margin-top:12px;">
        ...
        <div style="display:flex;gap:6px;margin-top:8px;">
          <input class="search-box" type="text" placeholder="Add a comment..." style="min-width:auto;flex:1;" id="budget-planner-comment-input" />
          <button class="btn primary" @click=${() => {
            const input = this.shadowRoot?.querySelector('#budget-planner-comment-input') as HTMLInputElement;
  ...
  private _exportJSON() {
    ...
    const url = URL.createObjectURL(blob);
    const a = document.createElement('a'); a.href = url; a.download = 'sc-budget-planner-data.json'; a.click();
    URL.revokeObjectURL(url);
  }
  ...
  private _exportCSV() {
    ...
    const url = URL.createObjectURL(blob);
    const a = document.createElement('a'); a.href = url; a.download = 'sc-budget-planner-data.csv'; a.click();
    URL.revokeObjectURL(url);
  }


  // --- Domain Rules Engine ---
  @state() private _bpRules: { id: string; name: string; category: string; severity: Severity; enabled: boolean; lastEval: string; passRate: number }[] = [];
  private _initBpRules() {
    const rules = [
  ...
  private _evaluateBpRules(): { passed: number; failed: number; skipped: number; total: number } {
    let passed = 0, failed = 0, skipped = 0;
    this._bpRules.forEach(r => { if (!r.enabled) { skipped++; } else if (r.passRate >= 80) { passed++; } else { failed++; } });
    return { passed, failed, skipped, total: this._bpRules.length };
  }

  // --- CVSS Scoring ---
  @state() private _bpcvssData: { itemId: string; vector: string; base: number; temporal: number; environmental: number; overall: number }[] = [];
  private _initBpCvss() {
    ...
    this._bpcvssData = vectors.map((v, i) => {
  ...
  // --- Anomaly Detection ---
  @state() private _bpanomalies: { id: string; type: string; severity: Severity; description: string; detected: string; confidence: number; affected: string[] }[] = [];
  private _runBpAnomalyDetection() {
    const types = [
    ...
    this._bpanomalies = types.map((a, i) => ({
  ...
  // --- Trend Prediction ---
  @state() private _bppredictions: { horizon: string; metric: string; current: number; predicted: number; direction: 'up' | 'down' | 'stable'; confidence: number }[] = [];
  private _generateBpPredictions() {
    this._bppredictions = [
  ...
  // --- Approval Workflow ---
  @state() private _bpApprovals: { id: string; title: string; requester: string; status: 'pending' | 'approved' | 'rejected' | 'expired'; createdAt: string; priority: Priority; type: string }[] = [];
  private _initBpApprovals() {
    this._bpApprovals = [
  ...
  private _approveBpItem(id: string) { const item = this._bpApprovals.find(a => a.id === id); if (item) item.status = 'approved'; this.requestUpdate(); }
  private _rejectBpItem(id: string) { const item = this._bpApprovals.find(a => a.id === id); if (item) item.status = 'rejected'; this.requestUpdate(); }

  // --- Activity Feed ---
  @state() private _bpActivity: { id: string; action: string; user: string; target: string; timestamp: string }[] = [];
  private _initBpActivity() {
    const actions = [
    ...
    this._bpActivity = actions.map((a, i) => ({ id: 'ACT-' + String(i + 1).padStart(3, '0'), ...a, timestamp: new Date(Date.now() - i * 3600000).toISOString() }));
  }

  // --- Notification System ---
  @state() private _bpNotifications: { id: string; message: string; type: 'info' | 'warning' | 'error' | 'success'; read: boolean; timestamp: string }[] = [];
  private _initBpNotifications() {
    this._bpNotifications = [
  ...
  private _markBpNotifRead(id: string) { const n = this._bpNotifications.find(x => x.id === id); if (n) n.read = true; this.requestUpdate(); }

  // --- Panel Configuration ---
  @state() private _bpConfig: { layout: 'compact' | 'default' | 'expanded'; theme: 'dark' | 'midnight' | 'slate'; showAnomalies: boolean; showPredictions: boolean; autoRefresh: boolean; refreshInterval: number } = {
    layout: 'default', theme: 'dark', showAnomalies: true, showPredictions: true, autoRefresh: true, refreshInterval: 60,
  };
  private _bpPresets: { name: string; config: typeof this._bpConfig }[] = [
  ...
  private _applyBpPreset(preset: typeof this._bpPresets[0]) { this._bpConfig = { ...preset.config }; this.requestUpdate(); }

  private _renderBpTreemapSVG(): string {
    const categories = [
  ...
  private _renderBpSankeySVG(): string {
  ...
  // --- Render: Rules Engine ---
  private _renderBpRules(): any {
    const ev = this._evaluateBpRules();
    return html`
  ...
  private _renderBpAnomalies(): any {
  ...
  // --- Render: Approvals ---
  private _renderBpApprovals(): any {
          ...
          $${this._bpApprovals.map(a => html`
            <div style="padding:6px 8px;background:#1f2937;border-radius:4px">
              ...
              $${a.status === 'pending' ? html`
                <div style="display:flex;gap:4px;margin-top:4px">
                  <button class="btn success" style="padding:2px 8px;font-size:9px" @click=$${() => this._approveBpItem(a.id)}>Approve</button>
                  <button class="btn error" style="padding:2px 8px;font-size:9px" @click=$${() => this._rejectBpItem(a.id)}>Reject</button>
                </div>` : nothing}
            </div>`)}
        </div>
      </div>`;
  ...
  private _renderBpNotifications(): any {
    const tc = (t: string) => t === 'error' ? '#ef4444' : t === 'warning' ? '#eab308' : t === 'success' ? '#22c55e' : '#3b82f6';
    const unread = this._bpNotifications.filter(n => !n.read).length;
    return html`
      <div style="background:#1a1d27;border-radius:8px;padding:12px;margin-top:12px">
        ...
        <div style="display:flex;flex-direction:column;gap:4px;max-height:120px;overflow-y:auto">
          $${this._bpNotifications.map(n => html`
            <div style="display:flex;align-items:center;gap:8px;padding:4px 8px;background:$${n.read ? '#1f2937' : '#252a36'};border-radius:4px;font-size:10px;opacity:$${n.read ? '0.6' : '1'};cursor:pointer" @click=$${() => this._markBpNotifRead(n.id)}>
      ...
      <div style="background:#1a1d27;border-radius:8px;padding:12px;margin-top:12px">
        ...
        <div style="display:flex;flex-direction:column;gap:6px;font-size:10px">
          <div style="display:flex;align-items:center;gap:8px">
            ...
            <select class="form-input" style="flex:1" @change=$${(e: Event) => { this._bpConfig.layout = (e.target as HTMLSelectElement).value as any; this.requestUpdate(); }}>
              <option value="compact" ?selected=$${this._bpConfig.layout === 'compact'}>Compact</option>
              <option value="default" ?selected=$${this._bpConfig.layout === 'default'}>Default</option>
              <option value="expanded" ?selected=$${this._bpConfig.layout === 'expanded'}>Expanded</option>
            </select>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Theme</span>
            <select class="form-input" style="flex:1" @change=$${(e: Event) => { this._bpConfig.theme = (e.target as HTMLSelectElement).value as any; this.requestUpdate(); }}>
              <option value="dark" ?selected=$${this._bpConfig.theme === 'dark'}>Dark</option>
              <option value="midnight" ?selected=$${this._bpConfig.theme === 'midnight'}>Midnight</option>
              <option value="slate" ?selected=$${this._bpConfig.theme === 'slate'}>Slate</option>
            </select>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Auto Refresh</span>
            <input type="checkbox" ?checked=$${this._bpConfig.autoRefresh} @change=$${() => { this._bpConfig.autoRefresh = !this._bpConfig.autoRefresh; this.requestUpdate(); }}/>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Show Anomalies</span>
            <input type="checkbox" ?checked=$${this._bpConfig.showAnomalies} @change=$${() => { this._bpConfig.showAnomalies = !this._bpConfig.showAnomalies; this.requestUpdate(); }}/>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Show Predictions</span>
            <input type="checkbox" ?checked=$${this._bpConfig.showPredictions} @change=$${() => { this._bpConfig.showPredictions = !this._bpConfig.showPredictions; this.requestUpdate(); }}/>
          </div>
          <div style="margin-top:6px;font-weight:600">Presets</div>
          <div style="display:flex;gap:4px">
            $${this._bpPresets.map(ps => html`<button class="btn" style="padding:2px 8px;font-size:9px" @click=$${() => this._applyBpPreset(ps)}>$${ps.name}</button>`)}
          </div>
        </div>
      </div>`;
  }
  ...
  @state() private _budgetPlanneContainerScans: Array<{image:string;registry:string;critical:number;high:number;medium:number;scanDate:string;status:string}> = [
  ...
  @state() private _budgetPlanneK8sPods: Array<{namespace:string;pod:string;securityContext:string;hostIPC:boolean;hostPID:boolean;privileged:boolean;riskLevel:string}> = [
  ...
  @state() private _budgetPlanneServerlessRisk: Array<{function:string;runtime:string;timeout:number;iamPerms:string;externalCalls:number;riskScore:number}> = [
  ...
  @state() private _budgetPlanneRuntimeAlerts: Array<{id:string;workload:string;alertType:string;severity:string;description:string;timestamp:string}> = [
  ...
  private _renderBudgetplanneCloudWl(): TemplateResult {
    const containers = this._budgetPlanneContainerScans;
    const pods = this._budgetPlanneK8sPods;
    const alerts = this._budgetPlanneRuntimeAlerts;
    return html`
  ...
  @state() private _budgetPlanneRiskTopTen: Array<{id:string;name:string;score:number;trend:string;owner:string;category:string;lastAssessed:string}> = [
  ...
  @state() private _budgetPlanneRiskCategories: Array<{category:string;count:number;avgScore:number;color:string}> = [
  ...
  @state() private _budgetPlanneRiskVelocity: Array<{week:string;newRisks:number;closedRisks:number;netChange:number}> = [
  ...
  @state() private _budgetPlanneRiskAppetite: {current:number;threshold:number;maxTolerated:number;status:string} = {
    current: 68, threshold: 55, maxTolerated: 80, status: 'Warning'
  };
  @state() private _budgetPlanneRiskOwnerMatrix: Array<{owner:string;criticalCount:number;highCount:number;mediumCount:number;complianceRate:number}> = [
  ...
  private _renderBudgetplanneRiskDash(): TemplateResult {
    const riskItems = this._budgetPlanneRiskTopTen;
    const velocity = this._budgetPlanneRiskVelocity;
    const appetite = this._budgetPlanneRiskAppetite;
    return html`
  ...
  @state() private _budgetPlanneCourses: Array<{id:string;title:string;category:string;duration:number;enrolled:number;completed:number;difficulty:string;rating:number}> = [
  ...
  @state() private _budgetPlanneLearningPaths: Array<{id:string;name:string;courseIds:string[];progress:number;enrolled:number}> = [
  ...
  @state() private _budgetPlanneDeptCompliance: Array<{dept:string;trainedPct:number;targetPct:number;avgScore:number;certCount:number}> = [
  ...
  @state() private _budgetPlanneSkillsGaps: Array<{skill:string;current:number;required:number;gap:number;priority:string}> = [
  ...
  private _renderBudgetplanneTraining(): TemplateResult {
    const courses = this._budgetPlanneCourses;
    const deptComp = this._budgetPlanneDeptCompliance;
    return html`
  ...
  @state() private _budgetPlanneCorrRules: Array<{id:string;name:string;sources:string[];logic:string;severity:string;active:boolean;lastTriggered:string}> = [
  ...
  @state() private _budgetPlanneEventTimeline: Array<{timestamp:string;source:string;eventType:string;details:string;correlated:boolean}> = [
  ...
  @state() private _budgetPlanneFalsePosMetrics: {totalEvents:number;correlatedEvents:number;falsePositives:number;fpRate:number;topFpRules:string[]} = {
  ...
  @state() private _budgetPlanneEventPatterns: Array<{id:string;pattern:string;frequency:number;firstSeen:string;lastSeen:string;status:string}> = [
  ...
  private _renderBudgetplanneEventCorr(): TemplateResult {
    const rules = this._budgetPlanneCorrRules;
    const timeline = this._budgetPlanneEventTimeline;
    const fpMetrics = this._budgetPlanneFalsePosMetrics;
    return html`
  ...
  @state() private _complianceCalendarEvents: Array<{id: string; title: string; deadline: string; category: string; status: string; assignee: string; notes: string}> = [
    {id: 'cc-budget-planner-001', title: 'SOX Section 404 Compliance Review', deadline: '2026-06-30', category: 'Regulatory', status: 'In Progress', assignee: 'Compliance Team', notes: 'Annual internal control assessment for financial reporting'},
    {id: 'cc-budget-planner-002', title: 'GDPR Data Protection Impact Assessment', deadline: '2026-05-15', category: 'Privacy', status: 'Pending', assignee: 'DPO Office', notes: 'Quarterly DPIA for high-risk processing activities'},
    {id: 'cc-budget-planner-003', title: 'ISO 27001 Surveillance Audit', deadline: '2026-07-20', category: 'Certification', status: 'Scheduled', assignee: 'QA Lead', notes: 'Stage 2 surveillance audit for ISMS certification renewal'},
    {id: 'cc-budget-planner-004', title: 'PCI DSS v4.0 Gap Analysis', deadline: '2026-05-30', category: 'Payment', status: 'Not Started', assignee: 'Security Architect', notes: 'Assess current state against PCI DSS v4.0 requirements'},
    {id: 'cc-budget-planner-005', title: 'NIST CSF Self-Assessment', deadline: '2026-08-15', category: 'Framework', status: 'Pending', assignee: 'CISO', notes: 'Biannual self-assessment against NIST Cybersecurity Framework'},
    {id: 'cc-budget-planner-006', title: 'HIPAA Security Rule Audit', deadline: '2026-06-15', category: 'Healthcare', status: 'In Progress', assignee: 'Compliance Analyst', notes: 'Annual audit of administrative, physical, and technical safeguards'},
    {id: 'cc-budget-planner-007', title: 'SOC 2 Type II Report Renewal', deadline: '2026-09-30', category: 'Audit', status: 'Scheduled', assignee: 'External Auditor', notes: 'Engage auditor for SOC 2 Type II examination period'},
    {id: 'cc-budget-planner-008', title: 'FedRAMP Authorization Review', deadline: '2026-07-01', category: 'Government', status: 'Pending', assignee: 'FedRAMP PMO', notes: 'Review and update security authorization package'},
    {id: 'cc-budget-planner-009', title: 'Annual Penetration Test', deadline: '2026-10-15', category: 'Testing', status: 'Not Started', assignee: 'Red Team Lead', notes: 'Comprehensive external and internal penetration testing engagement'},
    {id: 'cc-budget-planner-010', title: 'Security Awareness Training Rollout', deadline: '2026-05-01', category: 'Training', status: 'Completed', assignee: 'Security Awareness Manager', notes: 'Q2 organization-wide security awareness training program'},
    {id: 'cc-budget-planner-011', title: 'Vendor Security Review Cycle', deadline: '2026-06-01', category: 'Third Party', status: 'In Progress', assignee: 'Vendor Manager', notes: 'Quarterly review of critical vendor security posture and SLA compliance'},
    {id: 'cc-budget-planner-012', title: 'Incident Response Plan Update', deadline: '2026-05-20', category: 'Operations', status: 'Pending', assignee: 'IR Team Lead', notes: 'Update IR procedures based on lessons learned from recent incidents'},
  ];
  ...
  @state() private _dataQualityMetrics: Array<{id: string; dataSource: string; completenessScore: number; accuracyScore: number; timelinessScore: number; consistencyScore: number; reliabilityRank: number; lastUpdated: string; issues: string[]; trend: string}> = [
    {id: 'dq-budget-planner-001', dataSource: 'Vulnerability Scanner Feed', completenessScore: 94, accuracyScore: 91, timelinessScore: 88, consistencyScore: 95, reliabilityRank: 1, lastUpdated: '2026-04-23T08:00:00Z', issues: ['Minor delay in Nessus plugin updates'], trend: 'improving'},
    {id: 'dq-budget-planner-002', dataSource: 'SIEM Event Logs', completenessScore: 87, accuracyScore: 93, timelinessScore: 96, consistencyScore: 89, reliabilityRank: 2, lastUpdated: '2026-04-23T07:30:00Z', issues: ['Some log sources showing gaps in off-hours'], trend: 'stable'},
    {id: 'dq-budget-planner-003', dataSource: 'Asset Inventory Database', completenessScore: 82, accuracyScore: 78, timelinessScore: 75, consistencyScore: 84, reliabilityRank: 4, lastUpdated: '2026-04-22T18:00:00Z', issues: ['Shadow IT devices not fully cataloged', 'Decommissioned assets still listed'], trend: 'declining'},
    {id: 'dq-budget-planner-004', dataSource: 'Threat Intelligence Platform', completenessScore: 91, accuracyScore: 89, timelinessScore: 92, consistencyScore: 87, reliabilityRank: 3, lastUpdated: '2026-04-23T06:00:00Z', issues: ['Some IOC sources lack confidence scoring'], trend: 'improving'},
    {id: 'dq-budget-planner-005', dataSource: 'Identity Provider Logs', completenessScore: 96, accuracyScore: 97, timelinessScore: 98, consistencyScore: 96, reliabilityRank: 1, lastUpdated: '2026-04-23T09:00:00Z', issues: [], trend: 'stable'},
    {id: 'dq-budget-planner-006', dataSource: 'Cloud Security Posture Data', completenessScore: 79, accuracyScore: 85, timelinessScore: 82, consistencyScore: 81, reliabilityRank: 5, lastUpdated: '2026-04-23T05:00:00Z', issues: ['Multi-cloud coverage gaps', 'API rate limiting affects scan frequency'], trend: 'declining'},
    {id: 'dq-budget-planner-007', dataSource: 'Compliance Evidence Store', completenessScore: 88, accuracyScore: 86, timelinessScore: 80, consistencyScore: 83, reliabilityRank: 4, lastUpdated: '2026-04-21T14:00:00Z', issues: ['Manual evidence collection delays', 'Inconsistent formatting across frameworks'], trend: 'stable'},
    {id: 'dq-budget-planner-008', dataSource: 'Network Flow Data', completenessScore: 92, accuracyScore: 90, timelinessScore: 94, consistencyScore: 91, reliabilityRank: 2, lastUpdated: '2026-04-23T08:30:00Z', issues: ['Encrypted traffic classification accuracy needs improvement'], trend: 'improving'},
  ];
  ...
  @state() private _workflowTemplates: Array<{id: string; name: string; description: string; category: string; steps: number; avgDuration: string; successRate: number; lastRun: string; manualInterventions: number; optimizationScore: number}> = [
    {id: 'wf-budget-planner-001', name: 'Vulnerability Triage Pipeline', description: 'Automated vulnerability assessment, prioritization, and assignment workflow', category: 'Vulnerability Management', steps: 8, avgDuration: '12 min', successRate: 94.5, lastRun: '2026-04-23T06:00:00Z', manualInterventions: 2, optimizationScore: 87},
    {id: 'wf-budget-planner-002', name: 'Incident Response Orchestration', description: 'End-to-end IR workflow from detection to containment and recovery', category: 'Incident Response', steps: 15, avgDuration: '45 min', successRate: 89.2, lastRun: '2026-04-22T14:30:00Z', manualInterventions: 5, optimizationScore: 72},
    {id: 'wf-budget-planner-003', name: 'Access Request Approval Chain', description: 'Multi-level approval workflow for privileged access requests', category: 'Identity & Access', steps: 6, avgDuration: '4 hours', successRate: 97.1, lastRun: '2026-04-23T09:15:00Z', manualInterventions: 1, optimizationScore: 92},
    {id: 'wf-budget-planner-004', name: 'Compliance Evidence Collection', description: 'Automated gathering and packaging of audit evidence artifacts', category: 'Compliance', steps: 10, avgDuration: '30 min', successRate: 91.8, lastRun: '2026-04-21T10:00:00Z', manualInterventions: 3, optimizationScore: 78},
    {id: 'wf-budget-planner-005', name: 'Security Patch Deployment', description: 'Staged patch rollout with validation and rollback capability', category: 'Patch Management', steps: 12, avgDuration: '2 hours', successRate: 96.3, lastRun: '2026-04-20T22:00:00Z', manualInterventions: 1, optimizationScore: 85},
    {id: 'wf-budget-planner-006', name: 'Threat Intelligence Enrichment', description: 'IOC enrichment and correlation with internal threat data', category: 'Threat Intelligence', steps: 7, avgDuration: '8 min', successRate: 93.7, lastRun: '2026-04-23T07:00:00Z', manualInterventions: 0, optimizationScore: 95},
    {id: 'wf-budget-planner-007', name: 'Security Reporting Pipeline', description: 'Automated generation and distribution of security metrics reports', category: 'Reporting', steps: 5, avgDuration: '15 min', successRate: 98.9, lastRun: '2026-04-23T08:00:00Z', manualInterventions: 0, optimizationScore: 97},
    {id: 'wf-budget-planner-008', name: 'Vendor Risk Assessment', description: 'Automated vendor security questionnaire distribution and scoring', category: 'Third Party', steps: 9, avgDuration: '3 days', successRate: 85.4, lastRun: '2026-04-19T11:00:00Z', manualInterventions: 4, optimizationScore: 65},
  ];
  ...
  @state() private _workflowExecutionHistory: Array<{workflowId: string; runDate: string; duration: string; status: string; trigger: string}> = [
    {workflowId: 'wf-budget-planner-001', runDate: '2026-04-23T06:00:00Z', duration: '11 min 23 sec', status: 'Success', trigger: 'Scheduled'},
    {workflowId: 'wf-budget-planner-002', runDate: '2026-04-22T14:30:00Z', duration: '42 min 15 sec', status: 'Success', trigger: 'Alert'},
    {workflowId: 'wf-budget-planner-003', runDate: '2026-04-23T09:15:00Z', duration: '3h 45 min', status: 'Success', trigger: 'User Request'},
    {workflowId: 'wf-budget-planner-001', runDate: '2026-04-22T06:00:00Z', duration: '13 min 08 sec', status: 'Partial', trigger: 'Scheduled'},
    {workflowId: 'wf-budget-planner-004', runDate: '2026-04-21T10:00:00Z', duration: '28 min 42 sec', status: 'Success', trigger: 'Scheduled'},
  ];
  ...
  @state() private _knowledgeArticles: Array<{id: string; title: string; category: string; author: string; publishDate: string; views: number; rating: number; tags: string[]; summary: string; readTime: string}> = [
    {id: 'kb-budget-planner-001', title: 'Zero Trust Architecture Implementation Guide', category: 'Architecture', author: 'Security Architecture Team', publishDate: '2026-03-15', views: 1842, rating: 4.8, tags: ['zero-trust', 'network', 'identity'], summary: 'Comprehensive guide for implementing zero trust principles across enterprise infrastructure', readTime: '15 min'},
    {id: 'kb-budget-planner-002', title: 'Ransomware Defense Playbook 2026', category: 'Threats', author: 'Threat Intelligence Team', publishDate: '2026-04-01', views: 2341, rating: 4.9, tags: ['ransomware', 'incident-response', 'defense'], summary: 'Updated playbook with latest ransomware tactics, techniques, and defensive measures', readTime: '12 min'},
    {id: 'kb-budget-planner-003', title: 'Cloud Security Best Practices for Multi-Cloud', category: 'Cloud', author: 'Cloud Security Team', publishDate: '2026-02-28', views: 1567, rating: 4.5, tags: ['cloud', 'aws', 'azure', 'gcp'], summary: 'Best practices for securing workloads across multiple cloud service providers', readTime: '18 min'},
    {id: 'kb-budget-planner-004', title: 'API Security Testing Methodology', category: 'Testing', author: 'Red Team', publishDate: '2026-03-22', views: 987, rating: 4.6, tags: ['api', 'testing', 'owasp'], summary: 'Structured methodology for identifying and testing API security vulnerabilities', readTime: '10 min'},
    {id: 'kb-budget-planner-005', title: 'Supply Chain Security Risk Management', category: 'Third Party', author: 'GRC Team', publishDate: '2026-01-20', views: 1234, rating: 4.3, tags: ['supply-chain', 'vendor', 'risk'], summary: 'Framework for managing security risks in the software supply chain', readTime: '14 min'},
    {id: 'kb-budget-planner-006', title: 'Kubernetes Security Hardening Checklist', category: 'Container', author: 'Platform Security', publishDate: '2026-04-10', views: 2103, rating: 4.7, tags: ['kubernetes', 'container', 'hardening'], summary: 'Step-by-step hardening checklist for production Kubernetes clusters', readTime: '11 min'},
    {id: 'kb-budget-planner-007', title: 'Security Metrics That Matter for Executives', category: 'Metrics', author: 'CISO Office', publishDate: '2026-03-05', views: 876, rating: 4.4, tags: ['metrics', 'kpi', 'reporting'], summary: 'Key security metrics and KPIs that resonate with board-level stakeholders', readTime: '8 min'},
    {id: 'kb-budget-planner-008', title: 'Phishing Simulation Campaign Design', category: 'Awareness', author: 'Security Awareness Team', publishDate: '2026-02-15', views: 1456, rating: 4.5, tags: ['phishing', 'simulation', 'training'], summary: 'Designing effective phishing simulations that drive real behavioral change', readTime: '9 min'},
    {id: 'kb-budget-planner-009', title: 'Data Loss Prevention Strategy and Implementation', category: 'Data Protection', author: 'Data Security Team', publishDate: '2026-03-28', views: 1678, rating: 4.6, tags: ['dlp', 'data-protection', 'compliance'], summary: 'Strategic approach to DLP covering people, process, and technology layers', readTime: '16 min'},
    {id: 'kb-budget-planner-010', title: 'Security Automation with SOAR Platforms', category: 'Automation', author: 'SOC Engineering', publishDate: '2026-04-05', views: 1098, rating: 4.7, tags: ['soar', 'automation', 'soc'], summary: 'Building effective security automation playbooks using SOAR technology', readTime: '13 min'},
    {id: 'kb-budget-planner-011', title: 'Third-Party Risk Assessment Framework', category: 'GRC', author: 'Vendor Management', publishDate: '2026-01-30', views: 1345, rating: 4.4, tags: ['vendor', 'risk', 'assessment'], summary: 'Structured framework for evaluating and monitoring third-party security risks', readTime: '12 min'},
    {id: 'kb-budget-planner-012', title: 'Network Detection and Response Best Practices', category: 'Network', author: 'Network Security Team', publishDate: '2026-03-18', views: 1567, rating: 4.5, tags: ['ndr', 'network', 'detection'], summary: 'Implementing effective network detection and response capabilities', readTime: '14 min'},
    {id: 'kb-budget-planner-013', title: 'Security Chaos Engineering Guide', category: 'Resilience', author: 'SRE Security', publishDate: '2026-04-12', views: 789, rating: 4.3, tags: ['chaos-engineering', 'resilience', 'testing'], summary: 'Applying chaos engineering principles to validate security controls', readTime: '10 min'},
    {id: 'kb-budget-planner-014', title: 'Incident Communication Templates', category: 'Incident Response', author: 'IR Team', publishDate: '2026-02-22', views: 2234, rating: 4.8, tags: ['incident', 'communication', 'templates'], summary: 'Ready-to-use communication templates for security incident scenarios', readTime: '7 min'},
    {id: 'kb-budget-planner-015', title: 'Endpoint Detection and Response Configuration', category: 'Endpoint', author: 'Endpoint Security', publishDate: '2026-03-08', views: 1345, rating: 4.5, tags: ['edr', 'endpoint', 'configuration'], summary: 'Optimal EDR configuration for maximum detection with minimal false positives', readTime: '11 min'},
    {id: 'kb-budget-planner-016', title: 'Security Code Review Standards', category: 'Development', author: 'AppSec Team', publishDate: '2026-02-10', views: 1890, rating: 4.6, tags: ['code-review', 'secure-sdlc', 'standards'], summary: 'Standards and checklists for security-focused code reviews', readTime: '13 min'},
    {id: 'kb-budget-planner-017', title: 'IoT Security Assessment Methodology', category: 'IoT', author: 'IoT Security Lab', publishDate: '2026-04-08', views: 654, rating: 4.2, tags: ['iot', 'embedded', 'assessment'], summary: 'Methodology for assessing security posture of IoT devices and ecosystems', readTime: '15 min'},
    {id: 'kb-budget-planner-018', title: 'Passwordless Authentication Migration Guide', category: 'Identity', author: 'IAM Team', publishDate: '2026-03-25', views: 1678, rating: 4.7, tags: ['passwordless', 'authentication', 'mfa'], summary: 'Step-by-step migration plan from password-based to passwordless authentication', readTime: '12 min'},
    {id: 'kb-budget-planner-019', title: 'Security Awareness Program Metrics', category: 'Awareness', author: 'Security Culture Team', publishDate: '2026-01-25', views: 1123, rating: 4.4, tags: ['awareness', 'metrics', 'culture'], summary: 'Measuring the effectiveness of your security awareness and training programs', readTime: '9 min'},
    {id: 'kb-budget-planner-020', title: 'Deception Technology Deployment Guide', category: 'Detection', author: 'Blue Team', publishDate: '2026-04-15', views: 876, rating: 4.5, tags: ['deception', 'honeypot', 'detection'], summary: 'Planning and deploying deception technology for advanced threat detection', readTime: '11 min'},
  ];
  ...
  // --- Security Scenario Planning Methods (BUPL) ---
  private _initBuplScenarios(): void {
    const worstCaseScenarios = [
      { id: "bupl-sc-01", name: "Ransomware Attack on Critical Infrastructure", category: "Malware", impact: 9500000, probability: 0.12, recoveryDays: 21, affectedSystems: 47, dataLossGb: 320, businessImpact: "critical" },
      { id: "bupl-sc-02", name: "Insider Data Exfiltration via Authorized Channels", category: "Insider Threat", impact: 7200000, probability: 0.18, recoveryDays: 14, affectedSystems: 12, dataLossGb: 85, businessImpact: "high" },
      { id: "bupl-sc-03", name: "Supply Chain Compromise via Third-Party Library", category: "Supply Chain", impact: 6800000, probability: 0.09, recoveryDays: 30, affectedSystems: 63, dataLossGb: 0, businessImpact: "critical" },
      { id: "bupl-sc-04", name: "Cloud Misconfiguration Leading to Public Exposure", category: "Cloud", impact: 4100000, probability: 0.22, recoveryDays: 7, affectedSystems: 8, dataLossGb: 450, businessImpact: "high" },
      { id: "bupl-sc-05", name: "Zero-Day Exploit in Core Application Framework", category: "Vulnerability", impact: 8900000, probability: 0.05, recoveryDays: 45, affectedSystems: 120, dataLossGb: 0, businessImpact: "critical" },
      { id: "bupl-sc-06", name: "Distributed Denial of Service on Customer-Facing Services", category: "Availability", impact: 3400000, probability: 0.25, recoveryDays: 3, affectedSystems: 15, dataLossGb: 0, businessImpact: "medium" },
      { id: "bupl-sc-07", name: "Credential Stuffing and Account Takeover Wave", category: "Identity", impact: 2800000, probability: 0.30, recoveryDays: 5, affectedSystems: 6, dataLossGb: 12, businessImpact: "medium" },
      { id: "bupl-sc-08", name: "Physical Security Breach at Data Center Facility", category: "Physical", impact: 12000000, probability: 0.02, recoveryDays: 60, affectedSystems: 200, dataLossGb: 5000, businessImpact: "critical" },
    ];
    this._buplScenarios = worstCaseScenarios.map(s => ({ ...s, mitigationCost: Math.round(s.impact * 0.08), drillScheduled: false, lastDrillDate: null, drillScore: null, controlGaps: Math.floor(Math.random() * 5) + 1 }));
  }

  private _calculateBuplScenarioRisk(): void {
    this._buplScenarios.forEach(s => {
  ...
  private _scheduleBuplDrills(): void {
  ...
  private _buplScenarioComparison(): Record<string, unknown>[] {
    return this._buplScenarios.map(s => ({
  ...
  // --- Security Control Effectiveness Analytics (BUPL) ---
  private _initBuplControls(): void {
    const controls = [
      { id: "bupl-ct-01", name: "Network Segmentation", type: "preventive", maturity: "defined", score: 82, target: 90, failures: 3, lastTest: "2026-03-15" },
      { id: "bupl-ct-02", name: "Endpoint Detection and Response", type: "detective", maturity: "managed", score: 88, target: 92, failures: 1, lastTest: "2026-04-01" },
      { id: "bupl-ct-03", name: "Data Loss Prevention", type: "preventive", maturity: "repeatable", score: 71, target: 85, failures: 7, lastTest: "2026-03-22" },
      { id: "bupl-ct-04", name: "Security Information and Event Management", type: "detective", maturity: "managed", score: 85, target: 90, failures: 2, lastTest: "2026-04-05" },
      { id: "bupl-ct-05", name: "Identity and Access Management", type: "preventive", maturity: "defined", score: 76, target: 88, failures: 5, lastTest: "2026-03-28" },
      { id: "bupl-ct-06", name: "Vulnerability Management", type: "corrective", maturity: "managed", score: 80, target: 90, failures: 4, lastTest: "2026-04-02" },
      { id: "bupl-ct-07", name: "Email Security Gateway", type: "preventive", maturity: "managed", score: 90, target: 95, failures: 1, lastTest: "2026-04-08" },
      { id: "bupl-ct-08", name: "Web Application Firewall", type: "preventive", maturity: "managed", score: 87, target: 92, failures: 2, lastTest: "2026-03-30" },
      { id: "bupl-ct-09", name: "Patch Management", type: "corrective", maturity: "defined", score: 68, target: 85, failures: 9, lastTest: "2026-03-18" },
      { id: "bupl-ct-10", name: "Encryption at Rest", type: "preventive", maturity: "managed", score: 93, target: 95, failures: 0, lastTest: "2026-04-10" },
      { id: "bupl-ct-11", name: "Encryption in Transit", type: "preventive", maturity: "optimized", score: 96, target: 98, failures: 0, lastTest: "2026-04-12" },
      { id: "bupl-ct-12", name: "Privileged Access Management", type: "preventive", maturity: "defined", score: 74, target: 88, failures: 6, lastTest: "2026-03-25" },
      { id: "bupl-ct-13", name: "Security Awareness Training", type: "preventive", maturity: "repeatable", score: 65, target: 80, failures: 11, lastTest: "2026-03-20" },
      { id: "bupl-ct-14", name: "Incident Response Plan", type: "corrective", maturity: "managed", score: 78, target: 88, failures: 4, lastTest: "2026-04-03" },
      { id: "bupl-ct-15", name: "Backup and Recovery", type: "corrective", maturity: "managed", score: 84, target: 92, failures: 3, lastTest: "2026-04-06" },
      { id: "bupl-ct-16", name: "Multi-Factor Authentication", type: "preventive", maturity: "managed", score: 91, target: 95, failures: 1, lastTest: "2026-04-09" },
      { id: "bupl-ct-17", name: "Network Traffic Analysis", type: "detective", maturity: "defined", score: 72, target: 85, failures: 5, lastTest: "2026-03-27" },
      { id: "bupl-ct-18", name: "Cloud Security Posture Management", type: "detective", maturity: "repeatable", score: 69, target: 82, failures: 8, lastTest: "2026-03-24" },
      { id: "bupl-ct-19", name: "Container Security Scanning", type: "preventive", maturity: "defined", score: 75, target: 85, failures: 5, lastTest: "2026-04-04" },
      { id: "bupl-ct-20", name: "API Security Gateway", type: "preventive", maturity: "repeatable", score: 70, target: 82, failures: 7, lastTest: "2026-03-29" },
      { id: "bupl-ct-21", name: "Threat Intelligence Platform", type: "detective", maturity: "managed", score: 83, target: 90, failures: 2, lastTest: "2026-04-07" },
      { id: "bupl-ct-22", name: "Database Activity Monitoring", type: "detective", maturity: "defined", score: 67, target: 80, failures: 8, lastTest: "2026-03-21" },
      { id: "bupl-ct-23", name: "Deception Technology", type: "detective", maturity: "initial", score: 55, target: 75, failures: 12, lastTest: "2026-03-16" },
      { id: "bupl-ct-24", name: "Security Orchestration Automation", type: "corrective", maturity: "repeatable", score: 73, target: 85, failures: 6, lastTest: "2026-04-01" },
      { id: "bupl-ct-25", name: "Third-Party Risk Assessment", type: "preventive", maturity: "defined", score: 64, target: 78, failures: 9, lastTest: "2026-03-19" },
    ];
    this._buplControls = controls;
  }

  private _analyzeBuplControlEffectiveness(): void {
    const typeBreakdown: Record<string, { total: number; avgScore: number; avgFailures: number }> = {};
    this._buplControls.forEach(c => {
    ...
    this._buplControlTypeBreakdown = typeBreakdown;
  }

  private _buplControlOptimization(): Record<string, unknown>[] {
    return this._buplControls.filter(c => c.score < c.target).map(c => ({
  ...
  // --- Security Data Pipeline Health (BUPL) ---
  private _initBuplPipelines(): void {
    const pipelines = [
      { id: "bupl-pl-01", name: "SIEM Log Ingestion", status: "healthy", healthScore: 94, latencyMs: 120, freshnessMin: 2, errorRate: 0.02, throughputMbps: 450, recordsPerSec: 12000, backPressure: 0.05, uptime: 99.97 },
      { id: "bupl-pl-02", name: "Threat Feed Aggregation", status: "healthy", healthScore: 91, latencyMs: 300, freshnessMin: 15, errorRate: 0.05, throughputMbps: 85, recordsPerSec: 3200, backPressure: 0.08, uptime: 99.92 },
      { id: "bupl-pl-03", name: "Vulnerability Scan Results", status: "degraded", healthScore: 72, latencyMs: 2500, freshnessMin: 60, errorRate: 0.15, throughputMbps: 25, recordsPerSec: 800, backPressure: 0.35, uptime: 98.50 },
      { id: "bupl-pl-04", name: "Endpoint Telemetry Stream", status: "healthy", healthScore: 88, latencyMs: 450, freshnessMin: 5, errorRate: 0.08, throughputMbps: 280, recordsPerSec: 8500, backPressure: 0.12, uptime: 99.85 },
      { id: "bupl-pl-05", name: "Cloud Audit Log Pipeline", status: "healthy", healthScore: 86, latencyMs: 600, freshnessMin: 10, errorRate: 0.06, throughputMbps: 150, recordsPerSec: 4500, backPressure: 0.10, uptime: 99.80 },
      { id: "bupl-pl-06", name: "Identity Event Stream", status: "warning", healthScore: 78, latencyMs: 1200, freshnessMin: 20, errorRate: 0.12, throughputMbps: 45, recordsPerSec: 1500, backPressure: 0.22, uptime: 99.40 },
      { id: "bupl-pl-07", name: "Network Flow Collection", status: "healthy", healthScore: 82, latencyMs: 800, freshnessMin: 8, errorRate: 0.09, throughputMbps: 650, recordsPerSec: 18000, backPressure: 0.15, uptime: 99.70 },
      { id: "bupl-pl-08", name: "DLP Incident Pipeline", status: "degraded", healthScore: 68, latencyMs: 3500, freshnessMin: 45, errorRate: 0.20, throughputMbps: 18, recordsPerSec: 500, backPressure: 0.42, uptime: 97.80 },
    ];
    this._buplPipelines = pipelines.map(p => ({ ...p, dependencies: [], slaBreached: p.healthScore < 75, alertThreshold: p.errorRate > 0.15 }));
    this._buplPipelines[0].dependencies = ["bupl-pl-04", "bupl-pl-07"];
    this._buplPipelines[4].dependencies = ["bupl-pl-01"];
    this._buplPipelines[5].dependencies = ["bupl-pl-02"];
    this._buplPipelines[7].dependencies = ["bupl-pl-04", "bupl-pl-05"];
  }

  private _buplPipelineTrend(): Record<string, unknown>[] {
    const hours = Array.from({ length: 24 }, (_, i) => `H${String(i).padStart(2, "0")}`);
    return this._buplPipelines.map(p => ({
  ...
  // --- Security Stakeholder Report Generator (BUPL) ---
  private _initBuplReportTemplates(): void {
    this._buplReportTemplates = [
      { id: "bupl-rp-01", name: "Board Security Report", audience: "board", frequency: "quarterly", sections: 6, autoGenerate: true, lastGenerated: "2026-03-31", pages: 12 },
      { id: "bupl-rp-02", name: "Executive Risk Summary", audience: "executive", frequency: "monthly", sections: 8, autoGenerate: true, lastGenerated: "2026-04-01", pages: 8 },
      { id: "bupl-rp-03", name: "Technical Security Review", audience: "technical", frequency: "weekly", sections: 12, autoGenerate: true, lastGenerated: "2026-04-21", pages: 25 },
      { id: "bupl-rp-04", name: "Audit Compliance Report", audience: "audit", frequency: "quarterly", sections: 10, autoGenerate: false, lastGenerated: "2026-03-15", pages: 35 },
      { id: "bupl-rp-05", name: "Regulatory Filing Package", audience: "regulatory", frequency: "annual", sections: 15, autoGenerate: false, lastGenerated: "2025-12-31", pages: 48 },
    ];
  }

  private _generateBuplExecSummary(): string {
    const totalRisk = this._buplScenarios.reduce((sum: number, s: any) => sum + s.riskScore, 0);
    const avgControl = Math.round(this._buplControls.reduce((sum: number, c: any) => sum + c.score, 0) / this._buplControls.length);
    const degradedPipes = this._buplPipelines.filter((p: any) => p.status !== "healthy").length;
    return `Overall risk exposure: ${(totalRisk / 1000000).toFixed(1)}M. Average control effectiveness: {avgControl}%. {degradedPipes} pipeline(s) need attention. {this._buplScenarios.filter((s: any) => s.mitigationPriority === "immediate").length} scenarios require immediate action.`;
  }

  // --- Security Technology Radar (BUPL) ---
  private _initBuplTechRadar(): void {
    this._buplTechRadar = [
      { id: "bupl-tr-01", name: "AI-Powered Threat Detection", ring: "adopt", category: "Detection", maturity: 4, trend: "up", investment: "high", roi: 3.2, vendorCount: 8 },
      { id: "bupl-tr-02", name: "Zero Trust Architecture", ring: "adopt", category: "Architecture", maturity: 4, trend: "up", investment: "high", roi: 2.8, vendorCount: 12 },
      { id: "bupl-tr-03", name: "SASE/SSE Platform", ring: "trial", category: "Network", maturity: 3, trend: "up", investment: "medium", roi: 2.4, vendorCount: 10 },
      { id: "bupl-tr-04", name: "CNAPP Cloud Security", ring: "trial", category: "Cloud", maturity: 3, trend: "up", investment: "medium", roi: 2.1, vendorCount: 7 },
      { id: "bupl-tr-05", name: "Extended Detection and Response", ring: "adopt", category: "Detection", maturity: 4, trend: "stable", investment: "high", roi: 2.9, vendorCount: 9 },
      { id: "bupl-tr-06", name: "Quantum-Safe Cryptography", ring: "assess", category: "Crypto", maturity: 2, trend: "up", investment: "low", roi: 0.8, vendorCount: 4 },
      { id: "bupl-tr-07", name: "Security Service Edge", ring: "trial", category: "Network", maturity: 3, trend: "up", investment: "medium", roi: 2.0, vendorCount: 6 },
      { id: "bupl-tr-08", name: "SOAR 2.0 Autonomous SOC", ring: "assess", category: "Operations", maturity: 2, trend: "up", investment: "low", roi: 1.2, vendorCount: 5 },
      { id: "bupl-tr-09", name: "Software Supply Chain Security", ring: "trial", category: "DevSecOps", maturity: 3, trend: "up", investment: "medium", roi: 2.3, vendorCount: 8 },
      { id: "bupl-tr-10", name: "Identity Threat Detection", ring: "adopt", category: "Identity", maturity: 3, trend: "up", investment: "high", roi: 2.7, vendorCount: 7 },
      { id: "bupl-tr-11", name: "Data Security Posture Management", ring: "trial", category: "Data", maturity: 3, trend: "up", investment: "medium", roi: 2.2, vendorCount: 9 },
      { id: "bupl-tr-12", name: "Decentralized Identity Standards", ring: "hold", category: "Identity", maturity: 1, trend: "stable", investment: "low", roi: 0.5, vendorCount: 3 },
    ];
  }

  private _buplRadarSummary(): Record<string, unknown> {
    const rings: Record<string, number> = { adopt: 0, trial: 0, assess: 0, hold: 0 };
    this._buplTechRadar.forEach(t => { if (rings[t.ring as keyof typeof rings] !== undefined) rings[t.ring as keyof typeof rings]++; });
    return { adopt: rings.adopt, trial: rings.trial, assess: rings.assess, hold: rings.hold, total: this._buplTechRadar.length, avgMaturity: 2.8, topInvestment: this._buplTechRadar.filter(t => t.investment === "high").map(t => t.name) };
  }

  // --- BUPL Security Compliance Mapping Matrix ---
  private _initBuplComplianceMatrix(): void {
    ...
    this._buplComplianceMatrix = frameworks.map(fw => ({
  ...
  private _buplComplianceTrend(): Record<string, unknown>[] {
    const quarters = ["Q1-2025", "Q2-2025", "Q3-2025", "Q4-2025", "Q1-2026", "Q2-2026"];
    return this._buplComplianceMatrix.map(fw => ({
  ...
  // --- BUPL Threat Intelligence Correlation Engine ---
  private _initBuplThreatIntel(): void {
    ...
    this._buplThreatIntel = threatActors.map((actor, i) => ({
  ...
  private _buplThreatCorrelation(): Record<string, unknown>[] {
    return this._buplThreatIntel.filter(t => t.riskScore > 70).map(t => ({
  ...
  // --- BUPL Security Metrics Deep Dive ---
  private _initBuplMetricsDeep(): void {
    ...
    this._buplMetricsDeep = metricCategories.map(cat => ({
  ...
  private _buplMetricsHeatmap(): number[][] {
    return this._buplMetricsDeep.map(cat =>
      cat.metrics.map(m => Math.round((m.value / m.target) * 100))
    );
  }

  // --- BUPL Incident Cost Modeling ---
  private _initBuplCostModel(): void {
    const incidentTypes = ["Data Breach", "Ransomware", "DDoS", "Insider Threat", "Phishing", "Supply Chain", "Cloud Misconfig", "Zero-Day"];
    this._buplCostModel = incidentTypes.map(inc => ({
    ...
    this._buplCostModel.forEach(m => { m.totalAnnualExposure = m.avgCost * m.frequency; });
  }

  private _buplCostProjection(): Record<string, unknown>[] {
    return this._buplCostModel.map(m => ({
  ...
  // --- BUPL Security Architecture Pattern Library ---
  private _initBuplArchPatterns(): void {
    ...
    this._buplArchPatterns = patterns.map((p, i) => ({
  ...
  private _buplArchPatternAnalysis(): Record<string, unknown> {
    const implemented = this._buplArchPatterns.filter(p => p.implementation > 75).length;
    const avgCoverage = Math.round(this._buplArchPatterns.reduce((s: number, p: any) => s + p.coverage, 0) / this._buplArchPatterns.length);
    return {
      totalPatterns: this._buplArchPatterns.length, fullyImplemented: implemented, avgCoverage,
      avgRiskReduction: Math.round(this._buplArchPatterns.reduce((s: number, p: any) => s + p.riskReduction, 0) / this._buplArchPatterns.length),
      gaps: this._buplArchPatterns.filter(p => p.implementation < 60).map(p => p.pattern),
      recommendations: this._buplArchPatterns.filter(p => p.implementation < 70).map(p => ({ pattern: p.pattern, current: p.implementation, target: 85, effort: p.costComplexity }))
    };
  }
  ...
  private _fd0RiskAssessmentWorkflow = [
  ...
  private _fd0TreatmentOptions = [
    {id: 'fd0-T-001', riskId: 'RSK-042', risk: 'Ransomware Attack on Critical Infrastructure', before: 20, after: 6, strategy: 'Mitigate', controls: ['Next-gen EDR with behavioral detection and automated response', 'Zero-trust network micro-segmentation isolating critical assets', 'Immutable offline backup rotation with quarterly recovery testing', 'Incident response retainer with 1-hour response SLA'], cost: '$450K/yr', roi: '78% reduction vs $2.8M potential loss', timeline: 'Q3 2026', status: 'approved' as const},
  ...
  private _fd0TalentPositions = [
    ...
    {id: 'fd0-H-002', title: 'Cloud Security Engineer', dept: 'Cloud Security', level: 'Mid-Senior', loc: 'SF/Remote', salary: '$155K-$180K', posted: '2026-03-20', applicants: 45, pipeline: 12, interviews: 6, offers: 2, urgency: 'high' as const, manager: 'Mike Johnson', skills: ['AWS/Azure/GCP', 'Terraform', 'Kubernetes', 'IAM', 'CSPM'], nice: ['CCSP', 'CKS', 'Serverless']},
    {id: 'fd0-H-003', title: 'SOC Analyst L2', dept: 'Security Operations', level: 'Mid', loc: 'Austin TX', salary: '$105K-$130K', posted: '2026-04-01', applicants: 67, pipeline: 18, interviews: 8, offers: 0, urgency: 'medium' as const, manager: 'Lisa Park', skills: ['SIEM', 'Incident triage', 'Malware analysis', 'TCP/IP'], nice: ['GCIA', 'SOAR', 'Kill chain']},
    {id: 'fd0-H-004', title: 'Staff Security Architect', dept: 'Architecture', level: 'Staff', loc: 'Remote US', salary: '$200K-$240K', posted: '2026-02-28', applicants: 12, pipeline: 3, interviews: 2, offers: 0, urgency: 'critical' as const, manager: 'David Lee', skills: ['Enterprise arch', 'Zero trust', 'Risk frameworks', 'Board comms'], nice: ['CISSP+SABSA', 'Team building', 'Speaker']},
    {id: 'fd0-H-005', title: 'GRC Analyst', dept: 'GRC', level: 'Mid', loc: 'NY/Remote', salary: '$110K-$135K', posted: '2026-04-05', applicants: 34, pipeline: 9, interviews: 3, offers: 1, urgency: 'medium' as const, manager: 'Rachel Green', skills: ['ISO 27001', 'SOC 2', 'Risk assessment', 'Audit'], nice: ['CRISC', 'CISA', 'GDPR']},
    {id: 'fd0-H-006', title: 'Threat Intel Analyst', dept: 'Threat Intel', level: 'Mid-Senior', loc: 'Remote US', salary: '$140K-$170K', posted: '2026-03-25', applicants: 19, pipeline: 5, interviews: 2, offers: 0, urgency: 'low' as const, manager: 'James Wilson', skills: ['MITRE ATT&CK', 'OSINT', 'Threat modeling', 'Reverse eng'], nice: ['CTIA', 'Nation-state', 'Dark web']},
    {id: 'fd0-H-007', title: 'AppSec Engineer', dept: 'AppSec', level: 'Senior', loc: 'Seattle/Remote', salary: '$160K-$190K', posted: '2026-04-10', applicants: 28, pipeline: 7, interviews: 3, offers: 0, urgency: 'medium' as const, manager: 'Emily Zhang', skills: ['SAST/DAST/SCA', 'Secure SDLC', 'Code review', 'CI/CD'], nice: ['CSSLP', 'Mobile security']},
    {id: 'fd0-H-008', title: 'IAM Engineer', dept: 'IAM', level: 'Mid', loc: 'Remote US', salary: '$135K-$160K', posted: '2026-04-08', applicants: 31, pipeline: 10, interviews: 5, offers: 1, urgency: 'medium' as const, manager: 'Chris Martinez', skills: ['Okta/Azure AD', 'SAML/OIDC', 'PAM', 'RBAC'], nice: ['CISSP', 'Zero trust IAM']}
  ];

  private _fd0InterviewScorecard = [
  ...
  private _fd0OnboardingSteps = [
    {id: 'fd0-OB-01', item: 'Provision security-hardened laptop, monitors, peripherals, and configured workstation image with all required security tools', cat: 'IT Setup', day: 'Day 1', owner: 'IT Operations'},
    {id: 'fd0-OB-02', item: 'Create AD account, email, Slack, VPN, SSO enrollment, and all required application access accounts', cat: 'Access', day: 'Day 1', owner: 'IAM Team'},
    {id: 'fd0-OB-03', item: 'Grant security tooling access: SIEM console, EDR dashboard, vuln scanner, pentest platforms, SOAR', cat: 'Tools', day: 'Day 1-2', owner: 'SOC Manager'},
    {id: 'fd0-OB-04', item: 'Complete MFA enrollment, security awareness onboarding course, and acceptable use policy acknowledgment', cat: 'Security', day: 'Day 1', owner: 'Awareness Team'},
    {id: 'fd0-OB-05', item: 'Sign NDA, employment agreement, IP assignment, and code of conduct documents with HR', cat: 'HR', day: 'Day 1', owner: 'Human Resources'},
    {id: 'fd0-OB-06', item: 'Introduction meetings with direct team members and key cross-functional stakeholders', cat: 'Integration', day: 'Week 1', owner: 'Hiring Manager'},
    {id: 'fd0-OB-07', item: 'Security architecture overview, tooling walkthrough, and operational runbook review sessions', cat: 'Training', day: 'Week 1-2', owner: 'Security Architect'},
    {id: 'fd0-OB-08', item: 'Shadow experienced team member on active incident response and threat hunting investigations', cat: 'Mentoring', day: 'Week 2-3', owner: 'SOC Lead'},
    {id: 'fd0-OB-09', item: 'Set up individual certification study plan aligned with role requirements and career goals', cat: 'Development', day: 'Week 2', owner: 'Hiring Manager'},
    {id: 'fd0-OB-10', item: 'Establish 30-60-90 day goals, define success metrics, and schedule first performance checkpoint', cat: 'Goals', day: 'Week 1', owner: 'Hiring Manager'}
  ];

  private _fd0MetricsDashboard = [
    {id: 'fd0-MTD-001', name: 'Mean Time to Detect (MTTD)', value: '4.2 hours', trend: 'improving' as const, target: '< 4 hours', source: 'SIEM - Splunk', method: 'Median time from first alert to analyst acknowledgment', owner: 'SOC Manager', sla: '4 hours', prev: '5.1 hours', spark: [5.8, 5.4, 5.1, 4.9, 4.7, 4.5, 4.3, 4.2], breakdown: [{src: 'Network IDS', pct: '35%', avg: '3.8h'}, {src: 'Endpoint EDR', pct: '28%', avg: '4.1h'}, {src: 'Email Gateway', pct: '22%', avg: '3.5h'}, {src: 'Cloud Security', pct: '10%', avg: '5.2h'}, {src: 'User Reports', pct: '5%', avg: '6.8h'}]},
    {id: 'fd0-MTD-002', name: 'Mean Time to Respond (MTTR)', value: '2.8 hours', trend: 'stable' as const, target: '< 3 hours', source: 'SOAR - XSOAR', method: 'Median time from acknowledgment to first containment action', owner: 'IR Lead', sla: '3 hours', prev: '2.7 hours', spark: [3.2, 3.0, 2.9, 2.8, 2.8, 2.9, 2.8, 2.8], breakdown: [{src: 'Auto Playbooks', pct: '42%', avg: '1.2h'}, {src: 'Semi-Auto', pct: '33%', avg: '2.5h'}, {src: 'Manual', pct: '20%', avg: '5.1h'}, {src: 'L3 Escalation', pct: '5%', avg: '8.3h'}]},
    {id: 'fd0-MTD-003', name: 'Patch Compliance Rate', value: '97.6%', trend: 'improving' as const, target: '> 95%', source: 'Tenable.io', method: 'Pct of critical/high vulns patched within SLA windows', owner: 'Vuln Manager', sla: '95%', prev: '96.1%', spark: [93.2, 94.1, 94.8, 95.3, 95.9, 96.4, 97.0, 97.6], breakdown: [{src: 'Critical (7d)', pct: '40%', rate: '99.2%'}, {src: 'High (30d)', pct: '35%', rate: '97.8%'}, {src: 'Medium (90d)', pct: '20%', rate: '95.1%'}, {src: 'Low (180d)', pct: '5%', rate: '89.4%'}]},
    {id: 'fd0-MTD-004', name: 'Phishing Click Rate', value: '3.2%', trend: 'improving' as const, target: '< 5%', source: 'KnowBe4 + Proofpoint', method: 'Pct of users clicking simulated phishing links monthly', owner: 'Awareness Lead', sla: '5%', prev: '4.1%', spark: [6.8, 6.2, 5.5, 5.1, 4.6, 4.1, 3.6, 3.2], breakdown: [{src: 'Spear Phishing', pct: '35%', rate: '5.1%'}, {src: 'Generic Phishing', pct: '30%', rate: '2.8%'}, {src: 'BEC Sim', pct: '20%', rate: '3.5%'}, {src: 'SMS Phishing', pct: '15%', rate: '1.9%'}]},
    {id: 'fd0-MTD-005', name: 'Security Posture Score', value: '784', trend: 'improving' as const, target: '> 750', source: 'SecurityScorecard', method: 'Composite: external 30%, compliance 25%, vuln 25%, config 20%', owner: 'CISO', sla: '> 750', prev: '771', spark: [748, 752, 758, 762, 768, 773, 778, 784], breakdown: [{src: 'External Rating', pct: '30%', score: '791'}, {src: 'Compliance', pct: '25%', score: '812'}, {src: 'Vuln Mgmt', pct: '25%', score: '745'}, {src: 'Config', pct: '20%', score: '769'}]},
    {id: 'fd0-MTD-006', name: 'Vulnerability Backlog', value: '142', trend: 'improving' as const, target: '< 150', source: 'Tenable + Qualys', method: 'Total open vulns across all scanned assets tracked weekly', owner: 'Vuln Manager', sla: '< 150', prev: '168', spark: [210, 198, 185, 175, 165, 158, 150, 142], breakdown: [{src: 'Critical', pct: '8%', count: '11'}, {src: 'High', pct: '22%', count: '31'}, {src: 'Medium', pct: '45%', count: '64'}, {src: 'Low', pct: '25%', count: '36'}]}
  ];

  private _fd0ArchReview = [
    {id: 'fd0-AR-001', cat: 'Network', item: 'Network segmentation between trust zones with dedicated firewalls and granular ACLs', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Micro-segmentation via NSX across all production zones'},
    {id: 'fd0-AR-002', cat: 'Network', item: 'DMZ architecture isolating public services from internal network', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Dual-firewall DMZ with WAF and DDoS mitigation'},
    {id: 'fd0-AR-003', cat: 'Network', item: 'Least-privilege traffic flows with deny-by-default and quarterly review', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Explicit allow rules with automated drift detection'},
    {id: 'fd0-AR-004', cat: 'Network', item: 'Encrypted external communications with IPSec/TLS 1.3 and PFS', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'IKEv2 with PFS, TLS 1.3 for all external APIs'},
    {id: 'fd0-AR-005', cat: 'Identity', item: 'Centralized IdP with SSO and automated SCIM provisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Okta SSO SAML 2.0 for 247 apps with SCIM'},
    {id: 'fd0-AR-006', cat: 'Identity', item: 'RBAC with quarterly reviews and automated deprovisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Quarterly recertification with JIT admin access'},
    {id: 'fd0-AR-007', cat: 'Identity', item: 'PAM controlling all admin and service accounts with session recording', sev: 'high' as const, status: 'fail' as const, reviewer: 'IAM Lead', notes: '3 legacy accounts pending CyberArk enrollment'},
    {id: 'fd0-AR-008', cat: 'Identity', item: 'MFA enforced for all users, hardware tokens for privileged access', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'FIDO2 for admins, push MFA for users, 99.8% enrollment'},
    {id: 'fd0-AR-009', cat: 'Data', item: 'Data classification enforced with automated labeling on all repos', sev: 'high' as const, status: 'partial' as const, reviewer: 'Data Protection Lead', notes: 'Framework deployed, gaps on 4 legacy file shares'},
    {id: 'fd0-AR-010', cat: 'Data', item: 'AES-256 encryption at rest for all sensitive data stores', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'Full-disk, TDE on DBs, SSE-KMS on cloud storage'},
    {id: 'fd0-AR-011', cat: 'Data', item: 'DLP monitoring and preventing unauthorized data exfiltration', sev: 'high' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'DLP active on email, endpoint, cloud, and network'},
    {id: 'fd0-AR-012', cat: 'Data', item: 'Encrypted off-site backups with quarterly restore testing', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Infrastructure Lead', notes: '3-2-1 strategy with immutable backups'},
    {id: 'fd0-AR-013', cat: 'AppSec', item: 'Secure SDLC with SAST, DAST, SCA in all CI/CD pipelines', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: '34 pipelines with security gates and PR blocking'},
    {id: 'fd0-AR-014', cat: 'AppSec', item: 'API gateway with auth, rate limiting, schema validation', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: 'Kong with OAuth2, rate limits, OpenAPI validation'},
    {id: 'fd0-AR-015', cat: 'AppSec', item: 'Container security with image scanning and runtime protection', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Trivy scanning, Falco runtime in 80% of clusters'},
    {id: 'fd0-AR-016', cat: 'Monitoring', item: 'SIEM collecting from all critical systems with correlation rules', sev: 'critical' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'Splunk 98% coverage with 1200+ correlation rules'},
    {id: 'fd0-AR-017', cat: 'Monitoring', item: 'EDR with behavioral detection on all managed endpoints', sev: 'high' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'CrowdStrike on 99.2% endpoints with 24/7 MDR'},
    {id: 'fd0-AR-018', cat: 'Monitoring', item: 'Executive dashboards with real-time posture visibility', sev: 'medium' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'PowerBI dashboards with weekly exec summaries'},
    {id: 'fd0-AR-019', cat: 'Cloud', item: 'CSPM monitoring and remediating cloud misconfigurations', sev: 'high' as const, status: 'pass' as const, reviewer: 'Cloud Security Lead', notes: 'Prisma Cloud 450+ checks with auto-remediation'},
    {id: 'fd0-AR-020', cat: 'Cloud', item: 'IaC templates scanned before deployment to production', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Checkov for Terraform, cfn-nag for CloudFormation pending'}
  ];

  private _getfd0RiskProgress(): number {
    return Math.round(this._fd0RiskAssessmentWorkflow.filter(s => s.status === 'completed').length / this._fd0RiskAssessmentWorkflow.length * 100);
  }

  private _getfd0TreatmentSummary(): {total: number; approved: number; avgReduction: number; investment: string} {
    const a = this._fd0TreatmentOptions.filter(r => r.status === 'approved').length;
    const avg = this._fd0TreatmentOptions.reduce((s, r) => s + ((r.before - r.after) / r.before * 100), 0) / this._fd0TreatmentOptions.length;
    return {total: this._fd0TreatmentOptions.length, approved: a, avgReduction: Math.round(avg), investment: '$1.125M annually'};
  }

  private _getfd0RuleSummary(): {total: number; passing: number; failing: number; avgRate: number; violations: number} {
    const p = this._fd0ComplianceRules.filter(r => r.result === 'pass').length;
    const f = this._fd0ComplianceRules.filter(r => r.result === 'fail').length;
    const avg = this._fd0ComplianceRules.reduce((s, r) => s + r.passRate, 0) / this._fd0ComplianceRules.length;
    const v = this._fd0ComplianceRules.reduce((s, r) => s + r.violations, 0);
    return {total: this._fd0ComplianceRules.length, passing: p, failing: f, avgRate: Math.round(avg * 10) / 10, violations: v};
  }

  private _getfd0PipelineStats(): {positions: number; applicants: number; interviewing: number; offers: number; critical: number} {
    const t = this._fd0TalentPositions.length;
    const a = this._fd0TalentPositions.reduce((s, p) => s + p.applicants, 0);
    const i = this._fd0TalentPositions.reduce((s, p) => s + p.interviews, 0);
    const o = this._fd0TalentPositions.reduce((s, p) => s + p.offers, 0);
    const c = this._fd0TalentPositions.filter(x => x.urgency === 'critical').length;
    return {positions: t, applicants: a, interviewing: i, offers: o, critical: c};
  }

  private _getfd0MetricTrends(): {improving: number; stable: number; total: number} {
    const imp = this._fd0MetricsDashboard.filter(m => m.trend === 'improving').length;
    const stb = this._fd0MetricsDashboard.filter(m => m.trend === 'stable').length;
    return {improving: imp, stable: stb, total: this._fd0MetricsDashboard.length};
  }

  private _getfd0ArchScore(): {total: number; passed: number; failed: number; partial: number; score: number} {
    const p = this._fd0ArchReview.filter(c => c.status === 'pass').length;
    const f = this._fd0ArchReview.filter(c => c.status === 'fail').length;
    const pa = this._fd0ArchReview.filter(c => c.status === 'partial').length;
    return {total: this._fd0ArchReview.length, passed: p, failed: f, partial: pa, score: Math.round((p / this._fd0ArchReview.length) * 100)};
  }


  private _zfd0IncidentScenarios = [
    {id: 'zfd0-IS-001', name: 'Ransomware Outbreak in Production Environment', category: 'Malware', likelihood: 'Medium', impact: 'Critical', riskScore: 15, playbooks: ['IR-Ransomware-Isolate', 'IR-Ransomware-Eradicate', 'IR-Ransomway-Recover'], estimatedMTTD: '15min', estimatedMTTR: '4h', involvedTeams: ['SOC', 'IR', 'Infrastructure', 'Legal', 'Comms'], keyIndicators: ['Mass file encryption events', 'Ransom note deployment', 'Lateral movement via SMB/RDP', 'Backup deletion attempts'], mitigationControls: ['EDR behavioral detection', 'Network segmentation', 'Immutable backups', 'Email filtering'], lessonsLearned: 'Ensure offline backups are tested quarterly and Ransomware-specific playbooks are updated with latest threat intelligence', lastDrillDate: '2026-03-15', nextDrillDate: '2026-06-15'},
    {id: 'zfd0-IS-002', name: 'Cloud Misconfiguration Leading to Data Exposure', category: 'Cloud', likelihood: 'High', impact: 'High', riskScore: 16, playbooks: ['IR-Cloud-Misconfig-Assess', 'IR-Cloud-Misconfig-Remediate', 'IR-Cloud-Misconfig-Notify'], estimatedMTTD: '2h', estimatedMTTR: '6h', involvedTeams: ['Cloud Security', 'SOC', 'Data Protection', 'Legal'], keyIndicators: ['Public S3 bucket exposure', 'Overly permissive IAM policies', 'Unencrypted database snapshots', 'Public API endpoint discovery'], mitigationControls: ['CSPM monitoring', 'IAM policy analyzer', 'Automated remediation', 'Cloud audit logging'], lessonsLearned: 'Implement CSPM with auto-remediation for common misconfigurations and conduct monthly cloud configuration reviews', lastDrillDate: '2026-02-20', nextDrillDate: '2026-05-20'},
    {id: 'zfd0-IS-003', name: 'Insider Threat Data Exfiltration', category: 'Insider', likelihood: 'Low', impact: 'Critical', riskScore: 12, playbooks: ['IR-Insider-Investigate', 'IR-Insider-Contain', 'IR-Insider-Escalate'], estimatedMTTD: '8h', estimatedMTTR: '24h', involvedTeams: ['SOC', 'IR', 'HR', 'Legal', 'IAM'], keyIndicators: ['Anomalous data access patterns', 'Large file downloads to USB or cloud', 'Off-hours access to sensitive systems', 'Accessing data outside normal job scope'], mitigationControls: ['UEBA analytics', 'DLP policies', 'PAM controls', 'Access reviews'], lessonsLearned: 'Strengthen UEBA baselines and implement automated alerts for data access pattern anomalies', lastDrillDate: '2026-01-10', nextDrillDate: '2026-04-10'},
    {id: 'zfd0-IS-004', name: 'Supply Chain Attack via Compromised Vendor Software', category: 'Supply Chain', likelihood: 'Low', impact: 'Critical', riskScore: 12, playbooks: ['IR-SupplyChain-Detect', 'IR-SupplyChain-Isolate', 'IR-SupplyChain-Remediate'], estimatedMTTD: '24h', estimatedMTTR: '72h', involvedTeams: ['SOC', 'IR', 'Procurement', 'Vendor Mgmt', 'Legal'], keyIndicators: ['Unexpected network connections from vendor software', 'Modified binaries or dependencies', 'Anomalous behavior from trusted applications', 'SBOM discrepancy alerts'], mitigationControls: ['SCA scanning', 'SBOM monitoring', 'Vendor security assessments', 'Network segmentation'], lessonsLearned: 'Require SBOM from all vendors and implement continuous monitoring of third-party component behavior', lastDrillDate: '2026-03-01', nextDrillDate: '2026-06-01'},
    {id: 'zfd0-IS-005', name: 'Credential Stuffing Attack on Customer Portal', category: 'External Attack', likelihood: 'High', impact: 'Medium', riskScore: 12, playbooks: ['IR-CredentialStuffing-Detect', 'IR-CredentialStuffing-Block', 'IR-CredentialStuffing-Notify'], estimatedMTTD: '30min', estimatedMTTR: '2h', involvedTeams: ['SOC', 'AppSec', 'Customer Support', 'Comms'], keyIndicators: ['High volume of failed login attempts', 'Login attempts from known compromised credential lists', 'Unusual geographic distribution of login attempts', 'Account takeover indicators'], mitigationControls: ['WAF rate limiting', 'CAPTCHA on login', 'MFA enforcement', 'Credential monitoring service'], lessonsLearned: 'Deploy advanced bot detection on login endpoints and implement proactive credential monitoring for customer accounts', lastDrillDate: '2026-04-01', nextDrillDate: '2026-07-01'},
    {id: 'zfd0-IS-006', name: 'Phishing Campaign Targeting Executive Team', category: 'Social Engineering', likelihood: 'High', impact: 'High', riskScore: 16, playbooks: ['IR-Phishing-Contain', 'IR-Phishing-Investigate', 'IR-Phishing-Notify'], estimatedMTTD: '1h', estimatedMTTR: '4h', involvedTeams: ['SOC', 'Awareness', 'Executive Office', 'IT'], keyIndicators: ['Sophisticated spear-phishing emails to C-suite', 'Business email compromise indicators', 'Redirected MFA approval requests', 'Unauthorized wire transfer attempts'], mitigationControls: ['AI email filtering', 'Executive awareness training', 'Out-of-band verification policy', 'DMARC/DKIM/SPF'], lessonsLearned: 'Implement additional email security controls for executive mailboxes and conduct monthly spear-phishing simulations', lastDrillDate: '2026-02-15', nextDrillDate: '2026-05-15'}
  ];

  private _zfd0SecurityFrameworks = [
  ...
  private _getzfd0ScenarioSummary(): {total: number; critical: number; high: number; drilled: number; avgRiskScore: number} {
    const crit = this._zfd0IncidentScenarios.filter(s => s.impact === 'Critical').length;
    const high = this._zfd0IncidentScenarios.filter(s => s.impact === 'High').length;
    const avg = this._zfd0IncidentScenarios.reduce((s, x) => s + x.riskScore, 0) / this._zfd0IncidentScenarios.length;
    return {total: this._zfd0IncidentScenarios.length, critical: crit, high: high, drilled: this._zfd0IncidentScenarios.length, avgRiskScore: Math.round(avg)};
  }

  private _getzfd0VendorRiskSummary(): {total: number; approved: number; conditional: number; remediation: number; avgScore: number} {
    const approved = this._zfd0ThirdPartyRiskData.filter(v => v.status === 'approved').length;
    const cond = this._zfd0ThirdPartyRiskData.filter(v => v.status === 'conditional').length;
    const rem = this._zfd0ThirdPartyRiskData.filter(v => v.status === 'remediation_required').length;
    const avg = this._zfd0ThirdPartyRiskData.reduce((s, v) => s + v.riskScore, 0) / this._zfd0ThirdPartyRiskData.length;
    return {total: this._zfd0ThirdPartyRiskData.length, approved, conditional: cond, remediation: rem, avgScore: Math.round(avg)};
  }

  private _getzfd0TrainingSummary(): {total: number; avgCompletion: number; avgScore: number; overdueUpdates: number} {
    const avgComp = this._zfd0SecurityTrainingCatalog.reduce((s, t) => s + t.completionRate, 0) / this._zfd0SecurityTrainingCatalog.length;
    const avgScore = this._zfd0SecurityTrainingCatalog.filter(t => t.avgScore > 0).reduce((s, t) => s + t.avgScore, 0) / this._zfd0SecurityTrainingCatalog.filter(t => t.avgScore > 0).length;
    return {total: this._zfd0SecurityTrainingCatalog.length, avgCompletion: Math.round(avgComp * 10) / 10, avgScore: Math.round(avgScore), overdueUpdates: 0};
  }

  private _getzfd0ToolHealthSummary(): {total: number; healthy: number; degraded: number; annualCost: string} {
    const healthy = this._zfd0SecurityToolInventory.filter(t => t.health === 'healthy').length;
    const degraded = this._zfd0SecurityToolInventory.filter(t => t.health === 'degraded').length;
    const cost = this._zfd0SecurityToolInventory.reduce((s, t) => s + parseInt(t.annualCost.replace(/[^0-9]/g, '')), 0);
    return {total: this._zfd0SecurityToolInventory.length, healthy, degraded, annualCost: '$' + (cost / 1000).toFixed(0) + 'K'};
  }


  private _xfd0SecurityZones = [
    {zoneId: 'xfd0-Z-001', name: 'Internet DMZ', trustLevel: 'Untrusted', subnet: '10.0.0.0/24', segmentation: 'Dual-firewall', firewallRules: 45, monitoring: 'Full packet capture', assets: ['Web servers', 'Load balancers', 'WAF appliances', 'Reverse proxy'], riskLevel: 'high' as const, lastAssessment: '2026-04-15', nextAssessment: '2026-07-15'},
    {zoneId: 'xfd0-Z-002', name: 'Corporate Network', trustLevel: 'Trusted', subnet: '10.1.0.0/16', segmentation: 'VLAN + micro-seg', firewallRules: 128, monitoring: 'NetFlow + IDS', assets: ['Workstations', 'Printers', 'Meeting room systems', 'VoIP phones'], riskLevel: 'medium' as const, lastAssessment: '2026-04-10', nextAssessment: '2026-07-10'},
    {zoneId: 'xfd0-Z-003', name: 'Production Data Center', trustLevel: 'Restricted', subnet: '10.2.0.0/16', segmentation: 'Full micro-segmentation', firewallRules: 256, monitoring: 'Full packet capture + EDR', assets: ['Application servers', 'Database clusters', 'Message queues', 'API gateways'], riskLevel: 'low' as const, lastAssessment: '2026-04-12', nextAssessment: '2026-07-12'},
    {zoneId: 'xfd0-Z-004', name: 'Management Network', trustLevel: 'Restricted', subnet: '10.3.0.0/24', segmentation: 'Isolated VLAN', firewallRules: 32, monitoring: 'Syslog + SNMP', assets: ['Hypervisors', 'Switch management', 'Storage controllers', 'Backup appliances'], riskLevel: 'low' as const, lastAssessment: '2026-04-08', nextAssessment: '2026-07-08'},
    {zoneId: 'xfd0-Z-005', name: 'Cloud Production', trustLevel: 'Restricted', subnet: 'VPC: 172.16.0.0/12', segmentation: 'Security groups + NACLs', firewallRules: 189, monitoring: 'VPC Flow Logs + GuardDuty', assets: ['Kubernetes clusters', 'Managed databases', 'Object storage', 'Serverless functions'], riskLevel: 'medium' as const, lastAssessment: '2026-04-18', nextAssessment: '2026-07-18'}
  ];

  private _xfd0SecurityAlerts = [
    {id: 'xfd0-AL-001', severity: 'critical', title: 'Active ransomware encryption detected on PROD-DB-01', source: 'CrowdStrike', timestamp: '2026-04-22T13:45:00Z', status: 'investigating', assignee: 'SOC Analyst J. Smith', asset: 'PROD-DB-01 (10.2.1.15)', mitreTechnique: 'T1486 - Data Encrypted for Impact', playbook: 'IR-Ransomware-Isolate', sla: '15 minutes', elapsed: '12 minutes', notes: 'EDR detected mass file encryption event pattern. Automated isolation triggered. IR team paged.'},
    {id: 'xfd0-AL-002', severity: 'high', title: 'Impossible travel detected for user admin@company.com', source: 'Okta', timestamp: '2026-04-22T12:30:00Z', status: 'triaged', assignee: 'SOC Analyst M. Johnson', asset: 'Okta - admin@company.com', mitreTechnique: 'T1078 - Valid Accounts', playbook: 'IR-ImpossibleTravel', sla: '30 minutes', elapsed: '87 minutes', notes: 'Login from Tokyo followed by login from New York within 30 minutes. Account temporarily locked. User confirmed via out-of-band channel they are in New York.'},
    {id: 'xfd0-AL-003', severity: 'high', title: 'Public S3 bucket discovered with customer PII exposure', source: 'Prisma Cloud', timestamp: '2026-04-22T11:15:00Z', status: 'remediating', assignee: 'Cloud Security Lead A. Chen', asset: 'AWS S3: customer-data-archive-2024', mitreTechnique: 'N/A - Misconfiguration', playbook: 'IR-Cloud-Misconfig-Remediate', sla: '1 hour', elapsed: '2.5 hours', notes: 'Bucket containing archived customer records was publicly accessible. Bucket blocked and encrypted. Data exposure assessment in progress.'},
    {id: 'xfd0-AL-004', severity: 'medium', title: 'Anomalous data download by user jane.developer@company.com', source: 'Microsoft DLP', timestamp: '2026-04-22T10:00:00Z', status: 'investigating', assignee: 'SOC Analyst R. Davis', asset: 'Endpoint: WS-DEV-042', mitreTechnique: 'T1567 - Exfil Over Web Service', playbook: 'IR-DLP-Investigation', sla: '4 hours', elapsed: '3.5 hours', notes: 'User downloaded 4.2GB of source code files to personal Google Drive. Interview scheduled with user and manager.'},
    {id: 'xfd0-AL-005', severity: 'medium', title: 'Credential stuffing attack detected on customer portal', source: 'Cloudflare WAF', timestamp: '2026-04-22T09:30:00Z', status: 'contained', assignee: 'SOC Analyst K. Wilson', asset: 'Customer Portal (portal.company.com)', mitreTechnique: 'T1110 - Brute Force', playbook: 'IR-CredentialStuffing-Block', sla: '2 hours', elapsed: '4 hours', notes: 'Rate limiting and CAPTCHA automatically deployed. 12,000 failed login attempts from 800 unique IPs blocked. No successful account takeovers confirmed.'},
    {id: 'xfd0-AL-006', severity: 'low', title: 'SSL certificate expiring in 14 days for api.company.com', source: 'Certificate monitoring', timestamp: '2026-04-22T08:00:00Z', status: 'remediated', assignee: 'Infrastructure Lead T. Brown', asset: 'api.company.com', mitreTechnique: 'N/A', playbook: 'Certificate Renewal', sla: '30 days', elapsed: '16 days', notes: 'Automated renewal triggered via ACME. New certificate deployed successfully. No service interruption.'}
  ];

  private _xfd0ComplianceFrameworks = [
  ...
  private _xfd0DataClassificationPolicy = [
  ...
  private _getxfd0ZoneSummary(): {total: number; highRisk: number; mediumRisk: number; lowRisk: number; totalRules: number} {
    const high = this._xfd0SecurityZones.filter(z => z.riskLevel === 'high').length;
    const med = this._xfd0SecurityZones.filter(z => z.riskLevel === 'medium').length;
    const low = this._xfd0SecurityZones.filter(z => z.riskLevel === 'low').length;
    const rules = this._xfd0SecurityZones.reduce((s, z) => s + z.firewallRules, 0);
    return {total: this._xfd0SecurityZones.length, highRisk: high, mediumRisk: med, lowRisk: low, totalRules: rules};
  }

  private _getxfd0AlertSummary(): {total: number; critical: number; high: number; medium: number; low: number; open: number; contained: number} {
    const crit = this._xfd0SecurityAlerts.filter(a => a.severity === 'critical').length;
    const high = this._xfd0SecurityAlerts.filter(a => a.severity === 'high').length;
    const med = this._xfd0SecurityAlerts.filter(a => a.severity === 'medium').length;
    const low = this._xfd0SecurityAlerts.filter(a => a.severity === 'low').length;
    const open = this._xfd0SecurityAlerts.filter(a => a.status === 'investigating' || a.status === 'triaged').length;
    const contained = this._xfd0SecurityAlerts.filter(a => a.status === 'contained' || a.status === 'remediated').length;
    return {total: this._xfd0SecurityAlerts.length, critical: crit, high, medium: med, low, open, contained};
  }

  private _getxfd0ComplianceSummary(): {total: number; fullyCompliant: number; mostlyCompliant: number; avgComplianceRate: number} {
    const full = this._xfd0ComplianceFrameworks.filter(f => f.status === 'compliant').length;
    const mostly = this._xfd0ComplianceFrameworks.filter(f => f.status === 'mostly_compliant').length;
    const avgRate = this._xfd0ComplianceFrameworks.reduce((s, f) => s + (f.compliant / f.requirements * 100), 0) / this._xfd0ComplianceFrameworks.length;
  ...
  // === Security Risk Register (budget_plann) ===
  private _budget_plannRiskRegister = [
    { id: "RSK-BUD-0001", title: "Data breach from unpatched systems", owner: "CTO", category: "Financial", status: "mitigating", trend: "stable", severity: "low", likelihood: 9, impact: 6, treatment: "Monitor and review quarterly", lastReview: "2026-04-21", nextReview: "2026-07-28" },
    { id: "RSK-BUD-0002", title: "Ransomware attack on critical infrastructure", owner: "CRO", category: "Strategic", status: "closed", trend: "decreasing", severity: "critical", likelihood: 4, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-10", nextReview: "2026-07-24" },
    { id: "RSK-BUD-0003", title: "Insider threat data exfiltration", owner: "VP Eng", category: "Compliance", status: "accepted", trend: "increasing", severity: "critical", likelihood: 8, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-17", nextReview: "2026-07-10" },
    { id: "RSK-BUD-0004", title: "Supply chain compromise", owner: "Security Lead", category: "Technical", status: "open", trend: "stable", severity: "low", likelihood: 8, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-21", nextReview: "2026-07-20" },
    { id: "RSK-BUD-0005", title: "Cloud misconfiguration exposure", owner: "Risk Mgr", category: "Reputational", status: "mitigating", trend: "decreasing", severity: "high", likelihood: 8, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-13", nextReview: "2026-07-02" },
    { id: "RSK-BUD-0006", title: "Phishing campaign success rate", owner: "Compliance Dir", category: "Legal", status: "closed", trend: "increasing", severity: "critical", likelihood: 3, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-13", nextReview: "2026-07-06" },
    { id: "RSK-BUD-0007", title: "Third-party vendor data breach", owner: "IT Dir", category: "Regulatory", status: "accepted", trend: "stable", severity: "critical", likelihood: 1, impact: 6, treatment: "Monitor and review quarterly", lastReview: "2026-04-14", nextReview: "2026-07-10" },
    { id: "RSK-BUD-0008", title: "Regulatory non-compliance penalty", owner: "DevOps Lead", category: "Third-Party", status: "open", trend: "decreasing", severity: "medium", likelihood: 7, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-15", nextReview: "2026-07-23" },
    { id: "RSK-BUD-0009", title: "Zero-day exploit in production", owner: "Architect", category: "Human Capital", status: "mitigating", trend: "increasing", severity: "critical", likelihood: 4, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-06", nextReview: "2026-07-27" },
    { id: "RSK-BUD-0010", title: "Insufficient access controls", owner: "CISO", category: "Operational", status: "closed", trend: "stable", severity: "critical", likelihood: 7, impact: 2, treatment: "Monitor and review quarterly", lastReview: "2026-04-17", nextReview: "2026-07-25" },
    { id: "RSK-BUD-0011", title: "DDoS attack on services", owner: "CTO", category: "Financial", status: "accepted", trend: "decreasing", severity: "low", likelihood: 3, impact: 7, treatment: "Monitor and review quarterly", lastReview: "2026-04-17", nextReview: "2026-07-03" },
    { id: "RSK-BUD-0012", title: "Social engineering attack", owner: "CRO", category: "Strategic", status: "open", trend: "increasing", severity: "medium", likelihood: 1, impact: 1, treatment: "Monitor and review quarterly", lastReview: "2026-04-16", nextReview: "2026-07-04" },
    { id: "RSK-BUD-0013", title: "API security vulnerability", owner: "VP Eng", category: "Compliance", status: "mitigating", trend: "stable", severity: "critical", likelihood: 9, impact: 1, treatment: "Monitor and review quarterly", lastReview: "2026-04-04", nextReview: "2026-07-04" },
    { id: "RSK-BUD-0014", title: "Mobile device compromise", owner: "Security Lead", category: "Technical", status: "closed", trend: "decreasing", severity: "medium", likelihood: 4, impact: 1, treatment: "Monitor and review quarterly", lastReview: "2026-04-09", nextReview: "2026-07-26" },
    { id: "RSK-BUD-0015", title: "Physical security breach", owner: "Risk Mgr", category: "Reputational", status: "accepted", trend: "increasing", severity: "medium", likelihood: 6, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-16", nextReview: "2026-07-16" },
    { id: "RSK-BUD-0016", title: "Password policy weakness", owner: "Compliance Dir", category: "Legal", status: "open", trend: "stable", severity: "critical", likelihood: 10, impact: 1, treatment: "Monitor and review quarterly", lastReview: "2026-04-07", nextReview: "2026-07-01" },
    { id: "RSK-BUD-0017", title: "Network segmentation gap", owner: "IT Dir", category: "Regulatory", status: "mitigating", trend: "decreasing", severity: "medium", likelihood: 1, impact: 5, treatment: "Monitor and review quarterly", lastReview: "2026-04-04", nextReview: "2026-07-08" },
    { id: "RSK-BUD-0018", title: "Encryption key management failure", owner: "DevOps Lead", category: "Third-Party", status: "closed", trend: "increasing", severity: "medium", likelihood: 6, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-21", nextReview: "2026-07-17" },
    { id: "RSK-BUD-0019", title: "Audit trail tampering", owner: "Architect", category: "Human Capital", status: "accepted", trend: "stable", severity: "low", likelihood: 9, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-05", nextReview: "2026-07-13" },
    { id: "RSK-BUD-0020", title: "Business email compromise", owner: "CISO", category: "Operational", status: "open", trend: "decreasing", severity: "high", likelihood: 2, impact: 5, treatment: "Monitor and review quarterly", lastReview: "2026-04-06", nextReview: "2026-07-21" },
  ];
  private _budget_plannRiskFilter: string = 'all';
  private _budget_plannRiskSeverity: string = 'all';
  private _budget_plannRiskStatus: string = 'all';
  private _budget_plannExpandedRisk: string = '';
  private _budget_plannFilterRisks() {
    const reg = this._budget_plannRiskRegister;
    return reg.filter(r => {
      if (this._budget_plannRiskFilter !== "all" && r.category !== this._budget_plannRiskFilter) return false;
      if (this._budget_plannRiskSeverity !== "all" && r.severity !== this._budget_plannRiskSeverity) return false;
      if (this._budget_plannRiskStatus !== "all" && r.status !== this._budget_plannRiskStatus) return false;
      return true;
    });
  }
  private _budget_plannGetRiskScore(r: any) { return Math.round(r.likelihood * r.impact * 1.5); }
  private _budget_plannGetRiskTrendIcon(trend: string) {
    if (trend === "increasing") return "\u2191";
    if (trend === "decreasing") return "\u2193";
    return "\u2192";
  }
  private _budget_plannGetRiskColor(sev: string) {
    if (sev === "critical") return "#dc2626";
    if (sev === "high") return "#ea580c";
    if (sev === "medium") return "#d97706";
    return "#16a34a";
  }
  private _budget_plannGetRiskCounts() {
    const reg = this._budget_plannRiskRegister;
  ...
  private _budget_plannGetTreatmentProgress() {
    const reg = this._budget_plannRiskRegister;
    const treated = reg.filter(r => r.status === "mitigating" || r.status === "closed").length;
    return Math.round((treated / Math.max(reg.length, 1)) * 100);
  }

  // === Security Metrics API Gateway (budget_plann) ===
  private _budget_plannApiEndpoints = [
    { method: "GET", path: "/api/v1/threats", name: "Threat Intelligence Feed", status: "active", avgLatency: 35.4, reqPerMin: 347.0, errorRate: 2.1, uptime: round(99.22272915300165,2), version: "v1.1.9" },
    { method: "POST", path: "/api/v1/scans/start", name: "Vulnerability Scanner", status: "active", avgLatency: 165.4, reqPerMin: 538.0, errorRate: 1.79, uptime: round(95.89197626627512,2), version: "v2.2.14" },
    { method: "GET", path: "/api/v1/assets", name: "Asset Inventory", status: "active", avgLatency: 115.1, reqPerMin: 200.0, errorRate: 0.89, uptime: round(98.45059959283759,2), version: "v2.7.4" },
    { method: "POST", path: "/api/v1/alerts", name: "Alert Management", status: "active", avgLatency: 340.4, reqPerMin: 2161.0, errorRate: 0.78, uptime: round(96.89663572062113,2), version: "v1.4.15" },
    { method: "GET", path: "/api/v1/compliance", name: "Compliance Status", status: "active", avgLatency: 128.4, reqPerMin: 1899.0, errorRate: 0.11, uptime: round(95.01431434855873,2), version: "v1.9.10" },
    { method: "PUT", path: "/api/v1/policies", name: "Policy Engine", status: "active", avgLatency: 282.2, reqPerMin: 2471.0, errorRate: 2.31, uptime: round(99.61890564023912,2), version: "v3.6.12" },
    { method: "GET", path: "/api/v1/incidents", name: "Incident Tracker", status: "active", avgLatency: 128.5, reqPerMin: 2152.0, errorRate: 1.85, uptime: round(99.78856499302469,2), version: "v3.4.2" },
    { method: "POST", path: "/api/v1/forensics", name: "Forensics Collector", status: "degraded", avgLatency: 58.0, reqPerMin: 995.0, errorRate: 0.25, uptime: round(96.4581984806367,2), version: "v2.9.19" },
    { method: "GET", path: "/api/v1/risk/assess", name: "Risk Assessment", status: "active", avgLatency: 42.2, reqPerMin: 2441.0, errorRate: 1.52, uptime: round(98.79415747244455,2), version: "v1.2.8" },
    { method: "POST", path: "/api/v1/auth/verify", name: "Authentication", status: "active", avgLatency: 212.4, reqPerMin: 2499.0, errorRate: 0.13, uptime: round(95.09898089412607,2), version: "v2.6.11" },
    { method: "GET", path: "/api/v1/logs/audit", name: "Audit Log Query", status: "active", avgLatency: 284.4, reqPerMin: 653.0, errorRate: 2.32, uptime: round(95.97262413143152,2), version: "v2.9.13" },
    { method: "PUT", path: "/api/v1/users/roles", name: "Role Management", status: "active", avgLatency: 417.6, reqPerMin: 1543.0, errorRate: 2.31, uptime: round(97.06126070440662,2), version: "v1.8.8" },
    { method: "POST", path: "/api/v1/encrypt", name: "Encryption Service", status: "active", avgLatency: 397.0, reqPerMin: 2014.0, errorRate: 0.88, uptime: round(96.00986068581796,2), version: "v3.7.16" },
    { method: "GET", path: "/api/v1/network/topo", name: "Network Topology", status: "maintenance", avgLatency: 287.2, reqPerMin: 1431.0, errorRate: 2.22, uptime: round(98.13851199815159,2), version: "v1.7.9" },
    { method: "DELETE", path: "/api/v1/sessions", name: "Session Manager", status: "active", avgLatency: 258.7, reqPerMin: 134.0, errorRate: 1.22, uptime: round(96.42395245354606,2), version: "v2.4.7" },
  ];
  private _budget_plannApiKeys = [
    { id: "ak-000001", name: "key-budg-001", created: "2026-04-26", lastUsed: "2026-04-14", status: "revoked", calls: 1983, rateLimit: 5000 },
    { id: "ak-000002", name: "key-budg-002", created: "2026-03-16", lastUsed: "2026-04-12", status: "active", calls: 27096, rateLimit: 100 },
    { id: "ak-000003", name: "key-budg-003", created: "2026-03-27", lastUsed: "2026-04-23", status: "active", calls: 30632, rateLimit: 5000 },
    { id: "ak-000004", name: "key-budg-004", created: "2026-04-23", lastUsed: "2026-04-16", status: "active", calls: 7721, rateLimit: 100 },
    { id: "ak-000005", name: "key-budg-005", created: "2026-04-15", lastUsed: "2026-04-04", status: "active", calls: 5037, rateLimit: 1000 },
    { id: "ak-000006", name: "key-budg-006", created: "2026-02-20", lastUsed: "2026-04-02", status: "revoked", calls: 17851, rateLimit: 500 },
    { id: "ak-000007", name: "key-budg-007", created: "2026-01-26", lastUsed: "2026-04-07", status: "revoked", calls: 1718, rateLimit: 5000 },
    { id: "ak-000008", name: "key-budg-008", created: "2026-06-19", lastUsed: "2026-04-06", status: "active", calls: 16341, rateLimit: 500 },
  ];
  private _budget_plannApiHealthSummary() {
    const eps = this._budget_plannApiEndpoints;
  ...
  private _budget_plannGetApiByMethod(method: string) { return this._budget_plannApiEndpoints.filter(e=>e.method===method); }
  private _budget_plannGetSlowEndpoints() { return this._budget_plannApiEndpoints.filter(e=>e.avgLatency>200).sort((a,b)=>b.avgLatency-a.avgLatency); }
  private _budget_plannGetHighErrorEndpoints() { return this._budget_plannApiEndpoints.filter(e=>e.errorRate>1.0).sort((a,b)=>b.errorRate-a.errorRate); }

  // === Security Training Effectiveness (budget_plann) ===
  private _budget_plannTrainingModules = [
    { id: "TRN-001", name: "Security Fundamentals", completionRate: 86.3, avgScore: 70.1, behaviorChange: 83.4, enrolled: 465, completed: 175, duration: "25min", category: "mandatory" },
    { id: "TRN-002", name: "Phishing Awareness", completionRate: 96.2, avgScore: 84.4, behaviorChange: 63.9, enrolled: 251, completed: 353, duration: "22min", category: "mandatory" },
    { id: "TRN-003", name: "Social Engineering Defense", completionRate: 50.5, avgScore: 71.0, behaviorChange: 64.4, enrolled: 427, completed: 320, duration: "44min", category: "optional" },
    { id: "TRN-004", name: "Password Hygiene", completionRate: 51.9, avgScore: 61.5, behaviorChange: 80.0, enrolled: 483, completed: 112, duration: "99min", category: "mandatory" },
    { id: "TRN-005", name: "Data Classification", completionRate: 47.8, avgScore: 94.2, behaviorChange: 30.7, enrolled: 141, completed: 169, duration: "99min", category: "mandatory" },
    { id: "TRN-006", name: "Incident Response Basics", completionRate: 61.3, avgScore: 81.0, behaviorChange: 32.2, enrolled: 440, completed: 439, duration: "79min", category: "mandatory" },
    { id: "TRN-007", name: "Secure Coding", completionRate: 72.1, avgScore: 69.3, behaviorChange: 65.7, enrolled: 459, completed: 82, duration: "89min", category: "optional" },
    { id: "TRN-008", name: "Cloud Security", completionRate: 79.8, avgScore: 93.1, behaviorChange: 51.3, enrolled: 419, completed: 432, duration: "41min", category: "mandatory" },
    { id: "TRN-009", name: "Mobile Device Security", completionRate: 85.8, avgScore: 57.4, behaviorChange: 53.8, enrolled: 319, completed: 36, duration: "107min", category: "mandatory" },
    { id: "TRN-010", name: "Network Security", completionRate: 89.7, avgScore: 73.5, behaviorChange: 34.9, enrolled: 486, completed: 33, duration: "47min", category: "mandatory" },
    { id: "TRN-011", name: "Physical Security", completionRate: 62.1, avgScore: 64.9, behaviorChange: 82.7, enrolled: 76, completed: 74, duration: "73min", category: "optional" },
    { id: "TRN-012", name: "Regulatory Compliance", completionRate: 59.9, avgScore: 59.9, behaviorChange: 60.1, enrolled: 414, completed: 341, duration: "37min", category: "mandatory" },
    { id: "TRN-013", name: "Risk Management", completionRate: 63.3, avgScore: 92.6, behaviorChange: 76.5, enrolled: 151, completed: 22, duration: "47min", category: "mandatory" },
    { id: "TRN-014", name: "Cryptography Basics", completionRate: 88.0, avgScore: 73.4, behaviorChange: 79.8, enrolled: 328, completed: 246, duration: "24min", category: "mandatory" },
    { id: "TRN-015", name: "Access Control", completionRate: 79.2, avgScore: 55.5, behaviorChange: 40.2, enrolled: 239, completed: 104, duration: "105min", category: "optional" },
    { id: "TRN-016", name: "Vendor Management", completionRate: 86.9, avgScore: 57.3, behaviorChange: 43.2, enrolled: 55, completed: 187, duration: "19min", category: "mandatory" },
  ];
  private _budget_plannPhishingResults = [
    { month: "2026-01", sent: 947, clicked: 134, reported: 130, clickRate: round(14.149947201689548,1), reportRate: round(13.727560718057022,1) },
    { month: "2026-02", sent: 866, clicked: 218, reported: 315, clickRate: round(25.17321016166282,1), reportRate: round(36.37413394919168,1) },
    { month: "2026-03", sent: 929, clicked: 221, reported: 441, clickRate: round(23.78902045209903,1), reportRate: round(47.470398277717976,1) },
    { month: "2026-04", sent: 526, clicked: 80, reported: 265, clickRate: round(15.209125475285171,1), reportRate: round(50.38022813688213,1) },
    { month: "2026-05", sent: 709, clicked: 207, reported: 251, clickRate: round(29.196050775740478,1), reportRate: round(35.40197461212976,1) },
    { month: "2026-06", sent: 845, clicked: 251, reported: 290, clickRate: round(29.704142011834318,1), reportRate: round(34.319526627218934,1) },
  ];
  private _budget_plannTrainingROI = { totalInvestment: 121708, avgCostPerEmployee: 214, riskReductionPct: round(random.uniform(15,45),1), incidentReductionPct: round(random.uniform(10,35),1), complianceScoreGain: round(random.uniform(5,25),1) };
  private _budget_plannLearningPaths = [
    { name: "Beginner Security Analyst", totalModules: 20, completedModules: 13, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 10, enrolled: 103 },
    { name: "Advanced Threat Hunter", totalModules: 13, completedModules: 11, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 64, enrolled: 59 },
    { name: "Security Architect", totalModules: 20, completedModules: 14, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 29, enrolled: 184 },
    { name: "Incident Responder", totalModules: 12, completedModules: 12, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 12, enrolled: 74 },
    { name: "Compliance Specialist", totalModules: 9, completedModules: 5, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 61, enrolled: 74 },
    { name: "DevSecOps Engineer", totalModules: 20, completedModules: 10, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 78, enrolled: 44 },
  ];
  private _budget_plannGetOverallCompletion() {
    const mods = this._budget_plannTrainingModules;
    return round(mods.reduce((s,m)=>s+m.completionRate,0)/mods.length,1);
  }
  private _budget_plannGetTopPerformers() { return [...this._budget_plannTrainingModules].sort((a,b)=>b.avgScore-a.avgScore).slice(0,5); }
  private _budget_plannGetModulesNeedingAttention() { return this._budget_plannTrainingModules.filter(m=>m.completionRate<70||m.avgScore<65); }

  // === Security Governance Framework (budget_plann) ===
  private _budget_plannGovBodies = [
    { name: "Security Steering Committee", members: 14, chair: "CISO", meetingFreq: "Weekly", lastMeeting: "2026-04-15", nextMeeting: "2026-05-19", quorum: 7 },
    { name: "Risk Management Board", members: 5, chair: "CTO", meetingFreq: "Bi-weekly", lastMeeting: "2026-04-22", nextMeeting: "2026-05-11", quorum: 5 },
    { name: "Data Governance Council", members: 9, chair: "CRO", meetingFreq: "Monthly", lastMeeting: "2026-04-12", nextMeeting: "2026-05-07", quorum: 4 },
    { name: "Compliance Oversight Board", members: 6, chair: "CDO", meetingFreq: "Monthly", lastMeeting: "2026-04-20", nextMeeting: "2026-05-07", quorum: 4 },
    { name: "Architecture Review Board", members: 14, chair: "VP Eng", meetingFreq: "Bi-weekly", lastMeeting: "2026-04-15", nextMeeting: "2026-05-03", quorum: 3 },
    { name: "Change Advisory Board", members: 5, chair: "CISO", meetingFreq: "Weekly", lastMeeting: "2026-04-18", nextMeeting: "2026-05-21", quorum: 5 },
    { name: "Incident Review Board", members: 7, chair: "CIO", meetingFreq: "As needed", lastMeeting: "2026-04-02", nextMeeting: "2026-05-05", quorum: 6 },
    { name: "Vendor Risk Committee", members: 10, chair: "CFO", meetingFreq: "Quarterly", lastMeeting: "2026-04-15", nextMeeting: "2026-05-23", quorum: 5 },
  ];
  private _budget_plannDecisions = [
    { id: "DEC-0001", title: "Adopt zero-trust architecture framework", date: "2026-04-27", status: "approved", owner: "CISO" },
    { id: "DEC-0002", title: "Migrate to SIEM 2.0 platform", date: "2026-03-02", status: "implemented", owner: "CTO" },
    { id: "DEC-0003", title: "Implement DLP across all endpoints", date: "2026-04-26", status: "in-progress", owner: "Security Lead" },
    { id: "DEC-0004", title: "Mandate MFA for all external access", date: "2026-04-28", status: "pending", owner: "CRO" },
    { id: "DEC-0005", title: "Establish bug bounty program", date: "2026-02-01", status: "approved", owner: "VP Eng" },
    { id: "DEC-0006", title: "Deploy EDR solution enterprise-wide", date: "2026-02-05", status: "approved", owner: "CISO" },
    { id: "DEC-0007", title: "Conduct annual penetration testing", date: "2026-03-24", status: "implemented", owner: "CTO" },
    { id: "DEC-0008", title: "Implement network micro-segmentation", date: "2026-04-20", status: "in-progress", owner: "Security Lead" },
    { id: "DEC-0009", title: "Establish security champion program", date: "2026-04-07", status: "pending", owner: "CRO" },
    { id: "DEC-0010", title: "Migrate to passwordless authentication", date: "2026-04-11", status: "approved", owner: "VP Eng" },
  ];
  private _budget_plannPolicyLifecycle = [
    { name: "Information Security Policy", version: "v4.0", status: "active", lastUpdated: "2026-03-04", nextReview: "2026-7-19", owner: "CISO" },
    { name: "Acceptable Use Policy", version: "v4.4", status: "active", lastUpdated: "2026-03-19", nextReview: "2026-8-15", owner: "Legal" },
    { name: "Data Retention Policy", version: "v1.2", status: "under-review", lastUpdated: "2026-01-09", nextReview: "2026-9-23", owner: "DPO" },
    { name: "Access Control Policy", version: "v3.4", status: "active", lastUpdated: "2026-04-15", nextReview: "2026-8-26", owner: "IAM Lead" },
    { name: "Incident Response Policy", version: "v3.4", status: "draft", lastUpdated: "2026-02-16", nextReview: "2026-8-12", owner: "IR Lead" },
    { name: "Business Continuity Plan", version: "v1.5", status: "active", lastUpdated: "2026-01-01", nextReview: "2026-8-11", owner: "BCP Mgr" },
    { name: "Vendor Management Policy", version: "v1.3", status: "active", lastUpdated: "2026-03-05", nextReview: "2026-12-23", owner: "Procurement" },
    { name: "Encryption Standard", version: "v1.3", status: "under-review", lastUpdated: "2026-04-06", nextReview: "2026-9-13", owner: "Security Arch" },
  ];
  private _budget_plannGovMaturityScore = { overall: 3.1, riskManagement: 4.3, compliance: 3.1, incidentResponse: 5.1, awareness: 3.8, technology: 4.7 };
  private _budget_plannGetPendingDecisions() { return this._budget_plannDecisions.filter(d=>d.status==='pending'||d.status==='in-progress'); }
  private _budget_plannGetActivePolicies() { return this._budget_plannPolicyLifecycle.filter(p=>p.status==='active'); }
  private _budget_plannGetEscalationPath() { return ["L1 Analyst","L2 Senior","Security Lead","CISO","Board"]; }

  // === Security Innovation Lab (budget_plann) ===
  private _budget_plannInnoProjects = [
    { id: "INN-001", name: "AI-Powered Threat Detection", description: "Machine learning models for real-time threat identification", status: "active", progress: 72, startDate: "2026-02-17", teamSize: 5, budget: 49395, milestones: 3, completedMilestones: 2 },
    { id: "INN-002", name: "Quantum-Resistant Cryptography", description: "Post-quantum encryption algorithm prototyping", status: "research", progress: 35, startDate: "2026-03-21", teamSize: 5, budget: 30823, milestones: 10, completedMilestones: 7 },
    { id: "INN-003", name: "Automated Red Teaming", description: "Autonomous penetration testing framework", status: "active", progress: 58, startDate: "2026-02-18", teamSize: 5, budget: 135883, milestones: 8, completedMilestones: 7 },
    { id: "INN-004", name: "Zero-Knowledge Authentication", description: "Privacy-preserving identity verification", status: "poc", progress: 88, startDate: "2026-01-10", teamSize: 6, budget: 59101, milestones: 6, completedMilestones: 8 },
    { id: "INN-005", name: "Blockchain Audit Trail", description: "Immutable security event logging", status: "active", progress: 45, startDate: "2026-02-01", teamSize: 6, budget: 67775, milestones: 7, completedMilestones: 1 },
    { id: "INN-006", name: "Behavioral Biometrics", description: "Continuous authentication via user behavior patterns", status: "research", progress: 22, startDate: "2026-02-14", teamSize: 8, budget: 45343, milestones: 7, completedMilestones: 5 },
    { id: "INN-007", name: "Deception Grid 2.0", description: "Advanced honeypot network with adaptive responses", status: "active", progress: 65, startDate: "2026-01-10", teamSize: 7, budget: 148364, milestones: 6, completedMilestones: 5 },
    { id: "INN-008", name: "Secure Enclave Integration", description: "Hardware-backed security for critical workloads", status: "poc", progress: 40, startDate: "2026-03-11", teamSize: 7, budget: 37635, milestones: 10, completedMilestones: 4 },
  ];
  private _budget_plannTechEvaluations = [
    { name: "Rust for Security Tools", status: "evaluating", score: 8.6, recommendation: "Adopt", vendor: "Open Source" },
    { name: "eBPF for Runtime Detection", status: "completed", score: 6.8, recommendation: "Adopt", vendor: "AWS" },
    { name: "Confidential Computing", status: "planned", score: 6.1, recommendation: "Investigate", vendor: "Azure" },
    { name: "Homomorphic Encryption", status: "evaluating", score: 7.4, recommendation: "Pilot", vendor: "GCP" },
    { name: "SASE Architecture", status: "completed", score: 7.4, recommendation: "Adopt", vendor: "Multiple" },
    { name: "SOAR Platform 3.0", status: "planned", score: 8.6, recommendation: "Monitor", vendor: "Splunk" },
  ];
  private _budget_plannCollaborationPartners = [
  ...
  private _budget_plannInnoMetrics = { totalProjects: 8, activeProjects: 4, avgTimeToValue: "85 days", pocSuccessRate: round(random.uniform(55,85),1), researchToProduction: round(random.uniform(20,50),1), innovationIndex: round(random.uniform(6.0,9.5),1) };
  private _budget_plannGetProjectByStatus(status: string) { return this._budget_plannInnoProjects.filter(p=>p.status===status); }
  private _budget_plannGetTopEvaluations() { return [...this._budget_plannTechEvaluations].sort((a,b)=>b.score-a.score).slice(0,3); }



  // === Compliance Dashboard Extension (budget_plann) ===
  private _budget_plannComplianceFrameworks = [
    { name: "SOC 2 Type II", description: "Trust Services Criteria", totalControls: 5, implementedControls: 4, status: "partially-compliant", lastAudit: "2026-02-20", nextAudit: "2026-10-20", evidenceCount: 265 },
    { name: "ISO 27001", description: "Information Security Management", totalControls: 114, implementedControls: 83, status: "partially-compliant", lastAudit: "2026-02-08", nextAudit: "2026-9-27", evidenceCount: 123 },
    { name: "PCI DSS 4.0", description: "Payment Card Industry", totalControls: 12, implementedControls: 10, status: "partially-compliant", lastAudit: "2026-02-09", nextAudit: "2026-9-05", evidenceCount: 157 },
    { name: "HIPAA", description: "Health Insurance Portability", totalControls: 18, implementedControls: 11, status: "partially-compliant", lastAudit: "2026-02-24", nextAudit: "2026-9-08", evidenceCount: 200 },
    { name: "GDPR", description: "Data Protection Regulation", totalControls: 99, implementedControls: 86, status: "compliant", lastAudit: "2026-04-27", nextAudit: "2026-7-22", evidenceCount: 158 },
    { name: "NIST CSF 2.0", description: "Cybersecurity Framework", totalControls: 6, implementedControls: 5, status: "partially-compliant", lastAudit: "2026-04-01", nextAudit: "2026-8-12", evidenceCount: 108 },
    { name: "FedRAMP", description: "Federal Risk Authorization", totalControls: 15, implementedControls: 9, status: "in-review", lastAudit: "2026-04-11", nextAudit: "2026-11-03", evidenceCount: 218 },
    { name: "SOX", description: "Sarbanes-Oxley Compliance", totalControls: 8, implementedControls: 7, status: "compliant", lastAudit: "2026-04-16", nextAudit: "2026-11-15", evidenceCount: 491 },
    { name: "CIS Controls v8", description: "Center for Internet Security", totalControls: 18, implementedControls: 17, status: "non-compliant", lastAudit: "2026-04-11", nextAudit: "2026-9-15", evidenceCount: 235 },
    { name: "COBIT 2019", description: "IT Governance Framework", totalControls: 40, implementedControls: 35, status: "in-review", lastAudit: "2026-04-21", nextAudit: "2026-9-16", evidenceCount: 85 },
  ];
  private _budget_plannGetComplianceScore() {
    const fw = this._budget_plannComplianceFrameworks;
    return round(fw.reduce((s,f)=>s + (f.implementedControls/Math.max(f.totalControls,1))*100, 0) / fw.length, 1);
  }
  private _budget_plannGetGaps() {
    return this._budget_plannComplianceFrameworks.filter(f => f.status !== "compliant");
  }
  private _budget_plannAuditTrail = [
    { id: "AUD-0001", action: "Control tested", auditor: "Internal Audit", date: "2026-04-03", result: "pass", findings: 5 },
    { id: "AUD-0002", action: "Evidence collected", auditor: "External Auditor", date: "2026-04-21", result: "pass", findings: 1 },
    { id: "AUD-0003", action: "Gap identified", auditor: "Security Team", date: "2026-04-03", result: "fail", findings: 0 },
    { id: "AUD-0004", action: "Remediation completed", auditor: "Compliance Officer", date: "2026-04-10", result: "pass", findings: 4 },
    { id: "AUD-0005", action: "Policy updated", auditor: "IT Audit", date: "2026-04-02", result: "pass", findings: 5 },
    ...
    { id: "AUD-0008", action: "Exception approved", auditor: "CISO Office", date: "2026-04-10", result: "conditional", findings: 2 },
    { id: "AUD-0009", action: "Risk accepted", auditor: "Board Audit", date: "2026-04-08", result: "pass", findings: 4 },
    { id: "AUD-0010", action: "Control enhanced", auditor: "Third Party", date: "2026-04-07", result: "pass", findings: 3 },
  ];

  // === Threat Intelligence Feed Extension (budget_plann) ===
  private _budget_plannThreatActors = [
    { name: "APT-29", alias: "Cozy Bear", origin: "Russia", type: "Nation-State", severity: "high", lastActivity: "2026-04-14", targets: "Healthcare", indicators: 478, ttps: 6 },
    { name: "APT-41", alias: "Double Dragon", origin: "China", type: "Nation-State", severity: "critical", lastActivity: "2026-04-11", targets: "Healthcare", indicators: 209, ttps: 14 },
    { name: "Lazarus Group", alias: "Hidden Cobra", origin: "North Korea", type: "Nation-State", severity: "critical", lastActivity: "2026-04-21", targets: "Energy", indicators: 287, ttps: 7 },
    { name: "FIN7", alias: "Carbanak", origin: "Eastern Europe", type: "Financial", severity: "high", lastActivity: "2026-04-01", targets: "Healthcare", indicators: 216, ttps: 38 },
    { name: "Conti", alias: "Wizard Spider", origin: "Russia", type: "Ransomware", severity: "critical", lastActivity: "2026-04-22", targets: "Energy", indicators: 295, ttps: 16 },
    { name: "LockBit", alias: "LockBit Gang", origin: "Unknown", type: "Ransomware", severity: "high", lastActivity: "2026-04-12", targets: "Manufacturing", indicators: 175, ttps: 20 },
    { name: "Cl0p", alias: "Cl0p Team", origin: "Unknown", type: "Ransomware", severity: "high", lastActivity: "2026-04-06", targets: "Healthcare", indicators: 437, ttps: 16 },
    { name: "Sandworm", alias: "Unit 74455", origin: "Russia", type: "Nation-State", severity: "critical", lastActivity: "2026-04-21", targets: "Energy", indicators: 472, ttps: 22 },
  ];
  private _budget_plannIoCFeed = [
    { id: "ioc-000001", type: "ip", value: "42.29.239.243", confidence: 77, source: "CrowdStrike", firstSeen: "2026-04-02", lastSeen: "2026-04-09" },
    { id: "ioc-000002", type: "ip", value: "130.73.224.21", confidence: 88, source: "VirusTotal", firstSeen: "2026-04-08", lastSeen: "2026-04-04" },
    { id: "ioc-000003", type: "ip", value: "178.142.147.255", confidence: 86, source: "MISP", firstSeen: "2026-04-05", lastSeen: "2026-04-03" },
    { id: "ioc-000004", type: "ip", value: "6.127.251.142", confidence: 63, source: "CrowdStrike", firstSeen: "2026-04-05", lastSeen: "2026-04-16" },
    { id: "ioc-000005", type: "ip", value: "155.114.254.156", confidence: 51, source: "Mandiant", firstSeen: "2026-04-16", lastSeen: "2026-04-17" },
    { id: "ioc-000006", type: "ip", value: "8.108.26.143", confidence: 85, source: "CrowdStrike", firstSeen: "2026-04-16", lastSeen: "2026-04-13" },
    { id: "ioc-000007", type: "ip", value: "222.154.106.235", confidence: 53, source: "VirusTotal", firstSeen: "2026-04-16", lastSeen: "2026-04-09" },
    { id: "ioc-000008", type: "ip", value: "133.170.128.171", confidence: 59, source: "CrowdStrike", firstSeen: "2026-04-11", lastSeen: "2026-04-06" },
    { id: "ioc-000009", type: "ip", value: "171.209.156.126", confidence: 75, source: "CrowdStrike", firstSeen: "2026-04-08", lastSeen: "2026-04-12" },
    { id: "ioc-000010", type: "ip", value: "53.222.105.123", confidence: 47, source: "VirusTotal", firstSeen: "2026-04-03", lastSeen: "2026-04-20" },
    { id: "ioc-000011", type: "ip", value: "246.211.59.253", confidence: 47, source: "AlienVault", firstSeen: "2026-04-07", lastSeen: "2026-04-20" },
    { id: "ioc-000012", type: "ip", value: "228.27.158.92", confidence: 93, source: "Mandiant", firstSeen: "2026-04-01", lastSeen: "2026-04-23" },
    { id: "ioc-000013", type: "ip", value: "199.42.16.8", confidence: 90, source: "CrowdStrike", firstSeen: "2026-04-04", lastSeen: "2026-04-02" },
    { id: "ioc-000014", type: "ip", value: "170.2.53.244", confidence: 95, source: "AlienVault", firstSeen: "2026-04-17", lastSeen: "2026-04-14" },
    { id: "ioc-000015", type: "ip", value: "30.191.171.134", confidence: 64, source: "VirusTotal", firstSeen: "2026-04-22", lastSeen: "2026-04-21" },
  ];
  private _budget_plannGetActiveThreats() { return this._budget_plannThreatActors.filter(a => a.severity === 'critical'); }
  private _budget_plannGetThreatSummary() {
    const actors = this._budget_plannThreatActors;
  ...
  // === Incident Management Extension (budget_plann) ===
  private _budget_plannIncidents = [
    { id: "INC-20260001", title: "Unauthorized access detected", severity: "critical", status: "open", assignedTo: "SOC L1", detectedAt: "2026-04-20T00:26", affectedAssets: 25, rootCause: "Misconfiguration" },
    { id: "INC-20260002", title: "Malware outbreak on workstation", severity: "high", status: "investigating", assignedTo: "SOC L2", detectedAt: "2026-04-08T23:54", affectedAssets: 9, rootCause: "Credential compromise" },
    { id: "INC-20260003", title: "Data leak from S3 bucket", severity: "medium", status: "contained", assignedTo: "IR Lead", detectedAt: "2026-04-10T00:12", affectedAssets: 20, rootCause: "Zero-day" },
    { id: "INC-20260004", title: "Phishing campaign targeting finance", severity: "low", status: "eradicated", assignedTo: "CISO", detectedAt: "2026-04-17T03:47", affectedAssets: 18, rootCause: "Human error" },
    { id: "INC-20260005", title: "DDoS attack on web services", severity: "critical", status: "recovered", assignedTo: "Security Eng", detectedAt: "2026-04-05T10:25", affectedAssets: 13, rootCause: "Policy violation" },
    { id: "INC-20260006", title: "Ransomware encryption attempt", severity: "high", status: "closed", assignedTo: "Forensics", detectedAt: "2026-04-08T01:09", affectedAssets: 5, rootCause: "Unknown" },
    { id: "INC-20260007", title: "Insider data exfiltration", severity: "medium", status: "open", assignedTo: "SOC L1", detectedAt: "2026-04-17T23:59", affectedAssets: 7, rootCause: "Misconfiguration" },
    { id: "INC-20260008", title: "API key exposure in repo", severity: "low", status: "investigating", assignedTo: "SOC L2", detectedAt: "2026-04-13T19:12", affectedAssets: 2, rootCause: "Credential compromise" },
    { id: "INC-20260009", title: "SQL injection on portal", severity: "critical", status: "contained", assignedTo: "IR Lead", detectedAt: "2026-04-02T04:59", affectedAssets: 40, rootCause: "Zero-day" },
    { id: "INC-20260010", title: "Brute force on VPN", severity: "high", status: "eradicated", assignedTo: "CISO", detectedAt: "2026-04-19T16:45", affectedAssets: 43, rootCause: "Human error" },
    { id: "INC-20260011", title: "Supply chain alert from vendor", severity: "medium", status: "recovered", assignedTo: "Security Eng", detectedAt: "2026-04-10T18:58", affectedAssets: 24, rootCause: "Policy violation" },
    { id: "INC-20260012", title: "Suspicious lateral movement", severity: "low", status: "closed", assignedTo: "Forensics", detectedAt: "2026-04-14T06:13", affectedAssets: 3, rootCause: "Unknown" },
  ];
  private _budget_plannGetIncidentStats() {
    const inc = this._budget_plannIncidents;
    return { total: inc.length, open: inc.filter(i=>i.status==="open").length, investigating: inc.filter(i=>i.status==="investigating").length, mttd: 38, mttr: 123 };
  }
  private _budget_plannGetSeverityDistribution() {
    const inc = this._budget_plannIncidents;
  ...
  private _initBudgetPlannerComplianceHub() {
    const budget_plannerComplianceControls = [
    ...
    this._budget_plannerComplianceScore = this._calcBudgetPlannerComplianceScore(budget_plannerComplianceControls);
    this._budget_plannerDriftAlerts = budget_plannerComplianceControls.filter(c => c.status === 'drift-detected' || c.status === 'non-compliant');
    this._budget_plannerRemediationQueue = this._generateBudgetPlannerRemediationPlan(budget_plannerComplianceControls);
    this._budget_plannerRegulatoryChanges = this._detectBudgetPlannerRegulatoryImpact(budget_plannerComplianceControls);
  }

  private _calcBudgetPlannerComplianceScore(controls: Array<Record<string, unknown>>): number {
  ...
  private _generateBudgetPlannerRemediationPlan(controls: Array<Record<string, unknown>>): Array<Record<string, unknown>> {
  ...
  private _detectBudgetPlannerRegulatoryImpact(controls: Array<Record<string, unknown>>): Array<Record<string, unknown>> {
    return [
  ...
  private _runBudgetPlannerContinuousMonitoring(): void {
    ...
    this._budget_plannerMonitoringChecks = monitoringChecks;
  }


  // === Security Architecture Evolution Tracker ===
  private _initBudgetPlannerArchEvolution() {
    this._budget_plannerArchComponents = [
    ...
    this._budget_plannerArchRoadmap = this._planBudgetPlannerArchRoadmap();
    this._budget_plannerArchRiskSurface = this._mapBudgetPlannerArchRiskSurface();
    this._budget_plannerArchTechDebt = this._assessBudgetPlannerTechDebt();
    this._budget_plannerArchEvolutionTimeline = this._buildBudgetPlannerEvolutionTimeline();
  }

  private _planBudgetPlannerArchRoadmap(): Array<Record<string, unknown>> {
    return [
  ...
  private _mapBudgetPlannerArchRiskSurface(): Array<Record<string, unknown>> {
    return [
  ...
  private _assessBudgetPlannerTechDebt(): Array<Record<string, unknown>> {
    return this._budget_plannerArchComponents
  ...
  private _buildBudgetPlannerEvolutionTimeline(): Array<Record<string, unknown>> {
    return [
  ...
  private _initBudgetPlannerDesignPatterns() {
    this._budget_plannerDesignPatterns = [
    ...
    this._budget_plannerPatternCompliance = this._assessBudgetPlannerPatternCompliance();
    this._budget_plannerPatternGaps = this._identifyBudgetPlannerPatternGaps();
  }

  private _assessBudgetPlannerPatternCompliance(): Array<Record<string, unknown>> {
    return this._budget_plannerDesignPatterns.map((pat: Record<string, unknown>) => ({
  ...
  private _identifyBudgetPlannerPatternGaps(): Array<Record<string, unknown>> {
    return this._budget_plannerDesignPatterns
  ...
  private _initBudgetPlannerCapacityPlanning() {
    this._budget_plannerCapacityModels = [
    ...
    this._budget_plannerCapacityForecast = this._forecastBudgetPlannerCapacity();
    this._budget_plannerCapacityAlerts = this._checkBudgetPlannerCapacityAlerts();
  }

  private _forecastBudgetPlannerCapacity(): Array<Record<string, unknown>> {
  ...
  private _checkBudgetPlannerCapacityAlerts(): Array<Record<string, unknown>> {
    return this._budget_plannerCapacityModels
  ...
  private _initBudgetPlannerIntegrationMatrix() {
    this._budget_plannerIntegrations = [
    ...
    this._budget_plannerIntegrationHealth = this._assessBudgetPlannerIntegrationHealth();
    this._budget_plannerIntegrationAlerts = this._monitorBudgetPlannerIntegrationAlerts();
    this._budget_plannerDataFlowMatrix = this._buildBudgetPlannerDataFlowMatrix();
    this._budget_plannerIntegrationSLA = this._trackBudgetPlannerIntegrationSLA();
  }

  private _assessBudgetPlannerIntegrationHealth(): Record<string, unknown> {
    const active = this._budget_plannerIntegrations.filter((i: Record<string, unknown>) => i.status === 'active').length;
    const degraded = this._budget_plannerIntegrations.filter((i: Record<string, unknown>) => i.status === 'degraded').length;
    const warning = this._budget_plannerIntegrations.filter((i: Record<string, unknown>) => i.status === 'warning').length;
    const avgLatency = this._budget_plannerIntegrations.reduce((s: number, i: Record<string, unknown>) => s + Number(i.latency), 0) / this._budget_plannerIntegrations.length;
    const avgErrorRate = this._budget_plannerIntegrations.reduce((s: number, i: Record<string, unknown>) => s + Number(i.errorRate), 0) / this._budget_plannerIntegrations.length;
    return {
      totalIntegrations: this._budget_plannerIntegrations.length, active, degraded, warning,
      healthScore: Math.round((active / this._budget_plannerIntegrations.length) * 100),
      avgLatencyMs: Math.round(avgLatency), avgErrorRate: Math.round(avgErrorRate * 1000) / 10,
      dataFreshness: '95%', coverage: '92%'
    };
  }

  private _monitorBudgetPlannerIntegrationAlerts(): Array<Record<string, unknown>> {
    return this._budget_plannerIntegrations
  ...
  private _buildBudgetPlannerDataFlowMatrix(): Array<Record<string, unknown>> {
  ...
  private _trackBudgetPlannerIntegrationSLA(): Array<Record<string, unknown>> {
    return this._budget_plannerIntegrations.map((i: Record<string, unknown>) => ({
      integrationId: i.integrationId, integrationName: i.name,
  ...
  private _initBudgetPlannerServiceMesh() {
    this._budget_plannerMeshServices = [
    ...
    this._budget_plannerMeshHealth = this._calcBudgetPlannerMeshHealth();
    this._budget_plannerMeshTraffic = this._analyzeBudgetPlannerMeshTraffic();
  }

  private _calcBudgetPlannerMeshHealth(): Record<string, unknown> {
    const healthy = this._budget_plannerMeshServices.filter((s: Record<string, unknown>) => Number(s.errorRate) < 0.03).length;
    return {
      totalServices: this._budget_plannerMeshServices.length, healthyServices: healthy,
      healthPercent: Math.round(healthy / this._budget_plannerMeshServices.length * 100),
      totalReplicas: this._budget_plannerMeshServices.reduce((s: number, svc: Record<string, unknown>) => s + Number(svc.replicas), 0),
      avgCpuUsage: Math.round(this._budget_plannerMeshServices.reduce((s: number, svc: Record<string, unknown>) => s + Number(svc.cpuUsage), 0) / this._budget_plannerMeshServices.length),
      avgMemoryUsage: Math.round(this._budget_plannerMeshServices.reduce((s: number, svc: Record<string, unknown>) => s + Number(svc.memoryUsage), 0) / this._budget_plannerMeshServices.length),
      avgLatencyP99: Math.round(this._budget_plannerMeshServices.reduce((s: number, svc: Record<string, unknown>) => s + Number(svc.latencyP99), 0) / this._budget_plannerMeshServices.length)
    };
  }

  private _analyzeBudgetPlannerMeshTraffic(): Array<Record<string, unknown>> {
    return this._budget_plannerMeshServices.map((s: Record<string, unknown>) => ({
...
<div class="tabs">
        ...
        ${this._activeTab === 'rules' ? html`
          ...
          <div style="background:#1a1d27;border-radius:8px;padding:12px">${this._renderBpTreemapSVG()}</div>
          <div style="margin-top:12px;font-size:11px;font-weight:600;margin-bottom:6px">Data Flow (Sankey)</div>
          <div style="background:#1a1d27;border-radius:8px;padding:12px">${this._renderBpSankeySVG()}</div>
          ${this._renderBpActivity()}
        ` : nothing}
        ${this._activeTab === 'anomalies' ? html`
          ${this._renderBpAnomalies()}
          ${this._renderBpNotifications()}
        ` : nothing}
        ${this._activeTab === 'predictions' ? html`
          ${this._renderBpPredictions()}
          ...
          <div style="background:#1a1d27;border-radius:8px;padding:12px">
            <table class="history-table"><thead><tr><th>ID</th><th>Base</th><th>Temporal</th><th>Environmental</th><th>Overall</th></tr></thead><tbody>
              ${this._bpcvssData.map(c => html`<tr><td>${c.itemId}</td><td style="color:${c.base >= 7 ? '#ef4444' : c.base >= 4 ? '#eab308' : '#22c55e'}">${c.base}</td><td>${c.temporal}</td><td>${c.environmental}</td><td style="font-weight:700;color:${c.overall >= 7 ? '#ef4444' : c.overall >= 4 ? '#eab308' : '#22c55e'}">${c.overall}</td></tr>`)}
            </tbody></table>
          </div>
        ` : nothing}
        ${this._activeTab === 'approvals' ? html`
          ${this._renderBpApprovals()}
        ` : nothing}
        ${this._activeTab === 'config' ? html`
          ${this._renderBpConfig()}
        ` : nothing}
        ${this._activeTab === 'new' ? html`
          <div class="form-section">
            <div class="form-title">Create New Budget Planner Entry</div>
            <div class="form-grid">
  ...
  @state() private _bpScenarios: {id:string;name:string;attackType:string;target:string;method:string;impactLow:number;impactHigh:number;confidence:number;mitigation:string;status:string}[] = [];
  @state() private _bpScenarioForm: {attackType:string;target:string;method:string} = {attackType:'',target:'',method:''};
  @state() private _bpScenarioCompare: boolean = false;
  @state() private _bpScenarioSelected: string[] = [];

  private _bpInitScenarios(): void {
    const saved = localStorage.getItem('bp_scenarios');
    if (saved) { try { this._bpScenarios = JSON.parse(saved); } catch { /* ignore */ } }
    if (this._bpScenarios.length === 0) {
      this._bpScenarios = [
        {id:'bp-s1',name:'Baseline Threat',attackType:'Phishing',target:'Employees',method:'Spear Email',impactLow:45,impactHigh:78,confidence:72,mitigation:'Security awareness training + email filtering',status:'active'},
        {id:'bp-s2',name:'Escalated Attack',attackType:'Ransomware',target:'Endpoints',method:'Drive-by Download',impactLow:65,impactHigh:95,confidence:58,mitigation:'EDR deployment + network segmentation',status:'saved'},
        {id:'bp-s3',name:'Insider Threat',attackType:'Data Exfiltration',target:'Databases',method:'SQL Injection',impactLow:55,impactHigh:88,confidence:65,mitigation:'DLP policies + query monitoring',status:'draft'},
      ];
    }
  }

  private _bpSaveScenarios(): void {
    localStorage.setItem('bp_scenarios', JSON.stringify(this._bpScenarios));
  }

  private _bpAddScenario(): void {
    const f = this._bpScenarioForm;
    if (!f.attackType || !f.target) return;
    this._bpScenarios = [...this._bpScenarios, {
      id: 'bp-s' + (this._bpScenarios.length + 1),
    ...
    this._bpScenarioForm = {attackType:'',target:'',method:''};
    this._bpSaveScenarios();
  }

  private _bpRenderScenarioEngine(): any {
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <button class="tab" @click=${() => { this._bpScenarioCompare = !this._bpScenarioCompare; }}>${this._bpScenarioCompare ? 'List View' : 'Compare'}</button>
        </div>
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:6px;margin-bottom:10px">
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._bpScenarioForm = {...this._bpScenarioForm, attackType: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Attack Type</option>
            ${attackTypes.map(a => html`<option value=${a} ${this._bpScenarioForm.attackType === a ? 'selected' : ''}>${a}</option>`)}
          </select>
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._bpScenarioForm = {...this._bpScenarioForm, target: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Target</option>
            ${targets.map(t => html`<option value=${t} ${this._bpScenarioForm.target === t ? 'selected' : ''}>${t}</option>`)}
          </select>
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._bpScenarioForm = {...this._bpScenarioForm, method: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Method</option>
            ${methods.map(m => html`<option value=${m} ${this._bpScenarioForm.method === m ? 'selected' : ''}>${m}</option>`)}
          </select>
        </div>
        <button style="background:#3b82f6;border:none;border-radius:4px;padding:4px 12px;color:#fff;font-size:11px;cursor:pointer" @click=${this._bpAddScenario}>Run Simulation</button>
      </div>
      ${this._bpScenarioCompare && this._bpScenarios.length >= 2 ? html`
        <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
          <div style="font-weight:600;font-size:12px;color:#e2e8f0;margin-bottom:8px">Side-by-Side Comparison</div>
          <div style="display:grid;grid-template-columns:repeat(${Math.min(3, this._bpScenarios.length)},1fr);gap:8px">
            ${this._bpScenarios.slice(0,3).map(s => html`
      ...
      <div style="background:#0f1117;border-radius:8px;padding:12px">
        <div style="font-weight:600;font-size:12px;color:#e2e8f0;margin-bottom:8px">Saved Scenarios (${this._bpScenarios.length})</div>
        ${this._bpScenarios.map(s => html`
  ...
  @state() private _bpTrendData: {day:number;value:number;anomaly:boolean}[] = [];
  @state() private _bpTrendZoom: {start:number;end:number} | null = null;
  @state() private _bpTrendMA: number = 7;

  private _bpInitTrendData(): void {
    ...
    this._bpTrendData = data;
  }

  private _bpCalcMA(window: number): number[] {
    const result: number[] = [];
    for (let i = 0; i < this._bpTrendData.length; i++) {
      const start = Math.max(0, i - window + 1);
      const slice = this._bpTrendData.slice(start, i + 1);
      result.push(slice.reduce((s, d) => s + d.value, 0) / slice.length);
    }
    return result;
  }

  private _bpGetStats(): {mean:number;median:number;stddev:number;trend:string} {
    const vals = this._bpTrendData.map(d => d.value);
    const n = vals.length;
  ...
  private _bpRenderTimeSeries(): any {
    const stats = this._bpGetStats();
    const filtered = this._bpTrendZoom ? this._bpTrendData.filter(d => d.day >= this._bpTrendZoom.start && d.day <= this._bpTrendZoom.end) : this._bpTrendData;
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px">
            <button class="tab ${this._bpTrendMA === 7 ? 'active' : ''}" @click=${() => { this._bpTrendMA = 7; }}>7D MA</button>
            <button class="tab ${this._bpTrendMA === 30 ? 'active' : ''}" @click=${() => { this._bpTrendMA = 30; }}>30D MA</button>
            <button class="tab" @click=${() => { this._bpTrendZoom = null; }}>Reset Zoom</button>
          </div>
        </div>
        <div style="position:relative;height:120px;background:#1a1d2e;border-radius:6px;overflow:hidden;margin-bottom:8px;cursor:crosshair" @click=${(e: any) => {
          ...
          this._bpTrendZoom = { start: Math.max(0, center - 10), end: Math.min(89, center + 10) };
        }}>
  ...
  @state() private _bpRoles: string[] = ['Admin','Analyst','Operator','Viewer','Auditor'];
  @state() private _bpActions: string[] = ['Create','Read','Update','Delete','Export','Approve'];
  @state() private _bpPermissions: { [role: string]: { [action: string]: boolean } } = {};
  @state() private _bpPermAudit: {role:string;action:string;changedBy:string;timestamp:string;oldVal:boolean;newVal:boolean}[] = [];
  @state() private _bpPermCompare: string[] = [];

  private _bpInitPermissions(): void {
    ...
    for (const role of this._bpRoles) {
      perms[role] = {};
      this._bpActions.forEach((a, i) => { perms[role][a] = defaults[role]?.[i] ?? false; });
    }
    this._bpPermissions = perms;
  }

  private _bpTogglePermission(role: string, action: string): void {
    const old = this._bpPermissions[role][action];
    this._bpPermissions = {...this._bpPermissions, [role]: {...this._bpPermissions[role], [action]: !old}};
    this._bpPermAudit.unshift({role,action,changedBy:'current_user',timestamp:new Date().toISOString(),oldVal:old,newVal:!old});
  }

  private _bpRenderRBAC(): any {
    const compareRoles = this._bpPermCompare.map(r => this._bpPermissions[r]).filter(Boolean);
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          <span style="font-weight:700;font-size:13px;color:#e2e8f0">RBAC Permission Matrix</span>
          <div style="display:flex;gap:4px">
            ${this._bpRoles.map(r => html`
              <button class="tab ${this._bpPermCompare.includes(r) ? 'active' : ''}" @click=${() => {
                this._bpPermCompare = this._bpPermCompare.includes(r) ? this._bpPermCompare.filter(x => x !== r) : [...this._bpPermCompare, r];
              }}>${r}</button>
            `)}
          </div>
        </div>
          ...
          <table style="width:100%;border-collapse:collapse;font-size:10px">
            <thead>
              <tr>
                ...
                ${this._bpActions.map(a => html`<th style="padding:6px;color:#6b7280;border-bottom:1px solid #2a2d3a;text-align:center">${a}</th>`)}
              </tr>
            </thead>
            <tbody>
              ${this._bpRoles.map(role => html`
                <tr style="border-bottom:1px solid #1a1d2e">
                  <td style="padding:6px;color:#e2e8f0;font-weight:600">${role}</td>
                  ${this._bpActions.map(action => html`
                    <td style="text-align:center;padding:6px">
                      <button style="width:28px;height:20px;border-radius:3px;border:1px solid #2a2d3a;background:${this._bpPermissions[role][action] ? '#22c55e' : '#1a1d2e'};cursor:pointer;color:#fff;font-size:10px" @click=${() => this._bpTogglePermission(role, action)}>${this._bpPermissions[role][action] ? 'Y' : 'N'}</button>
                    </td>
                  `)}
                </tr>
              `)}
        ...
        ${compareRoles.length >= 2 ? html`
          <div style="margin-top:10px;padding:8px;background:#1a1d2e;border-radius:6px">
            <div style="font-size:11px;font-weight:600;color:#e2e8f0;margin-bottom:6px">Role Diff: ${this._bpPermCompare.join(' vs ')}</div>
            ${this._bpActions.map(action => {
              ...
              return allSame ? nothing : html`
                <div style="display:flex;gap:8px;padding:3px 0;font-size:10px">
                  ...
                  ${compareRoles.map((r, i) => html`<span style="color:${r[action] ? '#22c55e' : '#ef4444'}">${this._bpPermCompare[i]}=${r[action] ? 'Y' : 'N'}</span>`)}
                </div>
              `;
            })}
          </div>
        ` : nothing}
        ${this._bpPermAudit.length > 0 ? html`
          <div style="margin-top:8px;font-size:9px;color:#6b7280">Recent: ${this._bpPermAudit.slice(0,3).map(a => html`<span style="margin-right:8px">${a.role}.${a.action}: ${a.oldVal ? 'Y' : 'N'}->${a.newVal ? 'Y' : 'N'}</span>`)}
        ` : nothing}
      </div>
    `;
  }
  ...
  // === REPORTING SUITE ===
  @state() private _bpReportTemplate: string = 'executive';
  @state() private _bpReportSchedule: string = 'weekly';
  @state() private _bpReportDistList: string[] = ['security-team@company.com','ciso@company.com'];
  @state() private _bpReportHistory: {id:string;template:string;generatedAt:string;status:string}[] = [];

  private _bpGenerateReport(): void {
    const id = 'rpt-' + Date.now();
    this._bpReportHistory.unshift({id,template:this._bpReportTemplate,generatedAt:new Date().toISOString(),status:'sent'});
  }

  private _bpRenderReporting(): any {
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:8px">
          <div>
            ...
            ${templates.map(t => html`
              <div style="padding:6px;background:${this._bpReportTemplate === t.key ? '#1e3a5f' : '#1a1d2e'};border:1px solid ${this._bpReportTemplate === t.key ? '#3b82f6' : '#2a2d3a'};border-radius:4px;margin-bottom:4px;cursor:pointer" @click=${() => { this._bpReportTemplate = t.key; }}>
          ...
          <div>
            ...
            <div style="display:flex;gap:4px;margin-bottom:8px">
              ${schedules.map(s => html`<button class="tab ${this._bpReportSchedule === s.key ? 'active' : ''}" @click=${() => { this._bpReportSchedule = s.key; }}>${s.label}</button>`)}
            </div>
            <div style="font-size:10px;color:#6b7280;margin-bottom:4px">Distribution</div>
            <div style="font-size:10px;color:#9ca3af">${this._bpReportDistList.map(d => html`<div>${d}</div>`)}</div>
            <div style="margin-top:6px;display:flex;gap:4px">
              <button style="background:#3b82f6;border:none;border-radius:4px;padding:4px 10px;color:#fff;font-size:10px;cursor:pointer" @click=${this._bpGenerateReport}>Generate</button>
        ...
        ${this._bpReportHistory.length > 0 ? html`
          <div style="border-top:1px solid #2a2d3a;padding-top:8px">
            ...
            ${this._bpReportHistory.slice(0,3).map(r => html`
  ...
  @state() private _bpHighContrast: boolean = false;
  @state() private _bpA11yAnnounce: string = '';
  @state() private _bpShortcutsVisible: boolean = false;
  @state() private _bpFocusTrap: boolean = false;

  private _bpShortcuts: Record<string, string> = {
  ...
  private _bpHandleKeydown(e: KeyboardEvent): void {
    if (e.key === 'Escape' && this._bpFocusTrap) { this._bpFocusTrap = false; this._bpAnnounce('Dialog closed'); }
    if (e.ctrlKey && e.shiftKey && e.key === 'H') { e.preventDefault(); this._bpHighContrast = !this._bpHighContrast; this._bpAnnounce('High contrast ' + (this._bpHighContrast ? 'enabled' : 'disabled')); }
    if (e.ctrlKey && e.shiftKey && e.key === 'A') { e.preventDefault(); this._bpShortcutsVisible = !this._bpShortcutsVisible; }
  }

  private _bpAnnounce(msg: string): void {
    this._bpA11yAnnounce = msg;
    setTimeout(() => { this._bpA11yAnnounce = ''; }, 2000);
  }

  private _bpRenderAccessibility(): any {
    return html`
      <div role="region" aria-label="Accessibility Controls" style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <button class="tab ${this._bpShortcutsVisible ? 'active' : ''}" @click=${() => { this._bpShortcutsVisible = !this._bpShortcutsVisible; }} aria-expanded=${this._bpShortcutsVisible}>Shortcuts</button>
        </div>
        <div style="display:flex;gap:8px;margin-bottom:8px">
          <label style="display:flex;align-items:center;gap:6px;font-size:11px;color:#e2e8f0;cursor:pointer">
            <input type="checkbox" .checked=${this._bpHighContrast} @change=${() => { this._bpHighContrast = !this._bpHighContrast; }} aria-label="Toggle high contrast mode">
            High Contrast
          </label>
        </div>
        ${this._bpShortcutsVisible ? html`
          <div role="list" aria-label="Keyboard shortcuts" style="background:#1a1d2e;border-radius:6px;padding:8px">
            ${Object.entries(this._bpShortcuts).map(([key, desc]) => html`
        ...
        ` : nothing}
        <div role="status" aria-live="polite" aria-atomic="true" style="position:absolute;left:-9999px">${this._bpA11yAnnounce}</div>
      </div>
    `;
  }
  ...
  connectedCallback(): void {
    ...
    this._bpInitScenarios();
    this._bpInitTrendData();
    this._bpInitPermissions();
    document.addEventListener('keydown', this._bpHandleKeydown.bind(this));
  }

  disconnectedCallback(): void {
    super.disconnectedCallback();
    document.removeEventListener('keydown', this._bpHandleKeydown.bind(this));
  }

  // === TAB INTEGRATION FOR EXTENDED FEATURES ===
  @state() private _bpActiveSubTab: string = 'scenario';
  ...
  private _initThreatModel() {
    const categories = [
      ...
      { id: 'tc2', category: 'Tampering', threats: [
        { id: 't4', name: 'Data injection in security budgeting', stride: 'T', likelihood: 7, impact: 8, dreadScore: 7.0, status: 'open', mitigations: ['Input validation', 'WAF rules'], assignedTo: 'Dev Team', discoveredDate: '2024-01-08', lastReviewed: '2024-02-10' },
  ...
  private _bpGetAllSubTabs(): {key:string;label:string}[] {
    return [
  ...
  private _bpRenderSubPanel(): any {
    switch (this._bpActiveSubTab) {
      case 'scenario': return this._bpRenderScenarioEngine();
      case 'timeseries': return this._bpRenderTimeSeries();
      case 'rbac': return this._bpRenderRBAC();
      case 'reporting': return this._bpRenderReporting();
      case 'a11y': return this._bpRenderAccessibility();
      default: return nothing;
    }
  }

  private _bpRenderTabBar(): any {
    return html`
      <div style="display:flex;gap:4px;margin-bottom:12px;border-bottom:1px solid #2a2d3a;padding-bottom:8px;flex-wrap:wrap" role="tablist" aria-label="Extended panel features">
        ${this._bpGetAllSubTabs().map(t => html`
          <button class="tab ${this._bpActiveSubTab === t.key ? 'active' : ''}" @click=${() => { this._bpActiveSubTab = t.key; }} role="tab" aria-selected=${this._bpActiveSubTab === t.key}>${t.label}</button>
        `)}
      </div>
      <div role="tabpanel" aria-labelledby="bp-tab-${this._bpActiveSubTab}">
        ${this._bpRenderSubPanel()}
      </div>
    `;
  }
  ...
  @state() private _soarPlaybooks: Array<{
    ...
    {
      id: 'pb-soar-001', name: 'Budget Planner Auto Response', status: 'active',
      steps: [
    ...
    {
      id: 'pb-soar-002', name: 'Budget Planner Investigation Workflow', status: 'active',
      steps: [
    ...
    {
      id: 'pb-soar-003', name: 'Budget Planner Compliance Scan', status: 'draft',
      steps: [
  ...
  @state() private _bpAle: number = 0;
  @state() private _bpSroi: number = 0;
  @state() private _bpCpi: number = 0;
  @state() private _bpBudgetAlloc: number = 0;
  @state() private _bpCostBenefit: number = 0;

  // Security Economics Calculator
  private bpInitEconomics() {
    this._bpAle = Math.round(2850000 + Math.random() * 4500000);
    this._bpSroi = Math.round(180 + Math.random() * 320);
    this._bpCpi = Math.round(45000 + Math.random() * 120000);
    this._bpBudgetAlloc = Math.round(2500000 + Math.random() * 3000000);
    this._bpCostBenefit = Math.round(220 + Math.random() * 180);
  }

  private _bpCalcAle(): { annual: number; perIncident: number; byCategory: Array<{name: string; value: number}> } {
    const base = this._bpAle;
    const categories = [
  ...
  private _bpCalcSroi(): Array<{year: number; investment: number; savings: number; roi: number}> {
    const baseInv = this._bpSroi * 10000;
  ...
  private _bpGetBudgetAlloc(): Array<{category: string; amount: number; pct: number; trend: string}> {
    const total = this._bpBudgetAlloc;
    const items = [
  ...
  private _bpGetCostBenefit(): Array<{control: string; cost: number; benefit: number; ratio: number; priority: string}> {
    const base = this._bpCostBenefit;
    const controls = [
  ...
  private _bpRenderEconomics() {
    const ale = this._bpCalcAle();
    const roi = this._bpCalcSroi();
    const budget = this._bpGetBudgetAlloc();
    const cb = this._bpGetCostBenefit();
    const cpi = this._bpCpi;
  ...
  @state() private _bpThreatLevel: any = null;
  @state() private _bpEmergingThreats: any = null;
  @state() private _bpThreatTrends: any = null;
  @state() private _bpSectorRadar: any = null;
  @state() private _bpActorActivity: any = null;

  // Threat Landscape Intelligence
  private bpInitThreatIntel() {
    this._bpThreatLevel = {
  ...
  private _bpRenderThreatIntel() {
    const tl = this._bpThreatLevel;
    const et = this._bpEmergingThreats;
    const sr = this._bpSectorRadar;
    const aa = this._bpActorActivity;
  ...
  @state() private _bpPolicies: any = null;
  @state() private _bpExceptions: any = null;
  @state() private _bpRiskRegister: any = null;
  @state() private _bpMeetings: any = null;
  @state() private _bpDeadlines: any = null;

  // Security Governance Dashboard
  private bpInitGovernance() {
    this._bpPolicies = [
  ...
  private _bpRenderGovernance() {
    const policies = this._bpPolicies;
    const risks = this._bpRiskRegister;
    const deadlines = this._bpDeadlines;
  ...
  @state() private _bpCriticalAssets: any = null;
  @state() private _bpAssetDeps: any = null;
  @state() private _bpEolAssets: any = null;
  @state() private _bpAssetRisk: any = null;

  // Asset Intelligence
  private bpInitAssetIntel() {
    this._bpCriticalAssets = [
    ...
    this._bpAssetRisk = { critical: 7, high: 23, medium: 45, low: 128, total: 203 };
  }

  private _bpRenderAssetIntel() {
    const assets = this._bpCriticalAssets;
    const eol = this._bpEolAssets;
    const ar = this._bpAssetRisk;
  ...
  @state() private _bpUserBaseline: any = null;
  @state() private _bpAnomalyRules: any = null;
  @state() private _bpDataAccess: any = null;
  @state() private _bpInsiderRisk: any = null;
  @state() private _budgetr15Timeline: Array<{id:string;time:string;event:string;severity:string;actor:string}> = [
  ...
  @state() private _budgetr15RootCauses: Array<{why:string;answer:string}> = [
  ...
  @state() private _budgetr15ImpactMatrix: Array<{system:string;users:number;data:string;revenue:string;status:string}> = [
  ...
  @state() private _budgetr15Actions: Array<{id:string;item:string;owner:string;deadline:string;priority:string;status:string}> = [
  ...
  @state() private _budgetr15Lessons: Array<{id:string;lesson:string;category:string;severity:string;applies_to:string}> = [
  ...
  @state() private _budgetr15ActiveTab: string = 'timeline';
  @state() private _budgetr15Benchmarks: Array<{metric:string;current:number;industry:number;target:number;unit:string;source:string}> = [
  ...
  @state() private _budgetr15MaturityLevels: Array<{domain:string;current:number;target:number;description:string}> = [
  ...
  @state() private _budgetr15QuarterlyData: Array<{quarter:string;score:number;improvement:number}> = [
  ...
  @state() private _budgetr15SelectedDomain: string = 'all';
  @state() private _budgetr15Alerts: Array<{id:string;name:string;severity:number;confidence:number;assetCrit:number;score:number;enriched:boolean;group:string;status:string;enrichData:Array<{key:string;value:string}>}> = [
  ...
  @state() private _budgetr15QualityMetrics: {fpRate:number;enrichSuccess:number;avgTriageTime:number;enrichedCount:number;totalCount:number} = {fpRate:0.12, enrichSuccess:0.78, avgTriageTime:4.5, enrichedCount:3, totalCount:5};
  @state() private _budgetr15RoutingRules: Array<{name:string;condition:string;channel:string;active:boolean}> = [
  ...
  @state() private _budgetr15Shapes: Array<{id:string;type:string;label:string;controls:string[]}> = [
  ...
  @state() private _budgetr15TrustBoundaries: Array<{from:string;to:string;label:string;strength:string}> = [
  ...
  @state() private _budgetr15ADRs: Array<{id:string;title:string;status:string;date:string;decision:string}> = [
  ...
  @state() private _budgetr15SelectedShape: string = '';
  @state() private _budgetr15Gauges: Array<{name:string;value:number;max:number;unit:string;status:string;color:string}> = [
  ...
  @state() private _budgetr15Anomalies: Array<{id:string;time:string;description:string;severity:string;acknowledged:boolean}> = [
  ...
  @state() private _budgetr15Integrations: Array<{name:string;status:string;uptime:number;lastCheck:string;latency:number}> = [
  ...
  @state() private _budgetr15AlertFatigue: Array<{analyst:string;alertsPerDay:number;escalated:number;dismissed:number;avgResponseMin:number}> = [
  ...
  @state() private _budgetr15SlaTarget: number = 99.9;

  // Insider Threat Detection
  private bpInitInsiderThreat() {
    this._bpUserBaseline = [
    ...
    this._bpInsiderRisk = { totalUsers: 2847, monitored: 342, flagged: 18, investigated: 5, confirmed: 1 };
  }

  private _bpRenderInsiderThreat() {
    const baseline = this._bpUserBaseline;
    const rules = this._bpAnomalyRules;
    const ir = this._bpInsiderRisk;
    ...
    return html`<div class="card" style="padding:14px;margin-bottom:8px">
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px;margin-bottom:10px;flex-wrap:wrap">
            ${['timeline','rootcause','impact','actions','lessons'].map(t => html`
              <button class="btn ${this._budgetr15ActiveTab === t ? 'btn-primary' : ''}" style="font-size:10px;padding:3px 8px" @click=${() => { this._budgetr15ActiveTab = t; }}>${t.charAt(0).toUpperCase() + t.slice(1)}</button>
            `)}
          </div>
          ${this._budgetr15ActiveTab === 'timeline' ? html`
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._budgetr15Timeline.map(e => html`
          ...
          ` : this._budgetr15ActiveTab === 'rootcause' ? html`
            <div style="margin-bottom:8px">${{__html: this._budgetr15RenderFishbone()}}</div>
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._budgetr15RootCauses.map((rc, i) => html`
          ...
          ` : this._budgetr15ActiveTab === 'impact' ? html`
            <div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:10px">
              ...
              <tbody>${this._budgetr15ImpactMatrix.map(imp => html`
          ...
          ` : this._budgetr15ActiveTab === 'actions' ? html`
            <div style="display:flex;gap:12px;margin-bottom:8px;font-size:10px;color:#888">
              ${Object.entries(this._budgetr15GetActionStats()).map(([k,v]) => html`<span>${k}: <b style="color:#ddd">${v}</b></span>`)}
            </div>
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._budgetr15Actions.map(a => html`
                <div style="display:flex;gap:8px;align-items:center;padding:6px;background:#1a1d27;border-radius:4px;cursor:pointer" @click=${() => this._budgetr15ToggleAction(a.id)}>
          ...
          ` : html`
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._budgetr15Lessons.map(l => html`
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px;margin-bottom:10px;flex-wrap:wrap">
            ${['all', ...this._budgetr15MaturityLevels.map(m => m.domain)].map(d => html`
              <button class="btn ${this._budgetr15SelectedDomain === d ? 'btn-primary' : ''}" style="font-size:9px;padding:2px 6px" @click=${() => { this._budgetr15SelectedDomain = d; }}>${d}</button>
            `)}
          </div>
          <div style="display:flex;gap:16px;margin-bottom:10px">
            <div style="text-align:center"><div style="color:#e0e0e0;font-size:20px;font-weight:bold">${this._budgetr15GetOverallMaturity()}/5</div><div style="color:#888;font-size:10px">Maturity Level</div></div>
            <div style="text-align:center"><div style="color:#4f4;font-size:20px;font-weight:bold">${this._budgetr15GetGapAnalysis().filter(g => g.isAbove).length}/${this._budgetr15Benchmarks.length}</div><div style="color:#888;font-size:10px">Above Industry</div></div>
          </div>
          <div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:10px">
            ...
            <tbody>${this._budgetr15GetGapAnalysis().map(b => html`
          ...
          <div style="margin-top:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Maturity by Domain</div>
            ${this._budgetr15MaturityLevels.filter(m => this._budgetr15SelectedDomain === 'all' || m.domain === this._budgetr15SelectedDomain).map(m => html`
          ...
          <div style="margin-top:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Quarterly Trend</div>
            <div style="display:flex;height:40px;align-items:flex-end;gap:4px">
              ${this._budgetr15QuarterlyData.map(q => html`<div style="flex:1;text-align:center"><div style="background:#4a9eff;height:${q.score * 0.5}px;border-radius:2px 2px 0 0" title="${q.score}"></div><div style="color:#666;font-size:8px;margin-top:2px">${q.quarter}</div></div>`)}
            </div>
          </div>
        </div>
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:12px;margin-bottom:8px;font-size:10px">
            <div style="display:flex;gap:4px;flex-wrap:wrap">${this._budgetr15GroupAlerts().map(g => html`<span style="color:#888;padding:2px 6px;background:#1a1d27;border-radius:3px">${g.group}: ${g.count}</span>`)}</div>
          </div>
          <div style="display:flex;gap:8px;margin-bottom:8px;font-size:10px;color:#888">
            <span>FP Rate: <b style="color:${this._budgetr15QualityMetrics.fpRate > 0.15 ? '#f44' : '#4f4'}">${(this._budgetr15QualityMetrics.fpRate * 100).toFixed(1)}%</b></span>
            <span>Enrich: <b style="color:#4a9eff">${(this._budgetr15QualityMetrics.enrichSuccess * 100).toFixed(0)}%</b></span>
            <span>Avg Triage: <b style="color:#ddd">${this._budgetr15QualityMetrics.avgTriageTime}m</b></span>
          </div>
          <div style="display:flex;flex-direction:column;gap:4px;max-height:200px;overflow-y:auto">
            ${this._budgetr15Alerts.sort((a, b) => this._budgetr15CalcScore(b) - this._budgetr15CalcScore(a)).map(a => {
              const score = this._budgetr15CalcScore(a);
              return html`
                <div style="padding:6px;background:#1a1d27;border-radius:4px;border-left:3px solid ${a.severity >= 4 ? '#f44' : a.severity >= 3 ? '#fa0' : '#4a9eff'}">
                  <div style="display:flex;justify-content:space-between;align-items:center">
                    ...
                    <button class="btn" style="font-size:9px;padding:1px 6px;margin-left:4px" @click=${() => this._budgetr15EnrichAlert(a.id)}>${a.enriched ? 'Re-enrich' : 'Enrich'}</button>
                  </div>
          ...
          <div style="margin-top:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Routing Rules</div>
            ${this._budgetr15RoutingRules.map(r => html`
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:8px;margin-bottom:8px;flex-wrap:wrap">
            ${this._budgetr15Shapes.map(s => {
              const v = this._budgetr15ValidateControl(s.id);
              return html`<div style="padding:4px 8px;background:#1a1d27;border-radius:3px;cursor:pointer;border:1px solid ${this._budgetr15SelectedShape === s.id ? '#4a9eff' : '#2a2d37'}" @click=${() => { this._budgetr15SelectedShape = this._budgetr15SelectedShape === s.id ? '' : s.id; }}>
          ...
          ${this._budgetr15SelectedShape ? html`
            ${(() => {
              const shape = this._budgetr15Shapes.find(s => s.id === this._budgetr15SelectedShape);
              const v = this._budgetr15ValidateControl(this._budgetr15SelectedShape);
              return shape ? html`
          ...
          <div style="margin-bottom:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Trust Boundaries</div>
            ${this._budgetr15TrustBoundaries.map(tb => html`
              <div style="display:flex;gap:6px;align-items:center;padding:3px;background:#1a1d27;border-radius:3px;margin-bottom:2px;font-size:9px">
                <span style="color:#ddd">${this._budgetr15Shapes.find(s => s.id === tb.from)?.label || tb.from}</span>
                <span style="color:#4a9eff">\u2194</span>
                <span style="color:#ddd">${this._budgetr15Shapes.find(s => s.id === tb.to)?.label || tb.to}</span>
          ...
          <div><div style="color:#888;font-size:10px;margin-bottom:4px">Architecture Decision Records</div>
            ${this._budgetr15ADRs.map(adr => html`
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:8px;margin-bottom:8px;flex-wrap:wrap">
            ${this._budgetr15Gauges.map(g => html`
          ...
          <div style="display:flex;gap:8px;margin-bottom:8px;align-items:center">
            ...
            <span style="color:${this._budgetr15GetOverallHealth().score >= 99 ? '#4f4' : '#fa0'};font-size:12px;font-weight:bold">${this._budgetr15GetOverallHealth().score}%</span>
            <span style="color:#888;font-size:10px">(Target: ${this._budgetr15SlaTarget}%)</span>
            <span style="color:#4f4;font-size:10px">${this._budgetr15GetOverallHealth().healthy} healthy</span>
            <span style="color:#fa0;font-size:10px">${this._budgetr15GetOverallHealth().degraded} degraded</span>
          </div>
          <div style="margin-bottom:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Anomaly Stream</div>
            ${this._budgetr15Anomalies.slice(0, 3).map(a => html`
              <div style="display:flex;gap:6px;align-items:center;padding:4px;background:#1a1d27;border-radius:3px;margin-bottom:2px;opacity:${a.acknowledged ? 0.5 : 1}">
                ...
                ${!a.acknowledged ? html`<button class="btn" style="font-size:8px;padding:1px 4px" @click=${() => this._budgetr15AckAnomaly(a.id)}>ACK</button>` : html`<span style="color:#4f4;font-size:9px">ACK'd</span>`}
              </div>
            `)}
          </div>
          <div style="margin-bottom:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Integration Health</div>
            ${this._budgetr15Integrations.map(i => html`
              <div style="display:flex;gap:6px;align-items:center;padding:3px;background:#1a1d27;border-radius:3px;margin-bottom:2px;font-size:9px">
          ...
          <div><div style="color:#888;font-size:10px;margin-bottom:4px">Alert Fatigue Analysis</div>
            <div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:9px">
              ...
              <tbody>${this._budgetr15AlertFatigue.map(af => html`
  ...
  private _budgetr15RenderFishbone(): string {
  ...
  private _budgetr15ToggleAction(id: string) {
    this._budgetr15Actions = this._budgetr15Actions.map(a => a.id === id ? {...a, status: a.status === 'pending' ? 'in_progress' : a.status === 'in_progress' ? 'completed' : 'pending'} : a);
  }

  private _budgetr15GetActionStats() {
    const total = this._budgetr15Actions.length;
    const done = this._budgetr15Actions.filter(a => a.status === 'completed').length;
    const inProg = this._budgetr15Actions.filter(a => a.status === 'in_progress').length;
    return { total, done, inProg, pending: total - done - inProg };
  }

  private _budgetr15GetOverallMaturity(): number {
    if (this._budgetr15SelectedDomain === 'all') {
      return Math.round(this._budgetr15MaturityLevels.reduce((s, m) => s + m.current, 0) / this._budgetr15MaturityLevels.length * 10) / 10;
    }
    const d = this._budgetr15MaturityLevels.find(m => m.domain === this._budgetr15SelectedDomain);
    return d ? d.current : 0;
  }

  private _budgetr15GetGapAnalysis() {
    return this._budgetr15Benchmarks.map(b => {
  ...
  private _budgetr15CalcScore(alert: any): number {
    return Math.round(alert.severity * alert.confidence * alert.assetCrit * 100) / 100;
  }

  private _budgetr15EnrichAlert(id: string) {
    this._budgetr15Alerts = this._budgetr15Alerts.map(a => {
      if (a.id !== id) return a;
      const score = this._budgetr15CalcScore(a);
  ...
  private _budgetr15GroupAlerts() {
    const groups: Record<string, number> = {};
    this._budgetr15Alerts.forEach(a => { groups[a.group] = (groups[a.group] || 0) + 1; });
    return Object.entries(groups).map(([g, c]) => ({group: g, count: c}));
  }

  private _budgetr15ValidateControl(shapeId: string): {valid:boolean;missing:string[]} {
    const shape = this._budgetr15Shapes.find(s => s.id === shapeId);
  ...
  private _budgetr15GetOverallHealth(): {healthy:number;degraded:number;down:number;score:number} {
    const online = this._budgetr15Integrations.filter(i => i.status === 'online').length;
    const degraded = this._budgetr15Integrations.filter(i => i.status === 'degraded').length;
    const total = this._budgetr15Integrations.length;
    return { healthy: online, degraded, down: total - online - degraded, score: Math.round(online / total * 100) };
  }

  private _budgetr15AckAnomaly(id: string) {
    this._budgetr15Anomalies = this._budgetr15Anomalies.map(a => a.id === id ? {...a, acknowledged: true} : a);
  }
...
// ===== SECURITY CONTROL TESTING (R22) =====
  ...
  private _renderBudgetPlanning() {
    const budgetData = [
      { category: "Personnel & Training", planned: 1160000, actual: 4596000, utilization: 396.2, q1: "20%", q2: "25%", q3: "23%", q4: "15%" },
      { category: "Tooling & Licensing", planned: 1167000, actual: 4609000, utilization: 394.9, q1: "23%", q2: "30%", q3: "18%", q4: "16%" },
      { category: "Infrastructure Security", planned: 1174000, actual: 4622000, utilization: 393.7, q1: "26%", q2: "35%", q3: "29%", q4: "17%" },
      { category: "Compliance & Audit", planned: 1181000, actual: 4635000, utilization: 392.5, q1: "29%", q2: "24%", q3: "24%", q4: "18%" },
      { category: "Incident Response", planned: 1188000, actual: 4648000, utilization: 391.2, q1: "16%", q2: "29%", q3: "19%", q4: "19%" },
      { category: "Third-Party Assessments", planned: 1195000, actual: 4661000, utilization: 390.0, q1: "19%", q2: "34%", q3: "30%", q4: "20%" },
      { category: "Security Awareness", planned: 1202000, actual: 4674000, utilization: 388.9, q1: "22%", q2: "23%", q3: "25%", q4: "21%" },
      { category: "Research & Innovation", planned: 1209000, actual: 4687000, utilization: 387.7, q1: "25%", q2: "28%", q3: "20%", q4: "22%" },
    ];
    ...
    const headcount = [
      { team: "SOC Tier 1", current: 7, target: 16, gap: 5, avgSalary: "174k" },
      { team: "SOC Tier 2", current: 16, target: 15, gap: 4, avgSalary: "92k" },
      { team: "Threat Intel", current: 8, target: 14, gap: 3, avgSalary: "121k" },
      { team: "Red Team", current: 17, target: 13, gap: 2, avgSalary: "150k" },
      { team: "GRC", current: 9, target: 12, gap: 1, avgSalary: "179k" },
      { team: "AppSec", current: 18, target: 11, gap: 0, avgSalary: "97k" },
      { team: "Cloud Sec", current: 10, target: 10, gap: 5, avgSalary: "126k" },
      { team: "Identity & Access", current: 2, target: 9, gap: 4, avgSalary: "155k" },
    ];
    const vendorSpend = [
      { vendor: "CrowdStrike", annual: "584k", contractEnd: "2026-06", renewalRisk: "Low", satisfaction: 5 },
      { vendor: "Palo Alto", annual: "615k", contractEnd: "2026-07", renewalRisk: "Medium", satisfaction: 4 },
      { vendor: "Splunk", annual: "646k", contractEnd: "2026-08", renewalRisk: "High", satisfaction: 3 },
      { vendor: "Qualys", annual: "677k", contractEnd: "2026-09", renewalRisk: "Low", satisfaction: 5 },
      { vendor: "Rapid7", annual: "708k", contractEnd: "2026-10", renewalRisk: "Medium", satisfaction: 4 },
      { vendor: "Mandiant", annual: "739k", contractEnd: "2026-11", renewalRisk: "High", satisfaction: 3 },
      { vendor: "Zscaler", annual: "770k", contractEnd: "2026-12", renewalRisk: "Low", satisfaction: 5 },
      { vendor: "Duo Security", annual: "50k", contractEnd: "2026-01", renewalRisk: "Medium", satisfaction: 4 },
    ];
    const roiProjections = [
      { area: "Threat Detection", investment: "198k", projectedReturn: "1676k", roiMultiple: "2.6x", confidence: 77 },
      { area: "Incident Reduction", investment: "241k", projectedReturn: "1723k", roiMultiple: "2.5x", confidence: 94 },
      { area: "Compliance Savings", investment: "284k", projectedReturn: "1770k", roiMultiple: "2.4x", confidence: 75 },
      { area: "Automation Gains", investment: "327k", projectedReturn: "1817k", roiMultiple: "2.3x", confidence: 92 },
      { area: "Risk Avoidance", investment: "370k", projectedReturn: "1864k", roiMultiple: "2.2x", confidence: 73 },
    ];
    return html`
  ...
  private _renderMetricsNormalization() {
    const kpiCatalog = [
      { id: "kpi-1", name: "MTTD", owner: "SOC", unit: "minutes", target: 72, current: 83, benchmark: 83, collection: "auto", frequency: "realtime" },
      { id: "kpi-2", name: "MTTR", owner: "GRC", unit: "%", target: 75, current: 90, benchmark: 94, collection: "semi-auto", frequency: "daily" },
      { id: "kpi-3", name: "MTTC", owner: "AppSec", unit: "score", target: 78, current: 97, benchmark: 71, collection: "manual", frequency: "weekly" },
      { id: "kpi-4", name: "Vuln SLA Compliance", owner: "Cloud Sec", unit: "count", target: 81, current: 58, benchmark: 82, collection: "auto", frequency: "monthly" },
      { id: "kpi-5", name: "Patch Coverage", owner: "Identity", unit: "days", target: 84, current: 65, benchmark: 93, collection: "semi-auto", frequency: "realtime" },
      { id: "kpi-6", name: "Phishing Click Rate", owner: "Threat Intel", unit: "minutes", target: 87, current: 72, benchmark: 70, collection: "manual", frequency: "daily" },
      { id: "kpi-7", name: "Training Completion", owner: "Security Ops", unit: "%", target: 90, current: 79, benchmark: 81, collection: "auto", frequency: "weekly" },
      { id: "kpi-8", name: "Escalation Rate", owner: "Risk Mgmt", unit: "score", target: 93, current: 86, benchmark: 92, collection: "semi-auto", frequency: "monthly" },
      { id: "kpi-9", name: "False Positive Rate", owner: "SOC", unit: "count", target: 96, current: 93, benchmark: 69, collection: "manual", frequency: "realtime" },
      { id: "kpi-10", name: "Threat Intel Actionability", owner: "GRC", unit: "days", target: 99, current: 100, benchmark: 80, collection: "auto", frequency: "daily" },
      { id: "kpi-11", name: "Endpoint Compliance", owner: "AppSec", unit: "minutes", target: 72, current: 61, benchmark: 91, collection: "semi-auto", frequency: "weekly" },
      { id: "kpi-12", name: "Cloud Misconfig Score", owner: "Cloud Sec", unit: "%", target: 75, current: 68, benchmark: 68, collection: "manual", frequency: "monthly" },
      { id: "kpi-13", name: "Identity Anomaly Rate", owner: "Identity", unit: "score", target: 78, current: 75, benchmark: 79, collection: "auto", frequency: "realtime" },
      { id: "kpi-14", name: "DLP Events", owner: "Threat Intel", unit: "count", target: 81, current: 82, benchmark: 90, collection: "semi-auto", frequency: "daily" },
      { id: "kpi-15", name: "Vendor Risk Avg", owner: "Security Ops", unit: "days", target: 84, current: 89, benchmark: 67, collection: "manual", frequency: "weekly" },
      { id: "kpi-16", name: "Compliance Audit Pass Rate", owner: "Risk Mgmt", unit: "minutes", target: 87, current: 96, benchmark: 78, collection: "auto", frequency: "monthly" },
      { id: "kpi-17", name: "Awareness Score", owner: "SOC", unit: "%", target: 90, current: 57, benchmark: 89, collection: "semi-auto", frequency: "realtime" },
      { id: "kpi-18", name: "SOC Utilization", owner: "GRC", unit: "score", target: 93, current: 64, benchmark: 66, collection: "manual", frequency: "daily" },
      { id: "kpi-19", name: "Automation Coverage", owner: "AppSec", unit: "count", target: 96, current: 71, benchmark: 77, collection: "auto", frequency: "weekly" },
      { id: "kpi-20", name: "Risk Register Currency", owner: "Cloud Sec", unit: "days", target: 99, current: 78, benchmark: 88, collection: "semi-auto", frequency: "monthly" },
    ];
    const benchmarkSources = [
      { source: "NIST CSF", mappedKPIs: 5, alignment: 95, lastReview: "2026-03-25", status: "aligned" },
      { source: "CIS Controls v8", mappedKPIs: 6, alignment: 73, lastReview: "2026-04-20", status: "partial" },
      { source: "ISO 27001:2022", mappedKPIs: 7, alignment: 90, lastReview: "2026-05-15", status: "reviewing" },
      { source: "PCI DSS 4.0", mappedKPIs: 8, alignment: 68, lastReview: "2026-06-10", status: "aligned" },
      { source: "SOC 2 Type II", mappedKPIs: 3, alignment: 85, lastReview: "2026-01-05", status: "partial" },
      { source: "MITRE ATT&CK", mappedKPIs: 4, alignment: 63, lastReview: "2026-02-28", status: "reviewing" },
      { source: "SANS Top 20", mappedKPIs: 5, alignment: 80, lastReview: "2026-03-23", status: "aligned" },
      { source: "OWASP Top 10", mappedKPIs: 6, alignment: 97, lastReview: "2026-04-18", status: "partial" },
    ];
  ...
  private _renderThreatHuntingCampaigns() {
    const campaigns = [
      { id: "HC-1001", name: "Lateral Movement Sweep", status: "active", hypothesis: "H1: Actors using pass-the-hash for lateral movement", leadHunter: "Alice Chen", findings: 36, startDate: "2026-01-17", endDate: null, effectiveness: 85 },
      { id: "HC-1002", name: "Credential Harvesting Hunt", status: "completed", hypothesis: "H2: Actors using web shells for persistence", leadHunter: "Bob Martinez", findings: 39, startDate: "2026-04-28", endDate: "2026-05-06", effectiveness: 45 },
      { id: "HC-1003", name: "Persistence Mechanism Audit", status: "planned", hypothesis: "H3: Actors using scheduled tasks for data theft", leadHunter: "Carol Wu", findings: 42, startDate: "2026-03-11", endDate: null, effectiveness: 64 },
      { id: "HC-1004", name: "C2 Beacon Detection", status: "in-review", hypothesis: "H4: Actors using DNS tunneling for C2 communication", leadHunter: "Dave Kim", findings: 45, startDate: "2026-02-22", endDate: null, effectiveness: 83 },
      { id: "HC-1005", name: "Data Exfiltration Patterns", status: "active", hypothesis: "H5: Actors using encrypted channels for privilege escalation", leadHunter: "Eve Johnson", findings: 0, startDate: "2026-01-05", endDate: null, effectiveness: 43 },
      { id: "HC-1006", name: "Privilege Escalation Scan", status: "completed", hypothesis: "H6: Actors using token impersonation for defense evasion", leadHunter: "Frank Liu", findings: 3, startDate: "2026-04-16", endDate: "2026-06-18", effectiveness: 62 },
      { id: "HC-1007", name: "Supply Chain Implant Hunt", status: "planned", hypothesis: "H7: Actors using poisoned images for initial access", leadHunter: "Grace Park", findings: 6, startDate: "2026-03-27", endDate: null, effectiveness: 81 },
      { id: "HC-1008", name: "Insider Threat Indicators", status: "in-review", hypothesis: "H8: Actors using legitimate tools for credential access", leadHunter: "Hector Silva", findings: 9, startDate: "2026-02-10", endDate: null, effectiveness: 41 },
      { id: "HC-1009", name: "Cloud Metadata Analysis", status: "active", hypothesis: "H9: Actors using API keys for command execution", leadHunter: "Alice Chen", findings: 12, startDate: "2026-01-21", endDate: null, effectiveness: 60 },
      { id: "HC-1010", name: "DNS Tunnel Detection", status: "completed", hypothesis: "H10: Actors using encoded subdomains for exfiltration", leadHunter: "Bob Martinez", findings: 15, startDate: "2026-04-04", endDate: "2026-04-02", effectiveness: 79 },
      { id: "HC-1011", name: "Fileless Malware Search", status: "planned", hypothesis: "H11: Actors using WMI providers for discovery", leadHunter: "Carol Wu", findings: 18, startDate: "2026-03-15", endDate: null, effectiveness: 98 },
      { id: "HC-1012", name: "Zero-Day Exploit Traces", status: "in-review", hypothesis: "H12: Actors using exploit kits for collection", leadHunter: "Dave Kim", findings: 21, startDate: "2026-02-26", endDate: null, effectiveness: 58 },
    ];
    const hunterLeaderboard = [
      { hunter: "Alice Chen", campaigns: 11, findings: 101, highSeverity: 8, avgScore: 55, streak: 5 },
      { hunter: "Bob Martinez", campaigns: 8, findings: 14, highSeverity: 13, avgScore: 92, streak: 6 },
      { hunter: "Carol Wu", campaigns: 5, findings: 43, highSeverity: 18, avgScore: 85, streak: 7 },
      { hunter: "Dave Kim", campaigns: 15, findings: 72, highSeverity: 23, avgScore: 78, streak: 8 },
      { hunter: "Eve Johnson", campaigns: 12, findings: 101, highSeverity: 2, avgScore: 71, streak: 1 },
      { hunter: "Frank Liu", campaigns: 9, findings: 14, highSeverity: 7, avgScore: 64, streak: 2 },
      { hunter: "Grace Park", campaigns: 6, findings: 43, highSeverity: 12, avgScore: 57, streak: 3 },
      { hunter: "Hector Silva", campaigns: 3, findings: 72, highSeverity: 17, avgScore: 94, streak: 4 },
    ];
    const mitreMapping = [
      { tactic: "Initial Access", techniques: 2, campaigns: 1, coverage: 41 },
      { tactic: "Execution", techniques: 12, campaigns: 6, coverage: 92 },
      { tactic: "Persistence", techniques: 11, campaigns: 5, coverage: 72 },
      { tactic: "Privilege Escalation", techniques: 10, campaigns: 4, coverage: 52 },
      { tactic: "Defense Evasion", techniques: 9, campaigns: 3, coverage: 32 },
      { tactic: "Credential Access", techniques: 8, campaigns: 2, coverage: 83 },
      { tactic: "Discovery", techniques: 7, campaigns: 1, coverage: 63 },
      { tactic: "Lateral Movement", techniques: 6, campaigns: 6, coverage: 43 },
      { tactic: "Collection", techniques: 5, campaigns: 5, coverage: 94 },
      { tactic: "Exfiltration", techniques: 4, campaigns: 4, coverage: 74 },
      { tactic: "Command & Control", techniques: 3, campaigns: 3, coverage: 54 },
      { tactic: "Impact", techniques: 2, campaigns: 2, coverage: 34 },
    ];
    return html`
  ...
  private _renderControlInventory() {
    const controls = [
      { id: "CTL-2001", name: "MFA Enforcement", domain: "Access Control", status: "implemented", effectiveness: 82, lastTest: "2026-01-09", nextReview: "2026-09-09", owner: "SOC", risk: "Low" },
      { id: "CTL-2002", name: "Network Segmentation", domain: "Network Security", status: "partial", effectiveness: 2, lastTest: "2026-04-22", nextReview: "2026-10-28", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2003", name: "EDR Deployment", domain: "Endpoint Protection", status: "planned", effectiveness: 9, lastTest: "2026-03-07", nextReview: "2026-11-19", owner: "IT Ops", risk: "High" },
      { id: "CTL-2004", name: "DLP Policy", domain: "Data Protection", status: "gap", effectiveness: 16, lastTest: "2026-02-20", nextReview: "2026-12-10", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2005", name: "SSO Integration", domain: "Identity Management", status: "implemented", effectiveness: 94, lastTest: "2026-01-05", nextReview: "2026-05-01", owner: "IAM", risk: "Low" },
      { id: "CTL-2006", name: "SAST Pipeline", domain: "Application Security", status: "partial", effectiveness: 30, lastTest: "2026-04-18", nextReview: "2026-06-20", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2007", name: "CSPM Scanning", domain: "Cloud Security", status: "planned", effectiveness: 37, lastTest: "2026-03-03", nextReview: "2026-07-11", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2008", name: "Badge Access", domain: "Physical Security", status: "gap", effectiveness: 44, lastTest: "2026-02-16", nextReview: "2026-08-02", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2009", name: "Least Privilege", domain: "Access Control", status: "implemented", effectiveness: 47, lastTest: "2026-01-01", nextReview: "2026-09-21", owner: "SOC", risk: "Low" },
      { id: "CTL-2010", name: "Firewall Rules", domain: "Network Security", status: "partial", effectiveness: 7, lastTest: "2026-04-14", nextReview: "2026-10-12", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2011", name: "Disk Encryption", domain: "Endpoint Protection", status: "planned", effectiveness: 14, lastTest: "2026-03-27", nextReview: "2026-11-03", owner: "IT Ops", risk: "High" },
      { id: "CTL-2012", name: "Data Classification", domain: "Data Protection", status: "gap", effectiveness: 21, lastTest: "2026-02-12", nextReview: "2026-12-22", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2013", name: "PAM Implementation", domain: "Identity Management", status: "implemented", effectiveness: 59, lastTest: "2026-01-25", nextReview: "2026-05-13", owner: "IAM", risk: "Low" },
      { id: "CTL-2014", name: "DAST Pipeline", domain: "Application Security", status: "partial", effectiveness: 35, lastTest: "2026-04-10", nextReview: "2026-06-04", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2015", name: "IAM Policy Review", domain: "Cloud Security", status: "planned", effectiveness: 42, lastTest: "2026-03-23", nextReview: "2026-07-23", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2016", name: "Visitor Management", domain: "Physical Security", status: "gap", effectiveness: 49, lastTest: "2026-02-08", nextReview: "2026-08-14", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2017", name: "Access Reviews", domain: "Access Control", status: "implemented", effectiveness: 71, lastTest: "2026-01-21", nextReview: "2026-09-05", owner: "SOC", risk: "Low" },
      { id: "CTL-2018", name: "IDS/IPS Tuning", domain: "Network Security", status: "partial", effectiveness: 12, lastTest: "2026-04-06", nextReview: "2026-10-24", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2019", name: "Patch Management", domain: "Endpoint Protection", status: "planned", effectiveness: 19, lastTest: "2026-03-19", nextReview: "2026-11-15", owner: "IT Ops", risk: "High" },
      { id: "CTL-2020", name: "Backup Encryption", domain: "Data Protection", status: "gap", effectiveness: 26, lastTest: "2026-02-04", nextReview: "2026-12-06", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2021", name: "Password Policy", domain: "Identity Management", status: "implemented", effectiveness: 83, lastTest: "2026-01-17", nextReview: "2026-05-25", owner: "IAM", risk: "Low" },
      { id: "CTL-2022", name: "Container Scanning", domain: "Application Security", status: "partial", effectiveness: 40, lastTest: "2026-04-02", nextReview: "2026-06-16", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2023", name: "WAF Configuration", domain: "Cloud Security", status: "planned", effectiveness: 47, lastTest: "2026-03-15", nextReview: "2026-07-07", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2024", name: "CCTV Coverage", domain: "Physical Security", status: "gap", effectiveness: 3, lastTest: "2026-02-28", nextReview: "2026-08-26", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2025", name: "RBAC Enforcement", domain: "Access Control", status: "implemented", effectiveness: 95, lastTest: "2026-01-13", nextReview: "2026-09-17", owner: "SOC", risk: "Low" },
      { id: "CTL-2026", name: "VPN Management", domain: "Network Security", status: "partial", effectiveness: 17, lastTest: "2026-04-26", nextReview: "2026-10-08", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2027", name: "App Whitelisting", domain: "Endpoint Protection", status: "planned", effectiveness: 24, lastTest: "2026-03-11", nextReview: "2026-11-27", owner: "IT Ops", risk: "High" },
      { id: "CTL-2028", name: "Key Management", domain: "Data Protection", status: "gap", effectiveness: 31, lastTest: "2026-02-24", nextReview: "2026-12-18", owner: "Data Gov", risk: "Critical" },
    ];
    const gapAnalysis = [
      { gap: "Insufficient MFA coverage for legacy apps", severity: "High", remediationPlan: "Plan R3001", eta: "2026-Q3", estimatedCost: "86k" },
      { gap: "Missing network micro-segmentation", severity: "Medium", remediationPlan: "Plan R3002", eta: "2026-Q2", estimatedCost: "115k" },
      { gap: "Inconsistent EDR deployment", severity: "Medium", remediationPlan: "Plan R3003", eta: "2026-Q4", estimatedCost: "144k" },
      { gap: "DLP not covering cloud storage", severity: "Low", remediationPlan: "Plan R3004", eta: "2026-Q3", estimatedCost: "173k" },
      { gap: "SSO not integrated with all SaaS", severity: "High", remediationPlan: "Plan R3005", eta: "2026-Q2", estimatedCost: "21k" },
    ];
    return html`
  ...
  private _renderIncidentCostTracker() {
    const incidents = [
      { id: "INC-7001", name: "Security Incident 1", severity: "Critical", totalCost: 2013000, responseCost: 583770, recoveryCost: 684420, legalCost: 181170, regulatoryCost: 281820, insuranceClaim: 0, avoidedCost: 57000, date: "2026-01-01" },
      { id: "INC-7002", name: "Security Incident 2", severity: "High", totalCost: 2016000, responseCost: 302400, recoveryCost: 483840, legalCost: 120960, regulatoryCost: 181440, insuranceClaim: 1592640, avoidedCost: 86000, date: "2026-04-10" },
      { id: "INC-7003", name: "Security Incident 3", severity: "Medium", totalCost: 2019000, responseCost: 444180, recoveryCost: 706650, legalCost: 383610, regulatoryCost: 302850, insuranceClaim: 0, avoidedCost: 115000, date: "2026-03-19" },
      { id: "INC-7004", name: "Security Incident 4", severity: "Low", totalCost: 2022000, responseCost: 586380, recoveryCost: 505500, legalCost: 323520, regulatoryCost: 202200, insuranceClaim: 1496280, avoidedCost: 144000, date: "2026-02-28" },
      { id: "INC-7005", name: "Security Incident 5", severity: "Critical", totalCost: 2025000, responseCost: 303750, recoveryCost: 729000, legalCost: 263250, regulatoryCost: 101250, insuranceClaim: 0, avoidedCost: 173000, date: "2026-01-09" },
      { id: "INC-7006", name: "Security Incident 6", severity: "High", totalCost: 2028000, responseCost: 446160, recoveryCost: 527280, legalCost: 202800, regulatoryCost: 223080, insuranceClaim: 1399320, avoidedCost: 202000, date: "2026-04-18" },
      { id: "INC-7007", name: "Security Incident 7", severity: "Medium", totalCost: 2031000, responseCost: 588990, recoveryCost: 751470, legalCost: 142170, regulatoryCost: 121860, insuranceClaim: 0, avoidedCost: 231000, date: "2026-03-27" },
      { id: "INC-7008", name: "Security Incident 8", severity: "Low", totalCost: 2034000, responseCost: 305100, recoveryCost: 549180, legalCost: 406800, regulatoryCost: 244080, insuranceClaim: 1301760, avoidedCost: 260000, date: "2026-02-08" },
      { id: "INC-7009", name: "Security Incident 9", severity: "Critical", totalCost: 2037000, responseCost: 448140, recoveryCost: 774060, legalCost: 346290, regulatoryCost: 142590, insuranceClaim: 0, avoidedCost: 289000, date: "2026-01-17" },
      { id: "INC-7010", name: "Security Incident 10", severity: "High", totalCost: 2040000, responseCost: 591600, recoveryCost: 571200, legalCost: 285600, regulatoryCost: 265200, insuranceClaim: 1203600, avoidedCost: 318000, date: "2026-04-26" },
      { id: "INC-7011", name: "Security Incident 11", severity: "Medium", totalCost: 2043000, responseCost: 306450, recoveryCost: 796770, legalCost: 224730, regulatoryCost: 163440, insuranceClaim: 0, avoidedCost: 347000, date: "2026-03-07" },
      { id: "INC-7012", name: "Security Incident 12", severity: "Low", totalCost: 2046000, responseCost: 450120, recoveryCost: 593340, legalCost: 163680, regulatoryCost: 286440, insuranceClaim: 1104840, avoidedCost: 376000, date: "2026-02-16" },
    ];
    const yearlyTrend = [
      { month: "Jan", incidents: 11, totalCost: "77k", avgCost: "181k", insured: 46 },
      { month: "Feb", incidents: 8, totalCost: "120k", avgCost: "47k", insured: 46 },
      { month: "Mar", incidents: 5, totalCost: "163k", avgCost: "94k", insured: 46 },
      { month: "Apr", incidents: 2, totalCost: "206k", avgCost: "141k", insured: 46 },
      { month: "May", incidents: 10, totalCost: "249k", avgCost: "188k", insured: 46 },
      { month: "Jun", incidents: 7, totalCost: "292k", avgCost: "54k", insured: 46 },
    ];
...
declare global { interface HTMLElementTagNameMap { 'sc-budget-planner': ScBudgetPlanner; } }
