/**
 * sc-asset-inventory - Asset Inventory
...
@state() private _tablePage = 1;
  ...
  @state() private _comments: CommentEntry[] = [
    { id: 'c1', author: 'soc-tier1', timestamp: '2026-04-23 04:00', text: 'Initial assessment started for Asset Inventory finding #1' },
  ...
  private _items: PanelItem[] = [
      {
            "id": "asset-inventory-1",
            "title": "web-prod-01 | Ubuntu 22.04",
            "severity": "medium",
            "status": "open",
            "category": "Security",
            "source": "SIEM",
            "description": "IP: 10.0.1.10 | Apache 2.4.52 | Criticality: P1 | Owner: Platform | Last scan: 2h ago",
      ...
      {
            "id": "asset-inventory-2",
            "title": "db-master-01 | MySQL 8.0",
            "severity": "medium",
            "status": "in-progress",
            "category": "Network",
            "source": "EDR",
            "description": "IP: 10.0.2.5 | 2TB storage | Criticality: P1 | Owner: DBA | Last scan: 1h ago",
      ...
      {
            "id": "asset-inventory-3",
            "title": "nginx-lb-02 | Nginx 1.24",
            "severity": "medium",
            "status": "resolved",
            "category": "Access",
            "source": "Scanner",
            "description": "IP: 10.0.1.2 | Load Balancer | Criticality: P2 | Owner: Infra | Last scan: 3h ago",
      ...
      {
            "id": "asset-inventory-4",
            "title": "k8s-node-03 | K8s 1.28",
            "severity": "medium",
            "status": "open",
            "category": "Compliance",
            "source": "Audit",
            "description": "IP: 10.0.3.15 | 24 pods | Criticality: P2 | Owner: DevOps | Last scan: 30min ago",
      ...
      {
            "id": "asset-inventory-5",
            "title": "cache-01 | Redis 7.2",
            "severity": "medium",
            "status": "in-progress",
            "category": "Operations",
            "source": "Manual",
            "description": "IP: 10.0.2.10 | 64GB RAM | Criticality: P2 | Owner: Platform | Last scan: 1h ago",
      ...
      {
            "id": "asset-inventory-6",
            "title": "endpoint-42 | macOS 14.4",
            "severity": "medium",
            "status": "resolved",
            "category": "Security",
            "source": "SIEM",
            "description": "CrowdStrike EDR | User: Zhang Wei | Criticality: P4 | Last check-in: 5min ago",
      ...
      {
            "id": "asset-inventory-7",
            "title": "Asset Inventory Finding #7",
            "severity": "low",
            "status": "open",
            "category": "Network",
            "source": "EDR",
            "description": "Automated asset inventory assessment finding detected during routine scan of infrastructure component. Review and remediation recommended.",
      ...
      {
            "id": "asset-inventory-8",
            "title": "Asset Inventory Finding #8",
            "severity": "medium",
            "status": "open",
            "category": "Access",
            "source": "Scanner",
      ...
      {
            "id": "asset-inventory-9",
            "title": "Asset Inventory Finding #9",
            "severity": "high",
            "status": "open",
            "category": "Compliance",
            "source": "Audit",
      ...
      {
            "id": "asset-inventory-10",
            "title": "Asset Inventory Finding #10",
            "severity": "low",
            "status": "open",
            "category": "Operations",
            "source": "Manual",
  ...
  private _history: HistoryEntry[] = [
    { timestamp: '2026-04-23 04:15', action: 'Auto-correlated', user: 'system', details: 'Grouped related findings from Asset Inventory analysis' },
    { timestamp: '2026-04-23 03:00', action: 'Created', user: 'scanner', details: 'New Asset Inventory finding detected by automated assessment' },
    ...
    { timestamp: '2026-04-22 22:00', action: 'Resolved', user: 'security-eng', details: 'Remediation applied and verified for Asset Inventory finding' },
    { timestamp: '2026-04-22 18:00', action: 'Created', user: 'audit', details: 'Compliance audit identified Asset Inventory gap requiring remediation' },
    ...
    { timestamp: '2026-04-21 16:00', action: 'Resolved', user: 'soc-tier1', details: 'False positive confirmed - benign activity flagged by Asset Inventory scan' },
    { timestamp: '2026-04-21 12:00', action: 'Exported', user: 'compliance', details: 'Exported Asset Inventory findings for Q1 compliance report' },
  ];
...
private _workflowTasks: WorkflowTask[] = [
    { id: 'wt-1', title: 'Review Asset Inventory finding #1', status: 'active', assignee: 'soc-tier1', blockedBy: [], slaDeadline: '2026-04-23T12:00:00Z', priority: 'p1', createdAt: '2026-04-23T00:00:00Z', completedAt: null },
    ...
    { id: 'wt-3', title: 'Update Asset Inventory detection rules', status: 'blocked', assignee: 'soc-tier2', blockedBy: ['wt-2'], slaDeadline: '2026-04-24T00:00:00Z', priority: 'p2', createdAt: '2026-04-23T03:00:00Z', completedAt: null },
    ...
    { id: 'wt-8', title: 'Archive resolved Asset Inventory findings', status: 'failed', assignee: 'soc-tier1', blockedBy: [], slaDeadline: '2026-04-23T08:00:00Z', priority: 'p4', createdAt: '2026-04-22T22:00:00Z', completedAt: null },
  ];

private _executionHistory: ExecutionRecord[] = [
    {
      id: 'exec-1', name: 'Asset Inventory Full Assessment Run', startedAt: '2026-04-22T10:00:00Z', completedAt: '2026-04-22T10:12:00Z', status: 'success',
      steps: [
    ...
    {
      id: 'exec-2', name: 'Asset Inventory Delta Scan', startedAt: '2026-04-23T02:00:00Z', completedAt: '2026-04-23T02:05:00Z', status: 'failed',
      steps: [
  ...
  private _runExecution() {
    ...
    const exec: ExecutionRecord = {
      id: 'exec-' + Date.now(), name: 'Asset Inventory Assessment ' + new Date().toISOString().slice(0, 10), startedAt: new Date().toISOString(), completedAt: null, status: 'running', steps,
    };
  ...
  private _renderExecutionPanel(): unknown {
    ...
    return html`
      <div class="form-section">
        ...
        ` : html`<div class="empty-state">Click "Run Assessment" to start the Asset Inventory analysis pipeline</div>`}
      </div>
      <div class="form-section">
        ...
        <div class="settings-card">
          ...
          <div style="display:flex;gap:8px;margin-top:4px;">
            <button class="btn primary" @click=${() => {
              ...
              const a = document.createElement('a'); a.href = url; a.download = 'asset-inventory-config.json'; a.click();
    ...
    return html`
      <div style="margin-top:12px;">
        ...
        <div style="display:flex;gap:6px;margin-top:8px;">
          <input class="search-box" type="text" placeholder="Add a comment..." style="min-width:auto;flex:1;" id="asset-inventory-comment-input" />
          <button class="btn primary" @click=${() => {
            const input = this.shadowRoot?.querySelector('#asset-inventory-comment-input') as HTMLInputElement;
  ...
  private _exportJSON() {
    ...
    const url = URL.createObjectURL(blob);
    const a = document.createElement('a'); a.href = url; a.download = 'sc-asset-inventory-data.json'; a.click();
    URL.revokeObjectURL(url);
  }
  ...
  private _exportCSV() {
    ...
    const url = URL.createObjectURL(blob);
    const a = document.createElement('a'); a.href = url; a.download = 'sc-asset-inventory-data.csv'; a.click();
    URL.revokeObjectURL(url);
  }


  // --- Domain Rules Engine ---
  @state() private _aiRules: { id: string; name: string; category: string; severity: Severity; enabled: boolean; lastEval: string; passRate: number }[] = [];
  private _initAiRules() {
    const rules = [
  ...
  private _evaluateAiRules(): { passed: number; failed: number; skipped: number; total: number } {
    let passed = 0, failed = 0, skipped = 0;
    this._aiRules.forEach(r => { if (!r.enabled) { skipped++; } else if (r.passRate >= 80) { passed++; } else { failed++; } });
    return { passed, failed, skipped, total: this._aiRules.length };
  }

  // --- CVSS Scoring ---
  @state() private _aicvssData: { itemId: string; vector: string; base: number; temporal: number; environmental: number; overall: number }[] = [];
  private _initAiCvss() {
    ...
    this._aicvssData = vectors.map((v, i) => {
  ...
  // --- Anomaly Detection ---
  @state() private _aianomalies: { id: string; type: string; severity: Severity; description: string; detected: string; confidence: number; affected: string[] }[] = [];
  private _runAiAnomalyDetection() {
    const types = [
    ...
    this._aianomalies = types.map((a, i) => ({
  ...
  // --- Trend Prediction ---
  @state() private _aipredictions: { horizon: string; metric: string; current: number; predicted: number; direction: 'up' | 'down' | 'stable'; confidence: number }[] = [];
  private _generateAiPredictions() {
    this._aipredictions = [
  ...
  // --- Approval Workflow ---
  @state() private _aiApprovals: { id: string; title: string; requester: string; status: 'pending' | 'approved' | 'rejected' | 'expired'; createdAt: string; priority: Priority; type: string }[] = [];
  private _initAiApprovals() {
    this._aiApprovals = [
  ...
  private _approveAiItem(id: string) { const item = this._aiApprovals.find(a => a.id === id); if (item) item.status = 'approved'; this.requestUpdate(); }
  private _rejectAiItem(id: string) { const item = this._aiApprovals.find(a => a.id === id); if (item) item.status = 'rejected'; this.requestUpdate(); }

  // --- Activity Feed ---
  @state() private _aiActivity: { id: string; action: string; user: string; target: string; timestamp: string }[] = [];
  private _initAiActivity() {
    const actions = [
    ...
    this._aiActivity = actions.map((a, i) => ({ id: 'ACT-' + String(i + 1).padStart(3, '0'), ...a, timestamp: new Date(Date.now() - i * 3600000).toISOString() }));
  }

  // --- Notification System ---
  @state() private _aiNotifications: { id: string; message: string; type: 'info' | 'warning' | 'error' | 'success'; read: boolean; timestamp: string }[] = [];
  private _initAiNotifications() {
    this._aiNotifications = [
  ...
  private _markAiNotifRead(id: string) { const n = this._aiNotifications.find(x => x.id === id); if (n) n.read = true; this.requestUpdate(); }

  // --- Panel Configuration ---
  @state() private _aiConfig: { layout: 'compact' | 'default' | 'expanded'; theme: 'dark' | 'midnight' | 'slate'; showAnomalies: boolean; showPredictions: boolean; autoRefresh: boolean; refreshInterval: number } = {
    layout: 'default', theme: 'dark', showAnomalies: true, showPredictions: true, autoRefresh: true, refreshInterval: 60,
  };
  private _aiPresets: { name: string; config: typeof this._aiConfig }[] = [
  ...
  private _applyAiPreset(preset: typeof this._aiPresets[0]) { this._aiConfig = { ...preset.config }; this.requestUpdate(); }

  private _renderAiTreemapSVG(): string {
    const categories = [
  ...
  private _renderAiSankeySVG(): string {
  ...
  // --- Render: Rules Engine ---
  private _renderAiRules(): any {
    const ev = this._evaluateAiRules();
    return html`
  ...
  private _renderAiAnomalies(): any {
  ...
  // --- Render: Approvals ---
  private _renderAiApprovals(): any {
          ...
          $${this._aiApprovals.map(a => html`
            <div style="padding:6px 8px;background:#1f2937;border-radius:4px">
              ...
              $${a.status === 'pending' ? html`
                <div style="display:flex;gap:4px;margin-top:4px">
                  <button class="btn success" style="padding:2px 8px;font-size:9px" @click=$${() => this._approveAiItem(a.id)}>Approve</button>
                  <button class="btn error" style="padding:2px 8px;font-size:9px" @click=$${() => this._rejectAiItem(a.id)}>Reject</button>
                </div>` : nothing}
            </div>`)}
        </div>
      </div>`;
  ...
  private _renderAiNotifications(): any {
    const tc = (t: string) => t === 'error' ? '#ef4444' : t === 'warning' ? '#eab308' : t === 'success' ? '#22c55e' : '#3b82f6';
    const unread = this._aiNotifications.filter(n => !n.read).length;
    return html`
      <div style="background:#1a1d27;border-radius:8px;padding:12px;margin-top:12px">
        ...
        <div style="display:flex;flex-direction:column;gap:4px;max-height:120px;overflow-y:auto">
          $${this._aiNotifications.map(n => html`
            <div style="display:flex;align-items:center;gap:8px;padding:4px 8px;background:$${n.read ? '#1f2937' : '#252a36'};border-radius:4px;font-size:10px;opacity:$${n.read ? '0.6' : '1'};cursor:pointer" @click=$${() => this._markAiNotifRead(n.id)}>
      ...
      <div style="background:#1a1d27;border-radius:8px;padding:12px;margin-top:12px">
        ...
        <div style="display:flex;flex-direction:column;gap:6px;font-size:10px">
          <div style="display:flex;align-items:center;gap:8px">
            ...
            <select class="form-input" style="flex:1" @change=$${(e: Event) => { this._aiConfig.layout = (e.target as HTMLSelectElement).value as any; this.requestUpdate(); }}>
              <option value="compact" ?selected=$${this._aiConfig.layout === 'compact'}>Compact</option>
              <option value="default" ?selected=$${this._aiConfig.layout === 'default'}>Default</option>
              <option value="expanded" ?selected=$${this._aiConfig.layout === 'expanded'}>Expanded</option>
            </select>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Theme</span>
            <select class="form-input" style="flex:1" @change=$${(e: Event) => { this._aiConfig.theme = (e.target as HTMLSelectElement).value as any; this.requestUpdate(); }}>
              <option value="dark" ?selected=$${this._aiConfig.theme === 'dark'}>Dark</option>
              <option value="midnight" ?selected=$${this._aiConfig.theme === 'midnight'}>Midnight</option>
              <option value="slate" ?selected=$${this._aiConfig.theme === 'slate'}>Slate</option>
            </select>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Auto Refresh</span>
            <input type="checkbox" ?checked=$${this._aiConfig.autoRefresh} @change=$${() => { this._aiConfig.autoRefresh = !this._aiConfig.autoRefresh; this.requestUpdate(); }}/>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Show Anomalies</span>
            <input type="checkbox" ?checked=$${this._aiConfig.showAnomalies} @change=$${() => { this._aiConfig.showAnomalies = !this._aiConfig.showAnomalies; this.requestUpdate(); }}/>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Show Predictions</span>
            <input type="checkbox" ?checked=$${this._aiConfig.showPredictions} @change=$${() => { this._aiConfig.showPredictions = !this._aiConfig.showPredictions; this.requestUpdate(); }}/>
          </div>
          <div style="margin-top:6px;font-weight:600">Presets</div>
          <div style="display:flex;gap:4px">
            $${this._aiPresets.map(ps => html`<button class="btn" style="padding:2px 8px;font-size:9px" @click=$${() => this._applyAiPreset(ps)}>$${ps.name}</button>`)}
          </div>
        </div>
      </div>`;
  }
  ...
  @state() private _assetInventoContainerScans: Array<{image:string;registry:string;critical:number;high:number;medium:number;scanDate:string;status:string}> = [
  ...
  @state() private _assetInventoK8sPods: Array<{namespace:string;pod:string;securityContext:string;hostIPC:boolean;hostPID:boolean;privileged:boolean;riskLevel:string}> = [
  ...
  @state() private _assetInventoServerlessRisk: Array<{function:string;runtime:string;timeout:number;iamPerms:string;externalCalls:number;riskScore:number}> = [
  ...
  @state() private _assetInventoRuntimeAlerts: Array<{id:string;workload:string;alertType:string;severity:string;description:string;timestamp:string}> = [
  ...
  private _renderAssetinventoCloudWl(): TemplateResult {
    const containers = this._assetInventoContainerScans;
    const pods = this._assetInventoK8sPods;
    const alerts = this._assetInventoRuntimeAlerts;
    return html`
  ...
  @state() private _assetInventoThreatIntel: Array<{source:string;indicator:string;type:string;confidence:number;severity:string;observed:string;description:string}> = [
  ...
  @state() private _assetInventoIntelMetrics: {totalIndicators:number;criticalCount:number;highCount:number;mediumCount:number;staleIndicators:number;feedUptime:number} = {
    totalIndicators: 45230, criticalCount: 234, highCount: 1892, mediumCount: 8765, staleIndicators: 567, feedUptime: 99.7
  };
  @state() private _assetInventoIntelTrending: Array<{category:string;thisWeek:number;lastWeek:number;change:number}> = [
  ...
  private _renderAssetinventoThreatIntel(): TemplateResult {
    const intel = this._assetInventoThreatIntel;
    const trending = this._assetInventoIntelTrending;
    const metrics = this._assetInventoIntelMetrics;
    return html`
  ...
  @state() private _complianceCalendarEvents: Array<{id: string; title: string; deadline: string; category: string; status: string; assignee: string; notes: string}> = [
    {id: 'cc-asset-inventory-001', title: 'SOX Section 404 Compliance Review', deadline: '2026-06-30', category: 'Regulatory', status: 'In Progress', assignee: 'Compliance Team', notes: 'Annual internal control assessment for financial reporting'},
    {id: 'cc-asset-inventory-002', title: 'GDPR Data Protection Impact Assessment', deadline: '2026-05-15', category: 'Privacy', status: 'Pending', assignee: 'DPO Office', notes: 'Quarterly DPIA for high-risk processing activities'},
    {id: 'cc-asset-inventory-003', title: 'ISO 27001 Surveillance Audit', deadline: '2026-07-20', category: 'Certification', status: 'Scheduled', assignee: 'QA Lead', notes: 'Stage 2 surveillance audit for ISMS certification renewal'},
    {id: 'cc-asset-inventory-004', title: 'PCI DSS v4.0 Gap Analysis', deadline: '2026-05-30', category: 'Payment', status: 'Not Started', assignee: 'Security Architect', notes: 'Assess current state against PCI DSS v4.0 requirements'},
    {id: 'cc-asset-inventory-005', title: 'NIST CSF Self-Assessment', deadline: '2026-08-15', category: 'Framework', status: 'Pending', assignee: 'CISO', notes: 'Biannual self-assessment against NIST Cybersecurity Framework'},
    {id: 'cc-asset-inventory-006', title: 'HIPAA Security Rule Audit', deadline: '2026-06-15', category: 'Healthcare', status: 'In Progress', assignee: 'Compliance Analyst', notes: 'Annual audit of administrative, physical, and technical safeguards'},
    {id: 'cc-asset-inventory-007', title: 'SOC 2 Type II Report Renewal', deadline: '2026-09-30', category: 'Audit', status: 'Scheduled', assignee: 'External Auditor', notes: 'Engage auditor for SOC 2 Type II examination period'},
    {id: 'cc-asset-inventory-008', title: 'FedRAMP Authorization Review', deadline: '2026-07-01', category: 'Government', status: 'Pending', assignee: 'FedRAMP PMO', notes: 'Review and update security authorization package'},
    {id: 'cc-asset-inventory-009', title: 'Annual Penetration Test', deadline: '2026-10-15', category: 'Testing', status: 'Not Started', assignee: 'Red Team Lead', notes: 'Comprehensive external and internal penetration testing engagement'},
    {id: 'cc-asset-inventory-010', title: 'Security Awareness Training Rollout', deadline: '2026-05-01', category: 'Training', status: 'Completed', assignee: 'Security Awareness Manager', notes: 'Q2 organization-wide security awareness training program'},
    {id: 'cc-asset-inventory-011', title: 'Vendor Security Review Cycle', deadline: '2026-06-01', category: 'Third Party', status: 'In Progress', assignee: 'Vendor Manager', notes: 'Quarterly review of critical vendor security posture and SLA compliance'},
    {id: 'cc-asset-inventory-012', title: 'Incident Response Plan Update', deadline: '2026-05-20', category: 'Operations', status: 'Pending', assignee: 'IR Team Lead', notes: 'Update IR procedures based on lessons learned from recent incidents'},
  ];
  ...
  @state() private _dataQualityMetrics: Array<{id: string; dataSource: string; completenessScore: number; accuracyScore: number; timelinessScore: number; consistencyScore: number; reliabilityRank: number; lastUpdated: string; issues: string[]; trend: string}> = [
    {id: 'dq-asset-inventory-001', dataSource: 'Vulnerability Scanner Feed', completenessScore: 94, accuracyScore: 91, timelinessScore: 88, consistencyScore: 95, reliabilityRank: 1, lastUpdated: '2026-04-23T08:00:00Z', issues: ['Minor delay in Nessus plugin updates'], trend: 'improving'},
    {id: 'dq-asset-inventory-002', dataSource: 'SIEM Event Logs', completenessScore: 87, accuracyScore: 93, timelinessScore: 96, consistencyScore: 89, reliabilityRank: 2, lastUpdated: '2026-04-23T07:30:00Z', issues: ['Some log sources showing gaps in off-hours'], trend: 'stable'},
    {id: 'dq-asset-inventory-003', dataSource: 'Asset Inventory Database', completenessScore: 82, accuracyScore: 78, timelinessScore: 75, consistencyScore: 84, reliabilityRank: 4, lastUpdated: '2026-04-22T18:00:00Z', issues: ['Shadow IT devices not fully cataloged', 'Decommissioned assets still listed'], trend: 'declining'},
    {id: 'dq-asset-inventory-004', dataSource: 'Threat Intelligence Platform', completenessScore: 91, accuracyScore: 89, timelinessScore: 92, consistencyScore: 87, reliabilityRank: 3, lastUpdated: '2026-04-23T06:00:00Z', issues: ['Some IOC sources lack confidence scoring'], trend: 'improving'},
    {id: 'dq-asset-inventory-005', dataSource: 'Identity Provider Logs', completenessScore: 96, accuracyScore: 97, timelinessScore: 98, consistencyScore: 96, reliabilityRank: 1, lastUpdated: '2026-04-23T09:00:00Z', issues: [], trend: 'stable'},
    {id: 'dq-asset-inventory-006', dataSource: 'Cloud Security Posture Data', completenessScore: 79, accuracyScore: 85, timelinessScore: 82, consistencyScore: 81, reliabilityRank: 5, lastUpdated: '2026-04-23T05:00:00Z', issues: ['Multi-cloud coverage gaps', 'API rate limiting affects scan frequency'], trend: 'declining'},
    {id: 'dq-asset-inventory-007', dataSource: 'Compliance Evidence Store', completenessScore: 88, accuracyScore: 86, timelinessScore: 80, consistencyScore: 83, reliabilityRank: 4, lastUpdated: '2026-04-21T14:00:00Z', issues: ['Manual evidence collection delays', 'Inconsistent formatting across frameworks'], trend: 'stable'},
    {id: 'dq-asset-inventory-008', dataSource: 'Network Flow Data', completenessScore: 92, accuracyScore: 90, timelinessScore: 94, consistencyScore: 91, reliabilityRank: 2, lastUpdated: '2026-04-23T08:30:00Z', issues: ['Encrypted traffic classification accuracy needs improvement'], trend: 'improving'},
  ];
  ...
  @state() private _workflowTemplates: Array<{id: string; name: string; description: string; category: string; steps: number; avgDuration: string; successRate: number; lastRun: string; manualInterventions: number; optimizationScore: number}> = [
    {id: 'wf-asset-inventory-001', name: 'Vulnerability Triage Pipeline', description: 'Automated vulnerability assessment, prioritization, and assignment workflow', category: 'Vulnerability Management', steps: 8, avgDuration: '12 min', successRate: 94.5, lastRun: '2026-04-23T06:00:00Z', manualInterventions: 2, optimizationScore: 87},
    {id: 'wf-asset-inventory-002', name: 'Incident Response Orchestration', description: 'End-to-end IR workflow from detection to containment and recovery', category: 'Incident Response', steps: 15, avgDuration: '45 min', successRate: 89.2, lastRun: '2026-04-22T14:30:00Z', manualInterventions: 5, optimizationScore: 72},
    {id: 'wf-asset-inventory-003', name: 'Access Request Approval Chain', description: 'Multi-level approval workflow for privileged access requests', category: 'Identity & Access', steps: 6, avgDuration: '4 hours', successRate: 97.1, lastRun: '2026-04-23T09:15:00Z', manualInterventions: 1, optimizationScore: 92},
    {id: 'wf-asset-inventory-004', name: 'Compliance Evidence Collection', description: 'Automated gathering and packaging of audit evidence artifacts', category: 'Compliance', steps: 10, avgDuration: '30 min', successRate: 91.8, lastRun: '2026-04-21T10:00:00Z', manualInterventions: 3, optimizationScore: 78},
    {id: 'wf-asset-inventory-005', name: 'Security Patch Deployment', description: 'Staged patch rollout with validation and rollback capability', category: 'Patch Management', steps: 12, avgDuration: '2 hours', successRate: 96.3, lastRun: '2026-04-20T22:00:00Z', manualInterventions: 1, optimizationScore: 85},
    {id: 'wf-asset-inventory-006', name: 'Threat Intelligence Enrichment', description: 'IOC enrichment and correlation with internal threat data', category: 'Threat Intelligence', steps: 7, avgDuration: '8 min', successRate: 93.7, lastRun: '2026-04-23T07:00:00Z', manualInterventions: 0, optimizationScore: 95},
    {id: 'wf-asset-inventory-007', name: 'Security Reporting Pipeline', description: 'Automated generation and distribution of security metrics reports', category: 'Reporting', steps: 5, avgDuration: '15 min', successRate: 98.9, lastRun: '2026-04-23T08:00:00Z', manualInterventions: 0, optimizationScore: 97},
    {id: 'wf-asset-inventory-008', name: 'Vendor Risk Assessment', description: 'Automated vendor security questionnaire distribution and scoring', category: 'Third Party', steps: 9, avgDuration: '3 days', successRate: 85.4, lastRun: '2026-04-19T11:00:00Z', manualInterventions: 4, optimizationScore: 65},
  ];
  ...
  @state() private _workflowExecutionHistory: Array<{workflowId: string; runDate: string; duration: string; status: string; trigger: string}> = [
    {workflowId: 'wf-asset-inventory-001', runDate: '2026-04-23T06:00:00Z', duration: '11 min 23 sec', status: 'Success', trigger: 'Scheduled'},
    {workflowId: 'wf-asset-inventory-002', runDate: '2026-04-22T14:30:00Z', duration: '42 min 15 sec', status: 'Success', trigger: 'Alert'},
    {workflowId: 'wf-asset-inventory-003', runDate: '2026-04-23T09:15:00Z', duration: '3h 45 min', status: 'Success', trigger: 'User Request'},
    {workflowId: 'wf-asset-inventory-001', runDate: '2026-04-22T06:00:00Z', duration: '13 min 08 sec', status: 'Partial', trigger: 'Scheduled'},
    {workflowId: 'wf-asset-inventory-004', runDate: '2026-04-21T10:00:00Z', duration: '28 min 42 sec', status: 'Success', trigger: 'Scheduled'},
  ];
  ...
  @state() private _knowledgeArticles: Array<{id: string; title: string; category: string; author: string; publishDate: string; views: number; rating: number; tags: string[]; summary: string; readTime: string}> = [
    {id: 'kb-asset-inventory-001', title: 'Zero Trust Architecture Implementation Guide', category: 'Architecture', author: 'Security Architecture Team', publishDate: '2026-03-15', views: 1842, rating: 4.8, tags: ['zero-trust', 'network', 'identity'], summary: 'Comprehensive guide for implementing zero trust principles across enterprise infrastructure', readTime: '15 min'},
    {id: 'kb-asset-inventory-002', title: 'Ransomware Defense Playbook 2026', category: 'Threats', author: 'Threat Intelligence Team', publishDate: '2026-04-01', views: 2341, rating: 4.9, tags: ['ransomware', 'incident-response', 'defense'], summary: 'Updated playbook with latest ransomware tactics, techniques, and defensive measures', readTime: '12 min'},
    {id: 'kb-asset-inventory-003', title: 'Cloud Security Best Practices for Multi-Cloud', category: 'Cloud', author: 'Cloud Security Team', publishDate: '2026-02-28', views: 1567, rating: 4.5, tags: ['cloud', 'aws', 'azure', 'gcp'], summary: 'Best practices for securing workloads across multiple cloud service providers', readTime: '18 min'},
    {id: 'kb-asset-inventory-004', title: 'API Security Testing Methodology', category: 'Testing', author: 'Red Team', publishDate: '2026-03-22', views: 987, rating: 4.6, tags: ['api', 'testing', 'owasp'], summary: 'Structured methodology for identifying and testing API security vulnerabilities', readTime: '10 min'},
    {id: 'kb-asset-inventory-005', title: 'Supply Chain Security Risk Management', category: 'Third Party', author: 'GRC Team', publishDate: '2026-01-20', views: 1234, rating: 4.3, tags: ['supply-chain', 'vendor', 'risk'], summary: 'Framework for managing security risks in the software supply chain', readTime: '14 min'},
    {id: 'kb-asset-inventory-006', title: 'Kubernetes Security Hardening Checklist', category: 'Container', author: 'Platform Security', publishDate: '2026-04-10', views: 2103, rating: 4.7, tags: ['kubernetes', 'container', 'hardening'], summary: 'Step-by-step hardening checklist for production Kubernetes clusters', readTime: '11 min'},
    {id: 'kb-asset-inventory-007', title: 'Security Metrics That Matter for Executives', category: 'Metrics', author: 'CISO Office', publishDate: '2026-03-05', views: 876, rating: 4.4, tags: ['metrics', 'kpi', 'reporting'], summary: 'Key security metrics and KPIs that resonate with board-level stakeholders', readTime: '8 min'},
    {id: 'kb-asset-inventory-008', title: 'Phishing Simulation Campaign Design', category: 'Awareness', author: 'Security Awareness Team', publishDate: '2026-02-15', views: 1456, rating: 4.5, tags: ['phishing', 'simulation', 'training'], summary: 'Designing effective phishing simulations that drive real behavioral change', readTime: '9 min'},
    {id: 'kb-asset-inventory-009', title: 'Data Loss Prevention Strategy and Implementation', category: 'Data Protection', author: 'Data Security Team', publishDate: '2026-03-28', views: 1678, rating: 4.6, tags: ['dlp', 'data-protection', 'compliance'], summary: 'Strategic approach to DLP covering people, process, and technology layers', readTime: '16 min'},
    {id: 'kb-asset-inventory-010', title: 'Security Automation with SOAR Platforms', category: 'Automation', author: 'SOC Engineering', publishDate: '2026-04-05', views: 1098, rating: 4.7, tags: ['soar', 'automation', 'soc'], summary: 'Building effective security automation playbooks using SOAR technology', readTime: '13 min'},
    {id: 'kb-asset-inventory-011', title: 'Third-Party Risk Assessment Framework', category: 'GRC', author: 'Vendor Management', publishDate: '2026-01-30', views: 1345, rating: 4.4, tags: ['vendor', 'risk', 'assessment'], summary: 'Structured framework for evaluating and monitoring third-party security risks', readTime: '12 min'},
    {id: 'kb-asset-inventory-012', title: 'Network Detection and Response Best Practices', category: 'Network', author: 'Network Security Team', publishDate: '2026-03-18', views: 1567, rating: 4.5, tags: ['ndr', 'network', 'detection'], summary: 'Implementing effective network detection and response capabilities', readTime: '14 min'},
    {id: 'kb-asset-inventory-013', title: 'Security Chaos Engineering Guide', category: 'Resilience', author: 'SRE Security', publishDate: '2026-04-12', views: 789, rating: 4.3, tags: ['chaos-engineering', 'resilience', 'testing'], summary: 'Applying chaos engineering principles to validate security controls', readTime: '10 min'},
    {id: 'kb-asset-inventory-014', title: 'Incident Communication Templates', category: 'Incident Response', author: 'IR Team', publishDate: '2026-02-22', views: 2234, rating: 4.8, tags: ['incident', 'communication', 'templates'], summary: 'Ready-to-use communication templates for security incident scenarios', readTime: '7 min'},
    {id: 'kb-asset-inventory-015', title: 'Endpoint Detection and Response Configuration', category: 'Endpoint', author: 'Endpoint Security', publishDate: '2026-03-08', views: 1345, rating: 4.5, tags: ['edr', 'endpoint', 'configuration'], summary: 'Optimal EDR configuration for maximum detection with minimal false positives', readTime: '11 min'},
    {id: 'kb-asset-inventory-016', title: 'Security Code Review Standards', category: 'Development', author: 'AppSec Team', publishDate: '2026-02-10', views: 1890, rating: 4.6, tags: ['code-review', 'secure-sdlc', 'standards'], summary: 'Standards and checklists for security-focused code reviews', readTime: '13 min'},
    {id: 'kb-asset-inventory-017', title: 'IoT Security Assessment Methodology', category: 'IoT', author: 'IoT Security Lab', publishDate: '2026-04-08', views: 654, rating: 4.2, tags: ['iot', 'embedded', 'assessment'], summary: 'Methodology for assessing security posture of IoT devices and ecosystems', readTime: '15 min'},
    {id: 'kb-asset-inventory-018', title: 'Passwordless Authentication Migration Guide', category: 'Identity', author: 'IAM Team', publishDate: '2026-03-25', views: 1678, rating: 4.7, tags: ['passwordless', 'authentication', 'mfa'], summary: 'Step-by-step migration plan from password-based to passwordless authentication', readTime: '12 min'},
    {id: 'kb-asset-inventory-019', title: 'Security Awareness Program Metrics', category: 'Awareness', author: 'Security Culture Team', publishDate: '2026-01-25', views: 1123, rating: 4.4, tags: ['awareness', 'metrics', 'culture'], summary: 'Measuring the effectiveness of your security awareness and training programs', readTime: '9 min'},
    {id: 'kb-asset-inventory-020', title: 'Deception Technology Deployment Guide', category: 'Detection', author: 'Blue Team', publishDate: '2026-04-15', views: 876, rating: 4.5, tags: ['deception', 'honeypot', 'detection'], summary: 'Planning and deploying deception technology for advanced threat detection', readTime: '11 min'},
  ];
  ...
  // --- Security Scenario Planning Methods (ASIN) ---
  private _initAsinScenarios(): void {
    const worstCaseScenarios = [
      { id: "asin-sc-01", name: "Ransomware Attack on Critical Infrastructure", category: "Malware", impact: 9500000, probability: 0.12, recoveryDays: 21, affectedSystems: 47, dataLossGb: 320, businessImpact: "critical" },
      { id: "asin-sc-02", name: "Insider Data Exfiltration via Authorized Channels", category: "Insider Threat", impact: 7200000, probability: 0.18, recoveryDays: 14, affectedSystems: 12, dataLossGb: 85, businessImpact: "high" },
      { id: "asin-sc-03", name: "Supply Chain Compromise via Third-Party Library", category: "Supply Chain", impact: 6800000, probability: 0.09, recoveryDays: 30, affectedSystems: 63, dataLossGb: 0, businessImpact: "critical" },
      { id: "asin-sc-04", name: "Cloud Misconfiguration Leading to Public Exposure", category: "Cloud", impact: 4100000, probability: 0.22, recoveryDays: 7, affectedSystems: 8, dataLossGb: 450, businessImpact: "high" },
      { id: "asin-sc-05", name: "Zero-Day Exploit in Core Application Framework", category: "Vulnerability", impact: 8900000, probability: 0.05, recoveryDays: 45, affectedSystems: 120, dataLossGb: 0, businessImpact: "critical" },
      { id: "asin-sc-06", name: "Distributed Denial of Service on Customer-Facing Services", category: "Availability", impact: 3400000, probability: 0.25, recoveryDays: 3, affectedSystems: 15, dataLossGb: 0, businessImpact: "medium" },
      { id: "asin-sc-07", name: "Credential Stuffing and Account Takeover Wave", category: "Identity", impact: 2800000, probability: 0.30, recoveryDays: 5, affectedSystems: 6, dataLossGb: 12, businessImpact: "medium" },
      { id: "asin-sc-08", name: "Physical Security Breach at Data Center Facility", category: "Physical", impact: 12000000, probability: 0.02, recoveryDays: 60, affectedSystems: 200, dataLossGb: 5000, businessImpact: "critical" },
    ];
    this._asinScenarios = worstCaseScenarios.map(s => ({ ...s, mitigationCost: Math.round(s.impact * 0.08), drillScheduled: false, lastDrillDate: null, drillScore: null, controlGaps: Math.floor(Math.random() * 5) + 1 }));
  }

  private _calculateAsinScenarioRisk(): void {
    this._asinScenarios.forEach(s => {
  ...
  private _scheduleAsinDrills(): void {
  ...
  private _asinScenarioComparison(): Record<string, unknown>[] {
    return this._asinScenarios.map(s => ({
  ...
  // --- Security Control Effectiveness Analytics (ASIN) ---
  private _initAsinControls(): void {
    const controls = [
      { id: "asin-ct-01", name: "Network Segmentation", type: "preventive", maturity: "defined", score: 82, target: 90, failures: 3, lastTest: "2026-03-15" },
      { id: "asin-ct-02", name: "Endpoint Detection and Response", type: "detective", maturity: "managed", score: 88, target: 92, failures: 1, lastTest: "2026-04-01" },
      { id: "asin-ct-03", name: "Data Loss Prevention", type: "preventive", maturity: "repeatable", score: 71, target: 85, failures: 7, lastTest: "2026-03-22" },
      { id: "asin-ct-04", name: "Security Information and Event Management", type: "detective", maturity: "managed", score: 85, target: 90, failures: 2, lastTest: "2026-04-05" },
      { id: "asin-ct-05", name: "Identity and Access Management", type: "preventive", maturity: "defined", score: 76, target: 88, failures: 5, lastTest: "2026-03-28" },
      { id: "asin-ct-06", name: "Vulnerability Management", type: "corrective", maturity: "managed", score: 80, target: 90, failures: 4, lastTest: "2026-04-02" },
      { id: "asin-ct-07", name: "Email Security Gateway", type: "preventive", maturity: "managed", score: 90, target: 95, failures: 1, lastTest: "2026-04-08" },
      { id: "asin-ct-08", name: "Web Application Firewall", type: "preventive", maturity: "managed", score: 87, target: 92, failures: 2, lastTest: "2026-03-30" },
      { id: "asin-ct-09", name: "Patch Management", type: "corrective", maturity: "defined", score: 68, target: 85, failures: 9, lastTest: "2026-03-18" },
      { id: "asin-ct-10", name: "Encryption at Rest", type: "preventive", maturity: "managed", score: 93, target: 95, failures: 0, lastTest: "2026-04-10" },
      { id: "asin-ct-11", name: "Encryption in Transit", type: "preventive", maturity: "optimized", score: 96, target: 98, failures: 0, lastTest: "2026-04-12" },
      { id: "asin-ct-12", name: "Privileged Access Management", type: "preventive", maturity: "defined", score: 74, target: 88, failures: 6, lastTest: "2026-03-25" },
      { id: "asin-ct-13", name: "Security Awareness Training", type: "preventive", maturity: "repeatable", score: 65, target: 80, failures: 11, lastTest: "2026-03-20" },
      { id: "asin-ct-14", name: "Incident Response Plan", type: "corrective", maturity: "managed", score: 78, target: 88, failures: 4, lastTest: "2026-04-03" },
      { id: "asin-ct-15", name: "Backup and Recovery", type: "corrective", maturity: "managed", score: 84, target: 92, failures: 3, lastTest: "2026-04-06" },
      { id: "asin-ct-16", name: "Multi-Factor Authentication", type: "preventive", maturity: "managed", score: 91, target: 95, failures: 1, lastTest: "2026-04-09" },
      { id: "asin-ct-17", name: "Network Traffic Analysis", type: "detective", maturity: "defined", score: 72, target: 85, failures: 5, lastTest: "2026-03-27" },
      { id: "asin-ct-18", name: "Cloud Security Posture Management", type: "detective", maturity: "repeatable", score: 69, target: 82, failures: 8, lastTest: "2026-03-24" },
      { id: "asin-ct-19", name: "Container Security Scanning", type: "preventive", maturity: "defined", score: 75, target: 85, failures: 5, lastTest: "2026-04-04" },
      { id: "asin-ct-20", name: "API Security Gateway", type: "preventive", maturity: "repeatable", score: 70, target: 82, failures: 7, lastTest: "2026-03-29" },
      { id: "asin-ct-21", name: "Threat Intelligence Platform", type: "detective", maturity: "managed", score: 83, target: 90, failures: 2, lastTest: "2026-04-07" },
      { id: "asin-ct-22", name: "Database Activity Monitoring", type: "detective", maturity: "defined", score: 67, target: 80, failures: 8, lastTest: "2026-03-21" },
      { id: "asin-ct-23", name: "Deception Technology", type: "detective", maturity: "initial", score: 55, target: 75, failures: 12, lastTest: "2026-03-16" },
      { id: "asin-ct-24", name: "Security Orchestration Automation", type: "corrective", maturity: "repeatable", score: 73, target: 85, failures: 6, lastTest: "2026-04-01" },
      { id: "asin-ct-25", name: "Third-Party Risk Assessment", type: "preventive", maturity: "defined", score: 64, target: 78, failures: 9, lastTest: "2026-03-19" },
    ];
    this._asinControls = controls;
  }

  private _analyzeAsinControlEffectiveness(): void {
    const typeBreakdown: Record<string, { total: number; avgScore: number; avgFailures: number }> = {};
    this._asinControls.forEach(c => {
    ...
    this._asinControlTypeBreakdown = typeBreakdown;
  }

  private _asinControlOptimization(): Record<string, unknown>[] {
    return this._asinControls.filter(c => c.score < c.target).map(c => ({
  ...
  // --- Security Data Pipeline Health (ASIN) ---
  private _initAsinPipelines(): void {
    const pipelines = [
      { id: "asin-pl-01", name: "SIEM Log Ingestion", status: "healthy", healthScore: 94, latencyMs: 120, freshnessMin: 2, errorRate: 0.02, throughputMbps: 450, recordsPerSec: 12000, backPressure: 0.05, uptime: 99.97 },
      { id: "asin-pl-02", name: "Threat Feed Aggregation", status: "healthy", healthScore: 91, latencyMs: 300, freshnessMin: 15, errorRate: 0.05, throughputMbps: 85, recordsPerSec: 3200, backPressure: 0.08, uptime: 99.92 },
      { id: "asin-pl-03", name: "Vulnerability Scan Results", status: "degraded", healthScore: 72, latencyMs: 2500, freshnessMin: 60, errorRate: 0.15, throughputMbps: 25, recordsPerSec: 800, backPressure: 0.35, uptime: 98.50 },
      { id: "asin-pl-04", name: "Endpoint Telemetry Stream", status: "healthy", healthScore: 88, latencyMs: 450, freshnessMin: 5, errorRate: 0.08, throughputMbps: 280, recordsPerSec: 8500, backPressure: 0.12, uptime: 99.85 },
      { id: "asin-pl-05", name: "Cloud Audit Log Pipeline", status: "healthy", healthScore: 86, latencyMs: 600, freshnessMin: 10, errorRate: 0.06, throughputMbps: 150, recordsPerSec: 4500, backPressure: 0.10, uptime: 99.80 },
      { id: "asin-pl-06", name: "Identity Event Stream", status: "warning", healthScore: 78, latencyMs: 1200, freshnessMin: 20, errorRate: 0.12, throughputMbps: 45, recordsPerSec: 1500, backPressure: 0.22, uptime: 99.40 },
      { id: "asin-pl-07", name: "Network Flow Collection", status: "healthy", healthScore: 82, latencyMs: 800, freshnessMin: 8, errorRate: 0.09, throughputMbps: 650, recordsPerSec: 18000, backPressure: 0.15, uptime: 99.70 },
      { id: "asin-pl-08", name: "DLP Incident Pipeline", status: "degraded", healthScore: 68, latencyMs: 3500, freshnessMin: 45, errorRate: 0.20, throughputMbps: 18, recordsPerSec: 500, backPressure: 0.42, uptime: 97.80 },
    ];
    this._asinPipelines = pipelines.map(p => ({ ...p, dependencies: [], slaBreached: p.healthScore < 75, alertThreshold: p.errorRate > 0.15 }));
    this._asinPipelines[0].dependencies = ["asin-pl-04", "asin-pl-07"];
    this._asinPipelines[4].dependencies = ["asin-pl-01"];
    this._asinPipelines[5].dependencies = ["asin-pl-02"];
    this._asinPipelines[7].dependencies = ["asin-pl-04", "asin-pl-05"];
  }

  private _asinPipelineTrend(): Record<string, unknown>[] {
    const hours = Array.from({ length: 24 }, (_, i) => `H${String(i).padStart(2, "0")}`);
    return this._asinPipelines.map(p => ({
  ...
  // --- Security Stakeholder Report Generator (ASIN) ---
  private _initAsinReportTemplates(): void {
    this._asinReportTemplates = [
      { id: "asin-rp-01", name: "Board Security Report", audience: "board", frequency: "quarterly", sections: 6, autoGenerate: true, lastGenerated: "2026-03-31", pages: 12 },
      { id: "asin-rp-02", name: "Executive Risk Summary", audience: "executive", frequency: "monthly", sections: 8, autoGenerate: true, lastGenerated: "2026-04-01", pages: 8 },
      { id: "asin-rp-03", name: "Technical Security Review", audience: "technical", frequency: "weekly", sections: 12, autoGenerate: true, lastGenerated: "2026-04-21", pages: 25 },
      { id: "asin-rp-04", name: "Audit Compliance Report", audience: "audit", frequency: "quarterly", sections: 10, autoGenerate: false, lastGenerated: "2026-03-15", pages: 35 },
      { id: "asin-rp-05", name: "Regulatory Filing Package", audience: "regulatory", frequency: "annual", sections: 15, autoGenerate: false, lastGenerated: "2025-12-31", pages: 48 },
    ];
  }

  private _generateAsinExecSummary(): string {
    const totalRisk = this._asinScenarios.reduce((sum: number, s: any) => sum + s.riskScore, 0);
    const avgControl = Math.round(this._asinControls.reduce((sum: number, c: any) => sum + c.score, 0) / this._asinControls.length);
    const degradedPipes = this._asinPipelines.filter((p: any) => p.status !== "healthy").length;
    return `Overall risk exposure: ${(totalRisk / 1000000).toFixed(1)}M. Average control effectiveness: {avgControl}%. {degradedPipes} pipeline(s) need attention. {this._asinScenarios.filter((s: any) => s.mitigationPriority === "immediate").length} scenarios require immediate action.`;
  }

  // --- Security Technology Radar (ASIN) ---
  private _initAsinTechRadar(): void {
    this._asinTechRadar = [
      { id: "asin-tr-01", name: "AI-Powered Threat Detection", ring: "adopt", category: "Detection", maturity: 4, trend: "up", investment: "high", roi: 3.2, vendorCount: 8 },
      { id: "asin-tr-02", name: "Zero Trust Architecture", ring: "adopt", category: "Architecture", maturity: 4, trend: "up", investment: "high", roi: 2.8, vendorCount: 12 },
      { id: "asin-tr-03", name: "SASE/SSE Platform", ring: "trial", category: "Network", maturity: 3, trend: "up", investment: "medium", roi: 2.4, vendorCount: 10 },
      { id: "asin-tr-04", name: "CNAPP Cloud Security", ring: "trial", category: "Cloud", maturity: 3, trend: "up", investment: "medium", roi: 2.1, vendorCount: 7 },
      { id: "asin-tr-05", name: "Extended Detection and Response", ring: "adopt", category: "Detection", maturity: 4, trend: "stable", investment: "high", roi: 2.9, vendorCount: 9 },
      { id: "asin-tr-06", name: "Quantum-Safe Cryptography", ring: "assess", category: "Crypto", maturity: 2, trend: "up", investment: "low", roi: 0.8, vendorCount: 4 },
      { id: "asin-tr-07", name: "Security Service Edge", ring: "trial", category: "Network", maturity: 3, trend: "up", investment: "medium", roi: 2.0, vendorCount: 6 },
      { id: "asin-tr-08", name: "SOAR 2.0 Autonomous SOC", ring: "assess", category: "Operations", maturity: 2, trend: "up", investment: "low", roi: 1.2, vendorCount: 5 },
      { id: "asin-tr-09", name: "Software Supply Chain Security", ring: "trial", category: "DevSecOps", maturity: 3, trend: "up", investment: "medium", roi: 2.3, vendorCount: 8 },
      { id: "asin-tr-10", name: "Identity Threat Detection", ring: "adopt", category: "Identity", maturity: 3, trend: "up", investment: "high", roi: 2.7, vendorCount: 7 },
      { id: "asin-tr-11", name: "Data Security Posture Management", ring: "trial", category: "Data", maturity: 3, trend: "up", investment: "medium", roi: 2.2, vendorCount: 9 },
      { id: "asin-tr-12", name: "Decentralized Identity Standards", ring: "hold", category: "Identity", maturity: 1, trend: "stable", investment: "low", roi: 0.5, vendorCount: 3 },
    ];
  }

  private _asinRadarSummary(): Record<string, unknown> {
    const rings: Record<string, number> = { adopt: 0, trial: 0, assess: 0, hold: 0 };
    this._asinTechRadar.forEach(t => { if (rings[t.ring as keyof typeof rings] !== undefined) rings[t.ring as keyof typeof rings]++; });
    return { adopt: rings.adopt, trial: rings.trial, assess: rings.assess, hold: rings.hold, total: this._asinTechRadar.length, avgMaturity: 2.8, topInvestment: this._asinTechRadar.filter(t => t.investment === "high").map(t => t.name) };
  }

  // --- ASIN Security Compliance Mapping Matrix ---
  private _initAsinComplianceMatrix(): void {
    ...
    this._asinComplianceMatrix = frameworks.map(fw => ({
  ...
  private _asinComplianceTrend(): Record<string, unknown>[] {
    const quarters = ["Q1-2025", "Q2-2025", "Q3-2025", "Q4-2025", "Q1-2026", "Q2-2026"];
    return this._asinComplianceMatrix.map(fw => ({
  ...
  // --- ASIN Threat Intelligence Correlation Engine ---
  private _initAsinThreatIntel(): void {
    ...
    this._asinThreatIntel = threatActors.map((actor, i) => ({
  ...
  private _asinThreatCorrelation(): Record<string, unknown>[] {
    return this._asinThreatIntel.filter(t => t.riskScore > 70).map(t => ({
  ...
  // --- ASIN Security Metrics Deep Dive ---
  private _initAsinMetricsDeep(): void {
    ...
    this._asinMetricsDeep = metricCategories.map(cat => ({
  ...
  private _asinMetricsHeatmap(): number[][] {
    return this._asinMetricsDeep.map(cat =>
      cat.metrics.map(m => Math.round((m.value / m.target) * 100))
    );
  }

  // --- ASIN Incident Cost Modeling ---
  private _initAsinCostModel(): void {
    const incidentTypes = ["Data Breach", "Ransomware", "DDoS", "Insider Threat", "Phishing", "Supply Chain", "Cloud Misconfig", "Zero-Day"];
    this._asinCostModel = incidentTypes.map(inc => ({
    ...
    this._asinCostModel.forEach(m => { m.totalAnnualExposure = m.avgCost * m.frequency; });
  }

  private _asinCostProjection(): Record<string, unknown>[] {
    return this._asinCostModel.map(m => ({
  ...
  // --- ASIN Security Architecture Pattern Library ---
  private _initAsinArchPatterns(): void {
    ...
    this._asinArchPatterns = patterns.map((p, i) => ({
  ...
  private _asinArchPatternAnalysis(): Record<string, unknown> {
    const implemented = this._asinArchPatterns.filter(p => p.implementation > 75).length;
    const avgCoverage = Math.round(this._asinArchPatterns.reduce((s: number, p: any) => s + p.coverage, 0) / this._asinArchPatterns.length);
    return {
      totalPatterns: this._asinArchPatterns.length, fullyImplemented: implemented, avgCoverage,
      avgRiskReduction: Math.round(this._asinArchPatterns.reduce((s: number, p: any) => s + p.riskReduction, 0) / this._asinArchPatterns.length),
      gaps: this._asinArchPatterns.filter(p => p.implementation < 60).map(p => p.pattern),
      recommendations: this._asinArchPatterns.filter(p => p.implementation < 70).map(p => ({ pattern: p.pattern, current: p.implementation, target: 85, effort: p.costComplexity }))
    };
  }
  ...
  private _2efRiskAssessmentWorkflow = [
  ...
  private _2efTreatmentOptions = [
    {id: '2ef-T-001', riskId: 'RSK-042', risk: 'Ransomware Attack on Critical Infrastructure', before: 20, after: 6, strategy: 'Mitigate', controls: ['Next-gen EDR with behavioral detection and automated response', 'Zero-trust network micro-segmentation isolating critical assets', 'Immutable offline backup rotation with quarterly recovery testing', 'Incident response retainer with 1-hour response SLA'], cost: '$450K/yr', roi: '78% reduction vs $2.8M potential loss', timeline: 'Q3 2026', status: 'approved' as const},
  ...
  private _2efTalentPositions = [
    ...
    {id: '2ef-H-002', title: 'Cloud Security Engineer', dept: 'Cloud Security', level: 'Mid-Senior', loc: 'SF/Remote', salary: '$155K-$180K', posted: '2026-03-20', applicants: 45, pipeline: 12, interviews: 6, offers: 2, urgency: 'high' as const, manager: 'Mike Johnson', skills: ['AWS/Azure/GCP', 'Terraform', 'Kubernetes', 'IAM', 'CSPM'], nice: ['CCSP', 'CKS', 'Serverless']},
    {id: '2ef-H-003', title: 'SOC Analyst L2', dept: 'Security Operations', level: 'Mid', loc: 'Austin TX', salary: '$105K-$130K', posted: '2026-04-01', applicants: 67, pipeline: 18, interviews: 8, offers: 0, urgency: 'medium' as const, manager: 'Lisa Park', skills: ['SIEM', 'Incident triage', 'Malware analysis', 'TCP/IP'], nice: ['GCIA', 'SOAR', 'Kill chain']},
    {id: '2ef-H-004', title: 'Staff Security Architect', dept: 'Architecture', level: 'Staff', loc: 'Remote US', salary: '$200K-$240K', posted: '2026-02-28', applicants: 12, pipeline: 3, interviews: 2, offers: 0, urgency: 'critical' as const, manager: 'David Lee', skills: ['Enterprise arch', 'Zero trust', 'Risk frameworks', 'Board comms'], nice: ['CISSP+SABSA', 'Team building', 'Speaker']},
    {id: '2ef-H-005', title: 'GRC Analyst', dept: 'GRC', level: 'Mid', loc: 'NY/Remote', salary: '$110K-$135K', posted: '2026-04-05', applicants: 34, pipeline: 9, interviews: 3, offers: 1, urgency: 'medium' as const, manager: 'Rachel Green', skills: ['ISO 27001', 'SOC 2', 'Risk assessment', 'Audit'], nice: ['CRISC', 'CISA', 'GDPR']},
    {id: '2ef-H-006', title: 'Threat Intel Analyst', dept: 'Threat Intel', level: 'Mid-Senior', loc: 'Remote US', salary: '$140K-$170K', posted: '2026-03-25', applicants: 19, pipeline: 5, interviews: 2, offers: 0, urgency: 'low' as const, manager: 'James Wilson', skills: ['MITRE ATT&CK', 'OSINT', 'Threat modeling', 'Reverse eng'], nice: ['CTIA', 'Nation-state', 'Dark web']},
    {id: '2ef-H-007', title: 'AppSec Engineer', dept: 'AppSec', level: 'Senior', loc: 'Seattle/Remote', salary: '$160K-$190K', posted: '2026-04-10', applicants: 28, pipeline: 7, interviews: 3, offers: 0, urgency: 'medium' as const, manager: 'Emily Zhang', skills: ['SAST/DAST/SCA', 'Secure SDLC', 'Code review', 'CI/CD'], nice: ['CSSLP', 'Mobile security']},
    {id: '2ef-H-008', title: 'IAM Engineer', dept: 'IAM', level: 'Mid', loc: 'Remote US', salary: '$135K-$160K', posted: '2026-04-08', applicants: 31, pipeline: 10, interviews: 5, offers: 1, urgency: 'medium' as const, manager: 'Chris Martinez', skills: ['Okta/Azure AD', 'SAML/OIDC', 'PAM', 'RBAC'], nice: ['CISSP', 'Zero trust IAM']}
  ];

  private _2efInterviewScorecard = [
  ...
  private _2efOnboardingSteps = [
    {id: '2ef-OB-01', item: 'Provision security-hardened laptop, monitors, peripherals, and configured workstation image with all required security tools', cat: 'IT Setup', day: 'Day 1', owner: 'IT Operations'},
    {id: '2ef-OB-02', item: 'Create AD account, email, Slack, VPN, SSO enrollment, and all required application access accounts', cat: 'Access', day: 'Day 1', owner: 'IAM Team'},
    {id: '2ef-OB-03', item: 'Grant security tooling access: SIEM console, EDR dashboard, vuln scanner, pentest platforms, SOAR', cat: 'Tools', day: 'Day 1-2', owner: 'SOC Manager'},
    {id: '2ef-OB-04', item: 'Complete MFA enrollment, security awareness onboarding course, and acceptable use policy acknowledgment', cat: 'Security', day: 'Day 1', owner: 'Awareness Team'},
    {id: '2ef-OB-05', item: 'Sign NDA, employment agreement, IP assignment, and code of conduct documents with HR', cat: 'HR', day: 'Day 1', owner: 'Human Resources'},
    {id: '2ef-OB-06', item: 'Introduction meetings with direct team members and key cross-functional stakeholders', cat: 'Integration', day: 'Week 1', owner: 'Hiring Manager'},
    {id: '2ef-OB-07', item: 'Security architecture overview, tooling walkthrough, and operational runbook review sessions', cat: 'Training', day: 'Week 1-2', owner: 'Security Architect'},
    {id: '2ef-OB-08', item: 'Shadow experienced team member on active incident response and threat hunting investigations', cat: 'Mentoring', day: 'Week 2-3', owner: 'SOC Lead'},
    {id: '2ef-OB-09', item: 'Set up individual certification study plan aligned with role requirements and career goals', cat: 'Development', day: 'Week 2', owner: 'Hiring Manager'},
    {id: '2ef-OB-10', item: 'Establish 30-60-90 day goals, define success metrics, and schedule first performance checkpoint', cat: 'Goals', day: 'Week 1', owner: 'Hiring Manager'}
  ];

  private _2efMetricsDashboard = [
    {id: '2ef-MTD-001', name: 'Mean Time to Detect (MTTD)', value: '4.2 hours', trend: 'improving' as const, target: '< 4 hours', source: 'SIEM - Splunk', method: 'Median time from first alert to analyst acknowledgment', owner: 'SOC Manager', sla: '4 hours', prev: '5.1 hours', spark: [5.8, 5.4, 5.1, 4.9, 4.7, 4.5, 4.3, 4.2], breakdown: [{src: 'Network IDS', pct: '35%', avg: '3.8h'}, {src: 'Endpoint EDR', pct: '28%', avg: '4.1h'}, {src: 'Email Gateway', pct: '22%', avg: '3.5h'}, {src: 'Cloud Security', pct: '10%', avg: '5.2h'}, {src: 'User Reports', pct: '5%', avg: '6.8h'}]},
    {id: '2ef-MTD-002', name: 'Mean Time to Respond (MTTR)', value: '2.8 hours', trend: 'stable' as const, target: '< 3 hours', source: 'SOAR - XSOAR', method: 'Median time from acknowledgment to first containment action', owner: 'IR Lead', sla: '3 hours', prev: '2.7 hours', spark: [3.2, 3.0, 2.9, 2.8, 2.8, 2.9, 2.8, 2.8], breakdown: [{src: 'Auto Playbooks', pct: '42%', avg: '1.2h'}, {src: 'Semi-Auto', pct: '33%', avg: '2.5h'}, {src: 'Manual', pct: '20%', avg: '5.1h'}, {src: 'L3 Escalation', pct: '5%', avg: '8.3h'}]},
    {id: '2ef-MTD-003', name: 'Patch Compliance Rate', value: '97.6%', trend: 'improving' as const, target: '> 95%', source: 'Tenable.io', method: 'Pct of critical/high vulns patched within SLA windows', owner: 'Vuln Manager', sla: '95%', prev: '96.1%', spark: [93.2, 94.1, 94.8, 95.3, 95.9, 96.4, 97.0, 97.6], breakdown: [{src: 'Critical (7d)', pct: '40%', rate: '99.2%'}, {src: 'High (30d)', pct: '35%', rate: '97.8%'}, {src: 'Medium (90d)', pct: '20%', rate: '95.1%'}, {src: 'Low (180d)', pct: '5%', rate: '89.4%'}]},
    {id: '2ef-MTD-004', name: 'Phishing Click Rate', value: '3.2%', trend: 'improving' as const, target: '< 5%', source: 'KnowBe4 + Proofpoint', method: 'Pct of users clicking simulated phishing links monthly', owner: 'Awareness Lead', sla: '5%', prev: '4.1%', spark: [6.8, 6.2, 5.5, 5.1, 4.6, 4.1, 3.6, 3.2], breakdown: [{src: 'Spear Phishing', pct: '35%', rate: '5.1%'}, {src: 'Generic Phishing', pct: '30%', rate: '2.8%'}, {src: 'BEC Sim', pct: '20%', rate: '3.5%'}, {src: 'SMS Phishing', pct: '15%', rate: '1.9%'}]},
    {id: '2ef-MTD-005', name: 'Security Posture Score', value: '784', trend: 'improving' as const, target: '> 750', source: 'SecurityScorecard', method: 'Composite: external 30%, compliance 25%, vuln 25%, config 20%', owner: 'CISO', sla: '> 750', prev: '771', spark: [748, 752, 758, 762, 768, 773, 778, 784], breakdown: [{src: 'External Rating', pct: '30%', score: '791'}, {src: 'Compliance', pct: '25%', score: '812'}, {src: 'Vuln Mgmt', pct: '25%', score: '745'}, {src: 'Config', pct: '20%', score: '769'}]},
    {id: '2ef-MTD-006', name: 'Vulnerability Backlog', value: '142', trend: 'improving' as const, target: '< 150', source: 'Tenable + Qualys', method: 'Total open vulns across all scanned assets tracked weekly', owner: 'Vuln Manager', sla: '< 150', prev: '168', spark: [210, 198, 185, 175, 165, 158, 150, 142], breakdown: [{src: 'Critical', pct: '8%', count: '11'}, {src: 'High', pct: '22%', count: '31'}, {src: 'Medium', pct: '45%', count: '64'}, {src: 'Low', pct: '25%', count: '36'}]}
  ];

  private _2efArchReview = [
    {id: '2ef-AR-001', cat: 'Network', item: 'Network segmentation between trust zones with dedicated firewalls and granular ACLs', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Micro-segmentation via NSX across all production zones'},
    {id: '2ef-AR-002', cat: 'Network', item: 'DMZ architecture isolating public services from internal network', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Dual-firewall DMZ with WAF and DDoS mitigation'},
    {id: '2ef-AR-003', cat: 'Network', item: 'Least-privilege traffic flows with deny-by-default and quarterly review', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Explicit allow rules with automated drift detection'},
    {id: '2ef-AR-004', cat: 'Network', item: 'Encrypted external communications with IPSec/TLS 1.3 and PFS', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'IKEv2 with PFS, TLS 1.3 for all external APIs'},
    {id: '2ef-AR-005', cat: 'Identity', item: 'Centralized IdP with SSO and automated SCIM provisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Okta SSO SAML 2.0 for 247 apps with SCIM'},
    {id: '2ef-AR-006', cat: 'Identity', item: 'RBAC with quarterly reviews and automated deprovisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Quarterly recertification with JIT admin access'},
    {id: '2ef-AR-007', cat: 'Identity', item: 'PAM controlling all admin and service accounts with session recording', sev: 'high' as const, status: 'fail' as const, reviewer: 'IAM Lead', notes: '3 legacy accounts pending CyberArk enrollment'},
    {id: '2ef-AR-008', cat: 'Identity', item: 'MFA enforced for all users, hardware tokens for privileged access', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'FIDO2 for admins, push MFA for users, 99.8% enrollment'},
    {id: '2ef-AR-009', cat: 'Data', item: 'Data classification enforced with automated labeling on all repos', sev: 'high' as const, status: 'partial' as const, reviewer: 'Data Protection Lead', notes: 'Framework deployed, gaps on 4 legacy file shares'},
    {id: '2ef-AR-010', cat: 'Data', item: 'AES-256 encryption at rest for all sensitive data stores', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'Full-disk, TDE on DBs, SSE-KMS on cloud storage'},
    {id: '2ef-AR-011', cat: 'Data', item: 'DLP monitoring and preventing unauthorized data exfiltration', sev: 'high' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'DLP active on email, endpoint, cloud, and network'},
    {id: '2ef-AR-012', cat: 'Data', item: 'Encrypted off-site backups with quarterly restore testing', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Infrastructure Lead', notes: '3-2-1 strategy with immutable backups'},
    {id: '2ef-AR-013', cat: 'AppSec', item: 'Secure SDLC with SAST, DAST, SCA in all CI/CD pipelines', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: '34 pipelines with security gates and PR blocking'},
    {id: '2ef-AR-014', cat: 'AppSec', item: 'API gateway with auth, rate limiting, schema validation', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: 'Kong with OAuth2, rate limits, OpenAPI validation'},
    {id: '2ef-AR-015', cat: 'AppSec', item: 'Container security with image scanning and runtime protection', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Trivy scanning, Falco runtime in 80% of clusters'},
    {id: '2ef-AR-016', cat: 'Monitoring', item: 'SIEM collecting from all critical systems with correlation rules', sev: 'critical' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'Splunk 98% coverage with 1200+ correlation rules'},
    {id: '2ef-AR-017', cat: 'Monitoring', item: 'EDR with behavioral detection on all managed endpoints', sev: 'high' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'CrowdStrike on 99.2% endpoints with 24/7 MDR'},
    {id: '2ef-AR-018', cat: 'Monitoring', item: 'Executive dashboards with real-time posture visibility', sev: 'medium' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'PowerBI dashboards with weekly exec summaries'},
    {id: '2ef-AR-019', cat: 'Cloud', item: 'CSPM monitoring and remediating cloud misconfigurations', sev: 'high' as const, status: 'pass' as const, reviewer: 'Cloud Security Lead', notes: 'Prisma Cloud 450+ checks with auto-remediation'},
    {id: '2ef-AR-020', cat: 'Cloud', item: 'IaC templates scanned before deployment to production', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Checkov for Terraform, cfn-nag for CloudFormation pending'}
  ];

  private _get2efRiskProgress(): number {
    return Math.round(this._2efRiskAssessmentWorkflow.filter(s => s.status === 'completed').length / this._2efRiskAssessmentWorkflow.length * 100);
  }

  private _get2efTreatmentSummary(): {total: number; approved: number; avgReduction: number; investment: string} {
    const a = this._2efTreatmentOptions.filter(r => r.status === 'approved').length;
    const avg = this._2efTreatmentOptions.reduce((s, r) => s + ((r.before - r.after) / r.before * 100), 0) / this._2efTreatmentOptions.length;
    return {total: this._2efTreatmentOptions.length, approved: a, avgReduction: Math.round(avg), investment: '$1.125M annually'};
  }

  private _get2efRuleSummary(): {total: number; passing: number; failing: number; avgRate: number; violations: number} {
    const p = this._2efComplianceRules.filter(r => r.result === 'pass').length;
    const f = this._2efComplianceRules.filter(r => r.result === 'fail').length;
    const avg = this._2efComplianceRules.reduce((s, r) => s + r.passRate, 0) / this._2efComplianceRules.length;
    const v = this._2efComplianceRules.reduce((s, r) => s + r.violations, 0);
    return {total: this._2efComplianceRules.length, passing: p, failing: f, avgRate: Math.round(avg * 10) / 10, violations: v};
  }

  private _get2efPipelineStats(): {positions: number; applicants: number; interviewing: number; offers: number; critical: number} {
    const t = this._2efTalentPositions.length;
    const a = this._2efTalentPositions.reduce((s, p) => s + p.applicants, 0);
    const i = this._2efTalentPositions.reduce((s, p) => s + p.interviews, 0);
    const o = this._2efTalentPositions.reduce((s, p) => s + p.offers, 0);
    const c = this._2efTalentPositions.filter(x => x.urgency === 'critical').length;
    return {positions: t, applicants: a, interviewing: i, offers: o, critical: c};
  }

  private _get2efMetricTrends(): {improving: number; stable: number; total: number} {
    const imp = this._2efMetricsDashboard.filter(m => m.trend === 'improving').length;
    const stb = this._2efMetricsDashboard.filter(m => m.trend === 'stable').length;
    return {improving: imp, stable: stb, total: this._2efMetricsDashboard.length};
  }

  private _get2efArchScore(): {total: number; passed: number; failed: number; partial: number; score: number} {
    const p = this._2efArchReview.filter(c => c.status === 'pass').length;
    const f = this._2efArchReview.filter(c => c.status === 'fail').length;
    const pa = this._2efArchReview.filter(c => c.status === 'partial').length;
    return {total: this._2efArchReview.length, passed: p, failed: f, partial: pa, score: Math.round((p / this._2efArchReview.length) * 100)};
  }


  private _z2efIncidentScenarios = [
    {id: 'z2ef-IS-001', name: 'Ransomware Outbreak in Production Environment', category: 'Malware', likelihood: 'Medium', impact: 'Critical', riskScore: 15, playbooks: ['IR-Ransomware-Isolate', 'IR-Ransomware-Eradicate', 'IR-Ransomway-Recover'], estimatedMTTD: '15min', estimatedMTTR: '4h', involvedTeams: ['SOC', 'IR', 'Infrastructure', 'Legal', 'Comms'], keyIndicators: ['Mass file encryption events', 'Ransom note deployment', 'Lateral movement via SMB/RDP', 'Backup deletion attempts'], mitigationControls: ['EDR behavioral detection', 'Network segmentation', 'Immutable backups', 'Email filtering'], lessonsLearned: 'Ensure offline backups are tested quarterly and Ransomware-specific playbooks are updated with latest threat intelligence', lastDrillDate: '2026-03-15', nextDrillDate: '2026-06-15'},
    {id: 'z2ef-IS-002', name: 'Cloud Misconfiguration Leading to Data Exposure', category: 'Cloud', likelihood: 'High', impact: 'High', riskScore: 16, playbooks: ['IR-Cloud-Misconfig-Assess', 'IR-Cloud-Misconfig-Remediate', 'IR-Cloud-Misconfig-Notify'], estimatedMTTD: '2h', estimatedMTTR: '6h', involvedTeams: ['Cloud Security', 'SOC', 'Data Protection', 'Legal'], keyIndicators: ['Public S3 bucket exposure', 'Overly permissive IAM policies', 'Unencrypted database snapshots', 'Public API endpoint discovery'], mitigationControls: ['CSPM monitoring', 'IAM policy analyzer', 'Automated remediation', 'Cloud audit logging'], lessonsLearned: 'Implement CSPM with auto-remediation for common misconfigurations and conduct monthly cloud configuration reviews', lastDrillDate: '2026-02-20', nextDrillDate: '2026-05-20'},
    {id: 'z2ef-IS-003', name: 'Insider Threat Data Exfiltration', category: 'Insider', likelihood: 'Low', impact: 'Critical', riskScore: 12, playbooks: ['IR-Insider-Investigate', 'IR-Insider-Contain', 'IR-Insider-Escalate'], estimatedMTTD: '8h', estimatedMTTR: '24h', involvedTeams: ['SOC', 'IR', 'HR', 'Legal', 'IAM'], keyIndicators: ['Anomalous data access patterns', 'Large file downloads to USB or cloud', 'Off-hours access to sensitive systems', 'Accessing data outside normal job scope'], mitigationControls: ['UEBA analytics', 'DLP policies', 'PAM controls', 'Access reviews'], lessonsLearned: 'Strengthen UEBA baselines and implement automated alerts for data access pattern anomalies', lastDrillDate: '2026-01-10', nextDrillDate: '2026-04-10'},
    {id: 'z2ef-IS-004', name: 'Supply Chain Attack via Compromised Vendor Software', category: 'Supply Chain', likelihood: 'Low', impact: 'Critical', riskScore: 12, playbooks: ['IR-SupplyChain-Detect', 'IR-SupplyChain-Isolate', 'IR-SupplyChain-Remediate'], estimatedMTTD: '24h', estimatedMTTR: '72h', involvedTeams: ['SOC', 'IR', 'Procurement', 'Vendor Mgmt', 'Legal'], keyIndicators: ['Unexpected network connections from vendor software', 'Modified binaries or dependencies', 'Anomalous behavior from trusted applications', 'SBOM discrepancy alerts'], mitigationControls: ['SCA scanning', 'SBOM monitoring', 'Vendor security assessments', 'Network segmentation'], lessonsLearned: 'Require SBOM from all vendors and implement continuous monitoring of third-party component behavior', lastDrillDate: '2026-03-01', nextDrillDate: '2026-06-01'},
    {id: 'z2ef-IS-005', name: 'Credential Stuffing Attack on Customer Portal', category: 'External Attack', likelihood: 'High', impact: 'Medium', riskScore: 12, playbooks: ['IR-CredentialStuffing-Detect', 'IR-CredentialStuffing-Block', 'IR-CredentialStuffing-Notify'], estimatedMTTD: '30min', estimatedMTTR: '2h', involvedTeams: ['SOC', 'AppSec', 'Customer Support', 'Comms'], keyIndicators: ['High volume of failed login attempts', 'Login attempts from known compromised credential lists', 'Unusual geographic distribution of login attempts', 'Account takeover indicators'], mitigationControls: ['WAF rate limiting', 'CAPTCHA on login', 'MFA enforcement', 'Credential monitoring service'], lessonsLearned: 'Deploy advanced bot detection on login endpoints and implement proactive credential monitoring for customer accounts', lastDrillDate: '2026-04-01', nextDrillDate: '2026-07-01'},
    {id: 'z2ef-IS-006', name: 'Phishing Campaign Targeting Executive Team', category: 'Social Engineering', likelihood: 'High', impact: 'High', riskScore: 16, playbooks: ['IR-Phishing-Contain', 'IR-Phishing-Investigate', 'IR-Phishing-Notify'], estimatedMTTD: '1h', estimatedMTTR: '4h', involvedTeams: ['SOC', 'Awareness', 'Executive Office', 'IT'], keyIndicators: ['Sophisticated spear-phishing emails to C-suite', 'Business email compromise indicators', 'Redirected MFA approval requests', 'Unauthorized wire transfer attempts'], mitigationControls: ['AI email filtering', 'Executive awareness training', 'Out-of-band verification policy', 'DMARC/DKIM/SPF'], lessonsLearned: 'Implement additional email security controls for executive mailboxes and conduct monthly spear-phishing simulations', lastDrillDate: '2026-02-15', nextDrillDate: '2026-05-15'}
  ];

  private _z2efSecurityFrameworks = [
  ...
  private _getz2efScenarioSummary(): {total: number; critical: number; high: number; drilled: number; avgRiskScore: number} {
    const crit = this._z2efIncidentScenarios.filter(s => s.impact === 'Critical').length;
    const high = this._z2efIncidentScenarios.filter(s => s.impact === 'High').length;
    const avg = this._z2efIncidentScenarios.reduce((s, x) => s + x.riskScore, 0) / this._z2efIncidentScenarios.length;
    return {total: this._z2efIncidentScenarios.length, critical: crit, high: high, drilled: this._z2efIncidentScenarios.length, avgRiskScore: Math.round(avg)};
  }

  private _getz2efVendorRiskSummary(): {total: number; approved: number; conditional: number; remediation: number; avgScore: number} {
    const approved = this._z2efThirdPartyRiskData.filter(v => v.status === 'approved').length;
    const cond = this._z2efThirdPartyRiskData.filter(v => v.status === 'conditional').length;
    const rem = this._z2efThirdPartyRiskData.filter(v => v.status === 'remediation_required').length;
    const avg = this._z2efThirdPartyRiskData.reduce((s, v) => s + v.riskScore, 0) / this._z2efThirdPartyRiskData.length;
    return {total: this._z2efThirdPartyRiskData.length, approved, conditional: cond, remediation: rem, avgScore: Math.round(avg)};
  }

  private _getz2efTrainingSummary(): {total: number; avgCompletion: number; avgScore: number; overdueUpdates: number} {
    const avgComp = this._z2efSecurityTrainingCatalog.reduce((s, t) => s + t.completionRate, 0) / this._z2efSecurityTrainingCatalog.length;
    const avgScore = this._z2efSecurityTrainingCatalog.filter(t => t.avgScore > 0).reduce((s, t) => s + t.avgScore, 0) / this._z2efSecurityTrainingCatalog.filter(t => t.avgScore > 0).length;
    return {total: this._z2efSecurityTrainingCatalog.length, avgCompletion: Math.round(avgComp * 10) / 10, avgScore: Math.round(avgScore), overdueUpdates: 0};
  }

  private _getz2efToolHealthSummary(): {total: number; healthy: number; degraded: number; annualCost: string} {
    const healthy = this._z2efSecurityToolInventory.filter(t => t.health === 'healthy').length;
    const degraded = this._z2efSecurityToolInventory.filter(t => t.health === 'degraded').length;
    const cost = this._z2efSecurityToolInventory.reduce((s, t) => s + parseInt(t.annualCost.replace(/[^0-9]/g, '')), 0);
    return {total: this._z2efSecurityToolInventory.length, healthy, degraded, annualCost: '$' + (cost / 1000).toFixed(0) + 'K'};
  }


  private _x2efSecurityZones = [
    {zoneId: 'x2ef-Z-001', name: 'Internet DMZ', trustLevel: 'Untrusted', subnet: '10.0.0.0/24', segmentation: 'Dual-firewall', firewallRules: 45, monitoring: 'Full packet capture', assets: ['Web servers', 'Load balancers', 'WAF appliances', 'Reverse proxy'], riskLevel: 'high' as const, lastAssessment: '2026-04-15', nextAssessment: '2026-07-15'},
    {zoneId: 'x2ef-Z-002', name: 'Corporate Network', trustLevel: 'Trusted', subnet: '10.1.0.0/16', segmentation: 'VLAN + micro-seg', firewallRules: 128, monitoring: 'NetFlow + IDS', assets: ['Workstations', 'Printers', 'Meeting room systems', 'VoIP phones'], riskLevel: 'medium' as const, lastAssessment: '2026-04-10', nextAssessment: '2026-07-10'},
    {zoneId: 'x2ef-Z-003', name: 'Production Data Center', trustLevel: 'Restricted', subnet: '10.2.0.0/16', segmentation: 'Full micro-segmentation', firewallRules: 256, monitoring: 'Full packet capture + EDR', assets: ['Application servers', 'Database clusters', 'Message queues', 'API gateways'], riskLevel: 'low' as const, lastAssessment: '2026-04-12', nextAssessment: '2026-07-12'},
    {zoneId: 'x2ef-Z-004', name: 'Management Network', trustLevel: 'Restricted', subnet: '10.3.0.0/24', segmentation: 'Isolated VLAN', firewallRules: 32, monitoring: 'Syslog + SNMP', assets: ['Hypervisors', 'Switch management', 'Storage controllers', 'Backup appliances'], riskLevel: 'low' as const, lastAssessment: '2026-04-08', nextAssessment: '2026-07-08'},
    {zoneId: 'x2ef-Z-005', name: 'Cloud Production', trustLevel: 'Restricted', subnet: 'VPC: 172.16.0.0/12', segmentation: 'Security groups + NACLs', firewallRules: 189, monitoring: 'VPC Flow Logs + GuardDuty', assets: ['Kubernetes clusters', 'Managed databases', 'Object storage', 'Serverless functions'], riskLevel: 'medium' as const, lastAssessment: '2026-04-18', nextAssessment: '2026-07-18'}
  ];

  private _x2efSecurityAlerts = [
    {id: 'x2ef-AL-001', severity: 'critical', title: 'Active ransomware encryption detected on PROD-DB-01', source: 'CrowdStrike', timestamp: '2026-04-22T13:45:00Z', status: 'investigating', assignee: 'SOC Analyst J. Smith', asset: 'PROD-DB-01 (10.2.1.15)', mitreTechnique: 'T1486 - Data Encrypted for Impact', playbook: 'IR-Ransomware-Isolate', sla: '15 minutes', elapsed: '12 minutes', notes: 'EDR detected mass file encryption event pattern. Automated isolation triggered. IR team paged.'},
    {id: 'x2ef-AL-002', severity: 'high', title: 'Impossible travel detected for user admin@company.com', source: 'Okta', timestamp: '2026-04-22T12:30:00Z', status: 'triaged', assignee: 'SOC Analyst M. Johnson', asset: 'Okta - admin@company.com', mitreTechnique: 'T1078 - Valid Accounts', playbook: 'IR-ImpossibleTravel', sla: '30 minutes', elapsed: '87 minutes', notes: 'Login from Tokyo followed by login from New York within 30 minutes. Account temporarily locked. User confirmed via out-of-band channel they are in New York.'},
    {id: 'x2ef-AL-003', severity: 'high', title: 'Public S3 bucket discovered with customer PII exposure', source: 'Prisma Cloud', timestamp: '2026-04-22T11:15:00Z', status: 'remediating', assignee: 'Cloud Security Lead A. Chen', asset: 'AWS S3: customer-data-archive-2024', mitreTechnique: 'N/A - Misconfiguration', playbook: 'IR-Cloud-Misconfig-Remediate', sla: '1 hour', elapsed: '2.5 hours', notes: 'Bucket containing archived customer records was publicly accessible. Bucket blocked and encrypted. Data exposure assessment in progress.'},
    {id: 'x2ef-AL-004', severity: 'medium', title: 'Anomalous data download by user jane.developer@company.com', source: 'Microsoft DLP', timestamp: '2026-04-22T10:00:00Z', status: 'investigating', assignee: 'SOC Analyst R. Davis', asset: 'Endpoint: WS-DEV-042', mitreTechnique: 'T1567 - Exfil Over Web Service', playbook: 'IR-DLP-Investigation', sla: '4 hours', elapsed: '3.5 hours', notes: 'User downloaded 4.2GB of source code files to personal Google Drive. Interview scheduled with user and manager.'},
    {id: 'x2ef-AL-005', severity: 'medium', title: 'Credential stuffing attack detected on customer portal', source: 'Cloudflare WAF', timestamp: '2026-04-22T09:30:00Z', status: 'contained', assignee: 'SOC Analyst K. Wilson', asset: 'Customer Portal (portal.company.com)', mitreTechnique: 'T1110 - Brute Force', playbook: 'IR-CredentialStuffing-Block', sla: '2 hours', elapsed: '4 hours', notes: 'Rate limiting and CAPTCHA automatically deployed. 12,000 failed login attempts from 800 unique IPs blocked. No successful account takeovers confirmed.'},
    {id: 'x2ef-AL-006', severity: 'low', title: 'SSL certificate expiring in 14 days for api.company.com', source: 'Certificate monitoring', timestamp: '2026-04-22T08:00:00Z', status: 'remediated', assignee: 'Infrastructure Lead T. Brown', asset: 'api.company.com', mitreTechnique: 'N/A', playbook: 'Certificate Renewal', sla: '30 days', elapsed: '16 days', notes: 'Automated renewal triggered via ACME. New certificate deployed successfully. No service interruption.'}
  ];

  private _x2efComplianceFrameworks = [
  ...
  private _x2efDataClassificationPolicy = [
  ...
  private _getx2efZoneSummary(): {total: number; highRisk: number; mediumRisk: number; lowRisk: number; totalRules: number} {
    const high = this._x2efSecurityZones.filter(z => z.riskLevel === 'high').length;
    const med = this._x2efSecurityZones.filter(z => z.riskLevel === 'medium').length;
    const low = this._x2efSecurityZones.filter(z => z.riskLevel === 'low').length;
    const rules = this._x2efSecurityZones.reduce((s, z) => s + z.firewallRules, 0);
    return {total: this._x2efSecurityZones.length, highRisk: high, mediumRisk: med, lowRisk: low, totalRules: rules};
  }

  private _getx2efAlertSummary(): {total: number; critical: number; high: number; medium: number; low: number; open: number; contained: number} {
    const crit = this._x2efSecurityAlerts.filter(a => a.severity === 'critical').length;
    const high = this._x2efSecurityAlerts.filter(a => a.severity === 'high').length;
    const med = this._x2efSecurityAlerts.filter(a => a.severity === 'medium').length;
    const low = this._x2efSecurityAlerts.filter(a => a.severity === 'low').length;
    const open = this._x2efSecurityAlerts.filter(a => a.status === 'investigating' || a.status === 'triaged').length;
    const contained = this._x2efSecurityAlerts.filter(a => a.status === 'contained' || a.status === 'remediated').length;
    return {total: this._x2efSecurityAlerts.length, critical: crit, high, medium: med, low, open, contained};
  }

  private _getx2efComplianceSummary(): {total: number; fullyCompliant: number; mostlyCompliant: number; avgComplianceRate: number} {
    const full = this._x2efComplianceFrameworks.filter(f => f.status === 'compliant').length;
    const mostly = this._x2efComplianceFrameworks.filter(f => f.status === 'mostly_compliant').length;
    const avgRate = this._x2efComplianceFrameworks.reduce((s, f) => s + (f.compliant / f.requirements * 100), 0) / this._x2efComplianceFrameworks.length;
    return {total: this._x2efComplianceFrameworks.length, fullyCompliant: full, mostlyCompliant: mostly, avgComplianceRate: Math.round(avgRate * 10) / 10};
  }
  ...
  // === Security Risk Register (asset_invent) ===
  private _asset_inventRiskRegister = [
    { id: "RSK-ASS-0001", title: "Data breach from unpatched systems", owner: "CTO", category: "Financial", status: "mitigating", trend: "stable", severity: "critical", likelihood: 6, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-06", nextReview: "2026-07-14" },
    { id: "RSK-ASS-0002", title: "Ransomware attack on critical infrastructure", owner: "CRO", category: "Strategic", status: "closed", trend: "decreasing", severity: "critical", likelihood: 1, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-10", nextReview: "2026-07-04" },
    { id: "RSK-ASS-0003", title: "Insider threat data exfiltration", owner: "VP Eng", category: "Compliance", status: "accepted", trend: "increasing", severity: "critical", likelihood: 1, impact: 4, treatment: "Monitor and review quarterly", lastReview: "2026-04-16", nextReview: "2026-07-16" },
    { id: "RSK-ASS-0004", title: "Supply chain compromise", owner: "Security Lead", category: "Technical", status: "open", trend: "stable", severity: "low", likelihood: 8, impact: 4, treatment: "Monitor and review quarterly", lastReview: "2026-04-20", nextReview: "2026-07-02" },
    { id: "RSK-ASS-0005", title: "Cloud misconfiguration exposure", owner: "Risk Mgr", category: "Reputational", status: "mitigating", trend: "decreasing", severity: "high", likelihood: 2, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-12", nextReview: "2026-07-01" },
    { id: "RSK-ASS-0006", title: "Phishing campaign success rate", owner: "Compliance Dir", category: "Legal", status: "closed", trend: "increasing", severity: "critical", likelihood: 7, impact: 1, treatment: "Monitor and review quarterly", lastReview: "2026-04-18", nextReview: "2026-07-19" },
    { id: "RSK-ASS-0007", title: "Third-party vendor data breach", owner: "IT Dir", category: "Regulatory", status: "accepted", trend: "stable", severity: "medium", likelihood: 8, impact: 4, treatment: "Monitor and review quarterly", lastReview: "2026-04-11", nextReview: "2026-07-14" },
    { id: "RSK-ASS-0008", title: "Regulatory non-compliance penalty", owner: "DevOps Lead", category: "Third-Party", status: "open", trend: "decreasing", severity: "low", likelihood: 6, impact: 4, treatment: "Monitor and review quarterly", lastReview: "2026-04-18", nextReview: "2026-07-05" },
    { id: "RSK-ASS-0009", title: "Zero-day exploit in production", owner: "Architect", category: "Human Capital", status: "mitigating", trend: "increasing", severity: "critical", likelihood: 6, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-19", nextReview: "2026-07-28" },
    { id: "RSK-ASS-0010", title: "Insufficient access controls", owner: "CISO", category: "Operational", status: "closed", trend: "stable", severity: "critical", likelihood: 3, impact: 2, treatment: "Monitor and review quarterly", lastReview: "2026-04-09", nextReview: "2026-07-03" },
    { id: "RSK-ASS-0011", title: "DDoS attack on services", owner: "CTO", category: "Financial", status: "accepted", trend: "decreasing", severity: "low", likelihood: 5, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-03", nextReview: "2026-07-02" },
    { id: "RSK-ASS-0012", title: "Social engineering attack", owner: "CRO", category: "Strategic", status: "open", trend: "increasing", severity: "low", likelihood: 5, impact: 1, treatment: "Monitor and review quarterly", lastReview: "2026-04-06", nextReview: "2026-07-09" },
    { id: "RSK-ASS-0013", title: "API security vulnerability", owner: "VP Eng", category: "Compliance", status: "mitigating", trend: "stable", severity: "medium", likelihood: 1, impact: 2, treatment: "Monitor and review quarterly", lastReview: "2026-04-13", nextReview: "2026-07-11" },
    { id: "RSK-ASS-0014", title: "Mobile device compromise", owner: "Security Lead", category: "Technical", status: "closed", trend: "decreasing", severity: "medium", likelihood: 10, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-22", nextReview: "2026-07-02" },
    { id: "RSK-ASS-0015", title: "Physical security breach", owner: "Risk Mgr", category: "Reputational", status: "accepted", trend: "increasing", severity: "medium", likelihood: 3, impact: 7, treatment: "Monitor and review quarterly", lastReview: "2026-04-19", nextReview: "2026-07-09" },
    { id: "RSK-ASS-0016", title: "Password policy weakness", owner: "Compliance Dir", category: "Legal", status: "open", trend: "stable", severity: "medium", likelihood: 2, impact: 6, treatment: "Monitor and review quarterly", lastReview: "2026-04-07", nextReview: "2026-07-23" },
    { id: "RSK-ASS-0017", title: "Network segmentation gap", owner: "IT Dir", category: "Regulatory", status: "mitigating", trend: "decreasing", severity: "low", likelihood: 4, impact: 5, treatment: "Monitor and review quarterly", lastReview: "2026-04-08", nextReview: "2026-07-17" },
    { id: "RSK-ASS-0018", title: "Encryption key management failure", owner: "DevOps Lead", category: "Third-Party", status: "closed", trend: "increasing", severity: "medium", likelihood: 6, impact: 6, treatment: "Monitor and review quarterly", lastReview: "2026-04-12", nextReview: "2026-07-18" },
    { id: "RSK-ASS-0019", title: "Audit trail tampering", owner: "Architect", category: "Human Capital", status: "accepted", trend: "stable", severity: "low", likelihood: 5, impact: 6, treatment: "Monitor and review quarterly", lastReview: "2026-04-01", nextReview: "2026-07-08" },
    { id: "RSK-ASS-0020", title: "Business email compromise", owner: "CISO", category: "Operational", status: "open", trend: "decreasing", severity: "medium", likelihood: 7, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-19", nextReview: "2026-07-27" },
  ];
  private _asset_inventRiskFilter: string = 'all';
  private _asset_inventRiskSeverity: string = 'all';
  private _asset_inventRiskStatus: string = 'all';
  private _asset_inventExpandedRisk: string = '';
  private _asset_inventFilterRisks() {
    const reg = this._asset_inventRiskRegister;
    return reg.filter(r => {
      if (this._asset_inventRiskFilter !== "all" && r.category !== this._asset_inventRiskFilter) return false;
      if (this._asset_inventRiskSeverity !== "all" && r.severity !== this._asset_inventRiskSeverity) return false;
      if (this._asset_inventRiskStatus !== "all" && r.status !== this._asset_inventRiskStatus) return false;
      return true;
    });
  }
  private _asset_inventGetRiskScore(r: any) { return Math.round(r.likelihood * r.impact * 1.5); }
  private _asset_inventGetRiskTrendIcon(trend: string) {
    if (trend === "increasing") return "\u2191";
    if (trend === "decreasing") return "\u2193";
    return "\u2192";
  }
  private _asset_inventGetRiskColor(sev: string) {
    if (sev === "critical") return "#dc2626";
    if (sev === "high") return "#ea580c";
    if (sev === "medium") return "#d97706";
    return "#16a34a";
  }
  private _asset_inventGetRiskCounts() {
    const reg = this._asset_inventRiskRegister;
  ...
  private _asset_inventGetTreatmentProgress() {
    const reg = this._asset_inventRiskRegister;
    const treated = reg.filter(r => r.status === "mitigating" || r.status === "closed").length;
    return Math.round((treated / Math.max(reg.length, 1)) * 100);
  }

  // === Security Metrics API Gateway (asset_invent) ===
  private _asset_inventApiEndpoints = [
    { method: "GET", path: "/api/v1/threats", name: "Threat Intelligence Feed", status: "active", avgLatency: 322.6, reqPerMin: 871.0, errorRate: 1.84, uptime: round(98.78063165441243,2), version: "v1.5.8" },
    { method: "POST", path: "/api/v1/scans/start", name: "Vulnerability Scanner", status: "active", avgLatency: 413.0, reqPerMin: 1687.0, errorRate: 1.04, uptime: round(95.61969198456651,2), version: "v3.2.11" },
    { method: "GET", path: "/api/v1/assets", name: "Asset Inventory", status: "active", avgLatency: 316.1, reqPerMin: 2267.0, errorRate: 1.86, uptime: round(95.59040657835051,2), version: "v1.4.20" },
    { method: "POST", path: "/api/v1/alerts", name: "Alert Management", status: "active", avgLatency: 253.0, reqPerMin: 872.0, errorRate: 2.24, uptime: round(97.35906809948943,2), version: "v2.2.9" },
    { method: "GET", path: "/api/v1/compliance", name: "Compliance Status", status: "active", avgLatency: 281.3, reqPerMin: 2278.0, errorRate: 2.09, uptime: round(98.67308217715761,2), version: "v3.0.19" },
    { method: "PUT", path: "/api/v1/policies", name: "Policy Engine", status: "active", avgLatency: 332.3, reqPerMin: 414.0, errorRate: 0.19, uptime: round(96.49288321385107,2), version: "v1.6.13" },
    { method: "GET", path: "/api/v1/incidents", name: "Incident Tracker", status: "active", avgLatency: 342.0, reqPerMin: 764.0, errorRate: 2.07, uptime: round(97.44243616656279,2), version: "v1.2.19" },
    { method: "POST", path: "/api/v1/forensics", name: "Forensics Collector", status: "degraded", avgLatency: 306.6, reqPerMin: 428.0, errorRate: 0.24, uptime: round(96.9677219124714,2), version: "v1.2.12" },
    { method: "GET", path: "/api/v1/risk/assess", name: "Risk Assessment", status: "active", avgLatency: 237.3, reqPerMin: 909.0, errorRate: 1.95, uptime: round(99.75078420295942,2), version: "v3.6.4" },
    { method: "POST", path: "/api/v1/auth/verify", name: "Authentication", status: "active", avgLatency: 368.4, reqPerMin: 395.0, errorRate: 0.25, uptime: round(99.70572307404501,2), version: "v2.4.20" },
    { method: "GET", path: "/api/v1/logs/audit", name: "Audit Log Query", status: "active", avgLatency: 174.2, reqPerMin: 1378.0, errorRate: 0.77, uptime: round(99.46475078627645,2), version: "v1.6.6" },
    { method: "PUT", path: "/api/v1/users/roles", name: "Role Management", status: "active", avgLatency: 447.2, reqPerMin: 981.0, errorRate: 1.92, uptime: round(96.58983854753927,2), version: "v3.3.12" },
    { method: "POST", path: "/api/v1/encrypt", name: "Encryption Service", status: "active", avgLatency: 395.6, reqPerMin: 458.0, errorRate: 0.67, uptime: round(97.32771086210036,2), version: "v3.7.9" },
    { method: "GET", path: "/api/v1/network/topo", name: "Network Topology", status: "maintenance", avgLatency: 362.7, reqPerMin: 1236.0, errorRate: 1.67, uptime: round(97.2015910615768,2), version: "v1.8.8" },
    { method: "DELETE", path: "/api/v1/sessions", name: "Session Manager", status: "active", avgLatency: 431.8, reqPerMin: 953.0, errorRate: 1.94, uptime: round(95.18019520955185,2), version: "v2.4.15" },
  ];
  private _asset_inventApiKeys = [
    { id: "ak-000001", name: "key-asse-001", created: "2026-06-20", lastUsed: "2026-04-03", status: "revoked", calls: 31656, rateLimit: 5000 },
    { id: "ak-000002", name: "key-asse-002", created: "2026-07-21", lastUsed: "2026-04-23", status: "revoked", calls: 49308, rateLimit: 100 },
    { id: "ak-000003", name: "key-asse-003", created: "2026-03-26", lastUsed: "2026-04-05", status: "revoked", calls: 29530, rateLimit: 5000 },
    { id: "ak-000004", name: "key-asse-004", created: "2026-07-13", lastUsed: "2026-04-13", status: "active", calls: 20700, rateLimit: 1000 },
    { id: "ak-000005", name: "key-asse-005", created: "2026-06-28", lastUsed: "2026-04-20", status: "revoked", calls: 48639, rateLimit: 500 },
    { id: "ak-000006", name: "key-asse-006", created: "2026-03-21", lastUsed: "2026-04-05", status: "active", calls: 42108, rateLimit: 100 },
    { id: "ak-000007", name: "key-asse-007", created: "2026-01-17", lastUsed: "2026-04-15", status: "active", calls: 39750, rateLimit: 1000 },
    { id: "ak-000008", name: "key-asse-008", created: "2026-04-17", lastUsed: "2026-04-15", status: "active", calls: 41568, rateLimit: 1000 },
  ];
  private _asset_inventApiHealthSummary() {
    const eps = this._asset_inventApiEndpoints;
  ...
  private _asset_inventGetApiByMethod(method: string) { return this._asset_inventApiEndpoints.filter(e=>e.method===method); }
  private _asset_inventGetSlowEndpoints() { return this._asset_inventApiEndpoints.filter(e=>e.avgLatency>200).sort((a,b)=>b.avgLatency-a.avgLatency); }
  private _asset_inventGetHighErrorEndpoints() { return this._asset_inventApiEndpoints.filter(e=>e.errorRate>1.0).sort((a,b)=>b.errorRate-a.errorRate); }

  // === Security Training Effectiveness (asset_invent) ===
  private _asset_inventTrainingModules = [
    { id: "TRN-001", name: "Security Fundamentals", completionRate: 83.7, avgScore: 81.6, behaviorChange: 69.0, enrolled: 491, completed: 332, duration: "42min", category: "mandatory" },
    { id: "TRN-002", name: "Phishing Awareness", completionRate: 60.6, avgScore: 90.5, behaviorChange: 68.3, enrolled: 214, completed: 315, duration: "51min", category: "mandatory" },
    { id: "TRN-003", name: "Social Engineering Defense", completionRate: 79.7, avgScore: 87.3, behaviorChange: 53.5, enrolled: 362, completed: 97, duration: "103min", category: "optional" },
    { id: "TRN-004", name: "Password Hygiene", completionRate: 70.8, avgScore: 75.4, behaviorChange: 56.1, enrolled: 428, completed: 250, duration: "47min", category: "mandatory" },
    { id: "TRN-005", name: "Data Classification", completionRate: 89.6, avgScore: 74.5, behaviorChange: 35.4, enrolled: 87, completed: 331, duration: "109min", category: "mandatory" },
    { id: "TRN-006", name: "Incident Response Basics", completionRate: 63.5, avgScore: 84.6, behaviorChange: 72.2, enrolled: 347, completed: 165, duration: "51min", category: "mandatory" },
    { id: "TRN-007", name: "Secure Coding", completionRate: 69.3, avgScore: 94.4, behaviorChange: 77.2, enrolled: 105, completed: 40, duration: "96min", category: "optional" },
    { id: "TRN-008", name: "Cloud Security", completionRate: 70.6, avgScore: 82.5, behaviorChange: 52.0, enrolled: 314, completed: 233, duration: "109min", category: "mandatory" },
    { id: "TRN-009", name: "Mobile Device Security", completionRate: 51.3, avgScore: 56.6, behaviorChange: 34.4, enrolled: 422, completed: 224, duration: "105min", category: "mandatory" },
    { id: "TRN-010", name: "Network Security", completionRate: 47.1, avgScore: 59.1, behaviorChange: 38.1, enrolled: 420, completed: 409, duration: "51min", category: "mandatory" },
    { id: "TRN-011", name: "Physical Security", completionRate: 66.1, avgScore: 71.6, behaviorChange: 88.9, enrolled: 287, completed: 59, duration: "116min", category: "optional" },
    { id: "TRN-012", name: "Regulatory Compliance", completionRate: 56.3, avgScore: 78.9, behaviorChange: 39.1, enrolled: 213, completed: 235, duration: "56min", category: "mandatory" },
    { id: "TRN-013", name: "Risk Management", completionRate: 57.1, avgScore: 86.8, behaviorChange: 31.9, enrolled: 412, completed: 228, duration: "65min", category: "mandatory" },
    { id: "TRN-014", name: "Cryptography Basics", completionRate: 67.4, avgScore: 84.4, behaviorChange: 83.7, enrolled: 77, completed: 144, duration: "86min", category: "mandatory" },
    { id: "TRN-015", name: "Access Control", completionRate: 68.9, avgScore: 55.8, behaviorChange: 65.1, enrolled: 365, completed: 326, duration: "60min", category: "optional" },
    { id: "TRN-016", name: "Vendor Management", completionRate: 45.2, avgScore: 58.3, behaviorChange: 58.5, enrolled: 267, completed: 267, duration: "87min", category: "mandatory" },
  ];
  private _asset_inventPhishingResults = [
    { month: "2026-01", sent: 231, clicked: 51, reported: 76, clickRate: round(22.07792207792208,1), reportRate: round(32.900432900432904,1) },
    { month: "2026-02", sent: 536, clicked: 146, reported: 52, clickRate: round(27.238805970149254,1), reportRate: round(9.701492537313433,1) },
    { month: "2026-03", sent: 511, clicked: 136, reported: 294, clickRate: round(26.614481409001954,1), reportRate: round(57.534246575342465,1) },
    { month: "2026-04", sent: 547, clicked: 86, reported: 192, clickRate: round(15.722120658135283,1), reportRate: round(35.10054844606947,1) },
    { month: "2026-05", sent: 268, clicked: 55, reported: 69, clickRate: round(20.522388059701495,1), reportRate: round(25.74626865671642,1) },
    { month: "2026-06", sent: 759, clicked: 158, reported: 338, clickRate: round(20.816864295125164,1), reportRate: round(44.532279314888015,1) },
  ];
  private _asset_inventTrainingROI = { totalInvestment: 163248, avgCostPerEmployee: 250, riskReductionPct: round(random.uniform(15,45),1), incidentReductionPct: round(random.uniform(10,35),1), complianceScoreGain: round(random.uniform(5,25),1) };
  private _asset_inventLearningPaths = [
    { name: "Beginner Security Analyst", totalModules: 20, completedModules: 10, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 54, enrolled: 187 },
    { name: "Advanced Threat Hunter", totalModules: 13, completedModules: 14, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 10, enrolled: 110 },
    { name: "Security Architect", totalModules: 15, completedModules: 3, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 49, enrolled: 77 },
    { name: "Incident Responder", totalModules: 10, completedModules: 8, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 71, enrolled: 143 },
    { name: "Compliance Specialist", totalModules: 17, completedModules: 5, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 46, enrolled: 175 },
    { name: "DevSecOps Engineer", totalModules: 10, completedModules: 11, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 79, enrolled: 172 },
  ];
  private _asset_inventGetOverallCompletion() {
    const mods = this._asset_inventTrainingModules;
    return round(mods.reduce((s,m)=>s+m.completionRate,0)/mods.length,1);
  }
  private _asset_inventGetTopPerformers() { return [...this._asset_inventTrainingModules].sort((a,b)=>b.avgScore-a.avgScore).slice(0,5); }
  private _asset_inventGetModulesNeedingAttention() { return this._asset_inventTrainingModules.filter(m=>m.completionRate<70||m.avgScore<65); }

  // === Security Governance Framework (asset_invent) ===
  private _asset_inventGovBodies = [
    { name: "Security Steering Committee", members: 9, chair: "CISO", meetingFreq: "Weekly", lastMeeting: "2026-04-15", nextMeeting: "2026-05-05", quorum: 7 },
    { name: "Risk Management Board", members: 6, chair: "CTO", meetingFreq: "Bi-weekly", lastMeeting: "2026-04-09", nextMeeting: "2026-05-04", quorum: 8 },
    { name: "Data Governance Council", members: 13, chair: "CRO", meetingFreq: "Monthly", lastMeeting: "2026-04-18", nextMeeting: "2026-05-15", quorum: 6 },
    { name: "Compliance Oversight Board", members: 14, chair: "CDO", meetingFreq: "Monthly", lastMeeting: "2026-04-12", nextMeeting: "2026-05-11", quorum: 6 },
    { name: "Architecture Review Board", members: 5, chair: "VP Eng", meetingFreq: "Bi-weekly", lastMeeting: "2026-04-15", nextMeeting: "2026-05-04", quorum: 8 },
    { name: "Change Advisory Board", members: 14, chair: "CISO", meetingFreq: "Weekly", lastMeeting: "2026-04-12", nextMeeting: "2026-05-13", quorum: 7 },
    { name: "Incident Review Board", members: 13, chair: "CIO", meetingFreq: "As needed", lastMeeting: "2026-04-12", nextMeeting: "2026-05-03", quorum: 4 },
    { name: "Vendor Risk Committee", members: 14, chair: "CFO", meetingFreq: "Quarterly", lastMeeting: "2026-04-15", nextMeeting: "2026-05-07", quorum: 3 },
  ];
  private _asset_inventDecisions = [
    { id: "DEC-0001", title: "Adopt zero-trust architecture framework", date: "2026-04-14", status: "approved", owner: "CISO" },
    ...
    { id: "DEC-0004", title: "Mandate MFA for all external access", date: "2026-02-02", status: "pending", owner: "CRO" },
    { id: "DEC-0005", title: "Establish bug bounty program", date: "2026-02-10", status: "approved", owner: "VP Eng" },
    { id: "DEC-0006", title: "Deploy EDR solution enterprise-wide", date: "2026-01-23", status: "approved", owner: "CISO" },
    { id: "DEC-0007", title: "Conduct annual penetration testing", date: "2026-04-11", status: "implemented", owner: "CTO" },
    { id: "DEC-0008", title: "Implement network micro-segmentation", date: "2026-01-14", status: "in-progress", owner: "Security Lead" },
    { id: "DEC-0009", title: "Establish security champion program", date: "2026-03-28", status: "pending", owner: "CRO" },
    { id: "DEC-0010", title: "Migrate to passwordless authentication", date: "2026-04-11", status: "approved", owner: "VP Eng" },
  ];
  private _asset_inventPolicyLifecycle = [
    { name: "Information Security Policy", version: "v3.2", status: "active", lastUpdated: "2026-03-20", nextReview: "2026-10-06", owner: "CISO" },
    { name: "Acceptable Use Policy", version: "v4.2", status: "active", lastUpdated: "2026-04-10", nextReview: "2026-11-28", owner: "Legal" },
    { name: "Data Retention Policy", version: "v1.5", status: "under-review", lastUpdated: "2026-02-20", nextReview: "2026-9-23", owner: "DPO" },
    { name: "Access Control Policy", version: "v2.2", status: "active", lastUpdated: "2026-01-12", nextReview: "2026-8-06", owner: "IAM Lead" },
    { name: "Incident Response Policy", version: "v1.0", status: "draft", lastUpdated: "2026-04-03", nextReview: "2026-10-12", owner: "IR Lead" },
    { name: "Business Continuity Plan", version: "v3.5", status: "active", lastUpdated: "2026-02-20", nextReview: "2026-9-14", owner: "BCP Mgr" },
    { name: "Vendor Management Policy", version: "v2.0", status: "active", lastUpdated: "2026-03-04", nextReview: "2026-10-22", owner: "Procurement" },
    { name: "Encryption Standard", version: "v4.3", status: "under-review", lastUpdated: "2026-01-10", nextReview: "2026-8-27", owner: "Security Arch" },
  ];
  private _asset_inventGovMaturityScore = { overall: 4.3, riskManagement: 5.5, compliance: 2.2, incidentResponse: 2.8, awareness: 2.9, technology: 3.1 };
  private _asset_inventGetPendingDecisions() { return this._asset_inventDecisions.filter(d=>d.status==='pending'||d.status==='in-progress'); }
  private _asset_inventGetActivePolicies() { return this._asset_inventPolicyLifecycle.filter(p=>p.status==='active'); }
  private _asset_inventGetEscalationPath() { return ["L1 Analyst","L2 Senior","Security Lead","CISO","Board"]; }

  // === Security Innovation Lab (asset_invent) ===
  private _asset_inventInnoProjects = [
    { id: "INN-001", name: "AI-Powered Threat Detection", description: "Machine learning models for real-time threat identification", status: "active", progress: 72, startDate: "2026-01-02", teamSize: 7, budget: 145767, milestones: 9, completedMilestones: 5 },
    { id: "INN-002", name: "Quantum-Resistant Cryptography", description: "Post-quantum encryption algorithm prototyping", status: "research", progress: 35, startDate: "2026-01-21", teamSize: 6, budget: 194869, milestones: 8, completedMilestones: 7 },
    { id: "INN-003", name: "Automated Red Teaming", description: "Autonomous penetration testing framework", status: "active", progress: 58, startDate: "2026-02-03", teamSize: 6, budget: 64340, milestones: 9, completedMilestones: 7 },
    { id: "INN-004", name: "Zero-Knowledge Authentication", description: "Privacy-preserving identity verification", status: "poc", progress: 88, startDate: "2026-01-02", teamSize: 3, budget: 154152, milestones: 7, completedMilestones: 9 },
    { id: "INN-005", name: "Blockchain Audit Trail", description: "Immutable security event logging", status: "active", progress: 45, startDate: "2026-02-23", teamSize: 7, budget: 43974, milestones: 9, completedMilestones: 1 },
    { id: "INN-006", name: "Behavioral Biometrics", description: "Continuous authentication via user behavior patterns", status: "research", progress: 22, startDate: "2026-02-15", teamSize: 7, budget: 38311, milestones: 4, completedMilestones: 4 },
    { id: "INN-007", name: "Deception Grid 2.0", description: "Advanced honeypot network with adaptive responses", status: "active", progress: 65, startDate: "2026-01-16", teamSize: 4, budget: 23184, milestones: 5, completedMilestones: 2 },
    { id: "INN-008", name: "Secure Enclave Integration", description: "Hardware-backed security for critical workloads", status: "poc", progress: 40, startDate: "2026-01-26", teamSize: 3, budget: 181890, milestones: 9, completedMilestones: 2 },
  ];
  private _asset_inventTechEvaluations = [
    { name: "Rust for Security Tools", status: "evaluating", score: 4.1, recommendation: "Adopt", vendor: "Open Source" },
    { name: "eBPF for Runtime Detection", status: "completed", score: 10.2, recommendation: "Adopt", vendor: "AWS" },
  ...
  private _asset_inventCollaborationPartners = [
  ...
  private _asset_inventInnoMetrics = { totalProjects: 8, activeProjects: 4, avgTimeToValue: "82 days", pocSuccessRate: round(random.uniform(55,85),1), researchToProduction: round(random.uniform(20,50),1), innovationIndex: round(random.uniform(6.0,9.5),1) };
  private _asset_inventGetProjectByStatus(status: string) { return this._asset_inventInnoProjects.filter(p=>p.status===status); }
  private _asset_inventGetTopEvaluations() { return [...this._asset_inventTechEvaluations].sort((a,b)=>b.score-a.score).slice(0,3); }



  // === Compliance Dashboard Extension (asset_invent) ===
  private _asset_inventComplianceFrameworks = [
    { name: "SOC 2 Type II", description: "Trust Services Criteria", totalControls: 5, implementedControls: 3, status: "non-compliant", lastAudit: "2026-02-14", nextAudit: "2026-8-15", evidenceCount: 454 },
    { name: "ISO 27001", description: "Information Security Management", totalControls: 114, implementedControls: 80, status: "partially-compliant", lastAudit: "2026-04-26", nextAudit: "2026-9-27", evidenceCount: 446 },
    { name: "PCI DSS 4.0", description: "Payment Card Industry", totalControls: 12, implementedControls: 9, status: "in-review", lastAudit: "2026-03-19", nextAudit: "2026-12-20", evidenceCount: 95 },
    { name: "HIPAA", description: "Health Insurance Portability", totalControls: 18, implementedControls: 17, status: "in-review", lastAudit: "2026-04-10", nextAudit: "2026-9-24", evidenceCount: 457 },
    { name: "GDPR", description: "Data Protection Regulation", totalControls: 99, implementedControls: 76, status: "partially-compliant", lastAudit: "2026-04-21", nextAudit: "2026-9-04", evidenceCount: 461 },
    { name: "NIST CSF 2.0", description: "Cybersecurity Framework", totalControls: 6, implementedControls: 4, status: "in-review", lastAudit: "2026-04-27", nextAudit: "2026-8-04", evidenceCount: 342 },
    { name: "FedRAMP", description: "Federal Risk Authorization", totalControls: 15, implementedControls: 15, status: "compliant", lastAudit: "2026-02-12", nextAudit: "2026-7-11", evidenceCount: 445 },
    { name: "SOX", description: "Sarbanes-Oxley Compliance", totalControls: 8, implementedControls: 8, status: "partially-compliant", lastAudit: "2026-04-18", nextAudit: "2026-7-10", evidenceCount: 355 },
    { name: "CIS Controls v8", description: "Center for Internet Security", totalControls: 18, implementedControls: 16, status: "partially-compliant", lastAudit: "2026-02-18", nextAudit: "2026-11-14", evidenceCount: 499 },
    { name: "COBIT 2019", description: "IT Governance Framework", totalControls: 40, implementedControls: 26, status: "in-review", lastAudit: "2026-01-07", nextAudit: "2026-10-03", evidenceCount: 341 },
  ];
  private _asset_inventGetComplianceScore() {
    const fw = this._asset_inventComplianceFrameworks;
    return round(fw.reduce((s,f)=>s + (f.implementedControls/Math.max(f.totalControls,1))*100, 0) / fw.length, 1);
  }
  private _asset_inventGetGaps() {
    return this._asset_inventComplianceFrameworks.filter(f => f.status !== "compliant");
  }
  private _asset_inventAuditTrail = [
    { id: "AUD-0001", action: "Control tested", auditor: "Internal Audit", date: "2026-04-15", result: "pass", findings: 4 },
    { id: "AUD-0002", action: "Evidence collected", auditor: "External Auditor", date: "2026-04-18", result: "pass", findings: 5 },
    { id: "AUD-0003", action: "Gap identified", auditor: "Security Team", date: "2026-04-13", result: "fail", findings: 2 },
    ...
    { id: "AUD-0006", action: "Training verified", auditor: "Risk Team", date: "2026-04-05", result: "pass", findings: 3 },
    { id: "AUD-0007", action: "Access reviewed", auditor: "QA Team", date: "2026-04-11", result: "pass", findings: 0 },
    { id: "AUD-0008", action: "Exception approved", auditor: "CISO Office", date: "2026-04-23", result: "conditional", findings: 5 },
  ...
  // === Threat Intelligence Feed Extension (asset_invent) ===
  private _asset_inventThreatActors = [
    { name: "APT-29", alias: "Cozy Bear", origin: "Russia", type: "Nation-State", severity: "high", lastActivity: "2026-04-23", targets: "Manufacturing", indicators: 420, ttps: 19 },
    { name: "APT-41", alias: "Double Dragon", origin: "China", type: "Nation-State", severity: "critical", lastActivity: "2026-04-04", targets: "Healthcare", indicators: 131, ttps: 16 },
    { name: "Lazarus Group", alias: "Hidden Cobra", origin: "North Korea", type: "Nation-State", severity: "critical", lastActivity: "2026-04-21", targets: "Technology", indicators: 293, ttps: 28 },
    { name: "FIN7", alias: "Carbanak", origin: "Eastern Europe", type: "Financial", severity: "high", lastActivity: "2026-04-02", targets: "Healthcare", indicators: 394, ttps: 38 },
    { name: "Conti", alias: "Wizard Spider", origin: "Russia", type: "Ransomware", severity: "critical", lastActivity: "2026-04-18", targets: "Technology", indicators: 163, ttps: 25 },
    { name: "LockBit", alias: "LockBit Gang", origin: "Unknown", type: "Ransomware", severity: "high", lastActivity: "2026-04-01", targets: "Energy", indicators: 281, ttps: 18 },
    { name: "Cl0p", alias: "Cl0p Team", origin: "Unknown", type: "Ransomware", severity: "high", lastActivity: "2026-04-03", targets: "Government", indicators: 223, ttps: 15 },
    { name: "Sandworm", alias: "Unit 74455", origin: "Russia", type: "Nation-State", severity: "critical", lastActivity: "2026-04-22", targets: "Government", indicators: 493, ttps: 21 },
  ];
  private _asset_inventIoCFeed = [
    { id: "ioc-000001", type: "ip", value: "129.131.188.55", confidence: 94, source: "VirusTotal", firstSeen: "2026-04-16", lastSeen: "2026-04-18" },
    { id: "ioc-000002", type: "ip", value: "180.29.193.131", confidence: 75, source: "VirusTotal", firstSeen: "2026-04-18", lastSeen: "2026-04-20" },
    { id: "ioc-000003", type: "ip", value: "107.71.145.54", confidence: 46, source: "Mandiant", firstSeen: "2026-04-17", lastSeen: "2026-04-23" },
    { id: "ioc-000004", type: "ip", value: "201.242.89.227", confidence: 87, source: "VirusTotal", firstSeen: "2026-04-10", lastSeen: "2026-04-03" },
    { id: "ioc-000005", type: "ip", value: "203.41.135.5", confidence: 53, source: "STIX", firstSeen: "2026-04-17", lastSeen: "2026-04-14" },
    { id: "ioc-000006", type: "ip", value: "90.176.183.179", confidence: 82, source: "VirusTotal", firstSeen: "2026-04-17", lastSeen: "2026-04-15" },
    { id: "ioc-000007", type: "ip", value: "193.138.156.64", confidence: 42, source: "STIX", firstSeen: "2026-04-12", lastSeen: "2026-04-10" },
    { id: "ioc-000008", type: "ip", value: "149.136.59.241", confidence: 57, source: "VirusTotal", firstSeen: "2026-04-18", lastSeen: "2026-04-22" },
    { id: "ioc-000009", type: "ip", value: "39.159.118.251", confidence: 46, source: "Mandiant", firstSeen: "2026-04-12", lastSeen: "2026-04-08" },
    { id: "ioc-000010", type: "ip", value: "230.46.113.12", confidence: 84, source: "CrowdStrike", firstSeen: "2026-04-11", lastSeen: "2026-04-21" },
    { id: "ioc-000011", type: "ip", value: "56.148.115.150", confidence: 69, source: "VirusTotal", firstSeen: "2026-04-01", lastSeen: "2026-04-23" },
    { id: "ioc-000012", type: "ip", value: "224.223.106.54", confidence: 54, source: "CrowdStrike", firstSeen: "2026-04-04", lastSeen: "2026-04-22" },
    { id: "ioc-000013", type: "ip", value: "188.7.89.229", confidence: 71, source: "MISP", firstSeen: "2026-04-13", lastSeen: "2026-04-06" },
    { id: "ioc-000014", type: "ip", value: "235.91.150.228", confidence: 81, source: "CrowdStrike", firstSeen: "2026-04-23", lastSeen: "2026-04-13" },
    { id: "ioc-000015", type: "ip", value: "180.29.8.122", confidence: 47, source: "STIX", firstSeen: "2026-04-09", lastSeen: "2026-04-05" },
  ];
  private _asset_inventGetActiveThreats() { return this._asset_inventThreatActors.filter(a => a.severity === 'critical'); }
  private _asset_inventGetThreatSummary() {
    const actors = this._asset_inventThreatActors;
  ...
  // === Incident Management Extension (asset_invent) ===
  private _asset_inventIncidents = [
    { id: "INC-20260001", title: "Unauthorized access detected", severity: "critical", status: "open", assignedTo: "SOC L1", detectedAt: "2026-04-09T05:42", affectedAssets: 2, rootCause: "Misconfiguration" },
    { id: "INC-20260002", title: "Malware outbreak on workstation", severity: "high", status: "investigating", assignedTo: "SOC L2", detectedAt: "2026-04-16T00:00", affectedAssets: 36, rootCause: "Credential compromise" },
    { id: "INC-20260003", title: "Data leak from S3 bucket", severity: "medium", status: "contained", assignedTo: "IR Lead", detectedAt: "2026-04-13T10:38", affectedAssets: 31, rootCause: "Zero-day" },
    { id: "INC-20260004", title: "Phishing campaign targeting finance", severity: "low", status: "eradicated", assignedTo: "CISO", detectedAt: "2026-04-07T15:08", affectedAssets: 5, rootCause: "Human error" },
    { id: "INC-20260005", title: "DDoS attack on web services", severity: "critical", status: "recovered", assignedTo: "Security Eng", detectedAt: "2026-04-09T11:45", affectedAssets: 20, rootCause: "Policy violation" },
    { id: "INC-20260006", title: "Ransomware encryption attempt", severity: "high", status: "closed", assignedTo: "Forensics", detectedAt: "2026-04-19T09:00", affectedAssets: 44, rootCause: "Unknown" },
    { id: "INC-20260007", title: "Insider data exfiltration", severity: "medium", status: "open", assignedTo: "SOC L1", detectedAt: "2026-04-13T11:07", affectedAssets: 9, rootCause: "Misconfiguration" },
    { id: "INC-20260008", title: "API key exposure in repo", severity: "low", status: "investigating", assignedTo: "SOC L2", detectedAt: "2026-04-03T15:35", affectedAssets: 10, rootCause: "Credential compromise" },
    { id: "INC-20260009", title: "SQL injection on portal", severity: "critical", status: "contained", assignedTo: "IR Lead", detectedAt: "2026-04-20T12:45", affectedAssets: 37, rootCause: "Zero-day" },
    { id: "INC-20260010", title: "Brute force on VPN", severity: "high", status: "eradicated", assignedTo: "CISO", detectedAt: "2026-04-07T13:55", affectedAssets: 33, rootCause: "Human error" },
    { id: "INC-20260011", title: "Supply chain alert from vendor", severity: "medium", status: "recovered", assignedTo: "Security Eng", detectedAt: "2026-04-19T00:41", affectedAssets: 23, rootCause: "Policy violation" },
    { id: "INC-20260012", title: "Suspicious lateral movement", severity: "low", status: "closed", assignedTo: "Forensics", detectedAt: "2026-04-11T16:17", affectedAssets: 38, rootCause: "Unknown" },
  ];
  private _asset_inventGetIncidentStats() {
    const inc = this._asset_inventIncidents;
    return { total: inc.length, open: inc.filter(i=>i.status==="open").length, investigating: inc.filter(i=>i.status==="investigating").length, mttd: 44, mttr: 126 };
  }
  private _asset_inventGetSeverityDistribution() {
    const inc = this._asset_inventIncidents;
  ...
  private _initAssetInventoryMetricsEngine() {
    this._asset_inventoryNormalizationRules = [
    ...
    this._asset_inventoryIndustryBenchmarks = this._loadAssetInventoryBenchmarks();
    this._asset_inventoryKpiCatalog = this._defineAssetInventoryKpiCatalog();
    this._asset_inventoryMetricOwnership = this._buildAssetInventoryMetricOwnership();
    this._asset_inventoryNormTrends = this._calcAssetInventoryNormTrends();
  }

  private _loadAssetInventoryBenchmarks(): Array<Record<string, unknown>> {
    return [
  ...
  private _defineAssetInventoryKpiCatalog(): Array<Record<string, unknown>> {
    return [
  ...
  private _buildAssetInventoryMetricOwnership(): Array<Record<string, unknown>> {
    return [
  ...
  private _calcAssetInventoryNormTrends(): Array<Record<string, unknown>> {
  ...
  private _initAssetInventoryArchEvolution() {
    this._asset_inventoryArchComponents = [
    ...
    this._asset_inventoryArchRoadmap = this._planAssetInventoryArchRoadmap();
    this._asset_inventoryArchRiskSurface = this._mapAssetInventoryArchRiskSurface();
    this._asset_inventoryArchTechDebt = this._assessAssetInventoryTechDebt();
    this._asset_inventoryArchEvolutionTimeline = this._buildAssetInventoryEvolutionTimeline();
  }

  private _planAssetInventoryArchRoadmap(): Array<Record<string, unknown>> {
    return [
  ...
  private _mapAssetInventoryArchRiskSurface(): Array<Record<string, unknown>> {
    return [
  ...
  private _assessAssetInventoryTechDebt(): Array<Record<string, unknown>> {
    return this._asset_inventoryArchComponents
  ...
  private _buildAssetInventoryEvolutionTimeline(): Array<Record<string, unknown>> {
    return [
  ...
  private _initAssetInventoryDesignPatterns() {
    this._asset_inventoryDesignPatterns = [
    ...
    this._asset_inventoryPatternCompliance = this._assessAssetInventoryPatternCompliance();
    this._asset_inventoryPatternGaps = this._identifyAssetInventoryPatternGaps();
  }

  private _assessAssetInventoryPatternCompliance(): Array<Record<string, unknown>> {
    return this._asset_inventoryDesignPatterns.map((pat: Record<string, unknown>) => ({
  ...
  private _identifyAssetInventoryPatternGaps(): Array<Record<string, unknown>> {
    return this._asset_inventoryDesignPatterns
  ...
  private _initAssetInventoryCapacityPlanning() {
    this._asset_inventoryCapacityModels = [
    ...
    this._asset_inventoryCapacityForecast = this._forecastAssetInventoryCapacity();
    this._asset_inventoryCapacityAlerts = this._checkAssetInventoryCapacityAlerts();
  }

  private _forecastAssetInventoryCapacity(): Array<Record<string, unknown>> {
  ...
  private _checkAssetInventoryCapacityAlerts(): Array<Record<string, unknown>> {
    return this._asset_inventoryCapacityModels
  ...
  private _initAssetInventoryIntegrationMatrix() {
    this._asset_inventoryIntegrations = [
    ...
    this._asset_inventoryIntegrationHealth = this._assessAssetInventoryIntegrationHealth();
    this._asset_inventoryIntegrationAlerts = this._monitorAssetInventoryIntegrationAlerts();
    this._asset_inventoryDataFlowMatrix = this._buildAssetInventoryDataFlowMatrix();
    this._asset_inventoryIntegrationSLA = this._trackAssetInventoryIntegrationSLA();
  }

  private _assessAssetInventoryIntegrationHealth(): Record<string, unknown> {
    const active = this._asset_inventoryIntegrations.filter((i: Record<string, unknown>) => i.status === 'active').length;
    const degraded = this._asset_inventoryIntegrations.filter((i: Record<string, unknown>) => i.status === 'degraded').length;
    const warning = this._asset_inventoryIntegrations.filter((i: Record<string, unknown>) => i.status === 'warning').length;
    const avgLatency = this._asset_inventoryIntegrations.reduce((s: number, i: Record<string, unknown>) => s + Number(i.latency), 0) / this._asset_inventoryIntegrations.length;
    const avgErrorRate = this._asset_inventoryIntegrations.reduce((s: number, i: Record<string, unknown>) => s + Number(i.errorRate), 0) / this._asset_inventoryIntegrations.length;
    return {
      totalIntegrations: this._asset_inventoryIntegrations.length, active, degraded, warning,
      healthScore: Math.round((active / this._asset_inventoryIntegrations.length) * 100),
      avgLatencyMs: Math.round(avgLatency), avgErrorRate: Math.round(avgErrorRate * 1000) / 10,
      dataFreshness: '95%', coverage: '92%'
    };
  }

  private _monitorAssetInventoryIntegrationAlerts(): Array<Record<string, unknown>> {
    return this._asset_inventoryIntegrations
  ...
  private _buildAssetInventoryDataFlowMatrix(): Array<Record<string, unknown>> {
  ...
  private _trackAssetInventoryIntegrationSLA(): Array<Record<string, unknown>> {
    return this._asset_inventoryIntegrations.map((i: Record<string, unknown>) => ({
      integrationId: i.integrationId, integrationName: i.name,
  ...
  private _initAssetInventoryServiceMesh() {
    this._asset_inventoryMeshServices = [
    ...
    this._asset_inventoryMeshHealth = this._calcAssetInventoryMeshHealth();
    this._asset_inventoryMeshTraffic = this._analyzeAssetInventoryMeshTraffic();
  }

  private _calcAssetInventoryMeshHealth(): Record<string, unknown> {
    const healthy = this._asset_inventoryMeshServices.filter((s: Record<string, unknown>) => Number(s.errorRate) < 0.03).length;
    return {
      totalServices: this._asset_inventoryMeshServices.length, healthyServices: healthy,
      healthPercent: Math.round(healthy / this._asset_inventoryMeshServices.length * 100),
      totalReplicas: this._asset_inventoryMeshServices.reduce((s: number, svc: Record<string, unknown>) => s + Number(svc.replicas), 0),
      avgCpuUsage: Math.round(this._asset_inventoryMeshServices.reduce((s: number, svc: Record<string, unknown>) => s + Number(svc.cpuUsage), 0) / this._asset_inventoryMeshServices.length),
      avgMemoryUsage: Math.round(this._asset_inventoryMeshServices.reduce((s: number, svc: Record<string, unknown>) => s + Number(svc.memoryUsage), 0) / this._asset_inventoryMeshServices.length),
      avgLatencyP99: Math.round(this._asset_inventoryMeshServices.reduce((s: number, svc: Record<string, unknown>) => s + Number(svc.latencyP99), 0) / this._asset_inventoryMeshServices.length)
    };
  }

  private _analyzeAssetInventoryMeshTraffic(): Array<Record<string, unknown>> {
    return this._asset_inventoryMeshServices.map((s: Record<string, unknown>) => ({
  ...
  render() {    if (this._aiRules.length === 0) { this._initAiRules(); this._initAiCvss(); this._runAiAnomalyDetection(); this._generateAiPredictions(); this._initAiApprovals(); this._initAiActivity(); this._initAiNotifications(); }
...
<div class="tabs">
        ...
        ${this._activeTab === 'rules' ? html`
          ...
          <div style="background:#1a1d27;border-radius:8px;padding:12px">${this._renderAiTreemapSVG()}</div>
          <div style="margin-top:12px;font-size:11px;font-weight:600;margin-bottom:6px">Data Flow (Sankey)</div>
          <div style="background:#1a1d27;border-radius:8px;padding:12px">${this._renderAiSankeySVG()}</div>
          ${this._renderAiActivity()}
        ` : nothing}
        ${this._activeTab === 'anomalies' ? html`
          ${this._renderAiAnomalies()}
          ${this._renderAiNotifications()}
        ` : nothing}
        ${this._activeTab === 'predictions' ? html`
          ${this._renderAiPredictions()}
          ...
          <div style="background:#1a1d27;border-radius:8px;padding:12px">
            <table class="history-table"><thead><tr><th>ID</th><th>Base</th><th>Temporal</th><th>Environmental</th><th>Overall</th></tr></thead><tbody>
              ${this._aicvssData.map(c => html`<tr><td>${c.itemId}</td><td style="color:${c.base >= 7 ? '#ef4444' : c.base >= 4 ? '#eab308' : '#22c55e'}">${c.base}</td><td>${c.temporal}</td><td>${c.environmental}</td><td style="font-weight:700;color:${c.overall >= 7 ? '#ef4444' : c.overall >= 4 ? '#eab308' : '#22c55e'}">${c.overall}</td></tr>`)}
            </tbody></table>
          </div>
        ` : nothing}
        ${this._activeTab === 'approvals' ? html`
          ${this._renderAiApprovals()}
        ` : nothing}
        ...
        ${this._activeTab === 'new' ? html`
          <div class="form-section">
            <div class="form-title">Create New Asset Inventory Entry</div>
            <div class="form-grid">
  ...
  @state() private _aiScenarios: {id:string;name:string;attackType:string;target:string;method:string;impactLow:number;impactHigh:number;confidence:number;mitigation:string;status:string}[] = [];
  @state() private _aiScenarioForm: {attackType:string;target:string;method:string} = {attackType:'',target:'',method:''};
  @state() private _aiScenarioCompare: boolean = false;
  @state() private _aiScenarioSelected: string[] = [];

  private _aiInitScenarios(): void {
    const saved = localStorage.getItem('ai_scenarios');
    if (saved) { try { this._aiScenarios = JSON.parse(saved); } catch { /* ignore */ } }
    if (this._aiScenarios.length === 0) {
      this._aiScenarios = [
        {id:'ai-s1',name:'Baseline Threat',attackType:'Phishing',target:'Employees',method:'Spear Email',impactLow:45,impactHigh:78,confidence:72,mitigation:'Security awareness training + email filtering',status:'active'},
        {id:'ai-s2',name:'Escalated Attack',attackType:'Ransomware',target:'Endpoints',method:'Drive-by Download',impactLow:65,impactHigh:95,confidence:58,mitigation:'EDR deployment + network segmentation',status:'saved'},
        {id:'ai-s3',name:'Insider Threat',attackType:'Data Exfiltration',target:'Databases',method:'SQL Injection',impactLow:55,impactHigh:88,confidence:65,mitigation:'DLP policies + query monitoring',status:'draft'},
      ];
    }
  }

  private _aiSaveScenarios(): void {
    localStorage.setItem('ai_scenarios', JSON.stringify(this._aiScenarios));
  }

  private _aiAddScenario(): void {
    const f = this._aiScenarioForm;
    if (!f.attackType || !f.target) return;
    this._aiScenarios = [...this._aiScenarios, {
      id: 'ai-s' + (this._aiScenarios.length + 1),
    ...
    this._aiScenarioForm = {attackType:'',target:'',method:''};
    this._aiSaveScenarios();
  }

  private _aiRenderScenarioEngine(): any {
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <button class="tab" @click=${() => { this._aiScenarioCompare = !this._aiScenarioCompare; }}>${this._aiScenarioCompare ? 'List View' : 'Compare'}</button>
        </div>
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:6px;margin-bottom:10px">
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._aiScenarioForm = {...this._aiScenarioForm, attackType: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Attack Type</option>
            ${attackTypes.map(a => html`<option value=${a} ${this._aiScenarioForm.attackType === a ? 'selected' : ''}>${a}</option>`)}
          </select>
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._aiScenarioForm = {...this._aiScenarioForm, target: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Target</option>
            ${targets.map(t => html`<option value=${t} ${this._aiScenarioForm.target === t ? 'selected' : ''}>${t}</option>`)}
          </select>
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._aiScenarioForm = {...this._aiScenarioForm, method: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Method</option>
            ${methods.map(m => html`<option value=${m} ${this._aiScenarioForm.method === m ? 'selected' : ''}>${m}</option>`)}
          </select>
        </div>
        <button style="background:#3b82f6;border:none;border-radius:4px;padding:4px 12px;color:#fff;font-size:11px;cursor:pointer" @click=${this._aiAddScenario}>Run Simulation</button>
      </div>
      ${this._aiScenarioCompare && this._aiScenarios.length >= 2 ? html`
        <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
          <div style="font-weight:600;font-size:12px;color:#e2e8f0;margin-bottom:8px">Side-by-Side Comparison</div>
          <div style="display:grid;grid-template-columns:repeat(${Math.min(3, this._aiScenarios.length)},1fr);gap:8px">
            ${this._aiScenarios.slice(0,3).map(s => html`
      ...
      <div style="background:#0f1117;border-radius:8px;padding:12px">
        <div style="font-weight:600;font-size:12px;color:#e2e8f0;margin-bottom:8px">Saved Scenarios (${this._aiScenarios.length})</div>
        ${this._aiScenarios.map(s => html`
  ...
  @state() private _aiTrendData: {day:number;value:number;anomaly:boolean}[] = [];
  @state() private _aiTrendZoom: {start:number;end:number} | null = null;
  @state() private _aiTrendMA: number = 7;

  private _aiInitTrendData(): void {
    ...
    this._aiTrendData = data;
  }

  private _aiCalcMA(window: number): number[] {
    const result: number[] = [];
    for (let i = 0; i < this._aiTrendData.length; i++) {
      const start = Math.max(0, i - window + 1);
      const slice = this._aiTrendData.slice(start, i + 1);
      result.push(slice.reduce((s, d) => s + d.value, 0) / slice.length);
    }
    return result;
  }

  private _aiGetStats(): {mean:number;median:number;stddev:number;trend:string} {
    const vals = this._aiTrendData.map(d => d.value);
    const n = vals.length;
  ...
  private _aiRenderTimeSeries(): any {
    const stats = this._aiGetStats();
    const filtered = this._aiTrendZoom ? this._aiTrendData.filter(d => d.day >= this._aiTrendZoom.start && d.day <= this._aiTrendZoom.end) : this._aiTrendData;
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px">
            <button class="tab ${this._aiTrendMA === 7 ? 'active' : ''}" @click=${() => { this._aiTrendMA = 7; }}>7D MA</button>
            <button class="tab ${this._aiTrendMA === 30 ? 'active' : ''}" @click=${() => { this._aiTrendMA = 30; }}>30D MA</button>
            <button class="tab" @click=${() => { this._aiTrendZoom = null; }}>Reset Zoom</button>
          </div>
        </div>
        <div style="position:relative;height:120px;background:#1a1d2e;border-radius:6px;overflow:hidden;margin-bottom:8px;cursor:crosshair" @click=${(e: any) => {
          ...
          this._aiTrendZoom = { start: Math.max(0, center - 10), end: Math.min(89, center + 10) };
        }}>
  ...
  @state() private _aiRoles: string[] = ['Admin','Analyst','Operator','Viewer','Auditor'];
  @state() private _aiActions: string[] = ['Create','Read','Update','Delete','Export','Approve'];
  @state() private _aiPermissions: { [role: string]: { [action: string]: boolean } } = {};
  @state() private _aiPermAudit: {role:string;action:string;changedBy:string;timestamp:string;oldVal:boolean;newVal:boolean}[] = [];
  @state() private _aiPermCompare: string[] = [];

  private _aiInitPermissions(): void {
    ...
    for (const role of this._aiRoles) {
      perms[role] = {};
      this._aiActions.forEach((a, i) => { perms[role][a] = defaults[role]?.[i] ?? false; });
    }
    this._aiPermissions = perms;
  }

  private _aiTogglePermission(role: string, action: string): void {
    const old = this._aiPermissions[role][action];
    this._aiPermissions = {...this._aiPermissions, [role]: {...this._aiPermissions[role], [action]: !old}};
    this._aiPermAudit.unshift({role,action,changedBy:'current_user',timestamp:new Date().toISOString(),oldVal:old,newVal:!old});
  }

  private _aiRenderRBAC(): any {
    const compareRoles = this._aiPermCompare.map(r => this._aiPermissions[r]).filter(Boolean);
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          <span style="font-weight:700;font-size:13px;color:#e2e8f0">RBAC Permission Matrix</span>
          <div style="display:flex;gap:4px">
            ${this._aiRoles.map(r => html`
              <button class="tab ${this._aiPermCompare.includes(r) ? 'active' : ''}" @click=${() => {
                this._aiPermCompare = this._aiPermCompare.includes(r) ? this._aiPermCompare.filter(x => x !== r) : [...this._aiPermCompare, r];
              }}>${r}</button>
            `)}
          </div>
        </div>
          ...
          <table style="width:100%;border-collapse:collapse;font-size:10px">
            <thead>
              <tr>
                ...
                ${this._aiActions.map(a => html`<th style="padding:6px;color:#6b7280;border-bottom:1px solid #2a2d3a;text-align:center">${a}</th>`)}
              </tr>
            </thead>
            <tbody>
              ${this._aiRoles.map(role => html`
                <tr style="border-bottom:1px solid #1a1d2e">
                  <td style="padding:6px;color:#e2e8f0;font-weight:600">${role}</td>
                  ${this._aiActions.map(action => html`
                    <td style="text-align:center;padding:6px">
                      <button style="width:28px;height:20px;border-radius:3px;border:1px solid #2a2d3a;background:${this._aiPermissions[role][action] ? '#22c55e' : '#1a1d2e'};cursor:pointer;color:#fff;font-size:10px" @click=${() => this._aiTogglePermission(role, action)}>${this._aiPermissions[role][action] ? 'Y' : 'N'}</button>
                    </td>
                  `)}
                </tr>
              `)}
        ...
        ${compareRoles.length >= 2 ? html`
          <div style="margin-top:10px;padding:8px;background:#1a1d2e;border-radius:6px">
            <div style="font-size:11px;font-weight:600;color:#e2e8f0;margin-bottom:6px">Role Diff: ${this._aiPermCompare.join(' vs ')}</div>
            ${this._aiActions.map(action => {
              ...
              return allSame ? nothing : html`
                <div style="display:flex;gap:8px;padding:3px 0;font-size:10px">
                  ...
                  ${compareRoles.map((r, i) => html`<span style="color:${r[action] ? '#22c55e' : '#ef4444'}">${this._aiPermCompare[i]}=${r[action] ? 'Y' : 'N'}</span>`)}
                </div>
              `;
            })}
          </div>
        ` : nothing}
        ${this._aiPermAudit.length > 0 ? html`
          <div style="margin-top:8px;font-size:9px;color:#6b7280">Recent: ${this._aiPermAudit.slice(0,3).map(a => html`<span style="margin-right:8px">${a.role}.${a.action}: ${a.oldVal ? 'Y' : 'N'}->${a.newVal ? 'Y' : 'N'}</span>`)}
        ` : nothing}
      </div>
    `;
  }
  ...
  // === REPORTING SUITE ===
  @state() private _aiReportTemplate: string = 'executive';
  @state() private _aiReportSchedule: string = 'weekly';
  @state() private _aiReportDistList: string[] = ['security-team@company.com','ciso@company.com'];
  @state() private _aiReportHistory: {id:string;template:string;generatedAt:string;status:string}[] = [];

  private _aiGenerateReport(): void {
    const id = 'rpt-' + Date.now();
    this._aiReportHistory.unshift({id,template:this._aiReportTemplate,generatedAt:new Date().toISOString(),status:'sent'});
  }

  private _aiRenderReporting(): any {
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:8px">
          <div>
            ...
            ${templates.map(t => html`
              <div style="padding:6px;background:${this._aiReportTemplate === t.key ? '#1e3a5f' : '#1a1d2e'};border:1px solid ${this._aiReportTemplate === t.key ? '#3b82f6' : '#2a2d3a'};border-radius:4px;margin-bottom:4px;cursor:pointer" @click=${() => { this._aiReportTemplate = t.key; }}>
          ...
          <div>
            ...
            <div style="display:flex;gap:4px;margin-bottom:8px">
              ${schedules.map(s => html`<button class="tab ${this._aiReportSchedule === s.key ? 'active' : ''}" @click=${() => { this._aiReportSchedule = s.key; }}>${s.label}</button>`)}
            </div>
            <div style="font-size:10px;color:#6b7280;margin-bottom:4px">Distribution</div>
            <div style="font-size:10px;color:#9ca3af">${this._aiReportDistList.map(d => html`<div>${d}</div>`)}</div>
            <div style="margin-top:6px;display:flex;gap:4px">
              <button style="background:#3b82f6;border:none;border-radius:4px;padding:4px 10px;color:#fff;font-size:10px;cursor:pointer" @click=${this._aiGenerateReport}>Generate</button>
        ...
        ${this._aiReportHistory.length > 0 ? html`
          <div style="border-top:1px solid #2a2d3a;padding-top:8px">
            ...
            ${this._aiReportHistory.slice(0,3).map(r => html`
  ...
  @state() private _aiHighContrast: boolean = false;
  @state() private _aiA11yAnnounce: string = '';
  @state() private _aiShortcutsVisible: boolean = false;
  @state() private _aiFocusTrap: boolean = false;

  private _aiShortcuts: Record<string, string> = {
  ...
  private _aiHandleKeydown(e: KeyboardEvent): void {
    if (e.key === 'Escape' && this._aiFocusTrap) { this._aiFocusTrap = false; this._aiAnnounce('Dialog closed'); }
    if (e.ctrlKey && e.shiftKey && e.key === 'H') { e.preventDefault(); this._aiHighContrast = !this._aiHighContrast; this._aiAnnounce('High contrast ' + (this._aiHighContrast ? 'enabled' : 'disabled')); }
    if (e.ctrlKey && e.shiftKey && e.key === 'A') { e.preventDefault(); this._aiShortcutsVisible = !this._aiShortcutsVisible; }
  }

  private _aiAnnounce(msg: string): void {
    this._aiA11yAnnounce = msg;
    setTimeout(() => { this._aiA11yAnnounce = ''; }, 2000);
  }

  private _aiRenderAccessibility(): any {
    return html`
      <div role="region" aria-label="Accessibility Controls" style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <button class="tab ${this._aiShortcutsVisible ? 'active' : ''}" @click=${() => { this._aiShortcutsVisible = !this._aiShortcutsVisible; }} aria-expanded=${this._aiShortcutsVisible}>Shortcuts</button>
        </div>
        <div style="display:flex;gap:8px;margin-bottom:8px">
          <label style="display:flex;align-items:center;gap:6px;font-size:11px;color:#e2e8f0;cursor:pointer">
            <input type="checkbox" .checked=${this._aiHighContrast} @change=${() => { this._aiHighContrast = !this._aiHighContrast; }} aria-label="Toggle high contrast mode">
            High Contrast
          </label>
        </div>
        ${this._aiShortcutsVisible ? html`
          <div role="list" aria-label="Keyboard shortcuts" style="background:#1a1d2e;border-radius:6px;padding:8px">
            ${Object.entries(this._aiShortcuts).map(([key, desc]) => html`
        ...
        ` : nothing}
        <div role="status" aria-live="polite" aria-atomic="true" style="position:absolute;left:-9999px">${this._aiA11yAnnounce}</div>
      </div>
    `;
  }
  ...
  connectedCallback(): void {
    ...
    this._aiInitScenarios();
    this._aiInitTrendData();
    this._aiInitPermissions();
    document.addEventListener('keydown', this._aiHandleKeydown.bind(this));
  }

  disconnectedCallback(): void {
    super.disconnectedCallback();
    document.removeEventListener('keydown', this._aiHandleKeydown.bind(this));
  }

  // === TAB INTEGRATION FOR EXTENDED FEATURES ===
  @state() private _aiActiveSubTab: string = 'scenario';
  ...
  private _aiGetAllSubTabs(): {key:string;label:string}[] {
    return [
  ...
  private _aiRenderSubPanel(): any {
    switch (this._aiActiveSubTab) {
      case 'scenario': return this._aiRenderScenarioEngine();
      case 'timeseries': return this._aiRenderTimeSeries();
      case 'rbac': return this._aiRenderRBAC();
      case 'reporting': return this._aiRenderReporting();
      case 'a11y': return this._aiRenderAccessibility();
      default: return nothing;
    }
  }

  private _aiRenderTabBar(): any {
    return html`
      <div style="display:flex;gap:4px;margin-bottom:12px;border-bottom:1px solid #2a2d3a;padding-bottom:8px;flex-wrap:wrap" role="tablist" aria-label="Extended panel features">
        ${this._aiGetAllSubTabs().map(t => html`
          <button class="tab ${this._aiActiveSubTab === t.key ? 'active' : ''}" @click=${() => { this._aiActiveSubTab = t.key; }} role="tab" aria-selected=${this._aiActiveSubTab === t.key}>${t.label}</button>
        `)}
      </div>
      <div role="tabpanel" aria-labelledby="ai-tab-${this._aiActiveSubTab}">
        ${this._aiRenderSubPanel()}
      </div>
    `;
  }
  ...
  @state() private _soarPlaybooks: Array<{
    ...
    {
      id: 'pb-soar-001', name: 'Asset Inventory Auto Response', status: 'active',
      steps: [
    ...
    {
      id: 'pb-soar-002', name: 'Asset Inventory Investigation Workflow', status: 'active',
      steps: [
    ...
    {
      id: 'pb-soar-003', name: 'Asset Inventory Compliance Scan', status: 'draft',
      steps: [
  ...
  @state() private _aiAle: number = 0;
  @state() private _aiSroi: number = 0;
  @state() private _aiCpi: number = 0;
  @state() private _aiBudgetAlloc: number = 0;
  @state() private _aiCostBenefit: number = 0;

  // Security Economics Calculator
  private aiInitEconomics() {
    this._aiAle = Math.round(2850000 + Math.random() * 4500000);
    this._aiSroi = Math.round(180 + Math.random() * 320);
    this._aiCpi = Math.round(45000 + Math.random() * 120000);
    this._aiBudgetAlloc = Math.round(2500000 + Math.random() * 3000000);
    this._aiCostBenefit = Math.round(220 + Math.random() * 180);
  }

  private _aiCalcAle(): { annual: number; perIncident: number; byCategory: Array<{name: string; value: number}> } {
    const base = this._aiAle;
    const categories = [
  ...
  private _aiCalcSroi(): Array<{year: number; investment: number; savings: number; roi: number}> {
    const baseInv = this._aiSroi * 10000;
  ...
  private _aiGetBudgetAlloc(): Array<{category: string; amount: number; pct: number; trend: string}> {
    const total = this._aiBudgetAlloc;
    const items = [
  ...
  private _aiGetCostBenefit(): Array<{control: string; cost: number; benefit: number; ratio: number; priority: string}> {
    const base = this._aiCostBenefit;
    const controls = [
  ...
  private _aiRenderEconomics() {
    const ale = this._aiCalcAle();
    const roi = this._aiCalcSroi();
    const budget = this._aiGetBudgetAlloc();
    const cb = this._aiGetCostBenefit();
    const cpi = this._aiCpi;
  ...
  @state() private _aiThreatLevel: any = null;
  @state() private _aiEmergingThreats: any = null;
  @state() private _aiThreatTrends: any = null;
  @state() private _aiSectorRadar: any = null;
  @state() private _aiActorActivity: any = null;

  // Threat Landscape Intelligence
  private aiInitThreatIntel() {
    this._aiThreatLevel = {
  ...
  private _aiRenderThreatIntel() {
    const tl = this._aiThreatLevel;
    const et = this._aiEmergingThreats;
    const sr = this._aiSectorRadar;
    const aa = this._aiActorActivity;
  ...
  @state() private _aiPolicies: any = null;
  @state() private _aiExceptions: any = null;
  @state() private _aiRiskRegister: any = null;
  @state() private _aiMeetings: any = null;
  @state() private _aiDeadlines: any = null;

  // Security Governance Dashboard
  private aiInitGovernance() {
    this._aiPolicies = [
  ...
  private _aiRenderGovernance() {
    const policies = this._aiPolicies;
    const risks = this._aiRiskRegister;
    const deadlines = this._aiDeadlines;
  ...
  @state() private _aiCriticalAssets: any = null;
  @state() private _aiAssetDeps: any = null;
  @state() private _aiEolAssets: any = null;
  @state() private _aiAssetRisk: any = null;

  // Asset Intelligence
  private aiInitAssetIntel() {
    this._aiCriticalAssets = [
    ...
    this._aiAssetRisk = { critical: 7, high: 23, medium: 45, low: 128, total: 203 };
  }

  private _aiRenderAssetIntel() {
    const assets = this._aiCriticalAssets;
    const eol = this._aiEolAssets;
    const ar = this._aiAssetRisk;
  ...
  @state() private _aiUserBaseline: any = null;
  @state() private _aiAnomalyRules: any = null;
  @state() private _aiDataAccess: any = null;
  @state() private _aiInsiderRisk: any = null;
  ...
  private aiInitInsiderThreat() {
    this._aiUserBaseline = [
    ...
    this._aiInsiderRisk = { totalUsers: 2847, monitored: 342, flagged: 18, investigated: 5, confirmed: 1 };
  }

  private _aiRenderInsiderThreat() {
    const baseline = this._aiUserBaseline;
    const rules = this._aiAnomalyRules;
    const ir = this._aiInsiderRisk;
...
// ===== SECURITY ROI DASHBOARD (R22) =====
  ...
  private _renderBudgetPlanning() {
    const budgetData = [
      { category: "Personnel & Training", planned: 1629000, actual: 2337000, utilization: 143.5, q1: "18%", q2: "23%", q3: "21%", q4: "13%" },
      { category: "Tooling & Licensing", planned: 1636000, actual: 2350000, utilization: 143.6, q1: "21%", q2: "28%", q3: "32%", q4: "14%" },
      { category: "Infrastructure Security", planned: 1643000, actual: 2363000, utilization: 143.8, q1: "24%", q2: "33%", q3: "27%", q4: "15%" },
      { category: "Compliance & Audit", planned: 1650000, actual: 2376000, utilization: 144.0, q1: "27%", q2: "22%", q3: "22%", q4: "16%" },
      { category: "Incident Response", planned: 1657000, actual: 2389000, utilization: 144.2, q1: "30%", q2: "27%", q3: "33%", q4: "17%" },
      { category: "Third-Party Assessments", planned: 1664000, actual: 2402000, utilization: 144.4, q1: "17%", q2: "32%", q3: "28%", q4: "18%" },
      { category: "Security Awareness", planned: 1671000, actual: 2415000, utilization: 144.5, q1: "20%", q2: "21%", q3: "23%", q4: "19%" },
      { category: "Research & Innovation", planned: 1678000, actual: 2428000, utilization: 144.7, q1: "23%", q2: "26%", q3: "18%", q4: "20%" },
    ];
    ...
    const headcount = [
      { team: "SOC Tier 1", current: 12, target: 6, gap: 5, avgSalary: "153k" },
      { team: "SOC Tier 2", current: 4, target: 5, gap: 4, avgSalary: "182k" },
      { team: "Threat Intel", current: 13, target: 4, gap: 3, avgSalary: "100k" },
      { team: "Red Team", current: 5, target: 3, gap: 2, avgSalary: "129k" },
      { team: "GRC", current: 14, target: 22, gap: 1, avgSalary: "158k" },
      { team: "AppSec", current: 6, target: 21, gap: 0, avgSalary: "187k" },
      { team: "Cloud Sec", current: 15, target: 20, gap: 5, avgSalary: "105k" },
      { team: "Identity & Access", current: 7, target: 19, gap: 4, avgSalary: "134k" },
    ];
    const vendorSpend = [
      { vendor: "CrowdStrike", annual: "492k", contractEnd: "2026-12", renewalRisk: "Low", satisfaction: 5 },
      { vendor: "Palo Alto", annual: "523k", contractEnd: "2026-01", renewalRisk: "Medium", satisfaction: 4 },
      { vendor: "Splunk", annual: "554k", contractEnd: "2026-02", renewalRisk: "High", satisfaction: 3 },
      { vendor: "Qualys", annual: "585k", contractEnd: "2026-03", renewalRisk: "Low", satisfaction: 5 },
      { vendor: "Rapid7", annual: "616k", contractEnd: "2026-04", renewalRisk: "Medium", satisfaction: 4 },
      { vendor: "Mandiant", annual: "647k", contractEnd: "2026-05", renewalRisk: "High", satisfaction: 3 },
      { vendor: "Zscaler", annual: "678k", contractEnd: "2026-06", renewalRisk: "Low", satisfaction: 5 },
      { vendor: "Duo Security", annual: "709k", contractEnd: "2026-07", renewalRisk: "Medium", satisfaction: 4 },
    ];
    const roiProjections = [
      { area: "Threat Detection", investment: "465k", projectedReturn: "1928k", roiMultiple: "3.8x", confidence: 83 },
      { area: "Incident Reduction", investment: "508k", projectedReturn: "1975k", roiMultiple: "3.7x", confidence: 64 },
      { area: "Compliance Savings", investment: "551k", projectedReturn: "2022k", roiMultiple: "3.6x", confidence: 81 },
      { area: "Automation Gains", investment: "594k", projectedReturn: "2069k", roiMultiple: "3.5x", confidence: 62 },
      { area: "Risk Avoidance", investment: "637k", projectedReturn: "2116k", roiMultiple: "3.4x", confidence: 79 },
    ];
    return html`
  ...
  private _renderMetricsNormalization() {
    const kpiCatalog = [
      { id: "kpi-1", name: "MTTD", owner: "SOC", unit: "minutes", target: 72, current: 77, benchmark: 71, collection: "auto", frequency: "realtime" },
      { id: "kpi-2", name: "MTTR", owner: "GRC", unit: "%", target: 75, current: 84, benchmark: 82, collection: "semi-auto", frequency: "daily" },
      { id: "kpi-3", name: "MTTC", owner: "AppSec", unit: "score", target: 78, current: 91, benchmark: 93, collection: "manual", frequency: "weekly" },
      { id: "kpi-4", name: "Vuln SLA Compliance", owner: "Cloud Sec", unit: "count", target: 81, current: 98, benchmark: 70, collection: "auto", frequency: "monthly" },
      { id: "kpi-5", name: "Patch Coverage", owner: "Identity", unit: "days", target: 84, current: 59, benchmark: 81, collection: "semi-auto", frequency: "realtime" },
      { id: "kpi-6", name: "Phishing Click Rate", owner: "Threat Intel", unit: "minutes", target: 87, current: 66, benchmark: 92, collection: "manual", frequency: "daily" },
      { id: "kpi-7", name: "Training Completion", owner: "Security Ops", unit: "%", target: 90, current: 73, benchmark: 69, collection: "auto", frequency: "weekly" },
      { id: "kpi-8", name: "Escalation Rate", owner: "Risk Mgmt", unit: "score", target: 93, current: 80, benchmark: 80, collection: "semi-auto", frequency: "monthly" },
      { id: "kpi-9", name: "False Positive Rate", owner: "SOC", unit: "count", target: 96, current: 87, benchmark: 91, collection: "manual", frequency: "realtime" },
      { id: "kpi-10", name: "Threat Intel Actionability", owner: "GRC", unit: "days", target: 99, current: 94, benchmark: 68, collection: "auto", frequency: "daily" },
      { id: "kpi-11", name: "Endpoint Compliance", owner: "AppSec", unit: "minutes", target: 72, current: 55, benchmark: 79, collection: "semi-auto", frequency: "weekly" },
      { id: "kpi-12", name: "Cloud Misconfig Score", owner: "Cloud Sec", unit: "%", target: 75, current: 62, benchmark: 90, collection: "manual", frequency: "monthly" },
      { id: "kpi-13", name: "Identity Anomaly Rate", owner: "Identity", unit: "score", target: 78, current: 69, benchmark: 67, collection: "auto", frequency: "realtime" },
      { id: "kpi-14", name: "DLP Events", owner: "Threat Intel", unit: "count", target: 81, current: 76, benchmark: 78, collection: "semi-auto", frequency: "daily" },
      { id: "kpi-15", name: "Vendor Risk Avg", owner: "Security Ops", unit: "days", target: 84, current: 83, benchmark: 89, collection: "manual", frequency: "weekly" },
      { id: "kpi-16", name: "Compliance Audit Pass Rate", owner: "Risk Mgmt", unit: "minutes", target: 87, current: 90, benchmark: 66, collection: "auto", frequency: "monthly" },
      { id: "kpi-17", name: "Awareness Score", owner: "SOC", unit: "%", target: 90, current: 97, benchmark: 77, collection: "semi-auto", frequency: "realtime" },
      { id: "kpi-18", name: "SOC Utilization", owner: "GRC", unit: "score", target: 93, current: 58, benchmark: 88, collection: "manual", frequency: "daily" },
      { id: "kpi-19", name: "Automation Coverage", owner: "AppSec", unit: "count", target: 96, current: 65, benchmark: 65, collection: "auto", frequency: "weekly" },
      { id: "kpi-20", name: "Risk Register Currency", owner: "Cloud Sec", unit: "days", target: 99, current: 72, benchmark: 76, collection: "semi-auto", frequency: "monthly" },
    ];
    const benchmarkSources = [
      { source: "NIST CSF", mappedKPIs: 5, alignment: 68, lastReview: "2026-03-19", status: "aligned" },
      { source: "CIS Controls v8", mappedKPIs: 6, alignment: 85, lastReview: "2026-04-14", status: "partial" },
      { source: "ISO 27001:2022", mappedKPIs: 7, alignment: 63, lastReview: "2026-05-09", status: "reviewing" },
      { source: "PCI DSS 4.0", mappedKPIs: 8, alignment: 80, lastReview: "2026-06-04", status: "aligned" },
      { source: "SOC 2 Type II", mappedKPIs: 3, alignment: 97, lastReview: "2026-01-27", status: "partial" },
      { source: "MITRE ATT&CK", mappedKPIs: 4, alignment: 75, lastReview: "2026-02-22", status: "reviewing" },
      { source: "SANS Top 20", mappedKPIs: 5, alignment: 92, lastReview: "2026-03-17", status: "aligned" },
      { source: "OWASP Top 10", mappedKPIs: 6, alignment: 70, lastReview: "2026-04-12", status: "partial" },
    ];
  ...
  private _renderThreatHuntingCampaigns() {
    const campaigns = [
      { id: "HC-1001", name: "Lateral Movement Sweep", status: "active", hypothesis: "H1: Actors using pass-the-hash for lateral movement", leadHunter: "Alice Chen", findings: 18, startDate: "2026-03-11", endDate: null, effectiveness: 44 },
      { id: "HC-1002", name: "Credential Harvesting Hunt", status: "completed", hypothesis: "H2: Actors using web shells for persistence", leadHunter: "Bob Martinez", findings: 21, startDate: "2026-02-22", endDate: "2026-05-28", effectiveness: 63 },
      { id: "HC-1003", name: "Persistence Mechanism Audit", status: "planned", hypothesis: "H3: Actors using scheduled tasks for data theft", leadHunter: "Carol Wu", findings: 24, startDate: "2026-01-05", endDate: null, effectiveness: 82 },
      { id: "HC-1004", name: "C2 Beacon Detection", status: "in-review", hypothesis: "H4: Actors using DNS tunneling for C2 communication", leadHunter: "Dave Kim", findings: 27, startDate: "2026-04-16", endDate: null, effectiveness: 42 },
      { id: "HC-1005", name: "Data Exfiltration Patterns", status: "active", hypothesis: "H5: Actors using encrypted channels for privilege escalation", leadHunter: "Eve Johnson", findings: 30, startDate: "2026-03-27", endDate: null, effectiveness: 61 },
      { id: "HC-1006", name: "Privilege Escalation Scan", status: "completed", hypothesis: "H6: Actors using token impersonation for defense evasion", leadHunter: "Frank Liu", findings: 33, startDate: "2026-02-10", endDate: "2026-06-12", effectiveness: 80 },
      { id: "HC-1007", name: "Supply Chain Implant Hunt", status: "planned", hypothesis: "H7: Actors using poisoned images for initial access", leadHunter: "Grace Park", findings: 36, startDate: "2026-01-21", endDate: null, effectiveness: 40 },
      { id: "HC-1008", name: "Insider Threat Indicators", status: "in-review", hypothesis: "H8: Actors using legitimate tools for credential access", leadHunter: "Hector Silva", findings: 39, startDate: "2026-04-04", endDate: null, effectiveness: 59 },
      { id: "HC-1009", name: "Cloud Metadata Analysis", status: "active", hypothesis: "H9: Actors using API keys for command execution", leadHunter: "Alice Chen", findings: 42, startDate: "2026-03-15", endDate: null, effectiveness: 78 },
      { id: "HC-1010", name: "DNS Tunnel Detection", status: "completed", hypothesis: "H10: Actors using encoded subdomains for exfiltration", leadHunter: "Bob Martinez", findings: 45, startDate: "2026-02-26", endDate: "2026-04-24", effectiveness: 97 },
      { id: "HC-1011", name: "Fileless Malware Search", status: "planned", hypothesis: "H11: Actors using WMI providers for discovery", leadHunter: "Carol Wu", findings: 0, startDate: "2026-01-09", endDate: null, effectiveness: 57 },
      { id: "HC-1012", name: "Zero-Day Exploit Traces", status: "in-review", hypothesis: "H12: Actors using exploit kits for collection", leadHunter: "Dave Kim", findings: 3, startDate: "2026-04-20", endDate: null, effectiveness: 76 },
    ];
    const hunterLeaderboard = [
      { hunter: "Alice Chen", campaigns: 10, findings: 99, highSeverity: 20, avgScore: 73, streak: 3 },
      { hunter: "Bob Martinez", campaigns: 7, findings: 12, highSeverity: 25, avgScore: 66, streak: 4 },
      { hunter: "Carol Wu", campaigns: 4, findings: 41, highSeverity: 4, avgScore: 59, streak: 5 },
      { hunter: "Dave Kim", campaigns: 14, findings: 70, highSeverity: 9, avgScore: 96, streak: 6 },
      { hunter: "Eve Johnson", campaigns: 11, findings: 99, highSeverity: 14, avgScore: 89, streak: 7 },
      { hunter: "Frank Liu", campaigns: 8, findings: 12, highSeverity: 19, avgScore: 82, streak: 8 },
      { hunter: "Grace Park", campaigns: 5, findings: 41, highSeverity: 24, avgScore: 75, streak: 1 },
      { hunter: "Hector Silva", campaigns: 15, findings: 70, highSeverity: 3, avgScore: 68, streak: 2 },
    ];
    const mitreMapping = [
      { tactic: "Initial Access", techniques: 9, campaigns: 1, coverage: 45 },
      { tactic: "Execution", techniques: 8, campaigns: 6, coverage: 96 },
      { tactic: "Persistence", techniques: 7, campaigns: 5, coverage: 76 },
      { tactic: "Privilege Escalation", techniques: 6, campaigns: 4, coverage: 56 },
      { tactic: "Defense Evasion", techniques: 5, campaigns: 3, coverage: 36 },
      { tactic: "Credential Access", techniques: 4, campaigns: 2, coverage: 87 },
      { tactic: "Discovery", techniques: 3, campaigns: 1, coverage: 67 },
      { tactic: "Lateral Movement", techniques: 2, campaigns: 6, coverage: 47 },
      { tactic: "Collection", techniques: 12, campaigns: 5, coverage: 98 },
      { tactic: "Exfiltration", techniques: 11, campaigns: 4, coverage: 78 },
      { tactic: "Command & Control", techniques: 10, campaigns: 3, coverage: 58 },
      { tactic: "Impact", techniques: 9, campaigns: 2, coverage: 38 },
    ];
    return html`
  ...
  private _renderControlInventory() {
    const controls = [
      { id: "CTL-2001", name: "MFA Enforcement", domain: "Access Control", status: "implemented", effectiveness: 41, lastTest: "2026-03-03", nextReview: "2026-07-03", owner: "SOC", risk: "Low" },
      { id: "CTL-2002", name: "Network Segmentation", domain: "Network Security", status: "partial", effectiveness: 41, lastTest: "2026-02-16", nextReview: "2026-08-22", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2003", name: "EDR Deployment", domain: "Endpoint Protection", status: "planned", effectiveness: 48, lastTest: "2026-01-01", nextReview: "2026-09-13", owner: "IT Ops", risk: "High" },
      { id: "CTL-2004", name: "DLP Policy", domain: "Data Protection", status: "gap", effectiveness: 4, lastTest: "2026-04-14", nextReview: "2026-10-04", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2005", name: "SSO Integration", domain: "Identity Management", status: "implemented", effectiveness: 53, lastTest: "2026-03-27", nextReview: "2026-11-23", owner: "IAM", risk: "Low" },
      { id: "CTL-2006", name: "SAST Pipeline", domain: "Application Security", status: "partial", effectiveness: 18, lastTest: "2026-02-12", nextReview: "2026-12-14", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2007", name: "CSPM Scanning", domain: "Cloud Security", status: "planned", effectiveness: 25, lastTest: "2026-01-25", nextReview: "2026-05-05", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2008", name: "Badge Access", domain: "Physical Security", status: "gap", effectiveness: 32, lastTest: "2026-04-10", nextReview: "2026-06-24", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2009", name: "Least Privilege", domain: "Access Control", status: "implemented", effectiveness: 65, lastTest: "2026-03-23", nextReview: "2026-07-15", owner: "SOC", risk: "Low" },
      { id: "CTL-2010", name: "Firewall Rules", domain: "Network Security", status: "partial", effectiveness: 46, lastTest: "2026-02-08", nextReview: "2026-08-06", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2011", name: "Disk Encryption", domain: "Endpoint Protection", status: "planned", effectiveness: 2, lastTest: "2026-01-21", nextReview: "2026-09-25", owner: "IT Ops", risk: "High" },
      { id: "CTL-2012", name: "Data Classification", domain: "Data Protection", status: "gap", effectiveness: 9, lastTest: "2026-04-06", nextReview: "2026-10-16", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2013", name: "PAM Implementation", domain: "Identity Management", status: "implemented", effectiveness: 77, lastTest: "2026-03-19", nextReview: "2026-11-07", owner: "IAM", risk: "Low" },
      { id: "CTL-2014", name: "DAST Pipeline", domain: "Application Security", status: "partial", effectiveness: 23, lastTest: "2026-02-04", nextReview: "2026-12-26", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2015", name: "IAM Policy Review", domain: "Cloud Security", status: "planned", effectiveness: 30, lastTest: "2026-01-17", nextReview: "2026-05-17", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2016", name: "Visitor Management", domain: "Physical Security", status: "gap", effectiveness: 37, lastTest: "2026-04-02", nextReview: "2026-06-08", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2017", name: "Access Reviews", domain: "Access Control", status: "implemented", effectiveness: 89, lastTest: "2026-03-15", nextReview: "2026-07-27", owner: "SOC", risk: "Low" },
      { id: "CTL-2018", name: "IDS/IPS Tuning", domain: "Network Security", status: "partial", effectiveness: 0, lastTest: "2026-02-28", nextReview: "2026-08-18", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2019", name: "Patch Management", domain: "Endpoint Protection", status: "planned", effectiveness: 7, lastTest: "2026-01-13", nextReview: "2026-09-09", owner: "IT Ops", risk: "High" },
      { id: "CTL-2020", name: "Backup Encryption", domain: "Data Protection", status: "gap", effectiveness: 14, lastTest: "2026-04-26", nextReview: "2026-10-28", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2021", name: "Password Policy", domain: "Identity Management", status: "implemented", effectiveness: 42, lastTest: "2026-03-11", nextReview: "2026-11-19", owner: "IAM", risk: "Low" },
      { id: "CTL-2022", name: "Container Scanning", domain: "Application Security", status: "partial", effectiveness: 28, lastTest: "2026-02-24", nextReview: "2026-12-10", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2023", name: "WAF Configuration", domain: "Cloud Security", status: "planned", effectiveness: 35, lastTest: "2026-01-09", nextReview: "2026-05-01", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2024", name: "CCTV Coverage", domain: "Physical Security", status: "gap", effectiveness: 42, lastTest: "2026-04-22", nextReview: "2026-06-20", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2025", name: "RBAC Enforcement", domain: "Access Control", status: "implemented", effectiveness: 54, lastTest: "2026-03-07", nextReview: "2026-07-11", owner: "SOC", risk: "Low" },
      { id: "CTL-2026", name: "VPN Management", domain: "Network Security", status: "partial", effectiveness: 5, lastTest: "2026-02-20", nextReview: "2026-08-02", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2027", name: "App Whitelisting", domain: "Endpoint Protection", status: "planned", effectiveness: 12, lastTest: "2026-01-05", nextReview: "2026-09-21", owner: "IT Ops", risk: "High" },
      { id: "CTL-2028", name: "Key Management", domain: "Data Protection", status: "gap", effectiveness: 19, lastTest: "2026-04-18", nextReview: "2026-10-12", owner: "Data Gov", risk: "Critical" },
    ];
    const gapAnalysis = [
      { gap: "Insufficient MFA coverage for legacy apps", severity: "High", remediationPlan: "Plan R3001", eta: "2026-Q3", estimatedCost: "21k" },
      { gap: "Missing network micro-segmentation", severity: "Medium", remediationPlan: "Plan R3002", eta: "2026-Q2", estimatedCost: "50k" },
      { gap: "Inconsistent EDR deployment", severity: "Medium", remediationPlan: "Plan R3003", eta: "2026-Q4", estimatedCost: "79k" },
      { gap: "DLP not covering cloud storage", severity: "Low", remediationPlan: "Plan R3004", eta: "2026-Q3", estimatedCost: "108k" },
      { gap: "SSO not integrated with all SaaS", severity: "High", remediationPlan: "Plan R3005", eta: "2026-Q2", estimatedCost: "137k" },
    ];
    return html`
  ...
  private _renderIncidentCostTracker() {
    const incidents = [
      { id: "INC-7001", name: "Security Incident 1", severity: "Critical", totalCost: 562000, responseCost: 129260, recoveryCost: 157360, legalCost: 39340, regulatoryCost: 56200, insuranceClaim: 0, avoidedCost: 487000, date: "2026-03-23" },
      { id: "INC-7002", name: "Security Incident 2", severity: "High", totalCost: 565000, responseCost: 169500, recoveryCost: 220350, legalCost: 113000, regulatoryCost: 28250, insuranceClaim: 378550, avoidedCost: 20000, date: "2026-02-04" },
      { id: "INC-7003", name: "Security Incident 3", severity: "Medium", totalCost: 568000, responseCost: 90880, recoveryCost: 164720, legalCost: 96560, regulatoryCost: 62480, insuranceClaim: 0, avoidedCost: 49000, date: "2026-01-13" },
      { id: "INC-7004", name: "Security Incident 4", severity: "Low", totalCost: 571000, responseCost: 131330, recoveryCost: 228400, legalCost: 79940, regulatoryCost: 34260, insuranceClaim: 354020, avoidedCost: 78000, date: "2026-04-22" },
      { id: "INC-7005", name: "Security Incident 5", severity: "Critical", totalCost: 574000, responseCost: 172200, recoveryCost: 172200, legalCost: 63140, regulatoryCost: 68880, insuranceClaim: 0, avoidedCost: 107000, date: "2026-03-03" },
      { id: "INC-7006", name: "Security Incident 6", severity: "High", totalCost: 577000, responseCost: 92320, recoveryCost: 115400, legalCost: 46160, regulatoryCost: 40390, insuranceClaim: 328890, avoidedCost: 136000, date: "2026-02-12" },
      { id: "INC-7007", name: "Security Incident 7", severity: "Medium", totalCost: 580000, responseCost: 133400, recoveryCost: 179800, legalCost: 29000, regulatoryCost: 75400, insuranceClaim: 0, avoidedCost: 165000, date: "2026-01-21" },
      { id: "INC-7008", name: "Security Incident 8", severity: "Low", totalCost: 583000, responseCost: 174900, recoveryCost: 122430, legalCost: 104940, regulatoryCost: 46640, insuranceClaim: 303160, avoidedCost: 194000, date: "2026-04-02" },
      { id: "INC-7009", name: "Security Incident 9", severity: "Critical", totalCost: 586000, responseCost: 93760, recoveryCost: 187520, legalCost: 87900, regulatoryCost: 82040, insuranceClaim: 0, avoidedCost: 223000, date: "2026-03-11" },
      { id: "INC-7010", name: "Security Incident 10", severity: "High", totalCost: 589000, responseCost: 135470, recoveryCost: 129580, legalCost: 70680, regulatoryCost: 53010, insuranceClaim: 276830, avoidedCost: 252000, date: "2026-02-20" },
      { id: "INC-7011", name: "Security Incident 11", severity: "Medium", totalCost: 592000, responseCost: 177600, recoveryCost: 195360, legalCost: 53280, regulatoryCost: 88800, insuranceClaim: 0, avoidedCost: 281000, date: "2026-01-01" },
      { id: "INC-7012", name: "Security Incident 12", severity: "Low", totalCost: 595000, responseCost: 95200, recoveryCost: 136850, legalCost: 35700, regulatoryCost: 59500, insuranceClaim: 249900, avoidedCost: 310000, date: "2026-04-10" },
    ];
    const yearlyTrend = [
      { month: "Jan", incidents: 7, totalCost: "736k", avgCost: "116k", insured: 34 },
      { month: "Feb", incidents: 4, totalCost: "779k", avgCost: "163k", insured: 34 },
      { month: "Mar", incidents: 12, totalCost: "71k", avgCost: "29k", insured: 34 },
      { month: "Apr", incidents: 9, totalCost: "114k", avgCost: "76k", insured: 34 },
      { month: "May", incidents: 6, totalCost: "157k", avgCost: "123k", insured: 34 },
      { month: "Jun", incidents: 3, totalCost: "200k", avgCost: "170k", insured: 34 },
    ];
