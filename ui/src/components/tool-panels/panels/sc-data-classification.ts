/**
 * sc-data-classification - Data Classification
...
@customElement('sc-data-classification')
export class ScDataClassification extends LitElement {
  static styles = css`
...
@state() private _tablePage = 1;
  ...
  @state() private _comments: CommentEntry[] = [
    { id: 'c1', author: 'soc-tier1', timestamp: '2026-04-23 04:00', text: 'Initial assessment started for Data Classification finding #1' },
  ...
  private _items: PanelItem[] = [
      {
            ...
            "category": "Security",
            "source": "SIEM",
            "description": "Fields: Name, SSN, DOB, Address | Records: 2.3M | Encryption: AES-256 | Access: Named individuals only",
      ...
      {
            "id": "data-classification-2",
            "title": "Employee HR Records",
            "severity": "high",
            "status": "in-progress",
            "category": "Network",
            "source": "EDR",
            "description": "Fields: Name, Salary, Performance | Records: 5,200 | Encryption: Yes | Access: HR + Manager of record",
      ...
      {
            "id": "data-classification-3",
            "title": "Product Source Code",
            "severity": "medium",
            "status": "resolved",
            "category": "Access",
            "source": "Scanner",
            "description": "Repositories: 47 | Languages: Go, TypeScript, Python | Access: Engineering team | DLP: Git hooks enabled",
      ...
      {
            "id": "data-classification-4",
            "title": "Marketing Collateral",
            "severity": "low",
            "status": "open",
            "category": "Compliance",
            "source": "Audit",
            "description": "Assets: Images, copy, templates | Storage: Cloud CMS | Access: Marketing + Agencies | Classification: Internal",
      ...
      {
            "id": "data-classification-5",
            "title": "Public Documentation",
            "severity": "low",
            "status": "in-progress",
            "category": "Operations",
            "source": "Manual",
            "description": "API docs, help center, blog | Storage: CDN | Access: Unrestricted | Review: Quarterly | License: CC-BY-4.0",
      ...
      {
            "id": "data-classification-6",
            "title": "Financial Reports (Pre-release)",
            "severity": "critical",
            "status": "resolved",
            "category": "Security",
            "source": "SIEM",
            "description": "Quarterly results, projections | Access: C-suite + Finance | Encryption: Yes | Retention: 7 years",
      ...
      {
            "id": "data-classification-7",
            "title": "Data Classification Finding #7",
            "severity": "low",
            "status": "open",
            "category": "Network",
            "source": "EDR",
            "description": "Automated data classification assessment finding detected during routine scan of infrastructure component. Review and remediation recommended.",
      ...
      {
            "id": "data-classification-8",
            "title": "Data Classification Finding #8",
            "severity": "medium",
            "status": "open",
            "category": "Access",
            "source": "Scanner",
      ...
      {
            "id": "data-classification-9",
            "title": "Data Classification Finding #9",
            "severity": "high",
            "status": "open",
            "category": "Compliance",
            "source": "Audit",
      ...
      {
            "id": "data-classification-10",
            "title": "Data Classification Finding #10",
            "severity": "low",
            "status": "open",
            "category": "Operations",
            "source": "Manual",
  ...
  private _history: HistoryEntry[] = [
    { timestamp: '2026-04-23 04:15', action: 'Auto-correlated', user: 'system', details: 'Grouped related findings from Data Classification analysis' },
    { timestamp: '2026-04-23 03:00', action: 'Created', user: 'scanner', details: 'New Data Classification finding detected by automated assessment' },
    ...
    { timestamp: '2026-04-22 22:00', action: 'Resolved', user: 'security-eng', details: 'Remediation applied and verified for Data Classification finding' },
    { timestamp: '2026-04-22 18:00', action: 'Created', user: 'audit', details: 'Compliance audit identified Data Classification gap requiring remediation' },
    ...
    { timestamp: '2026-04-21 16:00', action: 'Resolved', user: 'soc-tier1', details: 'False positive confirmed - benign activity flagged by Data Classification scan' },
    { timestamp: '2026-04-21 12:00', action: 'Exported', user: 'compliance', details: 'Exported Data Classification findings for Q1 compliance report' },
  ];
...
private _workflowTasks: WorkflowTask[] = [
    { id: 'wt-1', title: 'Review Data Classification finding #1', status: 'active', assignee: 'soc-tier1', blockedBy: [], slaDeadline: '2026-04-23T12:00:00Z', priority: 'p1', createdAt: '2026-04-23T00:00:00Z', completedAt: null },
    ...
    { id: 'wt-3', title: 'Update Data Classification detection rules', status: 'blocked', assignee: 'soc-tier2', blockedBy: ['wt-2'], slaDeadline: '2026-04-24T00:00:00Z', priority: 'p2', createdAt: '2026-04-23T03:00:00Z', completedAt: null },
    ...
    { id: 'wt-8', title: 'Archive resolved Data Classification findings', status: 'failed', assignee: 'soc-tier1', blockedBy: [], slaDeadline: '2026-04-23T08:00:00Z', priority: 'p4', createdAt: '2026-04-22T22:00:00Z', completedAt: null },
  ];

private _executionHistory: ExecutionRecord[] = [
    {
      id: 'exec-1', name: 'Data Classification Full Assessment Run', startedAt: '2026-04-22T10:00:00Z', completedAt: '2026-04-22T10:12:00Z', status: 'success',
      steps: [
    ...
    {
      id: 'exec-2', name: 'Data Classification Delta Scan', startedAt: '2026-04-23T02:00:00Z', completedAt: '2026-04-23T02:05:00Z', status: 'failed',
      steps: [
  ...
  private _runExecution() {
    ...
    const exec: ExecutionRecord = {
      id: 'exec-' + Date.now(), name: 'Data Classification Assessment ' + new Date().toISOString().slice(0, 10), startedAt: new Date().toISOString(), completedAt: null, status: 'running', steps,
    };
  ...
  private _renderExecutionPanel(): unknown {
    ...
    return html`
      <div class="form-section">
        ...
        ` : html`<div class="empty-state">Click "Run Assessment" to start the Data Classification analysis pipeline</div>`}
      </div>
      <div class="form-section">
        ...
        <div class="settings-card">
          ...
          <div style="display:flex;gap:8px;margin-top:4px;">
            <button class="btn primary" @click=${() => {
              ...
              const a = document.createElement('a'); a.href = url; a.download = 'data-classification-config.json'; a.click();
    ...
    return html`
      <div style="margin-top:12px;">
        ...
        <div style="display:flex;gap:6px;margin-top:8px;">
          <input class="search-box" type="text" placeholder="Add a comment..." style="min-width:auto;flex:1;" id="data-classification-comment-input" />
          <button class="btn primary" @click=${() => {
            const input = this.shadowRoot?.querySelector('#data-classification-comment-input') as HTMLInputElement;
  ...
  private _exportJSON() {
    ...
    const url = URL.createObjectURL(blob);
    const a = document.createElement('a'); a.href = url; a.download = 'sc-data-classification-data.json'; a.click();
    URL.revokeObjectURL(url);
  }
  ...
  private _exportCSV() {
    ...
    const url = URL.createObjectURL(blob);
    const a = document.createElement('a'); a.href = url; a.download = 'sc-data-classification-data.csv'; a.click();
    URL.revokeObjectURL(url);
  }


  // --- Domain Rules Engine ---
  @state() private _dcRules: { id: string; name: string; category: string; severity: Severity; enabled: boolean; lastEval: string; passRate: number }[] = [];
  private _initDcRules() {
    const rules = [
  ...
  private _evaluateDcRules(): { passed: number; failed: number; skipped: number; total: number } {
    let passed = 0, failed = 0, skipped = 0;
    this._dcRules.forEach(r => { if (!r.enabled) { skipped++; } else if (r.passRate >= 80) { passed++; } else { failed++; } });
    return { passed, failed, skipped, total: this._dcRules.length };
  }

  // --- CVSS Scoring ---
  @state() private _dccvssData: { itemId: string; vector: string; base: number; temporal: number; environmental: number; overall: number }[] = [];
  private _initDcCvss() {
    ...
    this._dccvssData = vectors.map((v, i) => {
  ...
  // --- Anomaly Detection ---
  @state() private _dcanomalies: { id: string; type: string; severity: Severity; description: string; detected: string; confidence: number; affected: string[] }[] = [];
  private _runDcAnomalyDetection() {
    const types = [
    ...
    this._dcanomalies = types.map((a, i) => ({
  ...
  // --- Trend Prediction ---
  @state() private _dcpredictions: { horizon: string; metric: string; current: number; predicted: number; direction: 'up' | 'down' | 'stable'; confidence: number }[] = [];
  private _generateDcPredictions() {
    this._dcpredictions = [
  ...
  // --- Approval Workflow ---
  @state() private _dcApprovals: { id: string; title: string; requester: string; status: 'pending' | 'approved' | 'rejected' | 'expired'; createdAt: string; priority: Priority; type: string }[] = [];
  private _initDcApprovals() {
    this._dcApprovals = [
  ...
  private _approveDcItem(id: string) { const item = this._dcApprovals.find(a => a.id === id); if (item) item.status = 'approved'; this.requestUpdate(); }
  private _rejectDcItem(id: string) { const item = this._dcApprovals.find(a => a.id === id); if (item) item.status = 'rejected'; this.requestUpdate(); }

  // --- Activity Feed ---
  @state() private _dcActivity: { id: string; action: string; user: string; target: string; timestamp: string }[] = [];
  private _initDcActivity() {
    const actions = [
    ...
    this._dcActivity = actions.map((a, i) => ({ id: 'ACT-' + String(i + 1).padStart(3, '0'), ...a, timestamp: new Date(Date.now() - i * 3600000).toISOString() }));
  }

  // --- Notification System ---
  @state() private _dcNotifications: { id: string; message: string; type: 'info' | 'warning' | 'error' | 'success'; read: boolean; timestamp: string }[] = [];
  private _initDcNotifications() {
    this._dcNotifications = [
  ...
  private _markDcNotifRead(id: string) { const n = this._dcNotifications.find(x => x.id === id); if (n) n.read = true; this.requestUpdate(); }

  // --- Panel Configuration ---
  @state() private _dcConfig: { layout: 'compact' | 'default' | 'expanded'; theme: 'dark' | 'midnight' | 'slate'; showAnomalies: boolean; showPredictions: boolean; autoRefresh: boolean; refreshInterval: number } = {
    layout: 'default', theme: 'dark', showAnomalies: true, showPredictions: true, autoRefresh: true, refreshInterval: 60,
  };
  private _dcPresets: { name: string; config: typeof this._dcConfig }[] = [
  ...
  private _applyDcPreset(preset: typeof this._dcPresets[0]) { this._dcConfig = { ...preset.config }; this.requestUpdate(); }

  private _renderDcTreemapSVG(): string {
    const categories = [
  ...
  private _renderDcSankeySVG(): string {
  ...
  // --- Render: Rules Engine ---
  private _renderDcRules(): any {
    const ev = this._evaluateDcRules();
    return html`
  ...
  private _renderDcAnomalies(): any {
  ...
  // --- Render: Approvals ---
  private _renderDcApprovals(): any {
          ...
          $${this._dcApprovals.map(a => html`
            <div style="padding:6px 8px;background:#1f2937;border-radius:4px">
              ...
              $${a.status === 'pending' ? html`
                <div style="display:flex;gap:4px;margin-top:4px">
                  <button class="btn success" style="padding:2px 8px;font-size:9px" @click=$${() => this._approveDcItem(a.id)}>Approve</button>
                  <button class="btn error" style="padding:2px 8px;font-size:9px" @click=$${() => this._rejectDcItem(a.id)}>Reject</button>
                </div>` : nothing}
            </div>`)}
        </div>
      </div>`;
  ...
  private _renderDcNotifications(): any {
    const tc = (t: string) => t === 'error' ? '#ef4444' : t === 'warning' ? '#eab308' : t === 'success' ? '#22c55e' : '#3b82f6';
    const unread = this._dcNotifications.filter(n => !n.read).length;
    return html`
      <div style="background:#1a1d27;border-radius:8px;padding:12px;margin-top:12px">
        ...
        <div style="display:flex;flex-direction:column;gap:4px;max-height:120px;overflow-y:auto">
          $${this._dcNotifications.map(n => html`
            <div style="display:flex;align-items:center;gap:8px;padding:4px 8px;background:$${n.read ? '#1f2937' : '#252a36'};border-radius:4px;font-size:10px;opacity:$${n.read ? '0.6' : '1'};cursor:pointer" @click=$${() => this._markDcNotifRead(n.id)}>
      ...
      <div style="background:#1a1d27;border-radius:8px;padding:12px;margin-top:12px">
        ...
        <div style="display:flex;flex-direction:column;gap:6px;font-size:10px">
          <div style="display:flex;align-items:center;gap:8px">
            ...
            <select class="form-input" style="flex:1" @change=$${(e: Event) => { this._dcConfig.layout = (e.target as HTMLSelectElement).value as any; this.requestUpdate(); }}>
              <option value="compact" ?selected=$${this._dcConfig.layout === 'compact'}>Compact</option>
              <option value="default" ?selected=$${this._dcConfig.layout === 'default'}>Default</option>
              <option value="expanded" ?selected=$${this._dcConfig.layout === 'expanded'}>Expanded</option>
            </select>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Theme</span>
            <select class="form-input" style="flex:1" @change=$${(e: Event) => { this._dcConfig.theme = (e.target as HTMLSelectElement).value as any; this.requestUpdate(); }}>
              <option value="dark" ?selected=$${this._dcConfig.theme === 'dark'}>Dark</option>
              <option value="midnight" ?selected=$${this._dcConfig.theme === 'midnight'}>Midnight</option>
              <option value="slate" ?selected=$${this._dcConfig.theme === 'slate'}>Slate</option>
            </select>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Auto Refresh</span>
            <input type="checkbox" ?checked=$${this._dcConfig.autoRefresh} @change=$${() => { this._dcConfig.autoRefresh = !this._dcConfig.autoRefresh; this.requestUpdate(); }}/>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Show Anomalies</span>
            <input type="checkbox" ?checked=$${this._dcConfig.showAnomalies} @change=$${() => { this._dcConfig.showAnomalies = !this._dcConfig.showAnomalies; this.requestUpdate(); }}/>
          </div>
          <div style="display:flex;align-items:center;gap:8px">
            <span style="width:100px">Show Predictions</span>
            <input type="checkbox" ?checked=$${this._dcConfig.showPredictions} @change=$${() => { this._dcConfig.showPredictions = !this._dcConfig.showPredictions; this.requestUpdate(); }}/>
          </div>
          <div style="margin-top:6px;font-weight:600">Presets</div>
          <div style="display:flex;gap:4px">
            $${this._dcPresets.map(ps => html`<button class="btn" style="padding:2px 8px;font-size:9px" @click=$${() => this._applyDcPreset(ps)}>$${ps.name}</button>`)}
          </div>
        </div>
      </div>`;
  }
  ...
  @state() private _dataClassifiCorrRules: Array<{id:string;name:string;sources:string[];logic:string;severity:string;active:boolean;lastTriggered:string}> = [
  ...
  @state() private _dataClassifiEventTimeline: Array<{timestamp:string;source:string;eventType:string;details:string;correlated:boolean}> = [
  ...
  @state() private _dataClassifiFalsePosMetrics: {totalEvents:number;correlatedEvents:number;falsePositives:number;fpRate:number;topFpRules:string[]} = {
  ...
  @state() private _dataClassifiEventPatterns: Array<{id:string;pattern:string;frequency:number;firstSeen:string;lastSeen:string;status:string}> = [
  ...
  private _renderDataclassifiEventCorr(): TemplateResult {
    const rules = this._dataClassifiCorrRules;
    const timeline = this._dataClassifiEventTimeline;
    const fpMetrics = this._dataClassifiFalsePosMetrics;
    return html`
  ...
  @state() private _dataClassifiCourses: Array<{id:string;title:string;category:string;duration:number;enrolled:number;completed:number;difficulty:string;rating:number}> = [
  ...
  @state() private _dataClassifiLearningPaths: Array<{id:string;name:string;courseIds:string[];progress:number;enrolled:number}> = [
  ...
  @state() private _dataClassifiDeptCompliance: Array<{dept:string;trainedPct:number;targetPct:number;avgScore:number;certCount:number}> = [
  ...
  @state() private _dataClassifiSkillsGaps: Array<{skill:string;current:number;required:number;gap:number;priority:string}> = [
  ...
  private _renderDataclassifiTraining(): TemplateResult {
    const courses = this._dataClassifiCourses;
    const deptComp = this._dataClassifiDeptCompliance;
    return html`
  ...
  @state() private _dataClassifiZones: Array<{id:string;name:string;trustLevel:number;subnet:string;devices:number;policy:string;lastAudit:string}> = [
  ...
  @state() private _dataClassifiSegRules: Array<{id:string;source:string;dest:string;action:string;protocol:string;port:string;status:string;hits:number}> = [
  ...
  @state() private _dataClassifiCrossZoneTraffic: Array<{source:string;dest:string;bytes:number;sessions:number;violations:number}> = [
  ...
  @state() private _dataClassifiMicroSegGaps: Array<{id:string;zone:string;gapType:string;severity:string;recommendation:string}> = [
  ...
  private _renderDataclassifiNetworkSeg(): TemplateResult {
    const zones = this._dataClassifiZones;
    const gaps = this._dataClassifiMicroSegGaps;
    return html`
  ...
  @state() private _dataClassifiContainerScans: Array<{image:string;registry:string;critical:number;high:number;medium:number;scanDate:string;status:string}> = [
  ...
  @state() private _dataClassifiK8sPods: Array<{namespace:string;pod:string;securityContext:string;hostIPC:boolean;hostPID:boolean;privileged:boolean;riskLevel:string}> = [
  ...
  @state() private _dataClassifiServerlessRisk: Array<{function:string;runtime:string;timeout:number;iamPerms:string;externalCalls:number;riskScore:number}> = [
  ...
  @state() private _dataClassifiRuntimeAlerts: Array<{id:string;workload:string;alertType:string;severity:string;description:string;timestamp:string}> = [
  ...
  private _renderDataclassifiCloudWl(): TemplateResult {
    const containers = this._dataClassifiContainerScans;
    const pods = this._dataClassifiK8sPods;
    const alerts = this._dataClassifiRuntimeAlerts;
    return html`
  ...
  @state() private _dataClassifiThreatIntel: Array<{source:string;indicator:string;type:string;confidence:number;severity:string;observed:string;description:string}> = [
  ...
  @state() private _dataClassifiIntelMetrics: {totalIndicators:number;criticalCount:number;highCount:number;mediumCount:number;staleIndicators:number;feedUptime:number} = {
    totalIndicators: 45230, criticalCount: 234, highCount: 1892, mediumCount: 8765, staleIndicators: 567, feedUptime: 99.7
  };
  @state() private _dataClassifiIntelTrending: Array<{category:string;thisWeek:number;lastWeek:number;change:number}> = [
  ...
  private _renderDataclassifiThreatIntel(): TemplateResult {
    const intel = this._dataClassifiThreatIntel;
    const trending = this._dataClassifiIntelTrending;
    const metrics = this._dataClassifiIntelMetrics;
    return html`
  ...
  @state() private _complianceCalendarEvents: Array<{id: string; title: string; deadline: string; category: string; status: string; assignee: string; notes: string}> = [
    {id: 'cc-data-classification-001', title: 'SOX Section 404 Compliance Review', deadline: '2026-06-30', category: 'Regulatory', status: 'In Progress', assignee: 'Compliance Team', notes: 'Annual internal control assessment for financial reporting'},
    {id: 'cc-data-classification-002', title: 'GDPR Data Protection Impact Assessment', deadline: '2026-05-15', category: 'Privacy', status: 'Pending', assignee: 'DPO Office', notes: 'Quarterly DPIA for high-risk processing activities'},
    {id: 'cc-data-classification-003', title: 'ISO 27001 Surveillance Audit', deadline: '2026-07-20', category: 'Certification', status: 'Scheduled', assignee: 'QA Lead', notes: 'Stage 2 surveillance audit for ISMS certification renewal'},
    {id: 'cc-data-classification-004', title: 'PCI DSS v4.0 Gap Analysis', deadline: '2026-05-30', category: 'Payment', status: 'Not Started', assignee: 'Security Architect', notes: 'Assess current state against PCI DSS v4.0 requirements'},
    {id: 'cc-data-classification-005', title: 'NIST CSF Self-Assessment', deadline: '2026-08-15', category: 'Framework', status: 'Pending', assignee: 'CISO', notes: 'Biannual self-assessment against NIST Cybersecurity Framework'},
    {id: 'cc-data-classification-006', title: 'HIPAA Security Rule Audit', deadline: '2026-06-15', category: 'Healthcare', status: 'In Progress', assignee: 'Compliance Analyst', notes: 'Annual audit of administrative, physical, and technical safeguards'},
    {id: 'cc-data-classification-007', title: 'SOC 2 Type II Report Renewal', deadline: '2026-09-30', category: 'Audit', status: 'Scheduled', assignee: 'External Auditor', notes: 'Engage auditor for SOC 2 Type II examination period'},
    {id: 'cc-data-classification-008', title: 'FedRAMP Authorization Review', deadline: '2026-07-01', category: 'Government', status: 'Pending', assignee: 'FedRAMP PMO', notes: 'Review and update security authorization package'},
    {id: 'cc-data-classification-009', title: 'Annual Penetration Test', deadline: '2026-10-15', category: 'Testing', status: 'Not Started', assignee: 'Red Team Lead', notes: 'Comprehensive external and internal penetration testing engagement'},
    {id: 'cc-data-classification-010', title: 'Security Awareness Training Rollout', deadline: '2026-05-01', category: 'Training', status: 'Completed', assignee: 'Security Awareness Manager', notes: 'Q2 organization-wide security awareness training program'},
    {id: 'cc-data-classification-011', title: 'Vendor Security Review Cycle', deadline: '2026-06-01', category: 'Third Party', status: 'In Progress', assignee: 'Vendor Manager', notes: 'Quarterly review of critical vendor security posture and SLA compliance'},
    {id: 'cc-data-classification-012', title: 'Incident Response Plan Update', deadline: '2026-05-20', category: 'Operations', status: 'Pending', assignee: 'IR Team Lead', notes: 'Update IR procedures based on lessons learned from recent incidents'},
  ];
  ...
  @state() private _dataQualityMetrics: Array<{id: string; dataSource: string; completenessScore: number; accuracyScore: number; timelinessScore: number; consistencyScore: number; reliabilityRank: number; lastUpdated: string; issues: string[]; trend: string}> = [
    {id: 'dq-data-classification-001', dataSource: 'Vulnerability Scanner Feed', completenessScore: 94, accuracyScore: 91, timelinessScore: 88, consistencyScore: 95, reliabilityRank: 1, lastUpdated: '2026-04-23T08:00:00Z', issues: ['Minor delay in Nessus plugin updates'], trend: 'improving'},
    {id: 'dq-data-classification-002', dataSource: 'SIEM Event Logs', completenessScore: 87, accuracyScore: 93, timelinessScore: 96, consistencyScore: 89, reliabilityRank: 2, lastUpdated: '2026-04-23T07:30:00Z', issues: ['Some log sources showing gaps in off-hours'], trend: 'stable'},
    {id: 'dq-data-classification-003', dataSource: 'Asset Inventory Database', completenessScore: 82, accuracyScore: 78, timelinessScore: 75, consistencyScore: 84, reliabilityRank: 4, lastUpdated: '2026-04-22T18:00:00Z', issues: ['Shadow IT devices not fully cataloged', 'Decommissioned assets still listed'], trend: 'declining'},
    {id: 'dq-data-classification-004', dataSource: 'Threat Intelligence Platform', completenessScore: 91, accuracyScore: 89, timelinessScore: 92, consistencyScore: 87, reliabilityRank: 3, lastUpdated: '2026-04-23T06:00:00Z', issues: ['Some IOC sources lack confidence scoring'], trend: 'improving'},
    {id: 'dq-data-classification-005', dataSource: 'Identity Provider Logs', completenessScore: 96, accuracyScore: 97, timelinessScore: 98, consistencyScore: 96, reliabilityRank: 1, lastUpdated: '2026-04-23T09:00:00Z', issues: [], trend: 'stable'},
    {id: 'dq-data-classification-006', dataSource: 'Cloud Security Posture Data', completenessScore: 79, accuracyScore: 85, timelinessScore: 82, consistencyScore: 81, reliabilityRank: 5, lastUpdated: '2026-04-23T05:00:00Z', issues: ['Multi-cloud coverage gaps', 'API rate limiting affects scan frequency'], trend: 'declining'},
    {id: 'dq-data-classification-007', dataSource: 'Compliance Evidence Store', completenessScore: 88, accuracyScore: 86, timelinessScore: 80, consistencyScore: 83, reliabilityRank: 4, lastUpdated: '2026-04-21T14:00:00Z', issues: ['Manual evidence collection delays', 'Inconsistent formatting across frameworks'], trend: 'stable'},
    {id: 'dq-data-classification-008', dataSource: 'Network Flow Data', completenessScore: 92, accuracyScore: 90, timelinessScore: 94, consistencyScore: 91, reliabilityRank: 2, lastUpdated: '2026-04-23T08:30:00Z', issues: ['Encrypted traffic classification accuracy needs improvement'], trend: 'improving'},
  ];
  ...
  @state() private _workflowTemplates: Array<{id: string; name: string; description: string; category: string; steps: number; avgDuration: string; successRate: number; lastRun: string; manualInterventions: number; optimizationScore: number}> = [
    {id: 'wf-data-classification-001', name: 'Vulnerability Triage Pipeline', description: 'Automated vulnerability assessment, prioritization, and assignment workflow', category: 'Vulnerability Management', steps: 8, avgDuration: '12 min', successRate: 94.5, lastRun: '2026-04-23T06:00:00Z', manualInterventions: 2, optimizationScore: 87},
    {id: 'wf-data-classification-002', name: 'Incident Response Orchestration', description: 'End-to-end IR workflow from detection to containment and recovery', category: 'Incident Response', steps: 15, avgDuration: '45 min', successRate: 89.2, lastRun: '2026-04-22T14:30:00Z', manualInterventions: 5, optimizationScore: 72},
    {id: 'wf-data-classification-003', name: 'Access Request Approval Chain', description: 'Multi-level approval workflow for privileged access requests', category: 'Identity & Access', steps: 6, avgDuration: '4 hours', successRate: 97.1, lastRun: '2026-04-23T09:15:00Z', manualInterventions: 1, optimizationScore: 92},
    {id: 'wf-data-classification-004', name: 'Compliance Evidence Collection', description: 'Automated gathering and packaging of audit evidence artifacts', category: 'Compliance', steps: 10, avgDuration: '30 min', successRate: 91.8, lastRun: '2026-04-21T10:00:00Z', manualInterventions: 3, optimizationScore: 78},
    {id: 'wf-data-classification-005', name: 'Security Patch Deployment', description: 'Staged patch rollout with validation and rollback capability', category: 'Patch Management', steps: 12, avgDuration: '2 hours', successRate: 96.3, lastRun: '2026-04-20T22:00:00Z', manualInterventions: 1, optimizationScore: 85},
    {id: 'wf-data-classification-006', name: 'Threat Intelligence Enrichment', description: 'IOC enrichment and correlation with internal threat data', category: 'Threat Intelligence', steps: 7, avgDuration: '8 min', successRate: 93.7, lastRun: '2026-04-23T07:00:00Z', manualInterventions: 0, optimizationScore: 95},
    {id: 'wf-data-classification-007', name: 'Security Reporting Pipeline', description: 'Automated generation and distribution of security metrics reports', category: 'Reporting', steps: 5, avgDuration: '15 min', successRate: 98.9, lastRun: '2026-04-23T08:00:00Z', manualInterventions: 0, optimizationScore: 97},
    {id: 'wf-data-classification-008', name: 'Vendor Risk Assessment', description: 'Automated vendor security questionnaire distribution and scoring', category: 'Third Party', steps: 9, avgDuration: '3 days', successRate: 85.4, lastRun: '2026-04-19T11:00:00Z', manualInterventions: 4, optimizationScore: 65},
  ];
  ...
  @state() private _workflowExecutionHistory: Array<{workflowId: string; runDate: string; duration: string; status: string; trigger: string}> = [
    {workflowId: 'wf-data-classification-001', runDate: '2026-04-23T06:00:00Z', duration: '11 min 23 sec', status: 'Success', trigger: 'Scheduled'},
    {workflowId: 'wf-data-classification-002', runDate: '2026-04-22T14:30:00Z', duration: '42 min 15 sec', status: 'Success', trigger: 'Alert'},
    {workflowId: 'wf-data-classification-003', runDate: '2026-04-23T09:15:00Z', duration: '3h 45 min', status: 'Success', trigger: 'User Request'},
    {workflowId: 'wf-data-classification-001', runDate: '2026-04-22T06:00:00Z', duration: '13 min 08 sec', status: 'Partial', trigger: 'Scheduled'},
    {workflowId: 'wf-data-classification-004', runDate: '2026-04-21T10:00:00Z', duration: '28 min 42 sec', status: 'Success', trigger: 'Scheduled'},
  ];
  ...
  @state() private _knowledgeArticles: Array<{id: string; title: string; category: string; author: string; publishDate: string; views: number; rating: number; tags: string[]; summary: string; readTime: string}> = [
    {id: 'kb-data-classification-001', title: 'Zero Trust Architecture Implementation Guide', category: 'Architecture', author: 'Security Architecture Team', publishDate: '2026-03-15', views: 1842, rating: 4.8, tags: ['zero-trust', 'network', 'identity'], summary: 'Comprehensive guide for implementing zero trust principles across enterprise infrastructure', readTime: '15 min'},
    {id: 'kb-data-classification-002', title: 'Ransomware Defense Playbook 2026', category: 'Threats', author: 'Threat Intelligence Team', publishDate: '2026-04-01', views: 2341, rating: 4.9, tags: ['ransomware', 'incident-response', 'defense'], summary: 'Updated playbook with latest ransomware tactics, techniques, and defensive measures', readTime: '12 min'},
    {id: 'kb-data-classification-003', title: 'Cloud Security Best Practices for Multi-Cloud', category: 'Cloud', author: 'Cloud Security Team', publishDate: '2026-02-28', views: 1567, rating: 4.5, tags: ['cloud', 'aws', 'azure', 'gcp'], summary: 'Best practices for securing workloads across multiple cloud service providers', readTime: '18 min'},
    {id: 'kb-data-classification-004', title: 'API Security Testing Methodology', category: 'Testing', author: 'Red Team', publishDate: '2026-03-22', views: 987, rating: 4.6, tags: ['api', 'testing', 'owasp'], summary: 'Structured methodology for identifying and testing API security vulnerabilities', readTime: '10 min'},
    {id: 'kb-data-classification-005', title: 'Supply Chain Security Risk Management', category: 'Third Party', author: 'GRC Team', publishDate: '2026-01-20', views: 1234, rating: 4.3, tags: ['supply-chain', 'vendor', 'risk'], summary: 'Framework for managing security risks in the software supply chain', readTime: '14 min'},
    {id: 'kb-data-classification-006', title: 'Kubernetes Security Hardening Checklist', category: 'Container', author: 'Platform Security', publishDate: '2026-04-10', views: 2103, rating: 4.7, tags: ['kubernetes', 'container', 'hardening'], summary: 'Step-by-step hardening checklist for production Kubernetes clusters', readTime: '11 min'},
    {id: 'kb-data-classification-007', title: 'Security Metrics That Matter for Executives', category: 'Metrics', author: 'CISO Office', publishDate: '2026-03-05', views: 876, rating: 4.4, tags: ['metrics', 'kpi', 'reporting'], summary: 'Key security metrics and KPIs that resonate with board-level stakeholders', readTime: '8 min'},
    {id: 'kb-data-classification-008', title: 'Phishing Simulation Campaign Design', category: 'Awareness', author: 'Security Awareness Team', publishDate: '2026-02-15', views: 1456, rating: 4.5, tags: ['phishing', 'simulation', 'training'], summary: 'Designing effective phishing simulations that drive real behavioral change', readTime: '9 min'},
    {id: 'kb-data-classification-009', title: 'Data Loss Prevention Strategy and Implementation', category: 'Data Protection', author: 'Data Security Team', publishDate: '2026-03-28', views: 1678, rating: 4.6, tags: ['dlp', 'data-protection', 'compliance'], summary: 'Strategic approach to DLP covering people, process, and technology layers', readTime: '16 min'},
    {id: 'kb-data-classification-010', title: 'Security Automation with SOAR Platforms', category: 'Automation', author: 'SOC Engineering', publishDate: '2026-04-05', views: 1098, rating: 4.7, tags: ['soar', 'automation', 'soc'], summary: 'Building effective security automation playbooks using SOAR technology', readTime: '13 min'},
    {id: 'kb-data-classification-011', title: 'Third-Party Risk Assessment Framework', category: 'GRC', author: 'Vendor Management', publishDate: '2026-01-30', views: 1345, rating: 4.4, tags: ['vendor', 'risk', 'assessment'], summary: 'Structured framework for evaluating and monitoring third-party security risks', readTime: '12 min'},
    {id: 'kb-data-classification-012', title: 'Network Detection and Response Best Practices', category: 'Network', author: 'Network Security Team', publishDate: '2026-03-18', views: 1567, rating: 4.5, tags: ['ndr', 'network', 'detection'], summary: 'Implementing effective network detection and response capabilities', readTime: '14 min'},
    {id: 'kb-data-classification-013', title: 'Security Chaos Engineering Guide', category: 'Resilience', author: 'SRE Security', publishDate: '2026-04-12', views: 789, rating: 4.3, tags: ['chaos-engineering', 'resilience', 'testing'], summary: 'Applying chaos engineering principles to validate security controls', readTime: '10 min'},
    {id: 'kb-data-classification-014', title: 'Incident Communication Templates', category: 'Incident Response', author: 'IR Team', publishDate: '2026-02-22', views: 2234, rating: 4.8, tags: ['incident', 'communication', 'templates'], summary: 'Ready-to-use communication templates for security incident scenarios', readTime: '7 min'},
    {id: 'kb-data-classification-015', title: 'Endpoint Detection and Response Configuration', category: 'Endpoint', author: 'Endpoint Security', publishDate: '2026-03-08', views: 1345, rating: 4.5, tags: ['edr', 'endpoint', 'configuration'], summary: 'Optimal EDR configuration for maximum detection with minimal false positives', readTime: '11 min'},
    {id: 'kb-data-classification-016', title: 'Security Code Review Standards', category: 'Development', author: 'AppSec Team', publishDate: '2026-02-10', views: 1890, rating: 4.6, tags: ['code-review', 'secure-sdlc', 'standards'], summary: 'Standards and checklists for security-focused code reviews', readTime: '13 min'},
    {id: 'kb-data-classification-017', title: 'IoT Security Assessment Methodology', category: 'IoT', author: 'IoT Security Lab', publishDate: '2026-04-08', views: 654, rating: 4.2, tags: ['iot', 'embedded', 'assessment'], summary: 'Methodology for assessing security posture of IoT devices and ecosystems', readTime: '15 min'},
    {id: 'kb-data-classification-018', title: 'Passwordless Authentication Migration Guide', category: 'Identity', author: 'IAM Team', publishDate: '2026-03-25', views: 1678, rating: 4.7, tags: ['passwordless', 'authentication', 'mfa'], summary: 'Step-by-step migration plan from password-based to passwordless authentication', readTime: '12 min'},
    {id: 'kb-data-classification-019', title: 'Security Awareness Program Metrics', category: 'Awareness', author: 'Security Culture Team', publishDate: '2026-01-25', views: 1123, rating: 4.4, tags: ['awareness', 'metrics', 'culture'], summary: 'Measuring the effectiveness of your security awareness and training programs', readTime: '9 min'},
    {id: 'kb-data-classification-020', title: 'Deception Technology Deployment Guide', category: 'Detection', author: 'Blue Team', publishDate: '2026-04-15', views: 876, rating: 4.5, tags: ['deception', 'honeypot', 'detection'], summary: 'Planning and deploying deception technology for advanced threat detection', readTime: '11 min'},
  ];
  ...
  // --- Security Scenario Planning Methods (DACL) ---
  private _initDaclScenarios(): void {
    const worstCaseScenarios = [
      { id: "dacl-sc-01", name: "Ransomware Attack on Critical Infrastructure", category: "Malware", impact: 9500000, probability: 0.12, recoveryDays: 21, affectedSystems: 47, dataLossGb: 320, businessImpact: "critical" },
      { id: "dacl-sc-02", name: "Insider Data Exfiltration via Authorized Channels", category: "Insider Threat", impact: 7200000, probability: 0.18, recoveryDays: 14, affectedSystems: 12, dataLossGb: 85, businessImpact: "high" },
      { id: "dacl-sc-03", name: "Supply Chain Compromise via Third-Party Library", category: "Supply Chain", impact: 6800000, probability: 0.09, recoveryDays: 30, affectedSystems: 63, dataLossGb: 0, businessImpact: "critical" },
      { id: "dacl-sc-04", name: "Cloud Misconfiguration Leading to Public Exposure", category: "Cloud", impact: 4100000, probability: 0.22, recoveryDays: 7, affectedSystems: 8, dataLossGb: 450, businessImpact: "high" },
      { id: "dacl-sc-05", name: "Zero-Day Exploit in Core Application Framework", category: "Vulnerability", impact: 8900000, probability: 0.05, recoveryDays: 45, affectedSystems: 120, dataLossGb: 0, businessImpact: "critical" },
      { id: "dacl-sc-06", name: "Distributed Denial of Service on Customer-Facing Services", category: "Availability", impact: 3400000, probability: 0.25, recoveryDays: 3, affectedSystems: 15, dataLossGb: 0, businessImpact: "medium" },
      { id: "dacl-sc-07", name: "Credential Stuffing and Account Takeover Wave", category: "Identity", impact: 2800000, probability: 0.30, recoveryDays: 5, affectedSystems: 6, dataLossGb: 12, businessImpact: "medium" },
      { id: "dacl-sc-08", name: "Physical Security Breach at Data Center Facility", category: "Physical", impact: 12000000, probability: 0.02, recoveryDays: 60, affectedSystems: 200, dataLossGb: 5000, businessImpact: "critical" },
    ];
    this._daclScenarios = worstCaseScenarios.map(s => ({ ...s, mitigationCost: Math.round(s.impact * 0.08), drillScheduled: false, lastDrillDate: null, drillScore: null, controlGaps: Math.floor(Math.random() * 5) + 1 }));
  }

  private _calculateDaclScenarioRisk(): void {
    this._daclScenarios.forEach(s => {
  ...
  private _scheduleDaclDrills(): void {
  ...
  private _daclScenarioComparison(): Record<string, unknown>[] {
    return this._daclScenarios.map(s => ({
  ...
  // --- Security Control Effectiveness Analytics (DACL) ---
  private _initDaclControls(): void {
    const controls = [
      { id: "dacl-ct-01", name: "Network Segmentation", type: "preventive", maturity: "defined", score: 82, target: 90, failures: 3, lastTest: "2026-03-15" },
      { id: "dacl-ct-02", name: "Endpoint Detection and Response", type: "detective", maturity: "managed", score: 88, target: 92, failures: 1, lastTest: "2026-04-01" },
      { id: "dacl-ct-03", name: "Data Loss Prevention", type: "preventive", maturity: "repeatable", score: 71, target: 85, failures: 7, lastTest: "2026-03-22" },
      { id: "dacl-ct-04", name: "Security Information and Event Management", type: "detective", maturity: "managed", score: 85, target: 90, failures: 2, lastTest: "2026-04-05" },
      { id: "dacl-ct-05", name: "Identity and Access Management", type: "preventive", maturity: "defined", score: 76, target: 88, failures: 5, lastTest: "2026-03-28" },
      { id: "dacl-ct-06", name: "Vulnerability Management", type: "corrective", maturity: "managed", score: 80, target: 90, failures: 4, lastTest: "2026-04-02" },
      { id: "dacl-ct-07", name: "Email Security Gateway", type: "preventive", maturity: "managed", score: 90, target: 95, failures: 1, lastTest: "2026-04-08" },
      { id: "dacl-ct-08", name: "Web Application Firewall", type: "preventive", maturity: "managed", score: 87, target: 92, failures: 2, lastTest: "2026-03-30" },
      { id: "dacl-ct-09", name: "Patch Management", type: "corrective", maturity: "defined", score: 68, target: 85, failures: 9, lastTest: "2026-03-18" },
      { id: "dacl-ct-10", name: "Encryption at Rest", type: "preventive", maturity: "managed", score: 93, target: 95, failures: 0, lastTest: "2026-04-10" },
      { id: "dacl-ct-11", name: "Encryption in Transit", type: "preventive", maturity: "optimized", score: 96, target: 98, failures: 0, lastTest: "2026-04-12" },
      { id: "dacl-ct-12", name: "Privileged Access Management", type: "preventive", maturity: "defined", score: 74, target: 88, failures: 6, lastTest: "2026-03-25" },
      { id: "dacl-ct-13", name: "Security Awareness Training", type: "preventive", maturity: "repeatable", score: 65, target: 80, failures: 11, lastTest: "2026-03-20" },
      { id: "dacl-ct-14", name: "Incident Response Plan", type: "corrective", maturity: "managed", score: 78, target: 88, failures: 4, lastTest: "2026-04-03" },
      { id: "dacl-ct-15", name: "Backup and Recovery", type: "corrective", maturity: "managed", score: 84, target: 92, failures: 3, lastTest: "2026-04-06" },
      { id: "dacl-ct-16", name: "Multi-Factor Authentication", type: "preventive", maturity: "managed", score: 91, target: 95, failures: 1, lastTest: "2026-04-09" },
      { id: "dacl-ct-17", name: "Network Traffic Analysis", type: "detective", maturity: "defined", score: 72, target: 85, failures: 5, lastTest: "2026-03-27" },
      { id: "dacl-ct-18", name: "Cloud Security Posture Management", type: "detective", maturity: "repeatable", score: 69, target: 82, failures: 8, lastTest: "2026-03-24" },
      { id: "dacl-ct-19", name: "Container Security Scanning", type: "preventive", maturity: "defined", score: 75, target: 85, failures: 5, lastTest: "2026-04-04" },
      { id: "dacl-ct-20", name: "API Security Gateway", type: "preventive", maturity: "repeatable", score: 70, target: 82, failures: 7, lastTest: "2026-03-29" },
      { id: "dacl-ct-21", name: "Threat Intelligence Platform", type: "detective", maturity: "managed", score: 83, target: 90, failures: 2, lastTest: "2026-04-07" },
      { id: "dacl-ct-22", name: "Database Activity Monitoring", type: "detective", maturity: "defined", score: 67, target: 80, failures: 8, lastTest: "2026-03-21" },
      { id: "dacl-ct-23", name: "Deception Technology", type: "detective", maturity: "initial", score: 55, target: 75, failures: 12, lastTest: "2026-03-16" },
      { id: "dacl-ct-24", name: "Security Orchestration Automation", type: "corrective", maturity: "repeatable", score: 73, target: 85, failures: 6, lastTest: "2026-04-01" },
      { id: "dacl-ct-25", name: "Third-Party Risk Assessment", type: "preventive", maturity: "defined", score: 64, target: 78, failures: 9, lastTest: "2026-03-19" },
    ];
    this._daclControls = controls;
  }

  private _analyzeDaclControlEffectiveness(): void {
    const typeBreakdown: Record<string, { total: number; avgScore: number; avgFailures: number }> = {};
    this._daclControls.forEach(c => {
    ...
    this._daclControlTypeBreakdown = typeBreakdown;
  }

  private _daclControlOptimization(): Record<string, unknown>[] {
    return this._daclControls.filter(c => c.score < c.target).map(c => ({
  ...
  // --- Security Data Pipeline Health (DACL) ---
  private _initDaclPipelines(): void {
    const pipelines = [
      { id: "dacl-pl-01", name: "SIEM Log Ingestion", status: "healthy", healthScore: 94, latencyMs: 120, freshnessMin: 2, errorRate: 0.02, throughputMbps: 450, recordsPerSec: 12000, backPressure: 0.05, uptime: 99.97 },
      { id: "dacl-pl-02", name: "Threat Feed Aggregation", status: "healthy", healthScore: 91, latencyMs: 300, freshnessMin: 15, errorRate: 0.05, throughputMbps: 85, recordsPerSec: 3200, backPressure: 0.08, uptime: 99.92 },
      { id: "dacl-pl-03", name: "Vulnerability Scan Results", status: "degraded", healthScore: 72, latencyMs: 2500, freshnessMin: 60, errorRate: 0.15, throughputMbps: 25, recordsPerSec: 800, backPressure: 0.35, uptime: 98.50 },
      { id: "dacl-pl-04", name: "Endpoint Telemetry Stream", status: "healthy", healthScore: 88, latencyMs: 450, freshnessMin: 5, errorRate: 0.08, throughputMbps: 280, recordsPerSec: 8500, backPressure: 0.12, uptime: 99.85 },
      { id: "dacl-pl-05", name: "Cloud Audit Log Pipeline", status: "healthy", healthScore: 86, latencyMs: 600, freshnessMin: 10, errorRate: 0.06, throughputMbps: 150, recordsPerSec: 4500, backPressure: 0.10, uptime: 99.80 },
      { id: "dacl-pl-06", name: "Identity Event Stream", status: "warning", healthScore: 78, latencyMs: 1200, freshnessMin: 20, errorRate: 0.12, throughputMbps: 45, recordsPerSec: 1500, backPressure: 0.22, uptime: 99.40 },
      { id: "dacl-pl-07", name: "Network Flow Collection", status: "healthy", healthScore: 82, latencyMs: 800, freshnessMin: 8, errorRate: 0.09, throughputMbps: 650, recordsPerSec: 18000, backPressure: 0.15, uptime: 99.70 },
      { id: "dacl-pl-08", name: "DLP Incident Pipeline", status: "degraded", healthScore: 68, latencyMs: 3500, freshnessMin: 45, errorRate: 0.20, throughputMbps: 18, recordsPerSec: 500, backPressure: 0.42, uptime: 97.80 },
    ];
    this._daclPipelines = pipelines.map(p => ({ ...p, dependencies: [], slaBreached: p.healthScore < 75, alertThreshold: p.errorRate > 0.15 }));
    this._daclPipelines[0].dependencies = ["dacl-pl-04", "dacl-pl-07"];
    this._daclPipelines[4].dependencies = ["dacl-pl-01"];
    this._daclPipelines[5].dependencies = ["dacl-pl-02"];
    this._daclPipelines[7].dependencies = ["dacl-pl-04", "dacl-pl-05"];
  }

  private _daclPipelineTrend(): Record<string, unknown>[] {
    const hours = Array.from({ length: 24 }, (_, i) => `H${String(i).padStart(2, "0")}`);
    return this._daclPipelines.map(p => ({
  ...
  // --- Security Stakeholder Report Generator (DACL) ---
  private _initDaclReportTemplates(): void {
    this._daclReportTemplates = [
      { id: "dacl-rp-01", name: "Board Security Report", audience: "board", frequency: "quarterly", sections: 6, autoGenerate: true, lastGenerated: "2026-03-31", pages: 12 },
      { id: "dacl-rp-02", name: "Executive Risk Summary", audience: "executive", frequency: "monthly", sections: 8, autoGenerate: true, lastGenerated: "2026-04-01", pages: 8 },
      { id: "dacl-rp-03", name: "Technical Security Review", audience: "technical", frequency: "weekly", sections: 12, autoGenerate: true, lastGenerated: "2026-04-21", pages: 25 },
      { id: "dacl-rp-04", name: "Audit Compliance Report", audience: "audit", frequency: "quarterly", sections: 10, autoGenerate: false, lastGenerated: "2026-03-15", pages: 35 },
      { id: "dacl-rp-05", name: "Regulatory Filing Package", audience: "regulatory", frequency: "annual", sections: 15, autoGenerate: false, lastGenerated: "2025-12-31", pages: 48 },
    ];
  }

  private _generateDaclExecSummary(): string {
    const totalRisk = this._daclScenarios.reduce((sum: number, s: any) => sum + s.riskScore, 0);
    const avgControl = Math.round(this._daclControls.reduce((sum: number, c: any) => sum + c.score, 0) / this._daclControls.length);
    const degradedPipes = this._daclPipelines.filter((p: any) => p.status !== "healthy").length;
    return `Overall risk exposure: ${(totalRisk / 1000000).toFixed(1)}M. Average control effectiveness: {avgControl}%. {degradedPipes} pipeline(s) need attention. {this._daclScenarios.filter((s: any) => s.mitigationPriority === "immediate").length} scenarios require immediate action.`;
  }

  // --- Security Technology Radar (DACL) ---
  private _initDaclTechRadar(): void {
    this._daclTechRadar = [
      { id: "dacl-tr-01", name: "AI-Powered Threat Detection", ring: "adopt", category: "Detection", maturity: 4, trend: "up", investment: "high", roi: 3.2, vendorCount: 8 },
      { id: "dacl-tr-02", name: "Zero Trust Architecture", ring: "adopt", category: "Architecture", maturity: 4, trend: "up", investment: "high", roi: 2.8, vendorCount: 12 },
      { id: "dacl-tr-03", name: "SASE/SSE Platform", ring: "trial", category: "Network", maturity: 3, trend: "up", investment: "medium", roi: 2.4, vendorCount: 10 },
      { id: "dacl-tr-04", name: "CNAPP Cloud Security", ring: "trial", category: "Cloud", maturity: 3, trend: "up", investment: "medium", roi: 2.1, vendorCount: 7 },
      { id: "dacl-tr-05", name: "Extended Detection and Response", ring: "adopt", category: "Detection", maturity: 4, trend: "stable", investment: "high", roi: 2.9, vendorCount: 9 },
      { id: "dacl-tr-06", name: "Quantum-Safe Cryptography", ring: "assess", category: "Crypto", maturity: 2, trend: "up", investment: "low", roi: 0.8, vendorCount: 4 },
      { id: "dacl-tr-07", name: "Security Service Edge", ring: "trial", category: "Network", maturity: 3, trend: "up", investment: "medium", roi: 2.0, vendorCount: 6 },
      { id: "dacl-tr-08", name: "SOAR 2.0 Autonomous SOC", ring: "assess", category: "Operations", maturity: 2, trend: "up", investment: "low", roi: 1.2, vendorCount: 5 },
      { id: "dacl-tr-09", name: "Software Supply Chain Security", ring: "trial", category: "DevSecOps", maturity: 3, trend: "up", investment: "medium", roi: 2.3, vendorCount: 8 },
      { id: "dacl-tr-10", name: "Identity Threat Detection", ring: "adopt", category: "Identity", maturity: 3, trend: "up", investment: "high", roi: 2.7, vendorCount: 7 },
      { id: "dacl-tr-11", name: "Data Security Posture Management", ring: "trial", category: "Data", maturity: 3, trend: "up", investment: "medium", roi: 2.2, vendorCount: 9 },
      { id: "dacl-tr-12", name: "Decentralized Identity Standards", ring: "hold", category: "Identity", maturity: 1, trend: "stable", investment: "low", roi: 0.5, vendorCount: 3 },
    ];
  }

  private _daclRadarSummary(): Record<string, unknown> {
    const rings: Record<string, number> = { adopt: 0, trial: 0, assess: 0, hold: 0 };
    this._daclTechRadar.forEach(t => { if (rings[t.ring as keyof typeof rings] !== undefined) rings[t.ring as keyof typeof rings]++; });
    return { adopt: rings.adopt, trial: rings.trial, assess: rings.assess, hold: rings.hold, total: this._daclTechRadar.length, avgMaturity: 2.8, topInvestment: this._daclTechRadar.filter(t => t.investment === "high").map(t => t.name) };
  }

  // --- DACL Security Compliance Mapping Matrix ---
  private _initDaclComplianceMatrix(): void {
    ...
    this._daclComplianceMatrix = frameworks.map(fw => ({
  ...
  private _daclComplianceTrend(): Record<string, unknown>[] {
    const quarters = ["Q1-2025", "Q2-2025", "Q3-2025", "Q4-2025", "Q1-2026", "Q2-2026"];
    return this._daclComplianceMatrix.map(fw => ({
  ...
  // --- DACL Threat Intelligence Correlation Engine ---
  private _initDaclThreatIntel(): void {
    ...
    this._daclThreatIntel = threatActors.map((actor, i) => ({
  ...
  private _daclThreatCorrelation(): Record<string, unknown>[] {
    return this._daclThreatIntel.filter(t => t.riskScore > 70).map(t => ({
  ...
  // --- DACL Security Metrics Deep Dive ---
  private _initDaclMetricsDeep(): void {
    ...
    this._daclMetricsDeep = metricCategories.map(cat => ({
  ...
  private _daclMetricsHeatmap(): number[][] {
    return this._daclMetricsDeep.map(cat =>
      cat.metrics.map(m => Math.round((m.value / m.target) * 100))
    );
  }

  // --- DACL Incident Cost Modeling ---
  private _initDaclCostModel(): void {
    const incidentTypes = ["Data Breach", "Ransomware", "DDoS", "Insider Threat", "Phishing", "Supply Chain", "Cloud Misconfig", "Zero-Day"];
    this._daclCostModel = incidentTypes.map(inc => ({
    ...
    this._daclCostModel.forEach(m => { m.totalAnnualExposure = m.avgCost * m.frequency; });
  }

  private _daclCostProjection(): Record<string, unknown>[] {
    return this._daclCostModel.map(m => ({
  ...
  // --- DACL Security Architecture Pattern Library ---
  private _initDaclArchPatterns(): void {
    ...
    this._daclArchPatterns = patterns.map((p, i) => ({
  ...
  private _daclArchPatternAnalysis(): Record<string, unknown> {
    const implemented = this._daclArchPatterns.filter(p => p.implementation > 75).length;
    const avgCoverage = Math.round(this._daclArchPatterns.reduce((s: number, p: any) => s + p.coverage, 0) / this._daclArchPatterns.length);
    return {
      totalPatterns: this._daclArchPatterns.length, fullyImplemented: implemented, avgCoverage,
      avgRiskReduction: Math.round(this._daclArchPatterns.reduce((s: number, p: any) => s + p.riskReduction, 0) / this._daclArchPatterns.length),
      gaps: this._daclArchPatterns.filter(p => p.implementation < 60).map(p => p.pattern),
      recommendations: this._daclArchPatterns.filter(p => p.implementation < 70).map(p => ({ pattern: p.pattern, current: p.implementation, target: 85, effort: p.costComplexity }))
    };
  }
  ...
  private _80bRiskAssessmentWorkflow = [
  ...
  private _80bTreatmentOptions = [
    {id: '80b-T-001', riskId: 'RSK-042', risk: 'Ransomware Attack on Critical Infrastructure', before: 20, after: 6, strategy: 'Mitigate', controls: ['Next-gen EDR with behavioral detection and automated response', 'Zero-trust network micro-segmentation isolating critical assets', 'Immutable offline backup rotation with quarterly recovery testing', 'Incident response retainer with 1-hour response SLA'], cost: '$450K/yr', roi: '78% reduction vs $2.8M potential loss', timeline: 'Q3 2026', status: 'approved' as const},
  ...
  private _80bTalentPositions = [
    ...
    {id: '80b-H-002', title: 'Cloud Security Engineer', dept: 'Cloud Security', level: 'Mid-Senior', loc: 'SF/Remote', salary: '$155K-$180K', posted: '2026-03-20', applicants: 45, pipeline: 12, interviews: 6, offers: 2, urgency: 'high' as const, manager: 'Mike Johnson', skills: ['AWS/Azure/GCP', 'Terraform', 'Kubernetes', 'IAM', 'CSPM'], nice: ['CCSP', 'CKS', 'Serverless']},
    {id: '80b-H-003', title: 'SOC Analyst L2', dept: 'Security Operations', level: 'Mid', loc: 'Austin TX', salary: '$105K-$130K', posted: '2026-04-01', applicants: 67, pipeline: 18, interviews: 8, offers: 0, urgency: 'medium' as const, manager: 'Lisa Park', skills: ['SIEM', 'Incident triage', 'Malware analysis', 'TCP/IP'], nice: ['GCIA', 'SOAR', 'Kill chain']},
    {id: '80b-H-004', title: 'Staff Security Architect', dept: 'Architecture', level: 'Staff', loc: 'Remote US', salary: '$200K-$240K', posted: '2026-02-28', applicants: 12, pipeline: 3, interviews: 2, offers: 0, urgency: 'critical' as const, manager: 'David Lee', skills: ['Enterprise arch', 'Zero trust', 'Risk frameworks', 'Board comms'], nice: ['CISSP+SABSA', 'Team building', 'Speaker']},
    {id: '80b-H-005', title: 'GRC Analyst', dept: 'GRC', level: 'Mid', loc: 'NY/Remote', salary: '$110K-$135K', posted: '2026-04-05', applicants: 34, pipeline: 9, interviews: 3, offers: 1, urgency: 'medium' as const, manager: 'Rachel Green', skills: ['ISO 27001', 'SOC 2', 'Risk assessment', 'Audit'], nice: ['CRISC', 'CISA', 'GDPR']},
    {id: '80b-H-006', title: 'Threat Intel Analyst', dept: 'Threat Intel', level: 'Mid-Senior', loc: 'Remote US', salary: '$140K-$170K', posted: '2026-03-25', applicants: 19, pipeline: 5, interviews: 2, offers: 0, urgency: 'low' as const, manager: 'James Wilson', skills: ['MITRE ATT&CK', 'OSINT', 'Threat modeling', 'Reverse eng'], nice: ['CTIA', 'Nation-state', 'Dark web']},
    {id: '80b-H-007', title: 'AppSec Engineer', dept: 'AppSec', level: 'Senior', loc: 'Seattle/Remote', salary: '$160K-$190K', posted: '2026-04-10', applicants: 28, pipeline: 7, interviews: 3, offers: 0, urgency: 'medium' as const, manager: 'Emily Zhang', skills: ['SAST/DAST/SCA', 'Secure SDLC', 'Code review', 'CI/CD'], nice: ['CSSLP', 'Mobile security']},
    {id: '80b-H-008', title: 'IAM Engineer', dept: 'IAM', level: 'Mid', loc: 'Remote US', salary: '$135K-$160K', posted: '2026-04-08', applicants: 31, pipeline: 10, interviews: 5, offers: 1, urgency: 'medium' as const, manager: 'Chris Martinez', skills: ['Okta/Azure AD', 'SAML/OIDC', 'PAM', 'RBAC'], nice: ['CISSP', 'Zero trust IAM']}
  ];

  private _80bInterviewScorecard = [
  ...
  private _80bOnboardingSteps = [
    {id: '80b-OB-01', item: 'Provision security-hardened laptop, monitors, peripherals, and configured workstation image with all required security tools', cat: 'IT Setup', day: 'Day 1', owner: 'IT Operations'},
    {id: '80b-OB-02', item: 'Create AD account, email, Slack, VPN, SSO enrollment, and all required application access accounts', cat: 'Access', day: 'Day 1', owner: 'IAM Team'},
    {id: '80b-OB-03', item: 'Grant security tooling access: SIEM console, EDR dashboard, vuln scanner, pentest platforms, SOAR', cat: 'Tools', day: 'Day 1-2', owner: 'SOC Manager'},
    {id: '80b-OB-04', item: 'Complete MFA enrollment, security awareness onboarding course, and acceptable use policy acknowledgment', cat: 'Security', day: 'Day 1', owner: 'Awareness Team'},
    {id: '80b-OB-05', item: 'Sign NDA, employment agreement, IP assignment, and code of conduct documents with HR', cat: 'HR', day: 'Day 1', owner: 'Human Resources'},
    {id: '80b-OB-06', item: 'Introduction meetings with direct team members and key cross-functional stakeholders', cat: 'Integration', day: 'Week 1', owner: 'Hiring Manager'},
    {id: '80b-OB-07', item: 'Security architecture overview, tooling walkthrough, and operational runbook review sessions', cat: 'Training', day: 'Week 1-2', owner: 'Security Architect'},
    {id: '80b-OB-08', item: 'Shadow experienced team member on active incident response and threat hunting investigations', cat: 'Mentoring', day: 'Week 2-3', owner: 'SOC Lead'},
    {id: '80b-OB-09', item: 'Set up individual certification study plan aligned with role requirements and career goals', cat: 'Development', day: 'Week 2', owner: 'Hiring Manager'},
    {id: '80b-OB-10', item: 'Establish 30-60-90 day goals, define success metrics, and schedule first performance checkpoint', cat: 'Goals', day: 'Week 1', owner: 'Hiring Manager'}
  ];

  private _80bMetricsDashboard = [
    {id: '80b-MTD-001', name: 'Mean Time to Detect (MTTD)', value: '4.2 hours', trend: 'improving' as const, target: '< 4 hours', source: 'SIEM - Splunk', method: 'Median time from first alert to analyst acknowledgment', owner: 'SOC Manager', sla: '4 hours', prev: '5.1 hours', spark: [5.8, 5.4, 5.1, 4.9, 4.7, 4.5, 4.3, 4.2], breakdown: [{src: 'Network IDS', pct: '35%', avg: '3.8h'}, {src: 'Endpoint EDR', pct: '28%', avg: '4.1h'}, {src: 'Email Gateway', pct: '22%', avg: '3.5h'}, {src: 'Cloud Security', pct: '10%', avg: '5.2h'}, {src: 'User Reports', pct: '5%', avg: '6.8h'}]},
    {id: '80b-MTD-002', name: 'Mean Time to Respond (MTTR)', value: '2.8 hours', trend: 'stable' as const, target: '< 3 hours', source: 'SOAR - XSOAR', method: 'Median time from acknowledgment to first containment action', owner: 'IR Lead', sla: '3 hours', prev: '2.7 hours', spark: [3.2, 3.0, 2.9, 2.8, 2.8, 2.9, 2.8, 2.8], breakdown: [{src: 'Auto Playbooks', pct: '42%', avg: '1.2h'}, {src: 'Semi-Auto', pct: '33%', avg: '2.5h'}, {src: 'Manual', pct: '20%', avg: '5.1h'}, {src: 'L3 Escalation', pct: '5%', avg: '8.3h'}]},
    {id: '80b-MTD-003', name: 'Patch Compliance Rate', value: '97.6%', trend: 'improving' as const, target: '> 95%', source: 'Tenable.io', method: 'Pct of critical/high vulns patched within SLA windows', owner: 'Vuln Manager', sla: '95%', prev: '96.1%', spark: [93.2, 94.1, 94.8, 95.3, 95.9, 96.4, 97.0, 97.6], breakdown: [{src: 'Critical (7d)', pct: '40%', rate: '99.2%'}, {src: 'High (30d)', pct: '35%', rate: '97.8%'}, {src: 'Medium (90d)', pct: '20%', rate: '95.1%'}, {src: 'Low (180d)', pct: '5%', rate: '89.4%'}]},
    {id: '80b-MTD-004', name: 'Phishing Click Rate', value: '3.2%', trend: 'improving' as const, target: '< 5%', source: 'KnowBe4 + Proofpoint', method: 'Pct of users clicking simulated phishing links monthly', owner: 'Awareness Lead', sla: '5%', prev: '4.1%', spark: [6.8, 6.2, 5.5, 5.1, 4.6, 4.1, 3.6, 3.2], breakdown: [{src: 'Spear Phishing', pct: '35%', rate: '5.1%'}, {src: 'Generic Phishing', pct: '30%', rate: '2.8%'}, {src: 'BEC Sim', pct: '20%', rate: '3.5%'}, {src: 'SMS Phishing', pct: '15%', rate: '1.9%'}]},
    {id: '80b-MTD-005', name: 'Security Posture Score', value: '784', trend: 'improving' as const, target: '> 750', source: 'SecurityScorecard', method: 'Composite: external 30%, compliance 25%, vuln 25%, config 20%', owner: 'CISO', sla: '> 750', prev: '771', spark: [748, 752, 758, 762, 768, 773, 778, 784], breakdown: [{src: 'External Rating', pct: '30%', score: '791'}, {src: 'Compliance', pct: '25%', score: '812'}, {src: 'Vuln Mgmt', pct: '25%', score: '745'}, {src: 'Config', pct: '20%', score: '769'}]},
    {id: '80b-MTD-006', name: 'Vulnerability Backlog', value: '142', trend: 'improving' as const, target: '< 150', source: 'Tenable + Qualys', method: 'Total open vulns across all scanned assets tracked weekly', owner: 'Vuln Manager', sla: '< 150', prev: '168', spark: [210, 198, 185, 175, 165, 158, 150, 142], breakdown: [{src: 'Critical', pct: '8%', count: '11'}, {src: 'High', pct: '22%', count: '31'}, {src: 'Medium', pct: '45%', count: '64'}, {src: 'Low', pct: '25%', count: '36'}]}
  ];

  private _80bArchReview = [
    {id: '80b-AR-001', cat: 'Network', item: 'Network segmentation between trust zones with dedicated firewalls and granular ACLs', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Micro-segmentation via NSX across all production zones'},
    {id: '80b-AR-002', cat: 'Network', item: 'DMZ architecture isolating public services from internal network', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Dual-firewall DMZ with WAF and DDoS mitigation'},
    {id: '80b-AR-003', cat: 'Network', item: 'Least-privilege traffic flows with deny-by-default and quarterly review', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'Explicit allow rules with automated drift detection'},
    {id: '80b-AR-004', cat: 'Network', item: 'Encrypted external communications with IPSec/TLS 1.3 and PFS', sev: 'high' as const, status: 'pass' as const, reviewer: 'Network Architect', notes: 'IKEv2 with PFS, TLS 1.3 for all external APIs'},
    {id: '80b-AR-005', cat: 'Identity', item: 'Centralized IdP with SSO and automated SCIM provisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Okta SSO SAML 2.0 for 247 apps with SCIM'},
    {id: '80b-AR-006', cat: 'Identity', item: 'RBAC with quarterly reviews and automated deprovisioning', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'Quarterly recertification with JIT admin access'},
    {id: '80b-AR-007', cat: 'Identity', item: 'PAM controlling all admin and service accounts with session recording', sev: 'high' as const, status: 'fail' as const, reviewer: 'IAM Lead', notes: '3 legacy accounts pending CyberArk enrollment'},
    {id: '80b-AR-008', cat: 'Identity', item: 'MFA enforced for all users, hardware tokens for privileged access', sev: 'critical' as const, status: 'pass' as const, reviewer: 'IAM Lead', notes: 'FIDO2 for admins, push MFA for users, 99.8% enrollment'},
    {id: '80b-AR-009', cat: 'Data', item: 'Data classification enforced with automated labeling on all repos', sev: 'high' as const, status: 'partial' as const, reviewer: 'Data Protection Lead', notes: 'Framework deployed, gaps on 4 legacy file shares'},
    {id: '80b-AR-010', cat: 'Data', item: 'AES-256 encryption at rest for all sensitive data stores', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'Full-disk, TDE on DBs, SSE-KMS on cloud storage'},
    {id: '80b-AR-011', cat: 'Data', item: 'DLP monitoring and preventing unauthorized data exfiltration', sev: 'high' as const, status: 'pass' as const, reviewer: 'Data Protection Lead', notes: 'DLP active on email, endpoint, cloud, and network'},
    {id: '80b-AR-012', cat: 'Data', item: 'Encrypted off-site backups with quarterly restore testing', sev: 'critical' as const, status: 'pass' as const, reviewer: 'Infrastructure Lead', notes: '3-2-1 strategy with immutable backups'},
    {id: '80b-AR-013', cat: 'AppSec', item: 'Secure SDLC with SAST, DAST, SCA in all CI/CD pipelines', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: '34 pipelines with security gates and PR blocking'},
    {id: '80b-AR-014', cat: 'AppSec', item: 'API gateway with auth, rate limiting, schema validation', sev: 'high' as const, status: 'pass' as const, reviewer: 'AppSec Lead', notes: 'Kong with OAuth2, rate limits, OpenAPI validation'},
    {id: '80b-AR-015', cat: 'AppSec', item: 'Container security with image scanning and runtime protection', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Trivy scanning, Falco runtime in 80% of clusters'},
    {id: '80b-AR-016', cat: 'Monitoring', item: 'SIEM collecting from all critical systems with correlation rules', sev: 'critical' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'Splunk 98% coverage with 1200+ correlation rules'},
    {id: '80b-AR-017', cat: 'Monitoring', item: 'EDR with behavioral detection on all managed endpoints', sev: 'high' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'CrowdStrike on 99.2% endpoints with 24/7 MDR'},
    {id: '80b-AR-018', cat: 'Monitoring', item: 'Executive dashboards with real-time posture visibility', sev: 'medium' as const, status: 'pass' as const, reviewer: 'SOC Manager', notes: 'PowerBI dashboards with weekly exec summaries'},
    {id: '80b-AR-019', cat: 'Cloud', item: 'CSPM monitoring and remediating cloud misconfigurations', sev: 'high' as const, status: 'pass' as const, reviewer: 'Cloud Security Lead', notes: 'Prisma Cloud 450+ checks with auto-remediation'},
    {id: '80b-AR-020', cat: 'Cloud', item: 'IaC templates scanned before deployment to production', sev: 'high' as const, status: 'partial' as const, reviewer: 'Cloud Security Lead', notes: 'Checkov for Terraform, cfn-nag for CloudFormation pending'}
  ];

  private _get80bRiskProgress(): number {
    return Math.round(this._80bRiskAssessmentWorkflow.filter(s => s.status === 'completed').length / this._80bRiskAssessmentWorkflow.length * 100);
  }

  private _get80bTreatmentSummary(): {total: number; approved: number; avgReduction: number; investment: string} {
    const a = this._80bTreatmentOptions.filter(r => r.status === 'approved').length;
    const avg = this._80bTreatmentOptions.reduce((s, r) => s + ((r.before - r.after) / r.before * 100), 0) / this._80bTreatmentOptions.length;
    return {total: this._80bTreatmentOptions.length, approved: a, avgReduction: Math.round(avg), investment: '$1.125M annually'};
  }

  private _get80bRuleSummary(): {total: number; passing: number; failing: number; avgRate: number; violations: number} {
    const p = this._80bComplianceRules.filter(r => r.result === 'pass').length;
    const f = this._80bComplianceRules.filter(r => r.result === 'fail').length;
    const avg = this._80bComplianceRules.reduce((s, r) => s + r.passRate, 0) / this._80bComplianceRules.length;
    const v = this._80bComplianceRules.reduce((s, r) => s + r.violations, 0);
    return {total: this._80bComplianceRules.length, passing: p, failing: f, avgRate: Math.round(avg * 10) / 10, violations: v};
  }

  private _get80bPipelineStats(): {positions: number; applicants: number; interviewing: number; offers: number; critical: number} {
    const t = this._80bTalentPositions.length;
    const a = this._80bTalentPositions.reduce((s, p) => s + p.applicants, 0);
    const i = this._80bTalentPositions.reduce((s, p) => s + p.interviews, 0);
    const o = this._80bTalentPositions.reduce((s, p) => s + p.offers, 0);
    const c = this._80bTalentPositions.filter(x => x.urgency === 'critical').length;
    return {positions: t, applicants: a, interviewing: i, offers: o, critical: c};
  }

  private _get80bMetricTrends(): {improving: number; stable: number; total: number} {
    const imp = this._80bMetricsDashboard.filter(m => m.trend === 'improving').length;
    const stb = this._80bMetricsDashboard.filter(m => m.trend === 'stable').length;
    return {improving: imp, stable: stb, total: this._80bMetricsDashboard.length};
  }

  private _get80bArchScore(): {total: number; passed: number; failed: number; partial: number; score: number} {
    const p = this._80bArchReview.filter(c => c.status === 'pass').length;
    const f = this._80bArchReview.filter(c => c.status === 'fail').length;
    const pa = this._80bArchReview.filter(c => c.status === 'partial').length;
    return {total: this._80bArchReview.length, passed: p, failed: f, partial: pa, score: Math.round((p / this._80bArchReview.length) * 100)};
  }


  private _z80bIncidentScenarios = [
    {id: 'z80b-IS-001', name: 'Ransomware Outbreak in Production Environment', category: 'Malware', likelihood: 'Medium', impact: 'Critical', riskScore: 15, playbooks: ['IR-Ransomware-Isolate', 'IR-Ransomware-Eradicate', 'IR-Ransomway-Recover'], estimatedMTTD: '15min', estimatedMTTR: '4h', involvedTeams: ['SOC', 'IR', 'Infrastructure', 'Legal', 'Comms'], keyIndicators: ['Mass file encryption events', 'Ransom note deployment', 'Lateral movement via SMB/RDP', 'Backup deletion attempts'], mitigationControls: ['EDR behavioral detection', 'Network segmentation', 'Immutable backups', 'Email filtering'], lessonsLearned: 'Ensure offline backups are tested quarterly and Ransomware-specific playbooks are updated with latest threat intelligence', lastDrillDate: '2026-03-15', nextDrillDate: '2026-06-15'},
    {id: 'z80b-IS-002', name: 'Cloud Misconfiguration Leading to Data Exposure', category: 'Cloud', likelihood: 'High', impact: 'High', riskScore: 16, playbooks: ['IR-Cloud-Misconfig-Assess', 'IR-Cloud-Misconfig-Remediate', 'IR-Cloud-Misconfig-Notify'], estimatedMTTD: '2h', estimatedMTTR: '6h', involvedTeams: ['Cloud Security', 'SOC', 'Data Protection', 'Legal'], keyIndicators: ['Public S3 bucket exposure', 'Overly permissive IAM policies', 'Unencrypted database snapshots', 'Public API endpoint discovery'], mitigationControls: ['CSPM monitoring', 'IAM policy analyzer', 'Automated remediation', 'Cloud audit logging'], lessonsLearned: 'Implement CSPM with auto-remediation for common misconfigurations and conduct monthly cloud configuration reviews', lastDrillDate: '2026-02-20', nextDrillDate: '2026-05-20'},
    {id: 'z80b-IS-003', name: 'Insider Threat Data Exfiltration', category: 'Insider', likelihood: 'Low', impact: 'Critical', riskScore: 12, playbooks: ['IR-Insider-Investigate', 'IR-Insider-Contain', 'IR-Insider-Escalate'], estimatedMTTD: '8h', estimatedMTTR: '24h', involvedTeams: ['SOC', 'IR', 'HR', 'Legal', 'IAM'], keyIndicators: ['Anomalous data access patterns', 'Large file downloads to USB or cloud', 'Off-hours access to sensitive systems', 'Accessing data outside normal job scope'], mitigationControls: ['UEBA analytics', 'DLP policies', 'PAM controls', 'Access reviews'], lessonsLearned: 'Strengthen UEBA baselines and implement automated alerts for data access pattern anomalies', lastDrillDate: '2026-01-10', nextDrillDate: '2026-04-10'},
    {id: 'z80b-IS-004', name: 'Supply Chain Attack via Compromised Vendor Software', category: 'Supply Chain', likelihood: 'Low', impact: 'Critical', riskScore: 12, playbooks: ['IR-SupplyChain-Detect', 'IR-SupplyChain-Isolate', 'IR-SupplyChain-Remediate'], estimatedMTTD: '24h', estimatedMTTR: '72h', involvedTeams: ['SOC', 'IR', 'Procurement', 'Vendor Mgmt', 'Legal'], keyIndicators: ['Unexpected network connections from vendor software', 'Modified binaries or dependencies', 'Anomalous behavior from trusted applications', 'SBOM discrepancy alerts'], mitigationControls: ['SCA scanning', 'SBOM monitoring', 'Vendor security assessments', 'Network segmentation'], lessonsLearned: 'Require SBOM from all vendors and implement continuous monitoring of third-party component behavior', lastDrillDate: '2026-03-01', nextDrillDate: '2026-06-01'},
    {id: 'z80b-IS-005', name: 'Credential Stuffing Attack on Customer Portal', category: 'External Attack', likelihood: 'High', impact: 'Medium', riskScore: 12, playbooks: ['IR-CredentialStuffing-Detect', 'IR-CredentialStuffing-Block', 'IR-CredentialStuffing-Notify'], estimatedMTTD: '30min', estimatedMTTR: '2h', involvedTeams: ['SOC', 'AppSec', 'Customer Support', 'Comms'], keyIndicators: ['High volume of failed login attempts', 'Login attempts from known compromised credential lists', 'Unusual geographic distribution of login attempts', 'Account takeover indicators'], mitigationControls: ['WAF rate limiting', 'CAPTCHA on login', 'MFA enforcement', 'Credential monitoring service'], lessonsLearned: 'Deploy advanced bot detection on login endpoints and implement proactive credential monitoring for customer accounts', lastDrillDate: '2026-04-01', nextDrillDate: '2026-07-01'},
    {id: 'z80b-IS-006', name: 'Phishing Campaign Targeting Executive Team', category: 'Social Engineering', likelihood: 'High', impact: 'High', riskScore: 16, playbooks: ['IR-Phishing-Contain', 'IR-Phishing-Investigate', 'IR-Phishing-Notify'], estimatedMTTD: '1h', estimatedMTTR: '4h', involvedTeams: ['SOC', 'Awareness', 'Executive Office', 'IT'], keyIndicators: ['Sophisticated spear-phishing emails to C-suite', 'Business email compromise indicators', 'Redirected MFA approval requests', 'Unauthorized wire transfer attempts'], mitigationControls: ['AI email filtering', 'Executive awareness training', 'Out-of-band verification policy', 'DMARC/DKIM/SPF'], lessonsLearned: 'Implement additional email security controls for executive mailboxes and conduct monthly spear-phishing simulations', lastDrillDate: '2026-02-15', nextDrillDate: '2026-05-15'}
  ];

  private _z80bSecurityFrameworks = [
  ...
  private _getz80bScenarioSummary(): {total: number; critical: number; high: number; drilled: number; avgRiskScore: number} {
    const crit = this._z80bIncidentScenarios.filter(s => s.impact === 'Critical').length;
    const high = this._z80bIncidentScenarios.filter(s => s.impact === 'High').length;
    const avg = this._z80bIncidentScenarios.reduce((s, x) => s + x.riskScore, 0) / this._z80bIncidentScenarios.length;
    return {total: this._z80bIncidentScenarios.length, critical: crit, high: high, drilled: this._z80bIncidentScenarios.length, avgRiskScore: Math.round(avg)};
  }

  private _getz80bVendorRiskSummary(): {total: number; approved: number; conditional: number; remediation: number; avgScore: number} {
    const approved = this._z80bThirdPartyRiskData.filter(v => v.status === 'approved').length;
    const cond = this._z80bThirdPartyRiskData.filter(v => v.status === 'conditional').length;
    const rem = this._z80bThirdPartyRiskData.filter(v => v.status === 'remediation_required').length;
    const avg = this._z80bThirdPartyRiskData.reduce((s, v) => s + v.riskScore, 0) / this._z80bThirdPartyRiskData.length;
    return {total: this._z80bThirdPartyRiskData.length, approved, conditional: cond, remediation: rem, avgScore: Math.round(avg)};
  }

  private _getz80bTrainingSummary(): {total: number; avgCompletion: number; avgScore: number; overdueUpdates: number} {
    const avgComp = this._z80bSecurityTrainingCatalog.reduce((s, t) => s + t.completionRate, 0) / this._z80bSecurityTrainingCatalog.length;
    const avgScore = this._z80bSecurityTrainingCatalog.filter(t => t.avgScore > 0).reduce((s, t) => s + t.avgScore, 0) / this._z80bSecurityTrainingCatalog.filter(t => t.avgScore > 0).length;
    return {total: this._z80bSecurityTrainingCatalog.length, avgCompletion: Math.round(avgComp * 10) / 10, avgScore: Math.round(avgScore), overdueUpdates: 0};
  }

  private _getz80bToolHealthSummary(): {total: number; healthy: number; degraded: number; annualCost: string} {
    const healthy = this._z80bSecurityToolInventory.filter(t => t.health === 'healthy').length;
    const degraded = this._z80bSecurityToolInventory.filter(t => t.health === 'degraded').length;
    const cost = this._z80bSecurityToolInventory.reduce((s, t) => s + parseInt(t.annualCost.replace(/[^0-9]/g, '')), 0);
    return {total: this._z80bSecurityToolInventory.length, healthy, degraded, annualCost: '$' + (cost / 1000).toFixed(0) + 'K'};
  }


  private _x80bSecurityZones = [
    {zoneId: 'x80b-Z-001', name: 'Internet DMZ', trustLevel: 'Untrusted', subnet: '10.0.0.0/24', segmentation: 'Dual-firewall', firewallRules: 45, monitoring: 'Full packet capture', assets: ['Web servers', 'Load balancers', 'WAF appliances', 'Reverse proxy'], riskLevel: 'high' as const, lastAssessment: '2026-04-15', nextAssessment: '2026-07-15'},
    {zoneId: 'x80b-Z-002', name: 'Corporate Network', trustLevel: 'Trusted', subnet: '10.1.0.0/16', segmentation: 'VLAN + micro-seg', firewallRules: 128, monitoring: 'NetFlow + IDS', assets: ['Workstations', 'Printers', 'Meeting room systems', 'VoIP phones'], riskLevel: 'medium' as const, lastAssessment: '2026-04-10', nextAssessment: '2026-07-10'},
    {zoneId: 'x80b-Z-003', name: 'Production Data Center', trustLevel: 'Restricted', subnet: '10.2.0.0/16', segmentation: 'Full micro-segmentation', firewallRules: 256, monitoring: 'Full packet capture + EDR', assets: ['Application servers', 'Database clusters', 'Message queues', 'API gateways'], riskLevel: 'low' as const, lastAssessment: '2026-04-12', nextAssessment: '2026-07-12'},
    {zoneId: 'x80b-Z-004', name: 'Management Network', trustLevel: 'Restricted', subnet: '10.3.0.0/24', segmentation: 'Isolated VLAN', firewallRules: 32, monitoring: 'Syslog + SNMP', assets: ['Hypervisors', 'Switch management', 'Storage controllers', 'Backup appliances'], riskLevel: 'low' as const, lastAssessment: '2026-04-08', nextAssessment: '2026-07-08'},
    {zoneId: 'x80b-Z-005', name: 'Cloud Production', trustLevel: 'Restricted', subnet: 'VPC: 172.16.0.0/12', segmentation: 'Security groups + NACLs', firewallRules: 189, monitoring: 'VPC Flow Logs + GuardDuty', assets: ['Kubernetes clusters', 'Managed databases', 'Object storage', 'Serverless functions'], riskLevel: 'medium' as const, lastAssessment: '2026-04-18', nextAssessment: '2026-07-18'}
  ];

  private _x80bSecurityAlerts = [
    {id: 'x80b-AL-001', severity: 'critical', title: 'Active ransomware encryption detected on PROD-DB-01', source: 'CrowdStrike', timestamp: '2026-04-22T13:45:00Z', status: 'investigating', assignee: 'SOC Analyst J. Smith', asset: 'PROD-DB-01 (10.2.1.15)', mitreTechnique: 'T1486 - Data Encrypted for Impact', playbook: 'IR-Ransomware-Isolate', sla: '15 minutes', elapsed: '12 minutes', notes: 'EDR detected mass file encryption event pattern. Automated isolation triggered. IR team paged.'},
    {id: 'x80b-AL-002', severity: 'high', title: 'Impossible travel detected for user admin@company.com', source: 'Okta', timestamp: '2026-04-22T12:30:00Z', status: 'triaged', assignee: 'SOC Analyst M. Johnson', asset: 'Okta - admin@company.com', mitreTechnique: 'T1078 - Valid Accounts', playbook: 'IR-ImpossibleTravel', sla: '30 minutes', elapsed: '87 minutes', notes: 'Login from Tokyo followed by login from New York within 30 minutes. Account temporarily locked. User confirmed via out-of-band channel they are in New York.'},
    {id: 'x80b-AL-003', severity: 'high', title: 'Public S3 bucket discovered with customer PII exposure', source: 'Prisma Cloud', timestamp: '2026-04-22T11:15:00Z', status: 'remediating', assignee: 'Cloud Security Lead A. Chen', asset: 'AWS S3: customer-data-archive-2024', mitreTechnique: 'N/A - Misconfiguration', playbook: 'IR-Cloud-Misconfig-Remediate', sla: '1 hour', elapsed: '2.5 hours', notes: 'Bucket containing archived customer records was publicly accessible. Bucket blocked and encrypted. Data exposure assessment in progress.'},
    {id: 'x80b-AL-004', severity: 'medium', title: 'Anomalous data download by user jane.developer@company.com', source: 'Microsoft DLP', timestamp: '2026-04-22T10:00:00Z', status: 'investigating', assignee: 'SOC Analyst R. Davis', asset: 'Endpoint: WS-DEV-042', mitreTechnique: 'T1567 - Exfil Over Web Service', playbook: 'IR-DLP-Investigation', sla: '4 hours', elapsed: '3.5 hours', notes: 'User downloaded 4.2GB of source code files to personal Google Drive. Interview scheduled with user and manager.'},
    {id: 'x80b-AL-005', severity: 'medium', title: 'Credential stuffing attack detected on customer portal', source: 'Cloudflare WAF', timestamp: '2026-04-22T09:30:00Z', status: 'contained', assignee: 'SOC Analyst K. Wilson', asset: 'Customer Portal (portal.company.com)', mitreTechnique: 'T1110 - Brute Force', playbook: 'IR-CredentialStuffing-Block', sla: '2 hours', elapsed: '4 hours', notes: 'Rate limiting and CAPTCHA automatically deployed. 12,000 failed login attempts from 800 unique IPs blocked. No successful account takeovers confirmed.'},
    {id: 'x80b-AL-006', severity: 'low', title: 'SSL certificate expiring in 14 days for api.company.com', source: 'Certificate monitoring', timestamp: '2026-04-22T08:00:00Z', status: 'remediated', assignee: 'Infrastructure Lead T. Brown', asset: 'api.company.com', mitreTechnique: 'N/A', playbook: 'Certificate Renewal', sla: '30 days', elapsed: '16 days', notes: 'Automated renewal triggered via ACME. New certificate deployed successfully. No service interruption.'}
  ];

  private _x80bComplianceFrameworks = [
  ...
  private _x80bDataClassificationPolicy = [
  ...
  private _getx80bZoneSummary(): {total: number; highRisk: number; mediumRisk: number; lowRisk: number; totalRules: number} {
    const high = this._x80bSecurityZones.filter(z => z.riskLevel === 'high').length;
    const med = this._x80bSecurityZones.filter(z => z.riskLevel === 'medium').length;
    const low = this._x80bSecurityZones.filter(z => z.riskLevel === 'low').length;
    const rules = this._x80bSecurityZones.reduce((s, z) => s + z.firewallRules, 0);
    return {total: this._x80bSecurityZones.length, highRisk: high, mediumRisk: med, lowRisk: low, totalRules: rules};
  }

  private _getx80bAlertSummary(): {total: number; critical: number; high: number; medium: number; low: number; open: number; contained: number} {
    const crit = this._x80bSecurityAlerts.filter(a => a.severity === 'critical').length;
    const high = this._x80bSecurityAlerts.filter(a => a.severity === 'high').length;
    const med = this._x80bSecurityAlerts.filter(a => a.severity === 'medium').length;
    const low = this._x80bSecurityAlerts.filter(a => a.severity === 'low').length;
    const open = this._x80bSecurityAlerts.filter(a => a.status === 'investigating' || a.status === 'triaged').length;
    const contained = this._x80bSecurityAlerts.filter(a => a.status === 'contained' || a.status === 'remediated').length;
    return {total: this._x80bSecurityAlerts.length, critical: crit, high, medium: med, low, open, contained};
  }

  private _getx80bComplianceSummary(): {total: number; fullyCompliant: number; mostlyCompliant: number; avgComplianceRate: number} {
    const full = this._x80bComplianceFrameworks.filter(f => f.status === 'compliant').length;
    const mostly = this._x80bComplianceFrameworks.filter(f => f.status === 'mostly_compliant').length;
    const avgRate = this._x80bComplianceFrameworks.reduce((s, f) => s + (f.compliant / f.requirements * 100), 0) / this._x80bComplianceFrameworks.length;
    return {total: this._x80bComplianceFrameworks.length, fullyCompliant: full, mostlyCompliant: mostly, avgComplianceRate: Math.round(avgRate * 10) / 10};
  }
  ...
  // === Security Risk Register (data_classif) ===
  private _data_classifRiskRegister = [
    { id: "RSK-DAT-0001", title: "Data breach from unpatched systems", owner: "CTO", category: "Financial", status: "mitigating", trend: "stable", severity: "critical", likelihood: 8, impact: 6, treatment: "Monitor and review quarterly", lastReview: "2026-04-18", nextReview: "2026-07-15" },
    { id: "RSK-DAT-0002", title: "Ransomware attack on critical infrastructure", owner: "CRO", category: "Strategic", status: "closed", trend: "decreasing", severity: "high", likelihood: 3, impact: 1, treatment: "Monitor and review quarterly", lastReview: "2026-04-08", nextReview: "2026-07-22" },
    { id: "RSK-DAT-0003", title: "Insider threat data exfiltration", owner: "VP Eng", category: "Compliance", status: "accepted", trend: "increasing", severity: "low", likelihood: 3, impact: 5, treatment: "Monitor and review quarterly", lastReview: "2026-04-07", nextReview: "2026-07-28" },
    { id: "RSK-DAT-0004", title: "Supply chain compromise", owner: "Security Lead", category: "Technical", status: "open", trend: "stable", severity: "high", likelihood: 5, impact: 5, treatment: "Monitor and review quarterly", lastReview: "2026-04-16", nextReview: "2026-07-18" },
    { id: "RSK-DAT-0005", title: "Cloud misconfiguration exposure", owner: "Risk Mgr", category: "Reputational", status: "mitigating", trend: "decreasing", severity: "low", likelihood: 10, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-08", nextReview: "2026-07-14" },
    { id: "RSK-DAT-0006", title: "Phishing campaign success rate", owner: "Compliance Dir", category: "Legal", status: "closed", trend: "increasing", severity: "medium", likelihood: 4, impact: 4, treatment: "Monitor and review quarterly", lastReview: "2026-04-06", nextReview: "2026-07-02" },
    { id: "RSK-DAT-0007", title: "Third-party vendor data breach", owner: "IT Dir", category: "Regulatory", status: "accepted", trend: "stable", severity: "critical", likelihood: 1, impact: 5, treatment: "Monitor and review quarterly", lastReview: "2026-04-09", nextReview: "2026-07-12" },
    { id: "RSK-DAT-0008", title: "Regulatory non-compliance penalty", owner: "DevOps Lead", category: "Third-Party", status: "open", trend: "decreasing", severity: "low", likelihood: 1, impact: 1, treatment: "Monitor and review quarterly", lastReview: "2026-04-23", nextReview: "2026-07-05" },
    { id: "RSK-DAT-0009", title: "Zero-day exploit in production", owner: "Architect", category: "Human Capital", status: "mitigating", trend: "increasing", severity: "critical", likelihood: 3, impact: 3, treatment: "Monitor and review quarterly", lastReview: "2026-04-16", nextReview: "2026-07-09" },
    { id: "RSK-DAT-0010", title: "Insufficient access controls", owner: "CISO", category: "Operational", status: "closed", trend: "stable", severity: "critical", likelihood: 9, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-19", nextReview: "2026-07-15" },
    { id: "RSK-DAT-0011", title: "DDoS attack on services", owner: "CTO", category: "Financial", status: "accepted", trend: "decreasing", severity: "high", likelihood: 6, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-04", nextReview: "2026-07-14" },
    { id: "RSK-DAT-0012", title: "Social engineering attack", owner: "CRO", category: "Strategic", status: "open", trend: "increasing", severity: "low", likelihood: 8, impact: 9, treatment: "Monitor and review quarterly", lastReview: "2026-04-20", nextReview: "2026-07-23" },
    { id: "RSK-DAT-0013", title: "API security vulnerability", owner: "VP Eng", category: "Compliance", status: "mitigating", trend: "stable", severity: "critical", likelihood: 6, impact: 5, treatment: "Monitor and review quarterly", lastReview: "2026-04-04", nextReview: "2026-07-22" },
    { id: "RSK-DAT-0014", title: "Mobile device compromise", owner: "Security Lead", category: "Technical", status: "closed", trend: "decreasing", severity: "low", likelihood: 8, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-07", nextReview: "2026-07-11" },
    { id: "RSK-DAT-0015", title: "Physical security breach", owner: "Risk Mgr", category: "Reputational", status: "accepted", trend: "increasing", severity: "high", likelihood: 3, impact: 10, treatment: "Monitor and review quarterly", lastReview: "2026-04-03", nextReview: "2026-07-18" },
    { id: "RSK-DAT-0016", title: "Password policy weakness", owner: "Compliance Dir", category: "Legal", status: "open", trend: "stable", severity: "low", likelihood: 2, impact: 1, treatment: "Monitor and review quarterly", lastReview: "2026-04-18", nextReview: "2026-07-23" },
    { id: "RSK-DAT-0017", title: "Network segmentation gap", owner: "IT Dir", category: "Regulatory", status: "mitigating", trend: "decreasing", severity: "low", likelihood: 4, impact: 2, treatment: "Monitor and review quarterly", lastReview: "2026-04-12", nextReview: "2026-07-20" },
    { id: "RSK-DAT-0018", title: "Encryption key management failure", owner: "DevOps Lead", category: "Third-Party", status: "closed", trend: "increasing", severity: "medium", likelihood: 1, impact: 8, treatment: "Monitor and review quarterly", lastReview: "2026-04-11", nextReview: "2026-07-15" },
    { id: "RSK-DAT-0019", title: "Audit trail tampering", owner: "Architect", category: "Human Capital", status: "accepted", trend: "stable", severity: "critical", likelihood: 1, impact: 1, treatment: "Monitor and review quarterly", lastReview: "2026-04-22", nextReview: "2026-07-21" },
    { id: "RSK-DAT-0020", title: "Business email compromise", owner: "CISO", category: "Operational", status: "open", trend: "decreasing", severity: "high", likelihood: 2, impact: 6, treatment: "Monitor and review quarterly", lastReview: "2026-04-09", nextReview: "2026-07-18" },
  ];
  private _data_classifRiskFilter: string = 'all';
  private _data_classifRiskSeverity: string = 'all';
  private _data_classifRiskStatus: string = 'all';
  private _data_classifExpandedRisk: string = '';
  private _data_classifFilterRisks() {
    const reg = this._data_classifRiskRegister;
    return reg.filter(r => {
      if (this._data_classifRiskFilter !== "all" && r.category !== this._data_classifRiskFilter) return false;
      if (this._data_classifRiskSeverity !== "all" && r.severity !== this._data_classifRiskSeverity) return false;
      if (this._data_classifRiskStatus !== "all" && r.status !== this._data_classifRiskStatus) return false;
      return true;
    });
  }
  private _data_classifGetRiskScore(r: any) { return Math.round(r.likelihood * r.impact * 1.5); }
  private _data_classifGetRiskTrendIcon(trend: string) {
    if (trend === "increasing") return "\u2191";
    if (trend === "decreasing") return "\u2193";
    return "\u2192";
  }
  private _data_classifGetRiskColor(sev: string) {
    if (sev === "critical") return "#dc2626";
    if (sev === "high") return "#ea580c";
    if (sev === "medium") return "#d97706";
    return "#16a34a";
  }
  private _data_classifGetRiskCounts() {
    const reg = this._data_classifRiskRegister;
  ...
  private _data_classifGetTreatmentProgress() {
    const reg = this._data_classifRiskRegister;
    const treated = reg.filter(r => r.status === "mitigating" || r.status === "closed").length;
    return Math.round((treated / Math.max(reg.length, 1)) * 100);
  }

  // === Security Metrics API Gateway (data_classif) ===
  private _data_classifApiEndpoints = [
    { method: "GET", path: "/api/v1/threats", name: "Threat Intelligence Feed", status: "active", avgLatency: 164.5, reqPerMin: 894.0, errorRate: 0.41, uptime: round(96.53151787733708,2), version: "v3.2.13" },
    { method: "POST", path: "/api/v1/scans/start", name: "Vulnerability Scanner", status: "active", avgLatency: 349.7, reqPerMin: 662.0, errorRate: 2.23, uptime: round(98.5184280605785,2), version: "v2.5.6" },
    { method: "GET", path: "/api/v1/assets", name: "Asset Inventory", status: "active", avgLatency: 235.3, reqPerMin: 556.0, errorRate: 2.48, uptime: round(99.9595298689666,2), version: "v1.8.3" },
    { method: "POST", path: "/api/v1/alerts", name: "Alert Management", status: "active", avgLatency: 199.6, reqPerMin: 299.0, errorRate: 1.78, uptime: round(99.1508063093271,2), version: "v1.5.5" },
    { method: "GET", path: "/api/v1/compliance", name: "Compliance Status", status: "active", avgLatency: 237.4, reqPerMin: 136.0, errorRate: 1.79, uptime: round(96.15516443048269,2), version: "v2.1.15" },
    { method: "PUT", path: "/api/v1/policies", name: "Policy Engine", status: "active", avgLatency: 287.8, reqPerMin: 1601.0, errorRate: 0.91, uptime: round(98.70439448108267,2), version: "v3.1.16" },
    { method: "GET", path: "/api/v1/incidents", name: "Incident Tracker", status: "active", avgLatency: 140.2, reqPerMin: 551.0, errorRate: 2.19, uptime: round(96.65694800411714,2), version: "v3.1.13" },
    { method: "POST", path: "/api/v1/forensics", name: "Forensics Collector", status: "degraded", avgLatency: 332.1, reqPerMin: 2161.0, errorRate: 1.05, uptime: round(95.57425102231096,2), version: "v1.1.11" },
    { method: "GET", path: "/api/v1/risk/assess", name: "Risk Assessment", status: "active", avgLatency: 233.3, reqPerMin: 1036.0, errorRate: 0.51, uptime: round(97.33184588518176,2), version: "v3.0.1" },
    { method: "POST", path: "/api/v1/auth/verify", name: "Authentication", status: "active", avgLatency: 123.6, reqPerMin: 2464.0, errorRate: 1.13, uptime: round(98.42331119622072,2), version: "v1.5.17" },
    { method: "GET", path: "/api/v1/logs/audit", name: "Audit Log Query", status: "active", avgLatency: 47.7, reqPerMin: 1280.0, errorRate: 2.26, uptime: round(97.08109063391427,2), version: "v2.7.10" },
    { method: "PUT", path: "/api/v1/users/roles", name: "Role Management", status: "active", avgLatency: 157.6, reqPerMin: 2189.0, errorRate: 1.26, uptime: round(99.46220742775463,2), version: "v2.8.13" },
    { method: "POST", path: "/api/v1/encrypt", name: "Encryption Service", status: "active", avgLatency: 35.5, reqPerMin: 1597.0, errorRate: 1.25, uptime: round(96.5066599074358,2), version: "v2.6.8" },
    { method: "GET", path: "/api/v1/network/topo", name: "Network Topology", status: "maintenance", avgLatency: 23.8, reqPerMin: 100.0, errorRate: 0.75, uptime: round(95.61993425646192,2), version: "v2.4.16" },
    { method: "DELETE", path: "/api/v1/sessions", name: "Session Manager", status: "active", avgLatency: 432.8, reqPerMin: 1856.0, errorRate: 0.07, uptime: round(98.02723221018003,2), version: "v3.7.4" },
  ];
  private _data_classifApiKeys = [
    { id: "ak-000001", name: "key-data-001", created: "2026-05-02", lastUsed: "2026-04-22", status: "active", calls: 21032, rateLimit: 1000 },
    { id: "ak-000002", name: "key-data-002", created: "2026-08-20", lastUsed: "2026-04-06", status: "active", calls: 9448, rateLimit: 500 },
    { id: "ak-000003", name: "key-data-003", created: "2026-07-09", lastUsed: "2026-04-05", status: "active", calls: 14379, rateLimit: 500 },
    { id: "ak-000004", name: "key-data-004", created: "2026-05-25", lastUsed: "2026-04-05", status: "revoked", calls: 13114, rateLimit: 100 },
    { id: "ak-000005", name: "key-data-005", created: "2026-01-08", lastUsed: "2026-04-13", status: "revoked", calls: 8788, rateLimit: 5000 },
    { id: "ak-000006", name: "key-data-006", created: "2026-07-02", lastUsed: "2026-04-09", status: "revoked", calls: 40609, rateLimit: 100 },
    { id: "ak-000007", name: "key-data-007", created: "2026-06-14", lastUsed: "2026-04-04", status: "revoked", calls: 9883, rateLimit: 500 },
    { id: "ak-000008", name: "key-data-008", created: "2026-07-15", lastUsed: "2026-04-16", status: "active", calls: 25198, rateLimit: 100 },
  ];
  private _data_classifApiHealthSummary() {
    const eps = this._data_classifApiEndpoints;
  ...
  private _data_classifGetApiByMethod(method: string) { return this._data_classifApiEndpoints.filter(e=>e.method===method); }
  private _data_classifGetSlowEndpoints() { return this._data_classifApiEndpoints.filter(e=>e.avgLatency>200).sort((a,b)=>b.avgLatency-a.avgLatency); }
  private _data_classifGetHighErrorEndpoints() { return this._data_classifApiEndpoints.filter(e=>e.errorRate>1.0).sort((a,b)=>b.errorRate-a.errorRate); }

  // === Security Training Effectiveness (data_classif) ===
  private _data_classifTrainingModules = [
    { id: "TRN-001", name: "Security Fundamentals", completionRate: 73.5, avgScore: 92.7, behaviorChange: 65.9, enrolled: 468, completed: 261, duration: "94min", category: "mandatory" },
    { id: "TRN-002", name: "Phishing Awareness", completionRate: 57.9, avgScore: 86.8, behaviorChange: 64.6, enrolled: 174, completed: 76, duration: "85min", category: "mandatory" },
    { id: "TRN-003", name: "Social Engineering Defense", completionRate: 67.2, avgScore: 80.5, behaviorChange: 32.7, enrolled: 331, completed: 422, duration: "64min", category: "optional" },
    { id: "TRN-004", name: "Password Hygiene", completionRate: 91.8, avgScore: 65.0, behaviorChange: 57.6, enrolled: 55, completed: 217, duration: "48min", category: "mandatory" },
    { id: "TRN-005", name: "Data Classification", completionRate: 86.2, avgScore: 68.0, behaviorChange: 84.8, enrolled: 85, completed: 152, duration: "92min", category: "mandatory" },
    { id: "TRN-006", name: "Incident Response Basics", completionRate: 46.6, avgScore: 68.2, behaviorChange: 82.4, enrolled: 275, completed: 334, duration: "57min", category: "mandatory" },
    { id: "TRN-007", name: "Secure Coding", completionRate: 55.1, avgScore: 88.9, behaviorChange: 43.4, enrolled: 268, completed: 428, duration: "113min", category: "optional" },
    { id: "TRN-008", name: "Cloud Security", completionRate: 94.3, avgScore: 75.0, behaviorChange: 72.2, enrolled: 275, completed: 184, duration: "63min", category: "mandatory" },
    { id: "TRN-009", name: "Mobile Device Security", completionRate: 83.5, avgScore: 67.3, behaviorChange: 39.5, enrolled: 243, completed: 344, duration: "50min", category: "mandatory" },
    { id: "TRN-010", name: "Network Security", completionRate: 86.6, avgScore: 82.6, behaviorChange: 47.6, enrolled: 465, completed: 58, duration: "79min", category: "mandatory" },
    { id: "TRN-011", name: "Physical Security", completionRate: 59.4, avgScore: 66.7, behaviorChange: 83.9, enrolled: 296, completed: 239, duration: "102min", category: "optional" },
    { id: "TRN-012", name: "Regulatory Compliance", completionRate: 90.2, avgScore: 83.0, behaviorChange: 47.7, enrolled: 495, completed: 178, duration: "45min", category: "mandatory" },
    { id: "TRN-013", name: "Risk Management", completionRate: 88.6, avgScore: 76.2, behaviorChange: 30.0, enrolled: 76, completed: 170, duration: "87min", category: "mandatory" },
    { id: "TRN-014", name: "Cryptography Basics", completionRate: 85.6, avgScore: 65.8, behaviorChange: 75.5, enrolled: 384, completed: 397, duration: "67min", category: "mandatory" },
    { id: "TRN-015", name: "Access Control", completionRate: 71.3, avgScore: 77.1, behaviorChange: 79.3, enrolled: 327, completed: 438, duration: "74min", category: "optional" },
    { id: "TRN-016", name: "Vendor Management", completionRate: 54.7, avgScore: 89.2, behaviorChange: 32.4, enrolled: 78, completed: 323, duration: "24min", category: "mandatory" },
  ];
  private _data_classifPhishingResults = [
    { month: "2026-01", sent: 670, clicked: 94, reported: 298, clickRate: round(14.029850746268657,1), reportRate: round(44.47761194029851,1) },
    { month: "2026-02", sent: 333, clicked: 37, reported: 15, clickRate: round(11.11111111111111,1), reportRate: round(4.504504504504505,1) },
    { month: "2026-03", sent: 733, clicked: 56, reported: 410, clickRate: round(7.639836289222374,1), reportRate: round(55.934515688949524,1) },
    { month: "2026-04", sent: 736, clicked: 130, reported: 418, clickRate: round(17.66304347826087,1), reportRate: round(56.79347826086957,1) },
    { month: "2026-05", sent: 828, clicked: 164, reported: 76, clickRate: round(19.806763285024154,1), reportRate: round(9.178743961352657,1) },
    { month: "2026-06", sent: 886, clicked: 207, reported: 299, clickRate: round(23.363431151241535,1), reportRate: round(33.747178329571106,1) },
  ];
  private _data_classifTrainingROI = { totalInvestment: 104209, avgCostPerEmployee: 365, riskReductionPct: round(random.uniform(15,45),1), incidentReductionPct: round(random.uniform(10,35),1), complianceScoreGain: round(random.uniform(5,25),1) };
  private _data_classifLearningPaths = [
    { name: "Beginner Security Analyst", totalModules: 12, completedModules: 10, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 35, enrolled: 103 },
    { name: "Advanced Threat Hunter", totalModules: 20, completedModules: 16, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 18, enrolled: 190 },
    { name: "Security Architect", totalModules: 10, completedModules: 13, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 20, enrolled: 28 },
    { name: "Incident Responder", totalModules: 12, completedModules: 6, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 57, enrolled: 180 },
    { name: "Compliance Specialist", totalModules: 17, completedModules: 15, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 71, enrolled: 31 },
    { name: "DevSecOps Engineer", totalModules: 17, completedModules: 17, progress: round(random.uniform(10,95),1), estimatedHoursLeft: 12, enrolled: 166 },
  ];
  private _data_classifGetOverallCompletion() {
    const mods = this._data_classifTrainingModules;
    return round(mods.reduce((s,m)=>s+m.completionRate,0)/mods.length,1);
  }
  private _data_classifGetTopPerformers() { return [...this._data_classifTrainingModules].sort((a,b)=>b.avgScore-a.avgScore).slice(0,5); }
  private _data_classifGetModulesNeedingAttention() { return this._data_classifTrainingModules.filter(m=>m.completionRate<70||m.avgScore<65); }

  // === Security Governance Framework (data_classif) ===
  private _data_classifGovBodies = [
    { name: "Security Steering Committee", members: 14, chair: "CISO", meetingFreq: "Weekly", lastMeeting: "2026-04-08", nextMeeting: "2026-05-09", quorum: 7 },
    { name: "Risk Management Board", members: 5, chair: "CTO", meetingFreq: "Bi-weekly", lastMeeting: "2026-04-03", nextMeeting: "2026-05-27", quorum: 5 },
    { name: "Data Governance Council", members: 6, chair: "CRO", meetingFreq: "Monthly", lastMeeting: "2026-04-06", nextMeeting: "2026-05-12", quorum: 5 },
    { name: "Compliance Oversight Board", members: 8, chair: "CDO", meetingFreq: "Monthly", lastMeeting: "2026-04-10", nextMeeting: "2026-05-23", quorum: 3 },
    { name: "Architecture Review Board", members: 11, chair: "VP Eng", meetingFreq: "Bi-weekly", lastMeeting: "2026-04-03", nextMeeting: "2026-05-08", quorum: 3 },
    { name: "Change Advisory Board", members: 8, chair: "CISO", meetingFreq: "Weekly", lastMeeting: "2026-04-10", nextMeeting: "2026-05-12", quorum: 6 },
    { name: "Incident Review Board", members: 15, chair: "CIO", meetingFreq: "As needed", lastMeeting: "2026-04-08", nextMeeting: "2026-05-05", quorum: 5 },
    { name: "Vendor Risk Committee", members: 5, chair: "CFO", meetingFreq: "Quarterly", lastMeeting: "2026-04-08", nextMeeting: "2026-05-27", quorum: 7 },
  ];
  private _data_classifDecisions = [
    { id: "DEC-0001", title: "Adopt zero-trust architecture framework", date: "2026-02-12", status: "approved", owner: "CISO" },
    { id: "DEC-0002", title: "Migrate to SIEM 2.0 platform", date: "2026-04-13", status: "implemented", owner: "CTO" },
    { id: "DEC-0003", title: "Implement DLP across all endpoints", date: "2026-01-02", status: "in-progress", owner: "Security Lead" },
    { id: "DEC-0004", title: "Mandate MFA for all external access", date: "2026-04-05", status: "pending", owner: "CRO" },
    { id: "DEC-0005", title: "Establish bug bounty program", date: "2026-01-27", status: "approved", owner: "VP Eng" },
    { id: "DEC-0006", title: "Deploy EDR solution enterprise-wide", date: "2026-03-24", status: "approved", owner: "CISO" },
    { id: "DEC-0007", title: "Conduct annual penetration testing", date: "2026-04-06", status: "implemented", owner: "CTO" },
    { id: "DEC-0008", title: "Implement network micro-segmentation", date: "2026-03-16", status: "in-progress", owner: "Security Lead" },
    { id: "DEC-0009", title: "Establish security champion program", date: "2026-01-25", status: "pending", owner: "CRO" },
    { id: "DEC-0010", title: "Migrate to passwordless authentication", date: "2026-04-06", status: "approved", owner: "VP Eng" },
  ];
  private _data_classifPolicyLifecycle = [
    { name: "Information Security Policy", version: "v3.0", status: "active", lastUpdated: "2026-01-23", nextReview: "2026-9-18", owner: "CISO" },
    { name: "Acceptable Use Policy", version: "v3.5", status: "active", lastUpdated: "2026-03-21", nextReview: "2026-9-24", owner: "Legal" },
    { name: "Data Retention Policy", version: "v4.5", status: "under-review", lastUpdated: "2026-02-23", nextReview: "2026-9-28", owner: "DPO" },
    { name: "Access Control Policy", version: "v3.1", status: "active", lastUpdated: "2026-03-12", nextReview: "2026-7-02", owner: "IAM Lead" },
    { name: "Incident Response Policy", version: "v4.4", status: "draft", lastUpdated: "2026-01-15", nextReview: "2026-9-09", owner: "IR Lead" },
    { name: "Business Continuity Plan", version: "v2.5", status: "active", lastUpdated: "2026-03-25", nextReview: "2026-9-08", owner: "BCP Mgr" },
    { name: "Vendor Management Policy", version: "v2.0", status: "active", lastUpdated: "2026-04-19", nextReview: "2026-9-28", owner: "Procurement" },
    { name: "Encryption Standard", version: "v2.0", status: "under-review", lastUpdated: "2026-04-10", nextReview: "2026-11-17", owner: "Security Arch" },
  ];
  private _data_classifGovMaturityScore = { overall: 4.7, riskManagement: 4.4, compliance: 5.6, incidentResponse: 5.5, awareness: 2.2, technology: 3.9 };
  private _data_classifGetPendingDecisions() { return this._data_classifDecisions.filter(d=>d.status==='pending'||d.status==='in-progress'); }
  private _data_classifGetActivePolicies() { return this._data_classifPolicyLifecycle.filter(p=>p.status==='active'); }
  private _data_classifGetEscalationPath() { return ["L1 Analyst","L2 Senior","Security Lead","CISO","Board"]; }

  // === Security Innovation Lab (data_classif) ===
  private _data_classifInnoProjects = [
    { id: "INN-001", name: "AI-Powered Threat Detection", description: "Machine learning models for real-time threat identification", status: "active", progress: 72, startDate: "2026-02-25", teamSize: 2, budget: 123209, milestones: 3, completedMilestones: 7 },
    { id: "INN-002", name: "Quantum-Resistant Cryptography", description: "Post-quantum encryption algorithm prototyping", status: "research", progress: 35, startDate: "2026-03-11", teamSize: 5, budget: 184781, milestones: 8, completedMilestones: 5 },
    { id: "INN-003", name: "Automated Red Teaming", description: "Autonomous penetration testing framework", status: "active", progress: 58, startDate: "2026-01-13", teamSize: 3, budget: 82778, milestones: 5, completedMilestones: 2 },
    { id: "INN-004", name: "Zero-Knowledge Authentication", description: "Privacy-preserving identity verification", status: "poc", progress: 88, startDate: "2026-01-09", teamSize: 4, budget: 25162, milestones: 3, completedMilestones: 3 },
    { id: "INN-005", name: "Blockchain Audit Trail", description: "Immutable security event logging", status: "active", progress: 45, startDate: "2026-02-11", teamSize: 5, budget: 126177, milestones: 3, completedMilestones: 8 },
    { id: "INN-006", name: "Behavioral Biometrics", description: "Continuous authentication via user behavior patterns", status: "research", progress: 22, startDate: "2026-01-23", teamSize: 5, budget: 174043, milestones: 3, completedMilestones: 3 },
    { id: "INN-007", name: "Deception Grid 2.0", description: "Advanced honeypot network with adaptive responses", status: "active", progress: 65, startDate: "2026-01-24", teamSize: 4, budget: 108885, milestones: 6, completedMilestones: 2 },
    { id: "INN-008", name: "Secure Enclave Integration", description: "Hardware-backed security for critical workloads", status: "poc", progress: 40, startDate: "2026-03-11", teamSize: 2, budget: 171045, milestones: 8, completedMilestones: 3 },
  ];
  private _data_classifTechEvaluations = [
    { name: "Rust for Security Tools", status: "evaluating", score: 6.5, recommendation: "Adopt", vendor: "Open Source" },
    ...
    { name: "SASE Architecture", status: "completed", score: 3.9, recommendation: "Adopt", vendor: "Multiple" },
    { name: "SOAR Platform 3.0", status: "planned", score: 9.5, recommendation: "Monitor", vendor: "Splunk" },
  ];
  private _data_classifCollaborationPartners = [
  ...
  private _data_classifInnoMetrics = { totalProjects: 8, activeProjects: 4, avgTimeToValue: "88 days", pocSuccessRate: round(random.uniform(55,85),1), researchToProduction: round(random.uniform(20,50),1), innovationIndex: round(random.uniform(6.0,9.5),1) };
  private _data_classifGetProjectByStatus(status: string) { return this._data_classifInnoProjects.filter(p=>p.status===status); }
  private _data_classifGetTopEvaluations() { return [...this._data_classifTechEvaluations].sort((a,b)=>b.score-a.score).slice(0,3); }



  // === Compliance Dashboard Extension (data_classif) ===
  private _data_classifComplianceFrameworks = [
    { name: "SOC 2 Type II", description: "Trust Services Criteria", totalControls: 5, implementedControls: 2, status: "partially-compliant", lastAudit: "2026-02-05", nextAudit: "2026-9-20", evidenceCount: 255 },
    { name: "ISO 27001", description: "Information Security Management", totalControls: 114, implementedControls: 63, status: "in-review", lastAudit: "2026-04-20", nextAudit: "2026-9-03", evidenceCount: 427 },
    { name: "PCI DSS 4.0", description: "Payment Card Industry", totalControls: 12, implementedControls: 7, status: "partially-compliant", lastAudit: "2026-03-12", nextAudit: "2026-7-12", evidenceCount: 150 },
    { name: "HIPAA", description: "Health Insurance Portability", totalControls: 18, implementedControls: 9, status: "partially-compliant", lastAudit: "2026-01-13", nextAudit: "2026-8-10", evidenceCount: 461 },
    { name: "GDPR", description: "Data Protection Regulation", totalControls: 99, implementedControls: 78, status: "in-review", lastAudit: "2026-03-18", nextAudit: "2026-8-20", evidenceCount: 52 },
    { name: "NIST CSF 2.0", description: "Cybersecurity Framework", totalControls: 6, implementedControls: 4, status: "in-review", lastAudit: "2026-03-04", nextAudit: "2026-8-13", evidenceCount: 112 },
    { name: "FedRAMP", description: "Federal Risk Authorization", totalControls: 15, implementedControls: 7, status: "partially-compliant", lastAudit: "2026-04-28", nextAudit: "2026-7-08", evidenceCount: 496 },
    { name: "SOX", description: "Sarbanes-Oxley Compliance", totalControls: 8, implementedControls: 7, status: "in-review", lastAudit: "2026-03-02", nextAudit: "2026-12-28", evidenceCount: 222 },
    { name: "CIS Controls v8", description: "Center for Internet Security", totalControls: 18, implementedControls: 15, status: "partially-compliant", lastAudit: "2026-04-28", nextAudit: "2026-10-21", evidenceCount: 99 },
    { name: "COBIT 2019", description: "IT Governance Framework", totalControls: 40, implementedControls: 29, status: "non-compliant", lastAudit: "2026-03-14", nextAudit: "2026-11-12", evidenceCount: 402 },
  ];
  private _data_classifGetComplianceScore() {
    const fw = this._data_classifComplianceFrameworks;
    return round(fw.reduce((s,f)=>s + (f.implementedControls/Math.max(f.totalControls,1))*100, 0) / fw.length, 1);
  }
  private _data_classifGetGaps() {
    return this._data_classifComplianceFrameworks.filter(f => f.status !== "compliant");
  }
  private _data_classifAuditTrail = [
    { id: "AUD-0001", action: "Control tested", auditor: "Internal Audit", date: "2026-04-13", result: "pass", findings: 1 },
    { id: "AUD-0002", action: "Evidence collected", auditor: "External Auditor", date: "2026-04-14", result: "pass", findings: 3 },
    { id: "AUD-0003", action: "Gap identified", auditor: "Security Team", date: "2026-04-15", result: "fail", findings: 5 },
    { id: "AUD-0004", action: "Remediation completed", auditor: "Compliance Officer", date: "2026-04-21", result: "pass", findings: 1 },
    { id: "AUD-0005", action: "Policy updated", auditor: "IT Audit", date: "2026-04-18", result: "pass", findings: 0 },
    { id: "AUD-0006", action: "Training verified", auditor: "Risk Team", date: "2026-04-10", result: "pass", findings: 1 },
    { id: "AUD-0007", action: "Access reviewed", auditor: "QA Team", date: "2026-04-15", result: "pass", findings: 5 },
    { id: "AUD-0008", action: "Exception approved", auditor: "CISO Office", date: "2026-04-10", result: "conditional", findings: 1 },
    { id: "AUD-0009", action: "Risk accepted", auditor: "Board Audit", date: "2026-04-06", result: "pass", findings: 3 },
    { id: "AUD-0010", action: "Control enhanced", auditor: "Third Party", date: "2026-04-18", result: "pass", findings: 3 },
  ];

  // === Threat Intelligence Feed Extension (data_classif) ===
  private _data_classifThreatActors = [
    { name: "APT-29", alias: "Cozy Bear", origin: "Russia", type: "Nation-State", severity: "high", lastActivity: "2026-04-04", targets: "Finance", indicators: 36, ttps: 35 },
    { name: "APT-41", alias: "Double Dragon", origin: "China", type: "Nation-State", severity: "critical", lastActivity: "2026-04-18", targets: "Healthcare", indicators: 287, ttps: 45 },
    { name: "Lazarus Group", alias: "Hidden Cobra", origin: "North Korea", type: "Nation-State", severity: "critical", lastActivity: "2026-04-08", targets: "Technology", indicators: 116, ttps: 42 },
    { name: "FIN7", alias: "Carbanak", origin: "Eastern Europe", type: "Financial", severity: "high", lastActivity: "2026-04-14", targets: "Manufacturing", indicators: 149, ttps: 30 },
    { name: "Conti", alias: "Wizard Spider", origin: "Russia", type: "Ransomware", severity: "critical", lastActivity: "2026-04-14", targets: "Manufacturing", indicators: 205, ttps: 21 },
    { name: "LockBit", alias: "LockBit Gang", origin: "Unknown", type: "Ransomware", severity: "high", lastActivity: "2026-04-23", targets: "Technology", indicators: 276, ttps: 47 },
    { name: "Cl0p", alias: "Cl0p Team", origin: "Unknown", type: "Ransomware", severity: "high", lastActivity: "2026-04-15", targets: "Energy", indicators: 25, ttps: 33 },
    { name: "Sandworm", alias: "Unit 74455", origin: "Russia", type: "Nation-State", severity: "critical", lastActivity: "2026-04-09", targets: "Technology", indicators: 398, ttps: 44 },
  ];
  private _data_classifIoCFeed = [
    { id: "ioc-000001", type: "ip", value: "152.85.201.26", confidence: 76, source: "MISP", firstSeen: "2026-04-14", lastSeen: "2026-04-18" },
    { id: "ioc-000002", type: "ip", value: "39.104.206.22", confidence: 98, source: "MISP", firstSeen: "2026-04-14", lastSeen: "2026-04-14" },
    { id: "ioc-000003", type: "ip", value: "253.254.72.62", confidence: 76, source: "Mandiant", firstSeen: "2026-04-20", lastSeen: "2026-04-15" },
    { id: "ioc-000004", type: "ip", value: "68.206.7.199", confidence: 99, source: "MISP", firstSeen: "2026-04-07", lastSeen: "2026-04-17" },
    { id: "ioc-000005", type: "ip", value: "58.221.197.229", confidence: 56, source: "AlienVault", firstSeen: "2026-04-09", lastSeen: "2026-04-20" },
    { id: "ioc-000006", type: "ip", value: "135.245.202.155", confidence: 94, source: "MISP", firstSeen: "2026-04-17", lastSeen: "2026-04-16" },
    { id: "ioc-000007", type: "ip", value: "34.111.78.78", confidence: 78, source: "CrowdStrike", firstSeen: "2026-04-03", lastSeen: "2026-04-22" },
    { id: "ioc-000008", type: "ip", value: "130.254.226.65", confidence: 81, source: "STIX", firstSeen: "2026-04-08", lastSeen: "2026-04-01" },
    { id: "ioc-000009", type: "ip", value: "157.138.137.203", confidence: 62, source: "STIX", firstSeen: "2026-04-13", lastSeen: "2026-04-02" },
    { id: "ioc-000010", type: "ip", value: "173.185.239.11", confidence: 91, source: "MISP", firstSeen: "2026-04-06", lastSeen: "2026-04-16" },
    { id: "ioc-000011", type: "ip", value: "229.91.48.210", confidence: 90, source: "VirusTotal", firstSeen: "2026-04-03", lastSeen: "2026-04-07" },
    { id: "ioc-000012", type: "ip", value: "163.120.214.161", confidence: 78, source: "MISP", firstSeen: "2026-04-21", lastSeen: "2026-04-09" },
    { id: "ioc-000013", type: "ip", value: "42.174.230.249", confidence: 69, source: "CrowdStrike", firstSeen: "2026-04-22", lastSeen: "2026-04-12" },
    { id: "ioc-000014", type: "ip", value: "210.0.180.185", confidence: 80, source: "VirusTotal", firstSeen: "2026-04-14", lastSeen: "2026-04-05" },
    { id: "ioc-000015", type: "ip", value: "174.110.233.5", confidence: 80, source: "MISP", firstSeen: "2026-04-14", lastSeen: "2026-04-06" },
  ];
  private _data_classifGetActiveThreats() { return this._data_classifThreatActors.filter(a => a.severity === 'critical'); }
  private _data_classifGetThreatSummary() {
    const actors = this._data_classifThreatActors;
  ...
  // === Incident Management Extension (data_classif) ===
  private _data_classifIncidents = [
    { id: "INC-20260001", title: "Unauthorized access detected", severity: "critical", status: "open", assignedTo: "SOC L1", detectedAt: "2026-04-14T23:38", affectedAssets: 11, rootCause: "Misconfiguration" },
    { id: "INC-20260002", title: "Malware outbreak on workstation", severity: "high", status: "investigating", assignedTo: "SOC L2", detectedAt: "2026-04-12T13:57", affectedAssets: 38, rootCause: "Credential compromise" },
    { id: "INC-20260003", title: "Data leak from S3 bucket", severity: "medium", status: "contained", assignedTo: "IR Lead", detectedAt: "2026-04-14T02:13", affectedAssets: 5, rootCause: "Zero-day" },
    { id: "INC-20260004", title: "Phishing campaign targeting finance", severity: "low", status: "eradicated", assignedTo: "CISO", detectedAt: "2026-04-04T05:52", affectedAssets: 19, rootCause: "Human error" },
    { id: "INC-20260005", title: "DDoS attack on web services", severity: "critical", status: "recovered", assignedTo: "Security Eng", detectedAt: "2026-04-14T11:52", affectedAssets: 43, rootCause: "Policy violation" },
    { id: "INC-20260006", title: "Ransomware encryption attempt", severity: "high", status: "closed", assignedTo: "Forensics", detectedAt: "2026-04-10T17:14", affectedAssets: 4, rootCause: "Unknown" },
    { id: "INC-20260007", title: "Insider data exfiltration", severity: "medium", status: "open", assignedTo: "SOC L1", detectedAt: "2026-04-06T02:01", affectedAssets: 23, rootCause: "Misconfiguration" },
    { id: "INC-20260008", title: "API key exposure in repo", severity: "low", status: "investigating", assignedTo: "SOC L2", detectedAt: "2026-04-06T13:45", affectedAssets: 23, rootCause: "Credential compromise" },
    { id: "INC-20260009", title: "SQL injection on portal", severity: "critical", status: "contained", assignedTo: "IR Lead", detectedAt: "2026-04-09T08:03", affectedAssets: 12, rootCause: "Zero-day" },
    { id: "INC-20260010", title: "Brute force on VPN", severity: "high", status: "eradicated", assignedTo: "CISO", detectedAt: "2026-04-21T23:14", affectedAssets: 13, rootCause: "Human error" },
    { id: "INC-20260011", title: "Supply chain alert from vendor", severity: "medium", status: "recovered", assignedTo: "Security Eng", detectedAt: "2026-04-03T15:07", affectedAssets: 19, rootCause: "Policy violation" },
    { id: "INC-20260012", title: "Suspicious lateral movement", severity: "low", status: "closed", assignedTo: "Forensics", detectedAt: "2026-04-05T01:23", affectedAssets: 23, rootCause: "Unknown" },
  ];
  private _data_classifGetIncidentStats() {
    const inc = this._data_classifIncidents;
    return { total: inc.length, open: inc.filter(i=>i.status==="open").length, investigating: inc.filter(i=>i.status==="investigating").length, mttd: 6, mttr: 33 };
  }
  private _data_classifGetSeverityDistribution() {
    const inc = this._data_classifIncidents;
  ...
  private _initDataClassificationMetricsEngine() {
    this._data_classificationNormalizationRules = [
    ...
    this._data_classificationIndustryBenchmarks = this._loadDataClassificationBenchmarks();
    this._data_classificationKpiCatalog = this._defineDataClassificationKpiCatalog();
    this._data_classificationMetricOwnership = this._buildDataClassificationMetricOwnership();
    this._data_classificationNormTrends = this._calcDataClassificationNormTrends();
  }

  private _loadDataClassificationBenchmarks(): Array<Record<string, unknown>> {
    return [
  ...
  private _defineDataClassificationKpiCatalog(): Array<Record<string, unknown>> {
    return [
  ...
  private _buildDataClassificationMetricOwnership(): Array<Record<string, unknown>> {
    return [
  ...
  private _calcDataClassificationNormTrends(): Array<Record<string, unknown>> {
  ...
  private _initDataClassificationSocIntelHub() {
    this._data_classificationThreatActors = [
    ...
    this._data_classificationTtpMapping = this._buildDataClassificationTtpMatrix();
    this._data_classificationThreatCampaigns = this._trackDataClassificationActiveCampaigns();
    this._data_classificationIntelFeeds = this._configureDataClassificationIntelFeeds();
    this._data_classificationThreatScores = this._calcDataClassificationThreatScores();
    this._data_classificationPredictiveAnalysis = this._runDataClassificationPredictiveThreatModel();
  }

  private _buildDataClassificationTtpMatrix(): Array<Record<string, unknown>> {
    const techniques = [
  ...
  private _trackDataClassificationActiveCampaigns(): Array<Record<string, unknown>> {
    return [
  ...
  private _configureDataClassificationIntelFeeds(): Array<Record<string, unknown>> {
    return [
  ...
  private _calcDataClassificationThreatScores(): Array<Record<string, unknown>> {
    return this._data_classificationThreatActors.map((actor: Record<string, unknown>) => ({
  ...
  private _runDataClassificationPredictiveThreatModel(): Array<Record<string, unknown>> {
    return [
  ...
  private _initDataClassificationWorkflowEngine() {
    this._data_classificationWorkflows = [
    ...
    this._data_classificationWorkflowMetrics = this._aggregateDataClassificationWorkflowMetrics();
    this._data_classificationWorkflowBottlenecks = this._identifyDataClassificationBottlenecks();
    this._data_classificationAutomationROI = this._calcDataClassificationAutomationROI();
  }

  private _aggregateDataClassificationWorkflowMetrics(): Record<string, unknown> {
    const totalRuns = this._data_classificationWorkflows.reduce((s: number, w: Record<string, unknown>) => s + Number(w.totalRuns), 0);
    const avgSuccess = this._data_classificationWorkflows.reduce((s: number, w: Record<string, unknown>) => s + Number(w.successRate), 0) / this._data_classificationWorkflows.length;
    const totalAutoSteps = this._data_classificationWorkflows.reduce((s: number, w: Record<string, unknown>) => s + Number(w.autoSteps), 0);
    const totalManualSteps = this._data_classificationWorkflows.reduce((s: number, w: Record<string, unknown>) => s + Number(w.manualSteps), 0);
    return {
      ...
      activeWorkflows: this._data_classificationWorkflows.filter((w: Record<string, unknown>) => w.active).length,
      avgStepsPerWorkflow: Math.round((totalAutoSteps + totalManualSteps) / this._data_classificationWorkflows.length)
    };
  }

  private _identifyDataClassificationBottlenecks(): Array<Record<string, unknown>> {
    return [
  ...
  private _calcDataClassificationAutomationROI(): Array<Record<string, unknown>> {
    return this._data_classificationWorkflows.map((w: Record<string, unknown>) => ({
  ...
  private _runDataClassificationPostureAssessment() {
    this._data_classificationPostureDimensions = [
    ...
    this._data_classificationOverallPostureScore = this._data_classificationPostureDimensions.reduce(
      (s: number, d: Record<string, unknown>) => s + Number(d.score) * Number(d.weight), 0
    );
    this._data_classificationPostureHistory = Array.from({ length: 30 }, (_, i) => ({
    ...
    this._data_classificationPostureRecommendations = this._generateDataClassificationPostureRecommendations();
  }

  private _generateDataClassificationPostureRecommendations(): Array<Record<string, unknown>> {
    return [
...
<div class="tabs">
        ...
        ${this._activeTab === 'rules' ? html`
          ...
          <div style="background:#1a1d27;border-radius:8px;padding:12px">${this._renderDcTreemapSVG()}</div>
          <div style="margin-top:12px;font-size:11px;font-weight:600;margin-bottom:6px">Data Flow (Sankey)</div>
          <div style="background:#1a1d27;border-radius:8px;padding:12px">${this._renderDcSankeySVG()}</div>
          ${this._renderDcActivity()}
        ` : nothing}
        ${this._activeTab === 'anomalies' ? html`
          ${this._renderDcAnomalies()}
          ${this._renderDcNotifications()}
        ` : nothing}
        ${this._activeTab === 'predictions' ? html`
          ${this._renderDcPredictions()}
          ...
          <div style="background:#1a1d27;border-radius:8px;padding:12px">
            <table class="history-table"><thead><tr><th>ID</th><th>Base</th><th>Temporal</th><th>Environmental</th><th>Overall</th></tr></thead><tbody>
              ${this._dccvssData.map(c => html`<tr><td>${c.itemId}</td><td style="color:${c.base >= 7 ? '#ef4444' : c.base >= 4 ? '#eab308' : '#22c55e'}">${c.base}</td><td>${c.temporal}</td><td>${c.environmental}</td><td style="font-weight:700;color:${c.overall >= 7 ? '#ef4444' : c.overall >= 4 ? '#eab308' : '#22c55e'}">${c.overall}</td></tr>`)}
            </tbody></table>
          </div>
        ` : nothing}
        ${this._activeTab === 'approvals' ? html`
          ${this._renderDcApprovals()}
        ` : nothing}
        ${this._activeTab === 'config' ? html`
          ${this._renderDcConfig()}
        ` : nothing}
        ${this._activeTab === 'new' ? html`
          <div class="form-section">
            <div class="form-title">Create New Data Classification Entry</div>
            <div class="form-grid">
  ...
  @state() private _dcScenarios: {id:string;name:string;attackType:string;target:string;method:string;impactLow:number;impactHigh:number;confidence:number;mitigation:string;status:string}[] = [];
  @state() private _dcScenarioForm: {attackType:string;target:string;method:string} = {attackType:'',target:'',method:''};
  @state() private _dcScenarioCompare: boolean = false;
  @state() private _dcScenarioSelected: string[] = [];

  private _dcInitScenarios(): void {
    const saved = localStorage.getItem('dc_scenarios');
    if (saved) { try { this._dcScenarios = JSON.parse(saved); } catch { /* ignore */ } }
    if (this._dcScenarios.length === 0) {
      this._dcScenarios = [
        {id:'dc-s1',name:'Baseline Threat',attackType:'Phishing',target:'Employees',method:'Spear Email',impactLow:45,impactHigh:78,confidence:72,mitigation:'Security awareness training + email filtering',status:'active'},
        {id:'dc-s2',name:'Escalated Attack',attackType:'Ransomware',target:'Endpoints',method:'Drive-by Download',impactLow:65,impactHigh:95,confidence:58,mitigation:'EDR deployment + network segmentation',status:'saved'},
        {id:'dc-s3',name:'Insider Threat',attackType:'Data Exfiltration',target:'Databases',method:'SQL Injection',impactLow:55,impactHigh:88,confidence:65,mitigation:'DLP policies + query monitoring',status:'draft'},
      ];
    }
  }

  private _dcSaveScenarios(): void {
    localStorage.setItem('dc_scenarios', JSON.stringify(this._dcScenarios));
  }

  private _dcAddScenario(): void {
    const f = this._dcScenarioForm;
    if (!f.attackType || !f.target) return;
    this._dcScenarios = [...this._dcScenarios, {
      id: 'dc-s' + (this._dcScenarios.length + 1),
    ...
    this._dcScenarioForm = {attackType:'',target:'',method:''};
    this._dcSaveScenarios();
  }

  private _dcRenderScenarioEngine(): any {
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <button class="tab" @click=${() => { this._dcScenarioCompare = !this._dcScenarioCompare; }}>${this._dcScenarioCompare ? 'List View' : 'Compare'}</button>
        </div>
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:6px;margin-bottom:10px">
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._dcScenarioForm = {...this._dcScenarioForm, attackType: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Attack Type</option>
            ${attackTypes.map(a => html`<option value=${a} ${this._dcScenarioForm.attackType === a ? 'selected' : ''}>${a}</option>`)}
          </select>
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._dcScenarioForm = {...this._dcScenarioForm, target: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Target</option>
            ${targets.map(t => html`<option value=${t} ${this._dcScenarioForm.target === t ? 'selected' : ''}>${t}</option>`)}
          </select>
          <select style="background:#1a1d2e;border:1px solid #2a2d3a;border-radius:4px;padding:4px 6px;color:#e2e8f0;font-size:11px" @change=${(e: any) => { this._dcScenarioForm = {...this._dcScenarioForm, method: (e.target as HTMLSelectElement).value}; }}>
            <option value="">Method</option>
            ${methods.map(m => html`<option value=${m} ${this._dcScenarioForm.method === m ? 'selected' : ''}>${m}</option>`)}
          </select>
        </div>
        <button style="background:#3b82f6;border:none;border-radius:4px;padding:4px 12px;color:#fff;font-size:11px;cursor:pointer" @click=${this._dcAddScenario}>Run Simulation</button>
      </div>
      ${this._dcScenarioCompare && this._dcScenarios.length >= 2 ? html`
        <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
          <div style="font-weight:600;font-size:12px;color:#e2e8f0;margin-bottom:8px">Side-by-Side Comparison</div>
          <div style="display:grid;grid-template-columns:repeat(${Math.min(3, this._dcScenarios.length)},1fr);gap:8px">
            ${this._dcScenarios.slice(0,3).map(s => html`
      ...
      <div style="background:#0f1117;border-radius:8px;padding:12px">
        <div style="font-weight:600;font-size:12px;color:#e2e8f0;margin-bottom:8px">Saved Scenarios (${this._dcScenarios.length})</div>
        ${this._dcScenarios.map(s => html`
  ...
  @state() private _dcTrendData: {day:number;value:number;anomaly:boolean}[] = [];
  @state() private _dcTrendZoom: {start:number;end:number} | null = null;
  @state() private _dcTrendMA: number = 7;

  private _dcInitTrendData(): void {
    ...
    this._dcTrendData = data;
  }

  private _dcCalcMA(window: number): number[] {
    const result: number[] = [];
    for (let i = 0; i < this._dcTrendData.length; i++) {
      const start = Math.max(0, i - window + 1);
      const slice = this._dcTrendData.slice(start, i + 1);
      result.push(slice.reduce((s, d) => s + d.value, 0) / slice.length);
    }
    return result;
  }

  private _dcGetStats(): {mean:number;median:number;stddev:number;trend:string} {
    const vals = this._dcTrendData.map(d => d.value);
    const n = vals.length;
  ...
  private _dcRenderTimeSeries(): any {
    const stats = this._dcGetStats();
    const filtered = this._dcTrendZoom ? this._dcTrendData.filter(d => d.day >= this._dcTrendZoom.start && d.day <= this._dcTrendZoom.end) : this._dcTrendData;
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px">
            <button class="tab ${this._dcTrendMA === 7 ? 'active' : ''}" @click=${() => { this._dcTrendMA = 7; }}>7D MA</button>
            <button class="tab ${this._dcTrendMA === 30 ? 'active' : ''}" @click=${() => { this._dcTrendMA = 30; }}>30D MA</button>
            <button class="tab" @click=${() => { this._dcTrendZoom = null; }}>Reset Zoom</button>
          </div>
        </div>
        <div style="position:relative;height:120px;background:#1a1d2e;border-radius:6px;overflow:hidden;margin-bottom:8px;cursor:crosshair" @click=${(e: any) => {
          ...
          this._dcTrendZoom = { start: Math.max(0, center - 10), end: Math.min(89, center + 10) };
        }}>
  ...
  @state() private _dcRoles: string[] = ['Admin','Analyst','Operator','Viewer','Auditor'];
  @state() private _dcActions: string[] = ['Create','Read','Update','Delete','Export','Approve'];
  @state() private _dcPermissions: { [role: string]: { [action: string]: boolean } } = {};
  @state() private _dcPermAudit: {role:string;action:string;changedBy:string;timestamp:string;oldVal:boolean;newVal:boolean}[] = [];
  @state() private _dcPermCompare: string[] = [];

  private _dcInitPermissions(): void {
    ...
    for (const role of this._dcRoles) {
      perms[role] = {};
      this._dcActions.forEach((a, i) => { perms[role][a] = defaults[role]?.[i] ?? false; });
    }
    this._dcPermissions = perms;
  }

  private _dcTogglePermission(role: string, action: string): void {
    const old = this._dcPermissions[role][action];
    this._dcPermissions = {...this._dcPermissions, [role]: {...this._dcPermissions[role], [action]: !old}};
    this._dcPermAudit.unshift({role,action,changedBy:'current_user',timestamp:new Date().toISOString(),oldVal:old,newVal:!old});
  }

  private _dcRenderRBAC(): any {
    const compareRoles = this._dcPermCompare.map(r => this._dcPermissions[r]).filter(Boolean);
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          <span style="font-weight:700;font-size:13px;color:#e2e8f0">RBAC Permission Matrix</span>
          <div style="display:flex;gap:4px">
            ${this._dcRoles.map(r => html`
              <button class="tab ${this._dcPermCompare.includes(r) ? 'active' : ''}" @click=${() => {
                this._dcPermCompare = this._dcPermCompare.includes(r) ? this._dcPermCompare.filter(x => x !== r) : [...this._dcPermCompare, r];
              }}>${r}</button>
            `)}
          </div>
        </div>
          ...
          <table style="width:100%;border-collapse:collapse;font-size:10px">
            <thead>
              <tr>
                ...
                ${this._dcActions.map(a => html`<th style="padding:6px;color:#6b7280;border-bottom:1px solid #2a2d3a;text-align:center">${a}</th>`)}
              </tr>
            </thead>
            <tbody>
              ${this._dcRoles.map(role => html`
                <tr style="border-bottom:1px solid #1a1d2e">
                  <td style="padding:6px;color:#e2e8f0;font-weight:600">${role}</td>
                  ${this._dcActions.map(action => html`
                    <td style="text-align:center;padding:6px">
                      <button style="width:28px;height:20px;border-radius:3px;border:1px solid #2a2d3a;background:${this._dcPermissions[role][action] ? '#22c55e' : '#1a1d2e'};cursor:pointer;color:#fff;font-size:10px" @click=${() => this._dcTogglePermission(role, action)}>${this._dcPermissions[role][action] ? 'Y' : 'N'}</button>
                    </td>
                  `)}
                </tr>
              `)}
        ...
        ${compareRoles.length >= 2 ? html`
          <div style="margin-top:10px;padding:8px;background:#1a1d2e;border-radius:6px">
            <div style="font-size:11px;font-weight:600;color:#e2e8f0;margin-bottom:6px">Role Diff: ${this._dcPermCompare.join(' vs ')}</div>
            ${this._dcActions.map(action => {
              ...
              return allSame ? nothing : html`
                <div style="display:flex;gap:8px;padding:3px 0;font-size:10px">
                  ...
                  ${compareRoles.map((r, i) => html`<span style="color:${r[action] ? '#22c55e' : '#ef4444'}">${this._dcPermCompare[i]}=${r[action] ? 'Y' : 'N'}</span>`)}
                </div>
              `;
            })}
          </div>
        ` : nothing}
        ${this._dcPermAudit.length > 0 ? html`
          <div style="margin-top:8px;font-size:9px;color:#6b7280">Recent: ${this._dcPermAudit.slice(0,3).map(a => html`<span style="margin-right:8px">${a.role}.${a.action}: ${a.oldVal ? 'Y' : 'N'}->${a.newVal ? 'Y' : 'N'}</span>`)}
        ` : nothing}
      </div>
    `;
  }
  ...
  // === REPORTING SUITE ===
  @state() private _dcReportTemplate: string = 'executive';
  @state() private _dcReportSchedule: string = 'weekly';
  @state() private _dcReportDistList: string[] = ['security-team@company.com','ciso@company.com'];
  @state() private _dcReportHistory: {id:string;template:string;generatedAt:string;status:string}[] = [];

  private _dcGenerateReport(): void {
    const id = 'rpt-' + Date.now();
    this._dcReportHistory.unshift({id,template:this._dcReportTemplate,generatedAt:new Date().toISOString(),status:'sent'});
  }

  private _dcRenderReporting(): any {
    ...
    return html`
      <div style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:8px">
          <div>
            ...
            ${templates.map(t => html`
              <div style="padding:6px;background:${this._dcReportTemplate === t.key ? '#1e3a5f' : '#1a1d2e'};border:1px solid ${this._dcReportTemplate === t.key ? '#3b82f6' : '#2a2d3a'};border-radius:4px;margin-bottom:4px;cursor:pointer" @click=${() => { this._dcReportTemplate = t.key; }}>
          ...
          <div>
            ...
            <div style="display:flex;gap:4px;margin-bottom:8px">
              ${schedules.map(s => html`<button class="tab ${this._dcReportSchedule === s.key ? 'active' : ''}" @click=${() => { this._dcReportSchedule = s.key; }}>${s.label}</button>`)}
            </div>
            <div style="font-size:10px;color:#6b7280;margin-bottom:4px">Distribution</div>
            <div style="font-size:10px;color:#9ca3af">${this._dcReportDistList.map(d => html`<div>${d}</div>`)}</div>
            <div style="margin-top:6px;display:flex;gap:4px">
              <button style="background:#3b82f6;border:none;border-radius:4px;padding:4px 10px;color:#fff;font-size:10px;cursor:pointer" @click=${this._dcGenerateReport}>Generate</button>
        ...
        ${this._dcReportHistory.length > 0 ? html`
          <div style="border-top:1px solid #2a2d3a;padding-top:8px">
            ...
            ${this._dcReportHistory.slice(0,3).map(r => html`
  ...
  @state() private _dcHighContrast: boolean = false;
  @state() private _dcA11yAnnounce: string = '';
  @state() private _dcShortcutsVisible: boolean = false;
  @state() private _dcFocusTrap: boolean = false;

  private _dcShortcuts: Record<string, string> = {
  ...
  private _dcHandleKeydown(e: KeyboardEvent): void {
    if (e.key === 'Escape' && this._dcFocusTrap) { this._dcFocusTrap = false; this._dcAnnounce('Dialog closed'); }
    if (e.ctrlKey && e.shiftKey && e.key === 'H') { e.preventDefault(); this._dcHighContrast = !this._dcHighContrast; this._dcAnnounce('High contrast ' + (this._dcHighContrast ? 'enabled' : 'disabled')); }
    if (e.ctrlKey && e.shiftKey && e.key === 'A') { e.preventDefault(); this._dcShortcutsVisible = !this._dcShortcutsVisible; }
  }

  private _dcAnnounce(msg: string): void {
    this._dcA11yAnnounce = msg;
    setTimeout(() => { this._dcA11yAnnounce = ''; }, 2000);
  }

  private _dcRenderAccessibility(): any {
    return html`
      <div role="region" aria-label="Accessibility Controls" style="background:#0f1117;border-radius:8px;padding:12px;margin-bottom:12px">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
          ...
          <button class="tab ${this._dcShortcutsVisible ? 'active' : ''}" @click=${() => { this._dcShortcutsVisible = !this._dcShortcutsVisible; }} aria-expanded=${this._dcShortcutsVisible}>Shortcuts</button>
        </div>
        <div style="display:flex;gap:8px;margin-bottom:8px">
          <label style="display:flex;align-items:center;gap:6px;font-size:11px;color:#e2e8f0;cursor:pointer">
            <input type="checkbox" .checked=${this._dcHighContrast} @change=${() => { this._dcHighContrast = !this._dcHighContrast; }} aria-label="Toggle high contrast mode">
            High Contrast
          </label>
        </div>
        ${this._dcShortcutsVisible ? html`
          <div role="list" aria-label="Keyboard shortcuts" style="background:#1a1d2e;border-radius:6px;padding:8px">
            ${Object.entries(this._dcShortcuts).map(([key, desc]) => html`
        ...
        ` : nothing}
        <div role="status" aria-live="polite" aria-atomic="true" style="position:absolute;left:-9999px">${this._dcA11yAnnounce}</div>
      </div>
    `;
  }
  ...
  connectedCallback(): void {
    ...
    this._dcInitScenarios();
    this._dcInitTrendData();
    this._dcInitPermissions();
    document.addEventListener('keydown', this._dcHandleKeydown.bind(this));
  }

  disconnectedCallback(): void {
    super.disconnectedCallback();
    document.removeEventListener('keydown', this._dcHandleKeydown.bind(this));
  }

  // === TAB INTEGRATION FOR EXTENDED FEATURES ===
  @state() private _dcActiveSubTab: string = 'scenario';
  ...
  private _initThreatModel() {
    const categories = [
      ...
      { id: 'tc2', category: 'Tampering', threats: [
        { id: 't4', name: 'Data injection in data classification', stride: 'T', likelihood: 7, impact: 8, dreadScore: 7.0, status: 'open', mitigations: ['Input validation', 'WAF rules'], assignedTo: 'Dev Team', discoveredDate: '2024-01-08', lastReviewed: '2024-02-10' },
  ...
  private _dcGetAllSubTabs(): {key:string;label:string}[] {
    return [
  ...
  private _dcRenderSubPanel(): any {
    switch (this._dcActiveSubTab) {
      case 'scenario': return this._dcRenderScenarioEngine();
      case 'timeseries': return this._dcRenderTimeSeries();
      case 'rbac': return this._dcRenderRBAC();
      case 'reporting': return this._dcRenderReporting();
      case 'a11y': return this._dcRenderAccessibility();
      default: return nothing;
    }
  }

  private _dcRenderTabBar(): any {
    return html`
      <div style="display:flex;gap:4px;margin-bottom:12px;border-bottom:1px solid #2a2d3a;padding-bottom:8px;flex-wrap:wrap" role="tablist" aria-label="Extended panel features">
        ${this._dcGetAllSubTabs().map(t => html`
          <button class="tab ${this._dcActiveSubTab === t.key ? 'active' : ''}" @click=${() => { this._dcActiveSubTab = t.key; }} role="tab" aria-selected=${this._dcActiveSubTab === t.key}>${t.label}</button>
        `)}
      </div>
      <div role="tabpanel" aria-labelledby="dc-tab-${this._dcActiveSubTab}">
        ${this._dcRenderSubPanel()}
      </div>
    `;
  }
  ...
  @state() private _soarPlaybooks: Array<{
    ...
    {
      id: 'pb-soar-001', name: 'Data Classification Auto Response', status: 'active',
      steps: [
    ...
    {
      id: 'pb-soar-002', name: 'Data Classification Investigation Workflow', status: 'active',
      steps: [
    ...
    {
      id: 'pb-soar-003', name: 'Data Classification Compliance Scan', status: 'draft',
      steps: [
  ...
  @state() private _dcAle: number = 0;
  @state() private _dcSroi: number = 0;
  @state() private _dcCpi: number = 0;
  @state() private _dcBudgetAlloc: number = 0;
  @state() private _dcCostBenefit: number = 0;

  // Security Economics Calculator
  private dcInitEconomics() {
    this._dcAle = Math.round(2850000 + Math.random() * 4500000);
    this._dcSroi = Math.round(180 + Math.random() * 320);
    this._dcCpi = Math.round(45000 + Math.random() * 120000);
    this._dcBudgetAlloc = Math.round(2500000 + Math.random() * 3000000);
    this._dcCostBenefit = Math.round(220 + Math.random() * 180);
  }

  private _dcCalcAle(): { annual: number; perIncident: number; byCategory: Array<{name: string; value: number}> } {
    const base = this._dcAle;
    const categories = [
  ...
  private _dcCalcSroi(): Array<{year: number; investment: number; savings: number; roi: number}> {
    const baseInv = this._dcSroi * 10000;
  ...
  private _dcGetBudgetAlloc(): Array<{category: string; amount: number; pct: number; trend: string}> {
    const total = this._dcBudgetAlloc;
    const items = [
  ...
  private _dcGetCostBenefit(): Array<{control: string; cost: number; benefit: number; ratio: number; priority: string}> {
    const base = this._dcCostBenefit;
    const controls = [
  ...
  private _dcRenderEconomics() {
    const ale = this._dcCalcAle();
    const roi = this._dcCalcSroi();
    const budget = this._dcGetBudgetAlloc();
    const cb = this._dcGetCostBenefit();
    const cpi = this._dcCpi;
  ...
  @state() private _dcThreatLevel: any = null;
  @state() private _dcEmergingThreats: any = null;
  @state() private _dcThreatTrends: any = null;
  @state() private _dcSectorRadar: any = null;
  @state() private _dcActorActivity: any = null;

  // Threat Landscape Intelligence
  private dcInitThreatIntel() {
    this._dcThreatLevel = {
  ...
  private _dcRenderThreatIntel() {
    const tl = this._dcThreatLevel;
    const et = this._dcEmergingThreats;
    const sr = this._dcSectorRadar;
    const aa = this._dcActorActivity;
  ...
  @state() private _dcPolicies: any = null;
  @state() private _dcExceptions: any = null;
  @state() private _dcRiskRegister: any = null;
  @state() private _dcMeetings: any = null;
  @state() private _dcDeadlines: any = null;

  // Security Governance Dashboard
  private dcInitGovernance() {
    this._dcPolicies = [
  ...
  private _dcRenderGovernance() {
    const policies = this._dcPolicies;
    const risks = this._dcRiskRegister;
    const deadlines = this._dcDeadlines;
  ...
  @state() private _dcCriticalAssets: any = null;
  @state() private _dcAssetDeps: any = null;
  @state() private _dcEolAssets: any = null;
  @state() private _dcAssetRisk: any = null;

  // Asset Intelligence
  private dcInitAssetIntel() {
    this._dcCriticalAssets = [
    ...
    this._dcAssetRisk = { critical: 7, high: 23, medium: 45, low: 128, total: 203 };
  }

  private _dcRenderAssetIntel() {
    const assets = this._dcCriticalAssets;
    const eol = this._dcEolAssets;
    const ar = this._dcAssetRisk;
  ...
  @state() private _dcUserBaseline: any = null;
  @state() private _dcAnomalyRules: any = null;
  @state() private _dcDataAccess: any = null;
  @state() private _dcInsiderRisk: any = null;
  @state() private _dataclr15Timeline: Array<{id:string;time:string;event:string;severity:string;actor:string}> = [
  ...
  @state() private _dataclr15RootCauses: Array<{why:string;answer:string}> = [
  ...
  @state() private _dataclr15ImpactMatrix: Array<{system:string;users:number;data:string;revenue:string;status:string}> = [
  ...
  @state() private _dataclr15Actions: Array<{id:string;item:string;owner:string;deadline:string;priority:string;status:string}> = [
  ...
  @state() private _dataclr15Lessons: Array<{id:string;lesson:string;category:string;severity:string;applies_to:string}> = [
  ...
  @state() private _dataclr15ActiveTab: string = 'timeline';
  @state() private _dataclr15Benchmarks: Array<{metric:string;current:number;industry:number;target:number;unit:string;source:string}> = [
  ...
  @state() private _dataclr15MaturityLevels: Array<{domain:string;current:number;target:number;description:string}> = [
  ...
  @state() private _dataclr15QuarterlyData: Array<{quarter:string;score:number;improvement:number}> = [
  ...
  @state() private _dataclr15SelectedDomain: string = 'all';
  @state() private _dataclr15Alerts: Array<{id:string;name:string;severity:number;confidence:number;assetCrit:number;score:number;enriched:boolean;group:string;status:string;enrichData:Array<{key:string;value:string}>}> = [
  ...
  @state() private _dataclr15QualityMetrics: {fpRate:number;enrichSuccess:number;avgTriageTime:number;enrichedCount:number;totalCount:number} = {fpRate:0.12, enrichSuccess:0.78, avgTriageTime:4.5, enrichedCount:3, totalCount:5};
  @state() private _dataclr15RoutingRules: Array<{name:string;condition:string;channel:string;active:boolean}> = [
  ...
  @state() private _dataclr15Shapes: Array<{id:string;type:string;label:string;controls:string[]}> = [
  ...
  @state() private _dataclr15TrustBoundaries: Array<{from:string;to:string;label:string;strength:string}> = [
  ...
  @state() private _dataclr15ADRs: Array<{id:string;title:string;status:string;date:string;decision:string}> = [
  ...
  @state() private _dataclr15SelectedShape: string = '';
  @state() private _dataclr15Gauges: Array<{name:string;value:number;max:number;unit:string;status:string;color:string}> = [
  ...
  @state() private _dataclr15Anomalies: Array<{id:string;time:string;description:string;severity:string;acknowledged:boolean}> = [
  ...
  @state() private _dataclr15Integrations: Array<{name:string;status:string;uptime:number;lastCheck:string;latency:number}> = [
  ...
  @state() private _dataclr15AlertFatigue: Array<{analyst:string;alertsPerDay:number;escalated:number;dismissed:number;avgResponseMin:number}> = [
  ...
  @state() private _dataclr15SlaTarget: number = 99.9;

  // Insider Threat Detection
  private dcInitInsiderThreat() {
    this._dcUserBaseline = [
    ...
    this._dcInsiderRisk = { totalUsers: 2847, monitored: 342, flagged: 18, investigated: 5, confirmed: 1 };
  }

  private _dcRenderInsiderThreat() {
    const baseline = this._dcUserBaseline;
    const rules = this._dcAnomalyRules;
    const ir = this._dcInsiderRisk;
    ...
    return html`<div class="card" style="padding:14px;margin-bottom:8px">
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px;margin-bottom:10px;flex-wrap:wrap">
            ${['timeline','rootcause','impact','actions','lessons'].map(t => html`
              <button class="btn ${this._dataclr15ActiveTab === t ? 'btn-primary' : ''}" style="font-size:10px;padding:3px 8px" @click=${() => { this._dataclr15ActiveTab = t; }}>${t.charAt(0).toUpperCase() + t.slice(1)}</button>
            `)}
          </div>
          ${this._dataclr15ActiveTab === 'timeline' ? html`
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._dataclr15Timeline.map(e => html`
          ...
          ` : this._dataclr15ActiveTab === 'rootcause' ? html`
            <div style="margin-bottom:8px">${{__html: this._dataclr15RenderFishbone()}}</div>
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._dataclr15RootCauses.map((rc, i) => html`
          ...
          ` : this._dataclr15ActiveTab === 'impact' ? html`
            <div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:10px">
              ...
              <tbody>${this._dataclr15ImpactMatrix.map(imp => html`
          ...
          ` : this._dataclr15ActiveTab === 'actions' ? html`
            <div style="display:flex;gap:12px;margin-bottom:8px;font-size:10px;color:#888">
              ${Object.entries(this._dataclr15GetActionStats()).map(([k,v]) => html`<span>${k}: <b style="color:#ddd">${v}</b></span>`)}
            </div>
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._dataclr15Actions.map(a => html`
                <div style="display:flex;gap:8px;align-items:center;padding:6px;background:#1a1d27;border-radius:4px;cursor:pointer" @click=${() => this._dataclr15ToggleAction(a.id)}>
          ...
          ` : html`
            <div style="display:flex;flex-direction:column;gap:4px">
              ${this._dataclr15Lessons.map(l => html`
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:4px;margin-bottom:10px;flex-wrap:wrap">
            ${['all', ...this._dataclr15MaturityLevels.map(m => m.domain)].map(d => html`
              <button class="btn ${this._dataclr15SelectedDomain === d ? 'btn-primary' : ''}" style="font-size:9px;padding:2px 6px" @click=${() => { this._dataclr15SelectedDomain = d; }}>${d}</button>
            `)}
          </div>
          <div style="display:flex;gap:16px;margin-bottom:10px">
            <div style="text-align:center"><div style="color:#e0e0e0;font-size:20px;font-weight:bold">${this._dataclr15GetOverallMaturity()}/5</div><div style="color:#888;font-size:10px">Maturity Level</div></div>
            <div style="text-align:center"><div style="color:#4f4;font-size:20px;font-weight:bold">${this._dataclr15GetGapAnalysis().filter(g => g.isAbove).length}/${this._dataclr15Benchmarks.length}</div><div style="color:#888;font-size:10px">Above Industry</div></div>
          </div>
          <div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:10px">
            ...
            <tbody>${this._dataclr15GetGapAnalysis().map(b => html`
          ...
          <div style="margin-top:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Maturity by Domain</div>
            ${this._dataclr15MaturityLevels.filter(m => this._dataclr15SelectedDomain === 'all' || m.domain === this._dataclr15SelectedDomain).map(m => html`
          ...
          <div style="margin-top:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Quarterly Trend</div>
            <div style="display:flex;height:40px;align-items:flex-end;gap:4px">
              ${this._dataclr15QuarterlyData.map(q => html`<div style="flex:1;text-align:center"><div style="background:#4a9eff;height:${q.score * 0.5}px;border-radius:2px 2px 0 0" title="${q.score}"></div><div style="color:#666;font-size:8px;margin-top:2px">${q.quarter}</div></div>`)}
            </div>
          </div>
        </div>
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:12px;margin-bottom:8px;font-size:10px">
            <div style="display:flex;gap:4px;flex-wrap:wrap">${this._dataclr15GroupAlerts().map(g => html`<span style="color:#888;padding:2px 6px;background:#1a1d27;border-radius:3px">${g.group}: ${g.count}</span>`)}</div>
          </div>
          <div style="display:flex;gap:8px;margin-bottom:8px;font-size:10px;color:#888">
            <span>FP Rate: <b style="color:${this._dataclr15QualityMetrics.fpRate > 0.15 ? '#f44' : '#4f4'}">${(this._dataclr15QualityMetrics.fpRate * 100).toFixed(1)}%</b></span>
            <span>Enrich: <b style="color:#4a9eff">${(this._dataclr15QualityMetrics.enrichSuccess * 100).toFixed(0)}%</b></span>
            <span>Avg Triage: <b style="color:#ddd">${this._dataclr15QualityMetrics.avgTriageTime}m</b></span>
          </div>
          <div style="display:flex;flex-direction:column;gap:4px;max-height:200px;overflow-y:auto">
            ${this._dataclr15Alerts.sort((a, b) => this._dataclr15CalcScore(b) - this._dataclr15CalcScore(a)).map(a => {
              const score = this._dataclr15CalcScore(a);
              return html`
                <div style="padding:6px;background:#1a1d27;border-radius:4px;border-left:3px solid ${a.severity >= 4 ? '#f44' : a.severity >= 3 ? '#fa0' : '#4a9eff'}">
                  <div style="display:flex;justify-content:space-between;align-items:center">
                    ...
                    <button class="btn" style="font-size:9px;padding:1px 6px;margin-left:4px" @click=${() => this._dataclr15EnrichAlert(a.id)}>${a.enriched ? 'Re-enrich' : 'Enrich'}</button>
                  </div>
          ...
          <div style="margin-top:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Routing Rules</div>
            ${this._dataclr15RoutingRules.map(r => html`
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:8px;margin-bottom:8px;flex-wrap:wrap">
            ${this._dataclr15Shapes.map(s => {
              const v = this._dataclr15ValidateControl(s.id);
              return html`<div style="padding:4px 8px;background:#1a1d27;border-radius:3px;cursor:pointer;border:1px solid ${this._dataclr15SelectedShape === s.id ? '#4a9eff' : '#2a2d37'}" @click=${() => { this._dataclr15SelectedShape = this._dataclr15SelectedShape === s.id ? '' : s.id; }}>
          ...
          ${this._dataclr15SelectedShape ? html`
            ${(() => {
              const shape = this._dataclr15Shapes.find(s => s.id === this._dataclr15SelectedShape);
              const v = this._dataclr15ValidateControl(this._dataclr15SelectedShape);
              return shape ? html`
          ...
          <div style="margin-bottom:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Trust Boundaries</div>
            ${this._dataclr15TrustBoundaries.map(tb => html`
              <div style="display:flex;gap:6px;align-items:center;padding:3px;background:#1a1d27;border-radius:3px;margin-bottom:2px;font-size:9px">
                <span style="color:#ddd">${this._dataclr15Shapes.find(s => s.id === tb.from)?.label || tb.from}</span>
                <span style="color:#4a9eff">\u2194</span>
                <span style="color:#ddd">${this._dataclr15Shapes.find(s => s.id === tb.to)?.label || tb.to}</span>
          ...
          <div><div style="color:#888;font-size:10px;margin-bottom:4px">Architecture Decision Records</div>
            ${this._dataclr15ADRs.map(adr => html`
        ...
        <div class="card" style="padding:12px;margin-bottom:8px">
          ...
          <div style="display:flex;gap:8px;margin-bottom:8px;flex-wrap:wrap">
            ${this._dataclr15Gauges.map(g => html`
          ...
          <div style="display:flex;gap:8px;margin-bottom:8px;align-items:center">
            ...
            <span style="color:${this._dataclr15GetOverallHealth().score >= 99 ? '#4f4' : '#fa0'};font-size:12px;font-weight:bold">${this._dataclr15GetOverallHealth().score}%</span>
            <span style="color:#888;font-size:10px">(Target: ${this._dataclr15SlaTarget}%)</span>
            <span style="color:#4f4;font-size:10px">${this._dataclr15GetOverallHealth().healthy} healthy</span>
            <span style="color:#fa0;font-size:10px">${this._dataclr15GetOverallHealth().degraded} degraded</span>
          </div>
          <div style="margin-bottom:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Anomaly Stream</div>
            ${this._dataclr15Anomalies.slice(0, 3).map(a => html`
              <div style="display:flex;gap:6px;align-items:center;padding:4px;background:#1a1d27;border-radius:3px;margin-bottom:2px;opacity:${a.acknowledged ? 0.5 : 1}">
                ...
                ${!a.acknowledged ? html`<button class="btn" style="font-size:8px;padding:1px 4px" @click=${() => this._dataclr15AckAnomaly(a.id)}>ACK</button>` : html`<span style="color:#4f4;font-size:9px">ACK'd</span>`}
              </div>
            `)}
          </div>
          <div style="margin-bottom:8px"><div style="color:#888;font-size:10px;margin-bottom:4px">Integration Health</div>
            ${this._dataclr15Integrations.map(i => html`
              <div style="display:flex;gap:6px;align-items:center;padding:3px;background:#1a1d27;border-radius:3px;margin-bottom:2px;font-size:9px">
          ...
          <div><div style="color:#888;font-size:10px;margin-bottom:4px">Alert Fatigue Analysis</div>
            <div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:9px">
              ...
              <tbody>${this._dataclr15AlertFatigue.map(af => html`
  ...
  private _dataclr15RenderFishbone(): string {
  ...
  private _dataclr15ToggleAction(id: string) {
    this._dataclr15Actions = this._dataclr15Actions.map(a => a.id === id ? {...a, status: a.status === 'pending' ? 'in_progress' : a.status === 'in_progress' ? 'completed' : 'pending'} : a);
  }

  private _dataclr15GetActionStats() {
    const total = this._dataclr15Actions.length;
    const done = this._dataclr15Actions.filter(a => a.status === 'completed').length;
    const inProg = this._dataclr15Actions.filter(a => a.status === 'in_progress').length;
    return { total, done, inProg, pending: total - done - inProg };
  }

  private _dataclr15GetOverallMaturity(): number {
    if (this._dataclr15SelectedDomain === 'all') {
      return Math.round(this._dataclr15MaturityLevels.reduce((s, m) => s + m.current, 0) / this._dataclr15MaturityLevels.length * 10) / 10;
    }
    const d = this._dataclr15MaturityLevels.find(m => m.domain === this._dataclr15SelectedDomain);
    return d ? d.current : 0;
  }

  private _dataclr15GetGapAnalysis() {
    return this._dataclr15Benchmarks.map(b => {
  ...
  private _dataclr15CalcScore(alert: any): number {
    return Math.round(alert.severity * alert.confidence * alert.assetCrit * 100) / 100;
  }

  private _dataclr15EnrichAlert(id: string) {
    this._dataclr15Alerts = this._dataclr15Alerts.map(a => {
      if (a.id !== id) return a;
      const score = this._dataclr15CalcScore(a);
  ...
  private _dataclr15GroupAlerts() {
    const groups: Record<string, number> = {};
    this._dataclr15Alerts.forEach(a => { groups[a.group] = (groups[a.group] || 0) + 1; });
    return Object.entries(groups).map(([g, c]) => ({group: g, count: c}));
  }

  private _dataclr15ValidateControl(shapeId: string): {valid:boolean;missing:string[]} {
    const shape = this._dataclr15Shapes.find(s => s.id === shapeId);
  ...
  private _dataclr15GetOverallHealth(): {healthy:number;degraded:number;down:number;score:number} {
    const online = this._dataclr15Integrations.filter(i => i.status === 'online').length;
    const degraded = this._dataclr15Integrations.filter(i => i.status === 'degraded').length;
    const total = this._dataclr15Integrations.length;
    return { healthy: online, degraded, down: total - online - degraded, score: Math.round(online / total * 100) };
  }

  private _dataclr15AckAnomaly(id: string) {
    this._dataclr15Anomalies = this._dataclr15Anomalies.map(a => a.id === id ? {...a, acknowledged: true} : a);
  }
...
// ===== SECURITY ROI DASHBOARD (R22) =====
  ...
  private _renderBudgetPlanning() {
    const budgetData = [
      { category: "Personnel & Training", planned: 3318000, actual: 4504000, utilization: 135.7, q1: "22%", q2: "27%", q3: "25%", q4: "17%" },
      { category: "Tooling & Licensing", planned: 3325000, actual: 4517000, utilization: 135.8, q1: "25%", q2: "32%", q3: "20%", q4: "18%" },
      { category: "Infrastructure Security", planned: 3332000, actual: 4530000, utilization: 136.0, q1: "28%", q2: "21%", q3: "31%", q4: "19%" },
      { category: "Compliance & Audit", planned: 3339000, actual: 4543000, utilization: 136.1, q1: "15%", q2: "26%", q3: "26%", q4: "20%" },
      { category: "Incident Response", planned: 3346000, actual: 4556000, utilization: 136.2, q1: "18%", q2: "31%", q3: "21%", q4: "21%" },
      { category: "Third-Party Assessments", planned: 3353000, actual: 4569000, utilization: 136.3, q1: "21%", q2: "20%", q3: "32%", q4: "22%" },
      { category: "Security Awareness", planned: 3360000, actual: 4582000, utilization: 136.4, q1: "24%", q2: "25%", q3: "27%", q4: "23%" },
      { category: "Research & Innovation", planned: 3367000, actual: 4595000, utilization: 136.5, q1: "27%", q2: "30%", q3: "22%", q4: "24%" },
    ];
    ...
    const headcount = [
      { team: "SOC Tier 1", current: 12, target: 18, gap: 3, avgSalary: "148k" },
      { team: "SOC Tier 2", current: 4, target: 17, gap: 2, avgSalary: "177k" },
      { team: "Threat Intel", current: 13, target: 16, gap: 1, avgSalary: "95k" },
      { team: "Red Team", current: 5, target: 15, gap: 0, avgSalary: "124k" },
      { team: "GRC", current: 14, target: 14, gap: 5, avgSalary: "153k" },
      { team: "AppSec", current: 6, target: 13, gap: 4, avgSalary: "182k" },
      { team: "Cloud Sec", current: 15, target: 12, gap: 3, avgSalary: "100k" },
      { team: "Identity & Access", current: 7, target: 11, gap: 2, avgSalary: "129k" },
    ];
    const vendorSpend = [
      { vendor: "CrowdStrike", annual: "675k", contractEnd: "2026-04", renewalRisk: "Low", satisfaction: 3 },
      { vendor: "Palo Alto", annual: "706k", contractEnd: "2026-05", renewalRisk: "Medium", satisfaction: 5 },
      { vendor: "Splunk", annual: "737k", contractEnd: "2026-06", renewalRisk: "High", satisfaction: 4 },
      { vendor: "Qualys", annual: "768k", contractEnd: "2026-07", renewalRisk: "Low", satisfaction: 3 },
      { vendor: "Rapid7", annual: "799k", contractEnd: "2026-08", renewalRisk: "Medium", satisfaction: 5 },
      { vendor: "Mandiant", annual: "79k", contractEnd: "2026-09", renewalRisk: "High", satisfaction: 4 },
      { vendor: "Zscaler", annual: "110k", contractEnd: "2026-10", renewalRisk: "Low", satisfaction: 3 },
      { vendor: "Duo Security", annual: "141k", contractEnd: "2026-11", renewalRisk: "Medium", satisfaction: 5 },
    ];
    const roiProjections = [
      { area: "Threat Detection", investment: "574k", projectedReturn: "757k", roiMultiple: "1.6x", confidence: 75 },
      { area: "Incident Reduction", investment: "617k", projectedReturn: "804k", roiMultiple: "1.5x", confidence: 92 },
      { area: "Compliance Savings", investment: "660k", projectedReturn: "851k", roiMultiple: "4.0x", confidence: 73 },
      { area: "Automation Gains", investment: "703k", projectedReturn: "898k", roiMultiple: "3.9x", confidence: 90 },
      { area: "Risk Avoidance", investment: "746k", projectedReturn: "945k", roiMultiple: "3.8x", confidence: 71 },
    ];
    return html`
  ...
  private _renderMetricsNormalization() {
    const kpiCatalog = [
      { id: "kpi-1", name: "MTTD", owner: "SOC", unit: "minutes", target: 94, current: 89, benchmark: 71, collection: "auto", frequency: "realtime" },
      { id: "kpi-2", name: "MTTR", owner: "GRC", unit: "%", target: 97, current: 96, benchmark: 82, collection: "semi-auto", frequency: "daily" },
      { id: "kpi-3", name: "MTTC", owner: "AppSec", unit: "score", target: 70, current: 57, benchmark: 93, collection: "manual", frequency: "weekly" },
      { id: "kpi-4", name: "Vuln SLA Compliance", owner: "Cloud Sec", unit: "count", target: 73, current: 64, benchmark: 70, collection: "auto", frequency: "monthly" },
      { id: "kpi-5", name: "Patch Coverage", owner: "Identity", unit: "days", target: 76, current: 71, benchmark: 81, collection: "semi-auto", frequency: "realtime" },
      { id: "kpi-6", name: "Phishing Click Rate", owner: "Threat Intel", unit: "minutes", target: 79, current: 78, benchmark: 92, collection: "manual", frequency: "daily" },
      { id: "kpi-7", name: "Training Completion", owner: "Security Ops", unit: "%", target: 82, current: 85, benchmark: 69, collection: "auto", frequency: "weekly" },
      { id: "kpi-8", name: "Escalation Rate", owner: "Risk Mgmt", unit: "score", target: 85, current: 92, benchmark: 80, collection: "semi-auto", frequency: "monthly" },
      { id: "kpi-9", name: "False Positive Rate", owner: "SOC", unit: "count", target: 88, current: 99, benchmark: 91, collection: "manual", frequency: "realtime" },
      { id: "kpi-10", name: "Threat Intel Actionability", owner: "GRC", unit: "days", target: 91, current: 60, benchmark: 68, collection: "auto", frequency: "daily" },
      { id: "kpi-11", name: "Endpoint Compliance", owner: "AppSec", unit: "minutes", target: 94, current: 67, benchmark: 79, collection: "semi-auto", frequency: "weekly" },
      { id: "kpi-12", name: "Cloud Misconfig Score", owner: "Cloud Sec", unit: "%", target: 97, current: 74, benchmark: 90, collection: "manual", frequency: "monthly" },
      { id: "kpi-13", name: "Identity Anomaly Rate", owner: "Identity", unit: "score", target: 70, current: 81, benchmark: 67, collection: "auto", frequency: "realtime" },
      { id: "kpi-14", name: "DLP Events", owner: "Threat Intel", unit: "count", target: 73, current: 88, benchmark: 78, collection: "semi-auto", frequency: "daily" },
      { id: "kpi-15", name: "Vendor Risk Avg", owner: "Security Ops", unit: "days", target: 76, current: 95, benchmark: 89, collection: "manual", frequency: "weekly" },
      { id: "kpi-16", name: "Compliance Audit Pass Rate", owner: "Risk Mgmt", unit: "minutes", target: 79, current: 56, benchmark: 66, collection: "auto", frequency: "monthly" },
      { id: "kpi-17", name: "Awareness Score", owner: "SOC", unit: "%", target: 82, current: 63, benchmark: 77, collection: "semi-auto", frequency: "realtime" },
      { id: "kpi-18", name: "SOC Utilization", owner: "GRC", unit: "score", target: 85, current: 70, benchmark: 88, collection: "manual", frequency: "daily" },
      { id: "kpi-19", name: "Automation Coverage", owner: "AppSec", unit: "count", target: 88, current: 77, benchmark: 65, collection: "auto", frequency: "weekly" },
      { id: "kpi-20", name: "Risk Register Currency", owner: "Cloud Sec", unit: "days", target: 91, current: 84, benchmark: 76, collection: "semi-auto", frequency: "monthly" },
    ];
    const benchmarkSources = [
      { source: "NIST CSF", mappedKPIs: 3, alignment: 72, lastReview: "2026-01-11", status: "aligned" },
      { source: "CIS Controls v8", mappedKPIs: 4, alignment: 89, lastReview: "2026-02-06", status: "partial" },
      { source: "ISO 27001:2022", mappedKPIs: 5, alignment: 67, lastReview: "2026-03-01", status: "reviewing" },
      { source: "PCI DSS 4.0", mappedKPIs: 6, alignment: 84, lastReview: "2026-04-24", status: "aligned" },
      { source: "SOC 2 Type II", mappedKPIs: 7, alignment: 62, lastReview: "2026-05-19", status: "partial" },
      { source: "MITRE ATT&CK", mappedKPIs: 8, alignment: 79, lastReview: "2026-06-14", status: "reviewing" },
      { source: "SANS Top 20", mappedKPIs: 3, alignment: 96, lastReview: "2026-01-09", status: "aligned" },
      { source: "OWASP Top 10", mappedKPIs: 4, alignment: 74, lastReview: "2026-02-04", status: "partial" },
    ];
    const normalizationRules = [
      { rule: "Time metrics normalized to minutes", appliesTo: 7, exceptions: 0, version: "v1.4" },
      { rule: "Percentage metrics capped at 100", appliesTo: 6, exceptions: 1, version: "v1.1" },
      { rule: "Count metrics use 7-day rolling avg", appliesTo: 5, exceptions: 2, version: "v1.8" },
      { rule: "Score metrics use 0-100 scale", appliesTo: 4, exceptions: 0, version: "v1.5" },
      { rule: "Rate metrics per 1000 events", appliesTo: 3, exceptions: 1, version: "v1.2" },
    ];
    return html`
  ...
  private _renderThreatHuntingCampaigns() {
    const campaigns = [
      { id: "HC-1001", name: "Lateral Movement Sweep", status: "active", hypothesis: "H1: Actors using pass-the-hash for lateral movement", leadHunter: "Alice Chen", findings: 22, startDate: "2026-03-03", endDate: null, effectiveness: 76 },
      { id: "HC-1002", name: "Credential Harvesting Hunt", status: "completed", hypothesis: "H2: Actors using web shells for persistence", leadHunter: "Bob Martinez", findings: 25, startDate: "2026-02-14", endDate: "2026-06-20", effectiveness: 95 },
      { id: "HC-1003", name: "Persistence Mechanism Audit", status: "planned", hypothesis: "H3: Actors using scheduled tasks for data theft", leadHunter: "Carol Wu", findings: 28, startDate: "2026-01-25", endDate: null, effectiveness: 55 },
      { id: "HC-1004", name: "C2 Beacon Detection", status: "in-review", hypothesis: "H4: Actors using DNS tunneling for C2 communication", leadHunter: "Dave Kim", findings: 31, startDate: "2026-04-08", endDate: null, effectiveness: 74 },
      { id: "HC-1005", name: "Data Exfiltration Patterns", status: "active", hypothesis: "H5: Actors using encrypted channels for privilege escalation", leadHunter: "Eve Johnson", findings: 34, startDate: "2026-03-19", endDate: null, effectiveness: 93 },
      { id: "HC-1006", name: "Privilege Escalation Scan", status: "completed", hypothesis: "H6: Actors using token impersonation for defense evasion", leadHunter: "Frank Liu", findings: 37, startDate: "2026-02-02", endDate: "2026-04-04", effectiveness: 53 },
      { id: "HC-1007", name: "Supply Chain Implant Hunt", status: "planned", hypothesis: "H7: Actors using poisoned images for initial access", leadHunter: "Grace Park", findings: 40, startDate: "2026-01-13", endDate: null, effectiveness: 72 },
      { id: "HC-1008", name: "Insider Threat Indicators", status: "in-review", hypothesis: "H8: Actors using legitimate tools for credential access", leadHunter: "Hector Silva", findings: 43, startDate: "2026-04-24", endDate: null, effectiveness: 91 },
      { id: "HC-1009", name: "Cloud Metadata Analysis", status: "active", hypothesis: "H9: Actors using API keys for command execution", leadHunter: "Alice Chen", findings: 46, startDate: "2026-03-07", endDate: null, effectiveness: 51 },
      { id: "HC-1010", name: "DNS Tunnel Detection", status: "completed", hypothesis: "H10: Actors using encoded subdomains for exfiltration", leadHunter: "Bob Martinez", findings: 1, startDate: "2026-02-18", endDate: "2026-05-16", effectiveness: 70 },
      { id: "HC-1011", name: "Fileless Malware Search", status: "planned", hypothesis: "H11: Actors using WMI providers for discovery", leadHunter: "Carol Wu", findings: 4, startDate: "2026-01-01", endDate: null, effectiveness: 89 },
      { id: "HC-1012", name: "Zero-Day Exploit Traces", status: "in-review", hypothesis: "H12: Actors using exploit kits for collection", leadHunter: "Dave Kim", findings: 7, startDate: "2026-04-12", endDate: null, effectiveness: 49 },
    ];
    const hunterLeaderboard = [
      { hunter: "Alice Chen", campaigns: 14, findings: 39, highSeverity: 24, avgScore: 97, streak: 7 },
      { hunter: "Bob Martinez", campaigns: 11, findings: 68, highSeverity: 3, avgScore: 90, streak: 8 },
      { hunter: "Carol Wu", campaigns: 8, findings: 97, highSeverity: 8, avgScore: 83, streak: 1 },
      { hunter: "Dave Kim", campaigns: 5, findings: 10, highSeverity: 13, avgScore: 76, streak: 2 },
      { hunter: "Eve Johnson", campaigns: 15, findings: 39, highSeverity: 18, avgScore: 69, streak: 3 },
      { hunter: "Frank Liu", campaigns: 12, findings: 68, highSeverity: 23, avgScore: 62, streak: 4 },
      { hunter: "Grace Park", campaigns: 9, findings: 97, highSeverity: 2, avgScore: 55, streak: 5 },
      { hunter: "Hector Silva", campaigns: 6, findings: 10, highSeverity: 7, avgScore: 92, streak: 6 },
    ];
    const mitreMapping = [
      { tactic: "Initial Access", techniques: 11, campaigns: 5, coverage: 42 },
      { tactic: "Execution", techniques: 10, campaigns: 4, coverage: 93 },
      { tactic: "Persistence", techniques: 9, campaigns: 3, coverage: 73 },
      { tactic: "Privilege Escalation", techniques: 8, campaigns: 2, coverage: 53 },
      { tactic: "Defense Evasion", techniques: 7, campaigns: 1, coverage: 33 },
      { tactic: "Credential Access", techniques: 6, campaigns: 6, coverage: 84 },
      { tactic: "Discovery", techniques: 5, campaigns: 5, coverage: 64 },
      { tactic: "Lateral Movement", techniques: 4, campaigns: 4, coverage: 44 },
      { tactic: "Collection", techniques: 3, campaigns: 3, coverage: 95 },
      { tactic: "Exfiltration", techniques: 2, campaigns: 2, coverage: 75 },
      { tactic: "Command & Control", techniques: 12, campaigns: 1, coverage: 55 },
      { tactic: "Impact", techniques: 11, campaigns: 6, coverage: 35 },
    ];
    return html`
  ...
  private _renderControlInventory() {
    const controls = [
      { id: "CTL-2001", name: "MFA Enforcement", domain: "Access Control", status: "implemented", effectiveness: 73, lastTest: "2026-03-23", nextReview: "2026-11-23", owner: "SOC", risk: "Low" },
      { id: "CTL-2002", name: "Network Segmentation", domain: "Network Security", status: "partial", effectiveness: 24, lastTest: "2026-02-08", nextReview: "2026-12-14", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2003", name: "EDR Deployment", domain: "Endpoint Protection", status: "planned", effectiveness: 31, lastTest: "2026-01-21", nextReview: "2026-05-05", owner: "IT Ops", risk: "High" },
      { id: "CTL-2004", name: "DLP Policy", domain: "Data Protection", status: "gap", effectiveness: 38, lastTest: "2026-04-06", nextReview: "2026-06-24", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2005", name: "SSO Integration", domain: "Identity Management", status: "implemented", effectiveness: 85, lastTest: "2026-03-19", nextReview: "2026-07-15", owner: "IAM", risk: "Low" },
      { id: "CTL-2006", name: "SAST Pipeline", domain: "Application Security", status: "partial", effectiveness: 1, lastTest: "2026-02-04", nextReview: "2026-08-06", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2007", name: "CSPM Scanning", domain: "Cloud Security", status: "planned", effectiveness: 8, lastTest: "2026-01-17", nextReview: "2026-09-25", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2008", name: "Badge Access", domain: "Physical Security", status: "gap", effectiveness: 15, lastTest: "2026-04-02", nextReview: "2026-10-16", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2009", name: "Least Privilege", domain: "Access Control", status: "implemented", effectiveness: 97, lastTest: "2026-03-15", nextReview: "2026-11-07", owner: "SOC", risk: "Low" },
      { id: "CTL-2010", name: "Firewall Rules", domain: "Network Security", status: "partial", effectiveness: 29, lastTest: "2026-02-28", nextReview: "2026-12-26", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2011", name: "Disk Encryption", domain: "Endpoint Protection", status: "planned", effectiveness: 36, lastTest: "2026-01-13", nextReview: "2026-05-17", owner: "IT Ops", risk: "High" },
      { id: "CTL-2012", name: "Data Classification", domain: "Data Protection", status: "gap", effectiveness: 43, lastTest: "2026-04-26", nextReview: "2026-06-08", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2013", name: "PAM Implementation", domain: "Identity Management", status: "implemented", effectiveness: 50, lastTest: "2026-03-11", nextReview: "2026-07-27", owner: "IAM", risk: "Low" },
      { id: "CTL-2014", name: "DAST Pipeline", domain: "Application Security", status: "partial", effectiveness: 6, lastTest: "2026-02-24", nextReview: "2026-08-18", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2015", name: "IAM Policy Review", domain: "Cloud Security", status: "planned", effectiveness: 13, lastTest: "2026-01-09", nextReview: "2026-09-09", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2016", name: "Visitor Management", domain: "Physical Security", status: "gap", effectiveness: 20, lastTest: "2026-04-22", nextReview: "2026-10-28", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2017", name: "Access Reviews", domain: "Access Control", status: "implemented", effectiveness: 62, lastTest: "2026-03-07", nextReview: "2026-11-19", owner: "SOC", risk: "Low" },
      { id: "CTL-2018", name: "IDS/IPS Tuning", domain: "Network Security", status: "partial", effectiveness: 34, lastTest: "2026-02-20", nextReview: "2026-12-10", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2019", name: "Patch Management", domain: "Endpoint Protection", status: "planned", effectiveness: 41, lastTest: "2026-01-05", nextReview: "2026-05-01", owner: "IT Ops", risk: "High" },
      { id: "CTL-2020", name: "Backup Encryption", domain: "Data Protection", status: "gap", effectiveness: 48, lastTest: "2026-04-18", nextReview: "2026-06-20", owner: "Data Gov", risk: "Critical" },
      { id: "CTL-2021", name: "Password Policy", domain: "Identity Management", status: "implemented", effectiveness: 74, lastTest: "2026-03-03", nextReview: "2026-07-11", owner: "IAM", risk: "Low" },
      { id: "CTL-2022", name: "Container Scanning", domain: "Application Security", status: "partial", effectiveness: 11, lastTest: "2026-02-16", nextReview: "2026-08-02", owner: "DevSecOps", risk: "Medium" },
      { id: "CTL-2023", name: "WAF Configuration", domain: "Cloud Security", status: "planned", effectiveness: 18, lastTest: "2026-01-01", nextReview: "2026-09-21", owner: "Cloud Ops", risk: "High" },
      { id: "CTL-2024", name: "CCTV Coverage", domain: "Physical Security", status: "gap", effectiveness: 25, lastTest: "2026-04-14", nextReview: "2026-10-12", owner: "Facilities", risk: "Critical" },
      { id: "CTL-2025", name: "RBAC Enforcement", domain: "Access Control", status: "implemented", effectiveness: 86, lastTest: "2026-03-27", nextReview: "2026-11-03", owner: "SOC", risk: "Low" },
      { id: "CTL-2026", name: "VPN Management", domain: "Network Security", status: "partial", effectiveness: 39, lastTest: "2026-02-12", nextReview: "2026-12-22", owner: "Network Ops", risk: "Medium" },
      { id: "CTL-2027", name: "App Whitelisting", domain: "Endpoint Protection", status: "planned", effectiveness: 46, lastTest: "2026-01-25", nextReview: "2026-05-13", owner: "IT Ops", risk: "High" },
      { id: "CTL-2028", name: "Key Management", domain: "Data Protection", status: "gap", effectiveness: 2, lastTest: "2026-04-10", nextReview: "2026-06-04", owner: "Data Gov", risk: "Critical" },
    ];
    const gapAnalysis = [
      { gap: "Insufficient MFA coverage for legacy apps", severity: "High", remediationPlan: "Plan R3001", eta: "2026-Q4", estimatedCost: "146k" },
      { gap: "Missing network micro-segmentation", severity: "Medium", remediationPlan: "Plan R3002", eta: "2026-Q3", estimatedCost: "175k" },
      { gap: "Inconsistent EDR deployment", severity: "Medium", remediationPlan: "Plan R3003", eta: "2026-Q2", estimatedCost: "23k" },
      { gap: "DLP not covering cloud storage", severity: "Low", remediationPlan: "Plan R3004", eta: "2026-Q4", estimatedCost: "52k" },
      { gap: "SSO not integrated with all SaaS", severity: "High", remediationPlan: "Plan R3005", eta: "2026-Q3", estimatedCost: "81k" },
    ];
    return html`
  ...
  private _renderIncidentCostTracker() {
    const incidents = [
      { id: "INC-7001", name: "Security Incident 1", severity: "Critical", totalCost: 900000, responseCost: 135000, recoveryCost: 180000, legalCost: 99000, regulatoryCost: 108000, insuranceClaim: 0, avoidedCost: 107000, date: "2026-03-15" },
      { id: "INC-7002", name: "Security Incident 2", severity: "High", totalCost: 903000, responseCost: 198660, recoveryCost: 279930, legalCost: 72240, regulatoryCost: 63210, insuranceClaim: 451500, avoidedCost: 136000, date: "2026-02-24" },
      { id: "INC-7003", name: "Security Incident 3", severity: "Medium", totalCost: 906000, responseCost: 262740, recoveryCost: 190260, legalCost: 45300, regulatoryCost: 117780, insuranceClaim: 0, avoidedCost: 165000, date: "2026-01-05" },
      { id: "INC-7004", name: "Security Incident 4", severity: "Low", totalCost: 909000, responseCost: 136350, recoveryCost: 290880, legalCost: 163620, regulatoryCost: 72720, insuranceClaim: 409050, avoidedCost: 194000, date: "2026-04-14" },
      { id: "INC-7005", name: "Security Incident 5", severity: "Critical", totalCost: 912000, responseCost: 200640, recoveryCost: 200640, legalCost: 136800, regulatoryCost: 127680, insuranceClaim: 0, avoidedCost: 223000, date: "2026-03-23" },
      { id: "INC-7006", name: "Security Incident 6", severity: "High", totalCost: 915000, responseCost: 265350, recoveryCost: 301950, legalCost: 109800, regulatoryCost: 82350, insuranceClaim: 366000, avoidedCost: 252000, date: "2026-02-04" },
      { id: "INC-7007", name: "Security Incident 7", severity: "Medium", totalCost: 918000, responseCost: 137700, recoveryCost: 211140, legalCost: 82620, regulatoryCost: 137700, insuranceClaim: 0, avoidedCost: 281000, date: "2026-01-13" },
      { id: "INC-7008", name: "Security Incident 8", severity: "Low", totalCost: 921000, responseCost: 202620, recoveryCost: 313140, legalCost: 55260, regulatoryCost: 92100, insuranceClaim: 322350, avoidedCost: 310000, date: "2026-04-22" },
      { id: "INC-7009", name: "Security Incident 9", severity: "Critical", totalCost: 924000, responseCost: 267960, recoveryCost: 221760, legalCost: 175560, regulatoryCost: 46200, insuranceClaim: 0, avoidedCost: 339000, date: "2026-03-03" },
      { id: "INC-7010", name: "Security Incident 10", severity: "High", totalCost: 927000, responseCost: 139050, recoveryCost: 324450, legalCost: 148320, regulatoryCost: 101970, insuranceClaim: 278100, avoidedCost: 368000, date: "2026-02-12" },
      { id: "INC-7011", name: "Security Incident 11", severity: "Medium", totalCost: 930000, responseCost: 204600, recoveryCost: 232500, legalCost: 120900, regulatoryCost: 55800, insuranceClaim: 0, avoidedCost: 397000, date: "2026-01-21" },
      { id: "INC-7012", name: "Security Incident 12", severity: "Low", totalCost: 933000, responseCost: 270570, recoveryCost: 335880, legalCost: 93300, regulatoryCost: 111960, insuranceClaim: 709080, avoidedCost: 426000, date: "2026-04-02" },
    ];
    const yearlyTrend = [
      { month: "Jan", incidents: 9, totalCost: "168k", avgCost: "60k", insured: 68 },
      { month: "Feb", incidents: 6, totalCost: "211k", avgCost: "107k", insured: 68 },
      { month: "Mar", incidents: 3, totalCost: "254k", avgCost: "154k", insured: 68 },
      { month: "Apr", incidents: 11, totalCost: "297k", avgCost: "20k", insured: 68 },
      { month: "May", incidents: 8, totalCost: "340k", avgCost: "67k", insured: 68 },
      { month: "Jun", incidents: 5, totalCost: "383k", avgCost: "114k", insured: 68 },
    ];
...
declare global { interface HTMLElementTagNameMap { 'sc-data-classification': ScDataClassification; } }
