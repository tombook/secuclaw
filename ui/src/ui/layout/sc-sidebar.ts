...
const navItems: NavItem[] = [
  ...
  // Tool Demo Pages
  { path: '/tools/baseline', icon: '📋', labelKey: 'nav.baseline' },
  { path: '/tools/vuln-scan', icon: '🔍', labelKey: 'nav.vulnScan' },
  { path: '/tools/pentest', icon: '🎯', labelKey: 'nav.pentest' },
  { path: '/tools/threat-hunt', icon: '🕵️', labelKey: 'nav.threatHunt' },
