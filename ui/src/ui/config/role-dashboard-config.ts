...
export interface ChartConfig {
  type: 'vulnerability-trend' | 'compliance-status' | 'incident-timeline' | 
        'risk-distribution' | 'asset-coverage' | 'threat-landscape' |
        'supply-chain-risk' | 'security-score';
  dataKey: string;
}
...
export const ROLE_DASHBOARD_CONFIG: Record<RoleId, RoleDashboardConfig> = {
  ...
  'privacy-officer': {
    ...
    alertFilters: {
      category: ['privacy', 'data-protection', 'consent'],
  ...
  'security-architect': {
    ...
    alertFilters: {
      category: ['architecture', 'design', 'integration'],
      severity: ['critical', 'high', 'medium'],
    },
  ...
  'business-security-officer': {
    ...
    alertFilters: {
      category: ['business-impact', 'operational', 'regulatory'],
  ...
  'ciso': {
    ...
    alertFilters: {
      category: ['executive', 'strategic', 'regulatory'],
      severity: ['critical'],
    },
  ...
  'security-ops': {
    ...
    alertFilters: {
      category: ['alert', 'incident', 'forensic'],
      severity: ['critical', 'high', 'medium'],
  ...
  'supply-chain-security': {
    ...
    alertFilters: {
      category: ['vendor', 'dependency', 'license'],
      severity: ['critical', 'high'],
    },
