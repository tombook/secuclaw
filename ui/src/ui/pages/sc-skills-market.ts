...
@customElement('sc-skills-market') export class ScSkillsMarket extends LitElement {
  ...
  render() {
    return html`
      <h1 class="page-title">${this.i18n.t('nav.skillsMarket')}</h1>
      <div class="placeholder">
        <p>🛒 Skills Market</p>
        <p>Browse, install, and activate security skills</p>
      </div>
    `;
  }
}
