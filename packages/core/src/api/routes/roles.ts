 ...
 * More specific routes must be defined BEFORE parameterized routes (/:id)
 */
...
/**
 * GET /api/v1/roles/code/:code - Get role by code (MUST be before /:id)
 */
...
/**
 * POST /api/v1/roles/initialize - Initialize default roles (before /users and /:id)
 */
...
// ==================== Role Routes with /:id (MUST be after more specific routes) ====================
