export const PERMISSIONS = {
    ...
    MATURITY_READ: 'maturity.read',
    MATURITY_WRITE: 'maturity.write',
    BUDGET_READ: 'budget.read',
    BUDGET_WRITE: 'budget.write',
    REPORTS_BOARD: 'reports.board',
    ATTACK_PATH_READ: 'attack-path.read',
    ATTACK_PATH_WRITE: 'attack-path.write',
};
export const PERMISSION_MATRIX = {
    admin: ['*'],
    'secuclaw-commander': [
        PERMISSIONS.ASSETS_READ, PERMISSIONS.ASSETS_WRITE, PERMISSIONS.ASSETS_DELETE,
        PERMISSIONS.VENDORS_READ, PERMISSIONS.VENDORS_WRITE, PERMISSIONS.VENDORS_DELETE,
...
export function getInheritedPermissions(roleCode) {
...
export function hasPermissionWithInheritance(roleCode, required) {
